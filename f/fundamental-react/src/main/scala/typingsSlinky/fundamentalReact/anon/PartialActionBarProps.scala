...
object PartialActionBarProps {
  ...
  implicit class PartialActionBarPropsOps[Self <: PartialActionBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionClassName(value: String): Self = this.set("actionClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteActionClassName: Self = this.set("actionClassName", js.undefined)
    
    @scala.inline
    def setActionProps(value: js.Any): Self = this.set("actionProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setButtonContainerClassName(value: String): Self = this.set("buttonContainerClassName", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDescriptionProps(value: js.Any): Self = this.set("descriptionProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHeadingLevel(value: js.Any): Self = this.set("headingLevel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBackClick(value: /* repeated */ js.Any => _): Self = this.set("onBackClick", js.Any.fromFunction1(value))
