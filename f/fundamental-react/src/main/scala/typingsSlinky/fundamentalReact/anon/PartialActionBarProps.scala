...
@js.native
trait PartialActionBarProps extends StObject {
...
object PartialActionBarProps {
  ...
  @scala.inline
  implicit class PartialActionBarPropsMutableBuilder[Self <: PartialActionBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionClassName(value: String): Self = StObject.set(x, "actionClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActionClassNameUndefined: Self = StObject.set(x, "actionClassName", js.undefined)
    
    @scala.inline
    def setActionProps(value: js.Any): Self = StObject.set(x, "actionProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setButtonContainerClassName(value: String): Self = StObject.set(x, "buttonContainerClassName", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDescriptionProps(value: js.Any): Self = StObject.set(x, "descriptionProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBackClick(value: /* repeated */ js.Any => _): Self = StObject.set(x, "onBackClick", js.Any.fromFunction1(value))
