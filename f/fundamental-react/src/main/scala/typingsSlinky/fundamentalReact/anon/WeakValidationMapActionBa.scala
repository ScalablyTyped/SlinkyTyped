...
object WeakValidationMapActionBa {
  ...
  implicit class WeakValidationMapActionBaOps[Self <: WeakValidationMapActionBa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionClassName(value: Validator[js.UndefOr[Null | String]]): Self = this.set("actionClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteActionClassName: Self = this.set("actionClassName", js.undefined)
    
    @scala.inline
    def setActionProps(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("actionProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteActionProps: Self = this.set("actionProps", js.undefined)
    
    @scala.inline
    def setActions(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("actions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setButtonContainerClassName(value: Validator[js.UndefOr[Null | String]]): Self = this.set("buttonContainerClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteButtonContainerClassName: Self = this.set("buttonContainerClassName", js.undefined)
    ...
    @scala.inline
    def setDescriptionProps(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("descriptionProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDescriptionProps: Self = this.set("descriptionProps", js.undefined)
    ...
    @scala.inline
    def setHeadingLevel(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("headingLevel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBackClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = this.set("onBackClick", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnBackClick: Self = this.set("onBackClick", js.undefined)
