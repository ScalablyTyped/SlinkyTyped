...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/Link/Link.LinkProps> */
@js.native
trait PartialLinkProps extends StObject {
  ...
  var ref: js.UndefOr[Ref[HTMLAnchorElement]] = js.native
...
object PartialLinkProps {
  
  @scala.inline
  def apply(): PartialLinkProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLinkProps]
  }
  
  @scala.inline
  implicit class PartialLinkPropsMutableBuilder[Self <: PartialLinkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLAnchorElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
