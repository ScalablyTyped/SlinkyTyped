...
@js.native
trait PartialLinkProps extends js.Object {
...
object PartialLinkProps {
  ...
  @scala.inline
  implicit class PartialLinkPropsOps[Self <: PartialLinkProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRef(value: Ref[HTMLAnchorElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
