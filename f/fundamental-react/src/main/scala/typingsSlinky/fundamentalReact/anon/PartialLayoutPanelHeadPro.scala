...
@js.native
trait PartialLayoutPanelHeadPro extends js.Object {
...
object PartialLayoutPanelHeadPro {
  ...
  @scala.inline
  implicit class PartialLayoutPanelHeadProOps[Self <: PartialLayoutPanelHeadPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeadingStyle(value: `2` | `3` | `4` | `5` | `6`): Self = this.set("headingStyle", value.asInstanceOf[js.Any])
