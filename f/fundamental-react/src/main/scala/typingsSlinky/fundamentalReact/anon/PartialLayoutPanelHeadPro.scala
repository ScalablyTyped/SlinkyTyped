...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/LayoutPanel/LayoutPanel.LayoutPanelHeadProps> */
@js.native
trait PartialLayoutPanelHeadPro extends StObject {
  ...
  var headingStyle: js.UndefOr[`2` | `3` | `4` | `5` | `6`] = js.native
...
object PartialLayoutPanelHeadPro {
  
  @scala.inline
  def apply(): PartialLayoutPanelHeadPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLayoutPanelHeadPro]
  }
  
  @scala.inline
  implicit class PartialLayoutPanelHeadProMutableBuilder[Self <: PartialLayoutPanelHeadPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeadingStyle(value: `2` | `3` | `4` | `5` | `6`): Self = StObject.set(x, "headingStyle", value.asInstanceOf[js.Any])
