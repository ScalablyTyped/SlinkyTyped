...
object PartialButtonProps {
  ...
  implicit class PartialButtonPropsOps[Self <: PartialButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnClick(value: /* event */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOption(value: ButtonOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRef(value: ReactRef[HTMLButtonElement]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: ButtonTypes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTypeAttr(value: submit | reset | button_): Self = {
        val ret = this.duplicate
