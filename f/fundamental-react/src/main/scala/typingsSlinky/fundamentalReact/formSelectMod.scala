...
object formSelectMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FormSelectProps] = js.native
  ...
  type _To = ReactComponentClass[FormSelectProps]
  
  /* This means you don't have to write `default`, but can instead just say `formSelectMod.foo` */
  override def _to: ReactComponentClass[FormSelectProps] = default
}
