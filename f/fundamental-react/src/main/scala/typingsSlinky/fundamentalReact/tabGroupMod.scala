...
object tabGroupMod {
  ...
  type TabGroup = ReactComponentClass[TabGroupProps]
  ...
  object TabGroupProps {
    ...
    implicit class TabGroupPropsMutableBuilder[Self <: TabGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnTabClick(value: (/* event */ SyntheticMouseEvent[Element], /* index */ Double) => Unit): Self = StObject.set(x, "onTabClick", js.Any.fromFunction2(value))
