...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/ActionBar/ActionBar.ActionBarBackProps> */
trait PartialActionBarBackProps extends js.Object {
...
object PartialActionBarBackProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    __obj.asInstanceOf[PartialActionBarBackProps]
  }
}
