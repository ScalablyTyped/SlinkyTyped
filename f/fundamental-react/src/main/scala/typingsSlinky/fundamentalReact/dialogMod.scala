...
object dialogMod {
  ...
  type Dialog = ReactComponentClass[DialogProps]
  
  /* Inlined {  actions :std.Array<react.react.ReactNode>,   title :string,   backdropClassName :string | undefined,   bodyProps :any | undefined,   className :string | undefined,   contentProps :any | undefined,   disableStyles :boolean | undefined,   footerProps :any | undefined,   header :string | undefined,   headerProps :any | undefined,   headingLevel :any | undefined,   show :boolean | undefined,   size :any | undefined,   subheader :string | undefined,   titleProps :any | undefined,   onClose :(args : ...any): any | undefined} & react.react.HTMLAttributes<std.HTMLSpanElement> */
  @js.native
  trait DialogProps extends StObject {
    ...
    var actions: js.Array[ReactElement] = js.native
    ...
    var footerProps: js.UndefOr[js.Any] = js.native
    
    var header: js.UndefOr[String] = js.native
    
    var headerProps: js.UndefOr[js.Any] = js.native
    
    var headingLevel: js.UndefOr[js.Any] = js.native
    ...
    var title: String with js.UndefOr[String] = js.native
  ...
  object DialogProps {
    ...
    @scala.inline
    def apply(actions: js.Array[ReactElement], title: String with js.UndefOr[String]): DialogProps = {
    ...
    implicit class DialogPropsMutableBuilder[Self <: DialogProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTitle(value: String with js.UndefOr[String]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
