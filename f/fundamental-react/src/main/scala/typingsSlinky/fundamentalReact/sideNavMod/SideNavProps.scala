...
/* Inlined {  className ? :string,   compact ? :boolean,   condensed ? :boolean,   disableStyles ? :boolean,   selectedId ? :string, onItemSelect ? (e : any, id : any): void} & react.react.HTMLAttributes<std.Element> */
