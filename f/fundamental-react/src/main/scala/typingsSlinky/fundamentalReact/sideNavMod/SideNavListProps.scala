...
/* Inlined {  className ? :string,   compact ? :boolean,   condensed ? :boolean,   hasParent ? :boolean,   isUtility ? :boolean,   level ? :number,   open ? :boolean,   selectedId ? :string,   title ? :string,   titleProps ? :any, onItemSelect ? (args : ...any): any} & react.react.HTMLAttributes<std.Element> */
