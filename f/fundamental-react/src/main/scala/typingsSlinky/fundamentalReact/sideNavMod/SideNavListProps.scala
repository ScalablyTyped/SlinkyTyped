...
object SideNavListProps {
  ...
  @scala.inline
  implicit class SideNavListPropsOps[Self <: SideNavListProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withIsUtility(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isUtility")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsUtility: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isUtility")(js.undefined)
        ret
    }
    @scala.inline
