package typingsSlinky.fundamentalReact.dialogMod
...
trait DialogProps extends js.Object {
  ...
  var actions: js.Array[TagMod[Any]] = js.native
...
object DialogProps {
  @scala.inline
  def apply(actions: js.Array[TagMod[Any]]): DialogProps = {
  ...
  implicit class DialogPropsOps[Self <: DialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentProps(value: js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFooterProps(value: js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHeaderProps(value: js.Any): Self = {
        val ret = this.duplicate
