...
import typingsSlinky.fundamentalReact.AnonButtonProps
import typingsSlinky.fundamentalReact.AnonInputProps
...
trait LocalizationEditorProps extends js.Object {
  ...
  var control: AnonButtonProps = js.native
  ...
  var menu: js.Array[AnonInputProps] = js.native
  // Media Events
...
object LocalizationEditorProps {
  @scala.inline
  def apply(control: AnonButtonProps, menu: js.Array[AnonInputProps]): LocalizationEditorProps = {
