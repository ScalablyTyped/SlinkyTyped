...
trait ShellbarProps extends js.Object {
  ...
  var backAction: js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]] = js.native
...
object ShellbarProps {
  ...
  implicit class ShellbarPropsOps[Self <: ShellbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackAction(value: /* event */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("backAction", js.Any.fromFunction1(value))
