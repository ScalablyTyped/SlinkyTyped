...
trait ShellbarProps extends js.Object {
  ...
  var backAction: js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]] = js.undefined
...
object ShellbarProps {
  ...
  def apply(
    ...
    backAction: /* event */ SyntheticMouseEvent[HTMLButtonElement] => Unit = null,
    ...
    onAbort: SyntheticEvent[Event, Element] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[Element] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[Element] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[Element] => Unit = null,
    onAuxClick: SyntheticMouseEvent[Element] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with Element, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[Element] => Unit = null,
    onCanPlay: SyntheticEvent[Event, Element] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, Element] => Unit = null,
    onChange: SyntheticEvent[EventTarget with Element, Event] => Unit = null,
    onClick: SyntheticMouseEvent[Element] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[Element] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[Element] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[Element] => Unit = null,
    onContextMenu: SyntheticMouseEvent[Element] => Unit = null,
    onCopy: SyntheticClipboardEvent[Element] => Unit = null,
    onCut: SyntheticClipboardEvent[Element] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[Element] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, Element] => Unit = null,
    onEmptied: SyntheticEvent[Event, Element] => Unit = null,
    onEncrypted: SyntheticEvent[Event, Element] => Unit = null,
    onEnded: SyntheticEvent[Event, Element] => Unit = null,
    onError: SyntheticEvent[Event, Element] => Unit = null,
    onFocus: SyntheticFocusEvent[Element] => Unit = null,
    onInput: SyntheticEvent[EventTarget with Element, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with Element, Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[Element] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[Element] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[Element] => Unit = null,
    onLoad: SyntheticEvent[Event, Element] => Unit = null,
    onLoadStart: SyntheticEvent[Event, Element] => Unit = null,
    onLoadedData: SyntheticEvent[Event, Element] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, Element] => Unit = null,
    onMouseDown: SyntheticMouseEvent[Element] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[Element] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[Element] => Unit = null,
    onMouseMove: SyntheticMouseEvent[Element] => Unit = null,
    onMouseOut: SyntheticMouseEvent[Element] => Unit = null,
    onMouseOver: SyntheticMouseEvent[Element] => Unit = null,
    onMouseUp: SyntheticMouseEvent[Element] => Unit = null,
    onPaste: SyntheticClipboardEvent[Element] => Unit = null,
    onPause: SyntheticEvent[Event, Element] => Unit = null,
    onPlay: SyntheticEvent[Event, Element] => Unit = null,
    onPlaying: SyntheticEvent[Event, Element] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[Element] => Unit = null,
    onPointerDown: SyntheticPointerEvent[Element] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[Element] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[Element] => Unit = null,
    onPointerMove: SyntheticPointerEvent[Element] => Unit = null,
    onPointerOut: SyntheticPointerEvent[Element] => Unit = null,
    onPointerOver: SyntheticPointerEvent[Element] => Unit = null,
    onPointerUp: SyntheticPointerEvent[Element] => Unit = null,
    onProgress: SyntheticEvent[Event, Element] => Unit = null,
    onRateChange: SyntheticEvent[Event, Element] => Unit = null,
    onReset: SyntheticEvent[EventTarget with Element, Event] => Unit = null,
    onScroll: SyntheticUIEvent[Element] => Unit = null,
    onSeeked: SyntheticEvent[Event, Element] => Unit = null,
    onSeeking: SyntheticEvent[Event, Element] => Unit = null,
    onSelect: SyntheticEvent[Event, Element] => Unit = null,
    onStalled: SyntheticEvent[Event, Element] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with Element, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, Element] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, Element] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[Element] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[Element] => Unit = null,
    onTouchMove: SyntheticTouchEvent[Element] => Unit = null,
    onTouchStart: SyntheticTouchEvent[Element] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[Element] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, Element] => Unit = null,
    onWaiting: SyntheticEvent[Event, Element] => Unit = null,
    onWheel: SyntheticWheelEvent[Element] => Unit = null,
