...
object formSetMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FormSetProps] = js.native
  ...
  type _To = ReactComponentClass[FormSetProps]
  
  /* This means you don't have to write `default`, but can instead just say `formSetMod.foo` */
  override def _to: ReactComponentClass[FormSetProps] = default
}
