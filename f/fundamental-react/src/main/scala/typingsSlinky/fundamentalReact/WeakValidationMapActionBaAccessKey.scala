...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/ActionBar/ActionBar.ActionBarBackProps> */
trait WeakValidationMapActionBaAccessKey extends js.Object {
...
object WeakValidationMapActionBaAccessKey {
  @scala.inline
  def apply(
  ...
  ): WeakValidationMapActionBaAccessKey = {
    ...
    __obj.asInstanceOf[WeakValidationMapActionBaAccessKey]
  }
}
