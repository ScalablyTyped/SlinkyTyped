...
object avatarMod extends Shortcut {
  ...
  object AvatarProps {
    ...
    implicit class AvatarPropsMutableBuilder[Self <: AvatarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: `1` | `2` | `3` | `4` | `5` | `6` | `7` | `8` | `9`): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPlaceholder(value: js.UndefOr[Boolean] with js.UndefOr[String]): Self = StObject.set(x, "placeholder", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.fundamentalReact.fundamentalReactStrings.xs
  ...
  */
  trait AvatarSize extends StObject
  object AvatarSize {
    ...
    @scala.inline
    def xs: typingsSlinky.fundamentalReact.fundamentalReactStrings.xs = "xs".asInstanceOf[typingsSlinky.fundamentalReact.fundamentalReactStrings.xs]
  }
  
  /* Inlined std.Omit<react.react.HTMLAttributes<std.HTMLSpanElement>, 'color'> */
  @js.native
  trait HTMLAttributesColorOmited extends StObject {
  ...
  object HTMLAttributesColorOmited {
    
    @scala.inline
    def apply(): HTMLAttributesColorOmited = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HTMLAttributesColorOmited]
    }
    
    @scala.inline
    implicit class HTMLAttributesColorOmitedMutableBuilder[Self <: HTMLAttributesColorOmited] (val x: Self) extends AnyVal {
