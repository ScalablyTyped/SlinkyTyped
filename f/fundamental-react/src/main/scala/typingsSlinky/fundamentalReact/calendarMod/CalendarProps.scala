...
object CalendarProps {
  ...
  implicit class CalendarPropsOps[Self <: CalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlockedDatesVarargs(value: js.Date*): Self = this.set("blockedDates", js.Array(value :_*))
    @scala.inline
    def setBlockedDates(value: js.Array[js.Date]): Self = this.set("blockedDates", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBlockedDates: Self = this.set("blockedDates", js.undefined)
    @scala.inline
    def setDisableAfterDate(value: js.Date): Self = this.set("disableAfterDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableAfterDate: Self = this.set("disableAfterDate", js.undefined)
    @scala.inline
    def setDisableBeforeDate(value: js.Date): Self = this.set("disableBeforeDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: /* date */ js.Date => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
