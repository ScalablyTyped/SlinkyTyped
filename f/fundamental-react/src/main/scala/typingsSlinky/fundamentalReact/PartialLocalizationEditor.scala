...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/LocalizationEditor/LocalizationEditor.LocalizationEditorProps> */
@js.native
trait PartialLocalizationEditor extends js.Object {
  ...
  var control: js.UndefOr[AnonButtonProps] = js.native
  ...
  var menu: js.UndefOr[js.Array[AnonInputProps]] = js.native
  ...
  var textarea: js.UndefOr[Boolean] = js.native
...
object PartialLocalizationEditor {
  @scala.inline
  def apply(): PartialLocalizationEditor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLocalizationEditor]
  }
  @scala.inline
  implicit class PartialLocalizationEditorOps[Self <: PartialLocalizationEditor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withControl(value: AnonButtonProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMenu(value: js.Array[AnonInputProps]): Self = {
        val ret = this.duplicate
