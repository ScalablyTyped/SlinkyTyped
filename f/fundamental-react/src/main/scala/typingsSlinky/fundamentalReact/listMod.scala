...
object listMod {
  ...
  object ListProps {
    ...
    implicit class ListPropsMutableBuilder[Self <: ListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFooter(value: String | ReactElement): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
  ...
  object ListSelectionProps {
    ...
    implicit class ListSelectionPropsMutableBuilder[Self <: ListSelectionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (/* event */ SyntheticEvent[Event, HTMLInputElement], /* checkedState */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
