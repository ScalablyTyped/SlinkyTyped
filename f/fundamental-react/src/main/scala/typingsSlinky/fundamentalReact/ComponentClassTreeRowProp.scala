...
trait ComponentClassTreeRowProp
  extends Instantiable1[/* props */ TreeRowProps, ReactComponentClass[TreeRowProps]]
     with Instantiable2[/* props */ TreeRowProps, /* context */ js.Any, ReactComponentClass[TreeRowProps]] {
