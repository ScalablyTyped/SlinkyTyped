...
object datePickerMod {
  ...
  object DatePickerProps {
    ...
    implicit class DatePickerPropsMutableBuilder[Self <: DatePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBlockedDates(value: js.Array[js.Date]): Self = StObject.set(x, "blockedDates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBlockedDatesUndefined: Self = StObject.set(x, "blockedDates", js.undefined)
      
      @scala.inline
      def setBlockedDatesVarargs(value: js.Date*): Self = StObject.set(x, "blockedDates", js.Array(value :_*))
      ...
      @scala.inline
      def setDisableAfterDate(value: js.Date): Self = StObject.set(x, "disableAfterDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableAfterDateUndefined: Self = StObject.set(x, "disableAfterDate", js.undefined)
      
      @scala.inline
      def setDisableBeforeDate(value: js.Date): Self = StObject.set(x, "disableBeforeDate", value.asInstanceOf[js.Any])
