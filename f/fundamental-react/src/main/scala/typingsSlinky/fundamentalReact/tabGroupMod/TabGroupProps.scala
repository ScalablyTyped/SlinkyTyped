...
trait TabGroupProps
  ...
  var onTabClick: js.UndefOr[js.Function2[/* event */ SyntheticMouseEvent[Element], /* index */ Double, Unit]] = js.undefined
...
object TabGroupProps {
  ...
  def apply(
    ...
    onTabClick: (/* event */ SyntheticMouseEvent[Element], /* index */ Double) => Unit = null,
