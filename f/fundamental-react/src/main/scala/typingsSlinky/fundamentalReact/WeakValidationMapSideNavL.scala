...
object WeakValidationMapSideNavL {
  ...
  implicit class WeakValidationMapSideNavLOps[Self <: WeakValidationMapSideNavL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCondensed(value: Validator[js.UndefOr[Boolean | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHasParent(value: Validator[js.UndefOr[Boolean | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIsUtility(value: Validator[js.UndefOr[Boolean | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnClick(value: Validator[js.UndefOr[MouseEventHandler[Element] | Null]]): Self = {
        val ret = this.duplicate
