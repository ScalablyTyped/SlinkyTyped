package typingsSlinky.fundamentalReact.layoutPanelMod
...
@js.native
trait LayoutPanelHeadProps extends js.Object {
...
object LayoutPanelHeadProps {
  ...
  @scala.inline
  implicit class LayoutPanelHeadPropsOps[Self <: LayoutPanelHeadProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTitle(value: js.UndefOr[Boolean] with js.UndefOr[String]): Self = this.set("title", value.asInstanceOf[js.Any])
