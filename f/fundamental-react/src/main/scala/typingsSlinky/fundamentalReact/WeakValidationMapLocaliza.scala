...
trait WeakValidationMapLocaliza extends js.Object {
  ...
  var control: js.UndefOr[Validator[js.UndefOr[AnonButtonProps | Null]]] = js.native
  ...
  var menu: js.UndefOr[Validator[js.UndefOr[js.Array[AnonInputProps] | Null]]] = js.native
...
object WeakValidationMapLocaliza {
  ...
  implicit class WeakValidationMapLocalizaOps[Self <: WeakValidationMapLocaliza] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControl(value: Validator[js.UndefOr[AnonButtonProps | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMenu(value: Validator[js.UndefOr[js.Array[AnonInputProps] | Null]]): Self = {
        val ret = this.duplicate
