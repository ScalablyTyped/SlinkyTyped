package typingsSlinky.fundamentalDashReact.libFormsFormMessageMod
...
object FormMessageType {
  ...
  @scala.inline
  def help: typingsSlinky.fundamentalDashReact.fundamentalDashReactStrings.help = this.cast("help")
  @scala.inline
