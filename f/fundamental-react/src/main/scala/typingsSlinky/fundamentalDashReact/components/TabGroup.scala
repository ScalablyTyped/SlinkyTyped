...
import typingsSlinky.fundamentalDashReact.libTabsTabGroupMod.TabGroupProps
import typingsSlinky.fundamentalDashReact.libTabsTabGroupMod.default
...
object TabGroup
  ...
  typingsSlinky.fundamentalDashReact.libTabsTabGroupMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
