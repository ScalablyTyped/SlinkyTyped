...
trait Text_
  extends FontawesomeObject
     with IconOrText {
  val `type`: typingsSlinky.fortawesomeFontawesomeSvgCore.fortawesomeFontawesomeSvgCoreStrings.text
}
...
object Text_ {
  ...
  implicit class Text_Ops[Self <: Text_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.fortawesomeFontawesomeSvgCore.fortawesomeFontawesomeSvgCoreStrings.text): Self = this.set("type", value.asInstanceOf[js.Any])
  }
