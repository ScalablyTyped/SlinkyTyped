...
object anon {
  ...
  object ExcludeIE {
    ...
    implicit class ExcludeIEMutableBuilder[Self <: ExcludeIE] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSortPluginsFor(value: js.Array[js.RegExp]): Self = StObject.set(x, "sortPluginsFor", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSortPluginsForVarargs(value: js.RegExp*): Self = StObject.set(x, "sortPluginsFor", js.Array(value :_*))
    }
  }
