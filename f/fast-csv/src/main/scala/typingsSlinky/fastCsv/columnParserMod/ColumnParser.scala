...
trait ColumnParser extends js.Object {
  val nonQuotedColumnParser: typingsSlinky.fastCsv.nonQuotedColumnParserMod.default
  val parserOptions: js.Any
  val quotedColumnParser: typingsSlinky.fastCsv.quotedColumnParserMod.default
