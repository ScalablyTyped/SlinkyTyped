...
import typingsSlinky.fastDashCsv.buildSrcFormatterFormatterRowFormatterMod.RowFormatter
import typingsSlinky.fastDashCsv.buildSrcFormatterFormatterRowFormatterMod.RowFormatterCallback
...
object buildSrcFormatterFormatterRowFormatterMod extends js.Object {
  ...
  type RowFormatterCallback = js.Function2[/* error */ js.Error | Null, /* data */ js.UndefOr[js.Array[String]], Unit]
}
