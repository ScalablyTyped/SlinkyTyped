...
object Motion {
  ...
  implicit class MotionOps[Self <: Motion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnimateIn(value: (js.Object, js.Any, js.Function) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("animateIn")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withAnimateOut(value: (js.Object, js.Any, js.Function) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("animateOut")(js.Any.fromFunction3(value))
        ret
    }
  }
