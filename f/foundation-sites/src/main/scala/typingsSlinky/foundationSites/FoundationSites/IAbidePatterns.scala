...
trait IAbidePatterns extends StObject {
  ...
  var day_month_year: js.UndefOr[js.RegExp] = js.native
...
object IAbidePatterns {
  ...
  implicit class IAbidePatternsMutableBuilder[Self <: IAbidePatterns] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlpha(value: js.RegExp): Self = StObject.set(x, "alpha", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlphaUndefined: Self = StObject.set(x, "alpha", js.undefined)
    
    @scala.inline
    def setAlpha_numeric(value: js.RegExp): Self = StObject.set(x, "alpha_numeric", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlpha_numericUndefined: Self = StObject.set(x, "alpha_numeric", js.undefined)
    
    @scala.inline
    def setCard(value: js.RegExp): Self = StObject.set(x, "card", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCardUndefined: Self = StObject.set(x, "card", js.undefined)
    
    @scala.inline
    def setColor(value: js.RegExp): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
    
    @scala.inline
    def setCvv(value: js.RegExp): Self = StObject.set(x, "cvv", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCvvUndefined: Self = StObject.set(x, "cvv", js.undefined)
    
    @scala.inline
    def setDate(value: js.RegExp): Self = StObject.set(x, "date", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateISO(value: js.RegExp): Self = StObject.set(x, "dateISO", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDatetime(value: js.RegExp): Self = StObject.set(x, "datetime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDatetimeUndefined: Self = StObject.set(x, "datetime", js.undefined)
    
    @scala.inline
    def setDay_month_year(value: js.RegExp): Self = StObject.set(x, "day_month_year", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInteger(value: js.RegExp): Self = StObject.set(x, "integer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIntegerUndefined: Self = StObject.set(x, "integer", js.undefined)
    
    @scala.inline
    def setMonth_day_year(value: js.RegExp): Self = StObject.set(x, "month_day_year", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMonth_day_yearUndefined: Self = StObject.set(x, "month_day_year", js.undefined)
    
    @scala.inline
    def setNumber(value: js.RegExp): Self = StObject.set(x, "number", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNumberUndefined: Self = StObject.set(x, "number", js.undefined)
    
    @scala.inline
    def setTime(value: js.RegExp): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
