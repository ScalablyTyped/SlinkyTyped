...
object IAbidePatterns {
  ...
  implicit class IAbidePatternsOps[Self <: IAbidePatterns] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDay_month_year(value: js.RegExp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("day_month_year")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDay_month_year: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("day_month_year")(js.undefined)
        ret
    }
    @scala.inline
