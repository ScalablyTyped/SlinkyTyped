...
import typingsSlinky.formatjsEcma402Abstract.anon.Full
import typingsSlinky.formatjsEcma402Abstract.anon.Medium
import typingsSlinky.formatjsEcma402Abstract.anon.Narrow
import typingsSlinky.formatjsEcma402Abstract.anon.Short
...
object DateTimeFormatLocaleInternalData {
  ...
  implicit class DateTimeFormatLocaleInternalDataOps[Self <: DateTimeFormatLocaleInternalData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEra(value: Short): Self = this.set("era", value.asInstanceOf[js.Any])
