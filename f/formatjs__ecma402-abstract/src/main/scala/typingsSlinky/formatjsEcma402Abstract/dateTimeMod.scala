...
import typingsSlinky.formatjsEcma402Abstract.anon.IntervalFormatFallback
import typingsSlinky.formatjsEcma402Abstract.anon.Long
...
import typingsSlinky.std.Intl.DateTimeFormatPartTypes
...
object dateTimeMod {
  ...
  object DateTimeFormatLocaleInternalData {
    ...
    implicit class DateTimeFormatLocaleInternalDataMutableBuilder[Self <: DateTimeFormatLocaleInternalData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEra(value: Short): Self = StObject.set(x, "era", value.asInstanceOf[js.Any])
  ...
  object Formats {
    ...
    implicit class FormatsMutableBuilder[Self <: Formats] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRangePatterns(value: RecordTABLE2defaultRangeP): Self = StObject.set(x, "rangePatterns", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRangePatterns12(value: RecordTABLE2defaultRangeP): Self = StObject.set(x, "rangePatterns12", value.asInstanceOf[js.Any])
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.startRange
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.shared
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.endRange
  */
  trait RangePatternType extends StObject
  object RangePatternType {
    
    @scala.inline
    def endRange: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.endRange = "endRange".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.endRange]
    
    @scala.inline
    def shared: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.shared = "shared".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.shared]
    
    @scala.inline
    def startRange: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.startRange = "startRange".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.startRange]
  }
  ...
  trait ResolvedDateTimeFormatOptions
    extends typingsSlinky.std.Intl.ResolvedDateTimeFormatOptions {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.era
  ...
  */
  ...
  object TABLE_2 {
    ...
    @scala.inline
    def ampm: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.ampm = "ampm".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.ampm]
    ...
    @scala.inline
    def era: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.era = "era".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.era]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.weekday
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.era
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.year
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.month
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.day
    ...
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.minute
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.second
    - typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.timeZoneName
  */
  ...
  object TABLE_6 {
    ...
    @scala.inline
    def timeZoneName: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.timeZoneName = "timeZoneName".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.timeZoneName]
    
    @scala.inline
    def weekday: typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.weekday = "weekday".asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.weekday]
