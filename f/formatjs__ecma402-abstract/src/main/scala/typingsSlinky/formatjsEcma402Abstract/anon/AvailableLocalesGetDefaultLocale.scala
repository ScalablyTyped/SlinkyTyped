...
import typingsSlinky.formatjsEcma402Abstract.pluralRulesMod.PluralRulesData
...
@js.native
trait AvailableLocalesGetDefaultLocale extends js.Object {
...
object AvailableLocalesGetDefaultLocale {
  ...
  @scala.inline
  implicit class AvailableLocalesGetDefaultLocaleOps[Self <: AvailableLocalesGetDefaultLocale] (val x: Self) extends AnyVal {
