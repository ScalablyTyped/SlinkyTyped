...
object typesRelativeTimeMod {
  ...
  */
  ...
  object RelativeTimePart {
    ...
    @scala.inline
    def LiteralPart(`type`: literal, value: String): typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractUtilsMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractUtilsMod.LiteralPart]
    }
    
    @scala.inline
    def RelativeTimeFormatNumberPart(`type`: NumberFormatPartTypes, unit: RelativeTimeUnit, value: String): typingsSlinky.formatjsEcma402Abstract.typesRelativeTimeMod.RelativeTimeFormatNumberPart = {
      val __obj = js.Dynamic.literal(unit = unit.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.formatjsEcma402Abstract.typesRelativeTimeMod.RelativeTimeFormatNumberPart]
    }
  }
