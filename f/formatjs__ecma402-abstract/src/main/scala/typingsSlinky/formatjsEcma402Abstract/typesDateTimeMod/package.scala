...
package object typesDateTimeMod {
  ...
  */
  type IntlDateTimeFormatPartType = typingsSlinky.formatjsEcma402Abstract.typesDateTimeMod._IntlDateTimeFormatPartType | typingsSlinky.std.Intl.DateTimeFormatPartTypes
