...
import typingsSlinky.formatjsEcma402Abstract.anon.Value
import typingsSlinky.formatjsEcma402Abstract.anon.valueanyThisTypeany
import typingsSlinky.formatjsEcma402Abstract.formatjsEcma402AbstractStrings.literal
import typingsSlinky.formatjsEcma402Abstract.relativeTimeMod.RelativeTimePart
...
object utilsMod {
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "defineProperty")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "getInternalSlot")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "getMagnitude")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "invariant")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "isLiteralPart")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "repeat")
  @js.native
  def repeat(s: String, times: Double): String = js.native
  
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "setInternalSlot")
  @js.native
  ...
  @JSImport("@formatjs/ecma402-abstract/lib/utils", "setMultiInternalSlots")
  @js.native
