...
import typingsSlinky.forms.anon.ValidatePastFirstError
import typingsSlinky.forms.anon.WidgetParametersrowsnumbe
...
object mod {
  ...
  object validators {
    ...
    @js.native
    def regexp(regexp: js.RegExp): ValidatorFunction = js.native
    @JSImport("forms", "validators.regexp")
    @js.native
    def regexp(regexp: js.RegExp, errorMessage: String): ValidatorFunction = js.native
  ...
  object FieldParameters {
    ...
    implicit class FieldParametersMutableBuilder[Self <: FieldParameters] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCssClasses(value: typingsSlinky.forms.anon.Field): Self = StObject.set(x, "cssClasses", value.asInstanceOf[js.Any])
