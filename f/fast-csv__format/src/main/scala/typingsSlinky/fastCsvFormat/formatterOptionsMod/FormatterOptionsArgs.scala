package typingsSlinky.fastCsvFormat.formatterOptionsMod

import typingsSlinky.fastCsvFormat.typesMod.Row
import typingsSlinky.fastCsvFormat.typesMod.RowTransformCallback
...
object FormatterOptionsArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.fastCsvFormat.typesMod.Row */ I, /* <: typingsSlinky.fastCsvFormat.typesMod.Row */ O](): FormatterOptionsArgs[I, O] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormatterOptionsArgs[I, O]]
  }
  @scala.inline
  implicit class FormatterOptionsArgsOps[Self <: FormatterOptionsArgs[_, _], /* <: typingsSlinky.fastCsvFormat.typesMod.Row */ I, /* <: typingsSlinky.fastCsvFormat.typesMod.Row */ O] (val x: Self with (FormatterOptionsArgs[I, O])) extends AnyVal {
    @scala.inline
