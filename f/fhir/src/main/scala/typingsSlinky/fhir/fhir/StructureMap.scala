...
object StructureMap {
  ...
  @scala.inline
  implicit class StructureMapMutableBuilder[Self <: StructureMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroup(value: js.Array[StructureMapGroup]): Self = StObject.set(x, "group", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGroupVarargs(value: StructureMapGroup*): Self = StObject.set(x, "group", js.Array(value :_*))
    ...
    @scala.inline
    def setImport(value: js.Array[uri]): Self = StObject.set(x, "import", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setImportUndefined: Self = StObject.set(x, "import", js.undefined)
    
    @scala.inline
    def setImportVarargs(value: uri*): Self = StObject.set(x, "import", js.Array(value :_*))
    ...
    @scala.inline
    def setStructure(value: js.Array[StructureMapStructure]): Self = StObject.set(x, "structure", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStructureUndefined: Self = StObject.set(x, "structure", js.undefined)
    
    @scala.inline
    def setStructureVarargs(value: StructureMapStructure*): Self = StObject.set(x, "structure", js.Array(value :_*))
    ...
    @scala.inline
    def set_import(value: js.Array[Element]): Self = StObject.set(x, "_import", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_importUndefined: Self = StObject.set(x, "_import", js.undefined)
    
    @scala.inline
    def set_importVarargs(value: Element*): Self = StObject.set(x, "_import", js.Array(value :_*))
