...
trait ClaimResponseAddItem extends BackboneElement {
  ...
  /**
    * Added items details
    */
  var detail: js.UndefOr[js.Array[ClaimResponseAddItemDetail]] = js.native
  /**
...
object ClaimResponseAddItem {
  ...
  @scala.inline
  implicit class ClaimResponseAddItemOps[Self <: ClaimResponseAddItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDetailVarargs(value: ClaimResponseAddItemDetail*): Self = this.set("detail", js.Array(value :_*))
    @scala.inline
    def setDetail(value: js.Array[ClaimResponseAddItemDetail]): Self = this.set("detail", value.asInstanceOf[js.Any])
    @scala.inline
