...
object ExplanationOfBenefitBenefitBalance {
  ...
  implicit class ExplanationOfBenefitBenefitBalanceOps[Self <: ExplanationOfBenefitBenefitBalance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFinancialVarargs(value: ExplanationOfBenefitBenefitBalanceFinancial*): Self = this.set("financial", js.Array(value :_*))
    @scala.inline
    def setFinancial(value: js.Array[ExplanationOfBenefitBenefitBalanceFinancial]): Self = this.set("financial", value.asInstanceOf[js.Any])
    @scala.inline
