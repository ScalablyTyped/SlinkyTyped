...
object CompartmentDefinition {
  ...
  implicit class CompartmentDefinitionOps[Self <: CompartmentDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_search(value: Element): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_search")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def without_search: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_search")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withResource(value: js.Array[CompartmentDefinitionResource]): Self = {
        val ret = this.duplicate
