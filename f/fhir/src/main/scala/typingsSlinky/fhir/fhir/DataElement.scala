...
object DataElement {
  ...
  implicit class DataElementOps[Self <: DataElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_stringency(value: Element): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_stringency")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def without_stringency: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_stringency")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMapping(value: js.Array[DataElementMapping]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStringency(value: code): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stringency")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStringency: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stringency")(js.undefined)
        ret
    }
    @scala.inline
