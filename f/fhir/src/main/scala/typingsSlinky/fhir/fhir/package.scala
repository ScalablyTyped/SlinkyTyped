...
package object fhir {
  ...
  /**
    ...
    */
  type Age = typingsSlinky.fhir.fhir.Quantity
  
  /**
    * A measured or measurable amount
    */
  type Count = typingsSlinky.fhir.fhir.Quantity
  
  /**
    * A length - a value with a unit that is a physical distance
    */
  type Distance = typingsSlinky.fhir.fhir.Quantity
  
  /**
    * A length of time
    */
  type Duration = typingsSlinky.fhir.fhir.Quantity
  
  /**
    * An amount of economic utility in some recognized currency
    */
  type Money = typingsSlinky.fhir.fhir.Quantity
  
  /**
    * A fixed quantity (no comparator)
    */
  type SimpleQuantity = typingsSlinky.fhir.fhir.Quantity
