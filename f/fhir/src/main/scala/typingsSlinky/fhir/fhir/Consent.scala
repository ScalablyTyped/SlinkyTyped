...
- typingsSlinky.fhir.fhir.Resource because Already inherited */ trait Consent extends DomainResource {
  /**
  ...
  /**
    ...
    */
  var dateTime: js.UndefOr[typingsSlinky.fhir.fhir.dateTime] = js.undefined
  /**
