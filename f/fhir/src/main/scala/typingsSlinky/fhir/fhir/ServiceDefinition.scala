...
object ServiceDefinition {
  ...
  implicit class ServiceDefinitionOps[Self <: ServiceDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOperationDefinition(value: Reference): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("operationDefinition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOperationDefinition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("operationDefinition")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTrigger(value: js.Array[TriggerDefinition]): Self = {
        val ret = this.duplicate
