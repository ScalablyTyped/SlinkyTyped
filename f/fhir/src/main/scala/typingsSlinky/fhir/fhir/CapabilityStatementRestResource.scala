...
object CapabilityStatementRestResource {
  ...
  def apply(
    ...
    if (!js.isUndefined(conditionalCreate)) __obj.updateDynamic("conditionalCreate")(conditionalCreate.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(conditionalUpdate)) __obj.updateDynamic("conditionalUpdate")(conditionalUpdate.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(readHistory)) __obj.updateDynamic("readHistory")(readHistory.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(updateCreate)) __obj.updateDynamic("updateCreate")(updateCreate.get.asInstanceOf[js.Any])
