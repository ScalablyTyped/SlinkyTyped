...
object mod {
  ...
  object Severity extends StObject {
    ...
    /* "error" */ val Error: typingsSlinky.friendlyErrorsWebpackPlugin.mod.Severity.Error with String = js.native
    
    @js.native
    sealed trait Warning extends Severity
    /* "warning" */ val Warning: typingsSlinky.friendlyErrorsWebpackPlugin.mod.Severity.Warning with String = js.native
  }
