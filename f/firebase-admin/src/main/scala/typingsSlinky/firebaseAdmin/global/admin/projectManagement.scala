...
object projectManagement extends js.Object {
  ...
  object AppPlatform extends js.Object {
    /* "ANDROID" */ val ANDROID: typingsSlinky.firebaseAdmin.admin.projectManagement.AppPlatform.ANDROID with String = js.native
    /* "IOS" */ val IOS: typingsSlinky.firebaseAdmin.admin.projectManagement.AppPlatform.IOS with String = js.native
    /* "PLATFORM_UNKNOWN" */ val PLATFORM_UNKNOWN: typingsSlinky.firebaseAdmin.admin.projectManagement.AppPlatform.PLATFORM_UNKNOWN with String = js.native
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.firebaseAdmin.admin.projectManagement.AppPlatform with String] = js.native
  }
