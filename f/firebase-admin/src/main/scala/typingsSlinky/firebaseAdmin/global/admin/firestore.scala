...
object firestore extends js.Object {
  ...
  /**
    ...
    */
  def apply(): typingsSlinky.firebaseAdmin.admin.firestore.Firestore = js.native
  def apply(app: App): typingsSlinky.firebaseAdmin.admin.firestore.Firestore = js.native
