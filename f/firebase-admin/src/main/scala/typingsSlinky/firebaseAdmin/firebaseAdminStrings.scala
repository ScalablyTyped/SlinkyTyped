...
import typingsSlinky.firebaseAdmin.admin.database.EventType
import typingsSlinky.firebaseAdmin.admin.remoteConfig.TagColor
...
object firebaseAdminStrings {
  ...
  sealed trait BCRYPT
    extends HashAlgorithmType
       with typingsSlinky.firebaseAdmin.authMod.admin.auth.HashAlgorithmType
  ...
  sealed trait child_added
    extends EventType
       with typingsSlinky.firebaseAdmin.databaseMod.admin.database.EventType
