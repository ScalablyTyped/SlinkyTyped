...
trait Database extends js.Object {
  ...
  /**
    ...
    */
  def ref(): typingsSlinky.firebaseAdmin.admin.database.Reference = js.native
  def ref(path: String): typingsSlinky.firebaseAdmin.admin.database.Reference = js.native
  def ref(path: typingsSlinky.firebaseAdmin.admin.database.Reference): typingsSlinky.firebaseAdmin.admin.database.Reference = js.native
  /**
    * Returns a `Reference` representing the location in the Database
    ...
    */
  def refFromURL(url: String): typingsSlinky.firebaseAdmin.admin.database.Reference = js.native
  /**
