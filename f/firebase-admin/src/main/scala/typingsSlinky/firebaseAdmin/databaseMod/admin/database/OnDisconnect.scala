...
trait OnDisconnect extends js.Object {
  ...
  def setWithPriority(value: js.Any, priority: String, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  /**
  ...
  def setWithPriority(value: js.Any, priority: Double, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  def setWithPriority(value: js.Any, priority: Null, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  /**
  ...
  def update(values: js.Object, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
}
