...
trait DataSnapshot extends js.Object {
  var key: String | Null
  var ref: typingsSlinky.firebaseAdmin.admin.database.Reference
  /**
    ...
    */
  def child(path: String): typingsSlinky.firebaseAdmin.admin.database.DataSnapshot
  /**
...
object DataSnapshot {
  @scala.inline
  def apply(
    child: String => typingsSlinky.firebaseAdmin.admin.database.DataSnapshot,
    exists: () => Boolean,
    exportVal: () => js.Any,
    ...
    hasChildren: () => Boolean,
    numChildren: () => Double,
    ref: typingsSlinky.firebaseAdmin.admin.database.Reference,
