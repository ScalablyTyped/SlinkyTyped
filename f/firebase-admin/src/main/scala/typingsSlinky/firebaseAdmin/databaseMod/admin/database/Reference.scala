...
@js.native
trait Reference
  extends typingsSlinky.firebaseAdmin.admin.database.Query {
  /**
  ...
  /**
    ...
    * ```
    */
  var parent: typingsSlinky.firebaseAdmin.admin.database.Reference | Null = js.native
  ...
  /**
    ...
    * ```
    */
  var root: typingsSlinky.firebaseAdmin.admin.database.Reference = js.native
  /**
    ...
    */
  def child(path: String): typingsSlinky.firebaseAdmin.admin.database.Reference = js.native
  /**
    ...
    */
  def onDisconnect(): typingsSlinky.firebaseAdmin.admin.database.OnDisconnect = js.native
  /**
    ...
    */
  def push(): typingsSlinky.firebaseAdmin.admin.database.ThenableReference = js.native
  def push(value: js.Any): typingsSlinky.firebaseAdmin.admin.database.ThenableReference = js.native
  def push(value: js.Any, onComplete: js.Function1[/* a */ js.Error | Null, _]): typingsSlinky.firebaseAdmin.admin.database.ThenableReference = js.native
  /**
  ...
  def transaction(
    ...
    onComplete: js.Function3[
      /* a */ js.Error | Null, 
      /* b */ Boolean, 
      /* c */ typingsSlinky.firebaseAdmin.admin.database.DataSnapshot | Null, 
      _
    ]
