...
import typingsSlinky.firebaseAdmin.anon.Force
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.ADMIN_SDK_NODE
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.CONSOLE
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.FORCED_UPDATE
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.INCREMENTAL_UPDATE
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.REMOTE_CONFIG_UPDATE_ORIGIN_UNSPECIFIED
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.REMOTE_CONFIG_UPDATE_TYPE_UNSPECIFIED
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.REST_API
import typingsSlinky.firebaseAdmin.firebaseAdminStrings.ROLLBACK
  ...
  object remoteConfig {
    ...
    trait ListVersionsOptions extends StObject {
      ...
      /**
        ...
        */
      var endTime: js.UndefOr[js.Date | String] = js.native
      ...
      /**
        ...
        * time are omitted.
        */
      var startTime: js.UndefOr[js.Date | String] = js.native
    }
    object ListVersionsOptions {
      ...
      implicit class ListVersionsOptionsMutableBuilder[Self <: ListVersionsOptions] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setEndTime(value: js.Date | String): Self = StObject.set(x, "endTime", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setStartTime(value: js.Date | String): Self = StObject.set(x, "startTime", value.asInstanceOf[js.Any])
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.firebaseAdmin.remoteConfigMod.remoteConfig.ExplicitParameterValue
      - typingsSlinky.firebaseAdmin.remoteConfigMod.remoteConfig.InAppDefaultValue
    */
    trait RemoteConfigParameterValue extends StObject
    object RemoteConfigParameterValue {
      
      @scala.inline
      def ExplicitParameterValue(value: String): typingsSlinky.firebaseAdmin.remoteConfigMod.remoteConfig.ExplicitParameterValue = {
        val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.firebaseAdmin.remoteConfigMod.remoteConfig.ExplicitParameterValue]
      }
      
      @scala.inline
      def InAppDefaultValue(useInAppDefault: Boolean): typingsSlinky.firebaseAdmin.remoteConfigMod.remoteConfig.InAppDefaultValue = {
        val __obj = js.Dynamic.literal(useInAppDefault = useInAppDefault.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.firebaseAdmin.remoteConfigMod.remoteConfig.InAppDefaultValue]
      }
    }
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.BLUE
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.BROWN
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.CYAN
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.DEEP_ORANGE
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.GREEN
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.INDIGO
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.LIME
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.ORANGE
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.PINK
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.PURPLE
      - typingsSlinky.firebaseAdmin.firebaseAdminStrings.TEAL
    */
    trait TagColor extends StObject
    object TagColor {
      
      @scala.inline
      def BLUE: typingsSlinky.firebaseAdmin.firebaseAdminStrings.BLUE = "BLUE".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.BLUE]
      
      @scala.inline
      def BROWN: typingsSlinky.firebaseAdmin.firebaseAdminStrings.BROWN = "BROWN".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.BROWN]
      
      @scala.inline
      def CYAN: typingsSlinky.firebaseAdmin.firebaseAdminStrings.CYAN = "CYAN".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.CYAN]
      
      @scala.inline
      def DEEP_ORANGE: typingsSlinky.firebaseAdmin.firebaseAdminStrings.DEEP_ORANGE = "DEEP_ORANGE".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.DEEP_ORANGE]
      
      @scala.inline
      def GREEN: typingsSlinky.firebaseAdmin.firebaseAdminStrings.GREEN = "GREEN".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.GREEN]
      
      @scala.inline
      def INDIGO: typingsSlinky.firebaseAdmin.firebaseAdminStrings.INDIGO = "INDIGO".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.INDIGO]
      
      @scala.inline
      def LIME: typingsSlinky.firebaseAdmin.firebaseAdminStrings.LIME = "LIME".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.LIME]
      
      @scala.inline
      def ORANGE: typingsSlinky.firebaseAdmin.firebaseAdminStrings.ORANGE = "ORANGE".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.ORANGE]
      
      @scala.inline
      def PINK: typingsSlinky.firebaseAdmin.firebaseAdminStrings.PINK = "PINK".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.PINK]
      
      @scala.inline
      def PURPLE: typingsSlinky.firebaseAdmin.firebaseAdminStrings.PURPLE = "PURPLE".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.PURPLE]
      
      @scala.inline
      def TEAL: typingsSlinky.firebaseAdmin.firebaseAdminStrings.TEAL = "TEAL".asInstanceOf[typingsSlinky.firebaseAdmin.firebaseAdminStrings.TEAL]
    }
