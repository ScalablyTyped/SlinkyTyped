...
trait TenantManager extends js.Object {
  /**
    ...
    */
  def authForTenant(tenantId: String): typingsSlinky.firebaseAdmin.authMod.admin.auth.TenantAwareAuth = js.native
  /**
    ...
    *   created tenant.
    */
  def createTenant(tenantOptions: typingsSlinky.firebaseAdmin.authMod.admin.auth.CreateTenantRequest): js.Promise[typingsSlinky.firebaseAdmin.authMod.admin.auth.Tenant] = js.native
  /**
  ...
  /**
    ...
    */
  def getTenant(tenantId: String): js.Promise[typingsSlinky.firebaseAdmin.authMod.admin.auth.Tenant] = js.native
  /**
    ...
    */
  def listTenants(): js.Promise[typingsSlinky.firebaseAdmin.authMod.admin.auth.ListTenantsResult] = js.native
  def listTenants(maxResults: Double): js.Promise[typingsSlinky.firebaseAdmin.authMod.admin.auth.ListTenantsResult] = js.native
  def listTenants(maxResults: Double, pageToken: String): js.Promise[typingsSlinky.firebaseAdmin.authMod.admin.auth.ListTenantsResult] = js.native
  /**
  ...
  def updateTenant(
    tenantId: String,
    tenantOptions: typingsSlinky.firebaseAdmin.authMod.admin.auth.UpdateTenantRequest
  ): js.Promise[typingsSlinky.firebaseAdmin.authMod.admin.auth.Tenant] = js.native
}
