...
trait WebpushConfig extends js.Object {
  ...
  /**
    ...
    */
  var fcmOptions: js.UndefOr[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.WebpushFcmOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var notification: js.UndefOr[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.WebpushNotification] = js.undefined
}
...
object WebpushConfig {
  ...
  def apply(
    ...
    fcmOptions: typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.WebpushFcmOptions = null,
    headers: StringDictionary[String] = null,
    notification: typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.WebpushNotification = null
  ): WebpushConfig = {
