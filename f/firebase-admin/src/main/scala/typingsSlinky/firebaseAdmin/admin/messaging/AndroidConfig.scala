...
trait AndroidConfig extends js.Object {
  ...
  /**
    ...
    */
  var fcmOptions: js.UndefOr[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.AndroidFcmOptions] = js.undefined
  /**
    * Android notification to be included in the message.
    */
  var notification: js.UndefOr[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.AndroidNotification] = js.undefined
  /**
...
object AndroidConfig {
  ...
  def apply(
    ...
    fcmOptions: typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.AndroidFcmOptions = null,
    notification: typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.AndroidNotification = null,
