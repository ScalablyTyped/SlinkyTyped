...
trait BatchResponse extends js.Object {
  ...
  /**
    ...
    */
  var responses: js.Array[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.SendResponse]
  /**
...
object BatchResponse {
  ...
  def apply(
    failureCount: Double,
    responses: js.Array[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.SendResponse],
    successCount: Double
  ): BatchResponse = {
