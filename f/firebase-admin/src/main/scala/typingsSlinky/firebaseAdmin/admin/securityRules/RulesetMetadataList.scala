...
trait RulesetMetadataList extends js.Object {
  ...
  /**
    ...
    */
  val rulesets: js.Array[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadata]
}

object RulesetMetadataList {
  @scala.inline
  def apply(
    rulesets: js.Array[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadata],
