...
trait AppMetadata extends js.Object {
  ...
  /**
    ...
    * ```
    */
  var platform: typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AppPlatform
  /**
...
object AppMetadata {
  ...
  def apply(
    appId: String,
    platform: typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AppPlatform,
    projectId: String,
    resourceName: String,
