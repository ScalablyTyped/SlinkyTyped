...
trait UpdateRequest extends js.Object {
  ...
  /**
    ...
    */
  var multiFactor: js.UndefOr[typingsSlinky.firebaseAdmin.authMod.admin.auth.MultiFactorUpdateSettings] = js.undefined
  /**
...
object UpdateRequest {
  ...
  def apply(
    ...
    multiFactor: typingsSlinky.firebaseAdmin.authMod.admin.auth.MultiFactorUpdateSettings = null,
