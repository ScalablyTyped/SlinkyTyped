...
import typingsSlinky.firebaseAdmin.authMod.admin.auth.MultiFactorSettings
...
trait UserRecord extends js.Object {
  ...
  /**
    ...
    */
  var metadata: typingsSlinky.firebaseAdmin.authMod.admin.auth.UserMetadata
  /**
  ...
  /**
    ...
    */
  var providerData: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.UserInfo]
  /**
...
object UserRecord {
  ...
  def apply(
    ...
    metadata: typingsSlinky.firebaseAdmin.authMod.admin.auth.UserMetadata,
    providerData: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.UserInfo],
    toJSON: () => js.Object,
    uid: String,
