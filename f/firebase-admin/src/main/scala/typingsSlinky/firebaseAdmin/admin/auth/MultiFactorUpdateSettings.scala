...
trait MultiFactorUpdateSettings extends js.Object {
  /**
    ...
    */
  var enrolledFactors: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.UpdateMultiFactorInfoRequest] | Null
}

object MultiFactorUpdateSettings {
  @scala.inline
  def apply(
    enrolledFactors: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.UpdateMultiFactorInfoRequest] = null
