...
trait Aps
  ...
  /**
    ...
    */
  var alert: js.UndefOr[String | typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.ApsAlert] = js.undefined
  /**
  ...
  /**
    ...
    */
  var sound: js.UndefOr[String | typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.CriticalSound] = js.undefined
  /**
...
object Aps {
  ...
  def apply(
    ...
    alert: String | typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.ApsAlert = null,
    ...
    sound: String | typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.CriticalSound = null,
