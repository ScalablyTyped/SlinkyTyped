...
trait ListTenantsResult extends js.Object {
  ...
  /**
    ...
    */
  var tenants: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.Tenant]
}

object ListTenantsResult {
  @scala.inline
  def apply(tenants: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.Tenant], pageToken: String = null): ListTenantsResult = {
