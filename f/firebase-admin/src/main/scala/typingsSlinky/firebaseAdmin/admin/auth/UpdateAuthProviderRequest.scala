...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.firebaseAdmin.authMod.admin.auth.SAMLUpdateAuthProviderRequest
  - typingsSlinky.firebaseAdmin.authMod.admin.auth.OIDCUpdateAuthProviderRequest
*/
