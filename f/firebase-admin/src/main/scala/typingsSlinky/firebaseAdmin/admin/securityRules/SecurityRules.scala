...
trait SecurityRules extends js.Object {
  ...
  /**
    ...
    */
  def createRulesFileFromSource(name: String, source: String): typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesFile = js.native
  def createRulesFileFromSource(name: String, source: Buffer): typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesFile = js.native
  /**
    ...
    */
  def createRuleset(file: typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesFile): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  /**
  ...
  /**
    ...
    */
  def getFirestoreRuleset(): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  /**
    ...
    */
  def getRuleset(name: String): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  /**
    ...
    */
  def getStorageRuleset(): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  def getStorageRuleset(bucket: String): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  /**
    ...
    */
  def listRulesetMetadata(): js.Promise[
    typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadataList
  ] = js.native
  def listRulesetMetadata(pageSize: Double): js.Promise[
    typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadataList
  ] = js.native
  def listRulesetMetadata(pageSize: Double, nextPageToken: String): js.Promise[
    typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadataList
  ] = js.native
  /**
  ...
  def releaseFirestoreRuleset(ruleset: typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadata): js.Promise[Unit] = js.native
  /**
    * Creates a new {@link admin.securityRules.Ruleset `Ruleset`} from the given
    ...
    */
  def releaseFirestoreRulesetFromSource(source: String): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  def releaseFirestoreRulesetFromSource(source: Buffer): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  /**
    * Applies the specified {@link admin.securityRules.Ruleset `Ruleset`} ruleset
  ...
  def releaseStorageRuleset(ruleset: typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadata): js.Promise[Unit] = js.native
  def releaseStorageRuleset(
    ruleset: typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.RulesetMetadata,
    bucket: String
  ...
  /**
    ...
    * @return A promise that fulfills when the ruleset is created and released.
    */
  def releaseStorageRulesetFromSource(source: String): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  def releaseStorageRulesetFromSource(source: String, bucket: String): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  def releaseStorageRulesetFromSource(source: Buffer): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
  def releaseStorageRulesetFromSource(source: Buffer, bucket: String): js.Promise[typingsSlinky.firebaseAdmin.securityRulesMod.admin.securityRules.Ruleset] = js.native
}
