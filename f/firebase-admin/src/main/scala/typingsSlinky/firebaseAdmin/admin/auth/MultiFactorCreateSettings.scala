...
trait MultiFactorCreateSettings extends js.Object {
  /**
    ...
    */
  var enrolledFactors: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.CreateMultiFactorInfoRequest]
}

object MultiFactorCreateSettings {
  @scala.inline
  def apply(
    enrolledFactors: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.CreateMultiFactorInfoRequest]
