...
trait AndroidApp extends js.Object {
  ...
  def addShaCertificate(
    certificateToAdd: typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.ShaCertificate
  ): js.Promise[Unit]
  /**
  ...
  def deleteShaCertificate(
    certificateToRemove: typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.ShaCertificate
  ): js.Promise[Unit]
  /**
  ...
  def getMetadata(): js.Promise[
    typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AndroidAppMetadata
  ]
  /**
  ...
  def getShaCertificates(): js.Promise[
    js.Array[
      typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.ShaCertificate
    ]
  ]
  /**
...
object AndroidApp {
  @scala.inline
  def apply(
    addShaCertificate: typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.ShaCertificate => js.Promise[Unit],
    appId: String,
    deleteShaCertificate: typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.ShaCertificate => js.Promise[Unit],
