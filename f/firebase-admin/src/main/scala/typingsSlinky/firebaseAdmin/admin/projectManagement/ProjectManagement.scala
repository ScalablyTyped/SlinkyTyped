...
trait ProjectManagement extends js.Object {
  ...
  /**
    ...
    */
  def androidApp(appId: String): typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AndroidApp = js.native
  /**
    ...
    */
  def createAndroidApp(packageName: String): js.Promise[
    typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AndroidApp
  ] = js.native
  def createAndroidApp(packageName: String, displayName: String): js.Promise[
    typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AndroidApp
  ] = js.native
  /**
    ...
    */
  def createIosApp(bundleId: String): js.Promise[typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.IosApp] = js.native
  def createIosApp(bundleId: String, displayName: String): js.Promise[typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.IosApp] = js.native
  /**
    ...
    */
  def iosApp(appId: String): typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.IosApp = js.native
  /**
  ...
  def listAppMetadata(): js.Promise[
    js.Array[
      typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.AppMetadata
    ]
  ] = js.native
  /**
  ...
  def listIosApps(): js.Promise[
    js.Array[typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.IosApp]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  def shaCertificate(shaHash: String): typingsSlinky.firebaseAdmin.projectManagementMod.admin.projectManagement.ShaCertificate = js.native
}
