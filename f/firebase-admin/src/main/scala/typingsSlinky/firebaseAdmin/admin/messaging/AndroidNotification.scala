...
trait AndroidNotification extends js.Object {
  ...
  /**
    ...
    */
  var lightSettings: js.UndefOr[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.LightSettings] = js.undefined
  /**
...
object AndroidNotification {
  ...
  def apply(
    ...
    eventTimestamp: js.Date = null,
    icon: String = null,
    imageUrl: String = null,
    lightSettings: typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.LightSettings = null,
