...
trait ListProviderConfigResults extends js.Object {
  ...
  /**
    ...
    */
  var providerConfigs: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.AuthProviderConfig]
}

object ListProviderConfigResults {
  @scala.inline
  def apply(
    providerConfigs: js.Array[typingsSlinky.firebaseAdmin.authMod.admin.auth.AuthProviderConfig],
