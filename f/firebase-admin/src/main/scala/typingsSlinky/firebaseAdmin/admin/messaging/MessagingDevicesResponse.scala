...
trait MessagingDevicesResponse extends js.Object {
  ...
  /**
    ...
    */
  var results: js.Array[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.MessagingDeviceResult]
  /**
...
object MessagingDevicesResponse {
  ...
  def apply(
    ...
    failureCount: Double,
    multicastId: Double,
    results: js.Array[typingsSlinky.firebaseAdmin.messagingMod.admin.messaging.MessagingDeviceResult],
    successCount: Double
