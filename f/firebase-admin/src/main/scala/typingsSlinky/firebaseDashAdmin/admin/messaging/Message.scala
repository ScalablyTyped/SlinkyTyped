package typingsSlinky.firebaseDashAdmin.admin.messaging
...
/* Rewritten from type alias, can be one of: 
  - typings.firebaseDashAdmin.TokenMessage
  - typings.firebaseDashAdmin.TopicMessage
  - typings.firebaseDashAdmin.ConditionMessage
*/
