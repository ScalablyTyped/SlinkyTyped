...
import typingsSlinky.firebaseDashAdmin.Anon_Committed
...
trait Reference extends Query {
  ...
  /**
    ...
    * @return
    */
  def setPriority(priority: String, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  def setPriority(priority: Double, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  def setPriority(priority: Null, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any): js.Promise[Unit] = js.native
  /**
    ...
    * @return
    */
  def setWithPriority(newVal: js.Any, newPriority: String): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: String, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: Double): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: Double, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  def setWithPriority(newVal: js.Any, newPriority: Null, onComplete: js.Function1[/* a */ js.Error | Null, _]): js.Promise[Unit] = js.native
  /**
    ...
    */
  def transaction(transactionUpdate: js.Function1[/* a */ js.Any, _]): js.Promise[Anon_Committed] = js.native
  def transaction(
    transactionUpdate: js.Function1[/* a */ js.Any, _],
    onComplete: js.Function3[/* a */ js.Error | Null, /* b */ Boolean, /* c */ DataSnapshot | Null, _]
  ): js.Promise[Anon_Committed] = js.native
  def transaction(
    transactionUpdate: js.Function1[/* a */ js.Any, _],
    onComplete: js.Function3[/* a */ js.Error | Null, /* b */ Boolean, /* c */ DataSnapshot | Null, _],
