...
import typingsSlinky.atFormatjsIntlDashRelativetimeformat.atFormatjsIntlDashRelativetimeformatStrings.localeMatcher
import typingsSlinky.atFormatjsIntlDashRelativetimeformat.libCoreMod.IntlRelativeTimeFormatOptions
import typingsSlinky.atFormatjsIntlDashUtils.distRelativeDashTimeDashTypesMod.RelativeTimeLocaleData
import typingsSlinky.atFormatjsIntlDashUtils.distRelativeDashTimeDashTypesMod.UnpackedLocaleFieldsData
...
object libLocalesMod extends js.Object {
  @js.native
  class default ()
    extends typingsSlinky.atFormatjsIntlDashRelativetimeformat.libCoreMod.default {
