...
import typingsSlinky.formatjsIntlRelativetimeformat.coreMod.IntlRelativeTimeFormatOptions
...
@JSImport("@formatjs/intl-relativetimeformat/lib", JSImport.Namespace)
@js.native
object libMod extends js.Object {
  @js.native
  class default ()
    extends typingsSlinky.formatjsIntlRelativetimeformat.coreMod.default {
