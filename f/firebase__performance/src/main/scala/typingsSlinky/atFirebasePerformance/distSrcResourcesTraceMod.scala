...
import typingsSlinky.atFirebasePerformanceDashTypes.atFirebasePerformanceDashTypesMod.PerformanceTrace
...
@js.native
object distSrcResourcesTraceMod extends js.Object {
  @js.native
