...
object attributesUtilsMod {
  ...
  object VisibilityState extends StObject {
    ...
    /* 2 */ val HIDDEN: typingsSlinky.firebasePerformance.attributesUtilsMod.VisibilityState.HIDDEN with Double = js.native
    
    @js.native
    sealed trait UNKNOWN extends VisibilityState
    /* 0 */ val UNKNOWN: typingsSlinky.firebasePerformance.attributesUtilsMod.VisibilityState.UNKNOWN with Double = js.native
    
    @js.native
    sealed trait VISIBLE extends VisibilityState
    /* 1 */ val VISIBLE: typingsSlinky.firebasePerformance.attributesUtilsMod.VisibilityState.VISIBLE with Double = js.native
  }
