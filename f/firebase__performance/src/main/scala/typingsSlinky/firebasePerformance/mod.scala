...
object mod {
  ...
  object firebaseAppTypesAugmentingMod {
    ...
    object FirebaseNamespace {
      ...
      @scala.inline
      def apply(): typingsSlinky.firebasePerformance.mod.firebaseAppTypesAugmentingMod.FirebaseNamespace = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.firebasePerformance.mod.firebaseAppTypesAugmentingMod.FirebaseNamespace]
      }
      
      @scala.inline
      implicit class FirebaseNamespaceMutableBuilder[Self <: typingsSlinky.firebasePerformance.mod.firebaseAppTypesAugmentingMod.FirebaseNamespace] (val x: Self) extends AnyVal {
