...
object IDOMElementOptions {
  ...
  implicit class IDOMElementOptionsOps[Self <: IDOMElementOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCutout(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cutout")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCutout: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cutout")(js.undefined)
        ret
    }
    @scala.inline
