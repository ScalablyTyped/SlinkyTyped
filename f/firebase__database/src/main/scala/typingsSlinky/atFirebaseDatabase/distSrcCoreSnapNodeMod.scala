...
@js.native
object distSrcCoreSnapNodeMod extends js.Object {
  @js.native
  class NamedNode protected () extends js.Object {
    def this(name: String, node: Node) = this()
    var MAX: typingsSlinky.atFirebaseDatabase.distSrcCoreSnapChildrenNodeMod.distSrcCoreSnapNodeMod.NamedNode = js.native
    var MIN: typingsSlinky.atFirebaseDatabase.distSrcCoreSnapChildrenNodeMod.distSrcCoreSnapNodeMod.NamedNode = js.native
