...
import typingsSlinky.atFirebaseDatabase.atFirebaseDatabaseStrings.`[MAX_NAME]`
import typingsSlinky.atFirebaseDatabase.atFirebaseDatabaseStrings.`[MIN_NAME]`
...
object distSrcCoreUtilUtilMod extends js.Object {
  ...
  def callUserCallback(callback: js.Function, var_args: js.Any*): Unit = js.native
  ...
  def error(var_args: String*): Unit = js.native
  def errorForServerCode(code: String, query: Query): js.Error = js.native
  ...
  def fatal(var_args: String*): scala.Nothing = js.native
  ...
  def log(var_args: String*): Unit = js.native
