...
import typingsSlinky.atFirebaseDatabase.distSrcCoreRepoManagerMod.RepoManager
...
@js.native
object distSrcCoreRepoManagerMod extends js.Object {
  @js.native
  class RepoManager () extends js.Object {
    ...
    /**
      ...
      */
    def createRepo(repoInfo: RepoInfo, app: FirebaseApp): Repo = js.native
    /**
      ...
      * @return {!Database}
      */
    def databaseFromApp(app: FirebaseApp): Database = js.native
    def databaseFromApp(app: FirebaseApp, url: String): Database = js.native
    /**
