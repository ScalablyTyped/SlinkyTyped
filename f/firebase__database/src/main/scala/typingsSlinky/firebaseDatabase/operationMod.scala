...
object operationMod {
  ...
  object OperationType extends StObject {
    ...
    /* 2 */ val ACK_USER_WRITE: typingsSlinky.firebaseDatabase.operationMod.OperationType.ACK_USER_WRITE with Double = js.native
    
    @js.native
    sealed trait LISTEN_COMPLETE extends OperationType
    /* 3 */ val LISTEN_COMPLETE: typingsSlinky.firebaseDatabase.operationMod.OperationType.LISTEN_COMPLETE with Double = js.native
    
    @js.native
    sealed trait MERGE extends OperationType
    /* 1 */ val MERGE: typingsSlinky.firebaseDatabase.operationMod.OperationType.MERGE with Double = js.native
    
    @js.native
    sealed trait OVERWRITE extends OperationType
    /* 0 */ val OVERWRITE: typingsSlinky.firebaseDatabase.operationMod.OperationType.OVERWRITE with Double = js.native
  }
