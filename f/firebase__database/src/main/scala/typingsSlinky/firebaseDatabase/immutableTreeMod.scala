...
object immutableTreeMod {
  ...
  class ImmutableTree[T] () extends StObject {
    ...
    /**
      ...
      */
    def findRootMostMatchingPathAndValue(relativePath: Path, predicate: js.Function1[/* a */ T, Boolean]): typingsSlinky.firebaseDatabase.anon.Path[T] | Null = js.native
    ...
    /**
      ...
      * @return {?{path: !Path, value: !T}}
      */
    def findRootMostValueAndPath(relativePath: Path): typingsSlinky.firebaseDatabase.anon.Path[T] | Null = js.native
