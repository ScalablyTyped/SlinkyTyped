...
object childrenNodeMod {
  ...
  object firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod {
    ...
    object NamedNode {
      ...
      @scala.inline
      def apply(
        MAX: typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode,
        MIN: typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
      ): typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = {
        val __obj = js.Dynamic.literal(MAX = MAX.asInstanceOf[js.Any], MIN = MIN.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode]
      }
      
      @scala.inline
      implicit class NamedNodeMutableBuilder[Self <: typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setMAX(
          value: typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode
