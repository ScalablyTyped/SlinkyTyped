...
import typingsSlinky.firebaseDatabase.anon.Call
...
object mod {
  ...
  class OnDisconnect protected ()
    extends typingsSlinky.firebaseDatabase.onDisconnectMod.OnDisconnect {
    /**
      * @param {!Repo} repo_
      * @param {!Path} path_
      */
  ...
  object firebaseAppTypesAugmentingMod {
    ...
    object FirebaseNamespace {
      ...
      @scala.inline
      def apply(): typingsSlinky.firebaseDatabase.mod.firebaseAppTypesAugmentingMod.FirebaseNamespace = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.firebaseDatabase.mod.firebaseAppTypesAugmentingMod.FirebaseNamespace]
      }
      
      @scala.inline
      implicit class FirebaseNamespaceMutableBuilder[Self <: typingsSlinky.firebaseDatabase.mod.firebaseAppTypesAugmentingMod.FirebaseNamespace] (val x: Self) extends AnyVal {
