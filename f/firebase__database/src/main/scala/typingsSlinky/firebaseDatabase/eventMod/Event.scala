...
object Event {
  ...
  implicit class EventOps[Self <: Event] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetEventRunner(value: () => js.Function0[Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getEventRunner")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetEventType(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getEventType")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetPath(value: () => Path): Self = {
        val ret = this.duplicate
