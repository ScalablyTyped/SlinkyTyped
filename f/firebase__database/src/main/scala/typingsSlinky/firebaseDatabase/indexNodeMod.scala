...
object indexNodeMod {
  ...
  object firebaseAppTypesAugmentingMod {
    ...
    object FirebaseApp {
      ...
      @scala.inline
      def apply(): typingsSlinky.firebaseDatabase.indexNodeMod.firebaseAppTypesAugmentingMod.FirebaseApp = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.firebaseDatabase.indexNodeMod.firebaseAppTypesAugmentingMod.FirebaseApp]
      }
      
      @scala.inline
      implicit class FirebaseAppMutableBuilder[Self <: typingsSlinky.firebaseDatabase.indexNodeMod.firebaseAppTypesAugmentingMod.FirebaseApp] (val x: Self) extends AnyVal {
    ...
    trait FirebaseNamespace extends StObject {
      ...
      var database: js.UndefOr[typingsSlinky.firebaseDatabase.anon.Database] = js.native
    }
    object FirebaseNamespace {
      
      @scala.inline
      def apply(): typingsSlinky.firebaseDatabase.indexNodeMod.firebaseAppTypesAugmentingMod.FirebaseNamespace = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.firebaseDatabase.indexNodeMod.firebaseAppTypesAugmentingMod.FirebaseNamespace]
      }
      
      @scala.inline
      implicit class FirebaseNamespaceMutableBuilder[Self <: typingsSlinky.firebaseDatabase.indexNodeMod.firebaseAppTypesAugmentingMod.FirebaseNamespace] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setDatabase(value: typingsSlinky.firebaseDatabase.anon.Database): Self = StObject.set(x, "database", value.asInstanceOf[js.Any])
