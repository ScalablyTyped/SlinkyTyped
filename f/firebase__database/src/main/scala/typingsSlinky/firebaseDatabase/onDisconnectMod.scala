...
object onDisconnectMod extends js.Object {
  ...
  class OnDisconnect protected () extends js.Object {
    ...
    def set(value: js.Any, onComplete: js.Function1[/* a */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
    ...
    def setWithPriority(value: js.Any, priority: String, onComplete: js.Function1[/* a */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
    /**
      * @param {*} value
    ...
    def setWithPriority(value: js.Any, priority: Double, onComplete: js.Function1[/* a */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
    def setWithPriority(value: js.Any, priority: Null, onComplete: js.Function1[/* a */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
    /**
    ...
    def update(objectToMerge: Indexable, onComplete: js.Function1[/* a */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
  }
