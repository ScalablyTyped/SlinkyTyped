...
object nodeMod extends js.Object {
  ...
  class NamedNode protected () extends js.Object {
    ...
    var MAX: typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
    
    var MIN: typingsSlinky.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
