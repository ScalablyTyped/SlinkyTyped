...
object RowValidationResult {
  @scala.inline
  def apply[/* <: typingsSlinky.fastCsvParse.typesMod.Row[_] */ R](isValid: Boolean): RowValidationResult[R] = {
    val __obj = js.Dynamic.literal(isValid = isValid.asInstanceOf[js.Any])
    __obj.asInstanceOf[RowValidationResult[R]]
  }
  @scala.inline
  implicit class RowValidationResultOps[Self <: RowValidationResult[_], /* <: typingsSlinky.fastCsvParse.typesMod.Row[_] */ R] (val x: Self with RowValidationResult[R]) extends AnyVal {
    @scala.inline
