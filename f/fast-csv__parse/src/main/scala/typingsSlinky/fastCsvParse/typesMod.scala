...
object typesMod {
  ...
  type RowTransformCallback[R /* <: Row[_] */] = js.Function2[/* error */ js.UndefOr[js.Error | Null], /* row */ js.UndefOr[R], Unit]
  ...
  type RowValidatorCallback[R /* <: Row[_] */] = js.Function2[/* error */ js.Error | Null, /* result */ js.UndefOr[RowValidationResult[R]], Unit]
