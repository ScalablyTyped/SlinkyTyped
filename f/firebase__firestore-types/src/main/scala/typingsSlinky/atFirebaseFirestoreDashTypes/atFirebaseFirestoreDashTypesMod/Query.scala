...
import typingsSlinky.atFirebaseFirestoreDashTypes.Anon_CompleteErrorNextSnapshot
...
class Query[T] protected () extends js.Object {
  ...
  def onSnapshot(observer: Anon_CompleteErrorNextSnapshot[T]): js.Function0[Unit] = js.native
  ...
  def onSnapshot(options: SnapshotListenOptions, observer: Anon_CompleteErrorNextSnapshot[T]): js.Function0[Unit] = js.native
