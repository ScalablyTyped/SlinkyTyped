...
import typingsSlinky.firebaseFirestoreTypes.mod.QuerySnapshot
...
object AnonCompleteError {
  @scala.inline
  def apply[T](): AnonCompleteError[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCompleteError[T]]
  }
  @scala.inline
  implicit class AnonCompleteErrorOps[Self[t] <: AnonCompleteError[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
