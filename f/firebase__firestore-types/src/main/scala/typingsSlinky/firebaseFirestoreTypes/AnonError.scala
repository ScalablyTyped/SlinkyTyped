...
import typingsSlinky.firebaseFirestoreTypes.mod.DocumentSnapshot
...
object AnonError {
  @scala.inline
  def apply[T](): AnonError[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonError[T]]
  }
  @scala.inline
  implicit class AnonErrorOps[Self[t] <: AnonError[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
