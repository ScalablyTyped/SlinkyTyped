...
import typingsSlinky.atFirebaseRemoteDashConfig.atFirebaseRemoteDashConfigNumbers.`0DOT5`
...
@js.native
object distSrcClientExponentialUnderscoreBackoffMod extends js.Object {
  val MAX_VALUE_MILLIS: Double = js.native
  val RANDOM_FACTOR: `0DOT5` = js.native
