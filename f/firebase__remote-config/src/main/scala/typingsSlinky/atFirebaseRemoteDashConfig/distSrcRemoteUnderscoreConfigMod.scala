...
import typingsSlinky.atFirebaseLogger.atFirebaseLoggerMod.Logger
...
import typingsSlinky.atFirebaseRemoteDashConfig.distSrcStorageStorageUnderscoreCacheMod.StorageCache
...
import typingsSlinky.atFirebaseRemoteDashConfigDashTypes.atFirebaseRemoteDashConfigDashTypesMod.Settings
import typingsSlinky.atFirebaseRemoteDashConfigDashTypes.atFirebaseRemoteDashConfigDashTypesMod.Value
...
object distSrcRemoteUnderscoreConfigMod extends js.Object {
  ...
  class RemoteConfig protected ()
    extends typingsSlinky.atFirebaseRemoteDashConfigDashTypes.atFirebaseRemoteDashConfigDashTypesMod.RemoteConfig {
    def this(
      app: FirebaseApp,
