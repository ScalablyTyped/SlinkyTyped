package typingsSlinky.firebaseRemoteConfig.mod.global
...
object Window {
  ...
  implicit class WindowOps[Self <: Window] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFIREBASE_REMOTE_CONFIG_URL_BASE(value: String): Self = this.set("FIREBASE_REMOTE_CONFIG_URL_BASE", value.asInstanceOf[js.Any])
  }
}
