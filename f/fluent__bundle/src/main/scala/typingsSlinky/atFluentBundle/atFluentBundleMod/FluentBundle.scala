package typingsSlinky.atFluentBundle.atFluentBundleMod
...
class FluentBundle protected () extends js.Object {
  ...
  def formatPattern(pattern: String, args: js.Object, errors: js.Array[js.Error]): String = js.native
  def formatPattern(pattern: Pattern): String = js.native
  def formatPattern(pattern: Pattern, args: js.Object): String = js.native
  def formatPattern(pattern: Pattern, args: js.Object, errors: js.Array[js.Error]): String = js.native
