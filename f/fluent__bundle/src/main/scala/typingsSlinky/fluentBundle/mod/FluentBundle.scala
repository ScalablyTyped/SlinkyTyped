...
class FluentBundle protected () extends js.Object {
  ...
  def formatPattern(pattern: String, args: js.UndefOr[scala.Nothing], errors: js.Array[js.Error]): String = js.native
  ...
  def formatPattern(pattern: Pattern, args: js.UndefOr[scala.Nothing], errors: js.Array[js.Error]): String = js.native
