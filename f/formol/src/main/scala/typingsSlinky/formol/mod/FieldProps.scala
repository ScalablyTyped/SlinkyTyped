...
object FieldProps {
  ...
  implicit class FieldPropsOps[Self <: FieldProps[_], V] (val x: Self with FieldProps[V]) extends AnyVal {
    ...
    @scala.inline
    def setTypeFieldFunctionComponent(value: ReactComponentClass[js.Object]): Self = this.set("TypeField", value.asInstanceOf[js.Any])
    @scala.inline
    def setTypeFieldComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("TypeField", value.asInstanceOf[js.Any])
    @scala.inline
    def setTypeField(value: ReactComponentClass[js.Object]): Self = this.set("TypeField", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setExtrasReactElement(value: ReactElement): Self = this.set("extras", value.asInstanceOf[js.Any])
    @scala.inline
    def setExtras(value: ReactElement): Self = this.set("extras", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setUnitReactElement(value: ReactElement): Self = this.set("unit", value.asInstanceOf[js.Any])
    @scala.inline
    def setUnit(value: ReactElement): Self = this.set("unit", value.asInstanceOf[js.Any])
    @scala.inline
