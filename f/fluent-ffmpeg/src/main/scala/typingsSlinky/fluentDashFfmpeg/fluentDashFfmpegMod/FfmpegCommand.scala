package typingsSlinky.fluentDashFfmpeg.fluentDashFfmpegMod

import typingsSlinky.fluentDashFfmpeg.Anon_End
...
class FfmpegCommand () extends EventEmitter {
  ...
  def addOutput(target: String, pipeopts: Anon_End): FfmpegCommand = js.native
  def addOutput(target: Writable): FfmpegCommand = js.native
  def addOutput(target: Writable, pipeopts: Anon_End): FfmpegCommand = js.native
  ...
  def concat(target: Writable, options: Anon_End): FfmpegCommand = js.native
  def concatenate(target: String): FfmpegCommand = js.native
  def concatenate(target: String, options: Anon_End): FfmpegCommand = js.native
  def concatenate(target: Writable): FfmpegCommand = js.native
  def concatenate(target: Writable, options: Anon_End): FfmpegCommand = js.native
  ...
  def mergeToFile(target: String, options: Anon_End): FfmpegCommand = js.native
  def mergeToFile(target: Writable): FfmpegCommand = js.native
  def mergeToFile(target: Writable, options: Anon_End): FfmpegCommand = js.native
  ...
  def output(target: String, pipeopts: Anon_End): FfmpegCommand = js.native
  def output(target: Writable): FfmpegCommand = js.native
  def output(target: Writable, pipeopts: Anon_End): FfmpegCommand = js.native
  ...
  def pipe(stream: Writable, options: Anon_End): Writable | PassThrough = js.native
  ...
  def stream(stream: Writable, options: Anon_End): Writable = js.native
  ...
  def writeToStream(stream: Writable, options: Anon_End): Writable = js.native
}
