...
import typingsSlinky.firebird.firebirdBooleans.`false`
import typingsSlinky.firebird.firebirdBooleans.`true`
...
object mod {
  ...
  object Transaction {
    ...
    implicit class TransactionMutableBuilder[Self <: Transaction] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCommit(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = StObject.set(x, "commit", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setQuery(value: (String, js.Function2[/* err */ js.Error | Null, /* res */ FBResult, Unit]) => Unit): Self = StObject.set(x, "query", js.Any.fromFunction2(value))
      
      @scala.inline
      def setQuerySync(value: String => Unit): Self = StObject.set(x, "querySync", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRollback(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = StObject.set(x, "rollback", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRollbackSync(value: () => Unit): Self = StObject.set(x, "rollbackSync", js.Any.fromFunction0(value))
      
      @scala.inline
      def setStart(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = StObject.set(x, "start", js.Any.fromFunction1(value))
