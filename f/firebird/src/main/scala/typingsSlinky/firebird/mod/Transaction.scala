...
object Transaction {
  ...
  implicit class TransactionOps[Self <: Transaction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommit(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = this.set("commit", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setQuery(value: (String, js.Function2[/* err */ js.Error | Null, /* res */ FBResult, Unit]) => Unit): Self = this.set("query", js.Any.fromFunction2(value))
    @scala.inline
    def setQuerySync(value: String => Unit): Self = this.set("querySync", js.Any.fromFunction1(value))
    @scala.inline
    def setRollback(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = this.set("rollback", js.Any.fromFunction1(value))
    @scala.inline
    def setRollbackSync(value: () => Unit): Self = this.set("rollbackSync", js.Any.fromFunction0(value))
    @scala.inline
    def setStart(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = this.set("start", js.Any.fromFunction1(value))
    @scala.inline
