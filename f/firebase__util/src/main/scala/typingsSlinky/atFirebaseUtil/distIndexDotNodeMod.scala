...
import typingsSlinky.atFirebaseUtil.distSrcCryptMod.Base64
import typingsSlinky.atFirebaseUtil.distSrcErrorsMod.ErrorMap
import typingsSlinky.atFirebaseUtil.distSrcJwtMod.DecodedToken
...
object distIndexDotNodeMod extends js.Object {
  @js.native
  class Deferred[R] ()
    extends typingsSlinky.atFirebaseUtil.distSrcDeferredMod.Deferred[R]
  ...
  {readonly [ K in ErrorCode ]:? @firebase/util.@firebase/util/dist/src/errors.ErrorData}
    */ typingsSlinky.atFirebaseUtil.atFirebaseUtilStrings.ErrorFactory with js.Any */] protected ()
    extends typingsSlinky.atFirebaseUtil.distSrcErrorsMod.ErrorFactory[ErrorCode, ErrorParams] {
    def this(service: String, serviceName: String, errors: ErrorMap[ErrorCode]) = this()
  }
  
  @js.native
  class FirebaseError protected ()
    extends typingsSlinky.atFirebaseUtil.distSrcErrorsMod.FirebaseError {
    def this(code: String, message: String) = this()
  }
  
  @js.native
  class Sha1 ()
    extends typingsSlinky.atFirebaseUtil.distSrcSha1Mod.Sha1
  ...
  {[ key in K ]: V}
    */ typingsSlinky.atFirebaseUtil.atFirebaseUtilStrings.map with js.Any,
    fn: js.Function3[
      /* value */ V, 
      /* key */ K, 
      /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in K ]: V}
    */ /* obj */ typingsSlinky.atFirebaseUtil.atFirebaseUtilStrings.map with js.Any, 
      U
    ]
  ): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in K ]: U}
    */ typingsSlinky.atFirebaseUtil.atFirebaseUtilStrings.map with js.Any = js.native
  def map[K /* <: String */, V, U](
    obj: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in K ]: V}
    */ typingsSlinky.atFirebaseUtil.atFirebaseUtilStrings.map with js.Any,
