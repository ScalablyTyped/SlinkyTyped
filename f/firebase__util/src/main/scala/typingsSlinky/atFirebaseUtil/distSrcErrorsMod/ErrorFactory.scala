package typingsSlinky.atFirebaseUtil.distSrcErrorsMod
...
{readonly [ K in ErrorCode ]:? @firebase/util.@firebase/util/dist/src/errors.ErrorData}
  */ typingsSlinky.atFirebaseUtil.atFirebaseUtilStrings.ErrorFactory with js.Any */] protected () extends js.Object {
