...
object errorsMod {
  ...
  {readonly [ K in ErrorCode ]:? @firebase/util.@firebase/util/dist/src/errors.ErrorData}
    */ typingsSlinky.firebaseUtil.firebaseUtilStrings.ErrorFactory with TopLevel[js.Any] */] protected () extends StObject {
  ...
  {readonly [ K in ErrorCode ]: string}
    */ typingsSlinky.firebaseUtil.firebaseUtilStrings.ErrorMap with TopLevel[js.Any]
