package typingsSlinky.facebookDashPixel.facebook.Pixel
...
trait Event extends js.Object {
  ...
  def apply(
    eventType: String,
    eventName: String,
    parameters: typingsSlinky.facebookDashPixel.facebook.Pixel.DPA.AddToCartParameters
  ): Unit = js.native
  def apply(
    eventType: String,
    eventName: String,
    parameters: typingsSlinky.facebookDashPixel.facebook.Pixel.DPA.PurchaseParameters
  ): Unit = js.native
  def apply(
    eventType: String,
    eventName: String,
    parameters: typingsSlinky.facebookDashPixel.facebook.Pixel.DPA.ViewContentParameters
  ): Unit = js.native
