package typingsSlinky.fsDashMock.fsDashMockMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.fsDashMock.Anon_BufferSize
import typingsSlinky.fsDashMock.Anon_BufferSizeEncoding
import typingsSlinky.fsDashMock.Anon_Encoding
import typingsSlinky.fsDashMock.Anon_EncodingFlag
import typingsSlinky.fsDashMock.Anon_EncodingFlagMode
import typingsSlinky.fsDashMock.Anon_EncodingFlags
import typingsSlinky.fsDashMock.Anon_Flag
import typingsSlinky.fsDashMock.Anon_Interval
import typingsSlinky.fsDashMock.Anon_Persistent
...
trait FS extends js.Object {
  ...
  def appendFile(filename: String, data: js.Any, options: Anon_EncodingFlag): Unit = js.native
  ...
  def appendFileSync(filename: String, data: js.Any, options: Anon_EncodingFlag): Unit = js.native
  ...
  def createReadStream(path: String, options: Anon_BufferSize): ReadStream = js.native
  def createReadStream(path: String, options: Anon_BufferSizeEncoding): ReadStream = js.native
  def createWriteStream(path: String): WriteStream = js.native
  def createWriteStream(path: String, options: Anon_EncodingFlags): WriteStream = js.native
  ...
  def writeFile(filename: String, data: js.Any, options: Anon_EncodingFlagMode): Unit = js.native
  def writeFile(
    filename: String,
    data: js.Any,
    options: Anon_EncodingFlagMode,
  ...
  def writeFileSync(filename: String, data: js.Any, options: Anon_EncodingFlag): Unit = js.native
