...
trait CalendarProps extends js.Object {
  ...
  var navLinkDayClick: js.UndefOr[String | (js.Function2[/* date */ js.Date, /* jsEvent */ Event, Unit])] = js.undefined
  ...
  var visibleRange: js.UndefOr[(js.Function1[/* currentDate */ js.Date, DateRangeInput]) | DateRangeInput] = js.undefined
  var weekLabel: js.UndefOr[String] = js.undefined
  var weekNumberCalculation: js.UndefOr[local | ISO | (js.Function1[/* m */ js.Date, Double])] = js.undefined
...
object CalendarProps {
  ...
  def apply(
    ...
    navLinkDayClick: String | (js.Function2[/* date */ js.Date, /* jsEvent */ Event, Unit]) = null,
    ...
    views: js.Any = null,
    visibleRange: (js.Function1[/* currentDate */ js.Date, DateRangeInput]) | DateRangeInput = null,
    weekLabel: String = null,
    weekNumberCalculation: local | ISO | (js.Function1[/* m */ js.Date, Double]) = null,
