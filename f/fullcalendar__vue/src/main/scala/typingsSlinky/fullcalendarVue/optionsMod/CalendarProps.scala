...
object CalendarProps {
  ...
  implicit class CalendarPropsOps[Self <: CalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultDateDate(value: js.Date): Self = this.set("defaultDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNavLinkDayClickFunction2(value: (/* date */ js.Date, /* jsEvent */ Event) => Unit): Self = this.set("navLinkDayClick", js.Any.fromFunction2(value))
    @scala.inline
    def setNavLinkDayClick(value: String | (js.Function2[/* date */ js.Date, /* jsEvent */ Event, Unit])): Self = this.set("navLinkDayClick", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVisibleRangeFunction1(value: /* currentDate */ js.Date => DateRangeInput): Self = this.set("visibleRange", js.Any.fromFunction1(value))
    @scala.inline
    def setVisibleRange(value: (js.Function1[/* currentDate */ js.Date, DateRangeInput]) | DateRangeInput): Self = this.set("visibleRange", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWeekNumberCalculationFunction1(value: /* m */ js.Date => Double): Self = this.set("weekNumberCalculation", js.Any.fromFunction1(value))
    @scala.inline
    def setWeekNumberCalculation(value: local | ISO | (js.Function1[/* m */ js.Date, Double])): Self = this.set("weekNumberCalculation", value.asInstanceOf[js.Any])
    @scala.inline
