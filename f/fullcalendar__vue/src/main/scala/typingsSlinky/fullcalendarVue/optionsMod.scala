...
object optionsMod {
  ...
  object CalendarProps {
    ...
    implicit class CalendarPropsMutableBuilder[Self <: CalendarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultDateDate(value: js.Date): Self = StObject.set(x, "defaultDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNavLinkDayClick(value: String | (js.Function2[/* date */ js.Date, /* jsEvent */ Event, Unit])): Self = StObject.set(x, "navLinkDayClick", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavLinkDayClickFunction2(value: (/* date */ js.Date, /* jsEvent */ Event) => Unit): Self = StObject.set(x, "navLinkDayClick", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setVisibleRange(value: (js.Function1[/* currentDate */ js.Date, DateRangeInput]) | DateRangeInput): Self = StObject.set(x, "visibleRange", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVisibleRangeFunction1(value: /* currentDate */ js.Date => DateRangeInput): Self = StObject.set(x, "visibleRange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setWeekNumberCalculation(value: local | ISO | (js.Function1[/* m */ js.Date, Double])): Self = StObject.set(x, "weekNumberCalculation", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWeekNumberCalculationFunction1(value: /* m */ js.Date => Double): Self = StObject.set(x, "weekNumberCalculation", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.fullcalendarVue.fullcalendarVueStrings.ltr
    - typingsSlinky.fullcalendarVue.fullcalendarVueStrings.rtl
  */
  trait direction extends StObject
  object direction {
    
    @scala.inline
    def ltr: typingsSlinky.fullcalendarVue.fullcalendarVueStrings.ltr = "ltr".asInstanceOf[typingsSlinky.fullcalendarVue.fullcalendarVueStrings.ltr]
    
    @scala.inline
    def rtl: typingsSlinky.fullcalendarVue.fullcalendarVueStrings.rtl = "rtl".asInstanceOf[typingsSlinky.fullcalendarVue.fullcalendarVueStrings.rtl]
  }
}
