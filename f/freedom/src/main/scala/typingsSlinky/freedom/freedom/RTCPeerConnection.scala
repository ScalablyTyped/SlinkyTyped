...
import typingsSlinky.freedom.anon.Stream
...
import typingsSlinky.freedom.freedomStrings.oniceconnectionstatechange
import typingsSlinky.freedom.freedomStrings.onnegotiationneeded
import typingsSlinky.freedom.freedomStrings.onremovestream
import typingsSlinky.freedom.freedomStrings.onsignalingstatechange
...
object RTCPeerConnection {
  ...
  trait RTCPeerConnection extends StObject {
    ...
    @JSName("on")
    def on_ondatachannel(t: ondatachannel, f: js.Function1[/* d */ typingsSlinky.freedom.anon.Channel, Unit]): Unit = js.native
    @JSName("on")
