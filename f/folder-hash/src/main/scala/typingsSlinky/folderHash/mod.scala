package typingsSlinky.folderHash

import typingsSlinky.folderHash.folderHashStrings.base64
import typingsSlinky.folderHash.folderHashStrings.binary
import typingsSlinky.folderHash.folderHashStrings.hex
