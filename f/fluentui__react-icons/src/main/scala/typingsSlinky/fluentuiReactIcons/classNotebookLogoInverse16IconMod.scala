...
@JSImport("@fluentui/react-icons/lib/components/ClassNotebookLogoInverse16Icon", JSImport.Namespace)
@js.native
object classNotebookLogoInverse16IconMod extends js.Object {
