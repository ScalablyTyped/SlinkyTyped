...
object PYIcon {
  @JSImport("@fluentui/react-icons/lib/components/PYIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PYIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
