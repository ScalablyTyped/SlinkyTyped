...
object MicrophoneIcon {
  @JSImport("@fluentui/react-icons/lib/components/MicrophoneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MicrophoneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
