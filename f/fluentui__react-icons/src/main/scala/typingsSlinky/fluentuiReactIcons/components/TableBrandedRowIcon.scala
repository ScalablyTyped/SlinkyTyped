...
object TableBrandedRowIcon {
  @JSImport("@fluentui/react-icons/lib/components/TableBrandedRowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TableBrandedRowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
