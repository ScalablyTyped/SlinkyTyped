...
object StackColumnChartIcon {
  @JSImport("@fluentui/react-icons", "StackColumnChartIcon")
  @js.native
  ...
  implicit def make(companion: StackColumnChartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
