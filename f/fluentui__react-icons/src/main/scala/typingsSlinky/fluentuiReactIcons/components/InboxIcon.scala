...
object InboxIcon {
  @JSImport("@fluentui/react-icons/lib/components/InboxIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InboxIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
