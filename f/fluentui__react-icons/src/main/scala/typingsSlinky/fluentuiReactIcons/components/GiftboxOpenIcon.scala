...
object GiftboxOpenIcon {
  @JSImport("@fluentui/react-icons/lib/components/GiftboxOpenIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GiftboxOpenIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
