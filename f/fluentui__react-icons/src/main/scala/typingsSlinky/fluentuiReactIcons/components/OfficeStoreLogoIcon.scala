...
object OfficeStoreLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/OfficeStoreLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OfficeStoreLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
