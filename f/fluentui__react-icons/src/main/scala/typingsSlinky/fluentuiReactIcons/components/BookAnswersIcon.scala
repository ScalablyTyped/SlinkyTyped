...
object BookAnswersIcon {
  @JSImport("@fluentui/react-icons/lib/components/BookAnswersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BookAnswersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
