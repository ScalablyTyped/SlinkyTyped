...
object ServerProcessesIcon {
  @JSImport("@fluentui/react-icons/lib/components/ServerProcessesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ServerProcessesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
