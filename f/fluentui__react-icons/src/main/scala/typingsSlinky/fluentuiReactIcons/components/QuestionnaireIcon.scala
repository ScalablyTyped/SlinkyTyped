...
object QuestionnaireIcon {
  @JSImport("@fluentui/react-icons/lib/components/QuestionnaireIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QuestionnaireIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
