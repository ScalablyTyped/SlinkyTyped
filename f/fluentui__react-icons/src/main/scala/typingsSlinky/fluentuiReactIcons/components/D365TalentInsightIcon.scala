...
object D365TalentInsightIcon {
  @JSImport("@fluentui/react-icons/lib/components/D365TalentInsightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: D365TalentInsightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
