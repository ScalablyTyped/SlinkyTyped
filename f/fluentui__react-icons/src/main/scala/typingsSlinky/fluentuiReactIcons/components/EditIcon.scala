...
object EditIcon {
  @JSImport("@fluentui/react-icons/lib/components/EditIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EditIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
