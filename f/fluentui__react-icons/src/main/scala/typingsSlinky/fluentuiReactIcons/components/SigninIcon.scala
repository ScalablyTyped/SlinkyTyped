...
object SigninIcon {
  @JSImport("@fluentui/react-icons/lib/components/SigninIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SigninIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
