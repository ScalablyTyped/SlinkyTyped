...
object ParameterIcon {
  @JSImport("@fluentui/react-icons/lib/components/ParameterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ParameterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
