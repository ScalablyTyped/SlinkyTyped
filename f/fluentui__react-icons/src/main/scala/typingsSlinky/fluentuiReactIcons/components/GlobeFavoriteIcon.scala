...
object GlobeFavoriteIcon {
  @JSImport("@fluentui/react-icons/lib/components/GlobeFavoriteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GlobeFavoriteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
