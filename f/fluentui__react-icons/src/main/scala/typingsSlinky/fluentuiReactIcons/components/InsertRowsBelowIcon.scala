...
object InsertRowsBelowIcon {
  @JSImport("@fluentui/react-icons/lib/components/InsertRowsBelowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InsertRowsBelowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
