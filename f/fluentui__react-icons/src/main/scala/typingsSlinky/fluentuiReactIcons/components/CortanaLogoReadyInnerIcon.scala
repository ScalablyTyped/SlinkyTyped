...
object CortanaLogoReadyInnerIcon {
  @JSImport("@fluentui/react-icons/lib/components/CortanaLogoReadyInnerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CortanaLogoReadyInnerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
