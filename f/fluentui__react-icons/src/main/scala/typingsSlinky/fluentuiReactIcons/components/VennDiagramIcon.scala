...
object VennDiagramIcon {
  @JSImport("@fluentui/react-icons/lib/components/VennDiagramIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VennDiagramIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
