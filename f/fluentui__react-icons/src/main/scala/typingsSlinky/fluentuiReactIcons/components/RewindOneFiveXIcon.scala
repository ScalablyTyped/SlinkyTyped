...
object RewindOneFiveXIcon {
  @JSImport("@fluentui/react-icons/lib/components/RewindOneFiveXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RewindOneFiveXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
