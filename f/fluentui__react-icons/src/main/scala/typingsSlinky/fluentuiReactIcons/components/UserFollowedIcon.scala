...
object UserFollowedIcon {
  
  @JSImport("@fluentui/react-icons", "UserFollowedIcon")
  @js.native
  ...
  implicit def make(companion: UserFollowedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
