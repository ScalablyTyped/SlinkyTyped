...
object SourceIcon {
  @JSImport("@fluentui/react-icons/lib/components/SourceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SourceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
