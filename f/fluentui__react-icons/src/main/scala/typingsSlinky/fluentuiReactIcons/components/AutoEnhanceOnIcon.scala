...
object AutoEnhanceOnIcon {
  @JSImport("@fluentui/react-icons/lib/components/AutoEnhanceOnIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AutoEnhanceOnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
