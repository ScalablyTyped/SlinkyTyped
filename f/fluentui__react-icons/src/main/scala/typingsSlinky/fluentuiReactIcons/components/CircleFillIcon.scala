...
object CircleFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/CircleFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CircleFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
