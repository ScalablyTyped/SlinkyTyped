...
object Rotate90CounterClockwiseIcon {
  @JSImport("@fluentui/react-icons/lib/components/Rotate90CounterClockwiseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Rotate90CounterClockwiseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
