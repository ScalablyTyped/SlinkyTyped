...
object TrainIcon {
  @JSImport("@fluentui/react-icons/lib/components/TrainIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TrainIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
