...
object StatusCircleErrorXIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleErrorXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleErrorXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
