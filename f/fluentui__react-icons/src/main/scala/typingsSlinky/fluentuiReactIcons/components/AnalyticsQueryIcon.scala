...
object AnalyticsQueryIcon {
  @JSImport("@fluentui/react-icons/lib/components/AnalyticsQueryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AnalyticsQueryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
