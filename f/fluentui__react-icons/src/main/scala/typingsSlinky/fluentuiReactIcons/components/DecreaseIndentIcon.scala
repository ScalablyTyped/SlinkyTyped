...
object DecreaseIndentIcon {
  @JSImport("@fluentui/react-icons/lib/components/DecreaseIndentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DecreaseIndentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
