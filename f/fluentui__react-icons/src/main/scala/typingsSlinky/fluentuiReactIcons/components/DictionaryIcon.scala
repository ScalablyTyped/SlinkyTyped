...
object DictionaryIcon {
  @JSImport("@fluentui/react-icons/lib/components/DictionaryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DictionaryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
