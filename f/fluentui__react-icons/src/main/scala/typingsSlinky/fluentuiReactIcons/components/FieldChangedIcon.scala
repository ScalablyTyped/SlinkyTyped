...
object FieldChangedIcon {
  @JSImport("@fluentui/react-icons/lib/components/FieldChangedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FieldChangedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
