...
object DrillExpandIcon {
  @JSImport("@fluentui/react-icons/lib/components/DrillExpandIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DrillExpandIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
