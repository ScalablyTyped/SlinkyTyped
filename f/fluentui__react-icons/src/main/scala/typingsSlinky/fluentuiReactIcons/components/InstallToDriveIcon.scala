...
object InstallToDriveIcon {
  @JSImport("@fluentui/react-icons/lib/components/InstallToDriveIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InstallToDriveIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
