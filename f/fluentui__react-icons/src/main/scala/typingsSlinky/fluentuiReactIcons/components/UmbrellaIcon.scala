...
object UmbrellaIcon {
  @JSImport("@fluentui/react-icons/lib/components/UmbrellaIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UmbrellaIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
