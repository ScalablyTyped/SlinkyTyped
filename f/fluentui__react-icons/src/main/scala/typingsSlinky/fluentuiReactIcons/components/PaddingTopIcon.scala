...
object PaddingTopIcon {
  @JSImport("@fluentui/react-icons/lib/components/PaddingTopIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PaddingTopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
