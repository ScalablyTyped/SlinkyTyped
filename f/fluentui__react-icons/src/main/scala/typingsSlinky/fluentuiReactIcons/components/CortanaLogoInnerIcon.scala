...
object CortanaLogoInnerIcon {
  @JSImport("@fluentui/react-icons/lib/components/CortanaLogoInnerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CortanaLogoInnerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
