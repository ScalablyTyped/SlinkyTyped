...
object RIcon {
  @JSImport("@fluentui/react-icons/lib/components/RIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
