...
object TelemarketerIcon {
  @JSImport("@fluentui/react-icons", "TelemarketerIcon")
  @js.native
  ...
  implicit def make(companion: TelemarketerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
