...
object RemoveLinkIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveLinkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveLinkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
