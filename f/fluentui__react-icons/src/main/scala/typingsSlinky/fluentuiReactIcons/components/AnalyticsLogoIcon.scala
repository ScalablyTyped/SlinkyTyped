...
object AnalyticsLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/AnalyticsLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AnalyticsLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
