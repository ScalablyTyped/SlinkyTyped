...
object DoubleColumnIcon {
  @JSImport("@fluentui/react-icons", "DoubleColumnIcon")
  @js.native
  ...
  implicit def make(companion: DoubleColumnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
