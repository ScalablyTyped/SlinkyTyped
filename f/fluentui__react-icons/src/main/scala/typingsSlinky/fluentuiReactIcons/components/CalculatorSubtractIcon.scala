...
object CalculatorSubtractIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalculatorSubtractIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalculatorSubtractIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
