...
object DownloadDocumentIcon {
  @JSImport("@fluentui/react-icons/lib/components/DownloadDocumentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DownloadDocumentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
