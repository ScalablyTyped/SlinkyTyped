...
object DoubleBookmarkIcon {
  @JSImport("@fluentui/react-icons/lib/components/DoubleBookmarkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DoubleBookmarkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
