...
object FilterIcon {
  @JSImport("@fluentui/react-icons/lib/components/FilterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FilterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
