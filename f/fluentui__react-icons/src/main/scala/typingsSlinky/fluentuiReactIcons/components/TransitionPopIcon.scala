...
object TransitionPopIcon {
  @JSImport("@fluentui/react-icons/lib/components/TransitionPopIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TransitionPopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
