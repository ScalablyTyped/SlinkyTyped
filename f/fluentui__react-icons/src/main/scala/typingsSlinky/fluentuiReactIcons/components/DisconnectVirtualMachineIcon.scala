...
object DisconnectVirtualMachineIcon {
  @JSImport("@fluentui/react-icons/lib/components/DisconnectVirtualMachineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DisconnectVirtualMachineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
