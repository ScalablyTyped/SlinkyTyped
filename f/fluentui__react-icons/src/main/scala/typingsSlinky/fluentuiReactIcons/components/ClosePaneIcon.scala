...
object ClosePaneIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClosePaneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClosePaneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
