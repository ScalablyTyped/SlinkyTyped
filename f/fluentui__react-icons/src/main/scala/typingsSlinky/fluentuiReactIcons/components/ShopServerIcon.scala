...
object ShopServerIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShopServerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShopServerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
