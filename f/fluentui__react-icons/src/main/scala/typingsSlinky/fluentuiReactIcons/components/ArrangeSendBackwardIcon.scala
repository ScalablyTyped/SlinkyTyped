...
object ArrangeSendBackwardIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrangeSendBackwardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrangeSendBackwardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
