...
object OctagonIcon {
  @JSImport("@fluentui/react-icons/lib/components/OctagonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OctagonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
