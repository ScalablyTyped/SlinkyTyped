...
object ReadingModeIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReadingModeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReadingModeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
