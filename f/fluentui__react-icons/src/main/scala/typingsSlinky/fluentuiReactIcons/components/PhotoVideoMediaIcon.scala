...
object PhotoVideoMediaIcon {
  @JSImport("@fluentui/react-icons/lib/components/PhotoVideoMediaIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PhotoVideoMediaIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
