...
object RefreshIcon {
  @JSImport("@fluentui/react-icons", "RefreshIcon")
  @js.native
  ...
  implicit def make(companion: RefreshIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
