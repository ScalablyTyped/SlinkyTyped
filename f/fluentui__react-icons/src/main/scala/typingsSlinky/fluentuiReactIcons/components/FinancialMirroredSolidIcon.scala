...
object FinancialMirroredSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/FinancialMirroredSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FinancialMirroredSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
