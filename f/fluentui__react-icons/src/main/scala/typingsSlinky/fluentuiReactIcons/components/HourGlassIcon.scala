...
object HourGlassIcon {
  @JSImport("@fluentui/react-icons/lib/components/HourGlassIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HourGlassIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
