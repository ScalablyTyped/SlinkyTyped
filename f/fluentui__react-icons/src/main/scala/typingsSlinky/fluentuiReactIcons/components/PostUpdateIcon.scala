...
object PostUpdateIcon {
  @JSImport("@fluentui/react-icons/lib/components/PostUpdateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PostUpdateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
