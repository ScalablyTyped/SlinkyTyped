...
object WindDirectionIcon {
  @JSImport("@fluentui/react-icons/lib/components/WindDirectionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WindDirectionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
