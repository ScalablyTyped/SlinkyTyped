...
object GitGraphIcon {
  @JSImport("@fluentui/react-icons/lib/components/GitGraphIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GitGraphIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
