...
object ReceiptUndeliveredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReceiptUndeliveredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReceiptUndeliveredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
