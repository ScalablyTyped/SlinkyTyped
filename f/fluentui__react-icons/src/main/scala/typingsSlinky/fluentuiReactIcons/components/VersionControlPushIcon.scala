...
object VersionControlPushIcon {
  @JSImport("@fluentui/react-icons/lib/components/VersionControlPushIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VersionControlPushIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
