...
object RemoveContentIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveContentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveContentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
