...
object MyNetworkIcon {
  @JSImport("@fluentui/react-icons/lib/components/MyNetworkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MyNetworkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
