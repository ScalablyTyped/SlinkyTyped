...
object ContactIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContactIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContactIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
