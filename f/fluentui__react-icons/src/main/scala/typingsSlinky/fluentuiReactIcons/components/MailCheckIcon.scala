...
object MailCheckIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailCheckIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailCheckIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
