...
object AutoFitContentsIcon {
  @JSImport("@fluentui/react-icons/lib/components/AutoFitContentsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AutoFitContentsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
