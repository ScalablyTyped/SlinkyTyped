...
object PlayReverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/PlayReverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PlayReverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
