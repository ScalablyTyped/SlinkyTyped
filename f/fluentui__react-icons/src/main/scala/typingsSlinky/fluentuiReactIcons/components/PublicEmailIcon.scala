...
object PublicEmailIcon {
  @JSImport("@fluentui/react-icons/lib/components/PublicEmailIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PublicEmailIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
