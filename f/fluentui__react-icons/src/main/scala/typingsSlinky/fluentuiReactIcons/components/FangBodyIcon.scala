...
object FangBodyIcon {
  @JSImport("@fluentui/react-icons/lib/components/FangBodyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FangBodyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
