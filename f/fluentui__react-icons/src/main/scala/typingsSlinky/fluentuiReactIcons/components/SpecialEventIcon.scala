...
object SpecialEventIcon {
  @JSImport("@fluentui/react-icons/lib/components/SpecialEventIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SpecialEventIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
