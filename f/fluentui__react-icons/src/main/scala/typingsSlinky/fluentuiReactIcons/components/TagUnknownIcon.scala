...
object TagUnknownIcon {
  @JSImport("@fluentui/react-icons/lib/components/TagUnknownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TagUnknownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
