...
object VideoSearchIcon {
  @JSImport("@fluentui/react-icons/lib/components/VideoSearchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VideoSearchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
