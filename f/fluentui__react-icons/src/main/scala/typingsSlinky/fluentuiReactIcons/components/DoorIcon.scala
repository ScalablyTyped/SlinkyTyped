...
object DoorIcon {
  @JSImport("@fluentui/react-icons/lib/components/DoorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DoorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
