...
object BarChartVerticalIcon {
  @JSImport("@fluentui/react-icons/lib/components/BarChartVerticalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BarChartVerticalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
