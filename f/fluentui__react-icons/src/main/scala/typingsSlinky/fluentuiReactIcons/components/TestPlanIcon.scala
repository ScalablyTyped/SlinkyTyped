...
object TestPlanIcon {
  @JSImport("@fluentui/react-icons/lib/components/TestPlanIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TestPlanIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
