...
object ArchiveUndoIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArchiveUndoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArchiveUndoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
