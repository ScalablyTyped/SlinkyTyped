...
object BranchSearchIcon {
  @JSImport("@fluentui/react-icons/lib/components/BranchSearchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BranchSearchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
