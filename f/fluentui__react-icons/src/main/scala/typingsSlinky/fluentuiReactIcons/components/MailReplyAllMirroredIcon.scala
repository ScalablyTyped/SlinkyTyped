...
object MailReplyAllMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailReplyAllMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailReplyAllMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
