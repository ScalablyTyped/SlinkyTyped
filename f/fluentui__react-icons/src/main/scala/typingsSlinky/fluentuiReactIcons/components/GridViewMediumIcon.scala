...
object GridViewMediumIcon {
  @JSImport("@fluentui/react-icons/lib/components/GridViewMediumIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GridViewMediumIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
