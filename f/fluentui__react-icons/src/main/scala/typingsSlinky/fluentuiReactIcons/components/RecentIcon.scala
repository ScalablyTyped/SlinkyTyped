...
object RecentIcon {
  @JSImport("@fluentui/react-icons/lib/components/RecentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RecentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
