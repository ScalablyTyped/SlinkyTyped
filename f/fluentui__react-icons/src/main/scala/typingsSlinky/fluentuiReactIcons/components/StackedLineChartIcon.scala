...
object StackedLineChartIcon {
  @JSImport("@fluentui/react-icons/lib/components/StackedLineChartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StackedLineChartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
