...
object EmbedIcon {
  @JSImport("@fluentui/react-icons/lib/components/EmbedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EmbedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
