...
object FullViewIcon {
  @JSImport("@fluentui/react-icons/lib/components/FullViewIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FullViewIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
