...
object PasswordFieldIcon {
  @JSImport("@fluentui/react-icons/lib/components/PasswordFieldIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PasswordFieldIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
