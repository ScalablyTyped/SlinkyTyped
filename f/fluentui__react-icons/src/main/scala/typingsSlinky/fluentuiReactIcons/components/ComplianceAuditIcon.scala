...
object ComplianceAuditIcon {
  @JSImport("@fluentui/react-icons/lib/components/ComplianceAuditIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ComplianceAuditIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
