...
object ActionCenterIcon {
  @JSImport("@fluentui/react-icons/lib/components/ActionCenterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ActionCenterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
