...
object BlogIcon {
  @JSImport("@fluentui/react-icons/lib/components/BlogIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlogIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
