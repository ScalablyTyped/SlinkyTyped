...
object SendIcon {
  @JSImport("@fluentui/react-icons/lib/components/SendIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SendIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
