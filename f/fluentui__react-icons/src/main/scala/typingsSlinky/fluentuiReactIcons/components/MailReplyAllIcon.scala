...
object MailReplyAllIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailReplyAllIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailReplyAllIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
