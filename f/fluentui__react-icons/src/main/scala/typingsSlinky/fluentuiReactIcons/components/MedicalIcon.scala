...
object MedicalIcon {
  @JSImport("@fluentui/react-icons/lib/components/MedicalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MedicalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
