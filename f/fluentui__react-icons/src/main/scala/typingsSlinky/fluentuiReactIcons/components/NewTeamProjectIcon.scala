...
object NewTeamProjectIcon {
  @JSImport("@fluentui/react-icons/lib/components/NewTeamProjectIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NewTeamProjectIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
