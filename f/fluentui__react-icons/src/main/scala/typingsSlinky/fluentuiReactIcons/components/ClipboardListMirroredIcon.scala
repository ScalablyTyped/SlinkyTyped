...
object ClipboardListMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClipboardListMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClipboardListMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
