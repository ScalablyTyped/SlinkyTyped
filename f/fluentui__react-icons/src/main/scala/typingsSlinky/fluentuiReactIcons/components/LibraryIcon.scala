...
object LibraryIcon {
  @JSImport("@fluentui/react-icons/lib/components/LibraryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LibraryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
