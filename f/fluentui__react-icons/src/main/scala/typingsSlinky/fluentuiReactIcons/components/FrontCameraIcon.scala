...
object FrontCameraIcon {
  @JSImport("@fluentui/react-icons/lib/components/FrontCameraIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FrontCameraIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
