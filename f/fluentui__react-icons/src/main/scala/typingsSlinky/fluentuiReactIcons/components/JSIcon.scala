...
object JSIcon {
  @JSImport("@fluentui/react-icons/lib/components/JSIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: JSIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
