...
object DelveAnalyticsLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/DelveAnalyticsLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DelveAnalyticsLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
