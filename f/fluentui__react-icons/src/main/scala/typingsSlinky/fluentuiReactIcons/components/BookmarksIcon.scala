...
object BookmarksIcon {
  @JSImport("@fluentui/react-icons/lib/components/BookmarksIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BookmarksIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
