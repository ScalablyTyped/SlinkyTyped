...
object DiffInlineIcon {
  @JSImport("@fluentui/react-icons/lib/components/DiffInlineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DiffInlineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
