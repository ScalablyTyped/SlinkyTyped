...
object PageListFilterIcon {
  @JSImport("@fluentui/react-icons/lib/components/PageListFilterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PageListFilterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
