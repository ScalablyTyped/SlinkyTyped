...
object HideIcon {
  @JSImport("@fluentui/react-icons/lib/components/HideIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HideIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
