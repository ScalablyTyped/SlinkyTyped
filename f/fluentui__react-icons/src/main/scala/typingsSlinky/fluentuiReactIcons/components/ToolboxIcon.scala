...
object ToolboxIcon {
  @JSImport("@fluentui/react-icons/lib/components/ToolboxIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ToolboxIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
