...
object AlbumIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlbumIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlbumIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
