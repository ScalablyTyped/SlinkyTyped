...
object PresentationIcon {
  @JSImport("@fluentui/react-icons/lib/components/PresentationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PresentationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
