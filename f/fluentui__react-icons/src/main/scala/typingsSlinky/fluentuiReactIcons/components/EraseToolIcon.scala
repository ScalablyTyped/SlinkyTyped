...
object EraseToolIcon {
  @JSImport("@fluentui/react-icons/lib/components/EraseToolIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EraseToolIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
