...
object BrowserTabIcon {
  @JSImport("@fluentui/react-icons/lib/components/BrowserTabIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BrowserTabIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
