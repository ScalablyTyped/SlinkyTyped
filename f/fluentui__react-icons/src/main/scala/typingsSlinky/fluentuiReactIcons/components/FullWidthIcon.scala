...
object FullWidthIcon {
  @JSImport("@fluentui/react-icons/lib/components/FullWidthIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FullWidthIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
