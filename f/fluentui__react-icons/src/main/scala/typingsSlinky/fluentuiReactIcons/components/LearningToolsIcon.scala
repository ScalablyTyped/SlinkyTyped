...
object LearningToolsIcon {
  
  @JSImport("@fluentui/react-icons", "LearningToolsIcon")
  @js.native
  ...
  implicit def make(companion: LearningToolsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
