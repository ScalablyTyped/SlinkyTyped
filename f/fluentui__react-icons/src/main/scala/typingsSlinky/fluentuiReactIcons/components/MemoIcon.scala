...
object MemoIcon {
  @JSImport("@fluentui/react-icons/lib/components/MemoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MemoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
