...
object SidePanelIcon {
  @JSImport("@fluentui/react-icons/lib/components/SidePanelIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SidePanelIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
