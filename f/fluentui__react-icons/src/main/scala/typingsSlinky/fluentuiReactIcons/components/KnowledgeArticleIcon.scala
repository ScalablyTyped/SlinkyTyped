...
object KnowledgeArticleIcon {
  @JSImport("@fluentui/react-icons/lib/components/KnowledgeArticleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: KnowledgeArticleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
