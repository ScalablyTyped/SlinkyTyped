...
object SectionsIcon {
  @JSImport("@fluentui/react-icons/lib/components/SectionsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SectionsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
