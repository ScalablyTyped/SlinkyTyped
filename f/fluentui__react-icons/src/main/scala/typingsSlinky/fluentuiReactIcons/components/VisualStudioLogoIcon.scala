...
object VisualStudioLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/VisualStudioLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VisualStudioLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
