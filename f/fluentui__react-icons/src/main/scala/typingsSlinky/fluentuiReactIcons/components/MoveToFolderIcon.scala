...
object MoveToFolderIcon {
  @JSImport("@fluentui/react-icons/lib/components/MoveToFolderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MoveToFolderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
