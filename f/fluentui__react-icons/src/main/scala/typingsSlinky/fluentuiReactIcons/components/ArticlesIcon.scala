...
object ArticlesIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArticlesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArticlesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
