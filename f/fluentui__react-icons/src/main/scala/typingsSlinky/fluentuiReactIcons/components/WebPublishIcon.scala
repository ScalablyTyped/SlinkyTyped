...
object WebPublishIcon {
  @JSImport("@fluentui/react-icons/lib/components/WebPublishIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WebPublishIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
