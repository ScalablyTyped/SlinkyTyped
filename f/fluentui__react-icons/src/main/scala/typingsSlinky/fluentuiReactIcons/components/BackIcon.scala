...
object BackIcon {
  @JSImport("@fluentui/react-icons/lib/components/BackIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BackIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
