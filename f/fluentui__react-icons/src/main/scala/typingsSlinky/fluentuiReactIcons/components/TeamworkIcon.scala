...
object TeamworkIcon {
  @JSImport("@fluentui/react-icons/lib/components/TeamworkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TeamworkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
