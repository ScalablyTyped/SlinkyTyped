...
object PictureLibraryIcon {
  @JSImport("@fluentui/react-icons/lib/components/PictureLibraryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PictureLibraryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
