...
object MarkDownLanguageIcon {
  @JSImport("@fluentui/react-icons/lib/components/MarkDownLanguageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MarkDownLanguageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
