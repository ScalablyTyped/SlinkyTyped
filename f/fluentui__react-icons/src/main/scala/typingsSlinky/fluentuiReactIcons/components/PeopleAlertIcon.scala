...
object PeopleAlertIcon {
  @JSImport("@fluentui/react-icons/lib/components/PeopleAlertIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PeopleAlertIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
