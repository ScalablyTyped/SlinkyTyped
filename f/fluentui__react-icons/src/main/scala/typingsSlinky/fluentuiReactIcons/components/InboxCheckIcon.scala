...
object InboxCheckIcon {
  @JSImport("@fluentui/react-icons/lib/components/InboxCheckIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InboxCheckIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
