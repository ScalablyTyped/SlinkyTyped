...
object ClearFilterIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClearFilterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClearFilterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
