...
object GroupListIcon {
  @JSImport("@fluentui/react-icons/lib/components/GroupListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GroupListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
