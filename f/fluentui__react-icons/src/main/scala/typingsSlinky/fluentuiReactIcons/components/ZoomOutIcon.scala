...
object ZoomOutIcon {
  @JSImport("@fluentui/react-icons/lib/components/ZoomOutIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ZoomOutIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
