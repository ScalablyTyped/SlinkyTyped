...
object RainShowersNightIcon {
  @JSImport("@fluentui/react-icons/lib/components/RainShowersNightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RainShowersNightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
