...
object TicketIcon {
  @JSImport("@fluentui/react-icons/lib/components/TicketIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TicketIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
