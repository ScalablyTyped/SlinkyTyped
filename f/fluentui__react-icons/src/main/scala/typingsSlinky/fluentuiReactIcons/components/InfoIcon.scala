...
object InfoIcon {
  @JSImport("@fluentui/react-icons/lib/components/InfoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InfoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
