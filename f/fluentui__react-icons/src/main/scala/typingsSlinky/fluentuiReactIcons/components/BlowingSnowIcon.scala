...
object BlowingSnowIcon {
  @JSImport("@fluentui/react-icons/lib/components/BlowingSnowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlowingSnowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
