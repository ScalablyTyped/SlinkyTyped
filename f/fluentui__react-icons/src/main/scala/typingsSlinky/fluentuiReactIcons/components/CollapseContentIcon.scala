...
object CollapseContentIcon {
  @JSImport("@fluentui/react-icons/lib/components/CollapseContentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CollapseContentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
