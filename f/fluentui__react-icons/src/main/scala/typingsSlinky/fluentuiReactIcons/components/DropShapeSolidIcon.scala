...
object DropShapeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/DropShapeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DropShapeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
