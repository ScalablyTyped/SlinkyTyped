...
object CheckMarkIcon {
  @JSImport("@fluentui/react-icons", "CheckMarkIcon")
  @js.native
  ...
  implicit def make(companion: CheckMarkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
