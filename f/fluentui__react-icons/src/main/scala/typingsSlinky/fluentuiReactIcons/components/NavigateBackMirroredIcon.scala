...
object NavigateBackMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/NavigateBackMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NavigateBackMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
