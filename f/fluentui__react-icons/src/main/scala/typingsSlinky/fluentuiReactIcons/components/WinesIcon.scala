...
object WinesIcon {
  @JSImport("@fluentui/react-icons/lib/components/WinesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WinesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
