...
object HomeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/HomeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HomeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
