...
object StatusCircleRingIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleRingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleRingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
