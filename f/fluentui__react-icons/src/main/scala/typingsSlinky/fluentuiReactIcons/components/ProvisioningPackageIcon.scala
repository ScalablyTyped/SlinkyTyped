...
object ProvisioningPackageIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProvisioningPackageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProvisioningPackageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
