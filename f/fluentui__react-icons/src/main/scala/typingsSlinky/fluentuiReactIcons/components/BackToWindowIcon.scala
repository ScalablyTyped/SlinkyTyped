...
object BackToWindowIcon {
  @JSImport("@fluentui/react-icons/lib/components/BackToWindowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BackToWindowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
