...
object CPlusPlusIcon {
  @JSImport("@fluentui/react-icons/lib/components/CPlusPlusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CPlusPlusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
