...
object SkypeCircleCheckIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeCircleCheckIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeCircleCheckIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
