...
object BorderDotIcon {
  @JSImport("@fluentui/react-icons/lib/components/BorderDotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BorderDotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
