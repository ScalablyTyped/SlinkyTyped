...
object DropIcon {
  @JSImport("@fluentui/react-icons/lib/components/DropIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DropIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
