...
object CirclePlusIcon {
  @JSImport("@fluentui/react-icons/lib/components/CirclePlusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CirclePlusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
