...
object FontSizeIcon {
  @JSImport("@fluentui/react-icons/lib/components/FontSizeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FontSizeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
