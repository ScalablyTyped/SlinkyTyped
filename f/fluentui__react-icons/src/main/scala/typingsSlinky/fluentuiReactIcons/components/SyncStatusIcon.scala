...
object SyncStatusIcon {
  @JSImport("@fluentui/react-icons/lib/components/SyncStatusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SyncStatusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
