...
object TripleColumnWideIcon {
  @JSImport("@fluentui/react-icons/lib/components/TripleColumnWideIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TripleColumnWideIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
