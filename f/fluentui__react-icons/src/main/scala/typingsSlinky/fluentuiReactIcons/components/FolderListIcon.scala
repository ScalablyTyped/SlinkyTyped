...
object FolderListIcon {
  @JSImport("@fluentui/react-icons/lib/components/FolderListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FolderListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
