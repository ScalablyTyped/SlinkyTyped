...
object AirTicketsIcon {
  @JSImport("@fluentui/react-icons/lib/components/AirTicketsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AirTicketsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
