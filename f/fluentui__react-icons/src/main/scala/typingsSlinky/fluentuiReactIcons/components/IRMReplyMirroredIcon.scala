...
object IRMReplyMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/IRMReplyMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IRMReplyMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
