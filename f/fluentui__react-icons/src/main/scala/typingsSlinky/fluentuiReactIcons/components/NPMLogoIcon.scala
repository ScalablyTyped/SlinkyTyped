...
object NPMLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/NPMLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NPMLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
