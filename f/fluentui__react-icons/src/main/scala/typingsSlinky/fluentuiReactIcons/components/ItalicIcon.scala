...
object ItalicIcon {
  @JSImport("@fluentui/react-icons/lib/components/ItalicIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ItalicIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
