...
object StatusCircleQuestionMarkIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleQuestionMarkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleQuestionMarkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
