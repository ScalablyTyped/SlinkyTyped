...
object BufferTimeBeforeIcon {
  @JSImport("@fluentui/react-icons/lib/components/BufferTimeBeforeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BufferTimeBeforeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
