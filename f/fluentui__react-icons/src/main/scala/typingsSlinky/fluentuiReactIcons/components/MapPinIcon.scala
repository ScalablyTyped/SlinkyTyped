...
object MapPinIcon {
  @JSImport("@fluentui/react-icons/lib/components/MapPinIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MapPinIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
