...
object GoogleDriveLogoLeftGreenIcon {
  @JSImport("@fluentui/react-icons/lib/components/GoogleDriveLogoLeftGreenIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GoogleDriveLogoLeftGreenIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
