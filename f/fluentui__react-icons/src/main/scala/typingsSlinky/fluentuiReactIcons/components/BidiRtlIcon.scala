...
object BidiRtlIcon {
  @JSImport("@fluentui/react-icons/lib/components/BidiRtlIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BidiRtlIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
