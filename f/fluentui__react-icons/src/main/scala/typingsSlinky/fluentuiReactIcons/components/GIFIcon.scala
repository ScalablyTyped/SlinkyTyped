...
object GIFIcon {
  @JSImport("@fluentui/react-icons/lib/components/GIFIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GIFIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
