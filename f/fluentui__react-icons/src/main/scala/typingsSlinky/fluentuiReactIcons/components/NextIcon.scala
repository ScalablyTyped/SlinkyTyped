...
object NextIcon {
  @JSImport("@fluentui/react-icons/lib/components/NextIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NextIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
