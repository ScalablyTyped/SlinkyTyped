...
object CertificateIcon {
  @JSImport("@fluentui/react-icons/lib/components/CertificateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CertificateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
