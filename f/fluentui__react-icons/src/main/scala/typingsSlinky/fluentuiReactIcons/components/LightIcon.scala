...
object LightIcon {
  @JSImport("@fluentui/react-icons/lib/components/LightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
