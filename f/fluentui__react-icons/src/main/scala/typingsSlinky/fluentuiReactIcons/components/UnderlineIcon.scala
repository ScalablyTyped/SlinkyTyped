...
object UnderlineIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnderlineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnderlineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
