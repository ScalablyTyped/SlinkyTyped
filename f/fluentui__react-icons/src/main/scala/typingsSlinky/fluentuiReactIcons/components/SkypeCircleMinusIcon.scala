...
object SkypeCircleMinusIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeCircleMinusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeCircleMinusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
