...
object JoinOnlineMeetingIcon {
  @JSImport("@fluentui/react-icons/lib/components/JoinOnlineMeetingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: JoinOnlineMeetingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
