...
object LineSpacingIcon {
  @JSImport("@fluentui/react-icons/lib/components/LineSpacingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LineSpacingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
