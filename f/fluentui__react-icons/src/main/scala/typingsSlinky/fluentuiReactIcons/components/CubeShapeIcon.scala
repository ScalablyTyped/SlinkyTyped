...
object CubeShapeIcon {
  @JSImport("@fluentui/react-icons/lib/components/CubeShapeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CubeShapeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
