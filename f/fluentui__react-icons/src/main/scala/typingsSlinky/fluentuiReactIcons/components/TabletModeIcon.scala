...
object TabletModeIcon {
  @JSImport("@fluentui/react-icons/lib/components/TabletModeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TabletModeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
