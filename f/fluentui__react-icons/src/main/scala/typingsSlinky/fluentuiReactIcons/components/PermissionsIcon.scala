...
object PermissionsIcon {
  @JSImport("@fluentui/react-icons/lib/components/PermissionsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PermissionsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
