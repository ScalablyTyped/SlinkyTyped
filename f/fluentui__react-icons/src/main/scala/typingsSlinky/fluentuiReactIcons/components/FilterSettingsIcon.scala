...
object FilterSettingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/FilterSettingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FilterSettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
