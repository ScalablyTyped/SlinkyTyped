...
object ProjectLogo16Icon {
  @JSImport("@fluentui/react-icons/lib/components/ProjectLogo16Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProjectLogo16Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
