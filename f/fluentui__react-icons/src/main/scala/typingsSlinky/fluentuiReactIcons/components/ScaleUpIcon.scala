...
object ScaleUpIcon {
  @JSImport("@fluentui/react-icons/lib/components/ScaleUpIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ScaleUpIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
