...
object CircleShapeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/CircleShapeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CircleShapeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
