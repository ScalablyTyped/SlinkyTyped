...
object RectangleShapeIcon {
  @JSImport("@fluentui/react-icons/lib/components/RectangleShapeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RectangleShapeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
