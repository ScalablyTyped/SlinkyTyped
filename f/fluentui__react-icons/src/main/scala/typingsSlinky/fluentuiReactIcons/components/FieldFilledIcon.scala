...
object FieldFilledIcon {
  @JSImport("@fluentui/react-icons/lib/components/FieldFilledIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FieldFilledIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
