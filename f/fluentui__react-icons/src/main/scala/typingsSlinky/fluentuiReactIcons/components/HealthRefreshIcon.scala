...
object HealthRefreshIcon {
  @JSImport("@fluentui/react-icons/lib/components/HealthRefreshIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HealthRefreshIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
