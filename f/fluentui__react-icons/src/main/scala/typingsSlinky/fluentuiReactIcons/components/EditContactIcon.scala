...
object EditContactIcon {
  @JSImport("@fluentui/react-icons/lib/components/EditContactIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EditContactIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
