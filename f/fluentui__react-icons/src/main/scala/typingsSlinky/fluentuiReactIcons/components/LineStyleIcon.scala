...
object LineStyleIcon {
  @JSImport("@fluentui/react-icons/lib/components/LineStyleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LineStyleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
