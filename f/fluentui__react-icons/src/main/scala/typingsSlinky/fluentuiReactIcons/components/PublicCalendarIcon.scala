...
object PublicCalendarIcon {
  @JSImport("@fluentui/react-icons/lib/components/PublicCalendarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PublicCalendarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
