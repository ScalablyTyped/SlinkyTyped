...
object LockSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/LockSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LockSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
