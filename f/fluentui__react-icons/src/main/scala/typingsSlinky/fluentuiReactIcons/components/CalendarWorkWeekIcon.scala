...
object CalendarWorkWeekIcon {
  @JSImport("@fluentui/react-icons", "CalendarWorkWeekIcon")
  @js.native
  ...
  implicit def make(companion: CalendarWorkWeekIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
