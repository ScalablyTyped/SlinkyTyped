...
object PaddingLeftIcon {
  @JSImport("@fluentui/react-icons/lib/components/PaddingLeftIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PaddingLeftIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
