...
object SquareShapeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/SquareShapeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SquareShapeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
