...
object LifesaverIcon {
  @JSImport("@fluentui/react-icons/lib/components/LifesaverIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LifesaverIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
