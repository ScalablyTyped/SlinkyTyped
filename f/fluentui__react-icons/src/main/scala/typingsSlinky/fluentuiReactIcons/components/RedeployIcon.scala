...
object RedeployIcon {
  @JSImport("@fluentui/react-icons/lib/components/RedeployIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RedeployIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
