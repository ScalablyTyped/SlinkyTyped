...
object URLBlockIcon {
  @JSImport("@fluentui/react-icons/lib/components/URLBlockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: URLBlockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
