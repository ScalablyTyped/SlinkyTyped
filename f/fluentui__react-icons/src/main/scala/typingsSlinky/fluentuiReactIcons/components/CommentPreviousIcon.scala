...
object CommentPreviousIcon {
  @JSImport("@fluentui/react-icons/lib/components/CommentPreviousIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CommentPreviousIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
