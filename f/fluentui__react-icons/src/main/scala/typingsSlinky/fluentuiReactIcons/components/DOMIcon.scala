...
object DOMIcon {
  @JSImport("@fluentui/react-icons/lib/components/DOMIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DOMIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
