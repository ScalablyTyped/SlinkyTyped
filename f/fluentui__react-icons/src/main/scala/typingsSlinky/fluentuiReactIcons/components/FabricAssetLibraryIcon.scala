...
object FabricAssetLibraryIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricAssetLibraryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricAssetLibraryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
