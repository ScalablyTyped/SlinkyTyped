...
object FolderFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/FolderFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FolderFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
