...
object OpenFileIcon {
  @JSImport("@fluentui/react-icons/lib/components/OpenFileIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OpenFileIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
