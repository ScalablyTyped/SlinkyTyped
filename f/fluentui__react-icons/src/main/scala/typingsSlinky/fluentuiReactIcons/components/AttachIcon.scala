...
object AttachIcon {
  @JSImport("@fluentui/react-icons/lib/components/AttachIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AttachIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
