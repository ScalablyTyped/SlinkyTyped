...
object AndroidLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/AndroidLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AndroidLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
