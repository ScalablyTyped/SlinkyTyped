...
object BrowserScreenShotIcon {
  @JSImport("@fluentui/react-icons/lib/components/BrowserScreenShotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BrowserScreenShotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
