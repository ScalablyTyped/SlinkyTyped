...
object CompareUnevenIcon {
  @JSImport("@fluentui/react-icons/lib/components/CompareUnevenIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CompareUnevenIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
