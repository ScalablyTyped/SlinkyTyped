...
object PDFIcon {
  @JSImport("@fluentui/react-icons/lib/components/PDFIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PDFIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
