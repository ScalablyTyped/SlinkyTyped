...
object CircleAdditionSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/CircleAdditionSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CircleAdditionSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
