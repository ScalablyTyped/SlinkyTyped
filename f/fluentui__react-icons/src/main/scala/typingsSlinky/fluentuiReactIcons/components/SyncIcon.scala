...
object SyncIcon {
  @JSImport("@fluentui/react-icons/lib/components/SyncIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SyncIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
