...
object DocumentationIcon {
  @JSImport("@fluentui/react-icons/lib/components/DocumentationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DocumentationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
