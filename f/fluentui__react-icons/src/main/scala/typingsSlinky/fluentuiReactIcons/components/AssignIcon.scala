...
object AssignIcon {
  @JSImport("@fluentui/react-icons/lib/components/AssignIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AssignIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
