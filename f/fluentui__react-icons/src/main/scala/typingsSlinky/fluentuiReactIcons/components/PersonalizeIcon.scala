...
object PersonalizeIcon {
  @JSImport("@fluentui/react-icons/lib/components/PersonalizeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PersonalizeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
