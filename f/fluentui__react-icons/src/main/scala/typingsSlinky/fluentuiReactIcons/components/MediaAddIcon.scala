...
object MediaAddIcon {
  @JSImport("@fluentui/react-icons/lib/components/MediaAddIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MediaAddIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
