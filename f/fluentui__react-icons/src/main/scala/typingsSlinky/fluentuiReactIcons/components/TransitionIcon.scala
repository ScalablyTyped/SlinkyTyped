...
object TransitionIcon {
  @JSImport("@fluentui/react-icons/lib/components/TransitionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TransitionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
