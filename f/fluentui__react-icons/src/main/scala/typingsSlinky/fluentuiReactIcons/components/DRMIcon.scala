...
object DRMIcon {
  @JSImport("@fluentui/react-icons/lib/components/DRMIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DRMIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
