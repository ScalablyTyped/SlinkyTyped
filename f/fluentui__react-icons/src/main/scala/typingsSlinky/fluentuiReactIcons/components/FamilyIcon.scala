...
object FamilyIcon {
  @JSImport("@fluentui/react-icons/lib/components/FamilyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FamilyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
