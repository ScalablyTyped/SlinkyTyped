...
object MultiSelectMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MultiSelectMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MultiSelectMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
