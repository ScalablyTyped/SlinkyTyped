...
object WaffleIcon {
  ...
  @JSImport("@fluentui/react-icons", "WaffleIcon")
  @js.native
  ...
  implicit def make(companion: WaffleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
