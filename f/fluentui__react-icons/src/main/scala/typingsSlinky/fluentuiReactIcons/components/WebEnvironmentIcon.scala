...
object WebEnvironmentIcon {
  @JSImport("@fluentui/react-icons/lib/components/WebEnvironmentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WebEnvironmentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
