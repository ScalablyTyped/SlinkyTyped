...
object SaveAndCloseIcon {
  @JSImport("@fluentui/react-icons/lib/components/SaveAndCloseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SaveAndCloseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
