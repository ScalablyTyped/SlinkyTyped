...
object EmptyRecycleBinIcon {
  @JSImport("@fluentui/react-icons/lib/components/EmptyRecycleBinIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EmptyRecycleBinIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
