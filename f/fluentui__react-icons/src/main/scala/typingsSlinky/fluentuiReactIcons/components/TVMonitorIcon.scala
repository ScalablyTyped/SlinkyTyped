...
object TVMonitorIcon {
  @JSImport("@fluentui/react-icons/lib/components/TVMonitorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TVMonitorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
