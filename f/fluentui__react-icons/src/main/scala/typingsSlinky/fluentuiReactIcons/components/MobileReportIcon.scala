...
object MobileReportIcon {
  @JSImport("@fluentui/react-icons/lib/components/MobileReportIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MobileReportIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
