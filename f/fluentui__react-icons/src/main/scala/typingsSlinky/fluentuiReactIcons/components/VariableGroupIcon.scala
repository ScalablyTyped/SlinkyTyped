...
object VariableGroupIcon {
  @JSImport("@fluentui/react-icons/lib/components/VariableGroupIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VariableGroupIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
