...
object PictureCenterIcon {
  @JSImport("@fluentui/react-icons/lib/components/PictureCenterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PictureCenterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
