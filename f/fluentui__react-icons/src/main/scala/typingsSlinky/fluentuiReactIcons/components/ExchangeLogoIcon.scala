...
object ExchangeLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/ExchangeLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExchangeLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
