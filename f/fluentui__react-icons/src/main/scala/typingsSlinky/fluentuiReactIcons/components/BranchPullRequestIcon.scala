...
object BranchPullRequestIcon {
  @JSImport("@fluentui/react-icons/lib/components/BranchPullRequestIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BranchPullRequestIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
