...
object SkipBack10Icon {
  @JSImport("@fluentui/react-icons/lib/components/SkipBack10Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkipBack10Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
