...
object BacklogIcon {
  @JSImport("@fluentui/react-icons/lib/components/BacklogIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BacklogIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
