...
object AlignJustifyIcon {
  @JSImport("@fluentui/react-icons", "AlignJustifyIcon")
  @js.native
  ...
  implicit def make(companion: AlignJustifyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
