...
object CurrencyIcon {
  @JSImport("@fluentui/react-icons/lib/components/CurrencyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CurrencyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
