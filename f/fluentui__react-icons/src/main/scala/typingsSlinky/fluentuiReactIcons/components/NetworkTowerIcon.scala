...
object NetworkTowerIcon {
  @JSImport("@fluentui/react-icons/lib/components/NetworkTowerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NetworkTowerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
