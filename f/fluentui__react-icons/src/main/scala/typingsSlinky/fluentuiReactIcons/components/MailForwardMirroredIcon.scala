...
object MailForwardMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailForwardMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailForwardMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
