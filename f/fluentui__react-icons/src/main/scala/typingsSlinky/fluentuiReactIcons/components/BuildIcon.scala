...
object BuildIcon {
  @JSImport("@fluentui/react-icons/lib/components/BuildIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BuildIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
