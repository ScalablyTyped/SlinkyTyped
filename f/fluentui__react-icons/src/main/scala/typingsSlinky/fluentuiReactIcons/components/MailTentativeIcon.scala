...
object MailTentativeIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailTentativeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailTentativeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
