...
object WifiEthernetIcon {
  @JSImport("@fluentui/react-icons/lib/components/WifiEthernetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WifiEthernetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
