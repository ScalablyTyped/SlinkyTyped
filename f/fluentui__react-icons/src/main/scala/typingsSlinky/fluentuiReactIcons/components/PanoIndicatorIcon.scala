...
object PanoIndicatorIcon {
  @JSImport("@fluentui/react-icons/lib/components/PanoIndicatorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PanoIndicatorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
