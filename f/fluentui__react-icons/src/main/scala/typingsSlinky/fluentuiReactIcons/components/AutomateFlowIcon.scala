...
object AutomateFlowIcon {
  @JSImport("@fluentui/react-icons/lib/components/AutomateFlowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AutomateFlowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
