...
object CSharpLanguageIcon {
  @JSImport("@fluentui/react-icons/lib/components/CSharpLanguageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CSharpLanguageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
