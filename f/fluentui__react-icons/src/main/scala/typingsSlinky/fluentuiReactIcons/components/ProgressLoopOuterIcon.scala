...
object ProgressLoopOuterIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProgressLoopOuterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProgressLoopOuterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
