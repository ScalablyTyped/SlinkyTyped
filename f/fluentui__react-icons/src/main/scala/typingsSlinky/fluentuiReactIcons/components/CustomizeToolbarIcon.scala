...
object CustomizeToolbarIcon {
  @JSImport("@fluentui/react-icons/lib/components/CustomizeToolbarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CustomizeToolbarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
