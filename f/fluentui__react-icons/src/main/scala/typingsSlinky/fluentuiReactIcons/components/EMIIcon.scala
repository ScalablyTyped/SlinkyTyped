...
object EMIIcon {
  @JSImport("@fluentui/react-icons/lib/components/EMIIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EMIIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
