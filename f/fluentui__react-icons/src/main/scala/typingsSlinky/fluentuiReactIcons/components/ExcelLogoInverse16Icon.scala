...
object ExcelLogoInverse16Icon {
  @JSImport("@fluentui/react-icons/lib/components/ExcelLogoInverse16Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExcelLogoInverse16Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
