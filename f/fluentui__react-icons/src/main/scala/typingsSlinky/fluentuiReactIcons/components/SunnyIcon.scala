...
object SunnyIcon {
  @JSImport("@fluentui/react-icons/lib/components/SunnyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SunnyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
