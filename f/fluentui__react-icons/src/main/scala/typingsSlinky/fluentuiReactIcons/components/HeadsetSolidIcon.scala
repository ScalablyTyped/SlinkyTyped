...
object HeadsetSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/HeadsetSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HeadsetSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
