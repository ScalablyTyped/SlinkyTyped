...
object SortLinesIcon {
  @JSImport("@fluentui/react-icons/lib/components/SortLinesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SortLinesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
