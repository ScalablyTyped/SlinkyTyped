...
object ContactCardIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContactCardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContactCardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
