...
object AzureAPIManagementIcon {
  @JSImport("@fluentui/react-icons/lib/components/AzureAPIManagementIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AzureAPIManagementIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
