...
object TrimStartIcon {
  @JSImport("@fluentui/react-icons/lib/components/TrimStartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TrimStartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
