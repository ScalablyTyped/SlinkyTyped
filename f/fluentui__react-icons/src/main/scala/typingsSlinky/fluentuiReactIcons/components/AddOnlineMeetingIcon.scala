...
object AddOnlineMeetingIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddOnlineMeetingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddOnlineMeetingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
