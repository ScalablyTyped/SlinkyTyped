...
object BrightnessIcon {
  @JSImport("@fluentui/react-icons/lib/components/BrightnessIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BrightnessIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
