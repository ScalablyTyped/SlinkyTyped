...
object SpellingIcon {
  @JSImport("@fluentui/react-icons/lib/components/SpellingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SpellingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
