...
object LocationCircleIcon {
  @JSImport("@fluentui/react-icons/lib/components/LocationCircleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LocationCircleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
