...
object CommentSolidIcon {
  @JSImport("@fluentui/react-icons", "CommentSolidIcon")
  @js.native
  ...
  implicit def make(companion: CommentSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
