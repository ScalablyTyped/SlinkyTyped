...
object ScrollUpDownIcon {
  @JSImport("@fluentui/react-icons/lib/components/ScrollUpDownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ScrollUpDownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
