...
object SmartGlassRemoteIcon {
  @JSImport("@fluentui/react-icons/lib/components/SmartGlassRemoteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SmartGlassRemoteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
