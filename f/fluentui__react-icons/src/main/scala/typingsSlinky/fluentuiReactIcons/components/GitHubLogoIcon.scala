...
object GitHubLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/GitHubLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GitHubLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
