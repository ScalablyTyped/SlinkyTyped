...
object GoToDashboardIcon {
  @JSImport("@fluentui/react-icons/lib/components/GoToDashboardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GoToDashboardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
