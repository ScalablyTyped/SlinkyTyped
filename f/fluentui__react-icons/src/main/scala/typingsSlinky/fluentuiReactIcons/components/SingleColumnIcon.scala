...
object SingleColumnIcon {
  @JSImport("@fluentui/react-icons/lib/components/SingleColumnIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SingleColumnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
