...
object UnfavoriteIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnfavoriteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnfavoriteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
