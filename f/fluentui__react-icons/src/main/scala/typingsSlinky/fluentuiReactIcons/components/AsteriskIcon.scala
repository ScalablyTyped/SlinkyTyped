...
object AsteriskIcon {
  @JSImport("@fluentui/react-icons/lib/components/AsteriskIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AsteriskIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
