...
object FileCSSIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileCSSIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileCSSIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
