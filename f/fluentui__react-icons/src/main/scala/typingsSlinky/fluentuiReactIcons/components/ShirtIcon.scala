...
object ShirtIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShirtIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShirtIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
