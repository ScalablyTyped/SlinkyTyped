...
object PasteIcon {
  @JSImport("@fluentui/react-icons/lib/components/PasteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PasteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
