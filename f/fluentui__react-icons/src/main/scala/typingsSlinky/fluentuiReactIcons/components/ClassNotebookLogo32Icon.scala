...
object ClassNotebookLogo32Icon {
  @JSImport("@fluentui/react-icons/lib/components/ClassNotebookLogo32Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClassNotebookLogo32Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
