...
object NoteForwardIcon {
  @JSImport("@fluentui/react-icons/lib/components/NoteForwardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NoteForwardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
