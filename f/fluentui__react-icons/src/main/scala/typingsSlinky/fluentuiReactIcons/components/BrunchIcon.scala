...
object BrunchIcon {
  @JSImport("@fluentui/react-icons/lib/components/BrunchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BrunchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
