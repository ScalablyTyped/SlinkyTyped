...
object PinIcon {
  @JSImport("@fluentui/react-icons/lib/components/PinIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PinIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
