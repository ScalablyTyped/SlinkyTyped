...
object DefaultRatioIcon {
  @JSImport("@fluentui/react-icons/lib/components/DefaultRatioIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DefaultRatioIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
