...
object OpenInNewWindowIcon {
  @JSImport("@fluentui/react-icons/lib/components/OpenInNewWindowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OpenInNewWindowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
