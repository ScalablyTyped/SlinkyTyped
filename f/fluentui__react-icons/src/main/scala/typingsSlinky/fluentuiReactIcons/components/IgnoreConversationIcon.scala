...
object IgnoreConversationIcon {
  @JSImport("@fluentui/react-icons/lib/components/IgnoreConversationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IgnoreConversationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
