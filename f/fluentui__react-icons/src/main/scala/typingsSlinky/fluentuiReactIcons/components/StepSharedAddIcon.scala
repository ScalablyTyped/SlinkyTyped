...
object StepSharedAddIcon {
  @JSImport("@fluentui/react-icons/lib/components/StepSharedAddIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StepSharedAddIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
