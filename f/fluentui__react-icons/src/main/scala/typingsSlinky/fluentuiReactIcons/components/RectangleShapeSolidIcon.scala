...
object RectangleShapeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/RectangleShapeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RectangleShapeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
