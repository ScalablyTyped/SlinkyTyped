...
object HardDriveLockIcon {
  @JSImport("@fluentui/react-icons/lib/components/HardDriveLockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HardDriveLockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
