...
object GitLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/GitLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GitLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
