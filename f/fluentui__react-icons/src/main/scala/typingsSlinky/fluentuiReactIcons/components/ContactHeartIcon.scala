...
object ContactHeartIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContactHeartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContactHeartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
