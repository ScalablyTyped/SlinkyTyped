...
object QuestionnaireMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/QuestionnaireMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QuestionnaireMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
