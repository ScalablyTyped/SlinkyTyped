...
object AzureLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/AzureLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AzureLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
