...
object NumberedListTextMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/NumberedListTextMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NumberedListTextMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
