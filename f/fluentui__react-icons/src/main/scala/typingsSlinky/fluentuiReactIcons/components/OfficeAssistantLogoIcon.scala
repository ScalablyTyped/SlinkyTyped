...
object OfficeAssistantLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/OfficeAssistantLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OfficeAssistantLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
