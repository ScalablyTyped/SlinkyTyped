...
object SearchAndAppsIcon {
  @JSImport("@fluentui/react-icons/lib/components/SearchAndAppsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SearchAndAppsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
