...
object CalendarAgendaIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalendarAgendaIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalendarAgendaIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
