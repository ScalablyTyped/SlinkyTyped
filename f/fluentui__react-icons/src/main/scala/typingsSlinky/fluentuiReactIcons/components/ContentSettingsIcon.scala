...
object ContentSettingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContentSettingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContentSettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
