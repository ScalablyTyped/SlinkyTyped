...
object TestStepIcon {
  @JSImport("@fluentui/react-icons/lib/components/TestStepIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TestStepIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
