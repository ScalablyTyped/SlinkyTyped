...
object DecreaseIndentArrowIcon {
  @JSImport("@fluentui/react-icons/lib/components/DecreaseIndentArrowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DecreaseIndentArrowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
