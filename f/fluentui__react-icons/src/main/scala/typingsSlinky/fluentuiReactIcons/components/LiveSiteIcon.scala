...
object LiveSiteIcon {
  @JSImport("@fluentui/react-icons/lib/components/LiveSiteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LiveSiteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
