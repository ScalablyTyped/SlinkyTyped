...
object UserGaugeIcon {
  @JSImport("@fluentui/react-icons/lib/components/UserGaugeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UserGaugeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
