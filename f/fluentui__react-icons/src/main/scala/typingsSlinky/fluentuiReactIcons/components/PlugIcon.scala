...
object PlugIcon {
  @JSImport("@fluentui/react-icons/lib/components/PlugIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PlugIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
