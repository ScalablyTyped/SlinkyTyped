...
object FiltersIcon {
  @JSImport("@fluentui/react-icons/lib/components/FiltersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FiltersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
