...
object ProgressRingDotsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProgressRingDotsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProgressRingDotsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
