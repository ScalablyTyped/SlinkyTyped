...
object LookupEntitiesIcon {
  @JSImport("@fluentui/react-icons/lib/components/LookupEntitiesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LookupEntitiesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
