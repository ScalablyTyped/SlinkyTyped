...
object DelveAnalyticsIcon {
  
  @JSImport("@fluentui/react-icons", "DelveAnalyticsIcon")
  @js.native
  ...
  implicit def make(companion: DelveAnalyticsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
