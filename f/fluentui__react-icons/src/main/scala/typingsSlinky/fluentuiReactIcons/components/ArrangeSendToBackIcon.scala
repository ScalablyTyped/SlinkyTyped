...
object ArrangeSendToBackIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrangeSendToBackIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrangeSendToBackIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
