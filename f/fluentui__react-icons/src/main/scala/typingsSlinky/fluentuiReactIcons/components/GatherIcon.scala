...
object GatherIcon {
  @JSImport("@fluentui/react-icons/lib/components/GatherIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GatherIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
