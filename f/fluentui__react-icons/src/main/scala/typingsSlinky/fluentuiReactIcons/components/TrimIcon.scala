...
object TrimIcon {
  @JSImport("@fluentui/react-icons/lib/components/TrimIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TrimIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
