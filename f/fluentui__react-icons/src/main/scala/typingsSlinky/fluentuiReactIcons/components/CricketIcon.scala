...
object CricketIcon {
  @JSImport("@fluentui/react-icons/lib/components/CricketIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CricketIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
