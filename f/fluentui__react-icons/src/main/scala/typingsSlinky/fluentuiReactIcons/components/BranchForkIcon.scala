...
object BranchForkIcon {
  @JSImport("@fluentui/react-icons/lib/components/BranchForkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BranchForkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
