...
object SkypeMessageIcon {
  
  @JSImport("@fluentui/react-icons", "SkypeMessageIcon")
  @js.native
  ...
  implicit def make(companion: SkypeMessageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
