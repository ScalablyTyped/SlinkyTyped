...
object DoubleChevronLeftMedIcon {
  @JSImport("@fluentui/react-icons/lib/components/DoubleChevronLeftMedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DoubleChevronLeftMedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
