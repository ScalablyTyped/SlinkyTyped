...
object HexagonIcon {
  @JSImport("@fluentui/react-icons/lib/components/HexagonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HexagonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
