...
object AccountBrowserIcon {
  @JSImport("@fluentui/react-icons/lib/components/AccountBrowserIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AccountBrowserIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
