...
object AddSpaceBeforeIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddSpaceBeforeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddSpaceBeforeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
