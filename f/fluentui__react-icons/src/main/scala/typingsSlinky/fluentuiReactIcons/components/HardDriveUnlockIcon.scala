...
object HardDriveUnlockIcon {
  @JSImport("@fluentui/react-icons/lib/components/HardDriveUnlockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HardDriveUnlockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
