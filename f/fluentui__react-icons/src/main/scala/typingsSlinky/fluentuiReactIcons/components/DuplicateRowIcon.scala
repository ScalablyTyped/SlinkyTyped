...
object DuplicateRowIcon {
  @JSImport("@fluentui/react-icons/lib/components/DuplicateRowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DuplicateRowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
