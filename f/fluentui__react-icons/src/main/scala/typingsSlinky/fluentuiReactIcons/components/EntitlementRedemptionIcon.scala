...
object EntitlementRedemptionIcon {
  @JSImport("@fluentui/react-icons/lib/components/EntitlementRedemptionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EntitlementRedemptionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
