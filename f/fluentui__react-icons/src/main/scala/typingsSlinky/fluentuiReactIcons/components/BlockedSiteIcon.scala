...
object BlockedSiteIcon {
  @JSImport("@fluentui/react-icons/lib/components/BlockedSiteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlockedSiteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
