...
object NewMailIcon {
  @JSImport("@fluentui/react-icons/lib/components/NewMailIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NewMailIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
