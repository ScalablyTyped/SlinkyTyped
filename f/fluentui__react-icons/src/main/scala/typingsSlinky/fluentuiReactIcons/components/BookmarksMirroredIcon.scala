...
object BookmarksMirroredIcon {
  
  @JSImport("@fluentui/react-icons", "BookmarksMirroredIcon")
  @js.native
  ...
  implicit def make(companion: BookmarksMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
