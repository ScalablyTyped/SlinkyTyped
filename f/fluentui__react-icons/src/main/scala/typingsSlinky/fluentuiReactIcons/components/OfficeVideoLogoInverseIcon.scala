...
object OfficeVideoLogoInverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/OfficeVideoLogoInverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OfficeVideoLogoInverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
