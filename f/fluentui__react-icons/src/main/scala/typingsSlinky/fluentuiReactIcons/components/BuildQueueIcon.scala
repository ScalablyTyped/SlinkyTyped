...
object BuildQueueIcon {
  @JSImport("@fluentui/react-icons/lib/components/BuildQueueIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BuildQueueIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
