...
object PreviousIcon {
  @JSImport("@fluentui/react-icons/lib/components/PreviousIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PreviousIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
