...
object ScaleVolumeIcon {
  @JSImport("@fluentui/react-icons/lib/components/ScaleVolumeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ScaleVolumeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
