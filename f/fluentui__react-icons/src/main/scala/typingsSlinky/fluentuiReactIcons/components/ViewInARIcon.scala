...
object ViewInARIcon {
  @JSImport("@fluentui/react-icons/lib/components/ViewInARIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ViewInARIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
