...
object WorldClockIcon {
  @JSImport("@fluentui/react-icons/lib/components/WorldClockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WorldClockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
