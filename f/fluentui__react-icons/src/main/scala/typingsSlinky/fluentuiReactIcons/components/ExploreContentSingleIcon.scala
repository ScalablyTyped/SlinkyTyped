...
object ExploreContentSingleIcon {
  @JSImport("@fluentui/react-icons/lib/components/ExploreContentSingleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExploreContentSingleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
