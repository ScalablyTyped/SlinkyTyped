...
object BranchMergeIcon {
  @JSImport("@fluentui/react-icons/lib/components/BranchMergeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BranchMergeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
