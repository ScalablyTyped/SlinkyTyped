...
object PowerShellIcon {
  @JSImport("@fluentui/react-icons/lib/components/PowerShellIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PowerShellIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
