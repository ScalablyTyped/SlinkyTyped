...
object CityNextIcon {
  @JSImport("@fluentui/react-icons/lib/components/CityNextIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CityNextIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
