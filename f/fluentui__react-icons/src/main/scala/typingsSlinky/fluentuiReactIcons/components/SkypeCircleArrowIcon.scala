...
object SkypeCircleArrowIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeCircleArrowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeCircleArrowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
