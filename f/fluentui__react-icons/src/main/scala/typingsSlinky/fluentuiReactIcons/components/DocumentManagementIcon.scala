...
object DocumentManagementIcon {
  @JSImport("@fluentui/react-icons/lib/components/DocumentManagementIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DocumentManagementIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
