...
object StackedBarChartIcon {
  @JSImport("@fluentui/react-icons/lib/components/StackedBarChartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StackedBarChartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
