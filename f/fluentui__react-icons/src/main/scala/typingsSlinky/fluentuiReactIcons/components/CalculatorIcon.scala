...
object CalculatorIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalculatorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalculatorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
