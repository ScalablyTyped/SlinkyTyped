...
object DockLeftIcon {
  @JSImport("@fluentui/react-icons/lib/components/DockLeftIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DockLeftIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
