...
object GoIcon {
  @JSImport("@fluentui/react-icons/lib/components/GoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
