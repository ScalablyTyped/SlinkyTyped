...
object ColumnRightTwoThirdsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ColumnRightTwoThirdsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ColumnRightTwoThirdsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
