...
object CatIcon {
  @JSImport("@fluentui/react-icons/lib/components/CatIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CatIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
