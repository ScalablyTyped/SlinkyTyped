...
object RemoveLinkXIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveLinkXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveLinkXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
