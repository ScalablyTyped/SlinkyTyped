...
object CalculatorPercentageIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalculatorPercentageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalculatorPercentageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
