...
object TeethIcon {
  @JSImport("@fluentui/react-icons/lib/components/TeethIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TeethIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
