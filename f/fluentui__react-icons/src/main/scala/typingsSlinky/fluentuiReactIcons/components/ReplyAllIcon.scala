...
object ReplyAllIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReplyAllIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReplyAllIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
