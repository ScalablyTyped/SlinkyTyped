...
object DropShapeIcon {
  @JSImport("@fluentui/react-icons/lib/components/DropShapeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DropShapeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
