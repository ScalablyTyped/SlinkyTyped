...
object CollegeFootballIcon {
  @JSImport("@fluentui/react-icons/lib/components/CollegeFootballIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CollegeFootballIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
