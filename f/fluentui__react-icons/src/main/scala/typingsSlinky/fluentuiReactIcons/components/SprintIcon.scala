...
object SprintIcon {
  @JSImport("@fluentui/react-icons/lib/components/SprintIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SprintIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
