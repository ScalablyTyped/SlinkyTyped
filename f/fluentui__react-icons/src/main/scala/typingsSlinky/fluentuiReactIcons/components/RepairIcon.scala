...
object RepairIcon {
  @JSImport("@fluentui/react-icons/lib/components/RepairIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RepairIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
