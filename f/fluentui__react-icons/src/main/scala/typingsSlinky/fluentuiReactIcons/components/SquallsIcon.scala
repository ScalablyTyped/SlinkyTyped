...
object SquallsIcon {
  @JSImport("@fluentui/react-icons/lib/components/SquallsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SquallsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
