...
object OnboardingIcon {
  @JSImport("@fluentui/react-icons/lib/components/OnboardingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OnboardingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
