...
object RedEyeIcon {
  @JSImport("@fluentui/react-icons/lib/components/RedEyeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RedEyeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
