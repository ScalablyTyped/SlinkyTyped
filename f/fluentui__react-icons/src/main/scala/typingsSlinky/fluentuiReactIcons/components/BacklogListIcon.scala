...
object BacklogListIcon {
  @JSImport("@fluentui/react-icons/lib/components/BacklogListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BacklogListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
