...
object RibbonSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/RibbonSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RibbonSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
