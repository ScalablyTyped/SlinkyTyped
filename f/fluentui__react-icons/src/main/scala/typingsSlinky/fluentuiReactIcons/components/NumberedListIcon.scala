...
object NumberedListIcon {
  @JSImport("@fluentui/react-icons/lib/components/NumberedListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NumberedListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
