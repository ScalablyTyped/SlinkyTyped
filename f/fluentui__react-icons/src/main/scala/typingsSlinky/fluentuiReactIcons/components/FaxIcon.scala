...
object FaxIcon {
  @JSImport("@fluentui/react-icons/lib/components/FaxIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FaxIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
