...
object OfflineStorageSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/OfflineStorageSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OfflineStorageSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
