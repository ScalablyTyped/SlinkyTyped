...
object MiracastLogoLargeIcon {
  @JSImport("@fluentui/react-icons/lib/components/MiracastLogoLargeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MiracastLogoLargeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
