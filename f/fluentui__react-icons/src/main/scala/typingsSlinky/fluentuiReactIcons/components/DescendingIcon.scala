...
object DescendingIcon {
  @JSImport("@fluentui/react-icons/lib/components/DescendingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DescendingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
