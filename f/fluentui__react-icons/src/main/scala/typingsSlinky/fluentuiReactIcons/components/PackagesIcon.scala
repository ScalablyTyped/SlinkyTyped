...
object PackagesIcon {
  @JSImport("@fluentui/react-icons/lib/components/PackagesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PackagesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
