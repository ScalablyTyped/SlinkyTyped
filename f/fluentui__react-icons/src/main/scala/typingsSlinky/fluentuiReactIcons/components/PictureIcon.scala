...
object PictureIcon {
  @JSImport("@fluentui/react-icons/lib/components/PictureIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PictureIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
