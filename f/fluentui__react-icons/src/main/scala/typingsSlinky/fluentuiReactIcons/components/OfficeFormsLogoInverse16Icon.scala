...
object OfficeFormsLogoInverse16Icon {
  
  @JSImport("@fluentui/react-icons", "OfficeFormsLogoInverse16Icon")
  @js.native
  ...
  implicit def make(companion: OfficeFormsLogoInverse16Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
