...
object ContactListIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContactListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContactListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
