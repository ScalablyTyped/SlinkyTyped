...
object ErrorIcon {
  @JSImport("@fluentui/react-icons/lib/components/ErrorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ErrorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
