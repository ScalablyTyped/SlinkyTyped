...
object MSNVideosSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/MSNVideosSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MSNVideosSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
