...
object PinSolidOff12Icon {
  @JSImport("@fluentui/react-icons/lib/components/PinSolidOff12Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PinSolidOff12Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
