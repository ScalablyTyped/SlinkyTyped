...
object AssessmentGroupIcon {
  @JSImport("@fluentui/react-icons/lib/components/AssessmentGroupIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AssessmentGroupIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
