...
object BugIcon {
  @JSImport("@fluentui/react-icons/lib/components/BugIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BugIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
