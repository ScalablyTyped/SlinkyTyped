...
object MailAlertIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailAlertIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailAlertIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
