...
object MailOptionsIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailOptionsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailOptionsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
