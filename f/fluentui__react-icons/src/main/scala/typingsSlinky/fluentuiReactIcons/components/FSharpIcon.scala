...
object FSharpIcon {
  @JSImport("@fluentui/react-icons/lib/components/FSharpIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FSharpIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
