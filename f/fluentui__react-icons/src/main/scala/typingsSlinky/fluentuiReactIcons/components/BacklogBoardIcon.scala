...
object BacklogBoardIcon {
  @JSImport("@fluentui/react-icons/lib/components/BacklogBoardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BacklogBoardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
