...
object AllAppsIcon {
  @JSImport("@fluentui/react-icons/lib/components/AllAppsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AllAppsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
