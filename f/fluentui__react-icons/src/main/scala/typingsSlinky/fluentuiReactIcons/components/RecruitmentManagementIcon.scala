...
object RecruitmentManagementIcon {
  @JSImport("@fluentui/react-icons/lib/components/RecruitmentManagementIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RecruitmentManagementIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
