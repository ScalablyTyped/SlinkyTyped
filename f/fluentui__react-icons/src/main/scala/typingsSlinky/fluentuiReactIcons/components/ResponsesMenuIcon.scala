...
object ResponsesMenuIcon {
  @JSImport("@fluentui/react-icons/lib/components/ResponsesMenuIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ResponsesMenuIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
