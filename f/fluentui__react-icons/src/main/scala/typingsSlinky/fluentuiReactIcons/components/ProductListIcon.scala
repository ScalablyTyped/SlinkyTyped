...
object ProductListIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProductListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProductListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
