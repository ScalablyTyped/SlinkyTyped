...
object CalculatorDeltaIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalculatorDeltaIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalculatorDeltaIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
