...
object PauseIcon {
  @JSImport("@fluentui/react-icons/lib/components/PauseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PauseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
