...
object ToDoLogoTopIcon {
  
  @JSImport("@fluentui/react-icons", "ToDoLogoTopIcon")
  @js.native
  ...
  implicit def make(companion: ToDoLogoTopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
