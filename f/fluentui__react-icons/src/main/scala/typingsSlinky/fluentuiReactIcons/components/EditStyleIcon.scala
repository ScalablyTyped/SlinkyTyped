...
object EditStyleIcon {
  @JSImport("@fluentui/react-icons/lib/components/EditStyleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EditStyleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
