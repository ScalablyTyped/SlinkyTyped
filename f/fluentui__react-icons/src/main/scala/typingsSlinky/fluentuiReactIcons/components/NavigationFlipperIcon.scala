...
object NavigationFlipperIcon {
  @JSImport("@fluentui/react-icons/lib/components/NavigationFlipperIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NavigationFlipperIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
