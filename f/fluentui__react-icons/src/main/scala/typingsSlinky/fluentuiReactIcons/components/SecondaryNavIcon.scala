...
object SecondaryNavIcon {
  @JSImport("@fluentui/react-icons/lib/components/SecondaryNavIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SecondaryNavIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
