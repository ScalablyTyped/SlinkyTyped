...
object F12DevToolsIcon {
  @JSImport("@fluentui/react-icons/lib/components/F12DevToolsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: F12DevToolsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
