...
object TimeSheetIcon {
  @JSImport("@fluentui/react-icons/lib/components/TimeSheetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TimeSheetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
