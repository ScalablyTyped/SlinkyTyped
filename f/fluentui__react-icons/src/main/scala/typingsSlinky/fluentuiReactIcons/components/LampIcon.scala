...
object LampIcon {
  @JSImport("@fluentui/react-icons/lib/components/LampIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LampIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
