...
object CommentActiveIcon {
  @JSImport("@fluentui/react-icons/lib/components/CommentActiveIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CommentActiveIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
