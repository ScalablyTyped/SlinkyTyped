...
object IOTIcon {
  @JSImport("@fluentui/react-icons/lib/components/IOTIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IOTIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
