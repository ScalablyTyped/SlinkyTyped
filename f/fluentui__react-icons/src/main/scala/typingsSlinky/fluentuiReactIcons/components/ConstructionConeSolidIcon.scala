...
object ConstructionConeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/ConstructionConeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ConstructionConeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
