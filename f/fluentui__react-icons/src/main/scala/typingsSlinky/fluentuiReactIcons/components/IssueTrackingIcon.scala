...
object IssueTrackingIcon {
  @JSImport("@fluentui/react-icons/lib/components/IssueTrackingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IssueTrackingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
