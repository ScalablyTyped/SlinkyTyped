...
object VacationIcon {
  @JSImport("@fluentui/react-icons/lib/components/VacationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VacationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
