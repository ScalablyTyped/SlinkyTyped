...
object ReservationOrdersIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReservationOrdersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReservationOrdersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
