...
object ExternalGitIcon {
  @JSImport("@fluentui/react-icons/lib/components/ExternalGitIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExternalGitIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
