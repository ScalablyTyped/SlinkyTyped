...
object AutoDeploySettingsIcon {
  ...
  implicit def make(companion: AutoDeploySettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
