...
object TeamFavoriteIcon {
  @JSImport("@fluentui/react-icons/lib/components/TeamFavoriteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TeamFavoriteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
