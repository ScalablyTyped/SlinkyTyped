...
object ChevronDownEnd6Icon {
  @JSImport("@fluentui/react-icons/lib/components/ChevronDownEnd6Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChevronDownEnd6Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
