...
object StepSharedIcon {
  @JSImport("@fluentui/react-icons/lib/components/StepSharedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StepSharedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
