...
object InsertIcon {
  @JSImport("@fluentui/react-icons/lib/components/InsertIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InsertIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
