...
object USBIcon {
  @JSImport("@fluentui/react-icons/lib/components/USBIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: USBIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
