...
object MailReplyMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailReplyMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailReplyMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
