...
object FileCodeIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileCodeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileCodeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
