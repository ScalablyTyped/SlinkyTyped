...
object HeaderIcon {
  @JSImport("@fluentui/react-icons/lib/components/HeaderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HeaderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
