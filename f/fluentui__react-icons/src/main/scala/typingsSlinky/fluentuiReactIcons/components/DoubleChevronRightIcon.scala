...
object DoubleChevronRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/DoubleChevronRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DoubleChevronRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
