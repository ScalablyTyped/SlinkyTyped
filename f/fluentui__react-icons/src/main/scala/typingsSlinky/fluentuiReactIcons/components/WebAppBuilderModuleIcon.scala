...
object WebAppBuilderModuleIcon {
  @JSImport("@fluentui/react-icons/lib/components/WebAppBuilderModuleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WebAppBuilderModuleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
