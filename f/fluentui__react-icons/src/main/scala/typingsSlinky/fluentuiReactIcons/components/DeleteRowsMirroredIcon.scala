...
object DeleteRowsMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/DeleteRowsMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DeleteRowsMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
