...
object SkypeCircleClockIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeCircleClockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeCircleClockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
