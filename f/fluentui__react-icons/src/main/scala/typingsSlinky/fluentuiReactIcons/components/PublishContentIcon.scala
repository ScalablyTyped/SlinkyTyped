...
object PublishContentIcon {
  @JSImport("@fluentui/react-icons/lib/components/PublishContentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PublishContentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
