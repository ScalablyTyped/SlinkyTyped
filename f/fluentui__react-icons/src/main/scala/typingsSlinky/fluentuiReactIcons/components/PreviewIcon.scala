...
object PreviewIcon {
  @JSImport("@fluentui/react-icons/lib/components/PreviewIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PreviewIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
