...
object CalendarSettingsMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalendarSettingsMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalendarSettingsMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
