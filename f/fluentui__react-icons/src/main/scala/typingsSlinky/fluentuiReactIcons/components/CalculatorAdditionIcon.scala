...
object CalculatorAdditionIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalculatorAdditionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalculatorAdditionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
