...
object ExportIcon {
  @JSImport("@fluentui/react-icons/lib/components/ExportIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExportIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
