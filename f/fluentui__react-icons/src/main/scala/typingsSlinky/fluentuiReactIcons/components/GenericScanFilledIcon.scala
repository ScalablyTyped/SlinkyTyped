...
object GenericScanFilledIcon {
  @JSImport("@fluentui/react-icons/lib/components/GenericScanFilledIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GenericScanFilledIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
