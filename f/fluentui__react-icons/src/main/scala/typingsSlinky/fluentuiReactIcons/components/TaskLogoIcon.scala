...
object TaskLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/TaskLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TaskLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
