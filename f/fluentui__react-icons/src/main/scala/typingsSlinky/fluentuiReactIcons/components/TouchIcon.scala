...
object TouchIcon {
  @JSImport("@fluentui/react-icons/lib/components/TouchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TouchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
