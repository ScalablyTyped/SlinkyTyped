...
object LocationIcon {
  @JSImport("@fluentui/react-icons/lib/components/LocationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LocationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
