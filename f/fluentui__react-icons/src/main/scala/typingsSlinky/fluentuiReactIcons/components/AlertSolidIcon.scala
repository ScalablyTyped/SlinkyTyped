...
object AlertSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlertSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlertSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
