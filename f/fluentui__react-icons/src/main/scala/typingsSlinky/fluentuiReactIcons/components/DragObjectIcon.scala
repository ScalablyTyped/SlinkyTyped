...
object DragObjectIcon {
  @JSImport("@fluentui/react-icons/lib/components/DragObjectIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DragObjectIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
