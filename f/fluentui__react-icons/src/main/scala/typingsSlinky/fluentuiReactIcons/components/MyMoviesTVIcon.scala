...
object MyMoviesTVIcon {
  @JSImport("@fluentui/react-icons/lib/components/MyMoviesTVIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MyMoviesTVIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
