...
object EducationIcon {
  @JSImport("@fluentui/react-icons/lib/components/EducationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EducationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
