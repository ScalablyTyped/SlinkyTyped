...
object BusinessHoursSignIcon {
  @JSImport("@fluentui/react-icons/lib/components/BusinessHoursSignIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BusinessHoursSignIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
