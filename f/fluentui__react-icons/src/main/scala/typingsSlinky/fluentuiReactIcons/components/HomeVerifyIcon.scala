...
object HomeVerifyIcon {
  @JSImport("@fluentui/react-icons/lib/components/HomeVerifyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HomeVerifyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
