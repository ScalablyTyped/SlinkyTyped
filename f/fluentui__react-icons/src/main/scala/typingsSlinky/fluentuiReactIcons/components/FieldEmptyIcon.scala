...
object FieldEmptyIcon {
  @JSImport("@fluentui/react-icons/lib/components/FieldEmptyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FieldEmptyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
