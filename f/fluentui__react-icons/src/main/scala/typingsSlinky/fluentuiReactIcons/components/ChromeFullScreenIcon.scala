...
object ChromeFullScreenIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChromeFullScreenIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChromeFullScreenIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
