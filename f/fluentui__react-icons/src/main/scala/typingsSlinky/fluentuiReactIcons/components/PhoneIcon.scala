...
object PhoneIcon {
  @JSImport("@fluentui/react-icons/lib/components/PhoneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PhoneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
