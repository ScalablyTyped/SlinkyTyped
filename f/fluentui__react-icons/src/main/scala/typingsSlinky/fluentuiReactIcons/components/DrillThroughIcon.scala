...
object DrillThroughIcon {
  @JSImport("@fluentui/react-icons/lib/components/DrillThroughIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DrillThroughIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
