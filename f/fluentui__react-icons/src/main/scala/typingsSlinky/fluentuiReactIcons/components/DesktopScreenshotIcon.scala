...
object DesktopScreenshotIcon {
  @JSImport("@fluentui/react-icons/lib/components/DesktopScreenshotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DesktopScreenshotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
