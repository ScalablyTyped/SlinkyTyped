...
object StreetsideSplitMinimizeIcon {
  @JSImport("@fluentui/react-icons/lib/components/StreetsideSplitMinimizeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StreetsideSplitMinimizeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
