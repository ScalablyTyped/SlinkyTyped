...
object ChevronFold10Icon {
  @JSImport("@fluentui/react-icons/lib/components/ChevronFold10Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChevronFold10Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
