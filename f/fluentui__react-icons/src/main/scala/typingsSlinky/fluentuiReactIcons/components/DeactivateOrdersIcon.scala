...
object DeactivateOrdersIcon {
  @JSImport("@fluentui/react-icons/lib/components/DeactivateOrdersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DeactivateOrdersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
