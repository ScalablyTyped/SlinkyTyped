...
object SelectAllIcon {
  @JSImport("@fluentui/react-icons/lib/components/SelectAllIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SelectAllIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
