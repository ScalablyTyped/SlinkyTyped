...
object FileTypeSolutionIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileTypeSolutionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileTypeSolutionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
