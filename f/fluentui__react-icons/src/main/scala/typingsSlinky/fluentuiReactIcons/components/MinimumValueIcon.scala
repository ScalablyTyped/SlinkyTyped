...
object MinimumValueIcon {
  @JSImport("@fluentui/react-icons/lib/components/MinimumValueIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MinimumValueIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
