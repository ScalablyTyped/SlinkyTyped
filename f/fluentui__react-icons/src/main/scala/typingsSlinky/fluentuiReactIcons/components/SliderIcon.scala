...
object SliderIcon {
  @JSImport("@fluentui/react-icons/lib/components/SliderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SliderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
