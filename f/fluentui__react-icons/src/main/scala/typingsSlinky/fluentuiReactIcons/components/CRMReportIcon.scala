...
object CRMReportIcon {
  @JSImport("@fluentui/react-icons/lib/components/CRMReportIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CRMReportIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
