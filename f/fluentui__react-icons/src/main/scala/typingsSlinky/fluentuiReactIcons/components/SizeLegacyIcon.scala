...
object SizeLegacyIcon {
  @JSImport("@fluentui/react-icons/lib/components/SizeLegacyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SizeLegacyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
