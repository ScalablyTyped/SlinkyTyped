...
object WaffleOffice365Icon {
  @JSImport("@fluentui/react-icons/lib/components/WaffleOffice365Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WaffleOffice365Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
