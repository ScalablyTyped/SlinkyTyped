...
object MiniContractIcon {
  @JSImport("@fluentui/react-icons/lib/components/MiniContractIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MiniContractIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
