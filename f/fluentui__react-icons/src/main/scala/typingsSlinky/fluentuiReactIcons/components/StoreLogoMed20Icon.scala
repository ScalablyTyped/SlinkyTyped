...
object StoreLogoMed20Icon {
  @JSImport("@fluentui/react-icons", "StoreLogoMed20Icon")
  @js.native
  ...
  implicit def make(companion: StoreLogoMed20Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
