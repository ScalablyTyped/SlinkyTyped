...
object GroupedDescendingIcon {
  @JSImport("@fluentui/react-icons/lib/components/GroupedDescendingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GroupedDescendingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
