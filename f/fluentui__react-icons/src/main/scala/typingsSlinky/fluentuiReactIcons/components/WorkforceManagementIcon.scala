...
object WorkforceManagementIcon {
  @JSImport("@fluentui/react-icons/lib/components/WorkforceManagementIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WorkforceManagementIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
