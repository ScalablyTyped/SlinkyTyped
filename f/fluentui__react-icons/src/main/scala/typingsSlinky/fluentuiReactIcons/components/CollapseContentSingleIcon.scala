...
object CollapseContentSingleIcon {
  @JSImport("@fluentui/react-icons/lib/components/CollapseContentSingleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CollapseContentSingleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
