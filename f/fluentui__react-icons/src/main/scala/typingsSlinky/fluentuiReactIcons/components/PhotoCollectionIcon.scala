...
object PhotoCollectionIcon {
  @JSImport("@fluentui/react-icons/lib/components/PhotoCollectionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PhotoCollectionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
