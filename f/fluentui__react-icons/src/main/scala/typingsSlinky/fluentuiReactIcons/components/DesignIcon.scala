...
object DesignIcon {
  @JSImport("@fluentui/react-icons/lib/components/DesignIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DesignIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
