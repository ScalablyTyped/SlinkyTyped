...
object PaymentCardIcon {
  @JSImport("@fluentui/react-icons/lib/components/PaymentCardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PaymentCardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
