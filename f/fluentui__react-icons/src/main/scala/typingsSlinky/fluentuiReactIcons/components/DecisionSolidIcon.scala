...
object DecisionSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/DecisionSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DecisionSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
