...
object VariableIcon {
  @JSImport("@fluentui/react-icons/lib/components/VariableIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VariableIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
