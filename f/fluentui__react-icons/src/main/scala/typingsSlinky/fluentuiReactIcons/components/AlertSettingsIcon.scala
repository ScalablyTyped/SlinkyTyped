...
object AlertSettingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlertSettingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlertSettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
