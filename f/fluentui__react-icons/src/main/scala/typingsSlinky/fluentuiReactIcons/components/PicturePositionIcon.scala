...
object PicturePositionIcon {
  @JSImport("@fluentui/react-icons/lib/components/PicturePositionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PicturePositionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
