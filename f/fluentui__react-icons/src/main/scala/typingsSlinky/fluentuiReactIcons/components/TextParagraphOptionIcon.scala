...
object TextParagraphOptionIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextParagraphOptionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextParagraphOptionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
