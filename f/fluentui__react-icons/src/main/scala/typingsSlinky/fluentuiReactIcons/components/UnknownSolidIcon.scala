...
object UnknownSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnknownSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnknownSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
