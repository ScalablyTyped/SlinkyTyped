...
object InsertColumnsLeftIcon {
  @JSImport("@fluentui/react-icons/lib/components/InsertColumnsLeftIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InsertColumnsLeftIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
