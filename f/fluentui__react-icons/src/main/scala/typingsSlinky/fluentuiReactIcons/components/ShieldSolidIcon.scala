...
object ShieldSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShieldSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShieldSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
