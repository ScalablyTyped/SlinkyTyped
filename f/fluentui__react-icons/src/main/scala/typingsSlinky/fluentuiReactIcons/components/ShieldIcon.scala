...
object ShieldIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShieldIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShieldIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
