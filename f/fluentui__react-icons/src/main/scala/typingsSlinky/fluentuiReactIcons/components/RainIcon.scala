...
object RainIcon {
  @JSImport("@fluentui/react-icons/lib/components/RainIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RainIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
