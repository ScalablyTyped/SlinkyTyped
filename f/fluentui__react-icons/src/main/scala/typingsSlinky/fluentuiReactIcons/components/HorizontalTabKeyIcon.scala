...
object HorizontalTabKeyIcon {
  @JSImport("@fluentui/react-icons/lib/components/HorizontalTabKeyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HorizontalTabKeyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
