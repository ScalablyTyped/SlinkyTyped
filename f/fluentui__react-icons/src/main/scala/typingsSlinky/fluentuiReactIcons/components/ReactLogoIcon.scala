...
object ReactLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReactLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReactLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
