...
object WipePhoneIcon {
  @JSImport("@fluentui/react-icons/lib/components/WipePhoneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WipePhoneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
