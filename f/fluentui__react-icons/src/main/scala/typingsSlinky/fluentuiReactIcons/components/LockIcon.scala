...
object LockIcon {
  @JSImport("@fluentui/react-icons/lib/components/LockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
