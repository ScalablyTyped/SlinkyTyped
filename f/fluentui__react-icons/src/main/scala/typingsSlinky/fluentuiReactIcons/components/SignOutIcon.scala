...
object SignOutIcon {
  @JSImport("@fluentui/react-icons/lib/components/SignOutIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SignOutIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
