...
object HotelIcon {
  @JSImport("@fluentui/react-icons/lib/components/HotelIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HotelIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
