...
object RegistryEditorIcon {
  @JSImport("@fluentui/react-icons/lib/components/RegistryEditorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RegistryEditorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
