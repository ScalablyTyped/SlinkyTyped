...
object Header1Icon {
  @JSImport("@fluentui/react-icons/lib/components/Header1Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Header1Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
