...
object RadioBtnOnIcon {
  @JSImport("@fluentui/react-icons/lib/components/RadioBtnOnIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RadioBtnOnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
