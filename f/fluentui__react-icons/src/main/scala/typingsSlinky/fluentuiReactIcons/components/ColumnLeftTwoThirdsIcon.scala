...
object ColumnLeftTwoThirdsIcon {
  @JSImport("@fluentui/react-icons", "ColumnLeftTwoThirdsIcon")
  @js.native
  ...
  implicit def make(companion: ColumnLeftTwoThirdsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
