...
object BulletedListTextMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/BulletedListTextMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BulletedListTextMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
