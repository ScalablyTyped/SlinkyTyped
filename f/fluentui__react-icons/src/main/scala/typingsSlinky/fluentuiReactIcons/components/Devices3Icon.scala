...
object Devices3Icon {
  @JSImport("@fluentui/react-icons/lib/components/Devices3Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Devices3Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
