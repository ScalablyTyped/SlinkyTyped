...
object RocketIcon {
  @JSImport("@fluentui/react-icons/lib/components/RocketIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RocketIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
