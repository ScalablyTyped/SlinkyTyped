...
object CortanaLogoBeckonOuterIcon {
  @JSImport("@fluentui/react-icons/lib/components/CortanaLogoBeckonOuterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CortanaLogoBeckonOuterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
