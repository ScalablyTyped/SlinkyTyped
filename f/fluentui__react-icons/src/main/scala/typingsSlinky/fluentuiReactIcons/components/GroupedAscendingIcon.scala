...
object GroupedAscendingIcon {
  @JSImport("@fluentui/react-icons/lib/components/GroupedAscendingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GroupedAscendingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
