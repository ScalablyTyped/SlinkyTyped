...
object BalloonsIcon {
  @JSImport("@fluentui/react-icons/lib/components/BalloonsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BalloonsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
