...
object MusicNoteIcon {
  @JSImport("@fluentui/react-icons/lib/components/MusicNoteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MusicNoteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
