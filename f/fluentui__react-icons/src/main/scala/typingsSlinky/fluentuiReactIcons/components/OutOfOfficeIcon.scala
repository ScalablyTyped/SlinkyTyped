...
object OutOfOfficeIcon {
  @JSImport("@fluentui/react-icons/lib/components/OutOfOfficeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OutOfOfficeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
