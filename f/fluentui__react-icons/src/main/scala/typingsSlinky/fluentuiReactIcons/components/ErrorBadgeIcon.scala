...
object ErrorBadgeIcon {
  @JSImport("@fluentui/react-icons/lib/components/ErrorBadgeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ErrorBadgeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
