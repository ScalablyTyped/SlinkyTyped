...
object FieldNotChangedIcon {
  @JSImport("@fluentui/react-icons/lib/components/FieldNotChangedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FieldNotChangedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
