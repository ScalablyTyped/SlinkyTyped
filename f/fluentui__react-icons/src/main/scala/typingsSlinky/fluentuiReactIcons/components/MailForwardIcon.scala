...
object MailForwardIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailForwardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailForwardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
