...
object FontColorIcon {
  @JSImport("@fluentui/react-icons/lib/components/FontColorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FontColorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
