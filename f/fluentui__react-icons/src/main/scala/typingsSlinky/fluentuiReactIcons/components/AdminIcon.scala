...
object AdminIcon {
  @JSImport("@fluentui/react-icons/lib/components/AdminIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AdminIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
