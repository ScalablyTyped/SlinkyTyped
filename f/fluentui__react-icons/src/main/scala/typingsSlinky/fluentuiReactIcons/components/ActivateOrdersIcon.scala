...
object ActivateOrdersIcon {
  @JSImport("@fluentui/react-icons/lib/components/ActivateOrdersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ActivateOrdersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
