...
object FaviconIcon {
  @JSImport("@fluentui/react-icons/lib/components/FaviconIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FaviconIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
