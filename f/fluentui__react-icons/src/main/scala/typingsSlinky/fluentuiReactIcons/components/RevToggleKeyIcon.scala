...
object RevToggleKeyIcon {
  @JSImport("@fluentui/react-icons/lib/components/RevToggleKeyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RevToggleKeyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
