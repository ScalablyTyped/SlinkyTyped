...
object InputAddressIcon {
  @JSImport("@fluentui/react-icons/lib/components/InputAddressIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InputAddressIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
