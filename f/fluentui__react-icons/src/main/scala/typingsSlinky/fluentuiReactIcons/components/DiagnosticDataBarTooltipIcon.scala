...
object DiagnosticDataBarTooltipIcon {
  @JSImport("@fluentui/react-icons/lib/components/DiagnosticDataBarTooltipIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DiagnosticDataBarTooltipIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
