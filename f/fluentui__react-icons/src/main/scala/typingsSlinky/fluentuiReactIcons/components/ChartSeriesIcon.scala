...
object ChartSeriesIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChartSeriesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChartSeriesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
