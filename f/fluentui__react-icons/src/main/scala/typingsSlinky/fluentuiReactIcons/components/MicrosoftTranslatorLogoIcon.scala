...
object MicrosoftTranslatorLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/MicrosoftTranslatorLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MicrosoftTranslatorLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
