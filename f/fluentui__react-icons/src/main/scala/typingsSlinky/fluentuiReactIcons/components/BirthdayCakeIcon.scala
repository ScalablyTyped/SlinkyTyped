...
object BirthdayCakeIcon {
  @JSImport("@fluentui/react-icons/lib/components/BirthdayCakeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BirthdayCakeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
