...
object StorageAcountIcon {
  @JSImport("@fluentui/react-icons/lib/components/StorageAcountIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StorageAcountIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
