...
object BreakfastIcon {
  @JSImport("@fluentui/react-icons/lib/components/BreakfastIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BreakfastIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
