...
object TagUnknownMirrorIcon {
  @JSImport("@fluentui/react-icons/lib/components/TagUnknownMirrorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TagUnknownMirrorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
