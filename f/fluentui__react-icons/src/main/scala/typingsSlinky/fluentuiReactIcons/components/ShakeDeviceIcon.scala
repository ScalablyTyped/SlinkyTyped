...
object ShakeDeviceIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShakeDeviceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShakeDeviceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
