...
object PencilReplyIcon {
  @JSImport("@fluentui/react-icons/lib/components/PencilReplyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PencilReplyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
