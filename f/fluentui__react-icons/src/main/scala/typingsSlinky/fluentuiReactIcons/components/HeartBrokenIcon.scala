...
object HeartBrokenIcon {
  @JSImport("@fluentui/react-icons/lib/components/HeartBrokenIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HeartBrokenIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
