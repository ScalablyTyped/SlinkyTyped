...
object DownloadIcon {
  ...
  @JSImport("@fluentui/react-icons", "DownloadIcon")
  @js.native
  ...
  implicit def make(companion: DownloadIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
