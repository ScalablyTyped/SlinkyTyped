...
object MailTentativeMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailTentativeMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailTentativeMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
