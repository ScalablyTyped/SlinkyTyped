...
object ToggleBorderIcon {
  
  @JSImport("@fluentui/react-icons", "ToggleBorderIcon")
  @js.native
  ...
  implicit def make(companion: ToggleBorderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
