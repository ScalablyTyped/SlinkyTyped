...
object AppIconDefaultIcon {
  @JSImport("@fluentui/react-icons/lib/components/AppIconDefaultIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AppIconDefaultIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
