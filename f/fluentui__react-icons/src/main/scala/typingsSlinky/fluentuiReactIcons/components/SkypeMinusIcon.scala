...
object SkypeMinusIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeMinusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeMinusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
