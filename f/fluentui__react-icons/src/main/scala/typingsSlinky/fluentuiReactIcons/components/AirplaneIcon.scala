...
object AirplaneIcon {
  @JSImport("@fluentui/react-icons/lib/components/AirplaneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AirplaneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
