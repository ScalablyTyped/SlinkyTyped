...
object FooterIcon {
  @JSImport("@fluentui/react-icons/lib/components/FooterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FooterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
