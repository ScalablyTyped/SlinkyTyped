...
object InsertSignatureLineIcon {
  @JSImport("@fluentui/react-icons/lib/components/InsertSignatureLineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InsertSignatureLineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
