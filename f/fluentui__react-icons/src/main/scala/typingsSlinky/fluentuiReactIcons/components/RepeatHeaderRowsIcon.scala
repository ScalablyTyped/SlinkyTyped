...
object RepeatHeaderRowsIcon {
  @JSImport("@fluentui/react-icons/lib/components/RepeatHeaderRowsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RepeatHeaderRowsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
