...
object TestParameterIcon {
  @JSImport("@fluentui/react-icons", "TestParameterIcon")
  @js.native
  ...
  implicit def make(companion: TestParameterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
