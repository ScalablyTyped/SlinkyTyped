...
object DiagnosticIcon {
  @JSImport("@fluentui/react-icons/lib/components/DiagnosticIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DiagnosticIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
