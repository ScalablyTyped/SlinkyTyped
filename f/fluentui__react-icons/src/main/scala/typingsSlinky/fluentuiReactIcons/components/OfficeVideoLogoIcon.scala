...
object OfficeVideoLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/OfficeVideoLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OfficeVideoLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
