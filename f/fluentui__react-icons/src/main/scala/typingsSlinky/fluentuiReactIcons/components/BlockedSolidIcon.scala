...
object BlockedSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/BlockedSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlockedSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
