...
object PythonLogoYellowIcon {
  @JSImport("@fluentui/react-icons/lib/components/PythonLogoYellowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PythonLogoYellowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
