...
object BuildDefinitionIcon {
  @JSImport("@fluentui/react-icons/lib/components/BuildDefinitionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BuildDefinitionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
