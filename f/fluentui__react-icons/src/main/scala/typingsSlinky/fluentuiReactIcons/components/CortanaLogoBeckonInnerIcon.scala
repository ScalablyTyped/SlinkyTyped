...
object CortanaLogoBeckonInnerIcon {
  @JSImport("@fluentui/react-icons/lib/components/CortanaLogoBeckonInnerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CortanaLogoBeckonInnerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
