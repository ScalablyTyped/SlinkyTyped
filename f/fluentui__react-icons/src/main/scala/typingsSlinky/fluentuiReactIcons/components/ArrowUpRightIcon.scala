...
object ArrowUpRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrowUpRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrowUpRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
