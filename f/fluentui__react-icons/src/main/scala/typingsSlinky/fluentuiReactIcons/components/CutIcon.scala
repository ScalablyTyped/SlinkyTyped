...
object CutIcon {
  @JSImport("@fluentui/react-icons/lib/components/CutIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CutIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
