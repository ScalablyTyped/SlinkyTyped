...
object PowerApps2LogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/PowerApps2LogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PowerApps2LogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
