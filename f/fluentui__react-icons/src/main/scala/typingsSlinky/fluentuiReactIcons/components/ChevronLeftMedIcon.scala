...
object ChevronLeftMedIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChevronLeftMedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChevronLeftMedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
