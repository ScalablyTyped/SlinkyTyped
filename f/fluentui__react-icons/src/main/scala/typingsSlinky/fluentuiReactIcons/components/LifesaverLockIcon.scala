...
object LifesaverLockIcon {
  @JSImport("@fluentui/react-icons/lib/components/LifesaverLockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LifesaverLockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
