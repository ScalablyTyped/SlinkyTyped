...
object QuickNoteSolidIcon {
  
  @JSImport("@fluentui/react-icons", "QuickNoteSolidIcon")
  @js.native
  ...
  implicit def make(companion: QuickNoteSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
