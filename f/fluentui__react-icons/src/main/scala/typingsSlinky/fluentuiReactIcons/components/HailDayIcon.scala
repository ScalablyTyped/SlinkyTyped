...
object HailDayIcon {
  @JSImport("@fluentui/react-icons/lib/components/HailDayIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HailDayIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
