...
object BugBlockIcon {
  @JSImport("@fluentui/react-icons/lib/components/BugBlockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BugBlockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
