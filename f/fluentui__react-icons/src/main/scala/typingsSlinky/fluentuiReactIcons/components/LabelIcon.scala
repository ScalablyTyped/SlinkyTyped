...
object LabelIcon {
  @JSImport("@fluentui/react-icons/lib/components/LabelIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LabelIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
