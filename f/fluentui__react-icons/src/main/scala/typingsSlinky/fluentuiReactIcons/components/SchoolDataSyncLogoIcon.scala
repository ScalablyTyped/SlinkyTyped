...
object SchoolDataSyncLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/SchoolDataSyncLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SchoolDataSyncLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
