...
object CSharpIcon {
  @JSImport("@fluentui/react-icons/lib/components/CSharpIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CSharpIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
