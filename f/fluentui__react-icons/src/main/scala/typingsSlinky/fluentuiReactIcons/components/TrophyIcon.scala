...
object TrophyIcon {
  @JSImport("@fluentui/react-icons/lib/components/TrophyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TrophyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
