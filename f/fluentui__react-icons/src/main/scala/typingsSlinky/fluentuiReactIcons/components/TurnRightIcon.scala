...
object TurnRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/TurnRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TurnRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
