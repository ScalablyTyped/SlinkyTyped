...
object FavoriteListIcon {
  @JSImport("@fluentui/react-icons/lib/components/FavoriteListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FavoriteListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
