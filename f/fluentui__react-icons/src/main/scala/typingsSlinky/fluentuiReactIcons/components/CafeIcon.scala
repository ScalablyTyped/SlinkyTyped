...
object CafeIcon {
  @JSImport("@fluentui/react-icons/lib/components/CafeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CafeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
