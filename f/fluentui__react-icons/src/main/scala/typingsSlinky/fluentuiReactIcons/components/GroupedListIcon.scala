...
object GroupedListIcon {
  @JSImport("@fluentui/react-icons/lib/components/GroupedListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GroupedListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
