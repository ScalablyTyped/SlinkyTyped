...
object ArrowUpRightMirrored8Icon {
  @JSImport("@fluentui/react-icons/lib/components/ArrowUpRightMirrored8Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrowUpRightMirrored8Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
