...
object LightningBoltIcon {
  @JSImport("@fluentui/react-icons/lib/components/LightningBoltIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LightningBoltIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
