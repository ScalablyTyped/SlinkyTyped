...
object BlobStorageIcon {
  @JSImport("@fluentui/react-icons/lib/components/BlobStorageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlobStorageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
