...
object BullseyeTargetIcon {
  @JSImport("@fluentui/react-icons/lib/components/BullseyeTargetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BullseyeTargetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
