...
object WordLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/WordLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WordLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
