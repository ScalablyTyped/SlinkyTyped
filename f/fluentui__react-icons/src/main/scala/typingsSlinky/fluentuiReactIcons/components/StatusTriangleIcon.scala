...
object StatusTriangleIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusTriangleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusTriangleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
