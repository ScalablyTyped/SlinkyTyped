...
object CoffeeScriptIcon {
  @JSImport("@fluentui/react-icons/lib/components/CoffeeScriptIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CoffeeScriptIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
