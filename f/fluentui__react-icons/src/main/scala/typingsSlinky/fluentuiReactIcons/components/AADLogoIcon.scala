...
object AADLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/AADLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AADLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
