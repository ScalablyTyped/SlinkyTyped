...
object FolderListMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/FolderListMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FolderListMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
