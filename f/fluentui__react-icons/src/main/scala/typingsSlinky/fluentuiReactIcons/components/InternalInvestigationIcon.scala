...
object InternalInvestigationIcon {
  @JSImport("@fluentui/react-icons/lib/components/InternalInvestigationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InternalInvestigationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
