...
object AlignHorizontalRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlignHorizontalRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlignHorizontalRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
