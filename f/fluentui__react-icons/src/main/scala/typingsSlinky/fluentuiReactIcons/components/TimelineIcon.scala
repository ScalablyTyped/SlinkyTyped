...
object TimelineIcon {
  @JSImport("@fluentui/react-icons/lib/components/TimelineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TimelineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
