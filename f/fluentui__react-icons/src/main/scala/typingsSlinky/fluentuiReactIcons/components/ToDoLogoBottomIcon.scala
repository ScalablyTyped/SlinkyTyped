...
object ToDoLogoBottomIcon {
  @JSImport("@fluentui/react-icons/lib/components/ToDoLogoBottomIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ToDoLogoBottomIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
