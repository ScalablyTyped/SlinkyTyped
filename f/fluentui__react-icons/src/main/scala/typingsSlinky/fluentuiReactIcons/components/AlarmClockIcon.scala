...
object AlarmClockIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlarmClockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlarmClockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
