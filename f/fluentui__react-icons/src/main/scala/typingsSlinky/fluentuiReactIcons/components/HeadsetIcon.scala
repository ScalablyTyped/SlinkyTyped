...
object HeadsetIcon {
  @JSImport("@fluentui/react-icons/lib/components/HeadsetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HeadsetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
