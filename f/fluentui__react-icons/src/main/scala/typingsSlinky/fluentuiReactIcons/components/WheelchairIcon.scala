...
object WheelchairIcon {
  @JSImport("@fluentui/react-icons/lib/components/WheelchairIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WheelchairIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
