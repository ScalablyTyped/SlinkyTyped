...
object RectangularClippingIcon {
  @JSImport("@fluentui/react-icons/lib/components/RectangularClippingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RectangularClippingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
