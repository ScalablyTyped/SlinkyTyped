...
object TimerIcon {
  @JSImport("@fluentui/react-icons/lib/components/TimerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TimerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
