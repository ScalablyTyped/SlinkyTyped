...
object UserWarningIcon {
  @JSImport("@fluentui/react-icons/lib/components/UserWarningIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UserWarningIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
