...
object AllCurrencyIcon {
  @JSImport("@fluentui/react-icons/lib/components/AllCurrencyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AllCurrencyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
