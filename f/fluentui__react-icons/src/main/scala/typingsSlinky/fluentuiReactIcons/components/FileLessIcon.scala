...
object FileLessIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileLessIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileLessIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
