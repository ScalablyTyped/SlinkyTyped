...
object RepoSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/RepoSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RepoSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
