...
object ToggleFilledIcon {
  @JSImport("@fluentui/react-icons/lib/components/ToggleFilledIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ToggleFilledIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
