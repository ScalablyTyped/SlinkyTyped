...
object ReceiptReplyIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReceiptReplyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReceiptReplyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
