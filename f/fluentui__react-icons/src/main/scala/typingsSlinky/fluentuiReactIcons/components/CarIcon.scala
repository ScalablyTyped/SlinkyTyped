...
object CarIcon {
  @JSImport("@fluentui/react-icons/lib/components/CarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
