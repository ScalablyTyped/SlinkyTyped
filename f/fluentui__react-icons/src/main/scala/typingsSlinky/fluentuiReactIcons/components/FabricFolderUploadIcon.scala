...
object FabricFolderUploadIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricFolderUploadIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricFolderUploadIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
