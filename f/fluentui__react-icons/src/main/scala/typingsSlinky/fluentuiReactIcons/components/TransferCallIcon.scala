...
object TransferCallIcon {
  @JSImport("@fluentui/react-icons/lib/components/TransferCallIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TransferCallIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
