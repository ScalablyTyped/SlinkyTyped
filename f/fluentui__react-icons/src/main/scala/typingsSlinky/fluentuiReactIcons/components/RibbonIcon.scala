...
object RibbonIcon {
  @JSImport("@fluentui/react-icons/lib/components/RibbonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RibbonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
