...
object BranchCommitIcon {
  @JSImport("@fluentui/react-icons/lib/components/BranchCommitIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BranchCommitIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
