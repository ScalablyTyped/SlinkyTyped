...
object UserOptionalIcon {
  @JSImport("@fluentui/react-icons/lib/components/UserOptionalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UserOptionalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
