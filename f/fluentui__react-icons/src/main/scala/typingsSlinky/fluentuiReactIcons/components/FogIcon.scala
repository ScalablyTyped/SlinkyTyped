...
object FogIcon {
  @JSImport("@fluentui/react-icons/lib/components/FogIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FogIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
