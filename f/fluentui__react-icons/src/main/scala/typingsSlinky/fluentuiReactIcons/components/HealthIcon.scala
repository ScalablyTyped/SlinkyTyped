...
object HealthIcon {
  @JSImport("@fluentui/react-icons/lib/components/HealthIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HealthIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
