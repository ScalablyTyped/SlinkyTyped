...
object TextCalloutIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextCalloutIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextCalloutIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
