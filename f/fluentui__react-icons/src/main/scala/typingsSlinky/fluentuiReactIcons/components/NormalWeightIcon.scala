...
object NormalWeightIcon {
  @JSImport("@fluentui/react-icons/lib/components/NormalWeightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NormalWeightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
