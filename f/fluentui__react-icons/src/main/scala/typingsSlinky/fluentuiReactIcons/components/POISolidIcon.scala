...
object POISolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/POISolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: POISolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
