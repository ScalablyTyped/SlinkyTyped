...
object CalendarIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalendarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalendarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
