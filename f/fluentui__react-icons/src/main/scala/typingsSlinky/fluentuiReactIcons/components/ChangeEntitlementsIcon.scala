...
object ChangeEntitlementsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChangeEntitlementsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChangeEntitlementsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
