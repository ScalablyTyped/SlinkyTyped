...
object PrintIcon {
  @JSImport("@fluentui/react-icons/lib/components/PrintIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PrintIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
