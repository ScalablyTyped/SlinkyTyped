...
object FileBugIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileBugIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileBugIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
