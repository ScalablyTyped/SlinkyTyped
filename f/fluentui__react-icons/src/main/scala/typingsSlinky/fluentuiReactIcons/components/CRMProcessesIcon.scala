...
object CRMProcessesIcon {
  @JSImport("@fluentui/react-icons/lib/components/CRMProcessesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CRMProcessesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
