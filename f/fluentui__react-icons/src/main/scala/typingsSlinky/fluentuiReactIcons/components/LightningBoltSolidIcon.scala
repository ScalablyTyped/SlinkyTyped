...
object LightningBoltSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/LightningBoltSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LightningBoltSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
