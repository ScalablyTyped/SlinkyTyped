...
object ToDoLogoOutlineIcon {
  @JSImport("@fluentui/react-icons/lib/components/ToDoLogoOutlineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ToDoLogoOutlineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
