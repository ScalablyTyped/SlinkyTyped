...
object LocaleLanguageIcon {
  @JSImport("@fluentui/react-icons/lib/components/LocaleLanguageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LocaleLanguageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
