...
object FileImageIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileImageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileImageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
