...
object FontColorSwatchIcon {
  @JSImport("@fluentui/react-icons/lib/components/FontColorSwatchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FontColorSwatchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
