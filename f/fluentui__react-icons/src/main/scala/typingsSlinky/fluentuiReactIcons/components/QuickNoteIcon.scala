...
object QuickNoteIcon {
  @JSImport("@fluentui/react-icons/lib/components/QuickNoteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QuickNoteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
