...
object FullHistoryIcon {
  @JSImport("@fluentui/react-icons/lib/components/FullHistoryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FullHistoryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
