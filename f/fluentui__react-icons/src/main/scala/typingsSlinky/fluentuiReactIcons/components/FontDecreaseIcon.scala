...
object FontDecreaseIcon {
  @JSImport("@fluentui/react-icons/lib/components/FontDecreaseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FontDecreaseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
