...
object CompassNWIcon {
  @JSImport("@fluentui/react-icons/lib/components/CompassNWIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CompassNWIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
