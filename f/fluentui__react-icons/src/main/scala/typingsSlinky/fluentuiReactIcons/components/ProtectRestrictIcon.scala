...
object ProtectRestrictIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProtectRestrictIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProtectRestrictIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
