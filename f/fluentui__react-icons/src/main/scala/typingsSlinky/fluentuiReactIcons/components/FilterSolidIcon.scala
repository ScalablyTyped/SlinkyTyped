...
object FilterSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/FilterSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FilterSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
