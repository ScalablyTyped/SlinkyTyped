...
object ShowResultsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShowResultsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShowResultsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
