...
object FabricFolderConfirmIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricFolderConfirmIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricFolderConfirmIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
