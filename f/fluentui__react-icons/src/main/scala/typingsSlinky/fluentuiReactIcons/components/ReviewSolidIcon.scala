...
object ReviewSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReviewSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReviewSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
