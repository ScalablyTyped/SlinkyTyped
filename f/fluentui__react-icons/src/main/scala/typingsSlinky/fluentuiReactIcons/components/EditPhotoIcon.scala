...
object EditPhotoIcon {
  @JSImport("@fluentui/react-icons/lib/components/EditPhotoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EditPhotoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
