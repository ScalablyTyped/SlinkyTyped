...
object SyncStatusSolidIcon {
  @JSImport("@fluentui/react-icons", "SyncStatusSolidIcon")
  @js.native
  ...
  implicit def make(companion: SyncStatusSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
