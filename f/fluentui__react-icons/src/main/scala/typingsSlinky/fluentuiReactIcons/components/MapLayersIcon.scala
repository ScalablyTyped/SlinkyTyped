...
object MapLayersIcon {
  @JSImport("@fluentui/react-icons/lib/components/MapLayersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MapLayersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
