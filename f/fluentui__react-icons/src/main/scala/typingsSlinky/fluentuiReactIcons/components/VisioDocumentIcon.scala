...
object VisioDocumentIcon {
  @JSImport("@fluentui/react-icons/lib/components/VisioDocumentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VisioDocumentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
