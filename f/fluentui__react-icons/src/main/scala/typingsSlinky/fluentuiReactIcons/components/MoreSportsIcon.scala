...
object MoreSportsIcon {
  @JSImport("@fluentui/react-icons/lib/components/MoreSportsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MoreSportsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
