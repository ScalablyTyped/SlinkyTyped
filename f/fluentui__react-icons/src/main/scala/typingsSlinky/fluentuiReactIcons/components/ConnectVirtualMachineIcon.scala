...
object ConnectVirtualMachineIcon {
  @JSImport("@fluentui/react-icons/lib/components/ConnectVirtualMachineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ConnectVirtualMachineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
