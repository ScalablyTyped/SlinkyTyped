...
object DislikeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/DislikeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DislikeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
