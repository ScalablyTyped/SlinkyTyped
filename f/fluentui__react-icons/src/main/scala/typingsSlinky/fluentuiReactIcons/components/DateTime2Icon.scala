...
object DateTime2Icon {
  @JSImport("@fluentui/react-icons/lib/components/DateTime2Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DateTime2Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
