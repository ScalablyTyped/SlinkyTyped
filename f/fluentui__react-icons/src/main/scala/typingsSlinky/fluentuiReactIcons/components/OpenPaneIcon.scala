...
object OpenPaneIcon {
  @JSImport("@fluentui/react-icons/lib/components/OpenPaneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OpenPaneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
