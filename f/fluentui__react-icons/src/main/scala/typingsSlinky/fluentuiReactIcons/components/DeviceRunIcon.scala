...
object DeviceRunIcon {
  @JSImport("@fluentui/react-icons/lib/components/DeviceRunIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DeviceRunIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
