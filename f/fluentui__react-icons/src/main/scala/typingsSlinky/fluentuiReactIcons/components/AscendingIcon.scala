...
object AscendingIcon {
  @JSImport("@fluentui/react-icons/lib/components/AscendingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AscendingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
