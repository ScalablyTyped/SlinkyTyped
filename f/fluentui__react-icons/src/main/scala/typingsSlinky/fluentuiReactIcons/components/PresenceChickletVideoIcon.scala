...
object PresenceChickletVideoIcon {
  @JSImport("@fluentui/react-icons/lib/components/PresenceChickletVideoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PresenceChickletVideoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
