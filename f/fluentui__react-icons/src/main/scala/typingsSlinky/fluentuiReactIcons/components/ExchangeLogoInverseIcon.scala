...
object ExchangeLogoInverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/ExchangeLogoInverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExchangeLogoInverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
