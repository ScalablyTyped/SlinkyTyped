...
object RightTriangleIcon {
  @JSImport("@fluentui/react-icons/lib/components/RightTriangleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RightTriangleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
