...
object StoryboardIcon {
  @JSImport("@fluentui/react-icons/lib/components/StoryboardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StoryboardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
