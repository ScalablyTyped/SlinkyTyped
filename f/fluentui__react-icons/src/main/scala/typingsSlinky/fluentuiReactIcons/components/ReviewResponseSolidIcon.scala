...
object ReviewResponseSolidIcon {
  
  @JSImport("@fluentui/react-icons", "ReviewResponseSolidIcon")
  @js.native
  ...
  implicit def make(companion: ReviewResponseSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
