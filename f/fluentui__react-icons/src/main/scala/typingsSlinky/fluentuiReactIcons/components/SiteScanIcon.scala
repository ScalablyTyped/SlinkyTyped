...
object SiteScanIcon {
  @JSImport("@fluentui/react-icons/lib/components/SiteScanIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SiteScanIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
