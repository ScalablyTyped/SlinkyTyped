...
object ReportHackedIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReportHackedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReportHackedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
