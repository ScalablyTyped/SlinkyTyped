...
object LaptopSecureIcon {
  @JSImport("@fluentui/react-icons/lib/components/LaptopSecureIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LaptopSecureIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
