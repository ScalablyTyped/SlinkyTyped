...
object ShoppingCartSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShoppingCartSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShoppingCartSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
