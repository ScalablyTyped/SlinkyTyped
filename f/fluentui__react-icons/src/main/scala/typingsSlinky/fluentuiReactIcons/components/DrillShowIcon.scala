...
object DrillShowIcon {
  @JSImport("@fluentui/react-icons/lib/components/DrillShowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DrillShowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
