...
object EventDeclinedIcon {
  @JSImport("@fluentui/react-icons/lib/components/EventDeclinedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EventDeclinedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
