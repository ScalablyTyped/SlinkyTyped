...
object SpeakersIcon {
  @JSImport("@fluentui/react-icons/lib/components/SpeakersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SpeakersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
