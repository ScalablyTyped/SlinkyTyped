...
object RemoveEventIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveEventIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveEventIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
