...
object TemporaryUserIcon {
  @JSImport("@fluentui/react-icons/lib/components/TemporaryUserIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TemporaryUserIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
