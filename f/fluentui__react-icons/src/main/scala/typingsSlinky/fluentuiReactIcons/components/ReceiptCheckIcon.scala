...
object ReceiptCheckIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReceiptCheckIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReceiptCheckIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
