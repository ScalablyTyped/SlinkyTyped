...
object ImportAllMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ImportAllMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ImportAllMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
