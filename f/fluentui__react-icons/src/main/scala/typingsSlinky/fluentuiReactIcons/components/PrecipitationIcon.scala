...
object PrecipitationIcon {
  @JSImport("@fluentui/react-icons/lib/components/PrecipitationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PrecipitationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
