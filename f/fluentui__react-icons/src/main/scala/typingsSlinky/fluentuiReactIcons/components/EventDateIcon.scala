...
object EventDateIcon {
  @JSImport("@fluentui/react-icons/lib/components/EventDateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EventDateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
