...
object SystemIcon {
  @JSImport("@fluentui/react-icons/lib/components/SystemIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SystemIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
