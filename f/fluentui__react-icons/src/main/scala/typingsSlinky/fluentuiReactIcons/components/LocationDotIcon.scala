...
object LocationDotIcon {
  @JSImport("@fluentui/react-icons/lib/components/LocationDotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LocationDotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
