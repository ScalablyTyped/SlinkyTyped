...
object CommentAddIcon {
  @JSImport("@fluentui/react-icons/lib/components/CommentAddIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CommentAddIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
