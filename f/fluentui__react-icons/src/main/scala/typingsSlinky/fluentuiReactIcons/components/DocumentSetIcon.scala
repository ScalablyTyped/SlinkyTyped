...
object DocumentSetIcon {
  @JSImport("@fluentui/react-icons/lib/components/DocumentSetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DocumentSetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
