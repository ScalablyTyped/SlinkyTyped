...
object PollResultsIcon {
  @JSImport("@fluentui/react-icons/lib/components/PollResultsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PollResultsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
