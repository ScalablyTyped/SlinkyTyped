...
object AwayStatusIcon {
  @JSImport("@fluentui/react-icons/lib/components/AwayStatusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AwayStatusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
