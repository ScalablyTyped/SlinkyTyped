...
object UnpinIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnpinIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnpinIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
