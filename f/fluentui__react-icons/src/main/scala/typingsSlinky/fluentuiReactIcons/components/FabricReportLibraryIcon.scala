...
object FabricReportLibraryIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricReportLibraryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricReportLibraryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
