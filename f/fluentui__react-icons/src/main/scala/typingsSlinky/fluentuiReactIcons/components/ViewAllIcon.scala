...
object ViewAllIcon {
  @JSImport("@fluentui/react-icons/lib/components/ViewAllIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ViewAllIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
