...
object ClearNightIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClearNightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClearNightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
