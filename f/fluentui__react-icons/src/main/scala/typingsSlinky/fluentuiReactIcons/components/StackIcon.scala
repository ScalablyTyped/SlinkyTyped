...
object StackIcon {
  @JSImport("@fluentui/react-icons/lib/components/StackIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StackIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
