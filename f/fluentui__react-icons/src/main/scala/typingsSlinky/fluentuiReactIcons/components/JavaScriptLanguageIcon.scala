...
object JavaScriptLanguageIcon {
  @JSImport("@fluentui/react-icons/lib/components/JavaScriptLanguageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: JavaScriptLanguageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
