...
object MoreVerticalIcon {
  @JSImport("@fluentui/react-icons/lib/components/MoreVerticalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MoreVerticalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
