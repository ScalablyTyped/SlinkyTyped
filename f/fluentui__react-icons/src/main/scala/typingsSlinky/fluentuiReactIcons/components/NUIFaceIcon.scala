...
object NUIFaceIcon {
  @JSImport("@fluentui/react-icons/lib/components/NUIFaceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NUIFaceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
