...
object FabricFolderFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricFolderFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricFolderFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
