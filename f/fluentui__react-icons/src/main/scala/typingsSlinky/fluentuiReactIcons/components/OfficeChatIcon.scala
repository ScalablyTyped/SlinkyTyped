...
object OfficeChatIcon {
  @JSImport("@fluentui/react-icons/lib/components/OfficeChatIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OfficeChatIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
