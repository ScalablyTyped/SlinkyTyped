...
object DeveloperToolsIcon {
  @JSImport("@fluentui/react-icons/lib/components/DeveloperToolsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DeveloperToolsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
