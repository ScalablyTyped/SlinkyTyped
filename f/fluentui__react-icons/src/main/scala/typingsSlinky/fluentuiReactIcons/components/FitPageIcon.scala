...
object FitPageIcon {
  @JSImport("@fluentui/react-icons/lib/components/FitPageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FitPageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
