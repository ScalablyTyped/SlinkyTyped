...
object LargeGridIcon {
  @JSImport("@fluentui/react-icons/lib/components/LargeGridIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LargeGridIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
