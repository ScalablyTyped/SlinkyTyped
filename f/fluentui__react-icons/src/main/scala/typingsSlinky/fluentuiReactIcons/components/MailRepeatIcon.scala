...
object MailRepeatIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailRepeatIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailRepeatIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
