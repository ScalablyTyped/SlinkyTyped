...
object GolfIcon {
  @JSImport("@fluentui/react-icons/lib/components/GolfIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GolfIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
