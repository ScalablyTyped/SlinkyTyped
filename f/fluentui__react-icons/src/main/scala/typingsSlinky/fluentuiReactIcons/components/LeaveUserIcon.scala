...
object LeaveUserIcon {
  @JSImport("@fluentui/react-icons/lib/components/LeaveUserIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LeaveUserIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
