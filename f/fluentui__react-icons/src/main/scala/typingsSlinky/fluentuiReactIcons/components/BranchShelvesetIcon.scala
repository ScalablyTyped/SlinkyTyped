...
object BranchShelvesetIcon {
  @JSImport("@fluentui/react-icons/lib/components/BranchShelvesetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BranchShelvesetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
