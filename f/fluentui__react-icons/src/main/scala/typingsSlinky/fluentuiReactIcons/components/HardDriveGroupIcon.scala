...
object HardDriveGroupIcon {
  @JSImport("@fluentui/react-icons/lib/components/HardDriveGroupIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HardDriveGroupIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
