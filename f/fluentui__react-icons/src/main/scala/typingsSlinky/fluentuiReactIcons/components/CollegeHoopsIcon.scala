...
object CollegeHoopsIcon {
  @JSImport("@fluentui/react-icons/lib/components/CollegeHoopsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CollegeHoopsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
