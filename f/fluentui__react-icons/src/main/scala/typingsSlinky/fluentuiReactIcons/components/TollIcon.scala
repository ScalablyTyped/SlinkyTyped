...
object TollIcon {
  @JSImport("@fluentui/react-icons/lib/components/TollIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TollIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
