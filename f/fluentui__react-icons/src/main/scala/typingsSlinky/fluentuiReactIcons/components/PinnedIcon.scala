...
object PinnedIcon {
  @JSImport("@fluentui/react-icons/lib/components/PinnedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PinnedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
