...
object HistoricalWeatherIcon {
  @JSImport("@fluentui/react-icons/lib/components/HistoricalWeatherIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HistoricalWeatherIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
