...
object BarChartVerticalFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/BarChartVerticalFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BarChartVerticalFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
