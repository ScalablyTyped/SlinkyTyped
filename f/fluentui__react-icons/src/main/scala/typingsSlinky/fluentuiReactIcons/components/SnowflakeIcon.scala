...
object SnowflakeIcon {
  @JSImport("@fluentui/react-icons/lib/components/SnowflakeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnowflakeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
