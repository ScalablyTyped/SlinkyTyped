...
object NewsIcon {
  @JSImport("@fluentui/react-icons/lib/components/NewsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NewsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
