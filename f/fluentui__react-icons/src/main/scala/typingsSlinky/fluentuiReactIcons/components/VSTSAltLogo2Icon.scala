...
object VSTSAltLogo2Icon {
  @JSImport("@fluentui/react-icons/lib/components/VSTSAltLogo2Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VSTSAltLogo2Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
