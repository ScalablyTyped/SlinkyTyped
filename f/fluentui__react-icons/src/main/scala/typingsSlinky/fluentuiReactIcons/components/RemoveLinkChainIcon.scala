...
object RemoveLinkChainIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveLinkChainIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveLinkChainIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
