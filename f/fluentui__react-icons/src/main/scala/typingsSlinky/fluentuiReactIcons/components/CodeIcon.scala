...
object CodeIcon {
  @JSImport("@fluentui/react-icons/lib/components/CodeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CodeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
