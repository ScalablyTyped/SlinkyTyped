...
object StackedColumnChart2FillIcon {
  
  @JSImport("@fluentui/react-icons", "StackedColumnChart2FillIcon")
  @js.native
  ...
  implicit def make(companion: StackedColumnChart2FillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
