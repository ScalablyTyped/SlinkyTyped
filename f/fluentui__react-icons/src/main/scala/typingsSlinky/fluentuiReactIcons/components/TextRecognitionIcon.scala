...
object TextRecognitionIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextRecognitionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextRecognitionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
