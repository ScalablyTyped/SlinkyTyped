...
object ArrangeBringForwardIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrangeBringForwardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrangeBringForwardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
