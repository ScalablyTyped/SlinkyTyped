...
object VisioLogo16Icon {
  @JSImport("@fluentui/react-icons/lib/components/VisioLogo16Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VisioLogo16Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
