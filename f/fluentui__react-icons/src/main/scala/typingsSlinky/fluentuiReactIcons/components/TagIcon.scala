...
object TagIcon {
  @JSImport("@fluentui/react-icons/lib/components/TagIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TagIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
