...
object ListIcon {
  @JSImport("@fluentui/react-icons/lib/components/ListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
