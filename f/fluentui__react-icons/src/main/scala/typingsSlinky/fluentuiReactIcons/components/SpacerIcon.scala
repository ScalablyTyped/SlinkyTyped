...
object SpacerIcon {
  @JSImport("@fluentui/react-icons/lib/components/SpacerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SpacerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
