...
object CustomListIcon {
  @JSImport("@fluentui/react-icons/lib/components/CustomListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CustomListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
