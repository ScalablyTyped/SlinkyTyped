...
object ContactCardSettingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContactCardSettingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContactCardSettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
