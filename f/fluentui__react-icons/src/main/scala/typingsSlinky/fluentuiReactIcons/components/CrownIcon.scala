...
object CrownIcon {
  @JSImport("@fluentui/react-icons/lib/components/CrownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CrownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
