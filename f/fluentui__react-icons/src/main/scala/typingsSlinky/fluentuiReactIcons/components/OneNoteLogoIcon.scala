...
object OneNoteLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/OneNoteLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OneNoteLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
