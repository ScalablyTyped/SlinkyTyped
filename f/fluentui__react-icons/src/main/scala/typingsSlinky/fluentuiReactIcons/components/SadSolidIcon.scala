...
object SadSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/SadSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SadSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
