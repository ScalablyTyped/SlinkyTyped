...
object HealthSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/HealthSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HealthSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
