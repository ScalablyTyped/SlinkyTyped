...
object TimelineProgressIcon {
  @JSImport("@fluentui/react-icons/lib/components/TimelineProgressIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TimelineProgressIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
