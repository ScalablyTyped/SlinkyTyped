...
object ChromeMinimizeIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChromeMinimizeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChromeMinimizeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
