...
object HomeIcon {
  @JSImport("@fluentui/react-icons/lib/components/HomeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HomeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
