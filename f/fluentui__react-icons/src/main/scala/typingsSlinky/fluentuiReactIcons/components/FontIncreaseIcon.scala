...
object FontIncreaseIcon {
  @JSImport("@fluentui/react-icons/lib/components/FontIncreaseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FontIncreaseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
