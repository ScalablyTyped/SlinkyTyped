...
object ServerIcon {
  @JSImport("@fluentui/react-icons/lib/components/ServerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ServerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
