...
object BlockedIcon {
  @JSImport("@fluentui/react-icons/lib/components/BlockedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlockedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
