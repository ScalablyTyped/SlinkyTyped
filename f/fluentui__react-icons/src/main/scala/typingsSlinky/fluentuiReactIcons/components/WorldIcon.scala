...
object WorldIcon {
  @JSImport("@fluentui/react-icons/lib/components/WorldIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WorldIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
