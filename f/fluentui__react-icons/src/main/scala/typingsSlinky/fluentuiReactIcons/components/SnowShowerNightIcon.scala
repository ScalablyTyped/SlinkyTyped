...
object SnowShowerNightIcon {
  @JSImport("@fluentui/react-icons/lib/components/SnowShowerNightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnowShowerNightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
