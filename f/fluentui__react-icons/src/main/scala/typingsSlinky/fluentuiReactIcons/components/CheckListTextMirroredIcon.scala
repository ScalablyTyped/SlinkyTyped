...
object CheckListTextMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/CheckListTextMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CheckListTextMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
