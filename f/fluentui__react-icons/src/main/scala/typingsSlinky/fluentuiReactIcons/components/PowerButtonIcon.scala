...
object PowerButtonIcon {
  @JSImport("@fluentui/react-icons/lib/components/PowerButtonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PowerButtonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
