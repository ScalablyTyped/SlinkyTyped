...
object GlimmerIcon {
  @JSImport("@fluentui/react-icons/lib/components/GlimmerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GlimmerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
