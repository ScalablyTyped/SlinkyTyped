...
object AnnotationIcon {
  @JSImport("@fluentui/react-icons/lib/components/AnnotationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AnnotationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
