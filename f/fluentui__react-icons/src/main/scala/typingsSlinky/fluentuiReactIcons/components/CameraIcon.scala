...
object CameraIcon {
  @JSImport("@fluentui/react-icons/lib/components/CameraIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CameraIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
