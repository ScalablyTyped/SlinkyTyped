...
object InsertTextBoxIcon {
  @JSImport("@fluentui/react-icons/lib/components/InsertTextBoxIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InsertTextBoxIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
