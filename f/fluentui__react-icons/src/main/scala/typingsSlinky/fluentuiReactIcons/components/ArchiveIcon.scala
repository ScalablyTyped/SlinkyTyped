...
object ArchiveIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArchiveIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArchiveIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
