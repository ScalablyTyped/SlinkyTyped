...
object UpgradeAnalysisIcon {
  @JSImport("@fluentui/react-icons/lib/components/UpgradeAnalysisIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UpgradeAnalysisIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
