...
object ChevronUpEnd6Icon {
  @JSImport("@fluentui/react-icons/lib/components/ChevronUpEnd6Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChevronUpEnd6Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
