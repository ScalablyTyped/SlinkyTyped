...
object AlignRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlignRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlignRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
