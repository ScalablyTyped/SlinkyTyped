...
object WebComponentsIcon {
  @JSImport("@fluentui/react-icons/lib/components/WebComponentsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WebComponentsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
