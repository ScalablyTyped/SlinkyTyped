...
object TextAlignBottomIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextAlignBottomIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextAlignBottomIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
