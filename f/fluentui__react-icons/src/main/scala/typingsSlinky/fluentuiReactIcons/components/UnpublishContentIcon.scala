...
object UnpublishContentIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnpublishContentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnpublishContentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
