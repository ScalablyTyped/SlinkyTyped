...
object HeartFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/HeartFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HeartFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
