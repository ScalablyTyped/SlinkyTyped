...
object SentimentAnalysisIcon {
  @JSImport("@fluentui/react-icons/lib/components/SentimentAnalysisIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SentimentAnalysisIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
