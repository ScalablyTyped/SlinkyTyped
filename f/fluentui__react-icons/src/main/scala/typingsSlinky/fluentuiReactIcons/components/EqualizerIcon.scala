...
object EqualizerIcon {
  @JSImport("@fluentui/react-icons/lib/components/EqualizerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EqualizerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
