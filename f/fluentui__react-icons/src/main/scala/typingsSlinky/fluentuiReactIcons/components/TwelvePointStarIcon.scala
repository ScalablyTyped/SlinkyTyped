...
object TwelvePointStarIcon {
  @JSImport("@fluentui/react-icons/lib/components/TwelvePointStarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TwelvePointStarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
