...
object StorageOpticalIcon {
  @JSImport("@fluentui/react-icons/lib/components/StorageOpticalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StorageOpticalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
