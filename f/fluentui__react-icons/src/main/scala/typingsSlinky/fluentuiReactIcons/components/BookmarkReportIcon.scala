...
object BookmarkReportIcon {
  @JSImport("@fluentui/react-icons/lib/components/BookmarkReportIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BookmarkReportIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
