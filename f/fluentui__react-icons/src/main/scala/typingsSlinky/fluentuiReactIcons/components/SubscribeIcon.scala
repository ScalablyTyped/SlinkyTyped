...
object SubscribeIcon {
  @JSImport("@fluentui/react-icons/lib/components/SubscribeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SubscribeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
