...
object AzureDataExplorerIcon {
  @JSImport("@fluentui/react-icons/lib/components/AzureDataExplorerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AzureDataExplorerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
