...
object SavingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/SavingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SavingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
