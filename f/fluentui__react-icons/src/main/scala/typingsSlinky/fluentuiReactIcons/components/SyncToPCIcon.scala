...
object SyncToPCIcon {
  @JSImport("@fluentui/react-icons/lib/components/SyncToPCIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SyncToPCIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
