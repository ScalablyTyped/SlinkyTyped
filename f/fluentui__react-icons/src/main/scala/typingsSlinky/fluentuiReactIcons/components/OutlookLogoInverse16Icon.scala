...
object OutlookLogoInverse16Icon {
  @JSImport("@fluentui/react-icons/lib/components/OutlookLogoInverse16Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OutlookLogoInverse16Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
