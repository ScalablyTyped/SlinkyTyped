...
object TableLastColumnIcon {
  @JSImport("@fluentui/react-icons/lib/components/TableLastColumnIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TableLastColumnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
