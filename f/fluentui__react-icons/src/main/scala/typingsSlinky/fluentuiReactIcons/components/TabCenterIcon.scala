...
object TabCenterIcon {
  @JSImport("@fluentui/react-icons/lib/components/TabCenterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TabCenterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
