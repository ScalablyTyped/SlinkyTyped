...
object TriangleShapeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/TriangleShapeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TriangleShapeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
