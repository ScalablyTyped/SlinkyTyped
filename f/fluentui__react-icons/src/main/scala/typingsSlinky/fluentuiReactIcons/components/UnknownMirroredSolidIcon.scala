...
object UnknownMirroredSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnknownMirroredSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnknownMirroredSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
