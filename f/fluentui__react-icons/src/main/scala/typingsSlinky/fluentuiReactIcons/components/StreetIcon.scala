...
object StreetIcon {
  @JSImport("@fluentui/react-icons/lib/components/StreetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StreetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
