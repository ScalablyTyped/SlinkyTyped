...
object RewindTwoXIcon {
  @JSImport("@fluentui/react-icons/lib/components/RewindTwoXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RewindTwoXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
