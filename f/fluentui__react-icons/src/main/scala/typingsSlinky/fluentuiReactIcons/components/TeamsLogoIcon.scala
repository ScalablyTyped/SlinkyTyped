...
object TeamsLogoIcon {
  
  @JSImport("@fluentui/react-icons", "TeamsLogoIcon")
  @js.native
  ...
  implicit def make(companion: TeamsLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
