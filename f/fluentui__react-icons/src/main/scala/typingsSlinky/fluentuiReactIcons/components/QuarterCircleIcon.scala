...
object QuarterCircleIcon {
  @JSImport("@fluentui/react-icons/lib/components/QuarterCircleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QuarterCircleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
