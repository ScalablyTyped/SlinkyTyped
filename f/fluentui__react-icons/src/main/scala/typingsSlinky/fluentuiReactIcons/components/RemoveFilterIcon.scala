...
object RemoveFilterIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveFilterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveFilterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
