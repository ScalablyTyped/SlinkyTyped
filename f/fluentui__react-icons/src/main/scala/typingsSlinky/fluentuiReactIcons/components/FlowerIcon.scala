...
object FlowerIcon {
  @JSImport("@fluentui/react-icons/lib/components/FlowerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FlowerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
