...
object RugbyIcon {
  @JSImport("@fluentui/react-icons/lib/components/RugbyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RugbyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
