...
object CommitmentsIcon {
  @JSImport("@fluentui/react-icons/lib/components/CommitmentsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CommitmentsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
