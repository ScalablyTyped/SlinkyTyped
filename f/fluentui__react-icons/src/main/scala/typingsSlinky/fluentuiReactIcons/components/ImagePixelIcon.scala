...
object ImagePixelIcon {
  @JSImport("@fluentui/react-icons/lib/components/ImagePixelIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ImagePixelIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
