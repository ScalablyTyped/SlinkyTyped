...
object PlayerSettingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/PlayerSettingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PlayerSettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
