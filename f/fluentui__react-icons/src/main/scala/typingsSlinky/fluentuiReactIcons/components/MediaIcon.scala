...
object MediaIcon {
  @JSImport("@fluentui/react-icons/lib/components/MediaIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MediaIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
