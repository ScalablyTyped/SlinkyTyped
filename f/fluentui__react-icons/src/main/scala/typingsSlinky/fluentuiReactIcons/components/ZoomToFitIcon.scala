...
object ZoomToFitIcon {
  @JSImport("@fluentui/react-icons/lib/components/ZoomToFitIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ZoomToFitIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
