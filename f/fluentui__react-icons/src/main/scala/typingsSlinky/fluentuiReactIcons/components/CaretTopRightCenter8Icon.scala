...
object CaretTopRightCenter8Icon {
  @JSImport("@fluentui/react-icons/lib/components/CaretTopRightCenter8Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CaretTopRightCenter8Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
