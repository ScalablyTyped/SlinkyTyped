...
object FinancialSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/FinancialSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FinancialSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
