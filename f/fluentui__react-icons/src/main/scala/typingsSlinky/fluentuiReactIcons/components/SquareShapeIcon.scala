...
object SquareShapeIcon {
  @JSImport("@fluentui/react-icons/lib/components/SquareShapeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SquareShapeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
