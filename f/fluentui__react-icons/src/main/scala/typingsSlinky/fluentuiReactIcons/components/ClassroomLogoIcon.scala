...
object ClassroomLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClassroomLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClassroomLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
