...
object GenericScanIcon {
  @JSImport("@fluentui/react-icons/lib/components/GenericScanIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GenericScanIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
