...
object GlobalNavButtonIcon {
  @JSImport("@fluentui/react-icons/lib/components/GlobalNavButtonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GlobalNavButtonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
