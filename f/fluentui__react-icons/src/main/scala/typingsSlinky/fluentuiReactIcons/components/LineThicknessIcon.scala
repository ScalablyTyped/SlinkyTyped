...
object LineThicknessIcon {
  @JSImport("@fluentui/react-icons/lib/components/LineThicknessIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LineThicknessIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
