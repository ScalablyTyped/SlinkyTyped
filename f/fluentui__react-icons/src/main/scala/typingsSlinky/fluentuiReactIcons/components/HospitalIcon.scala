...
object HospitalIcon {
  @JSImport("@fluentui/react-icons/lib/components/HospitalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HospitalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
