...
object AddPhoneIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddPhoneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddPhoneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
