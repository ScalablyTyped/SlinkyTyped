...
object CloneToDesktopIcon {
  @JSImport("@fluentui/react-icons/lib/components/CloneToDesktopIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CloneToDesktopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
