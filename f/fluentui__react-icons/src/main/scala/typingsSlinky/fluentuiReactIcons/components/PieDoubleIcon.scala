...
object PieDoubleIcon {
  @JSImport("@fluentui/react-icons/lib/components/PieDoubleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PieDoubleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
