...
object LyncLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/LyncLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LyncLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
