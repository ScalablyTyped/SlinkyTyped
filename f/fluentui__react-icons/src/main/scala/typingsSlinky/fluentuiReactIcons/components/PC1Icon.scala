...
object PC1Icon {
  ...
  @JSImport("@fluentui/react-icons", "PC1Icon")
  @js.native
  ...
  implicit def make(companion: PC1Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
