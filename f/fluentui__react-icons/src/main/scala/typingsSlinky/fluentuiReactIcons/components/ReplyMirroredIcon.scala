...
object ReplyMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReplyMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReplyMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
