...
object StatusCircleBlockIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleBlockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleBlockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
