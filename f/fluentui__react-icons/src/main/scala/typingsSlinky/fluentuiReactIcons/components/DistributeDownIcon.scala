...
object DistributeDownIcon {
  @JSImport("@fluentui/react-icons/lib/components/DistributeDownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DistributeDownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
