...
object NavigateBackIcon {
  @JSImport("@fluentui/react-icons/lib/components/NavigateBackIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NavigateBackIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
