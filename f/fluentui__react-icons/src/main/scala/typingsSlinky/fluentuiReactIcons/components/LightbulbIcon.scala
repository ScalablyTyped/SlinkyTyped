...
object LightbulbIcon {
  @JSImport("@fluentui/react-icons/lib/components/LightbulbIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LightbulbIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
