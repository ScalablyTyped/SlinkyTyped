...
object AssessmentGroupTemplateIcon {
  @JSImport("@fluentui/react-icons/lib/components/AssessmentGroupTemplateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AssessmentGroupTemplateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
