...
object QuantityIcon {
  @JSImport("@fluentui/react-icons/lib/components/QuantityIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QuantityIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
