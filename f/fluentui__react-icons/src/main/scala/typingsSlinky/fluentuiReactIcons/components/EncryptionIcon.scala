...
object EncryptionIcon {
  @JSImport("@fluentui/react-icons/lib/components/EncryptionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EncryptionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
