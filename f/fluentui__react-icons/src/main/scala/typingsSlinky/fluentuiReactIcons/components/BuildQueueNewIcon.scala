...
object BuildQueueNewIcon {
  
  @JSImport("@fluentui/react-icons", "BuildQueueNewIcon")
  @js.native
  ...
  implicit def make(companion: BuildQueueNewIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
