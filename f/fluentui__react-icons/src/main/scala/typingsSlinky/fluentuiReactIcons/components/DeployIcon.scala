...
object DeployIcon {
  @JSImport("@fluentui/react-icons/lib/components/DeployIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DeployIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
