...
object PeopleRepeatIcon {
  @JSImport("@fluentui/react-icons/lib/components/PeopleRepeatIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PeopleRepeatIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
