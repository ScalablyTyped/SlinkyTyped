...
object SwayLogo16Icon {
  @JSImport("@fluentui/react-icons/lib/components/SwayLogo16Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SwayLogo16Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
