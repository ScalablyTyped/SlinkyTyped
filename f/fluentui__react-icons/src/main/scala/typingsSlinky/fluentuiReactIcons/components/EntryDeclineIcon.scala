...
object EntryDeclineIcon {
  @JSImport("@fluentui/react-icons/lib/components/EntryDeclineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EntryDeclineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
