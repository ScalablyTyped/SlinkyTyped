...
object ChevronRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChevronRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChevronRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
