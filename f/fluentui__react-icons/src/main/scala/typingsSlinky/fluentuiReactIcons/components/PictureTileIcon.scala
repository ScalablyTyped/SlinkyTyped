...
object PictureTileIcon {
  @JSImport("@fluentui/react-icons/lib/components/PictureTileIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PictureTileIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
