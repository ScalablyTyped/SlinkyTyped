...
object D365CustomerInsightsIcon {
  @JSImport("@fluentui/react-icons/lib/components/D365CustomerInsightsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: D365CustomerInsightsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
