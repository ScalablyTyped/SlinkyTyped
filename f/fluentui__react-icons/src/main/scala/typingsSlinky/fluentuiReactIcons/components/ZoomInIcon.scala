...
object ZoomInIcon {
  @JSImport("@fluentui/react-icons/lib/components/ZoomInIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ZoomInIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
