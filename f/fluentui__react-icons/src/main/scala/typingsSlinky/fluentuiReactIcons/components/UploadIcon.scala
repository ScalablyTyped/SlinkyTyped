...
object UploadIcon {
  @JSImport("@fluentui/react-icons/lib/components/UploadIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UploadIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
