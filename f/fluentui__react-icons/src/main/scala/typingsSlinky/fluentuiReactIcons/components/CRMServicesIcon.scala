...
object CRMServicesIcon {
  @JSImport("@fluentui/react-icons/lib/components/CRMServicesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CRMServicesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
