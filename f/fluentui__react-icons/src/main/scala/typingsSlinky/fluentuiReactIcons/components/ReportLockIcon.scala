...
object ReportLockIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReportLockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReportLockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
