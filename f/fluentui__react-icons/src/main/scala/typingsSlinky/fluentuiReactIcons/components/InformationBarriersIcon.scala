...
object InformationBarriersIcon {
  @JSImport("@fluentui/react-icons/lib/components/InformationBarriersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InformationBarriersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
