...
object TriggerApprovalIcon {
  @JSImport("@fluentui/react-icons/lib/components/TriggerApprovalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TriggerApprovalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
