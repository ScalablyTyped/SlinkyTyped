...
object TabletSelectedIcon {
  @JSImport("@fluentui/react-icons/lib/components/TabletSelectedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TabletSelectedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
