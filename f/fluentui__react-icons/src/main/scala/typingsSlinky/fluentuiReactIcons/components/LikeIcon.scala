...
object LikeIcon {
  @JSImport("@fluentui/react-icons/lib/components/LikeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LikeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
