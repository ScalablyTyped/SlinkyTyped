...
object MergeIcon {
  @JSImport("@fluentui/react-icons/lib/components/MergeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MergeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
