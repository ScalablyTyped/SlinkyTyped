...
object MSNVideosIcon {
  @JSImport("@fluentui/react-icons/lib/components/MSNVideosIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MSNVideosIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
