...
object CommentNextIcon {
  @JSImport("@fluentui/react-icons/lib/components/CommentNextIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CommentNextIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
