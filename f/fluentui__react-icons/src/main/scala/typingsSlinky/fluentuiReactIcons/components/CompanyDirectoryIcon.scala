...
object CompanyDirectoryIcon {
  @JSImport("@fluentui/react-icons/lib/components/CompanyDirectoryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CompanyDirectoryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
