...
object DatabaseSyncIcon {
  @JSImport("@fluentui/react-icons/lib/components/DatabaseSyncIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DatabaseSyncIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
