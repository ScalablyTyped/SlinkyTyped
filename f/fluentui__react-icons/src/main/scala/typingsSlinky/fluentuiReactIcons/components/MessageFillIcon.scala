...
object MessageFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/MessageFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MessageFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
