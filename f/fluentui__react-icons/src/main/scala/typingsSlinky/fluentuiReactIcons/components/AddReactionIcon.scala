...
object AddReactionIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddReactionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddReactionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
