...
object ProductVariantIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProductVariantIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProductVariantIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
