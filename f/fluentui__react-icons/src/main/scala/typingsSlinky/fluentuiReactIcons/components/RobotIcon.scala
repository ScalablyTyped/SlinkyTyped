...
object RobotIcon {
  @JSImport("@fluentui/react-icons/lib/components/RobotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RobotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
