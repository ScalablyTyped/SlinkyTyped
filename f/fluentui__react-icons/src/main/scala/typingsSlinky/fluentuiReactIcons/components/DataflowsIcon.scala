...
object DataflowsIcon {
  @JSImport("@fluentui/react-icons/lib/components/DataflowsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DataflowsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
