...
object EmojiIcon {
  @JSImport("@fluentui/react-icons/lib/components/EmojiIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EmojiIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
