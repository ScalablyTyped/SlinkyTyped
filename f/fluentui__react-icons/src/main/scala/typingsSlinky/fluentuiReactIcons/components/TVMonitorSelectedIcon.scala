...
object TVMonitorSelectedIcon {
  @JSImport("@fluentui/react-icons/lib/components/TVMonitorSelectedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TVMonitorSelectedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
