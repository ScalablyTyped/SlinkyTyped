...
object DashboardAddIcon {
  @JSImport("@fluentui/react-icons/lib/components/DashboardAddIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DashboardAddIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
