...
object GripperBarVerticalIcon {
  @JSImport("@fluentui/react-icons/lib/components/GripperBarVerticalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GripperBarVerticalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
