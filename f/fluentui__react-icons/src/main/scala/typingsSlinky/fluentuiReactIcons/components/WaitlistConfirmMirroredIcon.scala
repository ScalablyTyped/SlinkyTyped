...
object WaitlistConfirmMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/WaitlistConfirmMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WaitlistConfirmMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
