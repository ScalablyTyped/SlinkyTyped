...
object ClassNotebookLogoInverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClassNotebookLogoInverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClassNotebookLogoInverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
