...
object AustralianRulesIcon {
  @JSImport("@fluentui/react-icons/lib/components/AustralianRulesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AustralianRulesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
