...
object MiniExpandIcon {
  @JSImport("@fluentui/react-icons/lib/components/MiniExpandIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MiniExpandIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
