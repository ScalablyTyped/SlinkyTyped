...
object LightWeightIcon {
  @JSImport("@fluentui/react-icons/lib/components/LightWeightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LightWeightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
