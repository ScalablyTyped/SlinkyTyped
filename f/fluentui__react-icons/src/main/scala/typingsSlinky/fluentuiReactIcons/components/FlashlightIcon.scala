...
object FlashlightIcon {
  @JSImport("@fluentui/react-icons/lib/components/FlashlightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FlashlightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
