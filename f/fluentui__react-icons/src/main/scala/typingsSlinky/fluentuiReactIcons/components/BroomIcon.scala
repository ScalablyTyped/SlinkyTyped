...
object BroomIcon {
  @JSImport("@fluentui/react-icons/lib/components/BroomIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BroomIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
