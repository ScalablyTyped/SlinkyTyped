...
object EditMailIcon {
  @JSImport("@fluentui/react-icons/lib/components/EditMailIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EditMailIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
