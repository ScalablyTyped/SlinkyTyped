...
object OpenInNewTabIcon {
  @JSImport("@fluentui/react-icons/lib/components/OpenInNewTabIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OpenInNewTabIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
