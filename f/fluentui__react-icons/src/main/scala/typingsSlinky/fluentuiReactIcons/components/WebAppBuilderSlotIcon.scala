...
object WebAppBuilderSlotIcon {
  @JSImport("@fluentui/react-icons/lib/components/WebAppBuilderSlotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WebAppBuilderSlotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
