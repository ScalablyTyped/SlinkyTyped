...
object PageListMirroredSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/PageListMirroredSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PageListMirroredSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
