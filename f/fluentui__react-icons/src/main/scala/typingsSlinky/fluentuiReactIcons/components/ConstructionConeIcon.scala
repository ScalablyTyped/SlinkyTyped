...
object ConstructionConeIcon {
  @JSImport("@fluentui/react-icons/lib/components/ConstructionConeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ConstructionConeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
