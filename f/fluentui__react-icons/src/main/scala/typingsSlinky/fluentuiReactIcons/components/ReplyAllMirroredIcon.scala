...
object ReplyAllMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReplyAllMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReplyAllMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
