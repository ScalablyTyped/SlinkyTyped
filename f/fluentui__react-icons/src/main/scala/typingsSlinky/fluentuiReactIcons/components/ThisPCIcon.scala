...
object ThisPCIcon {
  @JSImport("@fluentui/react-icons/lib/components/ThisPCIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ThisPCIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
