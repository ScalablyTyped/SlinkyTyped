...
object PlugDisconnectedIcon {
  @JSImport("@fluentui/react-icons/lib/components/PlugDisconnectedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PlugDisconnectedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
