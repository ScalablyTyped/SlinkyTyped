...
object ShoppingCartIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShoppingCartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShoppingCartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
