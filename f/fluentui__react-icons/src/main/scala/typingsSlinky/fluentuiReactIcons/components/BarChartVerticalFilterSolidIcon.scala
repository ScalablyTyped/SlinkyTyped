...
object BarChartVerticalFilterSolidIcon {
  
  @JSImport("@fluentui/react-icons", "BarChartVerticalFilterSolidIcon")
  @js.native
  ...
  implicit def make(companion: BarChartVerticalFilterSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
