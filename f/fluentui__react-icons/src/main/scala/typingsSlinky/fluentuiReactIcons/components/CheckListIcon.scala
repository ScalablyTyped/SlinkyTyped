...
object CheckListIcon {
  @JSImport("@fluentui/react-icons/lib/components/CheckListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CheckListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
