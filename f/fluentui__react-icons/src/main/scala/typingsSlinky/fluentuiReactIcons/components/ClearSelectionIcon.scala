...
object ClearSelectionIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClearSelectionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClearSelectionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
