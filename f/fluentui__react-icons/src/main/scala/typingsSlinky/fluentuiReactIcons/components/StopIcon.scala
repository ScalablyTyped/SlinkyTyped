...
object StopIcon {
  @JSImport("@fluentui/react-icons/lib/components/StopIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
