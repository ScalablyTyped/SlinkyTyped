...
object StackIndicatorIcon {
  @JSImport("@fluentui/react-icons/lib/components/StackIndicatorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StackIndicatorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
