...
object BarChart4Icon {
  @JSImport("@fluentui/react-icons/lib/components/BarChart4Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BarChart4Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
