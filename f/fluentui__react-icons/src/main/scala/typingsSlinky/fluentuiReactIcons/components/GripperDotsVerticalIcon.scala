...
object GripperDotsVerticalIcon {
  @JSImport("@fluentui/react-icons/lib/components/GripperDotsVerticalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GripperDotsVerticalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
