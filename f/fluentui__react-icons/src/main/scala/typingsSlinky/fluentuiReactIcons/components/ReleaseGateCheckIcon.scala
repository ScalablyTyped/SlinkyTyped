...
object ReleaseGateCheckIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReleaseGateCheckIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReleaseGateCheckIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
