...
object BreadcrumbIcon {
  @JSImport("@fluentui/react-icons/lib/components/BreadcrumbIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BreadcrumbIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
