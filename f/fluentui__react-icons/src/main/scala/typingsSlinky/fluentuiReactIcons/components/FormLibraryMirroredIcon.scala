...
object FormLibraryMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/FormLibraryMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FormLibraryMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
