...
object GiftboxIcon {
  ...
  @JSImport("@fluentui/react-icons", "GiftboxIcon")
  @js.native
  ...
  implicit def make(companion: GiftboxIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
