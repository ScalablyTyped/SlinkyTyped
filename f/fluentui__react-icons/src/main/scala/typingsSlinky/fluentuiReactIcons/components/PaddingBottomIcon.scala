...
object PaddingBottomIcon {
  @JSImport("@fluentui/react-icons/lib/components/PaddingBottomIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PaddingBottomIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
