...
object AutoRacingIcon {
  @JSImport("@fluentui/react-icons/lib/components/AutoRacingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AutoRacingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
