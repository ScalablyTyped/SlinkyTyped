...
object BrowserTabScreenshotIcon {
  @JSImport("@fluentui/react-icons/lib/components/BrowserTabScreenshotIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BrowserTabScreenshotIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
