...
object UntagIcon {
  @JSImport("@fluentui/react-icons/lib/components/UntagIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UntagIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
