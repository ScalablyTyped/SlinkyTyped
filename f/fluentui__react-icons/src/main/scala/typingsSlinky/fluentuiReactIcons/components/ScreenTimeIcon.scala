...
object ScreenTimeIcon {
  @JSImport("@fluentui/react-icons", "ScreenTimeIcon")
  @js.native
  ...
  implicit def make(companion: ScreenTimeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
