...
object LineChartIcon {
  @JSImport("@fluentui/react-icons/lib/components/LineChartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LineChartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
