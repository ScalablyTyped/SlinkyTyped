...
object RawSourceIcon {
  @JSImport("@fluentui/react-icons/lib/components/RawSourceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RawSourceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
