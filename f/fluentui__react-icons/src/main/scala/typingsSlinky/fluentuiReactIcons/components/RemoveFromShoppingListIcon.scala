...
object RemoveFromShoppingListIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveFromShoppingListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveFromShoppingListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
