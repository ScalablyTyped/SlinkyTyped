...
object MasterDatabaseIcon {
  @JSImport("@fluentui/react-icons/lib/components/MasterDatabaseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MasterDatabaseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
