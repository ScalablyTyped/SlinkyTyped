...
object ServerEnviromentIcon {
  @JSImport("@fluentui/react-icons/lib/components/ServerEnviromentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ServerEnviromentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
