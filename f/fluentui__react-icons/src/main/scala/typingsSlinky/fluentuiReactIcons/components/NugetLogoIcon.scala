...
object NugetLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/NugetLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NugetLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
