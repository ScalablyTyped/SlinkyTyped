...
object BIDashboardIcon {
  @JSImport("@fluentui/react-icons/lib/components/BIDashboardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BIDashboardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
