...
object CaretRightSolid8Icon {
  
  @JSImport("@fluentui/react-icons", "CaretRightSolid8Icon")
  @js.native
  ...
  implicit def make(companion: CaretRightSolid8Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
