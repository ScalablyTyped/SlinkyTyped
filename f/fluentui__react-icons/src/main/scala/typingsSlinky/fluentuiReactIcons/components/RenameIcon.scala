...
object RenameIcon {
  @JSImport("@fluentui/react-icons/lib/components/RenameIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RenameIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
