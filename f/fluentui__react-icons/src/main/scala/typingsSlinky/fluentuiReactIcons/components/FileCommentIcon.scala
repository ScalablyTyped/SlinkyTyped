...
object FileCommentIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileCommentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileCommentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
