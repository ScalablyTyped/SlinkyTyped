...
object TextDocumentSharedIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextDocumentSharedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextDocumentSharedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
