...
object StatusCircleCheckmarkIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleCheckmarkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleCheckmarkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
