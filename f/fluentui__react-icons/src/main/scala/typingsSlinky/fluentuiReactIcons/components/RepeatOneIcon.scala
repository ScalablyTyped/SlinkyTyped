...
object RepeatOneIcon {
  @JSImport("@fluentui/react-icons/lib/components/RepeatOneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RepeatOneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
