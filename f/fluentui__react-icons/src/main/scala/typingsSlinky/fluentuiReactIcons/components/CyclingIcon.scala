...
object CyclingIcon {
  @JSImport("@fluentui/react-icons/lib/components/CyclingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CyclingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
