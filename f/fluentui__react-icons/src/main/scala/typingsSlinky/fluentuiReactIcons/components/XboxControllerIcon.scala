...
object XboxControllerIcon {
  @JSImport("@fluentui/react-icons/lib/components/XboxControllerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: XboxControllerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
