...
object UserSyncIcon {
  @JSImport("@fluentui/react-icons/lib/components/UserSyncIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UserSyncIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
