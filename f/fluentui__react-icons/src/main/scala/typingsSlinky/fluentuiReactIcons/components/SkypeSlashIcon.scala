...
object SkypeSlashIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeSlashIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeSlashIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
