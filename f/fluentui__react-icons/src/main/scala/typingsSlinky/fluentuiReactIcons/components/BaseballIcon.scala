...
object BaseballIcon {
  @JSImport("@fluentui/react-icons/lib/components/BaseballIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BaseballIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
