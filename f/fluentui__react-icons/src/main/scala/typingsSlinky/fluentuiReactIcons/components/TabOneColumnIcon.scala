...
object TabOneColumnIcon {
  @JSImport("@fluentui/react-icons/lib/components/TabOneColumnIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TabOneColumnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
