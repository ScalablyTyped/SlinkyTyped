...
object ColumnVerticalSectionIcon {
  @JSImport("@fluentui/react-icons/lib/components/ColumnVerticalSectionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ColumnVerticalSectionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
