...
object MegaphoneIcon {
  @JSImport("@fluentui/react-icons/lib/components/MegaphoneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MegaphoneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
