...
object SkypeClockIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeClockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeClockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
