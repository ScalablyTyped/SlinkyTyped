...
object MiniExpandMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MiniExpandMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MiniExpandMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
