...
object BankIcon {
  @JSImport("@fluentui/react-icons/lib/components/BankIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BankIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
