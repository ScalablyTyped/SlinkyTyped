...
object SwitchUserIcon {
  @JSImport("@fluentui/react-icons/lib/components/SwitchUserIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SwitchUserIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
