...
object AlignVerticalBottomIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlignVerticalBottomIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlignVerticalBottomIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
