...
object RotateIcon {
  @JSImport("@fluentui/react-icons/lib/components/RotateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RotateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
