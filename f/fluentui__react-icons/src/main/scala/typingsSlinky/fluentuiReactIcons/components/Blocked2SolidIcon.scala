...
object Blocked2SolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/Blocked2SolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Blocked2SolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
