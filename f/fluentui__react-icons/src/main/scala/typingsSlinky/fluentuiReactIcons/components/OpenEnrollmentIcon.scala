...
object OpenEnrollmentIcon {
  @JSImport("@fluentui/react-icons/lib/components/OpenEnrollmentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OpenEnrollmentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
