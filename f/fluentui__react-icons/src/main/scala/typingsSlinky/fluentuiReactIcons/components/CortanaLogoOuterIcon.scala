...
object CortanaLogoOuterIcon {
  
  @JSImport("@fluentui/react-icons", "CortanaLogoOuterIcon")
  @js.native
  ...
  implicit def make(companion: CortanaLogoOuterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
