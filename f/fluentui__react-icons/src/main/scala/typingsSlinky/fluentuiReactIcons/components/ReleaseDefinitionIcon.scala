...
object ReleaseDefinitionIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReleaseDefinitionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReleaseDefinitionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
