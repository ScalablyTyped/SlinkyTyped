...
object FormLibraryIcon {
  @JSImport("@fluentui/react-icons/lib/components/FormLibraryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FormLibraryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
