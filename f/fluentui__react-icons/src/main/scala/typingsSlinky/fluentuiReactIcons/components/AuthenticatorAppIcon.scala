...
object AuthenticatorAppIcon {
  @JSImport("@fluentui/react-icons/lib/components/AuthenticatorAppIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AuthenticatorAppIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
