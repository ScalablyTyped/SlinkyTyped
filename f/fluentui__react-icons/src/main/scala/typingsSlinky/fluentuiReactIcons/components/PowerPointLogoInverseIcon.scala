...
object PowerPointLogoInverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/PowerPointLogoInverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PowerPointLogoInverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
