...
object AzureServiceEndpointIcon {
  @JSImport("@fluentui/react-icons/lib/components/AzureServiceEndpointIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AzureServiceEndpointIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
