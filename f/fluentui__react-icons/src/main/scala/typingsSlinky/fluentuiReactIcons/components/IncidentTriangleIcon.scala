...
object IncidentTriangleIcon {
  @JSImport("@fluentui/react-icons/lib/components/IncidentTriangleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IncidentTriangleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
