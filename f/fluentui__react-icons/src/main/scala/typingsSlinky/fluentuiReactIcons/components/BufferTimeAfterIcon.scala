...
object BufferTimeAfterIcon {
  @JSImport("@fluentui/react-icons/lib/components/BufferTimeAfterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BufferTimeAfterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
