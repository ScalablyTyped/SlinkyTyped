...
object FollowUserIcon {
  @JSImport("@fluentui/react-icons/lib/components/FollowUserIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FollowUserIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
