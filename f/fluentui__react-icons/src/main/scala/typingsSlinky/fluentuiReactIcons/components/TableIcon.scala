...
object TableIcon {
  @JSImport("@fluentui/react-icons/lib/components/TableIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TableIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
