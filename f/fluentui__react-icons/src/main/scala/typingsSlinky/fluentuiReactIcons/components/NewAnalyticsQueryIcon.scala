...
object NewAnalyticsQueryIcon {
  @JSImport("@fluentui/react-icons/lib/components/NewAnalyticsQueryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NewAnalyticsQueryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
