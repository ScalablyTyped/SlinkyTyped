...
object FastModeIcon {
  @JSImport("@fluentui/react-icons/lib/components/FastModeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FastModeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
