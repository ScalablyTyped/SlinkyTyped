...
object ExploreContentIcon {
  @JSImport("@fluentui/react-icons/lib/components/ExploreContentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ExploreContentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
