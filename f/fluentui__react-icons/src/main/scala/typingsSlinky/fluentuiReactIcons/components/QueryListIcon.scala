...
object QueryListIcon {
  @JSImport("@fluentui/react-icons/lib/components/QueryListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QueryListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
