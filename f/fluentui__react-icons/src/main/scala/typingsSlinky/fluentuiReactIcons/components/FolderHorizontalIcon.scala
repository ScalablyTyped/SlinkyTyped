...
object FolderHorizontalIcon {
  @JSImport("@fluentui/react-icons/lib/components/FolderHorizontalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FolderHorizontalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
