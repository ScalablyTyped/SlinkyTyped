...
object EditCreateIcon {
  @JSImport("@fluentui/react-icons/lib/components/EditCreateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EditCreateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
