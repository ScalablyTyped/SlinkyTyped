...
object SyncFolderIcon {
  @JSImport("@fluentui/react-icons/lib/components/SyncFolderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SyncFolderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
