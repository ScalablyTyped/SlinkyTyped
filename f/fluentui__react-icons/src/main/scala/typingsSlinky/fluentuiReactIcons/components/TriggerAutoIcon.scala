...
object TriggerAutoIcon {
  @JSImport("@fluentui/react-icons/lib/components/TriggerAutoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TriggerAutoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
