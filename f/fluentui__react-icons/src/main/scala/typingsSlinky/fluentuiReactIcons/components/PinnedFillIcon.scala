...
object PinnedFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/PinnedFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PinnedFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
