...
object ToggleThumbIcon {
  @JSImport("@fluentui/react-icons/lib/components/ToggleThumbIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ToggleThumbIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
