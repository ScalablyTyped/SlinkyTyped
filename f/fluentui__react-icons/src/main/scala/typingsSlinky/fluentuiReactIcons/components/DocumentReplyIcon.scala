...
object DocumentReplyIcon {
  @JSImport("@fluentui/react-icons/lib/components/DocumentReplyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DocumentReplyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
