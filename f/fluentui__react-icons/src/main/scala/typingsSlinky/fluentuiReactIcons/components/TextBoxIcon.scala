...
object TextBoxIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextBoxIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextBoxIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
