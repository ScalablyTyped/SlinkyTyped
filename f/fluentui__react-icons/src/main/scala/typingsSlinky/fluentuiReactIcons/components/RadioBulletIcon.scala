...
object RadioBulletIcon {
  @JSImport("@fluentui/react-icons/lib/components/RadioBulletIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RadioBulletIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
