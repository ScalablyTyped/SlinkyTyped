...
object TypeScriptLanguageIcon {
  @JSImport("@fluentui/react-icons/lib/components/TypeScriptLanguageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TypeScriptLanguageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
