...
object TextDocumentIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextDocumentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextDocumentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
