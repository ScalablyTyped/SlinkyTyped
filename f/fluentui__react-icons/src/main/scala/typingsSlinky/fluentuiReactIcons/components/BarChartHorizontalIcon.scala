...
object BarChartHorizontalIcon {
  @JSImport("@fluentui/react-icons/lib/components/BarChartHorizontalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BarChartHorizontalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
