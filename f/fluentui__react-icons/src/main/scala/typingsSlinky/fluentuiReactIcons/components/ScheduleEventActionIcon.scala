...
object ScheduleEventActionIcon {
  @JSImport("@fluentui/react-icons/lib/components/ScheduleEventActionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ScheduleEventActionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
