...
object ChevronRightMedIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChevronRightMedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChevronRightMedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
