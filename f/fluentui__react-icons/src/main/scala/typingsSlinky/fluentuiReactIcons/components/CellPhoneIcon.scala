...
object CellPhoneIcon {
  @JSImport("@fluentui/react-icons/lib/components/CellPhoneIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CellPhoneIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
