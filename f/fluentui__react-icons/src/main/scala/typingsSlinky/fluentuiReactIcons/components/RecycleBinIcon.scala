...
object RecycleBinIcon {
  @JSImport("@fluentui/react-icons/lib/components/RecycleBinIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RecycleBinIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
