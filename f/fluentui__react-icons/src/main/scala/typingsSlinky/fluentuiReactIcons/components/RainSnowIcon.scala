...
object RainSnowIcon {
  @JSImport("@fluentui/react-icons/lib/components/RainSnowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RainSnowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
