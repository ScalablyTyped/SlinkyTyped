...
object SharedDatabaseIcon {
  
  @JSImport("@fluentui/react-icons", "SharedDatabaseIcon")
  @js.native
  ...
  implicit def make(companion: SharedDatabaseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
