...
object PentagonIcon {
  @JSImport("@fluentui/react-icons/lib/components/PentagonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PentagonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
