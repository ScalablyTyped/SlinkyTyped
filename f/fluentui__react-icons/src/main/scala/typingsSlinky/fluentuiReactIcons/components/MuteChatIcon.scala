...
object MuteChatIcon {
  @JSImport("@fluentui/react-icons/lib/components/MuteChatIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MuteChatIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
