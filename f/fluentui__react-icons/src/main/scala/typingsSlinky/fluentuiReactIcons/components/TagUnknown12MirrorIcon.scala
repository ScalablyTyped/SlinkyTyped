...
object TagUnknown12MirrorIcon {
  ...
  implicit def make(companion: TagUnknown12MirrorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
