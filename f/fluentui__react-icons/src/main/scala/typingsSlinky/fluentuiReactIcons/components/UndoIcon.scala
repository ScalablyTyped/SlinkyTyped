...
object UndoIcon {
  @JSImport("@fluentui/react-icons/lib/components/UndoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UndoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
