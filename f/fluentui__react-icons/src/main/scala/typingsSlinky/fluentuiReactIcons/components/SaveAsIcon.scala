...
object SaveAsIcon {
  @JSImport("@fluentui/react-icons/lib/components/SaveAsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SaveAsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
