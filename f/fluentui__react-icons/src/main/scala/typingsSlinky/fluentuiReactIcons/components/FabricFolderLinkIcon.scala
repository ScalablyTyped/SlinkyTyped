...
object FabricFolderLinkIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricFolderLinkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricFolderLinkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
