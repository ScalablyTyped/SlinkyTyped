...
object DockRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/DockRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DockRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
