...
object SplitIcon {
  @JSImport("@fluentui/react-icons/lib/components/SplitIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SplitIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
