...
object QRCodeIcon {
  @JSImport("@fluentui/react-icons/lib/components/QRCodeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QRCodeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
