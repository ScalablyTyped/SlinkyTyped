...
object ImportantIcon {
  @JSImport("@fluentui/react-icons/lib/components/ImportantIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ImportantIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
