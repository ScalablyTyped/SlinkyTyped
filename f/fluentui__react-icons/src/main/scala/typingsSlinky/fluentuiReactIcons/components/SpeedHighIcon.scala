...
object SpeedHighIcon {
  @JSImport("@fluentui/react-icons/lib/components/SpeedHighIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SpeedHighIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
