...
object PowerBILogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/PowerBILogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PowerBILogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
