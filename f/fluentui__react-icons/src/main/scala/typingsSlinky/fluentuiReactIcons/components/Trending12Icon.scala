...
object Trending12Icon {
  @JSImport("@fluentui/react-icons/lib/components/Trending12Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Trending12Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
