...
object ResetIcon {
  @JSImport("@fluentui/react-icons/lib/components/ResetIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ResetIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
