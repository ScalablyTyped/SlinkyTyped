...
object OneDriveLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/OneDriveLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OneDriveLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
