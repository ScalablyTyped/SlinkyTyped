...
object PhishingIcon {
  @JSImport("@fluentui/react-icons/lib/components/PhishingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PhishingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
