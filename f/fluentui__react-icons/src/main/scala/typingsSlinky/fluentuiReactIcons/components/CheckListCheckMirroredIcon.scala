...
object CheckListCheckMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/CheckListCheckMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CheckListCheckMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
