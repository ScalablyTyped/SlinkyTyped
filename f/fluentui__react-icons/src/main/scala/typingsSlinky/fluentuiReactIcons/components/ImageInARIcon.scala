...
object ImageInARIcon {
  @JSImport("@fluentui/react-icons/lib/components/ImageInARIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ImageInARIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
