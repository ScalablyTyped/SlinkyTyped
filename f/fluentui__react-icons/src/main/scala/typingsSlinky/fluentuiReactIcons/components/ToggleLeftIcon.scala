...
object ToggleLeftIcon {
  
  @JSImport("@fluentui/react-icons", "ToggleLeftIcon")
  @js.native
  ...
  implicit def make(companion: ToggleLeftIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
