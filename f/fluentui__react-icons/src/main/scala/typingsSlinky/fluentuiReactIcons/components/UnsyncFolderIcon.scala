...
object UnsyncFolderIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnsyncFolderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnsyncFolderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
