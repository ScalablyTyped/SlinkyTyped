...
object ClosedCaptionIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClosedCaptionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClosedCaptionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
