...
object SeeDoIcon {
  @JSImport("@fluentui/react-icons/lib/components/SeeDoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SeeDoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
