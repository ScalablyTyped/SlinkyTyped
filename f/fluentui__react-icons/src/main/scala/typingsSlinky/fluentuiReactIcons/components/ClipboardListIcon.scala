...
object ClipboardListIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClipboardListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClipboardListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
