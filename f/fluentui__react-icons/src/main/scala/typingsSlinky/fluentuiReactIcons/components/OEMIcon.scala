...
object OEMIcon {
  @JSImport("@fluentui/react-icons/lib/components/OEMIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OEMIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
