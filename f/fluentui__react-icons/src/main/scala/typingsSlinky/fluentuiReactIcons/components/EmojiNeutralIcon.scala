...
object EmojiNeutralIcon {
  @JSImport("@fluentui/react-icons/lib/components/EmojiNeutralIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EmojiNeutralIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
