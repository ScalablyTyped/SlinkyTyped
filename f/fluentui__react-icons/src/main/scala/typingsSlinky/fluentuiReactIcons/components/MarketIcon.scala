...
object MarketIcon {
  @JSImport("@fluentui/react-icons/lib/components/MarketIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MarketIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
