...
object MergeDuplicateIcon {
  @JSImport("@fluentui/react-icons/lib/components/MergeDuplicateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MergeDuplicateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
