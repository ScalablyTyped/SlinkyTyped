...
object ActivityFeedIcon {
  @JSImport("@fluentui/react-icons/lib/components/ActivityFeedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ActivityFeedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
