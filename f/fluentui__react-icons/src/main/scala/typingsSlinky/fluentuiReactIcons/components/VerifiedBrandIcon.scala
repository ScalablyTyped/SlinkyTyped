...
object VerifiedBrandIcon {
  @JSImport("@fluentui/react-icons/lib/components/VerifiedBrandIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VerifiedBrandIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
