...
object HalfAlphaIcon {
  @JSImport("@fluentui/react-icons/lib/components/HalfAlphaIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HalfAlphaIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
