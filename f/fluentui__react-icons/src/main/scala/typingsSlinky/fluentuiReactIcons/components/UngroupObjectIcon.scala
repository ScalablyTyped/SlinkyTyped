...
object UngroupObjectIcon {
  @JSImport("@fluentui/react-icons/lib/components/UngroupObjectIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UngroupObjectIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
