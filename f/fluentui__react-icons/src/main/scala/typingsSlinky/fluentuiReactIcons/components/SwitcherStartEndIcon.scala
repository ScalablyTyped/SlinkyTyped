...
object SwitcherStartEndIcon {
  @JSImport("@fluentui/react-icons/lib/components/SwitcherStartEndIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SwitcherStartEndIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
