...
object BorderDashIcon {
  @JSImport("@fluentui/react-icons/lib/components/BorderDashIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BorderDashIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
