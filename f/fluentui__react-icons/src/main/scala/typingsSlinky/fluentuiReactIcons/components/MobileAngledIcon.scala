...
object MobileAngledIcon {
  @JSImport("@fluentui/react-icons/lib/components/MobileAngledIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MobileAngledIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
