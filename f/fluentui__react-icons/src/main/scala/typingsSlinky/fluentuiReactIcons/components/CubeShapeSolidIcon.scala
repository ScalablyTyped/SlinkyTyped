...
object CubeShapeSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/CubeShapeSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CubeShapeSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
