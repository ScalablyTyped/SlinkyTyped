...
object Header4Icon {
  @JSImport("@fluentui/react-icons/lib/components/Header4Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Header4Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
