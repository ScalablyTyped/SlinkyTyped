...
object NavigateExternalInlineIcon {
  @JSImport("@fluentui/react-icons/lib/components/NavigateExternalInlineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NavigateExternalInlineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
