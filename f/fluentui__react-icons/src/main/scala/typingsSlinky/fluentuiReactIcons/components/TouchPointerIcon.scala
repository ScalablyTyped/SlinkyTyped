...
object TouchPointerIcon {
  @JSImport("@fluentui/react-icons/lib/components/TouchPointerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TouchPointerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
