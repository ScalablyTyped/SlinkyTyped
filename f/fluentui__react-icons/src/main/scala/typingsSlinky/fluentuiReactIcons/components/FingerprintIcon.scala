...
object FingerprintIcon {
  @JSImport("@fluentui/react-icons/lib/components/FingerprintIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FingerprintIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
