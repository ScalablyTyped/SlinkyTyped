...
object PlugConnectedIcon {
  @JSImport("@fluentui/react-icons/lib/components/PlugConnectedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PlugConnectedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
