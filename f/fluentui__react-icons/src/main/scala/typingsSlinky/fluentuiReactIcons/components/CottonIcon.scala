...
object CottonIcon {
  @JSImport("@fluentui/react-icons/lib/components/CottonIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CottonIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
