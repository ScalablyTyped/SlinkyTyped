...
object AnchorLockIcon {
  @JSImport("@fluentui/react-icons/lib/components/AnchorLockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AnchorLockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
