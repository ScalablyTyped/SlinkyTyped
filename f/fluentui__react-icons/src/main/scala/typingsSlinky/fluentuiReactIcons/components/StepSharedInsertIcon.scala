...
object StepSharedInsertIcon {
  @JSImport("@fluentui/react-icons/lib/components/StepSharedInsertIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StepSharedInsertIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
