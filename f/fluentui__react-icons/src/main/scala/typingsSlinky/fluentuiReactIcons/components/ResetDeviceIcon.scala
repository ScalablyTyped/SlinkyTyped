...
object ResetDeviceIcon {
  @JSImport("@fluentui/react-icons/lib/components/ResetDeviceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ResetDeviceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
