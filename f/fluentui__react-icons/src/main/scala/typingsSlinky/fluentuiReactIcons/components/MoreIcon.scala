...
object MoreIcon {
  @JSImport("@fluentui/react-icons/lib/components/MoreIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MoreIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
