...
object OneNoteLogoInverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/OneNoteLogoInverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OneNoteLogoInverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
