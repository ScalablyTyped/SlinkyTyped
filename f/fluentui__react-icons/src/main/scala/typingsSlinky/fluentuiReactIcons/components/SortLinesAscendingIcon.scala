...
object SortLinesAscendingIcon {
  @JSImport("@fluentui/react-icons/lib/components/SortLinesAscendingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SortLinesAscendingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
