...
object SearchBookmarkIcon {
  @JSImport("@fluentui/react-icons/lib/components/SearchBookmarkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SearchBookmarkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
