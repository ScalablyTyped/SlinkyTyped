...
object RewindEightXIcon {
  @JSImport("@fluentui/react-icons/lib/components/RewindEightXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RewindEightXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
