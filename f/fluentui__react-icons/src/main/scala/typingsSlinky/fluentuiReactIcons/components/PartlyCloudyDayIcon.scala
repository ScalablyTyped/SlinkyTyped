...
object PartlyCloudyDayIcon {
  @JSImport("@fluentui/react-icons/lib/components/PartlyCloudyDayIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PartlyCloudyDayIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
