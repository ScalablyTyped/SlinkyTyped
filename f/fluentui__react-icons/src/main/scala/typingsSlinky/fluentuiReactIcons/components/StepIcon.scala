...
object StepIcon {
  @JSImport("@fluentui/react-icons/lib/components/StepIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StepIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
