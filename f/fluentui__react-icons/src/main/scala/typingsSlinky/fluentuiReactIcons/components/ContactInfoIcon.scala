...
object ContactInfoIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContactInfoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContactInfoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
