...
object RewindIcon {
  @JSImport("@fluentui/react-icons/lib/components/RewindIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RewindIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
