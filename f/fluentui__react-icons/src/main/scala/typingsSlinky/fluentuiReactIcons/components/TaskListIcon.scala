...
object TaskListIcon {
  @JSImport("@fluentui/react-icons/lib/components/TaskListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TaskListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
