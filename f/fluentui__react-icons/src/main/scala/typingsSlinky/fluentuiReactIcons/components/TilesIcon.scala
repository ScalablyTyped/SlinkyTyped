...
object TilesIcon {
  @JSImport("@fluentui/react-icons/lib/components/TilesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TilesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
