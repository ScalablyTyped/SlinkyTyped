...
object HalfCircleIcon {
  @JSImport("@fluentui/react-icons/lib/components/HalfCircleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HalfCircleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
