...
object RightDoubleQuoteIcon {
  @JSImport("@fluentui/react-icons/lib/components/RightDoubleQuoteIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RightDoubleQuoteIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
