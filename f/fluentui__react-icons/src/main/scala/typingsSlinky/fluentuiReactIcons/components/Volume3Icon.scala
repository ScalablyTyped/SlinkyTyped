...
object Volume3Icon {
  @JSImport("@fluentui/react-icons", "Volume3Icon")
  @js.native
  ...
  implicit def make(companion: Volume3Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
