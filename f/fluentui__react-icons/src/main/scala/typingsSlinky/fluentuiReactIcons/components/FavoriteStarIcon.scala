...
object FavoriteStarIcon {
  @JSImport("@fluentui/react-icons/lib/components/FavoriteStarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FavoriteStarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
