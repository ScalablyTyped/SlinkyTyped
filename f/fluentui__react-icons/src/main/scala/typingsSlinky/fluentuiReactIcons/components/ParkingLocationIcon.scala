...
object ParkingLocationIcon {
  @JSImport("@fluentui/react-icons/lib/components/ParkingLocationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ParkingLocationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
