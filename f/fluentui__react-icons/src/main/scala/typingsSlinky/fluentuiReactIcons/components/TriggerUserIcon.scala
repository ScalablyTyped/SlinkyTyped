...
object TriggerUserIcon {
  @JSImport("@fluentui/react-icons/lib/components/TriggerUserIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TriggerUserIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
