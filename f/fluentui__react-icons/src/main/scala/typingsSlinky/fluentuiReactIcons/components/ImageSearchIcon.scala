...
object ImageSearchIcon {
  @JSImport("@fluentui/react-icons/lib/components/ImageSearchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ImageSearchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
