...
object LandscapeOrientationIcon {
  @JSImport("@fluentui/react-icons/lib/components/LandscapeOrientationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LandscapeOrientationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
