...
object MaximumValueIcon {
  @JSImport("@fluentui/react-icons/lib/components/MaximumValueIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MaximumValueIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
