...
object StickyNotesSolidAppIconIcon {
  @JSImport("@fluentui/react-icons/lib/components/StickyNotesSolidAppIconIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StickyNotesSolidAppIconIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
