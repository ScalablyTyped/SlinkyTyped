...
object PublishCourseIcon {
  @JSImport("@fluentui/react-icons/lib/components/PublishCourseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PublishCourseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
