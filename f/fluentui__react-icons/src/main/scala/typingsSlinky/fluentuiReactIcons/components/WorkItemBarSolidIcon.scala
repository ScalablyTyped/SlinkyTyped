...
object WorkItemBarSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/WorkItemBarSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WorkItemBarSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
