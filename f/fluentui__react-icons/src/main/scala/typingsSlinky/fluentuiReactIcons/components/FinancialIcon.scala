...
object FinancialIcon {
  @JSImport("@fluentui/react-icons/lib/components/FinancialIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FinancialIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
