...
object TimeEntryIcon {
  @JSImport("@fluentui/react-icons/lib/components/TimeEntryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TimeEntryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
