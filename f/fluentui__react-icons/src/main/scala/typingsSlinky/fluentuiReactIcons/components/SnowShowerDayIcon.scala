...
object SnowShowerDayIcon {
  @JSImport("@fluentui/react-icons/lib/components/SnowShowerDayIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnowShowerDayIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
