...
object DownIcon {
  @JSImport("@fluentui/react-icons/lib/components/DownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
