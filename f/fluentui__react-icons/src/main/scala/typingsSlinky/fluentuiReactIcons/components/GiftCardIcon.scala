...
object GiftCardIcon {
  @JSImport("@fluentui/react-icons/lib/components/GiftCardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GiftCardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
