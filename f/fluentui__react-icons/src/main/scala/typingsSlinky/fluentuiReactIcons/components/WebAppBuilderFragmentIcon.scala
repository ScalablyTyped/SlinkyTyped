...
object WebAppBuilderFragmentIcon {
  @JSImport("@fluentui/react-icons/lib/components/WebAppBuilderFragmentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WebAppBuilderFragmentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
