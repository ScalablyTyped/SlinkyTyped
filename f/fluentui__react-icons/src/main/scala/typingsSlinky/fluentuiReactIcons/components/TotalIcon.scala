...
object TotalIcon {
  @JSImport("@fluentui/react-icons/lib/components/TotalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TotalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
