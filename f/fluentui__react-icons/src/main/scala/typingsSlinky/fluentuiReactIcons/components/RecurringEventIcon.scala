...
object RecurringEventIcon {
  @JSImport("@fluentui/react-icons/lib/components/RecurringEventIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RecurringEventIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
