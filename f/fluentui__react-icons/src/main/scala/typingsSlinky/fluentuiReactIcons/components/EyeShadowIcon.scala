...
object EyeShadowIcon {
  @JSImport("@fluentui/react-icons/lib/components/EyeShadowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EyeShadowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
