...
object HandsFreeIcon {
  @JSImport("@fluentui/react-icons/lib/components/HandsFreeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HandsFreeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
