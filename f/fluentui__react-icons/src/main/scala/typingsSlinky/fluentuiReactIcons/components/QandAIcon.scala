...
object QandAIcon {
  @JSImport("@fluentui/react-icons/lib/components/QandAIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QandAIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
