...
object MountainClimbingIcon {
  @JSImport("@fluentui/react-icons/lib/components/MountainClimbingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MountainClimbingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
