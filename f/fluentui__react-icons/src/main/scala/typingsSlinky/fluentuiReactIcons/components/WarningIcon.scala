...
object WarningIcon {
  @JSImport("@fluentui/react-icons/lib/components/WarningIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WarningIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
