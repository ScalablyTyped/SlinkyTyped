...
object GenerateIcon {
  @JSImport("@fluentui/react-icons/lib/components/GenerateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GenerateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
