...
object VisuallyImpairedIcon {
  @JSImport("@fluentui/react-icons/lib/components/VisuallyImpairedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VisuallyImpairedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
