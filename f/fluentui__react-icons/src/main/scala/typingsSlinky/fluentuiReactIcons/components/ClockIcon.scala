...
object ClockIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClockIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClockIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
