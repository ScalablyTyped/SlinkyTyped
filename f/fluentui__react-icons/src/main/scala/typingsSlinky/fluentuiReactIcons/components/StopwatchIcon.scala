...
object StopwatchIcon {
  @JSImport("@fluentui/react-icons/lib/components/StopwatchIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StopwatchIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
