...
object ProjectDocumentIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProjectDocumentIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProjectDocumentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
