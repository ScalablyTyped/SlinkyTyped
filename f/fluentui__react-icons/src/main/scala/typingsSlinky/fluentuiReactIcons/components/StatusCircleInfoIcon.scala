...
object StatusCircleInfoIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleInfoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleInfoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
