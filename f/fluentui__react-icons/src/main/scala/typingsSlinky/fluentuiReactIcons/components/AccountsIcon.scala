...
object AccountsIcon {
  @JSImport("@fluentui/react-icons/lib/components/AccountsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AccountsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
