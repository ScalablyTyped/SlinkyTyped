...
object IncreaseIndentLegacyIcon {
  @JSImport("@fluentui/react-icons/lib/components/IncreaseIndentLegacyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IncreaseIndentLegacyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
