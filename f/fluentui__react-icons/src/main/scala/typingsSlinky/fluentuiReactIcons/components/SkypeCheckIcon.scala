...
object SkypeCheckIcon {
  @JSImport("@fluentui/react-icons/lib/components/SkypeCheckIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SkypeCheckIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
