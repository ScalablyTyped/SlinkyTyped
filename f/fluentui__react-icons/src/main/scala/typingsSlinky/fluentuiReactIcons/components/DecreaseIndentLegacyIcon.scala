...
object DecreaseIndentLegacyIcon {
  @JSImport("@fluentui/react-icons/lib/components/DecreaseIndentLegacyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DecreaseIndentLegacyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
