...
object TaskGroupIcon {
  @JSImport("@fluentui/react-icons/lib/components/TaskGroupIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TaskGroupIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
