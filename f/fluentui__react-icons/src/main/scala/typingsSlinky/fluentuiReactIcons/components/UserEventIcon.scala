...
object UserEventIcon {
  @JSImport("@fluentui/react-icons/lib/components/UserEventIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UserEventIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
