...
object ProgressLoopInnerIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProgressLoopInnerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProgressLoopInnerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
