...
object CocktailsIcon {
  @JSImport("@fluentui/react-icons/lib/components/CocktailsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CocktailsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
