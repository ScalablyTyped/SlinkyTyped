...
object FastForwardPointFiveXIcon {
  @JSImport("@fluentui/react-icons/lib/components/FastForwardPointFiveXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FastForwardPointFiveXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
