...
object StatusCircleInnerIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleInnerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleInnerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
