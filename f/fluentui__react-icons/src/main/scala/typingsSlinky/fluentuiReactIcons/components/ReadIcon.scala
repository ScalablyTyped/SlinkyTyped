...
object ReadIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReadIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReadIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
