...
object JenkinsLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/JenkinsLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: JenkinsLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
