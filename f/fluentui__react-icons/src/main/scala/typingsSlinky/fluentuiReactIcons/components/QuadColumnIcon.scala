...
object QuadColumnIcon {
  @JSImport("@fluentui/react-icons/lib/components/QuadColumnIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: QuadColumnIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
