...
object InstallationIcon {
  @JSImport("@fluentui/react-icons/lib/components/InstallationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InstallationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
