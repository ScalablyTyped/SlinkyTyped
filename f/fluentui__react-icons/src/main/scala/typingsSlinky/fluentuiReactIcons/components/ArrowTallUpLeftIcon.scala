...
object ArrowTallUpLeftIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrowTallUpLeftIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrowTallUpLeftIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
