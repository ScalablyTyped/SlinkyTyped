...
object SliderThumbIcon {
  @JSImport("@fluentui/react-icons/lib/components/SliderThumbIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SliderThumbIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
