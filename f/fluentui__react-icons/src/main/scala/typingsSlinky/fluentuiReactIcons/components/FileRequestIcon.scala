...
object FileRequestIcon {
  @JSImport("@fluentui/react-icons/lib/components/FileRequestIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FileRequestIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
