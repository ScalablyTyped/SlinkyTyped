...
object AlignVerticalCenterIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlignVerticalCenterIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlignVerticalCenterIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
