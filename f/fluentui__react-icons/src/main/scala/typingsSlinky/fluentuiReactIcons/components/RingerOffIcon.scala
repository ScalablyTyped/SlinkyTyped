...
object RingerOffIcon {
  @JSImport("@fluentui/react-icons/lib/components/RingerOffIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RingerOffIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
