...
object SellIcon {
  @JSImport("@fluentui/react-icons/lib/components/SellIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SellIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
