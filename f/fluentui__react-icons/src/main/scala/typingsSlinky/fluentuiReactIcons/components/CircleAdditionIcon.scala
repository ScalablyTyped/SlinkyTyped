...
object CircleAdditionIcon {
  @JSImport("@fluentui/react-icons/lib/components/CircleAdditionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CircleAdditionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
