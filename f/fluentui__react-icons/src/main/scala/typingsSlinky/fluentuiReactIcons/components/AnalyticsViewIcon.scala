...
object AnalyticsViewIcon {
  @JSImport("@fluentui/react-icons/lib/components/AnalyticsViewIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AnalyticsViewIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
