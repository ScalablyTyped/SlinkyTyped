...
object HighlightIcon {
  @JSImport("@fluentui/react-icons/lib/components/HighlightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HighlightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
