...
object KeyPhraseExtractionIcon {
  @JSImport("@fluentui/react-icons/lib/components/KeyPhraseExtractionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: KeyPhraseExtractionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
