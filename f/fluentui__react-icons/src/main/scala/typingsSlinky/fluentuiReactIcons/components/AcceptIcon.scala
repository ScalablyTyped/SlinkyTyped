...
object AcceptIcon {
  @JSImport("@fluentui/react-icons/lib/components/AcceptIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AcceptIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
