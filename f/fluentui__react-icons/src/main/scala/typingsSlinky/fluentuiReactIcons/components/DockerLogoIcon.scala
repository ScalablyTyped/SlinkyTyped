...
object DockerLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/DockerLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DockerLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
