...
object ProcessingPauseIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProcessingPauseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProcessingPauseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
