...
object RunningIcon {
  @JSImport("@fluentui/react-icons/lib/components/RunningIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RunningIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
