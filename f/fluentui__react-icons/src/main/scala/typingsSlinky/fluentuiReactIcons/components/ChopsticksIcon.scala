...
object ChopsticksIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChopsticksIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChopsticksIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
