...
object LinkedInLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/LinkedInLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LinkedInLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
