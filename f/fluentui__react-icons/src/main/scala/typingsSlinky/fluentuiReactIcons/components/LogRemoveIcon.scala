...
object LogRemoveIcon {
  @JSImport("@fluentui/react-icons/lib/components/LogRemoveIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LogRemoveIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
