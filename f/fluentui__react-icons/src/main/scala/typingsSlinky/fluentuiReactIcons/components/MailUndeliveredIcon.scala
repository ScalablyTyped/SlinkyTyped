...
object MailUndeliveredIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailUndeliveredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailUndeliveredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
