...
object CaretHollowIcon {
  @JSImport("@fluentui/react-icons/lib/components/CaretHollowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CaretHollowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
