...
object FabricPictureLibraryIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricPictureLibraryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricPictureLibraryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
