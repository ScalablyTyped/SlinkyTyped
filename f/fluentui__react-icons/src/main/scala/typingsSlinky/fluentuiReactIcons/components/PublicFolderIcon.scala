...
object PublicFolderIcon {
  @JSImport("@fluentui/react-icons/lib/components/PublicFolderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PublicFolderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
