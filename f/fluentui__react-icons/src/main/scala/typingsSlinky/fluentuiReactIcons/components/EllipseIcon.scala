...
object EllipseIcon {
  @JSImport("@fluentui/react-icons/lib/components/EllipseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EllipseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
