...
object MailReplyIcon {
  @JSImport("@fluentui/react-icons/lib/components/MailReplyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MailReplyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
