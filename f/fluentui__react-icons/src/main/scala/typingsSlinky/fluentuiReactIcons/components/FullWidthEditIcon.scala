...
object FullWidthEditIcon {
  @JSImport("@fluentui/react-icons/lib/components/FullWidthEditIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FullWidthEditIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
