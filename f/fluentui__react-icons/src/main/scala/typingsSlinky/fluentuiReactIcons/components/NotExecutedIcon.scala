...
object NotExecutedIcon {
  @JSImport("@fluentui/react-icons/lib/components/NotExecutedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NotExecutedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
