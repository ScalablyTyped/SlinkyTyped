...
object PythonLogoBlueIcon {
  @JSImport("@fluentui/react-icons/lib/components/PythonLogoBlueIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PythonLogoBlueIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
