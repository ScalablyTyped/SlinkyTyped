...
object TriangleShapeIcon {
  @JSImport("@fluentui/react-icons/lib/components/TriangleShapeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TriangleShapeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
