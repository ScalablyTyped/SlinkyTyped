...
object BoxAdditionSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/BoxAdditionSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BoxAdditionSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
