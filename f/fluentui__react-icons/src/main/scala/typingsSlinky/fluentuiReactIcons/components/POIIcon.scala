...
object POIIcon {
  @JSImport("@fluentui/react-icons/lib/components/POIIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: POIIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
