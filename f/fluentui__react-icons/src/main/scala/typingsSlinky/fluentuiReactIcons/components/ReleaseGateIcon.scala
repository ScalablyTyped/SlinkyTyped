...
object ReleaseGateIcon {
  @JSImport("@fluentui/react-icons", "ReleaseGateIcon")
  @js.native
  ...
  implicit def make(companion: ReleaseGateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
