...
object MapDirectionsIcon {
  @JSImport("@fluentui/react-icons/lib/components/MapDirectionsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MapDirectionsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
