...
object RepeatAllIcon {
  @JSImport("@fluentui/react-icons/lib/components/RepeatAllIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RepeatAllIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
