...
object CircleStopIcon {
  @JSImport("@fluentui/react-icons/lib/components/CircleStopIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CircleStopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
