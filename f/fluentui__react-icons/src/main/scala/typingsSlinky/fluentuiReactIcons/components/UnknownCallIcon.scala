...
object UnknownCallIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnknownCallIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnknownCallIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
