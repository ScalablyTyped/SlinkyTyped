...
object FieldRequiredIcon {
  @JSImport("@fluentui/react-icons/lib/components/FieldRequiredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FieldRequiredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
