...
object ViewListIcon {
  @JSImport("@fluentui/react-icons/lib/components/ViewListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ViewListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
