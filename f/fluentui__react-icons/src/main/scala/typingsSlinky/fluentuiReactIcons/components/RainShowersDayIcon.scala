...
object RainShowersDayIcon {
  @JSImport("@fluentui/react-icons/lib/components/RainShowersDayIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RainShowersDayIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
