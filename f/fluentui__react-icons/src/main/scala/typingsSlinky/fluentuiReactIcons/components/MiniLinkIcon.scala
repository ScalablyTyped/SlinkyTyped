...
object MiniLinkIcon {
  @JSImport("@fluentui/react-icons/lib/components/MiniLinkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MiniLinkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
