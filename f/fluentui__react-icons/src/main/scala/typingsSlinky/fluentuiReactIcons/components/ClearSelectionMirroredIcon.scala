...
object ClearSelectionMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClearSelectionMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClearSelectionMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
