...
object TennisIcon {
  @JSImport("@fluentui/react-icons/lib/components/TennisIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TennisIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
