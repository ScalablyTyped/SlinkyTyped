...
object PublicContactCardIcon {
  @JSImport("@fluentui/react-icons/lib/components/PublicContactCardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PublicContactCardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
