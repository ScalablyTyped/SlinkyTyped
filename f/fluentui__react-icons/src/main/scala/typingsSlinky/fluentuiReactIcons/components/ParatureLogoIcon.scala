...
object ParatureLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/ParatureLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ParatureLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
