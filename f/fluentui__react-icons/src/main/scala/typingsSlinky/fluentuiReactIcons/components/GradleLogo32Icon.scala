...
object GradleLogo32Icon {
  @JSImport("@fluentui/react-icons/lib/components/GradleLogo32Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GradleLogo32Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
