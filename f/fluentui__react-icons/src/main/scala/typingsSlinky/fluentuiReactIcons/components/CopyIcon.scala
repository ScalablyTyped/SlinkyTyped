...
object CopyIcon {
  @JSImport("@fluentui/react-icons/lib/components/CopyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CopyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
