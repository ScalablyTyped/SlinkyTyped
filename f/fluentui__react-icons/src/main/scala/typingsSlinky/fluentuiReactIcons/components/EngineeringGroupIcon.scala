...
object EngineeringGroupIcon {
  @JSImport("@fluentui/react-icons/lib/components/EngineeringGroupIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EngineeringGroupIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
