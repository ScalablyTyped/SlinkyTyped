...
object RadioBtnOffIcon {
  @JSImport("@fluentui/react-icons/lib/components/RadioBtnOffIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RadioBtnOffIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
