...
object VSTSAltLogo1Icon {
  @JSImport("@fluentui/react-icons/lib/components/VSTSAltLogo1Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VSTSAltLogo1Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
