...
object ClearIcon {
  @JSImport("@fluentui/react-icons/lib/components/ClearIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ClearIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
