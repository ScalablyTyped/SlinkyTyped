...
object ManufacturingIcon {
  @JSImport("@fluentui/react-icons/lib/components/ManufacturingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ManufacturingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
