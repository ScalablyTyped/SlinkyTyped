...
object VaccinationIcon {
  @JSImport("@fluentui/react-icons/lib/components/VaccinationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VaccinationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
