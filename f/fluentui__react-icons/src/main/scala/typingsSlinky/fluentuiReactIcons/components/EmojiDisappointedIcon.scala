...
object EmojiDisappointedIcon {
  @JSImport("@fluentui/react-icons/lib/components/EmojiDisappointedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EmojiDisappointedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
