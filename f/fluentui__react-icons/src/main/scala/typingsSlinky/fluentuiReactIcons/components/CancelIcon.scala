...
object CancelIcon {
  @JSImport("@fluentui/react-icons/lib/components/CancelIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CancelIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
