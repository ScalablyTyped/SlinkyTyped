...
object ContentFeedIcon {
  @JSImport("@fluentui/react-icons/lib/components/ContentFeedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ContentFeedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
