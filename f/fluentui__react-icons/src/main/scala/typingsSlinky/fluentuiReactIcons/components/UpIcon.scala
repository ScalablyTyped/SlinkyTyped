...
object UpIcon {
  @JSImport("@fluentui/react-icons/lib/components/UpIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UpIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
