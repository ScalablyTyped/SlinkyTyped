...
object RewindFourXIcon {
  @JSImport("@fluentui/react-icons/lib/components/RewindFourXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RewindFourXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
