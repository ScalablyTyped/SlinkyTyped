...
object PhotoIcon {
  @JSImport("@fluentui/react-icons/lib/components/PhotoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PhotoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
