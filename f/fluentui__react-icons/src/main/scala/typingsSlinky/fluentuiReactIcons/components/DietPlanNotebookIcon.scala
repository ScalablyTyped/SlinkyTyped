...
object DietPlanNotebookIcon {
  @JSImport("@fluentui/react-icons/lib/components/DietPlanNotebookIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DietPlanNotebookIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
