...
object GlassesIcon {
  @JSImport("@fluentui/react-icons/lib/components/GlassesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GlassesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
