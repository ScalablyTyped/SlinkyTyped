...
object GridViewLargeIcon {
  @JSImport("@fluentui/react-icons/lib/components/GridViewLargeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GridViewLargeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
