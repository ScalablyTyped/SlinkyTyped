...
object TransitionEffectIcon {
  @JSImport("@fluentui/react-icons/lib/components/TransitionEffectIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TransitionEffectIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
