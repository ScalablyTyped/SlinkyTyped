...
object ForumIcon {
  @JSImport("@fluentui/react-icons/lib/components/ForumIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ForumIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
