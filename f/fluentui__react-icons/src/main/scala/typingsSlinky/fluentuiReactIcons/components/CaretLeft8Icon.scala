...
object CaretLeft8Icon {
  @JSImport("@fluentui/react-icons/lib/components/CaretLeft8Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CaretLeft8Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
