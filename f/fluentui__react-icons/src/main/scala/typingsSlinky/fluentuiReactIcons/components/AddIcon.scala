...
object AddIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
