...
object D365ProjectOperationsIcon {
  @JSImport("@fluentui/react-icons/lib/components/D365ProjectOperationsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: D365ProjectOperationsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
