...
object VideoIcon {
  @JSImport("@fluentui/react-icons/lib/components/VideoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VideoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
