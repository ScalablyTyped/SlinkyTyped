...
object FastForwardOneFiveXIcon {
  @JSImport("@fluentui/react-icons/lib/components/FastForwardOneFiveXIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FastForwardOneFiveXIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
