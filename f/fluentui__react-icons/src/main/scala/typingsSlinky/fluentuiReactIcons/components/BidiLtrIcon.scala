...
object BidiLtrIcon {
  @JSImport("@fluentui/react-icons/lib/components/BidiLtrIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BidiLtrIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
