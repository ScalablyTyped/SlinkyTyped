...
object Tiles2Icon {
  @JSImport("@fluentui/react-icons/lib/components/Tiles2Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Tiles2Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
