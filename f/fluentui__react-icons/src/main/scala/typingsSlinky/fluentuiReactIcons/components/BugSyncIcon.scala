...
object BugSyncIcon {
  @JSImport("@fluentui/react-icons/lib/components/BugSyncIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BugSyncIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
