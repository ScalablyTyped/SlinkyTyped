...
object GripperToolIcon {
  @JSImport("@fluentui/react-icons/lib/components/GripperToolIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GripperToolIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
