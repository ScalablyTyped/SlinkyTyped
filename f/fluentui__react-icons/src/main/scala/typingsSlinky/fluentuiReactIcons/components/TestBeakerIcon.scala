...
object TestBeakerIcon {
  @JSImport("@fluentui/react-icons/lib/components/TestBeakerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TestBeakerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
