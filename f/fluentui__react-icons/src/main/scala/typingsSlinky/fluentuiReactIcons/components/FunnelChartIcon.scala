...
object FunnelChartIcon {
  @JSImport("@fluentui/react-icons/lib/components/FunnelChartIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FunnelChartIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
