...
object GameIcon {
  @JSImport("@fluentui/react-icons/lib/components/GameIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GameIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
