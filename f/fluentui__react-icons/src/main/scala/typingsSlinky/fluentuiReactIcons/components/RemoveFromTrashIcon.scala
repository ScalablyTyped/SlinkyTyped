...
object RemoveFromTrashIcon {
  @JSImport("@fluentui/react-icons/lib/components/RemoveFromTrashIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RemoveFromTrashIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
