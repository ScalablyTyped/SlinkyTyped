...
object RingerRemoveIcon {
  @JSImport("@fluentui/react-icons/lib/components/RingerRemoveIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RingerRemoveIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
