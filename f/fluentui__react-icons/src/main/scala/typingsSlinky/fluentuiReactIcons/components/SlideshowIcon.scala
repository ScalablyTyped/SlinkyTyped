...
object SlideshowIcon {
  @JSImport("@fluentui/react-icons/lib/components/SlideshowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SlideshowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
