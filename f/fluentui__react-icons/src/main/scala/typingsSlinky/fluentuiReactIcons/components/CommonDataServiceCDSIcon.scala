...
object CommonDataServiceCDSIcon {
  @JSImport("@fluentui/react-icons/lib/components/CommonDataServiceCDSIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CommonDataServiceCDSIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
