...
object RowsChildIcon {
  @JSImport("@fluentui/react-icons/lib/components/RowsChildIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RowsChildIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
