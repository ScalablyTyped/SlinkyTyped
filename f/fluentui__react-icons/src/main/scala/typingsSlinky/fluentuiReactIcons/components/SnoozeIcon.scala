...
object SnoozeIcon {
  @JSImport("@fluentui/react-icons/lib/components/SnoozeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnoozeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
