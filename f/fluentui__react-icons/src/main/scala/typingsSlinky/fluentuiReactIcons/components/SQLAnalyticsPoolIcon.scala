...
object SQLAnalyticsPoolIcon {
  @JSImport("@fluentui/react-icons/lib/components/SQLAnalyticsPoolIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SQLAnalyticsPoolIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
