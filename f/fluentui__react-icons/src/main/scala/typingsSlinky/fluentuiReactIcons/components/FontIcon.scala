...
object FontIcon {
  @JSImport("@fluentui/react-icons/lib/components/FontIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FontIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
