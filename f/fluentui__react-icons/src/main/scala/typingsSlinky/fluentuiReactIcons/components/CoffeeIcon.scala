...
object CoffeeIcon {
  @JSImport("@fluentui/react-icons/lib/components/CoffeeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CoffeeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
