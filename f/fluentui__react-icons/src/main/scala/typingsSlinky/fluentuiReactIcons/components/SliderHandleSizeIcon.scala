...
object SliderHandleSizeIcon {
  @JSImport("@fluentui/react-icons/lib/components/SliderHandleSizeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SliderHandleSizeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
