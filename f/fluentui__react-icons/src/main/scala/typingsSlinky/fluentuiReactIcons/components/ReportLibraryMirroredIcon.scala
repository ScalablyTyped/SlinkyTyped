...
object ReportLibraryMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReportLibraryMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReportLibraryMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
