...
object TrackersIcon {
  @JSImport("@fluentui/react-icons/lib/components/TrackersIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TrackersIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
