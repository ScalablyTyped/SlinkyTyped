...
object Blocked2Icon {
  @JSImport("@fluentui/react-icons/lib/components/Blocked2Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Blocked2Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
