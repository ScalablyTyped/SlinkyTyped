...
object PageCheckedOutIcon {
  @JSImport("@fluentui/react-icons/lib/components/PageCheckedOutIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PageCheckedOutIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
