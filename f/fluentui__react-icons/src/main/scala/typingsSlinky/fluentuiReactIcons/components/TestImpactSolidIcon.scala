...
object TestImpactSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/TestImpactSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TestImpactSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
