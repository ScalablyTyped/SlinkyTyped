...
object FlagIcon {
  @JSImport("@fluentui/react-icons/lib/components/FlagIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FlagIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
