...
object PlainTextIcon {
  @JSImport("@fluentui/react-icons/lib/components/PlainTextIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PlainTextIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
