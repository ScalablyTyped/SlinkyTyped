...
object BoxCheckmarkSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/BoxCheckmarkSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BoxCheckmarkSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
