...
object MedalIcon {
  @JSImport("@fluentui/react-icons/lib/components/MedalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MedalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
