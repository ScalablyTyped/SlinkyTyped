...
object IncreaseIndentArrowIcon {
  @JSImport("@fluentui/react-icons/lib/components/IncreaseIndentArrowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IncreaseIndentArrowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
