...
object PeopleIcon {
  @JSImport("@fluentui/react-icons/lib/components/PeopleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PeopleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
