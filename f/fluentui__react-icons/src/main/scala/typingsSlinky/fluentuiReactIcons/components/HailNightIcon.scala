...
object HailNightIcon {
  @JSImport("@fluentui/react-icons/lib/components/HailNightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HailNightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
