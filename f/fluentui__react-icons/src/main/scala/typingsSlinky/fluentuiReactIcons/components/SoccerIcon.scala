...
object SoccerIcon {
  @JSImport("@fluentui/react-icons/lib/components/SoccerIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SoccerIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
