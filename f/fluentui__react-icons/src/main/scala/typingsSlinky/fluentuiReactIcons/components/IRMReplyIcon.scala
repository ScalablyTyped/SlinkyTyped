...
object IRMReplyIcon {
  @JSImport("@fluentui/react-icons/lib/components/IRMReplyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IRMReplyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
