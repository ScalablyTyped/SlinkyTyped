...
object ScreenCastIcon {
  @JSImport("@fluentui/react-icons/lib/components/ScreenCastIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ScreenCastIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
