...
object MusicInCollectionIcon {
  @JSImport("@fluentui/react-icons/lib/components/MusicInCollectionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MusicInCollectionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
