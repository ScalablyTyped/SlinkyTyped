...
object PassiveAuthenticationIcon {
  @JSImport("@fluentui/react-icons/lib/components/PassiveAuthenticationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PassiveAuthenticationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
