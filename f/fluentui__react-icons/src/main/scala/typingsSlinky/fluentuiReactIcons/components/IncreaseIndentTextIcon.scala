...
object IncreaseIndentTextIcon {
  ...
  implicit def make(companion: IncreaseIndentTextIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
