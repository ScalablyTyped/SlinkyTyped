...
object CircleRingIcon {
  @JSImport("@fluentui/react-icons/lib/components/CircleRingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CircleRingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
