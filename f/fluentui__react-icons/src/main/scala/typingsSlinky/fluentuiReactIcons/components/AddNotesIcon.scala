...
object AddNotesIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddNotesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddNotesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
