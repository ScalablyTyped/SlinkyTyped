...
object AddToShoppingListIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddToShoppingListIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddToShoppingListIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
