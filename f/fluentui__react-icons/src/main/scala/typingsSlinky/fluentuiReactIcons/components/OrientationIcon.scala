...
object OrientationIcon {
  @JSImport("@fluentui/react-icons/lib/components/OrientationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OrientationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
