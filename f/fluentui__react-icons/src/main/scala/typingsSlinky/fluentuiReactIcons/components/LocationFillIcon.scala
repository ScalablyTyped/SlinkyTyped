...
object LocationFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/LocationFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LocationFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
