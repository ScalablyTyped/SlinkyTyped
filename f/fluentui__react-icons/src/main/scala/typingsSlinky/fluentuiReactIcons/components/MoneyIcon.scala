...
object MoneyIcon {
  @JSImport("@fluentui/react-icons/lib/components/MoneyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MoneyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
