...
object ReleaseGateErrorIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReleaseGateErrorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReleaseGateErrorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
