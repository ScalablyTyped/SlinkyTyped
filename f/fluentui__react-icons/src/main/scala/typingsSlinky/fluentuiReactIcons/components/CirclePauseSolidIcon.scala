...
object CirclePauseSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/CirclePauseSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CirclePauseSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
