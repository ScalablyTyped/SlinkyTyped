...
object CompletedIcon {
  @JSImport("@fluentui/react-icons/lib/components/CompletedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CompletedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
