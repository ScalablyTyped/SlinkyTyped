...
object BulletedListTextIcon {
  @JSImport("@fluentui/react-icons/lib/components/BulletedListTextIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BulletedListTextIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
