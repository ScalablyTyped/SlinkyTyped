...
object ReopenPagesIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReopenPagesIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReopenPagesIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
