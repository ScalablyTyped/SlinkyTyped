...
object AccountManagementIcon {
  @JSImport("@fluentui/react-icons/lib/components/AccountManagementIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AccountManagementIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
