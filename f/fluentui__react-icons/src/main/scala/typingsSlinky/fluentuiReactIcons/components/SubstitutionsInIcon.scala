...
object SubstitutionsInIcon {
  @JSImport("@fluentui/react-icons/lib/components/SubstitutionsInIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SubstitutionsInIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
