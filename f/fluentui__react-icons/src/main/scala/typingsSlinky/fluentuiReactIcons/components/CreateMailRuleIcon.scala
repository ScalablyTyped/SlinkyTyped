...
object CreateMailRuleIcon {
  @JSImport("@fluentui/react-icons/lib/components/CreateMailRuleIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CreateMailRuleIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
