...
object CouponIcon {
  @JSImport("@fluentui/react-icons", "CouponIcon")
  @js.native
  ...
  implicit def make(companion: CouponIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
