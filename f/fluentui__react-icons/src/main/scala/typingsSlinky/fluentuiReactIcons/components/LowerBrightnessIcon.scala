...
object LowerBrightnessIcon {
  @JSImport("@fluentui/react-icons/lib/components/LowerBrightnessIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LowerBrightnessIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
