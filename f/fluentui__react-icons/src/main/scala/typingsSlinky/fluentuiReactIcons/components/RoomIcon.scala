...
object RoomIcon {
  @JSImport("@fluentui/react-icons/lib/components/RoomIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RoomIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
