...
object FieldReadOnlyIcon {
  @JSImport("@fluentui/react-icons/lib/components/FieldReadOnlyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FieldReadOnlyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
