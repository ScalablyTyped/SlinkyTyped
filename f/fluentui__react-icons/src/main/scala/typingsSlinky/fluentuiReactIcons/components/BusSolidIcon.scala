...
object BusSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/BusSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BusSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
