...
object StreamingOffIcon {
  @JSImport("@fluentui/react-icons/lib/components/StreamingOffIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StreamingOffIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
