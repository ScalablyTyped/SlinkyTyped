...
object TransitionPushIcon {
  @JSImport("@fluentui/react-icons/lib/components/TransitionPushIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TransitionPushIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
