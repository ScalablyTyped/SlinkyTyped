...
object DockLeftMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/DockLeftMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DockLeftMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
