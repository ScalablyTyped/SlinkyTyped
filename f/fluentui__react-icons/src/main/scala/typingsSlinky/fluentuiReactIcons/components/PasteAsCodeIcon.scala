...
object PasteAsCodeIcon {
  @JSImport("@fluentui/react-icons/lib/components/PasteAsCodeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PasteAsCodeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
