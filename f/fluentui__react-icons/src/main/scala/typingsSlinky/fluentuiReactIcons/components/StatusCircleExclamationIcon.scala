...
object StatusCircleExclamationIcon {
  @JSImport("@fluentui/react-icons/lib/components/StatusCircleExclamationIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StatusCircleExclamationIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
