...
object AlignVerticalTopIcon {
  @JSImport("@fluentui/react-icons/lib/components/AlignVerticalTopIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlignVerticalTopIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
