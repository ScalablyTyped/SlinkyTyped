...
object SnowIcon {
  @JSImport("@fluentui/react-icons/lib/components/SnowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
