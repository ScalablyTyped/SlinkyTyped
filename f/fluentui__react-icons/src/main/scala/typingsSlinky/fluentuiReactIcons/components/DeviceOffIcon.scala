...
object DeviceOffIcon {
  @JSImport("@fluentui/react-icons/lib/components/DeviceOffIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DeviceOffIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
