...
object SnapToGridIcon {
  @JSImport("@fluentui/react-icons/lib/components/SnapToGridIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnapToGridIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
