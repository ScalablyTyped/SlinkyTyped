...
object PenWorkspaceIcon {
  
  @JSImport("@fluentui/react-icons", "PenWorkspaceIcon")
  @js.native
  ...
  implicit def make(companion: PenWorkspaceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
