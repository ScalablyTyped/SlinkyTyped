...
object LaptopSelectedIcon {
  @JSImport("@fluentui/react-icons/lib/components/LaptopSelectedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LaptopSelectedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
