...
object AzureKeyVaultIcon {
  @JSImport("@fluentui/react-icons/lib/components/AzureKeyVaultIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AzureKeyVaultIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
