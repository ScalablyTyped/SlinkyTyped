...
object BusIcon {
  @JSImport("@fluentui/react-icons/lib/components/BusIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BusIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
