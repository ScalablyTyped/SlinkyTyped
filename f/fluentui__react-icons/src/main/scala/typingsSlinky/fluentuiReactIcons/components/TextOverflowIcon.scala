...
object TextOverflowIcon {
  @JSImport("@fluentui/react-icons/lib/components/TextOverflowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TextOverflowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
