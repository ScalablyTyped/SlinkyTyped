...
object PageCheckedinIcon {
  @JSImport("@fluentui/react-icons/lib/components/PageCheckedinIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PageCheckedinIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
