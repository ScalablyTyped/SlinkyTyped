...
object SyncOccurenceIcon {
  @JSImport("@fluentui/react-icons/lib/components/SyncOccurenceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SyncOccurenceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
