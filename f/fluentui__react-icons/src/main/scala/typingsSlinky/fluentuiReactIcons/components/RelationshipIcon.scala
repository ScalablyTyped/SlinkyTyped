...
object RelationshipIcon {
  @JSImport("@fluentui/react-icons/lib/components/RelationshipIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RelationshipIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
