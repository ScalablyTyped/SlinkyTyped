...
object PackageIcon {
  @JSImport("@fluentui/react-icons/lib/components/PackageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PackageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
