...
object FilterDescendingIcon {
  @JSImport("@fluentui/react-icons/lib/components/FilterDescendingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FilterDescendingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
