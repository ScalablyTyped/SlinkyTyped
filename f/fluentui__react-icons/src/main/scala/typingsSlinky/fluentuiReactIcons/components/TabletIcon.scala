...
object TabletIcon {
  @JSImport("@fluentui/react-icons/lib/components/TabletIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TabletIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
