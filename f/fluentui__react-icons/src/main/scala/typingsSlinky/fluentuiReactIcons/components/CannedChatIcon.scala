...
object CannedChatIcon {
  @JSImport("@fluentui/react-icons/lib/components/CannedChatIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CannedChatIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
