...
object NavigateForwardIcon {
  @JSImport("@fluentui/react-icons/lib/components/NavigateForwardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NavigateForwardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
