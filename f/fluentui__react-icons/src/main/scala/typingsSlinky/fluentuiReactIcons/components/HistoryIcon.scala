...
object HistoryIcon {
  @JSImport("@fluentui/react-icons/lib/components/HistoryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HistoryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
