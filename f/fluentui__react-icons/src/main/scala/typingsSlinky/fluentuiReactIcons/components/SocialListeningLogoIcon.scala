...
object SocialListeningLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/SocialListeningLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SocialListeningLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
