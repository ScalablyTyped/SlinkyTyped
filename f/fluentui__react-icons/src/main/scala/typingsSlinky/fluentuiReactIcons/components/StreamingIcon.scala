...
object StreamingIcon {
  @JSImport("@fluentui/react-icons/lib/components/StreamingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StreamingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
