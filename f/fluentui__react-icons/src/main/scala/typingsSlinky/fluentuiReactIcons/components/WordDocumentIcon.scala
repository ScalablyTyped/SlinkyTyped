...
object WordDocumentIcon {
  @JSImport("@fluentui/react-icons", "WordDocumentIcon")
  @js.native
  ...
  implicit def make(companion: WordDocumentIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
