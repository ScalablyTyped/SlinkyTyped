...
object RealEstateIcon {
  @JSImport("@fluentui/react-icons/lib/components/RealEstateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RealEstateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
