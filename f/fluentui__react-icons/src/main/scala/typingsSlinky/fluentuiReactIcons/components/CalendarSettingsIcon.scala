...
object CalendarSettingsIcon {
  @JSImport("@fluentui/react-icons/lib/components/CalendarSettingsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CalendarSettingsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
