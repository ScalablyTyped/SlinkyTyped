...
object OpenSourceIcon {
  @JSImport("@fluentui/react-icons/lib/components/OpenSourceIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OpenSourceIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
