...
object BuildIssueIcon {
  @JSImport("@fluentui/react-icons/lib/components/BuildIssueIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BuildIssueIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
