...
object GuitarIcon {
  @JSImport("@fluentui/react-icons/lib/components/GuitarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GuitarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
