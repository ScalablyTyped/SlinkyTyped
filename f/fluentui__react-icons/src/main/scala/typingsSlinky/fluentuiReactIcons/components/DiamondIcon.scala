...
object DiamondIcon {
  @JSImport("@fluentui/react-icons/lib/components/DiamondIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DiamondIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
