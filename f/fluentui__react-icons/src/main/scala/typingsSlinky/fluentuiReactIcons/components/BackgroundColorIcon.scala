...
object BackgroundColorIcon {
  @JSImport("@fluentui/react-icons/lib/components/BackgroundColorIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BackgroundColorIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
