...
object WarningSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/WarningSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WarningSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
