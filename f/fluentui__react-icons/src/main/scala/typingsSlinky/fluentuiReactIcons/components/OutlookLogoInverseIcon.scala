...
object OutlookLogoInverseIcon {
  @JSImport("@fluentui/react-icons/lib/components/OutlookLogoInverseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OutlookLogoInverseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
