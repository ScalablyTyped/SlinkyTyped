...
object Webcam2OffIcon {
  @JSImport("@fluentui/react-icons/lib/components/Webcam2OffIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Webcam2OffIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
