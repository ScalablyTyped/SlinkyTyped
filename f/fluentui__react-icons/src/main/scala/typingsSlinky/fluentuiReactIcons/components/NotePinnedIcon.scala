...
object NotePinnedIcon {
  @JSImport("@fluentui/react-icons/lib/components/NotePinnedIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NotePinnedIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
