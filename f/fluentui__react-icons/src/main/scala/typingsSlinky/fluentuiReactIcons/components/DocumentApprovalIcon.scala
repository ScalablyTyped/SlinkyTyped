...
object DocumentApprovalIcon {
  @JSImport("@fluentui/react-icons/lib/components/DocumentApprovalIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DocumentApprovalIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
