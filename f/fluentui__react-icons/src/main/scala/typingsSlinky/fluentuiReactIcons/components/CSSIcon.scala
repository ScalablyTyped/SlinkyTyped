...
object CSSIcon {
  @JSImport("@fluentui/react-icons/lib/components/CSSIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CSSIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
