...
object PeoplePauseIcon {
  @JSImport("@fluentui/react-icons/lib/components/PeoplePauseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PeoplePauseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
