...
object SaveAllIcon {
  @JSImport("@fluentui/react-icons/lib/components/SaveAllIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SaveAllIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
