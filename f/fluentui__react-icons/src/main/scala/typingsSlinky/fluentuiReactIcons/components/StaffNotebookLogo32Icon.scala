...
object StaffNotebookLogo32Icon {
  @JSImport("@fluentui/react-icons/lib/components/StaffNotebookLogo32Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StaffNotebookLogo32Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
