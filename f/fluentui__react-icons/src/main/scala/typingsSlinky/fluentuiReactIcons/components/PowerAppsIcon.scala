...
object PowerAppsIcon {
  @JSImport("@fluentui/react-icons/lib/components/PowerAppsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PowerAppsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
