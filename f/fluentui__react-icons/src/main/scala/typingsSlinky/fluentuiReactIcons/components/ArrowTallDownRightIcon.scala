...
object ArrowTallDownRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrowTallDownRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrowTallDownRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
