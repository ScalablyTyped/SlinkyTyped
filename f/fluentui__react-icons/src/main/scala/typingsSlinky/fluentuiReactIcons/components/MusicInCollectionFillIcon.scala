...
object MusicInCollectionFillIcon {
  @JSImport("@fluentui/react-icons/lib/components/MusicInCollectionFillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MusicInCollectionFillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
