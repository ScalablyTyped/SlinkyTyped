...
object DriverOffIcon {
  @JSImport("@fluentui/react-icons/lib/components/DriverOffIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DriverOffIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
