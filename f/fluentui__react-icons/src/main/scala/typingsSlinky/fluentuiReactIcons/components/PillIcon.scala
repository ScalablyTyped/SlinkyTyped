...
object PillIcon {
  @JSImport("@fluentui/react-icons/lib/components/PillIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PillIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
