...
object InkingToolIcon {
  @JSImport("@fluentui/react-icons/lib/components/InkingToolIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InkingToolIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
