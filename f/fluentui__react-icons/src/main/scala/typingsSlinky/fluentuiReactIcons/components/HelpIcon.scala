...
object HelpIcon {
  @JSImport("@fluentui/react-icons/lib/components/HelpIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HelpIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
