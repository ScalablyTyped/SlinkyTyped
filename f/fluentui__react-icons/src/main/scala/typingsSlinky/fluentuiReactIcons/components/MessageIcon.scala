...
object MessageIcon {
  @JSImport("@fluentui/react-icons/lib/components/MessageIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: MessageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
