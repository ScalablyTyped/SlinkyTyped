...
object PartlyCloudyNightIcon {
  @JSImport("@fluentui/react-icons/lib/components/PartlyCloudyNightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PartlyCloudyNightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
