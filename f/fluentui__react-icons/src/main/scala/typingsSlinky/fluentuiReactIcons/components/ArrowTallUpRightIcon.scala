...
object ArrowTallUpRightIcon {
  @JSImport("@fluentui/react-icons/lib/components/ArrowTallUpRightIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ArrowTallUpRightIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
