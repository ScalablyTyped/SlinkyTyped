...
object BlockedSiteSolid12Icon {
  @JSImport("@fluentui/react-icons/lib/components/BlockedSiteSolid12Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BlockedSiteSolid12Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
