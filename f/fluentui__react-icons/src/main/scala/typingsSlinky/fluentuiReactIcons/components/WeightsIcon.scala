...
object WeightsIcon {
  @JSImport("@fluentui/react-icons/lib/components/WeightsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WeightsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
