...
object HandwritingIcon {
  @JSImport("@fluentui/react-icons/lib/components/HandwritingIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HandwritingIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
