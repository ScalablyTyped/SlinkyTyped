...
object StockDownIcon {
  @JSImport("@fluentui/react-icons/lib/components/StockDownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: StockDownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
