...
object TaskboardIcon {
  @JSImport("@fluentui/react-icons/lib/components/TaskboardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TaskboardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
