...
object ThumbnailViewIcon {
  @JSImport("@fluentui/react-icons/lib/components/ThumbnailViewIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ThumbnailViewIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
