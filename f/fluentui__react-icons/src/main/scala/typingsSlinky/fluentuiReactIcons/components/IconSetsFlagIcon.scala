...
object IconSetsFlagIcon {
  @JSImport("@fluentui/react-icons/lib/components/IconSetsFlagIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IconSetsFlagIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
