...
object RedoIcon {
  @JSImport("@fluentui/react-icons/lib/components/RedoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RedoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
