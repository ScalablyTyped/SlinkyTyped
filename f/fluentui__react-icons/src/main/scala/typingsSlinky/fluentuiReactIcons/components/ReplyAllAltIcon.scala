...
object ReplyAllAltIcon {
  @JSImport("@fluentui/react-icons/lib/components/ReplyAllAltIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ReplyAllAltIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
