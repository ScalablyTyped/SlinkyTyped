...
object CampaignTemplateIcon {
  @JSImport("@fluentui/react-icons/lib/components/CampaignTemplateIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CampaignTemplateIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
