...
object CirclePauseIcon {
  @JSImport("@fluentui/react-icons/lib/components/CirclePauseIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CirclePauseIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
