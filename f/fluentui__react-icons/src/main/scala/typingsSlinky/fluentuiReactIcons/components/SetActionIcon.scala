...
object SetActionIcon {
  @JSImport("@fluentui/react-icons/lib/components/SetActionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SetActionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
