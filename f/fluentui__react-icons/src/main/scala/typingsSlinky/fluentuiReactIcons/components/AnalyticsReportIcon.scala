...
object AnalyticsReportIcon {
  @JSImport("@fluentui/react-icons/lib/components/AnalyticsReportIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AnalyticsReportIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
