...
object AddLinkIcon {
  @JSImport("@fluentui/react-icons/lib/components/AddLinkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddLinkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
