...
object GreetingCardIcon {
  @JSImport("@fluentui/react-icons/lib/components/GreetingCardIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: GreetingCardIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
