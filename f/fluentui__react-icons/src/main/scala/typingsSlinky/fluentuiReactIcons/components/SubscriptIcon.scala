...
object SubscriptIcon {
  @JSImport("@fluentui/react-icons/lib/components/SubscriptIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SubscriptIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
