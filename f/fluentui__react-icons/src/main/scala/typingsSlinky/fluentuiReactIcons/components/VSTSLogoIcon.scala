...
object VSTSLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/VSTSLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VSTSLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
