...
object DoubleDownArrowIcon {
  @JSImport("@fluentui/react-icons/lib/components/DoubleDownArrowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DoubleDownArrowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
