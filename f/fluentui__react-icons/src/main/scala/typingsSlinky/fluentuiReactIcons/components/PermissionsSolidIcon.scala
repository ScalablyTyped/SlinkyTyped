...
object PermissionsSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/PermissionsSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PermissionsSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
