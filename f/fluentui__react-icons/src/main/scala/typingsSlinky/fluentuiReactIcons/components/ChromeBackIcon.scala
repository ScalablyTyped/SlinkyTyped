...
object ChromeBackIcon {
  @JSImport("@fluentui/react-icons/lib/components/ChromeBackIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChromeBackIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
