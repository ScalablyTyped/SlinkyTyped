...
object CakeIcon {
  @JSImport("@fluentui/react-icons/lib/components/CakeIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CakeIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
