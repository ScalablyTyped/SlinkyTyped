...
object ColumnOptionsIcon {
  @JSImport("@fluentui/react-icons/lib/components/ColumnOptionsIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ColumnOptionsIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
