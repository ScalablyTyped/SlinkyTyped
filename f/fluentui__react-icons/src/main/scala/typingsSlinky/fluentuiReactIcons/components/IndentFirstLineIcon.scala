...
object IndentFirstLineIcon {
  @JSImport("@fluentui/react-icons/lib/components/IndentFirstLineIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: IndentFirstLineIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
