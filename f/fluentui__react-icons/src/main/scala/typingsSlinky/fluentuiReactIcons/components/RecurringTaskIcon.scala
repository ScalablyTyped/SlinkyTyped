...
object RecurringTaskIcon {
  @JSImport("@fluentui/react-icons/lib/components/RecurringTaskIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RecurringTaskIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
