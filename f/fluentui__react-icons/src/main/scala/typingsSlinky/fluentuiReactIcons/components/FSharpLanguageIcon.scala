...
object FSharpLanguageIcon {
  @JSImport("@fluentui/react-icons", "FSharpLanguageIcon")
  @js.native
  ...
  implicit def make(companion: FSharpLanguageIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
