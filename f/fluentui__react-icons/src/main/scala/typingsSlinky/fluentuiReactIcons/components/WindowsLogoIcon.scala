...
object WindowsLogoIcon {
  @JSImport("@fluentui/react-icons/lib/components/WindowsLogoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WindowsLogoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
