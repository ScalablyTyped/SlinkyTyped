...
object ProjectCollectionIcon {
  @JSImport("@fluentui/react-icons/lib/components/ProjectCollectionIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ProjectCollectionIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
