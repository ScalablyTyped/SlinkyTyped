...
object BoxMultiplySolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/BoxMultiplySolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BoxMultiplySolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
