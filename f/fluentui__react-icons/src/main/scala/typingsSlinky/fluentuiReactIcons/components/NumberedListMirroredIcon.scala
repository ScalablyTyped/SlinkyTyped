...
object NumberedListMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/NumberedListMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NumberedListMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
