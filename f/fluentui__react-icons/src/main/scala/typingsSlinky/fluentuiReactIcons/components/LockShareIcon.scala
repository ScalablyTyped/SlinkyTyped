...
object LockShareIcon {
  @JSImport("@fluentui/react-icons/lib/components/LockShareIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LockShareIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
