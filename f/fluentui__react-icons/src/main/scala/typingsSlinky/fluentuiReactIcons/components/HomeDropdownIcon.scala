...
object HomeDropdownIcon {
  @JSImport("@fluentui/react-icons/lib/components/HomeDropdownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HomeDropdownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
