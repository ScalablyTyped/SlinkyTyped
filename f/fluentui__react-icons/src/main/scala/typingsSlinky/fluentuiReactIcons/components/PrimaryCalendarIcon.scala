...
object PrimaryCalendarIcon {
  @JSImport("@fluentui/react-icons/lib/components/PrimaryCalendarIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PrimaryCalendarIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
