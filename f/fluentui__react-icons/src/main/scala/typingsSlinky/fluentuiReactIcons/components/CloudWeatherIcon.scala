...
object CloudWeatherIcon {
  @JSImport("@fluentui/react-icons/lib/components/CloudWeatherIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CloudWeatherIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
