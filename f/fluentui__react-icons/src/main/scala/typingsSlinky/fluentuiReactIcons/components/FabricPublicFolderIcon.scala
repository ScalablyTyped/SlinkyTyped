...
object FabricPublicFolderIcon {
  @JSImport("@fluentui/react-icons/lib/components/FabricPublicFolderIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FabricPublicFolderIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
