...
object OrgIcon {
  @JSImport("@fluentui/react-icons/lib/components/OrgIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OrgIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
