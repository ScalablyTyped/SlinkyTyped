...
object EyedropperIcon {
  @JSImport("@fluentui/react-icons/lib/components/EyedropperIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EyedropperIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
