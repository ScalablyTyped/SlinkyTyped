...
object EventTentativeMirroredIcon {
  @JSImport("@fluentui/react-icons/lib/components/EventTentativeMirroredIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EventTentativeMirroredIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
