...
object EDiscoveryIcon {
  @JSImport("@fluentui/react-icons/lib/components/eDiscoveryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EDiscoveryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
