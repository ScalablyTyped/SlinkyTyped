...
object EatDrinkIcon {
  @JSImport("@fluentui/react-icons/lib/components/EatDrinkIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EatDrinkIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
