...
object AssignPolicyIcon {
  @JSImport("@fluentui/react-icons/lib/components/AssignPolicyIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AssignPolicyIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
