...
object SaveToMobileIcon {
  @JSImport("@fluentui/react-icons/lib/components/SaveToMobileIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SaveToMobileIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
