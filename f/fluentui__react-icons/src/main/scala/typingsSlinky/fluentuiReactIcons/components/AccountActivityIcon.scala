...
object AccountActivityIcon {
  @JSImport("@fluentui/react-icons/lib/components/AccountActivityIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AccountActivityIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
