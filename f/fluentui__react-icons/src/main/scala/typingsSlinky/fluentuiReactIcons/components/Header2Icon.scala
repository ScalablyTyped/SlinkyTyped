...
object Header2Icon {
  @JSImport("@fluentui/react-icons/lib/components/Header2Icon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Header2Icon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
