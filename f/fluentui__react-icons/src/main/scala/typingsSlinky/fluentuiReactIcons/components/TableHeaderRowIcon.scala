...
object TableHeaderRowIcon {
  @JSImport("@fluentui/react-icons/lib/components/TableHeaderRowIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TableHeaderRowIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
