...
object UnknownIcon {
  @JSImport("@fluentui/react-icons/lib/components/UnknownIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: UnknownIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
