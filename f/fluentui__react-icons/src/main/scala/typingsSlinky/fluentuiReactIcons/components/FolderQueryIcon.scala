...
object FolderQueryIcon {
  @JSImport("@fluentui/react-icons/lib/components/FolderQueryIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FolderQueryIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
