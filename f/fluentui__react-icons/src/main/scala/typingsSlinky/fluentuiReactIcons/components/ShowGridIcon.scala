...
object ShowGridIcon {
  @JSImport("@fluentui/react-icons/lib/components/ShowGridIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ShowGridIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
