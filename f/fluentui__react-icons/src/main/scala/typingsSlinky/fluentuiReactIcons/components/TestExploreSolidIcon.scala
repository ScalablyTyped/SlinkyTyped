...
object TestExploreSolidIcon {
  @JSImport("@fluentui/react-icons/lib/components/TestExploreSolidIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TestExploreSolidIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
