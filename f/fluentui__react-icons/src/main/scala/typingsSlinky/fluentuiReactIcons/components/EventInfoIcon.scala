...
object EventInfoIcon {
  @JSImport("@fluentui/react-icons/lib/components/EventInfoIcon", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EventInfoIcon.type): SharedBuilder_HTMLAttributesISvgIconProps1057284334 = new SharedBuilder_HTMLAttributesISvgIconProps1057284334(js.Array(this.component, js.Dictionary.empty))()
}
