...
@js.native
trait ActiveUnzonedRange extends js.Object {
...
object ActiveUnzonedRange {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ActiveUnzonedRange]
  }
  @scala.inline
  implicit class ActiveUnzonedRangeOps[Self <: ActiveUnzonedRange] (val x: Self) extends AnyVal {
    @scala.inline
