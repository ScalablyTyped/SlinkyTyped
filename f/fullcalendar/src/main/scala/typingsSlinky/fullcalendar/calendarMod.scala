...
import typingsSlinky.fullcalendar.srcTypesInputDashTypesMod.EventObjectInput
import typingsSlinky.fullcalendar.srcTypesInputDashTypesMod.EventSourceInput
import typingsSlinky.fullcalendar.srcTypesInputDashTypesMod.MomentInput
import typingsSlinky.fullcalendar.srcTypesInputDashTypesMod.OptionsInput
import typingsSlinky.fullcalendar.srcTypesInputDashTypesMod.RangeInput
...
@JSImport("fullcalendar/Calendar", JSImport.Namespace)
@js.native
object calendarMod extends js.Object {
  ...
  class Default protected () extends js.Object {
    ...
    var defaultAllDayEventDuration: Duration = js.native
    var defaultTimedEventDuration: Duration = js.native
    ...
    def computeFooterOptions(): Anon_ExtraClasses = js.native
    def computeHeaderOptions(): Anon_ExtraClasses = js.native
    ...
    def humanizeDuration(duration: Duration): String = js.native
