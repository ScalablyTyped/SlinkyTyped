package typingsSlinky.fullcalendar.calendarMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.fullcalendar.anon.ExtraClasses
...
class Default_ protected () extends js.Object {
  ...
  var businessHourGenerator: typingsSlinky.fullcalendar.businessHourGeneratorMod.default = js.native
  var constraints: typingsSlinky.fullcalendar.constraintsMod.default = js.native
  ...
  var eventManager: typingsSlinky.fullcalendar.eventManagerMod.default = js.native
  var footer: typingsSlinky.fullcalendar.toolbarMod.default = js.native
  var freezeContentHeightDepth: Double = js.native
  @JSName("hasHandlers")
  var hasHandlers_Original: js.Function1[/* type */ js.Any, _] = js.native
  var header: typingsSlinky.fullcalendar.toolbarMod.default = js.native
  ...
  var optionsManager: typingsSlinky.fullcalendar.optionsManagerMod.default = js.native
  ...
  var theme: typingsSlinky.fullcalendar.themeMod.default = js.native
  var toolbarsManager: typingsSlinky.fullcalendar.iteratorMod.default = js.native
  @JSName("triggerWith")
  ...
  var view: typingsSlinky.fullcalendar.viewMod.default = js.native
  var viewSpecManager: typingsSlinky.fullcalendar.viewSpecManagerMod.default = js.native
  var viewsByType: StringDictionary[typingsSlinky.fullcalendar.viewMod.default] = js.native
  ...
  def buildSelectFootprint(zonedStartInput: MomentInput): typingsSlinky.fullcalendar.componentFootprintMod.default = js.native
  def buildSelectFootprint(zonedStartInput: MomentInput, zonedEndInput: MomentInput): typingsSlinky.fullcalendar.componentFootprintMod.default = js.native
  ...
  def footprintToDateProfile(componentFootprint: js.Any): typingsSlinky.fullcalendar.eventDateProfileMod.default = js.native
  def footprintToDateProfile(componentFootprint: js.Any, ignoreEnd: Boolean): typingsSlinky.fullcalendar.eventDateProfileMod.default = js.native
  ...
  def getEventSourceById(id: js.Any): typingsSlinky.fullcalendar.eventSourceMod.default = js.native
  def getEventSources(): typingsSlinky.fullcalendar.eventSourceMod.default = js.native
  def getIsAmbigTimezone(): Boolean = js.native
  def getNow(): Moment = js.native
  def getSuggestedViewHeight(): Double = js.native
  def getView(): typingsSlinky.fullcalendar.viewMod.default = js.native
  ...
  def instantiateView(viewType: String): typingsSlinky.fullcalendar.viewMod.default = js.native
  ...
  def parseUnzonedRange(rangeInput: RangeInput): typingsSlinky.fullcalendar.unzonedRangeMod.default = js.native
