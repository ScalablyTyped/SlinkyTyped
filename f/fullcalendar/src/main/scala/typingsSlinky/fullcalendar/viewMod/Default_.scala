package typingsSlinky.fullcalendar.viewMod
...
abstract class Default_ protected ()
  extends typingsSlinky.fullcalendar.interactiveDateComponentMod.default {
  def this(calendar: js.Any, viewSpec: js.Any) = this()
  var batchRenderDepth: Double = js.native
  var calendar: typingsSlinky.fullcalendar.calendarMod.default = js.native
  ...
  var renderQueue: typingsSlinky.fullcalendar.renderQueueMod.default = js.native
  var selectedEventInstance: typingsSlinky.fullcalendar.eventInstanceMod.default = js.native
  ...
  def getUnzonedRangeOption(name: js.Any): typingsSlinky.fullcalendar.unzonedRangeMod.default = js.native
  ...
  def trimHiddenDays(inputUnzonedRange: js.Any): typingsSlinky.fullcalendar.unzonedRangeMod.default = js.native
