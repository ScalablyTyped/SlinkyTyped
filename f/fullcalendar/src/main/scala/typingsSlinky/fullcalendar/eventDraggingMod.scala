...
import typingsSlinky.fullcalendar.eventDraggingMod.Default
...
object eventDraggingMod extends js.Object {
  ...
  class Default protected ()
    ...
    def computeEventDropMutation(startFootprint: js.Any, endFootprint: js.Any, eventDef: js.Any): typingsSlinky.fullcalendar.eventDefMutationMod.default = js.native
