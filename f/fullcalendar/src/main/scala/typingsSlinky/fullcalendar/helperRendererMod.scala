...
import typingsSlinky.fullcalendar.helperRendererMod.Default
...
object helperRendererMod extends js.Object {
  ...
  class Default protected () extends js.Object {
    ...
    def fabricateEventFootprint(componentFootprint: js.Any): typingsSlinky.fullcalendar.eventFootprintMod.default = js.native
