package typingsSlinky.fullcalendar.eventDefDateMutationMod
...
class Default_ () extends js.Object {
  ...
  def buildNewDateProfile(eventDateProfile: js.Any, calendar: js.Any): typingsSlinky.fullcalendar.eventDateProfileMod.default = js.native
