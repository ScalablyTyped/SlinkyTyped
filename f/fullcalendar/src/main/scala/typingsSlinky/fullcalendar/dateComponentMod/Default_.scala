package typingsSlinky.fullcalendar.dateComponentMod

import typingsSlinky.fullcalendar.anon.End
...
@js.native
abstract class Default_ ()
  extends typingsSlinky.fullcalendar.componentMod.Default_ {
  ...
  def eventRangeToEventFootprints(eventRange: js.Any): js.Array[typingsSlinky.fullcalendar.eventFootprintMod.default] = js.native
