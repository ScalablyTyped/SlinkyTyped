...
@JSImport("fullcalendar/TimeGrid", JSImport.Namespace)
@js.native
object timeGridMod extends js.Object {
  @js.native
  class Default protected ()
    ...
    def computeSnapTime(snapIndex: js.Any): Duration = js.native
    def computeTimeTop(time: js.Any): js.Any = js.native
    def generateSegVerticalCss(seg: js.Any): Anon_BottomTop = js.native
