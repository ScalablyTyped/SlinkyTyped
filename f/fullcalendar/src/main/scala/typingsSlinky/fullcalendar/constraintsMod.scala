...
import typingsSlinky.fullcalendar.constraintsMod.Default
...
object constraintsMod extends js.Object {
  ...
  class Default protected () extends js.Object {
    ...
    def parseFootprints(rawInput: js.Any): js.Array[typingsSlinky.fullcalendar.componentFootprintMod.default] = js.native
  }
