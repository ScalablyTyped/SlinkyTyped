...
import typingsSlinky.fixedDashDataDashTableDash2.fixedDashDataDashTableDash2Mod.CellProps
...
object Cell
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.fixedDashDataDashTableDash2.fixedDashDataDashTableDash2Mod.Cell
    ] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.fixedDashDataDashTableDash2.fixedDashDataDashTableDash2Mod.Cell] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.fixedDashDataDashTableDash2.fixedDashDataDashTableDash2Mod.Cell, 
      Event
    ] => Unit = null,
  ...
  typingsSlinky.fixedDashDataDashTableDash2.fixedDashDataDashTableDash2Mod.Cell](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
