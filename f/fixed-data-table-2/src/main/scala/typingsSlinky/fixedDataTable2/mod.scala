...
object mod {
  ...
  object TableProps {
    ...
    implicit class TablePropsMutableBuilder[Self <: TableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnRowMouseUp(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowMouseUp", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowMouseUpUndefined: Self = StObject.set(x, "onRowMouseUp", js.undefined)
      
      @scala.inline
      def setOnRowTouchEnd(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowTouchEnd", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowTouchEndUndefined: Self = StObject.set(x, "onRowTouchEnd", js.undefined)
      
      @scala.inline
      def setOnRowTouchMove(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowTouchMove", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowTouchMoveUndefined: Self = StObject.set(x, "onRowTouchMove", js.undefined)
      
      @scala.inline
      def setOnRowTouchStart(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowTouchStart", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRowExpandedReactElement(value: ReactElement): Self = StObject.set(x, "rowExpanded", value.asInstanceOf[js.Any])
