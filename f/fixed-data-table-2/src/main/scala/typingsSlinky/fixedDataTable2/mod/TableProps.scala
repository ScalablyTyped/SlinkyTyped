...
object TableProps {
  ...
  def apply(
    ...
    onRowClick: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowDoubleClick: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseDown: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseEnter: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseLeave: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseUp: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowTouchEnd: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowTouchMove: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
    onRowTouchStart: (/* event */ SyntheticEvent[Event_, Table], /* rowIndex */ Double) => Unit = null,
