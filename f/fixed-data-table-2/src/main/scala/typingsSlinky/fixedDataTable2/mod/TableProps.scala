...
object TableProps {
  ...
  implicit class TablePropsOps[Self <: TableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRowClick(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowClick: Self = this.set("onRowClick", js.undefined)
    @scala.inline
    def setOnRowDoubleClick(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowDoubleClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowDoubleClick: Self = this.set("onRowDoubleClick", js.undefined)
    @scala.inline
    def setOnRowMouseDown(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowMouseDown", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowMouseDown: Self = this.set("onRowMouseDown", js.undefined)
    @scala.inline
    def setOnRowMouseEnter(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowMouseEnter", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowMouseEnter: Self = this.set("onRowMouseEnter", js.undefined)
    @scala.inline
    def setOnRowMouseLeave(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowMouseLeave", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowMouseLeave: Self = this.set("onRowMouseLeave", js.undefined)
    @scala.inline
    def setOnRowMouseUp(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowMouseUp", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowMouseUp: Self = this.set("onRowMouseUp", js.undefined)
    @scala.inline
    def setOnRowTouchEnd(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowTouchEnd", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowTouchEnd: Self = this.set("onRowTouchEnd", js.undefined)
    @scala.inline
    def setOnRowTouchMove(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowTouchMove", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowTouchMove: Self = this.set("onRowTouchMove", js.undefined)
    @scala.inline
    def setOnRowTouchStart(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = this.set("onRowTouchStart", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setRowExpandedReactElement(value: ReactElement): Self = this.set("rowExpanded", value.asInstanceOf[js.Any])
    @scala.inline
