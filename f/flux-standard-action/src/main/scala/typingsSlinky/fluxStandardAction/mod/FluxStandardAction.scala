...
object FluxStandardAction {
  @scala.inline
  def apply[/* <: java.lang.String */ Type, Payload, Meta](`type`: Type): FluxStandardAction[Type, Payload, Meta] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[FluxStandardAction[Type, Payload, Meta]]
  }
  @scala.inline
  implicit class FluxStandardActionOps[Self <: FluxStandardAction[_, _, _], /* <: java.lang.String */ Type, Payload, Meta] (val x: Self with (FluxStandardAction[Type, Payload, Meta])) extends AnyVal {
    @scala.inline
