...
object ErrorFluxStandardAction {
  @scala.inline
  def apply[/* <: java.lang.String */ Type, /* <: typingsSlinky.std.Error */ CustomError, Meta](error: `true`, `type`: Type): ErrorFluxStandardAction[Type, CustomError, Meta] = {
    val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ErrorFluxStandardAction[Type, CustomError, Meta]]
  }
  @scala.inline
  implicit class ErrorFluxStandardActionOps[Self <: ErrorFluxStandardAction[_, _, _], /* <: java.lang.String */ Type, /* <: typingsSlinky.std.Error */ CustomError, Meta] (val x: Self with (ErrorFluxStandardAction[Type, CustomError, Meta])) extends AnyVal {
    @scala.inline
