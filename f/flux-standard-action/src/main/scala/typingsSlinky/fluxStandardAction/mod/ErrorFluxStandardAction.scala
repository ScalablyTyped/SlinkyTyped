...
object ErrorFluxStandardAction {
  ...
  @scala.inline
  def apply[Type /* <: String */, CustomError /* <: js.Error */, Meta](error: `true`, `type`: Type): ErrorFluxStandardAction[Type, CustomError, Meta] = {
  ...
  @scala.inline
  implicit class ErrorFluxStandardActionOps[Self <: ErrorFluxStandardAction[_, _, _], Type /* <: String */, CustomError /* <: js.Error */, Meta] (val x: Self with (ErrorFluxStandardAction[Type, CustomError, Meta])) extends AnyVal {
