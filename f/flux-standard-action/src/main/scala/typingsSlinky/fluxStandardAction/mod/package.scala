...
package object mod {
  ...
  type ErrorFluxStandardActionAuto[Type /* <: java.lang.String */, CustomError /* <: js.Error */, Meta] = (typingsSlinky.fluxStandardAction.mod.ErrorFluxStandardActionWithPayloadAndMeta[Type, CustomError, Meta]) | (typingsSlinky.fluxStandardAction.mod.ErrorFluxStandardActionWithPayload[Type, CustomError, Meta])
  ...
  */
  type FluxStandardActionAuto[Type /* <: java.lang.String */, Payload, Meta] = (typingsSlinky.fluxStandardAction.mod._FluxStandardActionAuto[Type, Payload, Meta]) | (typingsSlinky.fluxStandardAction.mod.FluxStandardActionWithPayloadAndMeta[Type, Payload, Meta])
