...
object mod {
  ...
  @js.native
  def isError[Type /* <: String */, CustomError /* <: js.Error */, Meta](action: js.Any): /* is flux-standard-action.flux-standard-action.ErrorFluxStandardAction<Type, CustomError, Meta> */ Boolean = js.native
  ...
  object ErrorFluxStandardAction {
    ...
    @scala.inline
    implicit class ErrorFluxStandardActionMutableBuilder[Self <: ErrorFluxStandardAction[_, _, _], Type /* <: String */, CustomError /* <: js.Error */, Meta] (val x: Self with (ErrorFluxStandardAction[Type, CustomError, Meta])) extends AnyVal {
  ...
  */
  ...
  object _FluxStandardActionAuto {
    ...
    @scala.inline
    def FluxStandardAction[Type /* <: String */, Payload, Meta](`type`: Type): typingsSlinky.fluxStandardAction.mod.FluxStandardAction[Type, Payload, Meta] = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fluxStandardAction.mod.FluxStandardAction[Type, Payload, Meta]]
    }
    
    @scala.inline
    def FluxStandardActionWithMeta[Type /* <: String */, Payload, Meta](meta: Meta, `type`: Type): typingsSlinky.fluxStandardAction.mod.FluxStandardActionWithMeta[Type, Payload, Meta] = {
      val __obj = js.Dynamic.literal(meta = meta.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fluxStandardAction.mod.FluxStandardActionWithMeta[Type, Payload, Meta]]
    }
    
    @scala.inline
    def FluxStandardActionWithPayload[Type /* <: String */, Payload, Meta](payload: Payload, `type`: Type): typingsSlinky.fluxStandardAction.mod.FluxStandardActionWithPayload[Type, Payload, Meta] = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fluxStandardAction.mod.FluxStandardActionWithPayload[Type, Payload, Meta]]
    }
  }
}
