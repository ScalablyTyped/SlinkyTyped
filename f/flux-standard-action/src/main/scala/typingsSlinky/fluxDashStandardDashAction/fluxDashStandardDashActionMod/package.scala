...
package object fluxDashStandardDashActionMod {
  ...
  type ErrorFluxStandardActionWithMeta[Type /* <: String */, CustomError /* <: js.Error */, Meta] = (ErrorFluxStandardAction[Type, CustomError, Meta]) with (FluxStandardActionWithMeta[Type, CustomError, Meta])
  type ErrorFluxStandardActionWithPayload[Type /* <: String */, CustomError /* <: js.Error */, Meta] = (ErrorFluxStandardAction[Type, CustomError, Meta]) with (FluxStandardActionWithPayload[Type, CustomError, Meta])
  type ErrorFluxStandardActionWithPayloadAndMeta[Type /* <: String */, CustomError /* <: js.Error */, Meta] = (ErrorFluxStandardActionWithPayload[Type, CustomError, Meta]) with (ErrorFluxStandardActionWithMeta[Type, CustomError, Meta])
