...
import typingsSlinky.faker.fakerStrings.abbr
import typingsSlinky.faker.fakerStrings.key
import typingsSlinky.faker.fakerStrings.unix
import typingsSlinky.faker.fakerStrings.wide
...
object anon {
  ...
  trait Avatar extends StObject {
    ...
    def password(len: js.UndefOr[scala.Nothing], memorable: js.UndefOr[scala.Nothing], pattern: js.RegExp): String = js.native
    def password(
      len: js.UndefOr[scala.Nothing],
      memorable: js.UndefOr[scala.Nothing],
      pattern: js.RegExp,
    ...
    def password(len: js.UndefOr[scala.Nothing], memorable: Boolean, pattern: js.RegExp): String = js.native
    def password(len: js.UndefOr[scala.Nothing], memorable: Boolean, pattern: js.RegExp, prefix: String): String = js.native
    ...
    def password(len: Double, memorable: js.UndefOr[scala.Nothing], pattern: js.RegExp): String = js.native
    def password(len: Double, memorable: js.UndefOr[scala.Nothing], pattern: js.RegExp, prefix: String): String = js.native
