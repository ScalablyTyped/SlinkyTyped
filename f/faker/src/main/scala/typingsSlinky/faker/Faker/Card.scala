...
object Card {
  ...
  implicit class CardOps[Self <: Card] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAccountHistory(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accountHistory")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAddress(value: FullAddress): Self = {
        val ret = this.duplicate
