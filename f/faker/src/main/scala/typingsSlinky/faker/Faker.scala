...
object Faker {
  ...
  object ContextualCard {
    ...
    implicit class ContextualCardMutableBuilder[Self <: ContextualCard] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDob(value: js.Date): Self = StObject.set(x, "dob", value.asInstanceOf[js.Any])
  ...
  object FakerStatic {
    ...
    implicit class FakerStaticMutableBuilder[Self <: FakerStatic] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHelpers(value: typingsSlinky.faker.anon.ContextualCard): Self = StObject.set(x, "helpers", value.asInstanceOf[js.Any])
