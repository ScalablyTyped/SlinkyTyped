package typingsSlinky.formatUnicorn
...
object String {
  ...
  implicit class StringOps[Self <: String] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFormatUnicorn(value: js.Object => java.lang.String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("formatUnicorn")(js.Any.fromFunction1(value))
        ret
    }
  }
