package typingsSlinky.fluentuiReactComponentEventListener.typesMod
...
object EventListenerOptions {
  ...
  implicit class EventListenerOptionsOps[Self <: EventListenerOptions[_], T /* <: EventTypes */] (val x: Self with EventListenerOptions[T]) extends AnyVal {
    ...
    @scala.inline
    def setTargetRef(value: ReactRef[Target]): Self = this.set("targetRef", value.asInstanceOf[js.Any])
