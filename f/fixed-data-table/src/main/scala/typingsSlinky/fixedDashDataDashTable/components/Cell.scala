...
object Cell
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.Cell] {
  ...
  def apply(
    ...
    onAuxClick: SyntheticMouseEvent[typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.Cell] => Unit = null,
    onBeforeInput: SyntheticEvent[
      EventTarget with typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.Cell, 
      Event
    ] => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.Cell] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.Cell] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.Cell](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
