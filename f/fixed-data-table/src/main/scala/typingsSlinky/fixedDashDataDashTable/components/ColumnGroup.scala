...
import typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.ColumnGroupProps
...
object ColumnGroup
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typingsSlinky.fixedDashDataDashTable.fixedDashDataDashTableMod.ColumnGroup
    ] {
