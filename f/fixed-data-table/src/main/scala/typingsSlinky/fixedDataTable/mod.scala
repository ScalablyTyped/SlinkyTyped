package typingsSlinky.fixedDataTable
...
object mod {
  ...
  object TableProps {
    ...
    implicit class TablePropsMutableBuilder[Self <: TableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnRowClick(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowClick", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowClickUndefined: Self = StObject.set(x, "onRowClick", js.undefined)
      
      @scala.inline
      def setOnRowDoubleClick(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowDoubleClick", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowDoubleClickUndefined: Self = StObject.set(x, "onRowDoubleClick", js.undefined)
      
      @scala.inline
      def setOnRowMouseDown(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowMouseDown", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowMouseDownUndefined: Self = StObject.set(x, "onRowMouseDown", js.undefined)
      
      @scala.inline
      def setOnRowMouseEnter(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowMouseEnter", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnRowMouseEnterUndefined: Self = StObject.set(x, "onRowMouseEnter", js.undefined)
      
      @scala.inline
      def setOnRowMouseLeave(value: (/* event */ SyntheticEvent[Event, Table], /* rowIndex */ Double) => Unit): Self = StObject.set(x, "onRowMouseLeave", js.Any.fromFunction2(value))
