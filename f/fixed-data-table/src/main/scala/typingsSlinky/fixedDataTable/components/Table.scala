...
object Table
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.fixedDataTable.mod.Table] {
  ...
  def apply(
    ...
    onRowClick: (/* event */ SyntheticEvent[Event_, typingsSlinky.fixedDataTable.mod.Table], /* rowIndex */ Double) => Unit = null,
    onRowDoubleClick: (/* event */ SyntheticEvent[Event_, typingsSlinky.fixedDataTable.mod.Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseDown: (/* event */ SyntheticEvent[Event_, typingsSlinky.fixedDataTable.mod.Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseEnter: (/* event */ SyntheticEvent[Event_, typingsSlinky.fixedDataTable.mod.Table], /* rowIndex */ Double) => Unit = null,
    onRowMouseLeave: (/* event */ SyntheticEvent[Event_, typingsSlinky.fixedDataTable.mod.Table], /* rowIndex */ Double) => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.fixedDataTable.mod.Table] = {
