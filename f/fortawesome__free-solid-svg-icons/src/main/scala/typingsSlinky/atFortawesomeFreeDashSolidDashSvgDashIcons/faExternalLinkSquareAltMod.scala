package typingsSlinky.atFortawesomeFreeDashSolidDashSvgDashIcons
...
@JSImport("@fortawesome/free-solid-svg-icons/faExternalLinkSquareAlt", JSImport.Namespace)
@js.native
object faExternalLinkSquareAltMod extends js.Object {
