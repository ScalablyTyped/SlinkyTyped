...
import typingsSlinky.formatjsIntlDisplaynames.anon.Currency
...
trait DisplayNamesData extends js.Object {
  /**
    ...
    */
  var patterns: typingsSlinky.formatjsIntlDisplaynames.anon.Locale = js.native
  /**
...
object DisplayNamesData {
  @scala.inline
  def apply(patterns: typingsSlinky.formatjsIntlDisplaynames.anon.Locale, types: Currency): DisplayNamesData = {
  ...
  implicit class DisplayNamesDataOps[Self <: DisplayNamesData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPatterns(value: typingsSlinky.formatjsIntlDisplaynames.anon.Locale): Self = this.set("patterns", value.asInstanceOf[js.Any])
    @scala.inline
