...
import typingsSlinky.fastJsonPatch.helpersMod.JsonPatchErrorName
...
object coreMod {
  ...
  */
  ...
  object _Operation {
    ...
    @scala.inline
    def CopyOperation(from: String, op: copy, path: String): typingsSlinky.fastJsonPatch.coreMod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastJsonPatch.coreMod.CopyOperation]
    }
    
    @scala.inline
    def MoveOperation(from: String, op: move, path: String): typingsSlinky.fastJsonPatch.coreMod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastJsonPatch.coreMod.MoveOperation]
    }
    
    @scala.inline
    def RemoveOperation(op: remove, path: String): typingsSlinky.fastJsonPatch.coreMod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastJsonPatch.coreMod.RemoveOperation]
    }
  }
}
