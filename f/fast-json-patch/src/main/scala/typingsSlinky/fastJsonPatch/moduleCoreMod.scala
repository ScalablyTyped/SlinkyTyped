...
object moduleCoreMod {
  ...
  @JSImport("fast-json-patch/module/core", "applyReducer")
  @js.native
  def applyReducer[T](document: T, operation: Operation, index: Double): T = js.native
  
  @JSImport("fast-json-patch/module/core", "_areEquals")
  @js.native
  ...
  @JSImport("fast-json-patch/module/core", "getValueByPointer")
  @js.native
  ...
  @JSImport("fast-json-patch/module/core", "validator")
  @js.native
  ...
  */
  ...
  object _Operation {
    ...
    @scala.inline
    def CopyOperation(from: String, op: copy, path: String): typingsSlinky.fastJsonPatch.moduleCoreMod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastJsonPatch.moduleCoreMod.CopyOperation]
    }
    
    @scala.inline
    def MoveOperation(from: String, op: move, path: String): typingsSlinky.fastJsonPatch.moduleCoreMod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastJsonPatch.moduleCoreMod.MoveOperation]
    }
    
    @scala.inline
    def RemoveOperation(op: remove, path: String): typingsSlinky.fastJsonPatch.moduleCoreMod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = op.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastJsonPatch.moduleCoreMod.RemoveOperation]
    }
  }
}
