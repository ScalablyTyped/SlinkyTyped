...
object JoyrideOptions {
  ...
  def apply(
    ...
    cookie_expires: js.UndefOr[Double] = js.undefined,
    ...
    scroll_speed: js.UndefOr[Double] = js.undefined,
    ...
    tip_animation_fade_speed: js.UndefOr[Double] = js.undefined,
    tip_container: String = null,
    tip_location: String = null,
    tip_location_patterns: Bottom = null
  ): JoyrideOptions = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(cookie_domain)) __obj.updateDynamic("cookie_domain")(cookie_domain.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cookie_expires)) __obj.updateDynamic("cookie_expires")(cookie_expires.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cookie_monster)) __obj.updateDynamic("cookie_monster")(cookie_monster.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(next_button)) __obj.updateDynamic("next_button")(next_button.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(prev_button)) __obj.updateDynamic("prev_button")(prev_button.get.asInstanceOf[js.Any])
    if (scroll_animation != null) __obj.updateDynamic("scroll_animation")(scroll_animation.asInstanceOf[js.Any])
    if (!js.isUndefined(scroll_speed)) __obj.updateDynamic("scroll_speed")(scroll_speed.get.asInstanceOf[js.Any])
    if (!js.isUndefined(start_offset)) __obj.updateDynamic("start_offset")(start_offset.get.asInstanceOf[js.Any])
    if (!js.isUndefined(start_timer_on_click)) __obj.updateDynamic("start_timer_on_click")(start_timer_on_click.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(tip_animation_fade_speed)) __obj.updateDynamic("tip_animation_fade_speed")(tip_animation_fade_speed.get.asInstanceOf[js.Any])
