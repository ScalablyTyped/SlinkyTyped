...
object AbideOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(error_labels)) __obj.updateDynamic("error_labels")(error_labels.get.asInstanceOf[js.Any])
    if (!js.isUndefined(focus_on_invalid)) __obj.updateDynamic("focus_on_invalid")(focus_on_invalid.get.asInstanceOf[js.Any])
    if (!js.isUndefined(live_validate)) __obj.updateDynamic("live_validate")(live_validate.get.asInstanceOf[js.Any])
    if (patterns != null) __obj.updateDynamic("patterns")(patterns.asInstanceOf[js.Any])
    if (!js.isUndefined(timeout)) __obj.updateDynamic("timeout")(timeout.get.asInstanceOf[js.Any])
    if (!js.isUndefined(validate_on_blur)) __obj.updateDynamic("validate_on_blur")(validate_on_blur.get.asInstanceOf[js.Any])
