...
object Bottom {
  ...
  implicit class BottomOps[Self <: Bottom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBottomVarargs(value: String*): Self = this.set("bottom", js.Array(value :_*))
    
    @scala.inline
    def setBottom(value: js.Array[String]): Self = this.set("bottom", value.asInstanceOf[js.Any])
