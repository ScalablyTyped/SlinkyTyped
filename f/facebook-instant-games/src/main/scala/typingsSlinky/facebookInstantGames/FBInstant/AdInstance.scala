...
object AdInstance {
  ...
  implicit class AdInstanceOps[Self <: AdInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetPlacementID(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPlacementID")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withLoadAsync(value: () => js.Promise[Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadAsync")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withShowAsync(value: () => js.Promise[Unit]): Self = {
        val ret = this.duplicate
