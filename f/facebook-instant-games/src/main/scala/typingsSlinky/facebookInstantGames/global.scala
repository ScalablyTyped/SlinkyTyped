...
import typingsSlinky.facebookInstantGames.FBInstant.APIError
import typingsSlinky.facebookInstantGames.FBInstant.AdInstance
import typingsSlinky.facebookInstantGames.FBInstant.Context
import typingsSlinky.facebookInstantGames.FBInstant.CustomUpdatePayload
import typingsSlinky.facebookInstantGames.FBInstant.Leaderboard
import typingsSlinky.facebookInstantGames.FBInstant.LeaderboardUpdatePayload
import typingsSlinky.facebookInstantGames.FBInstant.Payments
import typingsSlinky.facebookInstantGames.FBInstant.Platform
import typingsSlinky.facebookInstantGames.FBInstant.Player
import typingsSlinky.facebookInstantGames.FBInstant.SharePayload
