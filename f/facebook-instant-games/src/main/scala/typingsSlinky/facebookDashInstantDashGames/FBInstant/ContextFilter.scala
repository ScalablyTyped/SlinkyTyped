...
object ContextFilter {
  @scala.inline
  def INCLUDE_EXISTING_CHALLENGES: typingsSlinky.facebookDashInstantDashGames.facebookDashInstantDashGamesStrings.INCLUDE_EXISTING_CHALLENGES = this.cast("INCLUDE_EXISTING_CHALLENGES")
  @scala.inline
  def NEW_CONTEXT_ONLY: typingsSlinky.facebookDashInstantDashGames.facebookDashInstantDashGamesStrings.NEW_CONTEXT_ONLY = this.cast("NEW_CONTEXT_ONLY")
  @scala.inline
  def NEW_PLAYERS_ONLY: typingsSlinky.facebookDashInstantDashGames.facebookDashInstantDashGamesStrings.NEW_PLAYERS_ONLY = this.cast("NEW_PLAYERS_ONLY")
  @scala.inline
