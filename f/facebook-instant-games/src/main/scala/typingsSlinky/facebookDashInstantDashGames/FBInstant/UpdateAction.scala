...
object UpdateAction {
  @scala.inline
  def CUSTOM: typingsSlinky.facebookDashInstantDashGames.facebookDashInstantDashGamesStrings.CUSTOM = this.cast("CUSTOM")
  @scala.inline
  def LEADERBOARD: typingsSlinky.facebookDashInstantDashGames.facebookDashInstantDashGamesStrings.LEADERBOARD = this.cast("LEADERBOARD")
  @scala.inline
