  ...
  */
  ...
  object RouteDefinition {
    ...
    def CallRoute(
      ...
      val __obj = js.Dynamic.literal(call = js.Any.fromFunction2(call), route = route.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.falcorRouter.mod.CallRoute]
    }
    ...
    def GetRoute(
      ...
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), route = route.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.falcorRouter.mod.GetRoute]
    }
    
    @scala.inline
    def SetRoute(route: String, set: JSONGraph => RouteResult | js.Promise[RouteResult] | Observable[RouteResult]): typingsSlinky.falcorRouter.mod.SetRoute = {
      val __obj = js.Dynamic.literal(route = route.asInstanceOf[js.Any], set = js.Any.fromFunction1(set))
      __obj.asInstanceOf[typingsSlinky.falcorRouter.mod.SetRoute]
    }
  }
