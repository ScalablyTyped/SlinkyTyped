...
object ResizeInfo {
  ...
  implicit class ResizeInfoMutableBuilder[Self <: ResizeInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlobBlob(value: Blob): Self = StObject.set(x, "blob", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBlobFile(value: File): Self = StObject.set(x, "blob", value.asInstanceOf[js.Any])
