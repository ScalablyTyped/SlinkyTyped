...
import typingsSlinky.fineUploader.coreMod.FineUploaderBasic
...
import typingsSlinky.fineUploader.coreMod.ScalingOptions
...
object mod {
  ...
  object UIOptions {
    ...
    implicit class UIOptionsMutableBuilder[Self <: UIOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTemplateHTMLElement(value: HTMLElement): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
