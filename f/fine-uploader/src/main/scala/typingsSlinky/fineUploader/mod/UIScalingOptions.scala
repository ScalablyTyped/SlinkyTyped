...
object UIScalingOptions {
  ...
  implicit class UIScalingOptionsOps[Self <: UIScalingOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHideScaled(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideScaled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHideScaled: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideScaled")(js.undefined)
        ret
    }
  }
