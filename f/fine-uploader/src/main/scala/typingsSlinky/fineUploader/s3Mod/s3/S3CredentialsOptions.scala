...
object S3CredentialsOptions {
  ...
  implicit class S3CredentialsOptionsOps[Self <: S3CredentialsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpirationDate(value: js.Date): Self = this.set("expiration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExpiration(value: String | js.Date): Self = this.set("expiration", value.asInstanceOf[js.Any])
