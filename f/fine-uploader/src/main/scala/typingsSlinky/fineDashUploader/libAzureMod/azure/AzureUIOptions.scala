package typingsSlinky.fineDashUploader.libAzureMod.azure

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIDeleteFileOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIDisplayOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIDragAndDropOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIMessages
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIPasteOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIRetryOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIScalingOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UITextOptions
import typingsSlinky.fineDashUploader.fineDashUploaderMod.UIThumbnailsOptions
import typingsSlinky.fineDashUploader.libCoreMod.BlobsOptions
import typingsSlinky.fineDashUploader.libCoreMod.CameraOptions
import typingsSlinky.fineDashUploader.libCoreMod.CoreEvents
import typingsSlinky.fineDashUploader.libCoreMod.ExtraButtonsOptions
import typingsSlinky.fineDashUploader.libCoreMod.FormOptions
import typingsSlinky.fineDashUploader.libCoreMod.PromiseOptions
import typingsSlinky.fineDashUploader.libCoreMod.ResumeOptions
import typingsSlinky.fineDashUploader.libCoreMod.SessionOptions
import typingsSlinky.fineDashUploader.libCoreMod.ValidationOptions
import typingsSlinky.fineDashUploader.libCoreMod.WorkArounds
