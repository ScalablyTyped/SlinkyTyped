...
import typingsSlinky.fineDashUploader.libCoreMod.ConcurrentOptions
import typingsSlinky.fineDashUploader.libCoreMod.ParamNamesOptions
import typingsSlinky.fineDashUploader.libCoreMod.SuccessOptions
