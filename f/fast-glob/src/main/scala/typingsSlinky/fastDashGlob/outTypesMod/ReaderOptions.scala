package typingsSlinky.fastDashGlob.outTypesMod
...
trait ReaderOptions extends Options {
  ...
  @JSName("deepFilter")
  def deepFilter_MReaderOptions(value: typingsSlinky.atNodelibFsDotWalk.outTypesMod.Entry): Boolean = js.native
  @JSName("entryFilter")
  def entryFilter_MReaderOptions(value: typingsSlinky.atNodelibFsDotWalk.outTypesMod.Entry): Boolean = js.native
  @JSName("errorFilter")
