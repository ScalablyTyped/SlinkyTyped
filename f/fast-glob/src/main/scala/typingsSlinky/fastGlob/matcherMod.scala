...
object matcherMod {
  ...
  object DynamicPatternSegment {
    ...
    implicit class DynamicPatternSegmentMutableBuilder[Self <: DynamicPatternSegment] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPatternRe(value: js.RegExp): Self = StObject.set(x, "patternRe", value.asInstanceOf[js.Any])
    }
  }
  ...
  */
  ...
  object PatternSegment {
    ...
    @scala.inline
    def DynamicPatternSegment(dynamic: `true`, pattern: Pattern, patternRe: js.RegExp): typingsSlinky.fastGlob.matcherMod.DynamicPatternSegment = {
      val __obj = js.Dynamic.literal(dynamic = dynamic.asInstanceOf[js.Any], pattern = pattern.asInstanceOf[js.Any], patternRe = patternRe.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastGlob.matcherMod.DynamicPatternSegment]
    }
    
    @scala.inline
    def StaticPatternSegment(dynamic: `false`, pattern: Pattern): typingsSlinky.fastGlob.matcherMod.StaticPatternSegment = {
      val __obj = js.Dynamic.literal(dynamic = dynamic.asInstanceOf[js.Any], pattern = pattern.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.fastGlob.matcherMod.StaticPatternSegment]
    }
  }
