...
trait Reader[T] extends js.Object {
  val deepFilter: typingsSlinky.fastGlob.deepMod.default
  val entryFilter: typingsSlinky.fastGlob.entryMod.default
  ...
  /**
    ...
    */
  def getReaderOptions(task: ITask): typingsSlinky.mrmlncReaddirEnhanced.mod.Options
  /**
