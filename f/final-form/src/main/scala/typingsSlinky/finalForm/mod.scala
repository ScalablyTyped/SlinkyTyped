...
import typingsSlinky.finalForm.finalFormBooleans.`false`
import typingsSlinky.finalForm.finalFormStrings.`FINAL_FORMSlasharray-error`
import typingsSlinky.finalForm.finalFormStrings.`FINAL_FORMSlashform-error`
import typingsSlinky.finalForm.finalFormStrings.debug
import typingsSlinky.finalForm.finalFormStrings.destroyOnUnregister
import typingsSlinky.finalForm.finalFormStrings.initialValues
import typingsSlinky.finalForm.finalFormStrings.keepDirtyOnReinitialize
import typingsSlinky.finalForm.finalFormStrings.mutators
import typingsSlinky.finalForm.finalFormStrings.validate
import typingsSlinky.finalForm.finalFormStrings.validateOnBlur
...
object mod {
  ...
  /* keyof final-form.final-form.Config<object, std.Partial<object>> */ /* Rewritten from type alias, can be one of: 
    - typingsSlinky.finalForm.finalFormStrings.debug
    - typingsSlinky.finalForm.finalFormStrings.destroyOnUnregister
    - typingsSlinky.finalForm.finalFormStrings.initialValues
    - typingsSlinky.finalForm.finalFormStrings.keepDirtyOnReinitialize
    - typingsSlinky.finalForm.finalFormStrings.mutators
    - typingsSlinky.finalForm.finalFormStrings.onSubmit
    - typingsSlinky.finalForm.finalFormStrings.validate
    - typingsSlinky.finalForm.finalFormStrings.validateOnBlur
  */
