...
object AnonHasErrorValue {
  @scala.inline
  def apply[TValue](hasError: `false`, value: TValue): AnonHasErrorValue[TValue] = {
  ...
  @scala.inline
  implicit class AnonHasErrorValueOps[Self[tvalue] <: AnonHasErrorValue[tvalue], TValue] (val x: Self[TValue]) extends AnyVal {
    @scala.inline
