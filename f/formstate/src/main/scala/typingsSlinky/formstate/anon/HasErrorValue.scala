...
object HasErrorValue {
  @scala.inline
  def apply[/* <: typingsSlinky.formstate.formStateMod.ValidatableMapOrArray */ TValue](hasError: `false`, value: TValue): HasErrorValue[TValue] = {
  ...
  @scala.inline
  implicit class HasErrorValueOps[Self <: HasErrorValue[_], /* <: typingsSlinky.formstate.formStateMod.ValidatableMapOrArray */ TValue] (val x: Self with HasErrorValue[TValue]) extends AnyVal {
    @scala.inline
