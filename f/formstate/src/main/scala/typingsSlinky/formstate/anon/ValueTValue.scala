...
object ValueTValue {
  @scala.inline
  def apply[/* <: typingsSlinky.formstate.formStateLazyMod.ValidatableArray */ TValue](hasError: `false`, value: TValue): ValueTValue[TValue] = {
  ...
  @scala.inline
  implicit class ValueTValueOps[Self <: ValueTValue[_], /* <: typingsSlinky.formstate.formStateLazyMod.ValidatableArray */ TValue] (val x: Self with ValueTValue[TValue]) extends AnyVal {
    @scala.inline
