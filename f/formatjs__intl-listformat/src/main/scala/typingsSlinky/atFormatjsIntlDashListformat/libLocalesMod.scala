...
import typingsSlinky.atFormatjsIntlDashListformat.libCoreMod.IntlListFormatOptions
...
object libLocalesMod extends js.Object {
  @js.native
  class default ()
    extends typingsSlinky.atFormatjsIntlDashListformat.libCoreMod.default {
