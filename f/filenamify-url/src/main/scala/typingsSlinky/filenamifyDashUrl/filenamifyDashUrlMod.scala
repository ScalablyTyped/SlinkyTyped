package typingsSlinky.filenamifyDashUrl

import typingsSlinky.filenamifyDashUrl.filenamifyDashUrlMod.Options
...
object filenamifyDashUrlMod extends js.Object {
  ...
  type Options = typingsSlinky.filenamify.filenamifyMod.Options
}
