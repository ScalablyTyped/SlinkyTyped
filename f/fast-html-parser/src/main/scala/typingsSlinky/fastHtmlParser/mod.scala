...
object mod {
  ...
  object NodeType extends StObject {
    ...
    /* 1 */ val ELEMENT_NODE: typingsSlinky.fastHtmlParser.mod.NodeType.ELEMENT_NODE with Double = js.native
    
    @js.native
    sealed trait TEXT_NODE extends NodeType
    /* 3 */ val TEXT_NODE: typingsSlinky.fastHtmlParser.mod.NodeType.TEXT_NODE with Double = js.native
  }
