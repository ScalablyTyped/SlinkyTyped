...
object StorageObserver {
  ...
  def apply[T](
    ...
    error: js.UndefOr[Null | (/* error */ js.Error | FirebaseStorageError => Unit)] = js.undefined,
    ...
    if (!js.isUndefined(error)) __obj.updateDynamic("error")(if (error != null) js.Any.fromFunction1(error.asInstanceOf[/* error */ js.Error | FirebaseStorageError => Unit]) else null)
