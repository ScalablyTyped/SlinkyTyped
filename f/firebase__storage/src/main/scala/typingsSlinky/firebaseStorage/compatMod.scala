...
object compatMod {
  ...
  object firebaseAppTypesAugmentingMod {
    ...
    object FirebaseNamespace {
      ...
      @scala.inline
      def apply(): typingsSlinky.firebaseStorage.compatMod.firebaseAppTypesAugmentingMod.FirebaseNamespace = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.firebaseStorage.compatMod.firebaseAppTypesAugmentingMod.FirebaseNamespace]
      }
      
      @scala.inline
      implicit class FirebaseNamespaceMutableBuilder[Self <: typingsSlinky.firebaseStorage.compatMod.firebaseAppTypesAugmentingMod.FirebaseNamespace] (val x: Self) extends AnyVal {
