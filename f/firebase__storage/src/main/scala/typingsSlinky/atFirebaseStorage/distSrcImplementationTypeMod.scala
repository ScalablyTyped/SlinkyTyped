...
@js.native
object distSrcImplementationTypeMod extends js.Object {
  def isDef[T](): /* is T */ Boolean = js.native
  def isDef[T](p: T): /* is T */ Boolean = js.native
  def isFunction(p: js.Any): /* is std.Function */ Boolean = js.native
  def isInteger(p: js.Any): /* is number */ Boolean = js.native
  ...
  def isNonNullObject(p: js.Any): /* is object */ Boolean = js.native
  def isNumber(p: js.Any): /* is number */ Boolean = js.native
  def isObject(p: js.Any): Boolean = js.native
