...
import typingsSlinky.atFirebaseStorage.distSrcImplementationStringMod.StringData
import typingsSlinky.atFirebaseStorage.distSrcImplementationStringMod.StringFormat
...
object distSrcImplementationStringMod extends js.Object {
  ...
  def base64Bytes_(format: StringFormat, value: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  def dataFromString(format: StringFormat, stringData: String): StringData = js.native
  def dataURLBytes_(dataUrl: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  def dataURLContentType_(dataUrl: String): String | Null = js.native
  def formatValidator(stringFormat: js.Any): Unit = js.native
  def percentEncodedBytes_(value: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  def utf8Bytes_(value: String): scala.scalajs.js.typedarray.Uint8Array = js.native
  @js.native
