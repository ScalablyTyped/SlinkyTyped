...
import typingsSlinky.followRedirects.followRedirectsStrings.error
import typingsSlinky.followRedirects.followRedirectsStrings.response
...
object mod {
  ...
  object http {
    ...
    @JSImport("follow-redirects", "http.createServer")
    @js.native
    def createServer_Fhttp: js.Function0[typingsSlinky.node.httpMod.Server] = js.native
    
    @scala.inline
    def createServer_Fhttp_=(x: js.Function0[typingsSlinky.node.httpMod.Server]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("createServer")(x.asInstanceOf[js.Any])
  ...
  object https {
    ...
    @JSImport("follow-redirects", "https.Agent")
    @js.native
    def Agent: Instantiable0[typingsSlinky.node.httpsMod.Agent] = js.native
    @scala.inline
    def Agent_=(x: Instantiable0[typingsSlinky.node.httpsMod.Agent]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Agent")(x.asInstanceOf[js.Any])
    ...
    @JSImport("follow-redirects", "https.Server")
    @js.native
    def Server: Instantiable0[typingsSlinky.node.httpsMod.Server] = js.native
    @scala.inline
    def Server_=(x: Instantiable0[typingsSlinky.node.httpsMod.Server]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Server")(x.asInstanceOf[js.Any])
    ...
    @JSImport("follow-redirects", "https.createServer")
    @js.native
    def createServer_Fhttps: js.Function0[typingsSlinky.node.httpsMod.Server] = js.native
    
    @scala.inline
    def createServer_Fhttps_=(x: js.Function0[typingsSlinky.node.httpsMod.Server]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("createServer")(x.asInstanceOf[js.Any])
    
    @JSImport("follow-redirects", "https.get")
    @js.native
    def get(
      options: typingsSlinky.node.httpsMod.RequestOptions with FollowOptions[typingsSlinky.node.httpsMod.RequestOptions]
    ...
    @js.native
    def globalAgent: typingsSlinky.node.httpsMod.Agent = js.native
    @scala.inline
    def globalAgent_=(x: typingsSlinky.node.httpsMod.Agent): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalAgent")(x.asInstanceOf[js.Any])
  ...
  {[ K in keyof T ]: follow-redirects.follow-redirects.WrappedScheme<T[K]>}
    */ typingsSlinky.followRedirects.followRedirectsStrings.wrap with TopLevel[T] = js.native
