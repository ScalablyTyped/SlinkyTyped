...
object httpsMod {
  ...
  @JSImport("follow-redirects/https", "createServer")
  @js.native
  def createServer_FhttpsMod: js.Function0[typingsSlinky.node.httpsMod.Server] = js.native
  
  @scala.inline
  def createServer_FhttpsMod_=(x: js.Function0[typingsSlinky.node.httpsMod.Server]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("createServer")(x.asInstanceOf[js.Any])
