...
object CpuContext {
  ...
  def Arm64CpuContext(
    ...
    __obj.asInstanceOf[typingsSlinky.fridaGum.Arm64CpuContext]
  }
  ...
  def ArmCpuContext(
    ...
    __obj.asInstanceOf[typingsSlinky.fridaGum.ArmCpuContext]
  }
  ...
  def Ia32CpuContext(
    ...
    __obj.asInstanceOf[typingsSlinky.fridaGum.Ia32CpuContext]
  }
  ...
  def MipsCpuContext(
    ...
    __obj.asInstanceOf[typingsSlinky.fridaGum.MipsCpuContext]
  }
  
  @scala.inline
  def PortableCpuContext(pc: NativePointer, sp: NativePointer): typingsSlinky.fridaGum.PortableCpuContext = {
    val __obj = js.Dynamic.literal(pc = pc.asInstanceOf[js.Any], sp = sp.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.fridaGum.PortableCpuContext]
  }
  ...
  def X64CpuContext(
    ...
    __obj.asInstanceOf[typingsSlinky.fridaGum.X64CpuContext]
  }
}
