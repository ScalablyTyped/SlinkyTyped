...
object Arm64BarrierOperand {
  ...
  @scala.inline
  implicit class Arm64BarrierOperandOps[Self <: Arm64BarrierOperand] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: barrier): Self = this.set("type", value.asInstanceOf[js.Any])
