...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.fridaGum.fridaGumStrings.abort
  - typingsSlinky.fridaGum.fridaGumStrings.`access-violation`
  - typingsSlinky.fridaGum.fridaGumStrings.`guard-page`
  - typingsSlinky.fridaGum.fridaGumStrings.`illegal-instruction`
  - typingsSlinky.fridaGum.fridaGumStrings.`stack-overflow`
  - typingsSlinky.fridaGum.fridaGumStrings.arithmetic
  - typingsSlinky.fridaGum.fridaGumStrings.breakpoint
