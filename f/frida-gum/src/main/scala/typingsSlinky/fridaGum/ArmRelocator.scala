...
/**
  ...
  */
@js.native
trait ArmRelocator extends StObject {
  ...
  /**
    * Recycles instance.
    */
  def reset(inputCode: NativePointerValue, output: ArmWriter): Unit = js.native
...
object ArmRelocator {
  ...
  def apply(
    ...
    readOne: () => Double,
    reset: (NativePointerValue, ArmWriter) => Unit,
    skipOne: () => Unit,
    writeAll: () => Unit,
    writeOne: () => Boolean
  ): ArmRelocator = {
  ...
  @scala.inline
  implicit class ArmRelocatorMutableBuilder[Self <: ArmRelocator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReset(value: (NativePointerValue, ArmWriter) => Unit): Self = StObject.set(x, "reset", js.Any.fromFunction2(value))
