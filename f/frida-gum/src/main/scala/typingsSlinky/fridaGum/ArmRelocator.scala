...
/**
  ...
  */
@js.native
trait ArmRelocator extends js.Object {
...
object ArmRelocator {
  ...
  @scala.inline
  implicit class ArmRelocatorOps[Self <: ArmRelocator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReset(value: (NativePointerValue, ArmWriter) => Unit): Self = this.set("reset", js.Any.fromFunction2(value))
