...
class NativePointer protected ()
  ...
  def or(v: Int64_): NativePointer = js.native
  /**
    * Makes a new NativePointer whose value is `this` | `v`.
    */
  def or(v: NativePointerValue): NativePointer = js.native
  def or(v: UInt64_): NativePointer = js.native
  ...
  def sub(v: UInt64_): NativePointer = js.native
  /**
  ...
  def xor(v: Int64_): NativePointer = js.native
  /**
    * Makes a new NativePointer whose value is `this` ^ `v`.
    */
  def xor(v: NativePointerValue): NativePointer = js.native
  def xor(v: UInt64_): NativePointer = js.native
}
