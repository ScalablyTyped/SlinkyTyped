...
object Arm64PrefetchOperand {
  ...
  @scala.inline
  implicit class Arm64PrefetchOperandOps[Self <: Arm64PrefetchOperand] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: prefetch): Self = this.set("type", value.asInstanceOf[js.Any])
