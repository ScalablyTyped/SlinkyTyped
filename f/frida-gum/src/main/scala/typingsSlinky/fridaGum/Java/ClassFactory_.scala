...
class ClassFactory_ () extends js.Object {
  ...
  /**
    ...
    */
  val loader: typingsSlinky.fridaGum.Wrapper | Null = js.native
  /**
  ...
  /**
    ...
    */
  def registerClass(spec: ClassSpec): typingsSlinky.fridaGum.Wrapper = js.native
  /**
...
object ClassFactory_ extends js.Object {
  /**
    ...
    */
  def get(classLoader: typingsSlinky.fridaGum.Wrapper): ClassFactory_ = js.native
}
