...
trait ClassSpec extends js.Object {
  ...
  /**
    ...
    */
  var implements: js.UndefOr[js.Array[typingsSlinky.fridaGum.anon.Wrapper]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var superClass: js.UndefOr[typingsSlinky.fridaGum.anon.Wrapper] = js.undefined
}
...
object ClassSpec {
  ...
  def apply(
    ...
    implements: js.Array[typingsSlinky.fridaGum.anon.Wrapper] = null,
    methods: StringDictionary[MethodImplementation[js.Object] | MethodSpec | js.Array[MethodSpec]] = null,
    superClass: typingsSlinky.fridaGum.anon.Wrapper = null
  ): ClassSpec = {
