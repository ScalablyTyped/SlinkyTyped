...
object ClassSpec {
  ...
  implicit class ClassSpecOps[Self <: ClassSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImplementsVarargs(value: typingsSlinky.fridaGum.anon.Wrapper*): Self = this.set("implements", js.Array(value :_*))
    
    @scala.inline
    def setImplements(value: js.Array[typingsSlinky.fridaGum.anon.Wrapper]): Self = this.set("implements", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSuperClass(value: typingsSlinky.fridaGum.anon.Wrapper): Self = this.set("superClass", value.asInstanceOf[js.Any])
