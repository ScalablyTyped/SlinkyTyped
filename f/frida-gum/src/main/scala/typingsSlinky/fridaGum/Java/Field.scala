...
object Field {
  @scala.inline
  def apply[Value, /* <: typingsSlinky.fridaGum.Java.Members[Holder] */ Holder](fieldReturnType: Type, fieldType: FieldType, holder: Wrapper[Holder], value: Value): Field[Value, Holder] = {
  ...
  @scala.inline
  implicit class FieldOps[Self <: Field[_, _], Value, /* <: typingsSlinky.fridaGum.Java.Members[Holder] */ Holder] (val x: Self with (Field[Value, Holder])) extends AnyVal {
    @scala.inline
