...
object ProxySpec {
  @scala.inline
  def apply[/* <: typingsSlinky.fridaGum.ObjC.ProxyData */ D, T, S](): ProxySpec[D, T, S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProxySpec[D, T, S]]
  }
  @scala.inline
  implicit class ProxySpecOps[Self <: ProxySpec[_, _, _], /* <: typingsSlinky.fridaGum.ObjC.ProxyData */ D, T, S] (val x: Self with (ProxySpec[D, T, S])) extends AnyVal {
    @scala.inline
