...
import typingsSlinky.fridaGum.Java.MethodDispatcher
...
object anon {
  ...
  trait Wrapper
    ...
    /**
      ...
      */
    @JSName("$super")
    var $super: typingsSlinky.fridaGum.Java.Wrapper[js.Object] = js.native
    
    /**
      * Retrieves a `java.lang.Class` wrapper for the current class.
      */
    var `class`: typingsSlinky.fridaGum.Java.Wrapper[js.Object] = js.native
  }
}
