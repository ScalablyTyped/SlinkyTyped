...
package object fridaGum {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Double
    - typingsSlinky.fridaGum.UInt64_
    - typingsSlinky.fridaGum.Int64_
  ...
  */
  ...
  type StalkerTransformCallback = typingsSlinky.fridaGum.StalkerX86TransformCallback | typingsSlinky.fridaGum.StalkerArm64TransformCallback | typingsSlinky.fridaGum.StalkerNativeTransformCallback
