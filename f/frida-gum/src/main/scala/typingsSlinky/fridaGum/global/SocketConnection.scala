...
abstract class SocketConnection ()
  extends typingsSlinky.fridaGum.SocketConnection {
  /**
    * The `InputStream` to read from.
    */
  /* CompleteClass */
  override var input: typingsSlinky.fridaGum.InputStream = js.native
  /**
    * The `OutputStream` to write to.
    */
  /* CompleteClass */
  override var output: typingsSlinky.fridaGum.OutputStream = js.native
  /**
