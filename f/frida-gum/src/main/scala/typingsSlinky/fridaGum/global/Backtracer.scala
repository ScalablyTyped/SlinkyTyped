...
object Backtracer {
  ...
  @js.native
  def ACCURATE: typingsSlinky.fridaGum.Backtracer = js.native
  @scala.inline
  def ACCURATE_=(x: typingsSlinky.fridaGum.Backtracer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ACCURATE")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def FUZZY: typingsSlinky.fridaGum.Backtracer = js.native
  @scala.inline
  def FUZZY_=(x: typingsSlinky.fridaGum.Backtracer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FUZZY")(x.asInstanceOf[js.Any])
}
