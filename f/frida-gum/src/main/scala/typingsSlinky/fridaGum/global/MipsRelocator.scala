...
class MipsRelocator protected ()
  extends typingsSlinky.fridaGum.MipsRelocator {
  /**
    ...
    *               address.
    */
  def this(inputCode: NativePointerValue, output: typingsSlinky.fridaGum.MipsWriter) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(inputCode: NativePointerValue, output: typingsSlinky.fridaGum.MipsWriter): Unit = js.native
  /**
