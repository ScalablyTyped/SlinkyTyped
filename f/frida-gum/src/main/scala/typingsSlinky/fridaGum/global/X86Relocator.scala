...
class X86Relocator protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var eob: Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var eoi: Boolean = js.native
  /**
    * Latest `Instruction` read so far. Starts out `null` and changes
    * on every call to `readOne()`.
    */
  /* CompleteClass */
  override var input: typingsSlinky.fridaGum.Instruction | Null = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def peekNextWriteInsn(): typingsSlinky.fridaGum.Instruction | Null = js.native
  /**
    * Peeks at the address of the next instruction to be written or skipped.
    */
  /* CompleteClass */
  override def peekNextWriteSource(): typingsSlinky.fridaGum.NativePointer = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(inputCode: NativePointerValue, output: typingsSlinky.fridaGum.X86Writer): Unit = js.native
  /**
