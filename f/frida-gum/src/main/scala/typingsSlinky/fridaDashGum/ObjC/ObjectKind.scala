...
object ObjectKind {
  ...
  @scala.inline
  def `class`: typingsSlinky.fridaDashGum.fridaDashGumStrings.`class` = this.cast("class")
  @scala.inline
  def instance: typingsSlinky.fridaDashGum.fridaDashGumStrings.instance = this.cast("instance")
  @scala.inline
  def `meta-class`: typingsSlinky.fridaDashGum.fridaDashGumStrings.`meta-class` = this.cast("meta-class")
}
