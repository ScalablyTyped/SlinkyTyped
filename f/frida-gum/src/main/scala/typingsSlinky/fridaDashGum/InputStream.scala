...
abstract class InputStream () extends js.Object {
  ...
  /**
    ...
    */
  def read(size: Double): js.Promise[scala.scalajs.js.typedarray.ArrayBuffer] = js.native
  /**
    ...
    */
  def readAll(size: Double): js.Promise[scala.scalajs.js.typedarray.ArrayBuffer] = js.native
}
