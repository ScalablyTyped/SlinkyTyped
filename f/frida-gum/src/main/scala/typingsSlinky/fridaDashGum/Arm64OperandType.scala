...
object Arm64OperandType {
  @scala.inline
  def barrier: typingsSlinky.fridaDashGum.fridaDashGumStrings.barrier = this.cast("barrier")
  @scala.inline
  ...
  @scala.inline
  def prefetch: typingsSlinky.fridaDashGum.fridaDashGumStrings.prefetch = this.cast("prefetch")
  @scala.inline
  def pstate: typingsSlinky.fridaDashGum.fridaDashGumStrings.pstate = this.cast("pstate")
  @scala.inline
  def reg: typingsSlinky.fridaDashGum.fridaDashGumStrings.reg = this.cast("reg")
  @scala.inline
  def `reg-mrs`: typingsSlinky.fridaDashGum.fridaDashGumStrings.`reg-mrs` = this.cast("reg-mrs")
  @scala.inline
  def `reg-msr`: typingsSlinky.fridaDashGum.fridaDashGumStrings.`reg-msr` = this.cast("reg-msr")
  @scala.inline
  def sys: typingsSlinky.fridaDashGum.fridaDashGumStrings.sys = this.cast("sys")
}
