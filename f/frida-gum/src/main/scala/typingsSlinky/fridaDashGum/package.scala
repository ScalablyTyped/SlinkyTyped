...
package object fridaDashGum {
  ...
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.`apsr-nzcvq`
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.block
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.call
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.compile
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.exec
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.ret
  import typingsSlinky.fridaDashGum.fridaDashGumStrings.stop
