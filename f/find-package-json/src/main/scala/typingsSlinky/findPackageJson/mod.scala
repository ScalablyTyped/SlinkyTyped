...
object mod {
  ...
  */
  ...
  object FindResult {
    ...
    @scala.inline
    def Done(done: `true`): typingsSlinky.findPackageJson.mod.Done = {
      val __obj = js.Dynamic.literal(done = done.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.findPackageJson.mod.Done]
    }
    
    @scala.inline
    def FoundPackage(done: `false`, filename: String, value: Package): typingsSlinky.findPackageJson.mod.FoundPackage = {
      ...
      __obj.asInstanceOf[typingsSlinky.findPackageJson.mod.FoundPackage]
    }
  }
