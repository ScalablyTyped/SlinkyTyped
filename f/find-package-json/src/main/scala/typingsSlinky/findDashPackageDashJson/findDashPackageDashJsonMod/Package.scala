...
import typingsSlinky.findDashPackageDashJson.Anon_Email
import typingsSlinky.findDashPackageDashJson.Anon_EmailUrl
import typingsSlinky.findDashPackageDashJson.Anon_Type
