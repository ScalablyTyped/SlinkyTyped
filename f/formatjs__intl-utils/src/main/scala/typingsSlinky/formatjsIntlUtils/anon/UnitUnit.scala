...
object UnitUnit {
  @scala.inline
  def apply(unit: typingsSlinky.formatjsIntlUtils.diffMod.Unit, value: Double): UnitUnit = {
  ...
  implicit class UnitUnitOps[Self <: UnitUnit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUnit(value: typingsSlinky.formatjsIntlUtils.diffMod.Unit): Self = this.set("unit", value.asInstanceOf[js.Any])
    @scala.inline
