...
/* Inlined {[ f in @formatjs/intl-utils.@formatjs/intl-utils/src/relative-time-types.RelativeTimeField ]:? @formatjs/intl-utils.@formatjs/intl-utils/src/relative-time-types.FieldData} & {  nu :std.Array<string | null>} */
@js.native
