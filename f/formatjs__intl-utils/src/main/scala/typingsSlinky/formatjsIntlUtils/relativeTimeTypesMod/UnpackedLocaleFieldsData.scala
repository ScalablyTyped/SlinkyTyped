...
/* Inlined {[ f in @formatjs/intl-utils.@formatjs/intl-utils/lib/src/relative-time-types.RelativeTimeField ]:? @formatjs/intl-utils.@formatjs/intl-utils/lib/src/relative-time-types.FieldData} & {  nu :std.Array<string | null>} */
@js.native
