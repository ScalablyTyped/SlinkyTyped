...
trait DisplayNamesData extends js.Object {
  /**
    ...
    */
  var patterns: typingsSlinky.formatjsIntlUtils.anon.Locale = js.native
  /**
...
object DisplayNamesData {
  @scala.inline
  def apply(patterns: typingsSlinky.formatjsIntlUtils.anon.Locale, types: Currency): DisplayNamesData = {
  ...
  implicit class DisplayNamesDataOps[Self <: DisplayNamesData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPatterns(value: typingsSlinky.formatjsIntlUtils.anon.Locale): Self = this.set("patterns", value.asInstanceOf[js.Any])
    @scala.inline
