...
/* Inlined {[ f in @formatjs/intl-utils.@formatjs/intl-utils.RelativeTimeField ]:? @formatjs/intl-utils.@formatjs/intl-utils.FieldData} & {  nu :std.Array<string | null> | undefined} */
@js.native
