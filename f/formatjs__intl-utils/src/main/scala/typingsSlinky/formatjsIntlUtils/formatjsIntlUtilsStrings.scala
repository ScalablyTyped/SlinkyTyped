...
import typingsSlinky.formatjsIntlUtils.mod.DecimalFormatNum
import typingsSlinky.formatjsIntlUtils.mod.LDMLPluralRule
import typingsSlinky.formatjsIntlUtils.mod.NumberFormatNotation
import typingsSlinky.formatjsIntlUtils.mod.NumberFormatRoundingType
import typingsSlinky.formatjsIntlUtils.mod.RelativeTimeField
import typingsSlinky.formatjsIntlUtils.mod.Unit
...
object formatjsIntlUtilsStrings {
  ...
  sealed trait `1000`
    extends DecimalFormatNum
       with typingsSlinky.formatjsIntlUtils.srcNumberTypesMod.DecimalFormatNum
       with typingsSlinky.formatjsIntlUtils.numberTypesMod.DecimalFormatNum
  ...
  sealed trait compact
    extends NumberFormatNotation
       with typingsSlinky.formatjsIntlUtils.srcNumberTypesMod.NumberFormatNotation
       with typingsSlinky.formatjsIntlUtils.numberTypesMod.NumberFormatNotation
  
  @js.native
  sealed trait compactRounding
    extends NumberFormatRoundingType
       with typingsSlinky.formatjsIntlUtils.srcNumberTypesMod.NumberFormatRoundingType
       with typingsSlinky.formatjsIntlUtils.numberTypesMod.NumberFormatRoundingType
  ...
  sealed trait day
    extends RelativeTimeField
       with typingsSlinky.formatjsIntlUtils.srcRelativeTimeTypesMod.RelativeTimeField
       with typingsSlinky.formatjsIntlUtils.relativeTimeTypesMod.RelativeTimeField
       with Unit
       with typingsSlinky.formatjsIntlUtils.srcDiffMod.Unit
       with typingsSlinky.formatjsIntlUtils.diffMod.Unit
  ...
  sealed trait few
    extends LDMLPluralRule
       with typingsSlinky.formatjsIntlUtils.pluralRulesTypesMod.LDMLPluralRule
       with typingsSlinky.formatjsIntlUtils.srcPluralRulesTypesMod.LDMLPluralRule
