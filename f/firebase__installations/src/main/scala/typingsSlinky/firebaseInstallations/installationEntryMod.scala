...
object installationEntryMod {
  ...
  */
  ...
  object AuthToken {
    ...
    @scala.inline
    def CompletedAuthToken(creationTime: Double, expiresIn: Double, requestStatus: `2`, token: String): typingsSlinky.firebaseInstallations.installationEntryMod.CompletedAuthToken = {
      ...
      __obj.asInstanceOf[typingsSlinky.firebaseInstallations.installationEntryMod.CompletedAuthToken]
    }
    
    @scala.inline
    def InProgressAuthToken(requestStatus: `1`, requestTime: Double): typingsSlinky.firebaseInstallations.installationEntryMod.InProgressAuthToken = {
      val __obj = js.Dynamic.literal(requestStatus = requestStatus.asInstanceOf[js.Any], requestTime = requestTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.firebaseInstallations.installationEntryMod.InProgressAuthToken]
    }
    
    @scala.inline
    def NotStartedAuthToken(requestStatus: `0`): typingsSlinky.firebaseInstallations.installationEntryMod.NotStartedAuthToken = {
      val __obj = js.Dynamic.literal(requestStatus = requestStatus.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.firebaseInstallations.installationEntryMod.NotStartedAuthToken]
    }
  }
  ...
  */
  ...
  object InstallationEntry {
    ...
    @scala.inline
    def InProgressInstallationEntry(fid: String, registrationStatus: `1`, registrationTime: Double): typingsSlinky.firebaseInstallations.installationEntryMod.InProgressInstallationEntry = {
      val __obj = js.Dynamic.literal(fid = fid.asInstanceOf[js.Any], registrationStatus = registrationStatus.asInstanceOf[js.Any], registrationTime = registrationTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.firebaseInstallations.installationEntryMod.InProgressInstallationEntry]
    }
    
    @scala.inline
    def RegisteredInstallationEntry(authToken: AuthToken, fid: String, refreshToken: String, registrationStatus: `2`): typingsSlinky.firebaseInstallations.installationEntryMod.RegisteredInstallationEntry = {
      ...
      __obj.asInstanceOf[typingsSlinky.firebaseInstallations.installationEntryMod.RegisteredInstallationEntry]
    }
    
    @scala.inline
    def UnregisteredInstallationEntry(fid: String, registrationStatus: `0`): typingsSlinky.firebaseInstallations.installationEntryMod.UnregisteredInstallationEntry = {
      val __obj = js.Dynamic.literal(fid = fid.asInstanceOf[js.Any], registrationStatus = registrationStatus.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.firebaseInstallations.installationEntryMod.UnregisteredInstallationEntry]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.firebaseInstallations.firebaseInstallationsNumbers.`0`
    - typingsSlinky.firebaseInstallations.firebaseInstallationsNumbers.`1`
    - typingsSlinky.firebaseInstallations.firebaseInstallationsNumbers.`2`
  */
