package typingsSlinky.falcor.falcorMod
...
import typingsSlinky.falcorDashJsonDashGraph.falcorDashJsonDashGraphMod.Path
...
class Model () extends js.Object {
  ...
  /**
    ...
    */
  def set(args: PathValue*): ModelResponse[JSONEnvelope[_]] = js.native
  ...
  @JSName("set")
  def set_T[T](args: PathValue*): ModelResponse[JSONEnvelope[T]] = js.native
  @JSName("set")
