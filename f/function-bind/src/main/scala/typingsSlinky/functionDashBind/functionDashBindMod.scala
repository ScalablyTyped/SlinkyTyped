package typingsSlinky.functionDashBind
...
@js.native
object functionDashBindMod extends js.Object {
  ...
  @JSName("apply")
  def apply[T, AX, R](func: js.ThisFunction1[/* this */ T, /* repeated */ AX, R], args: js.Array[T | AX]): js.Function1[/* repeated */ AX, R] = js.native
  @JSName("apply")
  ...
  // CallableFunction:
  @JSName("apply")
  def apply_TA_ArrayWildcardR[T, A /* <: js.Array[_] */, R](func: js.ThisFunction1[/* this */ T, /* args */ A, R], args: js.Array[T]): js.Function1[/* args */ A, R] = js.native
  // NewableFunction:
