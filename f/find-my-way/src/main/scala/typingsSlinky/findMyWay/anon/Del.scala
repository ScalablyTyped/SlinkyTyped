...
object Del {
  @scala.inline
  def apply[/* <: typingsSlinky.findMyWay.mod.HTTPVersion */ V](
    del: String => Unit,
    empty: () => Unit,
  ...
  @scala.inline
  implicit class DelOps[Self <: Del[_], /* <: typingsSlinky.findMyWay.mod.HTTPVersion */ V] (val x: Self with Del[V]) extends AnyVal {
    @scala.inline
