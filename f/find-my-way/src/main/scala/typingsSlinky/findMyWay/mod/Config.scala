...
object Config {
  @scala.inline
  def apply[/* <: typingsSlinky.findMyWay.mod.HTTPVersion */ V](): Config[V] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Config[V]]
  }
  @scala.inline
  implicit class ConfigOps[Self <: Config[_], /* <: typingsSlinky.findMyWay.mod.HTTPVersion */ V] (val x: Self with Config[V]) extends AnyVal {
    @scala.inline
