...
object mod {
  ...
  @js.native
  def default[Server /* <: typingsSlinky.node.httpMod.Server */, Request /* <: RawRequestDefaultExpression[Server] */, Reply /* <: RawReplyDefaultExpression[Server] */, Logger /* <: FastifyLoggerInstance */](): (FastifyInstance[Server, Request, Reply, Logger]) with (js.Thenable[FastifyInstance[Server, Request, Reply, Logger]]) = js.native
  @JSImport("fastify", JSImport.Default)
  @js.native
  ...
  @JSImport("fastify", JSImport.Default)
  @js.native
  def default[Server /* <: typingsSlinky.node.httpsMod.Server */, Request /* <: RawRequestDefaultExpression[Server] */, Reply /* <: RawReplyDefaultExpression[Server] */, Logger /* <: FastifyLoggerInstance */](opts: FastifyHttpsOptions[Server, Logger]): (FastifyInstance[Server, Request, Reply, Logger]) with (js.Thenable[FastifyInstance[Server, Request, Reply, Logger]]) = js.native
  @JSImport("fastify", JSImport.Default)
  @js.native
  def default[Server /* <: typingsSlinky.node.httpMod.Server */, Request /* <: RawRequestDefaultExpression[Server] */, Reply /* <: RawReplyDefaultExpression[Server] */, Logger /* <: FastifyLoggerInstance */](opts: FastifyServerOptions[Server, Logger]): (FastifyInstance[Server, Request, Reply, Logger]) with (js.Thenable[FastifyInstance[Server, Request, Reply, Logger]]) = js.native
  
  @JSImport("fastify", "fastify")
  @js.native
  def fastify[Server /* <: typingsSlinky.node.httpMod.Server */, Request /* <: RawRequestDefaultExpression[Server] */, Reply /* <: RawReplyDefaultExpression[Server] */, Logger /* <: FastifyLoggerInstance */](): (FastifyInstance[Server, Request, Reply, Logger]) with (js.Thenable[FastifyInstance[Server, Request, Reply, Logger]]) = js.native
  @JSImport("fastify", "fastify")
  @js.native
  ...
  object FastifyHttpsOptions {
    ...
    @scala.inline
    def apply[Server /* <: typingsSlinky.node.httpsMod.Server */, Logger /* <: FastifyLoggerInstance */](https: ServerOptions): FastifyHttpsOptions[Server, Logger] = {
