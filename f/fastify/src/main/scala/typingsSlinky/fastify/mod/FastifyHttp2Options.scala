...
@js.native
trait FastifyHttp2Options[Server /* <: Http2Server */, Logger /* <: FastifyLoggerInstance */] extends js.Object {
...
object FastifyHttp2Options {
  ...
  @scala.inline
  implicit class FastifyHttp2OptionsOps[Self <: FastifyHttp2Options[_, _], Server /* <: Http2Server */, Logger /* <: FastifyLoggerInstance */] (val x: Self with (FastifyHttp2Options[Server, Logger])) extends AnyVal {
    ...
    @scala.inline
    def setHttp2SessionTimeout(value: Double): Self = this.set("http2SessionTimeout", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHttp2SessionTimeout: Self = this.set("http2SessionTimeout", js.undefined)
