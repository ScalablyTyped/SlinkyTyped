...
object mod {
  ...
  object EnrichedTask {
    ...
    implicit class EnrichedTaskMutableBuilder[Self <: EnrichedTask] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set_end(value: js.Date): Self = StObject.set(x, "_end", value.asInstanceOf[js.Any])
      
      @scala.inline
      def set_index(value: Double): Self = StObject.set(x, "_index", value.asInstanceOf[js.Any])
      
      @scala.inline
      def set_start(value: js.Date): Self = StObject.set(x, "_start", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOn_date_change(value: (/* task */ EnrichedTask, /* start */ js.Date, /* end */ js.Date) => Unit): Self = StObject.set(x, "on_date_change", js.Any.fromFunction3(value))
