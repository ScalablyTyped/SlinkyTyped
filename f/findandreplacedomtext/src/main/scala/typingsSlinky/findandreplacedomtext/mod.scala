...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFind(value: js.RegExp | String): Self = StObject.set(x, "find", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFindRegExp(value: js.RegExp): Self = StObject.set(x, "find", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWrapHTMLElement(value: HTMLElement): Self = StObject.set(x, "wrap", value.asInstanceOf[js.Any])
