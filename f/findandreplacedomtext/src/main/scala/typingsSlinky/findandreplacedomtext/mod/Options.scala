package typingsSlinky.findandreplacedomtext.mod

import org.scalajs.dom.raw.HTMLElement
import org.scalajs.dom.raw.Text
import typingsSlinky.findandreplacedomtext.findandreplacedomtextStrings.first
import typingsSlinky.findandreplacedomtext.findandreplacedomtextStrings.prose
import typingsSlinky.findandreplacedomtext.findandreplacedomtextStrings.retain
...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var find: js.RegExp | String = js.native
...
object Options {
  ...
  @scala.inline
  def apply(find: js.RegExp | String): Options = {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFindRegExp(value: js.RegExp): Self = this.set("find", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFind(value: js.RegExp | String): Self = this.set("find", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWrapHTMLElement(value: HTMLElement): Self = this.set("wrap", value.asInstanceOf[js.Any])
