...
object StatsOpts {
  ...
  implicit class StatsOptsOps[Self <: StatsOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBucket_extension_interval(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bucket_extension_interval")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBucket_extension_interval: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bucket_extension_interval")(js.undefined)
        ret
    }
    @scala.inline
    def withBucket_precision(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bucket_precision")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBucket_precision: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bucket_precision")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStore_data(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("store_data")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStore_data: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("store_data")(js.undefined)
        ret
    }
  }
