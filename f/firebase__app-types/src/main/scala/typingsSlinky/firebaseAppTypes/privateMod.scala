...
object privateMod {
  ...
  type AppHook = js.Function2[/* event */ String, /* app */ typingsSlinky.firebaseAppTypes.mod.FirebaseApp, Unit]
  ...
  object FirebaseService {
    ...
    implicit class FirebaseServiceMutableBuilder[Self <: FirebaseService] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApp(value: typingsSlinky.firebaseAppTypes.mod.FirebaseApp): Self = StObject.set(x, "app", value.asInstanceOf[js.Any])
  ...
  type FirebaseServiceNamespace[T /* <: FirebaseService */] = js.Function1[/* app */ js.UndefOr[typingsSlinky.firebaseAppTypes.mod.FirebaseApp], T]
