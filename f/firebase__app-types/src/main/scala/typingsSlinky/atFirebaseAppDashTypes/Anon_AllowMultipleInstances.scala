...
import typingsSlinky.atFirebaseAppDashTypes.privateMod.AppHook
import typingsSlinky.atFirebaseAppDashTypes.privateMod.FirebaseService
import typingsSlinky.atFirebaseAppDashTypes.privateMod.FirebaseServiceFactory
...
trait Anon_AllowMultipleInstances extends js.Object {
  ...
  {readonly [ K in / * import warning: RewrittenClass.unapply cls $anonfun was tparam ErrorCode * / any ]:? @firebase/util.@firebase/util/dist/src/errors.ErrorData}
    */ typingsSlinky.atFirebaseAppDashTypes.atFirebaseAppDashTypesStrings.Anon_AllowMultipleInstances with js.Any
    ]
  ] = js.native
  /**
    * Service factories for each registered service.
    */
  var factories: StringDictionary[FirebaseServiceFactory] = js.native
  /**
  ...
  /**
    ...
    */
  def registerService(name: String, createService: FirebaseServiceFactory): FirebaseServiceNamespace[FirebaseService] = js.native
  def registerService(name: String, createService: FirebaseServiceFactory, serviceProperties: StringDictionary[js.Any]): FirebaseServiceNamespace[FirebaseService] = js.native
  def registerService(
    name: String,
    createService: FirebaseServiceFactory,
    serviceProperties: StringDictionary[js.Any],
    appHook: AppHook
  ): FirebaseServiceNamespace[FirebaseService] = js.native
  def registerService(
    name: String,
    createService: FirebaseServiceFactory,
    serviceProperties: StringDictionary[js.Any],
