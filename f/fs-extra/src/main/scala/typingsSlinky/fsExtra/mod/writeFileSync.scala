...
object writeFileSync extends js.Object {
  ...
  def apply(path: Double, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): Unit = js.native
  /**
  ...
  def apply(path: PathLike, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): Unit = js.native
}
