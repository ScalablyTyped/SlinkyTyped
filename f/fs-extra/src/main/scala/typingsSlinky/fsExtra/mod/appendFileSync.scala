...
object appendFileSync extends js.Object {
  ...
  def apply(file: Double, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): Unit = js.native
  /**
  ...
  def apply(file: PathLike, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): Unit = js.native
}
