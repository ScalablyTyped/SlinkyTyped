...
object appendFile extends js.Object {
  ...
  def __promisify__(file: Double, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
  /**
    * Asynchronously append data to a file, creating the file if it does not exist.
    * @param file A path to a file. If a URL is provided, it must use the `file:` protocol.
    * URL support is _experimental_.
  ...
  def __promisify__(file: PathLike, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
}
