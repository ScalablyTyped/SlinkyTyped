...
object writeFile extends js.Object {
  ...
  def apply(file: String, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
  def apply(
    file: String,
    data: js.Any,
  ...
  def apply(file: Double, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
  ...
  def apply(file: Buffer, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
  def apply(
    file: Buffer,
    data: js.Any,
    options: typingsSlinky.node.fsMod.WriteFileOptions,
  ...
  def __promisify__(path: Double, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
  /**
    * Asynchronously writes data to a file, replacing the file if it already exists.
    * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    * URL support is _experimental_.
  ...
  def __promisify__(path: PathLike, data: js.Any, options: typingsSlinky.node.fsMod.WriteFileOptions): js.Promise[Unit] = js.native
}
