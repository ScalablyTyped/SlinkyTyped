package typingsSlinky.flux.libFluxStoreMod
...
trait FluxStore[TPayload] extends js.Object {
  ...
  var __dispatcher: typingsSlinky.flux.libDispatcherMod.^[TPayload]
  ...
  /**
    ...
    */
  def getDispatcher(): typingsSlinky.flux.libDispatcherMod.^[TPayload]
  /**
...
object FluxStore {
  ...
  def apply[TPayload](
    ...
    __changed: Boolean,
    __className: String,
    __dispatcher: typingsSlinky.flux.libDispatcherMod.^[TPayload],
    __emitChange: () => Unit,
    ...
    getDispatcher: () => typingsSlinky.flux.libDispatcherMod.^[TPayload],
    hasChanged: () => Boolean
  ): FluxStore[TPayload] = {
