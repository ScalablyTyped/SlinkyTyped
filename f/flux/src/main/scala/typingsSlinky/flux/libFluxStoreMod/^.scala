...
abstract class ^[TPayload] protected () extends FluxStore[TPayload] {
  ...
  /* CompleteClass */
  override var __dispatcher: typingsSlinky.flux.libDispatcherMod.^[TPayload] = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDispatcher(): typingsSlinky.flux.libDispatcherMod.^[TPayload] = js.native
  /**
