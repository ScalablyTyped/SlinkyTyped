...
abstract class ^[TPayload] protected () extends FluxStore[TPayload] {
  ...
  /* CompleteClass */
  override var __dispatcher: typingsSlinky.flux.dispatcherMod.^[TPayload] = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDispatcher(): typingsSlinky.flux.dispatcherMod.^[TPayload] = js.native
  /**
