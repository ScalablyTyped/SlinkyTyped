package typingsSlinky.flux.libFluxMixinLegacyMod
...
object ^ extends js.Object {
  /**
    ...
    */
  def apply(stores: js.Array[typingsSlinky.flux.libFluxStoreMod.^[_]]): js.Any = js.native
  def apply(stores: js.Array[typingsSlinky.flux.libFluxStoreMod.^[_]], options: Options): js.Any = js.native
}
