...
object mod {
  ...
  @js.native
  def FontAwesomeIcon(props: FontAwesomeIconProps): ReactElement = js.native
  ...
  object FontAwesomeIconProps {
    ...
    implicit class FontAwesomeIconPropsMutableBuilder[Self <: FontAwesomeIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setForwardedRef(value: (js.Function1[/* e */ js.Any, Unit]) | ReactRef[_]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
