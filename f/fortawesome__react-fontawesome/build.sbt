...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fortawesome__fontawesome-common-types" % "0.2.28-51b0d4",
  "org.scalablytyped.slinky" %%% "fortawesome__fontawesome-svg-core" % "1.2.28-c778df",
