package typingsSlinky.findupSync.mod
...
trait Options
  extends typingsSlinky.micromatch.mod.Options
...
object Options {
  ...
  def apply(
    ...
    expandRange: (/* left */ String, /* right */ String, /* options */ typingsSlinky.micromatch.mod.Options) => String = null,
