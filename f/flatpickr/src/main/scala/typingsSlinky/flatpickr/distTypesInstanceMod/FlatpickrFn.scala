...
import typingsSlinky.flatpickr.Anon_Default
import typingsSlinky.flatpickr.distTypesGlobalsMod._Global_.Date
import typingsSlinky.flatpickr.distTypesLocaleMod.CustomLocale
import typingsSlinky.flatpickr.distTypesOptionsMod.DateOption
...
trait FlatpickrFn extends js.Object {
  ...
  var l10ns: typingsSlinky.flatpickr.flatpickrStrings.FlatpickrFn with js.Any with Anon_Default = js.native
