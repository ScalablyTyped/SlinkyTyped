...
object anon {
  ...
  object PartialParsedOptions {
    ...
    implicit class PartialParsedOptionsMutableBuilder[Self <: PartialParsedOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrorHandler(value: /* err */ js.Error => Unit): Self = StObject.set(x, "errorHandler", js.Any.fromFunction1(value))
  ...
  trait kinkeyofOptionsOptionsk extends StObject {
    ...
    var positionElement: js.UndefOr[org.scalajs.dom.raw.Element] = js.native
  ...
  object kinkeyofOptionsOptionsk {
    ...
    implicit class kinkeyofOptionsOptionskMutableBuilder[Self <: kinkeyofOptionsOptionsk] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPositionElement(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "positionElement", value.asInstanceOf[js.Any])
