...
trait Resolver extends js.Object {
  var binding: typingsSlinky.forgeDi.bindingMod.default
  var dependencies: js.Array[Dependency]
  var forge: typingsSlinky.forgeDi.forgeMod.default
  def resolve(context: typingsSlinky.forgeDi.contextMod.default, args: Arguments): js.Any
