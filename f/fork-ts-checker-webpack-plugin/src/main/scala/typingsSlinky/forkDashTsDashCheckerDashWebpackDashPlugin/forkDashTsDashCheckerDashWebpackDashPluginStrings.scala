...
import typingsSlinky.forkDashTsDashCheckerDashWebpackDashPlugin.libNormalizedMessageMod.ErrorType
import typingsSlinky.forkDashTsDashCheckerDashWebpackDashPlugin.libNormalizedMessageMod.Severity
