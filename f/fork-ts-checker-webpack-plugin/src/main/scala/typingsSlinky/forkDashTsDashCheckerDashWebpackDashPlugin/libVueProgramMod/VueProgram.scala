...
import typingsSlinky.forkDashTsDashCheckerDashWebpackDashPlugin.libFilesRegisterMod.FilesRegister
import typingsSlinky.forkDashTsDashCheckerDashWebpackDashPlugin.libFilesWatcherMod.FilesWatcher
