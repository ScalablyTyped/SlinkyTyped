...
import typingsSlinky.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginNumbers.`1`
import typingsSlinky.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginNumbers.`2048`
