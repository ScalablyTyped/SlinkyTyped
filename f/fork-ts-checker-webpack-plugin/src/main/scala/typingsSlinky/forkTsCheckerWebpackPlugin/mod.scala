...
import typingsSlinky.forkTsCheckerWebpackPlugin.anon.Canceled
import typingsSlinky.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginMod.ForkTsCheckerWebpackPlugin
