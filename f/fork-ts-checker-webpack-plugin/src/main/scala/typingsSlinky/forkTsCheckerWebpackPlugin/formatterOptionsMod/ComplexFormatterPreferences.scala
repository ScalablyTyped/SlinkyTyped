package typingsSlinky.forkTsCheckerWebpackPlugin.formatterOptionsMod
...
object ComplexFormatterPreferences {
  @scala.inline
  def apply[/* <: typingsSlinky.forkTsCheckerWebpackPlugin.formatterFactoryMod.FormatterType */ T](`type`: T): ComplexFormatterPreferences[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComplexFormatterPreferences[T]]
  }
  @scala.inline
  implicit class ComplexFormatterPreferencesOps[Self <: ComplexFormatterPreferences[_], /* <: typingsSlinky.forkTsCheckerWebpackPlugin.formatterFactoryMod.FormatterType */ T] (val x: Self with ComplexFormatterPreferences[T]) extends AnyVal {
    @scala.inline
