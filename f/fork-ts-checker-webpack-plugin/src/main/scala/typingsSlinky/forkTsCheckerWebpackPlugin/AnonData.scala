...
import typingsSlinky.forkTsCheckerWebpackPlugin.filesRegisterMod.DataShape
...
trait AnonData extends js.Object {
  var data: DataShape = js.native
  var mtime: js.UndefOr[Double] = js.native
}

object AnonData {
  @scala.inline
  def apply(data: DataShape): AnonData = {
  ...
  implicit class AnonDataOps[Self <: AnonData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: DataShape): Self = {
