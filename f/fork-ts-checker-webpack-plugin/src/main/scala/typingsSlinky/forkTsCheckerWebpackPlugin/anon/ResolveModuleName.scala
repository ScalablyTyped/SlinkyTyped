...
@js.native
trait ResolveModuleName extends js.Object {
  @JSName("resolveModuleName")
  var resolveModuleName_Original: typingsSlinky.forkTsCheckerWebpackPlugin.resolutionMod.ResolveModuleName = js.native
