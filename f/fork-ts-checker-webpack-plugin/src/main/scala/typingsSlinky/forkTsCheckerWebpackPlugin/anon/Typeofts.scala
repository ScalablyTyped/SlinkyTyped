...
import typingsSlinky.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.quit
...
trait Typeofts extends js.Object {
  ...
  def parseJsonConfigFileContent(
    ...
    resolutionStack: js.UndefOr[js.Array[typingsSlinky.typescript.mod.Path]],
    extraFileExtensions: js.UndefOr[js.Array[FileExtensionInfo]],
