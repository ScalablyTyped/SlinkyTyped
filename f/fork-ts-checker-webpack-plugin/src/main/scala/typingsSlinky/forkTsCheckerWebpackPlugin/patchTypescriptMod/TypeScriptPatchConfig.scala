...
trait TypeScriptPatchConfig extends js.Object {
  /**
    ...
    */
  var skipGetSyntacticDiagnostics: Boolean = js.native
}
...
object TypeScriptPatchConfig {
  ...
  @scala.inline
  implicit class TypeScriptPatchConfigOps[Self <: TypeScriptPatchConfig] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withSkipGetSyntacticDiagnostics(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("skipGetSyntacticDiagnostics")(value.asInstanceOf[js.Any])
        ret
    }
  }
