...
object RpcMessage {
  @scala.inline
  def apply[/* <: java.lang.String */ TType, /* <: typingsSlinky.forkTsCheckerWebpackPlugin.rpcProcedureMod.RpcProcedure[_, _] */ TProcedure, TPayload](id: Double, payload: TPayload, procedure: TProcedure, rpc: `true`, `type`: TType): RpcMessage[TType, TProcedure, TPayload] = {
  ...
  @scala.inline
  implicit class RpcMessageOps[Self <: RpcMessage[_, _, _], /* <: java.lang.String */ TType, /* <: typingsSlinky.forkTsCheckerWebpackPlugin.rpcProcedureMod.RpcProcedure[_, _] */ TProcedure, TPayload] (val x: Self with (RpcMessage[TType, TProcedure, TPayload])) extends AnyVal {
    @scala.inline
