...
import typingsSlinky.forkTsCheckerWebpackPlugin.hooksMod.ForkTsCheckerHooks
import typingsSlinky.forkTsCheckerWebpackPlugin.normalizedMessageMod.ErrorType
import typingsSlinky.forkTsCheckerWebpackPlugin.normalizedMessageMod.Severity
