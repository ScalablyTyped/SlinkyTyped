...
name := "falcor-express"
version := "0.1.2-dt-20200226Z-257bfb"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "falcor" % "2.0-dt-20200225Z-97250f",
  "org.scalablytyped.slinky" %%% "falcor-http-datasource" % "0.1.3-dt-20200226Z-f955ba",
  "org.scalablytyped.slinky" %%% "falcor-json-graph" % "1.1.7-dt-20200226Z-f5d293",
