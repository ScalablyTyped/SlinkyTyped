...
class FunctionCls protected () extends Function {
  ...
  /* CompleteClass */
  override def get(buffer: typingsSlinky.node.Buffer, offset: Double): js.Any = js.native
  /** To invoke when `ref.set` is invoked on a buffer of this type. */
  /* CompleteClass */
  override def set(buffer: typingsSlinky.node.Buffer, offset: Double, value: js.Any): Unit = js.native
}
