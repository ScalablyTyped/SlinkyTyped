package typingsSlinky.focusDashTrapDashReact.components
...
import typingsSlinky.focusDashTrap.focusDashTrapMod.Options
import typingsSlinky.focusDashTrapDashReact.focusDashTrapDashReactMod.^
...
object FocusDashTrapDashReact
  ...
  typingsSlinky.focusDashTrapDashReact.focusDashTrapDashReactMod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = typingsSlinky.focusDashTrapDashReact.focusDashTrapDashReactMod.Props
}
