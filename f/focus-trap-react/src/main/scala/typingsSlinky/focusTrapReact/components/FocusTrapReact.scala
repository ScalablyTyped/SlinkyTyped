package typingsSlinky.focusTrapReact.components
...
import typingsSlinky.focusTrapReact.mod.^
...
object FocusTrapReact
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, ^] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.focusTrapReact.mod.^](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = typingsSlinky.focusTrapReact.mod.Props
}
