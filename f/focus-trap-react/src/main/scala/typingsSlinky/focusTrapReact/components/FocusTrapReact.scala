...
import typingsSlinky.focusTrapReact.mod.Props
...
object FocusTrapReact {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def focusTrapOptions(value: Options): this.type = set("focusTrapOptions", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: FocusTrapReact.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
