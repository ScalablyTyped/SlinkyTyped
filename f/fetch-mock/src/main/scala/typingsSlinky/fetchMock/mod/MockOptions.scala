...
object MockOptions {
  ...
  implicit class MockOptionsOps[Self <: MockOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMatcherRegExp(value: js.RegExp): Self = this.set("matcher", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setResponseResponse(value: Response): Self = this.set("response", value.asInstanceOf[js.Any])
    @scala.inline
