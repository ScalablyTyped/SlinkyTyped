...
object siblingMod {
  ...
  object FocusNextOptions {
    ...
    implicit class FocusNextOptionsMutableBuilder[Self <: FocusNextOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScopeHTMLDocument(value: HTMLDocument): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScopeHTMLElement(value: HTMLElement): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
