package typingsSlinky.focusLock.siblingMod
...
object FocusNextOptions {
  ...
  implicit class FocusNextOptionsOps[Self <: FocusNextOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScopeHTMLElement(value: HTMLElement): Self = this.set("scope", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScopeHTMLDocument(value: HTMLDocument): Self = this.set("scope", value.asInstanceOf[js.Any])
