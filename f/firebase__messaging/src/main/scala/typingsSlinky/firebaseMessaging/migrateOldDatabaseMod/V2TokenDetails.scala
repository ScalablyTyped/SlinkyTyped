...
object V2TokenDetails {
  ...
  implicit class V2TokenDetailsOps[Self <: V2TokenDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVapidKeyUint8Array(value: js.typedarray.Uint8Array): Self = this.set("vapidKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVapidKey(value: String | js.typedarray.Uint8Array): Self = this.set("vapidKey", value.asInstanceOf[js.Any])
