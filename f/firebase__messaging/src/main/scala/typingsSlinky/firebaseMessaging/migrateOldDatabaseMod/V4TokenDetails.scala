...
object V4TokenDetails {
  ...
  implicit class V4TokenDetailsOps[Self <: V4TokenDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("auth", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setP256dhArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("p256dh", value.asInstanceOf[js.Any])
