...
object migrateOldDatabaseMod {
  ...
  object V2TokenDetails {
    ...
    implicit class V2TokenDetailsMutableBuilder[Self <: V2TokenDetails] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setVapidKey(value: String | js.typedarray.Uint8Array): Self = StObject.set(x, "vapidKey", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVapidKeyUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "vapidKey", value.asInstanceOf[js.Any])
    }
  }
  ...
  object V3TokenDetails {
    ...
    implicit class V3TokenDetailsMutableBuilder[Self <: V3TokenDetails] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuth(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "auth", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setP256dh(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "p256dh", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSwScope(value: String): Self = StObject.set(x, "swScope", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVapidKey(value: js.typedarray.Uint8Array): Self = StObject.set(x, "vapidKey", value.asInstanceOf[js.Any])
    }
  }
  ...
  object V4TokenDetails {
    ...
    implicit class V4TokenDetailsMutableBuilder[Self <: V4TokenDetails] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuthArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "auth", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setP256dhArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "p256dh", value.asInstanceOf[js.Any])
