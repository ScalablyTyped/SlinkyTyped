...
object internalMessagePayloadMod {
  ...
  object MessageType extends StObject {
    ...
    /* "notification-clicked" */ val NOTIFICATION_CLICKED: typingsSlinky.firebaseMessaging.internalMessagePayloadMod.MessageType.NOTIFICATION_CLICKED with String = js.native
    
    @js.native
    sealed trait PUSH_RECEIVED extends MessageType
    /* "push-received" */ val PUSH_RECEIVED: typingsSlinky.firebaseMessaging.internalMessagePayloadMod.MessageType.PUSH_RECEIVED with String = js.native
  }
