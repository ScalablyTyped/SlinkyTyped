package typingsSlinky.firebaseMessaging.internalDependenciesMod
...
object FirebaseInternalDependencies {
  ...
  implicit class FirebaseInternalDependenciesOps[Self <: FirebaseInternalDependencies] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnalyticsProvider(
      value: Provider[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FirebaseAnalyticsInternalName */ _
        ]
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("analyticsProvider")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withInstallations(value: FirebaseInstallations): Self = {
        val ret = this.duplicate
