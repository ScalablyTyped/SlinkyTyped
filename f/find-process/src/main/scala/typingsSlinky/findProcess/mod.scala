...
object mod extends js.Object {
  ...
  def apply(`type`: name, value: js.RegExp): js.Promise[js.Array[AnonCmd]] = js.native
  def apply(`type`: name, value: js.RegExp, strict: Boolean): js.Promise[js.Array[AnonCmd]] = js.native
  ...
  def apply(`type`: pid, value: js.RegExp): js.Promise[js.Array[AnonCmd]] = js.native
  def apply(`type`: pid, value: js.RegExp, strict: Boolean): js.Promise[js.Array[AnonCmd]] = js.native
  ...
  def apply(`type`: port, value: js.RegExp): js.Promise[js.Array[AnonCmd]] = js.native
  def apply(`type`: port, value: js.RegExp, strict: Boolean): js.Promise[js.Array[AnonCmd]] = js.native
}
