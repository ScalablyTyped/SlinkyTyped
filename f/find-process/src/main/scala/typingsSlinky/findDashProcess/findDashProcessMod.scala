...
import typingsSlinky.findDashProcess.findDashProcessStrings.name
import typingsSlinky.findDashProcess.findDashProcessStrings.pid
import typingsSlinky.findDashProcess.findDashProcessStrings.port
