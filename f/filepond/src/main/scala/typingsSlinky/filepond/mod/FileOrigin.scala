...
object FileOrigin extends StObject {
  ...
  /* 1 */ val INPUT: typingsSlinky.filepond.mod.FileOrigin.INPUT with Double = js.native
  
  @js.native
  sealed trait LIMBO extends FileOrigin
  /* 2 */ val LIMBO: typingsSlinky.filepond.mod.FileOrigin.LIMBO with Double = js.native
  
  @js.native
  sealed trait LOCAL extends FileOrigin
  /* 3 */ val LOCAL: typingsSlinky.filepond.mod.FileOrigin.LOCAL with Double = js.native
}
