...
object SERIAL_PIN_TYPE {
  ...
  @scala.inline
  def RES_RX0: `0x00` = 0x00.asInstanceOf[`0x00`]
  
  @scala.inline
  def RES_RX1: `0x02` = 0x02.asInstanceOf[`0x02`]
  
  @scala.inline
  def RES_RX2: `0x04` = 0x04.asInstanceOf[`0x04`]
  
  @scala.inline
  def RES_RX3: `0x06` = 0x06.asInstanceOf[`0x06`]
  
  @scala.inline
  def RES_TX0: `0x01` = 0x01.asInstanceOf[`0x01`]
  
  @scala.inline
  def RES_TX1: `0x03` = 0x03.asInstanceOf[`0x03`]
  
  @scala.inline
  def RES_TX2: `0x05` = 0x05.asInstanceOf[`0x05`]
  
  @scala.inline
  def RES_TX3: `0x07` = 0x07.asInstanceOf[`0x07`]
}
