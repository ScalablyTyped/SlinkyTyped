...
import typingsSlinky.firmata.Anon_Address
import typingsSlinky.firmata.Anon_Baud
import typingsSlinky.firmata.Anon_Delay
...
trait Board extends EventEmitter {
  ...
  var transport: typingsSlinky.serialport.serialportMod.^ = js.native
