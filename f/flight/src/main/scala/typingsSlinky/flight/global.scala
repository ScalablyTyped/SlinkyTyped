...
object global {
  ...
  @scala.inline
  def DEBUG_=(x: DebugStatic): Unit = js.Dynamic.global.updateDynamic("DEBUG")(x.asInstanceOf[js.Any])
  
  @JSGlobal("flight")
  @js.native
  def flight: FlightStatic = js.native
  @scala.inline
  def flight_=(x: FlightStatic): Unit = js.Dynamic.global.updateDynamic("flight")(x.asInstanceOf[js.Any])
}
