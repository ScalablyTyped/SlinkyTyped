...
class Class_XmlNode () extends Class__object {
  /**
  	 ...
  	 * @type XmlNodeList
  	 */
  var childNodes: Class_XmlNodeList = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  	 ...
  	 * @type XmlNode
  	 */
  var firstChild: Class_XmlNode = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  	 ...
  	 * @type XmlNode
  	 */
  var lastChild: Class_XmlNode = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  	 ...
  	 * @type XmlNode
  	 */
  var nextSibling: Class_XmlNode = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  ...
  /**
  	 ...
  	 * @type XmlDocument
  	 */
  var ownerDocument: Class_XmlDocument = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  	 ...
  	 * @type XmlNode
  	 */
  var parentNode: Class_XmlNode = js.native
  /**
  	 * class prop 
  	 *
  	 * 
  	 ...
  	 * @type XmlNode
  	 */
  var previousSibling: Class_XmlNode = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def appendChild(newChild: Class_XmlNode): Class_XmlNode = js.native
  /**
  	 * 
  	 * @brief 创建指定的节点的精确拷贝
  	 * 
  ...
  def cloneNode(deep: Boolean): Class_XmlNode = js.native
  /**
  	 * 
  	 * @brief 查询是否存在子节点
  ...
  /**
  	 ...
  	 * 
  	 */
  def insertAfter(newChild: Class_XmlNode, refChild: Class_XmlNode): Class_XmlNode = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def insertBefore(newChild: Class_XmlNode, refChild: Class_XmlNode): Class_XmlNode = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def removeChild(oldChild: Class_XmlNode): Class_XmlNode = js.native
  /**
  	 * 
  	 * @brief 将某个子节点替换为另一个
  	 * 
  	 ...
  	 * 
  	 */
  def replaceChild(newChild: Class_XmlNode, oldChild: Class_XmlNode): Class_XmlNode = js.native
}
