...
class Class_DgramSocket () extends Class_EventEmitter {
  ...
  /**
  	 ...
  	 * @async
  	 */
  def send(msg: Class_Buffer, offset: Double, length: Double, port: Double): Double = js.native
  def send(msg: Class_Buffer, offset: Double, length: Double, port: Double, address: String): Double = js.native
  /**
  	 * 
  	 * @brief 在 socket 上发送一个数据包
  	 * @param msg 指定发送的数据
  	 ...
  	 * @async
  	 */
  def send(msg: Class_Buffer, port: Double): Double = js.native
  def send(msg: Class_Buffer, port: Double, address: String): Double = js.native
  /**
  	 * 
