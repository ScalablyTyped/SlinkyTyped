...
class Class_XmlDocument () extends Class_XmlNode {
  ...
  /**
  	 ...
  	 * 
  	 */
  def createCDATASection(data: String): Class_XmlCDATASection = js.native
  /**
  	 * 
  	 * @brief 创建注释节点
  	 ...
  	 * 
  	 */
  def createComment(data: String): Class_XmlComment = js.native
  /**
  	 * 
  	 * @brief 创建元素节点
  	 ...
  	 * 
  	 */
  def createElement(tagName: String): Class_XmlElement = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def createElementNS(namespaceURI: String, qualifiedName: String): Class_XmlElement = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def createProcessingInstruction(target: String, data: String): Class_XmlProcessingInstruction = js.native
  /**
  	 * 
  	 * @brief 创建文本节点
  	 * @param data 指定此节点的文本
  	 ...
  	 * 
  	 */
  def createTextNode(data: String): Class_XmlText = js.native
  /**
  	 * 
  ...
  /**
  	 ...
  	 * 
  	 */
  def load(source: Class_Buffer): Unit = js.native
}
