...
class Class_StringDecoder () extends Class__object {
  ...
  /**
  	 ...
  	 * 
  	 */
  def end(buf: Class_Buffer): String = js.native
  /**
  	 * 
  	 * @brief 内部使用。.
  	 ...
  	 * 
  	 */
  def fillLast(buf: Class_Buffer): String = js.native
  /**
  	 * 
  	 * @brief 内部使用。.
  	 ...
  	 * 
  	 */
  def text(buf: Class_Buffer, offset: Double): String = js.native
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def write(buf: Class_Buffer): String = js.native
}
