...
object global extends js.Object {
  ...
  val Buffer: Instantiable0[typingsSlinky.fibjs.globalMod.Buffer] = js.native
  
  /** const setImmediate: Timer; */
  /** const clearImmediate: null; */
  val GC: js.Function0[Unit] = js.native
  
  val Int64: Instantiable0[typingsSlinky.fibjs.globalMod.Int64] = js.native
