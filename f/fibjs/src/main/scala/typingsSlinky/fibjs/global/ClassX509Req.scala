...
/**
  ...
  */
class ClassX509Req ()
  extends typingsSlinky.fibjs.ClassX509Req {
  /**
    * 
    ...
    * 
    */
  def this(subject: String, key: typingsSlinky.fibjs.ClassPKey) = this()
  def this(subject: String, key: typingsSlinky.fibjs.ClassPKey, hash: Double) = this()
}
