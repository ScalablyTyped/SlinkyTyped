...
class ClassHttpServer protected ()
  extends typingsSlinky.fibjs.ClassHttpServer {
  /**
    * 
    ...
    * 
    */
  def this(port: Double, hdlr: typingsSlinky.fibjs.ClassHandler) = this()
  /**
    * 
    ...
    * 
    */
  def this(addr: String, port: Double, hdlr: typingsSlinky.fibjs.ClassHandler) = this()
}
