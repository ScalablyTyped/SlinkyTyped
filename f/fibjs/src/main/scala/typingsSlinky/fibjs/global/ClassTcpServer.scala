...
class ClassTcpServer protected ()
  extends typingsSlinky.fibjs.ClassTcpServer {
  /**
    * 
    ...
    * 
    */
  def this(port: Double, listener: typingsSlinky.fibjs.ClassHandler) = this()
  /**
    * 
    ...
    * 
    */
  def this(addr: String, port: Double, listener: typingsSlinky.fibjs.ClassHandler) = this()
}
