...
class ClassSslServer protected ()
  extends typingsSlinky.fibjs.ClassSslServer {
  /**
    * 
    ...
    * 
    */
  def this(certs: js.Array[_], port: Double, listener: typingsSlinky.fibjs.ClassHandler) = this()
  /**
    * 
    ...
    * 
    */
  def this(certs: js.Array[_], addr: String, port: Double, listener: typingsSlinky.fibjs.ClassHandler) = this()
  /**
    * 
    * @brief SslServer 构造函数，在所有本机地址侦听
    ...
    */
  def this(
    crt: typingsSlinky.fibjs.ClassX509Cert,
    key: typingsSlinky.fibjs.ClassPKey,
    port: Double,
    listener: typingsSlinky.fibjs.ClassHandler
  ) = this()
  /**
    * 
    * @brief SslServer 构造函数
