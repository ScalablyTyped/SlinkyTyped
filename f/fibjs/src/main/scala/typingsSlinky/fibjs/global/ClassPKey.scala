...
/**
  ...
  */
class ClassPKey ()
  extends typingsSlinky.fibjs.ClassPKey {
  /**
    * 
    ...
    * 
    */
  def this(DerKey: typingsSlinky.fibjs.ClassBuffer) = this()
  /**
    * 
  ...
  def this(DerKey: typingsSlinky.fibjs.ClassBuffer, password: String) = this()
