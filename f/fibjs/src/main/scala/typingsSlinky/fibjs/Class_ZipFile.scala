...
class Class_ZipFile () extends Class__object {
  ...
  /**
  	 ...
  	 * @async
  	 */
  def extract(member: String, strm: Class_SeekableStream): Unit = js.native
  def extract(member: String, strm: Class_SeekableStream, password: String): Unit = js.native
  /**
  	 * 
  	 * @brief 解压所有文件到指定路径
  	 * @param path 指定要解压到的路径
  ...
  /**
  	 ...
  	 * @async
  	 */
  def read(member: String): Class_Buffer = js.native
  def read(member: String, password: String): Class_Buffer = js.native
  /**
  	 * 
  	 * @brief 解压所有文件
  	 * @param password 解压密码, 默认没有密码
  ...
  /**
  	 ...
  	 * @async
  	 */
  def write(data: Class_Buffer, inZipName: String): Unit = js.native
  def write(data: Class_Buffer, inZipName: String, password: String): Unit = js.native
  /**
  	 * 
  	 * @brief 写入指定文件到压缩文件
  ...
  /**
  	 ...
  	 * @async
  	 */
  def write(strm: Class_SeekableStream, inZipName: String): Unit = js.native
  def write(strm: Class_SeekableStream, inZipName: String, password: String): Unit = js.native
}
