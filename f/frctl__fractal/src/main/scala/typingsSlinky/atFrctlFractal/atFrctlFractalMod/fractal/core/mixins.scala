...
import typingsSlinky.atFrctlFractal.atFrctlFractalMod.fractal.core.mixins.Entity
...
object mixins extends js.Object {
  ...
  abstract class Entity () extends js.Object {
    ...
    val source: EntitySource[typingsSlinky.atFrctlFractal.atFrctlFractalMod.fractal.core.entities.Entity, _] = js.native
