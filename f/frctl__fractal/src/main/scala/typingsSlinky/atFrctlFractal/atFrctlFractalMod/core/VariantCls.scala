...
class VariantCls protected ()
  extends typingsSlinky.atFrctlFractal.atFrctlFractalMod.fractal.api.variants.Variant {
  def this(
    config: js.Object,
    view: js.Any,
    resources: AssetCollection,
    parent: typingsSlinky.atFrctlFractal.atFrctlFractalMod.fractal.api.components.Component
  ) = this()
}
