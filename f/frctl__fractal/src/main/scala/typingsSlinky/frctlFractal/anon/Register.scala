...
object Register {
  @scala.inline
  def apply[/* <: typingsSlinky.frctlFractal.mod.fractal.core.entities.Entity */ T, TEngine](register: (EntitySource[T, _], js.Any) => Adapter[TEngine]): Register[T, TEngine] = {
    val __obj = js.Dynamic.literal(register = js.Any.fromFunction2(register))
    __obj.asInstanceOf[Register[T, TEngine]]
  }
  @scala.inline
  implicit class RegisterOps[Self <: Register[_, _], /* <: typingsSlinky.frctlFractal.mod.fractal.core.entities.Entity */ T, TEngine] (val x: Self with (Register[T, TEngine])) extends AnyVal {
    @scala.inline
