...
import typingsSlinky.frctlFractal.anon.Alias
...
import typingsSlinky.frctlFractal.mod.fractal.api.components.Component
...
object api {
  ...
  object components {
    ...
    trait ComponentSource extends EntitySource[Component, ComponentConfig] {
      ...
      def findFile(filePath: String): js.UndefOr[typingsSlinky.frctlFractal.mod.fractal.api.files.File] = js.native
  ...
  object docs {
    ...
    trait DocSource extends EntitySource[Doc, DocConfig] {
      ...
      def render(page: typingsSlinky.frctlFractal.mod.fractal.api.files.File): js.Promise[String] = js.native
      def render(
        page: typingsSlinky.frctlFractal.mod.fractal.api.files.File,
      ...
      def render(page: typingsSlinky.frctlFractal.mod.fractal.api.files.File, context: js.Any): js.Promise[String] = js.native
      def render(
        page: typingsSlinky.frctlFractal.mod.fractal.api.files.File,
        context: js.Any,
        env: js.UndefOr[scala.Nothing],
      ...
      def render(page: typingsSlinky.frctlFractal.mod.fractal.api.files.File, context: js.Any, env: js.Any): js.Promise[String] = js.native
      def render(
        page: typingsSlinky.frctlFractal.mod.fractal.api.files.File,
        context: js.Any,
        env: js.Any,
      ...
      def toc(page: typingsSlinky.frctlFractal.mod.fractal.api.files.File): js.Promise[String] = js.native
      def toc(page: typingsSlinky.frctlFractal.mod.fractal.api.files.File, maxDepth: Double): js.Promise[String] = js.native
    }
  }
  ...
  object files {
    ...
    object File {
      ...
      def apply(
      ...
      ): typingsSlinky.frctlFractal.mod.fractal.api.files.File = {
        ...
        __obj.asInstanceOf[typingsSlinky.frctlFractal.mod.fractal.api.files.File]
      }
      
      @scala.inline
      implicit class FileMutableBuilder[Self <: typingsSlinky.frctlFractal.mod.fractal.api.files.File] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setToVinyl(value: () => typingsSlinky.vinyl.mod.File): Self = StObject.set(x, "toVinyl", js.Any.fromFunction0(value))
      }
    }
    
    @js.native
    trait FileCollection
      extends Collection[typingsSlinky.frctlFractal.mod.fractal.api.files.File] {
      ...
      def matchItems(items: Collection[typingsSlinky.frctlFractal.mod.fractal.api.files.File], test: String): typingsSlinky.frctlFractal.mod.fractal.api.files.File = js.native
      def matchItems(
        items: Collection[typingsSlinky.frctlFractal.mod.fractal.api.files.File],
        test: js.Array[String | js.RegExp]
      ): typingsSlinky.frctlFractal.mod.fractal.api.files.File = js.native
      def matchItems(items: Collection[typingsSlinky.frctlFractal.mod.fractal.api.files.File], test: js.RegExp): typingsSlinky.frctlFractal.mod.fractal.api.files.File = js.native
