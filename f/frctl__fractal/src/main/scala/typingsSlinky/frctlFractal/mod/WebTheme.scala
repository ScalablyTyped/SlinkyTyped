...
import typingsSlinky.frctlFractal.anon.`0`
...
import typingsSlinky.frctlFractal.frctlFractalStrings.lang
import typingsSlinky.frctlFractal.frctlFractalStrings.nav
import typingsSlinky.frctlFractal.frctlFractalStrings.panels
import typingsSlinky.frctlFractal.frctlFractalStrings.rtl
import typingsSlinky.frctlFractal.frctlFractalStrings.scripts
import typingsSlinky.frctlFractal.frctlFractalStrings.skin
import typingsSlinky.frctlFractal.frctlFractalStrings.static
import typingsSlinky.frctlFractal.frctlFractalStrings.staticDotmount
import typingsSlinky.frctlFractal.frctlFractalStrings.styles
import typingsSlinky.frctlFractal.frctlFractalStrings.version
...
- typingsSlinky.frctlFractal.mod.fractal.core.mixins.Configurable because Inheritance from two classes. Inlined config, config, set, set, get, get */ @JSImport("@frctl/fractal", "WebTheme")
@js.native
