...
object core {
  ...
  object mixins {
    ...
    - typingsSlinky.frctlFractal.mod.fractal.core.mixins.Configurable because Inheritance from two classes. Inlined config, config, set, set, get, get */ @JSImport("@frctl/fractal", "fractal.core.mixins.ConfigurableEmitter")
    @js.native
