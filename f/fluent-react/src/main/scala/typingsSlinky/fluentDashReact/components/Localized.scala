...
object Localized
  ...
  def apply(attrs: js.Object = null, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, typingsSlinky.fluentDashReact.fluentDashReactMod.Localized] = {
