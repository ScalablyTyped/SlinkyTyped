...
object mod {
  ...
  @js.native
  def withLocalization(component: ComponentClass[Matching[InjectedProps, GetProps[_]], js.Object]): ReactComponentClass[
    Omit[
  ...
  @JSImport("fluent-react", "withLocalization")
  @js.native
  def withLocalization(component: FunctionComponent[Matching[InjectedProps, GetProps[_]]]): ReactComponentClass[
    Omit[
      GetProps[ReactComponentClass[Matching[InjectedProps, GetProps[_]]]], 
