...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.fastMemoize.mod.Func */ F](): Options[F] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[F]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_], /* <: typingsSlinky.fastMemoize.mod.Func */ F] (val x: Self with Options[F]) extends AnyVal {
    @scala.inline
