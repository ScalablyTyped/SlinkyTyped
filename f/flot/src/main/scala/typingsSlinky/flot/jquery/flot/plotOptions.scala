...
trait plotOptions extends js.Object {
  ...
  var hooks: js.UndefOr[typingsSlinky.flot.jquery.flot.hooks] = js.undefined
  var interaction: js.UndefOr[typingsSlinky.flot.jquery.flot.interaction] = js.undefined
