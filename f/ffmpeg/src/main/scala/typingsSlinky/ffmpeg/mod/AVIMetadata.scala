...
object AVIMetadata {
  ...
  implicit class AVIMetadataOps[Self <: AVIMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setICRDDate(value: js.Date): Self = this.set("ICRD", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setICRD(value: String | js.Date): Self = this.set("ICRD", value.asInstanceOf[js.Any])
