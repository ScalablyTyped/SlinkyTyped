...
object mod extends Shortcut {
  ...
  object AVIMetadata {
    ...
    implicit class AVIMetadataMutableBuilder[Self <: AVIMetadata] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setICRD(value: String | js.Date): Self = StObject.set(x, "ICRD", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setICRDDate(value: js.Date): Self = StObject.set(x, "ICRD", value.asInstanceOf[js.Any])
