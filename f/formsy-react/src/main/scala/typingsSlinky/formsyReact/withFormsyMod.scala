...
object withFormsyMod {
  ...
  @js.native
  def default[T, V](WrappedComponent: ReactComponentClass[T with PassDownProps[V]]): ReactComponentClass[
    Omit[
  ...
  object WrapperProps {
    ...
    implicit class WrapperPropsMutableBuilder[Self <: WrapperProps[_], V] (val x: Self with WrapperProps[V]) extends AnyVal {
      ...
      @scala.inline
      def setValidationErrorReactElement(value: ReactElement): Self = StObject.set(x, "validationError", value.asInstanceOf[js.Any])
