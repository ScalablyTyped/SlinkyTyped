package typingsSlinky.formsyReact.anon
...
@js.native
trait PartialFormsyProps extends js.Object {
  ...
  var mapping: js.UndefOr[Null | (js.Function1[/* model */ IModel, IModel])] = js.native
  ...
  var onChange: js.UndefOr[js.Function2[/* model */ IModel, /* isChanged */ Boolean, Unit]] = js.native
...
object PartialFormsyProps {
  ...
  @scala.inline
  def apply(): PartialFormsyProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormsyProps]
  }
  
  @scala.inline
  implicit class PartialFormsyPropsOps[Self <: PartialFormsyProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (/* model */ IModel, /* isChanged */ Boolean) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
