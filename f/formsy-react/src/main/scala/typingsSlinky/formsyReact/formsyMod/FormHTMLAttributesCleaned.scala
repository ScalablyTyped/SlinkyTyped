...
@js.native
trait FormHTMLAttributesCleaned extends js.Object {
...
object FormHTMLAttributesCleaned {
  ...
  @scala.inline
  def apply(): FormHTMLAttributesCleaned = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormHTMLAttributesCleaned]
  }
  
  @scala.inline
  implicit class FormHTMLAttributesCleanedOps[Self <: FormHTMLAttributesCleaned] (val x: Self) extends AnyVal {
