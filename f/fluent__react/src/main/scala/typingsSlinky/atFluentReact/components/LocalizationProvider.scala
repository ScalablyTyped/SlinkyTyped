...
import typingsSlinky.atFluentReact.atFluentReactMod.LocalizationProviderProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object LocalizationProvider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atFluentReact.atFluentReactMod.LocalizationProvider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atFluentReact.atFluentReactMod.LocalizationProvider] = {
