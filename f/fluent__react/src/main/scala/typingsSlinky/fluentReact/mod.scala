...
object mod {
  ...
  @js.native
  def isReactLocalization(props: js.Object, propName: String): js.Error | Null = js.native
  
  @JSImport("@fluent/react", "withLocalization")
  @js.native
  def withLocalization(component: ComponentClass[Matching[LocalizationProps, GetProps[_]], js.Object]): (ReactComponentClass[
    Omit[
  ...
  @JSImport("@fluent/react", "withLocalization")
  @js.native
  def withLocalization(component: FunctionComponent[Matching[LocalizationProps, GetProps[_]]]): (ReactComponentClass[
    Omit[
      GetProps[ReactComponentClass[Matching[LocalizationProps, GetProps[_]]]], 
  ...
  object LocalizationProviderProps {
    ...
    implicit class LocalizationProviderPropsMutableBuilder[Self <: LocalizationProviderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBundles(value: js.Iterable[FluentBundle]): Self = StObject.set(x, "bundles", value.asInstanceOf[js.Any])
  ...
  {[ P in keyof DecorationTargetProps ]: P extends keyof InjectedProps? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : InjectedProps[P] : DecorationTargetProps[P]}
    */ typingsSlinky.fluentReact.fluentReactStrings.Matching with TopLevel[js.Any]
  ...
  {[ P in std.Extract<keyof InjectedProps, keyof DecorationTargetProps> ]:? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : never}
    */ typingsSlinky.fluentReact.fluentReactStrings.Shared with TopLevel[js.Any]
}
