...
object IRestrictedDatesOptions {
  ...
  implicit class IRestrictedDatesOptionsOps[Self <: IRestrictedDatesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRestrictedDatesVarargs(value: js.Date*): Self = this.set("restrictedDates", js.Array(value :_*))
    @scala.inline
    def setRestrictedDates(value: js.Array[js.Date]): Self = this.set("restrictedDates", value.asInstanceOf[js.Any])
    @scala.inline
