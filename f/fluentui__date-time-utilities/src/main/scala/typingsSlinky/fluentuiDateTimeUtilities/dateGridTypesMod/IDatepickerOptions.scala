...
object IDatepickerOptions {
  ...
  implicit class IDatepickerOptionsOps[Self <: IDatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarkedDaysVarargs(value: js.Date*): Self = this.set("markedDays", js.Array(value :_*))
    @scala.inline
    def setMarkedDays(value: js.Array[js.Date]): Self = this.set("markedDays", value.asInstanceOf[js.Any])
    @scala.inline
