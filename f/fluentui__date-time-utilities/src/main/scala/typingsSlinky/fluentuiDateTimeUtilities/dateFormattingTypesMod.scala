...
object dateFormattingTypesMod {
  ...
  object IDateFormatting {
    ...
    implicit class IDateFormattingMutableBuilder[Self <: IDateFormatting] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormatDay(value: js.Date => String): Self = StObject.set(x, "formatDay", js.Any.fromFunction1(value))
      
      @scala.inline
      def setFormatMonthDayYear(value: (js.Date, IDateGridStrings) => String): Self = StObject.set(x, "formatMonthDayYear", js.Any.fromFunction2(value))
      
      @scala.inline
      def setFormatMonthYear(value: (js.Date, IDateGridStrings) => String): Self = StObject.set(x, "formatMonthYear", js.Any.fromFunction2(value))
      
      @scala.inline
      def setFormatYear(value: js.Date => String): Self = StObject.set(x, "formatYear", js.Any.fromFunction1(value))
      
      @scala.inline
      def setParseDate(value: String => js.Date | Null): Self = StObject.set(x, "parseDate", js.Any.fromFunction1(value))
    }
  }
