...
import typingsSlinky.firebaseFirestoreTypes.mod.FieldPath
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@firebase/firestore/dist/src/api/user_data_reader", "UserDataReader")
@js.native
class UserDataReader protected () extends js.Object {
  ...
  /**
    ...
    */
  def parseQueryValue(methodName: String, input: js.Any): Value = js.native
  def parseQueryValue(methodName: String, input: js.Any, allowArrays: Boolean): Value = js.native
  ...
  def parseUpdateVarargs(
    methodName: String,
    field: typingsSlinky.firebaseFirestore.apiFieldPathMod.FieldPath,
    value: js.Any,
