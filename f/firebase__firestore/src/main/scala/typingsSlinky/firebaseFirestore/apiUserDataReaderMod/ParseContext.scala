...
import typingsSlinky.firebaseFirestore.anon.PartialContextSettingsArrayElement
...
@JSImport("@firebase/firestore/dist/src/api/user_data_reader", "ParseContext")
@js.native
class ParseContext protected () extends js.Object {
  ...
  def contextWith(configuration: PartialContextSettingsArrayElement): ParseContext = js.native
