...
trait ProviderCredentialsSettings extends CredentialsSettings {
  var client: CredentialsProvider = js.native
...
object ProviderCredentialsSettings {
  ...
  @scala.inline
  implicit class ProviderCredentialsSettingsOps[Self <: ProviderCredentialsSettings] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withClient(value: CredentialsProvider): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("client")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: provider): Self = {
        val ret = this.duplicate
