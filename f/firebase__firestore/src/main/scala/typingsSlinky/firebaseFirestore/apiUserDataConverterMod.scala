...
object apiUserDataConverterMod extends js.Object {
  ...
  def fieldPathFromArgument(methodName: String, path: String): typingsSlinky.firebaseFirestore.modelPathMod.FieldPath = js.native
  def fieldPathFromArgument(methodName: String, path: typingsSlinky.firebaseFirestore.apiFieldPathMod.FieldPath): typingsSlinky.firebaseFirestore.modelPathMod.FieldPath = js.native
