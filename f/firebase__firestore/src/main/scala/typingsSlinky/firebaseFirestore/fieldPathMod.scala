...
@JSImport("@firebase/firestore/dist/lib/src/api/field_path", JSImport.Namespace)
@js.native
object fieldPathMod extends js.Object {
  @js.native
  class FieldPath protected ()
    extends typingsSlinky.firebaseFirestoreTypes.mod.FieldPath {
    /**
    ...
    var _internalPath: typingsSlinky.firebaseFirestore.pathMod.FieldPath = js.native
  }
