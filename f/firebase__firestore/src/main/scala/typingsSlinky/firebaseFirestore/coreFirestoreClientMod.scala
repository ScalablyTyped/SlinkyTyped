...
import typingsSlinky.firebaseFirestore.coreEventManagerMod.ListenOptions
import typingsSlinky.firebaseFirestore.coreEventManagerMod.Observer
import typingsSlinky.firebaseFirestore.coreEventManagerMod.QueryListener
...
object coreFirestoreClientMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.firebaseFirestore.anon.Durable
    - typingsSlinky.firebaseFirestore.anon.CacheSizeBytes
  */
