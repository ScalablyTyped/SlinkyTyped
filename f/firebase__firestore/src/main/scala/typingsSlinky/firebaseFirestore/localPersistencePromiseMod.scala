...
import typingsSlinky.firebaseFirestore.anon.`0`
import typingsSlinky.firebaseFirestore.anon.`1`
import typingsSlinky.firebaseFirestore.anon.`3`
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@firebase/firestore/dist/src/local/persistence_promise", JSImport.Namespace)
@js.native
object localPersistencePromiseMod extends js.Object {
  @js.native
  ...
  object PersistencePromise extends js.Object {
    ...
    def reject[R](error: js.Error): PersistencePromise[R] = js.native
    def resolve(): PersistencePromise[Unit] = js.native
    def resolve[R](result: R): PersistencePromise[R] = js.native
    def waitFor(all: `3`): PersistencePromise[Unit] = js.native
  }
