...
import typingsSlinky.firebaseFirestore.streamBridgeMod.StreamBridge
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@firebase/firestore/dist/lib/test/unit/specs/spec_test_components", "MockConnection")
@js.native
