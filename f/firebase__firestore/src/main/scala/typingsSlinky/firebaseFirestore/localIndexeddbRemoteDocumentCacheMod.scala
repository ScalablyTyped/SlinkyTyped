...
import typingsSlinky.firebaseFirestore.modelCollectionsMod.DocumentSizeEntries
import typingsSlinky.firebaseFirestore.modelCollectionsMod.DocumentSizeEntry
