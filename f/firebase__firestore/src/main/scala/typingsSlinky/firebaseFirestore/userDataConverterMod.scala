...
object userDataConverterMod extends js.Object {
  ...
  class UserDataConverter protected () extends js.Object {
    ...
    def parseUpdateVarargs(
      methodName: String,
      field: typingsSlinky.firebaseFirestore.fieldPathMod.FieldPath,
      value: js.Any,
      moreFieldsAndValues: js.Array[_]
    ): ParsedUpdateData = js.native
  }
  
  def fieldPathFromArgument(methodName: String, path: String): typingsSlinky.firebaseFirestore.pathMod.FieldPath = js.native
  def fieldPathFromArgument(methodName: String, path: typingsSlinky.firebaseFirestore.fieldPathMod.FieldPath): typingsSlinky.firebaseFirestore.pathMod.FieldPath = js.native
