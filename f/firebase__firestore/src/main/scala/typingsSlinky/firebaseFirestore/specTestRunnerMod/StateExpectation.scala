...
import typingsSlinky.firebaseFirestore.AnonQueries
...
trait StateExpectation extends js.Object {
  /**
    ...
    */
  var activeTargets: js.UndefOr[NumberDictionary[AnonQueries]] = js.native
  /**
...
object StateExpectation {
  ...
  implicit class StateExpectationOps[Self <: StateExpectation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveTargets(value: NumberDictionary[AnonQueries]): Self = {
