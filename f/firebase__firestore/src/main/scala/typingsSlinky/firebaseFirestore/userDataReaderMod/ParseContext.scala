...
import typingsSlinky.firebaseFirestore.anon.PartialContextSettings
...
@JSImport("@firebase/firestore/dist/lib/src/api/user_data_reader", "ParseContext")
@js.native
class ParseContext protected () extends js.Object {
  ...
  def createError(reason: String): js.Error = js.native
