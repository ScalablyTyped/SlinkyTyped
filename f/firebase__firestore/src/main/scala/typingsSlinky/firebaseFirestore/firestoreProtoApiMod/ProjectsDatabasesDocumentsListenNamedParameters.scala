...
@js.native
trait ProjectsDatabasesDocumentsListenNamedParameters extends js.Object {
  @JSName("$Xgafv")
...
object ProjectsDatabasesDocumentsListenNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesDocumentsListenNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsListenNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesDocumentsListenNamedParametersOps[Self <: ProjectsDatabasesDocumentsListenNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
