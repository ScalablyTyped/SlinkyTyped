...
object ProjectsDatabasesDocumentsBatchGetNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesDocumentsBatchGetNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsBatchGetNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesDocumentsBatchGetNamedParametersOps[Self <: ProjectsDatabasesDocumentsBatchGetNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
