...
object ProjectsDatabasesDocumentsBeginTransactionNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesDocumentsBeginTransactionNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsBeginTransactionNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesDocumentsBeginTransactionNamedParametersOps[Self <: ProjectsDatabasesDocumentsBeginTransactionNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
