...
object ProjectsDatabasesDocumentsPatchNamedParameters {
  ...
  def apply(
    ...
    currentDocumentExists: js.UndefOr[Boolean] = js.undefined,
    currentDocumentUpdateTime: String = null,
    fields: String = null,
    key: String = null,
    ...
    updateMaskFieldPaths: js.Array[String] = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ProjectsDatabasesDocumentsPatchNamedParameters = {
    ...
    if (!js.isUndefined(currentDocumentExists)) __obj.updateDynamic("currentDocumentExists")(currentDocumentExists.get.asInstanceOf[js.Any])
    if (currentDocumentUpdateTime != null) __obj.updateDynamic("currentDocumentUpdateTime")(currentDocumentUpdateTime.asInstanceOf[js.Any])
    ...
    if (updateMaskFieldPaths != null) __obj.updateDynamic("updateMaskFieldPaths")(updateMaskFieldPaths.asInstanceOf[js.Any])
