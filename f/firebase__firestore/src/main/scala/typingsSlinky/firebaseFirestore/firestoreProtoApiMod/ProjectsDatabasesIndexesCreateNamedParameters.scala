...
object ProjectsDatabasesIndexesCreateNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesIndexesCreateNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesIndexesCreateNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesIndexesCreateNamedParametersOps[Self <: ProjectsDatabasesIndexesCreateNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def with$Xgafv(value: ProjectsDatabasesIndexesApiClientXgafv): Self = {
    ...
    @scala.inline
    def withAlt(value: ProjectsDatabasesIndexesApiClientAlt): Self = {
        val ret = this.duplicate
