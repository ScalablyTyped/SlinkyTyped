...
@js.native
trait ProjectsDatabasesDocumentsRunQueryNamedParameters extends js.Object {
  @JSName("$Xgafv")
...
object ProjectsDatabasesDocumentsRunQueryNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesDocumentsRunQueryNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsRunQueryNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesDocumentsRunQueryNamedParametersOps[Self <: ProjectsDatabasesDocumentsRunQueryNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
