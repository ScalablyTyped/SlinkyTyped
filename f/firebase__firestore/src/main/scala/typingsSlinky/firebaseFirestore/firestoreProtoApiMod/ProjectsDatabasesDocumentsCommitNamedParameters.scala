...
object ProjectsDatabasesDocumentsCommitNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesDocumentsCommitNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsCommitNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesDocumentsCommitNamedParametersOps[Self <: ProjectsDatabasesDocumentsCommitNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
