...
object ProjectsDatabasesIndexesListNamedParameters {
  @scala.inline
  def apply(): ProjectsDatabasesIndexesListNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesIndexesListNamedParameters]
  }
  @scala.inline
  implicit class ProjectsDatabasesIndexesListNamedParametersOps[Self <: ProjectsDatabasesIndexesListNamedParameters] (val x: Self) extends AnyVal {
    @scala.inline
