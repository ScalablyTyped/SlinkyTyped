...
trait SpecStep extends js.Object {
  ...
  var failDatabase: js.UndefOr[Boolean] = js.undefined
  /** Fail a write */
...
object SpecStep {
  ...
  def apply(
    ...
    failDatabase: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(failDatabase)) __obj.updateDynamic("failDatabase")(failDatabase.get.asInstanceOf[js.Any])
