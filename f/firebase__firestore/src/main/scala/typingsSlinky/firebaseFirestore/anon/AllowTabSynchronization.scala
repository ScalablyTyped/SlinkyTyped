...
@js.native
trait AllowTabSynchronization extends js.Object {
  var allowTabSynchronization: Boolean = js.native
  var clientId: typingsSlinky.firebaseFirestore.sharedClientStateMod.ClientId = js.native
...
object AllowTabSynchronization {
  @scala.inline
  def apply(
    allowTabSynchronization: Boolean,
    clientId: typingsSlinky.firebaseFirestore.sharedClientStateMod.ClientId,
    lruParams: LruParams,
    ...
    __obj.asInstanceOf[AllowTabSynchronization]
  }
  @scala.inline
  implicit class AllowTabSynchronizationOps[Self <: AllowTabSynchronization] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClientId(value: typingsSlinky.firebaseFirestore.sharedClientStateMod.ClientId): Self = {
        val ret = this.duplicate
