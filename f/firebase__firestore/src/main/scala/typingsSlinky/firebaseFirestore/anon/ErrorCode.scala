...
trait ErrorCode extends js.Object {
  ...
  var errorCode: js.UndefOr[typingsSlinky.firebaseFirestore.utilErrorMod.Code] = js.native
...
object ErrorCode {
  ...
  implicit class ErrorCodeOps[Self <: ErrorCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withErrorCode(value: typingsSlinky.firebaseFirestore.utilErrorMod.Code): Self = {
        val ret = this.duplicate
