...
trait Added extends js.Object {
  ...
  var errorCode: js.UndefOr[typingsSlinky.firebaseFirestore.errorMod.Code] = js.native
...
object Added {
  ...
  implicit class AddedOps[Self <: Added] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withErrorCode(value: typingsSlinky.firebaseFirestore.errorMod.Code): Self = {
        val ret = this.duplicate
