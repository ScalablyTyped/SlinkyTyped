...
class Query[T] protected ()
  ...
  def this(_query: typingsSlinky.firebaseFirestore.queryMod.Query, firestore: Firestore) = this()
  def this(
  ...
  var _query: typingsSlinky.firebaseFirestore.queryMod.Query = js.native
