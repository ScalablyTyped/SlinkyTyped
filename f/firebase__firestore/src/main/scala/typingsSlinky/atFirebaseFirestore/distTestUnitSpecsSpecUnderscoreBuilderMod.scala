...
import typingsSlinky.atFirebaseFirestore.distTestUnitSpecsSpecUnderscoreBuilderMod.ActiveTargetMap
import typingsSlinky.atFirebaseFirestore.distTestUnitSpecsSpecUnderscoreBuilderMod.ClientMemoryState
import typingsSlinky.atFirebaseFirestore.distTestUnitSpecsSpecUnderscoreBuilderMod.LimboMap
import typingsSlinky.atFirebaseFirestore.distTestUnitSpecsSpecUnderscoreBuilderMod.MultiClientSpecBuilder
import typingsSlinky.atFirebaseFirestore.distTestUnitSpecsSpecUnderscoreBuilderMod.SpecBuilder
import typingsSlinky.atFirebaseFirestore.distTestUnitSpecsSpecUnderscoreRpcUnderscoreErrorMod.RpcError
...
@js.native
object distTestUnitSpecsSpecUnderscoreBuilderMod extends js.Object {
  @js.native
  ...
  class SpecBuilder () extends js.Object {
    ...
    def expectActiveTargets(targets: Anon_Query*): this.type = js.native
    def expectEvents(query: Query, events: Anon_Added): this.type = js.native
    ...
    def expectUserCallbacks(docs: Anon_Acknowledged): this.type = js.native
    /**
    ...
    def failWrite(doc: String, error: RpcError, options: Anon_ExpectUserCallback): this.type = js.native
    ...
    /**
      ...
      */
    def toJSON(): Anon_Config = js.native
    ...
    def watchSends(targets: Anon_Affects, docs: MaybeDocument*): this.type = js.native
    ...
    def watchStreamCloses(error: Code, opts: Anon_RunBackoffTimer): this.type = js.native
    ...
    def writeAcks(doc: String, version: TestSnapshotVersion, options: Anon_ExpectUserCallback): this.type = js.native
  }
  ...
  type ActiveTargetMap = StringDictionary[Anon_Queries]
