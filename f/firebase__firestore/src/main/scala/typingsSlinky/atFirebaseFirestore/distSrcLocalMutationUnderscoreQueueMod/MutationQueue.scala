package typingsSlinky.atFirebaseFirestore.distSrcLocalMutationUnderscoreQueueMod
...
trait MutationQueue extends js.Object {
  ...
  /**
    ...
    */
  def lookupMutationKeys(transaction: PersistenceTransaction, batchId: BatchId): PersistencePromise[DocumentKeySet | Null]
  /**
...
object MutationQueue {
  ...
  def apply(
    ...
    lookupMutationKeys: (PersistenceTransaction, BatchId) => PersistencePromise[DocumentKeySet | Null],
