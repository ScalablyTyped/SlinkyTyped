package typingsSlinky.atFirebaseFirestore.distSrcCoreViewMod

import typingsSlinky.atFirebaseFirestore.distSrcCoreQueryMod.Query
import typingsSlinky.atFirebaseFirestore.distSrcCoreTypesMod.OnlineState
import typingsSlinky.atFirebaseFirestore.distSrcCoreViewUnderscoreSnapshotMod.ViewSnapshot
import typingsSlinky.atFirebaseFirestore.distSrcLocalLocalUnderscoreStoreMod.QueryResult
...
class View protected () extends js.Object {
  ...
  /**
    ...
    */
  def computeDocChanges(docChanges: MaybeDocumentMap): ViewDocumentChanges = js.native
  def computeDocChanges(docChanges: MaybeDocumentMap, previousChanges: ViewDocumentChanges): ViewDocumentChanges = js.native
  /**
  ...
  /**
    ...
    * this view.
    */
  def syncedDocuments(): DocumentKeySet = js.native
  /**
