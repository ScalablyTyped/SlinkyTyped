...
class WriteBatch protected ()
  extends typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.WriteBatch {
  ...
  def update(
    documentRef: typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.DocumentReference,
    field: FieldPath,
    value: js.Any,
