...
@js.native
object distSrcLocalIndexeddbUnderscorePersistenceMod extends js.Object {
  @js.native
  ...
  object IndexedDbPersistence extends js.Object {
    ...
    def createIndexedDbPersistence(options: Anon_AllowTabSynchronization): js.Promise[IndexedDbPersistence] = js.native
