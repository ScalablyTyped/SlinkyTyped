package typingsSlinky.atFirebaseFirestore.distSrcRemoteSerializerMod
...
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.BatchGetDocumentsResponse
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Document
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.DocumentMask
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.DocumentsTarget
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.FieldFilterOp
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.FieldReference
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Filter
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.ListenResponse
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.MapValue
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Order
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.OrderDirection
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.QueryTarget
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Status
...
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Value
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Write
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.WriteResult
import typingsSlinky.atFirebaseFirestore.distSrcRemoteWatchUnderscoreChangeMod.WatchChange
import typingsSlinky.atFirebaseFirestore.distSrcRemoteWatchUnderscoreChangeMod.WatchTargetChangeState
...
class JsonProtoSerializer protected () extends js.Object {
  ...
  def fromDocument(document: Document): typingsSlinky.atFirebaseFirestore.distSrcModelDocumentMod.Document = js.native
  def fromDocument(document: Document, hasCommittedMutations: Boolean): typingsSlinky.atFirebaseFirestore.distSrcModelDocumentMod.Document = js.native
  ...
  def fromFieldFilter(filter: Filter): typingsSlinky.atFirebaseFirestore.distSrcCoreQueryMod.Filter = js.native
  ...
  def fromUnaryFilter(filter: Filter): typingsSlinky.atFirebaseFirestore.distSrcCoreQueryMod.Filter = js.native
  ...
  def toArrayValue(array: ArrayValue): typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.ArrayValue = js.native
  def toDirection(dir: Direction): OrderDirection = js.native
  def toDocument(document: typingsSlinky.atFirebaseFirestore.distSrcModelDocumentMod.Document): Document = js.native
  ...
  def toTarget(targetData: TargetData): typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.Target = js.native
