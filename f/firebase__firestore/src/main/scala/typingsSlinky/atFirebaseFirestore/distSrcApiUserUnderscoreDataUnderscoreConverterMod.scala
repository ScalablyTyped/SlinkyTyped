...
import typingsSlinky.atFirebaseFirestore.distSrcApiUserUnderscoreDataUnderscoreConverterMod.DataPreConverter
import typingsSlinky.atFirebaseFirestore.distSrcApiUserUnderscoreDataUnderscoreConverterMod.ParsedSetData
import typingsSlinky.atFirebaseFirestore.distSrcApiUserUnderscoreDataUnderscoreConverterMod.ParsedUpdateData
...
import typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.FieldPath
...
@js.native
object distSrcApiUserUnderscoreDataUnderscoreConverterMod extends js.Object {
  @js.native
  ...
  class UserDataConverter protected () extends js.Object {
    ...
    def parseUpdateVarargs(
      methodName: String,
      field: typingsSlinky.atFirebaseFirestore.distSrcApiFieldUnderscorePathMod.FieldPath,
      value: js.Any,
      moreFieldsAndValues: js.Array[_]
    ): ParsedUpdateData = js.native
  }
  
  def fieldPathFromArgument(methodName: String, path: String): typingsSlinky.atFirebaseFirestore.distSrcModelPathMod.FieldPath = js.native
  def fieldPathFromArgument(
    methodName: String,
    path: typingsSlinky.atFirebaseFirestore.distSrcApiFieldUnderscorePathMod.FieldPath
  ): typingsSlinky.atFirebaseFirestore.distSrcModelPathMod.FieldPath = js.native
