...
import typingsSlinky.atFirebaseFirestore.distSrcUtilObjUnderscoreMapMod.ObjectMap
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@firebase/firestore/dist/src/local/remote_document_change_buffer", JSImport.Namespace)
@js.native
object distSrcLocalRemoteUnderscoreDocumentUnderscoreChangeUnderscoreBufferMod extends js.Object {
  @js.native
  abstract class RemoteDocumentChangeBuffer () extends js.Object {
    ...
    /* protected */ def getAllFromCache(transaction: PersistenceTransaction, documentKeys: DocumentKeySet): PersistencePromise[NullableMaybeDocumentMap] = js.native
    /**
