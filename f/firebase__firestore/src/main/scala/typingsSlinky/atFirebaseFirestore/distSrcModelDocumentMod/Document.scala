...
import typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.firestoreV1ApiClientInterfaces.Value
...
class Document protected () extends MaybeDocument {
  ...
  def this(
    ...
    proto: typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.firestoreV1ApiClientInterfaces.Document
  ) = this()
  def this(
    key: DocumentKey,
    version: SnapshotVersion,
