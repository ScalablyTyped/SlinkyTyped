...
import typingsSlinky.atFirebaseFirestore.distTestUtilTestUnderscorePlatformMod.FakeDocument
import typingsSlinky.atFirebaseFirestore.distTestUtilTestUnderscorePlatformMod.FakeWindow
import typingsSlinky.atFirebaseFirestore.distTestUtilTestUnderscorePlatformMod.SharedFakeWebStorage
