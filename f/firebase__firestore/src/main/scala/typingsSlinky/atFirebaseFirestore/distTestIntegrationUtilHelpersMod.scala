...
import typingsSlinky.atFirebaseFirestore.atFirebaseFirestoreStrings.`test-db2`
import typingsSlinky.atFirebaseFirestore.distSrcApiCredentialsMod.EmptyCredentialsProvider
import typingsSlinky.atFirebaseFirestore.distSrcAuthUserMod.User
import typingsSlinky.atFirebaseFirestore.distTestIntegrationUtilHelpersMod.ApiDescribe
import typingsSlinky.atFirebaseFirestore.distTestIntegrationUtilHelpersMod.ApiSuiteFunction
import typingsSlinky.atFirebaseFirestore.distTestIntegrationUtilHelpersMod.MockCredentialsProvider
import typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.CollectionReference
import typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.DocumentData
import typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.DocumentReference
...
import typingsSlinky.atFirebaseFirestoreDashTypes.atFirebaseFirestoreDashTypesMod.Settings
