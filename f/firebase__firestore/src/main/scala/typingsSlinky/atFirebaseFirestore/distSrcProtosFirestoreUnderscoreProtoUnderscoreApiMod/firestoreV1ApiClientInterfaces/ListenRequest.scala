...
trait ListenRequest extends js.Object {
  var addTarget: js.UndefOr[
    typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.firestoreV1ApiClientInterfaces.Target
  ] = js.undefined
...
object ListenRequest {
  @scala.inline
  def apply(
    addTarget: typingsSlinky.atFirebaseFirestore.distSrcProtosFirestoreUnderscoreProtoUnderscoreApiMod.firestoreV1ApiClientInterfaces.Target = null,
