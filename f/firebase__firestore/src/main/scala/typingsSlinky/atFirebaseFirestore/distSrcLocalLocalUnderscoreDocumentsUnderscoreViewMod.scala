...
@js.native
object distSrcLocalLocalUnderscoreDocumentsUnderscoreViewMod extends js.Object {
  @js.native
  class LocalDocumentsView protected () extends js.Object {
    ...
    /**
      ...
      */
    def getDocuments(transaction: PersistenceTransaction, keys: DocumentKeySet): PersistencePromise[MaybeDocumentMap] = js.native
    /**
    ...
    /**
      ...
      */
    def getLocalViewOfDocuments(transaction: PersistenceTransaction, baseDocs: NullableMaybeDocumentMap): PersistencePromise[MaybeDocumentMap] = js.native
  }
