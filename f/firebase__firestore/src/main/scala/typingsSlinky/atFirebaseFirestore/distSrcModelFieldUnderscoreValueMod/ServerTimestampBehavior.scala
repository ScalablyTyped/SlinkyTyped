...
object ServerTimestampBehavior extends js.Object {
  ...
  /* 0 */ val Default: typingsSlinky.atFirebaseFirestore.distSrcModelFieldUnderscoreValueMod.ServerTimestampBehavior.Default with Double = js.native
  /* 1 */ val Estimate: typingsSlinky.atFirebaseFirestore.distSrcModelFieldUnderscoreValueMod.ServerTimestampBehavior.Estimate with Double = js.native
  /* 2 */ val Previous: typingsSlinky.atFirebaseFirestore.distSrcModelFieldUnderscoreValueMod.ServerTimestampBehavior.Previous with Double = js.native
  @JSBracketAccess
