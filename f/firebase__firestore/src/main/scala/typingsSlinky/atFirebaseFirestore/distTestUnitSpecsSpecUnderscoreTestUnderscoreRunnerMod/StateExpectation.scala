...
import typingsSlinky.atFirebaseFirestore.Anon_AcknowledgedDocs
import typingsSlinky.atFirebaseFirestore.Anon_Queries
...
trait StateExpectation extends js.Object {
  /**
    ...
    */
  var activeTargets: js.UndefOr[NumberDictionary[Anon_Queries]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var userCallbacks: js.UndefOr[Anon_AcknowledgedDocs] = js.undefined
...
object StateExpectation {
  @scala.inline
  def apply(
    activeTargets: NumberDictionary[Anon_Queries] = null,
    ...
    userCallbacks: Anon_AcknowledgedDocs = null,
