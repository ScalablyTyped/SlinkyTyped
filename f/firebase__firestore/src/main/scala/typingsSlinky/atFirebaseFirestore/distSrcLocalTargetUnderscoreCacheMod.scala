...
@js.native
object distSrcLocalTargetUnderscoreCacheMod extends js.Object {
  @js.native
  trait TargetCache extends js.Object {
    /**
      ...
      */
    def addMatchingKeys(transaction: PersistenceTransaction, keys: DocumentKeySet, targetId: TargetId): PersistencePromise[Unit] = js.native
    /**
    ...
    /**
      ...
      */
    def getMatchingKeysForTargetId(transaction: PersistenceTransaction, targetId: TargetId): PersistencePromise[DocumentKeySet] = js.native
    /**
    ...
    /**
      ...
      * Multi-Tab Note: This operation should only be called by the primary client.
      */
    def removeMatchingKeys(transaction: PersistenceTransaction, keys: DocumentKeySet, targetId: TargetId): PersistencePromise[Unit] = js.native
    /**
