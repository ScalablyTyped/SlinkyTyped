...
@js.native
trait VerifyOptionsextractToken extends js.Object {
...
object VerifyOptionsextractToken {
  ...
  @scala.inline
  implicit class VerifyOptionsextractTokenOps[Self <: VerifyOptionsextractToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExtractToken(value: /* request */ FastifyRequest => String | Unit): Self = this.set("extractToken", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteExtractToken: Self = this.set("extractToken", js.undefined)
