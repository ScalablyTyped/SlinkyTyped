...
object AuthorizationTokenExpiredMessage {
  ...
  implicit class AuthorizationTokenExpiredMessageOps[Self <: AuthorizationTokenExpiredMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthorizationTokenInvalidFunction1(value: /* err */ js.Error => String): Self = this.set("authorizationTokenInvalid", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAuthorizationTokenInvalid(value: (js.Function1[/* err */ js.Error, String]) | String): Self = this.set("authorizationTokenInvalid", value.asInstanceOf[js.Any])
