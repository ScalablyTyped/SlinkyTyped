...
object anon {
  ...
  trait AuthorizationTokenExpiredMessage extends StObject {
    ...
    var authorizationTokenInvalid: js.UndefOr[(js.Function1[/* err */ js.Error, String]) | String] = js.native
  ...
  object AuthorizationTokenExpiredMessage {
    ...
    implicit class AuthorizationTokenExpiredMessageMutableBuilder[Self <: AuthorizationTokenExpiredMessage] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuthorizationTokenInvalid(value: (js.Function1[/* err */ js.Error, String]) | String): Self = StObject.set(x, "authorizationTokenInvalid", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAuthorizationTokenInvalidFunction1(value: /* err */ js.Error => String): Self = StObject.set(x, "authorizationTokenInvalid", js.Any.fromFunction1(value))
