...
import typingsSlinky.fluentuiTheme.anon.Dictkey
import typingsSlinky.fluentuiTheme.anon.PartialIEffects
import typingsSlinky.fluentuiTheme.anon.PartialIFontStyles
import typingsSlinky.fluentuiTheme.anon.PartialIPalette
import typingsSlinky.fluentuiTheme.anon.PartialISemanticColors
import typingsSlinky.fluentuiTheme.anon.PartialISpacing
import typingsSlinky.fluentuiTheme.anon.PinISchemeNamesIScheme
import typingsSlinky.fluentuiTheme.anon.RecursivePartialTokens
...
import typingsSlinky.fluentuiTheme.ischemeMod.IScheme
...
object themeMod {
  ...
  {[ P in keyof T ]:? T[P] extends std.Array<infer I>? std.Array</ * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias @fluentui/theme.@fluentui/theme/lib/types/Theme.RecursivePartial<I> * / object> : / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias @fluentui/theme.@fluentui/theme/lib/types/Theme.RecursivePartial<T[P]> * / object}
    */ typingsSlinky.fluentuiTheme.fluentuiThemeStrings.RecursivePartial with TopLevel[T]
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.smallest
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.smaller
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.small
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.medium
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.large
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.larger
    - typingsSlinky.fluentuiTheme.fluentuiThemeStrings.largest
  */
  trait SizeValue extends StObject
  object SizeValue {
    
    @scala.inline
    def large: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.large = "large".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.large]
    
    @scala.inline
    def larger: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.larger = "larger".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.larger]
    
    @scala.inline
    def largest: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.largest = "largest".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.largest]
    
    @scala.inline
    def medium: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.medium = "medium".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.medium]
    
    @scala.inline
    def small: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.small = "small".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.small]
    
    @scala.inline
    def smaller: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.smaller = "smaller".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.smaller]
    
    @scala.inline
    def smallest: typingsSlinky.fluentuiTheme.fluentuiThemeStrings.smallest = "smallest".asInstanceOf[typingsSlinky.fluentuiTheme.fluentuiThemeStrings.smallest]
  }
