...
object mod {
  ...
  @js.native
  def list(rootPath: String, callback: js.Function2[/* err */ js.Error, /* result */ js.Array[String], Unit]): Unit = js.native
  @JSImport("fs-plus", "list")
  @js.native
  def list(
    rootPath: String,
  ...
  @js.native
  def move(source: String, target: String, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  @js.native
  def remove(pathToRemove: String, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  def writeFile(
    filePath: String,
    content: js.Any,
    options: typingsSlinky.fsPlus.anon.Encoding,
    callback: js.Function1[/* err */ js.Any, Unit]
  ): Unit = js.native
  ...
  @JSImport("fs-plus", "writeFileSync")
  @js.native
  def writeFileSync(filePath: String, content: String, options: typingsSlinky.fsPlus.anon.Encoding): Unit = js.native
