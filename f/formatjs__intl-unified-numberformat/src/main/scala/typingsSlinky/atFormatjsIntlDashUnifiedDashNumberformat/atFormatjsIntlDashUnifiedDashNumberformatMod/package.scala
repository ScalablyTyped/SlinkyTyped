...
package object atFormatjsIntlDashUnifiedDashNumberformatMod {
  import typingsSlinky.atFormatjsIntlDashUnifiedDashNumberformat.Anon_AccountingAlways
  ...
  type UnifiedNumberFormatOptions = NumberFormatOptions with NumberFormatDigitOptions with Anon_AccountingAlways
