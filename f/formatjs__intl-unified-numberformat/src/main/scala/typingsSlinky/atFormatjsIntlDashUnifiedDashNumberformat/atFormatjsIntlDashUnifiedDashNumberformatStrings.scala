...
import typingsSlinky.atFormatjsIntlDashUnifiedDashNumberformat.atFormatjsIntlDashUnifiedDashNumberformatMod._UnifiedNumberFormatPartTypes
...
object atFormatjsIntlDashUnifiedDashNumberformatStrings {
  ...
  sealed trait acre
    extends Unit
       with typingsSlinky.atFormatjsIntlDashUnifiedDashNumberformat.atFormatjsIntlDashUnifiedDashNumberformatMod.Unit
  ...
  sealed trait compact
    extends _UnifiedNumberFormatPartTypes
       with typingsSlinky.atFormatjsIntlDashUnifiedDashNumberformat.libCoreMod._UnifiedNumberFormatPartTypes
