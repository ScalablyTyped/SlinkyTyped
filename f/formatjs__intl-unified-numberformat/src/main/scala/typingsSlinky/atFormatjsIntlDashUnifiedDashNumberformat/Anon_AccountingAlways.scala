...
import typingsSlinky.atFormatjsIntlDashUnifiedDashNumberformat.atFormatjsIntlDashUnifiedDashNumberformatMod.Unit
...
trait Anon_AccountingAlways extends js.Object {
...
object Anon_AccountingAlways {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Anon_AccountingAlways]
  }
}
