...
object LoginOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(enable_profile_selector)) __obj.updateDynamic("enable_profile_selector")(enable_profile_selector.get.asInstanceOf[js.Any])
    if (profile_selector_ids != null) __obj.updateDynamic("profile_selector_ids")(profile_selector_ids.asInstanceOf[js.Any])
    if (!js.isUndefined(return_scopes)) __obj.updateDynamic("return_scopes")(return_scopes.get.asInstanceOf[js.Any])
