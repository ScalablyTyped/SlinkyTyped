package typingsSlinky.fsExtraPromise
...
object mod {
  ...
  @js.native
  def fstatAsync(fd: Double): ^[typingsSlinky.node.fsMod.Stats] = js.native
  ...
  @JSImport("fs-extra-promise", "isDirectory")
  @js.native
  def isDirectory(path: String, callback: js.Function2[/* err */ js.Error, /* isDirectory */ Boolean, Unit]): Unit = js.native
  ...
  @js.native
  def lstatAsync(path: String): ^[typingsSlinky.node.fsMod.Stats] = js.native
  ...
  @JSImport("fs-extra-promise", "mkdtempAsync")
  @js.native
  def mkdtempAsync(prefix: String, options: typingsSlinky.fsExtraPromise.anon.Encoding): ^[String] = js.native
  ...
  @js.native
  def statAsync(path: String): ^[typingsSlinky.node.fsMod.Stats] = js.native
