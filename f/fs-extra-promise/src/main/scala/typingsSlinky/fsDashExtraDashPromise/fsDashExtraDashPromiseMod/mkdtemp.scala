...
import typingsSlinky.fsDashExtraDashPromise.fsDashExtraDashPromiseStrings.buffer
...
object mkdtemp extends js.Object {
  ...
  /**
    ...
    */
  def apply(prefix: String, callback: js.Function2[ErrnoException | Null, /* folder */ String, Unit]): Unit = js.native
  def apply(
    prefix: String,
