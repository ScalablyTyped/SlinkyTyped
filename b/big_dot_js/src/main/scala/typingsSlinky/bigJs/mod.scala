...
object mod extends Shortcut {
  ...
  trait Big extends StObject {
    ...
    def abs(): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      */
    def add(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      */
    def div(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      * @throws `NaN` if n is invalid.
      */
    def minus(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      */
    def mod(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      * @throws `NaN` if n is invalid.
      */
    def mul(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      * @throws `NaN` if n is invalid.
      */
    def plus(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      */
    def pow(exp: Double): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      */
    def round(): typingsSlinky.bigJs.mod.Big = js.native
    def round(dp: js.UndefOr[scala.Nothing], rm: RoundingMode): typingsSlinky.bigJs.mod.Big = js.native
    def round(dp: Double): typingsSlinky.bigJs.mod.Big = js.native
    def round(dp: Double, rm: RoundingMode): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      */
    def sqrt(): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      * @throws `NaN` if n is invalid.
      */
    def sub(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
    ...
    /**
      ...
      * @throws `NaN` if n is invalid.
      */
    def times(n: BigSource): typingsSlinky.bigJs.mod.Big = js.native
  ...
  class BigCls protected ()
    extends typingsSlinky.bigJs.mod.Big {
    /**
  ...
  object global {
    ...
    @JSGlobal("Big")
    @js.native
    val Big: typingsSlinky.bigJs.mod.global.BigJs.BigConstructor = js.native
  ...
  trait BigConstructor
    ...
    * @throws `NaN` on an invalid value.
    */
  Instantiable1[/* value */ BigSource, typingsSlinky.bigJs.mod.Big] {
    ...
    /**
      ...
      * @throws `NaN` on an invalid value.
      */
    def apply(value: BigSource): typingsSlinky.bigJs.mod.Big = js.native
  ...
  type BigSource = Double | String | typingsSlinky.bigJs.mod.Big
  
  type BigSource_ = BigSource
  
  type Big_ = typingsSlinky.bigJs.mod.Big
