...
import typingsSlinky.bell.Anon_ExtendedProfile
import typingsSlinky.bell.Anon_Uri
...
/* Rewritten from type alias, can be one of: 
  - typings.bell.bellMod.CustomProviderOptions
  - typings.bell.bellMod.KnownProviderOptions
*/
