...
object types extends js.Object {
  ...
  def is(
    `type`: String,
    n: typingsSlinky.babelTypes.mod.Node,
  ...
  def matchesPattern(node: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null], `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  def matchesPattern(node: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null], `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  def matchesPattern(node: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null], `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  def matchesPattern(
    node: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null],
  ...
  def validate[T /* <: typingsSlinky.babelTypes.mod.Node */, K /* <: /* keyof T */ String */](
    n: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null],
    key: K,
