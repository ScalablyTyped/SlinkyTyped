...
object types extends js.Object {
  ...
  def ensureBlock(node: Extract[typingsSlinky.babelTypes.mod.Node, Body]): BlockStatement_ = js.native
  ...
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 240 */ js.Any */](`type`: T, n: typingsSlinky.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 240 */ js.Any */, P /* <: Extract[typingsSlinky.babelTypes.mod.Node, Type[T]] */](`type`: T, n: js.UndefOr[typingsSlinky.babelTypes.mod.Node], required: Partial[P]): /* is P */ Boolean = js.native
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 240 */ js.Any */, P /* <: Extract[typingsSlinky.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
  ...
  def toSequenceExpression(nodes: js.Array[typingsSlinky.babelTypes.mod.Node], scope: BuildUndefinedNode): js.UndefOr[SequenceExpression_] = js.native
