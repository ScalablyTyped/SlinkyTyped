...
import typingsSlinky.atBabelCore.atBabelCoreStrings.`>`
import typingsSlinky.atBabelCore.atBabelCoreStrings.`??`
import typingsSlinky.atBabelCore.atBabelCoreStrings.`_backtick^_backtick`
...
object types extends js.Object {
  ...
  def binaryExpression(
    operator: `+` | `-` | `/` | `%` | typingsSlinky.atBabelCore.atBabelCoreStrings.`*` | `**` | `&` | typingsSlinky.atBabelCore.atBabelCoreStrings.`|` | `>>` | `>>>` | `<<` | `_backtick^_backtick` | `==` | `===` | `!=` | `!==` | in | instanceof | `>` | `<` | `>=` | `<=`,
    left: Expression,
    right: Expression
