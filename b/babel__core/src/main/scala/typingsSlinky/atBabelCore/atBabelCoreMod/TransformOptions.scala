...
import typingsSlinky.atBabelCore.atBabelCoreStrings.both
import typingsSlinky.atBabelCore.atBabelCoreStrings.enter
import typingsSlinky.atBabelCore.atBabelCoreStrings.exit
import typingsSlinky.atBabelCore.atBabelCoreStrings.module
import typingsSlinky.atBabelCore.atBabelCoreStrings.root
import typingsSlinky.atBabelCore.atBabelCoreStrings.script
import typingsSlinky.atBabelCore.atBabelCoreStrings.unambiguous
import typingsSlinky.atBabelCore.atBabelCoreStrings.upward
import typingsSlinky.atBabelGenerator.atBabelGeneratorMod.GeneratorOptions
  ...
  var wrapPluginVisitorMethod: js.UndefOr[
    (js.Function3[
      ...
      /* callback */ js.Function2[
        /* path */ typingsSlinky.atBabelTraverse.atBabelTraverseMod.NodePath[typingsSlinky.atBabelTraverse.atBabelTraverseMod.Node], 
        /* state */ js.Any, 
        Unit
      ], 
      js.Function2[
