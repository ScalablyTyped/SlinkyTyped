...
import typingsSlinky.browserfs.anon.AutoClose
import typingsSlinky.browserfs.anon.Encoding
import typingsSlinky.browserfs.anon.EncodingFlag
import typingsSlinky.browserfs.anon.Fd
import typingsSlinky.browserfs.anon.Flag
import typingsSlinky.browserfs.anon.Interval
import typingsSlinky.browserfs.anon.Mode
import typingsSlinky.browserfs.anon.Persistent
import typingsSlinky.browserfs.anon.TypeofFS
import typingsSlinky.browserfs.anon.TypeofStats
...
object fSMod extends js.Object {
  ...
  trait FS extends js.Object {
    ...
    def fstat(fd: Double, cb: BFSCallback[typingsSlinky.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `fstat`.
      * `fstat()` is identical to `stat()`, except that the file to be stat-ed is
      * specified by the file descriptor `fd`.
      ...
      */
    def fstatSync(fd: Double): typingsSlinky.browserfs.nodeFsStatsMod.default = js.native
    /**
      * Asynchronous fsync.
      * @param fd
      * @param callback
    ...
    def lstat(path: String, cb: BFSCallback[typingsSlinky.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `lstat`.
      * `lstat()` is identical to `stat()`, except that if path is a symbolic link,
      * then the link itself is stat-ed, not the file that it refers to.
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def lstatSync(path: String): typingsSlinky.browserfs.nodeFsStatsMod.default = js.native
    /**
      * Asynchronous `mkdir`.
      * @param path
    ...
    def stat(path: String, cb: BFSCallback[typingsSlinky.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `stat`.
      * @param path
      * @return [BrowserFS.node.fs.Stats]
      */
    def statSync(path: String): typingsSlinky.browserfs.nodeFsStatsMod.default = js.native
    /**
    ...
    def unwatchFile(
      ...
      listener: js.Function2[
          /* curr */ typingsSlinky.browserfs.nodeFsStatsMod.default, 
          /* prev */ typingsSlinky.browserfs.nodeFsStatsMod.default, 
          Unit
        ]
    ): Unit = js.native
    /**
