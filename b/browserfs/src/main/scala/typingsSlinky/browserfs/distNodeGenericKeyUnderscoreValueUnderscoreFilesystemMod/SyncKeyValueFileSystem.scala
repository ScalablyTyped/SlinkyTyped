...
import typingsSlinky.browserfs.distNodeCoreFileUnderscoreSystemMod.SynchronousFileSystem
import typingsSlinky.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default
