package typingsSlinky.browserfs.distNodeBackendAsyncMirrorMod
...
trait AsyncMirror
  ...
  def _syncSync(fd: typingsSlinky.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[_]): Unit = js.native
