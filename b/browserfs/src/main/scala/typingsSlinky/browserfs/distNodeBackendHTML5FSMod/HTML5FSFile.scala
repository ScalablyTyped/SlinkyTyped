...
class HTML5FSFile protected ()
  extends typingsSlinky.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[HTML5FS]
     with File {
  def this(
    fs: HTML5FS,
    entry: FileEntry,
    path: String,
    flag: FileFlag,
    stat: typingsSlinky.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default
  ) = this()
  def this(
    fs: HTML5FS,
    entry: FileEntry,
