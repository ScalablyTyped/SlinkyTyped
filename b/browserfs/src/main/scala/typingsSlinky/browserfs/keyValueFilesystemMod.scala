...
object keyValueFilesystemMod {
  ...
  class AsyncKeyValueFileSystem () extends BaseFileSystem {
    ...
    def _sync(
      p: String,
      data: Buffer,
      stats: typingsSlinky.browserfs.nodeFsStatsMod.default,
  ...
  class SyncKeyValueFileSystem protected () extends SynchronousFileSystem {
    ...
    def _syncSync(p: String, data: Buffer, stats: typingsSlinky.browserfs.nodeFsStatsMod.default): Unit = js.native
