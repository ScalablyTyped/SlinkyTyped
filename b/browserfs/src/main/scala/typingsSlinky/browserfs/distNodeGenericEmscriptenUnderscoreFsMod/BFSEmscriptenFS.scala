...
import typingsSlinky.browserfs.Anon_0
...
trait BFSEmscriptenFS extends EmscriptenFS {
  ...
  var flagsToPermissionStringMap: Anon_0 = js.native
  ...
  def getNodeFS(): typingsSlinky.browserfs.distNodeCoreFSMod.default = js.native
