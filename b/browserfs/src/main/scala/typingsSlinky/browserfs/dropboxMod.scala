...
object dropboxMod {
  ...
  class DropboxFile protected ()
    extends typingsSlinky.browserfs.preloadFileMod.default[DropboxFileSystem]
       with File {
    def this(
  ...
  trait DropboxFileSystem
    ...
    /**
      ...
      */
    def convert(err: ApiError): typingsSlinky.browserfs.apiErrorMod.ApiError = js.native
    def convert(err: ApiError, path: String): typingsSlinky.browserfs.apiErrorMod.ApiError = js.native
