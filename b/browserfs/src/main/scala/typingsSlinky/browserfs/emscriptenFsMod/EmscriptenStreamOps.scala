...
object EmscriptenStreamOps {
  ...
  implicit class EmscriptenStreamOpsOps[Self <: EmscriptenStreamOps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRead(value: (EmscriptenStream, js.typedarray.Uint8Array, Double, Double, Double) => Double): Self = this.set("read", js.Any.fromFunction5(value))
    
    @scala.inline
    def setWrite(value: (EmscriptenStream, js.typedarray.Uint8Array, Double, Double, Double) => Double): Self = this.set("write", js.Any.fromFunction5(value))
  }
}
