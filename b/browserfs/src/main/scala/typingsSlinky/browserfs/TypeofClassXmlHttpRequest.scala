...
import typingsSlinky.browserfs.distNodeBackendXmlHttpRequestMod.XmlHttpRequest
import typingsSlinky.browserfs.distNodeBackendXmlHttpRequestMod.XmlHttpRequestOptions
import typingsSlinky.browserfs.distNodeBackendXmlHttpRequestMod.default
