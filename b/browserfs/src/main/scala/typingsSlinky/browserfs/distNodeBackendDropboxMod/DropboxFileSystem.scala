package typingsSlinky.browserfs.distNodeBackendDropboxMod
...
import typingsSlinky.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.FileType
...
trait DropboxFileSystem
  ...
  /**
    ...
    */
  def convert(err: ApiError): typingsSlinky.browserfs.distNodeCoreApiUnderscoreErrorMod.ApiError = js.native
  def convert(err: ApiError, path: String): typingsSlinky.browserfs.distNodeCoreApiUnderscoreErrorMod.ApiError = js.native
  /* InferMemberOverrides */
