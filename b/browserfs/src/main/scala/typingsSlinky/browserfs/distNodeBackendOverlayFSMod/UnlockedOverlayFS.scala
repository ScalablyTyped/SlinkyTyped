...
class UnlockedOverlayFS protected ()
  ...
  def _syncAsync(
    file: typingsSlinky.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[UnlockedOverlayFS],
    cb: BFSOneArgCallback
  ): Unit = js.native
  def _syncSync(file: typingsSlinky.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[UnlockedOverlayFS]): Unit = js.native
