...
trait Typeofbuffer extends js.Object {
  ...
  var SlowBuffer: (Instantiable1[/* size */ Double, typingsSlinky.node.bufferMod.SlowBuffer]) with AnonInstantiable = js.native
  val constants: AnonMAXLENGTH = js.native
...
object Typeofbuffer {
  ...
  implicit class TypeofbufferOps[Self <: Typeofbuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSlowBuffer(value: (Instantiable1[/* size */ Double, SlowBuffer]) with AnonInstantiable): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SlowBuffer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withConstants(value: AnonMAXLENGTH): Self = {
        val ret = this.duplicate
