...
object fileFlagMod {
  ...
  object ActionType extends StObject {
    ...
    /* 3 */ val CREATE_FILE: typingsSlinky.browserfs.fileFlagMod.ActionType.CREATE_FILE with Double = js.native
    
    @js.native
    sealed trait NOP extends ActionType
    /* 0 */ val NOP: typingsSlinky.browserfs.fileFlagMod.ActionType.NOP with Double = js.native
    
    @js.native
    sealed trait THROW_EXCEPTION extends ActionType
    /* 1 */ val THROW_EXCEPTION: typingsSlinky.browserfs.fileFlagMod.ActionType.THROW_EXCEPTION with Double = js.native
    
    @js.native
    sealed trait TRUNCATE_FILE extends ActionType
    /* 2 */ val TRUNCATE_FILE: typingsSlinky.browserfs.fileFlagMod.ActionType.TRUNCATE_FILE with Double = js.native
  }
