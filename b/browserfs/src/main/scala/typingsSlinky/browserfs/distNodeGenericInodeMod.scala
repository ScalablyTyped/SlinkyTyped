...
object distNodeGenericInodeMod extends js.Object {
  ...
  trait Inode extends js.Object {
    ...
    /**
      ...
      */
    def toStats(): typingsSlinky.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default = js.native
    /**
      ...
      */
    def update(stats: typingsSlinky.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default): Boolean = js.native
  }
