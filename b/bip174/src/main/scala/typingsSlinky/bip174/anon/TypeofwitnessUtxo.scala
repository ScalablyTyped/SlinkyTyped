...
object TypeofwitnessUtxo {
  ...
  implicit class TypeofwitnessUtxoOps[Self <: TypeofwitnessUtxo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCheck(value: js.Any => /* is bip174.bip174/src/lib/interfaces.WitnessUtxo */ Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDecode(value: KeyValue => WitnessUtxo): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("decode")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEncode(value: WitnessUtxo => KeyValue): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encode")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withExpected(value: /* "{ script: Buffer; value: number; }" */ String): Self = {
        val ret = this.duplicate
