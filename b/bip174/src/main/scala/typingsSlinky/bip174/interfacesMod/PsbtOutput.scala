...
object PsbtOutput {
  ...
  implicit class PsbtOutputOps[Self <: PsbtOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUnknownKeyVals(value: js.Array[KeyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unknownKeyVals")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUnknownKeyVals: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unknownKeyVals")(js.undefined)
        ret
    }
  }
