...
object bitwiseNumbers {
  
  @js.native
  sealed trait `0`
    extends Bit
       with typingsSlinky.bitwise.bitwiseTypesMod.Bit
       with UInt4
       with typingsSlinky.bitwise.bitwiseTypesMod.UInt4
       with UInt8
       with typingsSlinky.bitwise.bitwiseTypesMod.UInt8
  @scala.inline
