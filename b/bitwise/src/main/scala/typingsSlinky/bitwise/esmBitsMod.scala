...
object esmBitsMod {
  ...
  object default {
    ...
    @JSImport("bitwise/esm/bits", "default.xnor")
    @js.native
    def xnor(bits1: js.Array[Bit], bits2: js.Array[Bit]): js.Array[Bit] = js.native
    
    @JSImport("bitwise/esm/bits", "default.xor")
    @js.native
