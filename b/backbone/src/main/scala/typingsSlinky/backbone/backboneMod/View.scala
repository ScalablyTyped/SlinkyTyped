...
class View[TModel /* <: Model */] () extends js.Object {
  ...
  def setElement(element: JQuery[typingsSlinky.std.HTMLElement]): View[TModel] = js.native
  def setElement(element: JQuery[typingsSlinky.std.HTMLElement], delegate: Boolean): View[TModel] = js.native
