package typingsSlinky.bricksJs

import org.scalajs.dom.raw.Node
import typingsSlinky.bricksJs.bricksJsStrings.pack
import typingsSlinky.bricksJs.bricksJsStrings.resize
import typingsSlinky.bricksJs.bricksJsStrings.update
...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContainerNode(value: Node): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
