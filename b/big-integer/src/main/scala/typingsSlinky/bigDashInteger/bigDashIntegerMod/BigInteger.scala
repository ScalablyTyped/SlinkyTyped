package typingsSlinky.bigDashInteger.bigDashIntegerMod

import typingsSlinky.bigDashInteger.Anon_Quotient
...
trait BigInteger extends js.Object {
  ...
  /**
    ...
    */
  def divmod(number: BigNumber): Anon_Quotient = js.native
  /**
