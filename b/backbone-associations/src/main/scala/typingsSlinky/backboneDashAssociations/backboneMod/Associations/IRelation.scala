package typingsSlinky.backboneDashAssociations.backboneMod.Associations
...
trait IRelation extends js.Object {
  ...
  var relatedModel: String | Instantiable0[typingsSlinky.backboneDashAssociations.backboneMod.Associations.AssociatedModel]
...
object IRelation {
  ...
  def apply(
    key: String,
    relatedModel: String | Instantiable0[typingsSlinky.backboneDashAssociations.backboneMod.Associations.AssociatedModel],
    `type`: String,
