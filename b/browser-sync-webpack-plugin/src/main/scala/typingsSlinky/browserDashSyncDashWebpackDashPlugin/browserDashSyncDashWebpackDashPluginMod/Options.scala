package typingsSlinky.browserDashSyncDashWebpackDashPlugin.browserDashSyncDashWebpackDashPluginMod

import typingsSlinky.browserDashSync.browserDashSyncMod.BrowserSyncInstance
...
object Options {
  @scala.inline
  def apply(
    callback: (/* error */ js.Error, /* bs */ BrowserSyncInstance) => Unit = null,
