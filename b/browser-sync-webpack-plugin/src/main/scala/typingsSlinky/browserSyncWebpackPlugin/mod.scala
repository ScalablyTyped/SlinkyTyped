package typingsSlinky.browserSyncWebpackPlugin
...
object mod {
  ...
  class ^ protected () extends Plugin {
    def this(browserSyncOptions: typingsSlinky.browserSync.mod.Options) = this()
    def this(browserSyncOptions: typingsSlinky.browserSync.mod.Options, pluginOptions: Options) = this()
  }
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCallback(value: (/* error */ js.Error, /* bs */ BrowserSyncInstance) => Unit): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
