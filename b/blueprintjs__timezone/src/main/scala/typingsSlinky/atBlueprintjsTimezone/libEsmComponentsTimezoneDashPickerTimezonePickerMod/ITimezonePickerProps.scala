...
trait ITimezonePickerProps extends IProps {
  ...
  var valueDisplayFormat: js.UndefOr[
    typingsSlinky.atBlueprintjsTimezone.libEsmComponentsTimezoneDashPickerTimezoneDisplayFormatMod.TimezoneDisplayFormat
  ] = js.undefined
  /**
...
object ITimezonePickerProps {
  ...
  def apply(
    ...
    value: String = null,
    valueDisplayFormat: typingsSlinky.atBlueprintjsTimezone.libEsmComponentsTimezoneDashPickerTimezoneDisplayFormatMod.TimezoneDisplayFormat = null
