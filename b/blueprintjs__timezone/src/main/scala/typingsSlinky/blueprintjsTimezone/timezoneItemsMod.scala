...
object timezoneItemsMod {
  ...
  @js.native
  def getInitialTimezoneItems(date: js.Date, includeLocalTimezone: Boolean): js.Array[ITimezoneItem] = js.native
  
  @JSImport("@blueprintjs/timezone/lib/esm/components/timezone-picker/timezoneItems", "getLocalTimezoneItem")
  @js.native
  def getLocalTimezoneItem(date: js.Date): js.UndefOr[ITimezoneItem] = js.native
  
  @JSImport("@blueprintjs/timezone/lib/esm/components/timezone-picker/timezoneItems", "getTimezoneItems")
  @js.native
  def getTimezoneItems(date: js.Date): js.Array[ITimezoneItem] = js.native
