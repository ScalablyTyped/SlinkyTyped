...
trait ITimezonePickerProps extends IProps {
  ...
  /**
    ...
    */
  var valueDisplayFormat: js.UndefOr[typingsSlinky.blueprintjsTimezone.timezoneDisplayFormatMod.TimezoneDisplayFormat] = js.undefined
  /**
...
object ITimezonePickerProps {
  ...
  def apply(
    ...
    value: String = null,
    valueDisplayFormat: typingsSlinky.blueprintjsTimezone.timezoneDisplayFormatMod.TimezoneDisplayFormat = null
