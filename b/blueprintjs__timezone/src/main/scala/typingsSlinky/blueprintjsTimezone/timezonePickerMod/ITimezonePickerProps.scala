...
object ITimezonePickerProps {
  ...
  implicit class ITimezonePickerPropsOps[Self <: ITimezonePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueDisplayFormat(value: typingsSlinky.blueprintjsTimezone.timezoneDisplayFormatMod.TimezoneDisplayFormat): Self = this.set("valueDisplayFormat", value.asInstanceOf[js.Any])
    @scala.inline
