...
trait DotsProps extends js.Object {
  ...
  var thumbnails: js.UndefOr[js.Array[ReactElement]] = js.native
...
object DotsProps {
  ...
  implicit class DotsPropsOps[Self <: DotsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setThumbnailsVarargs(value: ReactElement*): Self = this.set("thumbnails", js.Array(value :_*))
    @scala.inline
    def setThumbnails(value: js.Array[ReactElement]): Self = this.set("thumbnails", value.asInstanceOf[js.Any])
    @scala.inline
