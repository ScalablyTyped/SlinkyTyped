...
object AfterCarouselItems {
  ...
  implicit class AfterCarouselItemsOps[Self <: AfterCarouselItems] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterCarouselItems(value: () => ReactElement): Self = this.set("afterCarouselItems", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteAfterCarouselItems: Self = this.set("afterCarouselItems", js.undefined)
    
    @scala.inline
    def setBeforeCarouselItems(value: () => ReactElement): Self = this.set("beforeCarouselItems", js.Any.fromFunction0(value))
