...
import typingsSlinky.brainhubeuReactCarousel.mod.PluginStrategy
...
object anon {
  ...
  trait AfterCarouselItems extends StObject {
    ...
    var afterCarouselItems: js.UndefOr[js.Function0[ReactElement]] = js.native
    
    var beforeCarouselItems: js.UndefOr[js.Function0[ReactElement]] = js.native
  ...
  object AfterCarouselItems {
    ...
    implicit class AfterCarouselItemsMutableBuilder[Self <: AfterCarouselItems] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAfterCarouselItems(value: () => ReactElement): Self = StObject.set(x, "afterCarouselItems", js.Any.fromFunction0(value))
      
      @scala.inline
      def setAfterCarouselItemsUndefined: Self = StObject.set(x, "afterCarouselItems", js.undefined)
      
      @scala.inline
      def setBeforeCarouselItems(value: () => ReactElement): Self = StObject.set(x, "beforeCarouselItems", js.Any.fromFunction0(value))
  ...
  object CarouselProps {
    ...
    implicit class CarouselPropsMutableBuilder[Self <: CarouselProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCarouselProps(value: typingsSlinky.brainhubeuReactCarousel.mod.CarouselProps): Self = StObject.set(x, "carouselProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRefs(value: Record[String, ReactRef[HTMLElement]]): Self = StObject.set(x, "refs", value.asInstanceOf[js.Any])
    }
  }
  ...
  object PickCarouselPropsExcludek {
    ...
    implicit class PickCarouselPropsExcludekMutableBuilder[Self <: PickCarouselPropsExcludek] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSlides(value: js.Array[ReactElement]): Self = StObject.set(x, "slides", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSlidesUndefined: Self = StObject.set(x, "slides", js.undefined)
      
      @scala.inline
      def setSlidesVarargs(value: ReactElement*): Self = StObject.set(x, "slides", js.Array(value :_*))
