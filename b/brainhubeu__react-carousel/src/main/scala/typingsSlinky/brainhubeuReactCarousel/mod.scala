...
import typingsSlinky.brainhubeuReactCarousel.anon.AfterCarouselItems
...
object mod {
  ...
  type CarouselPluginFunc = js.Function1[
    /* hasOptionsCarouselPropsRefs */ typingsSlinky.brainhubeuReactCarousel.anon.CarouselProps, 
    AfterCarouselItems
  ]
  ...
  object CarouselPluginTypes {
    ...
    @scala.inline
    def apply(
      resolve: /* hasOptionsCarouselPropsRefs */ typingsSlinky.brainhubeuReactCarousel.anon.CarouselProps => AfterCarouselItems
    ): CarouselPluginTypes = {
    ...
    implicit class CarouselPluginTypesMutableBuilder[Self <: CarouselPluginTypes] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResolve(
        value: /* hasOptionsCarouselPropsRefs */ typingsSlinky.brainhubeuReactCarousel.anon.CarouselProps => AfterCarouselItems
  ...
  object DotsProps {
    ...
    implicit class DotsPropsMutableBuilder[Self <: DotsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setThumbnails(value: js.Array[ReactElement]): Self = StObject.set(x, "thumbnails", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setThumbnailsUndefined: Self = StObject.set(x, "thumbnails", js.undefined)
      
      @scala.inline
      def setThumbnailsVarargs(value: ReactElement*): Self = StObject.set(x, "thumbnails", js.Array(value :_*))
