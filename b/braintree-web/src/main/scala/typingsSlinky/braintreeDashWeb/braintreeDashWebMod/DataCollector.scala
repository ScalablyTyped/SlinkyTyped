...
import typingsSlinky.braintreeDashWeb.Anon_ClientKount
...
trait DataCollector extends js.Object {
  ...
  /**
    ...
    * @returns {void}
    */
  def create(options: Anon_ClientKount): js.Promise[DataCollector] = js.native
  def create(options: Anon_ClientKount, callback: callback): Unit = js.native
  /**
    * @memberof DataCollector
    * @name teardown
    * @function
