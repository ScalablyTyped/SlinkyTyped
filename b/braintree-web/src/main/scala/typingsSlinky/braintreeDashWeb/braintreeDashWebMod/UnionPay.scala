...
import typingsSlinky.braintreeDashWeb.Anon_Card
import typingsSlinky.braintreeDashWeb.Anon_CardEnrollmentId
import typingsSlinky.braintreeDashWeb.Anon_CardHostedFields
import typingsSlinky.braintreeDashWeb.Anon_Client
...
trait UnionPay extends js.Object {
  ...
  /**
    ...
    * @returns {void}
    */
  def enroll(options: Anon_CardHostedFields, callback: callback): Unit = js.native
  /**
    ...
    * @returns {void}
    */
  def fetchCapabilities(options: Anon_Card, callback: callback): Unit = js.native
  /**
