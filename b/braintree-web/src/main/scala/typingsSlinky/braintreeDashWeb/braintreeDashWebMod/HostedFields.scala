...
import typingsSlinky.braintreeDashWeb.Anon_BillingAddress
import typingsSlinky.braintreeDashWeb.Anon_ClientFields
...
trait HostedFields extends js.Object {
  ...
  /**
    ...
    * }, callback);
    */
  def create(options: Anon_ClientFields): js.Promise[HostedFields] = js.native
  def create(options: Anon_ClientFields, callback: callback): Unit = js.native
  /**
  ...
  /**
    ...
    * @returns {void}
    */
  def on(event: String, handler: js.Function1[/* event */ HostedFieldsStateObject, Unit]): Unit = js.native
  /**
