package typingsSlinky.builderDashUtilDashRuntime.outHttpExecutorMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.builderDashUtilDashRuntime.builderDashUtilDashRuntimeNumbers.`10`
import typingsSlinky.builderDashUtilDashRuntime.outCancellationTokenMod.CancellationToken
...
abstract class HttpExecutor[REQUEST] () extends js.Object {
  ...
  def downloadToBuffer(url: URL, options: DownloadOptions): js.Promise[Buffer] = js.native
