...
object publishOptionsMod {
  ...
  */
  ...
  object _AllPublishOptions {
    ...
    @scala.inline
    def BintrayOptions(provider: bintray): typingsSlinky.builderUtilRuntime.publishOptionsMod.BintrayOptions = {
      val __obj = js.Dynamic.literal(provider = provider.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.builderUtilRuntime.publishOptionsMod.BintrayOptions]
    }
    
    @scala.inline
    def CustomPublishOptions(provider: PublishProvider): typingsSlinky.builderUtilRuntime.publishOptionsMod.CustomPublishOptions = {
      val __obj = js.Dynamic.literal(provider = provider.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.builderUtilRuntime.publishOptionsMod.CustomPublishOptions]
    }
    
    @scala.inline
    def GenericServerOptions(provider: generic, url: String): typingsSlinky.builderUtilRuntime.publishOptionsMod.GenericServerOptions = {
      val __obj = js.Dynamic.literal(provider = provider.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.builderUtilRuntime.publishOptionsMod.GenericServerOptions]
    }
    
    @scala.inline
    def GithubOptions(provider: github): typingsSlinky.builderUtilRuntime.publishOptionsMod.GithubOptions = {
      val __obj = js.Dynamic.literal(provider = provider.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.builderUtilRuntime.publishOptionsMod.GithubOptions]
    }
    
    @scala.inline
    def S3Options(bucket: String, provider: s3): typingsSlinky.builderUtilRuntime.publishOptionsMod.S3Options = {
      val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any], provider = provider.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.builderUtilRuntime.publishOptionsMod.S3Options]
    }
    
    @scala.inline
    def SpacesOptions(name: String, provider: spaces, region: String): typingsSlinky.builderUtilRuntime.publishOptionsMod.SpacesOptions = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], provider = provider.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.builderUtilRuntime.publishOptionsMod.SpacesOptions]
    }
  }
}
