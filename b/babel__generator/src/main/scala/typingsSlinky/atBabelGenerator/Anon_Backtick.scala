...
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.backtick
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.binary
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.decimal
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.double
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.hexadecimal
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.octal
import typingsSlinky.atBabelGenerator.atBabelGeneratorStrings.single
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Anon_Backtick extends js.Object {
  /**
...
object Anon_Backtick {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Anon_Backtick]
  }
}
