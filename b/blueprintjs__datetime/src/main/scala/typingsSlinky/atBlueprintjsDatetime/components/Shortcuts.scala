...
object Shortcuts
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsDatetime.libEsmShortcutsMod.Shortcuts] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsDatetime.libEsmShortcutsMod.Shortcuts] = {
