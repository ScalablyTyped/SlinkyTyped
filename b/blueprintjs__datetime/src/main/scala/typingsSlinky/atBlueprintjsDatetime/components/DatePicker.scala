...
object DatePicker
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsDatetime.libEsmDatePickerMod.DatePicker] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsDatetime.libEsmDatePickerMod.DatePicker] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsDatetime.libEsmDatePickerMod.DatePicker] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.atBlueprintjsDatetime.libEsmDatePickerMod.DatePicker](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
