...
object PartialIDateInputProps {
  ...
  implicit class PartialIDateInputPropsOps[Self <: PartialIDateInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatDate(value: (/* date */ js.Date, /* locale */ js.UndefOr[String]) => String): Self = this.set("formatDate", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnError(value: /* errorDate */ js.Date => Unit): Self = this.set("onError", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setParseDate(value: (/* str */ String, /* locale */ js.UndefOr[String]) => js.Date | `false` | Null): Self = this.set("parseDate", js.Any.fromFunction2(value))
