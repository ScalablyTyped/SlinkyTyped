...
object ITimePickerProps {
  ...
  implicit class ITimePickerPropsOps[Self <: ITimePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxTime(value: js.Date): Self = this.set("maxTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaxTime: Self = this.set("maxTime", js.undefined)
    
    @scala.inline
    def setMinTime(value: js.Date): Self = this.set("minTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinTime: Self = this.set("minTime", js.undefined)
    
    @scala.inline
    def setOnBlur(value: (/* event */ SyntheticFocusEvent[HTMLInputElement], /* unit */ TimeUnit) => Unit): Self = this.set("onBlur", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnBlur: Self = this.set("onBlur", js.undefined)
    
    @scala.inline
    def setOnChange(value: /* newTime */ js.Date => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    
    @scala.inline
    def setOnFocus(value: (/* event */ SyntheticFocusEvent[HTMLInputElement], /* unit */ TimeUnit) => Unit): Self = this.set("onFocus", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnFocus: Self = this.set("onFocus", js.undefined)
    
    @scala.inline
    def setOnKeyDown(value: (/* event */ SyntheticKeyboardEvent[HTMLInputElement], /* unit */ TimeUnit) => Unit): Self = this.set("onKeyDown", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnKeyDown: Self = this.set("onKeyDown", js.undefined)
    
    @scala.inline
    def setOnKeyUp(value: (/* event */ SyntheticKeyboardEvent[HTMLInputElement], /* unit */ TimeUnit) => Unit): Self = this.set("onKeyUp", js.Any.fromFunction2(value))
