...
object dateRangeInputMod {
  ...
  object IDateRangeInputState {
    ...
    implicit class IDateRangeInputStateMutableBuilder[Self <: IDateRangeInputState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelectedEnd(value: js.Date): Self = StObject.set(x, "selectedEnd", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectedStart(value: js.Date): Self = StObject.set(x, "selectedStart", value.asInstanceOf[js.Any])
