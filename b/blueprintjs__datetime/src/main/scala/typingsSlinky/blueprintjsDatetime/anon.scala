...
object anon {
  ...
  object PartialIDateInputProps {
    ...
    implicit class PartialIDateInputPropsMutableBuilder[Self <: PartialIDateInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormatDate(value: (/* date */ js.Date, /* locale */ js.UndefOr[String]) => String): Self = StObject.set(x, "formatDate", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnError(value: /* errorDate */ js.Date => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setParseDate(value: (/* str */ String, /* locale */ js.UndefOr[String]) => js.Date | `false` | Null): Self = StObject.set(x, "parseDate", js.Any.fromFunction2(value))
