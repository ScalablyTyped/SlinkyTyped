...
object IDateRangeInputState {
  ...
  implicit class IDateRangeInputStateOps[Self <: IDateRangeInputState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectedEnd(value: js.Date): Self = this.set("selectedEnd", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSelectedStart(value: js.Date): Self = this.set("selectedStart", value.asInstanceOf[js.Any])
    @scala.inline
