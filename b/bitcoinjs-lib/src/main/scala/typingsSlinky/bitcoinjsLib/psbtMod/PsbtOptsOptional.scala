...
object PsbtOptsOptional {
  ...
  implicit class PsbtOptsOptionalOps[Self <: PsbtOptsOptional] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaximumFeeRate(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maximumFeeRate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaximumFeeRate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maximumFeeRate")(js.undefined)
        ret
    }
    @scala.inline
