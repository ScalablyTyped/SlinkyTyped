...
trait ArrayOptions extends Options {
  ...
  var `type`: String | typingsSlinky.binaryParser.mod.Parser[_]
}

object ArrayOptions {
  @scala.inline
  def apply(
    `type`: String | typingsSlinky.binaryParser.mod.Parser[_],
    assert: String | Double | (js.Function1[/* value */ Data, Boolean]) = null,
    formatter: /* value */ Data => _ = null,
    length: Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryParser.mod.Parser[_], Double]) = null,
    lengthInBytes: Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryParser.mod.Parser[_], Double]) = null,
