...
object ArrayOptions {
  ...
  implicit class ArrayOptionsOps[Self <: ArrayOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | typingsSlinky.binaryParser.mod.Parser[_]): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setLength(
    ...
    @scala.inline
    def setLengthInBytes(
      value: Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryParser.mod.Parser[_], Double])
    ): Self = this.set("lengthInBytes", value.asInstanceOf[js.Any])
    @scala.inline
