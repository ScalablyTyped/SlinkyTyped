...
object ChoiceOptions {
  ...
  implicit class ChoiceOptionsOps[Self <: ChoiceOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChoices(value: NumberDictionary[typingsSlinky.binaryParser.mod.Parser[_] | String]): Self = this.set("choices", value.asInstanceOf[js.Any])
    @scala.inline
    def setTag(value: String | (js.ThisFunction0[/* this */ typingsSlinky.binaryParser.mod.Parser[_], Double])): Self = this.set("tag", value.asInstanceOf[js.Any])
    @scala.inline
    def setDefaultChoice(value: typingsSlinky.binaryParser.mod.Parser[_] | String): Self = this.set("defaultChoice", value.asInstanceOf[js.Any])
    @scala.inline
