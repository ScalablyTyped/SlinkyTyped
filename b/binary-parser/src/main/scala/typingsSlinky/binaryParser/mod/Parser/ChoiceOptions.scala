...
trait ChoiceOptions extends Options {
  var choices: NumberDictionary[typingsSlinky.binaryParser.mod.Parser[_] | String]
  var defaultChoice: js.UndefOr[typingsSlinky.binaryParser.mod.Parser[_] | String] = js.undefined
  var tag: String | (js.ThisFunction0[/* this */ typingsSlinky.binaryParser.mod.Parser[_], Double])
}
...
object ChoiceOptions {
  ...
  def apply(
    ...
    defaultChoice: typingsSlinky.binaryParser.mod.Parser[_] | String = null,
