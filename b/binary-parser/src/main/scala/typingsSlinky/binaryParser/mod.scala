...
import typingsSlinky.binaryParser.mod.Parser.ArrayOptions
import typingsSlinky.binaryParser.mod.Parser.BufferOptions
import typingsSlinky.binaryParser.mod.Parser.ChoiceOptions
import typingsSlinky.binaryParser.mod.Parser.Endianness
import typingsSlinky.binaryParser.mod.Parser.NestOptions
import typingsSlinky.binaryParser.mod.Parser.Next
import typingsSlinky.binaryParser.mod.Parser.Options
import typingsSlinky.binaryParser.mod.Parser.Parsed
import typingsSlinky.binaryParser.mod.Parser.StringOptions
...
object mod {
  ...
  object Parser extends Shortcut {
    ...
    */
    ...
    {[ name in N ]: T}
      */ typingsSlinky.binaryParser.binaryParserStrings.Next with TopLevel[js.Any]
        ]
      ]
