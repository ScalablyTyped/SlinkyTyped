package typingsSlinky.binaryParser.anon
...
object Type {
  ...
  implicit class TypeOps[Self <: Type] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: /* import warning: importer.ImportType#apply Failed type conversion: infer T */ js.Any): Self = this.set("type", value.asInstanceOf[js.Any])
  }
