...
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.ArrayOptions
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.BufferOptions
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.ChoiceOptions
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.Endianness
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.NestOptions
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.Next
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.Options
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.Parsed
import typingsSlinky.binaryDashParser.binaryDashParserMod.Parser.StringOptions
...
trait Parser_[O /* <: js.UndefOr[js.Object] */] extends js.Object {
  ...
  def parse(
    buffer: Buffer,
    callback: js.Function2[/* err */ js.UndefOr[js.Error], /* result */ js.UndefOr[js.Any], Unit]
  ): Parsed[O] = js.native
