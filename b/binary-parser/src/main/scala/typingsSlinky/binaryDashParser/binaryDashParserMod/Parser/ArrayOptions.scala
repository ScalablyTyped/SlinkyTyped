...
trait ArrayOptions extends Options {
  var length: js.UndefOr[
    Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryDashParser.binaryDashParserMod.Parser[_], Double])
  ] = js.undefined
  var lengthInBytes: js.UndefOr[
    Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryDashParser.binaryDashParserMod.Parser[_], Double])
  ] = js.undefined
  var readUntil: js.UndefOr[String | (js.Function2[/* item */ Double, /* buffer */ Buffer, Boolean])] = js.undefined
  var `type`: String | typingsSlinky.binaryDashParser.binaryDashParserMod.Parser[_]
}

object ArrayOptions {
  @scala.inline
  def apply(
    `type`: String | typingsSlinky.binaryDashParser.binaryDashParserMod.Parser[_],
    assert: String | Double | (js.Function1[/* value */ Data, Boolean]) = null,
    formatter: /* value */ Data => _ = null,
    length: Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryDashParser.binaryDashParserMod.Parser[_], Double]) = null,
    lengthInBytes: Double | String | (js.ThisFunction0[/* this */ typingsSlinky.binaryDashParser.binaryDashParserMod.Parser[_], Double]) = null,
