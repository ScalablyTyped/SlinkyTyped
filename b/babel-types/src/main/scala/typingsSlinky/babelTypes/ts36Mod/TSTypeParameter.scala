...
trait TSTypeParameter extends Node {
  ...
  @JSName("type")
  var type_TSTypeParameter: typingsSlinky.babelTypes.babelTypesStrings.TSTypeParameter = js.native
}
object TSTypeParameter {
  ...
  implicit class TSTypeParameterMutableBuilder[Self <: TSTypeParameter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.babelTypes.babelTypesStrings.TSTypeParameter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
