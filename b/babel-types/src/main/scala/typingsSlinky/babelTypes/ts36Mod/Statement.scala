...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.babelTypes.ts36Mod.DebuggerStatement_
  - typingsSlinky.babelTypes.ts36Mod.DoWhileStatement_
  - typingsSlinky.babelTypes.ts36Mod.EmptyStatement_
  ...
  - typingsSlinky.babelTypes.ts36Mod.TSExportAssignment
  - typingsSlinky.babelTypes.ts36Mod.TSImportEqualsDeclaration
  - typingsSlinky.babelTypes.ts36Mod.TSInterfaceDeclaration
  - typingsSlinky.babelTypes.ts36Mod.TSModuleDeclaration
  - typingsSlinky.babelTypes.ts36Mod.TSNamespaceExportDeclaration
