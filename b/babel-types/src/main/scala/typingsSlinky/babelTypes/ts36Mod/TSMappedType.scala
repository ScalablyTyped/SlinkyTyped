...
trait TSMappedType
  ...
  @JSName("type")
  var type_TSMappedType: typingsSlinky.babelTypes.babelTypesStrings.TSMappedType = js.native
}
object TSMappedType {
  ...
  implicit class TSMappedTypeMutableBuilder[Self <: TSMappedType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.babelTypes.babelTypesStrings.TSMappedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
