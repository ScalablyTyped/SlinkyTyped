...
trait TSTypePredicate
  ...
  @JSName("type")
  var type_TSTypePredicate: typingsSlinky.babelTypes.babelTypesStrings.TSTypePredicate = js.native
}
object TSTypePredicate {
  ...
  implicit class TSTypePredicateMutableBuilder[Self <: TSTypePredicate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.babelTypes.babelTypesStrings.TSTypePredicate): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
