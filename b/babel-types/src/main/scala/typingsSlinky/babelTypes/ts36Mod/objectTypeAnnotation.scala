...
@JSImport("babel-types/ts3.6", "objectTypeAnnotation")
@js.native
object objectTypeAnnotation extends js.Object {
  ...
  def apply(properties: js.UndefOr[scala.Nothing], indexers: js.Array[ObjectTypeIndexer_]): ObjectTypeAnnotation_ = js.native
  def apply(
    properties: js.UndefOr[scala.Nothing],
