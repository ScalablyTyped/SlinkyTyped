...
@JSImport("babel-types/ts3.6", "functionTypeAnnotation")
@js.native
object functionTypeAnnotation extends js.Object {
  ...
  def apply(typeParameters: js.UndefOr[scala.Nothing], params: js.Array[FunctionTypeParam_]): FunctionTypeAnnotation_ = js.native
  def apply(
    typeParameters: js.UndefOr[scala.Nothing],
