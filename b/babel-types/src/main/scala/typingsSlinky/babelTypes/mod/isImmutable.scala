...
@JSImport("babel-types", "isImmutable")
@js.native
object isImmutable extends js.Object {
  def apply(): /* is babel-types.babel-types.Immutable */ Boolean = js.native
  def apply(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.Immutable */ Boolean = js.native
