...
object unaryExpression extends js.Object {
  ...
  def apply(operator: js.UndefOr[scala.Nothing], argument: Expression, prefix: Boolean): UnaryExpression_ = js.native
  def apply(operator: Exclamationmark): UnaryExpression_ = js.native
  def apply(operator: Exclamationmark, argument: js.UndefOr[scala.Nothing], prefix: Boolean): UnaryExpression_ = js.native
  ...
  def apply(operator: PlussignPlussign, argument: js.UndefOr[scala.Nothing], prefix: Boolean): UnaryExpression_ = js.native
  ...
  def apply(operator: Plussign, argument: js.UndefOr[scala.Nothing], prefix: Boolean): UnaryExpression_ = js.native
  ...
  def apply(operator: Tilde, argument: js.UndefOr[scala.Nothing], prefix: Boolean): UnaryExpression_ = js.native
  ...
  def apply(operator: `--`, argument: js.UndefOr[scala.Nothing], prefix: Boolean): UnaryExpression_ = js.native
  ...
  def apply(operator: `-_`, argument: js.UndefOr[scala.Nothing], prefix: Boolean): UnaryExpression_ = js.native
