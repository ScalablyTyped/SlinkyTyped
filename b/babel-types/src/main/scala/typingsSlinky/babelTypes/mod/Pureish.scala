...
object Pureish {
  ...
  @scala.inline
  implicit def apply(value: ClassDeclaration_): Pureish = value.asInstanceOf[Pureish]
  @scala.inline
  implicit def apply(value: ClassExpression_): Pureish = value.asInstanceOf[Pureish]
  @scala.inline
