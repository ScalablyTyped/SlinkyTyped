...
object objectTypeIndexer extends js.Object {
  ...
  def apply(id: js.UndefOr[scala.Nothing], key: FlowTypeAnnotation, value: FlowTypeAnnotation): ObjectTypeIndexer_ = js.native
  def apply(id: Expression): ObjectTypeIndexer_ = js.native
  def apply(id: Expression, key: js.UndefOr[scala.Nothing], value: FlowTypeAnnotation): ObjectTypeIndexer_ = js.native
