...
trait VariableDeclarator extends Node {
  ...
  var init: Expression
  @JSName("type")
  var type_VariableDeclarator: typingsSlinky.babelDashTypes.babelDashTypesStrings.VariableDeclarator
}
...
object VariableDeclarator {
  ...
  def apply(
    ...
    loc: SourceLocation,
    start: Double,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.VariableDeclarator,
