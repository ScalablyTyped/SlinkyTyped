...
trait DirectiveLiteral extends Node {
  @JSName("type")
  var type_DirectiveLiteral: typingsSlinky.babelDashTypes.babelDashTypesStrings.DirectiveLiteral
  var value: String
}
...
object DirectiveLiteral {
  ...
  def apply(
    ...
    loc: SourceLocation,
    start: Double,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.DirectiveLiteral,
    value: String,
