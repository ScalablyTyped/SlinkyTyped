...
trait JSXClosingElement
  ...
  @JSName("type")
  var type_JSXClosingElement: typingsSlinky.babelDashTypes.babelDashTypesStrings.JSXClosingElement
}
...
object JSXClosingElement {
  ...
  def apply(
    ...
    start: Double,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.JSXClosingElement,
