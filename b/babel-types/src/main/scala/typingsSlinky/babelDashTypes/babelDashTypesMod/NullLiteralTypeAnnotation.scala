...
trait NullLiteralTypeAnnotation extends Node {
  @JSName("type")
  var type_NullLiteralTypeAnnotation: typingsSlinky.babelDashTypes.babelDashTypesStrings.NullLiteralTypeAnnotation
}
...
object NullLiteralTypeAnnotation {
  ...
  def apply(
    ...
    loc: SourceLocation,
    start: Double,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.NullLiteralTypeAnnotation,
