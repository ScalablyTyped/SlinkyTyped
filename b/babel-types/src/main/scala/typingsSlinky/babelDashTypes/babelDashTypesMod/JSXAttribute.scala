...
trait JSXAttribute
  ...
  @JSName("type")
  var type_JSXAttribute: typingsSlinky.babelDashTypes.babelDashTypesStrings.JSXAttribute
...
object JSXAttribute {
  ...
  def apply(
    ...
    start: Double,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.JSXAttribute,
