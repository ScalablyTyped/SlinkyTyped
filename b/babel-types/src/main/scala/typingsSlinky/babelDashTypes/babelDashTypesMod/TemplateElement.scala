...
import typingsSlinky.babelDashTypes.Anon_Cooked
...
trait TemplateElement extends Node {
  var tail: Boolean
  @JSName("type")
  var type_TemplateElement: typingsSlinky.babelDashTypes.babelDashTypesStrings.TemplateElement
...
object TemplateElement {
  ...
  def apply(
    ...
    start: Double,
    tail: Boolean,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.TemplateElement,
    value: Anon_Cooked,
