...
trait JSXSpreadAttribute
  ...
  @JSName("type")
  var type_JSXSpreadAttribute: typingsSlinky.babelDashTypes.babelDashTypesStrings.JSXSpreadAttribute
}
...
object JSXSpreadAttribute {
  ...
  def apply(
    ...
    loc: SourceLocation,
    start: Double,
    `type`: typingsSlinky.babelDashTypes.babelDashTypesStrings.JSXSpreadAttribute,
