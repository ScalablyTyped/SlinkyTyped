...
trait LocalSearch extends StObject {
  ...
  def searchInBounds(keyword: String, bounds: Bounds, option: typingsSlinky.bmapgl.anon.CustomData): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds, option: typingsSlinky.bmapgl.anon.CustomData): Unit = js.native
  
  def searchNearby(keyword: String, center: String, radius: Double): Unit = js.native
  def searchNearby(keyword: String, center: String, radius: Double, option: typingsSlinky.bmapgl.anon.CustomData): Unit = js.native
  def searchNearby(keyword: String, center: LocalResultPoi, radius: Double): Unit = js.native
  def searchNearby(
    keyword: String,
    center: LocalResultPoi,
    radius: Double,
    option: typingsSlinky.bmapgl.anon.CustomData
  ): Unit = js.native
  def searchNearby(keyword: String, center: Point, radius: Double): Unit = js.native
  def searchNearby(keyword: String, center: Point, radius: Double, option: typingsSlinky.bmapgl.anon.CustomData): Unit = js.native
