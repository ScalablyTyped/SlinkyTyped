...
trait DragAndZoomTool extends StObject {
  ...
  def ondrawend(event: typingsSlinky.bmapgl.anon.Bounds): Unit = js.native
...
object DragAndZoomTool {
  ...
  @scala.inline
  def apply(close: () => Unit, ondrawend: typingsSlinky.bmapgl.anon.Bounds => Unit, open: () => Boolean): DragAndZoomTool = {
  ...
  implicit class DragAndZoomToolMutableBuilder[Self <: DragAndZoomTool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOndrawend(value: typingsSlinky.bmapgl.anon.Bounds => Unit): Self = StObject.set(x, "ondrawend", js.Any.fromFunction1(value))
