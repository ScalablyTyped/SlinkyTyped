...
trait Map extends js.Object {
  ...
  def onclick(event: typingsSlinky.bmapgl.anon.Overlay): Unit = js.native
  
  def ondblclick(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  
  def ondragend(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  
  def ondragging(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  
  def ondragstart(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  ...
  def onload(event: typingsSlinky.bmapgl.anon.Point): Unit = js.native
  
  def onlongpress(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  
  def onmaptypechange(event: Target): Unit = js.native
  
  def onmousemove(event: typingsSlinky.bmapgl.anon.Overlay): Unit = js.native
  ...
  def onresize(event: typingsSlinky.bmapgl.anon.Size): Unit = js.native
  
  def onrightclick(event: typingsSlinky.bmapgl.anon.Overlay): Unit = js.native
  
  def onrightdblclick(event: typingsSlinky.bmapgl.anon.Overlay): Unit = js.native
  
  def ontilesloaded(event: Target): Unit = js.native
  
  def ontouchend(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  
  def ontouchmove(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
  
  def ontouchstart(event: typingsSlinky.bmapgl.anon.Pixel): Unit = js.native
