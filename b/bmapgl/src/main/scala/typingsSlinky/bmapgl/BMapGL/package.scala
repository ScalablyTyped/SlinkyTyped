...
package object BMapGL {
  ...
  type GeolocationControl = typingsSlinky.bmapgl.BMapGL.Control
  ...
  type MapTypeControl = typingsSlinky.bmapgl.BMapGL.Control
  
  type MapTypeControlType = scala.Double
  
  type MercatorProjection = typingsSlinky.bmapgl.BMapGL.Projection
  
  type NavigationControl3D = typingsSlinky.bmapgl.BMapGL.Control
  
  type NavigationControlType = scala.Double
  
  type PanoramaControl = typingsSlinky.bmapgl.BMapGL.Control
  
  type PanoramaCoverageLayer = typingsSlinky.bmapgl.BMapGL.TileLayer
  
  type PanoramaPOIType = java.lang.String
  
  type PanoramaSceneType = java.lang.String
  
  type PerspectiveProjection = typingsSlinky.bmapgl.BMapGL.Projection
  ...
  type TrafficLayer = typingsSlinky.bmapgl.BMapGL.TileLayer
  
  type TransitPolicy = scala.Double
  
  type ZoomControl = typingsSlinky.bmapgl.BMapGL.Control
