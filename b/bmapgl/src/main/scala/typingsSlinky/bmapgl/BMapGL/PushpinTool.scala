...
trait PushpinTool extends StObject {
  ...
  def onmarkend(event: typingsSlinky.bmapgl.anon.Marker): Unit = js.native
...
object PushpinTool {
  ...
  def apply(
    ...
    getCursor: () => String,
    getIcon: () => Icon,
    onmarkend: typingsSlinky.bmapgl.anon.Marker => Unit,
    open: () => Boolean,
  ...
  implicit class PushpinToolMutableBuilder[Self <: PushpinTool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnmarkend(value: typingsSlinky.bmapgl.anon.Marker => Unit): Self = StObject.set(x, "onmarkend", js.Any.fromFunction1(value))
