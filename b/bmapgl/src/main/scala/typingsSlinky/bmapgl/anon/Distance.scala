...
import typingsSlinky.bmapgl.BMapGL.Polyline
...
trait Distance extends StObject {
  ...
  var points: js.Array[typingsSlinky.bmapgl.BMapGL.Point] = js.native
...
object Distance {
  ...
  def apply(
    distance: Double,
    points: js.Array[typingsSlinky.bmapgl.BMapGL.Point],
  ...
  implicit class DistanceMutableBuilder[Self <: Distance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoints(value: js.Array[typingsSlinky.bmapgl.BMapGL.Point]): Self = StObject.set(x, "points", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointsVarargs(value: typingsSlinky.bmapgl.BMapGL.Point*): Self = StObject.set(x, "points", js.Array(value :_*))
