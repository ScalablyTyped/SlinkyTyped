...
package object BMap {
  ...
  type GeolocationControl = typingsSlinky.baidumapWebSdk.BMap.Control
  ...
  type MapTypeControl = typingsSlinky.baidumapWebSdk.BMap.Control
  
  type MapTypeControlType = scala.Double
  
  type MercatorProjection = typingsSlinky.baidumapWebSdk.BMap.Projection
  
  type NavigationControlType = scala.Double
  
  type PanoramaControl = typingsSlinky.baidumapWebSdk.BMap.Control
  
  type PanoramaCoverageLayer = typingsSlinky.baidumapWebSdk.BMap.TileLayer
  
  type PanoramaPOIType = java.lang.String
  
  type PanoramaSceneType = java.lang.String
  
  type PerspectiveProjection = typingsSlinky.baidumapWebSdk.BMap.Projection
  ...
  type TrafficLayer = typingsSlinky.baidumapWebSdk.BMap.TileLayer
