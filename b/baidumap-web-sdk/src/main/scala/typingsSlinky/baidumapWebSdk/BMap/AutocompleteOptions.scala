...
object AutocompleteOptions {
  ...
  implicit class AutocompleteOptionsOps[Self <: AutocompleteOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInput(value: String | HTMLElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("input")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withLocation(value: String | Map | Point): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnSearchComplete(value: /* result */ AutocompleteResult => Unit): Self = {
        val ret = this.duplicate
