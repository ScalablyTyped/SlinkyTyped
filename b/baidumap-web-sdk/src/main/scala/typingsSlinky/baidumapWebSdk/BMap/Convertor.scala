...
import typingsSlinky.baidumapWebSdk.anon.Points
...
object Convertor {
  ...
  implicit class ConvertorOps[Self <: Convertor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTranslate(value: (js.Array[Point], Double, Double, js.Function1[/* result */ Points, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("translate")(js.Any.fromFunction4(value))
        ret
    }
  }
