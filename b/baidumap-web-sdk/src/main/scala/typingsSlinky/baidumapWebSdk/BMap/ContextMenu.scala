...
object ContextMenu {
  ...
  implicit class ContextMenuOps[Self <: ContextMenu] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnclose(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("onclose", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnopen(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("onopen", js.Any.fromFunction1(value))
