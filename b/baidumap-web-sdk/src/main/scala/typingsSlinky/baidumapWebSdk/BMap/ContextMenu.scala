...
object ContextMenu {
  ...
  implicit class ContextMenuMutableBuilder[Self <: ContextMenu] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnclose(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = StObject.set(x, "onclose", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnopen(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = StObject.set(x, "onopen", js.Any.fromFunction1(value))
