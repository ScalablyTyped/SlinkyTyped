...
trait LocalSearch extends js.Object {
  ...
  def searchInBounds(keyword: String, bounds: Bounds, option: typingsSlinky.baidumapWebSdk.anon.CustomData): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds, option: typingsSlinky.baidumapWebSdk.anon.CustomData): Unit = js.native
  def searchNearby(keyword: String, center: String, radius: Double): Unit = js.native
  def searchNearby(
    keyword: String,
    center: String,
    radius: Double,
    option: typingsSlinky.baidumapWebSdk.anon.CustomData
  ): Unit = js.native
