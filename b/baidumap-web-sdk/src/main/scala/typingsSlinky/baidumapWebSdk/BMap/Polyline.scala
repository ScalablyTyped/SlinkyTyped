...
trait Polyline extends Overlay {
  ...
  def ondblclick(event: typingsSlinky.baidumapWebSdk.anon.Pixel): Unit
  def onlineupdate(event: Target): Unit
  def onmousedown(event: typingsSlinky.baidumapWebSdk.anon.Pixel): Unit
  def onmouseout(event: typingsSlinky.baidumapWebSdk.anon.Pixel): Unit
  def onmouseover(event: typingsSlinky.baidumapWebSdk.anon.Pixel): Unit
  def onmouseup(event: typingsSlinky.baidumapWebSdk.anon.Pixel): Unit
