...
object Polyline {
  ...
  implicit class PolylineOps[Self <: Polyline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOndblclick(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("ondblclick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnlineupdate(value: Target => Unit): Self = this.set("onlineupdate", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnmousedown(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("onmousedown", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnmouseout(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("onmouseout", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnmouseover(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("onmouseover", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnmouseup(value: typingsSlinky.baidumapWebSdk.anon.Pixel => Unit): Self = this.set("onmouseup", js.Any.fromFunction1(value))
