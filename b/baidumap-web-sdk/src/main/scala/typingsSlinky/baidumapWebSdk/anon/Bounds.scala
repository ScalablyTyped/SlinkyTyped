...
object Bounds {
  ...
  implicit class BoundsOps[Self <: Bounds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundsVarargs(value: typingsSlinky.baidumapWebSdk.BMap.Bounds*): Self = this.set("bounds", js.Array(value :_*))
    @scala.inline
    def setBounds(value: js.Array[typingsSlinky.baidumapWebSdk.BMap.Bounds]): Self = this.set("bounds", value.asInstanceOf[js.Any])
    @scala.inline
