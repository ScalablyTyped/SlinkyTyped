...
object Distance {
  ...
  implicit class DistanceMutableBuilder[Self <: Distance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoints(value: js.Array[typingsSlinky.baidumapWebSdk.BMap.Point]): Self = StObject.set(x, "points", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointsVarargs(value: typingsSlinky.baidumapWebSdk.BMap.Point*): Self = StObject.set(x, "points", js.Array(value :_*))
