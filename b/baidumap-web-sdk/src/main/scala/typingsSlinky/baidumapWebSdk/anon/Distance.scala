...
object Distance {
  ...
  implicit class DistanceOps[Self <: Distance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPointsVarargs(value: typingsSlinky.baidumapWebSdk.BMap.Point*): Self = this.set("points", js.Array(value :_*))
    
    @scala.inline
    def setPoints(value: js.Array[typingsSlinky.baidumapWebSdk.BMap.Point]): Self = this.set("points", value.asInstanceOf[js.Any])
