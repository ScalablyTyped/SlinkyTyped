...
import typingsSlinky.baidumapWebSdk.BMap.PolylineOptions
...
class Polyline protected ()
  extends typingsSlinky.baidumapWebSdk.BMap.Polyline {
  def this(points: js.Array[typingsSlinky.baidumapWebSdk.BMap.Point]) = this()
  def this(points: js.Array[typingsSlinky.baidumapWebSdk.BMap.Point], opts: PolylineOptions) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def getPath(): js.Array[typingsSlinky.baidumapWebSdk.BMap.Point] = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def setPath(path: js.Array[typingsSlinky.baidumapWebSdk.BMap.Point]): Unit = js.native
  /* CompleteClass */
  override def setPointAt(index: Double, point: typingsSlinky.baidumapWebSdk.BMap.Point): Unit = js.native
  /* CompleteClass */
  override def setPositionAt(index: Double, point: typingsSlinky.baidumapWebSdk.BMap.Point): Unit = js.native
  /* CompleteClass */
