...
class Region ()
  ...
  /**
    ...
    */
  var currentView: typingsSlinky.backbone.backboneMod.View[Model] = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  def attachHtml(view: typingsSlinky.backbone.backboneMod.View[Model]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def destroyView[TModel /* <: Model */](view: typingsSlinky.backbone.backboneMod.View[TModel]): typingsSlinky.backbone.backboneMod.View[TModel] = js.native
  /**
  ...
  /**
    ...
    * view.
    */
  def detachView(): typingsSlinky.backbone.backboneMod.View[Model] = js.native
  /**
  ...
  /**
    ...
    */
  def removeView(view: typingsSlinky.backbone.backboneMod.View[Model]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def show(view: typingsSlinky.backbone.backboneMod.View[Model]): Unit = js.native
  def show(view: typingsSlinky.backbone.backboneMod.View[Model], options: RegionViewOptions): Unit = js.native
}
