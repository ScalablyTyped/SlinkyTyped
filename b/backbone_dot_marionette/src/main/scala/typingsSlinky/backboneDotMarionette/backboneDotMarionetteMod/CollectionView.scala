...
class CollectionView[TModel /* <: Model */, TView /* <: View[TModel] */, TCollection /* <: Collection[TModel] */] () extends View[TModel] {
  ...
  /**
    ...
    */
  var childView: (js.Function1[/* model */ TModel, Anon_Args[TView]]) | Anon_Args[TView] = js.native
  /**
  ...
  /**
    ...
    */
  var emptyView: js.Function0[Anon_ArgsAny[TModel]] | Anon_ArgsAny[TModel] = js.native
  /**
  ...
  /**
    ...
    */
  def buildChildView(child: TModel, childViewClass: Anon_Args[TView], childViewOptions: ViewOptions[TModel]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeFilter(options: Anon_PreventRender): Unit = js.native
  /**
