...
import typingsSlinky.backbone.backboneMod.EventsMixin
import typingsSlinky.backboneDotRadio.backboneDotRadioMod.Channel
...
class Object ()
  ...
  /**
    ...
    * object.
    */
  def bindRequests(channel: Channel, bindings: js.Any): Unit = js.native
  /**
  ...
  /**
    ...
    * object.
    */
  def unbindRequests(channel: Channel, bindings: js.Any): Unit = js.native
}
