...
object CollectionViewOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.backbone.mod.Model[_, typingsSlinky.backbone.mod.ModelSetOptions] */ TModel, /* <: typingsSlinky.backbone.mod.Collection[TModel] */ TCollection](): CollectionViewOptions[TModel, TCollection] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CollectionViewOptions[TModel, TCollection]]
  }
  @scala.inline
  implicit class CollectionViewOptionsOps[Self <: CollectionViewOptions[_, _], /* <: typingsSlinky.backbone.mod.Model[_, typingsSlinky.backbone.mod.ModelSetOptions] */ TModel, /* <: typingsSlinky.backbone.mod.Collection[TModel] */ TCollection] (val x: Self with (CollectionViewOptions[TModel, TCollection])) extends AnyVal {
    @scala.inline
