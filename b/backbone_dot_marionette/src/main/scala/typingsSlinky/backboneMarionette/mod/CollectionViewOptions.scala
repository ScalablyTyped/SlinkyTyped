...
trait CollectionViewOptions[TModel /* <: Model[_, ModelSetOptions, js.Object] */, TCollection /* <: Collection[TModel] */]
  ...
  var childView: js.UndefOr[
    (js.Function1[
      /* model */ TModel, 
      TypeofView with (Instantiable0[typingsSlinky.backbone.mod.View[Model[js.Any, ModelSetOptions, js.Object]]])
    ]) | (TypeofView with (Instantiable0[typingsSlinky.backbone.mod.View[Model[js.Any, ModelSetOptions, js.Object]]]))
  ] = js.native
...
object CollectionViewOptions {
  ...
  implicit class CollectionViewOptionsMutableBuilder[Self <: CollectionViewOptions[_, _], TModel /* <: Model[_, ModelSetOptions, js.Object] */, TCollection /* <: Collection[TModel] */] (val x: Self with (CollectionViewOptions[TModel, TCollection])) extends AnyVal {
    ...
    def setChildViewFunction1(
      value: /* model */ TModel => TypeofView with (Instantiable0[typingsSlinky.backbone.mod.View[Model[js.Any, ModelSetOptions, js.Object]]])
    ...
    def setEmptyViewFunction0(
      value: () => TypeofView with (Instantiable0[typingsSlinky.backbone.mod.View[Model[js.Any, ModelSetOptions, js.Object]]])
    ...
    def setViewFilterFunction3(
      value: (/* view */ js.UndefOr[
          TypeofView with (Instantiable0[typingsSlinky.backbone.mod.View[Model[js.Any, ModelSetOptions, js.Object]]])
        ], /* index */ js.UndefOr[Double], /* children */ js.UndefOr[js.Array[typingsSlinky.backbone.mod.View[Model[_, ModelSetOptions, js.Object]]]]) => Boolean
