...
object ViewOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.backbone.mod.Model[_, typingsSlinky.backbone.mod.ModelSetOptions] */ TModel](): ViewOptions[TModel] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ViewOptions[TModel]]
  }
  @scala.inline
  implicit class ViewOptionsOps[Self <: ViewOptions[_], /* <: typingsSlinky.backbone.mod.Model[_, typingsSlinky.backbone.mod.ModelSetOptions] */ TModel] (val x: Self with ViewOptions[TModel]) extends AnyVal {
    @scala.inline
