...
object LineStreamOptions {
  ...
  def apply(
    ...
    keepEmptyLines: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(keepEmptyLines)) __obj.updateDynamic("keepEmptyLines")(keepEmptyLines.get.asInstanceOf[js.Any])
