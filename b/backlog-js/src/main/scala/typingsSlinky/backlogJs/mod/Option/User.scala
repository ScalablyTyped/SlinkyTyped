...
object User {
  ...
  object RoleType extends StObject {
    ...
    /* 1 */ val Admin: typingsSlinky.backlogJs.mod.Option.User.RoleType.Admin with Double = js.native
    
    @js.native
    sealed trait GuestReporter extends RoleType
    /* 5 */ val GuestReporter: typingsSlinky.backlogJs.mod.Option.User.RoleType.GuestReporter with Double = js.native
    
    @js.native
    sealed trait GuestViewer extends RoleType
    /* 6 */ val GuestViewer: typingsSlinky.backlogJs.mod.Option.User.RoleType.GuestViewer with Double = js.native
    
    @js.native
    sealed trait Reporter extends RoleType
    /* 3 */ val Reporter: typingsSlinky.backlogJs.mod.Option.User.RoleType.Reporter with Double = js.native
    
    @js.native
    sealed trait User extends RoleType
    /* 2 */ val User: typingsSlinky.backlogJs.mod.Option.User.RoleType.User with Double = js.native
    
    @js.native
    sealed trait Viewer extends RoleType
    /* 4 */ val Viewer: typingsSlinky.backlogJs.mod.Option.User.RoleType.Viewer with Double = js.native
  }
