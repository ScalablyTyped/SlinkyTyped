...
object mod {
  ...
  object ErrorCodes extends StObject {
    ...
    /* 4 */ val errEmptyExtension: typingsSlinky.bcp47.mod.ErrorCodes.errEmptyExtension with Double = js.native
    
    @js.native
    sealed trait errExtensionTooLong extends ErrorCodes
    /* 2 */ val errExtensionTooLong: typingsSlinky.bcp47.mod.ErrorCodes.errExtensionTooLong with Double = js.native
    
    @js.native
    sealed trait errExtraContent extends ErrorCodes
    /* 6 */ val errExtraContent: typingsSlinky.bcp47.mod.ErrorCodes.errExtraContent with Double = js.native
    
    @js.native
    sealed trait errPrivateUseTooLong extends ErrorCodes
    /* 5 */ val errPrivateUseTooLong: typingsSlinky.bcp47.mod.ErrorCodes.errPrivateUseTooLong with Double = js.native
    
    @js.native
    sealed trait errTooManySubtags extends ErrorCodes
    /* 3 */ val errTooManySubtags: typingsSlinky.bcp47.mod.ErrorCodes.errTooManySubtags with Double = js.native
    
    @js.native
    sealed trait errVariantTooLong extends ErrorCodes
    /* 1 */ val errVariantTooLong: typingsSlinky.bcp47.mod.ErrorCodes.errVariantTooLong with Double = js.native
  }
