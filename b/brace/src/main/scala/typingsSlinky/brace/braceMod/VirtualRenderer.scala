package typingsSlinky.brace.braceMod
...
object VirtualRenderer
  ...
  **/
Instantiable1[/* container */ typingsSlinky.std.HTMLElement, VirtualRenderer]
     with Instantiable2[/* container */ typingsSlinky.std.HTMLElement, /* theme */ String, VirtualRenderer]
