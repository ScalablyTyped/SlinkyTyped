...
import typingsSlinky.beanstalkd.mod.default
import typingsSlinky.beanstalkdWorker.beanstalkdWorkerNumbers.`1`
import typingsSlinky.beanstalkdWorker.beanstalkdWorkerStrings.success
