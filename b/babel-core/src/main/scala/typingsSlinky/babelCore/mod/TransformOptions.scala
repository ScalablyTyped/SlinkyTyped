...
object TransformOptions {
  ...
  implicit class TransformOptionsOps[Self <: TransformOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnlyRegExp(value: js.RegExp): Self = this.set("only", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnly(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = this.set("only", value.asInstanceOf[js.Any])
