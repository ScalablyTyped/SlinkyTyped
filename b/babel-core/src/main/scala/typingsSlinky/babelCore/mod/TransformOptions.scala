...
object TransformOptions {
  ...
  def apply(
    ...
    wrapPluginVisitorMethod: (/* pluginAlias */ String, /* visitorType */ enter | exit, /* callback */ js.Function2[/* path */ NodePath[typingsSlinky.babelTraverse.mod.Node], /* state */ js.Any, Unit]) => js.Function2[/* path */ NodePath[typingsSlinky.babelTraverse.mod.Node], /* state */ _, Unit] = null
  ): TransformOptions = {
