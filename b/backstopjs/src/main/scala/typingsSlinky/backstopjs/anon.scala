...
object anon {
  ...
  trait Config extends StObject {
    ...
    var config: js.UndefOr[typingsSlinky.backstopjs.mod.Config | String] = js.native
  ...
  object Config {
    ...
    implicit class ConfigMutableBuilder[Self <: Config] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConfig(value: typingsSlinky.backstopjs.mod.Config | String): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
