...
object global {
  ...
  object Utils {
    ...
    @js.native
    class NumberFce ()
      extends typingsSlinky.businessRulesEngine.Utils.NumberFce
    object NumberFce {
      
      /* static member */
      @JSGlobal("Utils.NumberFce.GetNegDigits")
      @js.native
    ...
    @js.native
    class StringFce ()
      extends typingsSlinky.businessRulesEngine.Utils.StringFce
    object StringFce {
      
      /* static member */
      @JSGlobal("Utils.StringFce.format")
      @js.native
