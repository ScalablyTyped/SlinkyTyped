...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.bignumberJs.bignumberJsNumbers.`9`
*/
...
object ModuloMode {
  ...
  @scala.inline
  def `9`: typingsSlinky.bignumberJs.bignumberJsNumbers.`9` = 9.asInstanceOf[typingsSlinky.bignumberJs.bignumberJsNumbers.`9`]
}
