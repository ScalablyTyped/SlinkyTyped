...
import typingsSlinky.bignumberJs.bignumberJsBooleans.`true`
...
import typingsSlinky.bignumberJs.mod.BigNumber.Format
import typingsSlinky.bignumberJs.mod.BigNumber.Instance
import typingsSlinky.bignumberJs.mod.BigNumber.RoundingMode
...
object mod {
  ...
  object BigNumber {
    ...
    @js.native
    trait Constructor
      extends Instantiable1[/* n */ Value, typingsSlinky.bignumberJs.mod.BigNumber]
         with Instantiable2[/* n */ Value, /* base */ Double, typingsSlinky.bignumberJs.mod.BigNumber] {
