package typingsSlinky.bignumberDotJs.bignumberDotJsMod.BigNumber
...
@js.native
trait Constructor
  extends Instantiable1[/* n */ Value, typingsSlinky.bignumberDotJs.bignumberDotJsMod.BigNumber]
     with Instantiable2[
      /* n */ Value, 
      /* base */ Double, 
      typingsSlinky.bignumberDotJs.bignumberDotJsMod.BigNumber
    ] {
  /** Helps ES6 import. */
