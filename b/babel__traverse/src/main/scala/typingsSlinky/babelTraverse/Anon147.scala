...
import typingsSlinky.babelTraverse.babelTraverseStrings.VoidTypeAnnotation
...
object Anon147 {
  @scala.inline
  def apply(`type`: VoidTypeAnnotation): Anon147 = {
  ...
  implicit class Anon147Ops[Self <: Anon147] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: VoidTypeAnnotation): Self = {
