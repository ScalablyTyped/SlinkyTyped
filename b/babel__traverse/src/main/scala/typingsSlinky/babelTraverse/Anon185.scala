...
import typingsSlinky.babelTraverse.babelTraverseStrings.AnyTypeAnnotation
...
object Anon185 {
  @scala.inline
  def apply(`type`: AnyTypeAnnotation): Anon185 = {
  ...
  implicit class Anon185Ops[Self <: Anon185] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: AnyTypeAnnotation): Self = {
