...
object IReportPayload {
  ...
  implicit class IReportPayloadOps[Self <: IReportPayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventsVarargs(value: typingsSlinky.bugsnagJs.reportMod.default*): Self = this.set("events", js.Array(value :_*))
    @scala.inline
    def setEvents(value: js.Array[typingsSlinky.bugsnagJs.reportMod.default]): Self = this.set("events", value.asInstanceOf[js.Any])
    @scala.inline
