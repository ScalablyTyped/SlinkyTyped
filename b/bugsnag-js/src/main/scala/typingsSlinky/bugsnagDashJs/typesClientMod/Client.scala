...
import typingsSlinky.bugsnagDashJs.Anon_EnsureReport
import typingsSlinky.bugsnagDashJs.typesCommonMod.BeforeSession
import typingsSlinky.bugsnagDashJs.typesCommonMod.IConfig
import typingsSlinky.bugsnagDashJs.typesCommonMod.IFinalConfig
...
class Client () extends js.Object {
  var BugsnagBreadcrumb: Instantiable4[
    ...
    typingsSlinky.bugsnagDashJs.typesBreadcrumbMod.default
  ] = js.native
  var BugsnagReport: Anon_EnsureReport = js.native
  var BugsnagSession: Instantiable0[typingsSlinky.bugsnagDashJs.typesSessionMod.default] = js.native
