...
object TimepickerOptions {
  ...
  implicit class TimepickerOptionsMutableBuilder[Self <: TimepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultTime(value: String | Boolean | js.Date): Self = StObject.set(x, "defaultTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultTimeDate(value: js.Date): Self = StObject.set(x, "defaultTime", value.asInstanceOf[js.Any])
