...
object Position {
  ...
  implicit class PositionOps[Self <: Position] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanCover(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CanCover")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withFrozenAmount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FrozenAmount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMarginLevel(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MarginLevel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withProfit(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Profit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: VPositionType): Self = {
        val ret = this.duplicate
