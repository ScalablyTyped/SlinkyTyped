...
object Account {
  ...
  implicit class AccountOps[Self <: Account] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFrozenBalance(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FrozenBalance")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFrozenStocks(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FrozenStocks")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStocks(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Stocks")(value.asInstanceOf[js.Any])
        ret
    }
  }
