...
import typingsSlinky.bootstrapDotV3DotDatetimepicker.bootstrapDotV3DotDatetimepickerStrings.days
import typingsSlinky.bootstrapDotV3DotDatetimepicker.bootstrapDotV3DotDatetimepickerStrings.decades
import typingsSlinky.bootstrapDotV3DotDatetimepicker.bootstrapDotV3DotDatetimepickerStrings.default
import typingsSlinky.bootstrapDotV3DotDatetimepicker.bootstrapDotV3DotDatetimepickerStrings.months
import typingsSlinky.bootstrapDotV3DotDatetimepicker.bootstrapDotV3DotDatetimepickerStrings.top
import typingsSlinky.bootstrapDotV3DotDatetimepicker.bootstrapDotV3DotDatetimepickerStrings.years
...
trait DatetimepickerOptions extends js.Object {
  ...
  /**
  	 ...
  	 */
  var disabledDates: js.UndefOr[Boolean | (js.Array[Moment | js.Date | String]) | js.Any] = js.undefined
  /**
  ...
  /**
  	 ...
  	 * https://github.com/Eonasdan/bootstrap-datetimepicker/issues/1499
  	 */
  var enabledDates: js.UndefOr[Boolean | (js.Array[Moment | js.Date | String]) | js.Any] = js.undefined
  /**
  	 * Will allow or disallow hour selections (much like disabledTimeIntervals) but will affect all days
  	 * @default: false
  	 * IMPORTANT! The getter returns an Object NOT an Array, with keys being the hours, values being true.
...
object DatetimepickerOptions {
  ...
  def apply(
    ...
    defaultDate: Boolean | Moment | js.Date | String = null,
    disabledDates: Boolean | (js.Array[Moment | js.Date | String]) | js.Any = null,
    disabledHours: Boolean | js.Array[Double] | js.Any = null,
    disabledTimeIntervals: Boolean | js.Array[js.Array[Moment]] = null,
    enabledDates: Boolean | (js.Array[Moment | js.Date | String]) | js.Any = null,
    ...
    locale: String = null,
    maxDate: Boolean | Moment | js.Date | String = null,
    minDate: Boolean | Moment | js.Date | String = null,
    parseInputDate: /* input */ String | js.Date | Moment => Moment = null,
    ...
    viewDate: Boolean | Moment | js.Date | String = null,
