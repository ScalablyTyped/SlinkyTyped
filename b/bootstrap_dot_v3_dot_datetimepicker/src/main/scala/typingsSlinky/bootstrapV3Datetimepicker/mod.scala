...
object mod {
  ...
  object DatetimepickerOptions {
    ...
    implicit class DatetimepickerOptionsMutableBuilder[Self <: DatetimepickerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultDate(value: Boolean | Moment | js.Date | String): Self = StObject.set(x, "defaultDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDisabledDates(value: Boolean | (js.Array[Moment | js.Date | String]) | js.Any): Self = StObject.set(x, "disabledDates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisabledDatesUndefined: Self = StObject.set(x, "disabledDates", js.undefined)
      
      @scala.inline
      def setDisabledDatesVarargs(value: (Moment | js.Date | String)*): Self = StObject.set(x, "disabledDates", js.Array(value :_*))
      ...
      @scala.inline
      def setEnabledDates(value: Boolean | (js.Array[Moment | js.Date | String]) | js.Any): Self = StObject.set(x, "enabledDates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEnabledDatesUndefined: Self = StObject.set(x, "enabledDates", js.undefined)
      
      @scala.inline
      def setEnabledDatesVarargs(value: (Moment | js.Date | String)*): Self = StObject.set(x, "enabledDates", js.Array(value :_*))
      ...
      @scala.inline
      def setMaxDate(value: Boolean | Moment | js.Date | String): Self = StObject.set(x, "maxDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMinDate(value: Boolean | Moment | js.Date | String): Self = StObject.set(x, "minDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setParseInputDate(value: /* input */ String | js.Date | Moment => Moment): Self = StObject.set(x, "parseInputDate", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setViewDate(value: Boolean | Moment | js.Date | String): Self = StObject.set(x, "viewDate", value.asInstanceOf[js.Any])
