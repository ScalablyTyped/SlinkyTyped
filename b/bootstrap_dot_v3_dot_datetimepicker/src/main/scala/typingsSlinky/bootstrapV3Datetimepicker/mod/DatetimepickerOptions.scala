...
object DatetimepickerOptions {
  ...
  implicit class DatetimepickerOptionsOps[Self <: DatetimepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultDate(value: Boolean | Moment | js.Date | String): Self = this.set("defaultDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDefaultDate: Self = this.set("defaultDate", js.undefined)
    
    @scala.inline
    def setDisabledDatesVarargs(value: (Moment | js.Date | String)*): Self = this.set("disabledDates", js.Array(value :_*))
    
    @scala.inline
    def setDisabledDates(value: Boolean | (js.Array[Moment | js.Date | String]) | js.Any): Self = this.set("disabledDates", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnabledDatesVarargs(value: (Moment | js.Date | String)*): Self = this.set("enabledDates", js.Array(value :_*))
    
    @scala.inline
    def setEnabledDates(value: Boolean | (js.Array[Moment | js.Date | String]) | js.Any): Self = this.set("enabledDates", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxDate(value: Boolean | Moment | js.Date | String): Self = this.set("maxDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDate(value: Boolean | Moment | js.Date | String): Self = this.set("minDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinDate: Self = this.set("minDate", js.undefined)
    
    @scala.inline
    def setParseInputDate(value: /* input */ String | js.Date | Moment => Moment): Self = this.set("parseInputDate", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setViewDateDate(value: js.Date): Self = this.set("viewDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setViewDate(value: Boolean | Moment | js.Date | String): Self = this.set("viewDate", value.asInstanceOf[js.Any])
