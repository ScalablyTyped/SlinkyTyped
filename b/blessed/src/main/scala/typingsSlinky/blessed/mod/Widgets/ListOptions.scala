...
object ListOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.blessed.mod.Widgets.ListElementStyle */ TStyle](): ListOptions[TStyle] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListOptions[TStyle]]
  }
  @scala.inline
  implicit class ListOptionsOps[Self <: ListOptions[_], /* <: typingsSlinky.blessed.mod.Widgets.ListElementStyle */ TStyle] (val x: Self with ListOptions[TStyle]) extends AnyVal {
    @scala.inline
