...
import typingsSlinky.blessed.blessedStrings.`inline-block`
import typingsSlinky.blessed.blessedStrings.`inline`
import typingsSlinky.blessed.blessedStrings.grid
...
object LayoutOptions {
  ...
  implicit class LayoutOptionsOps[Self <: LayoutOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLayout(value: `inline` | `inline-block` | grid): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("layout")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRenderer(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderer")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
