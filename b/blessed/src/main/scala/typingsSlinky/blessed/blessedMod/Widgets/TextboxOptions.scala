...
object TextboxOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(censor)) __obj.updateDynamic("censor")(censor.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(secret)) __obj.updateDynamic("secret")(secret.asInstanceOf[js.Any])
