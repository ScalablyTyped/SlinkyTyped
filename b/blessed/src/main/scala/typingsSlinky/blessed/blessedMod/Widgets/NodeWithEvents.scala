...
import typingsSlinky.blessed.blessedMod.Widgets.Events.IKeyEventArg
import typingsSlinky.blessed.blessedMod.Widgets.Events.IMouseEventArg
import typingsSlinky.blessed.blessedStrings.keypress
import typingsSlinky.blessed.blessedStrings.warning
