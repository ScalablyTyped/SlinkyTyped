...
object mod {
  ...
  object JourneyEvent extends StObject {
    ...
    /* "didCallJourneyClose" */ val didCallJourneyClose: typingsSlinky.branchSdk.mod.JourneyEvent.didCallJourneyClose with String = js.native
    
    @js.native
    sealed trait didClickJourneyCTA extends JourneyEvent
    /* "didClickJourneyCTA" */ val didClickJourneyCTA: typingsSlinky.branchSdk.mod.JourneyEvent.didClickJourneyCTA with String = js.native
    
    @js.native
    sealed trait didClickJourneyClose extends JourneyEvent
    /* "didClickJourneyClose" */ val didClickJourneyClose: typingsSlinky.branchSdk.mod.JourneyEvent.didClickJourneyClose with String = js.native
    
    @js.native
    sealed trait didCloseJourney extends JourneyEvent
    /* "didCloseJourney" */ val didCloseJourney: typingsSlinky.branchSdk.mod.JourneyEvent.didCloseJourney with String = js.native
    
    @js.native
    sealed trait didShowJourney extends JourneyEvent
    /* "didShowJourney" */ val didShowJourney: typingsSlinky.branchSdk.mod.JourneyEvent.didShowJourney with String = js.native
    
    @js.native
    sealed trait willCloseJourney extends JourneyEvent
    /* "willCloseJourney" */ val willCloseJourney: typingsSlinky.branchSdk.mod.JourneyEvent.willCloseJourney with String = js.native
    
    @js.native
    sealed trait willNotShowJourney extends JourneyEvent
    /* "willNotShowJourney" */ val willNotShowJourney: typingsSlinky.branchSdk.mod.JourneyEvent.willNotShowJourney with String = js.native
    
    @js.native
    sealed trait willShowJourney extends JourneyEvent
    /* "willShowJourney" */ val willShowJourney: typingsSlinky.branchSdk.mod.JourneyEvent.willShowJourney with String = js.native
  }
  ...
  object UriRedirectMode extends StObject {
    ...
    /* 0 */ val Default: typingsSlinky.branchSdk.mod.UriRedirectMode.Default with Double = js.native
    ...
    /* 2 */ val Forceful: typingsSlinky.branchSdk.mod.UriRedirectMode.Forceful with Double = js.native
    ...
    /* 1 */ val Smart: typingsSlinky.branchSdk.mod.UriRedirectMode.Smart with Double = js.native
  }
