...
object PageableSetSortingOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.backbone.mod.Model[_, typingsSlinky.backbone.mod.ModelSetOptions] */ TModel](): PageableSetSortingOptions[TModel] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageableSetSortingOptions[TModel]]
  }
  @scala.inline
  implicit class PageableSetSortingOptionsOps[Self <: PageableSetSortingOptions[_], /* <: typingsSlinky.backbone.mod.Model[_, typingsSlinky.backbone.mod.ModelSetOptions] */ TModel] (val x: Self with PageableSetSortingOptions[TModel]) extends AnyVal {
    @scala.inline
