...
import typingsSlinky.bleno.TypeofClassCharacteristic
...
trait Bleno extends EventEmitter {
  ...
  val Descriptor: Instantiable1[/* options */ DescriptorOptions, typingsSlinky.bleno.blenoMod.Descriptor] = js.native
  val PrimaryService: Instantiable1[/* options */ PrimaryServiceOptions, typingsSlinky.bleno.blenoMod.PrimaryService] = js.native
  ...
  def setServices(services: js.Array[typingsSlinky.bleno.blenoMod.PrimaryService]): Unit = js.native
  def setServices(
    services: js.Array[typingsSlinky.bleno.blenoMod.PrimaryService],
