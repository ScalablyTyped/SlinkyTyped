...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(bugfixes)) __obj.updateDynamic("bugfixes")(bugfixes.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(forceAllTransforms)) __obj.updateDynamic("forceAllTransforms")(forceAllTransforms.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreBrowserslistConfig)) __obj.updateDynamic("ignoreBrowserslistConfig")(ignoreBrowserslistConfig.get.asInstanceOf[js.Any])
    if (include != null) __obj.updateDynamic("include")(include.asInstanceOf[js.Any])
    if (!js.isUndefined(loose)) __obj.updateDynamic("loose")(loose.get.asInstanceOf[js.Any])
    if (modules != null) __obj.updateDynamic("modules")(modules.asInstanceOf[js.Any])
    if (!js.isUndefined(shippedProposals)) __obj.updateDynamic("shippedProposals")(shippedProposals.get.asInstanceOf[js.Any])
