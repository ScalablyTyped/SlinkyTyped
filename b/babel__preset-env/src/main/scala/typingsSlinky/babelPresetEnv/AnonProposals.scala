...
import typingsSlinky.babelPresetEnv.mod.CorejsOption
import typingsSlinky.babelPresetEnv.mod.CorejsVersion
...
object AnonProposals {
  ...
  @scala.inline
  implicit class AnonProposalsOps[Self <: AnonProposals] (val x: Self) extends AnyVal {
    @scala.inline
