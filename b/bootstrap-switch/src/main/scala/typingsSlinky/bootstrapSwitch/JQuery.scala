...
import typingsSlinky.bootstrapSwitch.BootstrapSwitch.BootstrapSwitchChangeEventObject
import typingsSlinky.bootstrapSwitch.BootstrapSwitch.BootstrapSwitchEventObject
import typingsSlinky.bootstrapSwitch.BootstrapSwitch.BootstrapSwitchOptions
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.animate
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.baseClass
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.disabled
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.initDotbootstrapSwitch
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.labelText
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.offColor
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.offText
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.onColor
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.onText
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.radioAllOff
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.readonly
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.size
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.state
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.switchChangeDotbootstrapSwitch
import typingsSlinky.bootstrapSwitch.bootstrapSwitchStrings.wrapperClass
