...
object mod {
  ...
  @js.native
  def boomify(error: js.Error): Boom[Null] = js.native
  @JSImport("boom", "boomify")
  @js.native
  def boomify(error: js.Error, options: Message): Boom[Null] = js.native
  ...
  @js.native
  def isBoom(error: js.Error): /* is boom.boom.Boom<any> */ Boolean = js.native
