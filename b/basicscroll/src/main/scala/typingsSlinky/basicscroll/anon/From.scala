package typingsSlinky.basicscroll.anon

import typingsSlinky.basicscroll.mod.AnimatedType
import typingsSlinky.basicscroll.mod.KnownTimings
import typingsSlinky.basicscroll.mod.TimingFunction
