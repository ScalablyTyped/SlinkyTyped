package typingsSlinky.balancedMatch
...
object mod {
  ...
  @JSImport("balanced-match", "range")
  @js.native
  def range(a: String, b: js.RegExp, str: String): Output | Unit = js.native
  @JSImport("balanced-match", "range")
  @js.native
  def range(a: js.RegExp, b: String, str: String): Output | Unit = js.native
  @JSImport("balanced-match", "range")
  @js.native
  def range(a: js.RegExp, b: js.RegExp, str: String): Output | Unit = js.native
