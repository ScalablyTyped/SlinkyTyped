...
import typingsSlinky.babelDashGenerator.babelDashGeneratorStrings.auto
import typingsSlinky.babelDashGenerator.babelDashGeneratorStrings.double
import typingsSlinky.babelDashGenerator.babelDashGeneratorStrings.single
