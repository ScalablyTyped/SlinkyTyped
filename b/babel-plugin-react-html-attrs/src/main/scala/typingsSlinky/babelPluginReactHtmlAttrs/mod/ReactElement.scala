...
object ReactElement {
  @scala.inline
  def apply[P, /* <: java.lang.String | typingsSlinky.babelPluginReactHtmlAttrs.mod.JSXElementConstructor[_] */ T](props: P, `type`: T): ReactElement[P, T] = {
    val __obj = js.Dynamic.literal(props = props.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReactElement[P, T]]
  }
  @scala.inline
  implicit class ReactElementOps[Self <: ReactElement[_, _], P, /* <: java.lang.String | typingsSlinky.babelPluginReactHtmlAttrs.mod.JSXElementConstructor[_] */ T] (val x: Self with (ReactElement[P, T])) extends AnyVal {
    @scala.inline
