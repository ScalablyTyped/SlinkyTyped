...
trait SVGAttributes[T]
  ...
  var `panose-1`: js.UndefOr[Double | String] = js.undefined
  ...
  var `stroke-miterlimit`: js.UndefOr[Double | String] = js.undefined
...
object SVGAttributes {
  ...
  def apply[T](
    ...
    `color-interpolation-filters`: auto | sRGB | linearRGB | inherit = null,
    ...
    `stroke-miterlimit`: Double | String = null,
