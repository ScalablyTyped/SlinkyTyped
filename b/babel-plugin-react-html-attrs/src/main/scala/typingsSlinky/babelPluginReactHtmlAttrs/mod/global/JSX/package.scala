package typingsSlinky.babelPluginReactHtmlAttrs.mod.global
...
package object JSX {
  ...
  type LibraryManagedAttributes[C, P] = typingsSlinky.babelPluginReactHtmlAttrs.mod.ReactManagedAttributes[js.Any | C, P]
}
