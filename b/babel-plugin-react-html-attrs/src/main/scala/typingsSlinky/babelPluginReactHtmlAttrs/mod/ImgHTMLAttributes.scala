...
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings._empty
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.`no-referrer`
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.`unsafe-url`
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.`use-credentials`
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.anonymous
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.async
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.auto
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.eager
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.origin
import typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.sync
...
trait ImgHTMLAttributes[T] extends HTMLAttributes[T] {
  ...
  var loading: js.UndefOr[
    eager | typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.`lazy`
  ] = js.native
...
object ImgHTMLAttributes {
  ...
  implicit class ImgHTMLAttributesMutableBuilder[Self <: ImgHTMLAttributes[_], T] (val x: Self with ImgHTMLAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setLoading(value: eager | typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.`lazy`): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
