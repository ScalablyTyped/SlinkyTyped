...
object ImgHTMLAttributes {
  ...
  implicit class ImgHTMLAttributesOps[Self <: ImgHTMLAttributes[_], T] (val x: Self with ImgHTMLAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setLoading(value: eager | typingsSlinky.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.`lazy`): Self = this.set("loading", value.asInstanceOf[js.Any])
    @scala.inline
