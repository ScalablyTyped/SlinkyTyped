...
import typingsSlinky.babelPluginReactHtmlAttrs.anon.Html
...
object DOMAttributes {
  ...
  implicit class DOMAttributesMutableBuilder[Self <: DOMAttributes[_], T] (val x: Self with DOMAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnScroll(value: UIEvent[T, org.scalajs.dom.raw.UIEvent] => Unit): Self = StObject.set(x, "onScroll", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnScrollCapture(value: UIEvent[T, org.scalajs.dom.raw.UIEvent] => Unit): Self = StObject.set(x, "onScrollCapture", js.Any.fromFunction1(value))
