...
object DOMAttributes {
  ...
  implicit class DOMAttributesOps[Self <: DOMAttributes[_], T] (val x: Self with DOMAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnScroll(value: UIEvent[T, org.scalajs.dom.raw.UIEvent] => Unit): Self = this.set("onScroll", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnScroll: Self = this.set("onScroll", js.undefined)
    @scala.inline
    def setOnScrollCapture(value: UIEvent[T, org.scalajs.dom.raw.UIEvent] => Unit): Self = this.set("onScrollCapture", js.Any.fromFunction1(value))
    @scala.inline
