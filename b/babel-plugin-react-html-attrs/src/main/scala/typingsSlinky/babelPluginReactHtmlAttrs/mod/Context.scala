...
trait Context[T] extends StObject {
  ...
  var Consumer: typingsSlinky.babelPluginReactHtmlAttrs.mod.Consumer[T] = js.native
  
  var Provider: typingsSlinky.babelPluginReactHtmlAttrs.mod.Provider[T] = js.native
