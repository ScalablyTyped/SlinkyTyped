...
object AnimationEvent {
  ...
  def apply[T](
    ...
    isTrusted: Boolean,
    nativeEvent: org.scalajs.dom.raw.AnimationEvent,
    persist: () => Unit,
    preventDefault: () => Unit,
  ...
  @scala.inline
  implicit class AnimationEventOps[Self <: AnimationEvent[_], T] (val x: Self with AnimationEvent[T]) extends AnyVal {
