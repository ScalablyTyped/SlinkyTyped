...
import typingsSlinky.babelPluginReactHtmlAttrs.mod.SuspenseListRevealOrder
import typingsSlinky.babelPluginReactHtmlAttrs.mod.SuspenseListTailMode
...
object babelPluginReactHtmlAttrsStrings {
  ...
  sealed trait backwards
    extends SuspenseListRevealOrder
       with typingsSlinky.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.SuspenseListRevealOrder
  @scala.inline
  ...
  sealed trait collapsed
    extends SuspenseListTailMode
       with typingsSlinky.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.SuspenseListTailMode
  @scala.inline
