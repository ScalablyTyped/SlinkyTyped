...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrapSlider.bootstrapSliderStrings.slide
  - typingsSlinky.bootstrapSlider.bootstrapSliderStrings.slideStart
  - typingsSlinky.bootstrapSlider.bootstrapSliderStrings.slideStop
  - typingsSlinky.bootstrapSlider.bootstrapSliderStrings.change
  - typingsSlinky.bootstrapSlider.bootstrapSliderStrings.slideEnabled
  - typingsSlinky.bootstrapSlider.bootstrapSliderStrings.slideDisabled
*/
