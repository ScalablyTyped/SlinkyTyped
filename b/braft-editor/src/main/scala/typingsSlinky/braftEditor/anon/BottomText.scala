...
object BottomText {
  ...
  implicit class BottomTextOps[Self <: BottomText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBottomTextReactElement(value: ReactElement): Self = this.set("bottomText", value.asInstanceOf[js.Any])
    @scala.inline
    def setBottomText(value: ReactElement): Self = this.set("bottomText", value.asInstanceOf[js.Any])
    @scala.inline
