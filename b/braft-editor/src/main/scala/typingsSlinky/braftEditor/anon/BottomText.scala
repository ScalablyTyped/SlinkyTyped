...
trait BottomText extends StObject {
  ...
  var bottomText: js.UndefOr[ReactElement] = js.native
...
object BottomText {
  ...
  implicit class BottomTextMutableBuilder[Self <: BottomText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBottomText(value: ReactElement): Self = StObject.set(x, "bottomText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBottomTextReactElement(value: ReactElement): Self = StObject.set(x, "bottomText", value.asInstanceOf[js.Any])
