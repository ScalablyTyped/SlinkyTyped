...
object BraftEditorProps {
  ...
  implicit class BraftEditorPropsOps[Self <: BraftEditorProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentBelowControlBarReactElement(value: ReactElement): Self = this.set("componentBelowControlBar", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentBelowControlBar(value: ReactElement): Self = this.set("componentBelowControlBar", value.asInstanceOf[js.Any])
    @scala.inline
