...
object AnonArrowActive {
  @scala.inline
  def apply(key: String, `type`: dropdown): AnonArrowActive = {
    val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonArrowActive]
  }
  @scala.inline
  implicit class AnonArrowActiveOps[Self <: AnonArrowActive] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dropdown): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withArrowActive(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("arrowActive")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutArrowActive: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("arrowActive")(js.undefined)
        ret
    }
    @scala.inline
