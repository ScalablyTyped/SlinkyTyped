...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(isFullBoolValue)) __obj.updateDynamic("isFullBoolValue")(isFullBoolValue.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isFullModifier)) __obj.updateDynamic("isFullModifier")(isFullModifier.get.asInstanceOf[js.Any])
