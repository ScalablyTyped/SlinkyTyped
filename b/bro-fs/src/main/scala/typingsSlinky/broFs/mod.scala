...
object mod {
  ...
  @JSImport("bro-fs", "appendFile")
  @js.native
  def appendFile(path: String, data: js.typedarray.ArrayBuffer): js.Promise[FileSystem] = js.native
  @JSImport("bro-fs", "appendFile")
  @js.native
  ...
  @JSImport("bro-fs", "appendFile")
  @js.native
  def appendFile(path: FileEntry, data: js.typedarray.ArrayBuffer): js.Promise[FileSystem] = js.native
  @JSImport("bro-fs", "appendFile")
  @js.native
  ...
  @JSImport("bro-fs", "readFile")
  @js.native
  def readFile(path: String, options: Type): js.Promise[js.typedarray.ArrayBuffer] = js.native
  @JSImport("bro-fs", "readFile")
  @js.native
  ...
  @JSImport("bro-fs", "readFile")
  @js.native
  def readFile(path: FileEntry, options: Type): js.Promise[js.typedarray.ArrayBuffer] = js.native
  @JSImport("bro-fs", "readFile")
  @js.native
  ...
  @JSImport("bro-fs", "writeFile")
  @js.native
  def writeFile(path: String, data: js.typedarray.ArrayBuffer): js.Promise[FileEntry] = js.native
  @JSImport("bro-fs", "writeFile")
  @js.native
