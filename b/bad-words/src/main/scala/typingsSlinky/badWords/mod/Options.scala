...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplaceRegex(value: js.RegExp): Self = this.set("replaceRegex", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteReplaceRegex: Self = this.set("replaceRegex", js.undefined)
    
    @scala.inline
    def setSplitRegex(value: js.RegExp): Self = this.set("splitRegex", value.asInstanceOf[js.Any])
