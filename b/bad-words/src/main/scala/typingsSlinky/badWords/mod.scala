...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReplaceRegex(value: js.RegExp): Self = StObject.set(x, "replaceRegex", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReplaceRegexUndefined: Self = StObject.set(x, "replaceRegex", js.undefined)
      
      @scala.inline
      def setSplitRegex(value: js.RegExp): Self = StObject.set(x, "splitRegex", value.asInstanceOf[js.Any])
