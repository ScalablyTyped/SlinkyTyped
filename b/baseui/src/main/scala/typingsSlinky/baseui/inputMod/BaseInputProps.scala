...
object BaseInputProps {
  ...
  implicit class BaseInputPropsOps[Self <: BaseInputProps[_], T] (val x: Self with BaseInputProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setInputRefRefObject(value: ReactRef[T]): Self = this.set("inputRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with T, Event] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
