...
object progressStepsMod {
  ...
  @js.native
  val NumberedStep: ReactComponentClass[NumberedStepProps] = js.native
  
  @JSImport("baseui/progress-steps", "ProgressSteps")
  @js.native
  val ProgressSteps: ReactComponentClass[ProgressStepsProps] = js.native
  ...
  trait NumberedStepProps extends StObject {
    ...
    var step: js.UndefOr[ReactElement] = js.native
  ...
  object NumberedStepProps {
    ...
    implicit class NumberedStepPropsMutableBuilder[Self <: NumberedStepProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStep(value: ReactElement): Self = StObject.set(x, "step", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepReactElement(value: ReactElement): Self = StObject.set(x, "step", value.asInstanceOf[js.Any])
