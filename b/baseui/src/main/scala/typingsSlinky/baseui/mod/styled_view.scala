...
object styled_view extends js.Object {
  def apply[P /* <: js.Object */, T](component: view, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[view], 
      Exclude[/* keyof react.react.ComponentProps<'view'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: view, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[view], 
      Exclude[/* keyof react.react.ComponentProps<'view'> */ String, AnonClassName]
    ]) with P
