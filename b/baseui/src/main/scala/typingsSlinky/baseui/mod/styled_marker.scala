...
object styled_marker extends js.Object {
  def apply[P /* <: js.Object */, T](component: marker, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[marker], 
      Exclude[/* keyof react.react.ComponentProps<'marker'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: marker, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[marker], 
      Exclude[/* keyof react.react.ComponentProps<'marker'> */ String, AnonClassName]
    ]) with P
