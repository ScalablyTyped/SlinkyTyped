...
object styled_tr extends js.Object {
  def apply[P /* <: js.Object */, T](component: tr_, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[tr_], 
      Exclude[/* keyof react.react.ComponentProps<'tr'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: tr_, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[tr_], 
      Exclude[/* keyof react.react.ComponentProps<'tr'> */ String, AnonClassName]
    ]) with P
