...
object styled_style extends js.Object {
  def apply[P /* <: js.Object */, T](component: style, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[style], 
      Exclude[/* keyof react.react.ComponentProps<'style'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: style, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[style], 
      Exclude[/* keyof react.react.ComponentProps<'style'> */ String, AnonClassName]
    ]) with P
