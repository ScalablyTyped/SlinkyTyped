...
object styled_figure extends js.Object {
  def apply[P /* <: js.Object */, T](component: figure, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[figure], 
      Exclude[/* keyof react.react.ComponentProps<'figure'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: figure, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[figure], 
      Exclude[/* keyof react.react.ComponentProps<'figure'> */ String, AnonClassName]
    ]) with P
