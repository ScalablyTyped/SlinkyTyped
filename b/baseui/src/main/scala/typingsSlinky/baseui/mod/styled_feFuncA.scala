...
object styled_feFuncA extends js.Object {
  def apply[P /* <: js.Object */, T](component: feFuncA, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[feFuncA], 
      Exclude[/* keyof react.react.ComponentProps<'feFuncA'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: feFuncA, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[feFuncA], 
      Exclude[/* keyof react.react.ComponentProps<'feFuncA'> */ String, AnonClassName]
    ]) with P
