...
object styled_polygon extends js.Object {
  def apply[P /* <: js.Object */, T](component: polygon, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[polygon], 
      Exclude[/* keyof react.react.ComponentProps<'polygon'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: polygon, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[polygon], 
      Exclude[/* keyof react.react.ComponentProps<'polygon'> */ String, AnonClassName]
    ]) with P
