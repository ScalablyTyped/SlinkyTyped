...
object styled_tfoot extends js.Object {
  def apply[P /* <: js.Object */, T](component: tfoot, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[tfoot], 
      Exclude[/* keyof react.react.ComponentProps<'tfoot'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: tfoot, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[tfoot], 
      Exclude[/* keyof react.react.ComponentProps<'tfoot'> */ String, AnonClassName]
    ]) with P
