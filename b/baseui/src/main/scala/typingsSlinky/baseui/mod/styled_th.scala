...
object styled_th extends js.Object {
  def apply[P /* <: js.Object */, T](component: th_, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[th_], 
      Exclude[/* keyof react.react.ComponentProps<'th'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: th_, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[th_], 
      Exclude[/* keyof react.react.ComponentProps<'th'> */ String, AnonClassName]
    ]) with P
