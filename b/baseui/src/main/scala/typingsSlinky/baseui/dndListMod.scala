...
object dndListMod {
  ...
  @js.native
  val StatefulList: ReactComponentClass[StatefulListProps] = js.native
  ...
  object SharedStylePropsArgT {
    ...
    implicit class SharedStylePropsArgTMutableBuilder[Self <: SharedStylePropsArgT] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set$value(value: ReactElement): Self = StObject.set(x, "$value", value.asInstanceOf[js.Any])
  ...
  object State {
    ...
    @scala.inline
    def apply(items: js.Array[ReactElement]): State = {
