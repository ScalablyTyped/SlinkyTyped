...
object HeadingProps {
  ...
  implicit class HeadingPropsOps[Self <: HeadingProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStyleLevel(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("styleLevel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStyleLevel: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("styleLevel")(js.undefined)
        ret
    }
    @scala.inline
