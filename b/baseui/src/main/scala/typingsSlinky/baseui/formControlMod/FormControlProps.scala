...
object FormControlProps {
  ...
  implicit class FormControlPropsOps[Self <: FormControlProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withError(value: Boolean | TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("error")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withOverrides(value: FormControlOverrides): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPositiveReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("positive")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPositive(value: TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("positive")(value.asInstanceOf[js.Any])
        ret
    }
