...
object buttonGroupMod {
  ...
  @js.native
  val SHAPE: typingsSlinky.baseui.buttonMod.SHAPE = js.native
  
  @JSImport("baseui/button-group", "SIZE")
  @js.native
  val SIZE: typingsSlinky.baseui.buttonMod.SIZE = js.native
  ...
  @js.native
  val StatefulButtonGroup: ReactComponentClass[StatefulButtonGroupProps] = js.native
  ...
  object ButtonGroupProps {
    ...
    implicit class ButtonGroupPropsMutableBuilder[Self <: ButtonGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(value: (/* event */ SyntheticMouseEvent[HTMLButtonElement], /* index */ Double) => _): Self = StObject.set(x, "onClick", js.Any.fromFunction2(value))
