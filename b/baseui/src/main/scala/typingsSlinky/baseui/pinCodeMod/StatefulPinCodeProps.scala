...
object StatefulPinCodeProps {
  ...
  @scala.inline
  implicit class StatefulPinCodePropsOps[Self <: StatefulPinCodeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndEnhancerFunction1(value: /* args */ SharedProps => ReactElement): Self = this.set("endEnhancer", js.Any.fromFunction1(value))
    
    @scala.inline
    def setEndEnhancer(value: (js.Function1[/* args */ SharedProps, ReactElement]) | ReactElement): Self = this.set("endEnhancer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStartEnhancerFunction1(value: /* args */ SharedProps => ReactElement): Self = this.set("startEnhancer", js.Any.fromFunction1(value))
    
    @scala.inline
    def setStartEnhancer(value: (js.Function1[/* args */ SharedProps, ReactElement]) | ReactElement): Self = this.set("startEnhancer", value.asInstanceOf[js.Any])
