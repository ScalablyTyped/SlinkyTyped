...
trait StatefulTextareaProps extends js.Object {
  ...
  var onChange: js.UndefOr[FormEventHandler[HTMLTextAreaElement] with FormEventHandler[HTMLInputElement]] = js.native
...
object StatefulTextareaProps {
  ...
  implicit class StatefulTextareaPropsOps[Self <: StatefulTextareaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChange(value: FormEventHandler[HTMLTextAreaElement] with FormEventHandler[HTMLInputElement]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOverrides(value: BaseInputOverrides[SharedProps]): Self = {
        val ret = this.duplicate
