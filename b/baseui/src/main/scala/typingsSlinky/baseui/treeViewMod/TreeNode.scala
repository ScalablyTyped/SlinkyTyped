...
trait TreeNode[T]
  ...
  var label: (js.Function1[/* node */ TreeNode[_], ReactElement]) | String = js.native
}

object TreeNode {
  @scala.inline
  def apply[T](label: (js.Function1[/* node */ TreeNode[_], ReactElement]) | String): TreeNode[T] = {
  ...
  implicit class TreeNodeOps[Self <: TreeNode[_], T] (val x: Self with TreeNode[T]) extends AnyVal {
    ...
    @scala.inline
    def setLabelFunction1(value: /* node */ TreeNode[_] => ReactElement): Self = this.set("label", js.Any.fromFunction1(value))
    @scala.inline
    def setLabel(value: (js.Function1[/* node */ TreeNode[_], ReactElement]) | String): Self = this.set("label", value.asInstanceOf[js.Any])
    @scala.inline
