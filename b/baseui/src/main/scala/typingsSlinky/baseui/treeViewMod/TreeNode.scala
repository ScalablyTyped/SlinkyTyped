...
trait TreeNode
  ...
  var label: (js.Function1[/* node */ this.type, TagMod[Any]]) | String = js.native
}

object TreeNode {
  @scala.inline
  def apply(label: (js.Function1[TreeNode, TagMod[Any]]) | String): TreeNode = {
  ...
  implicit class TreeNodeOps[Self <: TreeNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabelFunction1(value: TreeNode => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("label")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withLabel(value: (js.Function1[TreeNode, TagMod[Any]]) | String): Self = {
        val ret = this.duplicate
