...
trait PaymentCardProps extends js.Object {
  ...
  var overrides: js.UndefOr[InputOverrides with PaymentCardOverrides] = js.native
...
object PaymentCardProps {
  ...
  @scala.inline
  implicit class PaymentCardPropsOps[Self <: PaymentCardProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOverrides(value: InputOverrides with PaymentCardOverrides): Self = {
        val ret = this.duplicate
