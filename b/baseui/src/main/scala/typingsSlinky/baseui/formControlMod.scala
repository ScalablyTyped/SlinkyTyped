...
object formControlMod {
  ...
  object FormControlProps {
    ...
    implicit class FormControlPropsMutableBuilder[Self <: FormControlProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setError(value: Boolean | ReactElement): Self = StObject.set(x, "error", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPositive(value: ReactElement): Self = StObject.set(x, "positive", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPositiveReactElement(value: ReactElement): Self = StObject.set(x, "positive", value.asInstanceOf[js.Any])
