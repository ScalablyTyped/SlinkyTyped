...
object textareaMod {
  ...
  @js.native
  val STATE_CHANGE_TYPE: typingsSlinky.baseui.inputMod.STATE_CHANGE_TYPE = js.native
  ...
  @js.native
  val StatefulTextarea: ReactComponentClass[StatefulTextareaProps] = js.native
