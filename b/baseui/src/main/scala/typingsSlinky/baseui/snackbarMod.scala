...
import typingsSlinky.baseui.anon.Dequeue
...
object snackbarMod {
  ...
  @js.native
  val SnackbarElement: ReactComponentClass[SnackbarElementPropsT] = js.native
  
  @JSImport("baseui/snackbar", "SnackbarProvider")
  @js.native
  val SnackbarProvider: ReactComponentClass[SnackbarProviderPropsT] = js.native
  ...
  object SnackbarElementPropsT {
    ...
    implicit class SnackbarElementPropsTMutableBuilder[Self <: SnackbarElementPropsT] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActionOnClick(value: /* event */ SyntheticMouseEvent[HTMLButtonElement] => _): Self = StObject.set(x, "actionOnClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setStartEnhancer(value: ReactComponentClass[Size]): Self = StObject.set(x, "startEnhancer", value.asInstanceOf[js.Any])
  ...
  trait SnackbarProviderPropsT extends StObject {
    ...
    var overrides: js.UndefOr[typingsSlinky.baseui.anon.SnackbarElementOverridesT] = js.native
  ...
  object SnackbarProviderPropsT {
    ...
    implicit class SnackbarProviderPropsTMutableBuilder[Self <: SnackbarProviderPropsT] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOverrides(value: typingsSlinky.baseui.anon.SnackbarElementOverridesT): Self = StObject.set(x, "overrides", value.asInstanceOf[js.Any])
