...
object FileUploaderProps {
  ...
  implicit class FileUploaderPropsOps[Self <: FileUploaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetDataTransferItems(value: /* event */ SyntheticEvent[Event, js.Any] => js.Promise[js.Array[File | DataTransferItem]]): Self = this.set("getDataTransferItems", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnClick(value: /* event */ SyntheticMouseEvent[HTMLElement] => _): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnKeyDown(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => _): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    @scala.inline
