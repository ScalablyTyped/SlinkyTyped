...
@js.native
trait ReadonlyToastProps extends js.Object {
  val autoHideDuration: js.UndefOr[Double] = js.native
  val children: js.UndefOr[(js.Function1[/* args */ Dismiss, TagMod[Any]]) | TagMod[Any]] = js.native
...
object ReadonlyToastProps {
  ...
  @scala.inline
  implicit class ReadonlyToastPropsOps[Self <: ReadonlyToastProps] (val x: Self) extends AnyVal {
    @scala.inline
