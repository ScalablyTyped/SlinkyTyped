...
import typingsSlinky.baseui.baseuiStrings.MN
import typingsSlinky.baseui.baseuiStrings.Plussign976
import typingsSlinky.baseui.baseuiStrings.`Mongolia LeftparenthesisМонголRightparenthesis`
