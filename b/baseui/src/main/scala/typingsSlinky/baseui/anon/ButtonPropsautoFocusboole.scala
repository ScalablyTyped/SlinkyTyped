...
object ButtonPropsautoFocusboole {
  ...
  implicit class ButtonPropsautoFocusbooleOps[Self <: ButtonPropsautoFocusboole] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with$asFunctionComponent(value: ReactComponentClass[js.Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("$as")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with$asComponentClass(value: ReactComponentClass[js.Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("$as")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def with$as(value: StyletronBase): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("$as")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def with$styleFunction1(value: ButtonProps => StyleObject): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("$style")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def with$style(value: StyleProp[ButtonProps]): Self = {
        val ret = this.duplicate
