...
object Left {
  ...
  implicit class LeftOps[Self <: Left] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeft(value: typingsSlinky.baseui.baseuiNumbers.`0`): Self = this.set("left", value.asInstanceOf[js.Any])
    @scala.inline
    def setTop(value: typingsSlinky.baseui.baseuiNumbers.`0`): Self = this.set("top", value.asInstanceOf[js.Any])
  }
