...
object NewIndex {
  ...
  implicit class NewIndexOps[Self <: NewIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewStateVarargs(value: ReactElement*): Self = this.set("newState", js.Array(value :_*))
    
    @scala.inline
    def setNewState(value: js.Array[ReactElement]): Self = this.set("newState", value.asInstanceOf[js.Any])
