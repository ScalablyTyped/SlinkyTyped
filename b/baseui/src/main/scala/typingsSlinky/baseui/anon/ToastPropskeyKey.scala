...
object ToastPropskeyKey {
  ...
  implicit class ToastPropskeyKeyOps[Self <: ToastPropskeyKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnBlur(value: /* e */ org.scalajs.dom.raw.Event => _): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnFocus(value: /* e */ org.scalajs.dom.raw.Event => _): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnMouseEnter(value: /* e */ org.scalajs.dom.raw.Event => _): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnMouseLeave(value: /* e */ org.scalajs.dom.raw.Event => _): Self = {
        val ret = this.duplicate
