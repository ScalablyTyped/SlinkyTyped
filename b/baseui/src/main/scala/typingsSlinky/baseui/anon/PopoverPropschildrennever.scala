...
trait PopoverPropschildrennever extends js.Object {
  ...
  var onClick: js.UndefOr[js.Function1[/* e */ org.scalajs.dom.raw.Event, _]] = js.undefined
...
object PopoverPropschildrennever {
  ...
  def apply(
    ...
    content: TagMod[Any] | js.Function0[TagMod[Any]] = null,
    ...
    onBlur: () => _ = null,
    onClick: /* e */ org.scalajs.dom.raw.Event => _ = null,
