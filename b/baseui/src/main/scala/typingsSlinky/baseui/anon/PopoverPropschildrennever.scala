...
trait PopoverPropschildrennever extends js.Object {
  ...
  var overrides: js.UndefOr[typingsSlinky.baseui.popoverMod.Overrides] = js.native
...
object PopoverPropschildrennever {
  ...
  implicit class PopoverPropschildrenneverOps[Self <: PopoverPropschildrennever] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: /* e */ org.scalajs.dom.raw.Event => _): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOverrides(value: typingsSlinky.baseui.popoverMod.Overrides): Self = this.set("overrides", value.asInstanceOf[js.Any])
    @scala.inline
