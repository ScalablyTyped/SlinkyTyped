...
object FilterOption {
  ...
  implicit class FilterOptionOps[Self <: FilterOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilterOption(value: (/* option */ typingsSlinky.baseui.selectMod.Option, /* filterValue */ String) => Boolean): Self = this.set("filterOption", js.Any.fromFunction2(value))
    @scala.inline
