...
object `27` {
  ...
  implicit class `27Ops`[Self <: `27`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDialCode(value: Plussign226): Self = this.set("dialCode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: BF): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabel(value: `Burkina Faso`): Self = this.set("label", value.asInstanceOf[js.Any])
  }
}
