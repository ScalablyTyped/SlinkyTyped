...
trait Option extends js.Object {
  var option: js.UndefOr[typingsSlinky.baseui.selectMod.Option] = js.undefined
  var optionState: Disabled
}

object Option {
  @scala.inline
  def apply(optionState: Disabled, option: typingsSlinky.baseui.selectMod.Option = null): Option = {
