...
object tabsMotionMod {
  ...
  object FILL extends StObject {
    ...
    /* "fixed" */ val fixed: typingsSlinky.baseui.tabsMotionMod.FILL.fixed with String = js.native
    
    @js.native
    sealed trait intrinsic extends FILL
    /* "intrinsic" */ val intrinsic: typingsSlinky.baseui.tabsMotionMod.FILL.intrinsic with String = js.native
  }
  ...
  object ORIENTATION extends StObject {
    ...
    /* "horizontal" */ val horizontal: typingsSlinky.baseui.tabsMotionMod.ORIENTATION.horizontal with String = js.native
    
    @js.native
    sealed trait vertical extends ORIENTATION
    /* "vertical" */ val vertical: typingsSlinky.baseui.tabsMotionMod.ORIENTATION.vertical with String = js.native
  }
  ...
  object STATE_CHANGE_TYPE extends StObject {
    ...
    /* "change" */ val change: typingsSlinky.baseui.tabsMotionMod.STATE_CHANGE_TYPE.change with String = js.native
  }
  
  @JSImport("baseui/tabs-motion", "StatefulTabs")
  @js.native
  val StatefulTabs: ReactComponentClass[StatefulTabsProps] = js.native
