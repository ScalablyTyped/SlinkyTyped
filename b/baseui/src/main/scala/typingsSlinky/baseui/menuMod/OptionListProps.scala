...
object OptionListProps {
  ...
  implicit class OptionListPropsOps[Self <: OptionListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetItemLabel(value: js.Any => ReactElement): Self = this.set("getItemLabel", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setGetChildMenu(value: /* item */ js.Any => ReactElement): Self = this.set("getChildMenu", js.Any.fromFunction1(value))
    @scala.inline
