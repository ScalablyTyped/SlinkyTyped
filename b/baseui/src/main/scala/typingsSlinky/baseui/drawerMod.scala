...
object drawerMod {
  ...
  object DrawerProps {
    ...
    implicit class DrawerPropsMutableBuilder[Self <: DrawerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBackdropClick(value: /* event */ SyntheticMouseEvent[HTMLElement] => _): Self = StObject.set(x, "onBackdropClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnEscapeKeyDown(value: /* event */ SyntheticKeyboardEvent[HTMLElement] => _): Self = StObject.set(x, "onEscapeKeyDown", js.Any.fromFunction1(value))
