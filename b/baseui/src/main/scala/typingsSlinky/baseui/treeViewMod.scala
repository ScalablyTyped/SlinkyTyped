...
object treeViewMod {
  ...
  @js.native
  val StatefulTreeView: ReactComponentClass[TreeViewProps] = js.native
  ...
  @js.native
  val TreeLabel: ReactComponentClass[TreeLabelProps] = js.native
  
  @JSImport("baseui/tree-view", "TreeLabelInteractable")
  @js.native
  val TreeLabelInteractable: ReactComponentClass[Overrides] = js.native
  
  @JSImport("baseui/tree-view", "TreeView")
  @js.native
  val TreeView: ReactComponentClass[TreeViewProps] = js.native
  ...
  trait StatefulContainerProps extends StObject {
    ...
    def children(props: TreeViewProps): ReactElement = js.native
  ...
  object StatefulContainerProps {
    ...
    @scala.inline
    def apply(children: TreeViewProps => ReactElement, data: js.Array[TreeNode[_]]): StatefulContainerProps = {
    ...
    implicit class StatefulContainerPropsMutableBuilder[Self <: StatefulContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: TreeViewProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  object TreeLabelProps {
    ...
    implicit class TreeLabelPropsMutableBuilder[Self <: TreeLabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabel(value: (js.Function1[/* node */ TreeNode[_], ReactElement]) | String): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelFunction1(value: /* node */ TreeNode[_] => ReactElement): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
