...
object accordionMod {
  ...
  @js.native
  val StatefulPanel: ReactComponentClass[StatefulPanelProps] = js.native
  ...
  @js.native
  val StatelessAccordion: ReactComponentClass[StatelessAccordionProps] = js.native
  ...
  object StatelessAccordionProps {
    ...
    implicit class StatelessAccordionPropsMutableBuilder[Self <: StatelessAccordionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: /* args */ typingsSlinky.baseui.anon.Key => _): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
