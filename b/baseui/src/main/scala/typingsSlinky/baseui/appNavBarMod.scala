...
object appNavBarMod {
  ...
  object AppNavBarPropsT {
    ...
    implicit class AppNavBarPropsTMutableBuilder[Self <: AppNavBarPropsT] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMapItemToNode(value: /* item */ NavItemT => ReactElement): Self = StObject.set(x, "mapItemToNode", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setUsernameSubtitle(value: ReactElement): Self = StObject.set(x, "usernameSubtitle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUsernameSubtitleReactElement(value: ReactElement): Self = StObject.set(x, "usernameSubtitle", value.asInstanceOf[js.Any])
  ...
  object NavItemT {
    ...
    implicit class NavItemTMutableBuilder[Self <: NavItemT] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIcon(value: ReactComponentClass[_]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNavExitIcon(value: ReactComponentClass[_]): Self = StObject.set(x, "navExitIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavExitIconComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "navExitIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavExitIconFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "navExitIcon", value.asInstanceOf[js.Any])
