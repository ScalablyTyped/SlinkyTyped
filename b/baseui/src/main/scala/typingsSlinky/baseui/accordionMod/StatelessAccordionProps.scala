...
trait StatelessAccordionProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function1[/* args */ typingsSlinky.baseui.anon.Key, _]] = js.native
...
object StatelessAccordionProps {
  ...
  implicit class StatelessAccordionPropsOps[Self <: StatelessAccordionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: /* args */ typingsSlinky.baseui.anon.Key => _): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
