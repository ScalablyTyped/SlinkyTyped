...
object NumberedStepProps {
  ...
  implicit class NumberedStepPropsOps[Self <: NumberedStepProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStepReactElement(value: ReactElement): Self = this.set("step", value.asInstanceOf[js.Any])
    @scala.inline
    def setStep(value: ReactElement): Self = this.set("step", value.asInstanceOf[js.Any])
    @scala.inline
