...
import typingsSlinky.baseui.Anon_EventItemAny
...
trait NavigationProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function1[/* args */ Anon_EventItemAny, _]] = js.undefined
...
object NavigationProps {
  ...
  def apply(
    ...
    onChange: /* args */ Anon_EventItemAny => _ = null,
