...
object Anon54 {
  @scala.inline
  def apply(dialCode: Plussign1767, id: DM, label: Dominica): Anon54 = {
  ...
  implicit class Anon54Ops[Self <: Anon54] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDialCode(value: Plussign1767): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dialCode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withId(value: DM): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLabel(value: Dominica): Self = {
        val ret = this.duplicate
