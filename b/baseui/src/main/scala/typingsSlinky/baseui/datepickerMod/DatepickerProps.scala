...
object DatepickerProps {
  ...
  implicit class DatepickerPropsOps[Self <: DatepickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilterDate(value: /* day */ js.Date => Boolean): Self = this.set("filterDate", js.Any.fromFunction1(value))
    @scala.inline
    def deleteFilterDate: Self = this.set("filterDate", js.undefined)
    @scala.inline
    def setFormatDisplayValue(value: (/* date */ js.Date | js.Array[js.Date], /* formatString */ String) => String): Self = this.set("formatDisplayValue", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setHighlightedDate(value: js.Date): Self = this.set("highlightedDate", value.asInstanceOf[js.Any])
    @scala.inline
