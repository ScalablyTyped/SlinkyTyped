...
trait TimezonePickerProps extends StObject {
  ...
  var mapLabels: js.UndefOr[js.Function1[/* args */ Option, ReactElement]] = js.native
...
object TimezonePickerProps {
  ...
  implicit class TimezonePickerPropsMutableBuilder[Self <: TimezonePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMapLabels(value: /* args */ Option => ReactElement): Self = StObject.set(x, "mapLabels", js.Any.fromFunction1(value))
