...
object Anon188 {
  @scala.inline
  def apply(dialCode: Plussign1721, id: SX, label: `Sint Maarten`): Anon188 = {
  ...
  implicit class Anon188Ops[Self <: Anon188] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDialCode(value: Plussign1721): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dialCode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withId(value: SX): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLabel(value: `Sint Maarten`): Self = {
        val ret = this.duplicate
