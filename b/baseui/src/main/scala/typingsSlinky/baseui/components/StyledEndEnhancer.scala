...
object StyledEndEnhancer {
  ...
  implicit def make(companion: StyledEndEnhancer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
