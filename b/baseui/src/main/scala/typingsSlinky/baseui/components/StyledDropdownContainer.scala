...
object StyledDropdownContainer {
  ...
  implicit def make(companion: StyledDropdownContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
