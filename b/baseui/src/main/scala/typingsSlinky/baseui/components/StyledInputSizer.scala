...
object StyledInputSizer {
  ...
  implicit def make(companion: StyledInputSizer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
