...
object StyledDropdownListItem {
  ...
  implicit def make(companion: StyledDropdownListItem.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
