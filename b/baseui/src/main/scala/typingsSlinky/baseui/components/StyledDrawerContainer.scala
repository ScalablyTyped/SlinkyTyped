...
object StyledDrawerContainer {
  ...
  implicit def make(companion: StyledDrawerContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
