...
object StyledLoadingSpinnerContainer {
  ...
  implicit def make(companion: StyledLoadingSpinnerContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
