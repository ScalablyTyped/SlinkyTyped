...
object StyledListItem {
  ...
  implicit def make(companion: StyledListItem.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
