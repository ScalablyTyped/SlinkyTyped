...
object StyledSingleValue {
  ...
  implicit def make(companion: StyledSingleValue.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
