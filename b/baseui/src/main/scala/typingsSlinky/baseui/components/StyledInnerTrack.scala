...
object StyledInnerTrack {
  ...
  implicit def make(companion: StyledInnerTrack.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
