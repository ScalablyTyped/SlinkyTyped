...
import typingsSlinky.baseui.StatefulDatepickerPropsDa
...
object StatefulDatepicker {
  ...
  def withProps(p: StatefulDatepickerPropsDa): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: StatefulDatepicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
