...
object StyledSeparator {
  ...
  implicit def make(companion: StyledSeparator.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
