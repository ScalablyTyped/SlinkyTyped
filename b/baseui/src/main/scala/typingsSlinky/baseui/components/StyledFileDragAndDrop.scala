...
object StyledFileDragAndDrop {
  ...
  implicit def make(companion: StyledFileDragAndDrop.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
