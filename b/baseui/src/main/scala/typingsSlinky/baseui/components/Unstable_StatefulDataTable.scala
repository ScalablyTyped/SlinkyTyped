...
object Unstable_StatefulDataTable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.baseui.dataDashTableMod.Unstable_StatefulDataTable] {
