...
object StyledCountrySelectDropdownNameColumn {
  ...
  implicit def make(companion: StyledCountrySelectDropdownNameColumn.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
