...
object StyledToggleTrack {
  ...
  implicit def make(companion: StyledToggleTrack.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
