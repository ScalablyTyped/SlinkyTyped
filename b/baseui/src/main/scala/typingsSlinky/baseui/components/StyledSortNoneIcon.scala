...
object StyledSortNoneIcon {
  ...
  implicit def make(companion: StyledSortNoneIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
