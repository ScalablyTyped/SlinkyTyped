...
object StyledTableBody {
  ...
  implicit def make(companion: StyledTableBody.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
