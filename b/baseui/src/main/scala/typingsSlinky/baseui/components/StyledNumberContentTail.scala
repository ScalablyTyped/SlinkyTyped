...
object StyledNumberContentTail {
  
  @JSImport("baseui/progress-steps", "StyledNumberContentTail")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: StyledNumberContentTail.type): SharedBuilder_PropsWithChildren_6741298 = new SharedBuilder_PropsWithChildren_6741298(js.Array(this.component, js.Dictionary.empty))()
