...
object StyledProfileImg {
  ...
  implicit def make(companion: StyledProfileImg.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
