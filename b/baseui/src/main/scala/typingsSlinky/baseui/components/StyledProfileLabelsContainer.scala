...
object StyledProfileLabelsContainer {
  ...
  implicit def make(companion: StyledProfileLabelsContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
