...
object StyledBarProgress {
  ...
  implicit def make(companion: StyledBarProgress.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
