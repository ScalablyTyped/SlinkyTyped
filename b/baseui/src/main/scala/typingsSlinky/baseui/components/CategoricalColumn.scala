...
object CategoricalColumn {
  ...
  implicit def make(companion: CategoricalColumn.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
