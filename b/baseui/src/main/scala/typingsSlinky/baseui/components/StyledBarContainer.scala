...
object StyledBarContainer {
  ...
  implicit def make(companion: StyledBarContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
