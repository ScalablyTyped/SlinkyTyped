...
object StyledValueContainer {
  ...
  implicit def make(companion: StyledValueContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
