...
object StyledStartEnhancer {
  ...
  implicit def make(companion: StyledStartEnhancer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
