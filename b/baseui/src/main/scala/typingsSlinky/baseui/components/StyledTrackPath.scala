...
object StyledTrackPath {
  ...
  implicit def make(companion: StyledTrackPath.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
