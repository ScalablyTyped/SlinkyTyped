...
object StyledHiddenInput {
  ...
  implicit def make(companion: StyledHiddenInput.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
