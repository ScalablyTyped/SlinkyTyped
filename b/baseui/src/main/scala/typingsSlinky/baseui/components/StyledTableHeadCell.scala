...
object StyledTableHeadCell {
  ...
  implicit def make(companion: StyledTableHeadCell.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
