...
object MonoParagraphLarge {
  ...
  implicit def make(companion: MonoParagraphLarge.type): SharedBuilder_BlockProps1115621296[js.Object] = new SharedBuilder_BlockProps1115621296[js.Object](js.Array(this.component, js.Dictionary.empty))()
