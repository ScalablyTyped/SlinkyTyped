...
object CheckIndeterminate {
  
  @JSImport("baseui/icon", "CheckIndeterminate")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CheckIndeterminate.type): SharedBuilder_IconProps_510117459 = new SharedBuilder_IconProps_510117459(js.Array(this.component, js.Dictionary.empty))()
