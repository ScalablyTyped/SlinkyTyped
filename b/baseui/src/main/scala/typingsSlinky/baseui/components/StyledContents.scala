...
object StyledContents {
  ...
  implicit def make(companion: StyledContents.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
