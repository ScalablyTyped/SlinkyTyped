...
object StyledToggleInner {
  ...
  implicit def make(companion: StyledToggleInner.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
