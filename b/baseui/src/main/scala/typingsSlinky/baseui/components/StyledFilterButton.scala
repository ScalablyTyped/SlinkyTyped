...
object StyledFilterButton {
  ...
  implicit def make(companion: StyledFilterButton.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
