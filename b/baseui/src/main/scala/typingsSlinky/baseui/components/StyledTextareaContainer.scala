...
object StyledTextareaContainer {
  ...
  implicit def make(companion: StyledTextareaContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
