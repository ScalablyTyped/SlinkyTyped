...
object StyledRadioMarkOuter {
  ...
  implicit def make(companion: StyledRadioMarkOuter.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
