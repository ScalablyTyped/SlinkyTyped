...
object StyledActionIcon {
  ...
  implicit def make(companion: StyledActionIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
