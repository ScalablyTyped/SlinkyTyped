...
object StyledOptionContent {
  ...
  implicit def make(companion: StyledOptionContent.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
