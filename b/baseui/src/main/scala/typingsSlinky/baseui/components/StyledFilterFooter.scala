...
object StyledFilterFooter {
  ...
  implicit def make(companion: StyledFilterFooter.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
