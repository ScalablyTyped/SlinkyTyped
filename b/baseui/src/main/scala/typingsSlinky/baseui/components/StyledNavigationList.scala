...
object StyledNavigationList {
  ...
  implicit def make(companion: StyledNavigationList.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
