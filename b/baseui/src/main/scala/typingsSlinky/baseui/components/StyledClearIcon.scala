...
object StyledClearIcon {
  ...
  implicit def make(companion: StyledClearIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
