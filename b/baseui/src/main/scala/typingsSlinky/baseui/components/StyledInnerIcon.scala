...
object StyledInnerIcon {
  ...
  implicit def make(companion: StyledInnerIcon.type): SharedBuilder_PropsWithChildren_6741298 = new SharedBuilder_PropsWithChildren_6741298(js.Array(this.component, js.Dictionary.empty))()
}
