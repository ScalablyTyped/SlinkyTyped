...
object StyledTabPanel {
  ...
  implicit def make(companion: StyledTabPanel.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
