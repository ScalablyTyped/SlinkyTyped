...
object StyledHeaderImage {
  ...
  implicit def make(companion: StyledHeaderImage.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
