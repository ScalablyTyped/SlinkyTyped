...
object AspectRatioBox {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.baseui.aspectRatioBoxMod.AspectRatioBox] {
  ...
  def withProps(p: AspectRatioBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: AspectRatioBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
