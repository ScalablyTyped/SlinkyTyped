...
object StyledProfileImgContainer {
  ...
  implicit def make(companion: StyledProfileImgContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
