...
object StyledSearchIcon {
  ...
  implicit def make(companion: StyledSearchIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
