...
object StyledNavigationItem {
  ...
  implicit def make(companion: StyledNavigationItem.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
