...
object StyledSortableLabel {
  ...
  implicit def make(companion: StyledSortableLabel.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
