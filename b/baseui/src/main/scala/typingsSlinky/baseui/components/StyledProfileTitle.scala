...
object StyledProfileTitle {
  ...
  implicit def make(companion: StyledProfileTitle.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
