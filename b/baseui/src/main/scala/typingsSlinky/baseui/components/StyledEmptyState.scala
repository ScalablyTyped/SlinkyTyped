...
object StyledEmptyState {
  ...
  implicit def make(companion: StyledEmptyState.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
