...
object StyledPlaceholder {
  ...
  implicit def make(companion: StyledPlaceholder.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
