...
object StyledCountrySelectDropdownDialcodeColumn {
  ...
  implicit def make(companion: StyledCountrySelectDropdownDialcodeColumn.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
