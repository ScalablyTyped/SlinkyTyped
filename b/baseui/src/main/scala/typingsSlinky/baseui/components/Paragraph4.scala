...
object Paragraph4 {
  ...
  implicit def make(companion: Paragraph4.type): SharedBuilder_BlockProps1115621296[Ref[js.Any]] = new SharedBuilder_BlockProps1115621296[Ref[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
