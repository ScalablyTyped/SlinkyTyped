...
object StyledRadioGroupRoot {
  ...
  implicit def make(companion: StyledRadioGroupRoot.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
