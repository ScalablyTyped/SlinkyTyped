...
object StyledInputEnhancer {
  ...
  implicit def make(companion: StyledInputEnhancer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
