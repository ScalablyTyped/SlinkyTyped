...
object StyledToggleIcon {
  ...
  implicit def make(companion: StyledToggleIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
