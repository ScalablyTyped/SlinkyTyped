...
object StyledCloseHandle {
  ...
  implicit def make(companion: StyledCloseHandle.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
