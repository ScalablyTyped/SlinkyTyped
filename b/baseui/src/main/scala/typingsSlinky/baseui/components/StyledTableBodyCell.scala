...
object StyledTableBodyCell {
  ...
  implicit def make(companion: StyledTableBodyCell.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
