...
object StyledMaxLabel {
  ...
  implicit def make(companion: StyledMaxLabel.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
