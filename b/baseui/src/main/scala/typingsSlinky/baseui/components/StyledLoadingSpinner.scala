...
object StyledLoadingSpinner {
  ...
  implicit def make(companion: StyledLoadingSpinner.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
