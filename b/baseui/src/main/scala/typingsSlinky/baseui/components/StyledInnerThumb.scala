...
object StyledInnerThumb {
  ...
  implicit def make(companion: StyledInnerThumb.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
