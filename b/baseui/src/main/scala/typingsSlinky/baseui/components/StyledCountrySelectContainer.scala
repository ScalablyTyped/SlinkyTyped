...
object StyledCountrySelectContainer {
  ...
  implicit def make(companion: StyledCountrySelectContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
