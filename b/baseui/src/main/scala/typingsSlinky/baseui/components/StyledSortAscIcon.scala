...
object StyledSortAscIcon {
  ...
  implicit def make(companion: StyledSortAscIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
