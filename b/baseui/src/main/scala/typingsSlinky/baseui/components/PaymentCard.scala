...
object PaymentCard
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.baseui.paymentCardMod.PaymentCard] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.baseui.paymentCardMod.PaymentCard] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.baseui.paymentCardMod.PaymentCard] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.baseui.paymentCardMod.PaymentCard](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
