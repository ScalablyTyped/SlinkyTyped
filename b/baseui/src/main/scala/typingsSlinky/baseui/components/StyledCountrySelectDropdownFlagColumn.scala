...
object StyledCountrySelectDropdownFlagColumn {
  ...
  implicit def make(companion: StyledCountrySelectDropdownFlagColumn.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
