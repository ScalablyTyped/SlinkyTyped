...
object StatefulInput {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def overrides(value: InputOverrides): this.type = set("overrides", value.asInstanceOf[js.Any])
  ...
  def withProps(p: StatefulInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(children: js.UndefOr[ReactElement] with js.UndefOr[scala.Nothing]): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[StatefulInputProps]))
  }
}
