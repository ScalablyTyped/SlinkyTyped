...
object StyledTabContent {
  ...
  implicit def make(companion: StyledTabContent.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
