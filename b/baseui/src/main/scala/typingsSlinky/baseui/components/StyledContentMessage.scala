...
object StyledContentMessage {
  ...
  implicit def make(companion: StyledContentMessage.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
