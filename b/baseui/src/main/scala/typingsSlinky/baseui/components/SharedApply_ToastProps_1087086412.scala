...
abstract class SharedApply_ToastProps_1087086412[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: onBlur, onFocus, onMouseEnter, onMouseLeave */
  def apply(
