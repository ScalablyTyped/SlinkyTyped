...
object StyledThumbnail {
  ...
  implicit def make(companion: StyledThumbnail.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
