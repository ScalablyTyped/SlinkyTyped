...
object Overflow {
  ...
  implicit def make(companion: Overflow.type): SharedBuilder_IconProps_510117459 = new SharedBuilder_IconProps_510117459(js.Array(this.component, js.Dictionary.empty))()
