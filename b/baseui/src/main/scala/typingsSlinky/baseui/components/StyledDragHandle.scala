...
object StyledDragHandle {
  ...
  implicit def make(companion: StyledDragHandle.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
