...
object StyledTableHead {
  ...
  implicit def make(companion: StyledTableHead.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
