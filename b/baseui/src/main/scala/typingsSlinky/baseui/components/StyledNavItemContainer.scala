...
object StyledNavItemContainer {
  ...
  implicit def make(companion: StyledNavItemContainer.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
