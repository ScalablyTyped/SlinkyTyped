...
object StyledDescription {
  ...
  implicit def make(companion: StyledDescription.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
