...
object FlexGridItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def flexGridItemCount(value: Double): this.type = set("flexGridItemCount", value.asInstanceOf[js.Any])
    @scala.inline
    def flexGridItemIndex(value: Double): this.type = set("flexGridItemIndex", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: FlexGridItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: FlexGridItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
