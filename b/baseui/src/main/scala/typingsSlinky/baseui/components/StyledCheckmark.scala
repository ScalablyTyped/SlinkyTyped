...
object StyledCheckmark {
  ...
  implicit def make(companion: StyledCheckmark.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
