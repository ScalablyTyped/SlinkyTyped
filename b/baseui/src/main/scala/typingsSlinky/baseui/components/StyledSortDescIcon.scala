...
object StyledSortDescIcon {
  ...
  implicit def make(companion: StyledSortDescIcon.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
