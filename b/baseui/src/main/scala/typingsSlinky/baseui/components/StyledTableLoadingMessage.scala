...
object StyledTableLoadingMessage {
  ...
  implicit def make(companion: StyledTableLoadingMessage.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
