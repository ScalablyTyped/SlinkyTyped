...
object StyledSpinnerNext {
  ...
  implicit def make(companion: StyledSpinnerNext.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
