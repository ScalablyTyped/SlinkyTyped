...
object StyledItemContent {
  ...
  implicit def make(companion: StyledItemContent.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
