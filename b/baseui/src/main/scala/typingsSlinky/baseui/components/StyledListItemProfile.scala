...
object StyledListItemProfile {
  ...
  implicit def make(companion: StyledListItemProfile.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
