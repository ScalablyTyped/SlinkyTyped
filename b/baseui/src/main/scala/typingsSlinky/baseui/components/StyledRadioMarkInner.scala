...
object StyledRadioMarkInner {
  ...
  implicit def make(companion: StyledRadioMarkInner.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
