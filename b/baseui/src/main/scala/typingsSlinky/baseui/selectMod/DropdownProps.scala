...
trait DropdownProps extends StObject {
  ...
  var getOptionLabel: js.UndefOr[js.Function1[/* args */ OptionState, ReactElement]] = js.native
...
object DropdownProps {
  ...
  implicit class DropdownPropsMutableBuilder[Self <: DropdownProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetOptionLabel(value: /* args */ OptionState => ReactElement): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
