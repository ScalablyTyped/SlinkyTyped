...
object StatefulSelectProps {
  ...
  implicit class StatefulSelectPropsMutableBuilder[Self <: StatefulSelectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setControlRefRefObject(value: ReactRef[HTMLInputElement | HTMLDivElement]): Self = StObject.set(x, "controlRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetOptionLabel(value: /* args */ typingsSlinky.baseui.anon.Option => ReactElement): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetOptionLabelUndefined: Self = StObject.set(x, "getOptionLabel", js.undefined)
    
    @scala.inline
    def setGetValueLabel(value: /* args */ OptionOption => ReactElement): Self = StObject.set(x, "getValueLabel", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setNoResultsMsg(value: ReactElement): Self = StObject.set(x, "noResultsMsg", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoResultsMsgReactElement(value: ReactElement): Self = StObject.set(x, "noResultsMsg", value.asInstanceOf[js.Any])
