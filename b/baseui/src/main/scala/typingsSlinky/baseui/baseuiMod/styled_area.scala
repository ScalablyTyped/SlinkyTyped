...
object styled_area extends js.Object {
  def apply[P /* <: js.Object */, T](component: area, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[area], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: area, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[area], Exclude[String, Anon_ClassName]]) with P] = js.native
}
