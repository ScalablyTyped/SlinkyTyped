...
object styled_text extends js.Object {
  def apply[P /* <: js.Object */, T](component: text, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[text], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: text, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[text], Exclude[String, Anon_ClassName]]) with P] = js.native
}
