...
object styled_datalist extends js.Object {
  def apply[P /* <: js.Object */, T](component: datalist, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[datalist], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: datalist, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[datalist], Exclude[String, Anon_ClassName]]) with P] = js.native
}
