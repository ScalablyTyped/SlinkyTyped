...
object styled_radialGradient extends js.Object {
  def apply[P /* <: js.Object */, T](component: radialGradient, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[radialGradient], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: radialGradient, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[radialGradient], Exclude[String, Anon_ClassName]]) with P] = js.native
}
