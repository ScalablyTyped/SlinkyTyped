...
object styled_textarea extends js.Object {
  def apply[P /* <: js.Object */, T](component: textarea, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[textarea], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: textarea, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[textarea], Exclude[String, Anon_ClassName]]) with P] = js.native
}
