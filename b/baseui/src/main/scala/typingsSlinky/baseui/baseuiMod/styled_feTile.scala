...
object styled_feTile extends js.Object {
  def apply[P /* <: js.Object */, T](component: feTile, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feTile], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feTile, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feTile], Exclude[String, Anon_ClassName]]) with P] = js.native
}
