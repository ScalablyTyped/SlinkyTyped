...
object styled_h5 extends js.Object {
  def apply[P /* <: js.Object */, T](component: h5, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[h5], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: h5, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[h5], Exclude[String, Anon_ClassName]]) with P] = js.native
}
