...
object styled_textPath extends js.Object {
  def apply[P /* <: js.Object */, T](component: textPath, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[textPath], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: textPath, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[textPath], Exclude[String, Anon_ClassName]]) with P] = js.native
}
