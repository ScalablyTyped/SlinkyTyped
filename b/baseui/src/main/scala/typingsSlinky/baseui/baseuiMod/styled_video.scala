...
object styled_video extends js.Object {
  def apply[P /* <: js.Object */, T](component: video, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[video], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: video, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[video], Exclude[String, Anon_ClassName]]) with P] = js.native
}
