...
object styled_animateTransform extends js.Object {
  def apply[P /* <: js.Object */, T](component: animateTransform, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[animateTransform], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: animateTransform, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[animateTransform], Exclude[String, Anon_ClassName]]) with P] = js.native
}
