...
object styled_caption extends js.Object {
  def apply[P /* <: js.Object */, T](component: caption, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[caption], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: caption, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[caption], Exclude[String, Anon_ClassName]]) with P] = js.native
}
