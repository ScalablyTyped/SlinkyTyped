...
object styled_section extends js.Object {
  def apply[P /* <: js.Object */, T](component: section, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[section], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: section, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[section], Exclude[String, Anon_ClassName]]) with P] = js.native
}
