...
object styled_clipPath extends js.Object {
  def apply[P /* <: js.Object */, T](component: clipPath, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[clipPath], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: clipPath, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[clipPath], Exclude[String, Anon_ClassName]]) with P] = js.native
}
