...
object styled_menu extends js.Object {
  def apply[P /* <: js.Object */, T](component: menu, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[menu], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: menu, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[menu], Exclude[String, Anon_ClassName]]) with P] = js.native
}
