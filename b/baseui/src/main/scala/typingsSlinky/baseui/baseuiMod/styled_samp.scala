...
object styled_samp extends js.Object {
  def apply[P /* <: js.Object */, T](component: samp, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[samp], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: samp, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[samp], Exclude[String, Anon_ClassName]]) with P] = js.native
}
