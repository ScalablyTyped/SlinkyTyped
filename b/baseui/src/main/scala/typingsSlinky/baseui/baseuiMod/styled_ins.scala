...
object styled_ins extends js.Object {
  def apply[P /* <: js.Object */, T](component: ins, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[ins], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: ins, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[ins], Exclude[String, Anon_ClassName]]) with P] = js.native
}
