...
object styled_dfn extends js.Object {
  def apply[P /* <: js.Object */, T](component: dfn, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[dfn], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: dfn, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[dfn], Exclude[String, Anon_ClassName]]) with P] = js.native
}
