...
object styled_data extends js.Object {
  def apply[P /* <: js.Object */, T](component: data, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[data], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: data, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[data], Exclude[String, Anon_ClassName]]) with P] = js.native
}
