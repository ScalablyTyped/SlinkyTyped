...
object styled_q extends js.Object {
  def apply[P /* <: js.Object */, T](component: q, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[q], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: q, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[q], Exclude[String, Anon_ClassName]]) with P] = js.native
}
