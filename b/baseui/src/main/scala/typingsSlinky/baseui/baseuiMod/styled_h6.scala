...
object styled_h6 extends js.Object {
  def apply[P /* <: js.Object */, T](component: h6, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[h6], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: h6, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[h6], Exclude[String, Anon_ClassName]]) with P] = js.native
}
