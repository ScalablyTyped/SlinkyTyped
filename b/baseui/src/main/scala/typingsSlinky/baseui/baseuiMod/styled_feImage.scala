...
object styled_feImage extends js.Object {
  def apply[P /* <: js.Object */, T](component: feImage, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feImage], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feImage, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feImage], Exclude[String, Anon_ClassName]]) with P] = js.native
}
