...
object styled_meter extends js.Object {
  def apply[P /* <: js.Object */, T](component: meter, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[meter], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: meter, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[meter], Exclude[String, Anon_ClassName]]) with P] = js.native
}
