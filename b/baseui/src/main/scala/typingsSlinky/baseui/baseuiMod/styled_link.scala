...
object styled_link extends js.Object {
  def apply[P /* <: js.Object */, T](component: link, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[link], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: link, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[link], Exclude[String, Anon_ClassName]]) with P] = js.native
}
