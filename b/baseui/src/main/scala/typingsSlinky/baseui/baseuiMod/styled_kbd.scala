...
@js.native
object styled_kbd extends js.Object {
  def apply[P /* <: js.Object */, T](component: kbd, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[kbd], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: kbd, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[kbd], Exclude[String, Anon_ClassName]]) with P] = js.native
}
