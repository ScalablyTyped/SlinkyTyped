...
object styled_abbr extends js.Object {
  def apply[P /* <: js.Object */, T](component: abbr, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[abbr], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: abbr, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[abbr], Exclude[String, Anon_ClassName]]) with P] = js.native
}
