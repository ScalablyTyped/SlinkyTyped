...
object styled_html extends js.Object {
  def apply[P /* <: js.Object */, T](component: html, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[html], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: html, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[html], Exclude[String, Anon_ClassName]]) with P] = js.native
}
