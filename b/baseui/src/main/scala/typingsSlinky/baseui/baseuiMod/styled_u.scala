...
object styled_u extends js.Object {
  def apply[P /* <: js.Object */, T](component: u, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[u], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: u, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[u], Exclude[String, Anon_ClassName]]) with P] = js.native
}
