...
object styled_bdo extends js.Object {
  def apply[P /* <: js.Object */, T](component: bdo, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[bdo], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: bdo, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[bdo], Exclude[String, Anon_ClassName]]) with P] = js.native
}
