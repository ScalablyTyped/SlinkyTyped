...
object styled_dd extends js.Object {
  def apply[P /* <: js.Object */, T](component: dd, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[dd], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: dd, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[dd], Exclude[String, Anon_ClassName]]) with P] = js.native
}
