...
object styled_noindex extends js.Object {
  def apply[P /* <: js.Object */, T](component: noindex, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[noindex], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: noindex, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[noindex], Exclude[String, Anon_ClassName]]) with P] = js.native
}
