...
object styled_meta extends js.Object {
  def apply[P /* <: js.Object */, T](component: meta, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[meta], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: meta, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[meta], Exclude[String, Anon_ClassName]]) with P] = js.native
}
