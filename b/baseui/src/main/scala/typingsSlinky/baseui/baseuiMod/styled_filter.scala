...
object styled_filter extends js.Object {
  def apply[P /* <: js.Object */, T](component: filter, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[filter], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: filter, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[filter], Exclude[String, Anon_ClassName]]) with P] = js.native
}
