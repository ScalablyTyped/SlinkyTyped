...
object styled_code extends js.Object {
  def apply[P /* <: js.Object */, T](component: code, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[code], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: code, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[code], Exclude[String, Anon_ClassName]]) with P] = js.native
}
