...
object styled_source extends js.Object {
  def apply[P /* <: js.Object */, T](component: source, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[source], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: source, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[source], Exclude[String, Anon_ClassName]]) with P] = js.native
}
