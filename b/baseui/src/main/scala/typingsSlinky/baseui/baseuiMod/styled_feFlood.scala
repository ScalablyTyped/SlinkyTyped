...
object styled_feFlood extends js.Object {
  def apply[P /* <: js.Object */, T](component: feFlood, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feFlood], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feFlood, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feFlood], Exclude[String, Anon_ClassName]]) with P] = js.native
}
