...
object styled_details extends js.Object {
  def apply[P /* <: js.Object */, T](component: details, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[details], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: details, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[details], Exclude[String, Anon_ClassName]]) with P] = js.native
}
