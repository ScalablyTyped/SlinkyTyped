...
object styled_img extends js.Object {
  def apply[P /* <: js.Object */, T](component: img, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[img], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: img, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[img], Exclude[String, Anon_ClassName]]) with P] = js.native
}
