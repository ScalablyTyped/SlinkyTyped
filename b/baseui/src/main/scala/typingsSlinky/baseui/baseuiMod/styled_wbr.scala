...
object styled_wbr extends js.Object {
  def apply[P /* <: js.Object */, T](component: wbr, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[wbr], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: wbr, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[wbr], Exclude[String, Anon_ClassName]]) with P] = js.native
}
