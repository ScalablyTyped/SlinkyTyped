...
object styled_feSpotLight extends js.Object {
  def apply[P /* <: js.Object */, T](component: feSpotLight, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feSpotLight], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feSpotLight, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feSpotLight], Exclude[String, Anon_ClassName]]) with P] = js.native
}
