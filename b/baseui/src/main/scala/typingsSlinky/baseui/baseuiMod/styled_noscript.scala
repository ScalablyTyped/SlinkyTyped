...
object styled_noscript extends js.Object {
  def apply[P /* <: js.Object */, T](component: noscript, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[noscript], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: noscript, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[noscript], Exclude[String, Anon_ClassName]]) with P] = js.native
}
