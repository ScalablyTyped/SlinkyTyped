...
object styled_figcaption extends js.Object {
  def apply[P /* <: js.Object */, T](component: figcaption, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[figcaption], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: figcaption, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[figcaption], Exclude[String, Anon_ClassName]]) with P] = js.native
}
