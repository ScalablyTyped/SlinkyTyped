...
object styled_feDropShadow extends js.Object {
  def apply[P /* <: js.Object */, T](component: feDropShadow, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feDropShadow], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feDropShadow, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feDropShadow], Exclude[String, Anon_ClassName]]) with P] = js.native
}
