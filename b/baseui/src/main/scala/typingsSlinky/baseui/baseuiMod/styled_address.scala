...
object styled_address extends js.Object {
  def apply[P /* <: js.Object */, T](component: address, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[address], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: address, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[address], Exclude[String, Anon_ClassName]]) with P] = js.native
}
