...
object styled_feConvolveMatrix extends js.Object {
  def apply[P /* <: js.Object */, T](component: feConvolveMatrix, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feConvolveMatrix], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feConvolveMatrix, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feConvolveMatrix], Exclude[String, Anon_ClassName]]) with P] = js.native
}
