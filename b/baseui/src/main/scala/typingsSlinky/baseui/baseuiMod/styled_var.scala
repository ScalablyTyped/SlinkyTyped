...
object styled_var extends js.Object {
  def apply[P /* <: js.Object */, T](component: `var`, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[`var`], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: `var`, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[`var`], Exclude[String, Anon_ClassName]]) with P] = js.native
}
