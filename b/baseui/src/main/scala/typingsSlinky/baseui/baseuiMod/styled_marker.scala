...
object styled_marker extends js.Object {
  def apply[P /* <: js.Object */, T](component: marker, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[marker], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: marker, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[marker], Exclude[String, Anon_ClassName]]) with P] = js.native
}
