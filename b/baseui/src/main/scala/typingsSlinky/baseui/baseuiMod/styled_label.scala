...
object styled_label extends js.Object {
  def apply[P /* <: js.Object */, T](component: label, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[label], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: label, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[label], Exclude[String, Anon_ClassName]]) with P] = js.native
}
