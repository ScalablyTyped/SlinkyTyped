...
object styled_body extends js.Object {
  def apply[P /* <: js.Object */, T](component: body, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[body], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: body, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[body], Exclude[String, Anon_ClassName]]) with P] = js.native
}
