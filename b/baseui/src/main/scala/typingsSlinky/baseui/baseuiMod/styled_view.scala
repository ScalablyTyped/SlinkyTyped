...
object styled_view extends js.Object {
  def apply[P /* <: js.Object */, T](component: view, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[view], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: view, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[view], Exclude[String, Anon_ClassName]]) with P] = js.native
}
