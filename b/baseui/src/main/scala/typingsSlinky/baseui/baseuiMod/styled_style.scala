...
object styled_style extends js.Object {
  def apply[P /* <: js.Object */, T](component: style, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[style], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: style, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[style], Exclude[String, Anon_ClassName]]) with P] = js.native
}
