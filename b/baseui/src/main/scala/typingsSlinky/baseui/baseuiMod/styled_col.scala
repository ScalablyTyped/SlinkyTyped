...
object styled_col extends js.Object {
  def apply[P /* <: js.Object */, T](component: col, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[col], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: col, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[col], Exclude[String, Anon_ClassName]]) with P] = js.native
}
