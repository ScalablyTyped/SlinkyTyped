...
object styled_ruby extends js.Object {
  def apply[P /* <: js.Object */, T](component: ruby, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[ruby], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: ruby, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[ruby], Exclude[String, Anon_ClassName]]) with P] = js.native
}
