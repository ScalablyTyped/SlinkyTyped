...
trait ProgressBarProps extends js.Object {
  ...
  var getProgressLabel: js.UndefOr[js.Function2[/* value */ Double, /* successValue */ Double, ReactElement]] = js.native
...
object ProgressBarProps {
  ...
  implicit class ProgressBarPropsOps[Self <: ProgressBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetProgressLabel(value: (/* value */ Double, /* successValue */ Double) => ReactElement): Self = this.set("getProgressLabel", js.Any.fromFunction2(value))
