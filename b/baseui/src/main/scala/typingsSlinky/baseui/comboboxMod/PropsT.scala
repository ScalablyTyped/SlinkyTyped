...
trait PropsT[OptionT] extends js.Object {
  ...
  var mapOptionToNode: js.UndefOr[js.Function1[/* hasIsSelectedOption */ js.Any, TagMod[Any]]] = js.undefined
...
object PropsT {
  ...
  def apply[OptionT](
    ...
    mapOptionToNode: /* hasIsSelectedOption */ js.Any => TagMod[Any] = null,
