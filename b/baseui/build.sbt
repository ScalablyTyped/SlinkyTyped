...
name := "baseui"
version := "9.64.9-b25892"
scalaVersion := "2.13.1"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "card-validator" % "4.1-dt-20180214Z-80864f",
  "org.scalablytyped.slinky" %%% "csstype" % "2.6.6-fa3762",
  "org.scalablytyped.slinky" %%% "date-fns" % "2.11.0-1d11d6",
  ...
  "org.scalablytyped.slinky" %%% "styletron-react" % "5.0-dt-20190925Z-3d0b7e",
