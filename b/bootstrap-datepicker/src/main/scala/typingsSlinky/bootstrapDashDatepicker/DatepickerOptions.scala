package typingsSlinky.bootstrapDashDatepicker

import typingsSlinky.bootstrapDashDatepicker.bootstrapDashDatepickerStrings.linked
...
object DatepickerOptions {
  ...
  def apply(
    ...
    beforeShowCentury: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse] = null,
    beforeShowDay: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowDayResponse] = null,
    beforeShowDecade: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse] = null,
    beforeShowYear: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse] = null,
