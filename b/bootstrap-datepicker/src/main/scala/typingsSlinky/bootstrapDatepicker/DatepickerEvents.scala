...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.show
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.hide
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.clearDate
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.changeDate
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.changeMonth
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.changeYear
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.changeDecade
  - typingsSlinky.bootstrapDatepicker.bootstrapDatepickerStrings.changeCentury
*/
