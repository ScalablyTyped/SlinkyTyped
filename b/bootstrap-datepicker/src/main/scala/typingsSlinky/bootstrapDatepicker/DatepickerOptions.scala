...
object DatepickerOptions {
  ...
  implicit class DatepickerOptionsOps[Self <: DatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBeforeShowCentury(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = this.set("beforeShowCentury", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteBeforeShowCentury: Self = this.set("beforeShowCentury", js.undefined)
    
    @scala.inline
    def setBeforeShowDay(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowDayResponse]): Self = this.set("beforeShowDay", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteBeforeShowDay: Self = this.set("beforeShowDay", js.undefined)
    
    @scala.inline
    def setBeforeShowDecade(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = this.set("beforeShowDecade", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteBeforeShowDecade: Self = this.set("beforeShowDecade", js.undefined)
    
    @scala.inline
    def setBeforeShowMonth(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = this.set("beforeShowMonth", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteBeforeShowMonth: Self = this.set("beforeShowMonth", js.undefined)
    
    @scala.inline
    def setBeforeShowYear(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = this.set("beforeShowYear", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setDefaultViewDateDate(value: js.Date): Self = this.set("defaultViewDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultViewDate(value: js.Date | String | DatepickerViewDate): Self = this.set("defaultViewDate", value.asInstanceOf[js.Any])
