...
object DatepickerOptions {
  ...
  implicit class DatepickerOptionsMutableBuilder[Self <: DatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBeforeShowCentury(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = StObject.set(x, "beforeShowCentury", js.Any.fromFunction1(value))
    
    @scala.inline
    def setBeforeShowCenturyUndefined: Self = StObject.set(x, "beforeShowCentury", js.undefined)
    
    @scala.inline
    def setBeforeShowDay(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowDayResponse]): Self = StObject.set(x, "beforeShowDay", js.Any.fromFunction1(value))
    
    @scala.inline
    def setBeforeShowDayUndefined: Self = StObject.set(x, "beforeShowDay", js.undefined)
    
    @scala.inline
    def setBeforeShowDecade(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = StObject.set(x, "beforeShowDecade", js.Any.fromFunction1(value))
    
    @scala.inline
    def setBeforeShowDecadeUndefined: Self = StObject.set(x, "beforeShowDecade", js.undefined)
    
    @scala.inline
    def setBeforeShowMonth(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = StObject.set(x, "beforeShowMonth", js.Any.fromFunction1(value))
    
    @scala.inline
    def setBeforeShowMonthUndefined: Self = StObject.set(x, "beforeShowMonth", js.undefined)
    
    @scala.inline
    def setBeforeShowYear(value: /* date */ js.Date => js.UndefOr[String | Boolean | DatepickerBeforeShowResponse]): Self = StObject.set(x, "beforeShowYear", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setDefaultViewDate(value: js.Date | String | DatepickerViewDate): Self = StObject.set(x, "defaultViewDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultViewDateDate(value: js.Date): Self = StObject.set(x, "defaultViewDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEndDate(value: js.Date | String): Self = StObject.set(x, "endDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStartDate(value: js.Date | String): Self = StObject.set(x, "startDate", value.asInstanceOf[js.Any])
