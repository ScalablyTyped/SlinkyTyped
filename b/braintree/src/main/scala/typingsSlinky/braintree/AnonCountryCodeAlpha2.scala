...
@js.native
trait AnonCountryCodeAlpha2 extends js.Object {
  ...
  var options: js.UndefOr[AnonUpdateExisting] = js.native
  var postalCode: js.UndefOr[String] = js.native
  var region: js.UndefOr[String] = js.native
  var streetAddress: js.UndefOr[String] = js.native
}

object AnonCountryCodeAlpha2 {
  @scala.inline
  def apply(): AnonCountryCodeAlpha2 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCountryCodeAlpha2]
  }
  @scala.inline
  implicit class AnonCountryCodeAlpha2Ops[Self <: AnonCountryCodeAlpha2] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOptions(value: AnonUpdateExisting): Self = {
        val ret = this.duplicate
