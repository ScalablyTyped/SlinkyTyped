...
import typingsSlinky.braintree.Anon_FailOnDuplicatePaymentMethod
...
trait ClientTokenRequest extends js.Object {
  ...
  var options: js.UndefOr[Anon_FailOnDuplicatePaymentMethod] = js.undefined
...
object ClientTokenRequest {
  ...
  def apply(
    ...
    options: Anon_FailOnDuplicatePaymentMethod = null,
    version: String = null
  ): ClientTokenRequest = {
