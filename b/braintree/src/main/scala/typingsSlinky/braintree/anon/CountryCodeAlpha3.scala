...
@js.native
trait CountryCodeAlpha3 extends StObject {
...
object CountryCodeAlpha3 {
  ...
  @scala.inline
  def apply(): CountryCodeAlpha3 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CountryCodeAlpha3]
  }
  
  @scala.inline
  implicit class CountryCodeAlpha3MutableBuilder[Self <: CountryCodeAlpha3] (val x: Self) extends AnyVal {
