...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.braintree.braintreeStrings.application_incomplete
  - typingsSlinky.braintree.braintreeStrings.avs
  - typingsSlinky.braintree.braintreeStrings.avs_and_cvv
  - typingsSlinky.braintree.braintreeStrings.cvv
  - typingsSlinky.braintree.braintreeStrings.duplicate
  - typingsSlinky.braintree.braintreeStrings.fraud
  - typingsSlinky.braintree.braintreeStrings.risk_threshold
  - typingsSlinky.braintree.braintreeStrings.three_d_secure
  - typingsSlinky.braintree.braintreeStrings.token_issuance
*/
