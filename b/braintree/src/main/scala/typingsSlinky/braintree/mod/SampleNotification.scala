...
object SampleNotification {
  ...
  implicit class SampleNotificationOps[Self <: SampleNotification] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBt_payload(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bt_payload")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBt_signature(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bt_signature")(value.asInstanceOf[js.Any])
        ret
    }
  }
