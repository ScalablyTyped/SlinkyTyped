...
object SubscriptionSource {
  ...
  @scala.inline
  def control_panel: typingsSlinky.braintree.braintreeStrings.control_panel = "control_panel".asInstanceOf[typingsSlinky.braintree.braintreeStrings.control_panel]
  @scala.inline
