...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.braintree.braintreeStrings.hold_pending
  - typingsSlinky.braintree.braintreeStrings.held
  - typingsSlinky.braintree.braintreeStrings.release_pending
  - typingsSlinky.braintree.braintreeStrings.released
  - typingsSlinky.braintree.braintreeStrings.refunded
*/
