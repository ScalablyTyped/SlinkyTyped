...
trait Anon_BinCardTypeCardholderNameCommercial extends js.Object {
  var bin: String
  var cardType: String
...
object Anon_BinCardTypeCardholderNameCommercial {
  @scala.inline
  def apply(
    bin: String,
    cardType: String,
    ...
    productId: String,
    token: String
  ): Anon_BinCardTypeCardholderNameCommercial = {
    ...
    __obj.asInstanceOf[Anon_BinCardTypeCardholderNameCommercial]
  }
}
