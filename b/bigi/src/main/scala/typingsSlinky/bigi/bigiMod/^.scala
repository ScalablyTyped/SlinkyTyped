...
@js.native
class ^ protected ()
  extends typingsSlinky.bigi.bigiMod.bigi {
...
object ^ extends js.Object {
  def fromBuffer(buffer: js.Any): typingsSlinky.bigi.bigiMod.bigi = js.native
  ...
  def fromHex(hex: String): typingsSlinky.bigi.bigiMod.bigi = js.native
  def isBigInteger(obj: js.Any, check_ver: js.Any): /* is bigi.bigi.bigi */ Boolean = js.native
  def valueOf(i: js.Any): typingsSlinky.bigi.bigiMod.bigi = js.native
}
