...
object mod {
  ...
  @js.native
  class ^ protected ()
    extends typingsSlinky.bigi.mod.bigi {
    def this(a: js.Any, b: js.Any, c: js.Any) = this()
  }
  
  @JSImport("bigi", "ONE")
  @js.native
  val ONE: typingsSlinky.bigi.mod.bigi with Constants = js.native
  
  @JSImport("bigi", "ZERO")
  @js.native
  val ZERO: typingsSlinky.bigi.mod.bigi with Constants = js.native
  
  /* static member */
  @JSImport("bigi", "fromBuffer")
  @js.native
  def fromBuffer(buffer: js.Any): typingsSlinky.bigi.mod.bigi = js.native
  ...
  @js.native
  def fromHex(hex: String): typingsSlinky.bigi.mod.bigi = js.native
  ...
  @js.native
  def valueOf_(i: js.Any): typingsSlinky.bigi.mod.bigi = js.native
  ...
  trait bigi extends StObject {
    ...
    def add(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def addTo(a: typingsSlinky.bigi.mod.bigi, r: Double): Unit = js.native
    
    def am(i: js.Any, x: js.Any, w: js.Any, j: js.Any, c: js.Any, n: js.Any): js.Any = js.native
    
    def and(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    ...
    def clearBit(n: Double): typingsSlinky.bigi.mod.bigi = js.native
    
    def compareTo(a: typingsSlinky.bigi.mod.bigi): Double = js.native
    ...
    def divideAndRemainder(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def dlShiftTo(n: typingsSlinky.bigi.mod.bigi, r: Double): Unit = js.native
    
    def drShiftTo(n: typingsSlinky.bigi.mod.bigi, r: Double): Unit = js.native
    
    def equals(a: typingsSlinky.bigi.mod.bigi): Boolean = js.native
    
    def exp(e: js.Any, z: js.Any): js.Any = js.native
    
    def flipBit(n: Double): typingsSlinky.bigi.mod.bigi = js.native
    ...
    def millerRabin(t: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def min(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def mod(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def modInt(n: Double): typingsSlinky.bigi.mod.bigi = js.native
    
    def modInverse(m: Double): typingsSlinky.bigi.mod.bigi = js.native
    
    def modPow(e: js.Any, m: js.Any): js.Any = js.native
    
    def modPowInt(e: js.Any, m: js.Any): js.Any = js.native
    
    def multiply(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def multiplyLowerTo(a: typingsSlinky.bigi.mod.bigi, n: js.Any, r: js.Any): Unit = js.native
    
    def multiplyTo(a: typingsSlinky.bigi.mod.bigi, r: js.Any): Unit = js.native
    
    def multiplyUpperTo(a: typingsSlinky.bigi.mod.bigi, n: js.Any, r: js.Any): Unit = js.native
    
    def negate(): typingsSlinky.bigi.mod.bigi = js.native
    
    def not(): typingsSlinky.bigi.mod.bigi = js.native
    
    def or(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def pow(e: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def rShiftTo(n: typingsSlinky.bigi.mod.bigi, r: js.Any): Unit = js.native
    
    def remainder(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
    
    def setBit(n: Double): typingsSlinky.bigi.mod.bigi = js.native
    
    def shiftLeft(n: Double): typingsSlinky.bigi.mod.bigi = js.native
    
    def shiftRight(n: Double): typingsSlinky.bigi.mod.bigi = js.native
    
    def shortValue(): typingsSlinky.bigi.mod.bigi = js.native
    
    def signum(): typingsSlinky.bigi.mod.bigi = js.native
    
    def square(): typingsSlinky.bigi.mod.bigi = js.native
    
    def squareTo(r: js.Any): Unit = js.native
    
    def subTo(a: js.Any, r: js.Any): Unit = js.native
    
    def subtract(a: typingsSlinky.bigi.mod.bigi): typingsSlinky.bigi.mod.bigi = js.native
