...
import typingsSlinky.bang88ReactNativeDrawerLayout.anon.Left
...
object mod {
  ...
  object DrawerLayoutProperties {
    ...
    implicit class DrawerLayoutPropertiesMutableBuilder[Self <: DrawerLayoutProperties] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderNavigationView(value: ReactElement): Self = StObject.set(x, "renderNavigationView", value.asInstanceOf[js.Any])
