package typingsSlinky.bang88ReactNativeDrawerLayout.components

import slinky.core.SyntheticEvent
import slinky.core.facade.ReactElement
import slinky.web.html.`*`.tag
import typingsSlinky.StBuildingComponent
import typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.`locked-closed`
import typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.`locked-open`
import typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.`on-drag`
import typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.left
import typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.right
import typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.unlocked
...
object ReactNativeDrawerLayout {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def keyboardDismissMode(
      value: typingsSlinky.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.none | `on-drag`
    ): this.type = set("keyboardDismissMode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onDrawerSlide(value: /* event */ DrawerLayoutSlideEvent => Unit): this.type = set("onDrawerSlide", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def renderNavigationView(value: ReactElement): this.type = set("renderNavigationView", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def apply(drawerPosition: left | right, drawerWidth: Double): Builder = {
    val __props = js.Dynamic.literal(drawerPosition = drawerPosition.asInstanceOf[js.Any], drawerWidth = drawerWidth.asInstanceOf[js.Any])
