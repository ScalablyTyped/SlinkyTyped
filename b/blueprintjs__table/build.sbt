...
version := "3.8.2-aba9b3"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.2",
  "org.scalablytyped.slinky" %%% "blueprintjs__core" % "3.21.0-f443c0",
  "org.scalablytyped.slinky" %%% "blueprintjs__icons" % "3.12.0-5c16b4",
  ...
  "org.scalablytyped.slinky" %%% "react-popper" % "1.3.6-298d70",
