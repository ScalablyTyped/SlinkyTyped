...
version := "3.8.6-f3cb98"
scalaVersion := "2.13.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "blueprintjs__core" % "3.27.0-639275",
  "org.scalablytyped.slinky" %%% "blueprintjs__icons" % "3.17.0-645492",
  ...
  "org.scalablytyped.slinky" %%% "react-popper" % "1.3.7-e840f9",
