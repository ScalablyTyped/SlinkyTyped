...
version := "3.8.2-f777bf"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.2",
  "org.scalablytyped.slinky" %%% "blueprintjs__core" % "3.22.3-b9777c",
  "org.scalablytyped.slinky" %%% "blueprintjs__icons" % "3.13.0-96af1f",
  ...
  "org.scalablytyped.slinky" %%% "react-popper" % "1.3.7-74780d",
