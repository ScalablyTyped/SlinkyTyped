package typingsSlinky.atBlueprintjsTable.libEsmHeadersHeaderMod
...
import typingsSlinky.atBlueprintjsTable.libEsmInteractionsReorderableMod.IReorderableProps
import typingsSlinky.atBlueprintjsTable.libEsmInteractionsResizeHandleMod.ILockableLayout
...
- typings.atBlueprintjsTable.libEsmInteractionsSelectableMod.ISelectableProps because var conflicts: selectedRegions. Inlined enableMultipleSelection, focusedCell, onSelectionEnd, selectedRegionTransform */ @js.native
trait IHeaderProps
