...
object libEsmCommonMod extends js.Object {
  ...
  class Grid protected ()
    extends typingsSlinky.atBlueprintjsTable.libEsmCommonGridMod.Grid {
    /**
  ...
  class Rect protected ()
    extends typingsSlinky.atBlueprintjsTable.libEsmCommonRectMod.Rect {
  ...
  object RenderMode extends js.Object {
    ...
    def apply(value: String): js.UndefOr[
        typingsSlinky.atBlueprintjsTable.libEsmCommonRenderModeMod.RenderMode with String
      ] = js.native
  }
