...
@js.native
class Regions ()
  extends typingsSlinky.atBlueprintjsTable.libEsmRegionsMod.Regions
...
object Regions extends js.Object {
  ...
  /**
    ...
    */
  def getRegionCardinality(region: IRegion): typingsSlinky.atBlueprintjsTable.libEsmRegionsMod.RegionCardinality = js.native
  /**
