...
object commonMod {
  ...
  class Grid protected ()
    extends typingsSlinky.blueprintjsTable.gridMod.Grid {
    /**
  ...
  class Rect protected ()
    extends typingsSlinky.blueprintjsTable.rectMod.Rect {
  ...
  object Rect {
    ...
    @js.native
    def ORIGIN: typingsSlinky.blueprintjsTable.rectMod.Rect = js.native
    @scala.inline
    def ORIGIN_=(x: typingsSlinky.blueprintjsTable.rectMod.Rect): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ORIGIN")(x.asInstanceOf[js.Any])
  ...
  object RenderMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.blueprintjsTable.renderModeMod.RenderMode with String] = js.native
