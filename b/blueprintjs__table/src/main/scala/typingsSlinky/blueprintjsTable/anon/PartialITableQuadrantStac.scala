...
object PartialITableQuadrantStac {
  ...
  implicit class PartialITableQuadrantStacOps[Self <: PartialITableQuadrantStac] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMenuRenderer(value: /* refHandler */ js.Function1[/* ref */ HTMLElement, Unit] => ReactElement): Self = this.set("menuRenderer", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnScroll(value: SyntheticEvent[Event, HTMLElement] => Unit): Self = this.set("onScroll", js.Any.fromFunction1(value))
    @scala.inline
