...
object PartialITableQuadrantStac {
  ...
  implicit class PartialITableQuadrantStacMutableBuilder[Self <: PartialITableQuadrantStac] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMenuRenderer(value: /* refHandler */ js.Function1[/* ref */ HTMLElement, Unit] => ReactElement): Self = StObject.set(x, "menuRenderer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnScroll(value: SyntheticEvent[Event, HTMLElement] => Unit): Self = StObject.set(x, "onScroll", js.Any.fromFunction1(value))
