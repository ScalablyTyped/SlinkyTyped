...
object PartialITableQuadrantProp {
  ...
  implicit class PartialITableQuadrantPropMutableBuilder[Self <: PartialITableQuadrantProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnHeaderCellRenderer(value: /* showFrozenColumnsOnly */ js.UndefOr[Boolean] => ReactElement): Self = StObject.set(x, "columnHeaderCellRenderer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setMenuRenderer(value: () => ReactElement): Self = StObject.set(x, "menuRenderer", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setRowHeaderCellRenderer(value: /* showFrozenRowsOnly */ js.UndefOr[Boolean] => ReactElement): Self = StObject.set(x, "rowHeaderCellRenderer", js.Any.fromFunction1(value))
