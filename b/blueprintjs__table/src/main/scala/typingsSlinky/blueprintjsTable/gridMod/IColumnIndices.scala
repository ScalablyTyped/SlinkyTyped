...
object IColumnIndices {
  ...
  implicit class IColumnIndicesOps[Self <: IColumnIndices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumnIndexEnd(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("columnIndexEnd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withColumnIndexStart(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("columnIndexStart")(value.asInstanceOf[js.Any])
        ret
    }
  }
