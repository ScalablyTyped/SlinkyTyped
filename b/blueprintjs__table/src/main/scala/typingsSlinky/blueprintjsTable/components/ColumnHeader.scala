...
object ColumnHeader
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsTable.columnHeaderMod.ColumnHeader] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsTable.columnHeaderMod.ColumnHeader] = {
