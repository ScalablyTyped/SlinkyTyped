...
object ITrucatedFormateMeasureByApproximateOptions {
  ...
  implicit class ITrucatedFormateMeasureByApproximateOptionsOps[Self <: ITrucatedFormateMeasureByApproximateOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApproximateCharWidth(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("approximateCharWidth")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withApproximateLineHeight(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("approximateLineHeight")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCellHorizontalPadding(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cellHorizontalPadding")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNumBufferLines(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("numBufferLines")(value.asInstanceOf[js.Any])
        ret
    }
  }
