...
object IHeaderCellProps {
  ...
  implicit class IHeaderCellPropsOps[Self <: IHeaderCellProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMenuRenderer(value: /* index */ js.UndefOr[Double] => ReactElement): Self = this.set("menuRenderer", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setReorderHandle(value: ReactElement): Self = this.set("reorderHandle", value.asInstanceOf[js.Any])
    @scala.inline
