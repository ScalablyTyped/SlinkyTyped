...
object headerCellMod {
  ...
  object IHeaderCellProps {
    ...
    implicit class IHeaderCellPropsMutableBuilder[Self <: IHeaderCellProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMenuRenderer(value: /* index */ js.UndefOr[Double] => ReactElement): Self = StObject.set(x, "menuRenderer", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setReorderHandle(value: ReactElement): Self = StObject.set(x, "reorderHandle", value.asInstanceOf[js.Any])
