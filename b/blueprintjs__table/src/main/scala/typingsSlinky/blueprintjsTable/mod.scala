...
object mod {
  ...
  object ColumnLoadingOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.blueprintjsTable.esmRegionsMod.ColumnLoadingOption with String] = js.native
  ...
  class CopyCellsMenuItem protected ()
    extends typingsSlinky.blueprintjsTable.menusMod.CopyCellsMenuItem {
  ...
  class EditableName protected ()
    extends typingsSlinky.blueprintjsTable.editableNameMod.EditableName {
  ...
  object Orientation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.blueprintjsTable.resizeHandleMod.Orientation with Double] = js.native
  ...
  object RegionCardinality extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.blueprintjsTable.esmRegionsMod.RegionCardinality with String] = js.native
  ...
  @js.native
  class Regions ()
    extends typingsSlinky.blueprintjsTable.esmRegionsMod.Regions
  /* static members */
  object Regions {
  ...
  object RowLoadingOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.blueprintjsTable.esmRegionsMod.RowLoadingOption with String] = js.native
  ...
  object TableLoadingOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.blueprintjsTable.esmRegionsMod.TableLoadingOption with String] = js.native
