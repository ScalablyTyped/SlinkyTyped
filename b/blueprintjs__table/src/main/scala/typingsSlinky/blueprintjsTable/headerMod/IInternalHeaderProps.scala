...
trait IInternalHeaderProps extends IHeaderProps {
  ...
  /**
    ...
    */
  def ghostCellRenderer(index: Double, extremaClasses: js.Array[String]): ReactElement = js.native
  /**
  ...
  /**
    ...
    */
  def headerCellRenderer(index: Double): ReactElement = js.native
  /**
  ...
  /**
    ...
    */
  def wrapCells(cells: js.Array[ReactElement]): ReactElement = js.native
}
