...
object b2Mat33 {
  ...
  implicit class b2Mat33Ops[Self <: b2Mat33] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetM(value: b2Mat33 => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetM")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetVVV(value: (b2Vec3, b2Vec3, b2Vec3) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetVVV")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSolve22(value: (b2Vec2, Double, Double) => b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Solve22")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withSolve33(value: (b2Vec3, Double, Double, Double) => b2Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Solve33")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withCol1(value: b2Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("col1")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCol2(value: b2Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("col2")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCol3(value: b2Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("col3")(value.asInstanceOf[js.Any])
        ret
    }
  }
