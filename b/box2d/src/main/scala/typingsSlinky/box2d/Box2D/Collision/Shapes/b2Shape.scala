...
object b2Shape {
  ...
  implicit class b2ShapeOps[Self <: b2Shape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComputeAABB(value: (b2AABB, b2Transform) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ComputeAABB")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withComputeMass(value: (b2MassData, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ComputeMass")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withComputeSubmergedArea(value: (b2Vec2, Double, b2Transform, b2Vec2) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ComputeSubmergedArea")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withCopy(value: () => b2Shape): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRayCast(value: (b2RayCastOutput, b2RayCastInput, b2Transform) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RayCast")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTestPoint(value: (b2Transform, b2Vec2) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TestPoint")(js.Any.fromFunction2(value))
        ret
    }
  }
