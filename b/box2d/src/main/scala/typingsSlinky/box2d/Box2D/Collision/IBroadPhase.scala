...
object IBroadPhase {
  ...
  implicit class IBroadPhaseOps[Self <: IBroadPhase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetProxyCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetProxyCount")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMoveProxy(value: (b2DynamicTreeNode, b2AABB, b2Vec2) => Unit): Self = {
        val ret = this.duplicate
