...
object b2BuoyancyController {
  ...
  implicit class b2BuoyancyControllerOps[Self <: b2BuoyancyController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGravity(value: b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gravity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLinearDrag(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("linearDrag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUseDensity(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("useDensity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUseWorldGravity(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("useWorldGravity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
