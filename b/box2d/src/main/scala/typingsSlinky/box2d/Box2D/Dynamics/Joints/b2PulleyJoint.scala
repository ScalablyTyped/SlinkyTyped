...
object b2PulleyJoint {
  ...
  implicit class b2PulleyJointOps[Self <: b2PulleyJoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetGroundAnchorA(value: () => b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetGroundAnchorA")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetGroundAnchorB(value: () => b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetGroundAnchorB")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetLength1(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetLength1")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetLength2(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetLength2")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
