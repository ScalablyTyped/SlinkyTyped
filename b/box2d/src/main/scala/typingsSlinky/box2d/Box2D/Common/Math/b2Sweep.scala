...
object b2Sweep {
  ...
  implicit class b2SweepOps[Self <: b2Sweep] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdvance(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Advance")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCopy(value: () => b2Sweep): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Copy")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetTransform(value: (b2Transform, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetTransform")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSet(value: b2Sweep => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withA0(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("a0")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withC(value: b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("c")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withC0(value: b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("c0")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLocalCenter(value: b2Vec2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("localCenter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withT0(value: b2Vec2): Self = {
        val ret = this.duplicate
