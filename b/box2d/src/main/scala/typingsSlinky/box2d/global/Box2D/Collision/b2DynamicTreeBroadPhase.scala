...
class b2DynamicTreeBroadPhase ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def CreateProxy(aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB, userData: js.Any): typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode = js.native
  /**
    * Destroy a proxy. It is up to the client to remove any pairs.
    * @param proxy Proxy to destroy.
    **/
  /* CompleteClass */
  override def DestroyProxy(proxy: typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode): Unit = js.native
  /**
    * Get the Fat AABB for a proxy.
    * @param proxy Proxy to retrieve the Fat AABB.
    **/
  /* CompleteClass */
  override def GetFatAABB(proxy: typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode): typingsSlinky.box2d.Box2D.Collision.b2AABB = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def GetUserData(proxy: typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode): js.Any = js.native
  /**
  ...
  override def MoveProxy(
    proxy: typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode,
    aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB,
    displacement: b2Vec2
  ): Unit = js.native
  /**
  ...
  /* CompleteClass */
  override def Query(
    callback: js.Function1[/* proxy */ typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode, Boolean],
    aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB
  ): Unit = js.native
  /**
  ...
  override def TestOverlap(
    proxyA: typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode,
    proxyB: typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode
  ): Boolean = js.native
  /**
