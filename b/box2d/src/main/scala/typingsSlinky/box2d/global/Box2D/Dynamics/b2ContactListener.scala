...
class b2ContactListener ()
  extends typingsSlinky.box2d.Box2D.Dynamics.b2ContactListener {
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def PostSolve(contact: b2Contact, impulse: typingsSlinky.box2d.Box2D.Dynamics.b2ContactImpulse): Unit = js.native
  /**
