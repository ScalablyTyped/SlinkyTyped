...
class b2ContactFilter ()
  extends typingsSlinky.box2d.Box2D.Dynamics.b2ContactFilter {
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def ShouldCollide(
    fixtureA: typingsSlinky.box2d.Box2D.Dynamics.b2Fixture,
    fixtureB: typingsSlinky.box2d.Box2D.Dynamics.b2Fixture
  ): Boolean = js.native
}
