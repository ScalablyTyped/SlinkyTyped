...
class b2TOIInput ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override var proxyA: typingsSlinky.box2d.Box2D.Collision.b2DistanceProxy = js.native
  /**
    * Proxy B
    **/
  /* CompleteClass */
  override var proxyB: typingsSlinky.box2d.Box2D.Collision.b2DistanceProxy = js.native
  /**
    * Sweep A
    **/
  /* CompleteClass */
