...
object Controllers extends js.Object {
  ...
  class b2BuoyancyController ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2BuoyancyController {
    /**
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override var m_bodyList: typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge = js.native
    /**
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override def AddBody(body: typingsSlinky.box2d.Box2D.Dynamics.b2Body): Unit = js.native
    /**
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override def Draw(debugDraw: typingsSlinky.box2d.Box2D.Dynamics.b2DebugDraw): Unit = js.native
    /**
      * Gets the body list.
      * @return Body list.
      **/
    /* CompleteClass */
    override def GetBodyList(): typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge = js.native
    /**
      * Gets the next controller.
      * @return Next controller.
      **/
    /* CompleteClass */
    override def GetNext(): typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2Controller = js.native
    /**
      * Gets the world.
      * @return World.
      **/
    /* CompleteClass */
    override def GetWorld(): typingsSlinky.box2d.Box2D.Dynamics.b2World = js.native
    /**
      * Removes a body from the controller.
      * @param body Body to remove from this controller.
      **/
    /* CompleteClass */
    override def RemoveBody(body: typingsSlinky.box2d.Box2D.Dynamics.b2Body): Unit = js.native
    /**
      * Step
  ...
  class b2ConstantAccelController ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ConstantAccelController {
    /**
  ...
  class b2ConstantForceController ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ConstantForceController {
    /**
      * The acceleration to apply.
      **/
    /* CompleteClass */
  ...
  @js.native
  class b2Controller ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2Controller {
    /**
      * Body count.
      **/
    /* CompleteClass */
  ...
  class b2ControllerEdge ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge {
    /**
      * Body.
      **/
    /* CompleteClass */
    override var body: typingsSlinky.box2d.Box2D.Dynamics.b2Body = js.native
    /**
      * Provides quick access to the other end of this edge.
      **/
    /* CompleteClass */
    override var controller: typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2Controller = js.native
    /**
      * The next controller edge in the controller's body list.
      **/
    /* CompleteClass */
    override var nextBody: typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge = js.native
    /**
      * The next controller edge in the body's controller list.
      **/
    /* CompleteClass */
    override var nextController: typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge = js.native
    /**
      * The previous controller edge in the controller's body list.
      **/
    /* CompleteClass */
    override var prevBody: typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge = js.native
    /**
      * The previous controller edge in the body's controller list.
      **/
    /* CompleteClass */
    override var prevController: typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2ControllerEdge = js.native
  }
  
  @js.native
  class b2GravityController ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2GravityController {
    /**
  ...
  class b2TensorDampingController ()
    extends typingsSlinky.box2d.Box2D.Dynamics.Controllers.b2TensorDampingController {
    /**
