...
class b2AABB ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def Contains(aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB): Boolean = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def TestOverlap(other: typingsSlinky.box2d.Box2D.Collision.b2AABB): Boolean = js.native
}
