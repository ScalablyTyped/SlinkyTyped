package typingsSlinky.box2d.global.Box2D
...
object Collision {
  ...
  @js.native
  class Features ()
    extends typingsSlinky.box2d.Box2D.Collision.Features
  ...
  object Shapes {
    ...
    /**
      ...
      **/
    class b2CircleShape ()
      extends typingsSlinky.box2d.Box2D.Collision.Shapes.b2CircleShape {
    ...
    class b2EdgeChainDef ()
      extends typingsSlinky.box2d.Box2D.Collision.Shapes.b2EdgeChainDef
    
    @JSGlobal("Box2D.Collision.Shapes.b2EdgeShape")
    @js.native
    class b2EdgeShape protected ()
      extends typingsSlinky.box2d.Box2D.Collision.Shapes.b2EdgeShape {
      /**
    ...
    @js.native
    class b2MassData ()
      extends typingsSlinky.box2d.Box2D.Collision.Shapes.b2MassData
    
    @JSGlobal("Box2D.Collision.Shapes.b2PolygonShape")
    @js.native
    class b2PolygonShape ()
      extends typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape
    /* static members */
    object b2PolygonShape {
      ...
      @js.native
      def AsArray(vertices: js.Array[b2Vec2]): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      @JSGlobal("Box2D.Collision.Shapes.b2PolygonShape.AsArray")
      @js.native
      def AsArray(vertices: js.Array[b2Vec2], vertexCount: Double): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      ...
      @js.native
      def AsBox(hx: Double, hy: Double): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      ...
      @js.native
      def AsEdge(v1: b2Vec2, b2: b2Vec2): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      ...
      @js.native
      def AsOrientedBox(hx: Double, hy: Double): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      @JSGlobal("Box2D.Collision.Shapes.b2PolygonShape.AsOrientedBox")
      @js.native
      def AsOrientedBox(hx: Double, hy: Double, center: js.UndefOr[scala.Nothing], angle: Double): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      @JSGlobal("Box2D.Collision.Shapes.b2PolygonShape.AsOrientedBox")
      @js.native
      def AsOrientedBox(hx: Double, hy: Double, center: b2Vec2): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      @JSGlobal("Box2D.Collision.Shapes.b2PolygonShape.AsOrientedBox")
      @js.native
      def AsOrientedBox(hx: Double, hy: Double, center: b2Vec2, angle: Double): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      ...
      @js.native
      def AsVector(vertices: js.Array[b2Vec2]): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
      @JSGlobal("Box2D.Collision.Shapes.b2PolygonShape.AsVector")
      @js.native
      def AsVector(vertices: js.Array[b2Vec2], vertexCount: Double): typingsSlinky.box2d.Box2D.Collision.Shapes.b2PolygonShape = js.native
    }
    ...
    /**
      ...
      **/
    class b2Shape ()
      extends typingsSlinky.box2d.Box2D.Collision.Shapes.b2Shape
    /* static members */
    object b2Shape {
      ...
      @js.native
      def TestOverlap(
        shape1: typingsSlinky.box2d.Box2D.Collision.Shapes.b2Shape,
        transform1: b2Transform,
        shape2: typingsSlinky.box2d.Box2D.Collision.Shapes.b2Shape,
  ...
  /**
    ...
    **/
  class b2ContactID ()
    extends typingsSlinky.box2d.Box2D.Collision.b2ContactID
  
  @JSGlobal("Box2D.Collision.b2ContactPoint")
  @js.native
  class b2ContactPoint ()
    extends typingsSlinky.box2d.Box2D.Collision.b2ContactPoint
  
  @JSGlobal("Box2D.Collision.b2DistanceInput")
  @js.native
  class b2DistanceInput ()
    extends typingsSlinky.box2d.Box2D.Collision.b2DistanceInput
  
  @JSGlobal("Box2D.Collision.b2DistanceOutput")
  @js.native
  class b2DistanceOutput ()
    extends typingsSlinky.box2d.Box2D.Collision.b2DistanceOutput
  
  @JSGlobal("Box2D.Collision.b2DistanceProxy")
  @js.native
  class b2DistanceProxy ()
    extends typingsSlinky.box2d.Box2D.Collision.b2DistanceProxy
  ...
  /**
    ...
    **/
  class b2DynamicTree ()
    extends typingsSlinky.box2d.Box2D.Collision.b2DynamicTree
  ...
  class b2DynamicTreeBroadPhase ()
    extends typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeBroadPhase
  
  @JSGlobal("Box2D.Collision.b2DynamicTreeNode")
  @js.native
  class b2DynamicTreeNode ()
    extends typingsSlinky.box2d.Box2D.Collision.b2DynamicTreeNode
  ...
  /**
    ...
    **/
  class b2Manifold ()
    extends typingsSlinky.box2d.Box2D.Collision.b2Manifold
  /* static members */
  object b2Manifold {
  ...
  class b2RayCastInput ()
    extends typingsSlinky.box2d.Box2D.Collision.b2RayCastInput {
  ...
  @js.native
  class b2Segment ()
    extends typingsSlinky.box2d.Box2D.Collision.b2Segment
  
  @JSGlobal("Box2D.Collision.b2SimplexCache")
  @js.native
  class b2SimplexCache ()
    extends typingsSlinky.box2d.Box2D.Collision.b2SimplexCache
  
  @JSGlobal("Box2D.Collision.b2TOIInput")
  @js.native
  class b2TOIInput ()
    extends typingsSlinky.box2d.Box2D.Collision.b2TOIInput
  ...
  class b2WorldManifold ()
    extends typingsSlinky.box2d.Box2D.Collision.b2WorldManifold
}
