...
class b2GearJointDef ()
  extends typingsSlinky.box2d.Box2D.Dynamics.Joints.b2GearJointDef {
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override var joint1: typingsSlinky.box2d.Box2D.Dynamics.Joints.b2Joint = js.native
  /**
    * The second revolute/prismatic joint attached to the gear joint.
    **/
  /* CompleteClass */
  override var joint2: typingsSlinky.box2d.Box2D.Dynamics.Joints.b2Joint = js.native
  /**
    * The gear ratio.
    **/
  /* CompleteClass */
