...
object Common {
  ...
  object Math {
    ...
    @js.native
    class b2Math ()
      extends typingsSlinky.box2d.Box2D.Common.Math.b2Math
    /* static members */
    object b2Math {
      ...
      @js.native
      def b2Mat22_identity: typingsSlinky.box2d.Box2D.Common.Math.b2Mat22 = js.native
      @scala.inline
      def b2Mat22_identity_=(x: typingsSlinky.box2d.Box2D.Common.Math.b2Mat22): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("b2Mat22_identity")(x.asInstanceOf[js.Any])
      ...
      @js.native
      def b2Transform_identity: typingsSlinky.box2d.Box2D.Common.Math.b2Transform = js.native
      @scala.inline
      def b2Transform_identity_=(x: typingsSlinky.box2d.Box2D.Common.Math.b2Transform): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("b2Transform_identity")(x.asInstanceOf[js.Any])
      ...
      @js.native
      def b2Vec2_zero: typingsSlinky.box2d.Box2D.Common.Math.b2Vec2 = js.native
      @scala.inline
      def b2Vec2_zero_=(x: typingsSlinky.box2d.Box2D.Common.Math.b2Vec2): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("b2Vec2_zero")(x.asInstanceOf[js.Any])
    }
  ...
  @js.native
  class b2Settings ()
    extends typingsSlinky.box2d.Box2D.Common.b2Settings
  /* static members */
  object b2Settings {
