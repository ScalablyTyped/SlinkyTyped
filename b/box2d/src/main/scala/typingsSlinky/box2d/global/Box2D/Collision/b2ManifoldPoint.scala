...
class b2ManifoldPoint ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override var m_id: typingsSlinky.box2d.Box2D.Collision.b2ContactID = js.native
  /**
    * Local contact point.
    **/
  /* CompleteClass */
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def Set(m: typingsSlinky.box2d.Box2D.Collision.b2ManifoldPoint): Unit = js.native
}
