...
class b2Segment ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def Extend(aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB): Unit = js.native
  /**
    * See Extend, this works on the ending point.
    * @param aabb AABB to extend/clip the ending point.
    **/
  /* CompleteClass */
  override def ExtendBackward(aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB): Unit = js.native
  /**
    * See Extend, this works on the starting point.
    * @param aabb AABB to extend/clip the starting point.
    **/
  /* CompleteClass */
  override def ExtendForward(aabb: typingsSlinky.box2d.Box2D.Collision.b2AABB): Unit = js.native
  /**
  ...
  override def TestSegment(
    ...
    normal: b2Vec2,
    segment: typingsSlinky.box2d.Box2D.Collision.b2Segment,
    maxLambda: Double
  ): Boolean = js.native
}
