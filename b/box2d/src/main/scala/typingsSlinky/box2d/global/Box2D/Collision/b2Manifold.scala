...
class b2Manifold ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override var m_points: js.Array[typingsSlinky.box2d.Box2D.Collision.b2ManifoldPoint] = js.native
  /**
    * Manifold type.
    **/
  /* CompleteClass */
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def Copy(): typingsSlinky.box2d.Box2D.Collision.b2Manifold = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def Set(m: typingsSlinky.box2d.Box2D.Collision.b2Manifold): Unit = js.native
}
