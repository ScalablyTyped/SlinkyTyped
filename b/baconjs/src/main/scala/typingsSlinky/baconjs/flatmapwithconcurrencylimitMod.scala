...
object flatmapwithconcurrencylimitMod extends js.Object {
  ...
  def default[V, V2](src: typingsSlinky.baconjs.observableMod.default[V], limit: Double, f: SpawnerOrObservable[V, V2]): typingsSlinky.baconjs.observableMod.default[V2] = js.native
}
