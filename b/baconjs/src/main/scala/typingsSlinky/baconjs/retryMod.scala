...
object retryMod {
  ...
  @js.native
  def default[V](options: RetryOptions[V]): EventStream[V] = js.native
  ...
  trait RetryOptions[V] extends StObject {
    ...
    /**
      ...
      */
    def source(attemptNumber: Double): default[V] = js.native
  }
  object RetryOptions {
    ...
    @scala.inline
    implicit class RetryOptionsMutableBuilder[Self <: RetryOptions[_], V] (val x: Self with RetryOptions[V]) extends AnyVal {
