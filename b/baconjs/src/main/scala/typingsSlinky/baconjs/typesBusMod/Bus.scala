package typingsSlinky.baconjs.typesBusMod
...
trait Bus[V] extends EventStream[V] {
  ...
  /** @hidden */
  def guardedSink(input: typingsSlinky.baconjs.typesObservableMod.default[V]): EventSink[V] = js.native
  /**
    ...
    */
  def plug[V2 /* <: V */](input: typingsSlinky.baconjs.typesObservableMod.default[V2]): js.UndefOr[js.Function0[Unit]] = js.native
  /**
  ...
  /** @hidden */
  def unsubscribeInput(input: typingsSlinky.baconjs.typesObservableMod.default[_]): Unit = js.native
}
