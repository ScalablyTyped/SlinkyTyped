...
object typesFlatmapMod {
  ...
  @js.native
  def default[In, Out](spawner: EventSpawner[In, Out], src: typingsSlinky.baconjs.observableMod.default[In]): typingsSlinky.baconjs.observableMod.default[Out] = js.native
  @JSImport("baconjs/types/flatmap_", JSImport.Default)
  @js.native
  def default[In, Out](
