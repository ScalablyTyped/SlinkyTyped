...
object PluginTesterOptions {
  ...
  implicit class PluginTesterOptionsOps[Self <: PluginTesterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBabelrcRootsRegExp(value: js.RegExp): Self = this.set("babelrcRoots", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setErrorRegExp(value: js.RegExp): Self = this.set("error", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setErrorError(value: js.Error): Self = this.set("error", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setError(value: Boolean | String | js.RegExp | js.Error | (js.Function1[/* error */ js.Any, Boolean])): Self = this.set("error", value.asInstanceOf[js.Any])
