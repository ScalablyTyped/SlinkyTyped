...
object ^ extends js.Object {
  ...
  def calculateVarint64(value: typingsSlinky.long.longMod.^): Double = js.native
  /**
  ...
  /**
    ...
    */
  def zigZagDecode64(n: Double): typingsSlinky.long.longMod.^ = js.native
  def zigZagDecode64(n: typingsSlinky.long.longMod.^): typingsSlinky.long.longMod.^ = js.native
  /**
  ...
  /**
    ...
    */
  def zigZagEncode64(n: Double): typingsSlinky.long.longMod.^ = js.native
  def zigZagEncode64(n: typingsSlinky.long.longMod.^): typingsSlinky.long.longMod.^ = js.native
}
