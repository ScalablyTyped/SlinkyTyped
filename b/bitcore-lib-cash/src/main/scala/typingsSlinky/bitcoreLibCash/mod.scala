package typingsSlinky.bitcoreLibCash

import typingsSlinky.bitcoreLibCash.anon.PrevHash
import typingsSlinky.bitcoreLibCash.anon.Reverse
import typingsSlinky.bitcoreLibCash.bitcoreLibCashStrings.little
import typingsSlinky.bitcoreLibCash.mod.Networks.Network
...
object mod {
  ...
  class Message protected () extends StObject {
    ...
    def toObject(): typingsSlinky.bitcoreLibCash.anon.Message = js.native
