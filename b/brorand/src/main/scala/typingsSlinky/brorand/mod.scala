...
object mod extends Shortcut {
  ...
  class Rand protected () extends RandInstance {
    def this(rand: typingsSlinky.brorand.mod.rand) = this()
  }
  ...
  object RandInstance {
    ...
    implicit class RandInstanceMutableBuilder[Self <: RandInstance] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGenerate(value: Double => Buffer | js.typedarray.Uint8Array): Self = StObject.set(x, "generate", js.Any.fromFunction1(value))
