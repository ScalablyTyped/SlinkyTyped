...
import typingsSlinky.bizcharts.bizchartsMod.Guide.RegionFilter
...
object GuideRegionFilter
  ...
  typingsSlinky.bizcharts.bizchartsMod.Guide.RegionFilter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
