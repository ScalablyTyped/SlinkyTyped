...
object Guide {
  ...
  object DataMarker {
    ...
    class Builder (val args: js.Array[js.Any])
      extends AnyVal
         with StBuildingComponent[tag.type, typingsSlinky.bizcharts.mod.Guide.DataMarker] {
  ...
  implicit def make(companion: Guide.type): Default[tag.type, typingsSlinky.bizcharts.mod.Guide] = new Default[tag.type, typingsSlinky.bizcharts.mod.Guide](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Props[js.Any]): Default[tag.type, typingsSlinky.bizcharts.mod.Guide] = new Default[tag.type, typingsSlinky.bizcharts.mod.Guide](js.Array(this.component, p.asInstanceOf[js.Any]))
}
