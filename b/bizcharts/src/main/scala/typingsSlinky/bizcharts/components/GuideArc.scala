...
import typingsSlinky.bizcharts.mod.Guide.Arc
...
object GuideArc
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Arc] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.bizcharts.mod.Guide.Arc](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ArcProps
}
