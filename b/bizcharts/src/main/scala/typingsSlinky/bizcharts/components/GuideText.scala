...
import typingsSlinky.bizcharts.bizchartsMod.Guide.Text
...
object GuideText
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Text] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.bizcharts.bizchartsMod.Guide.Text](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
