...
object Chart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.bizcharts.bizchartsMod.Chart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.bizcharts.bizchartsMod.Chart] = {
