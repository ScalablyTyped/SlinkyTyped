...
trait AxisProps
  ...
  var title: js.UndefOr[typingsSlinky.antvG2.mod.AxisTitle | Boolean | Null] = js.native
...
object AxisProps {
  ...
  implicit class AxisPropsMutableBuilder[Self <: AxisProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTitle(value: typingsSlinky.antvG2.mod.AxisTitle | Boolean): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
