...
- typingsSlinky.react.mod.Props because var conflicts: children. Inlined key, ref */ trait ChartProps
  ...
  // 事件属性
  var onGetG2Instance: js.UndefOr[js.Function1[/* chart */ typingsSlinky.antvG2.mod.Chart, Unit]] = js.undefined
  ...
  var onTooltipShow: js.UndefOr[js.Function1[/* ev */ typingsSlinky.bizcharts.anon.Tooltip, Unit]] = js.undefined
...
object ChartProps {
  ...
  def apply(
    ...
    onTooltipShow: /* ev */ typingsSlinky.bizcharts.anon.Tooltip => Unit = null,
