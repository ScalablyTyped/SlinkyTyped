...
object ChartProps {
  ...
  implicit class ChartPropsMutableBuilder[Self <: ChartProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnGetG2Instance(value: /* chart */ typingsSlinky.antvG2.mod.Chart => Unit): Self = StObject.set(x, "onGetG2Instance", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnTooltipShow(value: /* ev */ typingsSlinky.bizcharts.anon.Tooltip => Unit): Self = StObject.set(x, "onTooltipShow", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[js.Any]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
