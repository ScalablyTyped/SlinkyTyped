...
object ChartProps {
  ...
  implicit class ChartPropsOps[Self <: ChartProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnGetG2Instance(value: /* chart */ typingsSlinky.antvG2.mod.Chart => Unit): Self = this.set("onGetG2Instance", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnTooltipShow(value: /* ev */ typingsSlinky.bizcharts.anon.Tooltip => Unit): Self = this.set("onTooltipShow", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[js.Any]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
