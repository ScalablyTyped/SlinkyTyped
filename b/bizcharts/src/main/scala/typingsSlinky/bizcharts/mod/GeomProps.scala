...
trait GeomProps
  ...
  var adjust: js.UndefOr[String | (js.Array[AnonDodgeBy | String])] = js.undefined
   // 图形激活交互开关
  var animate: js.UndefOr[js.Any] = js.undefined
  var color: js.UndefOr[
    String | (js.Tuple2[String, js.Array[String] | (js.Function1[/* d */ js.UndefOr[_], String]) | String])
  ] = js.undefined
  var line: js.UndefOr[typingsSlinky.antvG2.mod.Styles.line | Boolean] = js.undefined
  ...
  var tooltip: js.UndefOr[Boolean | String | (js.Tuple2[String, js.Function1[/* repeated */ _, AnonName]])] = js.undefined
