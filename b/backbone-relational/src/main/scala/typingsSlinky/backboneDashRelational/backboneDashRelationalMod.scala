package typingsSlinky.backboneDashRelational

import typingsSlinky.backbone.backboneMod.Collection
import typingsSlinky.backbone.backboneMod.EventsMixin
import typingsSlinky.backboneDashRelational.backboneDashRelationalMod.Model
import typingsSlinky.backboneDashRelational.backboneDashRelationalMod.Relation
import typingsSlinky.backboneDashRelational.backboneDashRelationalMod.Store
...
object backboneDashRelationalMod extends js.Object {
  ...
  class HasMany () extends Relation {
    ...
    def addRelated(model: typingsSlinky.backbone.backboneMod.Model, options: js.Any): Unit = js.native
    def findRelated(options: js.Any): typingsSlinky.backbone.backboneMod.Model = js.native
    def onChange(model: typingsSlinky.backbone.backboneMod.Model, attr: js.Any, options: js.Any): Unit = js.native
    def removeRelated(model: typingsSlinky.backbone.backboneMod.Model, coll: js.Any, options: js.Any): Unit = js.native
    def setKeyContents(keyContents: String): Unit = js.native
    def setKeyContents(keyContents: Double): Unit = js.native
    def setKeyContents(keyContents: typingsSlinky.backbone.backboneMod.Model): Unit = js.native
    def tryAddRelated(model: typingsSlinky.backbone.backboneMod.Model, coll: js.Any, options: js.Any): Unit = js.native
  }
  ...
  class HasOne () extends Relation {
    ...
    def findRelated(options: js.Any): typingsSlinky.backbone.backboneMod.Model = js.native
    def handleAddition(
      model: typingsSlinky.backbone.backboneMod.Model,
      coll: Collection[typingsSlinky.backbone.backboneMod.Model],
      options: js.Any
    ): Unit = js.native
    def handleRemoval(
      model: typingsSlinky.backbone.backboneMod.Model,
    ...
    def handleReset(coll: Collection[typingsSlinky.backbone.backboneMod.Model], options: js.Any): Unit = js.native
    def onChange(model: typingsSlinky.backbone.backboneMod.Model, attr: js.Any, options: js.Any): Unit = js.native
    def removeRelated(model: typingsSlinky.backbone.backboneMod.Model, coll: js.Any, options: js.Any): Unit = js.native
    def setKeyContents(keyContents: String): Unit = js.native
    def setKeyContents(keyContents: js.Array[Double | String]): Unit = js.native
    def setKeyContents(keyContents: Double): Unit = js.native
    def setKeyContents(keyContents: Collection[typingsSlinky.backbone.backboneMod.Model]): Unit = js.native
    def tryAddRelated(model: typingsSlinky.backbone.backboneMod.Model, coll: js.Any, options: js.Any): Unit = js.native
  }
  ...
  class Relation ()
    ...
    def setRelated(related: Collection[typingsSlinky.backbone.backboneMod.Model]): Unit = js.native
    def setRelated(related: typingsSlinky.backbone.backboneMod.Model): Unit = js.native
  }
  ...
  class Store () extends EventsMixin {
    ...
    def getCollection(`type`: Model, create: Boolean): Collection[typingsSlinky.backbone.backboneMod.Model] = js.native
    ...
    def retroFitRelation(relation: Model, create: Boolean): Collection[typingsSlinky.backbone.backboneMod.Model] = js.native
