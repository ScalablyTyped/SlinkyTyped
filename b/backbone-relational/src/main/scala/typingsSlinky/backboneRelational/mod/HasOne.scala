...
class HasOne () extends Relation {
  ...
  def handleAddition(
    model: typingsSlinky.backbone.mod.Model,
    coll: Collection[typingsSlinky.backbone.mod.Model],
    options: js.Any
  ): Unit = js.native
  def handleRemoval(
    model: typingsSlinky.backbone.mod.Model,
  ...
  def handleReset(coll: Collection[typingsSlinky.backbone.mod.Model], options: js.Any): Unit = js.native
  ...
  def setKeyContents(keyContents: Collection[typingsSlinky.backbone.mod.Model]): Unit = js.native
