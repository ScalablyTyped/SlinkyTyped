package typingsSlinky.atBabelParser
...
package object atBabelParserMod {
  import typingsSlinky.atBabelParser.atBabelParserStrings.decorators
  import typingsSlinky.atBabelParser.atBabelParserStrings.flow
  import typingsSlinky.atBabelParser.atBabelParserStrings.pipelineOperator
