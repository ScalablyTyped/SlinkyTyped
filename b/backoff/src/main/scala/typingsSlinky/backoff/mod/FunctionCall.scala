...
import typingsSlinky.backoff.backoffStrings.backoff
...
trait FunctionCall[T] extends EventEmitter {
  ...
  /**
    ...
    */
  @JSName("addListener")
  def addListener_call(event: typingsSlinky.backoff.backoffStrings.call, listener: js.Function1[/* args */ T, Unit]): this.type = js.native
  @JSName("emit")
  ...
  @JSName("emit")
  def emit_call(event: typingsSlinky.backoff.backoffStrings.call, args: T): Boolean = js.native
  /**
  ...
  @JSName("listenerCount")
  def listenerCount_call(`type`: typingsSlinky.backoff.backoffStrings.call): Double = js.native
  @JSName("listenerCount")
  ...
  @JSName("listeners")
  def listeners_call(event: typingsSlinky.backoff.backoffStrings.call): js.Array[js.Function1[/* args */ T, Unit]] = js.native
  @JSName("on")
  ...
  @JSName("on")
  def on_call(event: typingsSlinky.backoff.backoffStrings.call, listener: js.Function1[/* args */ T, Unit]): this.type = js.native
  @JSName("once")
  ...
  @JSName("once")
  def once_call(event: typingsSlinky.backoff.backoffStrings.call, listener: js.Function1[/* args */ T, Unit]): this.type = js.native
  ...
  @JSName("prependListener")
  def prependListener_call(event: typingsSlinky.backoff.backoffStrings.call, listener: js.Function1[/* args */ T, Unit]): this.type = js.native
  ...
  @JSName("prependOnceListener")
  def prependOnceListener_call(event: typingsSlinky.backoff.backoffStrings.call, listener: js.Function1[/* args */ T, Unit]): this.type = js.native
  ...
  @JSName("removeAllListeners")
  def removeAllListeners_call(event: typingsSlinky.backoff.backoffStrings.call): this.type = js.native
  @JSName("removeAllListeners")
  ...
  @JSName("removeListener")
  def removeListener_call(event: typingsSlinky.backoff.backoffStrings.call, listener: js.Function1[/* args */ T, Unit]): this.type = js.native
  /**
