package typingsSlinky.bluebird.bluebirdMod
...
trait Bluebird[R]
  ...
  /**
    ...
    */
  @JSName("caught")
  var caught_Original: Fn_Error[R] = js.native
  @JSName("lastly")
  ...
  /**
    * Same as calling `Promise.all(thisPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
    */
  def all[Q](`this`: Bluebird[R with js.Iterable[Q]]): Bluebird[R] = js.native
  /**
  ...
  /**
    * Same as calling `Promise.any(thisPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
    */
  def any[Q](`this`: Bluebird[R with js.Iterable[Q]]): Bluebird[Q] = js.native
  ...
  /**
    ...
    */
  def each[Q](`this`: Bluebird[R with js.Iterable[Q]], iterator: IterateFunction[Q, _]): Bluebird[R] = js.native
  /**
  ...
  /**
    ...
    */
  def filter[Q](`this`: Bluebird[R with js.Iterable[Q]], filterer: IterateFunction[Q, Boolean]): Bluebird[R] = js.native
  def filter[Q](
    `this`: Bluebird[R with js.Iterable[Q]],
  ...
  /**
    ...
    */
  def map[U, Q](`this`: Bluebird[R with js.Iterable[Q]], mapper: IterateFunction[Q, U]): Bluebird[js.Array[U]] = js.native
  def map[U, Q](`this`: Bluebird[R with js.Iterable[Q]], mapper: IterateFunction[Q, U], options: ConcurrencyOption): Bluebird[js.Array[U]] = js.native
  /**
    ...
    */
  def mapSeries[U, Q](`this`: Bluebird[R with js.Iterable[Q]], iterator: IterateFunction[Q, U]): Bluebird[js.Array[U]] = js.native
  /**
  ...
  /**
    * Same as calling `Promise.race(thisPromise, count)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
    */
  def race[Q](`this`: Bluebird[R with js.Iterable[Q]]): Bluebird[Q] = js.native
  /**
