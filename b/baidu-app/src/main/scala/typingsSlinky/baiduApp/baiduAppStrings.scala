...
import typingsSlinky.baiduApp.swan.CameraDevice
import typingsSlinky.baiduApp.swan.EventType
import typingsSlinky.baiduApp.swan.ImageSizeType
import typingsSlinky.baiduApp.swan.ImageSourceType
import typingsSlinky.baiduApp.swan.LineCapType
import typingsSlinky.baiduApp.swan.LineJoinType
import typingsSlinky.baiduApp.swan.PaymentSignType
import typingsSlinky.baiduApp.swan.Scope
import typingsSlinky.baiduApp.swan.TimingFunction
import typingsSlinky.baiduApp.swan.TouchEventType
import typingsSlinky.baiduApp.swan.TransitionEventType
import typingsSlinky.baiduApp.swan.VideoSourceType
import typingsSlinky.baiduApp.swan.networkType
import typingsSlinky.baiduApp.swan.scanType
