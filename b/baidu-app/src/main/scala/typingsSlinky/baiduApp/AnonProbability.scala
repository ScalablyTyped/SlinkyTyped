...
@js.native
trait AnonProbability extends js.Object {
   // 分类结果置信度（0–1.0）
  var location: AnonHeight = js.native
...
object AnonProbability {
  @scala.inline
  def apply(location: AnonHeight, name: Double, probability: Double, `type`: Double): AnonProbability = {
    ...
    __obj.asInstanceOf[AnonProbability]
  }
  @scala.inline
  implicit class AnonProbabilityOps[Self <: AnonProbability] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withLocation(value: AnonHeight): Self = {
