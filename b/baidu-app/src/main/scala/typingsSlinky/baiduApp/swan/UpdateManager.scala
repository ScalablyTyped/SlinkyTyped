...
import typingsSlinky.baiduApp.anon.Confirm
import typingsSlinky.baiduApp.anon.HasUpdate
...
object UpdateManager {
  ...
  implicit class UpdateManagerOps[Self <: UpdateManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnCheckForUpdate(value: js.Function1[/* res */ HasUpdate, Unit] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnUpdateReady(value: js.Function1[/* res */ Confirm, Unit] => Unit): Self = {
        val ret = this.duplicate
