...
object TouchEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.baiduApp.swan.TouchEventType */ T](
  ...
  @scala.inline
  implicit class TouchEventOps[Self <: TouchEvent[_], /* <: typingsSlinky.baiduApp.swan.TouchEventType */ T] (val x: Self with TouchEvent[T]) extends AnyVal {
    @scala.inline
