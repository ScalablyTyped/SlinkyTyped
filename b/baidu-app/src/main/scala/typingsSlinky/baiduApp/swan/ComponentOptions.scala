...
object ComponentOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.baiduApp.swan.Component[Data, Props] */ Instance, Data, Methods, Props](): ComponentOptions[Instance, Data, Methods, Props] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComponentOptions[Instance, Data, Methods, Props]]
  }
  @scala.inline
  implicit class ComponentOptionsOps[Self <: ComponentOptions[_, _, _, _], /* <: typingsSlinky.baiduApp.swan.Component[Data, Props] */ Instance, Data, Methods, Props] (val x: Self with (ComponentOptions[Instance, Data, Methods, Props])) extends AnyVal {
    @scala.inline
