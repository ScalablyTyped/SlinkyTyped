...
object ComponentRelation {
  ...
  implicit class ComponentRelationOps[Self[d, p] <: ComponentRelation[d, p], D, P] (val x: Self[D, P]) extends AnyVal {
    ...
    @scala.inline
    def withLinkChanged(value: /* target */ Component[D, P] => Unit): Self[D, P] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLinked(value: /* target */ Component[D, P] => Unit): Self[D, P] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUnlinked(value: /* target */ Component[D, P] => Unit): Self[D, P] = {
        val ret = this.duplicate
