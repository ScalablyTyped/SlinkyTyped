...
object ocrIdCardResponse {
  ...
  implicit class ocrIdCardResponseOps[Self <: ocrIdCardResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEdit_tool(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("edit_tool")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withImage_status(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("image_status")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRisk_type(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("risk_type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
