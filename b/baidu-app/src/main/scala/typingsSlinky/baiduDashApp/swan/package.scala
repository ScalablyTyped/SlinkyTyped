...
package object swan {
  ...
  import typingsSlinky.baiduDashApp.Anon_Args
  import typingsSlinky.baiduDashApp.Anon_Cursor
  import typingsSlinky.baiduDashApp.Anon_NameValue
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.form
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.input
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.scroll
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.tap
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.touchcancel
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.touchend
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.touchforcechange
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.touchmove
  import typingsSlinky.baiduDashApp.baiduDashAppStrings.touchstart
  ...
  type CombinedInstance[Instance /* <: typingsSlinky.baiduDashApp.swan.Component[Data, Props] */, Data, Methods, Props] = Methods with Instance
  ...
  type ExtendedComponent[Instance /* <: typingsSlinky.baiduDashApp.swan.Component[Data, Props] */, Data, Methods, Props] = (CombinedInstance[Instance, Data, Methods, Props]) with (typingsSlinky.baiduDashApp.swan.Component[Data, Props])
  ...
  {[ K in keyof T ]: baidu-app.swan.PropValidator<T[K]>}
    */ typingsSlinky.baiduDashApp.baiduDashAppStrings.RecordPropsDefinition with T
  // #endregion
  // #region 网络API列表
  // 发起请求
  ...
  type ThisTypedComponentOptionsWithRecordProps[V /* <: typingsSlinky.baiduDashApp.swan.Component[Data, Props] */, Data, Methods, Props] = js.Object with (ComponentOptions[V, Data, Methods, Props]) with (ThisType[CombinedInstance[V, Data, Methods, Props]])
