...
import typingsSlinky.baiduDashApp.Anon_AuthSetting
...
trait requestPolymerPaymentOptions
  ...
  var orderInfo: orderInfoOptions
   // 需要隐藏的支付方式
  @JSName("success")
  var success_requestPolymerPaymentOptions: js.UndefOr[js.Function1[/* res */ Anon_AuthSetting, Unit]] = js.undefined
}
