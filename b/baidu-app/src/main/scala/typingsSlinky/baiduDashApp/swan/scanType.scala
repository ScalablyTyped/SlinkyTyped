...
object scanType {
  @scala.inline
  def barCode: typingsSlinky.baiduDashApp.baiduDashAppStrings.barCode = this.cast("barCode")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def qrCode: typingsSlinky.baiduDashApp.baiduDashAppStrings.qrCode = this.cast("qrCode")
}
