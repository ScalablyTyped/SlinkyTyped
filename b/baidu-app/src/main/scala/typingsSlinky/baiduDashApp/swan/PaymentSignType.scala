...
object PaymentSignType {
  @scala.inline
  def `HMAC-SHA256`: typingsSlinky.baiduDashApp.baiduDashAppStrings.`HMAC-SHA256` = this.cast("HMAC-SHA256")
  @scala.inline
  def MD5: typingsSlinky.baiduDashApp.baiduDashAppStrings.MD5 = this.cast("MD5")
  @scala.inline
