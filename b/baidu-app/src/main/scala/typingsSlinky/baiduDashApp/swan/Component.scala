...
import typingsSlinky.baiduDashApp.Anon_Bubbles
...
trait Component[D, P] extends js.Object {
  ...
  {[ key in keyof D & P ]: baidu-app.swan.DataValueType<D & P[key]>}
    */ typingsSlinky.baiduDashApp.baiduDashAppStrings.Component with js.Any = js.native
  /**
  		 * 节点dataset
  		 */
  ...
  /**
  		 ...
  		 */
  def selectAllComponents(selector: String): js.Array[typingsSlinky.baiduDashApp.swan.Component[_, _]] = js.native
  /**
  		 * 使用选择器选择组件实例节点
  		 * 返回匹配到的第一个组件实例对象
  		 */
  def selectComponent(selector: String): typingsSlinky.baiduDashApp.swan.Component[_, _] = js.native
  def setData(
  ...
  {[ key in keyof D ]:? string | number | boolean | symbol | object | null | std.Array<any>}
    */ typingsSlinky.baiduDashApp.baiduDashAppStrings.Component with js.Any
  ): Unit = js.native
  def setData(
    key: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof D ]:? string | number | boolean | symbol | object | null | std.Array<any>}
