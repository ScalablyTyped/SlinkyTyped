...
object mod extends Shortcut {
  ...
  */
  ...
  object CanvasOptions {
    ...
    @scala.inline
    def CanvasFalseOptions(): typingsSlinky.blueimpLoadImage.mod.CanvasFalseOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.blueimpLoadImage.mod.CanvasFalseOptions]
    }
    
    @scala.inline
    def CanvasTrueOptions(canvas: `true`): typingsSlinky.blueimpLoadImage.mod.CanvasTrueOptions = {
      val __obj = js.Dynamic.literal(canvas = canvas.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.blueimpLoadImage.mod.CanvasTrueOptions]
    }
  }
  ...
  */
  ...
  object CropOptions {
    ...
    @scala.inline
    def CropFalseOptions(): typingsSlinky.blueimpLoadImage.mod.CropFalseOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.blueimpLoadImage.mod.CropFalseOptions]
    }
    
    @scala.inline
    def CropTrueOptions(): typingsSlinky.blueimpLoadImage.mod.CropTrueOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.blueimpLoadImage.mod.CropTrueOptions]
    }
  }
  ...
  object ImageHead {
    ...
    implicit class ImageHeadMutableBuilder[Self <: ImageHead] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setImageHead(value: js.typedarray.ArrayBuffer | js.typedarray.Uint8Array): Self = StObject.set(x, "imageHead", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setImageHeadArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "imageHead", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setImageHeadUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "imageHead", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object MetaOptions {
    ...
    @scala.inline
    def MetaFalseOptions(): typingsSlinky.blueimpLoadImage.mod.MetaFalseOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.blueimpLoadImage.mod.MetaFalseOptions]
    }
    
    @scala.inline
    def MetaTrueOptions(orientation: Orientation): typingsSlinky.blueimpLoadImage.mod.MetaTrueOptions = {
      val __obj = js.Dynamic.literal(orientation = orientation.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.blueimpLoadImage.mod.MetaTrueOptions]
    }
  }
