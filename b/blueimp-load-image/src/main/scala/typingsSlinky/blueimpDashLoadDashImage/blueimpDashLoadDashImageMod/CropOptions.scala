...
import typingsSlinky.blueimpDashLoadDashImage.blueimpDashLoadDashImageBooleans.`true`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.blueimpDashLoadDashImage.blueimpDashLoadDashImageMod.CropFalseOptions
*/
