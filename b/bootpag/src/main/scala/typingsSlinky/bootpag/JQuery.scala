...
object JQuery {
  ...
  implicit class JQueryOps[Self <: JQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBootpag(value: Options => JQuery): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bootpag")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOn(value: (page, PageEventHandler) => JQuery): Self = {
        val ret = this.duplicate
