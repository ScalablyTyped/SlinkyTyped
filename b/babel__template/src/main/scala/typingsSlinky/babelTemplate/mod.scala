...
object mod extends Shortcut {
  ...
  trait TemplateBuilderOptions extends ParserOptions {
    ...
    /**
      ...
      * @default /^[_$A-Z0-9]+$/
      */
    var placeholderPattern: js.UndefOr[js.RegExp | `false` | Null] = js.native
  ...
  object TemplateBuilderOptions {
    ...
    implicit class TemplateBuilderOptionsMutableBuilder[Self <: TemplateBuilderOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPlaceholderPattern(value: js.RegExp | `false`): Self = StObject.set(x, "placeholderPattern", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPlaceholderPatternNull: Self = StObject.set(x, "placeholderPattern", null)
      
      @scala.inline
      def setPlaceholderPatternRegExp(value: js.RegExp): Self = StObject.set(x, "placeholderPattern", value.asInstanceOf[js.Any])
