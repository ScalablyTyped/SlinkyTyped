...
object Event {
  @scala.inline
  def apply[/* <: typingsSlinky.bulmaCalendar.mod.EventType */ T](data: bulmaCalendar, timeStamp: Double, `type`: T): Event[T] = {
  ...
  @scala.inline
  implicit class EventOps[Self <: Event[_], /* <: typingsSlinky.bulmaCalendar.mod.EventType */ T] (val x: Self with Event[T]) extends AnyVal {
    @scala.inline
