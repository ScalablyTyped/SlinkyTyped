...
trait BulmaCalendarOptions extends js.Object {
  ...
  /**
    ...
    * @default 'default'
    */
  var displayMode: js.UndefOr[typingsSlinky.bulmaCalendar.bulmaCalendarStrings.default | dialog | `inline`] = js.undefined
  /**
...
object BulmaCalendarOptions {
  ...
  def apply(
    ...
    displayMode: typingsSlinky.bulmaCalendar.bulmaCalendarStrings.default | dialog | `inline` = null,
