...
import typingsSlinky.lodash.lodashMod.DictionaryIterator
import typingsSlinky.lodash.lodashMod.List
import typingsSlinky.lodash.lodashMod.ListIterator
import typingsSlinky.lodash.lodashMod.LoDashExplicitObjectWrapper
import typingsSlinky.lodash.lodashMod.MemoIterator
...
abstract class CollectionBase[T /* <: Model[_] */] () extends Events[T] {
  ...
  def fetch(): typingsSlinky.bluebird.bluebirdMod.^[Collection[T]] = js.native
  def fetch(options: CollectionFetchOptions): typingsSlinky.bluebird.bluebirdMod.^[Collection[T]] = js.native
  ...
  def invokeThen(name: String, args: js.Any*): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  ...
  def reduceThen[R](
    ...
    initialValue: R,
    context: js.Any
  ): typingsSlinky.bluebird.bluebirdMod.^[R] = js.native
