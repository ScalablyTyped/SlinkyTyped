...
import typingsSlinky.lodash.mod.DictionaryIterator
import typingsSlinky.lodash.mod.List
import typingsSlinky.lodash.mod.ListIterator
import typingsSlinky.lodash.mod.MemoIterator
...
abstract class CollectionBase[T /* <: Model[_] */] () extends Events[T] {
  ...
  def fetch(): typingsSlinky.bluebird.mod.^[Collection[T]] = js.native
  def fetch(options: CollectionFetchOptions): typingsSlinky.bluebird.mod.^[Collection[T]] = js.native
  ...
  def invokeThen(name: String, args: js.Any*): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  def reduceThen[R](
    ...
    initialValue: R,
    context: js.Any
  ): typingsSlinky.bluebird.mod.^[R] = js.native
