...
object NodeCommon {
  @scala.inline
  def apply[/* <: typingsSlinky.broccoliNodeApi.mod.NodeInfo */ T](__broccoliFeatures__ : FeatureSet, __broccoliGetInfo__ : FeatureSet => T): NodeCommon[T] = {
  ...
  @scala.inline
  implicit class NodeCommonOps[Self <: NodeCommon[_], /* <: typingsSlinky.broccoliNodeApi.mod.NodeInfo */ T] (val x: Self with NodeCommon[T]) extends AnyVal {
    @scala.inline
