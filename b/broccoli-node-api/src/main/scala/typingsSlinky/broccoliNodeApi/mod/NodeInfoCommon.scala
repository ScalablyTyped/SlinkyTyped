...
object NodeInfoCommon {
  @scala.inline
  def apply[/* <: typingsSlinky.broccoliNodeApi.mod.NodeType */ T](instantiationStack: String, name: String, nodeType: T): NodeInfoCommon[T] = {
  ...
  @scala.inline
  implicit class NodeInfoCommonOps[Self <: NodeInfoCommon[_], /* <: typingsSlinky.broccoliNodeApi.mod.NodeType */ T] (val x: Self with NodeInfoCommon[T]) extends AnyVal {
    @scala.inline
