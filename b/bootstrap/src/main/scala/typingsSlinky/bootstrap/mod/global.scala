...
import typingsSlinky.bootstrap.bootstrapStrings.close
import typingsSlinky.bootstrap.bootstrapStrings.cycle
import typingsSlinky.bootstrap.bootstrapStrings.disable
import typingsSlinky.bootstrap.bootstrapStrings.dispose
import typingsSlinky.bootstrap.bootstrapStrings.enable
import typingsSlinky.bootstrap.bootstrapStrings.handleUpdate
import typingsSlinky.bootstrap.bootstrapStrings.hide
import typingsSlinky.bootstrap.bootstrapStrings.next
import typingsSlinky.bootstrap.bootstrapStrings.pause
import typingsSlinky.bootstrap.bootstrapStrings.prev
import typingsSlinky.bootstrap.bootstrapStrings.refresh
import typingsSlinky.bootstrap.bootstrapStrings.show
import typingsSlinky.bootstrap.bootstrapStrings.toggle
import typingsSlinky.bootstrap.bootstrapStrings.toggleEnabled
import typingsSlinky.bootstrap.bootstrapStrings.update
import typingsSlinky.jquery.JQuery.EventHandler
