...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrap.bootstrapStrings.auto
  - typingsSlinky.bootstrap.bootstrapStrings.top
  - typingsSlinky.bootstrap.bootstrapStrings.bottom
  - typingsSlinky.bootstrap.bootstrapStrings.left
  - typingsSlinky.bootstrap.bootstrapStrings.right
*/
