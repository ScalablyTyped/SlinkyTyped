...
import typingsSlinky.jquery.Event
...
trait CarouselEventHandler[TElement]
  ...
  /**
    ...
    */
  var relatedTarget: org.scalajs.dom.raw.HTMLElement
  /**
...
object CarouselEventHandler {
  @scala.inline
  def apply[TElement](
    currentTarget: org.scalajs.dom.raw.HTMLElement,
    ...
    preventDefault: () => Unit,
    relatedTarget: org.scalajs.dom.raw.HTMLElement,
    stopImmediatePropagation: () => Unit,
    stopPropagation: () => Unit,
    target: org.scalajs.dom.raw.HTMLElement,
    timeStamp: Double,
    to: Double,
    `type`: String,
