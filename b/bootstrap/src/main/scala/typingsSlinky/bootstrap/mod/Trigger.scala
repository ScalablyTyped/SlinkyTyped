...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrap.bootstrapStrings.click
  - typingsSlinky.bootstrap.bootstrapStrings.hover
  - typingsSlinky.bootstrap.bootstrapStrings.focus
  - typingsSlinky.bootstrap.bootstrapStrings.manual
  - typingsSlinky.bootstrap.bootstrapStrings.`click hover`
  - typingsSlinky.bootstrap.bootstrapStrings.`click focus`
  - typingsSlinky.bootstrap.bootstrapStrings.`hover focus`
  - typingsSlinky.bootstrap.bootstrapStrings.`click hover focus`
*/
