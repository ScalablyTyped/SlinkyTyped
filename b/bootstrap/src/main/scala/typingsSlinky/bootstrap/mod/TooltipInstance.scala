...
object TooltipInstance {
  @scala.inline
  def apply[/* <: typingsSlinky.bootstrap.mod.TooltipOption */ T](config: T, element: Element, tip: HTMLElement): TooltipInstance[T] = {
  ...
  @scala.inline
  implicit class TooltipInstanceOps[Self <: TooltipInstance[_], /* <: typingsSlinky.bootstrap.mod.TooltipOption */ T] (val x: Self with TooltipInstance[T]) extends AnyVal {
    @scala.inline
