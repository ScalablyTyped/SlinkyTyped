...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrap.bootstrapStrings.showDotbsDotcollapse
  - typingsSlinky.bootstrap.bootstrapStrings.shownDotbsDotcollapse
  - typingsSlinky.bootstrap.bootstrapStrings.hideDotbsDotcollapse
  - typingsSlinky.bootstrap.bootstrapStrings.hiddenDotbsDotcollapse
*/
