...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrap.bootstrapStrings.showDotbsDottab
  - typingsSlinky.bootstrap.bootstrapStrings.shownDotbsDottab
  - typingsSlinky.bootstrap.bootstrapStrings.hideDotbsDottab
  - typingsSlinky.bootstrap.bootstrapStrings.hiddenDotbsDottab
*/
