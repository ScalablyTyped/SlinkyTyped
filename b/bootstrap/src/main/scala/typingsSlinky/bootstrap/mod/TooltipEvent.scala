...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.bootstrap.bootstrapStrings.showDotbsDottooltip
  - typingsSlinky.bootstrap.bootstrapStrings.shownDotbsDottooltip
  - typingsSlinky.bootstrap.bootstrapStrings.hideDotbsDottooltip
  - typingsSlinky.bootstrap.bootstrapStrings.hiddenDotbsDottooltip
  - typingsSlinky.bootstrap.bootstrapStrings.insertedDotbsDottooltip
*/
