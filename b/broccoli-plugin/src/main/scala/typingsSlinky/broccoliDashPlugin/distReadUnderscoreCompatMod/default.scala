package typingsSlinky.broccoliDashPlugin.distReadUnderscoreCompatMod

import typingsSlinky.broccoliDashNodeDashApi.broccoliDashNodeDashApiMod.CallbackObject
