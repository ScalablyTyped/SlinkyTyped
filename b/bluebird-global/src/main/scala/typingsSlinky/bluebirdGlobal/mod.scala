...
import typingsSlinky.bluebirdGlobal.anon.Fn1
import typingsSlinky.bluebirdGlobal.anon.Fn2
import typingsSlinky.bluebirdGlobal.anon.Fn3
import typingsSlinky.bluebirdGlobal.anon.Fn4
import typingsSlinky.bluebirdGlobal.anon.FnCall
import typingsSlinky.bluebirdGlobal.anon.FnCallArg1Arg2Arg3Arg4Arg5Handler
import typingsSlinky.bluebirdGlobal.anon.FnCallDisposerDisposer2Disposer3Executor
...
import typingsSlinky.bluebirdGlobal.anon.FnCallFn
import typingsSlinky.bluebirdGlobal.anon.FnCallGeneratorFunctionOptions
import typingsSlinky.bluebirdGlobal.anon.FnCallHandler
import typingsSlinky.bluebirdGlobal.anon.FnCallMsMessage
import typingsSlinky.bluebirdGlobal.anon.FnCallMsValue
import typingsSlinky.bluebirdGlobal.anon.FnCallNodeFunctionOptions
import typingsSlinky.bluebirdGlobal.anon.FnCallObject
import typingsSlinky.bluebirdGlobal.anon.FnCallOnFulfilledOnRejected
import typingsSlinky.bluebirdGlobal.anon.FnCallResolverOptions
import typingsSlinky.bluebirdGlobal.anon.FnCallTargetOptions
import typingsSlinky.bluebirdGlobal.anon.FnCallThis
import typingsSlinky.bluebirdGlobal.anon.FnCallValue
import typingsSlinky.bluebirdGlobal.anon.FnCallValues
import typingsSlinky.bluebirdGlobal.anon.FnCallValuesCount
import typingsSlinky.bluebirdGlobal.anon.FnCallValuesFiltererOption
import typingsSlinky.bluebirdGlobal.anon.FnCallValuesIterator
import typingsSlinky.bluebirdGlobal.anon.FnCallValuesMapperOptions
import typingsSlinky.bluebirdGlobal.anon.FnCallValuesReducerInitialValue
  ...
  object global {
    ...
    trait PromiseConstructor
      ...
      def each[R](
        ...
        iterator: typingsSlinky.bluebird.mod.IterateFunction[R, _]
      ...
      def filter[R](
        values: Resolvable[js.Iterable[Resolvable[R]]],
        filterer: typingsSlinky.bluebird.mod.IterateFunction[R, Boolean]
      ): Bluebird[js.Array[R]] = js.native
      def filter[R](
        values: Resolvable[js.Iterable[Resolvable[R]]],
        filterer: typingsSlinky.bluebird.mod.IterateFunction[R, Boolean],
      ...
      def map[R, U](
        values: Resolvable[js.Iterable[Resolvable[R]]],
        mapper: typingsSlinky.bluebird.mod.IterateFunction[R, U]
      ...
      def mapSeries[R, U](
        values: Resolvable[js.Iterable[Resolvable[R]]],
        iterator: typingsSlinky.bluebird.mod.IterateFunction[R, U]
      ): Bluebird[js.Array[U]] = js.native
      @JSName("mapSeries")
