package typingsSlinky.atBlueprintjsCore.libEsmComponentsCardCardMod
...
- typings.atBlueprintjsCore.libEsmCommonPropsMod.IProps because var conflicts: className. Inlined  */ trait ICardProps extends HTMLAttributes[HTMLDivElement] {
  ...
  var onClick_ICardProps: js.UndefOr[
    js.Function1[/* e */ SyntheticMouseEvent[org.scalajs.dom.raw.HTMLDivElement], Unit]
  ] = js.undefined
}
...
object ICardProps {
  ...
  def apply(
    ...
    onClick: /* e */ SyntheticMouseEvent[org.scalajs.dom.raw.HTMLDivElement] => Unit = null,
