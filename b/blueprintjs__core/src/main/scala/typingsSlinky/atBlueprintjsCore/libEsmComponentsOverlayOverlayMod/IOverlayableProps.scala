package typingsSlinky.atBlueprintjsCore.libEsmComponentsOverlayOverlayMod
...
trait IOverlayableProps extends IOverlayLifecycleProps {
  ...
  /**
    ...
    */
  var onClose: js.UndefOr[js.Function1[/* event */ js.UndefOr[SyntheticEvent[Event, HTMLElement]], Unit]] = js.undefined
  /**
