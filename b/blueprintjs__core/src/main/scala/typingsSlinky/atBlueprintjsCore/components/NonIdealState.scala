...
object NonIdealState
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.NonIdealState] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.NonIdealState](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
