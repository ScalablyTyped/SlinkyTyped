...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsNavbarNavbarGroupMod.INavbarGroupProps
...
object NavbarGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.NavbarGroup] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.NavbarGroup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.NavbarGroup] = new slinky.core.BuildingComponent[
  slinky.web.html.div.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.NavbarGroup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = INavbarGroupProps
}
