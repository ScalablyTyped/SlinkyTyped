...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsMenuMenuMod.IMenuProps
...
object Menu
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Menu] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Menu] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Menu] = new slinky.core.BuildingComponent[
  slinky.web.html.ul.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Menu](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
