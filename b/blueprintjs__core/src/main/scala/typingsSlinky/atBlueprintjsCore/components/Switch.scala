...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsFormsControlsMod.ISwitchProps
...
object Switch
  ...
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Switch] = {
    ...
    if (innerLabel != null) __obj.updateDynamic("innerLabel")(innerLabel.asInstanceOf[js.Any])
    if (innerLabelChecked != null) __obj.updateDynamic("innerLabelChecked")(innerLabelChecked.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Switch] = new slinky.core.BuildingComponent[
  slinky.web.html.input.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Switch](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
