...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsFormsFileInputMod.IFileInputProps
...
object FileInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.FileInput] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.FileInput] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.FileInput] = new slinky.core.BuildingComponent[
  slinky.web.html.label.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.FileInput](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
