...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsHtmlDashSelectHtmlSelectMod.IHTMLSelectProps
...
object HTMLSelect
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.HTMLSelect] = {
