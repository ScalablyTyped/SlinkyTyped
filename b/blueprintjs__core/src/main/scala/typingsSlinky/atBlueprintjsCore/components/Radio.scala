...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsFormsControlsMod.IRadioProps
...
object Radio
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Radio] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Radio] = {
