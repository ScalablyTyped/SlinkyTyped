...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsFormsTextAreaMod.ITextAreaProps
...
object TextArea
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.TextArea] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.TextArea] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.TextArea] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.TextArea](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
