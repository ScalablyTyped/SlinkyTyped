...
import typingsSlinky.atBlueprintjsCore.atBlueprintjsCoreStrings.`hover-target`
import typingsSlinky.atBlueprintjsCore.atBlueprintjsCoreStrings.hover
...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsTooltipTooltipMod.ITooltipProps
...
object Tooltip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Tooltip] {
  ...
  def apply(
    content: typingsSlinky.react.reactMod._Global_.JSX.Element | String,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.Tooltip] = {
