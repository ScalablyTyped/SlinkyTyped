...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsHtmlDashTableHtmlTableMod.IHTMLTableProps
...
object HTMLTable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.HTMLTable] {
  @JSImport("@blueprintjs/core/lib/esm/components", "HTMLTable")
  @js.native
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.HTMLTable] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.HTMLTable] = new slinky.core.BuildingComponent[
  slinky.web.html.table.tag.type, 
  typingsSlinky.atBlueprintjsCore.libEsmComponentsMod.HTMLTable](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IHTMLTableProps
}
