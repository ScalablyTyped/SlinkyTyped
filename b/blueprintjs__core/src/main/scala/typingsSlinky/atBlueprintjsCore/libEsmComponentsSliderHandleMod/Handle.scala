...
import typingsSlinky.atBlueprintjsCore.Anon_IsMoving
...
import typingsSlinky.react.reactMod.TouchEvent
...
class Handle ()
  ...
  def beginHandleMovement(event: typingsSlinky.react.reactMod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  ...
  def mouseEventClientOffset(event: typingsSlinky.react.reactMod.MouseEvent[HTMLElement, NativeMouseEvent]): Double = js.native
