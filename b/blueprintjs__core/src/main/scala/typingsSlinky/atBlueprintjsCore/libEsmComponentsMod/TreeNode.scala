...
@js.native
class TreeNode[T] ()
  extends typingsSlinky.atBlueprintjsCore.libEsmComponentsTreeTreeNodeMod.TreeNode[T]
...
object TreeNode extends js.Object {
  ...
  def ofType[T](): Instantiable1[
    ...
    typingsSlinky.atBlueprintjsCore.libEsmComponentsTreeTreeNodeMod.TreeNode[T]
  ] = js.native
}
