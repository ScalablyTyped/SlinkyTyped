package typingsSlinky.atBlueprintjsCore.libEsmComponentsTooltipTooltipMod
...
import typingsSlinky.atBlueprintjsCore.libEsmComponentsPopoverPopoverSharedPropsMod.IPopoverSharedProps
