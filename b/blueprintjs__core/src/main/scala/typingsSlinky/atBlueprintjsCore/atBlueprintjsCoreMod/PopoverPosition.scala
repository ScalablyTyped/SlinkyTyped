...
import typingsSlinky.atBlueprintjsCore.atBlueprintjsCoreStrings.`auto-end`
import typingsSlinky.atBlueprintjsCore.atBlueprintjsCoreStrings.`auto-start`
...
import typingsSlinky.atBlueprintjsCore.atBlueprintjsCoreStrings.auto
...
@JSImport("@blueprintjs/core", "PopoverPosition")
@js.native
