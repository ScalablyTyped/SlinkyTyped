...
object Classes extends js.Object {
  ...
  def alignmentClass(alignment: typingsSlinky.atBlueprintjsCore.libEsmCommonAlignmentMod.Alignment): String = js.native
  def elevationClass(elevation: typingsSlinky.atBlueprintjsCore.libEsmCommonElevationMod.Elevation): String = js.native
  ...
  def intentClass(intent: typingsSlinky.atBlueprintjsCore.libEsmCommonIntentMod.Intent): String = js.native
  def positionClass(position: typingsSlinky.atBlueprintjsCore.libEsmCommonPositionMod.Position): String = js.native
}
