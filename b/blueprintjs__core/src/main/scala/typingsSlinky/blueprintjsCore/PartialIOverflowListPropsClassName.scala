...
trait PartialIOverflowListPropsClassName extends js.Object {
  ...
  var overflowRenderer: js.UndefOr[js.Function1[/* overflowItems */ js.Array[_], TagMod[Any]]] = js.undefined
...
object PartialIOverflowListPropsClassName {
  ...
  def apply(
    ...
    overflowRenderer: /* overflowItems */ js.Array[_] => TagMod[Any] = null,
