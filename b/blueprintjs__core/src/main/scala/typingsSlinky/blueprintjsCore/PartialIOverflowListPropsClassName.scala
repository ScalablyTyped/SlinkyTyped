...
trait PartialIOverflowListPropsClassName extends js.Object {
  ...
  var overflowRenderer: js.UndefOr[js.Function1[/* overflowItems */ js.Array[_], TagMod[Any]]] = js.native
...
object PartialIOverflowListPropsClassName {
  ...
  implicit class PartialIOverflowListPropsClassNameOps[Self <: PartialIOverflowListPropsClassName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnOverflow(value: /* overflowItems */ js.Array[_] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOverflowRenderer(value: /* overflowItems */ js.Array[_] => TagMod[Any]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVisibleItemRenderer(value: (/* item */ js.Any, /* index */ Double) => ReactChild): Self = {
        val ret = this.duplicate
