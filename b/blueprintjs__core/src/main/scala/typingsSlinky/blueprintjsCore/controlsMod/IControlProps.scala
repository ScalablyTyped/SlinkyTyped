...
object IControlProps {
  ...
  implicit class IControlPropsOps[Self <: IControlProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelElementReactElement(value: ReactElement): Self = this.set("labelElement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelElement(value: ReactElement): Self = this.set("labelElement", value.asInstanceOf[js.Any])
