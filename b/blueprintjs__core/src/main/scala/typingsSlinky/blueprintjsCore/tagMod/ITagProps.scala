...
- typingsSlinky.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait ITagProps
  ...
  /**
    ...
    */
  @JSName("onClick")
  var onClick_ITagProps: js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[HTMLDivElement], Unit]] = js.undefined
  /**
