...
object IFormGroupProps {
  ...
  implicit class IFormGroupPropsOps[Self <: IFormGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelInfoReactElement(value: ReactElement): Self = this.set("labelInfo", value.asInstanceOf[js.Any])
    @scala.inline
    def setLabelInfo(value: ReactElement): Self = this.set("labelInfo", value.asInstanceOf[js.Any])
    @scala.inline
