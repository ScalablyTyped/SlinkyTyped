...
object formGroupMod {
  ...
  trait IFormGroupProps
    ...
    /**
      ...
      */
    var labelInfo: js.UndefOr[ReactElement] = js.native
  ...
  object IFormGroupProps {
    ...
    implicit class IFormGroupPropsMutableBuilder[Self <: IFormGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHelperTextReactElement(value: ReactElement): Self = StObject.set(x, "helperText", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLabelInfo(value: ReactElement): Self = StObject.set(x, "labelInfo", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelInfoReactElement(value: ReactElement): Self = StObject.set(x, "labelInfo", value.asInstanceOf[js.Any])
