...
object IElementRefProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ E](): IElementRefProps[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IElementRefProps[E]]
  }
  @scala.inline
  implicit class IElementRefPropsOps[Self <: IElementRefProps[_], /* <: typingsSlinky.std.HTMLElement */ E] (val x: Self with IElementRefProps[E]) extends AnyVal {
    @scala.inline
