...
object ITreeNodeProps {
  ...
  implicit class ITreeNodePropsOps[Self <: ITreeNodeProps[_], T] (val x: Self with ITreeNodeProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    
    @scala.inline
    def setOnCollapse(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLSpanElement]) => Unit): Self = this.set("onCollapse", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnCollapse: Self = this.set("onCollapse", js.undefined)
    
    @scala.inline
    def setOnContextMenu(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit): Self = this.set("onContextMenu", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnContextMenu: Self = this.set("onContextMenu", js.undefined)
    
    @scala.inline
    def setOnDoubleClick(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit): Self = this.set("onDoubleClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnDoubleClick: Self = this.set("onDoubleClick", js.undefined)
    
    @scala.inline
    def setOnExpand(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLSpanElement]) => Unit): Self = this.set("onExpand", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnExpand: Self = this.set("onExpand", js.undefined)
    
    @scala.inline
    def setOnMouseEnter(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction2(value))
