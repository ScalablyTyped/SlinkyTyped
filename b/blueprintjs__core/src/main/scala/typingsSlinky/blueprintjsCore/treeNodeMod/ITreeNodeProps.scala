...
object ITreeNodeProps {
  ...
  def apply[T](
    ...
    nodeData: T = null,
    onClick: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit = null,
    onCollapse: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLSpanElement]) => Unit = null,
    onContextMenu: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit = null,
    onDoubleClick: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit = null,
    onExpand: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLSpanElement]) => Unit = null,
    onMouseEnter: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit = null,
    onMouseLeave: (/* node */ TreeNode[T], /* e */ SyntheticMouseEvent[HTMLDivElement]) => Unit = null,
