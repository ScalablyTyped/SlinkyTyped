...
object blueprintjsCoreStrings {
  ...
  @js.native
  sealed trait LifecycleCompatPolyfill extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait blueprintPortalClassName extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait safeInvokeMember extends StObject
  @scala.inline
