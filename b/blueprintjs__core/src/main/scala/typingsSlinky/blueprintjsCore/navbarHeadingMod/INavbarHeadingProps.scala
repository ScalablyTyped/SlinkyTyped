package typingsSlinky.blueprintjsCore.navbarHeadingMod
...
- typingsSlinky.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarHeadingProps extends HTMLAttributes[HTMLDivElement]
