...
trait IPanel[P] extends js.Object {
  /**
    ...
    */
  var component: ReactComponentClass[P with IPanelProps]
  /**
...
object IPanel {
  @scala.inline
  def apply[P](component: ReactComponentClass[P with IPanelProps], props: P = null, title: TagMod[Any] = null): IPanel[P] = {
