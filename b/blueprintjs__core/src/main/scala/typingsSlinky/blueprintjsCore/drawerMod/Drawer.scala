...
import typingsSlinky.blueprintjsCore.blueprintjsCoreStrings.`360px`
import typingsSlinky.blueprintjsCore.blueprintjsCoreStrings.`50Percentsign`
import typingsSlinky.blueprintjsCore.blueprintjsCoreStrings.`90Percentsign`
