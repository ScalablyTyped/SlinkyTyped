...
object ITextProps {
  ...
  implicit class ITextPropsOps[Self <: ITextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEllipsize(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ellipsize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEllipsize: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ellipsize")(js.undefined)
        ret
    }
    @scala.inline
