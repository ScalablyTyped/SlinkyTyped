...
object multiSliderMod {
  ...
  object ISliderBaseProps {
    ...
    implicit class ISliderBasePropsMutableBuilder[Self <: ISliderBaseProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelRenderer(value: Boolean | (js.Function1[/* value */ Double, String | ReactElement])): Self = StObject.set(x, "labelRenderer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelRendererFunction1(value: /* value */ Double => String | ReactElement): Self = StObject.set(x, "labelRenderer", js.Any.fromFunction1(value))
