...
@scala.inline
class SharedBuilder_HTMLPropsIElementRefProps_1330997956[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def elementRef(value: IRef[HTMLElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
