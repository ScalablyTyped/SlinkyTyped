...
object TagInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.TagInput] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.TagInput] = {
