...
object Tag
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Tag] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Tag] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Tag] = new slinky.core.BuildingComponent[slinky.web.html.span.tag.type, typingsSlinky.blueprintjsCore.mod.Tag](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
