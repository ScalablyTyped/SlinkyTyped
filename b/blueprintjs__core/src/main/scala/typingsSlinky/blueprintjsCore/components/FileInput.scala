...
import typingsSlinky.blueprintjsCore.fileInputMod.IFileInputProps
...
object FileInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.FileInput] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.FileInput] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.FileInput] = new slinky.core.BuildingComponent[slinky.web.html.label.tag.type, typingsSlinky.blueprintjsCore.mod.FileInput](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IFileInputProps
}
