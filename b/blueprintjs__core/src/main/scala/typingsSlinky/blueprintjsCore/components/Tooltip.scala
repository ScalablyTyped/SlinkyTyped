...
object Tooltip
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Tooltip] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Tooltip] = {
