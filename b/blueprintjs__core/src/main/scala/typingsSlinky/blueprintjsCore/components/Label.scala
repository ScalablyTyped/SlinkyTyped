...
object Label {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, HTMLLabelElement] {
    ...
    @scala.inline
    def elementRef(value: IRef[HTMLLabelElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def elementRefFunction1(value: /* ref */ HTMLLabelElement | Null => js.Any): this.type = set("elementRef", js.Any.fromFunction1(value))
  ...
  def withProps(p: HTMLProps[HTMLLabelElement] with IElementRefProps[HTMLLabelElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
