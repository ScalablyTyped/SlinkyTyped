...
object Tab
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Tab] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Tab] = {
