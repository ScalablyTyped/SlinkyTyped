...
object Blockquote {
  ...
  implicit def make(companion: Blockquote.type): `SharedBuilder_<intersection>_1717983003`[LegacyRef[js.Any] with js.Object] = new `SharedBuilder_<intersection>_1717983003`[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
