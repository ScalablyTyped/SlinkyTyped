...
object Blockquote {
  ...
  implicit def make(companion: Blockquote.type): `SharedBuilder_<intersection>_1717983003`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>_1717983003`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
