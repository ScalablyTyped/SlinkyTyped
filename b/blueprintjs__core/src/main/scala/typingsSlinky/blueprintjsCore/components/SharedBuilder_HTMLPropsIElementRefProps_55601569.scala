...
@scala.inline
class SharedBuilder_HTMLPropsIElementRefProps_55601569[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def elementRef(value: /* ref */ HTMLHeadingElement | Null => Unit): this.type = set("elementRef", js.Any.fromFunction1(value))
