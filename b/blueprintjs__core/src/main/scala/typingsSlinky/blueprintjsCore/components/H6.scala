...
object H6 {
  ...
  implicit def make(companion: H6.type): SharedBuilder_HTMLPropsIElementRefProps597744580[HTMLHeadingElement] = new SharedBuilder_HTMLPropsIElementRefProps597744580[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
