...
object H6 {
  ...
  implicit def make(companion: H6.type): SharedBuilder_HTMLPropsIElementRefProps_55601569[LegacyRef[js.Any] with js.Object] = new SharedBuilder_HTMLPropsIElementRefProps_55601569[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
