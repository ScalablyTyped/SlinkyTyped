...
import typingsSlinky.blueprintjsCore.buttonGroupMod.IButtonGroupProps
...
object ButtonGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.ButtonGroup] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.ButtonGroup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.ButtonGroup] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.blueprintjsCore.mod.ButtonGroup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
