...
@scala.inline
class SharedBuilder_HTMLPropsIElementRefProps_1717983003[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def elementRef(value: /* ref */ HTMLElement | Null => Unit): this.type = set("elementRef", js.Any.fromFunction1(value))
  @scala.inline
