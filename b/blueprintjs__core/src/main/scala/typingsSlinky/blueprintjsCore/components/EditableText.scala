...
object EditableText
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.EditableText] {
  @JSImport("@blueprintjs/core", "EditableText")
  @js.native
  object componentImport extends js.Object
  
  override val component: String | js.Object = this.componentImport
  /* The following DOM/SVG props were specified: className, disabled, placeholder, type */
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.EditableText] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.EditableText] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.blueprintjsCore.mod.EditableText](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
