...
import typingsSlinky.blueprintjsCore.calloutMod.ICalloutProps
...
object Callout
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Callout] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Callout] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Callout] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.blueprintjsCore.mod.Callout](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
