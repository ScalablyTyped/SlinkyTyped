...
@scala.inline
class SharedBuilder_HTMLPropsIElementRefProps597744580[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def elementRefFunction1(value: /* ref */ HTMLHeadingElement | Null => js.Any): this.type = set("elementRef", js.Any.fromFunction1(value))
  
  @scala.inline
  def elementRef(value: IRef[HTMLHeadingElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
