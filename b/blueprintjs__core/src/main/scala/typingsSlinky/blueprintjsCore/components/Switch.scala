...
object Switch {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Switch] {
    ...
    @scala.inline
    def innerLabel(value: String): this.type = set("innerLabel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def innerLabelChecked(value: String): this.type = set("innerLabelChecked", value.asInstanceOf[js.Any])
