...
import typingsSlinky.blueprintjsCore.asyncControllableInputMod.IAsyncControllableInputProps
...
object AsyncControllableInput {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[
          tag.type, 
          typingsSlinky.blueprintjsCore.asyncControllableInputMod.AsyncControllableInput
        ] {
  ...
  implicit def make(companion: AsyncControllableInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IAsyncControllableInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
