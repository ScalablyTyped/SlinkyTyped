...
object OL {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def elementRefFunction1(value: /* ref */ HTMLOListElement | Null => js.Any): this.type = set("elementRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def elementRef(value: IRef[HTMLOListElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
