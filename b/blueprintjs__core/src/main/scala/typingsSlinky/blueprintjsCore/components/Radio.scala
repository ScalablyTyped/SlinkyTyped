...
import typingsSlinky.blueprintjsCore.controlsMod.IRadioProps
...
object Radio
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Radio] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Radio] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Radio] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.blueprintjsCore.mod.Radio](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
