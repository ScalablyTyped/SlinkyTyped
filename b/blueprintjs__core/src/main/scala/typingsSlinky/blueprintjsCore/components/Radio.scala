...
import typingsSlinky.blueprintjsCore.controlsMod.IControlProps
...
object Radio {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Radio] {
    @scala.inline
    ...
    @scala.inline
    def alignIndicator(value: Alignment): this.type = set("alignIndicator", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IControlProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
