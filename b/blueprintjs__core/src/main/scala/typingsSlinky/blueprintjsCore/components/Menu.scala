...
object Menu
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Menu] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Menu] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Menu] = new slinky.core.BuildingComponent[slinky.web.html.ul.tag.type, typingsSlinky.blueprintjsCore.mod.Menu](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
