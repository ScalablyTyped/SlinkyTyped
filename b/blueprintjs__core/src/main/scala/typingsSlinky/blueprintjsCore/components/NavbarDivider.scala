...
import typingsSlinky.blueprintjsCore.navbarDividerMod.INavbarDividerProps
...
object NavbarDivider
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarDivider] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarDivider] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarDivider] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.blueprintjsCore.mod.NavbarDivider](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = INavbarDividerProps
}
