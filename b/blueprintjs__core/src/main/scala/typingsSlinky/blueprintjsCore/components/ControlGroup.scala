...
import typingsSlinky.blueprintjsCore.controlGroupMod.IControlGroupProps
...
object ControlGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.ControlGroup] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.ControlGroup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.ControlGroup] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.blueprintjsCore.mod.ControlGroup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = IControlGroupProps
}
