...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Button] {
    @scala.inline
    ...
    @scala.inline
    def alignText(value: Alignment): this.type = set("alignText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def outlined(value: Boolean): this.type = set("outlined", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: IButtonProps with ButtonHTMLAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
