...
import typingsSlinky.blueprintjsCore.drawerMod.IDrawerProps
...
object Drawer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Drawer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Drawer] = {
