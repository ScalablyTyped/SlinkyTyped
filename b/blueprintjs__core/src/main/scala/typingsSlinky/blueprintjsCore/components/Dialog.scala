...
object Dialog
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Dialog] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Dialog] = {
