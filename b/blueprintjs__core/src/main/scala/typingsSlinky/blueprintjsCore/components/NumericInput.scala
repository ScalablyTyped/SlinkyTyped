...
object NumericInput {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NumericInput] {
    @scala.inline
    ...
    @scala.inline
    def allowNumericCharactersOnly(value: Boolean): this.type = set("allowNumericCharactersOnly", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def buttonPosition(value: left | right | typingsSlinky.blueprintjsCore.blueprintjsCoreStrings.none): this.type = set("buttonPosition", value.asInstanceOf[js.Any])
    @scala.inline
    def capture(value: Boolean | String): this.type = set("capture", value.asInstanceOf[js.Any])
    @scala.inline
    def checked(value: Boolean): this.type = set("checked", value.asInstanceOf[js.Any])
    @scala.inline
    def clampValueOnBlur(value: Boolean): this.type = set("clampValueOnBlur", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def majorStepSizeNull: this.type = set("majorStepSize", null)
    @scala.inline
    ...
    @scala.inline
    def minorStepSize(value: Double): this.type = set("minorStepSize", value.asInstanceOf[js.Any])
    @scala.inline
    def minorStepSizeNull: this.type = set("minorStepSize", null)
    @scala.inline
    ...
    @scala.inline
    def onButtonClick(value: (/* valueAsNumber */ Double, /* valueAsString */ String) => Unit): this.type = set("onButtonClick", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def selectAllOnIncrement(value: Boolean): this.type = set("selectAllOnIncrement", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: HTMLInputProps with INumericInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
