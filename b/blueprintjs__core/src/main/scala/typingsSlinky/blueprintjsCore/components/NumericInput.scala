...
object NumericInput
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.NumericInput] {
  ...
  def apply(
    ...
    buttonPosition: left | right | typingsSlinky.blueprintjsCore.blueprintjsCoreStrings.none = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NumericInput] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NumericInput] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.blueprintjsCore.mod.NumericInput](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
