...
object UL {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def elementRef(value: IRef[HTMLUListElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def elementRefFunction1(value: /* ref */ HTMLUListElement | Null => js.Any): this.type = set("elementRef", js.Any.fromFunction1(value))
  ...
  def withProps(p: HTMLProps[HTMLUListElement] with IElementRefProps[HTMLUListElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
