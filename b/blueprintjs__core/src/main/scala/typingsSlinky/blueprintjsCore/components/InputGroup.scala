...
object InputGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.InputGroup] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.InputGroup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.InputGroup] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.blueprintjsCore.mod.InputGroup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
