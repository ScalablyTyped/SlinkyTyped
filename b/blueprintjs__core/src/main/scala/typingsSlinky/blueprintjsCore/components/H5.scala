...
object H5 {
  ...
  implicit def make(companion: H5.type): SharedBuilder_HTMLPropsIElementRefProps_55601569[HTMLHeadingElement] = new SharedBuilder_HTMLPropsIElementRefProps_55601569[HTMLHeadingElement](js.Array(this.component, js.Dictionary.empty))()
}
