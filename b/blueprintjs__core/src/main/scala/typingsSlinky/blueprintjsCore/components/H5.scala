...
object H5 {
  ...
  implicit def make(companion: H5.type): `SharedBuilder_<intersection>_55601569`[LegacyRef[js.Any]] = new `SharedBuilder_<intersection>_55601569`[LegacyRef[js.Any]](js.Array(this.component, js.Dictionary.empty))()
}
