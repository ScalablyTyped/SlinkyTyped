...
object Navbar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.Navbar] {
  ...
  def apply(
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Navbar] = {
    ...
    if (!js.isUndefined(fixedToTop)) __obj.updateDynamic("fixedToTop")(fixedToTop.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Navbar] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.blueprintjsCore.mod.Navbar](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
