...
object Navbar {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Navbar] {
    ...
    @scala.inline
    def fixedToTop(value: Boolean): this.type = set("fixedToTop", value.asInstanceOf[js.Any])
  ...
  def withProps(p: INavbarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
