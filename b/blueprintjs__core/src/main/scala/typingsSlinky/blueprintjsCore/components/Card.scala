...
object Card {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.Card] {
    ...
    @scala.inline
    def elevation(value: Elevation): this.type = set("elevation", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ICardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
