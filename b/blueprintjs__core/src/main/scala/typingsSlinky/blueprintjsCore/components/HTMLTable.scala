...
import typingsSlinky.blueprintjsCore.htmlTableMod.IHTMLTableProps
...
object HTMLTable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.HTMLTable] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.HTMLTable] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.HTMLTable] = new slinky.core.BuildingComponent[slinky.web.html.table.tag.type, typingsSlinky.blueprintjsCore.mod.HTMLTable](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
