...
object NavbarHeading {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarHeading] {
  ...
  implicit def make(companion: NavbarHeading.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: INavbarHeadingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
