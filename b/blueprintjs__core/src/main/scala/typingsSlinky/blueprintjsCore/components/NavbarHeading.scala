...
import typingsSlinky.blueprintjsCore.navbarHeadingMod.INavbarHeadingProps
...
object NavbarHeading
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarHeading] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarHeading] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.mod.NavbarHeading] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.blueprintjsCore.mod.NavbarHeading](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
