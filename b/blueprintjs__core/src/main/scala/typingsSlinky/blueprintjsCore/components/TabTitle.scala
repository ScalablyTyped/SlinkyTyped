...
object TabTitle {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.blueprintjsCore.tabTitleMod.TabTitle] {
    @scala.inline
    ...
    @scala.inline
    def panel(value: ReactElement): this.type = set("panel", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: ITabTitleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(
    id: TabId,
    ...
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onClick = js.Any.fromFunction2(onClick), parentId = parentId.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ITabTitleProps]))
  }
}
