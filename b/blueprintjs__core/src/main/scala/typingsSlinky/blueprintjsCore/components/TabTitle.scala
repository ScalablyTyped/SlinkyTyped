...
import typingsSlinky.blueprintjsCore.tabTitleMod.ITabTitleProps
...
object TabTitle
  ...
  ): BuildingComponent[tag.type, typingsSlinky.blueprintjsCore.tabTitleMod.TabTitle] = {
