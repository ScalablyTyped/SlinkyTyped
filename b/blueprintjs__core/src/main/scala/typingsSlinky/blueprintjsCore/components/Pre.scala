...
object Pre {
  ...
  implicit def make(companion: Pre.type): SharedBuilder_HTMLPropsIElementRefProps_1717983003[LegacyRef[js.Any] with js.Object] = new SharedBuilder_HTMLPropsIElementRefProps_1717983003[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
