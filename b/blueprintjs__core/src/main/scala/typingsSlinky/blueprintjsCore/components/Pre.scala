...
object Pre {
  ...
  implicit def make(companion: Pre.type): SharedBuilder_HTMLPropsIElementRefProps_1717983003[HTMLElement] = new SharedBuilder_HTMLPropsIElementRefProps_1717983003[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
}
