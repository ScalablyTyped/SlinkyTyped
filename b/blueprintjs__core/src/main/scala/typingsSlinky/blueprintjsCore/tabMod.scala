...
object tabMod {
  ...
  object Tab {
    ...
    @JSImport("@blueprintjs/core/lib/esm/components/tabs/tab", "Tab.defaultProps")
    @js.native
    ...
    @JSImport("@blueprintjs/core/lib/esm/components/tabs/tab", "Tab.displayName")
    @js.native
  ...
  /* Inlined parent @blueprintjs/core.@blueprintjs/core/lib/esm/common/props.IProps */
  /* Inlined parent std.Omit<@blueprintjs/core.@blueprintjs/core/lib/esm/common/props.HTMLDivProps, 'id' | 'title' | 'onClick'> */
  @js.native
  trait ITabProps extends StObject {
    ...
    /**
      ...
      */
    var panel: js.UndefOr[ReactElement] = js.native
  ...
  object ITabProps {
    ...
    @scala.inline
    def apply(id: TabId): ITabProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[ITabProps]
    }
    
    @scala.inline
    implicit class ITabPropsMutableBuilder[Self <: ITabProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPanel(value: ReactElement): Self = StObject.set(x, "panel", value.asInstanceOf[js.Any])
