...
object IAlertProps {
  ...
  implicit class IAlertPropsOps[Self <: IAlertProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCancel(value: /* evt */ js.UndefOr[SyntheticEvent[Event, HTMLElement]] => Unit): Self = this.set("onCancel", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnCancel: Self = this.set("onCancel", js.undefined)
    @scala.inline
    def setOnClose(value: (/* confirmed */ Boolean, /* evt */ js.UndefOr[SyntheticEvent[Event, HTMLElement]]) => Unit): Self = this.set("onClose", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnClose: Self = this.set("onClose", js.undefined)
    @scala.inline
    def setOnConfirm(value: /* evt */ js.UndefOr[SyntheticEvent[Event, HTMLElement]] => Unit): Self = this.set("onConfirm", js.Any.fromFunction1(value))
    @scala.inline
