...
object hotkeysEventsMod {
  ...
  object HotkeyScope extends StObject {
    ...
    /* "global" */ val GLOBAL: typingsSlinky.blueprintjsCore.hotkeysEventsMod.HotkeyScope.GLOBAL with String = js.native
    
    @js.native
    sealed trait LOCAL extends HotkeyScope
    /* "local" */ val LOCAL: typingsSlinky.blueprintjsCore.hotkeysEventsMod.HotkeyScope.LOCAL with String = js.native
  }
