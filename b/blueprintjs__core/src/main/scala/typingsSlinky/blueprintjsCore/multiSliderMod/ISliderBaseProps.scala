...
object ISliderBaseProps {
  ...
  implicit class ISliderBasePropsOps[Self <: ISliderBaseProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelRendererFunction1(value: /* value */ Double => String | ReactElement): Self = this.set("labelRenderer", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLabelRenderer(value: Boolean | (js.Function1[/* value */ Double, String | ReactElement])): Self = this.set("labelRenderer", value.asInstanceOf[js.Any])
