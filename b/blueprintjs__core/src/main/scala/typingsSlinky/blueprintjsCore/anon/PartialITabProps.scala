...
/* Inlined std.Partial<@blueprintjs/core.@blueprintjs/core/lib/esm/components/tabs/tab.ITabProps> */
@js.native
trait PartialITabProps extends StObject {
...
object PartialITabProps {
  
  @scala.inline
  def apply(): PartialITabProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialITabProps]
  }
  
  @scala.inline
  implicit class PartialITabPropsMutableBuilder[Self <: PartialITabProps] (val x: Self) extends AnyVal {
