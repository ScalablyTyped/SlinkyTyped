...
object IPopoverPropschildrenReac {
  ...
  implicit class IPopoverPropschildrenReacOps[Self <: IPopoverPropschildrenReac] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContent(value: String | ReactElement): Self = this.set("content", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTargetReactElement(value: ReactElement): Self = this.set("target", value.asInstanceOf[js.Any])
    @scala.inline
    def setTarget(value: String | ReactElement): Self = this.set("target", value.asInstanceOf[js.Any])
    @scala.inline
