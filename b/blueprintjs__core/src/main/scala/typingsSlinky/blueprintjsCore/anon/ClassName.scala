...
object ClassName {
  @scala.inline
  def apply[/* <: typingsSlinky.react.mod.HTMLAttributes[typingsSlinky.std.HTMLElement] */ H](
    className: String,
  ...
  @scala.inline
  implicit class ClassNameOps[Self <: ClassName[_], /* <: typingsSlinky.react.mod.HTMLAttributes[typingsSlinky.std.HTMLElement] */ H] (val x: Self with ClassName[H]) extends AnyVal {
    @scala.inline
