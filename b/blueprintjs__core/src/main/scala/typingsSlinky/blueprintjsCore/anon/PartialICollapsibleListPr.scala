...
trait PartialICollapsibleListPr extends js.Object {
  ...
  var dropdownTarget: js.UndefOr[ReactElement] = js.native
  
  var visibleItemClassName: js.UndefOr[String] = js.native
  
  var visibleItemCount: js.UndefOr[Double] = js.native
  
  var visibleItemRenderer: js.UndefOr[js.Function2[/* props */ IMenuItemProps, /* index */ Double, ReactElement]] = js.native
}
object PartialICollapsibleListPr {
  ...
  implicit class PartialICollapsibleListPrOps[Self <: PartialICollapsibleListPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDropdownTarget(value: ReactElement): Self = this.set("dropdownTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVisibleItemRenderer(value: (/* props */ IMenuItemProps, /* index */ Double) => ReactElement): Self = this.set("visibleItemRenderer", js.Any.fromFunction2(value))
