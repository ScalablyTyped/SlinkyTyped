...
trait PartialIOverflowListProps extends js.Object {
  ...
  var overflowRenderer: js.UndefOr[js.Function1[/* overflowItems */ js.Array[IBreadcrumbProps], TagMod[Any]]] = js.undefined
...
object PartialIOverflowListProps {
  ...
  def apply(
    ...
    overflowRenderer: /* overflowItems */ js.Array[IBreadcrumbProps] => TagMod[Any] = null,
