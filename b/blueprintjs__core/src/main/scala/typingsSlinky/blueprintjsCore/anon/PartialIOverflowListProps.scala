...
trait PartialIOverflowListProps extends StObject {
  ...
  var overflowRenderer: js.UndefOr[js.Function1[/* overflowItems */ js.Array[IBreadcrumbProps], ReactElement]] = js.native
...
object PartialIOverflowListProps {
  ...
  implicit class PartialIOverflowListPropsMutableBuilder[Self <: PartialIOverflowListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOverflowRenderer(value: /* overflowItems */ js.Array[IBreadcrumbProps] => ReactElement): Self = StObject.set(x, "overflowRenderer", js.Any.fromFunction1(value))
