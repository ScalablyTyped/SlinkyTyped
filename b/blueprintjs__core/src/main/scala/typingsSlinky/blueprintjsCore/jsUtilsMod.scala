...
object jsUtilsMod {
  ...
  @JSImport("@blueprintjs/core/lib/esm/common/utils/jsUtils", "approxEqual")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/common/utils/jsUtils", "arrayLengthCompare")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/common/utils/jsUtils", "clamp")
  @js.native
  def clamp(`val`: Double, min: Double, max: Double): Double = js.native
  
  @JSImport("@blueprintjs/core/lib/esm/common/utils/jsUtils", "countDecimalPlaces")
  @js.native
  def countDecimalPlaces(num: Double): Double = js.native
  
  @JSImport("@blueprintjs/core/lib/esm/common/utils/jsUtils", "isNodeEnv")
  @js.native
