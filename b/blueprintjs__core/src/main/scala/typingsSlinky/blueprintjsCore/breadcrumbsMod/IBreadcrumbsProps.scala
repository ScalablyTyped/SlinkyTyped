...
object IBreadcrumbsProps {
  ...
  implicit class IBreadcrumbsPropsOps[Self <: IBreadcrumbsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBreadcrumbRenderer(value: /* props */ IBreadcrumbProps => ReactElement): Self = this.set("breadcrumbRenderer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setCurrentBreadcrumbRenderer(value: /* props */ IBreadcrumbProps => ReactElement): Self = this.set("currentBreadcrumbRenderer", js.Any.fromFunction1(value))
