...
object tagMod {
  ...
  trait ITagProps
    ...
    var onRemove: js.UndefOr[
        js.Function2[/* e */ SyntheticMouseEvent[HTMLButtonElement], /* tagProps */ this.type, Unit]
      ] = js.native
  ...
  object ITagProps {
    ...
    implicit class ITagPropsMutableBuilder[Self <: ITagProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnRemove(value: (/* e */ SyntheticMouseEvent[HTMLButtonElement], ITagProps) => Unit): Self = StObject.set(x, "onRemove", js.Any.fromFunction2(value))
