...
- typingsSlinky.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait ICardProps extends HTMLAttributes[HTMLDivElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("onClick")
  var onClick_ICardProps: js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[HTMLDivElement], Unit]] = js.undefined
}
