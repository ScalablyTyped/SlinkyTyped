...
object mod extends Shortcut {
  ...
  trait Bugsnag extends StObject {
    ...
    def errorHandler(err: js.Error, req: js.Any, res: js.Any, next: NextFunction): Unit = js.native
    @JSName("errorHandler")
    ...
    def koaHandler(err: js.Error, ctx: js.Any): Unit = js.native
    
    var metaData: StringDictionary[js.Any] = js.native
    
    def notify(error: String): Unit = js.native
    def notify(error: String, cb: js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]): Unit = js.native
    def notify(error: String, options: NotifyOptions): Unit = js.native
    def notify(
      error: String,
      options: NotifyOptions,
      cb: js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]
    ): Unit = js.native
    def notify(error: js.Error): Unit = js.native
    def notify(error: js.Error, cb: js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]): Unit = js.native
    def notify(error: js.Error, options: NotifyOptions): Unit = js.native
    def notify(
      error: js.Error,
      options: NotifyOptions,
      cb: js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]
    ...
    def onBeforeNotify(cb: js.Function1[/* notification */ js.Any, Boolean | Unit], error: js.Error): Unit = js.native
    ...
    def restifyHandler(req: js.Any, res: js.Any, route: js.Any, err: js.Error): Unit = js.native
  ...
  trait ConfigurationOptions extends StObject {
    ...
    var onUncaughtError: js.UndefOr[js.Function1[/* error */ String | js.Error, Unit]] = js.native
  ...
  object ConfigurationOptions {
    ...
    implicit class ConfigurationOptionsMutableBuilder[Self <: ConfigurationOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnUncaughtError(value: /* error */ String | js.Error => Unit): Self = StObject.set(x, "onUncaughtError", js.Any.fromFunction1(value))
