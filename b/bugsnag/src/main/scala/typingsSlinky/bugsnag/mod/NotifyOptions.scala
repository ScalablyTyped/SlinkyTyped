package typingsSlinky.bugsnag.mod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.bugsnag.bugsnagStrings.error
import typingsSlinky.bugsnag.bugsnagStrings.info
import typingsSlinky.bugsnag.bugsnagStrings.warning
