...
import typingsSlinky.breeze.breeze.EntityManager
...
object AnonEntityManager {
  @scala.inline
  def apply(entityManager: EntityManager, httpResponse: HttpResponse, query: EntityQuery): AnonEntityManager = {
  ...
  @scala.inline
  implicit class AnonEntityManagerOps[Self <: AnonEntityManager] (val x: Self) extends AnyVal {
    @scala.inline
