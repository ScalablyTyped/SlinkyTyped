...
object AnonExtractKeyMappings {
  @scala.inline
  def apply(name: String, visitNode: (js.Object, QueryContext, NodeContext) => AnonEntityType): AnonExtractKeyMappings = {
  ...
  @scala.inline
  implicit class AnonExtractKeyMappingsOps[Self <: AnonExtractKeyMappings] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withVisitNode(value: (js.Object, QueryContext, NodeContext) => AnonEntityType): Self = {
        val ret = this.duplicate
