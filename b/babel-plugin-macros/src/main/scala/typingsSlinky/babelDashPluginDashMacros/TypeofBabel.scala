...
import typingsSlinky.atBabelCore.atBabelCoreMod.BabelFileResult
import typingsSlinky.atBabelCore.atBabelCoreMod.ConfigItem
import typingsSlinky.atBabelCore.atBabelCoreMod.CreateConfigItemOptions
import typingsSlinky.atBabelCore.atBabelCoreMod.FileParseCallback
import typingsSlinky.atBabelCore.atBabelCoreMod.FileResultCallback
import typingsSlinky.atBabelCore.atBabelCoreMod.ParseResult
import typingsSlinky.atBabelCore.atBabelCoreMod.PartialConfig
import typingsSlinky.atBabelCore.atBabelCoreMod.PluginOptions
import typingsSlinky.atBabelCore.atBabelCoreMod.PluginTarget
import typingsSlinky.atBabelCore.atBabelCoreMod.TransformOptions
import typingsSlinky.atBabelTemplate.atBabelTemplateMod.DefaultTemplateBuilder
import typingsSlinky.atBabelTemplate.atBabelTemplateMod.PublicReplacements
import typingsSlinky.atBabelTemplate.atBabelTemplateMod.TemplateBuilder
import typingsSlinky.atBabelTemplate.atBabelTemplateMod.TemplateBuilderOptions
import typingsSlinky.atBabelTraverse.atBabelTraverseMod.Hub
...
trait TypeofBabel extends js.Object {
  ...
  var NodePath: Instantiable2[
    /* hub */ Hub, 
    /* parent */ Node, 
    typingsSlinky.atBabelCore.atBabelCoreMod.NodePath[js.Object]
  ] = js.native
  @JSName("template")
  ...
  def transformFromAst(
    ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node,
  ...
  def transformFromAst(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node, code: String, callback: FileResultCallback): Unit = js.native
  def transformFromAst(
    ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node,
    code: String,
    opts: js.UndefOr[scala.Nothing],
  ...
  def transformFromAstAsync(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node): js.Promise[BabelFileResult | Null] = js.native
  def transformFromAstAsync(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node, code: String): js.Promise[BabelFileResult | Null] = js.native
  def transformFromAstAsync(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node, code: String, opts: TransformOptions): js.Promise[BabelFileResult | Null] = js.native
  def transformFromAstSync(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node): BabelFileResult | Null = js.native
  def transformFromAstSync(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node, code: String): BabelFileResult | Null = js.native
  def transformFromAstSync(ast: typingsSlinky.atBabelCore.atBabelCoreMod.Node, code: String, opts: TransformOptions): BabelFileResult | Null = js.native
