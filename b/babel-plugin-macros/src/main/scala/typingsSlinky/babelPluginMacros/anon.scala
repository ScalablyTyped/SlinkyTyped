...
import typingsSlinky.babelPluginMacros.babelPluginMacrosBooleans.`false`
import typingsSlinky.babelPluginMacros.babelPluginMacrosBooleans.`true`
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Ampersand
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.AmpersandAmpersand
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Asterisk
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.AsteriskAsterisk
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.BlockStatement
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.ClassBody
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.CommonJS
...
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.ES
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.EqualssignEqualssign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.EqualssignEqualssignEqualssign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Exclamationmark
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.ExclamationmarkEqualssign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.ExclamationmarkEqualssignEqualssign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Greaterthansign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.GreaterthansignEqualssign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.GreaterthansignGreaterthansign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.GreaterthansignGreaterthansignGreaterthansign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Identifier
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Lessthansign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.LessthansignEqualssign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.LessthansignLessthansign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Percentsign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Plussign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.PlussignPlussign
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.QuestionmarkQuestionmark
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Slash
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.StringLiteral
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Tilde
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Verticalline
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.VerticallineVerticalline
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.^
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.`--`
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.`-_`
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.`object`
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.`throw`
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.`var`
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.boolean
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.const
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.constructor
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.delete
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.function
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.get
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.in
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.instanceof
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.let
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.method
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.minus
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.module
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.number
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.plus
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.script
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.set
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.string
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.symbol
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.typeof
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.undefined
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.void
...
import typingsSlinky.babelTypes.mod.BigIntLiteral_
...
import typingsSlinky.babelTypes.mod.ClassPrivateMethod_
import typingsSlinky.babelTypes.mod.ClassPrivateProperty_
import typingsSlinky.babelTypes.mod.ClassProperty_
import typingsSlinky.babelTypes.mod.Comment
import typingsSlinky.babelTypes.mod.CommentBlock
import typingsSlinky.babelTypes.mod.CommentLine
import typingsSlinky.babelTypes.mod.CommentTypeShorthand
...
import typingsSlinky.babelTypes.mod.EmptyTypeAnnotation_
import typingsSlinky.babelTypes.mod.EnumBooleanBody_
import typingsSlinky.babelTypes.mod.EnumBooleanMember_
import typingsSlinky.babelTypes.mod.EnumDeclaration_
import typingsSlinky.babelTypes.mod.EnumDefaultedMember_
import typingsSlinky.babelTypes.mod.EnumNumberBody_
import typingsSlinky.babelTypes.mod.EnumNumberMember_
import typingsSlinky.babelTypes.mod.EnumStringBody_
import typingsSlinky.babelTypes.mod.EnumStringMember_
import typingsSlinky.babelTypes.mod.EnumSymbolBody_
import typingsSlinky.babelTypes.mod.ExistsTypeAnnotation_
...
import typingsSlinky.babelTypes.mod.FlowType
...
import typingsSlinky.babelTypes.mod.ImportAttribute_
...
import typingsSlinky.babelTypes.mod.Import_
import typingsSlinky.babelTypes.mod.InferredPredicate_
import typingsSlinky.babelTypes.mod.InterfaceDeclaration_
import typingsSlinky.babelTypes.mod.InterfaceExtends_
import typingsSlinky.babelTypes.mod.InterfaceTypeAnnotation_
import typingsSlinky.babelTypes.mod.InterpreterDirective_
...
import typingsSlinky.babelTypes.mod.JSXClosingFragment_
...
import typingsSlinky.babelTypes.mod.JSXOpeningFragment_
...
import typingsSlinky.babelTypes.mod.NumberLiteralTypeAnnotation_
...
import typingsSlinky.babelTypes.mod.ObjectTypeInternalSlot_
import typingsSlinky.babelTypes.mod.ObjectTypeProperty_
import typingsSlinky.babelTypes.mod.ObjectTypeSpreadProperty_
import typingsSlinky.babelTypes.mod.OpaqueType_
import typingsSlinky.babelTypes.mod.OptionalCallExpression_
import typingsSlinky.babelTypes.mod.OptionalMemberExpression_
import typingsSlinky.babelTypes.mod.ParenthesizedExpression_
import typingsSlinky.babelTypes.mod.Pattern
import typingsSlinky.babelTypes.mod.PatternLike
import typingsSlinky.babelTypes.mod.PipelineBareFunction_
import typingsSlinky.babelTypes.mod.PipelinePrimaryTopicReference_
import typingsSlinky.babelTypes.mod.PipelineTopicExpression_
import typingsSlinky.babelTypes.mod.Placeholder_
...
import typingsSlinky.babelTypes.mod.TSBigIntKeyword_
import typingsSlinky.babelTypes.mod.TSBooleanKeyword_
import typingsSlinky.babelTypes.mod.TSCallSignatureDeclaration_
import typingsSlinky.babelTypes.mod.TSConditionalType_
import typingsSlinky.babelTypes.mod.TSConstructSignatureDeclaration_
import typingsSlinky.babelTypes.mod.TSConstructorType_
import typingsSlinky.babelTypes.mod.TSDeclareFunction_
import typingsSlinky.babelTypes.mod.TSDeclareMethod_
import typingsSlinky.babelTypes.mod.TSEntityName
import typingsSlinky.babelTypes.mod.TSEnumDeclaration_
import typingsSlinky.babelTypes.mod.TSEnumMember_
import typingsSlinky.babelTypes.mod.TSExportAssignment_
import typingsSlinky.babelTypes.mod.TSExpressionWithTypeArguments_
import typingsSlinky.babelTypes.mod.TSExternalModuleReference_
import typingsSlinky.babelTypes.mod.TSFunctionType_
import typingsSlinky.babelTypes.mod.TSImportEqualsDeclaration_
import typingsSlinky.babelTypes.mod.TSImportType_
import typingsSlinky.babelTypes.mod.TSIndexSignature_
import typingsSlinky.babelTypes.mod.TSIndexedAccessType_
import typingsSlinky.babelTypes.mod.TSInferType_
...
import typingsSlinky.babelTypes.mod.TSModuleBlock_
import typingsSlinky.babelTypes.mod.TSModuleDeclaration_
import typingsSlinky.babelTypes.mod.TSNamedTupleMember_
import typingsSlinky.babelTypes.mod.TSNamespaceExportDeclaration_
import typingsSlinky.babelTypes.mod.TSNeverKeyword_
import typingsSlinky.babelTypes.mod.TSNonNullExpression_
import typingsSlinky.babelTypes.mod.TSNullKeyword_
import typingsSlinky.babelTypes.mod.TSNumberKeyword_
import typingsSlinky.babelTypes.mod.TSObjectKeyword_
import typingsSlinky.babelTypes.mod.TSOptionalType_
import typingsSlinky.babelTypes.mod.TSParameterProperty_
import typingsSlinky.babelTypes.mod.TSParenthesizedType_
import typingsSlinky.babelTypes.mod.TSPropertySignature_
import typingsSlinky.babelTypes.mod.TSQualifiedName_
import typingsSlinky.babelTypes.mod.TSRestType_
import typingsSlinky.babelTypes.mod.TSStringKeyword_
import typingsSlinky.babelTypes.mod.TSSymbolKeyword_
import typingsSlinky.babelTypes.mod.TSThisType_
import typingsSlinky.babelTypes.mod.TSTupleType_
import typingsSlinky.babelTypes.mod.TSType
import typingsSlinky.babelTypes.mod.TSTypeAliasDeclaration_
import typingsSlinky.babelTypes.mod.TSTypeAnnotation_
import typingsSlinky.babelTypes.mod.TSTypeAssertion_
import typingsSlinky.babelTypes.mod.TSTypeElement
import typingsSlinky.babelTypes.mod.TSTypeLiteral_
import typingsSlinky.babelTypes.mod.TSTypeOperator_
import typingsSlinky.babelTypes.mod.TSTypeParameterDeclaration_
import typingsSlinky.babelTypes.mod.TSTypeParameterInstantiation_
import typingsSlinky.babelTypes.mod.TSTypeParameter_
import typingsSlinky.babelTypes.mod.TSTypePredicate_
import typingsSlinky.babelTypes.mod.TSTypeQuery_
import typingsSlinky.babelTypes.mod.TSTypeReference_
import typingsSlinky.babelTypes.mod.TSUndefinedKeyword_
import typingsSlinky.babelTypes.mod.TSUnionType_
import typingsSlinky.babelTypes.mod.TSUnknownKeyword_
import typingsSlinky.babelTypes.mod.TSVoidKeyword_
...
import typingsSlinky.babelTypes.mod.TypeParameter_
...
object anon {
  ...
  trait TypeofNodePath
    extends Instantiable2[/* hub */ Hub, /* parent */ typingsSlinky.babelTypes.mod.Node, NodePath[js.Object]] {
  ...
  trait Typeoftraverse extends StObject {
    ...
    def apply(
      ...
      parentPath: js.UndefOr[typingsSlinky.babelTraverse.mod.NodePath[typingsSlinky.babelTypes.mod.Node]]
    ): Unit = js.native
    def apply[S](
    ...
    def apply[S](
      ...
      scope: js.UndefOr[scala.Nothing],
      state: S,
      parentPath: typingsSlinky.babelTraverse.mod.NodePath[typingsSlinky.babelTypes.mod.Node]
    ): Unit = js.native
    def apply[S](
      parent: js.UndefOr[typingsSlinky.babelTypes.mod.Node],
      opts: TraverseOptions[S],
    ...
    {[ Type in 'AnyTypeAnnotation' | 'ArgumentPlaceholder' | 'ArrayExpression' | 'ArrayPattern' | 'ArrayTypeAnnotation' | 'ArrowFunctionExpression' | 'AssignmentExpression' | 'AssignmentPattern' | 'AwaitExpression' | 'BigIntLiteral' | 'BinaryExpression' | 'LogicalExpression' | 'BindExpression' | 'BlockStatement' | 'Program' | 'TSModuleBlock' | 'CatchClause' | 'DoWhileStatement' | 'ForInStatement' | 'ForStatement' | 'FunctionDeclaration' | 'FunctionExpression' | 'ObjectMethod' | 'SwitchStatement' | 'WhileStatement' | 'ForOfStatement' | 'ClassMethod' | 'ClassPrivateMethod' | 'StaticBlock' | 'BooleanLiteral' | 'BooleanLiteralTypeAnnotation' | 'BooleanTypeAnnotation' | 'BreakStatement' | 'CallExpression' | 'ClassExpression' | 'ClassDeclaration' | 'ClassBody' | 'ClassImplements' | 'ClassPrivateProperty' | 'ClassProperty' | 'ContinueStatement' | 'ReturnStatement' | 'ThrowStatement' | 'ConditionalExpression' | 'IfStatement' | 'DebuggerStatement' | 'DecimalLiteral' | 'VariableDeclaration' | 'ExportAllDeclaration' | 'ExportDefaultDeclaration' | 'ExportNamedDeclaration' | 'ImportDeclaration' | 'DeclareClass' | 'DeclareFunction' | 'DeclareInterface' | 'DeclareModule' | 'DeclareModuleExports' | 'DeclareTypeAlias' | 'DeclareOpaqueType' | 'DeclareVariable' | 'DeclareExportDeclaration' | 'DeclareExportAllDeclaration' | 'InterfaceDeclaration' | 'OpaqueType' | 'TypeAlias' | 'EnumDeclaration' | 'TSDeclareFunction' | 'TSInterfaceDeclaration' | 'TSTypeAliasDeclaration' | 'TSEnumDeclaration' | 'TSModuleDeclaration' | 'DeclaredPredicate' | 'Decorator' | 'Directive' | 'DirectiveLiteral' | 'DoExpression' | 'EmptyStatement' | 'EmptyTypeAnnotation' | 'EnumBooleanBody' | 'EnumNumberBody' | 'EnumStringBody' | 'EnumSymbolBody' | 'EnumBooleanMember' | 'EnumDefaultedMember' | 'EnumNumberMember' | 'EnumStringMember' | 'ExistsTypeAnnotation' | 'ExportDefaultSpecifier' | 'ExportNamespaceSpecifier' | 'ExportSpecifier' | 'Identifier' | 'StringLiteral' | 'NumericLiteral' | 'NullLiteral' | 'RegExpLiteral' | 'MemberExpression' | 'NewExpression' | 'ObjectExpression' | 'SequenceExpression' | 'ParenthesizedExpression' | 'ThisExpression' | 'UnaryExpression' | 'UpdateExpression' | 'MetaProperty' | 'Super' | 'TaggedTemplateExpression' | 'TemplateLiteral' | 'YieldExpression' | 'Import' | 'OptionalMemberExpression' | 'OptionalCallExpression' | 'TypeCastExpression' | 'JSXElement' | 'JSXFragment' | 'PipelinePrimaryTopicReference' | 'RecordExpression' | 'TupleExpression' | 'TSAsExpression' | 'TSTypeAssertion' | 'TSNonNullExpression' | 'ExpressionStatement' | 'File' | 'NullLiteralTypeAnnotation' | 'FunctionTypeAnnotation' | 'FunctionTypeParam' | 'GenericTypeAnnotation' | 'InferredPredicate' | 'InterfaceExtends' | 'InterfaceTypeAnnotation' | 'IntersectionTypeAnnotation' | 'MixedTypeAnnotation' | 'NullableTypeAnnotation' | 'NumberLiteralTypeAnnotation' | 'NumberTypeAnnotation' | 'ObjectTypeAnnotation' | 'ObjectTypeInternalSlot' | 'ObjectTypeCallProperty' | 'ObjectTypeIndexer' | 'ObjectTypeProperty' | 'ObjectTypeSpreadProperty' | 'QualifiedTypeIdentifier' | 'StringLiteralTypeAnnotation' | 'StringTypeAnnotation' | 'SymbolTypeAnnotation' | 'ThisTypeAnnotation' | 'TupleTypeAnnotation' | 'TypeofTypeAnnotation' | 'TypeAnnotation' | 'TypeParameter' | 'TypeParameterDeclaration' | 'TypeParameterInstantiation' | 'UnionTypeAnnotation' | 'Variance' | 'VoidTypeAnnotation' | 'JSXAttribute' | 'JSXClosingElement' | 'JSXExpressionContainer' | 'JSXSpreadChild' | 'JSXOpeningElement' | 'JSXText' | 'JSXOpeningFragment' | 'JSXClosingFragment' | 'ImportAttribute' | 'ImportDefaultSpecifier' | 'ImportNamespaceSpecifier' | 'ImportSpecifier' | 'InterpreterDirective' | 'JSXEmptyExpression' | 'JSXIdentifier' | 'JSXMemberExpression' | 'JSXNamespacedName' | 'JSXSpreadAttribute' | 'RestElement' | 'ObjectPattern' | 'TSParameterProperty' | 'LabeledStatement' | 'Noop' | 'ObjectProperty' | 'PipelineBareFunction' | 'PipelineTopicExpression' | 'Placeholder' | 'PrivateName' | 'SpreadElement' | 'TryStatement' | 'WithStatement' | 'TSImportEqualsDeclaration' | 'TSExportAssignment' | 'TSNamespaceExportDeclaration' | 'SwitchCase' | 'TSAnyKeyword' | 'TSArrayType' | 'TSBooleanKeyword' | 'TSBigIntKeyword' | 'TSIntrinsicKeyword' | 'TSNeverKeyword' | 'TSNullKeyword' | 'TSNumberKeyword' | 'TSObjectKeyword' | 'TSStringKeyword' | 'TSSymbolKeyword' | 'TSUndefinedKeyword' | 'TSUnknownKeyword' | 'TSVoidKeyword' | 'TSThisType' | 'TSLiteralType' | 'TSCallSignatureDeclaration' | 'TSConditionalType' | 'TSConstructSignatureDeclaration' | 'TSConstructorType' | 'TSDeclareMethod' | 'TSQualifiedName' | 'TSEnumMember' | 'TSExpressionWithTypeArguments' | 'TSExternalModuleReference' | 'TSFunctionType' | 'TSImportType' | 'TSIndexSignature' | 'TSIndexedAccessType' | 'TSInferType' | 'TSInterfaceBody' | 'TSIntersectionType' | 'TSMappedType' | 'TSMethodSignature' | 'TSNamedTupleMember' | 'TSOptionalType' | 'TSParenthesizedType' | 'TSPropertySignature' | 'TSRestType' | 'TSTupleType' | 'TSTypeReference' | 'TSTypePredicate' | 'TSTypeQuery' | 'TSTypeLiteral' | 'TSUnionType' | 'TSTypeOperator' | 'TSTypeAnnotation' | 'TSTypeParameter' | 'TSTypeParameterDeclaration' | 'TSTypeParameterInstantiation' | 'TemplateElement' | 'V8IntrinsicIdentifier' | 'VariableDeclarator' ]:? @babel/traverse.@babel/traverse.VisitNodeObject<S, std.Extract<@babel/types.@babel/types.Node, {  type :Type}>>}
      */ typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Typeoftraverse with TopLevel[js.Any] = js.native
    @JSName("explode")
  ...
  trait Typeoftypes extends StObject {
    ...
    def addComment[T /* <: typingsSlinky.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String): T = js.native
    def addComment[T /* <: typingsSlinky.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String, line: Boolean): T = js.native
    
    def addComments[T /* <: typingsSlinky.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, comments: js.Array[Comment]): T = js.native
    ...
    def buildMatchMemberExpression(`match`: String): js.Function1[
        /* node */ js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null], 
    ...
    def clone[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T): T = js.native
    
    def cloneDeep[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T): T = js.native
    
    def cloneDeepWithoutLoc[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T): T = js.native
    
    def cloneNode[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T): T = js.native
    def cloneNode[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T, deep: js.UndefOr[scala.Nothing], withoutLoc: Boolean): T = js.native
    def cloneNode[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T, deep: Boolean): T = js.native
    def cloneNode[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T, deep: Boolean, withoutLoc: Boolean): T = js.native
    
    def cloneWithoutLoc[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T): T = js.native
    ...
    def ensureBlock(node: Extract[typingsSlinky.babelTypes.mod.Node, `0`]): BlockStatement_ = js.native
    def ensureBlock[K /* <: /* keyof std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.0> */ String */](
      node: Extract[
          typingsSlinky.babelTypes.mod.Node, 
          Record[K, BlockStatement_ | Statement | Expression]
        ],
      key: K
    ...
    def getBindingIdentifiers(node: typingsSlinky.babelTypes.mod.Node): Record[String, Identifier_] = js.native
    def getBindingIdentifiers(node: typingsSlinky.babelTypes.mod.Node, duplicates: js.UndefOr[scala.Nothing], outerOnly: Boolean): Record[String, Identifier_] = js.native
    def getBindingIdentifiers(node: typingsSlinky.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    def getBindingIdentifiers(node: typingsSlinky.babelTypes.mod.Node, duplicates: Boolean, outerOnly: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_false(node: typingsSlinky.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_false(node: typingsSlinky.babelTypes.mod.Node, duplicates: `false`, outerOnly: Boolean): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_true(node: typingsSlinky.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_true(node: typingsSlinky.babelTypes.mod.Node, duplicates: `true`, outerOnly: Boolean): Record[String, js.Array[Identifier_]] = js.native
    
    def getOuterBindingIdentifiers(node: typingsSlinky.babelTypes.mod.Node): Record[String, Identifier_] = js.native
    def getOuterBindingIdentifiers(node: typingsSlinky.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    @JSName("getOuterBindingIdentifiers")
    def getOuterBindingIdentifiers_false(node: typingsSlinky.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = js.native
    @JSName("getOuterBindingIdentifiers")
    def getOuterBindingIdentifiers_true(node: typingsSlinky.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = js.native
    ...
    def inheritInnerComments(node: typingsSlinky.babelTypes.mod.Node, parent: typingsSlinky.babelTypes.mod.Node): Unit = js.native
    
    def inheritLeadingComments(node: typingsSlinky.babelTypes.mod.Node, parent: typingsSlinky.babelTypes.mod.Node): Unit = js.native
    
    def inheritTrailingComments(node: typingsSlinky.babelTypes.mod.Node, parent: typingsSlinky.babelTypes.mod.Node): Unit = js.native
    
    def inherits[T /* <: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null] */](child: T): T = js.native
    def inherits[T /* <: js.UndefOr[typingsSlinky.babelTypes.mod.Node | Null] */](child: T, parent: typingsSlinky.babelTypes.mod.Node): T = js.native
    
    def inheritsComments[T /* <: typingsSlinky.babelTypes.mod.Node */](node: T, parent: typingsSlinky.babelTypes.mod.Node): Unit = js.native
    ...
    def is(
      `type`: String,
      n: js.UndefOr[typingsSlinky.babelTypes.mod.Node],
      required: Partial[typingsSlinky.babelTypes.mod.Node]
    ): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    def is(`type`: String, n: Null, required: Partial[typingsSlinky.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    def is(`type`: String, n: typingsSlinky.babelTypes.mod.Node): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 242 */ js.Any */](`type`: T, n: typingsSlinky.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 242 */ js.Any */, P /* <: Extract[typingsSlinky.babelTypes.mod.Node, Type[T]] */](`type`: T, n: js.UndefOr[typingsSlinky.babelTypes.mod.Node], required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 242 */ js.Any */, P /* <: Extract[typingsSlinky.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def isBinding(node: typingsSlinky.babelTypes.mod.Node, parent: typingsSlinky.babelTypes.mod.Node): Boolean = js.native
    def isBinding(
      node: typingsSlinky.babelTypes.mod.Node,
      parent: typingsSlinky.babelTypes.mod.Node,
      grandparent: typingsSlinky.babelTypes.mod.Node
    ): Boolean = js.native
    ...
    def isBlockScoped(node: typingsSlinky.babelTypes.mod.Node): Boolean = js.native
    ...
    def isImmutable(node: typingsSlinky.babelTypes.mod.Node): /* is @babel/types.@babel/types.Immutable */ Boolean = js.native
    ...
    def isLet(node: typingsSlinky.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = js.native
    ...
    def isNodesEquivalent[T /* <: Partial[typingsSlinky.babelTypes.mod.Node] */](a: T, b: js.Any): /* is T */ Boolean = js.native
    ...
    def isReferenced(node: typingsSlinky.babelTypes.mod.Node, parent: typingsSlinky.babelTypes.mod.Node): Boolean = js.native
    def isReferenced(
      node: typingsSlinky.babelTypes.mod.Node,
      parent: typingsSlinky.babelTypes.mod.Node,
      grandparent: typingsSlinky.babelTypes.mod.Node
    ...
    def isScope(node: typingsSlinky.babelTypes.mod.Node, parent: typingsSlinky.babelTypes.mod.Node): /* is @babel/types.@babel/types.Scopable */ Boolean = js.native
    ...
    def isVar(node: typingsSlinky.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = js.native
    ...
    @JSName("is")
    def is_P_Node[P /* <: typingsSlinky.babelTypes.mod.Node */](`type`: String, n: js.UndefOr[typingsSlinky.babelTypes.mod.Node], required: Partial[P]): /* is P */ Boolean = js.native
    @JSName("is")
    def is_P_Node[P /* <: typingsSlinky.babelTypes.mod.Node */](`type`: String, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def matchesPattern(node: js.UndefOr[typingsSlinky.babelTypes.mod.Node], `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: js.UndefOr[typingsSlinky.babelTypes.mod.Node], `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: js.UndefOr[typingsSlinky.babelTypes.mod.Node], `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(
      node: js.UndefOr[typingsSlinky.babelTypes.mod.Node],
    ...
    def placeholder_Declaration(
      expectedNode: typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Declaration,
      name: Identifier_
    ): Placeholder_ = js.native
    @JSName("placeholder")
    def placeholder_Expression(
      expectedNode: typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Expression,
      name: Identifier_
    ): Placeholder_ = js.native
    @JSName("placeholder")
    def placeholder_Identifier(expectedNode: Identifier, name: Identifier_): Placeholder_ = js.native
    @JSName("placeholder")
    def placeholder_Pattern(expectedNode: typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Pattern, name: Identifier_): Placeholder_ = js.native
    @JSName("placeholder")
    def placeholder_Statement(
      expectedNode: typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Statement,
      name: Identifier_
    ): Placeholder_ = js.native
    @JSName("placeholder")
    ...
    def removeComments[T /* <: typingsSlinky.babelTypes.mod.Node */](node: T): T = js.native
    
    def removeProperties(n: typingsSlinky.babelTypes.mod.Node): Unit = js.native
    def removeProperties(n: typingsSlinky.babelTypes.mod.Node, opts: PreserveComments): Unit = js.native
    
    def removePropertiesDeep[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T): T = js.native
    def removePropertiesDeep[T /* <: typingsSlinky.babelTypes.mod.Node */](n: T, opts: PreserveComments): T = js.native
    ...
    def toComputedKey[T /* <: Extract[typingsSlinky.babelTypes.mod.Node, Computed] */](node: T): Expression = js.native
    def toComputedKey[T /* <: Extract[typingsSlinky.babelTypes.mod.Node, Computed] */](node: T, key: Expression): Expression = js.native
    def toComputedKey[T /* <: Extract[typingsSlinky.babelTypes.mod.Node, Computed] */](node: T, key: Identifier_): Expression = js.native
    ...
    def toKeyAlias(node: Method, key: typingsSlinky.babelTypes.mod.Node): String = js.native
    def toKeyAlias(node: Property): String = js.native
    def toKeyAlias(node: Property, key: typingsSlinky.babelTypes.mod.Node): String = js.native
    
    def toSequenceExpression(nodes: js.Array[typingsSlinky.babelTypes.mod.Node], scope: Push): js.UndefOr[SequenceExpression_] = js.native
    ...
    def toStatement(node: Class): ClassDeclaration_ = js.native
    def toStatement(node: Class, ignore: Boolean): ClassDeclaration_ = js.native
    def toStatement(node: Function): FunctionDeclaration_ = js.native
    def toStatement(node: Function, ignore: Boolean): FunctionDeclaration_ = js.native
    def toStatement(node: Statement): Statement = js.native
    def toStatement(node: Statement, ignore: Boolean): Statement = js.native
    @JSName("toStatement")
    def toStatement_Statement(node: AssignmentExpression_): Statement = js.native
    @JSName("toStatement")
    def toStatement_Statement(node: AssignmentExpression_, ignore: Boolean): Statement = js.native
    @JSName("toStatement")
    ...
    def traverse[T](n: typingsSlinky.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = js.native
    def traverse[T](n: typingsSlinky.babelTypes.mod.Node, h: TraversalHandlers[T]): Unit = js.native
    def traverse[T](n: typingsSlinky.babelTypes.mod.Node, h: TraversalHandlers[T], state: T): Unit = js.native
    def traverse[T](n: typingsSlinky.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = js.native
    
    def traverseFast[T](n: typingsSlinky.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = js.native
    def traverseFast[T](n: typingsSlinky.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = js.native
    ...
    def validate(n: typingsSlinky.babelTypes.mod.Node, key: String, value: js.Any): Unit = js.native
    def validate[T /* <: typingsSlinky.babelTypes.mod.Node */, K /* <: /* keyof T */ String */](
      n: js.UndefOr[typingsSlinky.babelTypes.mod.Node],
      key: K,
    ...
    @JSName("valueToNode")
    def valueToNode_StringLiteral_(value: String): StringLiteral_ = js.native
  ...
  trait defaultArrayNodePathNodeR
    extends /* key */ StringDictionary[js.Array[NodePath[typingsSlinky.babelTypes.mod.Node]]] {
    
    var default: js.Array[NodePath[typingsSlinky.babelTypes.mod.Node]] = js.native
  }
  object defaultArrayNodePathNodeR {
    
    @scala.inline
    def apply(default: js.Array[NodePath[typingsSlinky.babelTypes.mod.Node]]): defaultArrayNodePathNodeR = {
    ...
    implicit class defaultArrayNodePathNodeRMutableBuilder[Self <: defaultArrayNodePathNodeR] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefault(value: js.Array[NodePath[typingsSlinky.babelTypes.mod.Node]]): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultVarargs(value: NodePath[typingsSlinky.babelTypes.mod.Node]*): Self = StObject.set(x, "default", js.Array(value :_*))
    }
  }
}
