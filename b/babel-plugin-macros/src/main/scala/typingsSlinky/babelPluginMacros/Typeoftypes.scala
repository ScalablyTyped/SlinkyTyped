...
import typingsSlinky.babelPluginMacros.babelPluginMacrosStrings.Declaration
...
import typingsSlinky.babelTypes.AnonBody
import typingsSlinky.babelTypes.AnonBuildUndefinedNode
import typingsSlinky.babelTypes.AnonChildren
import typingsSlinky.babelTypes.AnonComputed
import typingsSlinky.babelTypes.AnonCooked
import typingsSlinky.babelTypes.AnonPreserveComments
import typingsSlinky.babelTypes.AnonToString
import typingsSlinky.babelTypes.AnonType
import typingsSlinky.babelTypes.PickMemberExpressionobjec
...
trait Typeoftypes extends js.Object {
  ...
  def buildChildren(node: AnonChildren): js.Array[
  ...
  def optionalMemberExpression(`object`: Expression, property: js.Any, computed: js.UndefOr[scala.Nothing], optional: Boolean): OptionalMemberExpression_ = js.native
  def optionalMemberExpression(`object`: Expression, property: js.Any, computed: Boolean, optional: Boolean): OptionalMemberExpression_ = js.native
  ...
  def removeProperties(n: Node, opts: AnonPreserveComments): Unit = js.native
  def removePropertiesDeep[T /* <: Node */](n: T): T = js.native
  def removePropertiesDeep[T /* <: Node */](n: T, opts: AnonPreserveComments): T = js.native
  ...
  def toBindingIdentifierName(name: AnonToString): String = js.native
  ...
  def toComputedKey[T /* <: Extract[Node, AnonComputed] */](node: T): Expression = js.native
  def toComputedKey[T /* <: Extract[Node, AnonComputed] */](node: T, key: Expression): Expression = js.native
  def toComputedKey[T /* <: Extract[Node, AnonComputed] */](node: T, key: Identifier_): Expression = js.native
  ...
  def toIdentifier(name: AnonToString): String = js.native
  ...
  def toSequenceExpression(nodes: js.Array[Node], scope: AnonBuildUndefinedNode): js.UndefOr[SequenceExpression_] = js.native
