...
import typingsSlinky.betterDashSqlite3.betterDashSqlite3Mod.RunResult
...
trait Statement[BindParameters /* <: js.Array[_] */] extends js.Object {
  var database: typingsSlinky.betterDashSqlite3.betterDashSqlite3Mod.BetterSqlite3.Database = js.native
  ...
  def columns(): js.Array[
    typingsSlinky.betterDashSqlite3.betterDashSqlite3Mod.BetterSqlite3.ColumnDefinition
  ] = js.native
