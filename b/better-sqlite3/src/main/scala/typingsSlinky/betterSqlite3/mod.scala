...
import typingsSlinky.betterSqlite3.mod.BetterSqlite3.DatabaseConstructor
...
object mod extends Shortcut {
  ...
  @js.native
  class ^ protected ()
    extends typingsSlinky.betterSqlite3.mod.BetterSqlite3.Database {
  ...
  object BetterSqlite3 {
    ...
    object ColumnDefinition {
      ...
      @scala.inline
      def apply(name: String): typingsSlinky.betterSqlite3.mod.BetterSqlite3.ColumnDefinition = {
        val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.betterSqlite3.mod.BetterSqlite3.ColumnDefinition]
      }
      
      @scala.inline
      implicit class ColumnDefinitionMutableBuilder[Self <: typingsSlinky.betterSqlite3.mod.BetterSqlite3.ColumnDefinition] (val x: Self) extends AnyVal {
    ...
    trait Database extends StObject {
      ...
      def prepare[BindParameters /* <: js.Array[_] | js.Object */](source: String): typingsSlinky.betterSqlite3.mod.BetterSqlite3.Statement[js.Array[BindParameters] | BindParameters] = js.native
      
      var readonly: Boolean = js.native
      
      def transaction[F /* <: VariableArgFunction */](fn: F): typingsSlinky.betterSqlite3.mod.BetterSqlite3.Transaction[F] = js.native
    }
    
    @js.native
    trait DatabaseConstructor
      extends Instantiable1[/* filename */ String, typingsSlinky.betterSqlite3.mod.BetterSqlite3.Database]
         with Instantiable2[
              /* filename */ String, 
              /* options */ Options, 
              typingsSlinky.betterSqlite3.mod.BetterSqlite3.Database
            ] {
      
      def apply(filename: String): typingsSlinky.betterSqlite3.mod.BetterSqlite3.Database = js.native
      def apply(filename: String, options: Options): typingsSlinky.betterSqlite3.mod.BetterSqlite3.Database = js.native
    ...
    trait Statement[BindParameters /* <: js.Array[_] */] extends StObject {
      ...
      def columns(): js.Array[typingsSlinky.betterSqlite3.mod.BetterSqlite3.ColumnDefinition] = js.native
      
      var database: typingsSlinky.betterSqlite3.mod.BetterSqlite3.Database = js.native
  ...
  type Transaction = typingsSlinky.betterSqlite3.mod.BetterSqlite3.Transaction[VariableArgFunction]
