...
import typingsSlinky.browserDashSync.Anon_Bs
import typingsSlinky.browserDashSync.Anon_Stream
...
trait BrowserSyncInstance extends js.Object {
  ...
  /**
    ...
    * to refresh, or inject the files where possible.
    */
  def reload(options: Anon_Stream): ReadWriteStream = js.native
  /**
  ...
  /**
    ...
    */
  def use(module: Anon_Bs): Unit = js.native
  def use(module: Anon_Bs, options: js.Object): Unit = js.native
  def use(module: Anon_Bs, options: js.Object, cb: js.Any): Unit = js.native
  /**
