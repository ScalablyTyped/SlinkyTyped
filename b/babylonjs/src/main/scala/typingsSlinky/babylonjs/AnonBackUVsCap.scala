...
@js.native
trait AnonBackUVsCap extends js.Object {
...
object AnonBackUVsCap {
  @scala.inline
  def apply(path: js.Array[Vector3]): AnonBackUVsCap = {
    val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBackUVsCap]
  }
  @scala.inline
  implicit class AnonBackUVsCapOps[Self <: AnonBackUVsCap] (val x: Self) extends AnyVal {
    @scala.inline
