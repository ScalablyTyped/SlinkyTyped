...
@js.native
trait AnonBbSize extends js.Object {
...
object AnonBbSize {
  @scala.inline
  def apply(): AnonBbSize = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBbSize]
  }
  @scala.inline
  implicit class AnonBbSizeOps[Self <: AnonBbSize] (val x: Self) extends AnyVal {
    @scala.inline
