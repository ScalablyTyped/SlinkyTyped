...
class StandardMaterial protected ()
  extends typingsSlinky.babylonjs.standardMaterialMod.StandardMaterial {
  /**
...
object StandardMaterial extends js.Object {
  ...
  /**
    ...
    */
  def Parse(source: js.Any, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.standardMaterialMod.StandardMaterial = js.native
  /**
