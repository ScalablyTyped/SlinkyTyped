...
object NodeMaterial {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "NodeMaterial.CreateDefault")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "NodeMaterial.Parse")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "NodeMaterial.ParseFromFileAsync")
  @js.native
  ...
  /**
    ...
    * @returns a promise that will resolve to the new node material
    */
  @JSImport("babylonjs/Materials/index", "NodeMaterial.ParseFromSnippetAsync")
  @js.native
