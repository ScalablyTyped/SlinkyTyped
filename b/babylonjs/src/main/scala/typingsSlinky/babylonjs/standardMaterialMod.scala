...
object standardMaterialMod {
  ...
  object StandardMaterial {
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Materials/standardMaterial", "StandardMaterial.Parse")
    @js.native
    def Parse(source: js.Any, scene: Scene, rootUrl: String): StandardMaterial = js.native
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsSlinky.babylonjs.materialDetailMapConfigurationMod.IMaterialDetailMapDefines because var conflicts: _areTexturesDirty. Inlined DETAIL, DETAILDIRECTUV, DETAIL_NORMALBLENDMETHOD */ @JSImport("babylonjs/Materials/standardMaterial", "StandardMaterialDefines")
  @js.native
