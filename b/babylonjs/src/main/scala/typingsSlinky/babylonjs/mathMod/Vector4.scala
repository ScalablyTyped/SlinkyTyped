...
class Vector4 protected ()
  extends typingsSlinky.babylonjs.mathVectorMod.Vector4 {
  /**
...
object Vector4 {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.Center")
  @js.native
  def Center(
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.Distance")
  @js.native
  def Distance(
    value1: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4],
    value2: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4]
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.DistanceSquared")
  @js.native
  def DistanceSquared(
    value1: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4],
    value2: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4]
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.FromArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.FromArrayToRef")
  @js.native
  def FromArrayToRef(
  ...
  /**
    ...
    * @param result the vector to store the result in
    */
  @JSImport("babylonjs/Maths/math", "Vector4.FromFloatArrayToRef")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.FromFloatsToRef")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.FromVector3")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.Maximize")
  @js.native
  def Maximize(
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.Minimize")
  @js.native
  def Minimize(
    left: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4],
    right: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4]
  ...
  /**
    ...
    * @returns the vector
    */
  @JSImport("babylonjs/Maths/math", "Vector4.Normalize")
  @js.native
  ...
  /**
    ...
    * @param result the vector to store the result in
    */
  @JSImport("babylonjs/Maths/math", "Vector4.NormalizeToRef")
  @js.native
  def NormalizeToRef(
  ...
  /**
    ...
    * @returns the new vector
    */
  @JSImport("babylonjs/Maths/math", "Vector4.One")
  @js.native
  ...
  /**
    ...
    * @returns the new vector
    */
  @JSImport("babylonjs/Maths/math", "Vector4.TransformNormal")
  @js.native
  def TransformNormal(
    vector: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector4],
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Vector4.TransformNormalFromFloatsToRef")
  @js.native
  ...
  /**
    ...
    * @param result the vector to store the result in
    */
  @JSImport("babylonjs/Maths/math", "Vector4.TransformNormalToRef")
  @js.native
  ...
  /**
    ...
    * @returns the new vector
    */
  @JSImport("babylonjs/Maths/math", "Vector4.Zero")
  @js.native
