...
@js.native
trait AnonRadiusZ extends js.Object {
...
object AnonRadiusZ {
  @scala.inline
  def apply(): AnonRadiusZ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonRadiusZ]
  }
  @scala.inline
  implicit class AnonRadiusZOps[Self <: AnonRadiusZ] (val x: Self) extends AnyVal {
    @scala.inline
