...
import typingsSlinky.babylonjs.particleSystemSetMod.ParticleSystemSet
...
@JSImport("babylonjs/Particles/particleHelper", JSImport.Namespace)
@js.native
object particleHelperMod extends js.Object {
  @js.native
