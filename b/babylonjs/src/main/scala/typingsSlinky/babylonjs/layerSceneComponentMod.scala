...
object layerSceneComponentMod {
  ...
  object babylonjsAbstractSceneAugmentingMod {
    ...
    object AbstractScene {
      ...
      @scala.inline
      def apply(layers: js.Array[Layer]): typingsSlinky.babylonjs.layerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
        val __obj = js.Dynamic.literal(layers = layers.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.babylonjs.layerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
      }
      
      @scala.inline
      implicit class AbstractSceneMutableBuilder[Self <: typingsSlinky.babylonjs.layerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene] (val x: Self) extends AnyVal {
