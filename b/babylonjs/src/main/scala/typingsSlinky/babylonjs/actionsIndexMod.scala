...
object actionsIndexMod {
  ...
  class Condition protected ()
    extends typingsSlinky.babylonjs.conditionMod.Condition {
    /**
  ...
  class PlaySoundAction protected ()
    extends typingsSlinky.babylonjs.directAudioActionsMod.PlaySoundAction {
    /**
      * Instantiate the action
      * @param triggerOptions defines the trigger options
  ...
  class SetStateAction protected ()
    extends typingsSlinky.babylonjs.directActionsMod.SetStateAction {
    /**
      * Instantiate the action
      * @param triggerOptions defines the trigger options
  ...
  class SwitchBooleanAction protected ()
    extends typingsSlinky.babylonjs.directActionsMod.SwitchBooleanAction {
    /**
      * Instantiate the action
      * @param triggerOptions defines the trigger options
  ...
  class ValueCondition protected ()
    extends typingsSlinky.babylonjs.conditionMod.ValueCondition {
    /**
