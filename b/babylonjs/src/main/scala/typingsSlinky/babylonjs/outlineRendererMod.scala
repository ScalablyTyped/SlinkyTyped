...
object outlineRendererMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      def apply(_outlineRenderer: OutlineRenderer, getOutlineRenderer: () => OutlineRenderer): typingsSlinky.babylonjs.outlineRendererMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.outlineRendererMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.outlineRendererMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
