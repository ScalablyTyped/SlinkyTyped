...
@js.native
trait AnonDiameterFrontUVs extends js.Object {
...
object AnonDiameterFrontUVs {
  @scala.inline
  def apply(): AnonDiameterFrontUVs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDiameterFrontUVs]
  }
  @scala.inline
  implicit class AnonDiameterFrontUVsOps[Self <: AnonDiameterFrontUVs] (val x: Self) extends AnyVal {
    @scala.inline
