...
import typingsSlinky.babylonjs.fileToolsMod.RequestFileError
...
import typingsSlinky.babylonjs.keyboardEventsMod.KeyboardInfo
import typingsSlinky.babylonjs.keyboardEventsMod.KeyboardInfoPre
...
import typingsSlinky.babylonjs.pointerEventsMod.PointerEventTypes
import typingsSlinky.babylonjs.pointerEventsMod.PointerInfo
import typingsSlinky.babylonjs.pointerEventsMod.PointerInfoPre
import typingsSlinky.babylonjs.postProcessManagerMod.PostProcessManager
...
import typingsSlinky.babylonjs.sceneComponentMod.RenderingMeshStageAction
...
object sceneMod {
  ...
  class Scene protected ()
    ...
    def _loadFileAsync(url: String, onProgress: js.UndefOr[scala.Nothing], useOfflineSupport: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    def _loadFileAsync(
      url: String,
      onProgress: js.UndefOr[scala.Nothing],
      useOfflineSupport: Boolean,
    ...
    def _loadFileAsync(url: String, onProgress: js.Function1[/* data */ js.Any, Unit]): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    def _loadFileAsync(
      url: String,
    ...
    def _loadFileAsync(url: String, onProgress: js.Function1[/* data */ js.Any, Unit], useOfflineSupport: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    def _loadFileAsync(
      url: String,
      onProgress: js.Function1[/* data */ js.Any, Unit],
      useOfflineSupport: Boolean,
    ...
    def _readFileAsync(file: File, onProgress: js.UndefOr[scala.Nothing], useArrayBuffer: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    def _readFileAsync(file: File, onProgress: js.Function1[/* ev */ ProgressEvent, _]): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    def _readFileAsync(file: File, onProgress: js.Function1[/* ev */ ProgressEvent, _], useArrayBuffer: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    ...
    def _requestFileAsync(url: String, onProgress: js.UndefOr[scala.Nothing], useOfflineSupport: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
    def _requestFileAsync(
      url: String,
      onProgress: js.UndefOr[scala.Nothing],
      useOfflineSupport: Boolean,
