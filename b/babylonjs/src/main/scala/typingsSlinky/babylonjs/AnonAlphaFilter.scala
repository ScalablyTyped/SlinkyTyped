...
@js.native
trait AnonAlphaFilter extends js.Object {
...
object AnonAlphaFilter {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonAlphaFilter]
  }
  @scala.inline
  implicit class AnonAlphaFilterOps[Self <: AnonAlphaFilter] (val x: Self) extends AnyVal {
    @scala.inline
