...
object INavigationEnginePlugin {
  ...
  implicit class INavigationEnginePluginOps[Self <: INavigationEnginePlugin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBuildFromNavmeshData(value: js.typedarray.Uint8Array => Unit): Self = this.set("buildFromNavmeshData", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetNavmeshData(value: () => js.typedarray.Uint8Array): Self = this.set("getNavmeshData", js.Any.fromFunction0(value))
