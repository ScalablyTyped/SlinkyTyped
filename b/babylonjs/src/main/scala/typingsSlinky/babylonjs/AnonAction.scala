...
object AnonAction {
  @scala.inline
  def apply[T](action: T, component: ISceneComponent, index: Double): AnonAction[T] = {
  ...
  @scala.inline
  implicit class AnonActionOps[Self[t] <: AnonAction[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
