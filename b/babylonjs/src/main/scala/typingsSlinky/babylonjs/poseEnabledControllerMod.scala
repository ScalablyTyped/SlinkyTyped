...
object poseEnabledControllerMod {
  ...
  trait GamePadFactory extends StObject {
    ...
    /**
      ...
      */
    def create(gamepadInfo: js.Any): typingsSlinky.babylonjs.gamepadMod.Gamepad = js.native
  }
  object GamePadFactory {
    
    @scala.inline
    def apply(canCreate: js.Any => Boolean, create: js.Any => typingsSlinky.babylonjs.gamepadMod.Gamepad): GamePadFactory = {
    ...
    implicit class GamePadFactoryMutableBuilder[Self <: GamePadFactory] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreate(value: js.Any => typingsSlinky.babylonjs.gamepadMod.Gamepad): Self = StObject.set(x, "create", js.Any.fromFunction1(value))
    }
  }
