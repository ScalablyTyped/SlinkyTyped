...
@js.native
trait AnonRootNodeNameString extends js.Object {
  var rootNodeName: String = js.native
}

object AnonRootNodeNameString {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonRootNodeNameStringOps[Self <: AnonRootNodeNameString] (val x: Self) extends AnyVal {
    @scala.inline
