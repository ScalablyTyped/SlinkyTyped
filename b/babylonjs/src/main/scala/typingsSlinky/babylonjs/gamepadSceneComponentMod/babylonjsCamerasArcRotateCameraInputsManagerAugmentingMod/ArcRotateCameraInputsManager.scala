package typingsSlinky.babylonjs.gamepadSceneComponentMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod
...
object ArcRotateCameraInputsManager {
  ...
  implicit class ArcRotateCameraInputsManagerOps[Self <: ArcRotateCameraInputsManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddGamepad(value: () => ArcRotateCameraInputsManager): Self = {
