...
object boundingBoxRendererMod {
  ...
  object babylonjsMeshesAbstractMeshAugmentingMod {
    ...
    object AbstractMesh {
      ...
      @scala.inline
      def apply(_showBoundingBox: Boolean, showBoundingBox: Boolean): typingsSlinky.babylonjs.boundingBoxRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.boundingBoxRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh]
      }
      
      @scala.inline
      implicit class AbstractMeshMutableBuilder[Self <: typingsSlinky.babylonjs.boundingBoxRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh] (val x: Self) extends AnyVal {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      def apply(
      ...
      ): typingsSlinky.babylonjs.boundingBoxRendererMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.boundingBoxRendererMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.boundingBoxRendererMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
