...
@js.native
trait AnonDragAxisDragPlaneNormal extends js.Object {
  var dragAxis: js.UndefOr[Vector3] = js.native
  var dragPlaneNormal: js.UndefOr[Vector3] = js.native
}

object AnonDragAxisDragPlaneNormal {
  @scala.inline
  def apply(): AnonDragAxisDragPlaneNormal = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDragAxisDragPlaneNormal]
  }
  @scala.inline
  implicit class AnonDragAxisDragPlaneNormalOps[Self <: AnonDragAxisDragPlaneNormal] (val x: Self) extends AnyVal {
    @scala.inline
