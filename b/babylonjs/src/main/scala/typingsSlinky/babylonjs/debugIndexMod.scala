...
object debugIndexMod {
  ...
  object DebugLayerTab extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.babylonjs.debugLayerMod.DebugLayerTab with Double] = js.native
    
    /* 1 */ val Debug: typingsSlinky.babylonjs.debugLayerMod.DebugLayerTab.Debug with Double = js.native
    
    /* 0 */ val Properties: typingsSlinky.babylonjs.debugLayerMod.DebugLayerTab.Properties with Double = js.native
    
    /* 4 */ val Settings: typingsSlinky.babylonjs.debugLayerMod.DebugLayerTab.Settings with Double = js.native
    
    /* 2 */ val Statistics: typingsSlinky.babylonjs.debugLayerMod.DebugLayerTab.Statistics with Double = js.native
    
    /* 3 */ val Tools: typingsSlinky.babylonjs.debugLayerMod.DebugLayerTab.Tools with Double = js.native
  }
  
  @JSImport("babylonjs/Debug/index", "PhysicsViewer")
  @js.native
  class PhysicsViewer protected ()
    extends typingsSlinky.babylonjs.physicsViewerMod.PhysicsViewer {
    /**
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      def apply(
        _debugLayer: typingsSlinky.babylonjs.debugLayerMod.DebugLayer,
        debugLayer: typingsSlinky.babylonjs.debugLayerMod.DebugLayer
      ): typingsSlinky.babylonjs.debugIndexMod.babylonjsSceneAugmentingMod.Scene = {
        val __obj = js.Dynamic.literal(_debugLayer = _debugLayer.asInstanceOf[js.Any], debugLayer = debugLayer.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.babylonjs.debugIndexMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.debugIndexMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setDebugLayer(value: typingsSlinky.babylonjs.debugLayerMod.DebugLayer): Self = StObject.set(x, "debugLayer", value.asInstanceOf[js.Any])
        
        @scala.inline
        def set_debugLayer(value: typingsSlinky.babylonjs.debugLayerMod.DebugLayer): Self = StObject.set(x, "_debugLayer", value.asInstanceOf[js.Any])
      }
    }
  }
}
