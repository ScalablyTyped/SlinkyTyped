...
object spritesIndexMod {
  ...
  class SpriteManager protected ()
    extends typingsSlinky.babylonjs.spriteManagerMod.SpriteManager {
    /**
  ...
  object SpriteManager {
    ...
    @js.native
    def CreateFromSnippetAsync(snippetId: String, scene: Scene): js.Promise[typingsSlinky.babylonjs.spriteManagerMod.SpriteManager] = js.native
    @JSImport("babylonjs/Sprites/index", "SpriteManager.CreateFromSnippetAsync")
    @js.native
    def CreateFromSnippetAsync(snippetId: String, scene: Scene, rootUrl: String): js.Promise[typingsSlinky.babylonjs.spriteManagerMod.SpriteManager] = js.native
    ...
    @js.native
    def Parse(parsedManager: js.Any, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.spriteManagerMod.SpriteManager = js.native
    ...
    @js.native
    def ParseFromFileAsync(name: Nullable[String], url: String, scene: Scene): js.Promise[typingsSlinky.babylonjs.spriteManagerMod.SpriteManager] = js.native
    @JSImport("babylonjs/Sprites/index", "SpriteManager.ParseFromFileAsync")
    @js.native
    def ParseFromFileAsync(name: Nullable[String], url: String, scene: Scene, rootUrl: String): js.Promise[typingsSlinky.babylonjs.spriteManagerMod.SpriteManager] = js.native
  ...
  class SpriteSceneComponent protected ()
    extends typingsSlinky.babylonjs.spriteSceneComponentMod.SpriteSceneComponent {
    /**
