...
object debugLayerMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      def apply(_debugLayer: DebugLayer, debugLayer: DebugLayer): typingsSlinky.babylonjs.debugLayerMod.babylonjsSceneAugmentingMod.Scene = {
        val __obj = js.Dynamic.literal(_debugLayer = _debugLayer.asInstanceOf[js.Any], debugLayer = debugLayer.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.babylonjs.debugLayerMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.debugLayerMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
