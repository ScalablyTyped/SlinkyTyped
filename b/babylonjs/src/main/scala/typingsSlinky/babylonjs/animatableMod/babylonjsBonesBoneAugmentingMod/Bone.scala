package typingsSlinky.babylonjs.animatableMod.babylonjsBonesBoneAugmentingMod
...
object Bone {
  ...
  implicit class BoneOps[Self <: Bone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCopyAnimationRange(value: (Bone, String, Double, Boolean, Nullable[Vector3]) => Boolean): Self = {
