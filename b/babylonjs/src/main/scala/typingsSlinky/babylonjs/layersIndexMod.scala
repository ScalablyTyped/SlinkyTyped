...
object layersIndexMod {
  ...
  abstract class EffectLayer protected ()
    extends typingsSlinky.babylonjs.effectLayerMod.EffectLayer {
    /**
  ...
  object EffectLayer {
    ...
    @js.native
    def Parse(parsedEffectLayer: js.Any, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.effectLayerMod.EffectLayer = js.native
  ...
  class EffectLayerSceneComponent protected ()
    extends typingsSlinky.babylonjs.effectLayerSceneComponentMod.EffectLayerSceneComponent {
    /**
  ...
  class GlowLayer protected ()
    extends typingsSlinky.babylonjs.glowLayerMod.GlowLayer {
    /**
  ...
  object GlowLayer {
    ...
    @js.native
    def Parse(parsedGlowLayer: js.Any, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.glowLayerMod.GlowLayer = js.native
  }
  ...
  class LayerSceneComponent protected ()
    extends typingsSlinky.babylonjs.layerSceneComponentMod.LayerSceneComponent {
    /**
      * Creates a new instance of the component for the given scene
      * @param scene Defines the scene to register the component in
      */
