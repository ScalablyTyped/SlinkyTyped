...
class BoundingBoxRenderer protected ()
  extends typingsSlinky.babylonjs.BABYLON.BoundingBoxRenderer {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var backColor: typingsSlinky.babylonjs.BABYLON.Color3 = js.native
  /**
    * Color of the bounding box lines placed in front of an object
    */
  /* CompleteClass */
  override var frontColor: typingsSlinky.babylonjs.BABYLON.Color3 = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var renderList: typingsSlinky.babylonjs.BABYLON.SmartArray[typingsSlinky.babylonjs.BABYLON.BoundingBox] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def renderOcclusionBoundingBox(mesh: typingsSlinky.babylonjs.BABYLON.AbstractMesh): Unit = js.native
  /**
    * @hidden
    */
  /* CompleteClass */
