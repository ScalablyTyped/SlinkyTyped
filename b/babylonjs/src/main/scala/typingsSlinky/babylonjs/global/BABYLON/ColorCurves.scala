...
@js.native
class ColorCurves ()
  extends typingsSlinky.babylonjs.BABYLON.ColorCurves
...
object ColorCurves extends js.Object {
  ...
  /**
    ...
    */
  def Bind(
    colorCurves: typingsSlinky.babylonjs.BABYLON.ColorCurves,
  ...
  /**
    ...
    */
  def Parse(source: js.Any): typingsSlinky.babylonjs.BABYLON.ColorCurves = js.native
  /**
