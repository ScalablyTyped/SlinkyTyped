...
class UtilityLayerRenderer protected ()
  extends typingsSlinky.babylonjs.BABYLON.UtilityLayerRenderer {
  /**
  ...
  originalScene: typingsSlinky.babylonjs.BABYLON.Scene) = this()
  def this(
...
object UtilityLayerRenderer extends js.Object {
  ...
  /**
    ...
    */
  def DefaultKeepDepthUtilityLayer: typingsSlinky.babylonjs.BABYLON.UtilityLayerRenderer = js.native
  /**
    * A shared utility layer that can be used to overlay objects into a scene (Depth map of the previous scene is cleared before drawing on top of it)
    */
  def DefaultUtilityLayer: typingsSlinky.babylonjs.BABYLON.UtilityLayerRenderer = js.native
}
