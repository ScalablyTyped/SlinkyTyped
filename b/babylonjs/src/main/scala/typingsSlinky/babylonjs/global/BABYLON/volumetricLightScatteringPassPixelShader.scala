...
object volumetricLightScatteringPassPixelShader {
  ...
  @JSGlobal("BABYLON.volumetricLightScatteringPassPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.volumetricLightScatteringPassPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.volumetricLightScatteringPassPixelShader.shader")
  @js.native
