...
class LineEdgesRenderer protected ()
  extends typingsSlinky.babylonjs.BABYLON.LineEdgesRenderer {
  /**
  ...
  /* CompleteClass */
  override var _buffers: org.scalablytyped.runtime.StringDictionary[Nullable[typingsSlinky.babylonjs.BABYLON.VertexBuffer]] = js.native
  /* CompleteClass */
  override var _checkVerticesInsteadOfIndices: Boolean = js.native
  /* CompleteClass */
  override var _epsilon: Double = js.native
  /* CompleteClass */
  override var _ib: typingsSlinky.babylonjs.BABYLON.DataBuffer = js.native
  /* CompleteClass */
  override var _indicesCount: Double = js.native
  /* CompleteClass */
  override var _lineShader: typingsSlinky.babylonjs.BABYLON.ShaderMaterial = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var _source: typingsSlinky.babylonjs.BABYLON.AbstractMesh = js.native
  /**
  ...
  /* protected */ override def _checkEdge(
    faceIndex: Double,
    edge: Double,
    faceNormals: js.Array[typingsSlinky.babylonjs.BABYLON.Vector3],
  ...
  /* protected */ override def _processEdgeForAdjacenciesWithVertices(
    pa: typingsSlinky.babylonjs.BABYLON.Vector3,
    pb: typingsSlinky.babylonjs.BABYLON.Vector3,
    p0: typingsSlinky.babylonjs.BABYLON.Vector3,
    p1: typingsSlinky.babylonjs.BABYLON.Vector3,
  ...
  /**
    ...
    */
  /* CompleteClass */
  /* protected */ override def createLine(
    p0: typingsSlinky.babylonjs.BABYLON.Vector3,
    p1: typingsSlinky.babylonjs.BABYLON.Vector3,
    offset: Double
  ): Unit = js.native
