...
@js.native
class TorusBuilder ()
  extends typingsSlinky.babylonjs.BABYLON.TorusBuilder
/* static members */
object TorusBuilder {
  ...
  @js.native
  def CreateTorus(name: String, options: DiameterFrontUVs, scene: js.Any): typingsSlinky.babylonjs.BABYLON.Mesh = js.native
}
