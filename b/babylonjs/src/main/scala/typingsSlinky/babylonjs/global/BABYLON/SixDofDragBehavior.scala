...
class SixDofDragBehavior ()
  extends typingsSlinky.babylonjs.BABYLON.SixDofDragBehavior {
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var onDragEndObservable: typingsSlinky.babylonjs.BABYLON.Observable[js.Object] = js.native
  /**
    * Fires each time a drag starts
    */
  /* CompleteClass */
  override var onDragStartObservable: typingsSlinky.babylonjs.BABYLON.Observable[js.Object] = js.native
  /**
