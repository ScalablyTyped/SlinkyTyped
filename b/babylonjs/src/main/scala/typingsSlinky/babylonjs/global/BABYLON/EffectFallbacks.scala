...
class EffectFallbacks ()
  extends typingsSlinky.babylonjs.BABYLON.EffectFallbacks {
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addCPUSkinningFallback(rank: Double, mesh: typingsSlinky.babylonjs.BABYLON.AbstractMesh): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reduce(currentDefines: String, effect: typingsSlinky.babylonjs.BABYLON.Effect): String = js.native
  /**
