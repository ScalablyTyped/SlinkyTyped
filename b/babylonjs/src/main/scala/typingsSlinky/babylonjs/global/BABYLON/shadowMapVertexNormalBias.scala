...
object shadowMapVertexNormalBias {
  
  @JSGlobal("BABYLON.shadowMapVertexNormalBias")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.shadowMapVertexNormalBias.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.shadowMapVertexNormalBias.shader")
  @js.native
