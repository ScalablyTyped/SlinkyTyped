...
import typingsSlinky.babylonjs.BABYLON.IWebXRMotionControllerAxesValue
import typingsSlinky.babylonjs.BABYLON.IWebXRMotionControllerComponentChanges
...
class WebXRControllerComponent protected ()
  extends typingsSlinky.babylonjs.BABYLON.WebXRControllerComponent {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var onAxisValueChangedObservable: typingsSlinky.babylonjs.BABYLON.Observable[Y] = js.native
  /**
    * Observers registered here will be triggered when the state of a button changes
    * State change is either pressed / touched / value
    */
  /* CompleteClass */
  override var onButtonStateChangedObservable: typingsSlinky.babylonjs.BABYLON.Observable[typingsSlinky.babylonjs.BABYLON.WebXRControllerComponent] = js.native
  /**
    * the type of the component
    */
  /* CompleteClass */
