...
object shadowMapPixelShader {
  
  @JSGlobal("BABYLON.shadowMapPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.shadowMapPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.shadowMapPixelShader.shader")
  @js.native
