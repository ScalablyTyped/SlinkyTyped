...
class Material protected ()
  extends typingsSlinky.babylonjs.BABYLON.Material {
  /**
...
object Material extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedMaterial: js.Any, scene: typingsSlinky.babylonjs.BABYLON.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.BABYLON.Material] = js.native
