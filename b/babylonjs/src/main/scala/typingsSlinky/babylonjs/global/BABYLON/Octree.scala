...
class Octree[T] protected ()
  extends typingsSlinky.babylonjs.BABYLON.Octree[T] {
  /**
    * Creates a octree
    ...
    */
  def this(creationFunc: js.Function2[/* entry */ T, /* block */ typingsSlinky.babylonjs.BABYLON.OctreeBlock[T], Unit]) = this()
  def this(
