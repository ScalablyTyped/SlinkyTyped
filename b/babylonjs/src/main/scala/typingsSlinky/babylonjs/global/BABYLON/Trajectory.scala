...
/**
  ...
  */
class Trajectory ()
  extends typingsSlinky.babylonjs.BABYLON.Trajectory {
...
object Trajectory {
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.Trajectory.Deserialize")
  @js.native
  def Deserialize(json: String): typingsSlinky.babylonjs.BABYLON.Trajectory = js.native
