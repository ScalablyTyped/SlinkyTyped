...
class Observer[T] protected ()
  extends typingsSlinky.babylonjs.BABYLON.Observer[T] {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def callback(eventData: T, eventState: typingsSlinky.babylonjs.BABYLON.EventState): Unit = js.native
}
