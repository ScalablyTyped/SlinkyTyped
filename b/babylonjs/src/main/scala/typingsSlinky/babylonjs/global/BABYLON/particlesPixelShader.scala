...
object particlesPixelShader {
  
  @JSGlobal("BABYLON.particlesPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.particlesPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.particlesPixelShader.shader")
  @js.native
