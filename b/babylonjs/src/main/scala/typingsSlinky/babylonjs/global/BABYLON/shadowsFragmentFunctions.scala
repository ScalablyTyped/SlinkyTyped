...
object shadowsFragmentFunctions {
  
  @JSGlobal("BABYLON.shadowsFragmentFunctions")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.shadowsFragmentFunctions.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.shadowsFragmentFunctions.shader")
  @js.native
