...
class ReflectionProbe protected ()
  extends typingsSlinky.babylonjs.BABYLON.ReflectionProbe {
  /**
...
object ReflectionProbe extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedReflectionProbe: js.Any, scene: typingsSlinky.babylonjs.BABYLON.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.BABYLON.ReflectionProbe] = js.native
}
