...
class MultiRenderTarget protected ()
  extends typingsSlinky.babylonjs.BABYLON.MultiRenderTarget {
  /**
    ...
    */
  def this(name: String, size: js.Any, count: Double, scene: typingsSlinky.babylonjs.BABYLON.Scene) = this()
  def this(
    name: String,
    size: js.Any,
    count: Double,
