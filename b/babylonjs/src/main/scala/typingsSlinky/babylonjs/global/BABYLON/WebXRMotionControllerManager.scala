...
import typingsSlinky.babylonjs.BABYLON.MotionControllerConstructor
...
class WebXRMotionControllerManager ()
  extends typingsSlinky.babylonjs.BABYLON.WebXRMotionControllerManager
/* static members */
object WebXRMotionControllerManager {
  ...
  @js.native
  def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typingsSlinky.babylonjs.BABYLON.Scene): js.Promise[typingsSlinky.babylonjs.BABYLON.WebXRAbstractMotionController] = js.native
  @JSGlobal("BABYLON.WebXRMotionControllerManager.GetMotionControllerWithXRInput")
  @js.native
  def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typingsSlinky.babylonjs.BABYLON.Scene, forceProfile: String): js.Promise[typingsSlinky.babylonjs.BABYLON.WebXRAbstractMotionController] = js.native
