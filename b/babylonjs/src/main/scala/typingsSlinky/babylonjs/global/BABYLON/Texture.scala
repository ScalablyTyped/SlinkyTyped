...
class Texture protected ()
  extends typingsSlinky.babylonjs.BABYLON.Texture {
  /**
  ...
  def this(
    ...
    sceneOrEngine: Nullable[
        typingsSlinky.babylonjs.BABYLON.Scene | typingsSlinky.babylonjs.BABYLON.ThinEngine
      ],
...
object Texture {
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.Texture.CreateFromBase64String")
  @js.native
  ...
  /**
    ...
    * @returns the created texture
    */
  @JSGlobal("BABYLON.Texture.LoadFromDataString")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.Texture.Parse")
  @js.native
  def Parse(parsedTexture: js.Any, scene: typingsSlinky.babylonjs.BABYLON.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.BABYLON.BaseTexture] = js.native
  ...
  /** @hidden */
  @JSGlobal("BABYLON.Texture._CreateMirror")
  @js.native
  def _CreateMirror(
    name: String,
  ...
  ): typingsSlinky.babylonjs.BABYLON.MirrorTexture = js.native
  
  /** @hidden */
  @JSGlobal("BABYLON.Texture._CreateRenderTargetTexture")
  @js.native
  def _CreateRenderTargetTexture(
    ...
    scene: typingsSlinky.babylonjs.BABYLON.Scene,
    generateMipMaps: Boolean
  ): typingsSlinky.babylonjs.BABYLON.RenderTargetTexture = js.native
  
  /** @hidden */
  @JSGlobal("BABYLON.Texture._CubeTextureParser")
  @js.native
  def _CubeTextureParser(jsonTexture: js.Any, scene: typingsSlinky.babylonjs.BABYLON.Scene, rootUrl: String): typingsSlinky.babylonjs.BABYLON.CubeTexture = js.native
}
