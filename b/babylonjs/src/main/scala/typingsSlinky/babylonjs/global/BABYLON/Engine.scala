...
import typingsSlinky.babylonjs.BABYLON.IAudioEngine
import typingsSlinky.babylonjs.BABYLON.ILoadingScreen
...
class Engine protected ()
  extends typingsSlinky.babylonjs.BABYLON.Engine {
  /**
...
object Engine extends js.Object {
  ...
  var _RescalePostProcessFactory: Nullable[
    js.Function1[/* engine */ this.type, typingsSlinky.babylonjs.BABYLON.PostProcess]
  ] = js.native
  /**
  ...
  def MarkAllMaterialsAsDirty(flag: Double, predicate: js.Function1[/* mat */ typingsSlinky.babylonjs.BABYLON.Material, Boolean]): Unit = js.native
  /**
