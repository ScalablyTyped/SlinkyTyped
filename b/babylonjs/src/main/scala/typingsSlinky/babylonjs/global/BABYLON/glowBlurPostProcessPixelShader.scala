...
object glowBlurPostProcessPixelShader {
  
  @JSGlobal("BABYLON.glowBlurPostProcessPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.glowBlurPostProcessPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.glowBlurPostProcessPixelShader.shader")
  @js.native
