...
class MorphTargetManager ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addTarget(target: typingsSlinky.babylonjs.BABYLON.MorphTarget): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getActiveTarget(index: Double): typingsSlinky.babylonjs.BABYLON.MorphTarget = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getTarget(index: Double): typingsSlinky.babylonjs.BABYLON.MorphTarget = js.native
  /**
    * Gets the list of influences (one per target)
    */
  /* CompleteClass */
  override def influences: js.typedarray.Float32Array = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeTarget(target: typingsSlinky.babylonjs.BABYLON.MorphTarget): Unit = js.native
  /**
