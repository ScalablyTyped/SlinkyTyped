...
class Layer protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var onAfterRenderObservable: typingsSlinky.babylonjs.BABYLON.Observable[typingsSlinky.babylonjs.BABYLON.Layer] = js.native
  /**
    * An event triggered before rendering the scene
    */
  /* CompleteClass */
  override var onBeforeRenderObservable: typingsSlinky.babylonjs.BABYLON.Observable[typingsSlinky.babylonjs.BABYLON.Layer] = js.native
  /**
    * An event triggered when the layer is disposed.
    */
  /* CompleteClass */
  override var onDisposeObservable: typingsSlinky.babylonjs.BABYLON.Observable[typingsSlinky.babylonjs.BABYLON.Layer] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var renderTargetTextures: js.Array[typingsSlinky.babylonjs.BABYLON.RenderTargetTexture] = js.native
  /**
