...
class FramingBehavior ()
  extends typingsSlinky.babylonjs.BABYLON.FramingBehavior
/* static members */
object FramingBehavior {
  ...
  @js.native
  def EasingFunction: typingsSlinky.babylonjs.BABYLON.ExponentialEase = js.native
  @scala.inline
  def EasingFunction_=(x: typingsSlinky.babylonjs.BABYLON.ExponentialEase): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EasingFunction")(x.asInstanceOf[js.Any])
