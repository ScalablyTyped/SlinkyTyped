...
class VRCameraMetrics ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def leftHMatrix: typingsSlinky.babylonjs.BABYLON.Matrix = js.native
  /**
    * @hidden
    */
  /* CompleteClass */
  override def leftPreViewMatrix: typingsSlinky.babylonjs.BABYLON.Matrix = js.native
  /**
    * @hidden
    */
  /* CompleteClass */
  override def rightHMatrix: typingsSlinky.babylonjs.BABYLON.Matrix = js.native
  /**
    * @hidden
    */
  /* CompleteClass */
  override def rightPreViewMatrix: typingsSlinky.babylonjs.BABYLON.Matrix = js.native
}
