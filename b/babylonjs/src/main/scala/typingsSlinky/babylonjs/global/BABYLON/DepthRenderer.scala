...
class DepthRenderer protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDepthMap(): typingsSlinky.babylonjs.BABYLON.RenderTargetTexture = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def isReady(subMesh: typingsSlinky.babylonjs.BABYLON.SubMesh, useInstances: Boolean): Boolean = js.native
}
