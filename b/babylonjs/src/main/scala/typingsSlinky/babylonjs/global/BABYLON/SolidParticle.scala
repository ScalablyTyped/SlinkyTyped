...
class SolidParticle protected ()
  extends typingsSlinky.babylonjs.BABYLON.SolidParticle {
  /**
  ...
  def this(
    ...
    indiceIndex: Double,
    model: Nullable[typingsSlinky.babylonjs.BABYLON.ModelShape],
    shapeId: Double,
    idxInShape: Double,
    sps: typingsSlinky.babylonjs.BABYLON.SolidParticleSystem
  ) = this()
  def this(
    particleIndex: Double,
    particleId: Double,
    ...
    idxInShape: Double,
    sps: typingsSlinky.babylonjs.BABYLON.SolidParticleSystem,
    modelBoundingInfo: Nullable[typingsSlinky.babylonjs.BABYLON.BoundingInfo]
  ) = this()
  def this(
    particleIndex: Double,
    particleId: Double,
    ...
    idxInShape: Double,
    sps: typingsSlinky.babylonjs.BABYLON.SolidParticleSystem,
    modelBoundingInfo: js.UndefOr[Nullable[typingsSlinky.babylonjs.BABYLON.BoundingInfo]],
