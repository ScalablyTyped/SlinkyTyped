...
import typingsSlinky.babylonjs.BABYLON.PhysicsImpostorParameters
...
class PhysicsImpostor protected ()
  extends typingsSlinky.babylonjs.BABYLON.PhysicsImpostor {
  /**
...
object PhysicsImpostor {
  ...
  @js.native
  def DEFAULT_OBJECT_SIZE: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  @scala.inline
  def DEFAULT_OBJECT_SIZE_=(x: typingsSlinky.babylonjs.BABYLON.Vector3): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DEFAULT_OBJECT_SIZE")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def IDENTITY_QUATERNION: typingsSlinky.babylonjs.BABYLON.Quaternion = js.native
  @scala.inline
  def IDENTITY_QUATERNION_=(x: typingsSlinky.babylonjs.BABYLON.Quaternion): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IDENTITY_QUATERNION")(x.asInstanceOf[js.Any])
