...
class CylinderDirectedParticleEmitter ()
  extends typingsSlinky.babylonjs.BABYLON.CylinderDirectedParticleEmitter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var direction1: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /**
    * The max limit of the emission direction.
    */
  /* CompleteClass */
  override var direction2: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /**
