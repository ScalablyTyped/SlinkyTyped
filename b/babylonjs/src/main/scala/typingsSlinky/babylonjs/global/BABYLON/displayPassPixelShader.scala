...
object displayPassPixelShader {
  
  @JSGlobal("BABYLON.displayPassPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.displayPassPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.displayPassPixelShader.shader")
  @js.native
