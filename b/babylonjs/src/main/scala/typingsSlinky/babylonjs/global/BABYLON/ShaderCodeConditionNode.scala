...
class ShaderCodeConditionNode ()
  extends typingsSlinky.babylonjs.BABYLON.ShaderCodeConditionNode {
  /* CompleteClass */
  override var children: js.Array[typingsSlinky.babylonjs.BABYLON.ShaderCodeNode] = js.native
  /* CompleteClass */
