...
object imageProcessingFunctions {
  
  @JSGlobal("BABYLON.imageProcessingFunctions")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.imageProcessingFunctions.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.imageProcessingFunctions.shader")
  @js.native
