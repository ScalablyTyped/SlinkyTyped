...
class BoxParticleEmitter ()
  extends typingsSlinky.babylonjs.BABYLON.BoxParticleEmitter {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var maxEmitBox: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /**
    * Minimum box point around our emitter. Our emitter is the center of particles source, but if you want your particles to emit from more than one point, then you can tell it to do so.
    */
  /* CompleteClass */
  override var minEmitBox: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /**
