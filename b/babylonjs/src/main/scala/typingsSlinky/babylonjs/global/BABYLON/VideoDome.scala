...
class VideoDome protected ()
  extends typingsSlinky.babylonjs.BABYLON.VideoDome {
  /**
    ...
    */
  def this(name: String, urlsOrVideo: String, options: AutoPlay, scene: typingsSlinky.babylonjs.BABYLON.Scene) = this()
  def this(
    name: String,
