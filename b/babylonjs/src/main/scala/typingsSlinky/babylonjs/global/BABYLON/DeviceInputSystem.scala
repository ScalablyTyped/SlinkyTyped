...
class DeviceInputSystem protected ()
  extends typingsSlinky.babylonjs.BABYLON.DeviceInputSystem
/* static members */
@JSGlobal("BABYLON.DeviceInputSystem")
@js.native
object DeviceInputSystem extends js.Object {
  ...
  /**
    ...
    */
  def Create(engine: typingsSlinky.babylonjs.BABYLON.Engine): typingsSlinky.babylonjs.BABYLON.DeviceInputSystem = js.native
