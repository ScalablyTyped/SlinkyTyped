...
/**
  ...
  */
class AudioEngine ()
  extends typingsSlinky.babylonjs.BABYLON.AudioEngine {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var onAudioLockedObservable: typingsSlinky.babylonjs.BABYLON.Observable[typingsSlinky.babylonjs.BABYLON.AudioEngine] = js.native
  /**
    * Event raised when audio has been unlocked on the browser.
    */
  /* CompleteClass */
  override var onAudioUnlockedObservable: typingsSlinky.babylonjs.BABYLON.Observable[typingsSlinky.babylonjs.BABYLON.AudioEngine] = js.native
  /**
