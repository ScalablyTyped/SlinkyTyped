...
@js.native
class SceneRecorder ()
  extends typingsSlinky.babylonjs.BABYLON.SceneRecorder
/* static members */
object SceneRecorder {
  ...
  @js.native
  def ApplyDelta(deltaJSON: String, scene: typingsSlinky.babylonjs.BABYLON.Scene): Unit = js.native
  /**
  ...
  @JSGlobal("BABYLON.SceneRecorder.ApplyDelta")
  @js.native
  def ApplyDelta(deltaJSON: js.Any, scene: typingsSlinky.babylonjs.BABYLON.Scene): Unit = js.native
