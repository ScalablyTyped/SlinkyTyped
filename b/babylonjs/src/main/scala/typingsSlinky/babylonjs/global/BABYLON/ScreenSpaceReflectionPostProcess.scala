...
class ScreenSpaceReflectionPostProcess protected ()
  extends typingsSlinky.babylonjs.BABYLON.ScreenSpaceReflectionPostProcess {
  /**
...
object ScreenSpaceReflectionPostProcess {
  ...
  /** @hidden */
  @JSGlobal("BABYLON.ScreenSpaceReflectionPostProcess._Parse")
  @js.native
  def _Parse(
    ...
    scene: typingsSlinky.babylonjs.BABYLON.Scene,
    rootUrl: String
  ): typingsSlinky.babylonjs.BABYLON.ScreenSpaceReflectionPostProcess = js.native
}
