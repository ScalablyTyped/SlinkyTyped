...
import typingsSlinky.babylonjs.BABYLON.IAnimatable
...
class SerializationHelper ()
  extends typingsSlinky.babylonjs.BABYLON.SerializationHelper
...
object SerializationHelper extends js.Object {
  ...
  /** @hidden */
  def _ColorCurvesParser(sourceProperty: js.Any): typingsSlinky.babylonjs.BABYLON.ColorCurves = js.native
  /** @hidden */
  def _FresnelParametersParser(sourceProperty: js.Any): typingsSlinky.babylonjs.BABYLON.FresnelParameters = js.native
  /** @hidden */
  def _ImageProcessingConfigurationParser(sourceProperty: js.Any): typingsSlinky.babylonjs.BABYLON.ImageProcessingConfiguration = js.native
  /** @hidden */
  def _TextureParser(sourceProperty: js.Any, scene: typingsSlinky.babylonjs.BABYLON.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.BABYLON.BaseTexture] = js.native
}
