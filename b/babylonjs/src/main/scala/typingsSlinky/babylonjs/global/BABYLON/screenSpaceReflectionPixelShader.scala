...
object screenSpaceReflectionPixelShader {
  ...
  @JSGlobal("BABYLON.screenSpaceReflectionPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.screenSpaceReflectionPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.screenSpaceReflectionPixelShader.shader")
  @js.native
