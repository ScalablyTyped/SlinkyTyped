...
class VirtualJoystick ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var deltaPosition: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setAxisForLeftRight(axis: typingsSlinky.babylonjs.BABYLON.JoystickAxis): Unit = js.native
  /**
    * Defines which axis you'd like to control for up & down
    * @param axis defines the axis to use
    */
  /* CompleteClass */
  override def setAxisForUpDown(axis: typingsSlinky.babylonjs.BABYLON.JoystickAxis): Unit = js.native
  /**
