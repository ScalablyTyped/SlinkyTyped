...
class WebXRHand protected ()
  extends typingsSlinky.babylonjs.BABYLON.WebXRHand {
  /**
  ...
  xrController: typingsSlinky.babylonjs.BABYLON.WebXRInputSource,
    /** the meshes to be used to track the hand joints */
  trackedMeshes: js.Array[typingsSlinky.babylonjs.BABYLON.AbstractMesh]
  ) = this()
  def this(
    /** the controller to which the hand correlates */
  xrController: typingsSlinky.babylonjs.BABYLON.WebXRInputSource,
    /** the meshes to be used to track the hand joints */
  trackedMeshes: js.Array[typingsSlinky.babylonjs.BABYLON.AbstractMesh],
    _handMesh: typingsSlinky.babylonjs.BABYLON.AbstractMesh
  ) = this()
  def this(
    /** the controller to which the hand correlates */
  xrController: typingsSlinky.babylonjs.BABYLON.WebXRInputSource,
