...
object instancesDeclaration {
  
  @JSGlobal("BABYLON.instancesDeclaration")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.instancesDeclaration.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.instancesDeclaration.shader")
  @js.native
