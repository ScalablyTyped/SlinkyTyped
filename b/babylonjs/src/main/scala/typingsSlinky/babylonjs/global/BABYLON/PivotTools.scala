...
@js.native
class PivotTools ()
  extends typingsSlinky.babylonjs.BABYLON.PivotTools
/* static members */
object PivotTools {
  ...
  /** @hidden */
  @JSGlobal("BABYLON.PivotTools._RemoveAndStorePivotPoint")
  @js.native
  def _RemoveAndStorePivotPoint(mesh: typingsSlinky.babylonjs.BABYLON.AbstractMesh): Unit = js.native
  
  /** @hidden */
  @JSGlobal("BABYLON.PivotTools._RestorePivotPoint")
  @js.native
  def _RestorePivotPoint(mesh: typingsSlinky.babylonjs.BABYLON.AbstractMesh): Unit = js.native
}
