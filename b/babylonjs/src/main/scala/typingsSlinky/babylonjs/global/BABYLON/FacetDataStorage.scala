...
import typingsSlinky.babylonjs.BABYLON.IndicesArray
...
class FacetDataStorage ()
  extends typingsSlinky.babylonjs.BABYLON.FacetDataStorage {
  /* CompleteClass */
  override var bbSize: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var facetDepthSortFrom: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /* CompleteClass */
  override var facetDepthSortOrigin: typingsSlinky.babylonjs.BABYLON.Vector3 = js.native
  /* CompleteClass */
  override var facetNb: Double = js.native
  /* CompleteClass */
  override var facetNormals: js.Array[typingsSlinky.babylonjs.BABYLON.Vector3] = js.native
  /* CompleteClass */
  override var facetParameters: js.Any = js.native
  /* CompleteClass */
  override var facetPartitioning: js.Array[js.Array[Double]] = js.native
  /* CompleteClass */
  override var facetPositions: js.Array[typingsSlinky.babylonjs.BABYLON.Vector3] = js.native
  /* CompleteClass */
  override var invertedMatrix: typingsSlinky.babylonjs.BABYLON.Matrix = js.native
  /* CompleteClass */
