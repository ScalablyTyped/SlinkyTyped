...
object PoseEnabledControllerHelper {
  ...
  @js.native
  def _DefaultControllerFactory: Nullable[js.Function1[/* gamepadInfo */ js.Any, typingsSlinky.babylonjs.BABYLON.Gamepad]] = js.native
  @scala.inline
  def _DefaultControllerFactory_=(x: Nullable[js.Function1[/* gamepadInfo */ js.Any, typingsSlinky.babylonjs.BABYLON.Gamepad]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("_DefaultControllerFactory")(x.asInstanceOf[js.Any])
}
