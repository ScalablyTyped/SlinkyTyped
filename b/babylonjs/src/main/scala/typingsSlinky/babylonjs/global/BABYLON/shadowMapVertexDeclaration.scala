...
object shadowMapVertexDeclaration {
  
  @JSGlobal("BABYLON.shadowMapVertexDeclaration")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.shadowMapVertexDeclaration.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.shadowMapVertexDeclaration.shader")
  @js.native
