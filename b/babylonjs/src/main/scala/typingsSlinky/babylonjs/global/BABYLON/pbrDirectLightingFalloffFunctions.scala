...
object pbrDirectLightingFalloffFunctions {
  
  @JSGlobal("BABYLON.pbrDirectLightingFalloffFunctions")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrDirectLightingFalloffFunctions.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrDirectLightingFalloffFunctions.shader")
  @js.native
