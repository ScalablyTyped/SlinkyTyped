...
/**
  ...
  */
class Color3 ()
  extends typingsSlinky.babylonjs.BABYLON.Color3 {
  def this(/**
...
object Color3 {
  ...
  @js.native
  def Lerp(
    start: DeepImmutable[typingsSlinky.babylonjs.BABYLON.Color3],
  ...
  @js.native
  def LerpToRef(
    left: DeepImmutable[typingsSlinky.babylonjs.BABYLON.Color3],
    right: DeepImmutable[typingsSlinky.babylonjs.BABYLON.Color3],
    amount: Double,
    result: typingsSlinky.babylonjs.BABYLON.Color3
  ): Unit = js.native
