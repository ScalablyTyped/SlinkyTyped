...
@js.native
trait AnonDepthFaceColors extends js.Object {
...
object AnonDepthFaceColors {
  @scala.inline
  def apply(): AnonDepthFaceColors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDepthFaceColors]
  }
  @scala.inline
  implicit class AnonDepthFaceColorsOps[Self <: AnonDepthFaceColors] (val x: Self) extends AnyVal {
    @scala.inline
