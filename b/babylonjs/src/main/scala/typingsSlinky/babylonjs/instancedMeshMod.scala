...
object instancedMeshMod {
  ...
  object babylonjsMeshesAbstractMeshAugmentingMod {
    ...
    object AbstractMesh {
      ...
      @scala.inline
      def apply(instancedBuffers: StringDictionary[js.Any]): typingsSlinky.babylonjs.instancedMeshMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh = {
        val __obj = js.Dynamic.literal(instancedBuffers = instancedBuffers.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.babylonjs.instancedMeshMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh]
      }
      
      @scala.inline
      implicit class AbstractMeshMutableBuilder[Self <: typingsSlinky.babylonjs.instancedMeshMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh] (val x: Self) extends AnyVal {
  ...
  object babylonjsMeshesMeshAugmentingMod {
    ...
    object Mesh {
      ...
      def apply(
      ...
      ): typingsSlinky.babylonjs.instancedMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.instancedMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh]
      }
      
      @scala.inline
      implicit class MeshMutableBuilder[Self <: typingsSlinky.babylonjs.instancedMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh] (val x: Self) extends AnyVal {
