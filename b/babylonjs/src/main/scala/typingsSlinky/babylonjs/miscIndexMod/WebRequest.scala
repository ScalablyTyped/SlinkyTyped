...
@js.native
class WebRequest ()
  extends typingsSlinky.babylonjs.webRequestMod.WebRequest
/* static members */
object WebRequest {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Misc/index", "WebRequest.CustomRequestHeaders")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Misc/index", "WebRequest.CustomRequestModifiers")
  @js.native
