...
@js.native
class DDSTools ()
  extends typingsSlinky.babylonjs.ddsMod.DDSTools
/* static members */
object DDSTools {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Misc/index", "DDSTools.GetDDSInfo")
  @js.native
  ...
  /**
    ...
    * @hidden
    */
  @JSImport("babylonjs/Misc/index", "DDSTools.UploadDDSLevels")
  @js.native
  def UploadDDSLevels(
    engine: ThinEngine,
  ...
  @JSImport("babylonjs/Misc/index", "DDSTools._FloatView")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "DDSTools._FromHalfFloat")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "DDSTools._Int32View")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "DDSTools._ToHalfFloat")
  @js.native
