...
@JSImport("babylonjs/Misc/index", "TGATools")
@js.native
class TGATools ()
  extends typingsSlinky.babylonjs.tgaMod.TGATools
/* static members */
object TGATools {
  ...
  /**
    ...
    * @returns the header
    */
  @JSImport("babylonjs/Misc/index", "TGATools.GetTGAHeader")
  @js.native
  ...
  /**
    ...
    * @hidden
    */
  @JSImport("babylonjs/Misc/index", "TGATools.UploadContent")
  @js.native
  def UploadContent(texture: InternalTexture, data: js.typedarray.Uint8Array): Unit = js.native
  
  @JSImport("babylonjs/Misc/index", "TGATools._ORIGIN_BL")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._ORIGIN_BR")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._ORIGIN_MASK")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._ORIGIN_SHIFT")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._ORIGIN_UL")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._ORIGIN_UR")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._TYPE_GREY")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._TYPE_INDEXED")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._TYPE_RGB")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._TYPE_RLE_GREY")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._TYPE_RLE_INDEXED")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "TGATools._TYPE_RLE_RGB")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Misc/index", "TGATools._getImageData16bits")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Misc/index", "TGATools._getImageData24bits")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Misc/index", "TGATools._getImageData32bits")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Misc/index", "TGATools._getImageData8bits")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Misc/index", "TGATools._getImageDataGrey16bits")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Misc/index", "TGATools._getImageDataGrey8bits")
  @js.native
