...
import typingsSlinky.babylonjs.customAnimationFrameRequesterMod.ICustomAnimationFrameRequester
...
import typingsSlinky.babylonjs.engineViewsMod.EngineView
...
import typingsSlinky.babylonjs.performanceMonitorMod.PerformanceMonitor
...
object engineMod {
  ...
  class Engine protected () extends ThinEngine {
    ...
    def _loadFileAsync(url: String, offlineProvider: js.UndefOr[scala.Nothing], useArrayBuffer: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
