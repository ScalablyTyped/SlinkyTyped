...
object cullingIndexMod {
  ...
  class BoundingBox protected ()
    extends typingsSlinky.babylonjs.boundingBoxMod.BoundingBox {
    /**
  ...
  class Octree[T] protected ()
    extends typingsSlinky.babylonjs.octreesIndexMod.Octree[T] {
    /**
      * Creates a octree
  ...
  class OctreeBlock[T] protected ()
    extends typingsSlinky.babylonjs.octreesIndexMod.OctreeBlock[T] {
    /**
      * Creates a new block
  ...
  class OctreeSceneComponent protected ()
    extends typingsSlinky.babylonjs.octreesIndexMod.OctreeSceneComponent {
    /**
  ...
  object Ray {
    ...
    @js.native
    def CreateNewFromTo(origin: Vector3, end: Vector3): typingsSlinky.babylonjs.rayMod.Ray = js.native
    @JSImport("babylonjs/Culling/index", "Ray.CreateNewFromTo")
    @js.native
    def CreateNewFromTo(origin: Vector3, end: Vector3, world: DeepImmutable[Matrix]): typingsSlinky.babylonjs.rayMod.Ray = js.native
