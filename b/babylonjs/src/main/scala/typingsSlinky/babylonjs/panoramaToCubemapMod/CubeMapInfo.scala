...
object CubeMapInfo {
  ...
  implicit class CubeMapInfoOps[Self <: CubeMapInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBack(value: Nullable[js.typedarray.ArrayBufferView]): Self = this.set("back", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBackNull: Self = this.set("back", null)
    
    @scala.inline
    def setDown(value: Nullable[js.typedarray.ArrayBufferView]): Self = this.set("down", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDownNull: Self = this.set("down", null)
    
    @scala.inline
    def setFront(value: Nullable[js.typedarray.ArrayBufferView]): Self = this.set("front", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFrontNull: Self = this.set("front", null)
    
    @scala.inline
    def setLeft(value: Nullable[js.typedarray.ArrayBufferView]): Self = this.set("left", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeftNull: Self = this.set("left", null)
    
    @scala.inline
    def setRight(value: Nullable[js.typedarray.ArrayBufferView]): Self = this.set("right", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRightNull: Self = this.set("right", null)
    
    @scala.inline
    def setUp(value: Nullable[js.typedarray.ArrayBufferView]): Self = this.set("up", value.asInstanceOf[js.Any])
