...
import typingsSlinky.babylonjs.BABYLON.Material
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonDisableLighting extends js.Object {
  /**
...
object AnonDisableLighting {
  @scala.inline
  def apply(): AnonDisableLighting = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDisableLighting]
  }
  @scala.inline
  implicit class AnonDisableLightingOps[Self <: AnonDisableLighting] (val x: Self) extends AnyVal {
    @scala.inline
