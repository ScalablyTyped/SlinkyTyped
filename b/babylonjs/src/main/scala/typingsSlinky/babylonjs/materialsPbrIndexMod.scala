...
object materialsPbrIndexMod extends js.Object {
  ...
  abstract class PBRBaseMaterial protected ()
    extends typingsSlinky.babylonjs.pbrBaseMaterialMod.PBRBaseMaterial {
    /**
  ...
  abstract class PBRBaseSimpleMaterial protected ()
    extends typingsSlinky.babylonjs.pbrBaseSimpleMaterialMod.PBRBaseSimpleMaterial {
    /**
      * Instantiates a new PBRMaterial instance.
      *
      * @param name The material name
  ...
  class PBRMaterial protected ()
    extends typingsSlinky.babylonjs.pbrMaterialMod.PBRMaterial {
    /**
      * Instantiates a new PBRMaterial instance.
      *
      * @param name The material name
  ...
  object PBRMaterial extends js.Object {
    ...
    /**
      ...
      * @returns - PBRMaterial
      */
    def Parse(source: js.Any, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.pbrMaterialMod.PBRMaterial = js.native
  }
  ...
  class PBRMaterialDefines ()
    extends typingsSlinky.babylonjs.pbrBaseMaterialMod.PBRMaterialDefines
  
  @js.native
  class PBRMetallicRoughnessMaterial protected ()
    extends typingsSlinky.babylonjs.pbrMetallicRoughnessMaterialMod.PBRMetallicRoughnessMaterial {
    /**
  ...
  class PBRSpecularGlossinessMaterial protected ()
    extends typingsSlinky.babylonjs.pbrSpecularGlossinessMaterialMod.PBRSpecularGlossinessMaterial {
    /**
