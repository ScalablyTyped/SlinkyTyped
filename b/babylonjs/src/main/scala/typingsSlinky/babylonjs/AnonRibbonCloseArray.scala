...
object AnonRibbonCloseArray {
  @scala.inline
  def apply(path: js.Array[Vector3], shape: js.Array[Vector3]): AnonRibbonCloseArray = {
  ...
  @scala.inline
  implicit class AnonRibbonCloseArrayOps[Self <: AnonRibbonCloseArray] (val x: Self) extends AnyVal {
    @scala.inline
