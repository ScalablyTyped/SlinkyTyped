...
@js.native
trait AnonDiameterY extends js.Object {
...
object AnonDiameterY {
  @scala.inline
  def apply(): AnonDiameterY = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDiameterY]
  }
  @scala.inline
  implicit class AnonDiameterYOps[Self <: AnonDiameterY] (val x: Self) extends AnyVal {
    @scala.inline
