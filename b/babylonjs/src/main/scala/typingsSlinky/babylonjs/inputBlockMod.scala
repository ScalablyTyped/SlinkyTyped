...
import typingsSlinky.babylonjs.animatedInputBlockTypesMod.AnimatedInputBlockTypes
...
import typingsSlinky.babylonjs.nodeMaterialSystemValuesMod.NodeMaterialSystemValues
