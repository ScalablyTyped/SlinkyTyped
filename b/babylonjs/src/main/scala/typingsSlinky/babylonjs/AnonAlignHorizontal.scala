...
@js.native
trait AnonAlignHorizontal extends js.Object {
...
object AnonAlignHorizontal {
  @scala.inline
  def apply(): AnonAlignHorizontal = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAlignHorizontal]
  }
  @scala.inline
  implicit class AnonAlignHorizontalOps[Self <: AnonAlignHorizontal] (val x: Self) extends AnyVal {
    @scala.inline
