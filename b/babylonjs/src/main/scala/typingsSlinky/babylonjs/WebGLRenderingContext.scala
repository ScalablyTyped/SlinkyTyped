...
trait WebGLRenderingContext extends StObject {
  ...
  def clearBufferfv(buffer: Double, drawbuffer: Double, values: js.typedarray.ArrayBufferView): Unit = js.native
  def clearBufferfv(buffer: Double, drawbuffer: Double, values: js.typedarray.ArrayBufferView, srcOffset: Double): Unit = js.native
  
  def clearBufferiv(buffer: Double, drawbuffer: Double, values: js.typedarray.ArrayBufferView): Unit = js.native
  def clearBufferiv(buffer: Double, drawbuffer: Double, values: js.typedarray.ArrayBufferView, srcOffset: Double): Unit = js.native
  
  def clearBufferuiv(buffer: Double, drawbuffer: Double, values: js.typedarray.ArrayBufferView): Unit = js.native
  def clearBufferuiv(buffer: Double, drawbuffer: Double, values: js.typedarray.ArrayBufferView, srcOffset: Double): Unit = js.native
