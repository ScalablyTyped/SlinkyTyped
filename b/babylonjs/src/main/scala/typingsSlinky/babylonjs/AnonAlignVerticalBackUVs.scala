...
@js.native
trait AnonAlignVerticalBackUVs extends js.Object {
...
object AnonAlignVerticalBackUVs {
  @scala.inline
  def apply(): AnonAlignVerticalBackUVs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAlignVerticalBackUVs]
  }
  @scala.inline
  implicit class AnonAlignVerticalBackUVsOps[Self <: AnonAlignVerticalBackUVs] (val x: Self) extends AnyVal {
    @scala.inline
