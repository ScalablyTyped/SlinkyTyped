...
@js.native
trait AnonGapSizeInstance extends js.Object {
...
object AnonGapSizeInstance {
  @scala.inline
  def apply(points: js.Array[Vector3]): AnonGapSizeInstance = {
    val __obj = js.Dynamic.literal(points = points.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonGapSizeInstance]
  }
  @scala.inline
  implicit class AnonGapSizeInstanceOps[Self <: AnonGapSizeInstance] (val x: Self) extends AnyVal {
    @scala.inline
