...
object meshSimplificationSceneComponentMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      def apply(_simplificationQueue: SimplificationQueue, simplificationQueue: SimplificationQueue): typingsSlinky.babylonjs.meshSimplificationSceneComponentMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.meshSimplificationSceneComponentMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.meshSimplificationSceneComponentMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
