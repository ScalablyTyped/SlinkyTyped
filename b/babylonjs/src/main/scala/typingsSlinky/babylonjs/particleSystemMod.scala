...
object particleSystemMod {
  ...
  - typingsSlinky.babylonjs.animatableInterfaceMod.IAnimatable because var conflicts: animations. Inlined  */ @JSImport("babylonjs/Particles/particleSystem", "ParticleSystem")
  @js.native
