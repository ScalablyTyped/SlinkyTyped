...
import typingsSlinky.babylonjs.BABYLON.MotionControllerComponentStateType
...
@js.native
trait AnonMinNodeName extends js.Object {
  /**
...
object AnonMinNodeName {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonMinNodeName]
  }
  @scala.inline
  implicit class AnonMinNodeNameOps[Self <: AnonMinNodeName] (val x: Self) extends AnyVal {
    @scala.inline
