...
abstract class EffectLayer protected ()
  extends typingsSlinky.babylonjs.layersIndexMod.EffectLayer {
  /**
...
object EffectLayer {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "EffectLayer.Parse")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/index", "EffectLayer._SceneComponentInitialization")
  @js.native
