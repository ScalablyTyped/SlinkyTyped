...
class BoundingBox protected ()
  extends typingsSlinky.babylonjs.cullingIndexMod.BoundingBox {
  /**
...
object BoundingBox {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "BoundingBox.Intersects")
  @js.native
  def Intersects(
  ...
  /**
    ...
    * @returns true if there is an intersection
    */
  @JSImport("babylonjs/index", "BoundingBox.IntersectsSphere")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "BoundingBox.IsCompletelyInFrustum")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "BoundingBox.IsInFrustum")
  @js.native
  def IsInFrustum(
    boundingVectors: js.Array[DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Vector3]],
    frustumPlanes: js.Array[DeepImmutable[typingsSlinky.babylonjs.mathPlaneMod.Plane]]
