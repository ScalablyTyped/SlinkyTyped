...
class DepthOfFieldMergePostProcess protected ()
  extends typingsSlinky.babylonjs.postProcessesIndexMod.DepthOfFieldMergePostProcess {
  /**
  ...
  def this(
    ...
    blurSteps: js.Array[typingsSlinky.babylonjs.postProcessMod.PostProcess],
