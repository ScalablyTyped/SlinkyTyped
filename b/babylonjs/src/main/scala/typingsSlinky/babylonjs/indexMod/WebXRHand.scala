...
class WebXRHand protected ()
  extends typingsSlinky.babylonjs.xRIndexMod.WebXRHand {
  /**
  ...
  trackedMeshes: js.Array[typingsSlinky.babylonjs.abstractMeshMod.AbstractMesh]
  ) = this()
  def this(
    /** the controller to which the hand correlates */
  xrController: typingsSlinky.babylonjs.webXRInputSourceMod.WebXRInputSource,
    /** the meshes to be used to track the hand joints */
  trackedMeshes: js.Array[typingsSlinky.babylonjs.abstractMeshMod.AbstractMesh],
    _handMesh: typingsSlinky.babylonjs.abstractMeshMod.AbstractMesh
  ) = this()
  def this(
    /** the controller to which the hand correlates */
  xrController: typingsSlinky.babylonjs.webXRInputSourceMod.WebXRInputSource,
