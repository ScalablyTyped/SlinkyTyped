...
@js.native
class ColorCurves ()
  extends typingsSlinky.babylonjs.materialsIndexMod.ColorCurves
/* static members */
object ColorCurves {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ColorCurves.Bind")
  @js.native
  def Bind(
    colorCurves: typingsSlinky.babylonjs.colorCurvesMod.ColorCurves,
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ColorCurves.Parse")
  @js.native
  def Parse(source: js.Any): typingsSlinky.babylonjs.colorCurvesMod.ColorCurves = js.native
  
  /**
    * Prepare the list of uniforms associated with the ColorCurves effects.
    * @param uniformsList The list of uniforms used in the effect
    */
  @JSImport("babylonjs/index", "ColorCurves.PrepareUniforms")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ColorCurves.applyColorGradingSliderNonlinear")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ColorCurves.clamp")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ColorCurves.fromHSBToRef")
  @js.native
