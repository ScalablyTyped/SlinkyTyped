...
class DeviceInputSystem protected ()
  extends typingsSlinky.babylonjs.deviceInputIndexMod.DeviceInputSystem
/* static members */
@JSImport("babylonjs/index", "DeviceInputSystem")
@js.native
object DeviceInputSystem extends js.Object {
  ...
  /**
    ...
    */
  def Create(engine: typingsSlinky.babylonjs.engineMod.Engine): typingsSlinky.babylonjs.deviceInputSystemMod.DeviceInputSystem = js.native
