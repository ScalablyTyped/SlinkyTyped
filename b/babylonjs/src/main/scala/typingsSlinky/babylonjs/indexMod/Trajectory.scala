...
/**
  ...
  */
class Trajectory ()
  extends typingsSlinky.babylonjs.miscIndexMod.Trajectory {
...
object Trajectory {
  ...
  @js.native
  def Deserialize(json: String): typingsSlinky.babylonjs.trajectoryClassifierMod.Trajectory = js.native
