...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    @scala.inline
    def apply(_resizeOrCreateMultiviewTexture: (Double, Double) => Unit, _useMultiviewToSingleView: Boolean): typingsSlinky.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    @scala.inline
    implicit class CameraMutableBuilder[Self <: typingsSlinky.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera] (val x: Self) extends AnyVal {
