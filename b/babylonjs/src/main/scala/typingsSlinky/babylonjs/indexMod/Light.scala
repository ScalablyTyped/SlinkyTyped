...
abstract class Light protected ()
  extends typingsSlinky.babylonjs.lightsIndexMod.Light {
  /**
...
object Light extends js.Object {
  ...
  /**
    ...
    */
  def GetConstructorFromName(`type`: Double, name: String, scene: typingsSlinky.babylonjs.sceneMod.Scene): Nullable[js.Function0[this.type]] = js.native
  /**
    ...
    */
  def Parse(parsedLight: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene): Nullable[typingsSlinky.babylonjs.lightMod.Light] = js.native
}
