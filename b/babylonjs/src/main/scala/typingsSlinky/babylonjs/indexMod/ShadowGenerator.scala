...
@JSImport("babylonjs/index", "ShadowGenerator")
@js.native
class ShadowGenerator protected ()
  extends typingsSlinky.babylonjs.lightsIndexMod.ShadowGenerator {
  /**
...
object ShadowGenerator {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.CLASSNAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_BLURCLOSEEXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    * (http://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf)
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_BLUREXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    * (http://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf)
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_CLOSEEXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    * (http://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf)
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_EXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_NONE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_PCF")
  @js.native
  ...
  /**
    ...
    * Contact Hardening
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_PCSS")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.FILTER_POISSONSAMPLING")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.Parse")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.QUALITY_HIGH")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.QUALITY_LOW")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ShadowGenerator.QUALITY_MEDIUM")
  @js.native
  val QUALITY_MEDIUM: Double = js.native
  
  /** @hidden */
  @JSImport("babylonjs/index", "ShadowGenerator._SceneComponentInitialization")
  @js.native
