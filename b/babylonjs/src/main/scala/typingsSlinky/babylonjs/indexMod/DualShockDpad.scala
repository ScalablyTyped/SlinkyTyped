...
@JSImport("babylonjs/index", "DualShockDpad")
@js.native
object DualShockDpad extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsSlinky.babylonjs.dualShockGamepadMod.DualShockDpad with Double] = js.native
}
