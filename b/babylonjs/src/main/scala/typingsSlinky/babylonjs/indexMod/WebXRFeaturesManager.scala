...
class WebXRFeaturesManager protected ()
  extends typingsSlinky.babylonjs.xRIndexMod.WebXRFeaturesManager {
  /**
...
object WebXRFeaturesManager {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRFeaturesManager.AddWebXRFeature")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebXRFeaturesManager.ConstructFeature")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRFeaturesManager.GetAvailableFeatures")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRFeaturesManager.GetAvailableVersions")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRFeaturesManager.GetLatestVersionOfFeature")
  @js.native
  ...
  /**
    ...
    * @returns the version number. if not found will return -1
    */
  @JSImport("babylonjs/index", "WebXRFeaturesManager.GetStableVersionOfFeature")
  @js.native
