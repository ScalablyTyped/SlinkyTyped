...
class Effect protected ()
  extends typingsSlinky.babylonjs.materialsIndexMod.Effect {
  /**
  ...
  def this(
    ...
    uniformsNamesOrEngine: js.Array[String] | typingsSlinky.babylonjs.thinEngineMod.ThinEngine,
    samplers: js.UndefOr[Nullable[js.Array[String]]],
    engine: js.UndefOr[typingsSlinky.babylonjs.thinEngineMod.ThinEngine],
...
object Effect {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Effect.IncludesShadersStore")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Effect.LogShaderCodeOnCompilationError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Effect.RegisterShader")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Effect.ResetCache")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Effect.ShadersRepository")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Effect.ShadersStore")
  @js.native
  ...
  @JSImport("babylonjs/index", "Effect._baseCache")
  @js.native
  ...
  @JSImport("babylonjs/index", "Effect._uniqueIdSeed")
  @js.native
