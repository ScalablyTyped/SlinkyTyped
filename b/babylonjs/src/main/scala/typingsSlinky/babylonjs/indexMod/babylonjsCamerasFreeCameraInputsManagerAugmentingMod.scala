...
object babylonjsCamerasFreeCameraInputsManagerAugmentingMod {
  ...
  object FreeCameraInputsManager {
    ...
    def apply(
    ...
    ): typingsSlinky.babylonjs.indexMod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.indexMod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager]
    }
    
    @scala.inline
    implicit class FreeCameraInputsManagerMutableBuilder[Self <: typingsSlinky.babylonjs.indexMod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager] (val x: Self) extends AnyVal {
