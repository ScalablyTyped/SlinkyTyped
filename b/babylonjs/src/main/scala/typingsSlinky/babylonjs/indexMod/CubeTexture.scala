...
object CubeTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "CubeTexture.CreateFromImages")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "CubeTexture.CreateFromPrefilteredData")
  @js.native
  ...
  /**
    ...
    * @returns a cube texture
    */
  @JSImport("babylonjs/index", "CubeTexture.Parse")
  @js.native
