...
class ColorCorrectionPostProcess protected ()
  extends typingsSlinky.babylonjs.postProcessesIndexMod.ColorCorrectionPostProcess {
  def this(
    name: String,
...
object ColorCorrectionPostProcess extends js.Object {
  ...
  def _Parse(
    ...
    rootUrl: String
  ): Nullable[typingsSlinky.babylonjs.colorCorrectionPostProcessMod.ColorCorrectionPostProcess] = js.native
}
