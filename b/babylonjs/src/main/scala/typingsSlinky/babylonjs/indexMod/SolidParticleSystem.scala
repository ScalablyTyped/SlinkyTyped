...
class SolidParticleSystem protected ()
  extends typingsSlinky.babylonjs.particlesIndexMod.SolidParticleSystem {
  /**
  ...
  def this(name: String, scene: typingsSlinky.babylonjs.sceneMod.Scene, options: AnonBSphereRadiusFactor) = this()
}
