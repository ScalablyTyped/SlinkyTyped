...
@JSImport("babylonjs/index", "WebXRControllerComponent")
@js.native
class WebXRControllerComponent protected ()
  extends typingsSlinky.babylonjs.xRIndexMod.WebXRControllerComponent {
  /**
...
object WebXRControllerComponent {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRControllerComponent.BUTTON_TYPE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRControllerComponent.SQUEEZE_TYPE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRControllerComponent.THUMBSTICK_TYPE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRControllerComponent.TOUCHPAD_TYPE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRControllerComponent.TRIGGER_TYPE")
  @js.native
