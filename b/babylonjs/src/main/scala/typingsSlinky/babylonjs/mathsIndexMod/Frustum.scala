...
@js.native
class Frustum ()
  extends typingsSlinky.babylonjs.mathMod.Frustum
/* static members */
object Frustum {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetBottomPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetFarPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetLeftPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetNearPlaneToRef")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetPlanes")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetPlanesToRef")
  @js.native
  def GetPlanesToRef(
    transform: DeepImmutable[typingsSlinky.babylonjs.mathVectorMod.Matrix],
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetRightPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/index", "Frustum.GetTopPlaneToRef")
  @js.native
