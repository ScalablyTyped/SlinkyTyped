...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    @scala.inline
    def apply(_resizeOrCreateMultiviewTexture: (Double, Double) => Unit, _useMultiviewToSingleView: Boolean): typingsSlinky.babylonjs.mod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.mod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    @scala.inline
    implicit class CameraMutableBuilder[Self <: typingsSlinky.babylonjs.mod.babylonjsCamerasCameraAugmentingMod.Camera] (val x: Self) extends AnyVal {
