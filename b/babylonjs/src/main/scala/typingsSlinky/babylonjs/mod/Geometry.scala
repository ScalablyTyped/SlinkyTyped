...
class Geometry protected ()
  extends typingsSlinky.babylonjs.legacyMod.Geometry {
  /**
...
object Geometry {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Geometry.CreateGeometryForMesh")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Geometry.ExtractFromMesh")
  @js.native
  ...
  /**
    ...
    * @returns the new geometry object
    */
  @JSImport("babylonjs", "Geometry.Parse")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Geometry.RandomId")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs", "Geometry._ImportGeometry")
  @js.native
