...
class RenderingGroup protected ()
  extends typingsSlinky.babylonjs.legacyMod.RenderingGroup {
  /**
...
object RenderingGroup {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "RenderingGroup.backToFrontSortCompare")
  @js.native
  ...
  /**
    ...
    * @returns The result of the comparison
    */
  @JSImport("babylonjs", "RenderingGroup.defaultTransparentSortCompare")
  @js.native
  ...
  /**
    ...
    * @returns The result of the comparison
    */
  @JSImport("babylonjs", "RenderingGroup.frontToBackSortCompare")
  @js.native
