...
class GPUParticleSystem protected ()
  ...
  /**
    ...
    */
  def this(name: String, options: Partialcapacitynumberrand, scene: typingsSlinky.babylonjs.sceneMod.Scene) = this()
  def this(
    name: String,
...
object GPUParticleSystem extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedParticleSystem: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene, rootUrl: String): typingsSlinky.babylonjs.gpuParticleSystemMod.GPUParticleSystem = js.native
  def Parse(
