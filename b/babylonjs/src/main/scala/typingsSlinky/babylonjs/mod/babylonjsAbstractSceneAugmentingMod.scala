...
object babylonjsAbstractSceneAugmentingMod {
  ...
  object AbstractScene {
    ...
    def apply(
    ...
    ): typingsSlinky.babylonjs.mod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.mod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
    }
    
    @scala.inline
    implicit class AbstractSceneMutableBuilder[Self <: typingsSlinky.babylonjs.mod.babylonjsAbstractSceneAugmentingMod.AbstractScene] (val x: Self) extends AnyVal {
