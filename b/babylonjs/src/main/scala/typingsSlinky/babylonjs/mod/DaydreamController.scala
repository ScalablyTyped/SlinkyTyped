...
class DaydreamController protected ()
  extends typingsSlinky.babylonjs.legacyMod.DaydreamController {
  /**
...
object DaydreamController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "DaydreamController.GAMEPAD_ID_PREFIX")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "DaydreamController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "DaydreamController.MODEL_FILENAME")
  @js.native
