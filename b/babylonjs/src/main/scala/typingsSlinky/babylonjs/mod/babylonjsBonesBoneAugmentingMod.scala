...
object babylonjsBonesBoneAugmentingMod {
  ...
  object Bone {
    ...
    ): typingsSlinky.babylonjs.mod.babylonjsBonesBoneAugmentingMod.Bone = {
      val __obj = js.Dynamic.literal(copyAnimationRange = js.Any.fromFunction5(copyAnimationRange))
      __obj.asInstanceOf[typingsSlinky.babylonjs.mod.babylonjsBonesBoneAugmentingMod.Bone]
    }
    
    @scala.inline
    implicit class BoneMutableBuilder[Self <: typingsSlinky.babylonjs.mod.babylonjsBonesBoneAugmentingMod.Bone] (val x: Self) extends AnyVal {
