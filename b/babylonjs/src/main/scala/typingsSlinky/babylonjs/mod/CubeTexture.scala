...
class CubeTexture protected ()
  extends typingsSlinky.babylonjs.legacyMod.CubeTexture {
  /**
...
object CubeTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "CubeTexture.CreateFromImages")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "CubeTexture.CreateFromPrefilteredData")
  @js.native
  ...
  /**
    ...
    * @returns a cube texture
    */
  @JSImport("babylonjs", "CubeTexture.Parse")
  @js.native
