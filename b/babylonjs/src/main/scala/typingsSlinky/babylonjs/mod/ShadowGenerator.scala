...
class ShadowGenerator protected ()
  extends typingsSlinky.babylonjs.legacyMod.ShadowGenerator {
  /**
...
object ShadowGenerator {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.CLASSNAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_BLURCLOSEEXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    * (http://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf)
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_BLUREXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    * (http://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf)
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_CLOSEEXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    * (http://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf)
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_EXPONENTIALSHADOWMAP")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_NONE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_PCF")
  @js.native
  ...
  /**
    ...
    * Contact Hardening
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_PCSS")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.FILTER_POISSONSAMPLING")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.Parse")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.QUALITY_HIGH")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.QUALITY_LOW")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShadowGenerator.QUALITY_MEDIUM")
  @js.native
  val QUALITY_MEDIUM: Double = js.native
  
  /** @hidden */
  @JSImport("babylonjs", "ShadowGenerator._SceneComponentInitialization")
  @js.native
