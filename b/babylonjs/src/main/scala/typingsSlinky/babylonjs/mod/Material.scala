...
class Material protected ()
  extends typingsSlinky.babylonjs.legacyMod.Material {
  /**
  ...
  def this(name: String, scene: typingsSlinky.babylonjs.sceneMod.Scene, doNotAdd: Boolean) = this()
}
/* static members */
object Material {
  ...
  @js.native
  def Parse(parsedMaterial: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.materialMod.Material] = js.native
