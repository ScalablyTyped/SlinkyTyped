...
object babylonjsCamerasFreeCameraInputsManagerAugmentingMod {
  ...
  object FreeCameraInputsManager {
    ...
    def apply(
    ...
    ): typingsSlinky.babylonjs.mod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.mod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager]
    }
    
    @scala.inline
    implicit class FreeCameraInputsManagerMutableBuilder[Self <: typingsSlinky.babylonjs.mod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager] (val x: Self) extends AnyVal {
