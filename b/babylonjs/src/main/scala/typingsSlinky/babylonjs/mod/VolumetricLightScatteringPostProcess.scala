...
class VolumetricLightScatteringPostProcess protected ()
  extends typingsSlinky.babylonjs.legacyMod.VolumetricLightScatteringPostProcess {
  /**
    * @constructor
...
object VolumetricLightScatteringPostProcess {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "VolumetricLightScatteringPostProcess.CreateDefaultMesh")
  @js.native
