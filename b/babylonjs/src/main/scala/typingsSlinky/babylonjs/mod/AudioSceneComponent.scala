...
class AudioSceneComponent protected ()
  extends typingsSlinky.babylonjs.legacyMod.AudioSceneComponent {
  /**
...
object AudioSceneComponent {
  ...
  @JSImport("babylonjs", "AudioSceneComponent._CameraDirectionLH")
  @js.native
  ...
  @JSImport("babylonjs", "AudioSceneComponent._CameraDirectionRH")
  @js.native
