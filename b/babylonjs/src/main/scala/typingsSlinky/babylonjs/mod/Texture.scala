...
class Texture protected ()
  extends typingsSlinky.babylonjs.legacyMod.Texture {
  /**
...
object Texture {
  ...
  @JSImport("babylonjs", "Texture.BILINEAR_SAMPLINGMODE")
  @js.native
  val BILINEAR_SAMPLINGMODE: Double = js.native
  
  /** Texture is not repeating outside of 0..1 UVs */
  @JSImport("babylonjs", "Texture.CLAMP_ADDRESSMODE")
  @js.native
  val CLAMP_ADDRESSMODE: Double = js.native
  
  /** Cubic coordinates mode */
  @JSImport("babylonjs", "Texture.CUBIC_MODE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Texture.CreateFromBase64String")
  @js.native
  ...
  @JSImport("babylonjs", "Texture.EQUIRECTANGULAR_MODE")
  @js.native
  val EQUIRECTANGULAR_MODE: Double = js.native
  
  /** Explicit coordinates mode */
  @JSImport("babylonjs", "Texture.EXPLICIT_MODE")
  @js.native
  val EXPLICIT_MODE: Double = js.native
  
  /** Equirectangular Fixed Mirrored coordinates mode */
  @JSImport("babylonjs", "Texture.FIXED_EQUIRECTANGULAR_MIRRORED_MODE")
  @js.native
  val FIXED_EQUIRECTANGULAR_MIRRORED_MODE: Double = js.native
  
  /** Equirectangular Fixed coordinates mode */
  @JSImport("babylonjs", "Texture.FIXED_EQUIRECTANGULAR_MODE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Texture.ForceSerializeBuffers")
  @js.native
  ...
  @JSImport("babylonjs", "Texture.INVCUBIC_MODE")
  @js.native
  val INVCUBIC_MODE: Double = js.native
  
  /** mag = linear and min = linear and mip = none */
  @JSImport("babylonjs", "Texture.LINEAR_LINEAR")
  @js.native
  val LINEAR_LINEAR: Double = js.native
  
  /** Trilinear is mag = linear and min = linear and mip = linear */
  @JSImport("babylonjs", "Texture.LINEAR_LINEAR_MIPLINEAR")
  @js.native
  val LINEAR_LINEAR_MIPLINEAR: Double = js.native
  
  /** Bilinear is mag = linear and min = linear and mip = nearest */
  @JSImport("babylonjs", "Texture.LINEAR_LINEAR_MIPNEAREST")
  @js.native
  val LINEAR_LINEAR_MIPNEAREST: Double = js.native
  
  /** mag = linear and min = nearest and mip = none */
  @JSImport("babylonjs", "Texture.LINEAR_NEAREST")
  @js.native
  val LINEAR_NEAREST: Double = js.native
  
  /** mag = linear and min = nearest and mip = linear */
  @JSImport("babylonjs", "Texture.LINEAR_NEAREST_MIPLINEAR")
  @js.native
  val LINEAR_NEAREST_MIPLINEAR: Double = js.native
  
  /** mag = linear and min = nearest and mip = nearest */
  @JSImport("babylonjs", "Texture.LINEAR_NEAREST_MIPNEAREST")
  @js.native
  ...
  /**
    ...
    * @returns the created texture
    */
  @JSImport("babylonjs", "Texture.LoadFromDataString")
  @js.native
  ...
  @JSImport("babylonjs", "Texture.MIRROR_ADDRESSMODE")
  @js.native
  val MIRROR_ADDRESSMODE: Double = js.native
  
  /** mag = nearest and min = linear and mip = none */
  @JSImport("babylonjs", "Texture.NEAREST_LINEAR")
  @js.native
  val NEAREST_LINEAR: Double = js.native
  
  /** mag = nearest and min = linear and mip = linear */
  @JSImport("babylonjs", "Texture.NEAREST_LINEAR_MIPLINEAR")
  @js.native
  val NEAREST_LINEAR_MIPLINEAR: Double = js.native
  
  /** mag = nearest and min = linear and mip = nearest */
  @JSImport("babylonjs", "Texture.NEAREST_LINEAR_MIPNEAREST")
  @js.native
  val NEAREST_LINEAR_MIPNEAREST: Double = js.native
  
  /** mag = nearest and min = nearest and mip = none */
  @JSImport("babylonjs", "Texture.NEAREST_NEAREST")
  @js.native
  val NEAREST_NEAREST: Double = js.native
  
  /** nearest is mag = nearest and min = nearest and mip = linear */
  @JSImport("babylonjs", "Texture.NEAREST_NEAREST_MIPLINEAR")
  @js.native
  val NEAREST_NEAREST_MIPLINEAR: Double = js.native
  
  /** mag = nearest and min = nearest and mip = nearest */
  @JSImport("babylonjs", "Texture.NEAREST_NEAREST_MIPNEAREST")
  @js.native
  val NEAREST_NEAREST_MIPNEAREST: Double = js.native
  
  /** nearest is mag = nearest and min = nearest and mip = linear */
  @JSImport("babylonjs", "Texture.NEAREST_SAMPLINGMODE")
  @js.native
  val NEAREST_SAMPLINGMODE: Double = js.native
  
  /** Planar coordinates mode */
  @JSImport("babylonjs", "Texture.PLANAR_MODE")
  @js.native
  val PLANAR_MODE: Double = js.native
  
  /** Projection coordinates mode */
  @JSImport("babylonjs", "Texture.PROJECTION_MODE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Texture.Parse")
  @js.native
  def Parse(parsedTexture: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.baseTextureMod.BaseTexture] = js.native
  
  /** Inverse Cubic coordinates mode */
  @JSImport("babylonjs", "Texture.SKYBOX_MODE")
  @js.native
  val SKYBOX_MODE: Double = js.native
  
  /** Spherical coordinates mode */
  @JSImport("babylonjs", "Texture.SPHERICAL_MODE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Texture.SerializeBuffers")
  @js.native
  ...
  /** Trilinear is mag = linear and min = linear and mip = linear */
  @JSImport("babylonjs", "Texture.TRILINEAR_SAMPLINGMODE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Texture.UseSerializedUrlIfAny")
  @js.native
  ...
  @JSImport("babylonjs", "Texture.WRAP_ADDRESSMODE")
  @js.native
  val WRAP_ADDRESSMODE: Double = js.native
  
  /** @hidden */
  @JSImport("babylonjs", "Texture._CreateMirror")
  @js.native
  def _CreateMirror(
    name: String,
  ...
  ): typingsSlinky.babylonjs.mirrorTextureMod.MirrorTexture = js.native
  
  /** @hidden */
  @JSImport("babylonjs", "Texture._CreateRenderTargetTexture")
  @js.native
  def _CreateRenderTargetTexture(
    ...
    scene: typingsSlinky.babylonjs.sceneMod.Scene,
    generateMipMaps: Boolean
  ): typingsSlinky.babylonjs.renderTargetTextureMod.RenderTargetTexture = js.native
  
  /** @hidden */
  @JSImport("babylonjs", "Texture._CubeTextureParser")
  @js.native
  def _CubeTextureParser(jsonTexture: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene, rootUrl: String): typingsSlinky.babylonjs.cubeTextureMod.CubeTexture = js.native
}
