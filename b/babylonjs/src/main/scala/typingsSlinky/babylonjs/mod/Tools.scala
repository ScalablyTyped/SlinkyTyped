...
@js.native
class Tools ()
  extends typingsSlinky.babylonjs.legacyMod.Tools
/* static members */
@JSImport("babylonjs", "Tools")
@js.native
object Tools extends js.Object {
  ...
  /**
    ...
    */
  def DumpFramebuffer(width: Double, height: Double, engine: typingsSlinky.babylonjs.engineMod.Engine): Unit = js.native
  def DumpFramebuffer(
    width: Double,
    height: Double,
    engine: typingsSlinky.babylonjs.engineMod.Engine,
  ...
  /**
    ...
    */
  def GetPointerPrefix(engine: typingsSlinky.babylonjs.engineMod.Engine): String = js.native
