...
@JSImport("babylonjs", "StringTools")
@js.native
class StringTools ()
  extends typingsSlinky.babylonjs.legacyMod.StringTools
/* static members */
object StringTools {
  
  @JSImport("babylonjs", "StringTools.Decode")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "StringTools.EncodeArrayBufferToBase64")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "StringTools.EndsWith")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "StringTools.PadNumber")
  @js.native
  ...
  /**
    ...
    * @returns Boolean indicating whether the suffix was found (true) or not (false)
    */
  @JSImport("babylonjs", "StringTools.StartsWith")
  @js.native
