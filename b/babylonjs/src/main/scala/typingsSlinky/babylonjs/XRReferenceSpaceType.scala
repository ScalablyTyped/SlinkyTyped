...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.babylonjs.babylonjsStrings.local
  - typingsSlinky.babylonjs.babylonjsStrings.`local-floor`
  - typingsSlinky.babylonjs.babylonjsStrings.`bounded-floor`
