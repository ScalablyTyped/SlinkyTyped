...
object inavigationengineMod {
  ...
  trait INavigationEnginePlugin extends StObject {
    ...
    /**
      ...
      */
    def buildFromNavmeshData(data: js.typedarray.Uint8Array): Unit = js.native
    ...
    /**
      ...
      */
    def getNavmeshData(): js.typedarray.Uint8Array = js.native
  ...
  object INavigationEnginePlugin {
    ...
    implicit class INavigationEnginePluginMutableBuilder[Self <: INavigationEnginePlugin] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBuildFromNavmeshData(value: js.typedarray.Uint8Array => Unit): Self = StObject.set(x, "buildFromNavmeshData", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setGetNavmeshData(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "getNavmeshData", js.Any.fromFunction0(value))
