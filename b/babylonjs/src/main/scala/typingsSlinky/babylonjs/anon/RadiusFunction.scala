...
object RadiusFunction {
  ...
  @scala.inline
  implicit class RadiusFunctionOps[Self <: RadiusFunction] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRadiusFunction(value: (/* i */ Double, /* distance */ Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("radiusFunction")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutRadiusFunction: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("radiusFunction")(js.undefined)
        ret
    }
    @scala.inline
