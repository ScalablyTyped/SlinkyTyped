...
object Effect {
  ...
  implicit class EffectOps[Self <: Effect] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEffect(value: typingsSlinky.babylonjs.effectMod.Effect): Self = this.set("effect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubMesh(value: Nullable[typingsSlinky.babylonjs.subMeshMod.SubMesh]): Self = this.set("subMesh", value.asInstanceOf[js.Any])
