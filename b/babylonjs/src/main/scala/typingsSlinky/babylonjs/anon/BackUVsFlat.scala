...
@js.native
trait BackUVsFlat extends StObject {
...
object BackUVsFlat {
  ...
  @scala.inline
  def apply(): BackUVsFlat = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackUVsFlat]
  }
  
  @scala.inline
  implicit class BackUVsFlatMutableBuilder[Self <: BackUVsFlat] (val x: Self) extends AnyVal {
