...
object PositionGizmo {
  ...
  implicit class PositionGizmoMutableBuilder[Self <: PositionGizmo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingBoxGizmo(value: Nullable[typingsSlinky.babylonjs.BABYLON.BoundingBoxGizmo]): Self = StObject.set(x, "boundingBoxGizmo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundingBoxGizmoNull: Self = StObject.set(x, "boundingBoxGizmo", null)
    
    @scala.inline
    def setPositionGizmo(value: Nullable[typingsSlinky.babylonjs.BABYLON.PositionGizmo]): Self = StObject.set(x, "positionGizmo", value.asInstanceOf[js.Any])
