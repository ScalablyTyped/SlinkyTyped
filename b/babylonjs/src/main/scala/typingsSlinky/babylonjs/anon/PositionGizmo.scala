...
object PositionGizmo {
  ...
  implicit class PositionGizmoOps[Self <: PositionGizmo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingBoxGizmo(value: Nullable[typingsSlinky.babylonjs.BABYLON.BoundingBoxGizmo]): Self = this.set("boundingBoxGizmo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundingBoxGizmoNull: Self = this.set("boundingBoxGizmo", null)
    
    @scala.inline
    def setPositionGizmo(value: Nullable[typingsSlinky.babylonjs.BABYLON.PositionGizmo]): Self = this.set("positionGizmo", value.asInstanceOf[js.Any])
