...
object BoundingBoxGizmo {
  ...
  implicit class BoundingBoxGizmoMutableBuilder[Self <: BoundingBoxGizmo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingBoxGizmo(value: Nullable[typingsSlinky.babylonjs.boundingBoxGizmoMod.BoundingBoxGizmo]): Self = StObject.set(x, "boundingBoxGizmo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundingBoxGizmoNull: Self = StObject.set(x, "boundingBoxGizmo", null)
    
    @scala.inline
    def setPositionGizmo(value: Nullable[typingsSlinky.babylonjs.positionGizmoMod.PositionGizmo]): Self = StObject.set(x, "positionGizmo", value.asInstanceOf[js.Any])
