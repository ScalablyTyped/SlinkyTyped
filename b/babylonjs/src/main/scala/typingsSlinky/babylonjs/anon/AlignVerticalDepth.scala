...
@js.native
trait AlignVerticalDepth extends StObject {
...
object AlignVerticalDepth {
  
  @scala.inline
  def apply(): AlignVerticalDepth = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AlignVerticalDepth]
  }
  
  @scala.inline
  implicit class AlignVerticalDepthMutableBuilder[Self <: AlignVerticalDepth] (val x: Self) extends AnyVal {
