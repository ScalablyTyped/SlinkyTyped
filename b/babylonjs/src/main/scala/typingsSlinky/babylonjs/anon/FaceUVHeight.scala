...
@js.native
trait FaceUVHeight extends js.Object {
...
object FaceUVHeight {
  @scala.inline
  def apply(depth: Double): FaceUVHeight = {
    val __obj = js.Dynamic.literal(depth = depth.asInstanceOf[js.Any])
    __obj.asInstanceOf[FaceUVHeight]
  }
  @scala.inline
  implicit class FaceUVHeightOps[Self <: FaceUVHeight] (val x: Self) extends AnyVal {
    @scala.inline
