...
trait DisableDefaultHandMesh extends StObject {
  ...
  /**
    ...
    */
  var handMeshes: js.UndefOr[Left] = js.native
  ...
  var onHandJointMeshGenerated: js.UndefOr[
    js.Function3[
      ...
      /* jointId */ Double, 
      /* controllerId */ String, 
      js.UndefOr[typingsSlinky.babylonjs.meshMod.Mesh]
    ]
  ] = js.native
  ...
  /**
    ...
    */
  var sourceMesh: js.UndefOr[typingsSlinky.babylonjs.meshMod.Mesh] = js.native
}
object DisableDefaultHandMesh {
  
  @scala.inline
  def apply(): DisableDefaultHandMesh = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DisableDefaultHandMesh]
  }
  ...
  implicit class DisableDefaultHandMeshMutableBuilder[Self <: DisableDefaultHandMesh] (val x: Self) extends AnyVal {
    ...
    def setOnHandJointMeshGenerated(
      value: (/* meshInstance */ InstancedMesh, /* jointId */ Double, /* controllerId */ String) => js.UndefOr[typingsSlinky.babylonjs.meshMod.Mesh]
    ...
    @scala.inline
    def setSourceMesh(value: typingsSlinky.babylonjs.meshMod.Mesh): Self = StObject.set(x, "sourceMesh", value.asInstanceOf[js.Any])
