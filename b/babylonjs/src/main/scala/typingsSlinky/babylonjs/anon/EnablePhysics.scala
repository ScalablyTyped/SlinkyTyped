...
import typingsSlinky.babylonjs.BABYLON.InstancedMesh
...
trait EnablePhysics extends StObject {
  ...
  var onHandJointMeshGenerated: js.UndefOr[
    js.Function3[
      ...
      /* jointId */ Double, 
      /* controllerId */ String, 
      js.UndefOr[typingsSlinky.babylonjs.BABYLON.Mesh]
    ]
  ] = js.native
  ...
  /**
    ...
    */
  var sourceMesh: js.UndefOr[typingsSlinky.babylonjs.BABYLON.Mesh] = js.native
}
object EnablePhysics {
  ...
  implicit class EnablePhysicsMutableBuilder[Self <: EnablePhysics] (val x: Self) extends AnyVal {
    ...
    def setOnHandJointMeshGenerated(
      value: (/* meshInstance */ InstancedMesh, /* jointId */ Double, /* controllerId */ String) => js.UndefOr[typingsSlinky.babylonjs.BABYLON.Mesh]
    ...
    @scala.inline
    def setSourceMesh(value: typingsSlinky.babylonjs.BABYLON.Mesh): Self = StObject.set(x, "sourceMesh", value.asInstanceOf[js.Any])
