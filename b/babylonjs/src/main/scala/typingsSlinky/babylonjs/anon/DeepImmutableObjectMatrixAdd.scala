...
trait DeepImmutableObjectMatrixAdd extends js.Object {
  ...
  val asArray: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]] = js.native
  ...
  val m: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]] = js.native
  ...
  val toArray: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]] = js.native
...
object DeepImmutableObjectMatrixAdd {
  ...
  implicit class DeepImmutableObjectMatrixAddOps[Self <: DeepImmutableObjectMatrixAdd] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsArrayFunction0(value: () => DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]): Self = this.set("asArray", js.Any.fromFunction0(value))
    
    @scala.inline
    def setAsArray(value: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]]): Self = this.set("asArray", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMFunction0(value: () => DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]): Self = this.set("m", js.Any.fromFunction0(value))
    
    @scala.inline
    def setM(value: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]]): Self = this.set("m", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setToArrayFunction0(value: () => DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]): Self = this.set("toArray", js.Any.fromFunction0(value))
    
    @scala.inline
    def setToArray(value: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]]): Self = this.set("toArray", value.asInstanceOf[js.Any])
