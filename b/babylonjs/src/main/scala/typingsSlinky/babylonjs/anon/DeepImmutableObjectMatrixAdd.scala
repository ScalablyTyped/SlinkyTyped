...
object DeepImmutableObjectMatrixAdd {
  ...
  implicit class DeepImmutableObjectMatrixAddMutableBuilder[Self <: DeepImmutableObjectMatrixAdd] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsArray(value: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]]): Self = StObject.set(x, "asArray", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAsArrayFunction0(value: () => DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]): Self = StObject.set(x, "asArray", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setM(value: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]]): Self = StObject.set(x, "m", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMFunction0(value: () => DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]): Self = StObject.set(x, "m", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setToArray(value: DeepImmutable[js.Function0[DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]]]): Self = StObject.set(x, "toArray", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setToArrayFunction0(value: () => DeepImmutable[js.typedarray.Float32Array | js.Array[Double]]): Self = StObject.set(x, "toArray", js.Any.fromFunction0(value))
