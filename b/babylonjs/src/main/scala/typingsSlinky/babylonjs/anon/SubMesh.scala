...
object SubMesh {
  ...
  implicit class SubMeshOps[Self <: SubMesh] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEffect(value: typingsSlinky.babylonjs.BABYLON.Effect): Self = this.set("effect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubMesh(value: Nullable[typingsSlinky.babylonjs.BABYLON.SubMesh]): Self = this.set("subMesh", value.asInstanceOf[js.Any])
