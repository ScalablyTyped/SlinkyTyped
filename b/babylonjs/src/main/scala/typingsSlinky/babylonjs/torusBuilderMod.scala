...
@js.native
object torusBuilderMod extends js.Object {
  @js.native
  class TorusBuilder () extends js.Object
  ...
  object TorusBuilder extends js.Object {
    /**
      ...
      */
    def CreateTorus(name: String, options: AnonThickness, scene: js.Any): Mesh = js.native
  }
