...
@js.native
class LinesBuilder ()
  extends typingsSlinky.babylonjs.buildersIndexMod.LinesBuilder
...
object LinesBuilder extends js.Object {
  ...
  def CreateDashedLines(name: String, options: AnonDashSize, scene: Nullable[Scene]): typingsSlinky.babylonjs.linesMeshMod.LinesMesh = js.native
  /**
