...
class Geometry protected ()
  extends typingsSlinky.babylonjs.geometryMod.Geometry {
  /**
  ...
  def this(id: String, scene: Scene, vertexData: typingsSlinky.babylonjs.meshVertexDataMod.VertexData) = this()
  def this(
    id: String,
    scene: Scene,
...
object Geometry extends js.Object {
  ...
  /**
    ...
    * @returns the new geometry object
    */
  def Parse(parsedVertexData: js.Any, scene: Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.geometryMod.Geometry] = js.native
  /**
