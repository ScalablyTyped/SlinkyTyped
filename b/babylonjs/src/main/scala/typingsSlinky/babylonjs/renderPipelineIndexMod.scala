...
object renderPipelineIndexMod {
  ...
  class PostProcessRenderPipeline protected ()
    extends typingsSlinky.babylonjs.postProcessRenderPipelineMod.PostProcessRenderPipeline {
    /**
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      def apply(
      ...
      ): typingsSlinky.babylonjs.renderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.renderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.renderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
