...
object probesIndexMod {
  ...
  class ReflectionProbe protected ()
    extends typingsSlinky.babylonjs.reflectionProbeMod.ReflectionProbe {
    /**
  ...
  object ReflectionProbe {
    ...
    @js.native
    def Parse(parsedReflectionProbe: js.Any, scene: Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.reflectionProbeMod.ReflectionProbe] = js.native
  }
