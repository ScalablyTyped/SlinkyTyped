...
@JSImport("babylonjs/Gamepads/index", "GearVRController")
@js.native
class GearVRController protected ()
  extends typingsSlinky.babylonjs.controllersIndexMod.GearVRController {
  /**
...
object GearVRController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "GearVRController.GAMEPAD_ID_PREFIX")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "GearVRController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "GearVRController.MODEL_FILENAME")
  @js.native
