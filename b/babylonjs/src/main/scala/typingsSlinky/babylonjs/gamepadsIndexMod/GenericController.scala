...
class GenericController protected ()
  extends typingsSlinky.babylonjs.controllersIndexMod.GenericController {
  /**
...
object GenericController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "GenericController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "GenericController.MODEL_FILENAME")
  @js.native
