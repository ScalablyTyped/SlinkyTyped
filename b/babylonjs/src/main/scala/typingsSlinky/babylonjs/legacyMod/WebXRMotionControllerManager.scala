...
class WebXRMotionControllerManager ()
  extends typingsSlinky.babylonjs.indexMod.WebXRMotionControllerManager
/* static members */
@JSImport("babylonjs/Legacy/legacy", "WebXRMotionControllerManager")
@js.native
object WebXRMotionControllerManager extends js.Object {
  ...
  /**
    ...
    */
  def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typingsSlinky.babylonjs.sceneMod.Scene): js.Promise[
    typingsSlinky.babylonjs.webXRAbstractMotionControllerMod.WebXRAbstractMotionController
  ] = js.native
  def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typingsSlinky.babylonjs.sceneMod.Scene, forceProfile: String): js.Promise[
    typingsSlinky.babylonjs.webXRAbstractMotionControllerMod.WebXRAbstractMotionController
  ] = js.native
