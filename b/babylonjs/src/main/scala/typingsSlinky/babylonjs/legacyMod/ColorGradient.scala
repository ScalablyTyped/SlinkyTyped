...
class ColorGradient protected ()
  extends typingsSlinky.babylonjs.indexMod.ColorGradient {
  /**
  ...
  gradient: Double,
    ...
    */
  color1: typingsSlinky.babylonjs.mathColorMod.Color4
  ) = this()
  def this(
    /**
    * Gets or sets the gradient value (between 0 and 1)
  ...
  color1: typingsSlinky.babylonjs.mathColorMod.Color4,
    ...
    */
  color2: typingsSlinky.babylonjs.mathColorMod.Color4
  ) = this()
}
