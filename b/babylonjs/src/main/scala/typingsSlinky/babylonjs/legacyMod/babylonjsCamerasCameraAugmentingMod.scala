...
object babylonjsCamerasCameraAugmentingMod {
  ...
  trait Camera extends StObject {
    ...
    /**
      ...
      */
    var _multiviewTexture: Nullable[typingsSlinky.babylonjs.renderTargetTextureMod.RenderTargetTexture] = js.native
  ...
  object Camera {
    ...
    @scala.inline
    def apply(_resizeOrCreateMultiviewTexture: (Double, Double) => Unit, _useMultiviewToSingleView: Boolean): typingsSlinky.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    @scala.inline
    implicit class CameraMutableBuilder[Self <: typingsSlinky.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera] (val x: Self) extends AnyVal {
      
      @scala.inline
      def set_multiviewTexture(value: Nullable[typingsSlinky.babylonjs.renderTargetTextureMod.RenderTargetTexture]): Self = StObject.set(x, "_multiviewTexture", value.asInstanceOf[js.Any])
