...
object Mesh extends js.Object {
  ...
  /**
    ...
    * @returns a vector3
    */
  def Center(meshesOrMinMaxVector: AnonMax): typingsSlinky.babylonjs.mathVectorMod.Vector3 = js.native
  /**
  ...
  /**
    ...
    */
  def CreateIcoSphere(name: String, options: AnonUpdatable, scene: typingsSlinky.babylonjs.sceneMod.Scene): typingsSlinky.babylonjs.meshMod.Mesh = js.native
  /**
    * Creates lathe mesh.
  ...
  /**
    ...
    * @returns a new Mesh
    */
  def CreatePolyhedron(name: String, options: AnonFaceColors, scene: typingsSlinky.babylonjs.sceneMod.Scene): typingsSlinky.babylonjs.meshMod.Mesh = js.native
  /**
