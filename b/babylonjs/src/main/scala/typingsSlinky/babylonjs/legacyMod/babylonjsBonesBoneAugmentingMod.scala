...
object babylonjsBonesBoneAugmentingMod {
  ...
  object Bone {
    ...
    ): typingsSlinky.babylonjs.legacyMod.babylonjsBonesBoneAugmentingMod.Bone = {
      val __obj = js.Dynamic.literal(copyAnimationRange = js.Any.fromFunction5(copyAnimationRange))
      __obj.asInstanceOf[typingsSlinky.babylonjs.legacyMod.babylonjsBonesBoneAugmentingMod.Bone]
    }
    
    @scala.inline
    implicit class BoneMutableBuilder[Self <: typingsSlinky.babylonjs.legacyMod.babylonjsBonesBoneAugmentingMod.Bone] (val x: Self) extends AnyVal {
