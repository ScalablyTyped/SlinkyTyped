...
class Camera protected ()
  extends typingsSlinky.babylonjs.indexMod.Camera {
  /**
...
object Camera {
  ...
  @js.native
  def GetConstructorFromName(`type`: String, name: String, scene: typingsSlinky.babylonjs.sceneMod.Scene): js.Function0[this.type] = js.native
  @JSImport("babylonjs/Legacy/legacy", "Camera.GetConstructorFromName")
  @js.native
  ...
  @js.native
  def Parse(parsedCamera: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene): typingsSlinky.babylonjs.cameraMod.Camera = js.native
  ...
  @js.native
  def _createDefaultParsedCamera(name: String, scene: typingsSlinky.babylonjs.sceneMod.Scene): typingsSlinky.babylonjs.cameraMod.Camera = js.native
  
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "Camera._setStereoscopicAnaglyphRigMode")
  @js.native
  def _setStereoscopicAnaglyphRigMode(camera: typingsSlinky.babylonjs.cameraMod.Camera): Unit = js.native
  
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "Camera._setStereoscopicRigMode")
  @js.native
  def _setStereoscopicRigMode(camera: typingsSlinky.babylonjs.cameraMod.Camera): Unit = js.native
  
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "Camera._setVRRigMode")
  @js.native
  def _setVRRigMode(camera: typingsSlinky.babylonjs.cameraMod.Camera, rigParams: js.Any): Unit = js.native
  
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "Camera._setWebVRRigMode")
  @js.native
  def _setWebVRRigMode(camera: typingsSlinky.babylonjs.cameraMod.Camera, rigParams: js.Any): Unit = js.native
}
