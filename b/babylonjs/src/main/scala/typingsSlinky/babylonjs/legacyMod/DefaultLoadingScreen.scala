...
@JSImport("babylonjs/Legacy/legacy", "DefaultLoadingScreen")
@js.native
class DefaultLoadingScreen protected ()
  extends typingsSlinky.babylonjs.indexMod.DefaultLoadingScreen {
  /**
...
object DefaultLoadingScreen {
  ...
  @JSImport("babylonjs/Legacy/legacy", "DefaultLoadingScreen.DefaultLogoUrl")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "DefaultLoadingScreen.DefaultSpinnerUrl")
  @js.native
