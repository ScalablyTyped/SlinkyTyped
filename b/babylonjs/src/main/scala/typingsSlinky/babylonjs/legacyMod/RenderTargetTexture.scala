...
class RenderTargetTexture protected ()
  extends typingsSlinky.babylonjs.indexMod.RenderTargetTexture {
  /**
...
object RenderTargetTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "RenderTargetTexture.REFRESHRATE_RENDER_ONCE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYFRAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYTWOFRAMES")
  @js.native
