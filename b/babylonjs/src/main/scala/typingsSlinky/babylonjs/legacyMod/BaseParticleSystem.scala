...
@JSImport("babylonjs/Legacy/legacy", "BaseParticleSystem")
@js.native
class BaseParticleSystem protected ()
  extends typingsSlinky.babylonjs.indexMod.BaseParticleSystem {
  /**
...
object BaseParticleSystem {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "BaseParticleSystem.BLENDMODE_ADD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "BaseParticleSystem.BLENDMODE_MULTIPLY")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "BaseParticleSystem.BLENDMODE_MULTIPLYADD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "BaseParticleSystem.BLENDMODE_ONEONE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "BaseParticleSystem.BLENDMODE_STANDARD")
  @js.native
