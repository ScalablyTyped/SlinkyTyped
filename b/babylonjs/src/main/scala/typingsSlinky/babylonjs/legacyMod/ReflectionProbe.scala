...
class ReflectionProbe protected ()
  extends typingsSlinky.babylonjs.indexMod.ReflectionProbe {
  /**
...
object ReflectionProbe {
  ...
  @js.native
  def Parse(parsedReflectionProbe: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.reflectionProbeMod.ReflectionProbe] = js.native
}
