...
object KhronosTextureContainer {
  ...
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer.COMPRESSED_2D")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer.COMPRESSED_3D")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer.HEADER_LEN")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer.IsValid")
  @js.native
  def IsValid(data: js.typedarray.ArrayBufferView): Boolean = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer.TEX_2D")
  @js.native
  def TEX_2D: js.Any = js.native
  @scala.inline
  def TEX_2D_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TEX_2D")(x.asInstanceOf[js.Any])
  
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer.TEX_3D")
  @js.native
