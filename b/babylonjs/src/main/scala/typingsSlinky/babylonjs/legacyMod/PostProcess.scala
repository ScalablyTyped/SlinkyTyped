...
class PostProcess protected ()
  extends typingsSlinky.babylonjs.indexMod.PostProcess {
  /**
...
object PostProcess extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedPostProcess: js.Any, scene: typingsSlinky.babylonjs.sceneMod.Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.postProcessMod.PostProcess] = js.native
}
