...
@JSImport("babylonjs/Legacy/legacy", "AssetTaskState")
@js.native
object AssetTaskState extends js.Object {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsSlinky.babylonjs.assetsManagerMod.AssetTaskState with Double] = js.native
