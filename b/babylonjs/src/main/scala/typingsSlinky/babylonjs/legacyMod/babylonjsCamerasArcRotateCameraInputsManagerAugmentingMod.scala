...
object babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod {
  ...
  object ArcRotateCameraInputsManager {
    ...
    def apply(
    ...
    ): typingsSlinky.babylonjs.legacyMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.legacyMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager]
    }
    
    @scala.inline
    implicit class ArcRotateCameraInputsManagerMutableBuilder[Self <: typingsSlinky.babylonjs.legacyMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager] (val x: Self) extends AnyVal {
