...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    @scala.inline
    def apply(): typingsSlinky.babylonjs.legacyMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.babylonjs.legacyMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture]
    }
    
    @scala.inline
    implicit class BaseTextureMutableBuilder[Self <: typingsSlinky.babylonjs.legacyMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture] (val x: Self) extends AnyVal {
