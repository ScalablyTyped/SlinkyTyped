...
class CubeMapToSphericalPolynomialTools ()
  extends typingsSlinky.babylonjs.indexMod.CubeMapToSphericalPolynomialTools
/* static members */
object CubeMapToSphericalPolynomialTools {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "CubeMapToSphericalPolynomialTools.ConvertCubeMapTextureToSphericalPolynomial")
  @js.native
  ...
  /**
    ...
    * @return The Spherical Polynomial data.
    */
  @JSImport("babylonjs/Legacy/legacy", "CubeMapToSphericalPolynomialTools.ConvertCubeMapToSphericalPolynomial")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "CubeMapToSphericalPolynomialTools.FileFaces")
  @js.native
