...
@JSImport("babylonjs/Legacy/legacy", "SharpenPostProcess")
@js.native
class SharpenPostProcess protected ()
  extends typingsSlinky.babylonjs.indexMod.SharpenPostProcess {
  /**
...
object SharpenPostProcess {
  ...
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "SharpenPostProcess._Parse")
  @js.native
  def _Parse(
