...
@js.native
class DDSTools ()
  extends typingsSlinky.babylonjs.indexMod.DDSTools
/* static members */
object DDSTools {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "DDSTools.GetDDSInfo")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "DDSTools.StoreLODInAlphaChannel")
  @js.native
  ...
  /**
    ...
    * @hidden
    */
  @JSImport("babylonjs/Legacy/legacy", "DDSTools.UploadDDSLevels")
  @js.native
  def UploadDDSLevels(
