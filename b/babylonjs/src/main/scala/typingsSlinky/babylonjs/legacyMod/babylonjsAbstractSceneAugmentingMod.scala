...
object babylonjsAbstractSceneAugmentingMod {
  ...
  object AbstractScene {
    ...
    def apply(
    ...
    ): typingsSlinky.babylonjs.legacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
      ...
      __obj.asInstanceOf[typingsSlinky.babylonjs.legacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
    }
    
    @scala.inline
    implicit class AbstractSceneMutableBuilder[Self <: typingsSlinky.babylonjs.legacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene] (val x: Self) extends AnyVal {
