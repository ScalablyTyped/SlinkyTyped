...
class ScreenSpaceReflectionPostProcess protected ()
  extends typingsSlinky.babylonjs.screenSpaceReflectionPostProcessMod.ScreenSpaceReflectionPostProcess {
  /**
...
object ScreenSpaceReflectionPostProcess {
  ...
  @js.native
  def _Parse(parsedPostProcess: js.Any, targetCamera: Camera, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.screenSpaceReflectionPostProcessMod.ScreenSpaceReflectionPostProcess = js.native
}
