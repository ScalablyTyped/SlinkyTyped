...
object pipelinesIndexMod extends js.Object {
  ...
  class DefaultRenderingPipeline ()
    extends typingsSlinky.babylonjs.defaultRenderingPipelineMod.DefaultRenderingPipeline {
  ...
  class LensRenderingPipeline protected ()
    extends typingsSlinky.babylonjs.lensRenderingPipelineMod.LensRenderingPipeline {
    /**
      * @constructor
      *
  ...
  class SSAO2RenderingPipeline protected ()
    extends typingsSlinky.babylonjs.ssao2RenderingPipelineMod.SSAO2RenderingPipeline {
    /**
      * @constructor
      * @param name The rendering pipeline name
      * @param scene The scene linked to this pipeline
  ...
  class SSAORenderingPipeline protected ()
    extends typingsSlinky.babylonjs.ssaoRenderingPipelineMod.SSAORenderingPipeline {
    /**
      * @constructor
      * @param name - The rendering pipeline name
      * @param scene - The scene linked to this pipeline
  ...
  class StandardRenderingPipeline protected ()
    extends typingsSlinky.babylonjs.standardRenderingPipelineMod.StandardRenderingPipeline {
    /**
