...
object audioSceneComponentMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      def apply(
      ...
      ): typingsSlinky.babylonjs.audioSceneComponentMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.audioSceneComponentMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.audioSceneComponentMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
