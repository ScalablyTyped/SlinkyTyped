...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    @scala.inline
    def apply(): typingsSlinky.babylonjs.texturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.babylonjs.texturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture]
    }
    
    @scala.inline
    implicit class BaseTextureMutableBuilder[Self <: typingsSlinky.babylonjs.texturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture] (val x: Self) extends AnyVal {
