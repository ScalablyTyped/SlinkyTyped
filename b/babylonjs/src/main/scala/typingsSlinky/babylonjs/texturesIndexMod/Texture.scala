...
class Texture protected ()
  extends typingsSlinky.babylonjs.textureMod.Texture {
  /**
...
object Texture extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedTexture: js.Any, scene: Scene, rootUrl: String): Nullable[typingsSlinky.babylonjs.baseTextureMod.BaseTexture] = js.native
  ...
  /** @hidden */
  def _CreateMirror(name: String, renderTargetSize: Double, scene: Scene, generateMipMaps: Boolean): typingsSlinky.babylonjs.mirrorTextureMod.MirrorTexture = js.native
  
  /** @hidden */
  def _CreateRenderTargetTexture(name: String, renderTargetSize: Double, scene: Scene, generateMipMaps: Boolean): typingsSlinky.babylonjs.renderTargetTextureMod.RenderTargetTexture = js.native
  
  /** @hidden */
  def _CubeTextureParser(jsonTexture: js.Any, scene: Scene, rootUrl: String): typingsSlinky.babylonjs.cubeTextureMod.CubeTexture = js.native
}
