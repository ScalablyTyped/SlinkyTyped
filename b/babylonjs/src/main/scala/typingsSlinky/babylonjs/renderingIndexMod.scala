...
object renderingIndexMod {
  ...
  class BoundingBoxRenderer protected ()
    extends typingsSlinky.babylonjs.boundingBoxRendererMod.BoundingBoxRenderer {
    /**
  ...
  class DepthRendererSceneComponent protected ()
    extends typingsSlinky.babylonjs.depthRendererSceneComponentMod.DepthRendererSceneComponent {
    /**
  ...
  class PrePassRendererSceneComponent protected ()
    extends typingsSlinky.babylonjs.prePassRendererSceneComponentMod.PrePassRendererSceneComponent {
    /**
      * Creates a new instance of the component for the given scene
      * @param scene Defines the scene to register the component in
      */
  ...
  class RenderingManager protected ()
    extends typingsSlinky.babylonjs.renderingManagerMod.RenderingManager {
    /**
  ...
  class UtilityLayerRenderer protected ()
    extends typingsSlinky.babylonjs.utilityLayerRendererMod.UtilityLayerRenderer {
    /**
  ...
  object babylonjsMeshesAbstractMeshAugmentingMod {
    ...
    object AbstractMesh {
      ...
      def apply(
      ...
      ): typingsSlinky.babylonjs.renderingIndexMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh = {
        ...
        __obj.asInstanceOf[typingsSlinky.babylonjs.renderingIndexMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh]
      }
      
      @scala.inline
      implicit class AbstractMeshMutableBuilder[Self <: typingsSlinky.babylonjs.renderingIndexMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setEdgesRenderer(value: Nullable[typingsSlinky.babylonjs.edgesRendererMod.EdgesRenderer]): Self = StObject.set(x, "edgesRenderer", value.asInstanceOf[js.Any])
