...
object webVRCameraMod {
  ...
  - typingsSlinky.babylonjs.webVRCameraMod.PoseControlled because var conflicts: position, rotationQuaternion. Inlined devicePosition, deviceRotationQuaternion, rawPose, deviceScaleFactor, updateFromDevice */ @JSImport("babylonjs/Cameras/VR/webVRCamera", "WebVRFreeCamera")
  @js.native
  ...
  object DevicePose {
    ...
    implicit class DevicePoseMutableBuilder[Self <: DevicePose] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAngularAcceleration(value: Nullable[js.typedarray.Float32Array]): Self = StObject.set(x, "angularAcceleration", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAngularAccelerationNull: Self = StObject.set(x, "angularAcceleration", null)
      
      @scala.inline
      def setAngularVelocity(value: Nullable[js.typedarray.Float32Array]): Self = StObject.set(x, "angularVelocity", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAngularVelocityNull: Self = StObject.set(x, "angularVelocity", null)
      
      @scala.inline
      def setLinearAcceleration(value: Nullable[js.typedarray.Float32Array]): Self = StObject.set(x, "linearAcceleration", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLinearAccelerationNull: Self = StObject.set(x, "linearAcceleration", null)
      
      @scala.inline
      def setLinearVelocity(value: Nullable[js.typedarray.Float32Array]): Self = StObject.set(x, "linearVelocity", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLinearVelocityNull: Self = StObject.set(x, "linearVelocity", null)
      
      @scala.inline
      def setOrientation(value: Nullable[js.typedarray.Float32Array]): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOrientationNull: Self = StObject.set(x, "orientation", null)
      
      @scala.inline
      def setPosition(value: Nullable[js.typedarray.Float32Array]): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
