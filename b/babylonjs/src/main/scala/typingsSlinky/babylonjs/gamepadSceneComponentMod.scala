...
object gamepadSceneComponentMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      def apply(gamepadManager: GamepadManager): typingsSlinky.babylonjs.gamepadSceneComponentMod.babylonjsSceneAugmentingMod.Scene = {
        val __obj = js.Dynamic.literal(gamepadManager = gamepadManager.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.babylonjs.gamepadSceneComponentMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typingsSlinky.babylonjs.gamepadSceneComponentMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
