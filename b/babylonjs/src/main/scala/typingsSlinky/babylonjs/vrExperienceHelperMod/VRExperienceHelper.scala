...
class VRExperienceHelper protected () extends js.Object {
  ...
  /**
    ...
    */
  def displayGaze(value: Boolean): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def displayLaserPointer(value: Boolean): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def position(value: Vector3): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def teleportationTarget(value: Mesh): js.Any = js.native
  /**
