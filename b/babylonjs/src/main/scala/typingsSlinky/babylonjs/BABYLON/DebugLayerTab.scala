...
object DebugLayerTab extends js.Object {
  ...
  /* 1 */ @js.native
  object Debug
    extends TopLevel[typingsSlinky.babylonjs.BABYLON.DebugLayerTab.Debug with Double]
  ...
  /* 3 */ @js.native
  object Tools
    extends TopLevel[typingsSlinky.babylonjs.BABYLON.DebugLayerTab.Tools with Double]
