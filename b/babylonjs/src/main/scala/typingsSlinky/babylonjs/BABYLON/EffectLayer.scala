...
import typingsSlinky.babylonjs.anon.PartialIEffectLayerOptionAlphaBlendingMode
...
trait EffectLayer extends js.Object {
  ...
  var _emissiveTextureAndColor: typingsSlinky.babylonjs.anon.Texture = js.native
