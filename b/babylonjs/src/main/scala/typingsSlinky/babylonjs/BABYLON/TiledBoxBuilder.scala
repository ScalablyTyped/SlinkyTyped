...
import typingsSlinky.babylonjs.AnonAlignVerticalDepth
...
object TiledBoxBuilder extends js.Object {
  /**
    ...
    */
  def CreateTiledBox(name: String, options: AnonAlignVerticalDepth): Mesh = js.native
  def CreateTiledBox(name: String, options: AnonAlignVerticalDepth, scene: Nullable[Scene]): Mesh = js.native
}
