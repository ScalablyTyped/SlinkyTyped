...
class WebRequest () extends IWebRequest {
  ...
  def onprogress(value: js.ThisFunction1[/* this */ XMLHttpRequest, /* ev */ ProgressEvent, _]): js.Any = js.native
  /**
    * Gets or sets a function to be called when loading progress changes
    */
  @JSName("onprogress")
  def onprogress_Union: (js.ThisFunction1[/* this */ XMLHttpRequest, /* ev */ ProgressEvent, _]) | Null = js.native
  /**
