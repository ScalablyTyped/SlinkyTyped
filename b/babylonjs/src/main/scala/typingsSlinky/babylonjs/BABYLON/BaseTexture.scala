...
trait BaseTexture
  ...
  /**
    ...
    */
  def readPixels(): Nullable[js.typedarray.ArrayBufferView] = js.native
  def readPixels(
  ...
  def readPixels(faceIndex: js.UndefOr[scala.Nothing], level: Double): Nullable[js.typedarray.ArrayBufferView] = js.native
  def readPixels(
    faceIndex: js.UndefOr[scala.Nothing],
    level: Double,
    buffer: Nullable[js.typedarray.ArrayBufferView]
  ): Nullable[js.typedarray.ArrayBufferView] = js.native
  def readPixels(faceIndex: Double): Nullable[js.typedarray.ArrayBufferView] = js.native
  def readPixels(
    faceIndex: Double,
    level: js.UndefOr[scala.Nothing],
    buffer: Nullable[js.typedarray.ArrayBufferView]
  ): Nullable[js.typedarray.ArrayBufferView] = js.native
  def readPixels(faceIndex: Double, level: Double): Nullable[js.typedarray.ArrayBufferView] = js.native
