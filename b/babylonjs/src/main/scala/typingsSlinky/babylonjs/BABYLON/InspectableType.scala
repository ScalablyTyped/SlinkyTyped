...
object InspectableType extends js.Object {
  ...
  /* 4 */ @js.native
  object Color3
    extends TopLevel[typingsSlinky.babylonjs.BABYLON.InspectableType.Color3 with Double]
  
  /* 3 */ @js.native
  object Quaternion
    extends TopLevel[typingsSlinky.babylonjs.BABYLON.InspectableType.Quaternion with Double]
  ...
  /* 2 */ @js.native
  object Vector3
    extends TopLevel[typingsSlinky.babylonjs.BABYLON.InspectableType.Vector3 with Double]
