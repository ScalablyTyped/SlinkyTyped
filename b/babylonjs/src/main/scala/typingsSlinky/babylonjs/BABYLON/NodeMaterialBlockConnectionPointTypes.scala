...
object NodeMaterialBlockConnectionPointTypes extends js.Object {
  ...
  object Color3
    extends TopLevel[
          typingsSlinky.babylonjs.BABYLON.NodeMaterialBlockConnectionPointTypes.Color3 with Double
        ]
  
  /* 64 */ @js.native
  object Color4
    extends TopLevel[
          typingsSlinky.babylonjs.BABYLON.NodeMaterialBlockConnectionPointTypes.Color4 with Double
        ]
  ...
  object Matrix
    extends TopLevel[
          typingsSlinky.babylonjs.BABYLON.NodeMaterialBlockConnectionPointTypes.Matrix with Double
        ]
  
  /* 4 */ @js.native
  object Vector2
    extends TopLevel[
          typingsSlinky.babylonjs.BABYLON.NodeMaterialBlockConnectionPointTypes.Vector2 with Double
        ]
  
  /* 8 */ @js.native
  object Vector3
    extends TopLevel[
          typingsSlinky.babylonjs.BABYLON.NodeMaterialBlockConnectionPointTypes.Vector3 with Double
        ]
  
  /* 16 */ @js.native
  object Vector4
    extends TopLevel[
          typingsSlinky.babylonjs.BABYLON.NodeMaterialBlockConnectionPointTypes.Vector4 with Double
        ]
