...
@js.native
trait MotionBlurConfiguration extends PrePassEffectConfiguration
object MotionBlurConfiguration {
  
  @scala.inline
  def apply(enabled: Boolean, name: String, texturesRequired: js.Array[Double]): MotionBlurConfiguration = {
