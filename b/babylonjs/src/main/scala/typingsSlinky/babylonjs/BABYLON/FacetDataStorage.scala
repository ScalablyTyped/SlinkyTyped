...
object FacetDataStorage {
  ...
  implicit class FacetDataStorageMutableBuilder[Self <: FacetDataStorage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDepthSortedIndicesInt32Array(value: js.typedarray.Int32Array): Self = StObject.set(x, "depthSortedIndices", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDepthSortedIndicesUint16Array(value: js.typedarray.Uint16Array): Self = StObject.set(x, "depthSortedIndices", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDepthSortedIndicesUint32Array(value: js.typedarray.Uint32Array): Self = StObject.set(x, "depthSortedIndices", value.asInstanceOf[js.Any])
