...
object Analyser {
  ...
  implicit class AnalyserOps[Self <: Analyser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetByteFrequencyData(value: () => js.typedarray.Uint8Array): Self = this.set("getByteFrequencyData", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetByteTimeDomainData(value: () => js.typedarray.Uint8Array): Self = this.set("getByteTimeDomainData", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetFloatFrequencyData(value: () => js.typedarray.Float32Array): Self = this.set("getFloatFrequencyData", js.Any.fromFunction0(value))
