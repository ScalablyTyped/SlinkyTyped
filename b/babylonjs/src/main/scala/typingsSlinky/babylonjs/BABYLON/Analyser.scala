...
object Analyser {
  ...
  implicit class AnalyserMutableBuilder[Self <: Analyser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetByteFrequencyData(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "getByteFrequencyData", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetByteTimeDomainData(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "getByteTimeDomainData", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetFloatFrequencyData(value: () => js.typedarray.Float32Array): Self = StObject.set(x, "getFloatFrequencyData", js.Any.fromFunction0(value))
