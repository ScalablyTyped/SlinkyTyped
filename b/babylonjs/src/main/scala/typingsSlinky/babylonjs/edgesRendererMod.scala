...
object edgesRendererMod {
  ...
  object babylonjsMeshesAbstractMeshAugmentingMod {
    ...
    object AbstractMesh {
      ...
      @scala.inline
      def apply(): typingsSlinky.babylonjs.edgesRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.babylonjs.edgesRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh]
      }
      
      @scala.inline
      implicit class AbstractMeshMutableBuilder[Self <: typingsSlinky.babylonjs.edgesRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh] (val x: Self) extends AnyVal {
