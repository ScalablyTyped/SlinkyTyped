package typingsSlinky.babylonjs.dataReaderMod
...
object IDataBuffer {
  ...
  implicit class IDataBufferOps[Self <: IDataBuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReadAsync(value: (Double, Double) => js.Promise[js.typedarray.ArrayBufferView]): Self = this.set("readAsync", js.Any.fromFunction2(value))
  }
}
