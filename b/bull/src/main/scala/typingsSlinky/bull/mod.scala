...
object mod {
  ...
  object AdvancedSettings {
    ...
    implicit class AdvancedSettingsMutableBuilder[Self <: AdvancedSettings] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBackoffStrategies(value: StringDictionary[js.Function2[/* attemptsMade */ Double, /* err */ js.Error, Double]]): Self = StObject.set(x, "backoffStrategies", value.asInstanceOf[js.Any])
  ...
  object CronRepeatOptions {
    ...
    implicit class CronRepeatOptionsMutableBuilder[Self <: CronRepeatOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStartDate(value: js.Date | String | Double): Self = StObject.set(x, "startDate", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object RepeatOptions {
    ...
    implicit class RepeatOptionsMutableBuilder[Self <: RepeatOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndDate(value: js.Date | String | Double): Self = StObject.set(x, "endDate", value.asInstanceOf[js.Any])
