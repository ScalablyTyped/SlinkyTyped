...
object AdvancedSettings {
  ...
  implicit class AdvancedSettingsOps[Self <: AdvancedSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackoffStrategies(value: StringDictionary[js.Function2[/* attemptsMade */ Double, /* err */ js.Error, Double]]): Self = this.set("backoffStrategies", value.asInstanceOf[js.Any])
