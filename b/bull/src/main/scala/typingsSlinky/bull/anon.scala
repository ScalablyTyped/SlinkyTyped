...
object anon {
  ...
  object AttemptsMade {
    ...
    implicit class AttemptsMadeMutableBuilder[Self <: AttemptsMade[_], T] (val x: Self with AttemptsMade[T]) extends AnyVal {
      ...
      @scala.inline
      def setId(value: typingsSlinky.bull.mod.JobId): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
  ...
  object JobId {
    ...
    implicit class JobIdMutableBuilder[Self <: JobId] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setJobId(value: typingsSlinky.bull.mod.JobId): Self = StObject.set(x, "jobId", value.asInstanceOf[js.Any])
