...
object BootboxDialogOptions {
  ...
  implicit class BootboxDialogOptionsMutableBuilder[Self <: BootboxDialogOptions[_], T] (val x: Self with BootboxDialogOptions[T]) extends AnyVal {
    ...
    @scala.inline
    def setMessageDocumentFragment(value: DocumentFragment): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMessageElement(value: Element): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMessageText(value: Text): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
