...
object BootboxDialogOptions {
  ...
  implicit class BootboxDialogOptionsOps[Self <: BootboxDialogOptions[_], T] (val x: Self with BootboxDialogOptions[T]) extends AnyVal {
    ...
    @scala.inline
    def setMessageElement(value: Element): Self = this.set("message", value.asInstanceOf[js.Any])
    @scala.inline
    def setMessageDocumentFragment(value: DocumentFragment): Self = this.set("message", value.asInstanceOf[js.Any])
    @scala.inline
    def setMessageText(value: Text): Self = this.set("message", value.asInstanceOf[js.Any])
    @scala.inline
