...
object IGeoDataPrimitive {
  ...
  implicit class IGeoDataPrimitiveOps[Self <: IGeoDataPrimitive] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNumPoints(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NumPoints")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPrimitiveID(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PrimitiveID")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
