...
object IDirectionsEventArgs {
  ...
  implicit class IDirectionsEventArgsOps[Self <: IDirectionsEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRoute(value: js.Array[IRoute]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("route")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRouteSummary(value: js.Array[IRouteSummary]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("routeSummary")(value.asInstanceOf[js.Any])
        ret
    }
  }
