...
class Polyline protected ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.Polyline {
  /**
    * @constructor
    ...
    */
  def this(locations: js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Location]) = this()
  def this(locations: js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Location], options: IPolylineOptions) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLocations(): js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Location] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getStrokeColor(): String | typingsSlinky.bingmaps.Microsoft.Maps.Color = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLocations(locations: js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Location]): Unit = js.native
  /**
