...
import typingsSlinky.bingmaps.Microsoft.Maps.ITileSourceOptions
...
class TileSource protected ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.TileSource {
  /**
    * @constructor
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBounds(): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getUriConstructor(): String | (js.Function1[/* tile */ typingsSlinky.bingmaps.Microsoft.Maps.PyramidTileId, String]) = js.native
  /**
