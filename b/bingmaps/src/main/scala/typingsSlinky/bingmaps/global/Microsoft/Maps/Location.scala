...
class Location protected ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.Location {
  /**
    * @constructor
...
object Location {
  ...
  @js.native
  def areEqual(
    location1: typingsSlinky.bingmaps.Microsoft.Maps.Location,
    location2: typingsSlinky.bingmaps.Microsoft.Maps.Location
  ): Boolean = js.native
  ...
  @js.native
  def cloneFrom(source: typingsSlinky.bingmaps.Microsoft.Maps.Location): typingsSlinky.bingmaps.Microsoft.Maps.Location = js.native
  ...
  @js.native
  def parseLatLong(str: String): typingsSlinky.bingmaps.Microsoft.Maps.Location = js.native
}
