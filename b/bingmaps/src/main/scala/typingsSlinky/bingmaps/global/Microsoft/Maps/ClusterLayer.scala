...
class ClusterLayer protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getClusterPushpinByGridKey(gridKey: Double): typingsSlinky.bingmaps.Microsoft.Maps.ClusterPushpin | typingsSlinky.bingmaps.Microsoft.Maps.Pushpin = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getDisplayedPushpins(): js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Pushpin] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPushpins(): js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Pushpin] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getPushpinsByGridKey(gridKey: Double): js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Pushpin] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setPushpins(pushpins: js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Pushpin]): Unit = js.native
}
