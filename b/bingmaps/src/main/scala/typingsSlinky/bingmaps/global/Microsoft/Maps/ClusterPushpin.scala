...
import typingsSlinky.bingmaps.Microsoft.Maps.IPrimitiveOptions
...
class ClusterPushpin ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.ClusterPushpin {
  /** An array of all the pushpins that are in the cluster. */
  /* CompleteClass */
  override var containedPushpins: js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Pushpin] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var gridKey: Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getAnchor(): typingsSlinky.bingmaps.Microsoft.Maps.Point = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getColor(): String | typingsSlinky.bingmaps.Microsoft.Maps.Color = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getTextOffset(): typingsSlinky.bingmaps.Microsoft.Maps.Point = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLocation(location: typingsSlinky.bingmaps.Microsoft.Maps.Location): Unit = js.native
  /**
