...
import typingsSlinky.bingmaps.Microsoft.Maps.IGroundOverlayOptions
...
class GroundOverlay protected ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.GroundOverlay {
  /**
    * @constructor
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBackgroundColor(): String | typingsSlinky.bingmaps.Microsoft.Maps.Color = js.native
  /**
