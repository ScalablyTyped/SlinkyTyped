...
import typingsSlinky.bingmaps.Microsoft.Maps.Search.IGeocodeRequestOptions
import typingsSlinky.bingmaps.Microsoft.Maps.Search.ReverseGeocodeRequestOptions
