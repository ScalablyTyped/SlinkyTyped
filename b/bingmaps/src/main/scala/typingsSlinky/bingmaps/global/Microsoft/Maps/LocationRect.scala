...
class LocationRect protected ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.LocationRect {
  /**
    * @constructor
    ...
    */
  def this(center: typingsSlinky.bingmaps.Microsoft.Maps.Location, width: Double, height: Double) = this()
  /** The location that defines the center of the rectangle. */
  /* CompleteClass */
  override var center: typingsSlinky.bingmaps.Microsoft.Maps.Location = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def contains(location: typingsSlinky.bingmaps.Microsoft.Maps.Location): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getNorthwest(): typingsSlinky.bingmaps.Microsoft.Maps.Location = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSoutheast(): typingsSlinky.bingmaps.Microsoft.Maps.Location = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def intersects(rect: typingsSlinky.bingmaps.Microsoft.Maps.LocationRect): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def splitByInternationalDateLine(): js.Array[typingsSlinky.bingmaps.Microsoft.Maps.LocationRect] = js.native
}
...
object LocationRect extends js.Object {
  /**
    ...
    */
  def fromCorners(
    northwest: typingsSlinky.bingmaps.Microsoft.Maps.Location,
    southeast: typingsSlinky.bingmaps.Microsoft.Maps.Location
  ): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
    ...
    */
  def fromEdges(north: Double, west: Double, south: Double, east: Double): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
    * Gets a LocationRect using a list of locations.
    * @param locations A list of locations.
    * @returns A LocationRect that encloses all the specified locations.
    */
  def fromLocations(locations: typingsSlinky.bingmaps.Microsoft.Maps.Location*): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
    * Gets a LocationRect using an array of locations.
    * @param locations An array of locations.
    * @returns A LocationRect that encloses all the specified locations.
    */
  def fromLocations(locations: js.Array[typingsSlinky.bingmaps.Microsoft.Maps.Location]): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  def fromShapes(shapes: js.Array[IPrimitive | js.Array[IPrimitive]]): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
    ...
    */
  def fromShapes(shapes: IPrimitive): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
    ...
    */
  def fromString(str: String): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
  /**
    ...
    */
  def merge(
    rect1: typingsSlinky.bingmaps.Microsoft.Maps.LocationRect,
    rect2: typingsSlinky.bingmaps.Microsoft.Maps.LocationRect
  ): typingsSlinky.bingmaps.Microsoft.Maps.LocationRect = js.native
}
