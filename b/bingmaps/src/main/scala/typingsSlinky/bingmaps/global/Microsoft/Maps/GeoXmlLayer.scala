...
import typingsSlinky.bingmaps.Microsoft.Maps.IGeoXmlLayerOptions
...
/**
  ...
  */
class GeoXmlLayer ()
  extends typingsSlinky.bingmaps.Microsoft.Maps.GeoXmlLayer {
  ...
  def this(
    dataSource: js.typedarray.ArrayBuffer,
    isUrl: js.UndefOr[scala.Nothing],
    options: IGeoXmlLayerOptions
  ) = this()
