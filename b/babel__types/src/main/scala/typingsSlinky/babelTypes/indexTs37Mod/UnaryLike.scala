...
object UnaryLike {
  ...
  @scala.inline
  def SpreadElement_(argument: Expression, `type`: SpreadElement): typingsSlinky.babelTypes.indexTs37Mod.SpreadElement_ = {
    val __obj = js.Dynamic.literal(argument = argument.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.babelTypes.indexTs37Mod.SpreadElement_]
  }
  ...
  def UnaryExpression_(
    ...
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.babelTypes.indexTs37Mod.UnaryExpression_]
  }
}
