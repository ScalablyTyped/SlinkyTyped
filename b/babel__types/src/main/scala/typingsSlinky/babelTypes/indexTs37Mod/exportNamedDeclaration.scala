...
@JSImport("@babel/types/lib/index-ts3.7", "exportNamedDeclaration")
@js.native
object exportNamedDeclaration extends js.Object {
  ...
  def apply(declaration: Null, specifiers: js.UndefOr[scala.Nothing], source: StringLiteral_): ExportNamedDeclaration_ = js.native
  def apply(
    declaration: Null,
    specifiers: js.Array[ExportSpecifier_ | ExportDefaultSpecifier_ | ExportNamespaceSpecifier_]
  ): ExportNamedDeclaration_ = js.native
