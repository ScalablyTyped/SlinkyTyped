...
object _Node {
  ...
  @scala.inline
  def YieldExpression_(delegate: js.Any, `type`: YieldExpression): _Node = {
  ...
  @scala.inline
  def Identifier_(name: js.Any, `type`: Identifier): _Node = {
  ...
  @scala.inline
  def ClassExpression_(body: ClassBody_, mixins: js.Any, `type`: ClassExpression): _Node = {
  ...
  @scala.inline
  def MetaProperty_(meta: js.Any, property: Identifier_, `type`: MetaProperty): _Node = {
  ...
  @scala.inline
  def TSLiteralType_(literal: NumericLiteral_ | StringLiteral_ | BooleanLiteral_, `type`: TSLiteralType): _Node = {
    val __obj = js.Dynamic.literal(literal = literal.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[_Node]
  }
  @scala.inline
  def TSTupleType_(elementTypes: js.Array[TSType], `type`: TSTupleType): _Node = {
  ...
  @scala.inline
  def MemberExpression_(computed: Boolean, `object`: Expression, property: js.Any, `type`: MemberExpression): _Node = {
  ...
  @scala.inline
  def TryStatement_(block: js.Any, `type`: TryStatement): _Node = {
  ...
  @scala.inline
  def TupleExpression_(elements: js.Array[Null | Expression | SpreadElement_], `type`: TupleExpression): _Node = {
    val __obj = js.Dynamic.literal(elements = elements.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[_Node]
  }
  ...
  @scala.inline
  def BindExpression_(callee: js.Any, `object`: js.Any, `type`: BindExpression): _Node = {
    val __obj = js.Dynamic.literal(callee = callee.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[_Node]
  ...
  @scala.inline
  def RegExpLiteral_(flags: js.Any, pattern: String, `type`: RegExpLiteral): _Node = {
  ...
  @scala.inline
  def File_(comments: js.Any, program: Program_, tokens: js.Any, `type`: File): _Node = {
  ...
  @scala.inline
  def TemplateElement_(tail: Boolean, `type`: TemplateElement, value: AnonCooked): _Node = {
  ...
  @scala.inline
  def RecordExpression_(properties: js.Array[ObjectProperty_ | ObjectMethod_ | SpreadElement_], `type`: RecordExpression): _Node = {
    val __obj = js.Dynamic.literal(properties = properties.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[_Node]
  }
