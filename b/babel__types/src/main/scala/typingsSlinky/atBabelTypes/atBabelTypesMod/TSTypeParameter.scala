...
trait TSTypeParameter
  ...
  var name: String
  @JSName("type")
  var type_TSTypeParameter: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeParameter
}
...
object TSTypeParameter {
  ...
  def apply(
    name: String,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeParameter,
