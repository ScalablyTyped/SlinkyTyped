...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSIndexedAccessType
  ...
  @JSName("type")
  var type_TSIndexedAccessType: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSIndexedAccessType
}
...
object TSIndexedAccessType {
  ...
  def apply(
    indexType: TSType,
    objectType: TSType,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSIndexedAccessType,
    end: Int | Double = null,
