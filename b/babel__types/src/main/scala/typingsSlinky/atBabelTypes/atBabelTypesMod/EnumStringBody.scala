...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait EnumStringBody
  ...
  @JSName("type")
  var type_EnumStringBody: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumStringBody
}
...
object EnumStringBody {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumStringBody,
    end: Int | Double = null,
