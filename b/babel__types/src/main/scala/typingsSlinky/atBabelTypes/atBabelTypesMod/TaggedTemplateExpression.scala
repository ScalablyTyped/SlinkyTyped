...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TaggedTemplateExpression
  extends Expression
     with BaseNode {
  ...
  @JSName("type")
  var type_TaggedTemplateExpression: typingsSlinky.atBabelTypes.atBabelTypesStrings.TaggedTemplateExpression
}
