...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSExpressionWithTypeArguments
  ...
  @JSName("type")
  var type_TSExpressionWithTypeArguments: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSExpressionWithTypeArguments
}
...
object TSExpressionWithTypeArguments {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSExpressionWithTypeArguments,
    end: Int | Double = null,
