...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait JSXClosingElement
  extends Immutable
     with BaseNode
     with JSX {
  var name: JSXIdentifier | JSXMemberExpression | JSXNamespacedName
  @JSName("type")
  var type_JSXClosingElement: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXClosingElement
}
...
object JSXClosingElement {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXClosingElement,
    end: Int | Double = null,
