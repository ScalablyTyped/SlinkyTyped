...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSConstructorType
  ...
  @JSName("type")
  var type_TSConstructorType: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSConstructorType
}
...
object TSConstructorType {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSConstructorType,
    end: Int | Double = null,
