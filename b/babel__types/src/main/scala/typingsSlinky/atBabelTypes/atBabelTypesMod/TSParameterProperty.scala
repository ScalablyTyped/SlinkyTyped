...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSParameterProperty
  ...
  @JSName("type")
  var type_TSParameterProperty: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSParameterProperty
}
...
object TSParameterProperty {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSParameterProperty,
