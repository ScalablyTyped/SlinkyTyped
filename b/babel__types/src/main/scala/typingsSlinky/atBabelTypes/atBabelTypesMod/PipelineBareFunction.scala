...
trait PipelineBareFunction
  ...
  @JSName("type")
  var type_PipelineBareFunction: typingsSlinky.atBabelTypes.atBabelTypesStrings.PipelineBareFunction
}
...
object PipelineBareFunction {
  ...
  def apply(
    callee: Expression,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.PipelineBareFunction,
    end: Int | Double = null,
