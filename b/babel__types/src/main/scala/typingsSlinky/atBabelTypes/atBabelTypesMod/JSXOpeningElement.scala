...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait JSXOpeningElement
  ...
  @JSName("type")
  var type_JSXOpeningElement: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXOpeningElement
}
...
object JSXOpeningElement {
  ...
  def apply(
    ...
    selfClosing: Boolean,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXOpeningElement,
    end: Int | Double = null,
