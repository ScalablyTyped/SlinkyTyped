...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSInferType
  extends TSType
     with BaseNode {
  var typeParameter: TSTypeParameter
  @JSName("type")
  var type_TSInferType: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSInferType
}

object TSInferType {
  @scala.inline
  def apply(
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSInferType,
