...
trait TSInterfaceBody
  ...
  @JSName("type")
  var type_TSInterfaceBody: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSInterfaceBody
}
...
object TSInterfaceBody {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSInterfaceBody,
    end: Int | Double = null,
