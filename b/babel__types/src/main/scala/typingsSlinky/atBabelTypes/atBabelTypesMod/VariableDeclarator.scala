...
trait VariableDeclarator
  ...
  @JSName("type")
  var type_VariableDeclarator: typingsSlinky.atBabelTypes.atBabelTypesStrings.VariableDeclarator
}
...
object VariableDeclarator {
  ...
  def apply(
    id: LVal,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.VariableDeclarator,
