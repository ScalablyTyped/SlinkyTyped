...
trait EnumDeclaration
  ...
  var id: Identifier
  @JSName("type")
  var type_EnumDeclaration: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumDeclaration
}
...
object EnumDeclaration {
  ...
  def apply(
    ...
    id: Identifier,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumDeclaration,
    end: Int | Double = null,
