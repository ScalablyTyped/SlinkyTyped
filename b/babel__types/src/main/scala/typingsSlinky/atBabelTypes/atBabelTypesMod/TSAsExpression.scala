...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSAsExpression
  extends Expression
     with BaseNode {
  var expression: Expression
  var typeAnnotation: TSType
  @JSName("type")
  var type_TSAsExpression: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSAsExpression
}
