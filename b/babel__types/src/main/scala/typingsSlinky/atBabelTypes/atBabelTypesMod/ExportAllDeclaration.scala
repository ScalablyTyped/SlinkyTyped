...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ExportAllDeclaration
  extends Declaration
     with BaseNode
  ...
  @JSName("type")
  var type_ExportAllDeclaration: typingsSlinky.atBabelTypes.atBabelTypesStrings.ExportAllDeclaration
}
