...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSImportEqualsDeclaration
  ...
  @JSName("type")
  var type_TSImportEqualsDeclaration: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSImportEqualsDeclaration
}
...
object TSImportEqualsDeclaration {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSImportEqualsDeclaration,
    end: Int | Double = null,
