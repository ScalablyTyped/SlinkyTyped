...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ExpressionStatement
  ...
  @JSName("type")
  var type_ExpressionStatement: typingsSlinky.atBabelTypes.atBabelTypesStrings.ExpressionStatement
}
...
object ExpressionStatement {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.ExpressionStatement,
    end: Int | Double = null,
