...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSPropertySignature
  ...
  @JSName("type")
  var type_TSPropertySignature: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSPropertySignature
}
...
object TSPropertySignature {
  ...
  def apply(
    key: Expression,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSPropertySignature,
