...
object EnumMember {
  ...
  def EnumBooleanMember(
    id: Identifier,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumBooleanMember,
    end: Int | Double = null,
  ...
  def EnumNumberMember(
    id: Identifier,
    init: NumericLiteral,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumNumberMember,
    end: Int | Double = null,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
  ...
  def EnumStringMember(
    id: Identifier,
    init: StringLiteral,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumStringMember,
    end: Int | Double = null,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
  ...
  def EnumDefaultedMember(
    id: Identifier,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumDefaultedMember,
    end: Int | Double = null,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
