...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ReturnStatement
  ...
  @JSName("type")
  var type_ReturnStatement: typingsSlinky.atBabelTypes.atBabelTypesStrings.ReturnStatement
}
