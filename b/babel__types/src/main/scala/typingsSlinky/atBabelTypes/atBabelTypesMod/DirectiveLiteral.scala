...
trait DirectiveLiteral
  extends BaseNode
     with _Node {
  @JSName("type")
  var type_DirectiveLiteral: typingsSlinky.atBabelTypes.atBabelTypesStrings.DirectiveLiteral
  var value: String
}
...
object DirectiveLiteral {
  @scala.inline
  def apply(
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.DirectiveLiteral,
    value: String,
    end: Int | Double = null,
