...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait WhileStatement
  extends BlockParent
     with BaseNode
     with Loop
     with Scopable
  ...
  var test: Expression
  @JSName("type")
  var type_WhileStatement: typingsSlinky.atBabelTypes.atBabelTypesStrings.WhileStatement
}
