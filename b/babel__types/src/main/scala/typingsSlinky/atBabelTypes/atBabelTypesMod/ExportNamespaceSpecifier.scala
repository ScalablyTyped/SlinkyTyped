...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ExportNamespaceSpecifier
  extends ModuleSpecifier
     with BaseNode {
  var exported: Identifier
  @JSName("type")
  var type_ExportNamespaceSpecifier: typingsSlinky.atBabelTypes.atBabelTypesStrings.ExportNamespaceSpecifier
}
