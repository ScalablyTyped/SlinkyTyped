...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSQualifiedName
  ...
  @JSName("type")
  var type_TSQualifiedName: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSQualifiedName
}
...
object TSQualifiedName {
  ...
  def apply(
    left: TSEntityName,
    right: Identifier,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSQualifiedName,
    end: Int | Double = null,
