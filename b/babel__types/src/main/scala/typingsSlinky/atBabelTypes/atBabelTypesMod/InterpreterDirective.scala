...
trait InterpreterDirective
  extends BaseNode
     with _Node {
  @JSName("type")
  var type_InterpreterDirective: typingsSlinky.atBabelTypes.atBabelTypesStrings.InterpreterDirective
  var value: String
}
...
object InterpreterDirective {
  @scala.inline
  def apply(
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.InterpreterDirective,
    value: String,
    end: Int | Double = null,
