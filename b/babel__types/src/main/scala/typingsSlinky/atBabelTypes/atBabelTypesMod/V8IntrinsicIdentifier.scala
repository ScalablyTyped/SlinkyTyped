...
trait V8IntrinsicIdentifier
  ...
  var name: String
  @JSName("type")
  var type_V8IntrinsicIdentifier: typingsSlinky.atBabelTypes.atBabelTypesStrings.V8IntrinsicIdentifier
}
...
object V8IntrinsicIdentifier {
  ...
  def apply(
    name: String,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.V8IntrinsicIdentifier,
    end: Int | Double = null,
