...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait JSXMemberExpression
  ...
  @JSName("type")
  var type_JSXMemberExpression: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXMemberExpression
}
...
object JSXMemberExpression {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXMemberExpression,
    end: Int | Double = null,
