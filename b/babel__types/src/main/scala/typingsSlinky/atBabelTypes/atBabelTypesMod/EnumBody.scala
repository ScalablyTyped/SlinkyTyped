...
object EnumBody {
  ...
  def EnumBooleanBody(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumBooleanBody,
    end: Int | Double = null,
  ...
  def EnumNumberBody(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumNumberBody,
    end: Int | Double = null,
    explicit: js.UndefOr[Boolean] = js.undefined,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
  ...
  def EnumSymbolBody(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.EnumSymbolBody,
    end: Int | Double = null,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
