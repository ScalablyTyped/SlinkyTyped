...
trait TSTypeParameterDeclaration
  ...
  @JSName("type")
  var type_TSTypeParameterDeclaration: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeParameterDeclaration
}
...
object TSTypeParameterDeclaration {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeParameterDeclaration,
    end: Int | Double = null,
