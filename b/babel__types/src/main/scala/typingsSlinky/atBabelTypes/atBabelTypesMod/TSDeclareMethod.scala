...
trait TSDeclareMethod
  ...
  @JSName("type")
  var type_TSDeclareMethod: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSDeclareMethod
}
...
object TSDeclareMethod {
  ...
  def apply(
    ...
    static: Boolean,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSDeclareMethod,
