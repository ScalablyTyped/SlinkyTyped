...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSMethodSignature
  ...
  @JSName("type")
  var type_TSMethodSignature: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSMethodSignature
}
...
object TSMethodSignature {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSMethodSignature,
