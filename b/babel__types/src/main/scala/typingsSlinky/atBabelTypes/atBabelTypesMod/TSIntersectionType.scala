...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSIntersectionType
  extends TSType
     with BaseNode {
  @JSName("type")
  var type_TSIntersectionType: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSIntersectionType
...
object TSIntersectionType {
  @scala.inline
  def apply(
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSIntersectionType,
