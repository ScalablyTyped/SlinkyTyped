...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait JSXExpressionContainer
  ...
  @JSName("type")
  var type_JSXExpressionContainer: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXExpressionContainer
}
...
object JSXExpressionContainer {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.JSXExpressionContainer,
    end: Int | Double = null,
