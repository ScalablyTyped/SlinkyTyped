...
trait TSTypeParameterInstantiation
  ...
  @JSName("type")
  var type_TSTypeParameterInstantiation: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeParameterInstantiation
}
...
object TSTypeParameterInstantiation {
  ...
  def apply(
    ...
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeParameterInstantiation,
    end: Int | Double = null,
