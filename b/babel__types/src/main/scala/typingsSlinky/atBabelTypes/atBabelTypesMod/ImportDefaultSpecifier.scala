...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ImportDefaultSpecifier
  ...
  @JSName("type")
  var type_ImportDefaultSpecifier: typingsSlinky.atBabelTypes.atBabelTypesStrings.ImportDefaultSpecifier
}
...
object ImportDefaultSpecifier {
  ...
  def apply(
    local: Identifier,
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.ImportDefaultSpecifier,
    end: Int | Double = null,
