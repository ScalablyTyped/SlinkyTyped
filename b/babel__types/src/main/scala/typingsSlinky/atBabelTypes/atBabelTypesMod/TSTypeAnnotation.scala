...
trait TSTypeAnnotation
  ...
  @JSName("type")
  var type_TSTypeAnnotation: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeAnnotation
}

object TSTypeAnnotation {
  @scala.inline
  def apply(
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeAnnotation,
