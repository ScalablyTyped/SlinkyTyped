...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait DeclareClass
  extends Declaration
     with BaseNode
     with Flow
  ...
  @JSName("type")
  var type_DeclareClass: typingsSlinky.atBabelTypes.atBabelTypesStrings.DeclareClass
}
