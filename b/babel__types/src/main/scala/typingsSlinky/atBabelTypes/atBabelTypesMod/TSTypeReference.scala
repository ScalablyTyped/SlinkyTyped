...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSTypeReference
  ...
  @JSName("type")
  var type_TSTypeReference: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeReference
}

object TSTypeReference {
  @scala.inline
  def apply(
    `type`: typingsSlinky.atBabelTypes.atBabelTypesStrings.TSTypeReference,
