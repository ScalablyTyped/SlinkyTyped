...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait FunctionTypeParam
  extends Flow
     with BaseNode {
  ...
  @JSName("type")
  var type_FunctionTypeParam: typingsSlinky.atBabelTypes.atBabelTypesStrings.FunctionTypeParam
}
