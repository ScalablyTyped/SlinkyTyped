...
import typingsSlinky.browserBunyan.anon.PartialConsoleFormattedStDef
import typingsSlinky.browserBunyan.anon.Typeofbunyan
import typingsSlinky.browserBunyan.mod.BrowserBunyan.ConsoleFormattedStreamOptions
...
object mod extends Shortcut {
  ...
  type BrowserBunyan = (Instantiable1[/* options */ LoggerOptions, typingsSlinky.bunyan.mod.^]) with Typeofbunyan with typingsSlinky.browserBunyan.anon.ConsoleFormattedStream
