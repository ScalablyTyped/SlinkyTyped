...
object ConsoleFormattedStream {
  ...
  implicit class ConsoleFormattedStreamOps[Self <: ConsoleFormattedStream] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConsoleFormattedStream(value: typingsSlinky.browserBunyan.mod.BrowserBunyan.ConsoleFormattedStream): Self = this.set("ConsoleFormattedStream", value.asInstanceOf[js.Any])
