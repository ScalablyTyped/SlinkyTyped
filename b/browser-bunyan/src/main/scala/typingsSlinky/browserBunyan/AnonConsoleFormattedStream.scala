...
trait AnonConsoleFormattedStream extends js.Object {
  var ConsoleFormattedStream: typingsSlinky.browserBunyan.mod.BrowserBunyan.ConsoleFormattedStream
  var ConsoleRawStream: typingsSlinky.browserBunyan.mod.BrowserBunyan.ConsoleRawStream
}
