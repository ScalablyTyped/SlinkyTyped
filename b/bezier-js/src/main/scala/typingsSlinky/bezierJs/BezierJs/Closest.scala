...
object Closest {
  ...
  implicit class ClosestOps[Self <: Closest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMdist(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mdist")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMpos(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mpos")(value.asInstanceOf[js.Any])
        ret
    }
  }
