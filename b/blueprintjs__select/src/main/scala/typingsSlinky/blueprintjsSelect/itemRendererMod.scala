...
object itemRendererMod {
  ...
  object IItemRendererProps {
    ...
    implicit class IItemRendererPropsMutableBuilder[Self <: IItemRendererProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHandleClick(value: SyntheticMouseEvent[HTMLElement] => Unit): Self = StObject.set(x, "handleClick", js.Any.fromFunction1(value))
  ...
  type ItemRenderer[T] = js.Function2[/* item */ T, /* itemProps */ IItemRendererProps, ReactElement | Null]
}
