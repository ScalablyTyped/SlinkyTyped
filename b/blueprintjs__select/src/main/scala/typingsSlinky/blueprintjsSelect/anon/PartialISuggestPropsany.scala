...
object PartialISuggestPropsany {
  ...
  implicit class PartialISuggestPropsanyOps[Self <: PartialISuggestPropsany] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialContentReactElement(value: ReactElement): Self = this.set("initialContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialContent(value: ReactElement): Self = this.set("initialContent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemListRenderer(value: /* itemListProps */ IItemListRendererProps[_] => ReactElement | Null): Self = this.set("itemListRenderer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setItemRenderer(value: (_, /* itemProps */ IItemRendererProps) => ReactElement | Null): Self = this.set("itemRenderer", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setNoResultsReactElement(value: ReactElement): Self = this.set("noResults", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoResults(value: ReactElement): Self = this.set("noResults", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnItemSelect(value: (/* item */ js.Any, /* event */ js.UndefOr[SyntheticEvent[Event, HTMLElement]]) => Unit): Self = this.set("onItemSelect", js.Any.fromFunction2(value))
