...
object anon {
  ...
  object PartialISuggestPropsany {
    ...
    implicit class PartialISuggestPropsanyMutableBuilder[Self <: PartialISuggestPropsany] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInitialContent(value: ReactElement): Self = StObject.set(x, "initialContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInitialContentNull: Self = StObject.set(x, "initialContent", null)
      
      @scala.inline
      def setInitialContentReactElement(value: ReactElement): Self = StObject.set(x, "initialContent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setItemListRenderer(value: /* itemListProps */ IItemListRendererProps[_] => ReactElement | Null): Self = StObject.set(x, "itemListRenderer", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setItemRenderer(value: (_, /* itemProps */ IItemRendererProps) => ReactElement | Null): Self = StObject.set(x, "itemRenderer", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setNoResults(value: ReactElement): Self = StObject.set(x, "noResults", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNoResultsReactElement(value: ReactElement): Self = StObject.set(x, "noResults", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnItemSelect(value: (/* item */ js.Any, /* event */ js.UndefOr[SyntheticEvent[Event, HTMLElement]]) => Unit): Self = StObject.set(x, "onItemSelect", js.Any.fromFunction2(value))
