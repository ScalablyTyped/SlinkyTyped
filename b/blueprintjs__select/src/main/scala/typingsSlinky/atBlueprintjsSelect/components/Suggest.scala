...
object Suggest
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsSelect.libEsmComponentsMod.Suggest[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsSelect.libEsmComponentsMod.Suggest[js.Any]] = {
  ...
  typingsSlinky.atBlueprintjsSelect.libEsmComponentsMod.Suggest[js.Any]]]
  }
