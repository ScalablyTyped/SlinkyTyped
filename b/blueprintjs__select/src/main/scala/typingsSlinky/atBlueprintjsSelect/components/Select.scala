...
object Select
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atBlueprintjsSelect.libEsmComponentsMod.Select[js.Any]] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atBlueprintjsSelect.libEsmComponentsMod.Select[js.Any]] = {
  ...
  typingsSlinky.atBlueprintjsSelect.libEsmComponentsMod.Select[js.Any]]]
  }
