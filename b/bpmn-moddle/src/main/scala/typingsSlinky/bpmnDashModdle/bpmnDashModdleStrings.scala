...
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.AdHocOrdering
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.AssociationDirection
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.ChoreographyLoopType
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.ElementType
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.EventBasedGatewayType
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.GatewayDirection
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.ItemKind
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.MultiInstanceBehaviour
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.ProcessType
import typingsSlinky.bpmnDashModdle.bpmnDashModdleMod.RelationshipDirection
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object bpmnDashModdleStrings {
  @js.native
