...
object ItemKind {
  @scala.inline
  def Information: typingsSlinky.bpmnDashModdle.bpmnDashModdleStrings.Information = this.cast("Information")
  @scala.inline
  def Physical: typingsSlinky.bpmnDashModdle.bpmnDashModdleStrings.Physical = this.cast("Physical")
  @scala.inline
