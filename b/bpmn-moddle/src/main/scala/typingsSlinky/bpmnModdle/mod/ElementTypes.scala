...
object ElementTypes {
  ...
  @scala.inline
  def apply(
    biocColonColoredEdge: ColoredEdge,
    biocColonColoredShape: ColoredShape,
    bpmnColonActivity: Activity,
    bpmnColonAdHocSubProcess: AdHocSubProcess,
    bpmnColonArtifact: Artifact,
    bpmnColonAssignment: Assignment,
    bpmnColonAssociation: Association,
    bpmnColonAuditing: Auditing,
    bpmnColonBaseElement: BaseElement,
    bpmnColonBoundaryEvent: BoundaryEvent,
    bpmnColonBusinessRuleTask: BusinessRuleTask,
    bpmnColonCallActivity: CallActivity,
    bpmnColonCallChoreography: CallChoreography,
    bpmnColonCallConversation: CallConversation,
    bpmnColonCallableElement: CallableElement,
    bpmnColonCancelEventDefinition: CancelEventDefinition,
    bpmnColonCatchEvent: CatchEvent,
    bpmnColonCategory: Category,
    bpmnColonCategoryValue: CategoryValue,
    bpmnColonChoreography: Choreography,
    bpmnColonChoreographyActivity: ChoreographyActivity,
    bpmnColonChoreographyTask: ChoreographyTask,
    bpmnColonCollaboration: Collaboration,
    bpmnColonCompensateEventDefinition: CompensateEventDefinition,
    bpmnColonComplexBehaviorDefinition: ComplexBehaviorDefinition,
    bpmnColonComplexGateway: ComplexGateway,
    bpmnColonConditionalEventDefinition: ConditionalEventDefinition,
    bpmnColonConversation: Conversation,
    bpmnColonConversationAssociation: ConversationAssociation,
    bpmnColonConversationLink: ConversationLink,
    bpmnColonConversationNode: ConversationNode,
    bpmnColonCorrelationKey: CorrelationKey,
    bpmnColonCorrelationProperty: CorrelationProperty,
    bpmnColonCorrelationPropertyBinding: CorrelationPropertyBinding,
    bpmnColonCorrelationPropertyRetrievalExpression: CorrelationPropertyRetrievalExpression,
    bpmnColonCorrelationSubscription: CorrelationSubscription,
    bpmnColonDataAssociation: DataAssociation,
    bpmnColonDataInput: DataInput,
    bpmnColonDataInputAssociation: DataInputAssociation,
    bpmnColonDataObject: DataObject,
    bpmnColonDataObjectReference: DataObjectReference,
    bpmnColonDataOutput: DataOutput,
    bpmnColonDataOutputAssociation: DataOutputAssociation,
    bpmnColonDataState: DataState,
    bpmnColonDataStore: DataStore,
    bpmnColonDataStoreReference: DataStoreReference,
    bpmnColonDefinitions: Definitions,
    bpmnColonDocumentation: Documentation,
    bpmnColonEndEvent: EndEvent,
    bpmnColonEndPoint: EndPoint,
    bpmnColonError: ErrorElement,
    bpmnColonErrorEventDefinition: ErrorEventDefinition,
    bpmnColonEscalation: Escalation,
    bpmnColonEscalationEventDefinition: EscalationEventDefinition,
    bpmnColonEvent: Event,
    bpmnColonEventBasedGateway: EventBasedGateway,
    bpmnColonEventDefinition: EventDefinition,
    bpmnColonExclusiveGateway: ExclusiveGateway,
    bpmnColonExpression: Expression,
    bpmnColonExtension: Extension,
    bpmnColonExtensionAttributeDefinition: ExtensionAttributeDefinition,
    bpmnColonExtensionDefinition: ExtensionDefinition,
    bpmnColonExtensionElements: ExtensionElements,
    bpmnColonFlowElement: FlowElement,
    bpmnColonFlowElementsContainer: FlowElementsContainer,
    bpmnColonFlowNode: FlowNode,
    bpmnColonFormalExpression: FormalExpression,
    bpmnColonGateway: Gateway,
    bpmnColonGlobalBusinessRuleTask: GlobalBusinessRuleTask,
    bpmnColonGlobalChoreographyTask: GlobalChoreographyTask,
    bpmnColonGlobalConversation: GlobalConversation,
    bpmnColonGlobalManualTask: GlobalManualTask,
    bpmnColonGlobalScriptTask: GlobalScriptTask,
    bpmnColonGlobalTask: GlobalTask,
    bpmnColonGlobalUserTask: GlobalUserTask,
    bpmnColonGroup: Group,
    bpmnColonHumanPerformer: HumanPerformer,
    bpmnColonImplicitThrowEvent: ImplicitThrowEvent,
    bpmnColonImport: Import,
    bpmnColonInclusiveGateway: InclusiveGateway,
    bpmnColonInputOutputBinding: InputOutputBinding,
    bpmnColonInputOutputSpecification: InputOutputSpecification,
    bpmnColonInputSet: InputSet,
    bpmnColonInteractionNode: InteractionNode,
    bpmnColonInterface: Interface,
    bpmnColonIntermediateCatchEvent: IntermediateCatchEvent,
    bpmnColonIntermediateThrowEvent: IntermediateThrowEvent,
    bpmnColonItemAwareElement: ItemAwareElement,
    bpmnColonItemDefinition: ItemDefinition,
    bpmnColonLane: Lane,
    bpmnColonLaneSet: LaneSet,
    bpmnColonLinkEventDefinition: LinkEventDefinition,
    bpmnColonLoopCharacteristics: LoopCharacteristics,
    bpmnColonManualTask: ManualTask,
    bpmnColonMessage: Message,
    bpmnColonMessageEventDefinition: MessageEventDefinition,
    bpmnColonMessageFlow: MessageFlow,
    bpmnColonMessageFlowAssociation: MessageFlowAssociation,
    bpmnColonMonitoring: Monitoring,
    bpmnColonMultiInstanceLoopCharacteristics: MultiInstanceLoopCharacteristics,
    bpmnColonOperation: Operation,
    bpmnColonOutputSet: OutputSet,
    bpmnColonParallelGateway: ParallelGateway,
    bpmnColonParticipant: Participant,
    bpmnColonParticipantAssociation: ParticipantAssociation,
    bpmnColonParticipantMultiplicity: ParticipantMultiplicity,
    bpmnColonPartnerEntity: PartnerEntity,
    bpmnColonPartnerRole: PartnerRole,
    bpmnColonPerformer: Performer,
    bpmnColonPotentialOwner: PotentialOwner,
    bpmnColonProcess: Process,
    bpmnColonProperty: Property,
    bpmnColonReceiveTask: ReceiveTask,
    bpmnColonRelationship: Relationship,
    bpmnColonRendering: Rendering,
    bpmnColonResource: Resource,
    bpmnColonResourceAssignmentExpression: ResourceAssignmentExpression,
    bpmnColonResourceParameter: ResourceParameter,
    bpmnColonResourceParameterBinding: ResourceParameterBinding,
    bpmnColonResourceRole: ResourceRole,
    bpmnColonRootElement: RootElement,
    bpmnColonScriptTask: ScriptTask,
    bpmnColonSendTask: SendTask,
    bpmnColonSequenceFlow: SequenceFlow,
    bpmnColonServiceTask: ServiceTask,
    bpmnColonSignal: Signal,
    bpmnColonSignalEventDefinition: SignalEventDefinition,
    bpmnColonStandardLoopCharacteristics: StandardLoopCharacteristics,
    bpmnColonStartEvent: StartEvent,
    bpmnColonSubChoreography: SubChoreography,
    bpmnColonSubConversation: SubConversation,
    bpmnColonSubProcess: SubProcess,
    bpmnColonTask: Task,
    bpmnColonTerminateEventDefinition: TerminateEventDefinition,
    bpmnColonTextAnnotation: TextAnnotation,
    bpmnColonThrowEvent: ThrowEvent,
    bpmnColonTimerEventDefinition: TimerEventDefinition,
    bpmnColonTransaction: Transaction,
    bpmnColonUserTask: UserTask,
    bpmndiColonBPMNDiagram: BPMNDiagram,
    bpmndiColonBPMNEdge: BPMNEdge,
    bpmndiColonBPMNLabel: BPMNLabel,
    bpmndiColonBPMNLabelStyle: BPMNLabelStyle,
    bpmndiColonBPMNPlane: BPMNPlane,
    bpmndiColonBPMNShape: BPMNShape,
    ...
    diColonDiagram: Diagram,
    diColonDiagramElement: DiagramElement,
    diColonEdge: Edge,
    diColonExtension: Extension,
    diColonLabel: Label,
    diColonLabeledEdge: LabeledEdge,
    diColonLabeledShape: LabeledShape,
    diColonNode: Node,
    diColonPlane: Plane,
    diColonShape: Shape,
    diColonStyle: Style
    ...
    __obj.updateDynamic("bioc:ColoredEdge")(biocColonColoredEdge.asInstanceOf[js.Any])
    __obj.updateDynamic("bioc:ColoredShape")(biocColonColoredShape.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Activity")(bpmnColonActivity.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:AdHocSubProcess")(bpmnColonAdHocSubProcess.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Artifact")(bpmnColonArtifact.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Assignment")(bpmnColonAssignment.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Association")(bpmnColonAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Auditing")(bpmnColonAuditing.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:BaseElement")(bpmnColonBaseElement.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:BoundaryEvent")(bpmnColonBoundaryEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:BusinessRuleTask")(bpmnColonBusinessRuleTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CallActivity")(bpmnColonCallActivity.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CallChoreography")(bpmnColonCallChoreography.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CallConversation")(bpmnColonCallConversation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CallableElement")(bpmnColonCallableElement.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CancelEventDefinition")(bpmnColonCancelEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CatchEvent")(bpmnColonCatchEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Category")(bpmnColonCategory.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CategoryValue")(bpmnColonCategoryValue.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Choreography")(bpmnColonChoreography.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ChoreographyActivity")(bpmnColonChoreographyActivity.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ChoreographyTask")(bpmnColonChoreographyTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Collaboration")(bpmnColonCollaboration.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CompensateEventDefinition")(bpmnColonCompensateEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ComplexBehaviorDefinition")(bpmnColonComplexBehaviorDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ComplexGateway")(bpmnColonComplexGateway.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ConditionalEventDefinition")(bpmnColonConditionalEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Conversation")(bpmnColonConversation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ConversationAssociation")(bpmnColonConversationAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ConversationLink")(bpmnColonConversationLink.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ConversationNode")(bpmnColonConversationNode.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CorrelationKey")(bpmnColonCorrelationKey.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CorrelationProperty")(bpmnColonCorrelationProperty.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CorrelationPropertyBinding")(bpmnColonCorrelationPropertyBinding.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CorrelationPropertyRetrievalExpression")(bpmnColonCorrelationPropertyRetrievalExpression.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:CorrelationSubscription")(bpmnColonCorrelationSubscription.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataAssociation")(bpmnColonDataAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataInput")(bpmnColonDataInput.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataInputAssociation")(bpmnColonDataInputAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataObject")(bpmnColonDataObject.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataObjectReference")(bpmnColonDataObjectReference.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataOutput")(bpmnColonDataOutput.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataOutputAssociation")(bpmnColonDataOutputAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataState")(bpmnColonDataState.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataStore")(bpmnColonDataStore.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:DataStoreReference")(bpmnColonDataStoreReference.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Definitions")(bpmnColonDefinitions.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Documentation")(bpmnColonDocumentation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:EndEvent")(bpmnColonEndEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:EndPoint")(bpmnColonEndPoint.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Error")(bpmnColonError.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ErrorEventDefinition")(bpmnColonErrorEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Escalation")(bpmnColonEscalation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:EscalationEventDefinition")(bpmnColonEscalationEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Event")(bpmnColonEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:EventBasedGateway")(bpmnColonEventBasedGateway.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:EventDefinition")(bpmnColonEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ExclusiveGateway")(bpmnColonExclusiveGateway.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Expression")(bpmnColonExpression.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Extension")(bpmnColonExtension.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ExtensionAttributeDefinition")(bpmnColonExtensionAttributeDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ExtensionDefinition")(bpmnColonExtensionDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ExtensionElements")(bpmnColonExtensionElements.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:FlowElement")(bpmnColonFlowElement.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:FlowElementsContainer")(bpmnColonFlowElementsContainer.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:FlowNode")(bpmnColonFlowNode.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:FormalExpression")(bpmnColonFormalExpression.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Gateway")(bpmnColonGateway.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalBusinessRuleTask")(bpmnColonGlobalBusinessRuleTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalChoreographyTask")(bpmnColonGlobalChoreographyTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalConversation")(bpmnColonGlobalConversation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalManualTask")(bpmnColonGlobalManualTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalScriptTask")(bpmnColonGlobalScriptTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalTask")(bpmnColonGlobalTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:GlobalUserTask")(bpmnColonGlobalUserTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Group")(bpmnColonGroup.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:HumanPerformer")(bpmnColonHumanPerformer.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ImplicitThrowEvent")(bpmnColonImplicitThrowEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Import")(bpmnColonImport.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:InclusiveGateway")(bpmnColonInclusiveGateway.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:InputOutputBinding")(bpmnColonInputOutputBinding.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:InputOutputSpecification")(bpmnColonInputOutputSpecification.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:InputSet")(bpmnColonInputSet.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:InteractionNode")(bpmnColonInteractionNode.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Interface")(bpmnColonInterface.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:IntermediateCatchEvent")(bpmnColonIntermediateCatchEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:IntermediateThrowEvent")(bpmnColonIntermediateThrowEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ItemAwareElement")(bpmnColonItemAwareElement.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ItemDefinition")(bpmnColonItemDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Lane")(bpmnColonLane.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:LaneSet")(bpmnColonLaneSet.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:LinkEventDefinition")(bpmnColonLinkEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:LoopCharacteristics")(bpmnColonLoopCharacteristics.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ManualTask")(bpmnColonManualTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Message")(bpmnColonMessage.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:MessageEventDefinition")(bpmnColonMessageEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:MessageFlow")(bpmnColonMessageFlow.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:MessageFlowAssociation")(bpmnColonMessageFlowAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Monitoring")(bpmnColonMonitoring.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:MultiInstanceLoopCharacteristics")(bpmnColonMultiInstanceLoopCharacteristics.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Operation")(bpmnColonOperation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:OutputSet")(bpmnColonOutputSet.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ParallelGateway")(bpmnColonParallelGateway.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Participant")(bpmnColonParticipant.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ParticipantAssociation")(bpmnColonParticipantAssociation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ParticipantMultiplicity")(bpmnColonParticipantMultiplicity.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:PartnerEntity")(bpmnColonPartnerEntity.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:PartnerRole")(bpmnColonPartnerRole.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Performer")(bpmnColonPerformer.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:PotentialOwner")(bpmnColonPotentialOwner.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Process")(bpmnColonProcess.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Property")(bpmnColonProperty.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ReceiveTask")(bpmnColonReceiveTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Relationship")(bpmnColonRelationship.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Rendering")(bpmnColonRendering.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Resource")(bpmnColonResource.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ResourceAssignmentExpression")(bpmnColonResourceAssignmentExpression.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ResourceParameter")(bpmnColonResourceParameter.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ResourceParameterBinding")(bpmnColonResourceParameterBinding.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ResourceRole")(bpmnColonResourceRole.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:RootElement")(bpmnColonRootElement.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ScriptTask")(bpmnColonScriptTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:SendTask")(bpmnColonSendTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:SequenceFlow")(bpmnColonSequenceFlow.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ServiceTask")(bpmnColonServiceTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Signal")(bpmnColonSignal.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:SignalEventDefinition")(bpmnColonSignalEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:StandardLoopCharacteristics")(bpmnColonStandardLoopCharacteristics.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:StartEvent")(bpmnColonStartEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:SubChoreography")(bpmnColonSubChoreography.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:SubConversation")(bpmnColonSubConversation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:SubProcess")(bpmnColonSubProcess.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Task")(bpmnColonTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:TerminateEventDefinition")(bpmnColonTerminateEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:TextAnnotation")(bpmnColonTextAnnotation.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:ThrowEvent")(bpmnColonThrowEvent.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:TimerEventDefinition")(bpmnColonTimerEventDefinition.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:Transaction")(bpmnColonTransaction.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmn:UserTask")(bpmnColonUserTask.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmndi:BPMNDiagram")(bpmndiColonBPMNDiagram.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmndi:BPMNEdge")(bpmndiColonBPMNEdge.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmndi:BPMNLabel")(bpmndiColonBPMNLabel.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmndi:BPMNLabelStyle")(bpmndiColonBPMNLabelStyle.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmndi:BPMNPlane")(bpmndiColonBPMNPlane.asInstanceOf[js.Any])
    __obj.updateDynamic("bpmndi:BPMNShape")(bpmndiColonBPMNShape.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:Bounds")(dcColonBounds.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:Font")(dcColonFont.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:Point")(dcColonPoint.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:Real")(dcColonReal.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:boolean")(dcColonboolean.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:number")(dcColonnumber.asInstanceOf[js.Any])
    __obj.updateDynamic("dc:string")(dcColonstring.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Diagram")(diColonDiagram.asInstanceOf[js.Any])
    __obj.updateDynamic("di:DiagramElement")(diColonDiagramElement.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Edge")(diColonEdge.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Extension")(diColonExtension.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Label")(diColonLabel.asInstanceOf[js.Any])
    __obj.updateDynamic("di:LabeledEdge")(diColonLabeledEdge.asInstanceOf[js.Any])
    __obj.updateDynamic("di:LabeledShape")(diColonLabeledShape.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Node")(diColonNode.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Plane")(diColonPlane.asInstanceOf[js.Any])
    __obj.updateDynamic("di:Shape")(diColonShape.asInstanceOf[js.Any])
