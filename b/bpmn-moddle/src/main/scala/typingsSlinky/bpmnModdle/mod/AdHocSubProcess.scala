...
object AdHocSubProcess {
  ...
  implicit class AdHocSubProcessOps[Self <: AdHocSubProcess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCancelRemainingInstances(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cancelRemainingInstances")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOrdering(value: AdHocOrdering): Self = {
        val ret = this.duplicate
