...
import typingsSlinky.bpmnModdle.mod.AdHocOrdering
import typingsSlinky.bpmnModdle.mod.AssociationDirection
import typingsSlinky.bpmnModdle.mod.ChoreographyLoopType
import typingsSlinky.bpmnModdle.mod.ElementType
import typingsSlinky.bpmnModdle.mod.EventBasedGatewayType
import typingsSlinky.bpmnModdle.mod.GatewayDirection
import typingsSlinky.bpmnModdle.mod.ItemKind
import typingsSlinky.bpmnModdle.mod.MultiInstanceBehaviour
import typingsSlinky.bpmnModdle.mod.ProcessType
import typingsSlinky.bpmnModdle.mod.RelationshipDirection
