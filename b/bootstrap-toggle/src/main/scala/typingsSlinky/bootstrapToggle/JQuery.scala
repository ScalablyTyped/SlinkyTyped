...
import typingsSlinky.bootstrapToggle.bootstrapToggleStrings.destroy
import typingsSlinky.bootstrapToggle.bootstrapToggleStrings.disable
import typingsSlinky.bootstrapToggle.bootstrapToggleStrings.enable
