...
object mod {
  ...
  object JSONErrorOptions {
    ...
    implicit class JSONErrorOptionsMutableBuilder[Self <: JSONErrorOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormat(value: (/* err */ js.Error, /* obj */ js.Any) => _): Self = StObject.set(x, "format", js.Any.fromFunction2(value))
      
      @scala.inline
      def setFormatUndefined: Self = StObject.set(x, "format", js.undefined)
      
      @scala.inline
      def setPostFormat(value: (/* err */ js.Error, /* obj */ js.Any) => _): Self = StObject.set(x, "postFormat", js.Any.fromFunction2(value))
      
      @scala.inline
      def setPostFormatUndefined: Self = StObject.set(x, "postFormat", js.undefined)
      
      @scala.inline
      def setPreFormat(value: /* err */ js.Error => _): Self = StObject.set(x, "preFormat", js.Any.fromFunction1(value))
