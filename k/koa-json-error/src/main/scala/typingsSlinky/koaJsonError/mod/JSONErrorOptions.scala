...
object JSONErrorOptions {
  ...
  implicit class JSONErrorOptionsOps[Self <: JSONErrorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: (/* err */ js.Error, /* obj */ js.Any) => _): Self = this.set("format", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteFormat: Self = this.set("format", js.undefined)
    
    @scala.inline
    def setPostFormat(value: (/* err */ js.Error, /* obj */ js.Any) => _): Self = this.set("postFormat", js.Any.fromFunction2(value))
    
    @scala.inline
    def deletePostFormat: Self = this.set("postFormat", js.undefined)
    
    @scala.inline
    def setPreFormat(value: /* err */ js.Error => _): Self = this.set("preFormat", js.Any.fromFunction1(value))
