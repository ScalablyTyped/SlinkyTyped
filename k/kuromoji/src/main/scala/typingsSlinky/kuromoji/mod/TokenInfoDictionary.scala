...
object TokenInfoDictionary {
  ...
  implicit class TokenInfoDictionaryOps[Self <: TokenInfoDictionary] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLoadDictionary(value: js.typedarray.Uint8Array => TokenInfoDictionary): Self = this.set("loadDictionary", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLoadPosVector(value: js.typedarray.Uint8Array => TokenInfoDictionary): Self = this.set("loadPosVector", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLoadTargetMap(value: js.typedarray.Uint8Array => TokenInfoDictionary): Self = this.set("loadTargetMap", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPut(value: (Double, Double, Double, String, String) => Double): Self = this.set("put", js.Any.fromFunction5(value))
    
    @scala.inline
    def setTargetMapToBuffer(value: () => js.typedarray.Uint8Array): Self = this.set("targetMapToBuffer", js.Any.fromFunction0(value))
  }
}
