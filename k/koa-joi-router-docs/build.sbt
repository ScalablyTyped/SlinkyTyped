...
version := "1.0-dt-20191104Z-10919a"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "co-body" % "0.0-unknown-dt-20190322Z-b8f94f",
  ...
  "org.scalablytyped.slinky" %%% "koa-joi-router" % "5.2-dt-20191107Z-4406f7",
  ...
  "org.scalablytyped.slinky" %%% "qs" % "6.9-dt-20191107Z-cd553d",
