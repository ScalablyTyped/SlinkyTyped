...
version := "1.0-dt-20191104Z-356eaf"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "co-body" % "0.0-unknown-dt-20200226Z-efdeb6",
  ...
  "org.scalablytyped.slinky" %%% "koa-joi-router" % "5.2-dt-20191107Z-4a801b",
  ...
  "org.scalablytyped.slinky" %%% "qs" % "6.9-dt-20200225Z-b472fd",
