...
version := "1.0-dt-20191104Z-7c1fa7"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "co-body" % "5.1-dt-20200427Z-57ca16",
  ...
  "org.scalablytyped.slinky" %%% "koa-joi-router" % "5.2-dt-20191107Z-d5dee8",
