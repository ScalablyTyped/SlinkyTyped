...
name := "koa-webpack"
version := "5.0-dt-20200515Z-b68d05"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "webpack-dev-middleware" % "3.7-dt-20200515Z-313961",
  "org.scalablytyped.slinky" %%% "webpack-hot-client" % "4.1-dt-20200225Z-ee858b",
