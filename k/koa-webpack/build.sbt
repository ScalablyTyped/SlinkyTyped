...
name := "koa-webpack"
version := "6.0-dt-20200831Z-e310de"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "webpack-dev-middleware" % "3.7-dt-20200818Z-51fa94",
  "org.scalablytyped.slinky" %%% "webpack-hot-client" % "4.1-dt-20200225Z-6ac77d",
