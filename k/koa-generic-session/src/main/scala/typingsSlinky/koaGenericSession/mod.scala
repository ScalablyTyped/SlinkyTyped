...
object mod {
  ...
  object SessionOptions {
    ...
    implicit class SessionOptionsMutableBuilder[Self <: SessionOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrorHandler(value: (/* error */ js.Error, /* type */ String, /* ctx */ Context) => Unit): Self = StObject.set(x, "errorHandler", js.Any.fromFunction3(value))
  ...
  object koaAugmentingMod {
    ...
    object Context {
      ...
      @scala.inline
      def apply(regenerateSession: () => Generator[_, _, _]): typingsSlinky.koaGenericSession.mod.koaAugmentingMod.Context = {
        val __obj = js.Dynamic.literal(regenerateSession = js.Any.fromFunction0(regenerateSession))
        __obj.asInstanceOf[typingsSlinky.koaGenericSession.mod.koaAugmentingMod.Context]
      }
      
      @scala.inline
      implicit class ContextMutableBuilder[Self <: typingsSlinky.koaGenericSession.mod.koaAugmentingMod.Context] (val x: Self) extends AnyVal {
