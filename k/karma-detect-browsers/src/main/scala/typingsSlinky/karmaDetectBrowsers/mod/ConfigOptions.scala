...
object ConfigOptions {
  ...
  implicit class ConfigOptionsOps[Self <: ConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetectBrowsers(value: KarmaDetectBrowsers): Self = this.set("detectBrowsers", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDetectBrowsers: Self = this.set("detectBrowsers", js.undefined)
  }
}
