...
object ResolvedData {
  ...
  @scala.inline
  def apply[FieldNames /* <: String */](resolvedData: KeyValues[FieldNames, _]): ResolvedData[FieldNames] = {
    val __obj = js.Dynamic.literal(resolvedData = resolvedData.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResolvedData[FieldNames]]
  }
  
  @scala.inline
  implicit class ResolvedDataOps[Self <: ResolvedData[_], FieldNames /* <: String */] (val x: Self with ResolvedData[FieldNames]) extends AnyVal {
