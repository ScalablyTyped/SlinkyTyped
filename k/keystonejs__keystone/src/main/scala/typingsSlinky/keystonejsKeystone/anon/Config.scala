...
object Config {
  ...
  @scala.inline
  def apply[ListNames /* <: String */](list: ListNames, `type`: BaseAuthStrategy): Config[ListNames] = {
  ...
  @scala.inline
  implicit class ConfigOps[Self <: Config[_], ListNames /* <: String */] (val x: Self with Config[ListNames]) extends AnyVal {
