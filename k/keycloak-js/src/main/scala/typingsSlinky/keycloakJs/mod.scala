...
import typingsSlinky.keycloakJs.anon.RedirectUri
import typingsSlinky.keycloakJs.keycloakJsStrings.S256
import typingsSlinky.keycloakJs.keycloakJsStrings.`cordova-native`
import typingsSlinky.keycloakJs.keycloakJsStrings.cancelled
import typingsSlinky.keycloakJs.keycloakJsStrings.cordova
import typingsSlinky.keycloakJs.keycloakJsStrings.default
import typingsSlinky.keycloakJs.keycloakJsStrings.error
import typingsSlinky.keycloakJs.keycloakJsStrings.login
import typingsSlinky.keycloakJs.keycloakJsStrings.none
import typingsSlinky.keycloakJs.keycloakJsStrings.success
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.keycloakJs.keycloakJsStrings.standard
    - typingsSlinky.keycloakJs.keycloakJsStrings.`implicit`
    - typingsSlinky.keycloakJs.keycloakJsStrings.hybrid
  */
  trait KeycloakFlow extends StObject
  object KeycloakFlow {
    
    @scala.inline
    def hybrid: typingsSlinky.keycloakJs.keycloakJsStrings.hybrid = "hybrid".asInstanceOf[typingsSlinky.keycloakJs.keycloakJsStrings.hybrid]
    
    @scala.inline
    def `implicit`: typingsSlinky.keycloakJs.keycloakJsStrings.`implicit` = "implicit".asInstanceOf[typingsSlinky.keycloakJs.keycloakJsStrings.`implicit`]
    
    @scala.inline
    def standard: typingsSlinky.keycloakJs.keycloakJsStrings.standard = "standard".asInstanceOf[typingsSlinky.keycloakJs.keycloakJsStrings.standard]
  }
  ...
  */
  ...
  object KeycloakResponseMode {
    ...
    @scala.inline
    def fragment: typingsSlinky.keycloakJs.keycloakJsStrings.fragment = "fragment".asInstanceOf[typingsSlinky.keycloakJs.keycloakJsStrings.fragment]
    
    @scala.inline
    def query: typingsSlinky.keycloakJs.keycloakJsStrings.query = "query".asInstanceOf[typingsSlinky.keycloakJs.keycloakJsStrings.query]
  }
