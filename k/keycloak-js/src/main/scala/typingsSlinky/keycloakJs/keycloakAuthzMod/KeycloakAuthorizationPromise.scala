...
object KeycloakAuthorizationPromise {
  ...
  implicit class KeycloakAuthorizationPromiseOps[Self <: KeycloakAuthorizationPromise] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withThen(value: (js.Function1[/* rpt */ String, Unit], js.Function0[Unit], js.Function0[Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("then")(js.Any.fromFunction3(value))
        ret
    }
  }
