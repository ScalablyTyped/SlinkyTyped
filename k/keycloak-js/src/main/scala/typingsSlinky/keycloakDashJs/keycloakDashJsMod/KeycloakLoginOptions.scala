...
import typingsSlinky.keycloakDashJs.keycloakDashJsStrings.login
import typingsSlinky.keycloakDashJs.keycloakDashJsStrings.none
import typingsSlinky.keycloakDashJs.keycloakDashJsStrings.register
