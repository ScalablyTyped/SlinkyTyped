...
import typingsSlinky.knockoutPaging.anon.Element
...
object KnockoutComponentTypes {
  ...
  object Config {
    ...
    implicit class ConfigMutableBuilder[Self <: Config] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTemplateDocumentFragment(value: DocumentFragment): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
