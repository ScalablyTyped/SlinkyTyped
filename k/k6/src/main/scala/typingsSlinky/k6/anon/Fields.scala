...
object Fields {
  @scala.inline
  def apply[/* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT](): Fields[RT] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Fields[RT]]
  }
  @scala.inline
  implicit class FieldsOps[Self <: Fields[_], /* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT] (val x: Self with Fields[RT]) extends AnyVal {
    @scala.inline
