...
object Params {
  @scala.inline
  def apply[/* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT](): Params[RT] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Params[RT]]
  }
  @scala.inline
  implicit class ParamsOps[Self <: Params[_], /* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT] (val x: Self with Params[RT]) extends AnyVal {
    @scala.inline
