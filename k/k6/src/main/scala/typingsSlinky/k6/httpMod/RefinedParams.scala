...
object RefinedParams {
  @scala.inline
  def apply[/* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT](): RefinedParams[RT] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RefinedParams[RT]]
  }
  @scala.inline
  implicit class RefinedParamsOps[Self <: RefinedParams[_], /* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT] (val x: Self with RefinedParams[RT]) extends AnyVal {
    @scala.inline
