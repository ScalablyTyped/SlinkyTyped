...
import typingsSlinky.k6.AnonBlocked
import typingsSlinky.k6.AnonBody
import typingsSlinky.k6.AnonFields
import typingsSlinky.k6.AnonNextupdate
import typingsSlinky.k6.AnonParams
