...
import typingsSlinky.k6.anon.Blocked
import typingsSlinky.k6.anon.Body
import typingsSlinky.k6.anon.Fields
import typingsSlinky.k6.anon.Nextupdate
import typingsSlinky.k6.htmlMod.Selection
import typingsSlinky.k6.mod.JSONValue
...
trait Response extends js.Object {
  ...
  def clickLink[RT /* <: js.UndefOr[ResponseType] */](args: typingsSlinky.k6.anon.Params[RT]): RefinedResponse[RT] = js.native
  /**
