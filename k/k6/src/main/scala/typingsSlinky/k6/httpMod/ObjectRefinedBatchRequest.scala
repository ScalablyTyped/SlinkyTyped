...
object ObjectRefinedBatchRequest {
  @scala.inline
  def apply[/* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT](method: String, url: String): ObjectRefinedBatchRequest[RT] = {
    val __obj = js.Dynamic.literal(method = method.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[ObjectRefinedBatchRequest[RT]]
  }
  @scala.inline
  implicit class ObjectRefinedBatchRequestOps[Self <: ObjectRefinedBatchRequest[_], /* <: js.UndefOr[typingsSlinky.k6.httpMod.ResponseType] */ RT] (val x: Self with ObjectRefinedBatchRequest[RT]) extends AnyVal {
    @scala.inline
