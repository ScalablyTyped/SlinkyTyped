...
object global {
  ...
  object fixture {
    ...
    @scala.inline
    def el_=(x: HTMLElement): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("el")(x.asInstanceOf[js.Any])
    
    @JSGlobal("fixture.json")
    @js.native
    def json: js.Array[js.Any] = js.native
    @scala.inline
    def json_=(x: js.Array[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("json")(x.asInstanceOf[js.Any])
    
    @JSGlobal("fixture.load")
    @js.native
