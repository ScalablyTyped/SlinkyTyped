package typingsSlinky.keya.outCoreStoreMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.keya.Anon_Key
...
abstract class default protected () extends Store {
  ...
  /* CompleteClass */
  override def all(): js.Promise[js.Array[Anon_Key]] = js.native
  /* CompleteClass */
  override def clear(): js.Promise[Unit] = js.native
  /* CompleteClass */
  override def delete(key: String): js.Promise[Boolean] = js.native
  /* CompleteClass */
  override def find(finder: js.Function2[/* value */ js.Any, /* name */ String, js.Promise[Boolean] | Boolean]): js.Promise[js.Array[Anon_Key]] = js.native
  /* CompleteClass */
