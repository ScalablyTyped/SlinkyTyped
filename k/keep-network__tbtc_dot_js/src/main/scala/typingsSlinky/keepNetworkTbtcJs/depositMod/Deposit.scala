...
import typingsSlinky.keepNetworkTbtcJs.anon.Confirmations
import typingsSlinky.keepNetworkTbtcJs.anon.Digest
...
import typingsSlinky.keepNetworkTbtcJs.commonTypesMod.KeyPoint
...
trait Deposit extends DepositBaseClass {
  ...
  def getCurrentRedemption(): js.Promise[typingsSlinky.keepNetworkTbtcJs.redemptionMod.default | Null] = js.native
  ...
  def requestRedemption(redeemerAddress: String): js.Promise[typingsSlinky.keepNetworkTbtcJs.redemptionMod.default] = js.native
