...
object mod {
  ...
  object StorageEngine {
    ...
    implicit class StorageEngineMutableBuilder[Self <: StorageEngine] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set_removeFile(value: (IncomingMessage, File, js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "_removeFile", js.Any.fromFunction3(value))
    }
  }
  ...
  object koaAugmentingMod {
    ...
    trait DefaultContext extends StObject {
      ...
      var file: org.scalajs.dom.raw.File = js.native
      
      var files: js.Array[org.scalajs.dom.raw.File] = js.native
    }
    object DefaultContext {
      
      @scala.inline
      def apply(file: org.scalajs.dom.raw.File, files: js.Array[org.scalajs.dom.raw.File]): typingsSlinky.koaMulter.mod.koaAugmentingMod.DefaultContext = {
        val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any], files = files.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.koaMulter.mod.koaAugmentingMod.DefaultContext]
      }
      
      @scala.inline
      implicit class DefaultContextMutableBuilder[Self <: typingsSlinky.koaMulter.mod.koaAugmentingMod.DefaultContext] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setFile(value: org.scalajs.dom.raw.File): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setFiles(value: js.Array[org.scalajs.dom.raw.File]): Self = StObject.set(x, "files", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setFilesVarargs(value: org.scalajs.dom.raw.File*): Self = StObject.set(x, "files", js.Array(value :_*))
      }
    }
