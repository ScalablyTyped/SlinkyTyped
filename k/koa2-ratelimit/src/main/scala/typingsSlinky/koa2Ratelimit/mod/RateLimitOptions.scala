...
trait RateLimitOptions extends js.Object {
  ...
  var store: typingsSlinky.koa2Ratelimit.storeMod.^ = js.native
...
object RateLimitOptions {
  ...
  def apply(
    ...
    statusCode: Double,
    store: typingsSlinky.koa2Ratelimit.storeMod.^,
  ...
  implicit class RateLimitOptionsOps[Self <: RateLimitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStore(value: typingsSlinky.koa2Ratelimit.storeMod.^): Self = this.set("store", value.asInstanceOf[js.Any])
