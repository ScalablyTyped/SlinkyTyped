...
import typingsSlinky.koa2Ratelimit.mongodbStoreMod.^
import typingsSlinky.koa2Ratelimit.sequelizeStoreMod.SequelizeStoreOptions
...
trait Memory extends js.Object {
  ...
  var Redis: Instantiable1[/* config */ js.UndefOr[ClientOpts], typingsSlinky.koa2Ratelimit.redisStoreMod.^] = js.native
  
  var Sequelize: Instantiable2[
    /* sequelize */ typingsSlinky.sequelize.mod.Sequelize, 
    /* options */ js.UndefOr[SequelizeStoreOptions], 
    typingsSlinky.koa2Ratelimit.sequelizeStoreMod.^
  ] = js.native
  
  var Store: Instantiable0[typingsSlinky.koa2Ratelimit.storeMod.^] = js.native
}
object Memory {
  ...
  def apply(
    ...
    Redis: Instantiable1[/* config */ js.UndefOr[ClientOpts], typingsSlinky.koa2Ratelimit.redisStoreMod.^],
    Sequelize: Instantiable2[
      /* sequelize */ Sequelize, 
      /* options */ js.UndefOr[SequelizeStoreOptions], 
      typingsSlinky.koa2Ratelimit.sequelizeStoreMod.^
    ],
    Store: Instantiable0[typingsSlinky.koa2Ratelimit.storeMod.^]
  ): Memory = {
  ...
  implicit class MemoryOps[Self <: Memory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRedis(
      value: Instantiable1[/* config */ js.UndefOr[ClientOpts], typingsSlinky.koa2Ratelimit.redisStoreMod.^]
    ): Self = this.set("Redis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStore(value: Instantiable0[typingsSlinky.koa2Ratelimit.storeMod.^]): Self = this.set("Store", value.asInstanceOf[js.Any])
  }
}
