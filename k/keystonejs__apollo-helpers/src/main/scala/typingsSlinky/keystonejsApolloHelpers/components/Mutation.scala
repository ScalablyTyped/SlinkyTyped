...
object Mutation
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.keystonejsApolloHelpers.mod.Mutation] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.keystonejsApolloHelpers.mod.Mutation] = {
