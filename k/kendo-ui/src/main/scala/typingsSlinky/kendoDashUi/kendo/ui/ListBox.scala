...
import typingsSlinky.kendoDashUi.kendo.data.ObservableArray
import typingsSlinky.kendoDashUi.kendo.data.ObservableObject
...
class ListBox protected () extends Widget {
  ...
  def dataItem(element: typingsSlinky.std.Element): ObservableObject = js.native
  ...
  def enable(element: typingsSlinky.std.Element): Unit = js.native
  ...
  def reorder(element: typingsSlinky.std.Element, index: Double): Unit = js.native
