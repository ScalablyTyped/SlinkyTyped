...
class Image protected () extends Element {
  def this(src: String, rect: typingsSlinky.kendoDashUi.kendo.geometry.Rect) = this()
  @JSName("options")
  var options_Image: ImageOptions = js.native
  def rect(): typingsSlinky.kendoDashUi.kendo.geometry.Rect = js.native
  def rect(value: typingsSlinky.kendoDashUi.kendo.geometry.Rect): Unit = js.native
