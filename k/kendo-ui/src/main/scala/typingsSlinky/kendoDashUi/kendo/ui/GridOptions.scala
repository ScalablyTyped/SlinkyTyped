...
import typingsSlinky.kendoDashUi.kendoDashUiStrings.`inline`
import typingsSlinky.kendoDashUi.kendoDashUiStrings.incell
import typingsSlinky.kendoDashUi.kendoDashUiStrings.popup
