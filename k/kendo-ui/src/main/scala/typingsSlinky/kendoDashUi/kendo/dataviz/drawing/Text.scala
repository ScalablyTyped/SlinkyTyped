...
class Text protected ()
  ...
  def fill(color: String): typingsSlinky.kendoDashUi.kendo.drawing.Text = js.native
  def fill(color: String, opacity: Double): typingsSlinky.kendoDashUi.kendo.drawing.Text = js.native
  def position(): Point = js.native
  def position(value: Point): Unit = js.native
  def stroke(color: String): typingsSlinky.kendoDashUi.kendo.drawing.Text = js.native
  def stroke(color: String, width: Double): typingsSlinky.kendoDashUi.kendo.drawing.Text = js.native
  def stroke(color: String, width: Double, opacity: Double): typingsSlinky.kendoDashUi.kendo.drawing.Text = js.native
}
