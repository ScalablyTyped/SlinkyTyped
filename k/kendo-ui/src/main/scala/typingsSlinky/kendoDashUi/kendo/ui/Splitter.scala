...
class Splitter protected () extends Widget {
  ...
  def ajaxRequest(pane: typingsSlinky.std.Element, url: String, data: String): Unit = js.native
  def ajaxRequest(pane: typingsSlinky.std.Element, url: String, data: js.Any): Unit = js.native
  ...
  def collapse(pane: typingsSlinky.std.Element): Unit = js.native
  def expand(pane: String): Unit = js.native
  def expand(pane: JQuery): Unit = js.native
  def expand(pane: typingsSlinky.std.Element): Unit = js.native
  ...
  def insertAfter(config: js.Any, referencePane: typingsSlinky.std.Element): JQuery = js.native
  ...
  def insertBefore(config: js.Any, referencePane: typingsSlinky.std.Element): JQuery = js.native
  def max(pane: String, value: String): Unit = js.native
  def max(pane: JQuery, value: String): Unit = js.native
  def max(pane: typingsSlinky.std.Element, value: String): Unit = js.native
  def min(pane: String, value: String): Unit = js.native
  def min(pane: JQuery, value: String): Unit = js.native
  def min(pane: typingsSlinky.std.Element, value: String): Unit = js.native
  def remove(pane: String): Unit = js.native
  def remove(pane: JQuery): Unit = js.native
  def remove(pane: typingsSlinky.std.Element): Unit = js.native
  ...
  def size(pane: typingsSlinky.std.Element): js.Any = js.native
  def size(pane: typingsSlinky.std.Element, value: String): Unit = js.native
  @JSName("size")
  def size_Unit(pane: String): Unit = js.native
  @JSName("size")
  def size_Unit(pane: JQuery): Unit = js.native
  @JSName("size")
  def size_Unit(pane: typingsSlinky.std.Element): Unit = js.native
  ...
  def toggle(pane: typingsSlinky.std.Element): Unit = js.native
  def toggle(pane: typingsSlinky.std.Element, expand: Boolean): Unit = js.native
}
