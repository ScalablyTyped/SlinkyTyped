...
class Scheduler protected () extends Widget {
  ...
  def editEvent(event: typingsSlinky.kendoDashUi.kendo.data.SchedulerEvent): Unit = js.native
  def items(): js.Any = js.native
  def occurrenceByUid(uid: String): typingsSlinky.kendoDashUi.kendo.data.SchedulerEvent = js.native
  def occurrencesInRange(start: js.Date, end: js.Date): js.Any = js.native
  def refresh(): Unit = js.native
  def removeEvent(event: String): Unit = js.native
  def removeEvent(event: typingsSlinky.kendoDashUi.kendo.data.SchedulerEvent): Unit = js.native
