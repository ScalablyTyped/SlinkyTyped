...
object Model {
  ...
  @js.native
  def define(options: DataSourceSchemaModelWithFieldsArray): TypeofModel with (Instantiable1[/* data */ js.UndefOr[js.Any], typingsSlinky.kendoUi.kendo.data.Model]) = js.native
  /* static member */
  @JSGlobal("kendo.data.Model.define")
  @js.native
  def define(options: DataSourceSchemaModelWithFieldsObject): TypeofModel with (Instantiable1[/* data */ js.UndefOr[js.Any], typingsSlinky.kendoUi.kendo.data.Model]) = js.native
