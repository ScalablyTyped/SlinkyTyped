...
import typingsSlinky.kendoUi.kendo.data.BinderOptions
...
object Binder {
  ...
  @js.native
  def fn: typingsSlinky.kendoUi.kendo.data.Binder = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.kendoUi.kendo.data.Binder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
