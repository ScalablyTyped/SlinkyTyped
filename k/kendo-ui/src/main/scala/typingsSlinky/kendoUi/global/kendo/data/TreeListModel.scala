...
object TreeListModel {
  ...
  @js.native
  def define(options: DataSourceSchemaModelWithFieldsArray): TypeofTreeListModel with (Instantiable1[/* data */ js.UndefOr[js.Any], typingsSlinky.kendoUi.kendo.data.TreeListModel]) = js.native
  /* static member */
  @JSGlobal("kendo.data.TreeListModel.define")
  @js.native
  def define(options: DataSourceSchemaModelWithFieldsObject): TypeofTreeListModel with (Instantiable1[/* data */ js.UndefOr[js.Any], typingsSlinky.kendoUi.kendo.data.TreeListModel]) = js.native
