...
@js.native
trait SparklineCategoryAxisItemCrosshair extends StObject {
...
object SparklineCategoryAxisItemCrosshair {
  ...
  @scala.inline
  implicit class SparklineCategoryAxisItemCrosshairMutableBuilder[Self <: SparklineCategoryAxisItemCrosshair] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltip(value: SparklineCategoryAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
