...
object SurfaceTooltipCloseEvent {
  ...
  implicit class SurfaceTooltipCloseEventOps[Self <: SurfaceTooltipCloseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElement(value: typingsSlinky.kendoUi.kendo.drawing.Element): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteElement: Self = this.set("element", js.undefined)
    @scala.inline
    def setTarget(value: typingsSlinky.kendoUi.kendo.drawing.Element): Self = this.set("target", value.asInstanceOf[js.Any])
    @scala.inline
