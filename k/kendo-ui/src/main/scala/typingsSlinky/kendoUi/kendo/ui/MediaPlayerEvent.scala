...
object MediaPlayerEvent {
  ...
  @scala.inline
  implicit class MediaPlayerEventOps[Self <: MediaPlayerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: MediaPlayer): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
