...
object RangeSliderEvent {
  ...
  @scala.inline
  implicit class RangeSliderEventOps[Self <: RangeSliderEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: RangeSlider): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
