...
object SparklineSeriesDefaultsLabels {
  ...
  @scala.inline
  implicit class SparklineSeriesDefaultsLabelsMutableBuilder[Self <: SparklineSeriesDefaultsLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SparklineSeriesDefaultsLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
