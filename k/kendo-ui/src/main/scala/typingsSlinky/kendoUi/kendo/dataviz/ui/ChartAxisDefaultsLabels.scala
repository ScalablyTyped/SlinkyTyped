...
object ChartAxisDefaultsLabels {
  ...
  implicit class ChartAxisDefaultsLabelsOps[Self <: ChartAxisDefaultsLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMargin(value: Double | ChartAxisDefaultsLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartAxisDefaultsLabelsPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotation(value: String | Double | ChartAxisDefaultsLabelsRotation): Self = {
        val ret = this.duplicate
