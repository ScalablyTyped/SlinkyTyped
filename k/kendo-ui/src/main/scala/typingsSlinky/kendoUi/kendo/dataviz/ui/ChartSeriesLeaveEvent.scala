...
object ChartSeriesLeaveEvent {
  ...
  @scala.inline
  implicit class ChartSeriesLeaveEventOps[Self <: ChartSeriesLeaveEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: ChartSeriesLeaveEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
