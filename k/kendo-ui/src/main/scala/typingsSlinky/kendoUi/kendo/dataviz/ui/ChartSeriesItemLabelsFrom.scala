...
object ChartSeriesItemLabelsFrom {
  ...
  implicit class ChartSeriesItemLabelsFromOps[Self <: ChartSeriesItemLabelsFrom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartSeriesItemLabelsFromBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartSeriesItemLabelsFromMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartSeriesItemLabelsFromPadding): Self = {
        val ret = this.duplicate
