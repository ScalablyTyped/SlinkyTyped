...
object DiagramSelectOptions {
  ...
  implicit class DiagramSelectOptionsOps[Self <: DiagramSelectOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddToSelection(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addToSelection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAddToSelection: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addToSelection")(js.undefined)
        ret
    }
  }
