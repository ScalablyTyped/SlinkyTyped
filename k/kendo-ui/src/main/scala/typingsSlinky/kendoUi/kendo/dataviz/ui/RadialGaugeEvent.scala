...
object RadialGaugeEvent {
  ...
  @scala.inline
  implicit class RadialGaugeEventOps[Self <: RadialGaugeEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: RadialGauge): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
