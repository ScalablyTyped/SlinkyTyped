...
object FlatColorPickerEvent {
  ...
  @scala.inline
  implicit class FlatColorPickerEventOps[Self <: FlatColorPickerEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: FlatColorPicker): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
