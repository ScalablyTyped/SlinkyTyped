...
object ShapeFillGradient {
  ...
  implicit class ShapeFillGradientOps[Self <: ShapeFillGradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStopsVarargs(value: ShapeFillGradientStop*): Self = this.set("stops", js.Array(value :_*))
    
    @scala.inline
    def setStops(value: js.Array[ShapeFillGradientStop]): Self = this.set("stops", value.asInstanceOf[js.Any])
