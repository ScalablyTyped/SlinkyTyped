...
object ChartAxisDefaultsCrosshair {
  ...
  @scala.inline
  implicit class ChartAxisDefaultsCrosshairOps[Self <: ChartAxisDefaultsCrosshair] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTooltip(value: ChartAxisDefaultsCrosshairTooltip): Self = this.set("tooltip", value.asInstanceOf[js.Any])
    @scala.inline
