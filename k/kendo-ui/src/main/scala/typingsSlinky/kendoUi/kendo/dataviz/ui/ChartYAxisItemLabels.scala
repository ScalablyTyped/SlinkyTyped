...
object ChartYAxisItemLabels {
  ...
  implicit class ChartYAxisItemLabelsOps[Self <: ChartYAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartYAxisItemLabelsBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDateFormats(value: ChartYAxisItemLabelsDateFormats): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartYAxisItemLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartYAxisItemLabelsPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotation(value: Double | ChartYAxisItemLabelsRotation): Self = {
        val ret = this.duplicate
