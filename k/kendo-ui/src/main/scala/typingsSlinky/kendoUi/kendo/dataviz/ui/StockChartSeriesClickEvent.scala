...
object StockChartSeriesClickEvent {
  ...
  @scala.inline
  implicit class StockChartSeriesClickEventOps[Self <: StockChartSeriesClickEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSeries(value: StockChartSeriesClickEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
    @scala.inline
