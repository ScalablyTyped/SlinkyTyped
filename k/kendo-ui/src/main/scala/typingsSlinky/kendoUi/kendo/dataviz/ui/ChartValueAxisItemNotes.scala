...
object ChartValueAxisItemNotes {
  ...
  implicit class ChartValueAxisItemNotesOps[Self <: ChartValueAxisItemNotes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: js.Array[ChartValueAxisItemNotesDataItem]): Self = {
    ...
    @scala.inline
    def withIcon(value: ChartValueAxisItemNotesIcon): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: ChartValueAxisItemNotesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: ChartValueAxisItemNotesLine): Self = {
        val ret = this.duplicate
