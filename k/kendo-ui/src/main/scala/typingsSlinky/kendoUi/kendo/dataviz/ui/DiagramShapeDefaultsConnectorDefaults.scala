...
object DiagramShapeDefaultsConnectorDefaults {
  ...
  implicit class DiagramShapeDefaultsConnectorDefaultsOps[Self <: DiagramShapeDefaultsConnectorDefaults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFill(value: String | DiagramShapeDefaultsConnectorDefaultsFill): Self = {
    ...
    @scala.inline
    def withHover(value: DiagramShapeDefaultsConnectorDefaultsHover): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStroke(value: String | DiagramShapeDefaultsConnectorDefaultsStroke): Self = {
        val ret = this.duplicate
