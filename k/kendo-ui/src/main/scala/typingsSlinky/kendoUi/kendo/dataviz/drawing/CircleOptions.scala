...
object CircleOptions {
  ...
  implicit class CircleOptionsOps[Self <: CircleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClip(value: typingsSlinky.kendoUi.kendo.drawing.Path): Self = this.set("clip", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFill(value: typingsSlinky.kendoUi.kendo.drawing.FillOptions): Self = this.set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStroke(value: typingsSlinky.kendoUi.kendo.drawing.StrokeOptions): Self = this.set("stroke", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteStroke: Self = this.set("stroke", js.undefined)
    @scala.inline
    def setTooltip(value: typingsSlinky.kendoUi.kendo.drawing.TooltipOptions): Self = this.set("tooltip", value.asInstanceOf[js.Any])
    @scala.inline
