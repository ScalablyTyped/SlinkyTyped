...
object DiagramShapeConnector {
  ...
  implicit class DiagramShapeConnectorOps[Self <: DiagramShapeConnector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFill(value: String | DiagramShapeConnectorFill): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHover(value: DiagramShapeConnectorHover): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPosition(value: js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStroke(value: String | DiagramShapeConnectorStroke): Self = {
        val ret = this.duplicate
