...
object StockChartSeriesItemNotesIcon {
  ...
  @scala.inline
  implicit class StockChartSeriesItemNotesIconOps[Self <: StockChartSeriesItemNotesIcon] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: StockChartSeriesItemNotesIconBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
