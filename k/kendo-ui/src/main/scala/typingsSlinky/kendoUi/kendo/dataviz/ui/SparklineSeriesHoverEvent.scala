...
trait SparklineSeriesHoverEvent extends SparklineEvent {
  ...
  var series: js.UndefOr[SparklineSeriesHoverEventSeries] = js.native
...
object SparklineSeriesHoverEvent {
  ...
  @scala.inline
  implicit class SparklineSeriesHoverEventOps[Self <: SparklineSeriesHoverEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSeries(value: SparklineSeriesHoverEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
    @scala.inline
