...
object LayoutEvent {
  ...
  @scala.inline
  implicit class LayoutEventMutableBuilder[Self <: LayoutEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Layout): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
