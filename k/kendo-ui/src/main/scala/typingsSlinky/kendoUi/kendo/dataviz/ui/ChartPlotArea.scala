...
object ChartPlotArea {
  ...
  implicit class ChartPlotAreaOps[Self <: ChartPlotArea] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartPlotAreaBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartPlotAreaMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartPlotAreaPadding): Self = {
        val ret = this.duplicate
