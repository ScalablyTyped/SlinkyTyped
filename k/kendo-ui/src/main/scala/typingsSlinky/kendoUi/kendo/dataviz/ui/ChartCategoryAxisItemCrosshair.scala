...
@js.native
trait ChartCategoryAxisItemCrosshair extends StObject {
...
object ChartCategoryAxisItemCrosshair {
  ...
  @scala.inline
  implicit class ChartCategoryAxisItemCrosshairMutableBuilder[Self <: ChartCategoryAxisItemCrosshair] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltip(value: ChartCategoryAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
