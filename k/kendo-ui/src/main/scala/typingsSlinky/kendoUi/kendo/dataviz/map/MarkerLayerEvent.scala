...
object MarkerLayerEvent {
  ...
  @scala.inline
  implicit class MarkerLayerEventOps[Self <: MarkerLayerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: MarkerLayer): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
