...
object GanttEvent {
  ...
  @scala.inline
  implicit class GanttEventMutableBuilder[Self <: GanttEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Gantt): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
