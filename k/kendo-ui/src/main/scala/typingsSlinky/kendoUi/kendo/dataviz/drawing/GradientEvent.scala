...
object GradientEvent {
  ...
  @scala.inline
  implicit class GradientEventOps[Self <: GradientEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: Gradient): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
