...
object ChartCategoryAxisItemLabels {
  ...
  implicit class ChartCategoryAxisItemLabelsOps[Self <: ChartCategoryAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartCategoryAxisItemLabelsBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDateFormats(value: ChartCategoryAxisItemLabelsDateFormats): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartCategoryAxisItemLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartCategoryAxisItemLabelsPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotation(value: String | Double | ChartCategoryAxisItemLabelsRotation): Self = {
        val ret = this.duplicate
