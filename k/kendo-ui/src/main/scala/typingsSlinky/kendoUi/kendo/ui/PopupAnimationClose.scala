...
@js.native
trait PopupAnimationClose extends StObject {
...
object PopupAnimationClose {
  ...
  @scala.inline
  def apply(): PopupAnimationClose = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PopupAnimationClose]
  }
  
  @scala.inline
  implicit class PopupAnimationCloseMutableBuilder[Self <: PopupAnimationClose] (val x: Self) extends AnyVal {
