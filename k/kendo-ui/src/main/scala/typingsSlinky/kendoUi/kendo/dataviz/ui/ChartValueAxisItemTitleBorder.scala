...
@js.native
trait ChartValueAxisItemTitleBorder extends StObject {
...
object ChartValueAxisItemTitleBorder {
  ...
  @scala.inline
  def apply(): ChartValueAxisItemTitleBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartValueAxisItemTitleBorder]
  }
  
  @scala.inline
  implicit class ChartValueAxisItemTitleBorderMutableBuilder[Self <: ChartValueAxisItemTitleBorder] (val x: Self) extends AnyVal {
