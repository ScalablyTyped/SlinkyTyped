...
@js.native
trait MapLayerTooltip extends StObject {
...
object MapLayerTooltip {
  ...
  @scala.inline
  implicit class MapLayerTooltipMutableBuilder[Self <: MapLayerTooltip] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAnimation(value: MapLayerTooltipAnimation): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setContent(value: String | js.Function | MapLayerTooltipContent): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
