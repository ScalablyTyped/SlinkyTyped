...
@js.native
trait SchedulerPdfMargin extends StObject {
...
object SchedulerPdfMargin {
  ...
  @scala.inline
  def apply(): SchedulerPdfMargin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchedulerPdfMargin]
  }
  
  @scala.inline
  implicit class SchedulerPdfMarginMutableBuilder[Self <: SchedulerPdfMargin] (val x: Self) extends AnyVal {
