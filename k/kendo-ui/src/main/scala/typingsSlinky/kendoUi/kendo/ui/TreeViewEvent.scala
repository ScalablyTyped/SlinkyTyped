...
object TreeViewEvent {
  ...
  @scala.inline
  implicit class TreeViewEventOps[Self <: TreeViewEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: TreeView): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
