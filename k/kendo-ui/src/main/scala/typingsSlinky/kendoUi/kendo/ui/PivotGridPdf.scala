...
object PivotGridPdf {
  ...
  @scala.inline
  implicit class PivotGridPdfMutableBuilder[Self <: PivotGridPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: PivotGridPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
