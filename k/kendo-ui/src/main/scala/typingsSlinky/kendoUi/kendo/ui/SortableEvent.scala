...
object SortableEvent {
  ...
  @scala.inline
  implicit class SortableEventOps[Self <: SortableEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Sortable): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
