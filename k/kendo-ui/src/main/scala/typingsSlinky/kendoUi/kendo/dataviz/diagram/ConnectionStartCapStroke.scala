...
@js.native
trait ConnectionStartCapStroke extends StObject {
...
object ConnectionStartCapStroke {
  ...
  @scala.inline
  def apply(): ConnectionStartCapStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConnectionStartCapStroke]
  }
  
  @scala.inline
  implicit class ConnectionStartCapStrokeMutableBuilder[Self <: ConnectionStartCapStroke] (val x: Self) extends AnyVal {
