...
@js.native
trait MapMarkerDefaultsTooltipAnimationOpen extends StObject {
...
object MapMarkerDefaultsTooltipAnimationOpen {
  ...
  @scala.inline
  def apply(): MapMarkerDefaultsTooltipAnimationOpen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapMarkerDefaultsTooltipAnimationOpen]
  }
  
  @scala.inline
  implicit class MapMarkerDefaultsTooltipAnimationOpenMutableBuilder[Self <: MapMarkerDefaultsTooltipAnimationOpen] (val x: Self) extends AnyVal {
