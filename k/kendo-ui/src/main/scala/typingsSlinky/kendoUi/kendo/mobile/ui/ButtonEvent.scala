...
object ButtonEvent {
  ...
  @scala.inline
  implicit class ButtonEventMutableBuilder[Self <: ButtonEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Button): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
