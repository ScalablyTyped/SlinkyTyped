...
object ShapeEvent {
  ...
  @scala.inline
  implicit class ShapeEventMutableBuilder[Self <: ShapeEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Shape): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
