...
object SchedulerEvent {
  ...
  @scala.inline
  implicit class SchedulerEventOps[Self <: SchedulerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Scheduler): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
