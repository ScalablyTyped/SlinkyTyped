...
object DateTimePickerAnimation {
  ...
  implicit class DateTimePickerAnimationOps[Self <: DateTimePickerAnimation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClose(value: DateTimePickerAnimationClose): Self = this.set("close", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClose: Self = this.set("close", js.undefined)
    @scala.inline
    def setOpen(value: DateTimePickerAnimationOpen): Self = this.set("open", value.asInstanceOf[js.Any])
    @scala.inline
