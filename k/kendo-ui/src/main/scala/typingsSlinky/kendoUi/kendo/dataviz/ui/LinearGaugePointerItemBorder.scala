...
@js.native
trait LinearGaugePointerItemBorder extends StObject {
...
object LinearGaugePointerItemBorder {
  ...
  @scala.inline
  implicit class LinearGaugePointerItemBorderMutableBuilder[Self <: LinearGaugePointerItemBorder] (val x: Self) extends AnyVal {
