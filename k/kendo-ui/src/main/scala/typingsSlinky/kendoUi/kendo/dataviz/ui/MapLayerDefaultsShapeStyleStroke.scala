...
object MapLayerDefaultsShapeStyleStroke {
  ...
  @scala.inline
  def apply(): MapLayerDefaultsShapeStyleStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapLayerDefaultsShapeStyleStroke]
  }
  
  @scala.inline
  implicit class MapLayerDefaultsShapeStyleStrokeMutableBuilder[Self <: MapLayerDefaultsShapeStyleStroke] (val x: Self) extends AnyVal {
