...
object DiagramConnectionDefaultsEndCap {
  ...
  @scala.inline
  implicit class DiagramConnectionDefaultsEndCapOps[Self <: DiagramConnectionDefaultsEndCap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFill(value: String | DiagramConnectionDefaultsEndCapFill): Self = this.set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFill: Self = this.set("fill", js.undefined)
    @scala.inline
    def setStroke(value: String | DiagramConnectionDefaultsEndCapStroke): Self = this.set("stroke", value.asInstanceOf[js.Any])
    @scala.inline
