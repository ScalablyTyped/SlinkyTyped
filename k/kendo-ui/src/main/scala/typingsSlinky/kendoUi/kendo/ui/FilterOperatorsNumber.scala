...
@js.native
trait FilterOperatorsNumber extends StObject {
  
  @JSName("eq")
  var eq_FFilterOperatorsNumber: js.UndefOr[String] = js.native
...
object FilterOperatorsNumber {
  ...
  @scala.inline
  def apply(): FilterOperatorsNumber = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FilterOperatorsNumber]
  }
  
  @scala.inline
  implicit class FilterOperatorsNumberMutableBuilder[Self <: FilterOperatorsNumber] (val x: Self) extends AnyVal {
