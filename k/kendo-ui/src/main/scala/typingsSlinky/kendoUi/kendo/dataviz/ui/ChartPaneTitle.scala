...
object ChartPaneTitle {
  ...
  @scala.inline
  implicit class ChartPaneTitleMutableBuilder[Self <: ChartPaneTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartPaneTitleBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMargin(value: Double | ChartPaneTitleMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
