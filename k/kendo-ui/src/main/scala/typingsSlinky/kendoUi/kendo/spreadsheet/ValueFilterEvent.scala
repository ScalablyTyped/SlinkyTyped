...
object ValueFilterEvent {
  ...
  @scala.inline
  implicit class ValueFilterEventMutableBuilder[Self <: ValueFilterEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: ValueFilter): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
