...
object ChartSeriesItemNotesIcon {
  ...
  @scala.inline
  implicit class ChartSeriesItemNotesIconOps[Self <: ChartSeriesItemNotesIcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartSeriesItemNotesIconBorder): Self = this.set("border", value.asInstanceOf[js.Any])
