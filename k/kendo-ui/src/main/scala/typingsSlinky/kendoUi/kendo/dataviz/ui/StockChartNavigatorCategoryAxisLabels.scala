...
object StockChartNavigatorCategoryAxisLabels {
  ...
  implicit class StockChartNavigatorCategoryAxisLabelsOps[Self <: StockChartNavigatorCategoryAxisLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: StockChartNavigatorCategoryAxisLabelsBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDateFormats(value: StockChartNavigatorCategoryAxisLabelsDateFormats): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | StockChartNavigatorCategoryAxisLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | StockChartNavigatorCategoryAxisLabelsPadding): Self = {
        val ret = this.duplicate
