...
@js.native
trait StockChartNavigatorCategoryAxisMajorGridLines extends StObject {
...
object StockChartNavigatorCategoryAxisMajorGridLines {
  ...
  @scala.inline
  def apply(): StockChartNavigatorCategoryAxisMajorGridLines = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartNavigatorCategoryAxisMajorGridLines]
  }
  
  @scala.inline
  implicit class StockChartNavigatorCategoryAxisMajorGridLinesMutableBuilder[Self <: StockChartNavigatorCategoryAxisMajorGridLines] (val x: Self) extends AnyVal {
