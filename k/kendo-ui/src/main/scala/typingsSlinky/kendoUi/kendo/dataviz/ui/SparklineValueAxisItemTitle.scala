...
object SparklineValueAxisItemTitle {
  ...
  @scala.inline
  implicit class SparklineValueAxisItemTitleOps[Self <: SparklineValueAxisItemTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SparklineValueAxisItemTitleBorder): Self = this.set("border", value.asInstanceOf[js.Any])
