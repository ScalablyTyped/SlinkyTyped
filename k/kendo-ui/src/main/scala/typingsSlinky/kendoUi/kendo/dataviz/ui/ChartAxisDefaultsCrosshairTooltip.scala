...
object ChartAxisDefaultsCrosshairTooltip {
  ...
  @scala.inline
  implicit class ChartAxisDefaultsCrosshairTooltipOps[Self <: ChartAxisDefaultsCrosshairTooltip] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: ChartAxisDefaultsCrosshairTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPadding(value: ChartAxisDefaultsCrosshairTooltipPadding): Self = this.set("padding", value.asInstanceOf[js.Any])
    @scala.inline
