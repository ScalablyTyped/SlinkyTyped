...
object TreeListFilterableOperatorsNumber {
  ...
  @scala.inline
  def apply(): TreeListFilterableOperatorsNumber = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TreeListFilterableOperatorsNumber]
  }
  
  @scala.inline
  implicit class TreeListFilterableOperatorsNumberMutableBuilder[Self <: TreeListFilterableOperatorsNumber] (val x: Self) extends AnyVal {
