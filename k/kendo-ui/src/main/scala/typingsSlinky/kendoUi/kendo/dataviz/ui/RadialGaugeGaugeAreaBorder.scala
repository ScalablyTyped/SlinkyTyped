...
@js.native
trait RadialGaugeGaugeAreaBorder extends StObject {
...
object RadialGaugeGaugeAreaBorder {
  ...
  @scala.inline
  def apply(): RadialGaugeGaugeAreaBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RadialGaugeGaugeAreaBorder]
  }
  
  @scala.inline
  implicit class RadialGaugeGaugeAreaBorderMutableBuilder[Self <: RadialGaugeGaugeAreaBorder] (val x: Self) extends AnyVal {
