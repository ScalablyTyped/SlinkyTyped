...
@js.native
trait SparklineCategoryAxisItemLabels extends StObject {
...
object SparklineCategoryAxisItemLabels {
  ...
  @scala.inline
  implicit class SparklineCategoryAxisItemLabelsMutableBuilder[Self <: SparklineCategoryAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SparklineCategoryAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDateFormats(value: js.Any): Self = StObject.set(x, "dateFormats", value.asInstanceOf[js.Any])
