...
object ChartPlotAreaHoverEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartPlotAreaHoverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartPlotAreaHoverEvent]
  }
  
  @scala.inline
  implicit class ChartPlotAreaHoverEventMutableBuilder[Self <: ChartPlotAreaHoverEvent] (val x: Self) extends AnyVal {
