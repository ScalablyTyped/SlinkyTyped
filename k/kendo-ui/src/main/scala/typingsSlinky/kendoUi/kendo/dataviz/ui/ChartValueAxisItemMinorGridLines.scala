...
@js.native
trait ChartValueAxisItemMinorGridLines extends StObject {
...
object ChartValueAxisItemMinorGridLines {
  ...
  @scala.inline
  def apply(): ChartValueAxisItemMinorGridLines = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartValueAxisItemMinorGridLines]
  }
  
  @scala.inline
  implicit class ChartValueAxisItemMinorGridLinesMutableBuilder[Self <: ChartValueAxisItemMinorGridLines] (val x: Self) extends AnyVal {
