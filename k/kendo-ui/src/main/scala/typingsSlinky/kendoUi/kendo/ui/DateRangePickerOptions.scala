...
object DateRangePickerOptions {
  ...
  implicit class DateRangePickerOptionsOps[Self <: DateRangePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChange(value: /* e */ DateRangePickerChangeEvent => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClose(value: /* e */ DateRangePickerCloseEvent => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMessages(value: DateRangePickerMessages): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMonth(value: DateRangePickerMonth): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOpen(value: /* e */ DateRangePickerOpenEvent => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRange(value: DateRangePickerRange): Self = {
        val ret = this.duplicate
