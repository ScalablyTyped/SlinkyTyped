...
object StockChartSeriesItemNotesLabel {
  ...
  @scala.inline
  implicit class StockChartSeriesItemNotesLabelOps[Self <: StockChartSeriesItemNotesLabel] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: StockChartSeriesItemNotesLabelBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
