...
@js.native
trait ChartSeriesItemLabelsToBorder extends js.Object {
...
object ChartSeriesItemLabelsToBorder {
  ...
  @scala.inline
  implicit class ChartSeriesItemLabelsToBorderOps[Self <: ChartSeriesItemLabelsToBorder] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withWidth(value: Double | js.Function): Self = {
        val ret = this.duplicate
