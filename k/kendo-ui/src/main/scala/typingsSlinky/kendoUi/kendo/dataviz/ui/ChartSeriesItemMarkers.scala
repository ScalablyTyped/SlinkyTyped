...
object ChartSeriesItemMarkers {
  ...
  implicit class ChartSeriesItemMarkersOps[Self <: ChartSeriesItemMarkers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackground(value: String | js.Function): Self = {
    ...
    @scala.inline
    def withBorder(value: js.Function | ChartSeriesItemMarkersBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFrom(value: ChartSeriesItemMarkersFrom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotation(value: Double | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: Double | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTo(value: ChartSeriesItemMarkersTo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVisible(value: Boolean | js.Function): Self = {
        val ret = this.duplicate
