...
trait PivotGridEvent extends js.Object {
  ...
  var sender: PivotGrid = js.native
}
object PivotGridEvent {
  ...
  @scala.inline
  implicit class PivotGridEventOps[Self <: PivotGridEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: PivotGrid): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
