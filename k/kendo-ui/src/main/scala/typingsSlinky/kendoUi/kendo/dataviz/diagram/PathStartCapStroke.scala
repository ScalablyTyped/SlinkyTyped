...
@js.native
trait PathStartCapStroke extends StObject {
...
object PathStartCapStroke {
  ...
  @scala.inline
  def apply(): PathStartCapStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PathStartCapStroke]
  }
  
  @scala.inline
  implicit class PathStartCapStrokeMutableBuilder[Self <: PathStartCapStroke] (val x: Self) extends AnyVal {
