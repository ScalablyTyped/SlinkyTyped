...
object StockChartNavigatorCategoryAxisNotesDataItemIcon {
  ...
  @scala.inline
  implicit class StockChartNavigatorCategoryAxisNotesDataItemIconOps[Self <: StockChartNavigatorCategoryAxisNotesDataItemIcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartNavigatorCategoryAxisNotesDataItemIconBorder): Self = this.set("border", value.asInstanceOf[js.Any])
