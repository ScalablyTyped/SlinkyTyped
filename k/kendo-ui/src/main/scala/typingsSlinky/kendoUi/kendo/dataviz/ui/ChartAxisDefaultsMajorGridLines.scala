...
@js.native
trait ChartAxisDefaultsMajorGridLines extends js.Object {
...
object ChartAxisDefaultsMajorGridLines {
  ...
  @scala.inline
  implicit class ChartAxisDefaultsMajorGridLinesOps[Self <: ChartAxisDefaultsMajorGridLines] (val x: Self) extends AnyVal {
    @scala.inline
