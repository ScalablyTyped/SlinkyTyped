...
object StockChartNoteClickEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartNoteClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartNoteClickEvent]
  }
  
  @scala.inline
  implicit class StockChartNoteClickEventMutableBuilder[Self <: StockChartNoteClickEvent] (val x: Self) extends AnyVal {
