...
object SparklineCategoryAxisItemNotes {
  ...
  implicit class SparklineCategoryAxisItemNotesOps[Self <: SparklineCategoryAxisItemNotes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: js.Array[SparklineCategoryAxisItemNotesDataItem]): Self = {
    ...
    @scala.inline
    def withIcon(value: SparklineCategoryAxisItemNotesIcon): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: SparklineCategoryAxisItemNotesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: SparklineCategoryAxisItemNotesLine): Self = {
        val ret = this.duplicate
