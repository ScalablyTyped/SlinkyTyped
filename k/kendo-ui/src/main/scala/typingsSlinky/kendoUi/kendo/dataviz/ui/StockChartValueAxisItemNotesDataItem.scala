...
object StockChartValueAxisItemNotesDataItem {
  ...
  implicit class StockChartValueAxisItemNotesDataItemOps[Self <: StockChartValueAxisItemNotesDataItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcon(value: StockChartValueAxisItemNotesDataItemIcon): Self = {
    ...
    @scala.inline
    def withLabel(value: StockChartValueAxisItemNotesDataItemLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: StockChartValueAxisItemNotesDataItemLine): Self = {
        val ret = this.duplicate
