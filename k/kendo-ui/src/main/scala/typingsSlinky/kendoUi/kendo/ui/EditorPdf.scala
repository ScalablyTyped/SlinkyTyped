...
object EditorPdf {
  ...
  @scala.inline
  implicit class EditorPdfOps[Self <: EditorPdf] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMargin(value: EditorPdfMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
    @scala.inline
