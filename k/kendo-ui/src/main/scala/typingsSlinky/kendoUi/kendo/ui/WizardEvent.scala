...
@js.native
trait WizardEvent extends js.Object {
  
  def isDefaultPrevented(): Boolean = js.native
  
  var preventDefault: js.Function = js.native
  
  var sender: Wizard = js.native
}
object WizardEvent {
  ...
  @scala.inline
  implicit class WizardEventOps[Self <: WizardEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Wizard): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
