...
object MarkerTooltip {
  ...
  @scala.inline
  implicit class MarkerTooltipOps[Self <: MarkerTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: MarkerTooltipAnimation): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setContent(value: String | js.Function | MarkerTooltipContent): Self = this.set("content", value.asInstanceOf[js.Any])
