...
object CalendarEvent {
  ...
  @scala.inline
  implicit class CalendarEventOps[Self <: CalendarEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Calendar): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
