...
trait ResponsivePanelEvent extends js.Object {
  ...
  var sender: ResponsivePanel = js.native
...
object ResponsivePanelEvent {
  ...
  @scala.inline
  implicit class ResponsivePanelEventOps[Self <: ResponsivePanelEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: ResponsivePanel): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
