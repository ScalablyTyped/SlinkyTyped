...
object SplitViewEvent {
  ...
  @scala.inline
  implicit class SplitViewEventOps[Self <: SplitViewEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: SplitView): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
