...
object FileManagerMessagesDialogsMoveConfirm {
  ...
  @scala.inline
  def apply(): FileManagerMessagesDialogsMoveConfirm = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FileManagerMessagesDialogsMoveConfirm]
  }
  
  @scala.inline
  implicit class FileManagerMessagesDialogsMoveConfirmMutableBuilder[Self <: FileManagerMessagesDialogsMoveConfirm] (val x: Self) extends AnyVal {
