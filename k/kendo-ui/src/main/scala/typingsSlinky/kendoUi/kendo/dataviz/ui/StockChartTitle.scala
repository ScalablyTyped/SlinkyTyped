...
trait StockChartTitle extends StObject {
  ...
  var border: js.UndefOr[StockChartTitleBorder] = js.native
...
object StockChartTitle {
  ...
  @scala.inline
  def apply(): StockChartTitle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartTitle]
  }
  
  @scala.inline
  implicit class StockChartTitleMutableBuilder[Self <: StockChartTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartTitleBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
