...
object StockChartTitle {
  ...
  @scala.inline
  implicit class StockChartTitleOps[Self <: StockChartTitle] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: StockChartTitleBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
