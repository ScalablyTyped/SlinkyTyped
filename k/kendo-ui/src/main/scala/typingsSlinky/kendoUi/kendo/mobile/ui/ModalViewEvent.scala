...
object ModalViewEvent {
  ...
  @scala.inline
  implicit class ModalViewEventOps[Self <: ModalViewEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: ModalView): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
