...
object SparklineChartArea {
  ...
  @scala.inline
  implicit class SparklineChartAreaMutableBuilder[Self <: SparklineChartArea] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SparklineChartAreaBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
