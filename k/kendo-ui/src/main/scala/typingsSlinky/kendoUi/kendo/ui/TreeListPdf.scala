...
object TreeListPdf {
  ...
  @scala.inline
  implicit class TreeListPdfOps[Self <: TreeListPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: TreeListPdfMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
