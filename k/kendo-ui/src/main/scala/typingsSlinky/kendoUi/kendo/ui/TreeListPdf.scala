...
trait TreeListPdf extends StObject {
  ...
  var margin: js.UndefOr[TreeListPdfMargin] = js.native
...
object TreeListPdf {
  ...
  @scala.inline
  def apply(): TreeListPdf = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TreeListPdf]
  }
  
  @scala.inline
  implicit class TreeListPdfMutableBuilder[Self <: TreeListPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: TreeListPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
