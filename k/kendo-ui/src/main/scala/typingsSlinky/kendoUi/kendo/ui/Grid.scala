...
class Grid protected () extends Widget {
  ...
  def cellIndex(cell: typingsSlinky.std.Element): Double = js.native
  ...
  def collapseGroup(row: typingsSlinky.std.Element): Unit = js.native
  def collapseRow(row: String): Unit = js.native
  def collapseRow(row: JQuery): Unit = js.native
  def collapseRow(row: typingsSlinky.std.Element): Unit = js.native
  ...
  def expandGroup(row: typingsSlinky.std.Element): Unit = js.native
  def expandRow(row: String): Unit = js.native
  def expandRow(row: JQuery): Unit = js.native
  def expandRow(row: typingsSlinky.std.Element): Unit = js.native
