...
@js.native
trait EditorFileBrowserTransportDestroy extends StObject {
...
object EditorFileBrowserTransportDestroy {
  ...
  @scala.inline
  implicit class EditorFileBrowserTransportDestroyMutableBuilder[Self <: EditorFileBrowserTransportDestroy] (val x: Self) extends AnyVal {
