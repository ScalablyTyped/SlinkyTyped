...
object StockChartLegendItemHoverEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartLegendItemHoverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartLegendItemHoverEvent]
  }
  
  @scala.inline
  implicit class StockChartLegendItemHoverEventMutableBuilder[Self <: StockChartLegendItemHoverEvent] (val x: Self) extends AnyVal {
