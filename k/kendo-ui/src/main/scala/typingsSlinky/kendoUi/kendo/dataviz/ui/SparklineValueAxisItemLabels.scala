...
object SparklineValueAxisItemLabels {
  ...
  @scala.inline
  implicit class SparklineValueAxisItemLabelsOps[Self <: SparklineValueAxisItemLabels] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: SparklineValueAxisItemLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
