...
object SparklineCategoryAxisItemNotesDataItemLabelBorder {
  ...
  @scala.inline
  def apply(): SparklineCategoryAxisItemNotesDataItemLabelBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineCategoryAxisItemNotesDataItemLabelBorder]
  }
  
  @scala.inline
  implicit class SparklineCategoryAxisItemNotesDataItemLabelBorderMutableBuilder[Self <: SparklineCategoryAxisItemNotesDataItemLabelBorder] (val x: Self) extends AnyVal {
