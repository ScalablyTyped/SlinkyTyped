...
object ChartYAxisItem {
  ...
  implicit class ChartYAxisItemOps[Self <: ChartYAxisItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAxisCrossingValueDate(value: js.Date): Self = this.set("axisCrossingValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setAxisCrossingValue(value: js.Any | js.Date): Self = this.set("axisCrossingValue", value.asInstanceOf[js.Any])
    @scala.inline
