...
@js.native
trait GanttPdf extends StObject {
...
object GanttPdf {
  ...
  @scala.inline
  implicit class GanttPdfMutableBuilder[Self <: GanttPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: GanttPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
