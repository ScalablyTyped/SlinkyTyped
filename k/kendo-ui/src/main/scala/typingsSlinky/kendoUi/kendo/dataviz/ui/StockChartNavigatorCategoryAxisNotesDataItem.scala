...
object StockChartNavigatorCategoryAxisNotesDataItem {
  ...
  implicit class StockChartNavigatorCategoryAxisNotesDataItemOps[Self <: StockChartNavigatorCategoryAxisNotesDataItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcon(value: StockChartNavigatorCategoryAxisNotesDataItemIcon): Self = {
    ...
    @scala.inline
    def withLabel(value: StockChartNavigatorCategoryAxisNotesDataItemLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: StockChartNavigatorCategoryAxisNotesDataItemLine): Self = {
        val ret = this.duplicate
