...
object QRCodeOptions {
  ...
  implicit class QRCodeOptionsOps[Self <: QRCodeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: QRCodeBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withErrorCorrection(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("errorCorrection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutErrorCorrection: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("errorCorrection")(js.undefined)
        ret
    }
    @scala.inline
