...
object ActionSheetOpenEvent {
  ...
  @scala.inline
  implicit class ActionSheetOpenEventOps[Self <: ActionSheetOpenEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setContext(value: JQuery): Self = this.set("context", value.asInstanceOf[js.Any])
    @scala.inline
