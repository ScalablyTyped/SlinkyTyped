...
trait BackButtonEvent extends js.Object {
  ...
  var sender: BackButton = js.native
}
object BackButtonEvent {
  ...
  @scala.inline
  implicit class BackButtonEventOps[Self <: BackButtonEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: BackButton): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
