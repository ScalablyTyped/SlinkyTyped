...
object EditorFileBrowserTransport {
  ...
  implicit class EditorFileBrowserTransportOps[Self <: EditorFileBrowserTransport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: String | EditorFileBrowserTransportCreate): Self = {
    ...
    @scala.inline
    def withDestroy(value: String | EditorFileBrowserTransportDestroy): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFileUrl(value: String | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRead(value: String | js.Function | EditorFileBrowserTransportRead): Self = {
        val ret = this.duplicate
