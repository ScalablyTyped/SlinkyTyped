...
object ChartSeriesClickEvent {
  ...
  @scala.inline
  implicit class ChartSeriesClickEventOps[Self <: ChartSeriesClickEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSeries(value: ChartSeriesClickEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
    @scala.inline
