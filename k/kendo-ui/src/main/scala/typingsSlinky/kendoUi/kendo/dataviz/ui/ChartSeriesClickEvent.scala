...
trait ChartSeriesClickEvent extends ChartEvent {
  ...
  var series: js.UndefOr[ChartSeriesClickEventSeries] = js.native
...
object ChartSeriesClickEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartSeriesClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartSeriesClickEvent]
  }
  
  @scala.inline
  implicit class ChartSeriesClickEventMutableBuilder[Self <: ChartSeriesClickEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: ChartSeriesClickEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
