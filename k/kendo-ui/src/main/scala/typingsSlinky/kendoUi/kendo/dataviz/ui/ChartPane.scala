...
object ChartPane {
  ...
  implicit class ChartPaneOps[Self <: ChartPane] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartPaneBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartPaneMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: ChartPanePadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitle(value: String | ChartPaneTitle): Self = {
        val ret = this.duplicate
