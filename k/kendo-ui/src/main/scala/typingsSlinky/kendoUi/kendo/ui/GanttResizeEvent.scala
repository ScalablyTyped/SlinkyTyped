...
@js.native
trait GanttResizeEvent extends GanttEvent {
...
object GanttResizeEvent {
  
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Gantt): GanttResizeEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[GanttResizeEvent]
  }
  
  @scala.inline
  implicit class GanttResizeEventMutableBuilder[Self <: GanttResizeEvent] (val x: Self) extends AnyVal {
