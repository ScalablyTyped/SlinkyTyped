...
object StockChartNavigatorCategoryAxisTitle {
  ...
  implicit class StockChartNavigatorCategoryAxisTitleOps[Self <: StockChartNavigatorCategoryAxisTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: StockChartNavigatorCategoryAxisTitleBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | StockChartNavigatorCategoryAxisTitleMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | StockChartNavigatorCategoryAxisTitlePadding): Self = {
        val ret = this.duplicate
