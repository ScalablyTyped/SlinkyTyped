...
object ValidatorEvent {
  ...
  @scala.inline
  implicit class ValidatorEventOps[Self <: ValidatorEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: Validator): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
