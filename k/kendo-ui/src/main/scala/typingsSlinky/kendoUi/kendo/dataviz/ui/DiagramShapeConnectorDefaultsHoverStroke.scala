...
@js.native
trait DiagramShapeConnectorDefaultsHoverStroke extends StObject {
...
object DiagramShapeConnectorDefaultsHoverStroke {
  ...
  @scala.inline
  implicit class DiagramShapeConnectorDefaultsHoverStrokeMutableBuilder[Self <: DiagramShapeConnectorDefaultsHoverStroke] (val x: Self) extends AnyVal {
