...
trait StockChartTooltip extends js.Object {
  ...
  var border: js.UndefOr[StockChartTooltipBorder] = js.native
...
object StockChartTooltip {
  @scala.inline
  def apply(): StockChartTooltip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartTooltip]
  }
  @scala.inline
  implicit class StockChartTooltipOps[Self <: StockChartTooltip] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withBorder(value: StockChartTooltipBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSharedTemplate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sharedTemplate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSharedTemplate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sharedTemplate")(js.undefined)
        ret
    }
    @scala.inline
