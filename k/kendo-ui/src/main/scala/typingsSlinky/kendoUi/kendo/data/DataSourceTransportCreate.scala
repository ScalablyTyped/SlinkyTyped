...
import typingsSlinky.kendoUi.JQueryAjaxSettings
...
object DataSourceTransportCreate {
  ...
  @scala.inline
  def apply(): DataSourceTransportCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DataSourceTransportCreate]
  }
  
  @scala.inline
  implicit class DataSourceTransportCreateMutableBuilder[Self <: DataSourceTransportCreate] (val x: Self) extends AnyVal {
