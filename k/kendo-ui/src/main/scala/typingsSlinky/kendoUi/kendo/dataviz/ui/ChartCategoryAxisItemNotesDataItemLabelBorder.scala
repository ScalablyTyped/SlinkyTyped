...
@js.native
trait ChartCategoryAxisItemNotesDataItemLabelBorder extends StObject {
...
object ChartCategoryAxisItemNotesDataItemLabelBorder {
  ...
  @scala.inline
  implicit class ChartCategoryAxisItemNotesDataItemLabelBorderMutableBuilder[Self <: ChartCategoryAxisItemNotesDataItemLabelBorder] (val x: Self) extends AnyVal {
