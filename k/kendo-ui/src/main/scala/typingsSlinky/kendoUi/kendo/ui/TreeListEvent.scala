...
object TreeListEvent {
  ...
  @scala.inline
  implicit class TreeListEventOps[Self <: TreeListEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: TreeList): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
