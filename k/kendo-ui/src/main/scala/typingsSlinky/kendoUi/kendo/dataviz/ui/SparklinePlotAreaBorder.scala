...
@js.native
trait SparklinePlotAreaBorder extends StObject {
...
object SparklinePlotAreaBorder {
  ...
  @scala.inline
  implicit class SparklinePlotAreaBorderMutableBuilder[Self <: SparklinePlotAreaBorder] (val x: Self) extends AnyVal {
