...
object ChartValueAxisItemLabelsRotation {
  ...
  @scala.inline
  implicit class ChartValueAxisItemLabelsRotationOps[Self <: ChartValueAxisItemLabelsRotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAngle(value: Double | String): Self = {
        val ret = this.duplicate
