...
object GradientStopEvent {
  ...
  @scala.inline
  implicit class GradientStopEventMutableBuilder[Self <: GradientStopEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: GradientStop): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
