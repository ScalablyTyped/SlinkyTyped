...
object GridPdf {
  ...
  implicit class GridPdfOps[Self <: GridPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMargin(value: GridPdfMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRepeatHeaders(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("repeatHeaders")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRepeatHeaders: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("repeatHeaders")(js.undefined)
        ret
    }
    @scala.inline
