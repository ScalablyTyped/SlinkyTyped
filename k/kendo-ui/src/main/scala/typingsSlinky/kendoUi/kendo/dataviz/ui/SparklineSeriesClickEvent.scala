...
object SparklineSeriesClickEvent {
  ...
  @scala.inline
  implicit class SparklineSeriesClickEventMutableBuilder[Self <: SparklineSeriesClickEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: SparklineSeriesClickEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
