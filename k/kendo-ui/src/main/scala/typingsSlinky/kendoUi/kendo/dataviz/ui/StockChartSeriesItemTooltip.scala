...
object StockChartSeriesItemTooltip {
  ...
  @scala.inline
  implicit class StockChartSeriesItemTooltipOps[Self <: StockChartSeriesItemTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartSeriesItemTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
