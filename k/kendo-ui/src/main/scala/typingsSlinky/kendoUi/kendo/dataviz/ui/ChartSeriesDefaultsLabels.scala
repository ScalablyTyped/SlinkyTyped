...
object ChartSeriesDefaultsLabels {
  ...
  implicit class ChartSeriesDefaultsLabelsOps[Self <: ChartSeriesDefaultsLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartSeriesDefaultsLabelsBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFrom(value: ChartSeriesDefaultsLabelsFrom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartSeriesDefaultsLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartSeriesDefaultsLabelsPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTo(value: ChartSeriesDefaultsLabelsTo): Self = {
        val ret = this.duplicate
