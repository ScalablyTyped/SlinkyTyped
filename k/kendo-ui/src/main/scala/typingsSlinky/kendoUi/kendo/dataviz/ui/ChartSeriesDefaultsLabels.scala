...
object ChartSeriesDefaultsLabels {
  ...
  @scala.inline
  implicit class ChartSeriesDefaultsLabelsMutableBuilder[Self <: ChartSeriesDefaultsLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartSeriesDefaultsLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFrom(value: ChartSeriesDefaultsLabelsFrom): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFromUndefined: Self = StObject.set(x, "from", js.undefined)
    
    @scala.inline
    def setMargin(value: Double | ChartSeriesDefaultsLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarginUndefined: Self = StObject.set(x, "margin", js.undefined)
    
    @scala.inline
    def setPadding(value: Double | ChartSeriesDefaultsLabelsPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTo(value: ChartSeriesDefaultsLabelsTo): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
