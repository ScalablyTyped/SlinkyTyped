...
object SparklineSeriesItemNotes {
  ...
  implicit class SparklineSeriesItemNotesOps[Self <: SparklineSeriesItemNotes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcon(value: SparklineSeriesItemNotesIcon): Self = {
    ...
    @scala.inline
    def withLabel(value: SparklineSeriesItemNotesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: SparklineSeriesItemNotesLine): Self = {
        val ret = this.duplicate
