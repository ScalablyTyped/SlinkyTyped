...
@js.native
trait ChartSeriesDefaultsLabelsFromBorder extends StObject {
...
object ChartSeriesDefaultsLabelsFromBorder {
  ...
  @scala.inline
  implicit class ChartSeriesDefaultsLabelsFromBorderMutableBuilder[Self <: ChartSeriesDefaultsLabelsFromBorder] (val x: Self) extends AnyVal {
