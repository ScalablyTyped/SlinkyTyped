...
object DiagramShapeDefaultsConnector {
  ...
  implicit class DiagramShapeDefaultsConnectorOps[Self <: DiagramShapeDefaultsConnector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFill(value: String | DiagramShapeDefaultsConnectorFill): Self = {
    ...
    @scala.inline
    def withHover(value: DiagramShapeDefaultsConnectorHover): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStroke(value: String | DiagramShapeDefaultsConnectorStroke): Self = {
        val ret = this.duplicate
