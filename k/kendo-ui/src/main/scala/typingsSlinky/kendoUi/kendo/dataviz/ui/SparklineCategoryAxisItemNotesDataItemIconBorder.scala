...
object SparklineCategoryAxisItemNotesDataItemIconBorder {
  ...
  @scala.inline
  implicit class SparklineCategoryAxisItemNotesDataItemIconBorderMutableBuilder[Self <: SparklineCategoryAxisItemNotesDataItemIconBorder] (val x: Self) extends AnyVal {
