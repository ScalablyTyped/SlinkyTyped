...
@js.native
trait StockChartPdf extends StObject {
  ...
  var margin: js.UndefOr[StockChartPdfMargin] = js.native
...
object StockChartPdf {
  
  @scala.inline
  def apply(): StockChartPdf = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartPdf]
  }
  
  @scala.inline
  implicit class StockChartPdfMutableBuilder[Self <: StockChartPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: StockChartPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
