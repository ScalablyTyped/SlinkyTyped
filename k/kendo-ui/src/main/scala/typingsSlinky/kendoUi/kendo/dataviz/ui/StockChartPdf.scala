...
@js.native
trait StockChartPdf extends js.Object {
...
object StockChartPdf {
  ...
  @scala.inline
  implicit class StockChartPdfOps[Self <: StockChartPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: StockChartPdfMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
