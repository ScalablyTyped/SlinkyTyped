...
object ChartYAxisItemTitle {
  ...
  implicit class ChartYAxisItemTitleOps[Self <: ChartYAxisItemTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartYAxisItemTitleBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartYAxisItemTitleMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartYAxisItemTitlePadding): Self = {
        val ret = this.duplicate
