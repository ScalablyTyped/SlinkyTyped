...
object StockChartCategoryAxisItemNotesDataItem {
  ...
  implicit class StockChartCategoryAxisItemNotesDataItemOps[Self <: StockChartCategoryAxisItemNotesDataItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcon(value: StockChartCategoryAxisItemNotesDataItemIcon): Self = {
    ...
    @scala.inline
    def withLabel(value: StockChartCategoryAxisItemNotesDataItemLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: StockChartCategoryAxisItemNotesDataItemLine): Self = {
        val ret = this.duplicate
