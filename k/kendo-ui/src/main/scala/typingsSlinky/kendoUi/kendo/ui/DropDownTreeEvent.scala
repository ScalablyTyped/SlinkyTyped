...
object DropDownTreeEvent {
  ...
  @scala.inline
  implicit class DropDownTreeEventOps[Self <: DropDownTreeEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: DropDownTree): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
