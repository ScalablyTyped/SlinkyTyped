...
object DiagramShape {
  ...
  implicit class DiagramShapeOps[Self <: DiagramShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnectorDefaults(value: DiagramShapeConnectorDefaults): Self = {
    ...
    @scala.inline
    def withConnectors(value: js.Array[DiagramShapeConnector]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withContent(value: DiagramShapeContent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEditable(value: Boolean | DiagramShapeEditable): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFill(value: String | DiagramShapeFill): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHover(value: DiagramShapeHover): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotation(value: DiagramShapeRotation): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStroke(value: DiagramShapeStroke): Self = {
        val ret = this.duplicate
