...
object DateInputEvent {
  ...
  @scala.inline
  implicit class DateInputEventOps[Self <: DateInputEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: DateInput): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
