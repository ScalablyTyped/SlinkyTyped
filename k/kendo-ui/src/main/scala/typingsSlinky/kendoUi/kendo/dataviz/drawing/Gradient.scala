...
trait Gradient extends Class {
  ...
  def addStop(offset: Double, color: String, opacity: Double): typingsSlinky.kendoUi.kendo.drawing.GradientStop = js.native
  
  var options: GradientOptions = js.native
  
  def removeStop(stop: typingsSlinky.kendoUi.kendo.drawing.GradientStop): Unit = js.native
...
object Gradient {
  ...
  implicit class GradientMutableBuilder[Self <: Gradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddStop(value: (Double, String, Double) => typingsSlinky.kendoUi.kendo.drawing.GradientStop): Self = StObject.set(x, "addStop", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOptions(value: GradientOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRemoveStop(value: typingsSlinky.kendoUi.kendo.drawing.GradientStop => Unit): Self = StObject.set(x, "removeStop", js.Any.fromFunction1(value))
