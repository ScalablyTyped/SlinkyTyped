...
object Gradient {
  ...
  implicit class GradientOps[Self <: Gradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddStop(value: (Double, String, Double) => typingsSlinky.kendoUi.kendo.drawing.GradientStop): Self = {
    ...
    @scala.inline
    def withRemoveStop(value: typingsSlinky.kendoUi.kendo.drawing.GradientStop => Unit): Self = {
        val ret = this.duplicate
