...
object Gradient {
  ...
  implicit class GradientOps[Self <: Gradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddStop(value: (Double, String, Double) => typingsSlinky.kendoUi.kendo.drawing.GradientStop): Self = this.set("addStop", js.Any.fromFunction3(value))
    @scala.inline
    def setOptions(value: GradientOptions): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
    def setRemoveStop(value: typingsSlinky.kendoUi.kendo.drawing.GradientStop => Unit): Self = this.set("removeStop", js.Any.fromFunction1(value))
    @scala.inline
