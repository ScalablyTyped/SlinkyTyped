...
object Path extends js.Object {
  def fromArc(arc: typingsSlinky.kendoUi.kendo.geometry.Arc): Path = js.native
  def fromArc(arc: typingsSlinky.kendoUi.kendo.geometry.Arc, options: js.Any): Path = js.native
  def fromPoints(points: js.Any): Path = js.native
  def fromPoints(points: js.Any, options: js.Any): Path = js.native
  def fromRect(rect: typingsSlinky.kendoUi.kendo.geometry.Rect): Path = js.native
  def fromRect(rect: typingsSlinky.kendoUi.kendo.geometry.Rect, options: js.Any): Path = js.native
