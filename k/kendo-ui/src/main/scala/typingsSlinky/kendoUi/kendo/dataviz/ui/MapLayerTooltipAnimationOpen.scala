...
@js.native
trait MapLayerTooltipAnimationOpen extends StObject {
...
object MapLayerTooltipAnimationOpen {
  ...
  @scala.inline
  def apply(): MapLayerTooltipAnimationOpen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapLayerTooltipAnimationOpen]
  }
  
  @scala.inline
  implicit class MapLayerTooltipAnimationOpenMutableBuilder[Self <: MapLayerTooltipAnimationOpen] (val x: Self) extends AnyVal {
