...
@js.native
trait TreeListFilterableOperatorsDate extends StObject {
  
  @JSName("eq")
  var eq_FTreeListFilterableOperatorsDate: js.UndefOr[String] = js.native
...
object TreeListFilterableOperatorsDate {
  ...
  @scala.inline
  def apply(): TreeListFilterableOperatorsDate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TreeListFilterableOperatorsDate]
  }
  
  @scala.inline
  implicit class TreeListFilterableOperatorsDateMutableBuilder[Self <: TreeListFilterableOperatorsDate] (val x: Self) extends AnyVal {
