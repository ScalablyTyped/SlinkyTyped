...
object DateInputMessages {
  ...
  @scala.inline
  implicit class DateInputMessagesMutableBuilder[Self <: DateInputMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDayperiod(value: String): Self = StObject.set(x, "dayperiod", value.asInstanceOf[js.Any])
