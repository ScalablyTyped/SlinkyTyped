...
object DateInputMessages {
  ...
  implicit class DateInputMessagesOps[Self <: DateInputMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDayperiod(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dayperiod")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDayperiod: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dayperiod")(js.undefined)
        ret
    }
    @scala.inline
