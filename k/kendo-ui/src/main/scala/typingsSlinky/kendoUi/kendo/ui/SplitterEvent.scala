...
object SplitterEvent {
  ...
  @scala.inline
  implicit class SplitterEventOps[Self <: SplitterEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Splitter): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
