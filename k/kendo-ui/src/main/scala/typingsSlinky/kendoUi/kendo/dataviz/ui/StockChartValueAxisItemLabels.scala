...
trait StockChartValueAxisItemLabels extends StObject {
  ...
  var border: js.UndefOr[StockChartValueAxisItemLabelsBorder] = js.native
...
object StockChartValueAxisItemLabels {
  ...
  @scala.inline
  def apply(): StockChartValueAxisItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemLabels]
  }
  
  @scala.inline
  implicit class StockChartValueAxisItemLabelsMutableBuilder[Self <: StockChartValueAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartValueAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
