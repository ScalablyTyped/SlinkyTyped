...
object StockChartValueAxisItemLabels {
  ...
  @scala.inline
  implicit class StockChartValueAxisItemLabelsOps[Self <: StockChartValueAxisItemLabels] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: StockChartValueAxisItemLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
