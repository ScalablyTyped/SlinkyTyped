...
object ChartSeriesItemLabels {
  ...
  implicit class ChartSeriesItemLabelsOps[Self <: ChartSeriesItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartSeriesItemLabelsBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFrom(value: ChartSeriesItemLabelsFrom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartSeriesItemLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartSeriesItemLabelsPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTo(value: ChartSeriesItemLabelsTo): Self = {
        val ret = this.duplicate
