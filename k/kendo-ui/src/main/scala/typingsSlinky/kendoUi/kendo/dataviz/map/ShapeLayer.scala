...
object ShapeLayer {
  ...
  implicit class ShapeLayerOps[Self <: ShapeLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOptions(value: ShapeLayerOptions): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("options")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSetDataSource(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setDataSource")(js.Any.fromFunction0(value))
        ret
    }
  }
