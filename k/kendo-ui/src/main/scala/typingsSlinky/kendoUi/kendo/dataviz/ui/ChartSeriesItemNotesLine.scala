...
@js.native
trait ChartSeriesItemNotesLine extends StObject {
...
object ChartSeriesItemNotesLine {
  ...
  @scala.inline
  def apply(): ChartSeriesItemNotesLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartSeriesItemNotesLine]
  }
  
  @scala.inline
  implicit class ChartSeriesItemNotesLineMutableBuilder[Self <: ChartSeriesItemNotesLine] (val x: Self) extends AnyVal {
