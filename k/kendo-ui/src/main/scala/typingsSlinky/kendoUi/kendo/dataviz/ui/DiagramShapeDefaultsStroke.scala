...
@js.native
trait DiagramShapeDefaultsStroke extends StObject {
...
object DiagramShapeDefaultsStroke {
  ...
  @scala.inline
  def apply(): DiagramShapeDefaultsStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeDefaultsStroke]
  }
  
  @scala.inline
  implicit class DiagramShapeDefaultsStrokeMutableBuilder[Self <: DiagramShapeDefaultsStroke] (val x: Self) extends AnyVal {
