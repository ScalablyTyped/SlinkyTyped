...
@js.native
trait ChartXAxisItemLine extends StObject {
...
object ChartXAxisItemLine {
  ...
  @scala.inline
  def apply(): ChartXAxisItemLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartXAxisItemLine]
  }
  
  @scala.inline
  implicit class ChartXAxisItemLineMutableBuilder[Self <: ChartXAxisItemLine] (val x: Self) extends AnyVal {
