...
object RectangleEvent {
  ...
  @scala.inline
  implicit class RectangleEventOps[Self <: RectangleEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Rectangle): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
