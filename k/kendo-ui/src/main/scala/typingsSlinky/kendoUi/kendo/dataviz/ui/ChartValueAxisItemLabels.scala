...
object ChartValueAxisItemLabels {
  ...
  implicit class ChartValueAxisItemLabelsOps[Self <: ChartValueAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartValueAxisItemLabelsBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartValueAxisItemLabelsMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartValueAxisItemLabelsPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRotation(value: String | Double | ChartValueAxisItemLabelsRotation): Self = {
        val ret = this.duplicate
