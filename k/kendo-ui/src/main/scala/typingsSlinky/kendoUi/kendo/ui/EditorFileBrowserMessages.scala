...
@js.native
trait EditorFileBrowserMessages extends StObject {
...
object EditorFileBrowserMessages {
  ...
  @scala.inline
  def apply(): EditorFileBrowserMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EditorFileBrowserMessages]
  }
  
  @scala.inline
  implicit class EditorFileBrowserMessagesMutableBuilder[Self <: EditorFileBrowserMessages] (val x: Self) extends AnyVal {
