...
object SparklineSeriesLeaveEvent {
  ...
  @scala.inline
  implicit class SparklineSeriesLeaveEventOps[Self <: SparklineSeriesLeaveEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSeries(value: SparklineSeriesLeaveEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
    @scala.inline
