...
trait SparklineSeriesLeaveEvent extends SparklineEvent {
  ...
  var series: js.UndefOr[SparklineSeriesLeaveEventSeries] = js.native
...
object SparklineSeriesLeaveEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Sparkline): SparklineSeriesLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklineSeriesLeaveEvent]
  }
  
  @scala.inline
  implicit class SparklineSeriesLeaveEventMutableBuilder[Self <: SparklineSeriesLeaveEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: SparklineSeriesLeaveEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
