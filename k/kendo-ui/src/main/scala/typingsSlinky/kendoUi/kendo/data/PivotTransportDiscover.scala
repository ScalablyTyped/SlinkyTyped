...
@js.native
trait PivotTransportDiscover extends StObject {
...
object PivotTransportDiscover {
  ...
  @scala.inline
  def apply(): PivotTransportDiscover = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PivotTransportDiscover]
  }
  
  @scala.inline
  implicit class PivotTransportDiscoverMutableBuilder[Self <: PivotTransportDiscover] (val x: Self) extends AnyVal {
