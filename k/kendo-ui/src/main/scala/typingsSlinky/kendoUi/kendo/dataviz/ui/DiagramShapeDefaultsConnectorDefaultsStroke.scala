...
@js.native
trait DiagramShapeDefaultsConnectorDefaultsStroke extends StObject {
...
object DiagramShapeDefaultsConnectorDefaultsStroke {
  ...
  @scala.inline
  def apply(): DiagramShapeDefaultsConnectorDefaultsStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeDefaultsConnectorDefaultsStroke]
  }
  
  @scala.inline
  implicit class DiagramShapeDefaultsConnectorDefaultsStrokeMutableBuilder[Self <: DiagramShapeDefaultsConnectorDefaultsStroke] (val x: Self) extends AnyVal {
