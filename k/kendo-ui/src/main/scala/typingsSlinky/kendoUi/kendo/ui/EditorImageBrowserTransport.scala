...
object EditorImageBrowserTransport {
  ...
  implicit class EditorImageBrowserTransportOps[Self <: EditorImageBrowserTransport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: String | EditorImageBrowserTransportCreate): Self = {
    ...
    @scala.inline
    def withDestroy(value: String | EditorImageBrowserTransportDestroy): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withImageUrl(value: String | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRead(value: String | js.Function | EditorImageBrowserTransportRead): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withThumbnailUrl(value: String | js.Function): Self = {
        val ret = this.duplicate
