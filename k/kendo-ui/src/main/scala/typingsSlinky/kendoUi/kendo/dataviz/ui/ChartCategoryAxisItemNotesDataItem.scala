...
object ChartCategoryAxisItemNotesDataItem {
  ...
  implicit class ChartCategoryAxisItemNotesDataItemOps[Self <: ChartCategoryAxisItemNotesDataItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcon(value: ChartCategoryAxisItemNotesDataItemIcon): Self = {
    ...
    @scala.inline
    def withLabel(value: ChartCategoryAxisItemNotesDataItemLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: ChartCategoryAxisItemNotesDataItemLine): Self = {
        val ret = this.duplicate
