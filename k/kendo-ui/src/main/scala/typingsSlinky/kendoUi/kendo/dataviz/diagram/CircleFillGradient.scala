...
trait CircleFillGradient extends js.Object {
  ...
  var stops: js.UndefOr[js.Array[CircleFillGradientStop]] = js.native
...
object CircleFillGradient {
  ...
  @scala.inline
  implicit class CircleFillGradientOps[Self <: CircleFillGradient] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStopsVarargs(value: CircleFillGradientStop*): Self = this.set("stops", js.Array(value :_*))
    @scala.inline
    def setStops(value: js.Array[CircleFillGradientStop]): Self = this.set("stops", value.asInstanceOf[js.Any])
    @scala.inline
