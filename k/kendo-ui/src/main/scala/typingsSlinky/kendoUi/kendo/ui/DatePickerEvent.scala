...
object DatePickerEvent {
  ...
  @scala.inline
  implicit class DatePickerEventOps[Self <: DatePickerEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: DatePicker): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
