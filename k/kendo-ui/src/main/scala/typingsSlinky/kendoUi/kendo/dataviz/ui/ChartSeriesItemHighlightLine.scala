...
@js.native
trait ChartSeriesItemHighlightLine extends StObject {
...
object ChartSeriesItemHighlightLine {
  ...
  @scala.inline
  def apply(): ChartSeriesItemHighlightLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartSeriesItemHighlightLine]
  }
  
  @scala.inline
  implicit class ChartSeriesItemHighlightLineMutableBuilder[Self <: ChartSeriesItemHighlightLine] (val x: Self) extends AnyVal {
