...
object ConnectorEvent {
  ...
  @scala.inline
  implicit class ConnectorEventOps[Self <: ConnectorEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Connector): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
