...
object ChartSeriesItemLabelsTo {
  ...
  implicit class ChartSeriesItemLabelsToOps[Self <: ChartSeriesItemLabelsTo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: ChartSeriesItemLabelsToBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFont(value: String | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFormat(value: String | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: Double | ChartSeriesItemLabelsToMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPadding(value: Double | ChartSeriesItemLabelsToPadding): Self = {
        val ret = this.duplicate
