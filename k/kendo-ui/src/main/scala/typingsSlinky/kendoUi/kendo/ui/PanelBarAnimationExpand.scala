...
@js.native
trait PanelBarAnimationExpand extends StObject {
...
object PanelBarAnimationExpand {
  ...
  @scala.inline
  implicit class PanelBarAnimationExpandMutableBuilder[Self <: PanelBarAnimationExpand] (val x: Self) extends AnyVal {
