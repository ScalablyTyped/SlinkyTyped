...
object SparklineValueAxisItemNotes {
  ...
  implicit class SparklineValueAxisItemNotesOps[Self <: SparklineValueAxisItemNotes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: js.Array[SparklineValueAxisItemNotesDataItem]): Self = {
    ...
    @scala.inline
    def withIcon(value: SparklineValueAxisItemNotesIcon): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: SparklineValueAxisItemNotesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: SparklineValueAxisItemNotesLine): Self = {
        val ret = this.duplicate
