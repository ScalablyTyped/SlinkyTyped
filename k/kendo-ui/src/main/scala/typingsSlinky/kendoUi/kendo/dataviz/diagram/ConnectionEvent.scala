...
object ConnectionEvent {
  ...
  @scala.inline
  implicit class ConnectionEventOps[Self <: ConnectionEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: Connection): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
