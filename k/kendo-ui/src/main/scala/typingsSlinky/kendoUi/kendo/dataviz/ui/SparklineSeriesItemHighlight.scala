...
object SparklineSeriesItemHighlight {
  ...
  @scala.inline
  implicit class SparklineSeriesItemHighlightOps[Self <: SparklineSeriesItemHighlight] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SparklineSeriesItemHighlightBorder): Self = this.set("border", value.asInstanceOf[js.Any])
