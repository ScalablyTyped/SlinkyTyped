...
object SchedulerOptions {
  ...
  implicit class SchedulerOptionsOps[Self <: SchedulerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWorkDayEnd(value: js.Date): Self = this.set("workDayEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWorkDayEnd: Self = this.set("workDayEnd", js.undefined)
    @scala.inline
    def setWorkDayStart(value: js.Date): Self = this.set("workDayStart", value.asInstanceOf[js.Any])
    @scala.inline
