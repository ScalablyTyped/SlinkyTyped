...
@js.native
trait SparklineSeriesItemMarkers extends StObject {
...
object SparklineSeriesItemMarkers {
  ...
  @scala.inline
  implicit class SparklineSeriesItemMarkersMutableBuilder[Self <: SparklineSeriesItemMarkers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: js.Function | SparklineSeriesItemMarkersBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
