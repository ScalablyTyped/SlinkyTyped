...
object MaskedTextBoxEvent {
  ...
  @scala.inline
  implicit class MaskedTextBoxEventOps[Self <: MaskedTextBoxEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: MaskedTextBox): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
