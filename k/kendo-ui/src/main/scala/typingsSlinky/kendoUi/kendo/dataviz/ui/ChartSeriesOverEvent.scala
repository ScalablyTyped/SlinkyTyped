...
trait ChartSeriesOverEvent extends ChartEvent {
  ...
  var series: js.UndefOr[ChartSeriesOverEventSeries] = js.native
...
object ChartSeriesOverEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartSeriesOverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartSeriesOverEvent]
  }
  
  @scala.inline
  implicit class ChartSeriesOverEventMutableBuilder[Self <: ChartSeriesOverEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: ChartSeriesOverEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
