...
object ChartSeriesOverEvent {
  ...
  @scala.inline
  implicit class ChartSeriesOverEventOps[Self <: ChartSeriesOverEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: ChartSeriesOverEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
