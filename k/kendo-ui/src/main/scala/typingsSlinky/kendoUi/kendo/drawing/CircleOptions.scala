...
object CircleOptions {
  ...
  implicit class CircleOptionsMutableBuilder[Self <: CircleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFill(value: FillOptions): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStroke(value: StrokeOptions): Self = StObject.set(x, "stroke", value.asInstanceOf[js.Any])
