...
object ChartValueAxisItemNotesDataItem {
  ...
  implicit class ChartValueAxisItemNotesDataItemOps[Self <: ChartValueAxisItemNotesDataItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIcon(value: ChartValueAxisItemNotesDataItemIcon): Self = {
    ...
    @scala.inline
    def withLabel(value: ChartValueAxisItemNotesDataItemLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLine(value: ChartValueAxisItemNotesDataItemLine): Self = {
        val ret = this.duplicate
