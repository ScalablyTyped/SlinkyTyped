...
@js.native
trait ImageEditorToolbarItem extends StObject {
...
object ImageEditorToolbarItem {
  
  @scala.inline
  def apply(): ImageEditorToolbarItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ImageEditorToolbarItem]
  }
  
  @scala.inline
  implicit class ImageEditorToolbarItemMutableBuilder[Self <: ImageEditorToolbarItem] (val x: Self) extends AnyVal {
