...
object MultiPathEvent {
  ...
  @scala.inline
  implicit class MultiPathEventOps[Self <: MultiPathEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: MultiPath): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
