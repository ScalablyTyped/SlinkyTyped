...
@js.native
trait FileManagerToolbarItem extends StObject {
...
object FileManagerToolbarItem {
  ...
  @scala.inline
  implicit class FileManagerToolbarItemMutableBuilder[Self <: FileManagerToolbarItem] (val x: Self) extends AnyVal {
