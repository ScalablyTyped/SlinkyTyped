...
@js.native
trait AnonNamesAbbr extends js.Object {
  var names: js.Array[String] = js.native
  var namesAbbr: js.Array[String] = js.native
}

object AnonNamesAbbr {
  @scala.inline
  def apply(names: js.Array[String], namesAbbr: js.Array[String]): AnonNamesAbbr = {
    val __obj = js.Dynamic.literal(names = names.asInstanceOf[js.Any], namesAbbr = namesAbbr.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonNamesAbbr]
  }
  @scala.inline
  implicit class AnonNamesAbbrOps[Self <: AnonNamesAbbr] (val x: Self) extends AnyVal {
    @scala.inline
