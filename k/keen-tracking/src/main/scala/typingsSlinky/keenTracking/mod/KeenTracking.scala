...
import typingsSlinky.keenTracking.AnonCreated
...
trait KeenTracking extends js.Object {
  def recordEvent(collectionName: String, event: js.Object): js.Promise[AnonCreated] = js.native
...
object KeenTracking {
  ...
  implicit class KeenTrackingOps[Self <: KeenTracking] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRecordEvent(value: (String, js.Object) => js.Promise[AnonCreated]): Self = {
