...
object ^ extends js.Object {
  ...
  def combine[T /* <: StringDictionary[Observable[_, _]] */, K /* <: StringDictionary[Observable[_, _]] */](obss: T, passiveObss: K): Stream_[typingsSlinky.kefir.kefirStrings.^  with TopLevel[T] with TopLevel[K], _] = js.native
  ...
  var staticLand: typingsSlinky.kefir.anon.Observable = js.native
