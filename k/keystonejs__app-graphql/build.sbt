...
version := "5.0-dt-20200322Z-959dfe"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "keystonejs__fields" % "5.1-dt-20191115Z-0efcb9",
  "org.scalablytyped.slinky" %%% "keystonejs__keystone" % "6.0-dt-20200323Z-d236bb",
