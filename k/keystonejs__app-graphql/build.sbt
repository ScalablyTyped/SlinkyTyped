...
version := "5.0-dt-20191115Z-bfd19c"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "keystonejs__fields" % "5.1-dt-20191115Z-576a43",
  "org.scalablytyped.slinky" %%% "keystonejs__keystone" % "5.2-dt-20191231Z-001bc6",
