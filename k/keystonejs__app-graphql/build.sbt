...
version := "5.0-dt-20191115Z-2eceda"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "keystonejs__fields" % "5.1-dt-20191115Z-036cc5",
  "org.scalablytyped.slinky" %%% "keystonejs__keystone" % "5.2-dt-20191231Z-6cdd8d",
