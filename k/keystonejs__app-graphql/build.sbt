...
name := "keystonejs__app-graphql"
version := "5.0-dt-20200322Z-75a095"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "keystonejs__fields" % "5.1-dt-20191115Z-872661",
  "org.scalablytyped.slinky" %%% "keystonejs__keystone" % "6.0-dt-20200323Z-bd1fef",
