...
object AdminUIOptions {
  ...
  @scala.inline
  def apply[ListNames /* <: String */, UserType /* <: js.Object */](): AdminUIOptions[ListNames, UserType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AdminUIOptions[ListNames, UserType]]
  }
  
  @scala.inline
  implicit class AdminUIOptionsOps[Self <: AdminUIOptions[_, _], ListNames /* <: String */, UserType /* <: js.Object */] (val x: Self with (AdminUIOptions[ListNames, UserType])) extends AnyVal {
