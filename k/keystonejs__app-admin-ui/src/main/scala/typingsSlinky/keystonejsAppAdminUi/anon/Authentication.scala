...
object Authentication {
  ...
  @scala.inline
  def apply[UserType /* <: js.Object */, ListNames /* <: String */](authentication: Item[UserType, ListNames]): Authentication[UserType, ListNames] = {
  ...
  @scala.inline
  implicit class AuthenticationOps[Self <: Authentication[_, _], UserType /* <: js.Object */, ListNames /* <: String */] (val x: Self with (Authentication[UserType, ListNames])) extends AnyVal {
