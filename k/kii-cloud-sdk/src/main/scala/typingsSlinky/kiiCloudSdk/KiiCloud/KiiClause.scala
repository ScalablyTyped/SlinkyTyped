...
object KiiClause extends js.Object {
  /**
    ...
    */
  def and(A: KiiClause*): KiiClause = js.native
  /**
    ...
    */
  def equals(key: String, value: js.Any): KiiClause = js.native
  /**
    ...
    */
  def geoBox(key: String, northEast: KiiGeoPoint, southWest: KiiGeoPoint): KiiClause = js.native
  /**
    ...
    */
  def geoDistance(key: String, center: KiiGeoPoint, radius: Double, putDistanceInto: String): KiiClause = js.native
  /**
    * Create an expression of the form (key > value)
    *
    * @param key The key to compare
    * @param value the value to compare
    */
  def greaterThan(key: String, value: js.Any): KiiClause = js.native
  /**
    * Create an expression of the form (key >= value)
    *
    * @param key The key to compare
    * @param value the value to compare
    */
  def greaterThanOrEqual(key: String, value: js.Any): KiiClause = js.native
  /**
    ...
    */
  def hasField(key: String, fieldType: String): KiiClause = js.native
  /**
    ...
    */
  def inClause(key: String, values: js.Array[_]): KiiClause = js.native
  /**
    * Create an expression of the form (key < value)
    *
    * @param key The key to compare
    * @param value the value to compare
    */
  def lessThan(key: String, value: js.Any): KiiClause = js.native
  /**
    * Create an expression of the form (key <= value)
    *
    * @param key The key to compare
    * @param value the value to compare
    */
  def lessThanOrEqual(key: String, value: js.Any): KiiClause = js.native
  /**
    ...
    */
  def not(clause: KiiClause): KiiClause = js.native
  /**
    * Create an expression of the form (key != value)
    *
    * @param key The key to compare
    * @param value the value to compare
    */
  def notEquals(key: String, value: js.Any): KiiClause = js.native
  /**
    ...
    */
  def or(A: KiiClause*): KiiClause = js.native
  /**
    ...
    * @param value the value to compare
    */
  def startsWith(key: String, value: js.Any): KiiClause = js.native
}
