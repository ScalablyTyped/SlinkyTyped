...
class KiiUserBuilder ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def build(): typingsSlinky.kiiCloudSdk.KiiCloud.KiiUser = js.native
  /**
    * Set email address.
    *
    ...
    */
  /* CompleteClass */
  override def setEmailAddress(emailAddress: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiUserBuilder = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setGlobalPhoneNumber(phoneNumber: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiUserBuilder = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setLocalPhoneNumber(phoneNumber: String, country: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiUserBuilder = js.native
  /**
    * Set user name.
    *
    ...
    */
  /* CompleteClass */
  override def setUsername(username: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiUserBuilder = js.native
}
