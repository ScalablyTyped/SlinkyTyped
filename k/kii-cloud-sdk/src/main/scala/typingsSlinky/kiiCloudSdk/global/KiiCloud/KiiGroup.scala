...
@js.native
class KiiGroup ()
  extends typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup
/* static members */
@JSGlobal("KiiCloud.KiiGroup")
@js.native
object KiiGroup extends js.Object {
  ...
  /**
    ...
    */
  def groupWithID(groupId: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup = js.native
  ...
  /**
    ...
    */
  def groupWithName(groupName: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup = js.native
  ...
  /**
    ...
    */
  def groupWithNameAndMembers(groupName: String, members: js.Array[typingsSlinky.kiiCloudSdk.KiiCloud.KiiUser]): typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup = js.native
  ...
  /**
    ...
    */
  def groupWithURI(uri: String): typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup = js.native
  ...
  /**
    ...
    *     });
    */
  def registerGroupWithID(groupID: String, groupName: String, members: js.Array[typingsSlinky.kiiCloudSdk.KiiCloud.KiiUser]): js.Promise[typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup] = js.native
  def registerGroupWithID(
    groupID: String,
    groupName: String,
    members: js.Array[typingsSlinky.kiiCloudSdk.KiiCloud.KiiUser],
    callbacks: `10`
  ): js.Promise[typingsSlinky.kiiCloudSdk.KiiCloud.KiiGroup] = js.native
}
