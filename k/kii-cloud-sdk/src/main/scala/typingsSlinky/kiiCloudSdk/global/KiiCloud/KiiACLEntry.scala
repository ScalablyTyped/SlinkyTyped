...
class KiiACLEntry ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAction(): typingsSlinky.kiiCloudSdk.KiiCloud.KiiACLAction = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setAction(value: typingsSlinky.kiiCloudSdk.KiiCloud.KiiACLAction): Unit = js.native
  /**
