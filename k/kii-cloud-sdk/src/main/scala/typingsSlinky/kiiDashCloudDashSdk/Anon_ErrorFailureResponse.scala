...
import typingsSlinky.kiiDashCloudDashSdk.KiiCloud.KiiGcmInstallationResponse
...
object Anon_ErrorFailureResponse {
  @scala.inline
  def apply(failure: js.Error => js.Any, success: KiiGcmInstallationResponse => js.Any): Anon_ErrorFailureResponse = {
