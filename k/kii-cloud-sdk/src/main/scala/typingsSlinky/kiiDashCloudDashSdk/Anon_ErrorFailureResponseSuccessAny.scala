...
import typingsSlinky.kiiDashCloudDashSdk.KiiCloud.KiiMqttEndpoint
...
object Anon_ErrorFailureResponseSuccessAny {
  @scala.inline
  def apply(failure: js.Error => js.Any, success: KiiMqttEndpoint => js.Any): Anon_ErrorFailureResponseSuccessAny = {
