...
import typingsSlinky.kiiDashCloudDashSdk.Anon_AdminContext
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorString
import typingsSlinky.kiiDashCloudDashSdk.Anon_Error
...
object Kii extends js.Object {
  ...
  def authenticateAsAppAdmin(clientId: String, clientSecret: String, callbacks: Anon_AdminContext): js.Promise[KiiAppAdminContext] = js.native
  /**
  ...
  def authenticateAsThing(vendorThingID: String, password: String, callbacks: Anon_Error): js.Promise[KiiThingContext] = js.native
  /**
  ...
  def authenticateAsThingWithToken(thingID: String, token: String, callbacks: Anon_Error): js.Promise[KiiThingContext] = js.native
  /**
  ...
  /**
    ...
    *     Kii.initializeWithSite("my-app-id", "my-app-key", KiiSite.JP, {});
    */
  def initializeWithSite(appID: String, appKey: String, site: KiiSite): Unit = js.native
  def initializeWithSite(appID: String, appKey: String, site: KiiSite, analyticsOption: js.Any): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def serverCodeEntry(entryName: String): KiiServerCodeEntry = js.native
  /**
    ...
    */
  def serverCodeEntryWithVersion(entryName: String, version: String): KiiServerCodeEntry = js.native
  /**
