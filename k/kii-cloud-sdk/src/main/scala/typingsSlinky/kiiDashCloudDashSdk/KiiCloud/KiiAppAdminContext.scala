...
import typingsSlinky.kiiDashCloudDashSdk.Anon_AddMembersArray
import typingsSlinky.kiiDashCloudDashSdk.Anon_AdminContextAnErrorString
...
class KiiAppAdminContext () extends js.Object {
  ...
  def findUserByEmail(email: String, callbacks: Anon_AdminContextAnErrorString): js.Promise[js.Tuple2[KiiAppAdminContext, KiiUser]] = js.native
  /**
  ...
  def findUserByPhone(phone: String, callbacks: Anon_AdminContextAnErrorString): js.Promise[js.Tuple2[KiiAppAdminContext, KiiUser]] = js.native
  /**
  ...
  def findUserByUsername(username: String, callbacks: Anon_AdminContextAnErrorString): js.Promise[js.Tuple2[KiiAppAdminContext, KiiUser]] = js.native
  /**
  ...
  def loadThingWithThingID(thingID: String, callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
  ...
  def loadThingWithVendorThingID(vendorThingID: String, callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
  ...
  def registerGroupWithOwnerAndID(
    ...
    callbacks: Anon_AddMembersArray
  ...
  def registerThing(fields: KiiThingFields, callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
