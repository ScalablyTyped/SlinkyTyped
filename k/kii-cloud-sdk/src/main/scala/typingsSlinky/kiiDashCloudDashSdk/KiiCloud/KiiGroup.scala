...
import typingsSlinky.kiiDashCloudDashSdk.Anon_AddMembersArrayAnErrorString
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorString
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorStringFailureMemberList
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccessTheDeletedGroup
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccessTheGroup
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccessTheGroupTheOwner
...
class KiiGroup () extends KiiACLSubject {
  ...
  def changeGroupName(newName: String, callbacks: Anon_AnErrorStringFailureSuccessTheGroup): js.Promise[KiiGroup] = js.native
  /**
  ...
  def delete(callbacks: Anon_AnErrorStringFailureSuccessTheDeletedGroup): js.Promise[KiiGroup] = js.native
  /**
  ...
  def getMemberList(callbacks: Anon_AnErrorStringFailureMemberList): js.Promise[js.Tuple2[KiiGroup, js.Array[KiiUser]]] = js.native
  /**
  ...
  def getOwner(callbacks: Anon_AnErrorStringFailureSuccessTheGroupTheOwner): js.Promise[js.Tuple2[KiiGroup, KiiUser]] = js.native
  /**
    *
    *
  ...
  def refresh(callbacks: Anon_AnErrorStringFailureSuccessTheGroup): js.Promise[KiiGroup] = js.native
  /**
  ...
  def save(callbacks: Anon_AddMembersArrayAnErrorString): js.Promise[KiiGroup] = js.native
  /**
  ...
  def saveWithOwner(user: String, callbacks: Anon_AddMembersArrayAnErrorString): js.Promise[KiiGroup] = js.native
  /**
...
object KiiGroup extends js.Object {
  ...
  def registerGroupWithID(
    ...
    callbacks: Anon_AddMembersArrayAnErrorString
