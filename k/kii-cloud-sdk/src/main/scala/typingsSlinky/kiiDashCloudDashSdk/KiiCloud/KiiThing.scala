...
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorString
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureGroup
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureGroupSuccess
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureGroupSuccessThing
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureGroupSuccessThingAny
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureIsOwner
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureIsOwnerSuccess
import typingsSlinky.kiiDashCloudDashSdk.Anon_ErrorFailureSuccess
...
class KiiThing () extends KiiACLSubject {
  ...
  def deleteThing(callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
    * Disable the thing.
    * <br>This API is authorized by owner of thing.
    * <br>Need user login who owns this thing before execute this API.
  ...
  def disable(callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
    * Enable the thing.
    * <br>This API is authorized by owner of thing.
    * <br>Need user login who owns this thing before execute this API.
  ...
  def enable(callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
  ...
  def isOwner(owner: KiiGroup, callbacks: Anon_ErrorFailureIsOwnerSuccess): js.Promise[js.Tuple3[KiiThing, KiiGroup, Boolean]] = js.native
  /**
  ...
  def isOwner(owner: KiiUser, callbacks: Anon_ErrorFailureIsOwner): js.Promise[js.Tuple3[KiiThing, KiiUser, Boolean]] = js.native
  /**
  ...
  def listTopics(callbacks: Anon_AnErrorString): js.Promise[js.Tuple2[js.Array[KiiTopic], String]] = js.native
  def listTopics(callbacks: Anon_AnErrorString, paginationKey: String): js.Promise[js.Tuple2[js.Array[KiiTopic], String]] = js.native
  /**
  ...
  def refresh(callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  def registerOwner(owner: KiiGroup): js.Promise[js.Tuple2[KiiThing, KiiGroup]] = js.native
  def registerOwner(owner: KiiGroup, callbacks: Anon_ErrorFailureGroupSuccessThingAny): js.Promise[js.Tuple2[KiiThing, KiiGroup]] = js.native
  /**
  ...
  def registerOwner(owner: KiiUser, callbacks: Anon_ErrorFailureGroupSuccessThing): js.Promise[js.Tuple2[KiiThing, KiiUser]] = js.native
  /**
  ...
  def unregisterOwner(owner: KiiGroup, callbacks: Anon_ErrorFailureGroupSuccessThingAny): js.Promise[js.Tuple2[KiiThing, KiiGroup]] = js.native
  /**
  ...
  def unregisterOwner(owner: KiiUser, callbacks: Anon_ErrorFailureGroupSuccessThing): js.Promise[js.Tuple2[KiiThing, KiiUser]] = js.native
  /**
  ...
  def update(callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
}
...
object KiiThing extends js.Object {
  ...
  def loadWithThingID(thingID: String, callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
  ...
  def loadWithVendorThingID(vendorThingID: String, callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  /**
  ...
  def register(fields: KiiThingFields, callbacks: Anon_ErrorFailureSuccess): js.Promise[KiiThing] = js.native
  def registerOwnerWithThingID(thingID: String, owner: KiiGroup): js.Promise[KiiGroup] = js.native
  def registerOwnerWithThingID(thingID: String, owner: KiiGroup, callbacks: Anon_ErrorFailureGroupSuccess): js.Promise[KiiGroup] = js.native
  /**
  ...
  def registerOwnerWithThingID(thingID: String, owner: KiiUser, callbacks: Anon_ErrorFailureGroup): js.Promise[KiiUser] = js.native
  def registerOwnerWithVendorThingID(vendorThingID: String, owner: KiiGroup): js.Promise[KiiGroup] = js.native
  def registerOwnerWithVendorThingID(vendorThingID: String, owner: KiiGroup, callbacks: Anon_ErrorFailureGroupSuccess): js.Promise[KiiGroup] = js.native
  /**
    * Register user/group as owner of specified thing.
    * <br>Need user login before execute this API.
    * <br>Note: if you obtain thing instance from {@link KiiAppAdminContext},
  ...
  def registerOwnerWithVendorThingID(vendorThingID: String, owner: KiiUser, callbacks: Anon_ErrorFailureGroup): js.Promise[KiiUser] = js.native
}
