...
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorStringFailure
import typingsSlinky.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccess
...
class KiiACL () extends js.Object {
  ...
  def listACLEntries(callbacks: Anon_AnErrorStringFailure): js.Promise[js.Tuple2[KiiACL, js.Array[KiiACLEntry]]] = js.native
  /**
  ...
  def save(callbacks: Anon_AnErrorStringFailureSuccess): js.Promise[KiiACL] = js.native
}
