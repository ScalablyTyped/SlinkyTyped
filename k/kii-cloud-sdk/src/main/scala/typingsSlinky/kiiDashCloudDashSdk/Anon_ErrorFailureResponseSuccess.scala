...
import typingsSlinky.kiiDashCloudDashSdk.KiiCloud.KiiMqttInstallationResponse
...
object Anon_ErrorFailureResponseSuccess {
  @scala.inline
  def apply(failure: js.Error => js.Any, success: KiiMqttInstallationResponse => js.Any): Anon_ErrorFailureResponseSuccess = {
