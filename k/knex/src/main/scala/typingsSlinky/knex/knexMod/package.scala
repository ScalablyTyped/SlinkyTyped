...
package object knexMod {
  ...
  import typingsSlinky.knex.knexMod.DeferredKeySelection.Resolve
  ...
  // Utility Types
  //
  type Value = String | Double | Boolean | js.Date | (js.Array[Boolean | js.Date | Double | String]) | Buffer | Raw[js.Any]
