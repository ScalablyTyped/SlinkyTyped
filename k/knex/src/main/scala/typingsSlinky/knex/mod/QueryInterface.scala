...
import typingsSlinky.knex.mod.DeferredKeySelection.AddUnionMember
import typingsSlinky.knex.resultMod.Registry
...
trait QueryInterface[TRecord /* <: js.Object */, TResult] extends js.Object {
  ...
  // Order by
  def orderBy(columnDefs: js.Array[Column[TRecord] | Order | (/* keyof TRecord */ String)]): QueryBuilder[TRecord, TResult] = js.native
  // Order by
