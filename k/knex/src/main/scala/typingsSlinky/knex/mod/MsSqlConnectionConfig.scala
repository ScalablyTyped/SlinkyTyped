...
trait MsSqlConnectionConfig extends js.Object {
  ...
  var options: js.UndefOr[AbortTransactionOnError] = js.undefined
  var parseJSON: js.UndefOr[Boolean] = js.undefined
  var password: js.UndefOr[String] = js.undefined
  var pool: js.UndefOr[AcquireTimeoutMillis] = js.undefined
...
object MsSqlConnectionConfig {
  ...
  def apply(
    ...
    domain: String = null,
    driver: String = null,
    options: AbortTransactionOnError = null,
    parseJSON: js.UndefOr[Boolean] = js.undefined,
    password: String = null,
    pool: AcquireTimeoutMillis = null,
