...
trait Having[TRecord, TResult]
  ...
  def apply[K1 /* <: /* keyof TRecord */ String */, K2 /* <: /* keyof TRecord */ String */](tableName: String, column1: K1, operator: ComparisionOperator, column2: K2): QueryBuilder[TRecord, TResult] = js.native
}
