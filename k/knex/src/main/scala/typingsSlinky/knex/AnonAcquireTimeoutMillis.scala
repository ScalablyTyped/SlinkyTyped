...
@js.native
trait AnonAcquireTimeoutMillis extends js.Object {
...
object AnonAcquireTimeoutMillis {
  @scala.inline
  def apply(): AnonAcquireTimeoutMillis = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAcquireTimeoutMillis]
  }
  @scala.inline
  implicit class AnonAcquireTimeoutMillisOps[Self <: AnonAcquireTimeoutMillis] (val x: Self) extends AnyVal {
    @scala.inline
