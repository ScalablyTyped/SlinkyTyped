...
object ParallelOptions {
  ...
  implicit class ParallelOptionsOps[Self <: ParallelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAggregatedReporterTestRegExp(value: js.RegExp): Self = this.set("aggregatedReporterTest", value.asInstanceOf[js.Any])
    @scala.inline
    def setAggregatedReporterTest(value: (js.Function1[/* reporter */ js.Object, Boolean]) | js.RegExp): Self = this.set("aggregatedReporterTest", value.asInstanceOf[js.Any])
    @scala.inline
