package typingsSlinky.karmaParallel
...
object mod {
  ...
  object ParallelOptions {
    ...
    implicit class ParallelOptionsMutableBuilder[Self <: ParallelOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAggregatedReporterTest(value: (js.Function1[/* reporter */ js.Object, Boolean]) | js.RegExp): Self = StObject.set(x, "aggregatedReporterTest", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setAggregatedReporterTestRegExp(value: js.RegExp): Self = StObject.set(x, "aggregatedReporterTest", value.asInstanceOf[js.Any])
