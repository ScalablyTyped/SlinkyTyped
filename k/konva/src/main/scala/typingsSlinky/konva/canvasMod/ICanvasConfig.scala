package typingsSlinky.konva.canvasMod
...
@js.native
trait ICanvasConfig extends js.Object {
...
object ICanvasConfig {
  ...
  @scala.inline
  implicit class ICanvasConfigOps[Self <: ICanvasConfig] (val x: Self) extends AnyVal {
