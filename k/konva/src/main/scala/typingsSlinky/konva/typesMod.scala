...
object typesMod {
  ...
  object KonvaNodeEvent extends StObject {
    ...
    /* "click" */ val click: typingsSlinky.konva.typesMod.KonvaNodeEvent.click with String = js.native
    
    @js.native
    sealed trait contextmenu extends KonvaNodeEvent
    /* "contextmenu" */ val contextmenu: typingsSlinky.konva.typesMod.KonvaNodeEvent.contextmenu with String = js.native
    
    @js.native
    sealed trait dblclick extends KonvaNodeEvent
    /* "dblclick" */ val dblclick: typingsSlinky.konva.typesMod.KonvaNodeEvent.dblclick with String = js.native
    
    @js.native
    sealed trait dbltap extends KonvaNodeEvent
    /* "dbltap" */ val dbltap: typingsSlinky.konva.typesMod.KonvaNodeEvent.dbltap with String = js.native
    
    @js.native
    sealed trait dragend extends KonvaNodeEvent
    /* "dragend" */ val dragend: typingsSlinky.konva.typesMod.KonvaNodeEvent.dragend with String = js.native
    
    @js.native
    sealed trait dragmove extends KonvaNodeEvent
    /* "dragmove" */ val dragmove: typingsSlinky.konva.typesMod.KonvaNodeEvent.dragmove with String = js.native
    
    @js.native
    sealed trait dragstart extends KonvaNodeEvent
    /* "dragstart" */ val dragstart: typingsSlinky.konva.typesMod.KonvaNodeEvent.dragstart with String = js.native
    
    @js.native
    sealed trait mousedown extends KonvaNodeEvent
    /* "mousedown" */ val mousedown: typingsSlinky.konva.typesMod.KonvaNodeEvent.mousedown with String = js.native
    
    @js.native
    sealed trait mouseenter extends KonvaNodeEvent
    /* "mouseenter" */ val mouseenter: typingsSlinky.konva.typesMod.KonvaNodeEvent.mouseenter with String = js.native
    
    @js.native
    sealed trait mouseleave extends KonvaNodeEvent
    /* "mouseleave" */ val mouseleave: typingsSlinky.konva.typesMod.KonvaNodeEvent.mouseleave with String = js.native
    
    @js.native
    sealed trait mousemove extends KonvaNodeEvent
    /* "mousemove" */ val mousemove: typingsSlinky.konva.typesMod.KonvaNodeEvent.mousemove with String = js.native
    
    @js.native
    sealed trait mouseout extends KonvaNodeEvent
    /* "mouseout" */ val mouseout: typingsSlinky.konva.typesMod.KonvaNodeEvent.mouseout with String = js.native
    
    @js.native
    sealed trait mouseover extends KonvaNodeEvent
    /* "mouseover" */ val mouseover: typingsSlinky.konva.typesMod.KonvaNodeEvent.mouseover with String = js.native
    
    @js.native
    sealed trait mouseup extends KonvaNodeEvent
    /* "mouseup" */ val mouseup: typingsSlinky.konva.typesMod.KonvaNodeEvent.mouseup with String = js.native
    
    @js.native
    sealed trait tap extends KonvaNodeEvent
    /* "tap" */ val tap: typingsSlinky.konva.typesMod.KonvaNodeEvent.tap with String = js.native
    
    @js.native
    sealed trait touchend extends KonvaNodeEvent
    /* "touchend" */ val touchend: typingsSlinky.konva.typesMod.KonvaNodeEvent.touchend with String = js.native
    
    @js.native
    sealed trait touchmove extends KonvaNodeEvent
    /* "touchmove" */ val touchmove: typingsSlinky.konva.typesMod.KonvaNodeEvent.touchmove with String = js.native
    
    @js.native
    sealed trait touchstart extends KonvaNodeEvent
    /* "touchstart" */ val touchstart: typingsSlinky.konva.typesMod.KonvaNodeEvent.touchstart with String = js.native
    
    @js.native
    sealed trait wheel extends KonvaNodeEvent
    /* "wheel" */ val wheel: typingsSlinky.konva.typesMod.KonvaNodeEvent.wheel with String = js.native
  }
