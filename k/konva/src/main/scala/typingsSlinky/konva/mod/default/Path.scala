...
import typingsSlinky.konva.anon.XY
...
@js.native
object Path
  extends Instantiable0[typingsSlinky.konva.pathMod.Path]
     with Instantiable1[/* config */ PathConfig, typingsSlinky.konva.pathMod.Path] {
