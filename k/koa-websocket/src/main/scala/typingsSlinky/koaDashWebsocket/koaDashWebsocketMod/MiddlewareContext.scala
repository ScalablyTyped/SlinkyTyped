...
import typingsSlinky.koaDashWebsocket.koaDashWebsocketMod.koaMod.Context
...
object MiddlewareContext {
  @scala.inline
  def apply[StateT](app: App[_, js.Object], path: String, state: StateT, websocket: typingsSlinky.ws.wsMod.^): MiddlewareContext[StateT] = {
