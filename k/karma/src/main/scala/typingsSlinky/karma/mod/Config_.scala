...
object Config_ {
  ...
  implicit class Config_Ops[Self <: Config_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLOG_DEBUG(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LOG_DEBUG")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLOG_DISABLE(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LOG_DISABLE")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLOG_ERROR(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LOG_ERROR")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLOG_INFO(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LOG_INFO")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLOG_WARN(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LOG_WARN")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSet(value: ConfigOptions => Unit): Self = {
        val ret = this.duplicate
