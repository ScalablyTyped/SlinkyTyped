...
import typingsSlinky.karma.mod.AutomatedBrowsers
import typingsSlinky.karma.mod.FilePatternTypes
...
object karmaStrings {
  ...
  @js.native
  sealed trait log_ extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait run_complete extends StObject
  @scala.inline
