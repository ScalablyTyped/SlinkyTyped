package typingsSlinky.kramed.kramedMod

import typingsSlinky.kramed.Anon_KramedRenderer
import typingsSlinky.kramed.Anon_Options
...
trait KramedStatic extends js.Object {
  ...
  var Renderer: Anon_KramedRenderer = js.native
  /**
