...
@js.native
trait EventElementConnectedsinkMediaType extends js.Object {
...
object EventElementConnectedsinkMediaType {
  ...
  @scala.inline
  implicit class EventElementConnectedsinkMediaTypeOps[Self <: EventElementConnectedsinkMediaType] (val x: Self) extends AnyVal {
