...
@js.native
trait EventElementDisconnecteds extends js.Object {
...
object EventElementDisconnecteds {
  ...
  @scala.inline
  implicit class EventElementDisconnectedsOps[Self <: EventElementDisconnecteds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSink(value: EventElementDisconnecteds): Self = this.set("sink", value.asInstanceOf[js.Any])
