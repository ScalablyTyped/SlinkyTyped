...
import typingsSlinky.kurentoClient.kurentoClientStrings.ObjectDestroyed
...
@js.native
trait EventObjectDestroyedobjec extends js.Object {
...
object EventObjectDestroyedobjec {
  ...
  @scala.inline
  implicit class EventObjectDestroyedobjecOps[Self <: EventObjectDestroyedobjec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: ObjectDestroyed): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
