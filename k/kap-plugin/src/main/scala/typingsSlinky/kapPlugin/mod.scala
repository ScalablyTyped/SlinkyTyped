...
import typingsSlinky.electronStore.mod.^
...
import typingsSlinky.jsonSchema.mod.JSONSchema7Version
import typingsSlinky.kapPlugin.anon.FileType
import typingsSlinky.kapPlugin.anon.Typeofgot
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.kapPlugin.kapPluginStrings.gif
    - typingsSlinky.kapPlugin.kapPluginStrings.mp4
    - typingsSlinky.kapPlugin.kapPluginStrings.webm
    - typingsSlinky.kapPlugin.kapPluginStrings.apng
  */
  trait Format extends StObject
  object Format {
    
    @scala.inline
    def apng: typingsSlinky.kapPlugin.kapPluginStrings.apng = "apng".asInstanceOf[typingsSlinky.kapPlugin.kapPluginStrings.apng]
    
    @scala.inline
    def gif: typingsSlinky.kapPlugin.kapPluginStrings.gif = "gif".asInstanceOf[typingsSlinky.kapPlugin.kapPluginStrings.gif]
    
    @scala.inline
    def mp4: typingsSlinky.kapPlugin.kapPluginStrings.mp4 = "mp4".asInstanceOf[typingsSlinky.kapPlugin.kapPluginStrings.mp4]
    
    @scala.inline
    def webm: typingsSlinky.kapPlugin.kapPluginStrings.webm = "webm".asInstanceOf[typingsSlinky.kapPlugin.kapPluginStrings.webm]
  }
  ...
  trait KapShareService[T] extends StObject {
    ...
    {[ K in keyof T ]:? kap-plugin.kap-plugin.ConfigSchema<T[K]>}
      */ typingsSlinky.kapPlugin.kapPluginStrings.KapShareService with TopLevel[T] = js.native
  ...
  object KapShareService {
    ...
    {[ K in keyof T ]:? kap-plugin.kap-plugin.ConfigSchema<T[K]>}
      */ typingsSlinky.kapPlugin.kapPluginStrings.KapShareService with TopLevel[T],
