...
object KnockoutBindingHandlers {
  ...
  implicit class KnockoutBindingHandlersOps[Self <: KnockoutBindingHandlers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForeachInit(value: KnockoutBindingHandler): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("foreachInit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withInit(value: KnockoutBindingHandler): Self = {
        val ret = this.duplicate
