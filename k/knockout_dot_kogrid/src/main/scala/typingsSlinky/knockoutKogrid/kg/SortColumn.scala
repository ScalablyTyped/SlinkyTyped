...
object SortColumn {
  ...
  implicit class SortColumnOps[Self <: SortColumn] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSortingAlgorithm(value: (/* a */ js.Any, /* b */ js.Any) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sortingAlgorithm")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutSortingAlgorithm: Self = {
        val ret = this.duplicate
