package typingsSlinky.koaDashBodyparser.koaDashBodyparserMod

import typingsSlinky.koa.koaMod.Context
import typingsSlinky.koaDashBodyparser.Anon_Form
...
object Options {
  ...
  def apply(
    ...
    onerror: (/* err */ js.Error, /* ctx */ Context) => Unit = null,
