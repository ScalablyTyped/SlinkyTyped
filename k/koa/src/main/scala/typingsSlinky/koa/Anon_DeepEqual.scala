...
trait Anon_DeepEqual extends js.Object {
  ...
  def deepEqual(a: js.Any, b: js.Any, status: Double): Unit = js.native
  ...
  def equal[T](a: T, b: T, status: Double): Unit = js.native
  ...
  def notDeepEqual(a: js.Any, b: js.Any, status: Double): Unit = js.native
  ...
  def notEqual[T](a: T, b: T, status: Double): Unit = js.native
  ...
  def notStrictEqual(a: js.Any, b: js.Any, status: Double): Unit = js.native
  ...
  def ok(a: js.Any, status: Double): Unit = js.native
  ...
  def strictEqual(a: js.Any, b: js.Any, status: Double): Unit = js.native
