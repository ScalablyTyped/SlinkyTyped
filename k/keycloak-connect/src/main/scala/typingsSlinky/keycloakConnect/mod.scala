...
object mod {
  ...
  */
  ...
  object Config {
    ...
    @scala.inline
    def BaseConfig(): typingsSlinky.keycloakConnect.mod.BaseConfig = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.keycloakConnect.mod.BaseConfig]
    }
    
    @scala.inline
    def CookiesConfig(cookies: js.Any): typingsSlinky.keycloakConnect.mod.CookiesConfig = {
      val __obj = js.Dynamic.literal(cookies = cookies.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.keycloakConnect.mod.CookiesConfig]
    }
    
    @scala.inline
    def StoreConfig(store: js.Any): typingsSlinky.keycloakConnect.mod.StoreConfig = {
      val __obj = js.Dynamic.literal(store = store.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.keycloakConnect.mod.StoreConfig]
    }
  }
