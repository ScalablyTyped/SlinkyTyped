...
object KnockoutValidationConfiguration {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowHtmlMessages)) __obj.updateDynamic("allowHtmlMessages")(allowHtmlMessages.asInstanceOf[js.Any])
    if (!js.isUndefined(decorateElementOnModified)) __obj.updateDynamic("decorateElementOnModified")(decorateElementOnModified.asInstanceOf[js.Any])
    if (!js.isUndefined(decorateInputElement)) __obj.updateDynamic("decorateInputElement")(decorateInputElement.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(errorsAsTitle)) __obj.updateDynamic("errorsAsTitle")(errorsAsTitle.asInstanceOf[js.Any])
    if (!js.isUndefined(errorsAsTitleOnModified)) __obj.updateDynamic("errorsAsTitleOnModified")(errorsAsTitleOnModified.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(insertMessages)) __obj.updateDynamic("insertMessages")(insertMessages.asInstanceOf[js.Any])
    if (messageTemplate != null) __obj.updateDynamic("messageTemplate")(messageTemplate.asInstanceOf[js.Any])
    if (!js.isUndefined(messagesOnModified)) __obj.updateDynamic("messagesOnModified")(messagesOnModified.asInstanceOf[js.Any])
    if (!js.isUndefined(parseInputAttributes)) __obj.updateDynamic("parseInputAttributes")(parseInputAttributes.asInstanceOf[js.Any])
    if (!js.isUndefined(registerExtenders)) __obj.updateDynamic("registerExtenders")(registerExtenders.asInstanceOf[js.Any])
    if (validate != null) __obj.updateDynamic("validate")(validate.asInstanceOf[js.Any])
    if (!js.isUndefined(writeInputAttributes)) __obj.updateDynamic("writeInputAttributes")(writeInputAttributes.asInstanceOf[js.Any])
