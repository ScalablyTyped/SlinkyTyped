...
trait Kraken extends Express {
  ...
  /**
    ...
    * third argument.
    */
  def kraken(req: Request[ParamsDictionary, _, _, Query], res: Response[_]): js.Any = js.native
  def kraken(req: Request[ParamsDictionary, _, _, Query], res: ServerResponse): js.Any = js.native
