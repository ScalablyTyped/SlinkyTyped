...
object ConfigOptions {
  ...
  implicit class ConfigOptionsOps[Self <: ConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJsonPreprocessor(value: JsonPreprocessorOptions): Self = this.set("jsonPreprocessor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteJsonPreprocessor: Self = this.set("jsonPreprocessor", js.undefined)
  }
}
