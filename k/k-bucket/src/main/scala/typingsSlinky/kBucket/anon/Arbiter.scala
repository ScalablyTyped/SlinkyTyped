package typingsSlinky.kBucket.anon

import typingsSlinky.kBucket.mod.Contact
import typingsSlinky.kBucket.mod.Distance
...
trait Arbiter[T /* <: Contact */] extends js.Object {
  var arbiter: js.UndefOr[typingsSlinky.kBucket.mod.Arbiter[T]] = js.native
  var distance: js.UndefOr[Distance] = js.native
  var localNodeId: js.UndefOr[js.typedarray.Uint8Array] = js.native
...
object Arbiter {
  @scala.inline
  def apply[/* <: typingsSlinky.kBucket.mod.Contact */ T](): Arbiter[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Arbiter[T]]
  }
  @scala.inline
  implicit class ArbiterOps[Self <: Arbiter[_], /* <: typingsSlinky.kBucket.mod.Contact */ T] (val x: Self with Arbiter[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDistance(value: (/* firstId */ js.typedarray.Uint8Array, /* secondId */ js.typedarray.Uint8Array) => Double): Self = this.set("distance", js.Any.fromFunction2(value))
    @scala.inline
    def deleteDistance: Self = this.set("distance", js.undefined)
    @scala.inline
    def setLocalNodeId(value: js.typedarray.Uint8Array): Self = this.set("localNodeId", value.asInstanceOf[js.Any])
    @scala.inline
