package typingsSlinky.kBucket.mod
...
object Node {
  @scala.inline
  def apply[/* <: typingsSlinky.kBucket.mod.Contact */ T](contacts: js.Array[T], dontSplit: Boolean, left: T, right: T): Node[T] = {
  ...
  @scala.inline
  implicit class NodeOps[Self <: Node[_], /* <: typingsSlinky.kBucket.mod.Contact */ T] (val x: Self with Node[T]) extends AnyVal {
    @scala.inline
