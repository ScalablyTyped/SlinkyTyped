...
import typingsSlinky.kBucket.anon.Arbiter
import typingsSlinky.kBucket.kBucketStrings.added
import typingsSlinky.kBucket.kBucketStrings.ping
import typingsSlinky.kBucket.kBucketStrings.removed
import typingsSlinky.kBucket.kBucketStrings.updated
...
object mod {
  ...
  trait Contact extends StObject {
    ...
    var id: js.typedarray.Uint8Array = js.native
  ...
  object Contact {
    ...
    @scala.inline
    def apply(id: js.typedarray.Uint8Array, vectorClock: Double): Contact = {
    ...
    implicit class ContactMutableBuilder[Self <: Contact] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setId(value: js.typedarray.Uint8Array): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
