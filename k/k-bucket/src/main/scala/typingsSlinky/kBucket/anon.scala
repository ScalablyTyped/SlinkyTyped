...
import typingsSlinky.kBucket.mod.Arbiter_
import typingsSlinky.kBucket.mod.Contact
import typingsSlinky.kBucket.mod.Distance_
...
object anon {
  ...
  object Arbiter {
    ...
    implicit class ArbiterMutableBuilder[Self <: Arbiter[_], T /* <: Contact */] (val x: Self with Arbiter[T]) extends AnyVal {
      ...
      @scala.inline
      def setDistance(value: (/* firstId */ js.typedarray.Uint8Array, /* secondId */ js.typedarray.Uint8Array) => Double): Self = StObject.set(x, "distance", js.Any.fromFunction2(value))
      
      @scala.inline
      def setDistanceUndefined: Self = StObject.set(x, "distance", js.undefined)
      
      @scala.inline
      def setLocalNodeId(value: js.typedarray.Uint8Array): Self = StObject.set(x, "localNodeId", value.asInstanceOf[js.Any])
