...
import typingsSlinky.keystonejsFileAdapters.AnonId
...
trait LocalFileAdapterConfig extends js.Object {
  var getFilename: js.UndefOr[js.Function1[/* options */ AnonId, String]] = js.native
...
object LocalFileAdapterConfig {
  ...
  implicit class LocalFileAdapterConfigOps[Self <: LocalFileAdapterConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetFilename(value: /* options */ AnonId => String): Self = {
        val ret = this.duplicate
