...
object Message {
  ...
  implicit class MessageOps[Self <: Message] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHighWaterOffset(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("highWaterOffset")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHighWaterOffset: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("highWaterOffset")(js.undefined)
        ret
    }
    @scala.inline
