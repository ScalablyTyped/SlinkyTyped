...
object TypeofndbRedis {
  ...
  implicit class TypeofndbRedisOps[Self <: TypeofndbRedis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRedis_cmd(value: (String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("redis_cmd")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRedis_cmd_p1(value: (String, String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("redis_cmd_p1")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withRedis_cmd_p2(value: (String, String, String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("redis_cmd_p2")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
    def withRedis_cmd_p3(value: (String, String, String, String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("redis_cmd_p3")(js.Any.fromFunction6(value))
        ret
    }
    @scala.inline
    def withRedis_free(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("redis_free")(js.Any.fromFunction1(value))
        ret
    }
  }
