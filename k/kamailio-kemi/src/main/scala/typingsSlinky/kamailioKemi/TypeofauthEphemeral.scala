...
object TypeofauthEphemeral {
  ...
  implicit class TypeofauthEphemeralOps[Self <: TypeofauthEphemeral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAutheph_authenticate(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autheph_authenticate")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withAutheph_check(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autheph_check")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAutheph_proxy(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autheph_proxy")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAutheph_www(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autheph_www")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAutheph_www_method(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("autheph_www_method")(js.Any.fromFunction2(value))
        ret
    }
  }
