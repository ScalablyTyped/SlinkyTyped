...
object TypeofuacRedirect {
  ...
  implicit class TypeofuacRedirectOps[Self <: TypeofuacRedirect] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_redirects(value: (Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_redirects")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGet_redirects_acc(value: (Double, Double, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_redirects_acc")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGet_redirects_all(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_redirects_all")(js.Any.fromFunction0(value))
        ret
    }
  }
