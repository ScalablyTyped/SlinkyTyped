...
object Typeofbenchmark {
  ...
  implicit class TypeofbenchmarkOps[Self <: Typeofbenchmark] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBm_log_timer(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bm_log_timer")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withBm_start_timer(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bm_start_timer")(js.Any.fromFunction1(value))
        ret
    }
  }
