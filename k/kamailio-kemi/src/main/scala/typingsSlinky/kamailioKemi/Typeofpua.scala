...
object Typeofpua {
  ...
  implicit class TypeofpuaOps[Self <: Typeofpua] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPua_set_publish(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pua_set_publish")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withPua_update_contact(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pua_update_contact")(js.Any.fromFunction0(value))
        ret
    }
  }
