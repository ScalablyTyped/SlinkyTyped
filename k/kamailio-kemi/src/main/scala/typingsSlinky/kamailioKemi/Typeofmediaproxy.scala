...
object Typeofmediaproxy {
  ...
  implicit class TypeofmediaproxyOps[Self <: Typeofmediaproxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnd_media_session(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("end_media_session")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withEngage_media_proxy(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("engage_media_proxy")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withUse_media_proxy(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("use_media_proxy")(js.Any.fromFunction0(value))
        ret
    }
  }
