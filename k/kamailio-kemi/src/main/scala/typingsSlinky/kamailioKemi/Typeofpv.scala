...
object Typeofpv {
  ...
  implicit class TypeofpvOps[Self <: Typeofpv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: String => String | Double | Null): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGete(value: String => String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gete")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetvn(value: (String, Double) => String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getvn")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetvs(value: (String, Double) => String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getvs")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetw(value: String => String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getw")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIs_null(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_null")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSeti(value: (String, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("seti")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSets(value: (String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sets")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withUnset(value: String => Unit): Self = {
        val ret = this.duplicate
