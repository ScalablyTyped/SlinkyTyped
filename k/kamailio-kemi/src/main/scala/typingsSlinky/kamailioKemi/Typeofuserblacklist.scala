...
object Typeofuserblacklist {
  ...
  implicit class TypeofuserblacklistOps[Self <: Typeofuserblacklist] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCheck_user_blacklist(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_user_blacklist")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withCheck_user_blacklist_number(value: (String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_user_blacklist_number")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withCheck_user_blacklist_table(value: (String, String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_user_blacklist_table")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withCheck_user_whitelist(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_user_whitelist")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withCheck_user_whitelist_number(value: (String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_user_whitelist_number")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withCheck_user_whitelist_table(value: (String, String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("check_user_whitelist_table")(js.Any.fromFunction4(value))
        ret
    }
  }
