...
object Typeofsipcapture {
  ...
  implicit class TypeofsipcaptureOps[Self <: Typeofsipcapture] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFloat2int(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("float2int")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withReport_capture(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("report_capture")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReport_capture_cid(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("report_capture_cid")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withReport_capture_data(value: (String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("report_capture_data")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withSip_capture(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sip_capture")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSip_capture_forward(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sip_capture_forward")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSip_capture_mode(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sip_capture_mode")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSip_capture_table(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sip_capture_table")(js.Any.fromFunction1(value))
        ret
    }
  }
