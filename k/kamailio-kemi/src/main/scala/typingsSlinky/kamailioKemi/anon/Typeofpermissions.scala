...
object Typeofpermissions {
  ...
  implicit class TypeofpermissionsOps[Self <: Typeofpermissions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllow_address(value: (Double, String, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allow_address")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withAllow_address_group(value: (String, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allow_address_group")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withAllow_source_address(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allow_source_address")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAllow_source_address_group(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allow_source_address_group")(js.Any.fromFunction0(value))
        ret
    }
  }
