...
object Typeofregex {
  ...
  implicit class TypeofregexOps[Self <: Typeofregex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPcre_match(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pcre_match")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withPcre_match_group(value: (String, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pcre_match_group")(js.Any.fromFunction2(value))
        ret
    }
  }
