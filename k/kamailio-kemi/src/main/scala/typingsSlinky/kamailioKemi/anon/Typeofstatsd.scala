...
object Typeofstatsd {
  ...
  implicit class TypeofstatsdOps[Self <: Typeofstatsd] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStatsd_decr(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsd_decr")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStatsd_gauge(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsd_gauge")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withStatsd_incr(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsd_incr")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStatsd_set(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsd_set")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withStatsd_start(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsd_start")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStatsd_stop(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsd_stop")(js.Any.fromFunction1(value))
        ret
    }
  }
