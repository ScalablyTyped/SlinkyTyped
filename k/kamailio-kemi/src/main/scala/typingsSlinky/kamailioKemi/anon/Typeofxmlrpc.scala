...
object Typeofxmlrpc {
  ...
  implicit class TypeofxmlrpcOps[Self <: Typeofxmlrpc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDispatch_rpc(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dispatch_rpc")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withXmlrpc_reply(value: (Double, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xmlrpc_reply")(js.Any.fromFunction2(value))
        ret
    }
  }
