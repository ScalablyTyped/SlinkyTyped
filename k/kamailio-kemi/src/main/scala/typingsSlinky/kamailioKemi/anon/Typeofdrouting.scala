...
object Typeofdrouting {
  ...
  implicit class TypeofdroutingOps[Self <: Typeofdrouting] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDo_routing(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("do_routing")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDo_routing_furi(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("do_routing_furi")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGoes_to_gw(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("goes_to_gw")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGoes_to_gw_type(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("goes_to_gw_type")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIs_from_gw(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_from_gw")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIs_from_gw_type(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_from_gw_type")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIs_from_gw_type_flags(value: (Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("is_from_gw_type_flags")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withNext_routing(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("next_routing")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withUse_next_gw(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("use_next_gw")(js.Any.fromFunction0(value))
        ret
    }
  }
