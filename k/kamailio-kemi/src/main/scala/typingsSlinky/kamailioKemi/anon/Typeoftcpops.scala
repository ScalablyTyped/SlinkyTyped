...
object Typeoftcpops {
  ...
  implicit class TypeoftcpopsOps[Self <: Typeoftcpops] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTcp_conid_alive(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_conid_alive")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTcp_conid_state(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_conid_state")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTcp_enable_closed_event(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_enable_closed_event")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withTcp_enable_closed_event_cid(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_enable_closed_event_cid")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTcp_keepalive_disable(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_keepalive_disable")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withTcp_keepalive_disable_cid(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_keepalive_disable_cid")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTcp_keepalive_enable(value: (Double, Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_keepalive_enable")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withTcp_keepalive_enable_cid(value: (Double, Double, Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_keepalive_enable_cid")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withTcp_set_connection_lifetime(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_set_connection_lifetime")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTcp_set_connection_lifetime_cid(value: (Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tcp_set_connection_lifetime_cid")(js.Any.fromFunction2(value))
        ret
    }
  }
