...
object Typeofsanity {
  ...
  implicit class TypeofsanityOps[Self <: Typeofsanity] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSanity_check(value: (Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sanity_check")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSanity_check_defaults(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sanity_check_defaults")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSanity_reply(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sanity_reply")(js.Any.fromFunction0(value))
        ret
    }
  }
