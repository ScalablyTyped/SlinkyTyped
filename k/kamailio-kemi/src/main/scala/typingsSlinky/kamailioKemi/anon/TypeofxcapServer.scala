...
object TypeofxcapServer {
  ...
  implicit class TypeofxcapServerOps[Self <: TypeofxcapServer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withXcaps_del(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xcaps_del")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withXcaps_get(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xcaps_get")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withXcaps_put(value: (String, String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xcaps_put")(js.Any.fromFunction3(value))
        ret
    }
  }
