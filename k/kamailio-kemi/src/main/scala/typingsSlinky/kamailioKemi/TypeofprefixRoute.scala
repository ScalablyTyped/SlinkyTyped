...
object TypeofprefixRoute {
  ...
  implicit class TypeofprefixRouteOps[Self <: TypeofprefixRoute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPrefix_route(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prefix_route")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPrefix_route_uri(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prefix_route_uri")(js.Any.fromFunction0(value))
        ret
    }
  }
