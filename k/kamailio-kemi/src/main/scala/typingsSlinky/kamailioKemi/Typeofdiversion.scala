...
object Typeofdiversion {
  ...
  implicit class TypeofdiversionOps[Self <: Typeofdiversion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd_diversion(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("add_diversion")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAdd_diversion_uri(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("add_diversion_uri")(js.Any.fromFunction2(value))
        ret
    }
  }
