...
object ConfigOptions {
  ...
  implicit class ConfigOptionsOps[Self <: ConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBriefReporter(value: BriefReporterOptions): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("briefReporter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBriefReporter: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("briefReporter")(js.undefined)
        ret
    }
  }
