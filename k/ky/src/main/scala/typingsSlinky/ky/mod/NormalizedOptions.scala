...
object NormalizedOptions {
  ...
  implicit class NormalizedOptionsOps[Self <: NormalizedOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDownloadProgress(value: (/* progress */ DownloadProgress, /* chunk */ js.typedarray.Uint8Array) => Unit): Self = this.set("onDownloadProgress", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnDownloadProgress: Self = this.set("onDownloadProgress", js.undefined)
    @scala.inline
    def setPrefixUrlURL(value: URL): Self = this.set("prefixUrl", value.asInstanceOf[js.Any])
    @scala.inline
