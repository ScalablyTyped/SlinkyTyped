...
import typingsSlinky.ky.anon._empty
...
object mod {
  ...
  object NormalizedOptions {
    ...
    implicit class NormalizedOptionsMutableBuilder[Self <: NormalizedOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnDownloadProgress(value: (/* progress */ DownloadProgress, /* chunk */ js.typedarray.Uint8Array) => Unit): Self = StObject.set(x, "onDownloadProgress", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPrefixUrlURL(value: URL): Self = StObject.set(x, "prefixUrl", value.asInstanceOf[js.Any])
