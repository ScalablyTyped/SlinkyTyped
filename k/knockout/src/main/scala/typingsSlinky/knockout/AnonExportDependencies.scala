...
@js.native
trait AnonExportDependencies extends js.Object {
  var exportDependencies: Boolean = js.native
}

object AnonExportDependencies {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonExportDependenciesOps[Self <: AnonExportDependencies] (val x: Self) extends AnyVal {
    @scala.inline
