...
object Client extends js.Object {
  ...
  class HostFrame () extends js.Object {
    ...
    def setBackgroundColor(
      newColor: typingsSlinky.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod._Global_.Client.Color
    ): Unit = js.native
    def setBackgroundColor(
      newColor: typingsSlinky.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod._Global_.Client.Color,
  ...
  object Color extends js.Object {
    /**
    			 ...
    			 */
    def fromHexString(colorString: java.lang.String): typingsSlinky.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod._Global_.Client.Color = js.native
    /**
    			 * @see https://developer.knuddels.de/docs/classes/Client.Color.html#method_fromRGB
    			 */
    def fromRGB(red: Double, green: Double, blue: Double): typingsSlinky.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod._Global_.Client.Color = js.native
  }
