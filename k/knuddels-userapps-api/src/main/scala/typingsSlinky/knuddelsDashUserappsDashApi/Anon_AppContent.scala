...
import typingsSlinky.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod._Global_.AppContent
import typingsSlinky.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod._Global_.User
