...
import typingsSlinky.knuddelsUserappsApi.anon.Data
...
object Client {
  ...
  object Color {
    ...
    @js.native
    def fromHexString(colorString: java.lang.String): typingsSlinky.knuddelsUserappsApi.mod.global.Client.Color = js.native
    ...
    @js.native
    def fromRGB(red: Double, green: Double, blue: Double): typingsSlinky.knuddelsUserappsApi.mod.global.Client.Color = js.native
  }
  ...
  class HostFrame () extends StObject {
    ...
    /**
    			 ...
    			 */
    def setBackgroundColor(newColor: typingsSlinky.knuddelsUserappsApi.mod.global.Client.Color): Unit = js.native
    def setBackgroundColor(newColor: typingsSlinky.knuddelsUserappsApi.mod.global.Client.Color, durationMillis: Double): Unit = js.native
  ...
  @js.native
  def dispatchEvent(event: org.scalajs.dom.raw.Event): Unit = js.native
