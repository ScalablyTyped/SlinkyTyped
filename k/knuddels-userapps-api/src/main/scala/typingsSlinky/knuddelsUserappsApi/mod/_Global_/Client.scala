...
import typingsSlinky.knuddelsUserappsApi.AnonData
...
object Client extends js.Object {
  ...
  class HostFrame () extends js.Object {
    ...
    /**
    			 ...
    			 */
    def setBackgroundColor(newColor: typingsSlinky.knuddelsUserappsApi.mod._Global_.Client.Color): Unit = js.native
    def setBackgroundColor(newColor: typingsSlinky.knuddelsUserappsApi.mod._Global_.Client.Color, durationMillis: Double): Unit = js.native
    /**
  ...
  /**
  		 ...
  		 */
  def addEventListener(`type`: java.lang.String, callback: js.Function1[/* event */ AnonData, Unit]): Unit = js.native
  /**
  ...
  def removeEventListener(`type`: java.lang.String, callback: js.Function1[/* event */ AnonData, Unit]): Unit = js.native
  /**
  ...
  object Color extends js.Object {
    /**
    			 ...
    			 */
    def fromHexString(colorString: java.lang.String): typingsSlinky.knuddelsUserappsApi.mod._Global_.Client.Color = js.native
    /**
    			 * @see https://developer.knuddels.de/docs/classes/Client.Color.html#method_fromRGB
    			 */
    def fromRGB(red: Double, green: Double, blue: Double): typingsSlinky.knuddelsUserappsApi.mod._Global_.Client.Color = js.native
  }
