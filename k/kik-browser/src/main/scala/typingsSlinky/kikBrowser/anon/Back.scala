...
import typingsSlinky.kikBrowser.kikBrowserStrings.free
import typingsSlinky.kikBrowser.kikBrowserStrings.landscape
import typingsSlinky.kikBrowser.kikBrowserStrings.portrait
