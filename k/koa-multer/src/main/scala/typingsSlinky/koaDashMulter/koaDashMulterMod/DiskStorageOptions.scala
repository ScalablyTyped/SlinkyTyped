package typingsSlinky.koaDashMulter.koaDashMulterMod
...
object DiskStorageOptions {
  ...
  def apply(
    ...
    filename: (/* req */ IncomingMessage, /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* filename */ String, Unit]) => Unit = null
  ): DiskStorageOptions = {
