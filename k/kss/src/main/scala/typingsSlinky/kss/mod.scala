...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMask(value: String | js.RegExp): Self = StObject.set(x, "mask", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaskRegExp(value: js.RegExp): Self = StObject.set(x, "mask", value.asInstanceOf[js.Any])
