...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaskRegExp(value: js.RegExp): Self = this.set("mask", value.asInstanceOf[js.Any])
    @scala.inline
    def setMask(value: String | js.RegExp): Self = this.set("mask", value.asInstanceOf[js.Any])
    @scala.inline
