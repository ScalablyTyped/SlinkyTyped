...
object KnockoutUtils {
  ...
  implicit class KnockoutUtilsOps[Self <: KnockoutUtils] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withObjectForEach(value: (js.Any, js.Function) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("objectForEach")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withObjectMap(value: (js.Any, js.Function) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("objectMap")(js.Any.fromFunction2(value))
        ret
    }
  }
