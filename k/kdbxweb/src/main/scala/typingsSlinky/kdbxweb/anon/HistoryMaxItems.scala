...
object HistoryMaxItems {
  ...
  implicit class HistoryMaxItemsOps[Self <: HistoryMaxItems] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHistoryMaxItems(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HistoryMaxItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHistoryMaxSize(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HistoryMaxSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKeyEncryptionRounds(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("KeyEncryptionRounds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMntncHistoryDays(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MntncHistoryDays")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRecycleBinName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RecycleBinName")(value.asInstanceOf[js.Any])
        ret
    }
  }
