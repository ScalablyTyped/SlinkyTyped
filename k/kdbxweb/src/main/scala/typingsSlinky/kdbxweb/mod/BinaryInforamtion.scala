...
object BinaryInforamtion {
  ...
  implicit class BinaryInforamtionOps[Self <: BinaryInforamtion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("value", value.asInstanceOf[js.Any])
    @scala.inline
    def setValue(value: ProtectedValue | js.typedarray.ArrayBuffer): Self = this.set("value", value.asInstanceOf[js.Any])
  }
