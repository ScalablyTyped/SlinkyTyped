...
object CryptoEngine extends js.Object {
  ...
  def configure(newSubtle: Null, newWebCrypto: typingsSlinky.std.Crypto): Unit = js.native
  def configure(newSubtle: Null, newWebCrypto: typingsSlinky.std.Crypto, newNodeCrypto: Crypto): Unit = js.native
  def configure(newSubtle: typingsSlinky.std.SubtleCrypto): Unit = js.native
  def configure(newSubtle: typingsSlinky.std.SubtleCrypto, newWebCrypto: Null, newNodeCrypto: Crypto): Unit = js.native
  def configure(newSubtle: typingsSlinky.std.SubtleCrypto, newWebCrypto: typingsSlinky.std.Crypto): Unit = js.native
  def configure(
    newSubtle: typingsSlinky.std.SubtleCrypto,
    newWebCrypto: typingsSlinky.std.Crypto,
    newNodeCrypto: Crypto
  ): Unit = js.native
