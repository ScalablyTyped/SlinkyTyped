package typingsSlinky.koaDashJoiDashRouter.koaDashJoiDashRouterMod
...
import typingsSlinky.koaDashJoiDashRouter.Fn_Middleware
import typingsSlinky.koaDashRouter.koaDashRouterMod.IMiddleware
import typingsSlinky.koaDashRouter.koaDashRouterMod.IParamMiddleware
...
trait Router extends js.Object {
  ...
  var param_Original: js.Function2[
    ...
    typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object]
  ] = js.native
  @JSName("patch")
  ...
  def param(param: String, middleware: IParamMiddleware): typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  ...
  def prefix(prefix: String): typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  ...
  def use(middleware: (IMiddleware[_, js.Object])*): typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: String, middleware: (IMiddleware[_, js.Object])*): typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: js.Array[String], middleware: (IMiddleware[_, js.Object])*): typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: RegExp, middleware: (IMiddleware[_, js.Object])*): typingsSlinky.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
}
