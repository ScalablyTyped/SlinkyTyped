...
object mod {
  ...
  @JSImport("ultra-strftime", "strftime")
  @js.native
  def strftime(fmt: String, d: js.Date): String = js.native
  @JSImport("ultra-strftime", "strftime")
  @js.native
  def strftime(fmt: String, d: js.Date, locale: js.UndefOr[scala.Nothing], options: Options): String = js.native
  @JSImport("ultra-strftime", "strftime")
  @js.native
  def strftime(fmt: String, d: js.Date, locale: Locale): String = js.native
  @JSImport("ultra-strftime", "strftime")
  @js.native
  def strftime(fmt: String, d: js.Date, locale: Locale, options: Options): String = js.native
  @JSImport("ultra-strftime", "strftime")
  @js.native
  ...
  @js.native
  def strftimeTZ(fmt: String, d: js.Date, locale: Locale, timezone: Double): String = js.native
  @JSImport("ultra-strftime", "strftimeTZ")
  @js.native
  def strftimeTZ(fmt: String, d: js.Date, timezone: Double): String = js.native
  ...
  @JSImport("ultra-strftime", "strftimeUTC")
  @js.native
  def strftimeUTC(fmt: String, d: js.Date): String = js.native
  @JSImport("ultra-strftime", "strftimeUTC")
  @js.native
  def strftimeUTC(fmt: String, d: js.Date, locale: Locale): String = js.native
