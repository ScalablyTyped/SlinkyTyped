...
object strftime extends js.Object {
  ...
  def apply(fmt: String, d: js.Date, locale: js.UndefOr[scala.Nothing], options: Options): String = js.native
  def apply(fmt: String, d: js.Date, locale: Locale): String = js.native
  def apply(fmt: String, d: js.Date, locale: Locale, options: Options): String = js.native
