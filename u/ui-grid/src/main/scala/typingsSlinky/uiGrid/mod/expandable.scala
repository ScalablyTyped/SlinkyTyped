...
object expandable {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.expandable.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.expandable.IGridOptions]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.expandable.IGridOptions] (val x: Self) extends AnyVal {
  ...
  object IGridRow {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.expandable.IGridRow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.expandable.IGridRow]
    }
    
    @scala.inline
    implicit class IGridRowMutableBuilder[Self <: typingsSlinky.uiGrid.mod.expandable.IGridRow] (val x: Self) extends AnyVal {
