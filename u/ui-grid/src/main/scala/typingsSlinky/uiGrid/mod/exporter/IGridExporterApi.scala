...
object IGridExporterApi {
  ...
  implicit class IGridExporterApiOps[Self <: IGridExporterApi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCsvExport(value: (String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("csvExport")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withPdfExport(value: (String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pdfExport")(js.Any.fromFunction2(value))
        ret
    }
  }
