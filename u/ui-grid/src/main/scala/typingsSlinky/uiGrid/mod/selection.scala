...
import typingsSlinky.uiGrid.anon.RowSelectionChanged
...
object selection {
  ...
  trait IGridOptions extends StObject {
    ...
    /**
      ...
      * property.
      */
    var isRowSelectable: js.UndefOr[js.Function1[/* row */ typingsSlinky.uiGrid.mod.selection.IGridRow, Boolean]] = js.native
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.selection.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.selection.IGridOptions]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.selection.IGridOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIsRowSelectable(value: /* row */ typingsSlinky.uiGrid.mod.selection.IGridRow => Boolean): Self = StObject.set(x, "isRowSelectable", js.Any.fromFunction1(value))
  ...
  object IGridRow {
    ...
    @scala.inline
    def apply(setSelected: Boolean => Unit): typingsSlinky.uiGrid.mod.selection.IGridRow = {
      val __obj = js.Dynamic.literal(setSelected = js.Any.fromFunction1(setSelected))
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.selection.IGridRow]
    }
    
    @scala.inline
    implicit class IGridRowMutableBuilder[Self <: typingsSlinky.uiGrid.mod.selection.IGridRow] (val x: Self) extends AnyVal {
