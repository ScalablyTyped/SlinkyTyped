...
object treeBase {
  ...
  object IColumnDef {
    ...
    @scala.inline
    def apply[TEntity](): typingsSlinky.uiGrid.mod.treeBase.IColumnDef[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.treeBase.IColumnDef[TEntity]]
    }
    
    @scala.inline
    implicit class IColumnDefMutableBuilder[Self <: typingsSlinky.uiGrid.mod.treeBase.IColumnDef[_], TEntity] (val x: Self with typingsSlinky.uiGrid.mod.treeBase.IColumnDef[TEntity]) extends AnyVal {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply[TEntity](): typingsSlinky.uiGrid.mod.treeBase.IGridOptions[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.treeBase.IGridOptions[TEntity]]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.treeBase.IGridOptions[_], TEntity] (val x: Self with typingsSlinky.uiGrid.mod.treeBase.IGridOptions[TEntity]) extends AnyVal {
