...
object grouping {
  ...
  object IColumnDef {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.grouping.IColumnDef = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.grouping.IColumnDef]
    }
    
    @scala.inline
    implicit class IColumnDefMutableBuilder[Self <: typingsSlinky.uiGrid.mod.grouping.IColumnDef] (val x: Self) extends AnyVal {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.grouping.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.grouping.IGridOptions]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.grouping.IGridOptions] (val x: Self) extends AnyVal {
