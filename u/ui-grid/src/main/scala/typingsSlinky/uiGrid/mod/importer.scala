...
object importer {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply[TEntity](): typingsSlinky.uiGrid.mod.importer.IGridOptions[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.importer.IGridOptions[TEntity]]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.importer.IGridOptions[_], TEntity] (val x: Self with typingsSlinky.uiGrid.mod.importer.IGridOptions[TEntity]) extends AnyVal {
