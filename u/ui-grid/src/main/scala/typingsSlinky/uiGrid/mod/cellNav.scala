...
import typingsSlinky.angular.JQueryKeyEventObject
...
object cellNav {
  ...
  trait ICellNavApi[TEntity] extends StObject {
    ...
    /**
      ...
      */
    def scrollToFocus(rowEntity: TEntity, colDef: typingsSlinky.uiGrid.mod.cellNav.IColumnDef): IPromise[_] = js.native
  }
  object ICellNavApi {
    ...
    def apply[TEntity](
      ...
      scrollToFocus: (TEntity, typingsSlinky.uiGrid.mod.cellNav.IColumnDef) => IPromise[_]
    ): ICellNavApi[TEntity] = {
    ...
    implicit class ICellNavApiMutableBuilder[Self <: ICellNavApi[_], TEntity] (val x: Self with ICellNavApi[TEntity]) extends AnyVal {
      ...
      @scala.inline
      def setScrollToFocus(value: (TEntity, typingsSlinky.uiGrid.mod.cellNav.IColumnDef) => IPromise[_]): Self = StObject.set(x, "scrollToFocus", js.Any.fromFunction2(value))
    }
  }
  ...
  object IColumnDef {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.cellNav.IColumnDef = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.cellNav.IColumnDef]
    }
    
    @scala.inline
    implicit class IColumnDefMutableBuilder[Self <: typingsSlinky.uiGrid.mod.cellNav.IColumnDef] (val x: Self) extends AnyVal {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.cellNav.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.cellNav.IGridOptions]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.cellNav.IGridOptions] (val x: Self) extends AnyVal {
  ...
  object IGridRow {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.cellNav.IGridRow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.cellNav.IGridRow]
    }
    
    @scala.inline
    implicit class IGridRowMutableBuilder[Self <: typingsSlinky.uiGrid.mod.cellNav.IGridRow] (val x: Self) extends AnyVal {
