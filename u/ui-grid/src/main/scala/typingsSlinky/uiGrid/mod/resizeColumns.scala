...
object resizeColumns {
  ...
  object IColumnDef {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.resizeColumns.IColumnDef = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.resizeColumns.IColumnDef]
    }
    
    @scala.inline
    implicit class IColumnDefMutableBuilder[Self <: typingsSlinky.uiGrid.mod.resizeColumns.IColumnDef] (val x: Self) extends AnyVal {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.resizeColumns.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.resizeColumns.IGridOptions]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.resizeColumns.IGridOptions] (val x: Self) extends AnyVal {
