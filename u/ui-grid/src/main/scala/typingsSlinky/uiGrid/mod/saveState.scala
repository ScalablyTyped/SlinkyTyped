...
object saveState {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.saveState.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.saveState.IGridOptions]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.saveState.IGridOptions] (val x: Self) extends AnyVal {
