...
object exporter {
  ...
  object IColumnDef {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.exporter.IColumnDef = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.exporter.IColumnDef]
    }
    
    @scala.inline
    implicit class IColumnDefMutableBuilder[Self <: typingsSlinky.uiGrid.mod.exporter.IColumnDef] (val x: Self) extends AnyVal {
  ...
  object IGridOptions {
    ...
    @scala.inline
    def apply[TEntity](): typingsSlinky.uiGrid.mod.exporter.IGridOptions[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.exporter.IGridOptions[TEntity]]
    }
    
    @scala.inline
    implicit class IGridOptionsMutableBuilder[Self <: typingsSlinky.uiGrid.mod.exporter.IGridOptions[_], TEntity] (val x: Self with typingsSlinky.uiGrid.mod.exporter.IGridOptions[TEntity]) extends AnyVal {
  ...
  object IGridRow {
    ...
    @scala.inline
    def apply(): typingsSlinky.uiGrid.mod.exporter.IGridRow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uiGrid.mod.exporter.IGridRow]
    }
    
    @scala.inline
    implicit class IGridRowMutableBuilder[Self <: typingsSlinky.uiGrid.mod.exporter.IGridRow] (val x: Self) extends AnyVal {
