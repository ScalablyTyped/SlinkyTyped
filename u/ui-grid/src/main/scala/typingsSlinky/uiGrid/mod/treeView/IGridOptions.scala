...
object IGridOptions {
  ...
  implicit class IGridOptionsOps[Self <: IGridOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnableTreeView(value: Boolean): Self = this.set("enableTreeView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEnableTreeView: Self = this.set("enableTreeView", js.undefined)
  }
}
