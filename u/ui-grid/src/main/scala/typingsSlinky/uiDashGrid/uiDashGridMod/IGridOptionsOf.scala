...
import typingsSlinky.uiDashGrid.uiDashGridMod.treeBase.IGridTreeBaseCustomAggregation
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IGridOptionsOf[TEntity]
  extends typingsSlinky.uiDashGrid.uiDashGridMod.cellNav.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.edit.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.expandable.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.exporter.IGridOptions[TEntity]
     with typingsSlinky.uiDashGrid.uiDashGridMod.grouping.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.importer.IGridOptions[TEntity]
     with typingsSlinky.uiDashGrid.uiDashGridMod.infiniteScroll.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.moveColumns.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.pagination.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.pinning.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.resizeColumns.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.rowEdit.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.saveState.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.selection.IGridOptions
     with typingsSlinky.uiDashGrid.uiDashGridMod.treeBase.IGridOptions[TEntity]
     with typingsSlinky.uiDashGrid.uiDashGridMod.treeView.IGridOptions {
  /**
...
object IGridOptionsOf {
  ...
  def apply[TEntity](
    ...
    isRowSelectable: /* row */ typingsSlinky.uiDashGrid.uiDashGridMod.selection.IGridRow => Boolean = null,
