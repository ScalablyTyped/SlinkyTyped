package typingsSlinky.uiDashGrid.uiDashGridMod.treeBase

import typingsSlinky.uiDashGrid.Anon_HandlerRowCollapsed
...
trait IGridTreeBaseApi[TEntity] extends js.Object {
  // Events
  var on: Anon_HandlerRowCollapsed[TEntity]
  // Methods
  /**
...
object IGridTreeBaseApi {
  ...
  def apply[TEntity](
    ...
    on: Anon_HandlerRowCollapsed[TEntity],
