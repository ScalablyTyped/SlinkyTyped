...
trait IGridRowOf[TEntity]
  extends typingsSlinky.uiDashGrid.uiDashGridMod.cellNav.IGridRow
     with typingsSlinky.uiDashGrid.uiDashGridMod.edit.IGridRow
     with typingsSlinky.uiDashGrid.uiDashGridMod.exporter.IGridRow
     with typingsSlinky.uiDashGrid.uiDashGridMod.selection.IGridRow
     with typingsSlinky.uiDashGrid.uiDashGridMod.expandable.IGridRow {
