...
import typingsSlinky.uiDashGrid.Anon_Handler
...
trait ICellNavApi[TEntity] extends js.Object {
  ...
  /**
    ...
    */
  def scrollToFocus(rowEntity: TEntity, colDef: typingsSlinky.uiDashGrid.uiDashGridMod.cellNav.IColumnDef): IPromise[_]
}
...
object ICellNavApi {
  ...
  def apply[TEntity](
    ...
    scrollToFocus: (TEntity, typingsSlinky.uiDashGrid.uiDashGridMod.cellNav.IColumnDef) => IPromise[_]
  ): ICellNavApi[TEntity] = {
