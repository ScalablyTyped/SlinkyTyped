...
import typingsSlinky.uiDashGrid.uiDashGridMod.edit.IEditDropdown
import typingsSlinky.uiDashGrid.uiDashGridMod.treeBase.IGridTreeBaseAggregationObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IColumnDefOf[TEntity]
  extends typingsSlinky.uiDashGrid.uiDashGridMod.cellNav.IColumnDef
     with typingsSlinky.uiDashGrid.uiDashGridMod.edit.IColumnDef[TEntity]
     with typingsSlinky.uiDashGrid.uiDashGridMod.exporter.IColumnDef
     with typingsSlinky.uiDashGrid.uiDashGridMod.grouping.IColumnDef
     with typingsSlinky.uiDashGrid.uiDashGridMod.moveColumns.IColumnDef
     with typingsSlinky.uiDashGrid.uiDashGridMod.pinning.IColumnDef
     with typingsSlinky.uiDashGrid.uiDashGridMod.resizeColumns.IColumnDef
     with typingsSlinky.uiDashGrid.uiDashGridMod.treeBase.IColumnDef[TEntity] {
  /**
    * defaults to false
