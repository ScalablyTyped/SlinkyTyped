package typingsSlinky.urbanDictionary
...
object mod {
  ...
  @JSImport("urban-dictionary", "defid")
  @js.native
  def defid(id: Double, callback: js.Function2[/* error */ js.Error, /* object */ WordDefinition, _]): js.Promise[WordDefinition] = js.native
  ...
  @JSImport("urban-dictionary", "random")
  @js.native
  def random(callback: js.Function2[/* error */ js.Error, /* object */ WordDefinition, _]): js.Promise[WordDefinition] = js.native
