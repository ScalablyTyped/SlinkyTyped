...
object Children {
  @scala.inline
  def apply[/* <: java.lang.String */ T, /* <: js.Array[typingsSlinky.unist.mod.Node] */ C](children: C, `type`: T): Children[T, C] = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Children[T, C]]
  }
  @scala.inline
  implicit class ChildrenOps[Self <: Children[_, _], /* <: java.lang.String */ T, /* <: js.Array[typingsSlinky.unist.mod.Node] */ C] (val x: Self with (Children[T, C])) extends AnyVal {
    @scala.inline
