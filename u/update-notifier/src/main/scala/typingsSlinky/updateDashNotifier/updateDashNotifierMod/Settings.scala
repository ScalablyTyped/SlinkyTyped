package typingsSlinky.updateDashNotifier.updateDashNotifierMod
...
trait Settings extends js.Object {
  var callback: js.UndefOr[
    js.Function2[/* error */ js.Error | Null, /* update */ js.UndefOr[UpdateInfo], _]
  ] = js.undefined
...
object Settings {
  @scala.inline
  def apply(
    callback: (/* error */ js.Error | Null, /* update */ js.UndefOr[UpdateInfo]) => _ = null,
