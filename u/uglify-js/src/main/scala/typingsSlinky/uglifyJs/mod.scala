...
import typingsSlinky.uglifyJs.uglifyJsStrings.`inline`
...
object mod {
  ...
  object OutputOptions {
    ...
    implicit class OutputOptionsMutableBuilder[Self <: OutputOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComments(value: Boolean | all | some | js.RegExp): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
