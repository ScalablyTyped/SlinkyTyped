...
object ParseOptions {
  ...
  implicit class ParseOptionsOps[Self <: ParseOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForceStream(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forceStream")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutForceStream: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forceStream")(js.undefined)
        ret
    }
    @scala.inline
