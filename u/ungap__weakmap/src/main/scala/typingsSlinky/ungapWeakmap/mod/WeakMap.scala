...
object WeakMap {
  @scala.inline
  def apply[/* <: js.Object */ K, V](delete: K => Boolean, get: K => js.UndefOr[V], has: K => Boolean, set: (K, V) => WeakMap[K, V]): WeakMap[K, V] = {
  ...
  @scala.inline
  implicit class WeakMapOps[Self <: WeakMap[_, _], /* <: js.Object */ K, V] (val x: Self with (WeakMap[K, V])) extends AnyVal {
    @scala.inline
