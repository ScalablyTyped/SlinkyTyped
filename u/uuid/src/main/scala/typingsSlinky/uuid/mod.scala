...
object mod {
  ...
  @JSImport("uuid", "NIL")
  @js.native
  val NIL: typingsSlinky.uuid.mod.NIL = js.native
  type NIL = String
  
  @JSImport("uuid", "parse")
  @js.native
  val parse: typingsSlinky.uuid.mod.parse = js.native
  type parse = js.Function1[/* uuid */ String, OutputBuffer]
  
  @JSImport("uuid", "stringify")
  @js.native
  val stringify: typingsSlinky.uuid.mod.stringify = js.native
  type stringify = js.Function2[/* buffer */ InputBuffer, /* offset */ js.UndefOr[Double], String]
  
  @JSImport("uuid", "v1")
  @js.native
  val v1: typingsSlinky.uuid.mod.v1 = js.native
  type v1 = v1Buffer with v1String
  
  @JSImport("uuid", "v3")
  @js.native
  val v3: typingsSlinky.uuid.mod.v3 = js.native
  type v3 = v3Buffer with v3String with v3Static
  
  @JSImport("uuid", "v4")
  @js.native
  val v4: typingsSlinky.uuid.mod.v4 = js.native
  type v4 = v4Buffer with v4String
  
  @JSImport("uuid", "v5")
  @js.native
  val v5: typingsSlinky.uuid.mod.v5 = js.native
  type v5 = v5Buffer with v5String with v5Static
  
  @JSImport("uuid", "validate")
  @js.native
  val validate: typingsSlinky.uuid.mod.validate = js.native
  type validate = js.Function1[/* uuid */ String, Boolean]
  
  @JSImport("uuid", "version")
  @js.native
  val version: typingsSlinky.uuid.mod.version = js.native
  ...
  */
  ...
  object V1Options {
    ...
    @scala.inline
    def V1RandomOptions(): typingsSlinky.uuid.mod.V1RandomOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uuid.mod.V1RandomOptions]
    }
    
    @scala.inline
    def V1RngOptions(): typingsSlinky.uuid.mod.V1RngOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uuid.mod.V1RngOptions]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.uuid.mod.RandomOptions
    - typingsSlinky.uuid.mod.RngOptions
  */
  trait V4Options extends StObject
  object V4Options {
    
    @scala.inline
    def RandomOptions(): typingsSlinky.uuid.mod.RandomOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uuid.mod.RandomOptions]
    }
    
    @scala.inline
    def RngOptions(): typingsSlinky.uuid.mod.RngOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.uuid.mod.RngOptions]
    }
  }
