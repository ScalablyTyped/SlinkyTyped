...
object V1BaseOptions {
  ...
  implicit class V1BaseOptionsOps[Self <: V1BaseOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMsecsDate(value: js.Date): Self = this.set("msecs", value.asInstanceOf[js.Any])
    @scala.inline
    def setMsecs(value: Double | js.Date): Self = this.set("msecs", value.asInstanceOf[js.Any])
    @scala.inline
