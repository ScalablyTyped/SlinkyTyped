package typingsSlinky.utilityDashTypes

import typingsSlinky.std.Pick
import typingsSlinky.utilityDashTypes.distMappedDashTypesMod.DeepReadonly
import typingsSlinky.utilityDashTypes.distMappedDashTypesMod.SetComplement
...
object distUtilityDashTypesMod extends js.Object {
  ...
  {[ P in K & any ]: any}
    */ typingsSlinky.utilityDashTypes.utilityDashTypesStrings.$ElementType with js.Any */, K /* <: String | Double */] = /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
