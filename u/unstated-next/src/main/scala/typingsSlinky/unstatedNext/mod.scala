package typingsSlinky.unstatedNext
...
object mod {
  ...
  object Container {
    ...
    implicit class ContainerMutableBuilder[Self <: Container[_, _], Value, State] (val x: Self with (Container[Value, State])) extends AnyVal {
      ...
      @scala.inline
      def setProvider(value: ReactComponentClass[ContainerProviderProps[State]]): Self = StObject.set(x, "Provider", value.asInstanceOf[js.Any])
