...
import typingsSlinky.underscore.anon.Fn0
import typingsSlinky.underscore.anon.Fn1
import typingsSlinky.underscore.anon.Fn2
import typingsSlinky.underscore.anon.FnCall
import typingsSlinky.underscore.anon.FnCallCollectionIterateeMemoContext
import typingsSlinky.underscore.anon.FnCallIsSortedIterateeContext
import typingsSlinky.underscore.anon.FnCallIsSortedIterateeCotext
import typingsSlinky.underscore.anon.FnCallIterateeContext
import typingsSlinky.underscore.anon.FnCallIterateeMemoContext
import typingsSlinky.underscore.anon.FnCallListIsSortedIterateeContext
import typingsSlinky.underscore.anon.FnCallListN
import typingsSlinky.underscore.anon.FnCallN
...
object mod extends Shortcut {
  ...
  */
  ...
  type Omit[V, K /* <: String */] = (typingsSlinky.std.Pick[V, Exclude[/* keyof V */ String, K]]) | Partial[V]
  ...
  type Pick[V, K /* <: String */] = (typingsSlinky.std.Pick[V, Extract[K, /* keyof V */ String]]) | Partial[V]
  ...
  trait Underscore[T, V] extends StObject {
    ...
    def collect[I /* <: (CollectionIterator[TypeOfCollection[V, scala.Nothing], _, V]) | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in keyof underscore.underscore.TypeOfCollection<V, never> ]:? underscore.underscore.TypeOfCollection<V, never>[P]}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with (TopLevel[TypeOfCollection[V, scala.Nothing]])) */](iteratee: I): js.Array[IterateeResult[I, T]] = js.native
    def collect[I /* <: (CollectionIterator[TypeOfCollection[V, scala.Nothing], _, V]) | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in keyof underscore.underscore.TypeOfCollection<V, never> ]:? underscore.underscore.TypeOfCollection<V, never>[P]}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with (TopLevel[TypeOfCollection[V, scala.Nothing]])) */](iteratee: I, context: js.Any): js.Array[IterateeResult[I, T]] = js.native
    /**
      * @see map
      **/
    @JSName("collect")
    ...
    {[ K in keyof V ]: underscore.underscore.IterateeResult<null, V[K]>}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with TopLevel[V] = js.native
    ...
    def mapObject[I /* <: (CollectionIterator[TypeOfCollection[V, _], _, V]) | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in keyof underscore.underscore.TypeOfCollection<V, any> ]:? underscore.underscore.TypeOfCollection<V, any>[P]}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with (TopLevel[TypeOfCollection[V, _]])) */](iteratee: I): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in keyof V ]: underscore.underscore.IterateeResult<I, V[K]>}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with TopLevel[V] = js.native
    def mapObject[I /* <: (CollectionIterator[TypeOfCollection[V, _], _, V]) | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ P in keyof underscore.underscore.TypeOfCollection<V, any> ]:? underscore.underscore.TypeOfCollection<V, any>[P]}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with (TopLevel[TypeOfCollection[V, _]])) */](iteratee: I, context: js.Any): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in keyof V ]: underscore.underscore.IterateeResult<I, V[K]>}
      */ typingsSlinky.underscore.underscoreStrings.Underscore with TopLevel[V] = js.native
