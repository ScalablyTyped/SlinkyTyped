...
import typingsSlinky.underscore.underscoreNumbers.`false`
import typingsSlinky.underscore.underscoreStrings.Empty
...
trait UnderscoreStatic extends js.Object {
  ...
  @JSName("chain")
  def chain_T_TypeOfDictionaryVV_DictionaryWildcard[T /* <: TypeOfDictionary[V] */, V /* <: Dictionary[_] */](obj: V): _Chain[T, V] = js.native
  /**
