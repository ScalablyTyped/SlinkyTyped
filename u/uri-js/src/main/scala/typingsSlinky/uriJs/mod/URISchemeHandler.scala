...
object URISchemeHandler {
  @scala.inline
  def apply[/* <: typingsSlinky.uriJs.mod.URIComponents */ Components, /* <: typingsSlinky.uriJs.mod.URIOptions */ Options, /* <: typingsSlinky.uriJs.mod.URIComponents */ ParentComponents](
  ...
  @scala.inline
  implicit class URISchemeHandlerOps[Self <: URISchemeHandler[_, _, _], /* <: typingsSlinky.uriJs.mod.URIComponents */ Components, /* <: typingsSlinky.uriJs.mod.URIOptions */ Options, /* <: typingsSlinky.uriJs.mod.URIComponents */ ParentComponents] (val x: Self with (URISchemeHandler[Components, Options, ParentComponents])) extends AnyVal {
    @scala.inline
