...
object uriAllMinMod {
  ...
  object URIRegExps {
    ...
    implicit class URIRegExpsMutableBuilder[Self <: URIRegExps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIPV4ADDRESS(value: js.RegExp): Self = StObject.set(x, "IPV4ADDRESS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIPV6ADDRESS(value: js.RegExp): Self = StObject.set(x, "IPV6ADDRESS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_FRAGMENT(value: js.RegExp): Self = StObject.set(x, "NOT_FRAGMENT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_HOST(value: js.RegExp): Self = StObject.set(x, "NOT_HOST", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_PATH(value: js.RegExp): Self = StObject.set(x, "NOT_PATH", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_PATH_NOSCHEME(value: js.RegExp): Self = StObject.set(x, "NOT_PATH_NOSCHEME", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_QUERY(value: js.RegExp): Self = StObject.set(x, "NOT_QUERY", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_SCHEME(value: js.RegExp): Self = StObject.set(x, "NOT_SCHEME", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNOT_USERINFO(value: js.RegExp): Self = StObject.set(x, "NOT_USERINFO", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOTHER_CHARS(value: js.RegExp): Self = StObject.set(x, "OTHER_CHARS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPCT_ENCODED(value: js.RegExp): Self = StObject.set(x, "PCT_ENCODED", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUNRESERVED(value: js.RegExp): Self = StObject.set(x, "UNRESERVED", value.asInstanceOf[js.Any])
    }
  }
