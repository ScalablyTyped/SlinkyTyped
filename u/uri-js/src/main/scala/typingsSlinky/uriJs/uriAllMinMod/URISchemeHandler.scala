...
object URISchemeHandler {
  @scala.inline
  def apply[/* <: typingsSlinky.uriJs.uriAllMinMod.URIComponents */ Components, /* <: typingsSlinky.uriJs.uriAllMinMod.URIOptions */ Options, /* <: typingsSlinky.uriJs.uriAllMinMod.URIComponents */ ParentComponents](
  ...
  @scala.inline
  implicit class URISchemeHandlerOps[Self <: URISchemeHandler[_, _, _], /* <: typingsSlinky.uriJs.uriAllMinMod.URIComponents */ Components, /* <: typingsSlinky.uriJs.uriAllMinMod.URIOptions */ Options, /* <: typingsSlinky.uriJs.uriAllMinMod.URIComponents */ ParentComponents] (val x: Self with (URISchemeHandler[Components, Options, ParentComponents])) extends AnyVal {
    @scala.inline
