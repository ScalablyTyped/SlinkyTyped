...
object IAngularHelper {
  ...
  implicit class IAngularHelperOps[Self <: IAngularHelper] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetCurrentForm(value: IScope => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCurrentForm")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetNullForm(value: String => IFormController): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNullForm")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetRequiredCurrentForm(value: IScope => js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRequiredCurrentForm")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRejectedPromise(value: js.Object => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rejectedPromise")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSafeApply(value: (IScope, js.Function) => Unit): Self = {
        val ret = this.duplicate
