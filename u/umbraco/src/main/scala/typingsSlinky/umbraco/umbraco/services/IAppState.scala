...
object IAppState {
  ...
  implicit class IAppStateOps[Self <: IAppState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetGlobalState(value: String => IGlobalState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getGlobalState")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetMenuState(value: String => IStateObject): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMenuState")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetSectionState(value: String => ISectionState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSectionState")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetState(value: (IStateObject, String, String) => IStateObject): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getState")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetTreeState(value: String => ITreeState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTreeState")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetGlobalState(value: (String, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setGlobalState")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSetMenuState(value: (String, IMenuState) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setMenuState")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSetSectionState(value: (String, ISectionState) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setSectionState")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSetState(value: (IStateObject, String, js.Any, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setState")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withSetTreeState(value: (String, ITreeState) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setTreeState")(js.Any.fromFunction2(value))
        ret
    }
  }
