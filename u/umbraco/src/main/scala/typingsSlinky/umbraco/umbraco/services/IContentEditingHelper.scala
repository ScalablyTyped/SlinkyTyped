...
object IContentEditingHelper {
  ...
  implicit class IContentEditingHelperOps[Self <: IContentEditingHelper] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAllProps(value: js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllProps")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetAllowedActions(value: (js.Any, js.Any) => js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllowedActions")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetButtonFromAction(value: String => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getButtonFromAction")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withHandleSaveError(value: /* repeated */ js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handleSaveError")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withHandleSuccessfulSave(value: /* repeated */ js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handleSuccessfulSave")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReBindChangedProperties(value: (js.Any, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reBindChangedProperties")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withRedirectToCreatedContent(value: (Double, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("redirectToCreatedContent")(js.Any.fromFunction2(value))
        ret
    }
  }
