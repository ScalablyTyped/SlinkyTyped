...
object IPackageResource {
  ...
  implicit class IPackageResourceOps[Self <: IPackageResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCleanUp(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cleanUp")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFetch(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withImport(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("import")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInstallData(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("installData")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInstallFiles(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("installFiles")(js.Any.fromFunction1(value))
        ret
    }
  }
