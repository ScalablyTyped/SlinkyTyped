...
object IMediaHelper {
  ...
  implicit class IMediaHelperOps[Self <: IMediaHelper] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDetectIfImageByExtension(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("detectIfImageByExtension")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFormatFileTypes(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("formatFileTypes")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetImagePropertyValue(value: IMediaOptions => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getImagePropertyValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetMediaPropertyValue(value: IMediaOptions => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMediaPropertyValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetThumbnail(value: IMediaOptions => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getThumbnail")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetThumbnailFromPath(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getThumbnailFromPath")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withResolveFile(value: (IMediaEntity, Boolean) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveFile")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withResolveFileFromEntity(value: (IMediaEntity, Boolean) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveFileFromEntity")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withScaleToMaxSize(value: (Double, Double, Double) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleToMaxSize")(js.Any.fromFunction3(value))
        ret
    }
  }
