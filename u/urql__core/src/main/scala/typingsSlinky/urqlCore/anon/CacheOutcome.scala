...
import typingsSlinky.urqlCore.urqlCoreStrings.hit
import typingsSlinky.urqlCore.urqlCoreStrings.miss
import typingsSlinky.urqlCore.urqlCoreStrings.partial
