...
trait PartialGraphQLError extends js.Object {
  ...
  var originalError: js.UndefOr[Maybe[js.Error]] = js.native
  
  var path: js.UndefOr[js.Array[String | Double]] = js.native
  
  var positions: js.UndefOr[js.Array[Double]] = js.native
  
  var source: js.UndefOr[typingsSlinky.graphql.sourceMod.Source] = js.native
...
object PartialGraphQLError {
  ...
  implicit class PartialGraphQLErrorOps[Self <: PartialGraphQLError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(
      value: (/* message */ String, /* nodes */ js.UndefOr[Maybe[js.Array[ASTNode] | ASTNode]], /* source */ js.UndefOr[Maybe[typingsSlinky.graphql.sourceMod.Source]], /* positions */ js.UndefOr[Maybe[js.Array[Double]]], /* path */ js.UndefOr[Maybe[js.Array[String | Double]]], /* originalError */ js.UndefOr[Maybe[js.Error]], /* extensions */ js.UndefOr[Maybe[StringDictionary[_]]]) => js.Any
    ...
    @scala.inline
    def setOriginalError(value: Maybe[js.Error]): Self = this.set("originalError", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSource(value: typingsSlinky.graphql.sourceMod.Source): Self = this.set("source", value.asInstanceOf[js.Any])
