...
object Message {
  ...
  @scala.inline
  def apply[T /* <: cacheHit | cacheInvalidation | fetchRequest | fetchSuccess | fetchError | retryRetrying | String */](message: String, operation: Operation, `type`: T): Message[T] = {
  ...
  @scala.inline
  implicit class MessageOps[Self <: Message[_], T /* <: cacheHit | cacheInvalidation | fetchRequest | fetchSuccess | fetchError | retryRetrying | String */] (val x: Self with Message[T]) extends AnyVal {
