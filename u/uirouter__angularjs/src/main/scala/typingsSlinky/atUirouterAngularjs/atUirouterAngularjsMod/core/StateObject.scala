...
class StateObject ()
  extends typingsSlinky.atUirouterCore.atUirouterCoreMod.StateObject {
...
object StateObject extends js.Object {
  /**
    ...
    */
  def create(stateDecl: _StateDeclaration): typingsSlinky.atUirouterCore.libStateStateObjectMod.StateObject = js.native
