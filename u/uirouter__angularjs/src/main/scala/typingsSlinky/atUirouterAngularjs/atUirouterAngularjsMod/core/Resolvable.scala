...
class Resolvable protected ()
  extends typingsSlinky.atUirouterCore.atUirouterCoreMod.Resolvable {
  /** This constructor creates a new Resolvable from the plain old [[ResolvableLiteral]] javascript object */
  def this(resolvable: ResolvableLiteral) = this()
  /** This constructor creates a Resolvable copy */
  def this(resolvable: typingsSlinky.atUirouterCore.libResolveResolvableMod.Resolvable) = this()
  /**
...
object Resolvable extends js.Object {
  def fromData(token: js.Any, data: js.Any): typingsSlinky.atUirouterCore.libResolveResolvableMod.Resolvable = js.native
}
