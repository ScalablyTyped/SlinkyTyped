...
import typingsSlinky.atUirouterAngularjs.libDirectivesStateDirectivesMod.ng1_directive
import typingsSlinky.atUirouterAngularjs.libStatebuildersViewsMod.Ng1ViewConfig
