package typingsSlinky.ukDotCoDotWorkingedgeDotPhonegapDotPluginDotLaunchnavigator.ukDotCoDotWorkingedgeDotPhonegapDotPluginDotLaunchnavigatorMod
...
object RememberChoiceOptions {
  ...
  def apply(
    ...
    promptFn: /* callback */ js.Function1[/* rememberChoice */ Boolean, Unit] => Unit = null
