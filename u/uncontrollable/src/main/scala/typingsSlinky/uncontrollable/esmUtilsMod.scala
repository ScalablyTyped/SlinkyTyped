...
object esmUtilsMod {
  ...
  @JSImport("uncontrollable/esm/utils", "canAcceptRef")
  @js.native
  def canAcceptRef(component: js.Any): js.Any = js.native
  
  @JSImport("uncontrollable/esm/utils", "defaultKey")
  @js.native
  def defaultKey(key: String): String = js.native
  
  @JSImport("uncontrollable/esm/utils", "isProp")
  @js.native
  def isProp[P](props: P, prop: /* keyof P */ String): Boolean = js.native
  
  @JSImport("uncontrollable/esm/utils", "uncontrolledPropTypes")
  @js.native
