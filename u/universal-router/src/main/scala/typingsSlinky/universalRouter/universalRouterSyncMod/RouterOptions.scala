...
object RouterOptions {
  @scala.inline
  def apply[R, /* <: typingsSlinky.universalRouter.universalRouterSyncMod.RouterContext */ C](): RouterOptions[R, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RouterOptions[R, C]]
  }
  @scala.inline
  implicit class RouterOptionsOps[Self <: RouterOptions[_, _], R, /* <: typingsSlinky.universalRouter.universalRouterSyncMod.RouterContext */ C] (val x: Self with (RouterOptions[R, C])) extends AnyVal {
    @scala.inline
