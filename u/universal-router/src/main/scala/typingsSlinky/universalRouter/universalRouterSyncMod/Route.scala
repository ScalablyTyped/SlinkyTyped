...
import typingsSlinky.pathToRegexp.mod.Match_
...
object Route {
  @scala.inline
  def apply[R, /* <: typingsSlinky.universalRouter.universalRouterSyncMod.RouterContext */ C](): Route[R, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Route[R, C]]
  }
  @scala.inline
  implicit class RouteOps[Self <: Route[_, _], R, /* <: typingsSlinky.universalRouter.universalRouterSyncMod.RouterContext */ C] (val x: Self with (Route[R, C])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPathVarargs(value: (String | js.RegExp)*): Self = this.set("path", js.Array(value :_*))
    @scala.inline
