...
import typingsSlinky.pathToRegexp.mod.RegexpToFunctionOptions
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsSlinky.pathToRegexp.mod.TokensToRegexpOptions because var conflicts: delimiter. Inlined encode, end, endsWith, sensitive, start, strict */ @js.native
...
object RouterOptions {
  @scala.inline
  def apply[R, /* <: typingsSlinky.universalRouter.mod.RouterContext */ C](): RouterOptions[R, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RouterOptions[R, C]]
  }
  @scala.inline
  implicit class RouterOptionsOps[Self <: RouterOptions[_, _], R, /* <: typingsSlinky.universalRouter.mod.RouterContext */ C] (val x: Self with (RouterOptions[R, C])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setErrorHandler(value: (/* error */ RouteError, /* context */ ResolveContext) => RouteResult[R]): Self = this.set("errorHandler", js.Any.fromFunction2(value))
    @scala.inline
    def deleteErrorHandler: Self = this.set("errorHandler", js.undefined)
    @scala.inline
    def setResolveRoute(value: (/* context */ RouteContext[R, C], /* params */ RouteParams) => RouteResult[R]): Self = this.set("resolveRoute", js.Any.fromFunction2(value))
    @scala.inline
