...
object Route {
  @scala.inline
  def apply[R, /* <: typingsSlinky.universalRouter.mod.RouterContext */ C](): Route[R, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Route[R, C]]
  }
  @scala.inline
  implicit class RouteOps[Self <: Route[_, _], R, /* <: typingsSlinky.universalRouter.mod.RouterContext */ C] (val x: Self with (Route[R, C])) extends AnyVal {
    @scala.inline
