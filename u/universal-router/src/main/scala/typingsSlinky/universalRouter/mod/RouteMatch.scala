...
object RouteMatch {
  @scala.inline
  def apply[R, /* <: typingsSlinky.universalRouter.mod.RouterContext */ C](baseUrl: String, params: RouteParams, path: String, route: Route[R, C]): RouteMatch[R, C] = {
  ...
  @scala.inline
  implicit class RouteMatchOps[Self <: RouteMatch[_, _], R, /* <: typingsSlinky.universalRouter.mod.RouterContext */ C] (val x: Self with (RouteMatch[R, C])) extends AnyVal {
    @scala.inline
