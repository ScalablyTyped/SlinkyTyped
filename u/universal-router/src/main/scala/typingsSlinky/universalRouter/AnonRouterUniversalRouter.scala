...
object AnonRouterUniversalRouter {
  @scala.inline
  def apply[C, R](router: UniversalRouter[C, R]): AnonRouterUniversalRouter[C, R] = {
    val __obj = js.Dynamic.literal(router = router.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRouterUniversalRouter[C, R]]
  }
  @scala.inline
  implicit class AnonRouterUniversalRouterOps[Self[c, r] <: AnonRouterUniversalRouter[c, r], C, R] (val x: Self[C, R]) extends AnyVal {
    @scala.inline
