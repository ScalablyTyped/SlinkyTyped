...
object generateUrlsMod {
  ...
  @js.native
  def default(router: typingsSlinky.universalRouter.mod.default[_, RouterContext]): GenerateUrl = js.native
  @JSImport("universal-router/src/generateUrls", JSImport.Default)
  @js.native
  def default(router: typingsSlinky.universalRouter.mod.default[_, RouterContext], options: GenerateUrlsOptions): GenerateUrl = js.native
