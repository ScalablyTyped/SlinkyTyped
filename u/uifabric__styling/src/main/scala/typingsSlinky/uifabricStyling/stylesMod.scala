...
object stylesMod {
  ...
  @JSImport("@uifabric/styling/lib/styles", "AnimationVariables")
  @js.native
  val AnimationVariables: IAnimationVariables = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "DefaultEffects")
  @js.native
  val DefaultEffects: IEffects = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "DefaultFontStyles")
  @js.native
  val DefaultFontStyles: IFontStyles = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "DefaultPalette")
  @js.native
  ...
  object FontSizes {
    ...
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.icon")
    @js.native
    val icon: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.large")
    @js.native
    val large: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.medium")
    @js.native
    val medium: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.mediumPlus")
    @js.native
    val mediumPlus: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.mega")
    @js.native
    val mega: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.mini")
    @js.native
    val mini: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size10")
    @js.native
    val size10: /* "10px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size12")
    @js.native
    val size12: /* "12px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size14")
    @js.native
    val size14: /* "14px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size16")
    @js.native
    val size16: /* "16px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size18")
    @js.native
    val size18: /* "18px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size20")
    @js.native
    val size20: /* "20px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size24")
    @js.native
    val size24: /* "24px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size28")
    @js.native
    val size28: /* "28px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size32")
    @js.native
    val size32: /* "32px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size42")
    @js.native
    val size42: /* "42px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.size68")
    @js.native
    val size68: /* "68px" */ String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.small")
    @js.native
    val small: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.smallPlus")
    @js.native
    val smallPlus: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.superLarge")
    @js.native
    val superLarge: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.xLarge")
    @js.native
    val xLarge: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.xLargePlus")
    @js.native
    val xLargePlus: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.xSmall")
    @js.native
    val xSmall: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.xxLarge")
    @js.native
    val xxLarge: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontSizes.xxLargePlus")
    @js.native
  ...
  object FontWeights {
    ...
    @JSImport("@uifabric/styling/lib/styles", "FontWeights.bold")
    @js.native
    val bold: IFontWeight = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontWeights.light")
    @js.native
    val light: IFontWeight = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontWeights.regular")
    @js.native
    val regular: IFontWeight = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontWeights.semibold")
    @js.native
    val semibold: IFontWeight = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "FontWeights.semilight")
    @js.native
  ...
  object IconFontSizes {
    ...
    @JSImport("@uifabric/styling/lib/styles", "IconFontSizes.large")
    @js.native
    val large: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "IconFontSizes.medium")
    @js.native
    val medium: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "IconFontSizes.small")
    @js.native
    val small: String = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "IconFontSizes.xSmall")
    @js.native
    val xSmall: String = js.native
  }
  ...
  object PulsingBeaconAnimationStyles {
    ...
    @JSImport("@uifabric/styling/lib/styles", "PulsingBeaconAnimationStyles")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "PulsingBeaconAnimationStyles.continuousPulseAnimationDouble")
    @js.native
    ...
    @JSImport("@uifabric/styling/lib/styles", "PulsingBeaconAnimationStyles.continuousPulseAnimationSingle")
    @js.native
  ...
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMaxMedium")
  @js.native
  val ScreenWidthMaxMedium: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMaxSmall")
  @js.native
  val ScreenWidthMaxSmall: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMaxXLarge")
  @js.native
  val ScreenWidthMaxXLarge: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMaxXXLarge")
  @js.native
  val ScreenWidthMaxXXLarge: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinLarge")
  @js.native
  val ScreenWidthMinLarge: /* 640 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinMedium")
  @js.native
  val ScreenWidthMinMedium: /* 480 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinSmall")
  @js.native
  val ScreenWidthMinSmall: /* 320 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinUhfMobile")
  @js.native
  val ScreenWidthMinUhfMobile: /* 768 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinXLarge")
  @js.native
  val ScreenWidthMinXLarge: /* 1024 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinXXLarge")
  @js.native
  val ScreenWidthMinXXLarge: /* 1366 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ScreenWidthMinXXXLarge")
  @js.native
  val ScreenWidthMinXXXLarge: /* 1920 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles", "ThemeSettingName")
  @js.native
  val ThemeSettingName: /* "theme" */ String = js.native
  
  object ZIndexes {
    
    @JSImport("@uifabric/styling/lib/styles", "ZIndexes.Coachmark")
    @js.native
    val Coachmark: Double = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "ZIndexes.FocusStyle")
    @js.native
    val FocusStyle: Double = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "ZIndexes.KeytipLayer")
    @js.native
    val KeytipLayer: Double = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "ZIndexes.Layer")
    @js.native
    val Layer: Double = js.native
    
    @JSImport("@uifabric/styling/lib/styles", "ZIndexes.Nav")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@uifabric/styling/lib/styles", "ZIndexes.ScrollablePane")
    @js.native
  ...
  @JSImport("@uifabric/styling/lib/styles", "normalize")
  @js.native
