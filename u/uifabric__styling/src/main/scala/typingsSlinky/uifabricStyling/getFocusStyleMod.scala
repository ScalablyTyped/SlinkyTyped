...
object getFocusStyleMod {
  ...
  @JSImport("@uifabric/styling/lib/styles/getFocusStyle", "focusClear")
  @js.native
  def focusClear(): IRawStyle = js.native
  
  @JSImport("@uifabric/styling/lib/styles/getFocusStyle", "getFocusOutlineStyle")
  @js.native
  ...
  @JSImport("@uifabric/styling/lib/styles/getFocusStyle", "getFocusStyle")
  @js.native
  ...
  @JSImport("@uifabric/styling/lib/styles/getFocusStyle", "getInputFocusStyle")
  @js.native
