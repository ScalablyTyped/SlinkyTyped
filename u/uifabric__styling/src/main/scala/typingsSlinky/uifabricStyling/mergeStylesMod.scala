...
import typingsSlinky.uifabricStyling.uifabricStylingBooleans.`false`
import typingsSlinky.uifabricStyling.uifabricStylingNumbers.`0`
...
object mergeStylesMod extends js.Object {
  @js.native
  class Stylesheet ()
    extends typingsSlinky.uifabricMergeStyles.mod.Stylesheet {
