package typingsSlinky.uglifyjsWebpackPlugin
...
object mod {
  ...
  object ExtractCommentsOptions {
    ...
    implicit class ExtractCommentsOptionsMutableBuilder[Self <: ExtractCommentsOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCondition(value: js.RegExp | (js.Function2[/* node */ js.Object, /* comment */ String, Boolean])): Self = StObject.set(x, "condition", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setConditionRegExp(value: js.RegExp): Self = StObject.set(x, "condition", value.asInstanceOf[js.Any])
  ...
  object UglifyJsPluginOptions {
    ...
    implicit class UglifyJsPluginOptionsMutableBuilder[Self <: UglifyJsPluginOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExclude(value: js.RegExp | js.Array[js.RegExp]): Self = StObject.set(x, "exclude", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setExtractCommentsRegExp(value: js.RegExp): Self = StObject.set(x, "extractComments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExtractCommentsUndefined: Self = StObject.set(x, "extractComments", js.undefined)
      
      @scala.inline
      def setInclude(value: js.RegExp | js.Array[js.RegExp]): Self = StObject.set(x, "include", value.asInstanceOf[js.Any])
