...
object UglifyJsPluginOptions {
  ...
  implicit class UglifyJsPluginOptionsOps[Self <: UglifyJsPluginOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExclude(value: js.RegExp | js.Array[js.RegExp]): Self = this.set("exclude", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInclude(value: js.RegExp | js.Array[js.RegExp]): Self = this.set("include", value.asInstanceOf[js.Any])
    @scala.inline
