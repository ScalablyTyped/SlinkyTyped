...
import typingsSlinky.uws.Anon_Binary
import typingsSlinky.uws.Anon_BinaryBoolean
import typingsSlinky.uws.Anon_Code
import typingsSlinky.uws.Anon_CodeReason
import typingsSlinky.uws.Anon_Data
import typingsSlinky.uws.Anon_DataTarget
import typingsSlinky.uws.Anon_Target
import typingsSlinky.uws.Anon_Target_1916242669
...
trait WebSocket extends EventEmitter {
  ...
  def send(data: js.Any, options: Anon_Binary, cb: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  def stream(options: Anon_Binary, cb: js.Function2[/* err */ js.Error, /* final */ Boolean, Unit]): Unit = js.native
