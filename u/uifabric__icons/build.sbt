...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "uifabric__merge-styles" % "7.8.1-8c242e",
  "org.scalablytyped.slinky" %%% "uifabric__styling" % "7.8.1-3eaad1",
  "org.scalablytyped.slinky" %%% "uifabric__utilities" % "7.8.0-01a8c5")
