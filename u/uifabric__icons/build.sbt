...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fluentui__theme" % "1.7.0-ea4133",
  ...
  "org.scalablytyped.slinky" %%% "uifabric__styling" % "7.16.18-64785f",
  "org.scalablytyped.slinky" %%% "uifabric__utilities" % "7.33.2-f01143")
