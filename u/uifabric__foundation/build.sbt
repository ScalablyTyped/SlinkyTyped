...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "uifabric__merge-styles" % "7.8.1-31b444",
  "org.scalablytyped.slinky" %%% "uifabric__styling" % "7.7.3-863108",
  "org.scalablytyped.slinky" %%% "uifabric__utilities" % "7.5.0-205bf1")
