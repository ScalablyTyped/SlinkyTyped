...
trait AnonSlots[TSlots] extends js.Object {
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsSlinky.uifabricFoundation.uifabricFoundationStrings.AnonSlots with TSlots
  ] = js.undefined
}
...
object AnonSlots {
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsSlinky.uifabricFoundation.uifabricFoundationStrings.AnonSlots with TSlots = null
  ): AnonSlots[TSlots] = {
