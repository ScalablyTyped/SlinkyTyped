...
object IComponentOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.uifabricFoundation.libIslotsMod.ISlottableProps[TComponentSlots] */ TComponentProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet, TViewProps, TComponentSlots, TStatics](): IComponentOptions[TComponentProps, TTokens, TStyleSet, TViewProps, TComponentSlots, TStatics] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IComponentOptions[TComponentProps, TTokens, TStyleSet, TViewProps, TComponentSlots, TStatics]]
  }
  @scala.inline
  implicit class IComponentOptionsOps[Self <: IComponentOptions[_, _, _, _, _, _], /* <: typingsSlinky.uifabricFoundation.libIslotsMod.ISlottableProps[TComponentSlots] */ TComponentProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet, TViewProps, TComponentSlots, TStatics] (val x: Self with (IComponentOptions[TComponentProps, TTokens, TStyleSet, TViewProps, TComponentSlots, TStatics])) extends AnyVal {
    @scala.inline
