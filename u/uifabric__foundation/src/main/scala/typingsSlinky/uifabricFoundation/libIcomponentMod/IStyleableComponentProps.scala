...
object IStyleableComponentProps {
  @scala.inline
  def apply[TViewProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet](): IStyleableComponentProps[TViewProps, TTokens, TStyleSet] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IStyleableComponentProps[TViewProps, TTokens, TStyleSet]]
  }
  @scala.inline
  implicit class IStyleableComponentPropsOps[Self <: IStyleableComponentProps[_, _, _], TViewProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet] (val x: Self with (IStyleableComponentProps[TViewProps, TTokens, TStyleSet])) extends AnyVal {
    @scala.inline
