...
object ICustomizationProps {
  @scala.inline
  def apply[TViewProps, TTokens, TStyleSet](): ICustomizationProps[TViewProps, TTokens, TStyleSet] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ICustomizationProps[TViewProps, TTokens, TStyleSet]]
  }
  @scala.inline
  implicit class ICustomizationPropsOps[Self[tviewprops, ttokens, tstyleset] <: ICustomizationProps[tviewprops, ttokens, tstyleset], TViewProps, TTokens, TStyleSet] (val x: Self[TViewProps, TTokens, TStyleSet]) extends AnyVal {
    @scala.inline
