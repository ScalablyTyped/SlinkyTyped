...
object ICustomizationProps {
  ...
  @scala.inline
  implicit class ICustomizationPropsOps[Self <: ICustomizationProps[_, _, _], TViewProps, TTokens, TStyleSet /* <: IStyleSet[TStyleSet] */] (val x: Self with (ICustomizationProps[TViewProps, TTokens, TStyleSet])) extends AnyVal {
