...
object ICustomizationProps {
  @scala.inline
  def apply[TViewProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet](theme: js.UndefOr[ITheme] with ITheme): ICustomizationProps[TViewProps, TTokens, TStyleSet] = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ICustomizationProps[TViewProps, TTokens, TStyleSet]]
  }
  @scala.inline
  implicit class ICustomizationPropsOps[Self <: ICustomizationProps[_, _, _], TViewProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet] (val x: Self with (ICustomizationProps[TViewProps, TTokens, TStyleSet])) extends AnyVal {
    @scala.inline
