...
object IComponent {
  @scala.inline
  def apply[TComponentProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet, TViewProps, TStatics](
    displayName: String,
  ...
  @scala.inline
  implicit class IComponentOps[Self <: IComponent[_, _, _, _, _], TComponentProps, TTokens, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet, TViewProps, TStatics] (val x: Self with (IComponent[TComponentProps, TTokens, TStyleSet, TViewProps, TStatics])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setView(value: /* props */ PropsWithChildren[TViewProps] => ReturnType[ReactComponentClass[js.Object]]): Self = this.set("view", js.Any.fromFunction1(value))
  }
