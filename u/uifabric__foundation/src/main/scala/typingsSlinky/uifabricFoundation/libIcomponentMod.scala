...
import typingsSlinky.uifabricFoundation.uifabricFoundationBooleans.`false`
...
object libIcomponentMod {
  ...
  object IComponent {
    ...
    implicit class IComponentMutableBuilder[Self <: IComponent[_, _, _, _, _], TComponentProps, TTokens, TStyleSet /* <: IStyleSet[TStyleSet] */, TViewProps, TStatics] (val x: Self with (IComponent[TComponentProps, TTokens, TStyleSet, TViewProps, TStatics])) extends AnyVal {
      ...
      @scala.inline
      def setView(value: /* props */ PropsWithChildren[TViewProps] => ReturnType[ReactComponentClass[js.Object]]): Self = StObject.set(x, "view", js.Any.fromFunction1(value))
    }
  }
  ...
  {[ key in keyof TSlots ]:? @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle}
    */ typingsSlinky.uifabricFoundation.uifabricFoundationStrings.IComponentStyles with TopLevel[js.Any]
