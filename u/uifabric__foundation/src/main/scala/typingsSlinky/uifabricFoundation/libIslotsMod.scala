...
object libIslotsMod {
  ...
  {[ slot in keyof TSlots ]: react.react.ElementType<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[slot]>>}
    */ typingsSlinky.uifabricFoundation.uifabricFoundationStrings.ISlotDefinition with TopLevel[TSlots]
  ...
  object ISlotOptions {
    ...
    implicit class ISlotOptionsMutableBuilder[Self <: ISlotOptions[_], TProps] (val x: Self with ISlotOptions[TProps]) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[TProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[TProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
  ...
  {[ slot in keyof TSlots ]: @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlot<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[slot]>>}
    */ typingsSlinky.uifabricFoundation.uifabricFoundationStrings.ISlots with TopLevel[TSlots]
