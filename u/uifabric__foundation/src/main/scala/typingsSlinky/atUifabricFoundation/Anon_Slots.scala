...
trait Anon_Slots[TSlots] extends js.Object {
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsSlinky.atUifabricFoundation.atUifabricFoundationStrings.Anon_Slots with TSlots
  ] = js.undefined
}
...
object Anon_Slots {
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsSlinky.atUifabricFoundation.atUifabricFoundationStrings.Anon_Slots with TSlots = null
  ): Anon_Slots[TSlots] = {
