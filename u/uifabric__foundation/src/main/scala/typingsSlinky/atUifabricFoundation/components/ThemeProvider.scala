package typingsSlinky.atUifabricFoundation.components
...
object ThemeProvider
  ...
  def apply(scheme: ISchemeNames = null, theme: ITheme = null, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, js.Object] = {
