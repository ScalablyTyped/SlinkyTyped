...
object mod {
  ...
  /**
    ...
    */
  type ProcessCallback = js.Function2[/* error */ js.Error | Null, /* file */ VFile, Unit]
  ...
  /**
    ...
    */
  type RunCallback = js.Function3[/* error */ js.Error | Null, /* node */ Node, /* file */ VFile, Unit]
  ...
  type Transformer = js.Function3[
    ...
    /* file */ VFile, 
    /* next */ js.UndefOr[
      js.Function3[/* error */ js.Error | Null, /* tree */ Node, /* file */ VFile, js.Object]
    ], 
    js.Error | Node | (js.Promise[Node | Unit]) | Unit
  ]
}
