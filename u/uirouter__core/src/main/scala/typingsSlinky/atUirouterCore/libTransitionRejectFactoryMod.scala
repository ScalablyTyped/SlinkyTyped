...
import typingsSlinky.atUirouterCore.libTransitionRejectFactoryMod.RejectType
import typingsSlinky.atUirouterCore.libTransitionRejectFactoryMod.Rejection
...
@js.native
object libTransitionRejectFactoryMod extends js.Object {
  @js.native
