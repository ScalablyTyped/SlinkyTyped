...
object libVanillaIndexMod extends js.Object {
  ...
  abstract class BaseLocationServices protected ()
    extends typingsSlinky.atUirouterCore.libVanillaBaseLocationServiceMod.BaseLocationServices {
    def this(router: UIRouter, fireAfterUpdate: Boolean) = this()
  }
  
  @js.native
  class BrowserLocationConfig ()
    extends typingsSlinky.atUirouterCore.libVanillaBrowserLocationConfigMod.BrowserLocationConfig {
  ...
  class HashLocationService protected ()
    extends typingsSlinky.atUirouterCore.libVanillaHashLocationServiceMod.HashLocationService {
  ...
  class MemoryLocationService protected ()
    extends typingsSlinky.atUirouterCore.libVanillaMemoryLocationServiceMod.MemoryLocationService {
    def this(router: UIRouter) = this()
  }
  
  @js.native
  class PushStateLocationService protected ()
    extends typingsSlinky.atUirouterCore.libVanillaPushStateLocationServiceMod.PushStateLocationService {
    def this(router: UIRouter) = this()
  }
