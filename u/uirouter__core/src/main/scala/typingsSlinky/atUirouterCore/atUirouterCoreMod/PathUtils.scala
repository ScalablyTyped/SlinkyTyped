...
@js.native
class PathUtils ()
  extends typingsSlinky.atUirouterCore.libPathMod.PathUtils
...
object PathUtils extends js.Object {
  ...
  def applyViewConfigs(
    $view: typingsSlinky.atUirouterCore.libViewViewMod.ViewService,
    path: js.Array[typingsSlinky.atUirouterCore.libPathPathNodeMod.PathNode],
    states: js.Array[typingsSlinky.atUirouterCore.libStateStateObjectMod.StateObject]
  ): Unit = js.native
  def buildPath(targetState: typingsSlinky.atUirouterCore.libStateTargetStateMod.TargetState): js.Array[typingsSlinky.atUirouterCore.libPathPathNodeMod.PathNode] = js.native
  ...
  def makeTargetState(
    registry: typingsSlinky.atUirouterCore.libStateMod.StateRegistry,
    path: js.Array[typingsSlinky.atUirouterCore.libPathPathNodeMod.PathNode]
  ): typingsSlinky.atUirouterCore.libStateTargetStateMod.TargetState = js.native
  /**
  ...
  def nonDynamicParams(node: typingsSlinky.atUirouterCore.libPathPathNodeMod.PathNode): js.Array[typingsSlinky.atUirouterCore.libParamsParamMod.Param] = js.native
  ...
  def treeChanges(
    fromPath: js.Array[typingsSlinky.atUirouterCore.libPathPathNodeMod.PathNode],
    toPath: js.Array[typingsSlinky.atUirouterCore.libPathPathNodeMod.PathNode],
    reloadState: typingsSlinky.atUirouterCore.libStateStateObjectMod.StateObject
