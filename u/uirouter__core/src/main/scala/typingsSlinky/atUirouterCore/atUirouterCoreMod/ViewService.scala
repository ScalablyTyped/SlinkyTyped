...
import typingsSlinky.atUirouterCore.Anon_UiViewContextAnchor
...
import typingsSlinky.atUirouterCore.libViewInterfaceMod.ViewContext
...
class ViewService protected ()
  extends typingsSlinky.atUirouterCore.libViewMod.ViewService {
  /** @hidden */
  def this(/** @hidden */ router: typingsSlinky.atUirouterCore.libRouterMod.UIRouter) = this()
}
