...
import typingsSlinky.atUirouterCore.libParamsInterfaceMod.ParamTypeDefinition
import typingsSlinky.atUirouterCore.libParamsMod.ParamTypes
...
@js.native
object libUrlUrlConfigMod extends js.Object {
  @js.native
