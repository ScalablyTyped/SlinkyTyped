...
object libParamsMod extends js.Object {
  ...
  class Param protected ()
    extends typingsSlinky.atUirouterCore.libParamsParamMod.Param {
    def this(
      id: String,
  ...
  class ParamType protected ()
    extends typingsSlinky.atUirouterCore.libParamsParamTypeMod.ParamType {
    /**
  ...
  /** @internalapi */
  class ParamTypes ()
    extends typingsSlinky.atUirouterCore.libParamsParamTypesMod.ParamTypes
  
  @js.native
  class StateParams ()
    extends typingsSlinky.atUirouterCore.libParamsStateParamsMod.StateParams {
  ...
  object DefType extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.atUirouterCore.libParamsParamMod.DefType with Double] = js.native
  }
