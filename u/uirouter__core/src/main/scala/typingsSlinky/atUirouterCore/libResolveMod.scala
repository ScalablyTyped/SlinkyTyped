...
object libResolveMod extends js.Object {
  ...
  class Resolvable protected ()
    extends typingsSlinky.atUirouterCore.libResolveResolvableMod.Resolvable {
  ...
  class ResolveContext protected ()
    extends typingsSlinky.atUirouterCore.libResolveResolveContextMod.ResolveContext {
