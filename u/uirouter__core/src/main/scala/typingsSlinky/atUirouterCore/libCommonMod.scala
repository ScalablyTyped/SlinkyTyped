...
import typingsSlinky.atUirouterCore.libCommonCommonMod.Mapper
...
object libCommonMod extends js.Object {
  ...
  class Glob protected ()
    extends typingsSlinky.atUirouterCore.libCommonGlobMod.Glob {
    def this(text: String) = this()
  }
  
  @js.native
  class Queue[T] ()
    extends typingsSlinky.atUirouterCore.libCommonQueueMod.Queue[T] {
  ...
  /** @hidden */
  class Trace ()
    extends typingsSlinky.atUirouterCore.libCommonTraceMod.Trace
  
  @JSName("equals")
  val equals_FlibCommonMod: js.Any = js.native
  ...
  /**
    ...
    * ```
    */
  val trace: typingsSlinky.atUirouterCore.libCommonTraceMod.Trace = js.native
  ...
  object Category extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.atUirouterCore.libCommonTraceMod.Category with Double] = js.native
  }
  ...
  object extend extends js.Object {
    ...
    def apply[T_1, U_1, V](target: T_1, source1: U_1, source2: V): T_1 with U_1 with V = js.native
    def apply[T_2, U_2, V_1, W](target: T_2, source1: U_2, source2: V_1, source3: W): T_2 with U_2 with V_1 with W = js.native
  }
