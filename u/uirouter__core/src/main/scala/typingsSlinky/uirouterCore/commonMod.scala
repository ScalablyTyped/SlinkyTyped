...
object commonMod {
  ...
  class Glob protected ()
    extends typingsSlinky.uirouterCore.globMod.Glob {
  ...
  @js.native
  class Queue[T] ()
    extends typingsSlinky.uirouterCore.queueMod.Queue[T] {
  ...
  /** @internal */
  class Trace_ ()
    extends typingsSlinky.uirouterCore.traceMod.Trace_
  ...
  @JSImport("@uirouter/core/lib/common", "trace")
  @js.native
  val trace: typingsSlinky.uirouterCore.traceMod.Trace_ = js.native
