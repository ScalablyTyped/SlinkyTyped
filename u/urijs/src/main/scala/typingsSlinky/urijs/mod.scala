...
import typingsSlinky.urijs.anon.Hostname
import typingsSlinky.urijs.anon.Password
import typingsSlinky.urijs.anon.Port
...
object mod {
  ...
  @JSImport("urijs", JSImport.Namespace)
  @js.native
  def apply(value: typingsSlinky.urijs.mod.HTMLElement): URI = js.native
  @JSImport("urijs", JSImport.Namespace)
  @js.native
  ...
  class Class () extends URI {
    ...
    def this(value: typingsSlinky.urijs.mod.HTMLElement) = this()
