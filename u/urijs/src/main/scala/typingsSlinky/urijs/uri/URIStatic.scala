...
import typingsSlinky.urijs.Anon_Hostname
import typingsSlinky.urijs.Anon_HostnamePort
import typingsSlinky.urijs.Anon_Password
import typingsSlinky.urijs.HTMLElement
...
@js.native
trait URIStatic
  extends Instantiable0[typingsSlinky.urijs.uri.URI]
     with Instantiable1[
      (/* value */ HTMLElement) | (/* value */ String) | (/* value */ URIOptions), 
      typingsSlinky.urijs.uri.URI
    ] {
  /**
  ...
  var expand: js.UndefOr[
    js.Function2[/* template */ String, /* vals */ js.Object, typingsSlinky.urijs.uri.URI]
  ] = js.native
  def apply(): typingsSlinky.urijs.uri.URI = js.native
  def apply(value: String): typingsSlinky.urijs.uri.URI = js.native
  def apply(value: HTMLElement): typingsSlinky.urijs.uri.URI = js.native
  def apply(value: URIOptions): typingsSlinky.urijs.uri.URI = js.native
  ...
  def joinPaths(paths: (String | typingsSlinky.urijs.uri.URI)*): typingsSlinky.urijs.uri.URI = js.native
