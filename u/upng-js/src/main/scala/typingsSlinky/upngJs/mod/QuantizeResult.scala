...
object QuantizeResult {
  ...
  implicit class QuantizeResultOps[Self <: QuantizeResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAbuf(value: js.typedarray.ArrayBuffer): Self = this.set("abuf", value.asInstanceOf[js.Any])
    @scala.inline
    def setInds(value: js.typedarray.Uint8Array): Self = this.set("inds", value.asInstanceOf[js.Any])
    @scala.inline
