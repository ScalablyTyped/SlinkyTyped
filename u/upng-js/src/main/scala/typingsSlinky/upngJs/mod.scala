...
object mod {
  ...
  @js.native
  def decode(buffer: js.typedarray.ArrayBuffer): Image = js.native
  
  @JSImport("upng-js", "encode")
  @js.native
  def encode(imgs: js.Array[js.typedarray.ArrayBuffer], w: Double, h: Double, cnum: Double): js.typedarray.ArrayBuffer = js.native
  @JSImport("upng-js", "encode")
  @js.native
  def encode(
  ...
  @js.native
  def quantize(data: js.typedarray.ArrayBuffer, psize: Double): QuantizeResult = js.native
  
  @JSImport("upng-js", "toRGBA8")
  @js.native
  def toRGBA8(out: Image): js.Array[js.typedarray.ArrayBuffer] = js.native
  ...
  object QuantizeResult {
    ...
    implicit class QuantizeResultMutableBuilder[Self <: QuantizeResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAbuf(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "abuf", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInds(value: js.typedarray.Uint8Array): Self = StObject.set(x, "inds", value.asInstanceOf[js.Any])
