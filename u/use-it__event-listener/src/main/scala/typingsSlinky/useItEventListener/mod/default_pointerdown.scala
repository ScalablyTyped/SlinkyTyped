...
object default_pointerdown extends js.Object {
  ...
  def apply(eventName: pointerdown, handler: PointerEvent, element: Document): Unit = js.native
  def apply(eventName: pointerdown, handler: PointerEvent, element: Document, options: Options): Unit = js.native
  def apply(
    eventName: pointerdown,
    handler: PointerEvent,
    // allow null to support usage with `useRef<HTMLElement | null>(null)`
