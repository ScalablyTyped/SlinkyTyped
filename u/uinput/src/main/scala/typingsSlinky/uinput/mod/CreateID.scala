...
object CreateID {
  ...
  def apply(
    ...
    ff_effects_max: js.UndefOr[Double] = js.undefined
  ): CreateID = {
    ...
    if (!js.isUndefined(ff_effects_max)) __obj.updateDynamic("ff_effects_max")(ff_effects_max.get.asInstanceOf[js.Any])
