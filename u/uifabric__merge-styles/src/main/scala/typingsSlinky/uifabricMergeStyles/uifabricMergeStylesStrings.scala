...
import typingsSlinky.uifabricMergeStyles.irawstylebaseMod.ICSSBaselinePositionRule
import typingsSlinky.uifabricMergeStyles.irawstylebaseMod.ICSSDisplayRule
import typingsSlinky.uifabricMergeStyles.irawstylebaseMod.ICSSOverflowAndSelfPositionRule
...
import typingsSlinky.uifabricMergeStyles.irawstylebaseMod.IMixBlendModes
...
object uifabricMergeStylesStrings {
  ...
  @js.native
  sealed trait antialiased extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait larger extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `safe left` extends StObject
  @scala.inline
  def `safe left`: `safe left` = ("safe left").asInstanceOf[`safe left`]
  
  @js.native
  sealed trait `safe right` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait smaller extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `subpixel-antialiased` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `unsafe left` extends StObject
  @scala.inline
  def `unsafe left`: `unsafe left` = ("unsafe left").asInstanceOf[`unsafe left`]
  
  @js.native
  sealed trait `unsafe right` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `x-large` extends StObject
  @scala.inline
  def `x-large`: `x-large` = "x-large".asInstanceOf[`x-large`]
  
  @js.native
  sealed trait `x-small` extends StObject
  @scala.inline
  def `x-small`: `x-small` = "x-small".asInstanceOf[`x-small`]
  
  @js.native
  sealed trait `xx-large` extends StObject
  @scala.inline
  def `xx-large`: `xx-large` = "xx-large".asInstanceOf[`xx-large`]
  
  @js.native
  sealed trait `xx-small` extends StObject
  @scala.inline
