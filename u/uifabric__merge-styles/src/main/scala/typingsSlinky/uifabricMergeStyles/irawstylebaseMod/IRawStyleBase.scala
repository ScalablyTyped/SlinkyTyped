...
trait IRawStyleBase extends IRawFontStyle {
  /**
    ...
    */
  var MozOsxFontSmoothing: js.UndefOr[none | antialiased | grayscale | `subpixel-antialiased`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var WebkitFontSmoothing: js.UndefOr[none | antialiased | grayscale | `subpixel-antialiased`] = js.undefined
  /**
    * (Webkit specific) momentum scrolling on iOS devices
    */
  var WebkitOverflowScrolling: js.UndefOr[auto | touch] = js.undefined
  /**
  ...
  /**
    ...
    */
  var alignItems: js.UndefOr[ICSSRule | `flex-start` | `flex-end` | center | baseline | stretch] = js.undefined
  /**
  ...
  /**
    ...
    */
  var animationFillMode: js.UndefOr[ICSSRule | none | forwards | backwards | both] = js.undefined
  /**
  ...
  /**
    ...
    */
  var backgroundAttachment: js.UndefOr[ICSSRule | scroll | fixed | local] = js.undefined
  /**
  ...
  /**
    ...
    */
  var backgroundClip: js.UndefOr[ICSSRule | `border-box` | `padding-box` | `content-box` | text] = js.undefined
  /**
  ...
  /**
    ...
    */
  var boxSizing: js.UndefOr[ICSSRule | `border-box` | `content-box`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var columnCount: js.UndefOr[ICSSRule | Double | auto] = js.undefined
  /**
  ...
  /**
    ...
    */
  var flexDirection: js.UndefOr[ICSSRule | row | `row-reverse` | column | `column-reverse`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var flexWrap: js.UndefOr[ICSSRule | nowrap | wrap | `wrap-reverse`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var objectFit: js.UndefOr[ICSSRule | cover | contain | fill | none] = js.undefined
  /**
  ...
  /**
    ...
    */
  var overflowWrap: js.UndefOr[ICSSRule | normal | `break-word`] = js.undefined
  /**
    * Controls how extra content exceeding the x-axis of the bounding box of an element
    * is rendered.
    */
  var overflowX: js.UndefOr[ICSSRule | auto | hidden | scroll | visible] = js.undefined
  /**
    * Controls how extra content exceeding the y-axis of the bounding box of an element
    * is rendered.
    */
  var overflowY: js.UndefOr[ICSSRule | auto | hidden | scroll | visible] = js.undefined
  /**
  ...
  /**
    ...
    */
  var resize: js.UndefOr[ICSSRule | none | both | horizontal | vertical | block | `inline`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var strokeLinecap: js.UndefOr[ICSSRule | butt | round | square] = js.undefined
  /**
    * SVG: Specifies the opacity of the outline on the current object.
    * See SVG 1.1 https://www.w3.org/TR/SVG/painting.html#StrokeOpacityProperty
    */
  var strokeOpacity: js.UndefOr[ICSSRule | Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var userSelect: js.UndefOr[ICSSRule | none | auto | text | all | contain] = js.undefined
  /**
  ...
  /**
    ...
    */
  var widows: js.UndefOr[ICSSRule | Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zIndex: js.UndefOr[ICSSRule | auto | Double] = js.undefined
  /**
...
object IRawStyleBase {
  ...
  def apply(
    ...
    alignmentAdjust: ICSSRule | String = null,
    alignmentBaseline: ICSSRule | String = null,
    animation: ICSSRule | String = null,
    animationDelay: ICSSRule | String = null,
    animationDirection: ICSSRule | String = null,
    animationDuration: ICSSRule | String = null,
    animationFillMode: ICSSRule | none | forwards | backwards | both = null,
    animationIterationCount: ICSSRule | String = null,
    animationName: ICSSRule | String = null,
    animationPlayState: ICSSRule | String = null,
    animationTimingFunction: ICSSRule | String = null,
    appearance: ICSSRule | String = null,
    backdropFilter: ICSSRule | String = null,
    backfaceVisibility: ICSSRule | String = null,
    background: ICSSRule | String = null,
    backgroundAttachment: ICSSRule | scroll | fixed | local = null,
    backgroundBlendMode: ICSSRule | String = null,
    backgroundClip: ICSSRule | `border-box` | `padding-box` | `content-box` | text = null,
    backgroundColor: ICSSRule | String = null,
    backgroundComposite: ICSSRule | String = null,
    backgroundImage: ICSSRule | String = null,
    backgroundOrigin: ICSSRule | String = null,
    backgroundPosition: ICSSRule | String = null,
    backgroundRepeat: ICSSRule | String = null,
    backgroundSize: ICSSRule | String = null,
    border: ICSSRule | `0` | String = null,
    borderBottom: ICSSRule | ICSSPixelUnitRule = null,
    borderBottomColor: ICSSRule | String = null,
    borderBottomLeftRadius: ICSSRule | ICSSPixelUnitRule = null,
    borderBottomRightRadius: ICSSRule | ICSSPixelUnitRule = null,
    borderBottomStyle: ICSSRule | String = null,
    borderBottomWidth: ICSSRule | ICSSPixelUnitRule = null,
    borderCollapse: ICSSRule | String = null,
    borderColor: ICSSRule | String = null,
    borderCornerShape: ICSSRule | String = null,
    borderImageSource: ICSSRule | String = null,
    borderImageWidth: ICSSRule | ICSSPixelUnitRule = null,
    borderLeft: ICSSRule | ICSSPixelUnitRule = null,
    borderLeftColor: ICSSRule | String = null,
    borderLeftStyle: ICSSRule | String = null,
    ...
    borderRightColor: ICSSRule | String = null,
    borderRightStyle: ICSSRule | String = null,
    borderRightWidth: ICSSRule | ICSSPixelUnitRule = null,
    borderSpacing: ICSSRule | String = null,
    borderStyle: ICSSRule | String = null,
    borderTop: ICSSRule | ICSSPixelUnitRule = null,
    borderTopColor: ICSSRule | String = null,
    borderTopLeftRadius: ICSSRule | ICSSPixelUnitRule = null,
    borderTopRightRadius: ICSSRule | ICSSPixelUnitRule = null,
    borderTopStyle: ICSSRule | String = null,
    ...
    boxDecorationBreak: ICSSRule | String = null,
    boxShadow: ICSSRule | String = null,
    boxSizing: ICSSRule | `border-box` | `content-box` = null,
    breakAfter: ICSSRule | String = null,
    breakBefore: ICSSRule | String = null,
    breakInside: ICSSRule | String = null,
    clear: ICSSRule | String = null,
    clipRule: ICSSRule | String = null,
    color: ICSSRule | String = null,
    columnCount: ICSSRule | Double | auto = null,
    columnFill: ICSSRule | String = null,
    columnGap: ICSSRule | String = null,
    columnRule: ICSSRule | String = null,
    columnRuleColor: ICSSRule | String = null,
    columnRuleWidth: ICSSRule | ICSSPixelUnitRule = null,
    columnSpan: ICSSRule | String = null,
    columnWidth: ICSSRule | ICSSPixelUnitRule = null,
    columns: ICSSRule | String = null,
    content: String = null,
    counterIncrement: ICSSRule | String = null,
    counterReset: ICSSRule | String = null,
    cue: ICSSRule | String = null,
    cueAfter: ICSSRule | String = null,
    cursor: ICSSRule | String = null,
    direction: ICSSRule | String = null,
    display: ICSSRule | ICSSDisplayRule = null,
    fill: ICSSRule | String = null,
    fillOpacity: ICSSRule | Double = null,
    fillRule: ICSSRule | String = null,
    filter: ICSSRule | String = null,
    flex: ICSSRule | String | Double = null,
    flexBasis: ICSSRule | String | Double = null,
    flexDirection: ICSSRule | row | `row-reverse` | column | `column-reverse` = null,
    flexFlow: ICSSRule | String = null,
    flexGrow: ICSSRule | Double | String = null,
    flexShrink: ICSSRule | Double | String = null,
    flexWrap: ICSSRule | nowrap | wrap | `wrap-reverse` = null,
    float: ICSSRule | String = null,
    flowFrom: ICSSRule | String = null,
    gridArea: ICSSRule | String = null,
    gridAutoColumns: ICSSRule | String = null,
    gridAutoFlow: ICSSRule | String = null,
    gridAutoRows: ICSSRule | String = null,
    gridColumn: ICSSRule | String = null,
    gridColumnEnd: ICSSRule | String = null,
    gridColumnGap: ICSSRule | String = null,
    gridColumnStart: ICSSRule | String = null,
    gridGap: ICSSRule | String = null,
    gridRow: ICSSRule | String = null,
    gridRowEnd: ICSSRule | String = null,
    gridRowGap: ICSSRule | String = null,
    gridRowPosition: ICSSRule | String = null,
    gridRowStart: ICSSRule | String = null,
    gridTemplate: ICSSRule | String = null,
    gridTemplateAreas: ICSSRule | String = null,
    gridTemplateColumns: ICSSRule | String = null,
    gridTemplateRows: ICSSRule | String = null,
    height: ICSSRule | ICSSPixelUnitRule = null,
    hyphenateLimitChars: ICSSRule | String = null,
    hyphenateLimitLines: ICSSRule | String = null,
    hyphenateLimitZone: ICSSRule | String = null,
    hyphens: ICSSRule | String = null,
    justifyContent: ICSSRule | `flex-start` | `flex-end` | center | `space-between` | `space-around` | `space-evenly` | stretch = null,
    justifySelf: ICSSRule | auto | normal | stretch | ICSSBaselinePositionRule | ICSSOverflowAndSelfPositionRule | left | right | (`safe left`) | (`safe right`) | (`unsafe left`) | (`unsafe right`) = null,
    left: ICSSRule | ICSSPixelUnitRule = null,
    letterSpacing: ICSSRule | String = null,
    lineHeight: ICSSRule | normal | ICSSPixelUnitRule | ICSSPercentageRule = null,
    listStyle: ICSSRule | String = null,
    listStyleImage: ICSSRule | String = null,
    listStylePosition: ICSSRule | String = null,
    listStyleType: ICSSRule | String = null,
    ...
    marqueeDirection: ICSSRule | String = null,
    marqueeStyle: ICSSRule | String = null,
    mask: ICSSRule | String = null,
    maskBorder: ICSSRule | String = null,
    maskBorderRepeat: ICSSRule | String = null,
    maskBorderSlice: ICSSRule | String = null,
    maskBorderSource: ICSSRule | String = null,
    maskBorderWidth: ICSSRule | ICSSPixelUnitRule = null,
    maskClip: ICSSRule | String = null,
    maskOrigin: ICSSRule | String = null,
    ...
    objectFit: ICSSRule | cover | contain | fill | none = null,
    opacity: ICSSRule | Double | String = null,
    order: ICSSRule | Double = null,
    orphans: ICSSRule | Double = null,
    outline: ICSSRule | `0` | String = null,
    outlineColor: ICSSRule | String = null,
    outlineOffset: ICSSRule | String = null,
    overflow: ICSSRule | auto | hidden | scroll | visible = null,
    overflowStyle: ICSSRule | String = null,
    overflowWrap: ICSSRule | normal | `break-word` = null,
    overflowX: ICSSRule | auto | hidden | scroll | visible = null,
    overflowY: ICSSRule | auto | hidden | scroll | visible = null,
    ...
    pageBreakAfter: ICSSRule | String = null,
    pageBreakBefore: ICSSRule | String = null,
    pageBreakInside: ICSSRule | String = null,
    pause: ICSSRule | String = null,
    pauseAfter: ICSSRule | String = null,
    pauseBefore: ICSSRule | String = null,
    perspective: ICSSRule | String = null,
    perspectiveOrigin: ICSSRule | String = null,
    pointerEvents: ICSSRule | String = null,
    position: ICSSRule | static | relative | absolute | fixed | sticky = null,
    quotes: ICSSRule | String = null,
    regionFragment: ICSSRule | String = null,
    resize: ICSSRule | none | both | horizontal | vertical | block | `inline` = null,
    restAfter: ICSSRule | String = null,
    restBefore: ICSSRule | String = null,
    right: ICSSRule | ICSSPixelUnitRule = null,
    shapeImageThreshold: ICSSRule | String = null,
    shapeInside: ICSSRule | String = null,
    shapeMargin: ICSSRule | String = null,
    shapeOutside: ICSSRule | String = null,
    speak: ICSSRule | String = null,
    speakAs: ICSSRule | String = null,
    stroke: ICSSRule | String = null,
    strokeLinecap: ICSSRule | butt | round | square = null,
    strokeOpacity: ICSSRule | Double = null,
    strokeWidth: ICSSRule | ICSSPixelUnitRule = null,
    tabSize: ICSSRule | String = null,
    tableLayout: ICSSRule | String = null,
    textAlign: ICSSRule | String = null,
    textAlignLast: ICSSRule | String = null,
    textDecoration: ICSSRule | String = null,
    textDecorationColor: ICSSRule | String = null,
    textDecorationLine: ICSSRule | String = null,
    textDecorationSkip: ICSSRule | String = null,
    textDecorationStyle: ICSSRule | String = null,
    textEmphasis: ICSSRule | String = null,
    textEmphasisColor: ICSSRule | String = null,
    textEmphasisStyle: ICSSRule | String = null,
    textHeight: ICSSRule | String = null,
    textIndent: ICSSRule | String = null,
    textOverflow: ICSSRule | String = null,
    textOverline: ICSSRule | String = null,
    textOverlineColor: ICSSRule | String = null,
    textOverlineMode: ICSSRule | String = null,
    textOverlineStyle: ICSSRule | String = null,
    ...
    touchAction: ICSSRule | String = null,
    transform: ICSSRule | String = null,
    transformOrigin: ICSSRule | String = null,
    transformOriginZ: ICSSRule | String = null,
    transformStyle: ICSSRule | String = null,
    transition: ICSSRule | String = null,
    transitionDelay: ICSSRule | String = null,
    transitionDuration: ICSSRule | String = null,
    transitionProperty: ICSSRule | String = null,
    transitionTimingFunction: ICSSRule | String = null,
    unicodeBidi: ICSSRule | String = null,
    userFocus: ICSSRule | String = null,
    userInput: ICSSRule | String = null,
    userSelect: ICSSRule | none | auto | text | all | contain = null,
    verticalAlign: ICSSRule | String = null,
    visibility: ICSSRule | String = null,
