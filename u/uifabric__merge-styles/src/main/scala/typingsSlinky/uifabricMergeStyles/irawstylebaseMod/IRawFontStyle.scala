...
object IRawFontStyle {
  ...
  implicit class IRawFontStyleOps[Self <: IRawFontStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFont(value: ICSSRule | String): Self = {
    ...
    @scala.inline
    def withFontFamily(value: ICSSRule | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontKerning(value: ICSSRule | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontSizeAdjust(value: ICSSRule | none | Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontStyle(value: ICSSRule | normal | italic | oblique): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontSynthesis(value: ICSSRule | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontVariant(value: ICSSRule | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontVariantAlternates(value: ICSSRule | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontWeight(value: IFontWeight): Self = {
        val ret = this.duplicate
