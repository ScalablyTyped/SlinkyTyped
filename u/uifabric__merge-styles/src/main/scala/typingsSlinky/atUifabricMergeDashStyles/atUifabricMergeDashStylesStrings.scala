...
import typingsSlinky.atUifabricMergeDashStyles.libIRawStyleBaseMod.ICSSBaselinePositionRule
import typingsSlinky.atUifabricMergeDashStyles.libIRawStyleBaseMod.ICSSDisplayRule
import typingsSlinky.atUifabricMergeDashStyles.libIRawStyleBaseMod.ICSSOverflowAndSelfPositionRule
...
import typingsSlinky.atUifabricMergeDashStyles.libIRawStyleBaseMod.IMixBlendModes
...
object atUifabricMergeDashStylesStrings {
  ...
  @js.native
  sealed trait antialiased extends js.Object
  ...
  @js.native
  sealed trait `x-large` extends js.Object
  
  @js.native
  sealed trait `x-small` extends js.Object
  
  @js.native
  sealed trait `xx-large` extends js.Object
