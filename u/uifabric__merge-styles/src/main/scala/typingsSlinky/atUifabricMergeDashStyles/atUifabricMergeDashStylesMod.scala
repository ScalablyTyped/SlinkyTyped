...
import typingsSlinky.atUifabricMergeDashStyles.libIStyleOptionsMod.IStyleOptions
...
object atUifabricMergeDashStylesMod extends js.Object {
  @js.native
  class Stylesheet ()
    extends typingsSlinky.atUifabricMergeDashStyles.libStylesheetMod.Stylesheet {
