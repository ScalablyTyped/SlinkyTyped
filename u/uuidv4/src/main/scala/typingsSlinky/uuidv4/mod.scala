...
object mod {
  ...
  object regex {
    ...
    @scala.inline
    def v4_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("v4")(x.asInstanceOf[js.Any])
    
    @JSImport("uuidv4", "regex.v5")
    @js.native
    def v5: js.RegExp = js.native
    @scala.inline
    def v5_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("v5")(x.asInstanceOf[js.Any])
  }
