...
object BoxOwnPropsElementTypeany {
  ...
  implicit class BoxOwnPropsElementTypeanyOps[Self <: BoxOwnPropsElementTypeany] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsFunctionComponent(value: ReactComponentClass[_]): Self = this.set("is", value.asInstanceOf[js.Any])
    @scala.inline
    def setIsComponentClass(value: ReactComponentClass[_]): Self = this.set("is", value.asInstanceOf[js.Any])
    @scala.inline
    def setIs(value: ReactElement): Self = this.set("is", value.asInstanceOf[js.Any])
    @scala.inline
