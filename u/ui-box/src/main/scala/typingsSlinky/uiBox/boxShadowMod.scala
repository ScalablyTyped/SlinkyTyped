...
object boxShadowMod {
  ...
  @JSImport("ui-box/dist/src/enhancers/box-shadow", "propAliases")
  @js.native
  val propAliases: PropAliases = js.native
  
  @JSImport("ui-box/dist/src/enhancers/box-shadow", "propEnhancers")
  @js.native
  val propEnhancers: PropEnhancers = js.native
  
  @JSImport("ui-box/dist/src/enhancers/box-shadow", "propTypes")
  @js.native
  val propTypes: PropTypesMapping = js.native
  
  @JSImport("ui-box/dist/src/enhancers/box-shadow", "propValidators")
  @js.native
