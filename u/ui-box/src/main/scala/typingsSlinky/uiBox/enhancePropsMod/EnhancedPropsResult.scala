package typingsSlinky.uiBox.enhancePropsMod
...
object EnhancedPropsResult {
  ...
  implicit class EnhancedPropsResultOps[Self <: EnhancedPropsResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnhancedProps(value: PreservedProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enhancedProps")(value.asInstanceOf[js.Any])
        ret
    }
  }
