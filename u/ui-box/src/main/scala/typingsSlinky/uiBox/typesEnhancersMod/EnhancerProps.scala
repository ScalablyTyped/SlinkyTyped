...
object EnhancerProps {
  @scala.inline
  def apply(
    alignContent: AlignContentProperty | Double | `false` = null,
    alignItems: AlignItemsProperty | Double | `false` = null,
    alignSelf: AlignSelfProperty | Double | `false` = null,
    background: (BackgroundProperty[String | `0`]) | Double | `false` = null,
    backgroundBlendMode: BackgroundBlendModeProperty | Double | `false` = null,
    backgroundClip: BackgroundClipProperty | Double | `false` = null,
    backgroundColor: BackgroundColorProperty | Double | `false` = null,
    backgroundImage: BackgroundImageProperty | Double | `false` = null,
    backgroundOrigin: BackgroundOriginProperty | Double | `false` = null,
    backgroundPosition: (BackgroundPositionProperty[String | `0`]) | Double | `false` = null,
    backgroundRepeat: BackgroundRepeatProperty | Double | `false` = null,
    backgroundSize: (BackgroundSizeProperty[String | `0`]) | Double | `false` = null,
    border: (BorderProperty[String | `0`]) | Double | `false` = null,
    borderBottom: (BorderBottomProperty[String | `0`]) | Double | `false` = null,
    borderBottomColor: BorderBottomColorProperty | Double | `false` = null,
    borderBottomLeftRadius: (BorderBottomLeftRadiusProperty[String | `0`]) | Double | `false` = null,
    borderBottomRightRadius: (BorderBottomRightRadiusProperty[String | `0`]) | Double | `false` = null,
    borderBottomStyle: BorderBottomStyleProperty | Double | `false` = null,
    borderBottomWidth: (BorderBottomWidthProperty[String | `0`]) | Double | `false` = null,
    borderColor: BorderColorProperty | Double | `false` = null,
    borderLeft: (BorderLeftProperty[String | `0`]) | Double | `false` = null,
    borderLeftColor: BorderLeftColorProperty | Double | `false` = null,
    borderLeftStyle: BorderLeftStyleProperty | Double | `false` = null,
    borderLeftWidth: (BorderLeftWidthProperty[String | `0`]) | Double | `false` = null,
    borderRadius: (BorderRadiusProperty[String | `0`]) | Double | `false` = null,
    borderRight: (BorderRightProperty[String | `0`]) | Double | `false` = null,
    borderRightColor: BorderRightColorProperty | Double | `false` = null,
    borderRightStyle: BorderRightStyleProperty | Double | `false` = null,
    borderRightWidth: (BorderRightWidthProperty[String | `0`]) | Double | `false` = null,
    borderStyle: BorderStyleProperty | Double | `false` = null,
    borderTop: (BorderTopProperty[String | `0`]) | Double | `false` = null,
    borderTopColor: BorderTopColorProperty | Double | `false` = null,
    borderTopLeftRadius: (BorderTopLeftRadiusProperty[String | `0`]) | Double | `false` = null,
    borderTopRightRadius: (BorderTopRightRadiusProperty[String | `0`]) | Double | `false` = null,
    borderTopStyle: BorderTopStyleProperty | Double | `false` = null,
    borderTopWidth: (BorderTopWidthProperty[String | `0`]) | Double | `false` = null,
    borderWidth: (BorderWidthProperty[String | `0`]) | Double | `false` = null,
    bottom: (BottomProperty[String | `0`]) | Double | `false` = null,
    boxShadow: BoxShadowProperty | Double | `false` = null,
    boxSizing: BoxSizingProperty | Double | `false` = null,
    clear: ClearProperty | Double | `false` = null,
    clearfix: js.UndefOr[Boolean] = js.undefined,
    color: ColorProperty | Double | `false` = null,
    columnGap: (ColumnGapProperty[String | `0`]) | Double | `false` = null,
    cursor: CursorProperty | Double | `false` = null,
    display: DisplayProperty | Double | `false` = null,
    flex: (FlexProperty[String | `0`]) | Double | `false` = null,
    flexBasis: (FlexBasisProperty[String | `0`]) | Double | `false` = null,
    flexDirection: FlexDirectionProperty | Double | `false` = null,
    flexFlow: FlexFlowProperty | Double | `false` = null,
    flexGrow: GlobalsNumber | Double | `false` = null,
    flexShrink: GlobalsNumber | Double | `false` = null,
    flexWrap: FlexWrapProperty | Double | `false` = null,
    float: FloatProperty | Double | `false` = null,
    font: FontProperty | Double | `false` = null,
    fontFamily: FontFamilyProperty | Double | `false` = null,
    fontSize: (FontSizeProperty[String | `0`]) | Double | `false` = null,
    fontStyle: FontStyleProperty | Double | `false` = null,
    fontVariant: FontVariantProperty | Double | `false` = null,
    fontWeight: FontWeightProperty | Double | `false` = null,
    gap: (GapProperty[String | `0`]) | Double | `false` = null,
    grid: GridProperty | Double | `false` = null,
    gridArea: GridAreaProperty | Double | `false` = null,
    gridAutoColumns: (GridAutoColumnsProperty[String | `0`]) | Double | `false` = null,
    gridAutoFlow: GridAutoFlowProperty | Double | `false` = null,
    gridAutoRows: (GridAutoRowsProperty[String | `0`]) | Double | `false` = null,
    gridColumn: GridColumnProperty | Double | `false` = null,
    gridColumnEnd: GridColumnEndProperty | Double | `false` = null,
    gridColumnGap: (GridColumnGapProperty[String | `0`]) | Double | `false` = null,
    gridColumnStart: GridColumnStartProperty | Double | `false` = null,
    gridGap: (GridGapProperty[String | `0`]) | Double | `false` = null,
    gridRow: GridRowProperty | Double | `false` = null,
    gridRowEnd: GridRowEndProperty | Double | `false` = null,
    gridRowGap: (GridRowGapProperty[String | `0`]) | Double | `false` = null,
    gridRowStart: GridRowStartProperty | Double | `false` = null,
    gridTemplate: GridTemplateProperty | Double | `false` = null,
    gridTemplateAreas: GridTemplateAreasProperty | Double | `false` = null,
    gridTemplateColumns: (GridTemplateColumnsProperty[String | `0`]) | Double | `false` = null,
    gridTemplateRows: (GridTemplateRowsProperty[String | `0`]) | Double | `false` = null,
    height: (HeightProperty[String | `0`]) | Double | `false` = null,
    justifyContent: JustifyContentProperty | Double | `false` = null,
    justifyItems: JustifyItemsProperty | Double | `false` = null,
    justifySelf: JustifySelfProperty | Double | `false` = null,
    left: (LeftProperty[String | `0`]) | Double | `false` = null,
    letterSpacing: (LetterSpacingProperty[String | `0`]) | Double | `false` = null,
    lineHeight: (LineHeightProperty[String | `0`]) | Double | `false` = null,
    listStyle: ListStyleProperty | Double | `false` = null,
    listStyleImage: ListStyleImageProperty | Double | `false` = null,
    listStylePosition: ListStylePositionProperty | Double | `false` = null,
    listStyleType: ListStyleTypeProperty | Double | `false` = null,
    margin: (MarginProperty[String | `0`]) | Double | `false` = null,
    marginBottom: (MarginBottomProperty[String | `0`]) | Double | `false` = null,
    marginLeft: (MarginLeftProperty[String | `0`]) | Double | `false` = null,
    marginRight: (MarginRightProperty[String | `0`]) | Double | `false` = null,
    marginTop: (MarginTopProperty[String | `0`]) | Double | `false` = null,
    marginX: BoxPropValue = null,
    marginY: BoxPropValue = null,
    maxHeight: (MaxHeightProperty[String | `0`]) | Double | `false` = null,
    maxWidth: (MaxWidthProperty[String | `0`]) | Double | `false` = null,
    minHeight: (MinHeightProperty[String | `0`]) | Double | `false` = null,
    minWidth: (MinWidthProperty[String | `0`]) | Double | `false` = null,
    opacity: GlobalsNumber | Double | `false` = null,
    order: GlobalsNumber | Double | `false` = null,
    overflow: OverflowProperty | Double | `false` = null,
    overflowX: OverflowXProperty | Double | `false` = null,
    overflowY: OverflowYProperty | Double | `false` = null,
    padding: (PaddingProperty[String | `0`]) | Double | `false` = null,
    paddingBottom: (PaddingBottomProperty[String | `0`]) | Double | `false` = null,
    paddingLeft: (PaddingLeftProperty[String | `0`]) | Double | `false` = null,
    paddingRight: (PaddingRightProperty[String | `0`]) | Double | `false` = null,
    paddingTop: (PaddingTopProperty[String | `0`]) | Double | `false` = null,
    paddingX: BoxPropValue = null,
    paddingY: BoxPropValue = null,
    placeContent: PlaceContentProperty | Double | `false` = null,
    placeItems: PlaceItemsProperty | Double | `false` = null,
    placeSelf: PlaceSelfProperty | Double | `false` = null,
    pointerEvents: PointerEventsProperty | Double | `false` = null,
    position: PositionProperty | Double | `false` = null,
    right: (RightProperty[String | `0`]) | Double | `false` = null,
    rowGap: (RowGapProperty[String | `0`]) | Double | `false` = null,
    textAlign: TextAlignProperty | Double | `false` = null,
    textDecoration: TextDecorationProperty | Double | `false` = null,
    textOverflow: TextOverflowProperty | Double | `false` = null,
    textShadow: TextShadowProperty | Double | `false` = null,
    textTransform: TextTransformProperty | Double | `false` = null,
    top: (TopProperty[String | `0`]) | Double | `false` = null,
    transform: TransformProperty | Double | `false` = null,
    transformOrigin: (TransformOriginProperty[String | `0`]) | Double | `false` = null,
    transition: TransitionProperty | Double | `false` = null,
    transitionDelay: GlobalsString | Double | `false` = null,
    transitionDuration: GlobalsString | Double | `false` = null,
    transitionProperty: TransitionPropertyProperty | Double | `false` = null,
    transitionTimingFunction: TransitionTimingFunctionProperty | Double | `false` = null,
    userSelect: UserSelectProperty | Double | `false` = null,
    visibility: VisibilityProperty | Double | `false` = null,
    whiteSpace: WhiteSpaceProperty | Double | `false` = null,
    width: (WidthProperty[String | `0`]) | Double | `false` = null,
    wordBreak: WordBreakProperty | Double | `false` = null,
    wordWrap: WordWrapProperty | Double | `false` = null,
    zIndex: ZIndexProperty | Double | `false` = null
  ): EnhancerProps = {
