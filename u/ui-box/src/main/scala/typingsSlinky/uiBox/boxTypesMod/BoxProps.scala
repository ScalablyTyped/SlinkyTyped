...
/* Inlined ui-box.ui-box/dist/types/box-types.InheritedProps<T> & ui-box.ui-box/dist/types/enhancers.EnhancerProps & {  is ? :T,   innerRef ? :react.react.Ref<ui-box.ui-box/dist/types/box-types.RefType<T>>} */
trait BoxProps[T /* <: Is[_] */] extends js.Object {
