package typingsSlinky.umzug.umzugMod

import typingsSlinky.umzug.Anon_Down
...
trait MigrationOptions extends js.Object {
  /**
    ...
    * for examples.
    */
  var customResolver: js.UndefOr[js.Function1[/* path */ String, Anon_Down]] = js.undefined
  /*
...
object MigrationOptions {
  @scala.inline
  def apply(
    customResolver: /* path */ String => Anon_Down = null,
