...
import typingsSlinky.uniDashApp.uniDashAppStrings.igexin
import typingsSlinky.uniDashApp.uniDashAppStrings.mipush
import typingsSlinky.uniDashApp.uniDashAppStrings.unipush
