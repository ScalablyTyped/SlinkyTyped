...
trait GetConnectedWifiOptions extends StObject {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ GetConnectedWifiRes, Unit]] = js.native
}
object GetConnectedWifiOptions {
  
  @scala.inline
  def apply(): GetConnectedWifiOptions = {
  ...
  implicit class GetConnectedWifiOptionsMutableBuilder[Self <: GetConnectedWifiOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetConnectedWifiRes => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
