...
object PageInstanceBaseProps {
  @scala.inline
  def apply[/* <: typingsSlinky.uniApp.AnyObject */ D](): PageInstanceBaseProps[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageInstanceBaseProps[D]]
  }
  @scala.inline
  implicit class PageInstanceBasePropsOps[Self <: PageInstanceBaseProps[_], /* <: typingsSlinky.uniApp.AnyObject */ D] (val x: Self with PageInstanceBaseProps[D]) extends AnyVal {
    @scala.inline
