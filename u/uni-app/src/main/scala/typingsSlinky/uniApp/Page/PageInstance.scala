...
object PageInstance {
  @scala.inline
  def apply[/* <: typingsSlinky.uniApp.AnyObject */ D, /* <: typingsSlinky.uniApp.AnyObject */ T](): PageInstance[D, T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageInstance[D, T]]
  }
  @scala.inline
  implicit class PageInstanceOps[Self <: PageInstance[_, _], /* <: typingsSlinky.uniApp.AnyObject */ D, /* <: typingsSlinky.uniApp.AnyObject */ T] (val x: Self with (PageInstance[D, T])) extends AnyVal {
    @scala.inline
