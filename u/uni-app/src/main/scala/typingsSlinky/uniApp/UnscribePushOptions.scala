...
@js.native
trait UnscribePushOptions extends StObject {
...
object UnscribePushOptions {
  ...
  @scala.inline
  def apply(): UnscribePushOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UnscribePushOptions]
  }
  
  @scala.inline
  implicit class UnscribePushOptionsMutableBuilder[Self <: UnscribePushOptions] (val x: Self) extends AnyVal {
