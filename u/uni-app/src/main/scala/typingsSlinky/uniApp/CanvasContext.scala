...
import typingsSlinky.uniApp.uniAppStrings.`no-repeat`
import typingsSlinky.uniApp.uniAppStrings.`repeat-x`
import typingsSlinky.uniApp.uniAppStrings.`repeat-y`
import typingsSlinky.uniApp.uniAppStrings.bevel
import typingsSlinky.uniApp.uniAppStrings.bottom
import typingsSlinky.uniApp.uniAppStrings.butt
import typingsSlinky.uniApp.uniAppStrings.center
import typingsSlinky.uniApp.uniAppStrings.left
import typingsSlinky.uniApp.uniAppStrings.middle
import typingsSlinky.uniApp.uniAppStrings.miter
import typingsSlinky.uniApp.uniAppStrings.normal
import typingsSlinky.uniApp.uniAppStrings.repeat
import typingsSlinky.uniApp.uniAppStrings.right
import typingsSlinky.uniApp.uniAppStrings.round
import typingsSlinky.uniApp.uniAppStrings.square
