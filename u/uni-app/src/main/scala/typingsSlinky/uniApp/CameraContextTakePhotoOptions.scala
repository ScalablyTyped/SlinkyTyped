...
object CameraContextTakePhotoOptions {
  ...
  implicit class CameraContextTakePhotoOptionsOps[Self <: CameraContextTakePhotoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuality(value: normal | high | low): Self = this.set("quality", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteQuality: Self = this.set("quality", js.undefined)
    @scala.inline
    def setSuccess(value: /* result */ CameraContextTakePhotoResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
