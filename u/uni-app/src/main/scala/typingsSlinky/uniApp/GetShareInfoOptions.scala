...
trait GetShareInfoOptions extends js.Object {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ GetShareInfoRes, Unit]] = js.native
...
object GetShareInfoOptions {
  ...
  implicit class GetShareInfoOptionsOps[Self <: GetShareInfoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetShareInfoRes => Unit): Self = this.set("success", js.Any.fromFunction1(value))
