...
import typingsSlinky.uniApp.uniAppStrings.`ease-in-out`
import typingsSlinky.uniApp.uniAppStrings.`ease-in`
import typingsSlinky.uniApp.uniAppStrings.`ease-out`
import typingsSlinky.uniApp.uniAppStrings.`step-end`
import typingsSlinky.uniApp.uniAppStrings.`step-start`
import typingsSlinky.uniApp.uniAppStrings.ease
