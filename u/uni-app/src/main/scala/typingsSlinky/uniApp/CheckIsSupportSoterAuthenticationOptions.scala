...
trait CheckIsSupportSoterAuthenticationOptions extends js.Object {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ CheckIsSupportSoterAuthenticationRes, Unit]] = js.native
}
object CheckIsSupportSoterAuthenticationOptions {
  ...
  implicit class CheckIsSupportSoterAuthenticationOptionsOps[Self <: CheckIsSupportSoterAuthenticationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ CheckIsSupportSoterAuthenticationRes => Unit): Self = this.set("success", js.Any.fromFunction1(value))
