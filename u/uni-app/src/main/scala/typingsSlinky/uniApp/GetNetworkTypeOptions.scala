...
trait GetNetworkTypeOptions extends StObject {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ GetNetworkTypeSuccess, Unit]] = js.native
}
object GetNetworkTypeOptions {
  ...
  implicit class GetNetworkTypeOptionsMutableBuilder[Self <: GetNetworkTypeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetNetworkTypeSuccess => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
