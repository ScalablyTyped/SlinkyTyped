...
trait GetBluetoothDevicesOptions extends StObject {
  ...
  /**
    * 成功则返回本机蓝牙适配器状态
    */
  var success: js.UndefOr[js.Function1[/* result */ GetBluetoothDevicesSuccess, Unit]] = js.native
}
object GetBluetoothDevicesOptions {
  
  @scala.inline
  def apply(): GetBluetoothDevicesOptions = {
  ...
  implicit class GetBluetoothDevicesOptionsMutableBuilder[Self <: GetBluetoothDevicesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetBluetoothDevicesSuccess => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
