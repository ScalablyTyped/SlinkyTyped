...
import typingsSlinky.uniApp.App.AppInstance
import typingsSlinky.uniApp.App.LaunchShowOption
import typingsSlinky.uniApp.App.PageNotFoundOption
import typingsSlinky.uniApp.Page.PageInstance
...
object mod {
  ...
  - typingsSlinky.uniApp.App.AppInstance because var conflicts: onHide, onShow. Inlined globalData, onLaunch, onError, onPageNotFound, onUniNViewMessage */ @js.native
