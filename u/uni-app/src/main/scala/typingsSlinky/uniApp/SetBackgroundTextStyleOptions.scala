...
@js.native
trait SetBackgroundTextStyleOptions extends StObject {
...
object SetBackgroundTextStyleOptions {
  ...
  @scala.inline
  implicit class SetBackgroundTextStyleOptionsMutableBuilder[Self <: SetBackgroundTextStyleOptions] (val x: Self) extends AnyVal {
