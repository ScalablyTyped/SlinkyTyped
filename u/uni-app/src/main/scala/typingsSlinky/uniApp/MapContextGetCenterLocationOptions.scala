...
object MapContextGetCenterLocationOptions {
  ...
  @scala.inline
  implicit class MapContextGetCenterLocationOptionsOps[Self <: MapContextGetCenterLocationOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ LocationObject => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
