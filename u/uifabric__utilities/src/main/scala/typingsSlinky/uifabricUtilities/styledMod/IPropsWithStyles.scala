...
object IPropsWithStyles {
  @scala.inline
  def apply[TStyleProps, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet](): IPropsWithStyles[TStyleProps, TStyleSet] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IPropsWithStyles[TStyleProps, TStyleSet]]
  }
  @scala.inline
  implicit class IPropsWithStylesOps[Self <: IPropsWithStyles[_, _], TStyleProps, /* <: typingsSlinky.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet] (val x: Self with (IPropsWithStyles[TStyleProps, TStyleSet])) extends AnyVal {
    @scala.inline
