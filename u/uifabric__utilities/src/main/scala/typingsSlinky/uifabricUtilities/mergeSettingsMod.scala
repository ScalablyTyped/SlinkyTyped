...
object mergeSettingsMod {
  
  @JSImport("@uifabric/utilities/lib/customizations/mergeSettings", "mergeScopedSettings")
  @js.native
  ...
  @JSImport("@uifabric/utilities/lib/customizations/mergeSettings", "mergeSettings")
  @js.native
