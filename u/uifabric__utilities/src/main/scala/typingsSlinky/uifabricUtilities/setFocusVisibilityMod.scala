...
import typingsSlinky.uifabricUtilities.uifabricUtilitiesStrings.`ms-Fabric--isFocusHidden`
import typingsSlinky.uifabricUtilities.uifabricUtilitiesStrings.`ms-Fabric--isFocusVisible`
