...
object DelayedRender
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atUifabricUtilities.libDelayedRenderMod.DelayedRender] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.atUifabricUtilities.libDelayedRenderMod.DelayedRender](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
