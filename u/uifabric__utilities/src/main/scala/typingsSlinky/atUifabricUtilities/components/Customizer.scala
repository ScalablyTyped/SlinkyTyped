...
object Customizer
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Customizer] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Customizer] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Customizer] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.atUifabricUtilities.atUifabricUtilitiesMod.Customizer](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
