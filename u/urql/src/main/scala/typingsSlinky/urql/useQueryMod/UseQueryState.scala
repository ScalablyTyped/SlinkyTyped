package typingsSlinky.urql.useQueryMod

import typingsSlinky.std.Record
import typingsSlinky.urqlCore.mod.CombinedError
...
object UseQueryState {
  @scala.inline
  def apply[T](fetching: Boolean, stale: Boolean): UseQueryState[T] = {
  ...
  @scala.inline
  implicit class UseQueryStateOps[Self <: UseQueryState[_], T] (val x: Self with UseQueryState[T]) extends AnyVal {
    @scala.inline
