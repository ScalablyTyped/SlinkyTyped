package typingsSlinky.undertakerRegistry.mod
...
object UndertakerRegistry {
  ...
  implicit class UndertakerRegistryOps[Self <: UndertakerRegistry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTasks(value: () => StringDictionary[js.Function1[/* repeated */ js.Any, _]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tasks")(js.Any.fromFunction0(value))
        ret
    }
  }
