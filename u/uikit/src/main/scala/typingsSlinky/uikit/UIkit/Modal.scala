...
trait Modal extends js.Object {
  ...
  def apply(selector: JQuery[HTMLElement]): ModalElement = js.native
  def apply(selector: JQuery[HTMLElement], options: ModalOptions): ModalElement = js.native
  /**
