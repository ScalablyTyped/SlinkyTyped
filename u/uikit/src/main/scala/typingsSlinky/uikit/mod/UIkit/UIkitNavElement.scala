...
object UIkitNavElement {
  ...
  implicit class UIkitNavElementOps[Self <: UIkitNavElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIndexNode(value: Node): Self = this.set("index", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIndex(value: String | Double | Node): Self = this.set("index", value.asInstanceOf[js.Any])
  }
}
