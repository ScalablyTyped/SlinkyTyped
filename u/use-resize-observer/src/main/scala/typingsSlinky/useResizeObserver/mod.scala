...
object mod {
  ...
  object DefaultsWithResizeHandler {
    ...
    implicit class DefaultsWithResizeHandlerMutableBuilder[Self <: DefaultsWithResizeHandler[_], TElement] (val x: Self with DefaultsWithResizeHandler[TElement]) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: ReactRef[TElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object ObserverDefaults {
    ...
    @scala.inline
    def DefaultsWithResizeHandler[TElement /* <: HTMLElement */](onResize: /* newSize */ RefSize => Unit): typingsSlinky.useResizeObserver.mod.DefaultsWithResizeHandler[TElement] = {
      val __obj = js.Dynamic.literal(onResize = js.Any.fromFunction1(onResize))
      __obj.asInstanceOf[typingsSlinky.useResizeObserver.mod.DefaultsWithResizeHandler[TElement]]
    }
    
    @scala.inline
    def DefaultsWithoutResizeHandler[TElement /* <: HTMLElement */](): typingsSlinky.useResizeObserver.mod.DefaultsWithoutResizeHandler[TElement] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.useResizeObserver.mod.DefaultsWithoutResizeHandler[TElement]]
    }
  }
