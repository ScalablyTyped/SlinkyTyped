package typingsSlinky.usb

import typingsSlinky.node.Buffer
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.std.Error
import typingsSlinky.usb.usbMod.BosDescriptor
import typingsSlinky.usb.usbMod.Capability
import typingsSlinky.usb.usbMod.CapabilityDescriptor
import typingsSlinky.usb.usbMod.ConfigDescriptor
import typingsSlinky.usb.usbMod.Device
import typingsSlinky.usb.usbMod.DeviceDescriptor
import typingsSlinky.usb.usbMod.Endpoint
import typingsSlinky.usb.usbMod.EndpointDescriptor
import typingsSlinky.usb.usbMod.InEndpoint
import typingsSlinky.usb.usbMod.Interface
import typingsSlinky.usb.usbMod.InterfaceDescriptor
import typingsSlinky.usb.usbMod.LibUSBException
import typingsSlinky.usb.usbMod.OutEndpoint
