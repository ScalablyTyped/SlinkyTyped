package typingsSlinky.unityDashWebapi
...
object UnityPlaybackState extends js.Object {
  ...
  /* 1 */ val Paused: typingsSlinky.unityDashWebapi.UnityPlaybackState.Paused with Double = js.native
  /* 0 */ val Playing: typingsSlinky.unityDashWebapi.UnityPlaybackState.Playing with Double = js.native
  @JSBracketAccess
