...
import typingsSlinky.unfetch.anon.Body
import typingsSlinky.unfetch.anon.Entries
...
object mod {
  ...
  object unfetch {
    ...
    type IsomorphicBody = org.scalajs.dom.experimental.Body | typingsSlinky.nodeFetch.mod.Body
