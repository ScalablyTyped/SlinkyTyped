package typingsSlinky.ethereumjsDashUtil

import typingsSlinky.bnDotJs.bnDotJsMod.Endianness
import typingsSlinky.bnDotJs.bnDotJsMod.IPrimeName
import typingsSlinky.bnDotJs.bnDotJsMod.ReductionContext
import typingsSlinky.bnDotJs.bnDotJsMod.^
import typingsSlinky.ethereumjsDashUtil.distSignatureMod.ECDSASignature
import typingsSlinky.ethereumjsDashUtil.ethereumjsDashUtilStrings.hex
...
object ethereumjsDashUtilMod extends js.Object {
  ...
  class BN protected () extends ^ {
    ...
    def this(number: typingsSlinky.bnDotJs.bnDotJsMod.BN) = this()
    ...
    def this(number: typingsSlinky.bnDotJs.bnDotJsMod.BN, base: Double) = this()
    def this(number: typingsSlinky.bnDotJs.bnDotJsMod.BN, base: hex) = this()
    def this(number: typingsSlinky.bnDotJs.bnDotJsMod.BN, endian: Endianness) = this()
    ...
    def this(number: typingsSlinky.bnDotJs.bnDotJsMod.BN, base: Double, endian: Endianness) = this()
    def this(number: typingsSlinky.bnDotJs.bnDotJsMod.BN, base: hex, endian: Endianness) = this()
  ...
  object BN extends js.Object {
    ...
    /**
      ...
      */
    def max(left: typingsSlinky.bnDotJs.bnDotJsMod.BN, right: typingsSlinky.bnDotJs.bnDotJsMod.BN): typingsSlinky.bnDotJs.bnDotJsMod.BN = js.native
    /**
      * @description returns the minimum of 2 BN instances.
      */
    def min(left: typingsSlinky.bnDotJs.bnDotJsMod.BN, right: typingsSlinky.bnDotJs.bnDotJsMod.BN): typingsSlinky.bnDotJs.bnDotJsMod.BN = js.native
    /**
      * @description  create a reduction context  with the Montgomery trick.
      */
    def mont(num: typingsSlinky.bnDotJs.bnDotJsMod.BN): ReductionContext = js.native
    /**
      * @description  create a reduction context
      */
    def red(reductionContext: typingsSlinky.bnDotJs.bnDotJsMod.BN): ReductionContext = js.native
