...
import typingsSlinky.ethereumjsUtil.typesMod.BNLike
import typingsSlinky.ethereumjsUtil.typesMod.BufferLike
...
object accountMod {
  ...
  object AccountData {
    ...
    implicit class AccountDataMutableBuilder[Self <: AccountData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCodeHashUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "codeHash", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStateRootUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "stateRoot", value.asInstanceOf[js.Any])
