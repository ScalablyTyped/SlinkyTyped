...
import typingsSlinky.ethereumjsUtil.addressMod.Address
...
object typesMod {
  ...
  type BufferLike = Buffer | js.typedarray.Uint8Array | js.Array[Double] | Double | ^ | TransformableToBuffer | PrefixedHexString
  ...
  trait TransformableToArray extends StObject {
    ...
    def toArray(): js.typedarray.Uint8Array = js.native
  ...
  object TransformableToArray {
    ...
    @scala.inline
    def apply(toArray: () => js.typedarray.Uint8Array): TransformableToArray = {
    ...
    implicit class TransformableToArrayMutableBuilder[Self <: TransformableToArray] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setToArray(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "toArray", js.Any.fromFunction0(value))
  ...
  trait TransformableToBuffer extends StObject {
    ...
    var toArray: js.UndefOr[js.Function0[js.typedarray.Uint8Array]] = js.native
