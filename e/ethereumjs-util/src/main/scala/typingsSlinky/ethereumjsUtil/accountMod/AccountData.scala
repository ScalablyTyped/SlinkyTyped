...
object AccountData {
  ...
  implicit class AccountDataOps[Self <: AccountData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCodeHashUint8Array(value: js.typedarray.Uint8Array): Self = this.set("codeHash", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStateRootUint8Array(value: js.typedarray.Uint8Array): Self = this.set("stateRoot", value.asInstanceOf[js.Any])
