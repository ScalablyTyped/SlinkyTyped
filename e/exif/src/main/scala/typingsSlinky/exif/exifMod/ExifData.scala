...
import typingsSlinky.exif.Anon_ApertureValue
import typingsSlinky.exif.Anon_AutoBracketing
import typingsSlinky.exif.Anon_Compression
import typingsSlinky.exif.Anon_Copyright
import typingsSlinky.exif.Anon_GPSAltitude
import typingsSlinky.exif.Anon_InteropIndex
