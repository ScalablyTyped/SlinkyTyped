package typingsSlinky.easyDashApiDashRequest.easyDashApiDashRequestMod

import typingsSlinky.bunyan.bunyanMod.^
import typingsSlinky.easyDashApiDashRequest.Anon_Cb
...
trait BaseRequest extends js.Object {
  ...
  var req: typingsSlinky.express.expressMod.Request[ParamsDictionary] = js.native
