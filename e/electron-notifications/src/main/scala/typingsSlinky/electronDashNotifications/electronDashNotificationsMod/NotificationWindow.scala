package typingsSlinky.electronDashNotifications.electronDashNotificationsMod

import typingsSlinky.electron.electronMod.BrowserWindow
import typingsSlinky.electronDashNotifications.electronDashNotificationsStrings.buttonClicked
import typingsSlinky.electronDashNotifications.electronDashNotificationsStrings.clicked
import typingsSlinky.electronDashNotifications.electronDashNotificationsStrings.swipedRight
