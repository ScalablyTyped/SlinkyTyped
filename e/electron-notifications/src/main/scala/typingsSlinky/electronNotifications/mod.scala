package typingsSlinky.electronNotifications

import typingsSlinky.electron.Electron.BrowserWindowConstructorOptions
import typingsSlinky.electron.mod.BrowserWindow
import typingsSlinky.electronNotifications.electronNotificationsStrings.buttonClicked
import typingsSlinky.electronNotifications.electronNotificationsStrings.clicked
import typingsSlinky.electronNotifications.electronNotificationsStrings.swipedRight
