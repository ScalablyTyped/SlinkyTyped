...
object mod extends Shortcut {
  ...
  object Context extends StObject {
    ...
    sealed trait ATRUL
      extends Context
         with PrefixContext
    /* 3 */ val ATRUL: typingsSlinky.emotionStylis.mod.Context.ATRUL with Double = js.native
    
    @js.native
    sealed trait BLCKS
      extends Context
         with PrefixContext
    /* 2 */ val BLCKS: typingsSlinky.emotionStylis.mod.Context.BLCKS with Double = js.native
    
    @js.native
    sealed trait POSTS extends Context
    /* -2 */ val POSTS: typingsSlinky.emotionStylis.mod.Context.POSTS with Double = js.native
    
    @js.native
    sealed trait PREPS extends Context
    /* -1 */ val PREPS: typingsSlinky.emotionStylis.mod.Context.PREPS with Double = js.native
    
    @js.native
    sealed trait PROPS
      extends Context
         with PrefixContext
    /* 1 */ val PROPS: typingsSlinky.emotionStylis.mod.Context.PROPS with Double = js.native
    
    @js.native
    sealed trait UNKWN extends Context
    /* 0 */ val UNKWN: typingsSlinky.emotionStylis.mod.Context.UNKWN with Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.emotionStylis.mod.Context.PROPS
    - typingsSlinky.emotionStylis.mod.Context.BLCKS
