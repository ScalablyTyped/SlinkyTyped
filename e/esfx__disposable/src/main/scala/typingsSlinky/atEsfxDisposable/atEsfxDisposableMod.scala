...
object atEsfxDisposableMod extends js.Object {
  ...
  object AsyncDisposable extends js.Object {
    ...
    val name: typingsSlinky.atEsfxDisposable.atEsfxDisposableStrings.AsyncDisposable = js.native
    /**
      * Creates an `AsyncDisposable` wrapper around a callback used to dispose resources.
      */
    def create(dispose: js.Function0[Unit | js.Thenable[Unit]]): typingsSlinky.atEsfxDisposable.distMod.AsyncDisposable = js.native
    /**
    ...
    def from(
      resources: js.Iterable[
          js.UndefOr[typingsSlinky.atEsfxDisposable.distMod.AsyncDisposable | Disposable | Null]
        ]
    ): typingsSlinky.atEsfxDisposable.distMod.AsyncDisposable = js.native
    /**
    ...
    /**
      ...
      */
    def use[U](
      resource: typingsSlinky.atEsfxDisposable.distMod.AsyncDisposable,
  ...
  object Disposable extends js.Object {
    ...
    val name: typingsSlinky.atEsfxDisposable.atEsfxDisposableStrings.Disposable = js.native
    /**
      * Creates a `Disposable` wrapper around a callback used to dispose of a resource.
      */
    def create(dispose: js.Function0[Unit]): typingsSlinky.atEsfxDisposable.distMod.Disposable = js.native
    /**
      * Creates a `Disposable` wrapper around a set of other disposables.
      * @param disposables An `Iterable` of `Disposable` objects.
      */
    def from(disposables: js.Iterable[js.UndefOr[typingsSlinky.atEsfxDisposable.distMod.Disposable | Null]]): typingsSlinky.atEsfxDisposable.distMod.Disposable = js.native
    /**
    ...
    /**
      ...
      */
    def use[U](
      resource: typingsSlinky.atEsfxDisposable.distMod.Disposable,
      callback: js.Function1[/* resource */ typingsSlinky.atEsfxDisposable.distMod.Disposable, U]
    ): U = js.native
  }
