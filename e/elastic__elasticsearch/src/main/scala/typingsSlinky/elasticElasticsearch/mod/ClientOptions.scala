...
object ClientOptions {
  ...
  implicit class ClientOptionsOps[Self <: ClientOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNodeFilter(value: /* connection */ typingsSlinky.elasticElasticsearch.connectionMod.default => Boolean): Self = this.set("nodeFilter", js.Any.fromFunction1(value))
