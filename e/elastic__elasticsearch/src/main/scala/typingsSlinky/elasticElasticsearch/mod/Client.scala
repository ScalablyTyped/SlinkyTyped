...
import typingsSlinky.elasticElasticsearch.anon.Bulk
...
import typingsSlinky.elasticElasticsearch.anon.GetAutoscalingDecision
import typingsSlinky.elasticElasticsearch.anon.HotThreads
import typingsSlinky.elasticElasticsearch.anon.Info
...
class Client () extends EventEmitter {
  ...
  def bulk[TResponse, TRequestBody /* <: RequestNDBody[js.Array[Record[String, _]]] */, TContext](params: typingsSlinky.elasticElasticsearch.requestParamsMod.Bulk[TRequestBody]): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def bulk[TResponse, TRequestBody /* <: RequestNDBody[js.Array[Record[String, _]]] */, TContext](
    params: typingsSlinky.elasticElasticsearch.requestParamsMod.Bulk[TRequestBody],
  ...
  def get[TResponse, TContext](
    params: typingsSlinky.elasticElasticsearch.requestParamsMod.Get,
    callback: callbackFn[TResponse, TContext]
  ): TransportRequestCallback = js.native
  ...
  def info[TResponse, TContext](params: typingsSlinky.elasticElasticsearch.requestParamsMod.Info): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def info[TResponse, TContext](
    params: typingsSlinky.elasticElasticsearch.requestParamsMod.Info,
    callback: callbackFn[TResponse, TContext]
  ): TransportRequestCallback = js.native
  def info[TResponse, TContext](params: typingsSlinky.elasticElasticsearch.requestParamsMod.Info, options: TransportRequestOptions): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def info[TResponse, TContext](
    params: typingsSlinky.elasticElasticsearch.requestParamsMod.Info,
    options: TransportRequestOptions,
    callback: callbackFn[TResponse, TContext]
