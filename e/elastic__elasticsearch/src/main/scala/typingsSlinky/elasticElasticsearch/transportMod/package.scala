...
package object transportMod {
  ...
  typingsSlinky.elasticElasticsearch.transportMod.Context]
  */
  type ApiError = typingsSlinky.elasticElasticsearch.transportMod._ApiError | (typingsSlinky.elasticElasticsearch.errorsMod.ConnectionError[
    typingsSlinky.std.Record[java.lang.String, js.Any], 
    typingsSlinky.elasticElasticsearch.transportMod.Context
  ]) | (typingsSlinky.elasticElasticsearch.errorsMod.NoLivingConnectionsError[
    typingsSlinky.std.Record[java.lang.String, js.Any], 
  ...
  type Context = (typingsSlinky.std.Record[java.lang.String, js.Any]) | scala.Null
