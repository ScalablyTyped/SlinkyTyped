...
import typingsSlinky.elasticElasticsearch.errorsMod.ConnectionError
import typingsSlinky.elasticElasticsearch.errorsMod.NoLivingConnectionsError
import typingsSlinky.elasticElasticsearch.errorsMod.RequestAbortedError
import typingsSlinky.elasticElasticsearch.errorsMod.ResponseError
import typingsSlinky.elasticElasticsearch.errorsMod.TimeoutError
...
object transportMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.elasticElasticsearch.errorsMod.ConnectionError[
  typingsSlinky.std.Record[java.lang.String, js.Any], 
  typingsSlinky.elasticElasticsearch.transportMod.Context]
    ...
    - typingsSlinky.elasticElasticsearch.errorsMod.NoLivingConnectionsError[
  typingsSlinky.std.Record[java.lang.String, js.Any], 
  typingsSlinky.elasticElasticsearch.transportMod.Context]
    - typingsSlinky.elasticElasticsearch.errorsMod.ResponseError[
  typingsSlinky.std.Record[java.lang.String, js.Any], 
  typingsSlinky.elasticElasticsearch.transportMod.Context]
    - typingsSlinky.elasticElasticsearch.errorsMod.TimeoutError[
  typingsSlinky.std.Record[java.lang.String, js.Any], 
  typingsSlinky.elasticElasticsearch.transportMod.Context]
    - typingsSlinky.elasticElasticsearch.errorsMod.RequestAbortedError[
  typingsSlinky.std.Record[java.lang.String, js.Any], 
  typingsSlinky.elasticElasticsearch.transportMod.Context]
  */
  ...
  type nodeFilterFn = js.Function1[/* connection */ typingsSlinky.elasticElasticsearch.connectionMod.default, Boolean]
