...
object SnapshotCleanupRepository {
  @scala.inline
  def apply[T](repository: String): SnapshotCleanupRepository[T] = {
    val __obj = js.Dynamic.literal(repository = repository.asInstanceOf[js.Any])
    __obj.asInstanceOf[SnapshotCleanupRepository[T]]
  }
  @scala.inline
  implicit class SnapshotCleanupRepositoryOps[Self[t] <: SnapshotCleanupRepository[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
