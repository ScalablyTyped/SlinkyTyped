...
@js.native
trait SearchableSnapshotsClearCache extends Generic {
...
object SearchableSnapshotsClearCache {
  @scala.inline
  def apply(): SearchableSnapshotsClearCache = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SearchableSnapshotsClearCache]
  }
  @scala.inline
  implicit class SearchableSnapshotsClearCacheOps[Self <: SearchableSnapshotsClearCache] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setExpand_wildcards(value: open | closed | none | all): Self = this.set("expand_wildcards", value.asInstanceOf[js.Any])
    @scala.inline
