...
object MlGetRecords {
  ...
  @scala.inline
  implicit class MlGetRecordsOps[Self[t] <: MlGetRecords[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRecord_score(value: Double): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("record_score")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRecord_score: Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("record_score")(js.undefined)
        ret
    }
    @scala.inline
