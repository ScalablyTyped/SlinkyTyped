...
object MlGetTrainedModels {
  ...
  def apply(
    ...
    if (!js.isUndefined(decompress_definition)) __obj.updateDynamic("decompress_definition")(decompress_definition.asInstanceOf[js.Any])
    if (!js.isUndefined(error_trace)) __obj.updateDynamic("error_trace")(error_trace.asInstanceOf[js.Any])
    if (filter_path != null) __obj.updateDynamic("filter_path")(filter_path.asInstanceOf[js.Any])
    if (from != null) __obj.updateDynamic("from")(from.asInstanceOf[js.Any])
    if (!js.isUndefined(human)) __obj.updateDynamic("human")(human.asInstanceOf[js.Any])
    if (ignore != null) __obj.updateDynamic("ignore")(ignore.asInstanceOf[js.Any])
    if (!js.isUndefined(include_model_definition)) __obj.updateDynamic("include_model_definition")(include_model_definition.asInstanceOf[js.Any])
