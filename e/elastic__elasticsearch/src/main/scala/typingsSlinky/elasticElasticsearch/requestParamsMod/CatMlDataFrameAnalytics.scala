...
object CatMlDataFrameAnalytics {
  ...
  @scala.inline
  def apply(): CatMlDataFrameAnalytics = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CatMlDataFrameAnalytics]
  }
  
  @scala.inline
  implicit class CatMlDataFrameAnalyticsMutableBuilder[Self <: CatMlDataFrameAnalytics] (val x: Self) extends AnyVal {
