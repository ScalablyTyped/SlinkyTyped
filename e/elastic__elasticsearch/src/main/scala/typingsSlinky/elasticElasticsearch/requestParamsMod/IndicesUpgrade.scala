...
object IndicesUpgrade {
  ...
  implicit class IndicesUpgradeOps[Self <: IndicesUpgrade] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnly_ancient_segments(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("only_ancient_segments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOnly_ancient_segments: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("only_ancient_segments")(js.undefined)
        ret
    }
    @scala.inline
