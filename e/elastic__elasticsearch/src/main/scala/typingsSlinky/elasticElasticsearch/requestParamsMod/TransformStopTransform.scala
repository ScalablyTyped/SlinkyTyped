...
object TransformStopTransform {
  ...
  def apply(
    ...
    source: String = null,
    timeout: String = null,
    wait_for_checkpoint: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(wait_for_checkpoint)) __obj.updateDynamic("wait_for_checkpoint")(wait_for_checkpoint.get.asInstanceOf[js.Any])
