...
object IndicesFlush {
  ...
  implicit class IndicesFlushOps[Self <: IndicesFlush] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWait_if_ongoing(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("wait_if_ongoing")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWait_if_ongoing: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("wait_if_ongoing")(js.undefined)
        ret
    }
  }
