...
object CatNodes {
  ...
  implicit class CatNodesOps[Self <: CatNodes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFull_id(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("full_id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFull_id: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("full_id")(js.undefined)
        ret
    }
    @scala.inline
