...
object CatNodes {
  ...
  @scala.inline
  implicit class CatNodesMutableBuilder[Self <: CatNodes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFull_id(value: Boolean): Self = StObject.set(x, "full_id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFull_idUndefined: Self = StObject.set(x, "full_id", js.undefined)
