...
object LicenseGet {
  ...
  implicit class LicenseGetOps[Self <: LicenseGet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAccept_enterprise(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accept_enterprise")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAccept_enterprise: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("accept_enterprise")(js.undefined)
        ret
    }
    @scala.inline
