...
trait CloseJob extends js.Object {
  ...
  def stopDatafeed[TResponse, TContext](): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stopDatafeed[TResponse, TContext](callback: callbackFn[TResponse, TContext]): TransportRequestCallback = js.native
  def stopDatafeed[TResponse, TContext](params: js.UndefOr[scala.Nothing], options: TransportRequestOptions): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stopDatafeed[TResponse, TContext](params: MlStopDatafeed): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stopDatafeed[TResponse, TContext](params: MlStopDatafeed, callback: callbackFn[TResponse, TContext]): TransportRequestCallback = js.native
  def stopDatafeed[TResponse, TContext](params: MlStopDatafeed, options: TransportRequestOptions): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stopDatafeed[TResponse, TContext](
    params: MlStopDatafeed,
    options: TransportRequestOptions,
    callback: callbackFn[TResponse, TContext]
  ): TransportRequestCallback = js.native
  ...
  def stop_datafeed[TResponse, TContext](): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stop_datafeed[TResponse, TContext](callback: callbackFn[TResponse, TContext]): TransportRequestCallback = js.native
  def stop_datafeed[TResponse, TContext](params: js.UndefOr[scala.Nothing], options: TransportRequestOptions): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stop_datafeed[TResponse, TContext](params: MlStopDatafeed): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stop_datafeed[TResponse, TContext](params: MlStopDatafeed, callback: callbackFn[TResponse, TContext]): TransportRequestCallback = js.native
  def stop_datafeed[TResponse, TContext](params: MlStopDatafeed, options: TransportRequestOptions): TransportRequestPromise[ApiResponse[TResponse, TContext]] = js.native
  def stop_datafeed[TResponse, TContext](
    params: MlStopDatafeed,
    options: TransportRequestOptions,
    callback: callbackFn[TResponse, TContext]
  ): TransportRequestCallback = js.native
