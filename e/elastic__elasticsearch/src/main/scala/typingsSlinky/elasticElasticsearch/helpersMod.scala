...
import typingsSlinky.elasticElasticsearch.anon.Causedby
...
object helpersMod {
  ...
  */
  ...
  object _Action {
    ...
    @scala.inline
    def CreateAction(create: Dictkey): typingsSlinky.elasticElasticsearch.helpersMod.CreateAction = {
      val __obj = js.Dynamic.literal(create = create.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.elasticElasticsearch.helpersMod.CreateAction]
    }
    
    @scala.inline
    def DeleteAction(delete: Dictkey): typingsSlinky.elasticElasticsearch.helpersMod.DeleteAction = {
      val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.elasticElasticsearch.helpersMod.DeleteAction]
    }
    
    @scala.inline
    def IndexAction(index: Dictkey): typingsSlinky.elasticElasticsearch.helpersMod.IndexAction = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.elasticElasticsearch.helpersMod.IndexAction]
    }
  }
