...
import typingsSlinky.atElasticElasticsearch.atElasticElasticsearchStrings.cluster
import typingsSlinky.atElasticElasticsearch.atElasticElasticsearchStrings.indices
...
import typingsSlinky.atElasticElasticsearch.atElasticElasticsearchStrings.shards
