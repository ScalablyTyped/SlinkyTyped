...
import typingsSlinky.atElasticElasticsearch.atElasticElasticsearchBooleans.`false`
...
trait Transport extends js.Object {
  ...
  def getConnection(opts: TransportGetConnectionOptions): typingsSlinky.atElasticElasticsearch.libConnectionMod.default | Null = js.native
