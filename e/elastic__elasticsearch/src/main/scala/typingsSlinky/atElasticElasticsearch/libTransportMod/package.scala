...
package object libTransportMod {
  ...
  type nodeFilterFn = js.Function1[
    /* connection */ typingsSlinky.atElasticElasticsearch.libConnectionMod.default, 
    Boolean
  ]
  type nodeSelectorFn = js.Function1[
    /* connections */ js.Array[typingsSlinky.atElasticElasticsearch.libConnectionMod.default], 
    typingsSlinky.atElasticElasticsearch.libConnectionMod.default
  ]
