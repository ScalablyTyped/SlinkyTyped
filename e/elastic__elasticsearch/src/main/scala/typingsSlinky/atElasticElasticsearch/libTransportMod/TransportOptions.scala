package typingsSlinky.atElasticElasticsearch.libTransportMod

import typingsSlinky.atElasticElasticsearch.atElasticElasticsearchStrings.gzip
import typingsSlinky.atElasticElasticsearch.libPoolMod.CloudConnectionPool
import typingsSlinky.atElasticElasticsearch.libPoolMod.ConnectionPool
...
trait TransportOptions extends js.Object {
  ...
  var serializer: typingsSlinky.atElasticElasticsearch.libSerializerMod.default = js.native
