...
import typingsSlinky.emscripten.FS.FSNode
import typingsSlinky.emscripten.FS.FSStream
...
object global extends js.Object {
  ...
  def allocate(slab: js.typedarray.ArrayBufferView, types: js.Array[CType], allocator: Double): Double = js.native
  def allocate(slab: js.typedarray.ArrayBufferView, types: js.Array[CType], allocator: Double, ptr: Double): Double = js.native
  def allocate(slab: js.typedarray.ArrayBufferView, types: CType, allocator: Double): Double = js.native
  def allocate(slab: js.typedarray.ArrayBufferView, types: CType, allocator: Double, ptr: Double): Double = js.native
