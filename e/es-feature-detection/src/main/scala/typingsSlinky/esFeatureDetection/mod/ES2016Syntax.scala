...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.esFeatureDetection.esFeatureDetectionStrings.`Exponentiation operator`
  - typingsSlinky.esFeatureDetection.esFeatureDetectionStrings.`Rest destructuring`
*/
