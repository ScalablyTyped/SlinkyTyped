...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.esFeatureDetection.esFeatureDetectionStrings.__all
  - typingsSlinky.esFeatureDetection.esFeatureDetectionStrings.ArrayDotprototypeDotincludes
  - typingsSlinky.esFeatureDetection.esFeatureDetectionStrings.TypedArrayDotprototypeDotincludes
*/
