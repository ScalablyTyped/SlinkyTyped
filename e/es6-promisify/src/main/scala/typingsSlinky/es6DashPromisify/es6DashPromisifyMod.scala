package typingsSlinky.es6DashPromisify

import typingsSlinky.es6DashPromisify.es6DashPromisifyMod.Callback
import typingsSlinky.es6DashPromisify.es6DashPromisifyMod.CallbackFunction
import typingsSlinky.es6DashPromisify.es6DashPromisifyMod.PromiseFunction
