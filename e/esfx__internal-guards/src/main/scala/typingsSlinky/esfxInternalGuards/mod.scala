package typingsSlinky.esfxInternalGuards

import typingsSlinky.esfxTypeModel.distMod.AbstractConstructor
import typingsSlinky.esfxTypeModel.distMod.Constructor
...
object mod {
  ...
  @js.native
  def isInstance[C /* <: AbstractConstructor[js.Object] */](value: js.Any, ctor: C): Boolean = js.native
  @JSImport("@esfx/internal-guards", "isInstance")
  @js.native
  def isInstance_C_ConstructorObjectArrayWildcard[C /* <: Constructor[js.Object, js.Array[_]] */](value: js.Any, ctor: C): /* is std.InstanceType<C> */ Boolean = js.native
