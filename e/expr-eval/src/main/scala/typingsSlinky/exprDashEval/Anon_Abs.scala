package typingsSlinky.exprDashEval
...
object Anon_Abs {
  ...
  def apply(
    ...
    if (!js.isUndefined(abs)) __obj.updateDynamic("abs")(abs.asInstanceOf[js.Any])
    if (!js.isUndefined(acos)) __obj.updateDynamic("acos")(acos.asInstanceOf[js.Any])
    if (!js.isUndefined(acosh)) __obj.updateDynamic("acosh")(acosh.asInstanceOf[js.Any])
    if (!js.isUndefined(add)) __obj.updateDynamic("add")(add.asInstanceOf[js.Any])
    if (!js.isUndefined(asin)) __obj.updateDynamic("asin")(asin.asInstanceOf[js.Any])
    if (!js.isUndefined(asinh)) __obj.updateDynamic("asinh")(asinh.asInstanceOf[js.Any])
    if (!js.isUndefined(assignment)) __obj.updateDynamic("assignment")(assignment.asInstanceOf[js.Any])
    if (!js.isUndefined(atan)) __obj.updateDynamic("atan")(atan.asInstanceOf[js.Any])
    if (!js.isUndefined(atanh)) __obj.updateDynamic("atanh")(atanh.asInstanceOf[js.Any])
    if (!js.isUndefined(cbrt)) __obj.updateDynamic("cbrt")(cbrt.asInstanceOf[js.Any])
    if (!js.isUndefined(ceil)) __obj.updateDynamic("ceil")(ceil.asInstanceOf[js.Any])
    if (!js.isUndefined(comparison)) __obj.updateDynamic("comparison")(comparison.asInstanceOf[js.Any])
    if (!js.isUndefined(concatenate)) __obj.updateDynamic("concatenate")(concatenate.asInstanceOf[js.Any])
    if (!js.isUndefined(conditional)) __obj.updateDynamic("conditional")(conditional.asInstanceOf[js.Any])
    if (!js.isUndefined(cos)) __obj.updateDynamic("cos")(cos.asInstanceOf[js.Any])
    if (!js.isUndefined(cosh)) __obj.updateDynamic("cosh")(cosh.asInstanceOf[js.Any])
    if (!js.isUndefined(divide)) __obj.updateDynamic("divide")(divide.asInstanceOf[js.Any])
    if (!js.isUndefined(exp)) __obj.updateDynamic("exp")(exp.asInstanceOf[js.Any])
    if (!js.isUndefined(expm1)) __obj.updateDynamic("expm1")(expm1.asInstanceOf[js.Any])
    if (!js.isUndefined(factorial)) __obj.updateDynamic("factorial")(factorial.asInstanceOf[js.Any])
    if (!js.isUndefined(floor)) __obj.updateDynamic("floor")(floor.asInstanceOf[js.Any])
    if (!js.isUndefined(fndef)) __obj.updateDynamic("fndef")(fndef.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(ln)) __obj.updateDynamic("ln")(ln.asInstanceOf[js.Any])
    if (!js.isUndefined(log)) __obj.updateDynamic("log")(log.asInstanceOf[js.Any])
    if (!js.isUndefined(log10)) __obj.updateDynamic("log10")(log10.asInstanceOf[js.Any])
    if (!js.isUndefined(log1p)) __obj.updateDynamic("log1p")(log1p.asInstanceOf[js.Any])
    if (!js.isUndefined(log2)) __obj.updateDynamic("log2")(log2.asInstanceOf[js.Any])
    if (!js.isUndefined(logical)) __obj.updateDynamic("logical")(logical.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(multiply)) __obj.updateDynamic("multiply")(multiply.asInstanceOf[js.Any])
    if (!js.isUndefined(power)) __obj.updateDynamic("power")(power.asInstanceOf[js.Any])
    if (!js.isUndefined(random)) __obj.updateDynamic("random")(random.asInstanceOf[js.Any])
    if (!js.isUndefined(remainder)) __obj.updateDynamic("remainder")(remainder.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sin)) __obj.updateDynamic("sin")(sin.asInstanceOf[js.Any])
    if (!js.isUndefined(sinh)) __obj.updateDynamic("sinh")(sinh.asInstanceOf[js.Any])
    if (!js.isUndefined(sqrt)) __obj.updateDynamic("sqrt")(sqrt.asInstanceOf[js.Any])
    if (!js.isUndefined(subtract)) __obj.updateDynamic("subtract")(subtract.asInstanceOf[js.Any])
    if (!js.isUndefined(tan)) __obj.updateDynamic("tan")(tan.asInstanceOf[js.Any])
    if (!js.isUndefined(tanh)) __obj.updateDynamic("tanh")(tanh.asInstanceOf[js.Any])
    if (!js.isUndefined(trunc)) __obj.updateDynamic("trunc")(trunc.asInstanceOf[js.Any])
