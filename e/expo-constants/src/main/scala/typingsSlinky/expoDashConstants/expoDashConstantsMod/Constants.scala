package typingsSlinky.expoDashConstants.expoDashConstantsMod
...
import typingsSlinky.expoDashConstants.buildConstantsDotTypesMod.PlatformManifest
import typingsSlinky.expoDashConstants.expoDashConstantsStrings.ExponentConstants
...
object Constants {
  @scala.inline
  def apply(
    appOwnership: typingsSlinky.expoDashConstants.buildConstantsDotTypesMod.AppOwnership,
    debugMode: Boolean,
