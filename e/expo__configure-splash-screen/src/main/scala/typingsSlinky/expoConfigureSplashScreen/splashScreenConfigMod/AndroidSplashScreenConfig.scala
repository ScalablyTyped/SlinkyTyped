package typingsSlinky.expoConfigureSplashScreen.splashScreenConfigMod

import typingsSlinky.colorString.mod.Color
import typingsSlinky.expoConfigureSplashScreen.anon.Image
import typingsSlinky.expoConfigureSplashScreen.anon.Style
