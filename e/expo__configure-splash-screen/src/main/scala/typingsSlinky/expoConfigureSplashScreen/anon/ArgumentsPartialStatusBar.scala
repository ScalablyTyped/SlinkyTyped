...
import typingsSlinky.expoConfigureSplashScreen.constantsMod.StatusBarStyle
import typingsSlinky.expoConfigureSplashScreen.expoConfigureSplashScreenBooleans.`true`
...
trait ArgumentsPartialStatusBar extends js.Object {
  ...
  var resizeMode: typingsSlinky.expoConfigureSplashScreen.constantsMod.ResizeMode = js.native
...
object ArgumentsPartialStatusBar {
  ...
  def apply(
    ...
    resizeMode: typingsSlinky.expoConfigureSplashScreen.constantsMod.ResizeMode
  ...
  implicit class ArgumentsPartialStatusBarOps[Self <: ArgumentsPartialStatusBar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResizeMode(value: typingsSlinky.expoConfigureSplashScreen.constantsMod.ResizeMode): Self = this.set("resizeMode", value.asInstanceOf[js.Any])
    @scala.inline
