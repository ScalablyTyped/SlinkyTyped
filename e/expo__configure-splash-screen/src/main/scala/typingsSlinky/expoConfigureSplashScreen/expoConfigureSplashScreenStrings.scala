...
import typingsSlinky.expoConfigureSplashScreen.constantsMod.PlatformType
...
object expoConfigureSplashScreenStrings {
  ...
  @scala.inline
  def JsonShape: JsonShape = "JsonShape".asInstanceOf[JsonShape]
  ...
  @js.native
  sealed trait JsonShape extends js.Object
