...
import typingsSlinky.expoConfigureSplashScreen.anon.DeletionFlag
import typingsSlinky.expoConfigureSplashScreen.anon.DisregardComments
import typingsSlinky.expoConfigureSplashScreen.anon.Idx
...
object xmlManipulationMod {
  ...
  */
  ...
  object ExpectedElement {
    ...
    @scala.inline
    def ExpectedCommentType(comment: String): typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedCommentType = {
      val __obj = js.Dynamic.literal(comment = comment.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedCommentType]
    }
    
    @scala.inline
    def ExpectedElementType(name: String): typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedElementType = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedElementType]
    }
    
    @scala.inline
    def ExpectedElementsType(elements: ExpectedElements): typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedElementsType = {
      val __obj = js.Dynamic.literal(elements = elements.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedElementsType]
    }
    
    @scala.inline
    def ExpectedTextType(text: String | Double | Boolean): typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedTextType = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expoConfigureSplashScreen.xmlManipulationMod.ExpectedTextType]
    }
  }
