...
trait Attr extends Warning {
  ...
  var node: org.scalajs.dom.raw.Element = js.native
...
object Attr {
  ...
  @scala.inline
  def apply(attr: String, message: String, node: org.scalajs.dom.raw.Element, ruleId: String, `type`: attr): Attr = {
  ...
  implicit class AttrMutableBuilder[Self <: Attr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNode(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
