  ...
  object Options {
    ...
    object Options {
      ...
      def apply(
        ...
        wasm: Boolean
      ): typingsSlinky.esm.mod.Options.Options = {
        ...
        __obj.asInstanceOf[typingsSlinky.esm.mod.Options.Options]
      }
      
      @scala.inline
      implicit class OptionsMutableBuilder[Self <: typingsSlinky.esm.mod.Options.Options] (val x: Self) extends AnyVal {
