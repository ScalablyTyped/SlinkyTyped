...
@js.native
object dashPrivateRegistryDashProxyDashMixinMod extends js.Object {
  /**
  ...
  trait RegistryProxyMixin extends js.Object {
    ...
    def register(fullName: String, factory: js.Any, options: Anon_Instantiate): js.Any = js.native
    /**
  ...
  val default: typingsSlinky.atEmberObject.mixinMod.default[RegistryProxyMixin, typingsSlinky.atEmberObject.atEmberObjectMod.default] = js.native
}
