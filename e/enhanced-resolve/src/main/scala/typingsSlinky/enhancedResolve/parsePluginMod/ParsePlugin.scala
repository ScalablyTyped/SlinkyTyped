package typingsSlinky.enhancedResolve.parsePluginMod
...
object ParsePlugin {
  @scala.inline
  def apply(apply: typingsSlinky.enhancedResolve.resolverMod.^ => Unit, source: String, target: String): ParsePlugin = {
