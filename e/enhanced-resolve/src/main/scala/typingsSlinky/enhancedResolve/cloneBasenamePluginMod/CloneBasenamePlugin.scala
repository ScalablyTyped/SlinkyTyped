package typingsSlinky.enhancedResolve.cloneBasenamePluginMod
...
object CloneBasenamePlugin {
  @scala.inline
  def apply(apply: typingsSlinky.enhancedResolve.resolverMod.^ => Unit, source: String, target: String): CloneBasenamePlugin = {
  ...
  @scala.inline
  implicit class CloneBasenamePluginOps[Self <: CloneBasenamePlugin] (val x: Self) extends AnyVal {
    @scala.inline
