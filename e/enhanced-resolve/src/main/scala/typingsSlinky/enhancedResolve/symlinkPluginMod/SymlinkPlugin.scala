package typingsSlinky.enhancedResolve.symlinkPluginMod
...
object SymlinkPlugin {
  ...
  @scala.inline
  def apply(apply: typingsSlinky.enhancedResolve.resolverMod.^ => Unit, source: String, target: String): SymlinkPlugin = {
