package typingsSlinky.enhancedResolve.joinRequestPluginMod
...
object JoinRequestPlugin {
  @scala.inline
  def apply(apply: typingsSlinky.enhancedResolve.resolverMod.^ => Unit, source: String, target: String): JoinRequestPlugin = {
  ...
  @scala.inline
  implicit class JoinRequestPluginOps[Self <: JoinRequestPlugin] (val x: Self) extends AnyVal {
    @scala.inline
