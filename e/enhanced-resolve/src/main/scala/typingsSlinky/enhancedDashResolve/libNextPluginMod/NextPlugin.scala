package typingsSlinky.enhancedDashResolve.libNextPluginMod
...
object NextPlugin {
  @scala.inline
  def apply(apply: typingsSlinky.enhancedDashResolve.libResolverMod.^ => Unit, source: String, target: String): NextPlugin = {
