package typingsSlinky.enhancedDashResolve.libParsePluginMod
...
object ParsePlugin {
  @scala.inline
  def apply(apply: typingsSlinky.enhancedDashResolve.libResolverMod.^ => Unit, source: String, target: String): ParsePlugin = {
