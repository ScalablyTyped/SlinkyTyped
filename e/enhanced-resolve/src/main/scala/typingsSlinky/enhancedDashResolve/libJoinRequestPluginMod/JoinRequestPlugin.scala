package typingsSlinky.enhancedDashResolve.libJoinRequestPluginMod
...
object JoinRequestPlugin {
  @scala.inline
  def apply(apply: typingsSlinky.enhancedDashResolve.libResolverMod.^ => Unit, source: String, target: String): JoinRequestPlugin = {
