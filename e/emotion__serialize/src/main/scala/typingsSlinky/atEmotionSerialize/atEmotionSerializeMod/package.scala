...
package object atEmotionSerializeMod {
  import typingsSlinky.atEmotionSerialize.Anon_Anim
  import typingsSlinky.atEmotionSerialize.typesHelperMod.Equal
  ...
  */
  ...
  {[ K in keyof @emotion/serialize.@emotion/serialize.CSSProperties ]: @emotion/serialize.@emotion/serialize.CSSProperties[K] | std.Array<std.Extract<@emotion/serialize.@emotion/serialize.CSSProperties[K], string>>}
    */ typingsSlinky.atEmotionSerialize.atEmotionSerializeStrings.CSSPropertiesWithMultiValues with js.Any
  ...
  {[ K in csstype.csstype.Pseudos ]:? @emotion/serialize.@emotion/serialize.ObjectInterpolation<MP>}
    */ typingsSlinky.atEmotionSerialize.atEmotionSerializeStrings.CSSPseudos with js.Any
  ...
  {[ K in csstype.csstype.Pseudos ]:? @emotion/serialize.@emotion/serialize.CSSObject}
    */ typingsSlinky.atEmotionSerialize.atEmotionSerializeStrings.CSSPseudosForCSSObject with js.Any
  /* Rewritten from type alias, can be one of: 
    - scala.Null
    - `js.undefined`
    - scala.Boolean
