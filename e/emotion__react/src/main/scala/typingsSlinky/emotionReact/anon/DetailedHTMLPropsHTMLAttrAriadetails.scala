...
@js.native
trait DetailedHTMLPropsHTMLAttrAriadetails extends js.Object {
...
object DetailedHTMLPropsHTMLAttrAriadetails {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrAriadetailsOps[Self <: DetailedHTMLPropsHTMLAttrAriadetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLHRElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLHRElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: LegacyRef[HTMLHRElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
