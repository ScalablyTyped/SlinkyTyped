...
@js.native
trait DetailedHTMLPropsFormHTML extends js.Object {
...
object DetailedHTMLPropsFormHTML {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsFormHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsFormHTML]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsFormHTMLOps[Self <: DetailedHTMLPropsFormHTML] (val x: Self) extends AnyVal {
