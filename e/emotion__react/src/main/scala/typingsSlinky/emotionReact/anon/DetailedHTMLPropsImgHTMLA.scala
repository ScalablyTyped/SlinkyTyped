...
import typingsSlinky.emotionReact.emotionReactStrings.async
...
import typingsSlinky.emotionReact.emotionReactStrings.sync
...
object DetailedHTMLPropsImgHTMLA {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsImgHTMLA = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsImgHTMLA]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsImgHTMLAMutableBuilder[Self <: DetailedHTMLPropsImgHTMLA] (val x: Self) extends AnyVal {
