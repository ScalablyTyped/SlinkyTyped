...
@js.native
trait SVGPropsSVGSVGElementcssI extends js.Object {
...
object SVGPropsSVGSVGElementcssI {
  ...
  @scala.inline
  def apply(): SVGPropsSVGSVGElementcssI = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGPropsSVGSVGElementcssI]
  }
  
  @scala.inline
  implicit class SVGPropsSVGSVGElementcssIOps[Self <: SVGPropsSVGSVGElementcssI] (val x: Self) extends AnyVal {
