...
/* Inlined react.react.DetailedHTMLProps<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, std.HTMLTextAreaElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
...
object DetailedHTMLPropsTextarea {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsTextarea = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsTextarea]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsTextareaMutableBuilder[Self <: DetailedHTMLPropsTextarea] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: LegacyRef[HTMLTextAreaElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
