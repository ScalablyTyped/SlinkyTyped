...
object DetailedHTMLPropsSelectHT {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsSelectHTMutableBuilder[Self <: DetailedHTMLPropsSelectHT] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: LegacyRef[HTMLSelectElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLSelectElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRefNull: Self = StObject.set(x, "ref", null)
    
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLSelectElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
