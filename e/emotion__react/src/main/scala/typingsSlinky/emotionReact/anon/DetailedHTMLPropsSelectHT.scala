...
/* Inlined react.react.DetailedHTMLProps<react.react.SelectHTMLAttributes<std.HTMLSelectElement>, std.HTMLSelectElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsSelectHT extends js.Object {
  ...
  var ref: js.UndefOr[LegacyRef[HTMLSelectElement]] = js.native
...
object DetailedHTMLPropsSelectHT {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsSelectHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsSelectHT]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsSelectHTOps[Self <: DetailedHTMLPropsSelectHT] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLSelectElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLSelectElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: LegacyRef[HTMLSelectElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
