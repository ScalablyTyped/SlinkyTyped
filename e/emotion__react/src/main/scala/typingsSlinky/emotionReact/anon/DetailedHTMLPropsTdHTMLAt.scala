...
import typingsSlinky.emotionReact.emotionReactStrings.bottom
...
import typingsSlinky.emotionReact.emotionReactStrings.top
...
/* Inlined react.react.DetailedHTMLProps<react.react.TdHTMLAttributes<std.HTMLTableDataCellElement>, std.HTMLTableDataCellElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
...
object DetailedHTMLPropsTdHTMLAt {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsTdHTMLAt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsTdHTMLAt]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsTdHTMLAtMutableBuilder[Self <: DetailedHTMLPropsTdHTMLAt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with HTMLTableDataCellElement, Event] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLTableDataCellElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
