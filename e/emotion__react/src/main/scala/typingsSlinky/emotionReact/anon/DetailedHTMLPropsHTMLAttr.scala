...
object DetailedHTMLPropsHTMLAttr {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrOps[Self <: DetailedHTMLPropsHTMLAttr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLTableSectionElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLTableSectionElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: LegacyRef[HTMLTableSectionElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
