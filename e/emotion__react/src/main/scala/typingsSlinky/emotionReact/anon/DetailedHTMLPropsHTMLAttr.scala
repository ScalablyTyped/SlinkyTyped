...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLTableSectionElement>, std.HTMLTableSectionElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsHTMLAttr extends StObject {
  ...
  var ref: js.UndefOr[LegacyRef[HTMLTableSectionElement]] = js.native
...
object DetailedHTMLPropsHTMLAttr {
  
  @scala.inline
  def apply(): DetailedHTMLPropsHTMLAttr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttr]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrMutableBuilder[Self <: DetailedHTMLPropsHTMLAttr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: LegacyRef[HTMLTableSectionElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLTableSectionElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRefNull: Self = StObject.set(x, "ref", null)
    
    @scala.inline
    def setRefRefObject(value: ReactRef[HTMLTableSectionElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
