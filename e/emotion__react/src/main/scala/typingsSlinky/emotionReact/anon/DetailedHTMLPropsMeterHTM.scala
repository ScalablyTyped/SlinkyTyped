...
@js.native
trait DetailedHTMLPropsMeterHTM extends StObject {
...
object DetailedHTMLPropsMeterHTM {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsMeterHTMMutableBuilder[Self <: DetailedHTMLPropsMeterHTM] (val x: Self) extends AnyVal {
