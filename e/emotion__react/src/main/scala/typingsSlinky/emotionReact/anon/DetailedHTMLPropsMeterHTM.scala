...
/* Inlined react.react.DetailedHTMLProps<react.react.MeterHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsMeterHTM extends js.Object {
...
object DetailedHTMLPropsMeterHTM {
  
  @scala.inline
  def apply(): DetailedHTMLPropsMeterHTM = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsMeterHTM]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsMeterHTMOps[Self <: DetailedHTMLPropsMeterHTM] (val x: Self) extends AnyVal {
