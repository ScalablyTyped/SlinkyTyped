...
@js.native
trait DetailedHTMLPropsButtonHT extends StObject {
...
object DetailedHTMLPropsButtonHT {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsButtonHTMutableBuilder[Self <: DetailedHTMLPropsButtonHT] (val x: Self) extends AnyVal {
