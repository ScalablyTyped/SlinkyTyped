...
import typingsSlinky.emotionReact.emotionReactStrings.button
...
import typingsSlinky.emotionReact.emotionReactStrings.reset
...
import typingsSlinky.emotionReact.emotionReactStrings.submit
...
/* Inlined react.react.DetailedHTMLProps<react.react.ButtonHTMLAttributes<std.HTMLButtonElement>, std.HTMLButtonElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsButtonHT extends js.Object {
...
object DetailedHTMLPropsButtonHT {
  
  @scala.inline
  def apply(): DetailedHTMLPropsButtonHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsButtonHT]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsButtonHTOps[Self <: DetailedHTMLPropsButtonHT] (val x: Self) extends AnyVal {
