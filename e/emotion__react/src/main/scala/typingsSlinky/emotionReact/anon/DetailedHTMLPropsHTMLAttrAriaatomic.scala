...
@js.native
trait DetailedHTMLPropsHTMLAttrAriaatomic extends StObject {
...
object DetailedHTMLPropsHTMLAttrAriaatomic {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrAriaatomicMutableBuilder[Self <: DetailedHTMLPropsHTMLAttrAriaatomic] (val x: Self) extends AnyVal {
