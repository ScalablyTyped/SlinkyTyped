...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsHTMLAttrAriaatomic extends js.Object {
...
object DetailedHTMLPropsHTMLAttrAriaatomic {
  
  @scala.inline
  def apply(): DetailedHTMLPropsHTMLAttrAriaatomic = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAriaatomic]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrAriaatomicOps[Self <: DetailedHTMLPropsHTMLAttrAriaatomic] (val x: Self) extends AnyVal {
