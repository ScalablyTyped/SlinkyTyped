...
@js.native
trait DetailedHTMLPropsHTMLAttrAriacurrent extends js.Object {
...
object DetailedHTMLPropsHTMLAttrAriacurrent {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsHTMLAttrAriacurrent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAriacurrent]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrAriacurrentOps[Self <: DetailedHTMLPropsHTMLAttrAriacurrent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: LegacyRef[HTMLSpanElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
