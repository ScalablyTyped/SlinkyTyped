...
import typingsSlinky.elasticApmNode.mod.AgentConfigOptions
import typingsSlinky.elasticApmNode.mod.AwsLambda.Handler
import typingsSlinky.elasticApmNode.mod.CaptureErrorCallback
import typingsSlinky.elasticApmNode.mod.CaptureErrorOptions
import typingsSlinky.elasticApmNode.mod.FilterFn
import typingsSlinky.elasticApmNode.mod.LabelValue
import typingsSlinky.elasticApmNode.mod.Labels
import typingsSlinky.elasticApmNode.mod.Logger
import typingsSlinky.elasticApmNode.mod.ParameterizedMessageObject
import typingsSlinky.elasticApmNode.mod.PatchHandler
import typingsSlinky.elasticApmNode.mod.Span
import typingsSlinky.elasticApmNode.mod.SpanOptions
import typingsSlinky.elasticApmNode.mod.Transaction
import typingsSlinky.elasticApmNode.mod.TransactionOptions
import typingsSlinky.elasticApmNode.mod.UserObject
