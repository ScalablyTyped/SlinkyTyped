package typingsSlinky.expressDashBunyanDashLogger.expressDashBunyanDashLoggerMod
...
- Dropped {[ P in keyof bunyan.bunyan.LoggerOptions ]:? bunyan.bunyan.LoggerOptions[P]} */ trait Options extends js.Object {
  ...
  var logger: js.UndefOr[typingsSlinky.bunyan.bunyanMod.^] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    levelFn: (/* status */ Double, /* err */ js.Error | Null, /* meta */ js.Any) => String = null,
    logger: typingsSlinky.bunyan.bunyanMod.^ = null,
