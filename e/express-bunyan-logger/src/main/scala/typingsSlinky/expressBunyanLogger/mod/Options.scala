...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLevelFn(value: (/* status */ Double, /* err */ js.Error | Null, /* meta */ js.Any) => String): Self = this.set("levelFn", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteLevelFn: Self = this.set("levelFn", js.undefined)
    
    @scala.inline
    def setLogger(value: typingsSlinky.bunyan.mod.^): Self = this.set("logger", value.asInstanceOf[js.Any])
