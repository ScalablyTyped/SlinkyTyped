package typingsSlinky.emberRouting.routeMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.emberRouting.anon.Outlet
import typingsSlinky.emberRouting.anon.QueryParams
import typingsSlinky.emberRouting.transitionMod.Transition
import typingsSlinky.emberRouting.typesMod.RenderOptions
import typingsSlinky.emberRouting.typesMod.RouteQueryParam
...
trait Route extends js.Object {
  ...
  /**
    ...
    */
  var controller: typingsSlinky.emberController.mod.default = js.native
  /**
  ...
  /**
    ...
    */
  def controllerFor(name: String): typingsSlinky.emberController.mod.default = js.native
  /**
  ...
  /**
    ...
    */
  def renderTemplate(controller: typingsSlinky.emberController.mod.default, model: js.Object): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def resetController(controller: typingsSlinky.emberController.mod.default, isExiting: Boolean, transition: js.Any): Unit = js.native
  /**
  ...
  /**
    ...
    * `_super`
    */
  def setupController(controller: typingsSlinky.emberController.mod.default, model: js.Object): Unit = js.native
  /**
