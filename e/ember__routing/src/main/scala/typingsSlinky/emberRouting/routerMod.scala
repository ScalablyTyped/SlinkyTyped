...
object routerMod {
  ...
  object emberServiceAugmentingMod {
    ...
    trait Registry extends StObject {
      ...
      var router: typingsSlinky.emberRouting.routerServiceMod.default = js.native
    }
    object Registry {
      
      @scala.inline
      def apply(router: typingsSlinky.emberRouting.routerServiceMod.default): Registry = {
      ...
      implicit class RegistryMutableBuilder[Self <: Registry] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setRouter(value: typingsSlinky.emberRouting.routerServiceMod.default): Self = StObject.set(x, "router", value.asInstanceOf[js.Any])
      }
    }
  }
}
