...
import typingsSlinky.ethereumjsTx.ethereumjsTxBooleans.`false`
import typingsSlinky.ethereumjsTx.ethereumjsTxBooleans.`true`
...
import typingsSlinky.ethereumjsTx.typesMod.TxData
