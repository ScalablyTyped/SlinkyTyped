...
class KeyPair protected () extends js.Object {
  def this(eddsa: typingsSlinky.elliptic.ellipticMod.eddsa, params: KeyPairOptions) = this()
...
object KeyPair extends js.Object {
  def fromPublic(eddsa: typingsSlinky.elliptic.ellipticMod.eddsa, pub: Bytes): KeyPair = js.native
  def fromSecret(eddsa: typingsSlinky.elliptic.ellipticMod.eddsa, secret: Bytes): KeyPair = js.native
}
