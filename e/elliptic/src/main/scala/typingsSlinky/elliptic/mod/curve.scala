...
import typingsSlinky.elliptic.mod.curve.short.ShortConf
import typingsSlinky.elliptic.mod.curve.short.ShortPoint
  ...
  object edwards {
    ...
    object EdwardsConf {
      ...
      implicit class EdwardsConfMutableBuilder[Self <: EdwardsConf] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "c", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setDUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "d", value.asInstanceOf[js.Any])
  ...
  object short {
    ...
    object ShortConf {
      ...
      implicit class ShortConfMutableBuilder[Self <: ShortConf] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setBetaUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "beta", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setLambdaUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "lambda", value.asInstanceOf[js.Any])
