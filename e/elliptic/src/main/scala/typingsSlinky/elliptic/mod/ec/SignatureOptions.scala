...
object SignatureOptions {
  ...
  implicit class SignatureOptionsOps[Self <: SignatureOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRUint8Array(value: js.typedarray.Uint8Array): Self = this.set("r", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSUint8Array(value: js.typedarray.Uint8Array): Self = this.set("s", value.asInstanceOf[js.Any])
