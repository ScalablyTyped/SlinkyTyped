...
object ec {
  ...
  object SignatureOptions {
    ...
    implicit class SignatureOptionsMutableBuilder[Self <: SignatureOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "r", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "s", value.asInstanceOf[js.Any])
