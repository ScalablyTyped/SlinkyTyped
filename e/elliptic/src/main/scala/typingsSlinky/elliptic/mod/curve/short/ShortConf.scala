...
object ShortConf {
  ...
  implicit class ShortConfOps[Self <: ShortConf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBetaUint8Array(value: js.typedarray.Uint8Array): Self = this.set("beta", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLambdaUint8Array(value: js.typedarray.Uint8Array): Self = this.set("lambda", value.asInstanceOf[js.Any])
    @scala.inline
