...
import typingsSlinky.elliptic.AnonReason
...
object KeyPair extends js.Object {
  ...
  def fromPublic(ec: typingsSlinky.elliptic.mod.ec, pub: AnonX): KeyPair = js.native
  def fromPublic(ec: typingsSlinky.elliptic.mod.ec, pub: AnonX, enc: String): KeyPair = js.native
