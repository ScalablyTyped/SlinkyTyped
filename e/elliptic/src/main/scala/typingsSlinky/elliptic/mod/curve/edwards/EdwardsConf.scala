...
object EdwardsConf {
  ...
  implicit class EdwardsConfOps[Self <: EdwardsConf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCUint8Array(value: js.typedarray.Uint8Array): Self = this.set("c", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDUint8Array(value: js.typedarray.Uint8Array): Self = this.set("d", value.asInstanceOf[js.Any])
    @scala.inline
