package typingsSlinky.atEmberTemplate

import typingsSlinky.atEmberTemplate.dashPrivateHandlebarsMod.SafeString
...
@js.native
object atEmberTemplateMod extends js.Object {
