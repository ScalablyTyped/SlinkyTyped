...
object ExpressMinifyOptions {
  ...
  implicit class ExpressMinifyOptionsOps[Self <: ExpressMinifyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoffee_match(value: js.RegExp): Self = this.set("coffee_match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCoffee_match: Self = this.set("coffee_match", js.undefined)
    
    @scala.inline
    def setCss_match(value: js.RegExp): Self = this.set("css_match", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJs_match(value: js.RegExp): Self = this.set("js_match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteJs_match: Self = this.set("js_match", js.undefined)
    
    @scala.inline
    def setJson_match(value: js.RegExp): Self = this.set("json_match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteJson_match: Self = this.set("json_match", js.undefined)
    
    @scala.inline
    def setLess_match(value: js.RegExp): Self = this.set("less_match", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSass_match(value: js.RegExp): Self = this.set("sass_match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSass_match: Self = this.set("sass_match", js.undefined)
    
    @scala.inline
    def setStylus_match(value: js.RegExp): Self = this.set("stylus_match", value.asInstanceOf[js.Any])
