...
object ExpressMinifyInterfaces {
  ...
  object ExpressMinifyOptions {
    ...
    implicit class ExpressMinifyOptionsMutableBuilder[Self <: ExpressMinifyOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCoffee_match(value: js.RegExp): Self = StObject.set(x, "coffee_match", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCoffee_matchUndefined: Self = StObject.set(x, "coffee_match", js.undefined)
      
      @scala.inline
      def setCss_match(value: js.RegExp): Self = StObject.set(x, "css_match", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setJs_match(value: js.RegExp): Self = StObject.set(x, "js_match", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setJs_matchUndefined: Self = StObject.set(x, "js_match", js.undefined)
      
      @scala.inline
      def setJson_match(value: js.RegExp): Self = StObject.set(x, "json_match", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setJson_matchUndefined: Self = StObject.set(x, "json_match", js.undefined)
      
      @scala.inline
      def setLess_match(value: js.RegExp): Self = StObject.set(x, "less_match", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSass_match(value: js.RegExp): Self = StObject.set(x, "sass_match", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSass_matchUndefined: Self = StObject.set(x, "sass_match", js.undefined)
      
      @scala.inline
      def setStylus_match(value: js.RegExp): Self = StObject.set(x, "stylus_match", value.asInstanceOf[js.Any])
