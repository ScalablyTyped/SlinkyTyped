...
import typingsSlinky.ensureError.anon.Stack
...
object mod {
  ...
  */
  ...
  trait NonError extends Error {
    ...
    @JSName("name")
    var name_NonError: typingsSlinky.ensureError.ensureErrorStrings.NonError = js.native
  ...
  object NonError {
    ...
    @scala.inline
    def apply(message: String, name: typingsSlinky.ensureError.ensureErrorStrings.NonError, stack: String): NonError = {
    ...
    implicit class NonErrorMutableBuilder[Self <: NonError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.ensureError.ensureErrorStrings.NonError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
