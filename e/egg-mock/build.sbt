...
name := "egg-mock"
version := "3.x-dt-20200515Z-f68ad9"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20200515Z-3b3723",
  "org.scalablytyped.slinky" %%% "egg" % "2.27.0-f2ef56",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.4.2-187d1e",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.4-b42368",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.2-9f22ba",
  ...
  "org.scalablytyped.slinky" %%% "koa-router" % "7.4-dt-20200515Z-ef1596",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.36.1-820462")
