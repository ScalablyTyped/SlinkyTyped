...
name := "egg-mock"
version := "3.x-dt-20190327Z-7af84a"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20181116Z-709604",
  "org.scalablytyped.slinky" %%% "egg" % "2.25.0-f4107c",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.2.7-deb629",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.3-9666f4",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.1-5bc5cd",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.34.1-86fbe3")
