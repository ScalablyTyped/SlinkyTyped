...
name := "egg-mock"
version := "3.x-dt-20200304Z-15ca86"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20200225Z-472829",
  "org.scalablytyped.slinky" %%% "egg" % "2.26.0-48bab2",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.3.0-c6cfef",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.4-d3a185",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.1-fc52dc",
  ...
  "org.scalablytyped.slinky" %%% "koa-router" % "7.4-dt-20200226Z-6471e3",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.34.2-830746")
