...
name := "egg-mock"
version := "3.x-dt-20201028Z-2ee905"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20201002Z-e89281",
  "org.scalablytyped.slinky" %%% "egg" % "2.29.1-1f2450",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.4.2-dde7ba",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.20.0-009393",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.2-31cec0",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.36.1-e328e0")
