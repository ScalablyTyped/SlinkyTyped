...
name := "egg-mock"
version := "3.x-dt-20200304Z-90a72b"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20200225Z-870fbb",
  "org.scalablytyped.slinky" %%% "egg" % "2.26.0-55bf4c",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.3.0-7ef8a1",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.4-7e16ee",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.1-9907e1",
  ...
  "org.scalablytyped.slinky" %%% "koa-router" % "7.4-dt-20200226Z-6a4968",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.34.2-025011")
