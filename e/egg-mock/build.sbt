...
name := "egg-mock"
version := "3.x-dt-20190327Z-1b4439"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20181116Z-4a680c",
  "org.scalablytyped.slinky" %%% "egg" % "2.26.0-2fbc97",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.3.0-4b4747",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.4-bff37f",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.1-963567",
  ...
  "org.scalablytyped.slinky" %%% "koa-router" % "v7.x-dt-20191016Z-2e9bd3",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.34.1-18be51")
