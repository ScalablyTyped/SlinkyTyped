...
name := "egg-mock"
version := "3.x-dt-20200226Z-6ef2a6"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20200225Z-c5f4f6",
  "org.scalablytyped.slinky" %%% "egg" % "2.26.0-f75634",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.3.0-8f2e08",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.4-3b3ebc",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.1-9d3783",
  ...
  "org.scalablytyped.slinky" %%% "koa-router" % "7.4-dt-20200226Z-b03061",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.34.2-730d11")
