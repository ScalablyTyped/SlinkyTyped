...
name := "egg-mock"
version := "3.x-dt-20200515Z-e8b366"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "depd" % "1.1-dt-20200515Z-a4f1fe",
  "org.scalablytyped.slinky" %%% "egg" % "2.26.1-4e843d",
  "org.scalablytyped.slinky" %%% "egg-cookies" % "2.3.3-59be38",
  "org.scalablytyped.slinky" %%% "egg-core" % "4.17.4-bc452b",
  "org.scalablytyped.slinky" %%% "egg-logger" % "2.4.2-f2cfb5",
  ...
  "org.scalablytyped.slinky" %%% "koa-router" % "7.4-dt-20200515Z-90a3ee",
  ...
  "org.scalablytyped.slinky" %%% "urllib" % "2.35.0-5d2de3")
