...
trait JSXIdentifier extends BaseNode {
  var name: String
  @JSName("type")
  var type_JSXIdentifier: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXIdentifier
}
...
object JSXIdentifier {
  ...
  def apply(
    name: String,
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXIdentifier,
