...
trait JSXSpreadChild extends BaseNode {
  ...
  @JSName("type")
  var type_JSXSpreadChild: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXSpreadChild
}
...
object JSXSpreadChild {
  ...
  def apply(
    ...
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXSpreadChild,
