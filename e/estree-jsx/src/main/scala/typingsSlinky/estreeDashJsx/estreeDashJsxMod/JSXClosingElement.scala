...
trait JSXClosingElement extends JSXBoundaryElement {
  @JSName("type")
  var type_JSXClosingElement: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXClosingElement
}
...
object JSXClosingElement {
  ...
  def apply(
    ...
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXClosingElement,
