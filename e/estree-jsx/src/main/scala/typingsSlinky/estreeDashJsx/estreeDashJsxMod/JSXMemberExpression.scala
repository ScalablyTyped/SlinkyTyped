...
trait JSXMemberExpression extends BaseNode {
  @JSName("type")
  var type_JSXMemberExpression: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXMemberExpression
}

object JSXMemberExpression {
  @scala.inline
  def apply(
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXMemberExpression,
