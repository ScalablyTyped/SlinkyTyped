...
trait JSXOpeningFragment extends BaseNode {
  @JSName("type")
  var type_JSXOpeningFragment: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXOpeningFragment
}

object JSXOpeningFragment {
  @scala.inline
  def apply(
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXOpeningFragment,
