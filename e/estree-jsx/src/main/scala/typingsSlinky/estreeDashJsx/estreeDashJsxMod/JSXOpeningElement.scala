...
trait JSXOpeningElement extends JSXBoundaryElement {
  ...
  @JSName("type")
  var type_JSXOpeningElement: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXOpeningElement
}
...
object JSXOpeningElement {
  ...
  def apply(
    ...
    selfClosing: Boolean,
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXOpeningElement,
