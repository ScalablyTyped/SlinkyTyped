...
trait JSXNamespacedName extends BaseNode {
  @JSName("type")
  var type_JSXNamespacedName: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXNamespacedName
}

object JSXNamespacedName {
  @scala.inline
  def apply(
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXNamespacedName,
