...
trait JSXExpressionContainer extends BaseNode {
  ...
  @JSName("type")
  var type_JSXExpressionContainer: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXExpressionContainer
}
...
object JSXExpressionContainer {
  ...
  def apply(
    ...
    `type`: typingsSlinky.estreeDashJsx.estreeDashJsxStrings.JSXExpressionContainer,
