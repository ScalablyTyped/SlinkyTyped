...
trait JSXMemberExpression extends BaseNode {
  @JSName("type")
  var type_JSXMemberExpression: typingsSlinky.estreeJsx.estreeJsxStrings.JSXMemberExpression
}

object JSXMemberExpression {
  @scala.inline
  def apply(
    `type`: typingsSlinky.estreeJsx.estreeJsxStrings.JSXMemberExpression,
