...
trait JSXSpreadAttribute
  ...
  @JSName("type")
  var type_JSXSpreadAttribute: typingsSlinky.estreeJsx.estreeJsxStrings.JSXSpreadAttribute
}
...
object JSXSpreadAttribute {
  ...
  def apply(
    argument: Expression,
    `type`: typingsSlinky.estreeJsx.estreeJsxStrings.JSXSpreadAttribute,
