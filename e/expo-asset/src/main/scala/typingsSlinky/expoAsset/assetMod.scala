...
object assetMod {
  ...
  type AssetMetadata = typingsSlinky.expoAsset.assetSourcesMod.AssetMetadata
  ...
  object DownloadPromiseCallbacks {
    ...
    implicit class DownloadPromiseCallbacksMutableBuilder[Self <: DownloadPromiseCallbacks] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReject(value: js.Error => Unit): Self = StObject.set(x, "reject", js.Any.fromFunction1(value))
