...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSafeFileNamesRegExp(value: js.RegExp): Self = this.set("safeFileNames", value.asInstanceOf[js.Any])
    @scala.inline
    def setSafeFileNames(value: Boolean | js.RegExp): Self = this.set("safeFileNames", value.asInstanceOf[js.Any])
    @scala.inline
