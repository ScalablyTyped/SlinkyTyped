...
object libLinearListCollectionMod extends js.Object {
  ...
  class ListCollection[T] ()
    ...
    override def begin(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[T, List[T], Iterator[T], ReverseIterator[T], T] = js.native
    /* CompleteClass */
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def end(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[T, List[T], Iterator[T], ReverseIterator[T], T] = js.native
    /* CompleteClass */
  ...
  object ListCollection extends js.Object {
    ...
    class Iterator[T] protected ()
      extends ListIterator[
              T, 
              List[T], 
              typingsSlinky.tstl.containerListMod.List.Iterator[T], 
              typingsSlinky.tstl.containerListMod.List.ReverseIterator[T], 
              T
            ] {
      /**
        * @hidden
      ...
      def equals(obj: typingsSlinky.tstl.containerListMod.List.Iterator[T]): Boolean = js.native
    }
    ...
    class ReverseIterator[T] ()
      extends typingsSlinky.tstl.baseIteratorReverseIteratorMod.ReverseIterator[
              T, 
              List[T], 
              typingsSlinky.tstl.containerListMod.List.Iterator[T], 
              typingsSlinky.tstl.containerListMod.List.ReverseIterator[T], 
