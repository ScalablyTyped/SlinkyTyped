...
import typingsSlinky.tstl.hashSetMod.HashSet
...
object hashSetCollectionMod extends js.Object {
  ...
  class HashSetCollection[T] ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def begin(): typingsSlinky.tstl.icontainerMod.IContainer.Iterator[T, HashSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
      * @inheritDoc
      */
    /* InferMemberOverrides */
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def end(): typingsSlinky.tstl.icontainerMod.IContainer.Iterator[T, HashSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
  ...
  object HashSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        HashSet[T], 
        typingsSlinky.tstl.hashSetMod.HashSet.Iterator[T], 
        typingsSlinky.tstl.hashSetMod.HashSet.ReverseIterator[T]
      ]
    /**
      * Iterator of {@link HashSet}
      */
    type Iterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.Iterator[Key, typingsSlinky.ecol.ecolBooleans.`true`, HashSet[Key]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.ReverseIterator[Key, typingsSlinky.ecol.ecolBooleans.`true`, HashSet[Key]]
  }
