...
import typingsSlinky.tstl.containerHashMultiSetMod.HashMultiSet
...
object libSetsHashMultiSetCollectionMod extends js.Object {
  ...
  class HashMultiSetCollection[T] ()
    ...
    override def begin(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[T, HashMultiSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[T, HashMultiSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /* CompleteClass */
  ...
  object HashMultiSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        HashMultiSet[T], 
        typingsSlinky.tstl.containerHashMultiSetMod.HashMultiSet.Iterator[T], 
        typingsSlinky.tstl.containerHashMultiSetMod.HashMultiSet.ReverseIterator[T]
      ]
