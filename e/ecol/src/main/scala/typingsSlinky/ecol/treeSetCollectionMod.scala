...
import typingsSlinky.tstl.treeSetMod.TreeSet
...
@js.native
object treeSetCollectionMod extends js.Object {
  ...
  object TreeSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        TreeSet[T], 
        typingsSlinky.tstl.treeSetMod.TreeSet.Iterator[T], 
        typingsSlinky.tstl.treeSetMod.TreeSet.ReverseIterator[T]
      ]
    /**
      * Iterator of {@link TreeSet}
      */
    type Iterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.Iterator[Key, typingsSlinky.ecol.ecolBooleans.`true`, TreeSet[Key]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key] = typingsSlinky.tstl.setElementListMod.SetElementList.ReverseIterator[Key, typingsSlinky.ecol.ecolBooleans.`true`, TreeSet[Key]]
  }
