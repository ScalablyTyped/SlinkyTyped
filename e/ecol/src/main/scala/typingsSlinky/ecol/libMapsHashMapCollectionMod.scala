...
import typingsSlinky.ecol.ecolNumbers.`true`
...
import typingsSlinky.tstl.containerHashMapMod.HashMap
import typingsSlinky.tstl.containerHashMapMod.HashMap.Iterator
import typingsSlinky.tstl.containerHashMapMod.HashMap.ReverseIterator
...
object libMapsHashMapCollectionMod extends js.Object {
  ...
  class HashMapCollection[Key, T] ()
    ...
    override def begin(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[Entry[Key, T], HashMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[Entry[Key, T], HashMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /* CompleteClass */
  ...
  object HashMapCollection extends js.Object {
    ...
    type Event[Key, T] = CollectionEvent[
        Entry[Key, T], 
        HashMap[Key, T], 
        typingsSlinky.tstl.containerHashMapMod.HashMap.Iterator[Key, T], 
        typingsSlinky.tstl.containerHashMapMod.HashMap.ReverseIterator[Key, T]
      ]
    type Iterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `true`, HashMap[Key, T]]
    ...
    type ReverseIterator[Key, T] = typingsSlinky.tstl.baseContainerMapElementListMod.MapElementList.ReverseIterator[Key, T, `true`, HashMap[Key, T]]
  }
