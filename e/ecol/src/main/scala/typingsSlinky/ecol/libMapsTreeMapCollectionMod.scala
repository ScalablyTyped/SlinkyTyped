...
object libMapsTreeMapCollectionMod extends js.Object {
  ...
  class TreeMapCollection[Key, T] ()
    ...
    override def begin(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[Entry[Key, T], TreeMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[Entry[Key, T], TreeMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /* CompleteClass */
  ...
  object TreeMapCollection extends js.Object {
    ...
    type Event[Key, T] = CollectionEvent[
        Entry[Key, T], 
        TreeMap[Key, T], 
        typingsSlinky.tstl.containerTreeMapMod.TreeMap.Iterator[Key, T], 
        typingsSlinky.tstl.containerTreeMapMod.TreeMap.ReverseIterator[Key, T]
      ]
