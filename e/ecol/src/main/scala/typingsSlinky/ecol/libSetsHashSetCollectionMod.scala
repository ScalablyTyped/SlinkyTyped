...
object libSetsHashSetCollectionMod extends js.Object {
  ...
  class HashSetCollection[T] ()
    ...
    override def begin(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[T, HashSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsSlinky.tstl.baseIteratorIteratorMod.Iterator[T, HashSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /* CompleteClass */
  ...
  object HashSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        HashSet[T], 
        typingsSlinky.tstl.containerHashSetMod.HashSet.Iterator[T], 
        typingsSlinky.tstl.containerHashSetMod.HashSet.ReverseIterator[T]
      ]
