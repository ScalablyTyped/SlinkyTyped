...
import typingsSlinky.ecol.ecolNumbers.`false`
...
object libMapsTreeMultiMapCollectionMod extends js.Object {
  ...
  object TreeMultiMapCollection extends js.Object {
    ...
    type Event[Key, T] = CollectionEvent[
        Entry[Key, T], 
        TreeMultiMap[Key, T], 
        typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap.Iterator[Key, T], 
        typingsSlinky.tstl.containerTreeMultiMapMod.TreeMultiMap.ReverseIterator[Key, T]
      ]
