...
import typingsSlinky.ethereumDashProtocol.ethereumDashProtocolMod.ConstructorStateMutability
import typingsSlinky.ethereumDashProtocol.ethereumDashProtocolMod.StateMutability
import typingsSlinky.ethereumDashProtocol.ethereumDashProtocolMod.Unit
