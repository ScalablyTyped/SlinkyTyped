...
import typingsSlinky.ethereumProtocol.mod.ConstructorStateMutability
import typingsSlinky.ethereumProtocol.mod.StateMutability
import typingsSlinky.ethereumProtocol.mod.Unit
