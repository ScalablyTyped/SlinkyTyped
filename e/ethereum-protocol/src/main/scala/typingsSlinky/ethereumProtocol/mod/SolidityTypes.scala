...
object SolidityTypes extends StObject {
  ...
  /* "address" */ val Address: typingsSlinky.ethereumProtocol.mod.SolidityTypes.Address with String = js.native
  
  @js.native
  sealed trait Uint extends SolidityTypes
  /* "uint" */ val Uint: typingsSlinky.ethereumProtocol.mod.SolidityTypes.Uint with String = js.native
  
  @js.native
  sealed trait Uint256 extends SolidityTypes
  /* "uint256" */ val Uint256: typingsSlinky.ethereumProtocol.mod.SolidityTypes.Uint256 with String = js.native
  
  @js.native
  sealed trait Uint8 extends SolidityTypes
  /* "uint8" */ val Uint8: typingsSlinky.ethereumProtocol.mod.SolidityTypes.Uint8 with String = js.native
}
