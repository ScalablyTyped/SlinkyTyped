...
object BlockParamLiteral extends StObject {
  ...
  /* "earliest" */ val Earliest: typingsSlinky.ethereumProtocol.mod.BlockParamLiteral.Earliest with String = js.native
  
  @js.native
  sealed trait Latest extends BlockParamLiteral
  /* "latest" */ val Latest: typingsSlinky.ethereumProtocol.mod.BlockParamLiteral.Latest with String = js.native
  
  @js.native
  sealed trait Pending extends BlockParamLiteral
  /* "pending" */ val Pending: typingsSlinky.ethereumProtocol.mod.BlockParamLiteral.Pending with String = js.native
}
