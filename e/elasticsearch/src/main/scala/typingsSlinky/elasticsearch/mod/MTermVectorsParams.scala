...
object MTermVectorsParams {
  ...
  @scala.inline
  implicit class MTermVectorsParamsOps[Self <: MTermVectorsParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIds(value: NameList): Self = this.set("ids", value.asInstanceOf[js.Any])
    @scala.inline
