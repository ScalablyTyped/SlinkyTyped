...
import typingsSlinky.elasticsearch.elasticsearchStrings.force
import typingsSlinky.elasticsearch.elasticsearchStrings.internal
...
object UpdateDocumentParams {
  ...
  implicit class UpdateDocumentParamsOps[Self <: UpdateDocumentParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRetryOnConflict(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("retryOnConflict")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRetryOnConflict: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("retryOnConflict")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withVersionType(value: internal | force): Self = {
        val ret = this.duplicate
