...
object UpdateDocumentByQueryParams {
  ...
  @scala.inline
  implicit class UpdateDocumentByQueryParamsOps[Self <: UpdateDocumentByQueryParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVersionType(value: Boolean): Self = this.set("versionType", value.asInstanceOf[js.Any])
