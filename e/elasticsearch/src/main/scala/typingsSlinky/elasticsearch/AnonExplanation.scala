...
import typingsSlinky.elasticsearch.mod.Explanation
...
trait AnonExplanation[T] extends js.Object {
  var _explanation: js.UndefOr[Explanation] = js.native
...
object AnonExplanation {
  @scala.inline
  def apply[T](_id: String, _index: String, _score: Double, _source: T, _type: String): AnonExplanation[T] = {
  ...
  @scala.inline
  implicit class AnonExplanationOps[Self[t] <: AnonExplanation[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def with_explanation(value: Explanation): Self[T] = {
        val ret = this.duplicate
