...
object anon {
  ...
  object AutoFields {
    ...
    implicit class AutoFieldsMutableBuilder[Self <: AutoFields] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFileModeMatchRegExp(value: js.RegExp): Self = StObject.set(x, "fileModeMatch", value.asInstanceOf[js.Any])
  ...
  object CurrentDate {
    ...
    implicit class CurrentDateMutableBuilder[Self <: CurrentDate] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCurrentDate(value: String | Double | js.Date): Self = StObject.set(x, "currentDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentDateDate(value: js.Date): Self = StObject.set(x, "currentDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentDateUndefined: Self = StObject.set(x, "currentDate", js.undefined)
      
      @scala.inline
      def setEndDate(value: String | Double | js.Date): Self = StObject.set(x, "endDate", value.asInstanceOf[js.Any])
