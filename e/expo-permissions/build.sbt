...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "unimodules-permissions-interface" % "5.2.1-0ed569",
  "org.scalablytyped.slinky" %%% "unimodules__react-native-adapter" % "5.4.0-7f0f82")
