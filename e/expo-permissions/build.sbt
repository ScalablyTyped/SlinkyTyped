...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "unimodules-permissions-interface" % "5.3.0-ecbd60",
  "org.scalablytyped.slinky" %%% "unimodules__react-native-adapter" % "5.6.0-737652")
