...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "unimodules-permissions-interface" % "5.3.0-74181c",
  "org.scalablytyped.slinky" %%% "unimodules__react-native-adapter" % "5.6.0-57c278")
