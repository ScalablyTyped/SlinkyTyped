...
import typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.FeatureLayerOptions
...
class FeatureLayer protected ()
  extends typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.FeatureLayer {
