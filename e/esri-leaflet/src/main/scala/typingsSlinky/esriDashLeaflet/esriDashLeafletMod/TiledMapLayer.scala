...
import typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.TiledMapLayerOptions
...
class TiledMapLayer protected ()
  extends typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.TiledMapLayer {
...
object tiledMapLayer extends js.Object {
  /**
    ...
    * service is added to map attribution automatically.
    */
  def apply(options: TiledMapLayerOptions): typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.TiledMapLayer = js.native
}
