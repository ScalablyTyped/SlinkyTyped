...
import typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.QueryOptions
...
class Query protected ()
  extends typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.Query {
...
object query extends js.Object {
  /**
    ...
    * version of ArcGIS Server that hosts the service some of these options may not be available.
    */
  def apply(options: QueryOptions): typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.Query = js.native
}
