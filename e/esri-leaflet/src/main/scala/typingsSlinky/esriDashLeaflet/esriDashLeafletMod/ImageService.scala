...
import typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.ImageServiceOptions
...
class ImageService protected ()
  extends typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.ImageService {
...
object imageService extends js.Object {
  /**
    ...
    * service.
    */
  def apply(options: ImageServiceOptions): typingsSlinky.esriDashLeaflet.esriDashLeafletMod.leafletMod.esri.ImageService = js.native
}
