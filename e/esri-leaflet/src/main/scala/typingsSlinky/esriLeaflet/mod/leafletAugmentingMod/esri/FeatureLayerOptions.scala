...
object FeatureLayerOptions {
  ...
  def apply(
    ...
    simplifyFactor: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(cacheLayers)) __obj.updateDynamic("cacheLayers")(cacheLayers.get.asInstanceOf[js.Any])
    if (fields != null) __obj.updateDynamic("fields")(fields.asInstanceOf[js.Any])
    if (from != null) __obj.updateDynamic("from")(from.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreRenderer)) __obj.updateDynamic("ignoreRenderer")(ignoreRenderer.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isModern)) __obj.updateDynamic("isModern")(isModern.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(simplifyFactor)) __obj.updateDynamic("simplifyFactor")(simplifyFactor.get.asInstanceOf[js.Any])
