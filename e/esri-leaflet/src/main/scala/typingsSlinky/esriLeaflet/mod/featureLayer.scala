...
import typingsSlinky.esriLeaflet.mod.leafletAugmentingMod.esri.FeatureLayerOptions
...
object featureLayer extends js.Object {
  /**
    ...
    * JavaScript.
    */
  def apply(options: FeatureLayerOptions): typingsSlinky.esriLeaflet.mod.leafletAugmentingMod.esri.FeatureLayer_ = js.native
}
