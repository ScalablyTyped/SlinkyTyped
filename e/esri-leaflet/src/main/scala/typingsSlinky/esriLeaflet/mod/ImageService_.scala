...
import typingsSlinky.esriLeaflet.mod.leafletAugmentingMod.esri.ImageServiceOptions
...
class ImageService_ protected ()
  extends typingsSlinky.esriLeaflet.mod.leafletAugmentingMod.esri.ImageService_ {
