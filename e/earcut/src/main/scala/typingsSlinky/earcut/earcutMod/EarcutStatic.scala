package typingsSlinky.earcut.earcutMod

import typingsSlinky.earcut.Anon_Dimensions
...
trait EarcutStatic extends js.Object {
  ...
  /**
  	 ...
  	 */
  def flatten(data: ArrayLike[ArrayLike[ArrayLike[Double]]]): Anon_Dimensions = js.native
}
