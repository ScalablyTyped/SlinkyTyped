...
import typingsSlinky.ember.emberMod.Ember.NativeArray
import typingsSlinky.ember.emberMod.default.ComputedProperty
import typingsSlinky.ember.emberMod.default.Map
import typingsSlinky.emberDashData.TypeofClassModel
...
@js.native
class Model ()
  extends typingsSlinky.emberDashData.emberDashDataMod.DS.Model
...
object Model extends js.Object {
  ...
  /**
    ...
    * descriptor.
    */
  def eachRelationship[M /* <: typingsSlinky.emberDashData.emberDashDataMod.DS.Model */](callback: js.Function2[/* name */ String, /* details */ RelationshipMeta[M], Unit]): Unit = js.native
  def eachRelationship[M /* <: typingsSlinky.emberDashData.emberDashDataMod.DS.Model */](
  ...
  /**
    ...
    */
  def inverseFor[K /* <: String */](name: K, store: typingsSlinky.emberDashData.emberDashDataMod.DS.Store): js.Object = js.native
  /**
    * For a given relationship name, returns the model type of the relationship.
    */
  def typeForRelationship[K /* <: String */](name: K, store: typingsSlinky.emberDashData.emberDashDataMod.DS.Store): /* import warning: importer.ImportType#apply Failed type conversion: ember-data.ember-data/types/registries/model.ModelRegistry[K] */ js.Any = js.native
}
