...
- typingsSlinky.emberData.mod.DS.BuildURLMixin because Inheritance from two classes. Inlined buildURL, urlForFindRecord, urlForFindAll, urlForQuery, urlForQueryRecord, urlForFindMany, urlForFindHasMany, urlForFindBelongsTo, urlForCreateRecord, urlForUpdateRecord, urlForDeleteRecord, pathForType */ @JSImport("ember-data", "DS.RESTAdapter")
@js.native
