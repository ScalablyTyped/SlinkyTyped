...
object Model extends js.Object {
  ...
  /**
    ...
    */
  def inverseFor[K /* <: String */](name: K, store: typingsSlinky.emberData.mod.DS.Store): js.Object = js.native
  /**
    * For a given relationship name, returns the model type of the relationship.
    */
  def typeForRelationship[K /* <: String */](name: K, store: typingsSlinky.emberData.mod.DS.Store): /* import warning: importer.ImportType#apply Failed type conversion: ember-data.ember-data/types/registries/model.ModelRegistry[K] */ js.Any = js.native
}
