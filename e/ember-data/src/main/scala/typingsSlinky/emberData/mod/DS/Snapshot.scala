...
import typingsSlinky.emberData.Anon0
import typingsSlinky.emberData.AnonId
import typingsSlinky.emberData.AnonIds
...
class Snapshot[K /* <: String */] () extends js.Object {
  ...
  {[ L in keyof ember-data.ember-data/types/registries/model.ModelRegistry[K] ]: ember-data.ember-data/types/registries/model.ModelRegistry[K][L]}
    */ typingsSlinky.emberData.emberDataStrings.Snapshot with ModelRegistry = js.native
  /**
  ...
  {[ L in keyof ember-data.ember-data/types/registries/model.ModelRegistry[K] ]: ember-data.ember-data/types/registries/model.ModelRegistry[K][L]}
    */ typingsSlinky.emberData.emberDataStrings.Snapshot with ModelRegistry
  ] = js.native
  /**
