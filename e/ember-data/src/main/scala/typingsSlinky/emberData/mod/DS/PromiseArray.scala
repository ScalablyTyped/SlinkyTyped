...
- typingsSlinky.emberObject.promiseProxyMixinMod.PromiseProxyMixin because Inheritance from two classes. Inlined promise, isRejected, isPending, reason, isSettled, isFulfilled */ @JSImport("ember-data", "DS.PromiseArray")
@js.native
class PromiseArray[T] ()
  ...
  /**
    ...
    */
  var promise: typingsSlinky.rsvp.mod.default.Promise[ArrayProxy[T]] = js.native
