...
object BusinessNotebook {
  ...
  implicit class BusinessNotebookOps[Self <: BusinessNotebook] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBusinessNotebook(value: typingsSlinky.evernote.mod.Types.BusinessNotebook): Self = this.set("businessNotebook", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGuid(value: typingsSlinky.evernote.mod.Types.Guid): Self = this.set("guid", value.asInstanceOf[js.Any])
