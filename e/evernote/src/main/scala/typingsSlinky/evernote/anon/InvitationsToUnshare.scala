...
object InvitationsToUnshare {
  ...
  implicit class InvitationsToUnshareOps[Self <: InvitationsToUnshare] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInvitationsToUnshareVarargs(value: typingsSlinky.evernote.mod.Types.IdentityID*): Self = this.set("invitationsToUnshare", js.Array(value :_*))
    @scala.inline
    def setInvitationsToUnshare(value: js.Array[typingsSlinky.evernote.mod.Types.IdentityID]): Self = this.set("invitationsToUnshare", value.asInstanceOf[js.Any])
    @scala.inline
