...
object Attributes {
  ...
  implicit class AttributesOps[Self <: Attributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagGuidsVarargs(value: typingsSlinky.evernote.mod.Types.Guid*): Self = this.set("tagGuids", js.Array(value :_*))
    @scala.inline
    def setTagGuids(value: js.Array[typingsSlinky.evernote.mod.Types.Guid]): Self = this.set("tagGuids", value.asInstanceOf[js.Any])
    @scala.inline
