...
object ChunkHighUSN {
  ...
  implicit class ChunkHighUSNOps[Self <: ChunkHighUSN] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpungedLinkedNotebooksVarargs(value: typingsSlinky.evernote.mod.Types.Guid*): Self = this.set("expungedLinkedNotebooks", js.Array(value :_*))
    
    @scala.inline
    def setExpungedLinkedNotebooks(value: js.Array[typingsSlinky.evernote.mod.Types.Guid]): Self = this.set("expungedLinkedNotebooks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteExpungedLinkedNotebooks: Self = this.set("expungedLinkedNotebooks", js.undefined)
    
    @scala.inline
    def setExpungedNotebooksVarargs(value: typingsSlinky.evernote.mod.Types.Guid*): Self = this.set("expungedNotebooks", js.Array(value :_*))
    
    @scala.inline
    def setExpungedNotebooks(value: js.Array[typingsSlinky.evernote.mod.Types.Guid]): Self = this.set("expungedNotebooks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteExpungedNotebooks: Self = this.set("expungedNotebooks", js.undefined)
    
    @scala.inline
    def setExpungedNotesVarargs(value: typingsSlinky.evernote.mod.Types.Guid*): Self = this.set("expungedNotes", js.Array(value :_*))
    
    @scala.inline
    def setExpungedNotes(value: js.Array[typingsSlinky.evernote.mod.Types.Guid]): Self = this.set("expungedNotes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteExpungedNotes: Self = this.set("expungedNotes", js.undefined)
    
    @scala.inline
    def setExpungedSearchesVarargs(value: typingsSlinky.evernote.mod.Types.Guid*): Self = this.set("expungedSearches", js.Array(value :_*))
    
    @scala.inline
    def setExpungedSearches(value: js.Array[typingsSlinky.evernote.mod.Types.Guid]): Self = this.set("expungedSearches", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteExpungedSearches: Self = this.set("expungedSearches", js.undefined)
    
    @scala.inline
    def setExpungedTagsVarargs(value: typingsSlinky.evernote.mod.Types.Guid*): Self = this.set("expungedTags", js.Array(value :_*))
    
    @scala.inline
    def setExpungedTags(value: js.Array[typingsSlinky.evernote.mod.Types.Guid]): Self = this.set("expungedTags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotesVarargs(value: typingsSlinky.evernote.mod.Types.Note*): Self = this.set("notes", js.Array(value :_*))
    
    @scala.inline
    def setNotes(value: js.Array[typingsSlinky.evernote.mod.Types.Note]): Self = this.set("notes", value.asInstanceOf[js.Any])
