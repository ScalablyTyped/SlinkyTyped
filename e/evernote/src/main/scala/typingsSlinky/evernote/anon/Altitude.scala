...
trait Altitude extends StObject {
  ...
  var conflictSourceNoteGuid: js.UndefOr[typingsSlinky.evernote.mod.Types.Guid] = js.native
...
object Altitude {
  ...
  implicit class AltitudeMutableBuilder[Self <: Altitude] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConflictSourceNoteGuid(value: typingsSlinky.evernote.mod.Types.Guid): Self = StObject.set(x, "conflictSourceNoteGuid", value.asInstanceOf[js.Any])
