...
trait Altitude extends js.Object {
  ...
  var conflictSourceNoteGuid: js.UndefOr[typingsSlinky.evernote.mod.Types.Guid] = js.undefined
...
object Altitude {
  ...
  def apply(
    ...
    conflictSourceNoteGuid: typingsSlinky.evernote.mod.Types.Guid = null,
