...
object ExpungeWhichSharedNotebookRestrictions {
  ...
  def apply(
    ...
    if (!js.isUndefined(noCreateNotes)) __obj.updateDynamic("noCreateNotes")(noCreateNotes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noCreateSharedNotebooks)) __obj.updateDynamic("noCreateSharedNotebooks")(noCreateSharedNotebooks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noCreateTags)) __obj.updateDynamic("noCreateTags")(noCreateTags.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noEmailNotes)) __obj.updateDynamic("noEmailNotes")(noEmailNotes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noExpungeNotebook)) __obj.updateDynamic("noExpungeNotebook")(noExpungeNotebook.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noExpungeNotes)) __obj.updateDynamic("noExpungeNotes")(noExpungeNotes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noExpungeTags)) __obj.updateDynamic("noExpungeTags")(noExpungeTags.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noPublishToBusinessLibrary)) __obj.updateDynamic("noPublishToBusinessLibrary")(noPublishToBusinessLibrary.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noPublishToPublic)) __obj.updateDynamic("noPublishToPublic")(noPublishToPublic.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noReadNotes)) __obj.updateDynamic("noReadNotes")(noReadNotes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noRenameNotebook)) __obj.updateDynamic("noRenameNotebook")(noRenameNotebook.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noSendMessageToRecipients)) __obj.updateDynamic("noSendMessageToRecipients")(noSendMessageToRecipients.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noSetDefaultNotebook)) __obj.updateDynamic("noSetDefaultNotebook")(noSetDefaultNotebook.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noSetNotebookStack)) __obj.updateDynamic("noSetNotebookStack")(noSetNotebookStack.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noSetParentTag)) __obj.updateDynamic("noSetParentTag")(noSetParentTag.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noShareNotes)) __obj.updateDynamic("noShareNotes")(noShareNotes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noShareNotesWithBusiness)) __obj.updateDynamic("noShareNotesWithBusiness")(noShareNotesWithBusiness.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noUpdateNotebook)) __obj.updateDynamic("noUpdateNotebook")(noUpdateNotebook.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noUpdateNotes)) __obj.updateDynamic("noUpdateNotes")(noUpdateNotes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noUpdateTags)) __obj.updateDynamic("noUpdateTags")(noUpdateTags.get.asInstanceOf[js.Any])
