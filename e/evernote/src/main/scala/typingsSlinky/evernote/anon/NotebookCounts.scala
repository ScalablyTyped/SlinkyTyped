...
trait NotebookCounts extends js.Object {
  var notebookCounts: js.UndefOr[Map[typingsSlinky.evernote.mod.Types.Guid, Double]] = js.undefined
  var tagCounts: js.UndefOr[Map[typingsSlinky.evernote.mod.Types.Guid, Double]] = js.undefined
...
object NotebookCounts {
  @scala.inline
  def apply(
    notebookCounts: Map[typingsSlinky.evernote.mod.Types.Guid, Double] = null,
    tagCounts: Map[typingsSlinky.evernote.mod.Types.Guid, Double] = null,
