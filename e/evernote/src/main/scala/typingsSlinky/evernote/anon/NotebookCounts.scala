...
object NotebookCounts {
  ...
  implicit class NotebookCountsOps[Self <: NotebookCounts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotebookCounts(value: Map[typingsSlinky.evernote.mod.Types.Guid, Double]): Self = this.set("notebookCounts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNotebookCounts: Self = this.set("notebookCounts", js.undefined)
    
    @scala.inline
    def setTagCounts(value: Map[typingsSlinky.evernote.mod.Types.Guid, Double]): Self = this.set("tagCounts", value.asInstanceOf[js.Any])
