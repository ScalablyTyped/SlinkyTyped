...
import typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel
import typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookRecipientSettings
