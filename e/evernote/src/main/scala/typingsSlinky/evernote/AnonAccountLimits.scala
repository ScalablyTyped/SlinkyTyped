...
object AnonAccountLimits {
  @scala.inline
  def apply(): AnonAccountLimits = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAccountLimits]
  }
  @scala.inline
  implicit class AnonAccountLimitsOps[Self <: AnonAccountLimits] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAccountLimits(value: AccountLimits): Self = {
