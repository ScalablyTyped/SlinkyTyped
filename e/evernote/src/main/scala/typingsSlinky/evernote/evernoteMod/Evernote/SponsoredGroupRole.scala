...
object SponsoredGroupRole extends js.Object {
  ...
  /* 2 */ val GROUP_ADMIN: typingsSlinky.evernote.evernoteMod.Evernote.SponsoredGroupRole.GROUP_ADMIN with Double = js.native
  /* 1 */ val GROUP_MEMBER: typingsSlinky.evernote.evernoteMod.Evernote.SponsoredGroupRole.GROUP_MEMBER with Double = js.native
  /* 3 */ val GROUP_OWNER: typingsSlinky.evernote.evernoteMod.Evernote.SponsoredGroupRole.GROUP_OWNER with Double = js.native
  @JSBracketAccess
