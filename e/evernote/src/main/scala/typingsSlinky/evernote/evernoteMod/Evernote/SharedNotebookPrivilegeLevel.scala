...
object SharedNotebookPrivilegeLevel extends js.Object {
  ...
  /* 5 */ val BUSINESS_FULL_ACCESS: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel.BUSINESS_FULL_ACCESS with Double = js.native
  /* 4 */ val FULL_ACCESS: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel.FULL_ACCESS with Double = js.native
  /* 3 */ val GROUP: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel.GROUP with Double = js.native
  /* 1 */ val MODIFY_NOTEBOOK_PLUS_ACTIVITY: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel.MODIFY_NOTEBOOK_PLUS_ACTIVITY with Double = js.native
  /* 0 */ val READ_NOTEBOOK: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel.READ_NOTEBOOK with Double = js.native
  /* 2 */ val READ_NOTEBOOK_PLUS_ACTIVITY: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookPrivilegeLevel.READ_NOTEBOOK_PLUS_ACTIVITY with Double = js.native
  @JSBracketAccess
