...
object SharedNotebookInstanceRestrictions extends js.Object {
  ...
  /* 2 */ val NO_SHARED_NOTEBOOKS: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookInstanceRestrictions.NO_SHARED_NOTEBOOKS with Double = js.native
  /* 1 */ val ONLY_JOINED_OR_PREVIEW: typingsSlinky.evernote.evernoteMod.Evernote.SharedNotebookInstanceRestrictions.ONLY_JOINED_OR_PREVIEW with Double = js.native
  @JSBracketAccess
