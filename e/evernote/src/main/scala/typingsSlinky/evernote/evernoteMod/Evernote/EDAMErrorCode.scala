...
object EDAMErrorCode extends js.Object {
  ...
  /* 9 */ val AUTH_EXPIRED: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.AUTH_EXPIRED with Double = js.native
  /* 2 */ val BAD_DATA_FORMAT: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.BAD_DATA_FORMAT with Double = js.native
  /* 10 */ val DATA_CONFLICT: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.DATA_CONFLICT with Double = js.native
  /* 5 */ val DATA_REQUIRED: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.DATA_REQUIRED with Double = js.native
  /* 11 */ val ENML_VALIDATION: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.ENML_VALIDATION with Double = js.native
  /* 4 */ val INTERNAL_ERROR: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.INTERNAL_ERROR with Double = js.native
  /* 8 */ val INVALID_AUTH: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.INVALID_AUTH with Double = js.native
  /* 14 */ val LEN_TOO_LONG: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.LEN_TOO_LONG with Double = js.native
  /* 13 */ val LEN_TOO_SHORT: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.LEN_TOO_SHORT with Double = js.native
  /* 6 */ val LIMIT_REACHED: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.LIMIT_REACHED with Double = js.native
  /* 3 */ val PERMISSION_DENIED: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.PERMISSION_DENIED with Double = js.native
  /* 7 */ val QUOTA_REACHED: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.QUOTA_REACHED with Double = js.native
  /* 19 */ val RATE_LIMIT_REACHED: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.RATE_LIMIT_REACHED with Double = js.native
  /* 12 */ val SHARD_UNAVAILABLE: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.SHARD_UNAVAILABLE with Double = js.native
  /* 18 */ val TAKEN_DOWN: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.TAKEN_DOWN with Double = js.native
  /* 15 */ val TOO_FEW: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.TOO_FEW with Double = js.native
  /* 16 */ val TOO_MANY: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.TOO_MANY with Double = js.native
  /* 1 */ val UNKNOWN: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.UNKNOWN with Double = js.native
  /* 17 */ val UNSUPPORTED_OPERATION: typingsSlinky.evernote.evernoteMod.Evernote.EDAMErrorCode.UNSUPPORTED_OPERATION with Double = js.native
  @JSBracketAccess
