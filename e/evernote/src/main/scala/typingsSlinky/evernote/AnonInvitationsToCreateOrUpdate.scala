...
object AnonInvitationsToCreateOrUpdate {
  @scala.inline
  def apply(): AnonInvitationsToCreateOrUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonInvitationsToCreateOrUpdate]
  }
  @scala.inline
  implicit class AnonInvitationsToCreateOrUpdateOps[Self <: AnonInvitationsToCreateOrUpdate] (val x: Self) extends AnyVal {
    @scala.inline
