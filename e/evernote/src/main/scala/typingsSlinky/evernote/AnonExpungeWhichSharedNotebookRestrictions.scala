...
object AnonExpungeWhichSharedNotebookRestrictions {
  @scala.inline
  def apply(): AnonExpungeWhichSharedNotebookRestrictions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonExpungeWhichSharedNotebookRestrictions]
  }
  @scala.inline
  implicit class AnonExpungeWhichSharedNotebookRestrictionsOps[Self <: AnonExpungeWhichSharedNotebookRestrictions] (val x: Self) extends AnyVal {
    @scala.inline
