...
object SharedNotebookInstanceRestrictions extends StObject {
  ...
  /* 2 */ val NO_SHARED_NOTEBOOKS: typingsSlinky.evernote.mod.Types.SharedNotebookInstanceRestrictions.NO_SHARED_NOTEBOOKS with Double = js.native
  
  @js.native
  sealed trait ONLY_JOINED_OR_PREVIEW extends SharedNotebookInstanceRestrictions
  /* 1 */ val ONLY_JOINED_OR_PREVIEW: typingsSlinky.evernote.mod.Types.SharedNotebookInstanceRestrictions.ONLY_JOINED_OR_PREVIEW with Double = js.native
}
