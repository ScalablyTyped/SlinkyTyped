...
object SharedNotePrivilegeLevel extends StObject {
  ...
  /* 2 */ val FULL_ACCESS: typingsSlinky.evernote.mod.Types.SharedNotePrivilegeLevel.FULL_ACCESS with Double = js.native
  
  @js.native
  sealed trait MODIFY_NOTE extends SharedNotePrivilegeLevel
  /* 1 */ val MODIFY_NOTE: typingsSlinky.evernote.mod.Types.SharedNotePrivilegeLevel.MODIFY_NOTE with Double = js.native
  
  @js.native
  sealed trait READ_NOTE extends SharedNotePrivilegeLevel
  /* 0 */ val READ_NOTE: typingsSlinky.evernote.mod.Types.SharedNotePrivilegeLevel.READ_NOTE with Double = js.native
}
