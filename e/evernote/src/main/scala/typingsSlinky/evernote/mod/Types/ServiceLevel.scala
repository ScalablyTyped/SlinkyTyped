...
object ServiceLevel extends StObject {
  ...
  /* 1 */ val BASIC: typingsSlinky.evernote.mod.Types.ServiceLevel.BASIC with Double = js.native
  
  @js.native
  sealed trait PLUS extends ServiceLevel
  /* 2 */ val PLUS: typingsSlinky.evernote.mod.Types.ServiceLevel.PLUS with Double = js.native
  
  @js.native
  sealed trait PREMIUM extends ServiceLevel
  /* 3 */ val PREMIUM: typingsSlinky.evernote.mod.Types.ServiceLevel.PREMIUM with Double = js.native
}
