...
object BusinessUserRole extends StObject {
  ...
  /* 1 */ val ADMIN: typingsSlinky.evernote.mod.Types.BusinessUserRole.ADMIN with Double = js.native
  
  @js.native
  sealed trait NORMAL extends BusinessUserRole
  /* 2 */ val NORMAL: typingsSlinky.evernote.mod.Types.BusinessUserRole.NORMAL with Double = js.native
}
