...
object RelatedContentType extends StObject {
  ...
  /* 1 */ val NEWS_ARTICLE: typingsSlinky.evernote.mod.Types.RelatedContentType.NEWS_ARTICLE with Double = js.native
  
  @js.native
  sealed trait PROFILE_ORGANIZATION extends RelatedContentType
  /* 3 */ val PROFILE_ORGANIZATION: typingsSlinky.evernote.mod.Types.RelatedContentType.PROFILE_ORGANIZATION with Double = js.native
  
  @js.native
  sealed trait PROFILE_PERSON extends RelatedContentType
  /* 2 */ val PROFILE_PERSON: typingsSlinky.evernote.mod.Types.RelatedContentType.PROFILE_PERSON with Double = js.native
  
  @js.native
  sealed trait REFERENCE_MATERIAL extends RelatedContentType
  /* 4 */ val REFERENCE_MATERIAL: typingsSlinky.evernote.mod.Types.RelatedContentType.REFERENCE_MATERIAL with Double = js.native
}
