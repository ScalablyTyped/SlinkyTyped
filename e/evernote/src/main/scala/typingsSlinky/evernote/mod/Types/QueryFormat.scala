...
object QueryFormat extends StObject {
  ...
  /* 2 */ val SEXP: typingsSlinky.evernote.mod.Types.QueryFormat.SEXP with Double = js.native
  
  @js.native
  sealed trait USER extends QueryFormat
  /* 1 */ val USER: typingsSlinky.evernote.mod.Types.QueryFormat.USER with Double = js.native
}
