...
object ShareRelationshipPrivilegeLevel extends StObject {
  ...
  /* 30 */ val FULL_ACCESS: typingsSlinky.evernote.mod.NoteStore.ShareRelationshipPrivilegeLevel.FULL_ACCESS with Double = js.native
  
  @js.native
  sealed trait MODIFY_NOTEBOOK_PLUS_ACTIVITY extends ShareRelationshipPrivilegeLevel
  /* 20 */ val MODIFY_NOTEBOOK_PLUS_ACTIVITY: typingsSlinky.evernote.mod.NoteStore.ShareRelationshipPrivilegeLevel.MODIFY_NOTEBOOK_PLUS_ACTIVITY with Double = js.native
  
  @js.native
  sealed trait READ_NOTEBOOK extends ShareRelationshipPrivilegeLevel
  /* 0 */ val READ_NOTEBOOK: typingsSlinky.evernote.mod.NoteStore.ShareRelationshipPrivilegeLevel.READ_NOTEBOOK with Double = js.native
  
  @js.native
  sealed trait READ_NOTEBOOK_PLUS_ACTIVITY extends ShareRelationshipPrivilegeLevel
  /* 10 */ val READ_NOTEBOOK_PLUS_ACTIVITY: typingsSlinky.evernote.mod.NoteStore.ShareRelationshipPrivilegeLevel.READ_NOTEBOOK_PLUS_ACTIVITY with Double = js.native
}
