...
object BusinessInvitationStatus extends StObject {
  ...
  /* 0 */ val APPROVED: typingsSlinky.evernote.mod.Types.BusinessInvitationStatus.APPROVED with Double = js.native
  
  @js.native
  sealed trait REDEEMED extends BusinessInvitationStatus
  /* 2 */ val REDEEMED: typingsSlinky.evernote.mod.Types.BusinessInvitationStatus.REDEEMED with Double = js.native
  
  @js.native
  sealed trait REQUESTED extends BusinessInvitationStatus
  /* 1 */ val REQUESTED: typingsSlinky.evernote.mod.Types.BusinessInvitationStatus.REQUESTED with Double = js.native
}
