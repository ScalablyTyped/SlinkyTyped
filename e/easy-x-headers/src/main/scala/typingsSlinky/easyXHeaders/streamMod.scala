...
import typingsSlinky.easyXHeaders.NodeJS.ReadWriteStream
...
object streamMod {
  ...
  - typingsSlinky.easyXHeaders.NodeJS.EventEmitter because Already inherited
  - typingsSlinky.easyXHeaders.NodeJS.ReadableStream because Already inherited
  - typingsSlinky.easyXHeaders.NodeJS.ReadWriteStream because var conflicts: readable. Inlined  */ @JSImport("stream", "Duplex")
  @js.native
  class Duplex ()
    extends Readable
       with WritableStream {
