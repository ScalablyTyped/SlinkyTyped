...
import typingsSlinky.easyXHeaders.httpMod.ClientRequest
import typingsSlinky.easyXHeaders.httpMod.IncomingMessage
...
object httpsMod {
  ...
  type Server = typingsSlinky.easyXHeaders.tlsMod.Server
