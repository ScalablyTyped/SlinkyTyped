...
object cryptoMod {
  ...
  @JSImport("crypto", "pseudoRandomBytes")
  @js.native
  def pseudoRandomBytes(size: Double, callback: js.Function2[/* err */ js.Error, /* buf */ Buffer, Unit]): Unit = js.native
  ...
  @JSImport("crypto", "randomBytes")
  @js.native
  def randomBytes(size: Double, callback: js.Function2[/* err */ js.Error, /* buf */ Buffer, Unit]): Unit = js.native
