...
import typingsSlinky.easyXHeaders.anon.Dotfiles
import typingsSlinky.easyXHeaders.httpMod.Server
import typingsSlinky.easyXHeaders.httpMod.ServerRequest
import typingsSlinky.easyXHeaders.httpMod.ServerResponse
...
object expressMod {
  ...
  @js.native
  def apply(): typingsSlinky.easyXHeaders.expressMod.Express = js.native
  ...
  trait Request
    extends ServerRequest
       with typingsSlinky.easyXHeaders.Express.Request {
  ...
  trait Response
    extends ServerResponse
       with typingsSlinky.easyXHeaders.Express.Response {
