...
import typingsSlinky.easyXHeaders.streamMod.Transform
...
object zlibMod {
  ...
  @js.native
  def deflate(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
  
  @JSImport("zlib", "deflateRaw")
  @js.native
  def deflateRaw(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
  ...
  @js.native
  def gunzip(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("zlib", "gzip")
  @js.native
  def gzip(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
  ...
  @js.native
  def inflate(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
  
  @JSImport("zlib", "inflateRaw")
  @js.native
  def inflateRaw(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("zlib", "unzip")
  @js.native
  def unzip(buf: Buffer, callback: js.Function2[/* error */ js.Error, /* result */ js.Any, Unit]): Unit = js.native
