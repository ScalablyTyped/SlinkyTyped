...
package object mod {
  ...
  {[ K in string | symbol ]: std.Array<any>}
    */ typingsSlinky.eventemitter3.eventemitter3Strings.EventArgs with js.Any) */, K /* <: typingsSlinky.eventemitter3.mod.EventNames[T] */] = (/* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any) | js.Array[js.Any]
  type EventNames[T /* <: java.lang.String | js.Symbol | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in string | symbol ]: std.Array<any>}
    */ typingsSlinky.eventemitter3.eventemitter3Strings.EventNames with js.Any) */] = java.lang.String | T
