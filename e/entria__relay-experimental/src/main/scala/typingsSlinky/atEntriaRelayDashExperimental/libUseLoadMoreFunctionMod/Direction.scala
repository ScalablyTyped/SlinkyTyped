...
object Direction {
  @scala.inline
  def backward: typingsSlinky.atEntriaRelayDashExperimental.atEntriaRelayDashExperimentalStrings.backward = this.cast("backward")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def forward: typingsSlinky.atEntriaRelayDashExperimental.atEntriaRelayDashExperimentalStrings.forward = this.cast("forward")
}
