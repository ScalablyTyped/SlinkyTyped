  ...
  */
  ...
  object Action {
    ...
    def Environment(
      ...
      __obj.asInstanceOf[typingsSlinky.entriaRelayExperimental.anon.Environment]
    }
    
    @scala.inline
    def FetchPolicy(environment: Environment, refetchVariables: Variables, `type`: String): typingsSlinky.entriaRelayExperimental.anon.FetchPolicy = {
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.entriaRelayExperimental.anon.FetchPolicy]
    }
  }
