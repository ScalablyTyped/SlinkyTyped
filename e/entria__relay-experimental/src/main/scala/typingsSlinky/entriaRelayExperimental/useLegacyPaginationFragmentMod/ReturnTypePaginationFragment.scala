...
object ReturnTypePaginationFragment {
  @scala.inline
  def apply[/* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, TKey, TFragmentData](
    data: TFragmentData,
    hasNext: Boolean,
    hasPrevious: Boolean,
  ...
  @scala.inline
  implicit class ReturnTypePaginationFragmentOps[Self <: ReturnTypePaginationFragment[_, _, _], /* <: typingsSlinky.relayRuntime.relayRuntimeTypesMod.OperationType */ TQuery, TKey, TFragmentData] (val x: Self with (ReturnTypePaginationFragment[TQuery, TKey, TFragmentData])) extends AnyVal {
    @scala.inline
