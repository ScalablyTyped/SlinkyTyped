...
name := "express"
version := "4.17-dt-20200515Z-65e9a4"
scalaVersion := "2.13.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "body-parser" % "1.19-dt-20200210Z-4b8e0e",
  ...
  "org.scalablytyped.slinky" %%% "serve-static" % "1.13-dt-20200519Z-32009a",
