...
import typingsSlinky.eggDashLogger.eggDashLoggerStrings.duplicate
import typingsSlinky.eggDashLogger.eggDashLoggerStrings.ignore
import typingsSlinky.eggDashLogger.eggDashLoggerStrings.redirect
