package typingsSlinky.ethersprojectLogger
...
object mod {
  ...
  object LogLevel extends StObject {
    ...
    /* "DEBUG" */ val DEBUG: typingsSlinky.ethersprojectLogger.mod.LogLevel.DEBUG with String = js.native
    
    @js.native
    sealed trait ERROR extends LogLevel
    /* "ERROR" */ val ERROR: typingsSlinky.ethersprojectLogger.mod.LogLevel.ERROR with String = js.native
    
    @js.native
    sealed trait INFO extends LogLevel
    /* "INFO" */ val INFO: typingsSlinky.ethersprojectLogger.mod.LogLevel.INFO with String = js.native
    
    @js.native
    sealed trait OFF extends LogLevel
    /* "OFF" */ val OFF: typingsSlinky.ethersprojectLogger.mod.LogLevel.OFF with String = js.native
    
    @js.native
    sealed trait WARNING extends LogLevel
    /* "WARNING" */ val WARNING: typingsSlinky.ethersprojectLogger.mod.LogLevel.WARNING with String = js.native
  }
