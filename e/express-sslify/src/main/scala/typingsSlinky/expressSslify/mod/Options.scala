...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTrustAzureHeader(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trustAzureHeader")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTrustAzureHeader: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trustAzureHeader")(js.undefined)
        ret
    }
    @scala.inline
    def withTrustProtoHeader(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trustProtoHeader")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTrustProtoHeader: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trustProtoHeader")(js.undefined)
        ret
    }
    @scala.inline
    def withTrustXForwardedHostHeader(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trustXForwardedHostHeader")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTrustXForwardedHostHeader: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trustXForwardedHostHeader")(js.undefined)
        ret
    }
  }
