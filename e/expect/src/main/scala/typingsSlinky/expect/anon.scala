...
import typingsSlinky.jestMatcherUtils.mod.MatcherHintOptions
import typingsSlinky.jestMatcherUtils.mod.PrintLabel
...
object anon {
  ...
  object Actual {
    ...
    @scala.inline
    def apply(actual: String | Double, error: js.Error, expected: String): Actual = {
  ...
  trait PartialMatcherState extends StObject {
    ...
    var suppressedErrors: js.UndefOr[js.Array[js.Error]] = js.native
  ...
  object PartialMatcherState {
    ...
    implicit class PartialMatcherStateMutableBuilder[Self <: PartialMatcherState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExpectedAssertionsNumberError(value: js.Error): Self = StObject.set(x, "expectedAssertionsNumberError", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIsExpectingAssertionsError(value: js.Error): Self = StObject.set(x, "isExpectingAssertionsError", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSuppressedErrors(value: js.Array[js.Error]): Self = StObject.set(x, "suppressedErrors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSuppressedErrorsUndefined: Self = StObject.set(x, "suppressedErrors", js.undefined)
      
      @scala.inline
      def setSuppressedErrorsVarargs(value: js.Error*): Self = StObject.set(x, "suppressedErrors", js.Array(value :_*))
