...
object PartialMatcherState {
  ...
  implicit class PartialMatcherStateOps[Self <: PartialMatcherState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpectedAssertionsNumberError(value: js.Error): Self = this.set("expectedAssertionsNumberError", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsExpectingAssertionsError(value: js.Error): Self = this.set("isExpectingAssertionsError", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSuppressedErrorsVarargs(value: js.Error*): Self = this.set("suppressedErrors", js.Array(value :_*))
    
    @scala.inline
    def setSuppressedErrors(value: js.Array[js.Error]): Self = this.set("suppressedErrors", value.asInstanceOf[js.Any])
