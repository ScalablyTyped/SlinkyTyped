package typingsSlinky.electronDashSpellchecker
...
@js.native
object electronDashSpellcheckerMod extends js.Object {
  @js.native
  ...
  type ContextMenuFormatter = js.Function1[/* options */ Anon_Word, String]
}
