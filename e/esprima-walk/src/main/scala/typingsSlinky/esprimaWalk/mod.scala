...
object mod extends js.Object {
  /* Inlined std.Node & {  parent ? :std.Node} */
  @js.native
  ...
  /**
    ...
    */
  def apply(ast: Program, fn: js.Function1[/* node */ typingsSlinky.estree.mod.Node, Unit]): Unit = js.native
  def walk(ast: Program, fn: js.Function1[/* node */ typingsSlinky.estree.mod.Node, Unit]): Unit = js.native
