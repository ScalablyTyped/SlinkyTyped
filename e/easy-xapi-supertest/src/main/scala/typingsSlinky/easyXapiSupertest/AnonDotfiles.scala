...
import typingsSlinky.easyXapiSupertest.expressMod.Response
...
object AnonDotfiles {
  @scala.inline
  def apply(): AnonDotfiles = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDotfiles]
  }
  @scala.inline
  implicit class AnonDotfilesOps[Self <: AnonDotfiles] (val x: Self) extends AnyVal {
    @scala.inline
