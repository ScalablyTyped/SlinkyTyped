...
import typingsSlinky.easyXapiSupertest.NodeJS.ReadWriteStream
...
object streamMod {
  ...
  - typingsSlinky.easyXapiSupertest.NodeJS.EventEmitter because Already inherited
  - typingsSlinky.easyXapiSupertest.NodeJS.ReadableStream because Already inherited
  - typingsSlinky.easyXapiSupertest.NodeJS.ReadWriteStream because var conflicts: readable. Inlined  */ @JSImport("stream", "Duplex")
  @js.native
  class Duplex ()
    extends Readable
       with WritableStream {
