package typingsSlinky.easyDashXapiDashSupertest.expressMod

import typingsSlinky.easyDashXapiDashSupertest.httpMod.ServerResponse
...
trait Response
  extends ServerResponse
     with typingsSlinky.easyDashXapiDashSupertest.Express.Response {
