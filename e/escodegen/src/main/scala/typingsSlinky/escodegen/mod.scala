package typingsSlinky.escodegen
...
object mod {
  ...
  object Precedence extends StObject {
    ...
    /* 14 */ val Additive: typingsSlinky.escodegen.mod.Precedence.Additive with Double = js.native
    
    @js.native
    sealed trait ArrowFunction extends Precedence
    /* 5 */ val ArrowFunction: typingsSlinky.escodegen.mod.Precedence.ArrowFunction with Double = js.native
    
    @js.native
    sealed trait Assignment extends Precedence
    /* 3 */ val Assignment: typingsSlinky.escodegen.mod.Precedence.Assignment with Double = js.native
    
    @js.native
    sealed trait Await extends Precedence
    /* 2 */ val Await: typingsSlinky.escodegen.mod.Precedence.Await with Double = js.native
    
    @js.native
    sealed trait BitwiseAND extends Precedence
    /* 10 */ val BitwiseAND: typingsSlinky.escodegen.mod.Precedence.BitwiseAND with Double = js.native
    
    @js.native
    sealed trait BitwiseOR extends Precedence
    /* 8 */ val BitwiseOR: typingsSlinky.escodegen.mod.Precedence.BitwiseOR with Double = js.native
    
    @js.native
    sealed trait BitwiseSHIFT extends Precedence
    /* 13 */ val BitwiseSHIFT: typingsSlinky.escodegen.mod.Precedence.BitwiseSHIFT with Double = js.native
    
    @js.native
    sealed trait BitwiseXOR extends Precedence
    /* 9 */ val BitwiseXOR: typingsSlinky.escodegen.mod.Precedence.BitwiseXOR with Double = js.native
    
    @js.native
    sealed trait Call extends Precedence
    /* 18 */ val Call: typingsSlinky.escodegen.mod.Precedence.Call with Double = js.native
    
    @js.native
    sealed trait Conditional extends Precedence
    /* 4 */ val Conditional: typingsSlinky.escodegen.mod.Precedence.Conditional with Double = js.native
    
    @js.native
    sealed trait Equality extends Precedence
    /* 11 */ val Equality: typingsSlinky.escodegen.mod.Precedence.Equality with Double = js.native
    
    @js.native
    sealed trait LogicalAND extends Precedence
    /* 7 */ val LogicalAND: typingsSlinky.escodegen.mod.Precedence.LogicalAND with Double = js.native
    
    @js.native
    sealed trait LogicalOR extends Precedence
    /* 6 */ val LogicalOR: typingsSlinky.escodegen.mod.Precedence.LogicalOR with Double = js.native
    
    @js.native
    sealed trait Member extends Precedence
    /* 21 */ val Member: typingsSlinky.escodegen.mod.Precedence.Member with Double = js.native
    
    @js.native
    sealed trait Multiplicative extends Precedence
    /* 15 */ val Multiplicative: typingsSlinky.escodegen.mod.Precedence.Multiplicative with Double = js.native
    
    @js.native
    sealed trait New extends Precedence
    /* 19 */ val New: typingsSlinky.escodegen.mod.Precedence.New with Double = js.native
    
    @js.native
    sealed trait Postfix extends Precedence
    /* 17 */ val Postfix: typingsSlinky.escodegen.mod.Precedence.Postfix with Double = js.native
    
    @js.native
    sealed trait Primary extends Precedence
    /* 22 */ val Primary: typingsSlinky.escodegen.mod.Precedence.Primary with Double = js.native
    
    @js.native
    sealed trait Relational extends Precedence
    /* 12 */ val Relational: typingsSlinky.escodegen.mod.Precedence.Relational with Double = js.native
    
    @js.native
    sealed trait Sequence extends Precedence
    /* 0 */ val Sequence: typingsSlinky.escodegen.mod.Precedence.Sequence with Double = js.native
    
    @js.native
    sealed trait TaggedTemplate extends Precedence
    /* 20 */ val TaggedTemplate: typingsSlinky.escodegen.mod.Precedence.TaggedTemplate with Double = js.native
    
    @js.native
    sealed trait Unary extends Precedence
    /* 16 */ val Unary: typingsSlinky.escodegen.mod.Precedence.Unary with Double = js.native
    
    @js.native
    sealed trait Yield extends Precedence
    /* 1 */ val Yield: typingsSlinky.escodegen.mod.Precedence.Yield with Double = js.native
  }
