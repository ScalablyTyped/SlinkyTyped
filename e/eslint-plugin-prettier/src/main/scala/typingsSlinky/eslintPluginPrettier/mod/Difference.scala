package typingsSlinky.eslintPluginPrettier.mod

import typingsSlinky.eslintPluginPrettier.eslintPluginPrettierStrings.delete
import typingsSlinky.eslintPluginPrettier.eslintPluginPrettierStrings.insert
import typingsSlinky.eslintPluginPrettier.eslintPluginPrettierStrings.replace
