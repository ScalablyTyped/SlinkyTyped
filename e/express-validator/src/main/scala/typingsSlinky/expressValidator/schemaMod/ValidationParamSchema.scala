...
object ValidationParamSchema {
  ...
  implicit class ValidationParamSchemaOps[Self <: ValidationParamSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withErrorMessageFunction2(value: (/* value */ js.Any, /* meta */ Meta) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("errorMessage")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withErrorMessage(value: DynamicMessageCreator | js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIn(value: Location | js.Array[Location]): Self = {
        val ret = this.duplicate
