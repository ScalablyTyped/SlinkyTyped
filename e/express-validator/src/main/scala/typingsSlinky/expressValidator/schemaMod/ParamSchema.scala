...
/* Inlined express-validator.express-validator/src/middlewares/schema.InternalParamSchema & {  in ? :express-validator.express-validator/src/base.Location | std.Array<express-validator.express-validator/src/base.Location>,   errorMessage ? :express-validator.express-validator/src/base.DynamicMessageCreator | any,   optional ? :true | {  options ? :std.Partial<express-validator.express-validator/src/context.Optional>}} */
@js.native
trait ParamSchema extends js.Object {
...
object ParamSchema {
  ...
  @scala.inline
  implicit class ParamSchemaOps[Self <: ParamSchema] (val x: Self) extends AnyVal {
    @scala.inline
