...
trait Msg extends ValidationError {
  ...
  var location: typingsSlinky.expressValidator.baseMod.Location = js.native
...
object Msg {
  ...
  @scala.inline
  def apply(
    location: typingsSlinky.expressValidator.baseMod.Location,
    msg: js.Any,
    param: String,
    value: js.Any
  ): Msg = {
  ...
  implicit class MsgMutableBuilder[Self <: Msg] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocation(value: typingsSlinky.expressValidator.baseMod.Location): Self = StObject.set(x, "location", value.asInstanceOf[js.Any])
