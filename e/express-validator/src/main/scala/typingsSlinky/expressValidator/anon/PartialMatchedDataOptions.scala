...
trait PartialMatchedDataOptions extends js.Object {
  ...
  var locations: js.UndefOr[js.Array[typingsSlinky.expressValidator.baseMod.Location]] = js.undefined
...
object PartialMatchedDataOptions {
  ...
  def apply(
    ...
    locations: js.Array[typingsSlinky.expressValidator.baseMod.Location] = null,
