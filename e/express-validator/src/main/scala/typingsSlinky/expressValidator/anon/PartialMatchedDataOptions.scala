...
object PartialMatchedDataOptions {
  ...
  implicit class PartialMatchedDataOptionsOps[Self <: PartialMatchedDataOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocationsVarargs(value: typingsSlinky.expressValidator.baseMod.Location*): Self = this.set("locations", js.Array(value :_*))
    @scala.inline
    def setLocations(value: js.Array[typingsSlinky.expressValidator.baseMod.Location]): Self = this.set("locations", value.asInstanceOf[js.Any])
    @scala.inline
