package typingsSlinky.eslintDashScope.eslintDashScopeMod
...
@js.native
class Scope ()
  extends typingsSlinky.eslint.eslintMod.Scope.Scope {
  /* CompleteClass */
  override var block: Node = js.native
  /* CompleteClass */
  override var childScopes: js.Array[typingsSlinky.eslint.eslintMod.Scope.Scope] = js.native
  /* CompleteClass */
  override var functionExpressionScope: Boolean = js.native
  /* CompleteClass */
  override var isStrict: Boolean = js.native
  /* CompleteClass */
  override var references: js.Array[typingsSlinky.eslint.eslintMod.Scope.Reference] = js.native
  /* CompleteClass */
  override var set: Map[String, typingsSlinky.eslint.eslintMod.Scope.Variable] = js.native
  /* CompleteClass */
  override var through: js.Array[typingsSlinky.eslint.eslintMod.Scope.Reference] = js.native
  /* CompleteClass */
  override var `type`: block | `catch` | `class` | `for` | function | `function-expression-name` | global | module | switch | `with` | TDZ = js.native
  /* CompleteClass */
  override var upper: typingsSlinky.eslint.eslintMod.Scope.Scope | Null = js.native
  /* CompleteClass */
  override var variableScope: typingsSlinky.eslint.eslintMod.Scope.Scope = js.native
  /* CompleteClass */
  override var variables: js.Array[typingsSlinky.eslint.eslintMod.Scope.Variable] = js.native
}
