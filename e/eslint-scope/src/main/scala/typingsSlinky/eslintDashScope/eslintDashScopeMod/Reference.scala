...
import typingsSlinky.estree.estreeMod.Identifier
...
@js.native
class Reference ()
  extends typingsSlinky.eslint.eslintMod.Scope.Reference {
  /* CompleteClass */
  override var from: typingsSlinky.eslint.eslintMod.Scope.Scope = js.native
  /* CompleteClass */
  override var identifier: Identifier = js.native
  /* CompleteClass */
  override var init: Boolean = js.native
  /* CompleteClass */
  override var resolved: typingsSlinky.eslint.eslintMod.Scope.Variable | Null = js.native
  /* CompleteClass */
