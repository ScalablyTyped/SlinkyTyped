...
import typingsSlinky.ethersprojectAbi.mod.Fragment
...
object mod {
  ...
  trait Event extends Log {
    ...
    var decodeError: js.UndefOr[js.Error] = js.native
  ...
  object Event {
    ...
    implicit class EventMutableBuilder[Self <: Event] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDecodeError(value: js.Error): Self = StObject.set(x, "decodeError", value.asInstanceOf[js.Any])
