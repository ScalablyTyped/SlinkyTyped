...
object BaseModuleSpecifier {
  ...
  @scala.inline
  implicit class BaseModuleSpecifierOps[Self <: BaseModuleSpecifier] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLocal(value: Identifier): Self = this.set("local", value.asInstanceOf[js.Any])
  }
