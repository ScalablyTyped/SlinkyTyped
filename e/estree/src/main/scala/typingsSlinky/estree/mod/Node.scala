...
object Node {
  ...
  @scala.inline
  def RegExpLiteral(regex: AnonFlags, `type`: typingsSlinky.estree.estreeStrings.Literal): Node = {
  ...
  @scala.inline
  def TemplateElement(tail: Boolean, `type`: typingsSlinky.estree.estreeStrings.TemplateElement, value: AnonCooked): Node = {
