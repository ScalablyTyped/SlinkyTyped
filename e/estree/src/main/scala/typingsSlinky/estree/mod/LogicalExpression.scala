...
trait LogicalExpression
  ...
  @JSName("type")
  var type_LogicalExpression: typingsSlinky.estree.estreeStrings.LogicalExpression = js.native
}
object LogicalExpression {
  ...
  implicit class LogicalExpressionMutableBuilder[Self <: LogicalExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.LogicalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
