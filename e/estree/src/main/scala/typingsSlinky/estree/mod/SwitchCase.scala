...
trait SwitchCase
  ...
  @JSName("type")
  var type_SwitchCase: typingsSlinky.estree.estreeStrings.SwitchCase = js.native
}
object SwitchCase {
  
  @scala.inline
  def apply(consequent: js.Array[Statement], `type`: typingsSlinky.estree.estreeStrings.SwitchCase): SwitchCase = {
  ...
  implicit class SwitchCaseMutableBuilder[Self <: SwitchCase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.SwitchCase): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
