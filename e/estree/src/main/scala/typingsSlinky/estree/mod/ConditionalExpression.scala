...
trait ConditionalExpression
  ...
  @JSName("type")
  var type_ConditionalExpression: typingsSlinky.estree.estreeStrings.ConditionalExpression = js.native
}
object ConditionalExpression {
  ...
  implicit class ConditionalExpressionMutableBuilder[Self <: ConditionalExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.ConditionalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
