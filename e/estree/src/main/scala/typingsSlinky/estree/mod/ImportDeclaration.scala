...
trait ImportDeclaration
  ...
  @JSName("type")
  var type_ImportDeclaration: typingsSlinky.estree.estreeStrings.ImportDeclaration = js.native
}
object ImportDeclaration {
  ...
  implicit class ImportDeclarationMutableBuilder[Self <: ImportDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.ImportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
