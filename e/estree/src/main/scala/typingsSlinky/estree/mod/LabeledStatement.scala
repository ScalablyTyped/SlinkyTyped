...
trait LabeledStatement
  ...
  @JSName("type")
  var type_LabeledStatement: typingsSlinky.estree.estreeStrings.LabeledStatement = js.native
}
object LabeledStatement {
  
  @scala.inline
  def apply(body: Statement, label: Identifier, `type`: typingsSlinky.estree.estreeStrings.LabeledStatement): LabeledStatement = {
  ...
  implicit class LabeledStatementMutableBuilder[Self <: LabeledStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.LabeledStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
