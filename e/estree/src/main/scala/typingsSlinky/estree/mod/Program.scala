...
trait Program
  ...
  @JSName("type")
  var type_Program: typingsSlinky.estree.estreeStrings.Program = js.native
}
object Program {
  ...
  implicit class ProgramMutableBuilder[Self <: Program] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.Program): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
