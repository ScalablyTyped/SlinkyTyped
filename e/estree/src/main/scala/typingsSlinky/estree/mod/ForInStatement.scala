...
trait ForInStatement
  ...
  @JSName("type")
  var type_ForInStatement: typingsSlinky.estree.estreeStrings.ForInStatement = js.native
}
object ForInStatement {
  ...
  implicit class ForInStatementMutableBuilder[Self <: ForInStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.ForInStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
