...
trait UnaryExpression
  ...
  @JSName("type")
  var type_UnaryExpression: typingsSlinky.estree.estreeStrings.UnaryExpression = js.native
}
...
object UnaryExpression {
  ...
  implicit class UnaryExpressionOps[Self <: UnaryExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOperator(value: UnaryOperator): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("operator")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPrefix(value: `true`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prefix")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: typingsSlinky.estree.estreeStrings.UnaryExpression): Self = {
        val ret = this.duplicate
