...
trait WhileStatement
  ...
  @JSName("type")
  var type_WhileStatement: typingsSlinky.estree.estreeStrings.WhileStatement = js.native
}
object WhileStatement {
  
  @scala.inline
  def apply(body: Statement, test: Expression, `type`: typingsSlinky.estree.estreeStrings.WhileStatement): WhileStatement = {
  ...
  implicit class WhileStatementMutableBuilder[Self <: WhileStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.estree.estreeStrings.WhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
