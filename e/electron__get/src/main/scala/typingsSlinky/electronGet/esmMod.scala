...
import typingsSlinky.electronGet.esmTypesMod.ElectronDownloadRequestOptions
import typingsSlinky.electronGet.esmTypesMod.ElectronPlatformArtifactDetailsWithDefaults
