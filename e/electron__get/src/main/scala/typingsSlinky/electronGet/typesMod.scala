...
object typesMod {
  ...
  */
  ...
  object ElectronArtifactDetails {
    ...
    @scala.inline
    def ElectronGenericArtifactDetails(artifactName: String, isGeneric: `true`, version: String): typingsSlinky.electronGet.typesMod.ElectronGenericArtifactDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.electronGet.typesMod.ElectronGenericArtifactDetails]
    }
    
    @scala.inline
    def ElectronPlatformArtifactDetails(arch: String, artifactName: String, platform: String, version: String): typingsSlinky.electronGet.typesMod.ElectronPlatformArtifactDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.electronGet.typesMod.ElectronPlatformArtifactDetails]
    }
  }
  ...
  */
  ...
  object ElectronPlatformArtifactDetailsWithDefaults {
    ...
    @scala.inline
    def OmitElectronPlatformArtif(artifactName: String, version: String): typingsSlinky.electronGet.anon.OmitElectronPlatformArtif = {
      val __obj = js.Dynamic.literal(artifactName = artifactName.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.electronGet.anon.OmitElectronPlatformArtif]
    }
  }
