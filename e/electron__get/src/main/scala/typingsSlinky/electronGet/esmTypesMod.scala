...
import typingsSlinky.electronGet.esmDownloaderMod.Downloader
...
object esmTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.electronGet.esmTypesMod.ElectronPlatformArtifactDetails
    - typingsSlinky.electronGet.esmTypesMod.ElectronGenericArtifactDetails
  */
  trait ElectronArtifactDetails extends StObject
  object ElectronArtifactDetails {
    
    @scala.inline
    def ElectronGenericArtifactDetails(artifactName: String, isGeneric: `true`, version: String): typingsSlinky.electronGet.esmTypesMod.ElectronGenericArtifactDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.electronGet.esmTypesMod.ElectronGenericArtifactDetails]
    }
    
    @scala.inline
    def ElectronPlatformArtifactDetails(arch: String, artifactName: String, platform: String, version: String): typingsSlinky.electronGet.esmTypesMod.ElectronPlatformArtifactDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.electronGet.esmTypesMod.ElectronPlatformArtifactDetails]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.electronGet.anon.OmitElectronPlatformArtifArch
    - typingsSlinky.electronGet.esmTypesMod.ElectronGenericArtifactDetails
  */
  ...
  object ElectronPlatformArtifactDetailsWithDefaults {
    ...
    @scala.inline
    def OmitElectronPlatformArtifArch(artifactName: String, version: String): typingsSlinky.electronGet.anon.OmitElectronPlatformArtifArch = {
      val __obj = js.Dynamic.literal(artifactName = artifactName.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.electronGet.anon.OmitElectronPlatformArtifArch]
    }
  }
