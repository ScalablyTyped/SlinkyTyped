...
import typingsSlinky.ethersprojectJsonWallets.anon.N
...
object keystoreMod {
  ...
  class KeystoreAccount protected ()
    ...
    {[ K in 'address' | 'privateKey' | 'mnemonic' | '_isKeystoreAccount' ]: @ethersproject/json-wallets.@ethersproject/json-wallets/lib/keystore._KeystoreAccount[K]}
      */ typingsSlinky.ethersprojectJsonWallets.ethersprojectJsonWalletsStrings.KeystoreAccount with TopLevel[_KeystoreAccount]) = this()
