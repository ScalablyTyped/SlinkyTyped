package typingsSlinky.electronUnhandled
...
object mod {
  ...
  object UnhandledOptions {
    ...
    implicit class UnhandledOptionsMutableBuilder[Self <: UnhandledOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLogger(value: /* error */ js.Error => Unit): Self = StObject.set(x, "logger", js.Any.fromFunction1(value))
      
      @scala.inline
      def setLoggerUndefined: Self = StObject.set(x, "logger", js.undefined)
      
      @scala.inline
      def setReportButton(value: /* error */ js.Error => Unit): Self = StObject.set(x, "reportButton", js.Any.fromFunction1(value))
