...
object AnonExists {
  @scala.inline
  def apply(exists: `true`, isDirectory: Boolean, modificationTime: Double, size: Double, uri: String): AnonExists = {
  ...
  @scala.inline
  implicit class AnonExistsOps[Self <: AnonExists] (val x: Self) extends AnyVal {
    @scala.inline
