...
object expoDashFileDashSystemMod extends js.Object {
  ...
  class DownloadResumable protected ()
    extends typingsSlinky.expoDashFileDashSystem.buildFileSystemMod.DownloadResumable {
  ...
  def createDownloadResumable(uri: String, fileUri: String): typingsSlinky.expoDashFileDashSystem.buildFileSystemMod.DownloadResumable = js.native
  def createDownloadResumable(uri: String, fileUri: String, options: DownloadOptions): typingsSlinky.expoDashFileDashSystem.buildFileSystemMod.DownloadResumable = js.native
  def createDownloadResumable(uri: String, fileUri: String, options: DownloadOptions, callback: DownloadProgressCallback): typingsSlinky.expoDashFileDashSystem.buildFileSystemMod.DownloadResumable = js.native
  def createDownloadResumable(
    ...
    callback: DownloadProgressCallback,
    resumeData: String
  ): typingsSlinky.expoDashFileDashSystem.buildFileSystemMod.DownloadResumable = js.native
