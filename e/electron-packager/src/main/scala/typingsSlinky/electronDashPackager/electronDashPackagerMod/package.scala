...
package object electronDashPackagerMod {
  import typingsSlinky.electronDashPackager.electronDashPackagerStrings.appBundleId
  import typingsSlinky.electronDashPackager.electronDashPackagerStrings.appPath
  ...
  /**
    ...
    */
  type finalCallback = js.Function2[/* err */ js.Error, /* appPaths */ String | js.Array[String], Unit]
