...
import typingsSlinky.electronDashPackager.Anon_Name
import typingsSlinky.electronDashPackager.electronDashPackagerBooleans.`false`
...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var arch: js.UndefOr[
    typingsSlinky.electronDashPackager.electronDashPackagerMod.arch | js.Array[typingsSlinky.electronDashPackager.electronDashPackagerMod.arch]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var platform: js.UndefOr[typingsSlinky.electronDashPackager.electronDashPackagerMod.platform] = js.undefined
  /**
