...
object CreateConfig {
  ...
  implicit class CreateConfigOps[Self <: CreateConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCryptoHexEncodedHash256(value: /* data */ String | js.typedarray.ArrayBuffer | Null => String): Self = this.set("cryptoHexEncodedHash256", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setCryptoMd5Method(value: /* data */ js.typedarray.ArrayBuffer => String): Self = this.set("cryptoMd5Method", js.Any.fromFunction1(value))
    @scala.inline
