...
object Details {
  ...
  implicit class DetailsOps[Self <: Details] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeoIp(value: StringDictionary[js.Any]): Self = this.set("geoIp", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIsWindowsPhone(value: Boolean): Self = this.set("isWindowsPhone", value.asInstanceOf[js.Any])
    @scala.inline
