...
/* Inlined ejs.ejs.Options & {  async ? :false,   client ? :false} */
@js.native
trait Optionsasyncfalseclientfa extends js.Object {
  /**
  ...
  /**
  	 ...
  	 * @default false
  	 */
  var client: js.UndefOr[Boolean with `false`] = js.native
  /**
...
object Optionsasyncfalseclientfa {
  @scala.inline
  def apply(): Optionsasyncfalseclientfa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Optionsasyncfalseclientfa]
  }
  @scala.inline
  implicit class OptionsasyncfalseclientfaOps[Self <: Optionsasyncfalseclientfa] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClient(value: Boolean with `false`): Self = {
        val ret = this.duplicate
