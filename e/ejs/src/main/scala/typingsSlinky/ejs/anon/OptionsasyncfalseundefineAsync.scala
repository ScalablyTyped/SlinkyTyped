package typingsSlinky.ejs.anon
...
@js.native
trait OptionsasyncfalseundefineAsync extends js.Object {
  /**
...
object OptionsasyncfalseundefineAsync {
  ...
  @scala.inline
  implicit class OptionsasyncfalseundefineAsyncOps[Self <: OptionsasyncfalseundefineAsync] (val x: Self) extends AnyVal {
    @scala.inline
