...
@js.native
trait Optionsasyncfalse extends js.Object {
  /**
...
object Optionsasyncfalse {
  @scala.inline
  def apply(): Optionsasyncfalse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Optionsasyncfalse]
  }
  @scala.inline
  implicit class OptionsasyncfalseOps[Self <: Optionsasyncfalse] (val x: Self) extends AnyVal {
    @scala.inline
