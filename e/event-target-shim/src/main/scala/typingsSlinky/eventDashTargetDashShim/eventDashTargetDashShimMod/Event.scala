...
import typingsSlinky.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget._EventData
import typingsSlinky.eventDashTargetDashShim.eventDashTargetDashShimStrings.standard
