...
object PartialPickEventOmittable {
  @scala.inline
  def apply[/* <: typingsSlinky.eventTargetShim.mod.EventTarget.EventDefinition */ TEvents](): PartialPickEventOmittable[TEvents] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickEventOmittable[TEvents]]
  }
  @scala.inline
  implicit class PartialPickEventOmittableOps[Self <: PartialPickEventOmittable[_], /* <: typingsSlinky.eventTargetShim.mod.EventTarget.EventDefinition */ TEvents] (val x: Self with PartialPickEventOmittable[TEvents]) extends AnyVal {
    @scala.inline
