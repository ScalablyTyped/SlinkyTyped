...
package object EventTarget {
  ...
  {[ P in keyof TEventAttributes ]: event-target-shim.event-target-shim.EventTarget.FunctionListener<TEventAttributes[P]> | null}
    */ typingsSlinky.eventTargetShim.eventTargetShimStrings.EventAttributes with TEventAttributes
  ...
  ]]) with typingsSlinky.eventTargetShim.PartialPickEventOmittable
  */
  type EventData[TEvents /* <: typingsSlinky.eventTargetShim.mod.EventTarget.EventDefinition */, TEventType /* <: java.lang.String */, TMode /* <: typingsSlinky.eventTargetShim.mod.EventTarget.Mode */] = (typingsSlinky.eventTargetShim.mod.EventTarget._EventData[TEvents, TEventType, TMode]) | ((typingsSlinky.std.Pick[
    /* import warning: importer.ImportType#apply Failed type conversion: TEvents[TEventType] */ js.Any, 
    typingsSlinky.std.Exclude[
      /* import warning: importer.ImportType#apply Failed type conversion: keyof TEvents[TEventType] */ js.Any, 
      typingsSlinky.eventTargetShim.mod.EventTarget.OmittableEventKeys
  ...
  type EventType[TEvents /* <: typingsSlinky.eventTargetShim.mod.EventTarget.EventDefinition */, TMode /* <: typingsSlinky.eventTargetShim.mod.EventTarget.Mode */] = java.lang.String
  ...
  type PickEvent[TEvents /* <: typingsSlinky.eventTargetShim.mod.EventTarget.EventDefinition */, TEventType /* <: java.lang.String */] = typingsSlinky.eventTargetShim.mod.Event | (/* import warning: importer.ImportType#apply Failed type conversion: TEvents[TEventType] */ js.Any)
}
