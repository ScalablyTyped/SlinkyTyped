...
Instantiable0[Serial] {
  ...
  def on(eventName: String, f: js.Function1[/* str */ String, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def print(string: js.Any): Unit = js.native
  /**
    ...
    */
  def println(string: js.Any): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setConsole(force: Boolean): Unit = js.native
  def setup(baudrate: Double, options: js.Any): Unit = js.native
  /**
