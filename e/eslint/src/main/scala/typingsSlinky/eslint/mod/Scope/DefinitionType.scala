...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.eslint.AnonNode
  - typingsSlinky.eslint.AnonParent
  - typingsSlinky.eslint.AnonType
  - typingsSlinky.eslint.AnonNodeParent
  - typingsSlinky.eslint.AnonParentType
  - typingsSlinky.eslint.AnonNodeParentType
  - typingsSlinky.eslint.AnonNodeAny
  - typingsSlinky.eslint.AnonNodeVariableDeclarator
*/
...
object DefinitionType {
  ...
  @scala.inline
  def AnonNode(node: CatchClause, parent: Null, `type`: typingsSlinky.eslint.eslintStrings.CatchClause): DefinitionType = {
    val __obj = js.Dynamic.literal(node = node.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefinitionType]
  }
