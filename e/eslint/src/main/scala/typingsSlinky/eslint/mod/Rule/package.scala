...
package object Rule {
  ...
  type SuggestionReportDescriptor = typingsSlinky.eslint.mod.Rule.SuggestionDescriptorMessage with typingsSlinky.eslint.mod.Rule.ReportDescriptorOptionsBase
}
