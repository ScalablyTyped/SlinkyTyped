...
trait Scope extends js.Object {
  var block: Node
  var childScopes: js.Array[typingsSlinky.eslint.mod.Scope.Scope]
  ...
  var upper: typingsSlinky.eslint.mod.Scope.Scope | Null
  var variableScope: typingsSlinky.eslint.mod.Scope.Scope
