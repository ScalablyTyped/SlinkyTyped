...
object textSupportMod extends Shortcut {
  ...
  @js.native
  val default: typingsSlinky.emberObject.mixinMod.default[TextSupport, typingsSlinky.emberObject.mod.default] = js.native
  ...
  type _To = typingsSlinky.emberObject.mixinMod.default[TextSupport, typingsSlinky.emberObject.mod.default]
  
  /* This means you don't have to write `default`, but can instead just say `textSupportMod.foo` */
  override def _to: typingsSlinky.emberObject.mixinMod.default[TextSupport, typingsSlinky.emberObject.mod.default] = default
}
