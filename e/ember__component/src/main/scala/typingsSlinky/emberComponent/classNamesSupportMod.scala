...
object classNamesSupportMod extends Shortcut {
  ...
  @js.native
  val default: typingsSlinky.emberObject.mixinMod.default[ClassNamesSupport, typingsSlinky.emberObject.mod.default] = js.native
  ...
  type _To = typingsSlinky.emberObject.mixinMod.default[ClassNamesSupport, typingsSlinky.emberObject.mod.default]
  
  /* This means you don't have to write `default`, but can instead just say `classNamesSupportMod.foo` */
  override def _to: typingsSlinky.emberObject.mixinMod.default[ClassNamesSupport, typingsSlinky.emberObject.mod.default] = default
}
