...
@js.native
object dashPrivateViewDashMixinMod extends js.Object {
  @js.native
  ...
  val default: typingsSlinky.atEmberObject.mixinMod.default[ViewMixin, typingsSlinky.atEmberObject.atEmberObjectMod.default] = js.native
}
