...
object distMod {
  ...
  */
  ...
  {[ P in @esfx/type-model.@esfx/type-model/dist.AnyKeyof<T> ]: @esfx/type-model.@esfx/type-model/dist.AnyExtract<T, {readonly [ U in P ]: unknown}>[P]}
    */ typingsSlinky.esfxTypeModel.esfxTypeModelStrings.Conjoin with (TopLevel[
    AnyExtract[
      T, 
      /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {readonly [ U in P ]: unknown}
    */ typingsSlinky.esfxTypeModel.esfxTypeModelStrings.Conjoin with TopLevel[js.Any]
    ]
  ])
  ...
  */
  ...
  {-readonly [ P in keyof T ]: T[P]}
    */ typingsSlinky.esfxTypeModel.esfxTypeModelStrings.Mutable with TopLevel[T]
