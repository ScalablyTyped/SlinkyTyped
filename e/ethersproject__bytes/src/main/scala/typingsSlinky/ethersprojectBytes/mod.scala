...
import typingsSlinky.ethersprojectBytes.anon.R
import typingsSlinky.ethersprojectBytes.ethersprojectBytesStrings.left
import typingsSlinky.ethersprojectBytes.ethersprojectBytesStrings.right
