...
@js.native
class ModelMgr ()
  extends typingsSlinky.extjs.Ext.ModelMgr
/* static members */
object ModelMgr {
  ...
  @js.native
  def associationStack: typingsSlinky.extjs.Ext.Array = js.native
  @scala.inline
  def associationStack_=(x: typingsSlinky.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("associationStack")(x.asInstanceOf[js.Any])
