...
@js.native
class ComponentMgr ()
  extends typingsSlinky.extjs.Ext.ComponentMgr
/* static members */
object ComponentMgr {
  ...
  /** [Method] Executes the specified function once for each item in the collection
    ...
    */
  @JSGlobal("Ext.ComponentMgr.each")
  @js.native
  ...
  /** [Method] Gets the number of items in the collection
    ...
    */
  @JSGlobal("Ext.ComponentMgr.getCount")
  @js.native
  ...
  /** [Method] Registers a function that will be called when an item with the specified id is added to the manager
    ...
    */
  @JSGlobal("Ext.ComponentMgr.onAvailable")
  @js.native
  ...
  /** [Method] Registers a new item constructor keyed by a type key
    ...
    * @param cls Object
    */
  @JSGlobal("Ext.ComponentMgr.registerType")
  @js.native
