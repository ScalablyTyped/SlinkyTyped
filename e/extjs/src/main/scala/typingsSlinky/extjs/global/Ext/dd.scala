...
object dd {
  ...
  @js.native
  class DDM ()
    extends typingsSlinky.extjs.Ext.dd.DDM
  /* static members */
  object DDM {
    ...
    @JSGlobal("Ext.dd.DDM.getBestMatch")
    @js.native
    def getBestMatch(dds: typingsSlinky.extjs.Ext.Array): IDragDrop = js.native
    ...
    @js.native
    def getRelated(): typingsSlinky.extjs.Ext.Array = js.native
    @JSGlobal("Ext.dd.DDM.getRelated")
    @js.native
    def getRelated(p_oDD: js.UndefOr[scala.Nothing], bTargetsOnly: Boolean): typingsSlinky.extjs.Ext.Array = js.native
    @JSGlobal("Ext.dd.DDM.getRelated")
    @js.native
    def getRelated(p_oDD: IDragDrop): typingsSlinky.extjs.Ext.Array = js.native
    @JSGlobal("Ext.dd.DDM.getRelated")
    @js.native
    def getRelated(p_oDD: IDragDrop, bTargetsOnly: Boolean): typingsSlinky.extjs.Ext.Array = js.native
  ...
  class DragDropManager_ ()
    extends typingsSlinky.extjs.Ext.dd.DragDropManager_
  /* static members */
  ...
  @js.native
  class DragDropMgr ()
    extends typingsSlinky.extjs.Ext.dd.DragDropMgr
  /* static members */
  object DragDropMgr {
  ...
  @js.native
  class Registry ()
    extends typingsSlinky.extjs.Ext.dd.Registry
  /* static members */
  object Registry {
