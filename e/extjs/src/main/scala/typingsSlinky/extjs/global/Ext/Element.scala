...
@js.native
class Element ()
  extends typingsSlinky.extjs.Ext.Element
/* static members */
@JSGlobal("Ext.Element")
@js.native
object Element extends js.Object {
  ...
  /** [Method] Returns an array of unique class names based upon the input strings or string arrays
    ...
    */
  def mergeClsList(): typingsSlinky.extjs.Ext.Array = js.native
  def mergeClsList(clsList1: js.UndefOr[scala.Nothing], clsList2: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  def mergeClsList(clsList1: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  def mergeClsList(clsList1: js.Any, clsList2: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  ...
  /** [Method] Returns an array of unique class names deom the first parameter with all class names from the second parameter removed
    ...
    */
  def removeCls(): typingsSlinky.extjs.Ext.Array = js.native
  def removeCls(existingClsList: js.UndefOr[scala.Nothing], removeClsList: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  def removeCls(existingClsList: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  def removeCls(existingClsList: js.Any, removeClsList: js.Any): typingsSlinky.extjs.Ext.Array = js.native
