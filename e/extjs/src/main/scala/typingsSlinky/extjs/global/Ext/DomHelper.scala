...
@js.native
class DomHelper ()
  extends typingsSlinky.extjs.Ext.DomHelper
/* static members */
object DomHelper {
  ...
  /** [Method] Applies a style specification to an element
    ...
    */
  @JSGlobal("Ext.DomHelper.applyStyles")
  @js.native
  ...
  /** [Method] Call the original method that was previously overridden with override Ext define My Cat  constructor functi
    ...
    */
  @JSGlobal("Ext.DomHelper.callOverridden")
  @js.native
  ...
  /** [Method] Call the parent method of the current method
    ...
    */
  @JSGlobal("Ext.DomHelper.callParent")
  @js.native
  ...
  /** [Method] This method is used by an override to call the superclass method but bypass any overridden method
    ...
    */
  @JSGlobal("Ext.DomHelper.callSuper")
  @js.native
  ...
  /** [Method] Creates new DOM element s without inserting them to the document
    ...
    */
  @JSGlobal("Ext.DomHelper.createDom")
  @js.native
  ...
  /** [Method] Alias for markup
    ...
    * @returns String
    */
  @JSGlobal("Ext.DomHelper.createHtml")
  @js.native
  ...
  /** [Method] Creates a new Ext Template from the DOM object spec
    ...
    */
  @JSGlobal("Ext.DomHelper.createTemplate")
  @js.native
  ...
  /** [Method] Converts the styles from the given object to text
    ...
    */
  @JSGlobal("Ext.DomHelper.generateStyles")
  @js.native
  def generateStyles(): js.Any = js.native
  @JSGlobal("Ext.DomHelper.generateStyles")
  @js.native
  def generateStyles(styles: js.UndefOr[scala.Nothing], buffer: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  @JSGlobal("Ext.DomHelper.generateStyles")
  @js.native
  def generateStyles(styles: js.Any): js.Any = js.native
  @JSGlobal("Ext.DomHelper.generateStyles")
  @js.native
  def generateStyles(styles: js.Any, buffer: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  
  /** [Method] Returns the initial configuration passed to constructor when instantiating this class
    * @param name String Name of the config option to return.
    * @returns Object/Mixed The full config object or a single config value when name parameter specified.
    */
  @JSGlobal("Ext.DomHelper.getInitialConfig")
  @js.native
  ...
  /** [Method] Initialize configuration for this class
    ...
    */
  @JSGlobal("Ext.DomHelper.initConfig")
  @js.native
  ...
  /** [Method] Creates new DOM element s and inserts them after el
    ...
    * @returns HTMLElement/Ext.Element The new node
    */
  @JSGlobal("Ext.DomHelper.insertAfter")
  @js.native
  ...
  /** [Method] Creates new DOM element s and inserts them before el
    ...
    * @returns HTMLElement/Ext.Element The new node
    */
  @JSGlobal("Ext.DomHelper.insertBefore")
  @js.native
  ...
  /** [Method] Creates new DOM element s and inserts them as the first child of el
    ...
    * @returns HTMLElement/Ext.Element The new node
    */
  @JSGlobal("Ext.DomHelper.insertFirst")
  @js.native
  ...
  /** [Method] Inserts an HTML fragment into the DOM
    ...
    */
  @JSGlobal("Ext.DomHelper.insertHtml")
  @js.native
  ...
  /** [Method] Creates new DOM element s and overwrites the contents of el with them
    ...
    * @returns HTMLElement/Ext.Element The new node
    */
  @JSGlobal("Ext.DomHelper.overwrite")
  @js.native
  ...
  /** [Method] Get the reference to the class from which this object was instantiated
    * @returns Ext.Class
    */
  @JSGlobal("Ext.DomHelper.statics")
  @js.native
