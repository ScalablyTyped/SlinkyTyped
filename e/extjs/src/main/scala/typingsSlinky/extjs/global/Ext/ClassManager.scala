...
import typingsSlinky.extjs.Ext.IClassManager
...
@js.native
class ClassManager ()
  extends typingsSlinky.extjs.Ext.ClassManager
/* static members */
object ClassManager {
  ...
  @js.native
  def getAliasesByName(): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.ClassManager.getAliasesByName")
  @js.native
  def getAliasesByName(name: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  ...
  @js.native
  def getNamesByExpression(): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.ClassManager.getNamesByExpression")
  @js.native
  def getNamesByExpression(expression: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
