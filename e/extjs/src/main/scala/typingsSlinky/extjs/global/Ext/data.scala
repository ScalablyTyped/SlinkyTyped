...
object data {
  ...
  @js.native
  class AbstractStore ()
    extends typingsSlinky.extjs.Ext.data.AbstractStore
  /* static members */
  ...
  @js.native
  class Model ()
    extends typingsSlinky.extjs.Ext.data.Model
  /* static members */
  object Model {
    ...
    @js.native
    def getFields(): typingsSlinky.extjs.Ext.Array = js.native
  ...
  @js.native
  class Record ()
    extends typingsSlinky.extjs.Ext.data.Record
  /* static members */
  object Record {
  ...
  @js.native
  class StoreManager ()
    extends typingsSlinky.extjs.Ext.data.StoreManager
  /* static members */
  object StoreManager {
