...
object bind extends js.Object {
  ...
  def apply(fn: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def apply(
    fn: js.UndefOr[scala.Nothing],
    scope: js.Any,
    args: typingsSlinky.extjs.Ext.Array,
  ...
  def apply(fn: js.Any, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def apply(
    fn: js.Any,
    scope: js.UndefOr[scala.Nothing],
    args: typingsSlinky.extjs.Ext.Array,
  ...
  def apply(fn: js.Any, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def apply(fn: js.Any, scope: js.Any, args: typingsSlinky.extjs.Ext.Array, appendArgs: js.Any): js.Any = js.native
}
