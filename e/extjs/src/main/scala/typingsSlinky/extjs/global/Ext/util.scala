...
object util {
  ...
  object Filter {
    ...
    @JSGlobal("Ext.util.Filter.createFilterFn")
    @js.native
    def createFilterFn(filters: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  ...
  @js.native
  class Inflector ()
    extends typingsSlinky.extjs.Ext.util.Inflector
  /* static members */
  object Inflector {
  ...
  @js.native
  class Point ()
    extends typingsSlinky.extjs.Ext.util.Point
  /* static members */
  object Point {
  ...
  @js.native
  class Sortable ()
    extends typingsSlinky.extjs.Ext.util.Sortable
  /* static members */
  object Sortable {
    ...
    @JSGlobal("Ext.util.Sortable.createComparator")
    @js.native
    def createComparator(sorters: typingsSlinky.extjs.Ext.Array): js.Any = js.native
