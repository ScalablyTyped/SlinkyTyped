...
@js.native
class StoreManager ()
  extends typingsSlinky.extjs.Ext.StoreManager
/* static members */
object StoreManager {
  ...
  /** [Method] Adds the specified events to the list of events which this Observable may fire
    ...
    */
  @JSGlobal("Ext.StoreManager.addEvents")
  @js.native
  ...
  /** [Method] Appends an event handler to this object
    ...
    */
  @JSGlobal("Ext.StoreManager.addListener")
  @js.native
  ...
  /** [Method] Adds listeners to any Observable object or Ext Element which are automatically removed when this Component is destr
    ...
    */
  @JSGlobal("Ext.StoreManager.addManagedListener")
  @js.native
  ...
  @JSGlobal("Ext.StoreManager.clearListeners")
  @js.native
  def clearListeners(): Unit = js.native
  
  /** [Method] Removes all managed listeners for this object  */
  @JSGlobal("Ext.StoreManager.clearManagedListeners")
  @js.native
  ...
  /** [Method] Collects unique values of a particular property in this MixedCollection
    ...
    */
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: js.UndefOr[scala.Nothing], root: js.UndefOr[scala.Nothing], allowBlank: Boolean): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: js.UndefOr[scala.Nothing], root: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: js.UndefOr[scala.Nothing], root: java.lang.String, allowBlank: Boolean): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: java.lang.String, root: js.UndefOr[scala.Nothing], allowBlank: Boolean): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: java.lang.String, root: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.collect")
  @js.native
  def collect(property: java.lang.String, root: java.lang.String, allowBlank: Boolean): typingsSlinky.extjs.Ext.Array = js.native
  ...
  /** [Method] Enables events fired by this Observable to bubble up an owner hierarchy by calling this getBubbleTarget  if present
    ...
    */
  @JSGlobal("Ext.StoreManager.enableBubble")
  @js.native
  ...
  @JSGlobal("Ext.StoreManager.find")
  @js.native
  ...
  /** [Method] Finds the index of the first matching object in this collection by a specific property value
    ...
    */
  @JSGlobal("Ext.StoreManager.findIndex")
  @js.native
  ...
  /** [Method] Fires the specified event with the passed parameters minus the event name plus the options object passed to addList
    ...
    */
  @JSGlobal("Ext.StoreManager.fireEvent")
  @js.native
  ...
  /** [Method] Fires the specified event with the passed parameter list
    ...
    * @returns Boolean returns false if any of the handlers return false otherwise it returns true.
    */
  @JSGlobal("Ext.StoreManager.fireEventArgs")
  @js.native
  ...
  @JSGlobal("Ext.StoreManager.generateComparator")
  @js.native
  ...
  /** [Method] Gets the first sorter from the sorters collection excluding any groupers that may be in place
    ...
    */
  @JSGlobal("Ext.StoreManager.getFirstSorter")
  @js.native
  ...
  @js.native
  def getRange(): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.getRange")
  @js.native
  def getRange(startIndex: js.UndefOr[scala.Nothing], endIndex: Double): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.getRange")
  @js.native
  def getRange(startIndex: Double): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.getRange")
  @js.native
  def getRange(startIndex: Double, endIndex: Double): typingsSlinky.extjs.Ext.Array = js.native
  
  /** [Method] Checks to see if this object has any listeners for a specified event or whether the event bubbles
    * @param eventName String The name of the event to check for
    * @returns Boolean true if the event is being listened for or bubbles, else false
    */
  @JSGlobal("Ext.StoreManager.hasListener")
  @js.native
  ...
  @JSGlobal("Ext.StoreManager.initSortable")
  @js.native
  ...
  /** [Method] Relays selected events from the specified Observable as if the events were fired by this
    ...
    */
  @JSGlobal("Ext.StoreManager.relayEvents")
  @js.native
  ...
  @JSGlobal("Ext.StoreManager.removeAll")
  @js.native
  def removeAll(items: typingsSlinky.extjs.Ext.Array): IMixedCollection = js.native
  ...
  /** [Method] Removes an event handler
    ...
    */
  @JSGlobal("Ext.StoreManager.removeListener")
  @js.native
  ...
  /** [Method] Removes listeners that were added by the mon method
    ...
    * @param scope Object If the ename parameter was an event name, this is the scope (this reference) in which the handler function is executed.
    */
  @JSGlobal("Ext.StoreManager.removeManagedListener")
  @js.native
  ...
  /** [Method] Remove a range of items starting at a specified index in the collection
    ...
    */
  @JSGlobal("Ext.StoreManager.removeRange")
  @js.native
  ...
  /** [Method] Reorders each of the items based on a mapping from old index to new index
    ...
    */
  @JSGlobal("Ext.StoreManager.reorder")
  @js.native
  ...
  /** [Method] Resumes firing of the named event s
    ...
    */
  @JSGlobal("Ext.StoreManager.resumeEvent")
  @js.native
  def resumeEvent(eventName: js.Any*): Unit = js.native
  
  /** [Method] Resumes firing events see suspendEvents */
  @JSGlobal("Ext.StoreManager.resumeEvents")
  @js.native
  ...
  @JSGlobal("Ext.StoreManager.sort")
  @js.native
  def sort(sorters: js.UndefOr[scala.Nothing], direction: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.sort")
  @js.native
  def sort(sorters: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.StoreManager.sort")
  @js.native
  def sort(sorters: js.Any, direction: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  
  /** [Method] Sorts the collection by a single sorter function
    * @param sorterFn Function The function to sort by
    */
  @JSGlobal("Ext.StoreManager.sortBy")
  @js.native
  ...
  /** [Method] Sorts this collection by keys
    ...
    */
  @JSGlobal("Ext.StoreManager.sortByKey")
  @js.native
  ...
  /** [Method] Suspends firing of the named event s
    ...
    */
  @JSGlobal("Ext.StoreManager.suspendEvent")
  @js.native
  ...
  /** [Method] Suspends the firing of all events
    ...
    */
  @JSGlobal("Ext.StoreManager.suspendEvents")
  @js.native
  ...
  /** [Method] Change the key for an existing item in the collection
    ...
    */
  @JSGlobal("Ext.StoreManager.updateKey")
  @js.native
