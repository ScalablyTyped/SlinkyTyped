...
class ComponentQuery ()
  extends typingsSlinky.extjs.Ext.ComponentQuery
/* static members */
object ComponentQuery {
  ...
  @JSGlobal("Ext.ComponentQuery.query")
  @js.native
  def query(selector: js.UndefOr[scala.Nothing], root: IContainer): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.ComponentQuery.query")
  @js.native
  def query(selector: java.lang.String): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.ComponentQuery.query")
  @js.native
  def query(selector: java.lang.String, root: IContainer): typingsSlinky.extjs.Ext.Array = js.native
