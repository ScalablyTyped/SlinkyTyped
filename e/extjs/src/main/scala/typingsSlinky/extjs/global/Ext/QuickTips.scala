...
import typingsSlinky.extjs.Ext.tip.IQuickTip
...
@js.native
class QuickTips ()
  extends typingsSlinky.extjs.Ext.QuickTips
/* static members */
object QuickTips {
  ...
  /** [Method] Call the original method that was previously overridden with override Ext define My Cat  constructor functi
    ...
    */
  @JSGlobal("Ext.QuickTips.callOverridden")
  @js.native
  ...
  /** [Method] Call the parent method of the current method
    ...
    */
  @JSGlobal("Ext.QuickTips.callParent")
  @js.native
  ...
  /** [Method] This method is used by an override to call the superclass method but bypass any overridden method
    ...
    */
  @JSGlobal("Ext.QuickTips.callSuper")
  @js.native
  ...
  @JSGlobal("Ext.QuickTips.destroy")
  @js.native
  def destroy(): Unit = js.native
  
  /** [Method] Disables quick tips globally  */
  @JSGlobal("Ext.QuickTips.disable")
  @js.native
  def disable(): Unit = js.native
  
  /** [Method] Enables quick tips globally  */
  @JSGlobal("Ext.QuickTips.enable")
  @js.native
  ...
  /** [Method] Returns the initial configuration passed to constructor when instantiating this class
    ...
    */
  @JSGlobal("Ext.QuickTips.getInitialConfig")
  @js.native
  ...
  /** [Method] Gets the single QuickTip instance used to show tips from all registered elements
    ...
    */
  @JSGlobal("Ext.QuickTips.getQuickTip")
  @js.native
  ...
  /** [Method] Initialize configuration for this class
    ...
    */
  @JSGlobal("Ext.QuickTips.initConfig")
  @js.native
  ...
  /** [Method] Returns true if quick tips are enabled else false
    * @returns Boolean
    */
  @JSGlobal("Ext.QuickTips.isEnabled")
  @js.native
  ...
  /** [Method] Configures a new quick tip instance and assigns it to a target element
    ...
    */
  @JSGlobal("Ext.QuickTips.register")
  @js.native
  ...
  /** [Method] Get the reference to the class from which this object was instantiated
    * @returns Ext.Class
    */
  @JSGlobal("Ext.QuickTips.statics")
  @js.native
  ...
  /** [Method] Removes any registered quick tip from the target element and destroys it
    ...
    */
  @JSGlobal("Ext.QuickTips.unregister")
  @js.native
