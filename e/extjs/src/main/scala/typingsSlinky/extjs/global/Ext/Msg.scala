...
@js.native
class Msg ()
  extends typingsSlinky.extjs.Ext.Msg
/* static members */
object Msg {
  ...
  @js.native
  def floatParent: typingsSlinky.extjs.Ext.IContainer = js.native
  @scala.inline
  def floatParent_=(x: typingsSlinky.extjs.Ext.IContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("floatParent")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def ownerCt: typingsSlinky.extjs.Ext.IContainer = js.native
  @scala.inline
  def ownerCt_=(x: typingsSlinky.extjs.Ext.IContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ownerCt")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def zIndexParent: typingsSlinky.extjs.Ext.IContainer = js.native
  @scala.inline
  def zIndexParent_=(x: typingsSlinky.extjs.Ext.IContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("zIndexParent")(x.asInstanceOf[js.Any])
}
