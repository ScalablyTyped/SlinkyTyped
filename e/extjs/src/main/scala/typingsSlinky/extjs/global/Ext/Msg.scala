...
object Msg extends js.Object {
  ...
  def cascade(
    ...
    scope: js.UndefOr[scala.Nothing],
    args: typingsSlinky.extjs.Ext.Array
  ): IContainer = js.native
  def cascade(fn: js.UndefOr[scala.Nothing], scope: js.Any): IContainer = js.native
  def cascade(fn: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): IContainer = js.native
  def cascade(fn: js.Any): IContainer = js.native
  def cascade(fn: js.Any, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): IContainer = js.native
  def cascade(fn: js.Any, scope: js.Any): IContainer = js.native
  def cascade(fn: js.Any, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): IContainer = js.native
