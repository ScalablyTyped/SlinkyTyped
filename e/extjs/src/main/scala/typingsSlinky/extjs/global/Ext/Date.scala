...
@js.native
class Date ()
  extends typingsSlinky.extjs.Ext.Date
/* static members */
object Date {
  ...
  @js.native
  def dayNames: typingsSlinky.extjs.Ext.Array = js.native
  @scala.inline
  def dayNames_=(x: typingsSlinky.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dayNames")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def monthNames: typingsSlinky.extjs.Ext.Array = js.native
  @scala.inline
  def monthNames_=(x: typingsSlinky.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("monthNames")(x.asInstanceOf[js.Any])
