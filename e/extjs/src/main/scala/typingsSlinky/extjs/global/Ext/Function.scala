...
@js.native
class Function ()
  extends typingsSlinky.extjs.Ext.Function
/* static members */
@JSGlobal("Ext.Function")
@js.native
object Function extends js.Object {
  ...
  def bind(fn: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def bind(
    fn: js.UndefOr[scala.Nothing],
    scope: js.Any,
    args: typingsSlinky.extjs.Ext.Array,
  ...
  def bind(fn: js.Any, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def bind(
    fn: js.Any,
    scope: js.UndefOr[scala.Nothing],
    args: typingsSlinky.extjs.Ext.Array,
  ...
  def bind(fn: js.Any, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def bind(fn: js.Any, scope: js.Any, args: typingsSlinky.extjs.Ext.Array, appendArgs: js.Any): js.Any = js.native
  ...
  def createBuffered(fn: js.UndefOr[scala.Nothing], buffer: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  ...
  def createBuffered(fn: js.Any, buffer: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def createBuffered(fn: js.Any, buffer: Double): js.Any = js.native
  def createBuffered(fn: js.Any, buffer: Double, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def createBuffered(fn: js.Any, buffer: Double, scope: js.Any): js.Any = js.native
  def createBuffered(fn: js.Any, buffer: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  ...
  def createDelayed(fn: js.UndefOr[scala.Nothing], delay: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def createDelayed(
    fn: js.UndefOr[scala.Nothing],
    delay: Double,
    scope: js.Any,
  ...
  def createDelayed(fn: js.Any, delay: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def createDelayed(
    fn: js.Any,
    delay: js.UndefOr[scala.Nothing],
    scope: js.Any,
  ...
  def createDelayed(fn: js.Any, delay: Double, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def createDelayed(
    fn: js.Any,
    delay: Double,
    scope: js.UndefOr[scala.Nothing],
  ...
  def createDelayed(fn: js.Any, delay: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def createDelayed(fn: js.Any, delay: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array, appendArgs: js.Any): js.Any = js.native
  ...
  def defer(fn: js.UndefOr[scala.Nothing], millis: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def defer(
    fn: js.UndefOr[scala.Nothing],
    millis: Double,
    scope: js.Any,
  ...
  def defer(fn: js.Any, millis: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def defer(
    fn: js.Any,
    millis: js.UndefOr[scala.Nothing],
    scope: js.Any,
  ...
  def defer(fn: js.Any, millis: Double, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def defer(
    fn: js.Any,
    millis: Double,
    scope: js.UndefOr[scala.Nothing],
  ...
  def defer(fn: js.Any, millis: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def defer(fn: js.Any, millis: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array, appendArgs: js.Any): Double = js.native
  ...
  def pass(fn: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def pass(fn: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array, scope: js.Any): js.Any = js.native
  def pass(fn: js.Any): js.Any = js.native
  def pass(fn: js.Any, args: js.UndefOr[scala.Nothing], scope: js.Any): js.Any = js.native
  def pass(fn: js.Any, args: typingsSlinky.extjs.Ext.Array): js.Any = js.native
  def pass(fn: js.Any, args: typingsSlinky.extjs.Ext.Array, scope: js.Any): js.Any = js.native
}
