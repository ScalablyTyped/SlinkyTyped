...
object defer extends js.Object {
  ...
  def apply(fn: js.UndefOr[scala.Nothing], millis: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def apply(
    fn: js.UndefOr[scala.Nothing],
    millis: Double,
    scope: js.Any,
  ...
  def apply(fn: js.Any, millis: js.UndefOr[scala.Nothing], scope: js.Any, args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def apply(
    fn: js.Any,
    millis: js.UndefOr[scala.Nothing],
    scope: js.Any,
  ...
  def apply(fn: js.Any, millis: Double, scope: js.UndefOr[scala.Nothing], args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def apply(
    fn: js.Any,
    millis: Double,
    scope: js.UndefOr[scala.Nothing],
  ...
  def apply(fn: js.Any, millis: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array): Double = js.native
  def apply(fn: js.Any, millis: Double, scope: js.Any, args: typingsSlinky.extjs.Ext.Array, appendArgs: js.Any): Double = js.native
}
