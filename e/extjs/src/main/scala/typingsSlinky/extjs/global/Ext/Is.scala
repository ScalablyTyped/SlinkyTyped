...
@js.native
class Is ()
  extends typingsSlinky.extjs.Ext.Is
/* static members */
object Is {
  ...
  @scala.inline
  def Standalone_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Standalone")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def iPad_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("iPad")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def iPhone_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("iPhone")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def iPod_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("iPod")(x.asInstanceOf[js.Any])
}
