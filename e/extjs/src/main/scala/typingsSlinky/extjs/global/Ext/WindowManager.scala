...
@js.native
class WindowManager ()
  extends typingsSlinky.extjs.Ext.WindowManager
/* static members */
object WindowManager {
  ...
  @js.native
  def getBy(): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.WindowManager.getBy")
  @js.native
  def getBy(fn: js.UndefOr[scala.Nothing], scope: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.WindowManager.getBy")
  @js.native
  def getBy(fn: js.Any): typingsSlinky.extjs.Ext.Array = js.native
  @JSGlobal("Ext.WindowManager.getBy")
  @js.native
  def getBy(fn: js.Any, scope: js.Any): typingsSlinky.extjs.Ext.Array = js.native
