...
object IPanel {
  ...
  def apply(
    ...
    collapse: (/* direction */ js.UndefOr[java.lang.String], /* animate */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.panel.IPanel = null,
    ...
    dd: js.Any = null,
    expand: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.panel.IPanel = null,
    fbar: js.Any = null,
    ...
    toggleCollapse: () => typingsSlinky.extjs.Ext.panel.IPanel = null,
    tools: js.Any = null
  ): IPanel = {
