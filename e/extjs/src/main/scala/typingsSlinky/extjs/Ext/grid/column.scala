...
object column {
  ...
  object IColumn {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.grid.column.IColumn = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.grid.column.IColumn]
    }
    
    @scala.inline
    implicit class IColumnMutableBuilder[Self <: typingsSlinky.extjs.Ext.grid.column.IColumn] (val x: Self) extends AnyVal {
  ...
  object IRowNumberer {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.grid.column.IRowNumberer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.grid.column.IRowNumberer]
    }
  }
