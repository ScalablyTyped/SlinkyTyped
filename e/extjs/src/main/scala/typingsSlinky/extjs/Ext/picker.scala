...
object picker {
  ...
  object IDate {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.picker.IDate = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.picker.IDate]
    }
    
    @scala.inline
    implicit class IDateMutableBuilder[Self <: typingsSlinky.extjs.Ext.picker.IDate] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ITime
    extends typingsSlinky.extjs.Ext.view.IBoundList {
