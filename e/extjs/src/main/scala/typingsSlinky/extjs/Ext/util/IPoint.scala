...
object IPoint {
  ...
  implicit class IPointOps[Self <: IPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEquals(value: /* p */ js.UndefOr[js.Any] => Boolean): Self = {
    ...
    @scala.inline
    def withIsContainedBy(value: /* region */ js.UndefOr[js.Any] => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isContainedBy")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutIsContainedBy: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isContainedBy")(js.undefined)
        ret
    }
    @scala.inline
    def withIsWithin(value: (/* p */ js.UndefOr[js.Any], /* threshold */ js.UndefOr[js.Any]) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isWithin")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRoundedEquals(value: /* p */ js.UndefOr[js.Any] => Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTranslate(value: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[Double]) => IRegion): Self = {
        val ret = this.duplicate
