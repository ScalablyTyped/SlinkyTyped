...
object ICompositeElementLite {
  ...
  implicit class ICompositeElementLiteOps[Self <: ICompositeElementLite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdd(value: /* els */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElement): Self = this.set("add", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setFill(value: /* els */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElement): Self = this.set("fill", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteFill: Self = this.set("fill", js.undefined)
    
    @scala.inline
    def setFilter(value: /* selector */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElement): Self = this.set("filter", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteFilter: Self = this.set("filter", js.undefined)
    
    @scala.inline
    def setFirst(value: () => typingsSlinky.extjs.Ext.dom.IElement): Self = this.set("first", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setItem(value: /* index */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.IElement): Self = this.set("item", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteItem: Self = this.set("item", js.undefined)
    
    @scala.inline
    def setLast(value: () => typingsSlinky.extjs.Ext.dom.IElement): Self = this.set("last", js.Any.fromFunction0(value))
