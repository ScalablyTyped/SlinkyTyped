...
import typingsSlinky.extjs.Ext.data.IRecord
import typingsSlinky.extjs.Ext.data.proxy.IProxy
...
object IStore {
  ...
  def apply(
    ...
    sync: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.IStore = null,
