...
trait IBoundListKeyNav
  extends typingsSlinky.extjs.Ext.util.IKeyNav {
  /** [Config Option] (Ext.view.BoundList) */
  var boundList: js.UndefOr[typingsSlinky.extjs.Ext.view.IBoundList] = js.undefined
...
object IBoundListKeyNav {
  ...
  def apply(
    ...
    boundList: typingsSlinky.extjs.Ext.view.IBoundList = null,
    ...
    keyMap: typingsSlinky.extjs.Ext.util.IKeyMap = null,
    mixins: js.Any = null,
