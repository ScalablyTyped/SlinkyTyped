...
object draw {
  ...
  object IComponent {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.draw.IComponent = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.draw.IComponent]
    }
    
    @scala.inline
    implicit class IComponentMutableBuilder[Self <: typingsSlinky.extjs.Ext.draw.IComponent] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait IText
    extends typingsSlinky.extjs.Ext.draw.IComponent {
