package typingsSlinky.extjs.Ext.data.reader

import typingsSlinky.extjs.Ext.Array
import typingsSlinky.extjs.Ext.IClass
import typingsSlinky.extjs.Ext.data.IResultSet
...
object IArray {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.reader.IArray = null,
