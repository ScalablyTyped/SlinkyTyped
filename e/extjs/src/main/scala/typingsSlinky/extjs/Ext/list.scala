...
object list {
  ...
  object IListView {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.list.IListView = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.list.IListView]
    }
    
    @scala.inline
    implicit class IListViewMutableBuilder[Self <: typingsSlinky.extjs.Ext.list.IListView] (val x: Self) extends AnyVal {
