...
object proxy {
  ...
  object IJsonP {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.data.proxy.IJsonP = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.data.proxy.IJsonP]
    }
    
    @scala.inline
    implicit class IJsonPMutableBuilder[Self <: typingsSlinky.extjs.Ext.data.proxy.IJsonP] (val x: Self) extends AnyVal {
  ...
  trait IProxy extends IObservable {
    ...
    /** [Method] Returns the writer currently attached to this proxy instance
      ...
      */
    var getWriter: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.data.writer.IWriter]] = js.native
    ...
    var setReader: js.UndefOr[
        js.Function1[/* reader */ js.UndefOr[js.Any], typingsSlinky.extjs.Ext.data.reader.IReader]
      ] = js.native
    ...
    var setWriter: js.UndefOr[
        js.Function1[/* writer */ js.UndefOr[js.Any], typingsSlinky.extjs.Ext.data.writer.IWriter]
      ] = js.native
  ...
  object IProxy {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.data.proxy.IProxy = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.data.proxy.IProxy]
    }
    
    @scala.inline
    implicit class IProxyMutableBuilder[Self <: typingsSlinky.extjs.Ext.data.proxy.IProxy] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetWriter(value: () => typingsSlinky.extjs.Ext.data.writer.IWriter): Self = StObject.set(x, "getWriter", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setSetReader(value: /* reader */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.reader.IReader): Self = StObject.set(x, "setReader", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSetReaderUndefined: Self = StObject.set(x, "setReader", js.undefined)
      
      @scala.inline
      def setSetWriter(value: /* writer */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.writer.IWriter): Self = StObject.set(x, "setWriter", js.Any.fromFunction1(value))
