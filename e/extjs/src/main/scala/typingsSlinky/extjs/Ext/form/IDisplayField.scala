...
trait IDisplayField extends IBase {
  ...
  /** [Method] Returns the raw value of the field without performing any normalization conversion or validation
    ...
    */
  @JSName("getRawValue")
  var getRawValue_IDisplayField: js.UndefOr[js.Function0[String]] = js.native
  ...
  /** [Method] Returns true if the value of this Field has been changed from its originalValue
    ...
    */
  @JSName("isDirty")
  var isDirty_IDisplayField: js.UndefOr[js.Function0[Boolean]] = js.native
  ...
  /** [Method] Returns whether or not the field value is currently valid by validating the processed raw value of the field
    ...
    */
  @JSName("isValid")
  var isValid_IDisplayField: js.UndefOr[js.Function0[Boolean]] = js.native
  ...
  /** [Method] Returns whether or not the field value is currently valid by validating the field s current value and fires the vali
    ...
    */
  @JSName("validate")
  var validate_IDisplayField: js.UndefOr[js.Function0[Boolean]] = js.native
}
object IDisplayField {
  
  @scala.inline
  def apply(): IDisplayField = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IDisplayField]
  }
  
  @scala.inline
  implicit class IDisplayFieldMutableBuilder[Self <: IDisplayField] (val x: Self) extends AnyVal {
