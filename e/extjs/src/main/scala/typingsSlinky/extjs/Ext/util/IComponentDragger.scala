...
object IComponentDragger {
  ...
  def apply(
    ...
    constrainDelegate: js.UndefOr[Boolean] = js.undefined,
    ...
    onBeforeStart: /* e */ js.UndefOr[IEventObject] => Unit = null,
    ...
    if (!js.isUndefined(constrainDelegate)) __obj.updateDynamic("constrainDelegate")(constrainDelegate.get.asInstanceOf[js.Any])
