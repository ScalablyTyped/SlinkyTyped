...
object window {
  ...
  object IMessageBox {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.window.IMessageBox = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.window.IMessageBox]
    }
    
    @scala.inline
    implicit class IMessageBoxMutableBuilder[Self <: typingsSlinky.extjs.Ext.window.IMessageBox] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlert(
        value: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.window.IMessageBox
      ...
      @scala.inline
      def setProgress(
        value: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* progressText */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.window.IMessageBox
      ...
      @scala.inline
      def setPrompt(
        value: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* multiline */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.window.IMessageBox
      ...
      @scala.inline
      def setSetIcon(
        value: (/* icon */ js.UndefOr[java.lang.String], /* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => typingsSlinky.extjs.Ext.window.IMessageBox
      ...
      @scala.inline
      def setShow(value: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.window.IMessageBox): Self = StObject.set(x, "show", js.Any.fromFunction1(value))
      ...
      def setUpdateProgress(
        value: (/* value */ js.UndefOr[Double], /* progressText */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.window.IMessageBox
      ...
      @scala.inline
      def setWait_(
        value: (/* msg */ js.UndefOr[java.lang.String], /* title */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.window.IMessageBox
  ...
  object IWindow {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.window.IWindow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.window.IWindow]
    }
    
    @scala.inline
    implicit class IWindowMutableBuilder[Self <: typingsSlinky.extjs.Ext.window.IWindow] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMaximize(value: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.window.IWindow): Self = StObject.set(x, "maximize", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setMinimize(value: () => typingsSlinky.extjs.Ext.window.IWindow): Self = StObject.set(x, "minimize", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setRestore(value: /* animate */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.window.IWindow): Self = StObject.set(x, "restore", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRestoreUndefined: Self = StObject.set(x, "restore", js.undefined)
      
      @scala.inline
      def setToggleMaximize(value: () => typingsSlinky.extjs.Ext.window.IWindow): Self = StObject.set(x, "toggleMaximize", js.Any.fromFunction0(value))
