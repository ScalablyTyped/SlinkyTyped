...
object tab {
  ...
  object IPanel {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.tab.IPanel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.tab.IPanel]
    }
    
    @scala.inline
    implicit class IPanelMutableBuilder[Self <: typingsSlinky.extjs.Ext.tab.IPanel] (val x: Self) extends AnyVal {
