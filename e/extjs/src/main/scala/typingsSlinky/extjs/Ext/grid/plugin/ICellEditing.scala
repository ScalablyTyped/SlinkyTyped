...
object ICellEditing {
  ...
  implicit class ICellEditingOps[Self <: ICellEditing] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStartEdit(value: (/* record */ js.UndefOr[js.Any], /* columnHeader */ js.UndefOr[js.Any]) => Boolean): Self = {
    ...
    @scala.inline
    def withStartEditByPosition(value: /* position */ js.UndefOr[js.Any] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startEditByPosition")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutStartEditByPosition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startEditByPosition")(js.undefined)
        ret
    }
  }
