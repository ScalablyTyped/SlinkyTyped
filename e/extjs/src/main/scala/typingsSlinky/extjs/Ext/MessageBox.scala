...
object MessageBox extends js.Object {
  ...
  var body: typingsSlinky.extjs.Ext.dom.IElement = js.native
  /** [Property] (Object) */
  ...
  /** [Method] Adds a CSS class to the body element
  		...
  		*/
  def addBodyCls(): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def addBodyCls(cls: java.lang.String): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  ...
  def afterLayout(layout: typingsSlinky.extjs.Ext.layout.container.IContainer): Unit = js.native
  ...
  /** [Method] Displays a standard read only message box with an OK button comparable to the basic JavaScript alert prompt
  		...
  		*/
  def alert(): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String, msg: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String, msg: java.lang.String, fn: js.Any): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String, msg: java.lang.String, fn: js.Any, scope: js.Any): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Collapses the panel body so that the body becomes hidden
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def collapse(): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def collapse(direction: java.lang.String): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def collapse(direction: java.lang.String, animate: Boolean): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  /** [Method] Displays a confirmation message box with Yes and No buttons comparable to JavaScript s confirm
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def confirm(): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String, msg: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String, msg: java.lang.String, fn: js.Any): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String, msg: java.lang.String, fn: js.Any, scope: js.Any): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Expands the panel body so that it becomes visible
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def expand(): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def expand(animate: Boolean): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  ...
  /** [Method] Retrieves the top level element representing this component
  		...
  		*/
  def getEl(): typingsSlinky.extjs.Ext.dom.IElement = js.native
  ...
  /** [Method] Returns the layout instance currently associated with this Container
  		...
  		*/
  def getLayout(): typingsSlinky.extjs.Ext.layout.container.IContainer = js.native
  ...
  /** [Method] Fits the window within its current container and automatically replaces the maximize tool button with the restore
  		...
  		*/
  def maximize(): typingsSlinky.extjs.Ext.window.IWindow = js.native
  def maximize(animate: Boolean): typingsSlinky.extjs.Ext.window.IWindow = js.native
  /** [Method] Placeholder method for minimizing the window
  		* @returns Ext.window.Window this
  		*/
  def minimize(): typingsSlinky.extjs.Ext.window.IWindow = js.native
  ...
  /** [Method] Displays a message box with a progress bar
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def progress(): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def progress(title: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def progress(title: java.lang.String, msg: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def progress(title: java.lang.String, msg: java.lang.String, progressText: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  ...
  ): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Removes a CSS class from the body element
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def removeBodyCls(): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def removeBodyCls(cls: java.lang.String): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  ...
  /** [Method] Restores a maximized window back to its original size and position prior to being maximized and also replaces the re
  		...
  		* @returns Ext.window.Window this
  		*/
  def restore(): typingsSlinky.extjs.Ext.window.IWindow = js.native
  def restore(animate: js.Any): typingsSlinky.extjs.Ext.window.IWindow = js.native
  ...
  /** [Method] Sets the body style according to the passed parameters
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def setBodyStyle(): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def setBodyStyle(style: js.Any): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  def setBodyStyle(style: js.Any, value: java.lang.String): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  /** [Method]
  		* @param border Object
  ...
  /** [Method] Adds the specified icon to the dialog
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def setIcon(): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def setIcon(icon: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def setIcon(icon: java.lang.String, width: Double): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def setIcon(icon: java.lang.String, width: Double, height: Double): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Displays a new message box or reinitializes an existing message box based on the config options passed in
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def show(): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def show(config: js.Any): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Shortcut for performing an expand or collapse based on the current state of the panel
  		* @returns Ext.panel.Panel this
  		*/
  def toggleCollapse(): typingsSlinky.extjs.Ext.panel.IPanel = js.native
  /** [Method] A shortcut method for toggling between maximize and restore based on the current maximized state of the window
  		* @returns Ext.window.Window this
  		*/
  def toggleMaximize(): typingsSlinky.extjs.Ext.window.IWindow = js.native
  ...
  /** [Method] Updates a progress style message box s text and progress bar
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def updateProgress(): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def updateProgress(value: Double): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def updateProgress(value: Double, progressText: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def updateProgress(value: Double, progressText: java.lang.String, msg: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def wait(msg: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def wait(msg: java.lang.String, title: java.lang.String): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
  def wait(msg: java.lang.String, title: java.lang.String, config: js.Any): typingsSlinky.extjs.Ext.window.IMessageBox = js.native
}
