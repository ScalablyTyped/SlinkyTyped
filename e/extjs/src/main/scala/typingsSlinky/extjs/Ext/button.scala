...
object button {
  ...
  object IButton {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.button.IButton = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.button.IButton]
    }
    
    @scala.inline
    implicit class IButtonMutableBuilder[Self <: typingsSlinky.extjs.Ext.button.IButton] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHideMenu(value: () => typingsSlinky.extjs.Ext.button.IButton): Self = StObject.set(x, "hideMenu", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setSetGlyph(value: /* glyph */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.button.IButton): Self = StObject.set(x, "setGlyph", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSetHandler(
        value: (/* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.button.IButton
      ...
      @scala.inline
      def setSetIcon(value: /* icon */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.button.IButton): Self = StObject.set(x, "setIcon", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSetIconCls(value: /* cls */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.button.IButton): Self = StObject.set(x, "setIconCls", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSetText(value: /* text */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.button.IButton): Self = StObject.set(x, "setText", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSetTooltip(value: /* tooltip */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.button.IButton): Self = StObject.set(x, "setTooltip", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setToggle(
        value: (/* state */ js.UndefOr[Boolean], /* suppressEvent */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.button.IButton
