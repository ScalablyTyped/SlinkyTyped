...
import typingsSlinky.extjs.Ext.data.IErrors
...
object IProperty {
  ...
  def apply(
    ...
    join: /* store */ js.UndefOr[typingsSlinky.extjs.Ext.data.IStore] => Unit = null,
    ...
    statics: js.Any = null,
    store: typingsSlinky.extjs.Ext.data.IStore = null,
    stores: Array = null,
    suspendEvent: /* repeated */ js.Any => Unit = null,
    suspendEvents: /* queueSuspended */ js.UndefOr[Boolean] => Unit = null,
    un: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => Unit = null,
    unjoin: /* store */ js.UndefOr[typingsSlinky.extjs.Ext.data.IStore] => Unit = null,
    uses: Array = null,
