...
trait IBoundList extends IAuto {
  ...
  var beginLayoutCycle_IBoundList: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[js.Any], Unit]] = js.undefined
  /** [Method] Called before any calculation cycles to prepare for layout
  		* @param ownerContext Object
  		*/
  @JSName("beginLayout")
  var beginLayout_IBoundList: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[js.Any], Unit]] = js.undefined
...
object IBoundList {
  ...
  def apply(
    ...
    config: js.Any = null,
    configureItem: /* item */ js.UndefOr[typingsSlinky.extjs.Ext.IComponent] => Unit = null,
    destroy: () => Unit = null,
    ...
    getItemSizePolicy: /* item */ js.UndefOr[typingsSlinky.extjs.Ext.IComponent] => ISizePolicy = null,
    getLayoutItems: () => Unit = null,
    getRenderTarget: () => IElement = null,
    getTarget: () => IElement = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.layout.component.IBoundList = null,
    ...
    onContentChange: /* child */ js.UndefOr[typingsSlinky.extjs.Ext.IComponent] => Boolean = null,
