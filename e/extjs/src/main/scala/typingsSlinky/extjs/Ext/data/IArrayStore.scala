...
object IArrayStore {
  ...
  def apply(
    ...
    getProxy: () => typingsSlinky.extjs.Ext.data.proxy.IProxy = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => IArrayStore = null,
    ...
    save: () => Unit = null,
    self: IClass = null,
    setProxy: /* proxy */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.proxy.IProxy = null,
