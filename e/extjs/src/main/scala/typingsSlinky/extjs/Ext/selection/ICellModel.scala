...
object ICellModel {
  ...
  implicit class ICellModelOps[Self <: ICellModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeselect(value: (/* record */ js.UndefOr[js.Any], /* suppressEvent */ js.UndefOr[js.Any]) => Unit): Self = {
    ...
    @scala.inline
    def withPreventWrap(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preventWrap")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPreventWrap: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preventWrap")(js.undefined)
        ret
    }
    @scala.inline
    def withSelect(
    ...
    @scala.inline
    def withSetCurrentPosition(value: (/* position */ js.UndefOr[js.Any], /* suppressEvent */ js.UndefOr[Boolean]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setCurrentPosition")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutSetCurrentPosition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setCurrentPosition")(js.undefined)
        ret
    }
  }
