...
object IAjax {
  ...
  def apply(
    ...
    getWriter: () => typingsSlinky.extjs.Ext.data.writer.IWriter = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.proxy.IAjax = null,
    ...
    setReader: /* reader */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.reader.IReader = null,
    setWriter: /* writer */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.writer.IWriter = null,
