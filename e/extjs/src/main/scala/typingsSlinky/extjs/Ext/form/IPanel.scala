...
object IPanel {
  ...
  implicit class IPanelOps[Self <: IPanel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnFieldValidityChange(value: (js.UndefOr[typingsSlinky.extjs.Ext.form.field.IField], js.UndefOr[Boolean]) => Unit): Self = this.set("onFieldValidityChange", js.Any.fromFunction2(value))
