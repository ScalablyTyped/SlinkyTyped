...
object menu {
  ...
  trait IDatePicker extends IMenu {
    ...
    var picker: js.UndefOr[typingsSlinky.extjs.Ext.picker.IDate] = js.native
  ...
  object IDatePicker {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.menu.IDatePicker = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.menu.IDatePicker]
    }
    
    @scala.inline
    implicit class IDatePickerMutableBuilder[Self <: typingsSlinky.extjs.Ext.menu.IDatePicker] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPicker(value: typingsSlinky.extjs.Ext.picker.IDate): Self = StObject.set(x, "picker", value.asInstanceOf[js.Any])
  ...
  type IKeyNav = typingsSlinky.extjs.Ext.util.IKeyNav
