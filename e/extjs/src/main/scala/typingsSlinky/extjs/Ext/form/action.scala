...
object action {
  ...
  object IAction {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.form.action.IAction = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.form.action.IAction]
    }
    
    @scala.inline
    implicit class IActionMutableBuilder[Self <: typingsSlinky.extjs.Ext.form.action.IAction] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait ILoad
    extends typingsSlinky.extjs.Ext.form.action.IAction
  object ILoad {
