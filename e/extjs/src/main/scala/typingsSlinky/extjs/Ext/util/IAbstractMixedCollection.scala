...
object IAbstractMixedCollection {
  ...
  implicit class IAbstractMixedCollectionOps[Self <: IAbstractMixedCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdd(value: (/* key */ js.UndefOr[js.Any], /* obj */ js.UndefOr[js.Any]) => _): Self = this.set("add", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setFind(value: () => Unit): Self = this.set("find", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setIsMixedCollection(value: Boolean): Self = this.set("isMixedCollection", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsMixedCollection: Self = this.set("isMixedCollection", js.undefined)
    ...
    @scala.inline
    def setRemoveRange(value: (/* index */ js.UndefOr[Double], /* removeCount */ js.UndefOr[Double]) => _): Self = this.set("removeRange", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteRemoveRange: Self = this.set("removeRange", js.undefined)
    ...
    @scala.inline
    def setUpdateKey(value: (/* oldKey */ js.UndefOr[js.Any], /* newKey */ js.UndefOr[js.Any]) => Unit): Self = this.set("updateKey", js.Any.fromFunction2(value))
