...
object IAbstractComponent {
  ...
  implicit class IAbstractComponentOps[Self <: IAbstractComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDoComponentLayout(value: () => typingsSlinky.extjs.Ext.container.IContainer): Self = this.set("doComponentLayout", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetBubbleTarget(value: () => typingsSlinky.extjs.Ext.container.IContainer): Self = this.set("getBubbleTarget", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetEl(value: () => typingsSlinky.extjs.Ext.dom.IElement): Self = this.set("getEl", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setOnRender(value: (js.UndefOr[typingsSlinky.extjs.Ext.core.IElement], js.UndefOr[Double]) => Unit): Self = this.set("onRender", js.Any.fromFunction2(value))
    @scala.inline
