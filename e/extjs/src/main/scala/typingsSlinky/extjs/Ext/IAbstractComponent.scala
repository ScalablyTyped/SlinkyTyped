...
object IAbstractComponent {
  ...
  implicit class IAbstractComponentMutableBuilder[Self <: IAbstractComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDoComponentLayout(value: () => typingsSlinky.extjs.Ext.container.IContainer): Self = StObject.set(x, "doComponentLayout", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetBubbleTarget(value: () => typingsSlinky.extjs.Ext.container.IContainer): Self = StObject.set(x, "getBubbleTarget", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetEl(value: () => typingsSlinky.extjs.Ext.dom.IElement): Self = StObject.set(x, "getEl", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setOnRender(value: (js.UndefOr[typingsSlinky.extjs.Ext.core.IElement], js.UndefOr[Double]) => Unit): Self = StObject.set(x, "onRender", js.Any.fromFunction2(value))
