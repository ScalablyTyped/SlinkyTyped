...
object IPaging {
  ...
  implicit class IPagingOps[Self <: IPaging] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterPageText(value: String): Self = this.set("afterPageText", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAfterPageText: Self = this.set("afterPageText", js.undefined)
    @scala.inline
    def setBeforePageText(value: String): Self = this.set("beforePageText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisplayMsg(value: String): Self = this.set("displayMsg", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setEmptyMsg(value: String): Self = this.set("emptyMsg", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRefreshText(value: String): Self = this.set("refreshText", value.asInstanceOf[js.Any])
    @scala.inline
