...
object ILayer {
  ...
  def apply(
    ...
    addClsOnClick: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    addClsOnFocus: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    addClsOnOver: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    addListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    alias: Array = null,
    alternateClassName: js.Any = null,
    animate: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    appendChild: (/* el */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    appendTo: /* el */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    blur: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    boxWrap: /* clazz */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    clearListeners: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    clearOpacity: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    clearPositioning: /* value */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    clip: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    cls: java.lang.String = null,
    config: js.Any = null,
    constrain: js.UndefOr[Boolean] = js.undefined,
    contains: /* el */ js.UndefOr[js.Any] => Boolean = null,
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[HTMLElement], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    createProxy: (/* config */ js.UndefOr[js.Any], /* renderTo */ js.UndefOr[js.Any], /* matchBox */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    createShim: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    defaultUnit: java.lang.String = null,
    destroy: () => Unit = null,
    dh: js.Any = null,
    dom: HTMLElement = null,
    down: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    enableDisplayMode: /* display */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    extend: java.lang.String = null,
    fadeIn: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    fadeOut: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    focus: /* defer */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    focusable: () => Boolean = null,
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    getXY: () => Array = null,
    getY: () => Double = null,
    ghost: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    hasCls: /* className */ js.UndefOr[java.lang.String] => Boolean = null,
    hide: /* animate */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    hideMode: java.lang.String = null,
    highlight: (/* color */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    hover: (/* overFn */ js.UndefOr[js.Any], /* outFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    id: java.lang.String = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    insertAfter: /* el */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    insertBefore: /* el */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    insertFirst: /* el */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    insertHtml: (/* where */ js.UndefOr[java.lang.String], /* html */ js.UndefOr[java.lang.String], /* returnEl */ js.UndefOr[Boolean]) => _ = null,
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    load: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    mask: (/* msg */ js.UndefOr[java.lang.String], /* msgCls */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    mixins: js.Any = null,
    monitorMouseLeave: (/* delay */ js.UndefOr[Double], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => _ = null,
    moveTo: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    needsTabIndex: () => Unit = null,
    next: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    on: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    originalDisplay: java.lang.String = null,
    parent: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    pause: /* seconds */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    puff: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    purgeAllListeners: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    remove: () => Unit = null,
    removeAllListeners: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    removeCls: /* className */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    repaint: () => typingsSlinky.extjs.Ext.dom.IElement = null,
    replace: /* el */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    replaceWith: /* el */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    requires: Array = null,
    scale: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    scroll: (/* direction */ js.UndefOr[java.lang.String], /* distance */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => Boolean = null,
    scrollBy: (/* deltaX */ js.UndefOr[js.Any], /* deltaY */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    scrollIntoView: (/* container */ js.UndefOr[js.Any], /* hscroll */ js.UndefOr[Boolean], /* animate */ js.UndefOr[js.Any], /* highlight */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.ICompositeElement = null,
    selectable: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    self: IClass = null,
    ...
    setBottom: /* bottom */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    setDisplayed: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    setLocation: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    setOpacity: (/* opacity */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    setPositioning: /* posCfg */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    setRight: /* right */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    setScrollLeft: /* left */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    setScrollTop: /* top */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    setZIndex: /* zindex */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    shadow: js.Any = null,
    shadowOffset: Int | Double = null,
    shift: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    shim: js.UndefOr[Boolean] = js.undefined,
    show: /* animate */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    slideIn: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    slideOut: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    statics: js.Any = null,
    swallowEvent: (/* eventName */ js.UndefOr[js.Any], /* preventDefault */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    switchOff: /* options */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    toggle: /* animate */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ILayer = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.IElement = null,
    un: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
    unclip: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    unmask: () => Unit = null,
    unselectable: () => typingsSlinky.extjs.Ext.dom.ILayer = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ILayer = null,
