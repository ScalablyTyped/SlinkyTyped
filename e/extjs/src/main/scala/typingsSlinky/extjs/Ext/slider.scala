...
object slider {
  ...
  object ISlider {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.slider.ISlider = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.slider.ISlider]
    }
    
    @scala.inline
    implicit class ISliderMutableBuilder[Self <: typingsSlinky.extjs.Ext.slider.ISlider] (val x: Self) extends AnyVal {
  ...
  object ITip {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.slider.ITip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.slider.ITip]
    }
    
    @scala.inline
    implicit class ITipMutableBuilder[Self <: typingsSlinky.extjs.Ext.slider.ITip] (val x: Self) extends AnyVal {
