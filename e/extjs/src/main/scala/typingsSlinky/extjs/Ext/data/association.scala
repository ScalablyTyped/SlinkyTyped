...
object association {
  ...
  trait IAssociation extends IBase {
    ...
    /** [Method] Get a specialized reader for reading associated data
      ...
      */
    var getReader: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.data.reader.IReader]] = js.native
    ...
    var reader: js.UndefOr[typingsSlinky.extjs.Ext.data.reader.IReader] = js.native
  }
  object IAssociation {
    
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.data.association.IAssociation = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.data.association.IAssociation]
    }
    
    @scala.inline
    implicit class IAssociationMutableBuilder[Self <: typingsSlinky.extjs.Ext.data.association.IAssociation] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetReader(value: () => typingsSlinky.extjs.Ext.data.reader.IReader): Self = StObject.set(x, "getReader", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setReader(value: typingsSlinky.extjs.Ext.data.reader.IReader): Self = StObject.set(x, "reader", value.asInstanceOf[js.Any])
