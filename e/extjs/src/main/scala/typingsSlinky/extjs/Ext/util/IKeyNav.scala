...
object IKeyNav {
  ...
  implicit class IKeyNavMutableBuilder[Self <: IKeyNav] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultEventAction(value: String): Self = StObject.set(x, "defaultEventAction", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setKeyMap(value: IKeyMap): Self = StObject.set(x, "keyMap", value.asInstanceOf[js.Any])
