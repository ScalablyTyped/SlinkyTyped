...
object IKeyNav {
  ...
  implicit class IKeyNavOps[Self <: IKeyNav] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultEventAction(value: String): Self = this.set("defaultEventAction", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setKeyMap(value: IKeyMap): Self = this.set("keyMap", value.asInstanceOf[js.Any])
