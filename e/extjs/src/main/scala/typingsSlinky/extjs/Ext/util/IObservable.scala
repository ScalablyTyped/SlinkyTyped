...
object IObservable {
  ...
  implicit class IObservableOps[Self <: IObservable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnableBubble(value: /* eventNames */ js.UndefOr[js.Any] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFireEventArgs(value: (/* eventName */ js.UndefOr[String], /* args */ js.UndefOr[Array]) => Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSuspendEvents(value: /* queueSuspended */ js.UndefOr[Boolean] => Unit): Self = {
        val ret = this.duplicate
