...
object flash {
  ...
  object IComponent {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.flash.IComponent = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.flash.IComponent]
    }
    
    @scala.inline
    implicit class IComponentMutableBuilder[Self <: typingsSlinky.extjs.Ext.flash.IComponent] (val x: Self) extends AnyVal {
