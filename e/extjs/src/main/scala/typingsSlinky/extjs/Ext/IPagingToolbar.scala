...
object IPagingToolbar {
  @scala.inline
  def apply(
    IToolbar: typingsSlinky.extjs.Ext.toolbar.IToolbar = null,
    ...
    inputItemWidth: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(displayInfo)) __obj.updateDynamic("displayInfo")(displayInfo.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(inputItemWidth)) __obj.updateDynamic("inputItemWidth")(inputItemWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(prependButtons)) __obj.updateDynamic("prependButtons")(prependButtons.get.asInstanceOf[js.Any])
