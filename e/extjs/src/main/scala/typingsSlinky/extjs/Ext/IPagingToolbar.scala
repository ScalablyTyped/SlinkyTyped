...
object IPagingToolbar {
  ...
  implicit class IPagingToolbarOps[Self <: IPagingToolbar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAfterPageText(value: java.lang.String): Self = {
    ...
    @scala.inline
    def withBeforePageText(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDisplayMsg(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEmptyMsg(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFirstText(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLastText(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRefreshText(value: java.lang.String): Self = {
        val ret = this.duplicate
