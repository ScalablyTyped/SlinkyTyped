...
trait IDateField
  ...
  @JSName("initValue")
  var initValue_IDateField: js.UndefOr[js.Function0[Unit]] = js.native
...
object IDateField {
  ...
  @scala.inline
  implicit class IDateFieldMutableBuilder[Self <: IDateField] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetValue(value: /* date */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.form.field.IDate): Self = StObject.set(x, "setValue", js.Any.fromFunction1(value))
