...
object view {
  ...
  object IAbstractView {
    ...
    implicit class IAbstractViewMutableBuilder[Self <: IAbstractView] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetSelectionModel(value: () => typingsSlinky.extjs.Ext.selection.IModel): Self = StObject.set(x, "getSelectionModel", js.Any.fromFunction0(value))
  ...
  object IBoundList {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.view.IBoundList = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.view.IBoundList]
    }
    
    @scala.inline
    implicit class IBoundListMutableBuilder[Self <: typingsSlinky.extjs.Ext.view.IBoundList] (val x: Self) extends AnyVal {
  ...
  trait IBoundListKeyNav
    ...
    var boundList: js.UndefOr[typingsSlinky.extjs.Ext.view.IBoundList] = js.native
  ...
  object IBoundListKeyNav {
    ...
    implicit class IBoundListKeyNavMutableBuilder[Self <: IBoundListKeyNav] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBoundList(value: typingsSlinky.extjs.Ext.view.IBoundList): Self = StObject.set(x, "boundList", value.asInstanceOf[js.Any])
