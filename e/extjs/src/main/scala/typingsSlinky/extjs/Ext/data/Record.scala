...
object Record extends js.Object {
  ...
  /** [Method] Returns the configured Proxy for this Model
  		...
  		*/
  def getProxy(): typingsSlinky.extjs.Ext.data.proxy.IProxy = js.native
  ...
  /** [Method] Sets the Proxy to use for this model
  		...
  		*/
  def setProxy(): typingsSlinky.extjs.Ext.data.proxy.IProxy = js.native
  def setProxy(proxy: js.Any): typingsSlinky.extjs.Ext.data.proxy.IProxy = js.native
}
