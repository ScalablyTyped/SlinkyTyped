...
object fx {
  ...
  object target {
    ...
    object ICompositeElement {
      ...
      @scala.inline
      def apply(): typingsSlinky.extjs.Ext.fx.target.ICompositeElement = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.extjs.Ext.fx.target.ICompositeElement]
      }
      
      @scala.inline
      implicit class ICompositeElementMutableBuilder[Self <: typingsSlinky.extjs.Ext.fx.target.ICompositeElement] (val x: Self) extends AnyVal {
    ...
    type ICompositeElementCSS = typingsSlinky.extjs.Ext.fx.target.ICompositeElement
    
    type ICompositeSprite = ISprite
    
    type IElement = ITarget
    
    type IElementCSS = typingsSlinky.extjs.Ext.fx.target.IElement
