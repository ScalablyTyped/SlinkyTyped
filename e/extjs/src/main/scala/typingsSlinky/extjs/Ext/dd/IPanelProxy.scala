...
trait IPanelProxy extends IBase {
  ...
  /** [Method] Gets the proxy s ghost Panel
  		...
  		*/
  var getGhost: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.panel.IPanel]] = js.undefined
  ...
  var panel: js.UndefOr[typingsSlinky.extjs.Ext.panel.IPanel] = js.undefined
...
object IPanelProxy {
  ...
  def apply(
    ...
    getEl: () => IElement = null,
    getGhost: () => typingsSlinky.extjs.Ext.panel.IPanel = null,
    ...
    panel: typingsSlinky.extjs.Ext.panel.IPanel = null,
    requires: Array = null,
    self: IClass = null,
    show: () => Unit = null,
