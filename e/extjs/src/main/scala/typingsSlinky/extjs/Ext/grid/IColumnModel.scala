...
object IColumnModel {
  ...
  implicit class IColumnModelOps[Self <: IColumnModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetHeaderAtIndex(value: /* index */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.grid.column.IColumn): Self = this.set("getHeaderAtIndex", js.Any.fromFunction1(value))
    @scala.inline
    def deleteGetHeaderAtIndex: Self = this.set("getHeaderAtIndex", js.undefined)
    @scala.inline
    def setGetHeaderById(value: /* id */ js.UndefOr[String] => typingsSlinky.extjs.Ext.grid.column.IColumn): Self = this.set("getHeaderById", js.Any.fromFunction1(value))
    @scala.inline
    def deleteGetHeaderById: Self = this.set("getHeaderById", js.undefined)
    @scala.inline
    def setGetHeaderIndex(value: /* header */ js.UndefOr[typingsSlinky.extjs.Ext.grid.column.IColumn] => Double): Self = this.set("getHeaderIndex", js.Any.fromFunction1(value))
    @scala.inline
