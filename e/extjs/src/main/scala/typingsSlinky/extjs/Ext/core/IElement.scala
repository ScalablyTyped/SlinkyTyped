...
object IElement {
  ...
  implicit class IElementOps[Self <: IElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddKeyMap(value: /* config */ js.UndefOr[js.Any] => IKeyMap): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withBoxWrap(value: /* clazz */ js.UndefOr[String] => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClearPositioning(value: /* value */ js.UndefOr[String] => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEnableDisplayMode(value: /* display */ js.UndefOr[String] => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetAttributeNS(value: (/* namespace */ js.UndefOr[String], /* name */ js.UndefOr[String]) => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetFrameWidth(value: /* sides */ js.UndefOr[String] => Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGhost(value: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHighlight(value: (/* color */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMask(value: (/* msg */ js.UndefOr[String], /* msgCls */ js.UndefOr[String]) => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOriginalDisplay(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRelayEvent(value: (/* eventName */ js.UndefOr[String], /* observable */ js.UndefOr[js.Any]) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSlideIn(value: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSlideOut(value: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IElement): Self = {
        val ret = this.duplicate
