...
object IElement {
  ...
  def apply(
    ...
    replaceCls: (/* oldClassName */ js.UndefOr[String], /* newClassName */ js.UndefOr[String]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[String]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    toggleCls: /* className */ js.UndefOr[String] => typingsSlinky.extjs.Ext.dom.IElement = null,
