...
object toolbar {
  ...
  object IToolbar {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.toolbar.IToolbar = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.toolbar.IToolbar]
    }
    
    @scala.inline
    implicit class IToolbarMutableBuilder[Self <: typingsSlinky.extjs.Ext.toolbar.IToolbar] (val x: Self) extends AnyVal {
