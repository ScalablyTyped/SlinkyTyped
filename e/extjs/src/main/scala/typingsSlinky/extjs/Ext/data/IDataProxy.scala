...
object IDataProxy {
  ...
  implicit class IDataProxyOps[Self <: IDataProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetWriter(value: () => typingsSlinky.extjs.Ext.data.writer.IWriter): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetReader(value: /* reader */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.reader.IReader): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetWriter(value: /* writer */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.writer.IWriter): Self = {
        val ret = this.duplicate
