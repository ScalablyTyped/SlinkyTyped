...
object IDataProxy {
  ...
  implicit class IDataProxyOps[Self <: IDataProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetWriter(value: () => typingsSlinky.extjs.Ext.data.writer.IWriter): Self = this.set("getWriter", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetReader(value: /* reader */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.reader.IReader): Self = this.set("setReader", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetReader: Self = this.set("setReader", js.undefined)
    
    @scala.inline
    def setSetWriter(value: /* writer */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.writer.IWriter): Self = this.set("setWriter", js.Any.fromFunction1(value))
