...
object ICompositeElementLite {
  ...
  implicit class ICompositeElementLiteOps[Self <: ICompositeElementLite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: /* els */ js.UndefOr[js.Any] => ICompositeElement): Self = {
    ...
    @scala.inline
    def withEach(value: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => ICompositeElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFill(value: /* els */ js.UndefOr[js.Any] => ICompositeElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFilter(value: /* selector */ js.UndefOr[js.Any] => ICompositeElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFirst(value: () => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLast(value: () => IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRemoveElement(value: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => ICompositeElement): Self = {
        val ret = this.duplicate
