...
trait ICompositeElementLite extends IBase {
  ...
  /** [Method] Returns the first Element
  		...
  		*/
  var first: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.dom.IElement]] = js.undefined
  ...
  /** [Method] Returns the last Element
  		* @returns Ext.dom.Element
  		*/
  var last: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.dom.IElement]] = js.undefined
...
object ICompositeElementLite {
  @scala.inline
  def apply(
    add: /* els */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElement = null,
    alias: Array = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.ICompositeElement = null,
    elements: Array = null,
    extend: java.lang.String = null,
    fill: /* els */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElement = null,
    filter: /* selector */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElement = null,
    first: () => typingsSlinky.extjs.Ext.dom.IElement = null,
    getCount: () => Double = null,
    getInitialConfig: /* name */ js.UndefOr[java.lang.String] => _ = null,
    indexOf: /* el */ js.UndefOr[js.Any] => Double = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.ICompositeElementLite = null,
    isComposite: js.UndefOr[Boolean] = js.undefined,
    item: /* index */ js.UndefOr[Double] => typingsSlinky.extjs.Ext.dom.IElement = null,
    last: () => typingsSlinky.extjs.Ext.dom.IElement = null,
    mixins: js.Any = null,
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ICompositeElement = null,
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.ICompositeElement = null,
    requires: Array = null,
    self: IClass = null,
