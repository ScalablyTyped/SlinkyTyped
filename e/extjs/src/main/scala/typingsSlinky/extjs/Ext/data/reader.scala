...
object reader {
  ...
  object IReader {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.data.reader.IReader = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.data.reader.IReader]
    }
    
    @scala.inline
    implicit class IReaderMutableBuilder[Self <: typingsSlinky.extjs.Ext.data.reader.IReader] (val x: Self) extends AnyVal {
