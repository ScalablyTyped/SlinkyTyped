...
trait IKeyNav extends IBase {
  ...
  var keyMap: js.UndefOr[typingsSlinky.extjs.Ext.util.IKeyMap] = js.undefined
...
object IKeyNav {
  ...
  def apply(
    ...
    if (!js.isUndefined(forceKeyDown)) __obj.updateDynamic("forceKeyDown")(forceKeyDown.get.asInstanceOf[js.Any])
