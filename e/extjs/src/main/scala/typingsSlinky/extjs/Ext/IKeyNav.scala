...
trait IKeyNav extends IBase {
  ...
  var keyMap: js.UndefOr[typingsSlinky.extjs.Ext.util.IKeyMap] = js.native
...
object IKeyNav {
  ...
  implicit class IKeyNavOps[Self <: IKeyNav] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefaultEventAction(value: java.lang.String): Self = {
    ...
    @scala.inline
    def withEventName(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKeyMap(value: typingsSlinky.extjs.Ext.util.IKeyMap): Self = {
        val ret = this.duplicate
