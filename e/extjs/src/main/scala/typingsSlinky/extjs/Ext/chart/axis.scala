...
object axis {
  ...
  object IAxis {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.chart.axis.IAxis = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.chart.axis.IAxis]
    }
    
    @scala.inline
    implicit class IAxisMutableBuilder[Self <: typingsSlinky.extjs.Ext.chart.axis.IAxis] (val x: Self) extends AnyVal {
