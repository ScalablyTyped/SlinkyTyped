...
object IAssociation {
  ...
  implicit class IAssociationOps[Self <: IAssociation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetReader(value: () => typingsSlinky.extjs.Ext.data.reader.IReader): Self = this.set("getReader", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setReader(value: typingsSlinky.extjs.Ext.data.reader.IReader): Self = this.set("reader", value.asInstanceOf[js.Any])
    @scala.inline
