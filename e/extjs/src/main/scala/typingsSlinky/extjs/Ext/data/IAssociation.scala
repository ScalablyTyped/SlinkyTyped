...
trait IAssociation extends IBase {
  ...
  /** [Method] Get a specialized reader for reading associated data
  		...
  		*/
  var getReader: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.data.reader.IReader]] = js.undefined
  /** [Config Option] (String) */
  ...
  var reader: js.UndefOr[typingsSlinky.extjs.Ext.data.reader.IReader] = js.undefined
}
