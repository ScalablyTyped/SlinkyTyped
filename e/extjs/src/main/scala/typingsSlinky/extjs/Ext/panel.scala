...
object panel {
  ...
  trait IAbstractPanel
    ...
    var addBodyCls: js.UndefOr[
        js.Function1[/* cls */ js.UndefOr[java.lang.String], typingsSlinky.extjs.Ext.panel.IPanel]
      ] = js.native
    ...
    var body: js.UndefOr[typingsSlinky.extjs.Ext.dom.IElement] = js.native
    ...
    var setBodyStyle: js.UndefOr[
        js.Function2[
          ...
          typingsSlinky.extjs.Ext.panel.IPanel
        ]
      ] = js.native
  ...
  object IAbstractPanel {
    ...
    implicit class IAbstractPanelMutableBuilder[Self <: IAbstractPanel] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddBodyCls(value: /* cls */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.panel.IPanel): Self = StObject.set(x, "addBodyCls", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setBody(value: typingsSlinky.extjs.Ext.dom.IElement): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRemoveBodyCls(value: /* cls */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.panel.IPanel): Self = StObject.set(x, "removeBodyCls", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSetBodyStyle(
        value: (/* style */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.panel.IPanel
  ...
  object IPanel {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.panel.IPanel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.panel.IPanel]
    }
    
    @scala.inline
    implicit class IPanelMutableBuilder[Self <: typingsSlinky.extjs.Ext.panel.IPanel] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCollapse(
        value: (/* direction */ js.UndefOr[java.lang.String], /* animate */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.panel.IPanel
      ...
      @scala.inline
      def setExpand(value: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.panel.IPanel): Self = StObject.set(x, "expand", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setToggleCollapse(value: () => typingsSlinky.extjs.Ext.panel.IPanel): Self = StObject.set(x, "toggleCollapse", js.Any.fromFunction0(value))
  ...
  trait IProxy extends IBase {
    ...
    /** [Method] Gets the proxy s ghost Panel
      ...
      */
    var getGhost: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.panel.IPanel]] = js.native
    ...
    var panel: js.UndefOr[typingsSlinky.extjs.Ext.panel.IPanel] = js.native
  ...
  object IProxy {
    ...
    implicit class IProxyMutableBuilder[Self <: IProxy] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetGhost(value: () => typingsSlinky.extjs.Ext.panel.IPanel): Self = StObject.set(x, "getGhost", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setPanel(value: typingsSlinky.extjs.Ext.panel.IPanel): Self = StObject.set(x, "panel", value.asInstanceOf[js.Any])
  ...
  object ITable {
    ...
    implicit class ITableMutableBuilder[Self <: ITable] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.extjs.Ext.view.ITable): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
