...
object IAbstractContainer {
  ...
  implicit class IAbstractContainerOps[Self <: IAbstractContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterLayout(value: /* layout */ js.UndefOr[typingsSlinky.extjs.Ext.layout.container.IContainer] => Unit): Self = this.set("afterLayout", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetLayout(value: () => typingsSlinky.extjs.Ext.layout.container.IContainer): Self = this.set("getLayout", js.Any.fromFunction0(value))
