...
- typings.extjs.Ext.IQueryable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined child, down, query, queryBy, queryById */ trait IAbstractContainer extends IComponent {
  ...
  /** [Method] Manually force this container s layout to be recalculated
  		...
  		*/
  var doLayout: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.container.IContainer]] = js.undefined
  ...
  /** [Method] Returns the layout instance currently associated with this Container
  		...
  		*/
  var getLayout: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.layout.container.IContainer]] = js.undefined
...
object IAbstractContainer {
  ...
  def apply(
    ...
    afterLayout: /* layout */ js.UndefOr[typingsSlinky.extjs.Ext.layout.container.IContainer] => Unit = null,
    autoDestroy: js.UndefOr[Boolean] = js.undefined,
    bubbleEvents: Array = null,
    cascade: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* args */ js.UndefOr[Array]) => typingsSlinky.extjs.Ext.IContainer = null,
    ...
    doLayout: () => typingsSlinky.extjs.Ext.container.IContainer = null,
    down: js.UndefOr[js.Any] => _ = null,
    getComponent: /* comp */ js.UndefOr[js.Any] => IComponent = null,
    getLayout: () => typingsSlinky.extjs.Ext.layout.container.IContainer = null,
    getRefItems: /* deep */ js.UndefOr[js.Any] => Unit = null,
    insert: (/* index */ js.UndefOr[Double], /* component */ js.UndefOr[js.Any]) => IComponent = null,
    isAncestor: /* possibleDescendant */ js.UndefOr[IComponent] => Unit = null,
    items: js.Any = null,
    layout: js.Any = null,
    move: (/* fromIdx */ js.UndefOr[js.Any], /* toIdx */ js.UndefOr[Double]) => IComponent = null,
    onAdd: (/* component */ js.UndefOr[IComponent], /* position */ js.UndefOr[Double]) => Unit = null,
    onBeforeAdd: /* item */ js.UndefOr[IComponent] => Unit = null,
