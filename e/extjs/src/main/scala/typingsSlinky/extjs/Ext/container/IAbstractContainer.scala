...
object IAbstractContainer {
  ...
  def apply(
    ...
    if (!js.isUndefined(detachOnRemove)) __obj.updateDynamic("detachOnRemove")(detachOnRemove.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(suspendLayout)) __obj.updateDynamic("suspendLayout")(suspendLayout.get.asInstanceOf[js.Any])
