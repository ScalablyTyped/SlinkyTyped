...
trait IBoundList extends IView {
  ...
  /** [Method] A method that returns the inner template for displaying items in the list
  		...
  		*/
  var getInnerTpl: js.UndefOr[js.Function1[/* displayField */ js.UndefOr[String], String]] = js.native
...
object IBoundList {
  ...
  implicit class IBoundListOps[Self <: IBoundList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetInnerTpl(value: /* displayField */ js.UndefOr[String] => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getInnerTpl")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutGetInnerTpl: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getInnerTpl")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPagingToolbar(value: IPaging): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pagingToolbar")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPagingToolbar: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pagingToolbar")(js.undefined)
        ret
    }
    @scala.inline
