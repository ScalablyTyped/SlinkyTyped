...
import typingsSlinky.extjs.Ext.dd.IDragDrop
import typingsSlinky.extjs.Ext.dd.IDragSource
import typingsSlinky.extjs.Ext.dd.IStatusProxy
...
object ISpriteDD {
  ...
  def apply(
    ...
    getDragEl: /* e */ js.UndefOr[js.Any] => HTMLElement = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => ISpriteDD = null,
    initFrame: () => Unit = null,
    ...
    if (setDragElPos != null) __obj.updateDynamic("setDragElPos")(js.Any.fromFunction0(setDragElPos))
