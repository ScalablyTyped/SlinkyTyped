...
object IComponent {
  ...
  def apply(
    ...
    findParentBy: /* fn */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.container.IContainer = null,
    findParentByType: /* xtype */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.container.IContainer = null,
    ...
    toFront: js.UndefOr[Boolean] => IComponent = null,
