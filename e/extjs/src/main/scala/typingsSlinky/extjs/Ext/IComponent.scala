...
object IComponent {
  ...
  implicit class IComponentOps[Self <: IComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFindParentBy(value: /* fn */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.container.IContainer): Self = this.set("findParentBy", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteFindParentBy: Self = this.set("findParentBy", js.undefined)
    
    @scala.inline
    def setFindParentByType(value: /* xtype */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.container.IContainer): Self = this.set("findParentByType", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setToFront(value: js.UndefOr[Boolean] => IComponent): Self = this.set("toFront", js.Any.fromFunction1(value))
