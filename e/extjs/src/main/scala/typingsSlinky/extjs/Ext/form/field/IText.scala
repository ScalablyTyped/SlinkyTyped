...
object IText {
  ...
  implicit class ITextOps[Self <: IText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaskRe(value: js.RegExp): Self = this.set("maskRe", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStripCharsRe(value: js.RegExp): Self = this.set("stripCharsRe", value.asInstanceOf[js.Any])
