...
object IText {
  ...
  implicit class ITextMutableBuilder[Self <: IText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaskRe(value: js.RegExp): Self = StObject.set(x, "maskRe", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStripCharsRe(value: js.RegExp): Self = StObject.set(x, "stripCharsRe", value.asInstanceOf[js.Any])
