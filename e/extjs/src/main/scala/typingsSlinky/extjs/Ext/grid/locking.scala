...
object locking {
  ...
  object ILockable {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.grid.locking.ILockable = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.grid.locking.ILockable]
    }
    
    @scala.inline
    implicit class ILockableMutableBuilder[Self <: typingsSlinky.extjs.Ext.grid.locking.ILockable] (val x: Self) extends AnyVal {
  ...
  object IView {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.grid.locking.IView = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.grid.locking.IView]
    }
    
    @scala.inline
    implicit class IViewMutableBuilder[Self <: typingsSlinky.extjs.Ext.grid.locking.IView] (val x: Self) extends AnyVal {
