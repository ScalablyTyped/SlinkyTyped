...
trait IContext extends IBase {
  ...
  var getEl: js.UndefOr[
    js.Function2[
      ...
      /* el */ js.UndefOr[typingsSlinky.extjs.Ext.dom.IElement], 
      Unit
    ]
  ] = js.undefined
...
object IContext {
  ...
  def apply(
    ...
    getEl: (/* parent */ js.UndefOr[IContextItem], /* el */ js.UndefOr[typingsSlinky.extjs.Ext.dom.IElement]) => Unit = null,
    ...
    mixins: js.Any = null,
    removeEl: (/* parent */ js.UndefOr[IContextItem], /* el */ js.UndefOr[typingsSlinky.extjs.Ext.dom.IElement]) => Unit = null,
    requires: Array = null,
