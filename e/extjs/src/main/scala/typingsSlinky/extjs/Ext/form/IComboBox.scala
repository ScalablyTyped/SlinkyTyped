...
object IComboBox {
  @scala.inline
  def apply(
    IPicker: typingsSlinky.extjs.Ext.form.field.IPicker = null,
    ...
    typeAheadDelay: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(enableRegEx)) __obj.updateDynamic("enableRegEx")(enableRegEx.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(growToLongestValue)) __obj.updateDynamic("growToLongestValue")(growToLongestValue.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(queryCaching)) __obj.updateDynamic("queryCaching")(queryCaching.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(typeAheadDelay)) __obj.updateDynamic("typeAheadDelay")(typeAheadDelay.get.asInstanceOf[js.Any])
