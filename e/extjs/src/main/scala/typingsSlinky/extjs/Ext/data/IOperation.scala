...
object IOperation {
  ...
  implicit class IOperationMutableBuilder[Self <: IOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionCommitRecordsRe(value: js.RegExp): Self = StObject.set(x, "actionCommitRecordsRe", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActionCommitRecordsReUndefined: Self = StObject.set(x, "actionCommitRecordsRe", js.undefined)
    
    @scala.inline
    def setActionSkipSyncRe(value: js.RegExp): Self = StObject.set(x, "actionSkipSyncRe", value.asInstanceOf[js.Any])
