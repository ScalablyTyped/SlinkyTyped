...
object IOperation {
  ...
  implicit class IOperationOps[Self <: IOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionCommitRecordsRe(value: js.RegExp): Self = this.set("actionCommitRecordsRe", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteActionCommitRecordsRe: Self = this.set("actionCommitRecordsRe", js.undefined)
    
    @scala.inline
    def setActionSkipSyncRe(value: js.RegExp): Self = this.set("actionSkipSyncRe", value.asInstanceOf[js.Any])
