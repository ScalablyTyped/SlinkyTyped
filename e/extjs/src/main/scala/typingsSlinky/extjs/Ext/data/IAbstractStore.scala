...
object IAbstractStore {
  ...
  implicit class IAbstractStoreMutableBuilder[Self <: IAbstractStore] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetProxy(value: () => typingsSlinky.extjs.Ext.data.proxy.IProxy): Self = StObject.set(x, "getProxy", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetProxy(value: /* proxy */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.proxy.IProxy): Self = StObject.set(x, "setProxy", js.Any.fromFunction1(value))
