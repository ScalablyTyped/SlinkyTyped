...
object IAbstractStore {
  ...
  implicit class IAbstractStoreOps[Self <: IAbstractStore] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetProxy(value: () => typingsSlinky.extjs.Ext.data.proxy.IProxy): Self = this.set("getProxy", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetProxy(value: /* proxy */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.data.proxy.IProxy): Self = this.set("setProxy", js.Any.fromFunction1(value))
