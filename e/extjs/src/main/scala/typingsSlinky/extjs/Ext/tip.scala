...
object tip {
  ...
  object IQuickTip {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.tip.IQuickTip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.tip.IQuickTip]
    }
    
    @scala.inline
    implicit class IQuickTipMutableBuilder[Self <: typingsSlinky.extjs.Ext.tip.IQuickTip] (val x: Self) extends AnyVal {
  ...
  object ITip {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.tip.ITip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.tip.ITip]
    }
    
    @scala.inline
    implicit class ITipMutableBuilder[Self <: typingsSlinky.extjs.Ext.tip.ITip] (val x: Self) extends AnyVal {
  ...
  object IToolTip {
    ...
    @scala.inline
    def apply(): typingsSlinky.extjs.Ext.tip.IToolTip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.extjs.Ext.tip.IToolTip]
    }
    
    @scala.inline
    implicit class IToolTipMutableBuilder[Self <: typingsSlinky.extjs.Ext.tip.IToolTip] (val x: Self) extends AnyVal {
