...
object IButton {
  ...
  def apply(
    ...
    hideMenu: () => typingsSlinky.extjs.Ext.button.IButton = null,
    ...
    scale: js.Any = null,
    scope: js.Any = null,
    setGlyph: /* glyph */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.button.IButton = null,
    setHandler: (/* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.button.IButton = null,
    setHref: /* href */ js.UndefOr[java.lang.String] => Unit = null,
    setIcon: /* icon */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.button.IButton = null,
    setIconCls: /* cls */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.button.IButton = null,
    setParams: /* params */ js.UndefOr[js.Any] => Unit = null,
    setScale: /* scale */ js.UndefOr[java.lang.String] => Unit = null,
    setText: /* text */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.button.IButton = null,
    setTextAlign: /* align */ js.UndefOr[java.lang.String] => Unit = null,
    setTooltip: /* tooltip */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.button.IButton = null,
    ...
    toggle: (/* state */ js.UndefOr[Boolean], /* suppressEvent */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.button.IButton = null,
