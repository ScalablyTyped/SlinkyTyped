...
object IButton {
  ...
  implicit class IButtonOps[Self <: IButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArrowAlign(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withArrowCls(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMenuActiveCls(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetHref(value: /* href */ js.UndefOr[String] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetIcon(value: /* icon */ js.UndefOr[String] => IButton): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetIconCls(value: /* cls */ js.UndefOr[String] => IButton): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetScale(value: /* scale */ js.UndefOr[String] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetText(value: /* text */ js.UndefOr[String] => IButton): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetTextAlign(value: /* align */ js.UndefOr[String] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withToggleGroup(value: String): Self = {
        val ret = this.duplicate
