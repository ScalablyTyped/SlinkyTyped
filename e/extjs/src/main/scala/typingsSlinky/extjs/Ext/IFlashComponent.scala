...
object IFlashComponent {
  ...
  implicit class IFlashComponentOps[Self <: IFlashComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEXPRESS_INSTALL_URL(value: java.lang.String): Self = {
    ...
    @scala.inline
    def withBackgroundColor(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFlashVersion(value: java.lang.String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWmode(value: java.lang.String): Self = {
        val ret = this.duplicate
