...
trait IAbstractElement extends IBase {
  ...
  /** [Method] Set the innerHTML of this element
    ...
    */
  var setHTML: js.UndefOr[js.Function1[/* html */ js.UndefOr[String], typingsSlinky.extjs.Ext.IElement]] = js.undefined
...
object IAbstractElement {
  ...
  def apply(
    ...
    requires: Array = null,
    select: (/* selector */ js.UndefOr[String], /* unique */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.ICompositeElement = null,
    self: IClass = null,
    serializeForm: /* form */ js.UndefOr[js.Any] => String = null,
    set: (/* o */ js.UndefOr[js.Any], /* useSet */ js.UndefOr[Boolean]) => IElement = null,
    setHTML: /* html */ js.UndefOr[String] => typingsSlinky.extjs.Ext.IElement = null,
    ...
    unmask: () => Unit = null,
    up: (/* selector */ js.UndefOr[String], /* limit */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.IElement = null,
