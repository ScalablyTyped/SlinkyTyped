...
trait IAbstractElement extends IBase {
  ...
  /** [Method] Forces the browser to repaint this element Defined in override Ext dom AbstractElement_style
  		* @returns Ext.dom.Element this
  		*/
  var repaint: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.dom.IElement]] = js.undefined
...
object IAbstractElement {
  ...
  def apply(
    ...
    hide: /* animate */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    requires: Array = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.ICompositeElement = null,
    self: IClass = null,
    ...
    setHTML: /* html */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.IElement = null,
    setHeight: /* height */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    setSize: (/* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    setVisible: (/* visible */ js.UndefOr[Boolean], /* animate */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setWidth: /* width */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    show: /* animate */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    statics: js.Any = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.IElement = null,
    unmask: () => Unit = null,
    up: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.IElement = null,
    update: /* html */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.IElement = null,
    uses: Array = null,
