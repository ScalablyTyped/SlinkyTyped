...
trait IDatePicker extends IComponent {
  ...
  /** [Method] Sets the current value to today
  		* @returns Ext.picker.Date this
  		*/
  var selectToday: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.picker.IDate]] = js.undefined
  /** [Config Option] (String) */
  ...
  /** [Method] Show the next month
  		...
  		* @returns Ext.picker.Date this
  		*/
  var showNextMonth: js.UndefOr[js.Function1[/* e */ js.UndefOr[js.Any], typingsSlinky.extjs.Ext.picker.IDate]] = js.undefined
  /** [Method] Show the next year
  		* @returns Ext.picker.Date this
  		*/
  var showNextYear: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.picker.IDate]] = js.undefined
  /** [Method] Show the previous month
  		* @param e Object
  		* @returns Ext.picker.Date this
  		*/
  var showPrevMonth: js.UndefOr[js.Function1[/* e */ js.UndefOr[js.Any], typingsSlinky.extjs.Ext.picker.IDate]] = js.undefined
  /** [Method] Show the previous year
  		* @returns Ext.picker.Date this
  		*/
  var showPrevYear: js.UndefOr[js.Function0[typingsSlinky.extjs.Ext.picker.IDate]] = js.undefined
  /** [Config Option] (Boolean) */
...
object IDatePicker {
  ...
  def apply(
    ...
    getValue: () => _ = null,
    handler: js.Any = null,
    hideMonthPicker: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.picker.IDate = null,
    ...
    scope: js.Any = null,
    selectToday: () => typingsSlinky.extjs.Ext.picker.IDate = null,
    selectedCls: java.lang.String = null,
    setDisabledDates: /* disabledDates */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate = null,
    setDisabledDays: /* disabledDays */ js.UndefOr[Array] => typingsSlinky.extjs.Ext.picker.IDate = null,
    setMaxDate: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate = null,
    setMinDate: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate = null,
    setValue: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate = null,
    showMonthPicker: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.picker.IDate = null,
    showNextMonth: /* e */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate = null,
    showNextYear: () => typingsSlinky.extjs.Ext.picker.IDate = null,
    showPrevMonth: /* e */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate = null,
    showPrevYear: () => typingsSlinky.extjs.Ext.picker.IDate = null,
