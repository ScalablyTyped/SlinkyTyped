...
object IDatePicker {
  ...
  implicit class IDatePickerOps[Self <: IDatePicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabledDatesRE(value: js.RegExp): Self = this.set("disabledDatesRE", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHideMonthPicker(value: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("hideMonthPicker", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSelectToday(value: () => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("selectToday", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetDisabledDates(value: /* disabledDates */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("setDisabledDates", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetDisabledDates: Self = this.set("setDisabledDates", js.undefined)
    
    @scala.inline
    def setSetDisabledDays(value: /* disabledDays */ js.UndefOr[Array] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("setDisabledDays", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetDisabledDays: Self = this.set("setDisabledDays", js.undefined)
    
    @scala.inline
    def setSetMaxDate(value: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("setMaxDate", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetMaxDate: Self = this.set("setMaxDate", js.undefined)
    
    @scala.inline
    def setSetMinDate(value: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("setMinDate", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetMinDate: Self = this.set("setMinDate", js.undefined)
    
    @scala.inline
    def setSetValue(value: /* value */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("setValue", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetValue: Self = this.set("setValue", js.undefined)
    
    @scala.inline
    def setShowMonthPicker(value: /* animate */ js.UndefOr[Boolean] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("showMonthPicker", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteShowMonthPicker: Self = this.set("showMonthPicker", js.undefined)
    
    @scala.inline
    def setShowNextMonth(value: /* e */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("showNextMonth", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteShowNextMonth: Self = this.set("showNextMonth", js.undefined)
    
    @scala.inline
    def setShowNextYear(value: () => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("showNextYear", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteShowNextYear: Self = this.set("showNextYear", js.undefined)
    
    @scala.inline
    def setShowPrevMonth(value: /* e */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("showPrevMonth", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteShowPrevMonth: Self = this.set("showPrevMonth", js.undefined)
    
    @scala.inline
    def setShowPrevYear(value: () => typingsSlinky.extjs.Ext.picker.IDate): Self = this.set("showPrevYear", js.Any.fromFunction0(value))
