...
object IMessageBox {
  @scala.inline
  def apply(
    CANCEL: js.UndefOr[Double] = js.undefined,
    ERROR: String = null,
    INFO: String = null,
    IWindow: IWindow = null,
    NO: js.UndefOr[Double] = js.undefined,
    OK: js.UndefOr[Double] = js.undefined,
    OKCANCEL: js.UndefOr[Double] = js.undefined,
    QUESTION: String = null,
    WARNING: String = null,
    YES: js.UndefOr[Double] = js.undefined,
    YESNO: js.UndefOr[Double] = js.undefined,
    YESNOCANCEL: js.UndefOr[Double] = js.undefined,
    ...
    minProgressWidth: js.UndefOr[Double] = js.undefined,
    minPromptWidth: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(NO)) __obj.updateDynamic("NO")(NO.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(YES)) __obj.updateDynamic("YES")(YES.get.asInstanceOf[js.Any])
    if (!js.isUndefined(YESNO)) __obj.updateDynamic("YESNO")(YESNO.get.asInstanceOf[js.Any])
    if (!js.isUndefined(YESNOCANCEL)) __obj.updateDynamic("YESNOCANCEL")(YESNOCANCEL.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(minProgressWidth)) __obj.updateDynamic("minProgressWidth")(minProgressWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(minPromptWidth)) __obj.updateDynamic("minPromptWidth")(minPromptWidth.get.asInstanceOf[js.Any])
