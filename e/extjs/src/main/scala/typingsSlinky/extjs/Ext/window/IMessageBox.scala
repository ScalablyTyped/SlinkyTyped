...
trait IMessageBox
  extends typingsSlinky.extjs.Ext.window.IWindow {
  /** [Property] (Number) */
...
object IMessageBox {
  ...
  def apply(
    ...
    IWindow: typingsSlinky.extjs.Ext.window.IWindow = null,
    NO: Int | Double = null,
    OK: Int | Double = null,
    ...
    alert: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    buttonText: js.Any = null,
    confirm: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    defaultTextHeight: Int | Double = null,
    hide: () => IComponent = null,
    minProgressWidth: Int | Double = null,
    minPromptWidth: Int | Double = null,
    progress: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* progressText */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    prompt: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* multiline */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    setIcon: (/* icon */ js.UndefOr[java.lang.String], /* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    show: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    updateProgress: (/* value */ js.UndefOr[Double], /* progressText */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.window.IMessageBox = null,
    wait: (/* msg */ js.UndefOr[java.lang.String], /* title */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.window.IMessageBox = null
  ): IMessageBox = {
