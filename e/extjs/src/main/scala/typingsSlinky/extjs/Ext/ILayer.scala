...
trait ILayer extends IElement {
  ...
  /** [Method] Sets the element s top position directly using CSS style instead of setY
    ...
    */
  @JSName("setTop")
  var setTop_ILayer: js.UndefOr[js.Function1[/* top */ js.UndefOr[js.Any], typingsSlinky.extjs.Ext.dom.IElement]] = js.undefined
  /** [Method] overridden Element method
...
object ILayer {
  ...
  def apply(
    ...
    addCls: /* className */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    addKeyListener: (/* key */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.util.IKeyMap = null,
    addKeyMap: /* config */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.util.IKeyMap = null,
    ...
    applyStyles: /* styles */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => ILayer = null,
    ...
    radioCls: /* className */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    relayEvent: (/* eventName */ js.UndefOr[java.lang.String], /* observable */ js.UndefOr[js.Any]) => Unit = null,
    remove: () => Unit = null,
    removeAllListeners: () => ILayer = null,
    removeCls: /* className */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => ILayer = null,
    repaint: () => typingsSlinky.extjs.Ext.dom.IElement = null,
    replace: /* el */ js.UndefOr[js.Any] => ILayer = null,
    replaceCls: (/* oldClassName */ js.UndefOr[java.lang.String], /* newClassName */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    set: (/* o */ js.UndefOr[js.Any], /* useSet */ js.UndefOr[Boolean]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setBottom: /* bottom */ js.UndefOr[js.Any] => ILayer = null,
    setBounds: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setDisplayed: /* value */ js.UndefOr[js.Any] => ILayer = null,
    setHTML: /* html */ js.UndefOr[java.lang.String] => IElement = null,
    setHeight: (/* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setLeft: /* left */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    setLeftTop: (/* left */ js.UndefOr[js.Any], /* top */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    setSize: (/* w */ js.UndefOr[js.Any], /* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setTop: /* top */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement = null,
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => ILayer = null,
    setVisible: (/* visible */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    setWidth: (/* w */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typingsSlinky.extjs.Ext.dom.IElement = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => ILayer = null,
