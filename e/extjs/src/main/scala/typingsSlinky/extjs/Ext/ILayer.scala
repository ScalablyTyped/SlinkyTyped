...
object ILayer {
  ...
  implicit class ILayerOps[Self <: ILayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetLeft(value: /* left */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement): Self = this.set("setLeft", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSetTop(value: /* top */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement): Self = this.set("setTop", js.Any.fromFunction1(value))
