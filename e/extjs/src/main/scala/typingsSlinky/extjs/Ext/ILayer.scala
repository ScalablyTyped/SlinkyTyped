...
object ILayer {
  ...
  implicit class ILayerOps[Self <: ILayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetLeft(value: /* left */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetTop(value: /* top */ js.UndefOr[js.Any] => typingsSlinky.extjs.Ext.dom.IElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVisibilityCls(value: java.lang.String): Self = {
        val ret = this.duplicate
