...
object remote extends Shortcut {
  ...
  @JSImport("electron", "remote.BrowserView")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("electron", "remote.Notification")
  @js.native
  /**
    * Notification
    */
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("electron", "remote.ServiceWorkers")
  @js.native
  class ServiceWorkersCls ()
    extends typingsSlinky.electron.Electron.ServiceWorkers
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("electron", "remote.TouchBarButton")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("electron", "remote.TouchBar")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("electron", "remote.TouchBarColorPicker")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("electron", "remote.TouchBarOtherItemsProxy")
  @js.native
