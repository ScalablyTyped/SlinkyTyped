...
import typingsSlinky.electron.electronStrings.longEdge
import typingsSlinky.electron.electronStrings.shortEdge
import typingsSlinky.electron.electronStrings.simplex
