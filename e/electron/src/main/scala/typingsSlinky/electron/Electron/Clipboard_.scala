...
trait Clipboard_ extends EventEmitter {
  ...
  @JSName("readImage")
  def readImage_clipboard(`type`: typingsSlinky.electron.electronStrings.clipboard): NativeImage_ = js.native
  @JSName("readImage")
  ...
  @JSName("writeImage")
  def writeImage_clipboard(image: NativeImage_, `type`: typingsSlinky.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeImage")
