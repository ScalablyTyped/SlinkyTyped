...
import typingsSlinky.electron.electronStrings.`balloon-click`
import typingsSlinky.electron.electronStrings.`balloon-closed`
import typingsSlinky.electron.electronStrings.`balloon-show`
import typingsSlinky.electron.electronStrings.`double-click`
import typingsSlinky.electron.electronStrings.`drag-end`
import typingsSlinky.electron.electronStrings.`drag-enter`
import typingsSlinky.electron.electronStrings.`drag-leave`
import typingsSlinky.electron.electronStrings.`drop-files`
import typingsSlinky.electron.electronStrings.`drop-text`
import typingsSlinky.electron.electronStrings.`mouse-down`
import typingsSlinky.electron.electronStrings.`mouse-enter`
import typingsSlinky.electron.electronStrings.`mouse-leave`
import typingsSlinky.electron.electronStrings.`mouse-move`
import typingsSlinky.electron.electronStrings.`mouse-up`
