...
import typingsSlinky.electron.electronStrings.cancelled
import typingsSlinky.electron.electronStrings.completed
import typingsSlinky.electron.electronStrings.done
