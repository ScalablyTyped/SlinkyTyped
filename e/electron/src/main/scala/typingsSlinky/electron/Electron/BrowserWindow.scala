...
import typingsSlinky.electron.anon.PartialRectangle
import typingsSlinky.electron.electronStrings.`always-on-top-changed`
import typingsSlinky.electron.electronStrings.`app-command`
import typingsSlinky.electron.electronStrings.`appearance-based`
import typingsSlinky.electron.electronStrings.`enter-full-screen`
import typingsSlinky.electron.electronStrings.`enter-html-full-screen`
import typingsSlinky.electron.electronStrings.`fullscreen-ui`
import typingsSlinky.electron.electronStrings.`leave-full-screen`
import typingsSlinky.electron.electronStrings.`leave-html-full-screen`
import typingsSlinky.electron.electronStrings.`main-menu`
import typingsSlinky.electron.electronStrings.`medium-light`
import typingsSlinky.electron.electronStrings.`modal-panel`
...
import typingsSlinky.electron.electronStrings.`pop-up-menu`
import typingsSlinky.electron.electronStrings.`ready-to-show`
import typingsSlinky.electron.electronStrings.`rotate-gesture`
import typingsSlinky.electron.electronStrings.`screen-saver`
import typingsSlinky.electron.electronStrings.`scroll-touch-begin`
import typingsSlinky.electron.electronStrings.`scroll-touch-edge`
import typingsSlinky.electron.electronStrings.`scroll-touch-end`
...
import typingsSlinky.electron.electronStrings.`will-move`
import typingsSlinky.electron.electronStrings.`will-resize`
import typingsSlinky.electron.electronStrings.blur
import typingsSlinky.electron.electronStrings.close
import typingsSlinky.electron.electronStrings.closed
import typingsSlinky.electron.electronStrings.content
import typingsSlinky.electron.electronStrings.dark
import typingsSlinky.electron.electronStrings.floating
...
import typingsSlinky.electron.electronStrings.maximize
import typingsSlinky.electron.electronStrings.menu
import typingsSlinky.electron.electronStrings.minimize
import typingsSlinky.electron.electronStrings.move
import typingsSlinky.electron.electronStrings.moved
...
import typingsSlinky.electron.electronStrings.sheet
import typingsSlinky.electron.electronStrings.show
import typingsSlinky.electron.electronStrings.sidebar
import typingsSlinky.electron.electronStrings.status
import typingsSlinky.electron.electronStrings.swipe
import typingsSlinky.electron.electronStrings.titlebar
import typingsSlinky.electron.electronStrings.tooltip
import typingsSlinky.electron.electronStrings.unmaximize
