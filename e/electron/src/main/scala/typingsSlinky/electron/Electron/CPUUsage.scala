...
object CPUUsage {
  ...
  implicit class CPUUsageOps[Self <: CPUUsage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIdleWakeupsPerSecond(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("idleWakeupsPerSecond")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPercentCPUUsage(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("percentCPUUsage")(value.asInstanceOf[js.Any])
        ret
    }
  }
