...
import typingsSlinky.electron.electronStrings.`accent-color-changed`
import typingsSlinky.electron.electronStrings.`color-changed`
import typingsSlinky.electron.electronStrings.`high-contrast-color-scheme-changed`
import typingsSlinky.electron.electronStrings.`inverted-color-scheme-changed`
import typingsSlinky.electron.electronStrings.`not-determined`
import typingsSlinky.electron.electronStrings.array
import typingsSlinky.electron.electronStrings.blue
import typingsSlinky.electron.electronStrings.boolean
import typingsSlinky.electron.electronStrings.brown
import typingsSlinky.electron.electronStrings.camera
import typingsSlinky.electron.electronStrings.dark
import typingsSlinky.electron.electronStrings.denied
import typingsSlinky.electron.electronStrings.dictionary
import typingsSlinky.electron.electronStrings.double
import typingsSlinky.electron.electronStrings.float
import typingsSlinky.electron.electronStrings.granted
import typingsSlinky.electron.electronStrings.gray
import typingsSlinky.electron.electronStrings.green
import typingsSlinky.electron.electronStrings.integer
import typingsSlinky.electron.electronStrings.light
import typingsSlinky.electron.electronStrings.microphone
import typingsSlinky.electron.electronStrings.orange
import typingsSlinky.electron.electronStrings.pink
import typingsSlinky.electron.electronStrings.purple
import typingsSlinky.electron.electronStrings.red
import typingsSlinky.electron.electronStrings.restricted
import typingsSlinky.electron.electronStrings.screen
import typingsSlinky.electron.electronStrings.string
import typingsSlinky.electron.electronStrings.unknown_
import typingsSlinky.electron.electronStrings.url
import typingsSlinky.electron.electronStrings.yellow
