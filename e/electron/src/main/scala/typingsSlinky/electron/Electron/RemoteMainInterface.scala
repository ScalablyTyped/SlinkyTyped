...
trait RemoteMainInterface extends StObject {
  ...
  var Menu: TypeofMenu with Instantiable0[typingsSlinky.electron.Electron.Menu] = js.native
  ...
  var TouchBar: TypeofTouchBar with (Instantiable1[/* options */ TouchBarConstructorOptions, typingsSlinky.electron.Electron.TouchBar]) = js.native
