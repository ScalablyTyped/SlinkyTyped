...
import typingsSlinky.electron.electronStrings.`accessibility-support-changed`
import typingsSlinky.electron.electronStrings.`activity-was-continued`
import typingsSlinky.electron.electronStrings.`before-quit`
import typingsSlinky.electron.electronStrings.`browser-window-blur`
...
import typingsSlinky.electron.electronStrings.`open-file`
import typingsSlinky.electron.electronStrings.`open-url`
import typingsSlinky.electron.electronStrings.`remote-get-builtin`
import typingsSlinky.electron.electronStrings.`remote-get-current-web-contents`
import typingsSlinky.electron.electronStrings.`remote-get-current-window`
import typingsSlinky.electron.electronStrings.`remote-get-global`
import typingsSlinky.electron.electronStrings.`remote-require`
import typingsSlinky.electron.electronStrings.`render-process-gone`
import typingsSlinky.electron.electronStrings.`renderer-process-crashed`
import typingsSlinky.electron.electronStrings.`second-instance`
import typingsSlinky.electron.electronStrings.`select-client-certificate`
import typingsSlinky.electron.electronStrings.`session-created`
import typingsSlinky.electron.electronStrings.`update-activity-state`
import typingsSlinky.electron.electronStrings.`web-contents-created`
import typingsSlinky.electron.electronStrings.`will-continue-activity`
import typingsSlinky.electron.electronStrings.`will-finish-launching`
import typingsSlinky.electron.electronStrings.`will-quit`
import typingsSlinky.electron.electronStrings.`window-all-closed`
import typingsSlinky.electron.electronStrings.accessory
import typingsSlinky.electron.electronStrings.activate
import typingsSlinky.electron.electronStrings.appData
import typingsSlinky.electron.electronStrings.basic
import typingsSlinky.electron.electronStrings.cache
import typingsSlinky.electron.electronStrings.complete
import typingsSlinky.electron.electronStrings.crashDumps
import typingsSlinky.electron.electronStrings.desktop
import typingsSlinky.electron.electronStrings.documents
import typingsSlinky.electron.electronStrings.downloads
import typingsSlinky.electron.electronStrings.exe
import typingsSlinky.electron.electronStrings.home
import typingsSlinky.electron.electronStrings.login
import typingsSlinky.electron.electronStrings.logs
import typingsSlinky.electron.electronStrings.module
import typingsSlinky.electron.electronStrings.music
import typingsSlinky.electron.electronStrings.pepperFlashSystemPlugin
import typingsSlinky.electron.electronStrings.pictures
