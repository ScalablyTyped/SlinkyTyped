...
@js.native
class Session ()
  extends typingsSlinky.electron.Electron.Session
...
object Session extends js.Object {
  /**
    ...
    */
  var defaultSession: js.UndefOr[typingsSlinky.electron.Electron.Session] = js.native
  ...
  /**
    ...
    */
  def fromPartition(partition: String): typingsSlinky.electron.Electron.Session = js.native
  def fromPartition(partition: String, options: FromPartitionOptions): typingsSlinky.electron.Electron.Session = js.native
}

@JSImport("electron", "session")
@js.native
object session
  extends Instantiable0[typingsSlinky.electron.Electron.Session] {
  /**
    * A Session object, the default session object of the app.
    */
  var defaultSession: js.UndefOr[typingsSlinky.electron.Electron.Session] = js.native
