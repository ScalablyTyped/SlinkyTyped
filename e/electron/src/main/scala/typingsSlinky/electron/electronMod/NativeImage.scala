...
@js.native
class NativeImage ()
  extends typingsSlinky.electron.Electron.NativeImage
...
object NativeImage extends js.Object {
  ...
  /**
    ...
    */
  def createEmpty(): typingsSlinky.electron.Electron.NativeImage = js.native
  /**
    * Creates a new NativeImage instance from buffer that contains the raw bitmap
    * pixel data returned by toBitmap(). The specific format is platform-dependent.
    */
  def createFromBitmap(buffer: Buffer, options: CreateFromBitmapOptions): typingsSlinky.electron.Electron.NativeImage = js.native
  /**
    * Creates a new NativeImage instance from buffer. Tries to decode as PNG or JPEG
    * first.
    */
  def createFromBuffer(buffer: Buffer): typingsSlinky.electron.Electron.NativeImage = js.native
  def createFromBuffer(buffer: Buffer, options: CreateFromBufferOptions): typingsSlinky.electron.Electron.NativeImage = js.native
  /**
    * Creates a new NativeImage instance from dataURL.
    */
  def createFromDataURL(dataURL: String): typingsSlinky.electron.Electron.NativeImage = js.native
  /**
    ...
    */
  def createFromNamedImage(imageName: String, hslShift: js.Array[Double]): typingsSlinky.electron.Electron.NativeImage = js.native
  /**
    * Creates a new NativeImage instance from a file located at path. This method
    * returns an empty image if the path does not exist, cannot be read, or is not a
    * valid image.
    */
  def createFromPath(path: String): typingsSlinky.electron.Electron.NativeImage = js.native
}

@JSImport("electron", "nativeImage")
@js.native
object nativeImage
  extends Instantiable0[typingsSlinky.electron.Electron.NativeImage] {
  // Docs: http://electronjs.org/docs/api/native-image
  /**
    * Creates an empty NativeImage instance.
    */
