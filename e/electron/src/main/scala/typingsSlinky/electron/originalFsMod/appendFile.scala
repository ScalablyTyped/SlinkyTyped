...
object appendFile extends js.Object {
  ...
  def promisify(file: Double, data: String): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: Double, data: String, options: WriteFileOptions): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: Double, data: js.typedarray.Uint8Array): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: Double, data: js.typedarray.Uint8Array, options: WriteFileOptions): js.Promise[Unit] = js.native
  /**
    ...
    */
  @JSName("__promisify__")
  def promisify(file: PathLike, data: String): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: PathLike, data: String, options: WriteFileOptions): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: PathLike, data: js.typedarray.Uint8Array): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: PathLike, data: js.typedarray.Uint8Array, options: WriteFileOptions): js.Promise[Unit] = js.native
}
