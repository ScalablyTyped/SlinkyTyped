package typingsSlinky.esfxCancelable

import typingsSlinky.esfxCancelable.distMod.CancelSubscription
import typingsSlinky.esfxCancelable.distMod.CancelableCancelSignal
...
object mod {
  ...
  @js.native
  class CancelError ()
    extends typingsSlinky.esfxCancelable.distMod.CancelError {
