...
object CancelSignal {
  ...
  implicit class CancelSignalOps[Self <: CancelSignal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSignaled(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("signaled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSubscribe(value: js.Function0[Unit] => CancelSubscription): Self = {
        val ret = this.duplicate
