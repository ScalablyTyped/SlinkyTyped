package typingsSlinky.atEsfxCancelable

import typingsSlinky.atEsfxCancelable.distMod.CancelSubscription
import typingsSlinky.atEsfxCancelable.distMod.CancelableCancelSignal
...
@js.native
object atEsfxCancelableMod extends js.Object {
  @js.native
  class CancelError ()
    extends typingsSlinky.atEsfxCancelable.distMod.CancelError {
  ...
  object CancelSubscription extends js.Object {
    /**
      ...
      */
    def create(unsubscribe: js.Function0[Unit]): typingsSlinky.atEsfxCancelable.distMod.CancelSubscription = js.native
  }
  ...
  object Cancelable extends js.Object {
    ...
    val name: typingsSlinky.atEsfxCancelable.atEsfxCancelableStrings.Cancelable = js.native
    /**
    ...
    /**
      ...
      */
    def isSignaled(cancelable: typingsSlinky.atEsfxCancelable.distMod.Cancelable): Boolean = js.native
    ...
    /**
      ...
      */
    def subscribe(cancelable: typingsSlinky.atEsfxCancelable.distMod.Cancelable, onSignaled: js.Function0[Unit]): CancelSubscription = js.native
    def throwIfSignaled(): Unit = js.native
    /**
      * Throws a `CancelError` exception if the provided `cancelable` is in the signaled state.
      */
    def throwIfSignaled(cancelable: typingsSlinky.atEsfxCancelable.distMod.Cancelable): Unit = js.native
  }
  ...
  object CancelableSource extends js.Object {
    ...
    /**
      ...
      */
    val cancelSignal: js.Symbol = js.native
    val name: typingsSlinky.atEsfxCancelable.atEsfxCancelableStrings.CancelableSource = js.native
    /**
