...
import typingsSlinky.egg.mod.IgnoreItem
...
object anon {
  ...
  object Callback {
    ...
    implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setWhiteList(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = StObject.set(x, "whiteList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWhiteListRegExp(value: js.RegExp): Self = StObject.set(x, "whiteList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWhiteListVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "whiteList", js.Array(value :_*))
    }
  }
