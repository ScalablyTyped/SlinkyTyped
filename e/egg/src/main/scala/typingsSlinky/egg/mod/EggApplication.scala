...
class EggApplication () extends EggCoreBase[EggAppConfig] {
  ...
  var Controller: Instantiable0[typingsSlinky.egg.mod.Controller] = js.native
  var HttpClient: EggHttpConstructor = js.native
  var Service: Instantiable0[typingsSlinky.egg.mod.Service] = js.native
  var Subscription: Instantiable0[typingsSlinky.egg.mod.Subscription] = js.native
  /**
