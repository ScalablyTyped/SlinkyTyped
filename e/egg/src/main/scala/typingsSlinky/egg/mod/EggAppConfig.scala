...
object EggAppConfig {
  ...
  implicit class EggAppConfigOps[Self <: EggAppConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClientError(value: (js.Error, Socket, EggApplication) => ClientErrorResponse | js.Promise[ClientErrorResponse]): Self = this.set("onClientError", js.Any.fromFunction3(value))
