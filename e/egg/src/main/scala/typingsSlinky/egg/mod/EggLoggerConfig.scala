...
object EggLoggerConfig {
  ...
  implicit class EggLoggerConfigOps[Self <: EggLoggerConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConsoleLevel(value: typingsSlinky.eggLogger.mod.LoggerLevel): Self = this.set("consoleLevel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLevel(value: typingsSlinky.eggLogger.mod.LoggerLevel): Self = this.set("level", value.asInstanceOf[js.Any])
    @scala.inline
