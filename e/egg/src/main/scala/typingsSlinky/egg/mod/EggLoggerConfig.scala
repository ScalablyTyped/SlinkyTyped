...
trait EggLoggerConfig extends js.Object {
  ...
  var consoleLevel: js.UndefOr[typingsSlinky.eggLogger.mod.LoggerLevel] = js.undefined
  ...
  var level: js.UndefOr[typingsSlinky.eggLogger.mod.LoggerLevel] = js.undefined
...
object EggLoggerConfig {
  ...
  def apply(
    ...
    consoleLevel: typingsSlinky.eggLogger.mod.LoggerLevel = null,
    coreLogger: PartialEggLoggerOptions = null,
    disableConsoleAfterReady: js.UndefOr[Boolean] = js.undefined,
    encoding: String = null,
    env: String = null,
    eol: String = null,
    level: typingsSlinky.eggLogger.mod.LoggerLevel = null,
