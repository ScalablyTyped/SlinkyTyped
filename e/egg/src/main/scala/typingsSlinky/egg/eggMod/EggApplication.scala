...
import typingsSlinky.eggDashCookies.eggDashCookiesMod.^
import typingsSlinky.eggDashCore.eggDashCoreMod.EggCoreBase
import typingsSlinky.eggDashCore.eggDashCoreMod.EggCoreOptions
import typingsSlinky.eggDashLogger.eggDashLoggerMod.EggContextLogger
import typingsSlinky.eggDashLogger.eggDashLoggerMod.EggLogger
import typingsSlinky.eggDashLogger.eggDashLoggerMod.EggLoggers
...
class EggApplication () extends EggCoreBase[EggAppConfig] {
  ...
  var Controller: Instantiable0[typingsSlinky.egg.eggMod.Controller] = js.native
  var HttpClient: EggHttpConstructor = js.native
  var Service: Instantiable0[typingsSlinky.egg.eggMod.Service] = js.native
  var Subscription: Instantiable0[typingsSlinky.egg.eggMod.Subscription] = js.native
  /**
