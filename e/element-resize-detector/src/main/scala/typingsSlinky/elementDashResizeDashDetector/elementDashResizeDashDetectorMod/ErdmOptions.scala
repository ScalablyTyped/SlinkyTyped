...
import typingsSlinky.elementDashResizeDashDetector.elementDashResizeDashDetectorStrings.`object`
import typingsSlinky.elementDashResizeDashDetector.elementDashResizeDashDetectorStrings.scroll
