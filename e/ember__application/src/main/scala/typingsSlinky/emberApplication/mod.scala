...
import typingsSlinky.emberApplication.anon.Instantiate
...
object mod extends js.Object {
  @js.native
  trait Application
    extends typingsSlinky.emberEngine.mod.default {
    /**
      * Application's router.
      */
    var Router: typingsSlinky.emberRouting.mod.Router = js.native
    /**
    ...
    /**
      ...
      */
    var eventDispatcher: typingsSlinky.emberApplication.eventDispatcherMod.default = js.native
    var registry: typingsSlinky.emberApplication.registryMod.default = js.native
    /**
      * Set this to provide an alternate class to Ember.DefaultResolver
      */
    @JSName("resolver")
    var resolver_Application: typingsSlinky.emberApplication.defaultResolverMod.default = js.native
    /**
