...
@js.native
object atEmberApplicationMod extends js.Object {
  @js.native
  trait Application
    ...
    /**
      ...
      */
    var Router: typingsSlinky.atEmberRouting.atEmberRoutingMod.Router = js.native
    /**
    ...
    /**
      ...
      */
    var eventDispatcher: typingsSlinky.atEmberApplication.dashPrivateEventDashDispatcherMod.default = js.native
    var registry: typingsSlinky.atEmberApplication.dashPrivateRegistryMod.default = js.native
    /**
      * Set this to provide an alternate class to Ember.DefaultResolver
      */
    @JSName("resolver")
    var resolver_Application: typingsSlinky.atEmberApplication.dashPrivateDefaultDashResolverMod.default = js.native
    /**
    ...
    def register(fullName: String, factory: js.Any, options: Anon_Instantiate): Unit = js.native
    /**
