...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsSlinky.expired.mod.expired = js.native
  
  type Headers = String | (StringDictionary[js.UndefOr[String | js.Array[String]]])
  
  type _To = typingsSlinky.expired.mod.expired
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.expired.mod.expired = ^
