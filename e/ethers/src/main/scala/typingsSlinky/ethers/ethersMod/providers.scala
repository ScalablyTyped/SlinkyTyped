...
object providers extends js.Object {
  ...
  class EtherscanProvider ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.EtherscanProvider {
  ...
  class FallbackProvider protected ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.FallbackProvider {
    def this(providers: js.Array[typingsSlinky.ethers.distTypesProvidersProviderMod.Provider]) = this()
  }
  
  @js.native
  class InfuraProvider ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.IpcProvider {
  ...
  class JsonRpcProvider ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.JsonRpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.Provider {
  ...
  class Web3Provider protected ()
    extends typingsSlinky.ethers.distTypesEthersMod.providers.Web3Provider {
