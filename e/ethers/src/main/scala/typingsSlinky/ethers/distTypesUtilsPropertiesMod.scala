...
@JSImport("ethers/dist/types/utils/properties", JSImport.Namespace)
@js.native
object distTypesUtilsPropertiesMod extends js.Object {
  ...
  def jsonCopy(`object`: js.Any): js.Any = js.native
