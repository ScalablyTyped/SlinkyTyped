...
object providers extends js.Object {
  ...
  class EtherscanProvider ()
    extends typingsSlinky.ethers.ethersMod.providers.EtherscanProvider {
  ...
  class InfuraProvider ()
    extends typingsSlinky.ethers.ethersMod.providers.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typingsSlinky.ethers.ethersMod.providers.IpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typingsSlinky.ethers.ethersMod.providers.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typingsSlinky.ethers.ethersMod.providers.Provider {
