...
@js.native
object distTypesProvidersMod extends js.Object {
  @js.native
  class EtherscanProvider ()
    extends typingsSlinky.ethers.distTypesProvidersEtherscanDashProviderMod.EtherscanProvider {
  ...
  class FallbackProvider protected ()
    extends typingsSlinky.ethers.distTypesProvidersFallbackDashProviderMod.FallbackProvider {
    def this(providers: js.Array[typingsSlinky.ethers.distTypesProvidersProviderMod.Provider]) = this()
  }
  
  @js.native
  class InfuraProvider ()
    extends typingsSlinky.ethers.distTypesProvidersInfuraDashProviderMod.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typingsSlinky.ethers.distTypesProvidersIpcDashProviderMod.IpcProvider {
  ...
  class JsonRpcProvider ()
    extends typingsSlinky.ethers.distTypesProvidersJsonDashRpcDashProviderMod.JsonRpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typingsSlinky.ethers.distTypesProvidersJsonDashRpcDashProviderMod.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typingsSlinky.ethers.distTypesProvidersProviderMod.Provider {
  ...
  class Web3Provider protected ()
    extends typingsSlinky.ethers.distTypesProvidersWeb3DashProviderMod.Web3Provider {
