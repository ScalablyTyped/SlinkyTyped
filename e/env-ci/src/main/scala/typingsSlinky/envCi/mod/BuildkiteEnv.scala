...
object BuildkiteEnv {
  ...
  implicit class BuildkiteEnvOps[Self <: BuildkiteEnv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: Buildkite): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoot(value: String): Self = this.set("root", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setService(value: buildkite_): Self = this.set("service", value.asInstanceOf[js.Any])
