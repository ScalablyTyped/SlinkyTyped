  ...
  */
  ...
  object ExpectToClickOptions {
    ...
    implicit class ExpectToClickOptionsMutableBuilder[Self <: ExpectToClickOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setText(value: String | js.RegExp): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextRegExp(value: js.RegExp): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
