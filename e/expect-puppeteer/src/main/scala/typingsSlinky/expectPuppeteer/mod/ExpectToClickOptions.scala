...
object ExpectToClickOptions {
  ...
  implicit class ExpectToClickOptionsOps[Self <: ExpectToClickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextRegExp(value: js.RegExp): Self = this.set("text", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setText(value: String | js.RegExp): Self = this.set("text", value.asInstanceOf[js.Any])
