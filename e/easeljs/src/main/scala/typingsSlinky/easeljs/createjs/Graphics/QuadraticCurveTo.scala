...
object QuadraticCurveTo {
  ...
  implicit class QuadraticCurveToOps[Self <: QuadraticCurveTo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCpx(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cpx")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCpy(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cpy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
