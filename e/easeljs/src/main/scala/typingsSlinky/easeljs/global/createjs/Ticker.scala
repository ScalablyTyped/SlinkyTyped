...
@js.native
class Ticker ()
  extends typingsSlinky.easeljs.createjs.Ticker
/* static members */
object Ticker {
  ...
  @JSGlobal("createjs.Ticker.addEventListener")
  @js.native
  def addEventListener(`type`: String, listener: typingsSlinky.easeljs.createjs.Stage): typingsSlinky.easeljs.createjs.Stage = js.native
  @JSGlobal("createjs.Ticker.addEventListener")
  @js.native
  def addEventListener(`type`: String, listener: typingsSlinky.easeljs.createjs.Stage, useCapture: Boolean): typingsSlinky.easeljs.createjs.Stage = js.native
