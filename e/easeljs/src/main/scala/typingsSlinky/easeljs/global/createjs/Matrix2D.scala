...
class Matrix2D protected ()
  extends typingsSlinky.easeljs.createjs.Matrix2D {
  def this(
    a: js.UndefOr[Double],
    b: js.UndefOr[Double],
    c: js.UndefOr[Double],
...
object Matrix2D {
  ...
  @js.native
  def identity: typingsSlinky.easeljs.createjs.Matrix2D = js.native
  @scala.inline
  def identity_=(x: typingsSlinky.easeljs.createjs.Matrix2D): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("identity")(x.asInstanceOf[js.Any])
}
