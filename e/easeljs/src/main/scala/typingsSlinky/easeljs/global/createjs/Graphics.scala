...
object Graphics {
  ...
  @js.native
  def beginCmd: typingsSlinky.easeljs.createjs.Graphics.BeginPath = js.native
  @scala.inline
  def beginCmd_=(x: typingsSlinky.easeljs.createjs.Graphics.BeginPath): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("beginCmd")(x.asInstanceOf[js.Any])
