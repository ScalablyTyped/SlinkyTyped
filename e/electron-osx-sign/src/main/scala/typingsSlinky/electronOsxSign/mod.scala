package typingsSlinky.electronOsxSign
...
object mod {
  ...
  @js.native
  def flat(opts: FlatOptions, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
  ...
  @js.native
  def sign(opts: SignOptions, callback: js.Function1[/* error */ js.Error, Unit]): Unit = js.native
