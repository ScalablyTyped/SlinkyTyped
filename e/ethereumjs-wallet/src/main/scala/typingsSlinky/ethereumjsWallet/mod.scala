...
import typingsSlinky.ethereumjsWallet.anon.Cipher
import typingsSlinky.ethereumjsWallet.anon.CipherText
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.ethereumjsWallet.mod.ScryptKDFParamsOut
    - typingsSlinky.ethereumjsWallet.mod.PBKDFParamsOut
  */
  trait KDFParamsOut extends StObject
  object KDFParamsOut {
    
    @scala.inline
    def PBKDFParamsOut(c: Double, dklen: Double, prf: String, salt: String): typingsSlinky.ethereumjsWallet.mod.PBKDFParamsOut = {
      ...
      __obj.asInstanceOf[typingsSlinky.ethereumjsWallet.mod.PBKDFParamsOut]
    }
    
    @scala.inline
    def ScryptKDFParamsOut(dklen: Double, n: Double, p: Double, r: Double, salt: String): typingsSlinky.ethereumjsWallet.mod.ScryptKDFParamsOut = {
      ...
      __obj.asInstanceOf[typingsSlinky.ethereumjsWallet.mod.ScryptKDFParamsOut]
    }
  }
