...
import typingsSlinky.ethereumjsWallet.mod.default
...
object thirdpartyMod {
  ...
  object default {
    ...
    @js.native
    def fromEtherCamp: js.Function1[/* passphrase */ String, typingsSlinky.ethereumjsWallet.mod.default] = js.native
    @JSImport("ethereumjs-wallet/dist/thirdparty", "default.fromEtherCamp")
    @js.native
    def fromEtherCamp(passphrase: String): typingsSlinky.ethereumjsWallet.mod.default = js.native
    @scala.inline
    def fromEtherCamp_=(x: js.Function1[/* passphrase */ String, typingsSlinky.ethereumjsWallet.mod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fromEtherCamp")(x.asInstanceOf[js.Any])
