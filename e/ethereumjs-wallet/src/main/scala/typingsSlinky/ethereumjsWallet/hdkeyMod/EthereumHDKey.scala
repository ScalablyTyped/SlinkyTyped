package typingsSlinky.ethereumjsWallet.hdkeyMod
...
trait EthereumHDKey extends js.Object {
  ...
  /**
    ...
    */
  def getWallet(): typingsSlinky.ethereumjsWallet.mod.default = js.native
...
object EthereumHDKey {
  ...
  def apply(
    ...
    getWallet: () => typingsSlinky.ethereumjsWallet.mod.default,
  ...
  implicit class EthereumHDKeyOps[Self <: EthereumHDKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetWallet(value: () => typingsSlinky.ethereumjsWallet.mod.default): Self = this.set("getWallet", js.Any.fromFunction0(value))
