package typingsSlinky.ethersprojectProperties
...
object mod extends js.Object {
  ...
  class Description[T] protected () extends js.Object {
    ...
    {[ K in keyof T ]: T[K]}
      */ typingsSlinky.ethersprojectProperties.ethersprojectPropertiesStrings.Description with TopLevel[T]) = this()
  }
  ...
  {[ P in keyof T ]: T[P] | std.Promise<T[P]>}
    */ typingsSlinky.ethersprojectProperties.ethersprojectPropertiesStrings.Resolvable with TopLevel[js.Any]
  type Similar[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: T[P]}
    */ typingsSlinky.ethersprojectProperties.ethersprojectPropertiesStrings.Similar with TopLevel[T]
}
