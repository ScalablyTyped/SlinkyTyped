...
object ^ extends js.Object {
  var algorithm: js.Function2[/* str */ String, /* options */ js.UndefOr[Options], String] = js.native
  var emit: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Emitter.emit */ js.Any = js.native
  var fragment: js.Function2[/* str */ String, /* options */ js.UndefOr[Options], String] = js.native
