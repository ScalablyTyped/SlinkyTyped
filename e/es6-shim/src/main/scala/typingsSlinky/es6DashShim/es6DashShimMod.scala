...
object es6DashShimMod extends js.Object {
  @js.native
  class Map[K, V] ()
    extends typingsSlinky.es6DashShim.Map[K, V] {
    def this(iterable: IterableShim[js.Tuple2[K, V]]) = this()
  }
  
  @js.native
  class Promise[T] protected ()
    extends typingsSlinky.es6DashShim.Promise[T] {
    /**
  ...
  @js.native
  class Set[T] ()
    extends typingsSlinky.es6DashShim.Set[T] {
    def this(iterable: IterableShim[T]) = this()
  }
  
  @js.native
  class WeakMap[K /* <: js.Object */, V] ()
    extends typingsSlinky.es6DashShim.WeakMap[K, V] {
    def this(iterable: IterableShim[js.Tuple2[K, V]]) = this()
    /* CompleteClass */
    ...
    /* CompleteClass */
    override def set(key: K, value: V): typingsSlinky.es6DashShim.WeakMap[K, V] = js.native
  }
  
  @js.native
  class WeakSet[T] ()
    extends typingsSlinky.es6DashShim.WeakSet[T] {
    def this(iterable: IterableShim[T]) = this()
    /* CompleteClass */
    override def add(value: T): typingsSlinky.es6DashShim.WeakSet[T] = js.native
    /* CompleteClass */
