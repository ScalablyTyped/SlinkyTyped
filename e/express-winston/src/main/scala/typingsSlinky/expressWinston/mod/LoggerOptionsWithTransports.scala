...
object LoggerOptionsWithTransports {
  ...
  implicit class LoggerOptionsWithTransportsOps[Self <: LoggerOptionsWithTransports] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransportsVarargs(value: typingsSlinky.winstonTransport.mod.^ *): Self = this.set("transports", js.Array(value :_*))
    @scala.inline
    def setTransports(value: js.Array[typingsSlinky.winstonTransport.mod.^]): Self = this.set("transports", value.asInstanceOf[js.Any])
  }
