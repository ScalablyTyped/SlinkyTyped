...
object mod {
  ...
  object BaseErrorLoggerOptions {
    ...
    implicit class BaseErrorLoggerOptionsMutableBuilder[Self <: BaseErrorLoggerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExceptionToMeta(value: /* err */ js.Error => js.Object): Self = StObject.set(x, "exceptionToMeta", js.Any.fromFunction1(value))
  ...
  */
  ...
  object ErrorLoggerOptions {
    ...
    @scala.inline
    def ErrorLoggerOptionsWithTransports(transports: js.Array[typingsSlinky.winstonTransport.mod.^]): typingsSlinky.expressWinston.mod.ErrorLoggerOptionsWithTransports = {
      val __obj = js.Dynamic.literal(transports = transports.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expressWinston.mod.ErrorLoggerOptionsWithTransports]
    }
    
    @scala.inline
    def ErrorLoggerOptionsWithWinstonInstance(winstonInstance: Logger): typingsSlinky.expressWinston.mod.ErrorLoggerOptionsWithWinstonInstance = {
      val __obj = js.Dynamic.literal(winstonInstance = winstonInstance.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expressWinston.mod.ErrorLoggerOptionsWithWinstonInstance]
    }
  }
  ...
  object ErrorLoggerOptionsWithTransports {
    ...
    implicit class ErrorLoggerOptionsWithTransportsMutableBuilder[Self <: ErrorLoggerOptionsWithTransports] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTransports(value: js.Array[typingsSlinky.winstonTransport.mod.^]): Self = StObject.set(x, "transports", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTransportsVarargs(value: typingsSlinky.winstonTransport.mod.^ *): Self = StObject.set(x, "transports", js.Array(value :_*))
    }
  }
  ...
  */
  ...
  object LoggerOptions {
    ...
    @scala.inline
    def LoggerOptionsWithTransports(transports: js.Array[typingsSlinky.winstonTransport.mod.^]): typingsSlinky.expressWinston.mod.LoggerOptionsWithTransports = {
      val __obj = js.Dynamic.literal(transports = transports.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expressWinston.mod.LoggerOptionsWithTransports]
    }
    
    @scala.inline
    def LoggerOptionsWithWinstonInstance(winstonInstance: Logger): typingsSlinky.expressWinston.mod.LoggerOptionsWithWinstonInstance = {
      val __obj = js.Dynamic.literal(winstonInstance = winstonInstance.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.expressWinston.mod.LoggerOptionsWithWinstonInstance]
    }
  }
