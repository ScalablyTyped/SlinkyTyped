...
object AgentConfigOptions {
  ...
  implicit class AgentConfigOptionsMutableBuilder[Self <: AgentConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreUserAgents(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "ignoreUserAgents", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIgnoreUserAgentsUndefined: Self = StObject.set(x, "ignoreUserAgents", js.undefined)
    
    @scala.inline
    def setIgnoreUserAgentsVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "ignoreUserAgents", js.Array(value :_*))
