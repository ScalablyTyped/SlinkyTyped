...
object AgentConfigOptions {
  ...
  implicit class AgentConfigOptionsOps[Self <: AgentConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreUserAgentsVarargs(value: (String | js.RegExp)*): Self = this.set("ignoreUserAgents", js.Array(value :_*))
    
    @scala.inline
    def setIgnoreUserAgents(value: js.Array[String | js.RegExp]): Self = this.set("ignoreUserAgents", value.asInstanceOf[js.Any])
