...
object AxesMultiLevelLabel {
  ...
  @scala.inline
  implicit class AxesMultiLevelLabelOps[Self <: AxesMultiLevelLabel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: AxesMultiLevelLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFont(value: AxesMultiLevelLabelsFont): Self = this.set("font", value.asInstanceOf[js.Any])
