...
object ListView {
  ...
  object AjaxSettings {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.ListView.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.ListView.AjaxSettings]
    }
    
    @scala.inline
    implicit class AjaxSettingsMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.ListView.AjaxSettings] (val x: Self) extends AnyVal {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the items to the ListView control.
      * @Default {null}
      */
    var ajaxSettings: js.UndefOr[typingsSlinky.ejWebAll.ej.ListView.AjaxSettings] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.ListView.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.ListView.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.ListView.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAjaxSettings(value: typingsSlinky.ejWebAll.ej.ListView.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
