...
object Dialog {
  ...
  object AjaxSettings {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Dialog.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Dialog.AjaxSettings]
    }
    
    @scala.inline
    implicit class AjaxSettingsMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Dialog.AjaxSettings] (val x: Self) extends AnyVal {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the content to the Dialog control.
      * @Default {null}
      */
    var ajaxSettings: js.UndefOr[typingsSlinky.ejWebAll.ej.Dialog.AjaxSettings] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Dialog.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Dialog.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Dialog.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAjaxSettings(value: typingsSlinky.ejWebAll.ej.Dialog.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
