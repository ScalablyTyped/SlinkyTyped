...
object Layer {
  ...
  implicit class LayerOps[Self <: Layer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBubbleSettings(value: LayersBubbleSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabelSettings(value: LayersLabelSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLegendSettings(value: LayersLegendSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShapeSettings(value: LayersShapeSettings): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSubLayers(value: js.Array[LayersSubLayer]): Self = {
        val ret = this.duplicate
