...
object CommonSeriesOptionsErrorBar {
  ...
  @scala.inline
  implicit class CommonSeriesOptionsErrorBarOps[Self <: CommonSeriesOptionsErrorBar] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCap(value: CommonSeriesOptionsErrorBarCap): Self = this.set("cap", value.asInstanceOf[js.Any])
    @scala.inline
