...
object GalleryItemClickEventArgs {
  ...
  implicit class GalleryItemClickEventArgsOps[Self <: GalleryItemClickEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGalleryModel(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("galleryModel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutGalleryModel: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("galleryModel")(js.undefined)
        ret
    }
    @scala.inline
