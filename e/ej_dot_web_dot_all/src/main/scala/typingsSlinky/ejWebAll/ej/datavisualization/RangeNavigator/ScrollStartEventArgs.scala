...
object ScrollStartEventArgs {
  ...
  implicit class ScrollStartEventArgsOps[Self <: ScrollStartEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataEndRange(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataEndRange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDataEndRange: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataEndRange")(js.undefined)
        ret
    }
    @scala.inline
    def withDataStartRange(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataStartRange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDataStartRange: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataStartRange")(js.undefined)
        ret
    }
    @scala.inline
