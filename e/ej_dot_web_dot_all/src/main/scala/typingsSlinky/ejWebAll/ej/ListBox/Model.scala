...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableWordWrap)) __obj.updateDynamic("enableWordWrap")(enableWordWrap.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(loadDataOnInit)) __obj.updateDynamic("loadDataOnInit")(loadDataOnInit.get.asInstanceOf[js.Any])
