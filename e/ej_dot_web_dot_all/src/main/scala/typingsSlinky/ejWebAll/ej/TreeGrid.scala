...
import typingsSlinky.ejWebAll.ej.TreeGrid.EjPredicate
...
object TreeGrid {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.TreeGrid.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.TreeGrid.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.TreeGrid.Model] (val x: Self) extends AnyVal {
  ...
  trait SelectionSettings extends StObject {
    ...
    /** Specifies the type of selection whether to select row or cell.
      ...
      */
    var selectionMode: js.UndefOr[typingsSlinky.std.SelectionMode | String] = js.native
  ...
  object SelectionSettings {
    ...
    implicit class SelectionSettingsMutableBuilder[Self <: SelectionSettings] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelectionMode(value: typingsSlinky.std.SelectionMode | String): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
