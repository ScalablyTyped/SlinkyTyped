...
@js.native
class PivotChart_ protected () extends Widget_ {
  ...
  var defaults: typingsSlinky.ejWebAll.ej.PivotChart.Model = js.native
  @JSName("model")
  var model_PivotChart_ : typingsSlinky.ejWebAll.ej.PivotChart.Model = js.native
