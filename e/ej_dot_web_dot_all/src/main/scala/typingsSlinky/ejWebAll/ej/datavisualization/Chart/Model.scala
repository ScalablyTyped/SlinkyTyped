...
object Model {
  ...
  def apply(
    ...
    perspectiveAngle: js.UndefOr[Double] = js.undefined,
    ...
    wallSize: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(initSeriesRender)) __obj.updateDynamic("initSeriesRender")(initSeriesRender.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(perspectiveAngle)) __obj.updateDynamic("perspectiveAngle")(perspectiveAngle.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sideBySideSeriesPlacement)) __obj.updateDynamic("sideBySideSeriesPlacement")(sideBySideSeriesPlacement.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(wallSize)) __obj.updateDynamic("wallSize")(wallSize.get.asInstanceOf[js.Any])
