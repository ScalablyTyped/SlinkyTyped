...
class TreeView_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsSlinky.ejWebAll.ej.TreeView.Model) = this()
  def this(element: Element, options: typingsSlinky.ejWebAll.ej.TreeView.Model) = this()
  var defaults: typingsSlinky.ejWebAll.ej.TreeView.Model = js.native
  @JSName("model")
  var model_TreeView_ : typingsSlinky.ejWebAll.ej.TreeView.Model = js.native
