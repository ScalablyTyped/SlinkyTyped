...
trait Model extends js.Object {
  ...
  /** Specifies the theme for Sparkline.
    ...
    */
  var theme: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Theme | String] = js.undefined
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Type | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    stroke: String = null,
    theme: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Theme | String = null,
    tooltip: Tooltip = null,
    tooltipInitialize: /* e */ TooltipInitializeEventArgs => Unit = null,
    `type`: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Type | String = null,
