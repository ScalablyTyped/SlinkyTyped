...
trait Model extends js.Object {
  ...
  /** Specifies the theme for Sparkline.
    ...
    */
  var theme: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Theme | String] = js.native
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Type | String] = js.native
...
object Model {
  ...
  implicit class ModelOps[Self <: Model] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTheme(value: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Theme | String): Self = this.set("theme", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setType(value: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Type | String): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
