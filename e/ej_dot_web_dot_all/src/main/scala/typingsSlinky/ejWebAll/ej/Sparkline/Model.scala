...
object Model {
  ...
  implicit class ModelOps[Self <: Model] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTheme(value: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Theme | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Type | String): Self = {
        val ret = this.duplicate
