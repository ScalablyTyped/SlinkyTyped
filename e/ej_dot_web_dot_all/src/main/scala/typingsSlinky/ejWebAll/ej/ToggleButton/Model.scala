...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(preventToggle)) __obj.updateDynamic("preventToggle")(preventToggle.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(toggleState)) __obj.updateDynamic("toggleState")(toggleState.get.asInstanceOf[js.Any])
