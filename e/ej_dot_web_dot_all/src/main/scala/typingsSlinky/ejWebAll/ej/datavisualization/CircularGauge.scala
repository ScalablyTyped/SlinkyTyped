...
object CircularGauge {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.datavisualization.CircularGauge.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.datavisualization.CircularGauge.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.datavisualization.CircularGauge.Model] (val x: Self) extends AnyVal {
  ...
  trait Scale extends StObject {
    ...
    /** Specify scale direction of circular gauge. See
      * @Default {Clockwise}
      */
    var direction: js.UndefOr[typingsSlinky.ejWebAll.ej.Direction | String] = js.native
  ...
  object Scale {
    ...
    implicit class ScaleMutableBuilder[Self <: Scale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDirection(value: typingsSlinky.ejWebAll.ej.Direction | String): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
