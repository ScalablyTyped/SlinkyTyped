...
@js.native
class SpellCheck_ protected () extends Widget_ {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejWebAll.ej.SpellCheck.Model) = this()
  def this(element: Element, options: typingsSlinky.ejWebAll.ej.SpellCheck.Model) = this()
  var defaults: typingsSlinky.ejWebAll.ej.SpellCheck.Model = js.native
  @JSName("model")
  var model_SpellCheck_ : typingsSlinky.ejWebAll.ej.SpellCheck.Model = js.native
