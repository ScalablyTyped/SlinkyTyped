...
@js.native
trait MultiLevelLabelClickEventArgs extends js.Object {
...
object MultiLevelLabelClickEventArgs {
  ...
  @scala.inline
  implicit class MultiLevelLabelClickEventArgsOps[Self <: MultiLevelLabelClickEventArgs] (val x: Self) extends AnyVal {
