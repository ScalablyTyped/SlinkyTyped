...
@js.native
trait PrimaryXAxisMinorGridLines extends js.Object {
...
object PrimaryXAxisMinorGridLines {
  ...
  @scala.inline
  implicit class PrimaryXAxisMinorGridLinesOps[Self <: PrimaryXAxisMinorGridLines] (val x: Self) extends AnyVal {
    @scala.inline
