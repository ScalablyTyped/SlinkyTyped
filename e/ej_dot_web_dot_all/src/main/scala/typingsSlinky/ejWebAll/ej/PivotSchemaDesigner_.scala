...
class PivotSchemaDesigner_ protected () extends Widget_ {
  ...
  var defaults: typingsSlinky.ejWebAll.ej.PivotSchemaDesigner.Model = js.native
  @JSName("model")
  var model_PivotSchemaDesigner_ : typingsSlinky.ejWebAll.ej.PivotSchemaDesigner.Model = js.native
