...
class RecurrenceEditor_ protected () extends Widget_ {
  ...
  var defaults: typingsSlinky.ejWebAll.ej.RecurrenceEditor.Model = js.native
  @JSName("model")
  var model_RecurrenceEditor_ : typingsSlinky.ejWebAll.ej.RecurrenceEditor.Model = js.native
