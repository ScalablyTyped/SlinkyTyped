...
object Autocomplete {
  ...
  object Animation extends StObject {
    ...
    @js.native
    sealed trait Fade
      extends typingsSlinky.ejWebAll.ej.Autocomplete.Animation
  ...
  object MultiSelectMode extends StObject {
    ...
    sealed trait Delimiter
      extends typingsSlinky.ejWebAll.ej.Autocomplete.MultiSelectMode
  ...
  trait Model extends StObject {
    ...
    /** Enables or disables selecting the animation style for the popup list. Animation types can be selected through either of the following options,
      * @Default {slide}
      */
    var animateType: js.UndefOr[typingsSlinky.ejWebAll.ej.Animation | String] = js.native
    ...
    /** Enables or disables selecting multiple values from the suggestion list. Multiple values can be selected through either of the following options,
      ...
      */
    var multiSelectMode: js.UndefOr[typingsSlinky.ejWebAll.ej.MultiSelectMode | String] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Autocomplete.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Autocomplete.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Autocomplete.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAnimateType(value: typingsSlinky.ejWebAll.ej.Animation | String): Self = StObject.set(x, "animateType", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMultiSelectMode(value: typingsSlinky.ejWebAll.ej.MultiSelectMode | String): Self = StObject.set(x, "multiSelectMode", value.asInstanceOf[js.Any])
  ...
  trait SelectEventArgs extends StObject {
    ...
    /** Data object of the selected item.
      */
    var Item: js.UndefOr[typingsSlinky.ejWebAll.ej.Model] = js.native
  ...
  object SelectEventArgs {
    ...
    implicit class SelectEventArgsMutableBuilder[Self <: SelectEventArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: typingsSlinky.ejWebAll.ej.Model): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
