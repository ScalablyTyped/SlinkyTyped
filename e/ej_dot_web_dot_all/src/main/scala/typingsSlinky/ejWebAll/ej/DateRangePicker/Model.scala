...
object Model {
  ...
  implicit class ModelOps[Self <: Model] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndDate(value: String | js.Date): Self = this.set("endDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxDate(value: String | js.Date): Self = this.set("maxDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDate(value: String | js.Date): Self = this.set("minDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStartDate(value: String | js.Date): Self = this.set("startDate", value.asInstanceOf[js.Any])
