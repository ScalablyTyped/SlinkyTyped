...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableTimePicker)) __obj.updateDynamic("enableTimePicker")(enableTimePicker.get.asInstanceOf[js.Any])
