...
@js.native
class PivotGauge_ protected () extends Widget_ {
  ...
  var defaults: typingsSlinky.ejWebAll.ej.PivotGauge.Model = js.native
  @JSName("model")
  var model_PivotGauge_ : typingsSlinky.ejWebAll.ej.PivotGauge.Model = js.native
