...
object AjaxBeforeLoadEventArgs {
  ...
  implicit class AjaxBeforeLoadEventArgsOps[Self <: AjaxBeforeLoadEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAjaxData(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ajaxData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAjaxData: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ajaxData")(js.undefined)
        ret
    }
    @scala.inline
