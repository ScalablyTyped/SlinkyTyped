...
@js.native
trait SeriesMarkerDataLabelMargin extends js.Object {
...
object SeriesMarkerDataLabelMargin {
  ...
  @scala.inline
  implicit class SeriesMarkerDataLabelMarginOps[Self <: SeriesMarkerDataLabelMargin] (val x: Self) extends AnyVal {
