...
object EditSettings {
  ...
  implicit class EditSettingsOps[Self <: EditSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEditItems(value: js.Array[EditSettingsEditItem]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("editItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEditItems: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("editItems")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withExternalFormTemplate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("externalFormTemplate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutExternalFormTemplate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("externalFormTemplate")(js.undefined)
        ret
    }
    @scala.inline
