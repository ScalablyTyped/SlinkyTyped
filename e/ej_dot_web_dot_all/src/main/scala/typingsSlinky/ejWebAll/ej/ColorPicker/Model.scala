...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableOpacity)) __obj.updateDynamic("enableOpacity")(enableOpacity.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showApplyCancel)) __obj.updateDynamic("showApplyCancel")(showApplyCancel.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showRecentColors)) __obj.updateDynamic("showRecentColors")(showRecentColors.asInstanceOf[js.Any])
    if (!js.isUndefined(showSwitcher)) __obj.updateDynamic("showSwitcher")(showSwitcher.asInstanceOf[js.Any])
