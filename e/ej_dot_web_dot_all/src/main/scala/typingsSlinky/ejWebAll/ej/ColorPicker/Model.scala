...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableOpacity)) __obj.updateDynamic("enableOpacity")(enableOpacity.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showApplyCancel)) __obj.updateDynamic("showApplyCancel")(showApplyCancel.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showRecentColors)) __obj.updateDynamic("showRecentColors")(showRecentColors.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showSwitcher)) __obj.updateDynamic("showSwitcher")(showSwitcher.get.asInstanceOf[js.Any])
