...
@js.native
class PivotGrid_ protected () extends Widget_ {
  ...
  var defaults: typingsSlinky.ejWebAll.ej.PivotGrid.Model = js.native
  @JSName("model")
  var model_PivotGrid_ : typingsSlinky.ejWebAll.ej.PivotGrid.Model = js.native
