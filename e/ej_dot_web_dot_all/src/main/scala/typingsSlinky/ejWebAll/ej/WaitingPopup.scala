...
object WaitingPopup {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.WaitingPopup.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.WaitingPopup.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.WaitingPopup.Model] (val x: Self) extends AnyVal {
