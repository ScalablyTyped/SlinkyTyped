...
object SeriesMarkerDataLabel {
  ...
  implicit class SeriesMarkerDataLabelOps[Self <: SeriesMarkerDataLabel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: SeriesMarkerDataLabelBorder): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withConnectorLine(value: SeriesMarkerDataLabelConnectorLine): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFont(value: SeriesMarkerDataLabelFont): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMargin(value: SeriesMarkerDataLabelMargin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOffset(value: SeriesMarkerDataLabelOffset): Self = {
        val ret = this.duplicate
