...
object RenderingCompleteEventArgs {
  ...
  implicit class RenderingCompleteEventArgsOps[Self <: RenderingCompleteEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReportParameters(value: js.Any): Self = this.set("reportParameters", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteReportParameters: Self = this.set("reportParameters", js.undefined)
    @scala.inline
