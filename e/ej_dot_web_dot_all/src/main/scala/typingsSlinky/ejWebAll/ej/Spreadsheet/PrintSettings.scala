...
object PrintSettings {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowPageSetup)) __obj.updateDynamic("allowPageSetup")(allowPageSetup.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowPageSize)) __obj.updateDynamic("allowPageSize")(allowPageSize.get.asInstanceOf[js.Any])
