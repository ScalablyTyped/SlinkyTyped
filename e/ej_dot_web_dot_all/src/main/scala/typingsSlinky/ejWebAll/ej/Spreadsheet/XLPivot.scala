...
object XLPivot {
  ...
  implicit class XLPivotOps[Self <: XLPivot] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClearPivotFieldList(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearPivotFieldList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreatePivotTable(value: (String, String, String, PivotOptions, js.Any) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPivotTable")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
    def withDeletePivotTable(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deletePivotTable")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRefreshDataSource(value: (String, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refreshDataSource")(js.Any.fromFunction2(value))
        ret
    }
  }
