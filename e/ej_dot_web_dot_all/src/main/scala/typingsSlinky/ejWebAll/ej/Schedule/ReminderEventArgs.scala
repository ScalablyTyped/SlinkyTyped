...
object ReminderEventArgs {
  ...
  implicit class ReminderEventArgsOps[Self <: ReminderEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReminderAppointment(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reminderAppointment")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutReminderAppointment: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reminderAppointment")(js.undefined)
        ret
    }
    @scala.inline
