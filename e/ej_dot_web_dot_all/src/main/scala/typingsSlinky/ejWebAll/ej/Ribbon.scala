...
object Ribbon {
  ...
  object Type extends StObject {
    ...
    @js.native
    sealed trait Button
      extends typingsSlinky.ejWebAll.ej.Ribbon.Type
  ...
  trait Model extends StObject {
    ...
    /** Specifies the tabs and its groups. Also specifies the control details that has to be placed in the tab area in the ribbon control.
      * @Default {Array}
      */
    var tabs: js.UndefOr[js.Array[typingsSlinky.ejWebAll.ej.Ribbon.Tab]] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Ribbon.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Ribbon.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Ribbon.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTabs(value: js.Array[typingsSlinky.ejWebAll.ej.Ribbon.Tab]): Self = StObject.set(x, "tabs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTabsUndefined: Self = StObject.set(x, "tabs", js.undefined)
      
      @scala.inline
      def setTabsVarargs(value: typingsSlinky.ejWebAll.ej.Ribbon.Tab*): Self = StObject.set(x, "tabs", js.Array(value :_*))
  ...
  object Tab {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Ribbon.Tab = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Ribbon.Tab]
    }
    
    @scala.inline
    implicit class TabMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Ribbon.Tab] (val x: Self) extends AnyVal {
