...
object RowSelectingEventArgs {
  ...
  implicit class RowSelectingEventArgsOps[Self <: RowSelectingEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPrevRow(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prevRow")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPrevRow: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prevRow")(js.undefined)
        ret
    }
    @scala.inline
