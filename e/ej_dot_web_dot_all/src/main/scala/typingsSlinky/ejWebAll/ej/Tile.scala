...
object Tile {
  ...
  object ImagePosition extends StObject {
    ...
    sealed trait BottomCenter
      extends typingsSlinky.ejWebAll.ej.Tile.ImagePosition
  ...
  trait Model extends StObject {
    ...
    /** Specifies the position of tile image.
      * @Default {center}
      */
    var imagePosition: js.UndefOr[typingsSlinky.ejWebAll.ej.ImagePosition | String] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Tile.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Tile.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Tile.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setImagePosition(value: typingsSlinky.ejWebAll.ej.ImagePosition | String): Self = StObject.set(x, "imagePosition", value.asInstanceOf[js.Any])
