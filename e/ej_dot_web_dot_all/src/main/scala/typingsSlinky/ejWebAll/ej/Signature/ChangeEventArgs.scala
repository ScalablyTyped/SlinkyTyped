...
object ChangeEventArgs {
  ...
  implicit class ChangeEventArgsOps[Self <: ChangeEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLastImage(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lastImage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLastImage: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lastImage")(js.undefined)
        ret
    }
    @scala.inline
