...
object GroupButtonMode extends js.Object {
  ...
  /* 0 */ @js.native
  object CheckBox
    extends TopLevel[typingsSlinky.ejWebAll.ej.GroupButtonMode.CheckBox with Double]
  
  /* 1 */ @js.native
  object RadioButton
    extends TopLevel[typingsSlinky.ejWebAll.ej.GroupButtonMode.RadioButton with Double]
