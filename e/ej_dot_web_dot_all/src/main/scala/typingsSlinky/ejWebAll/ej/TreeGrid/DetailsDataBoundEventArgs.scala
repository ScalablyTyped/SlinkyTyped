...
object DetailsDataBoundEventArgs {
  ...
  implicit class DetailsDataBoundEventArgsOps[Self <: DetailsDataBoundEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDetailsElement(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("detailsElement")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDetailsElement: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("detailsElement")(js.undefined)
        ret
    }
    @scala.inline
