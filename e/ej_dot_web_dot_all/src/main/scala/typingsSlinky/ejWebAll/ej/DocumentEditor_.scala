...
class DocumentEditor_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsSlinky.ejWebAll.ej.DocumentEditor.Model) = this()
  def this(element: Element, options: typingsSlinky.ejWebAll.ej.DocumentEditor.Model) = this()
  var defaults: typingsSlinky.ejWebAll.ej.DocumentEditor.Model = js.native
  @JSName("model")
  var model_DocumentEditor_ : typingsSlinky.ejWebAll.ej.DocumentEditor.Model = js.native
