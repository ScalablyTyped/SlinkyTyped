...
object Sparkline {
  ...
  object Type extends StObject {
    ...
    @js.native
    sealed trait Area
      extends typingsSlinky.ejWebAll.ej.Sparkline.Type
  ...
  trait Model extends StObject {
    ...
    /** Options to customize the tooltip.
      */
    var tooltip: js.UndefOr[typingsSlinky.ejWebAll.ej.Sparkline.Tooltip] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Sparkline.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Sparkline.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Sparkline.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTooltip(value: typingsSlinky.ejWebAll.ej.Sparkline.Tooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
  ...
  object Tooltip {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Sparkline.Tooltip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Sparkline.Tooltip]
    }
    
    @scala.inline
    implicit class TooltipMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Sparkline.Tooltip] (val x: Self) extends AnyVal {
