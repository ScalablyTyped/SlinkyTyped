...
object Toolbar {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Toolbar.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Toolbar.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Toolbar.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisabledItemIndices(value: js.Array[_]): Self = StObject.set(x, "disabledItemIndices", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEnabledItemIndices(value: js.Array[_]): Self = StObject.set(x, "enabledItemIndices", value.asInstanceOf[js.Any])
