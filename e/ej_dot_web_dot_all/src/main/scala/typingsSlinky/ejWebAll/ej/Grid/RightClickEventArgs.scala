...
object RightClickEventArgs {
  ...
  implicit class RightClickEventArgsOps[Self <: RightClickEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurrentData(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("currentData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCurrentData: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("currentData")(js.undefined)
        ret
    }
    @scala.inline
