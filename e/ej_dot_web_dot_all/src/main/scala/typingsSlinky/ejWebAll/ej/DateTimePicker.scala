...
object DateTimePicker {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.DateTimePicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.DateTimePicker.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.DateTimePicker.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMaxDateTime(value: String | js.Date): Self = StObject.set(x, "maxDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaxDateTimeDate(value: js.Date): Self = StObject.set(x, "maxDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaxDateTimeUndefined: Self = StObject.set(x, "maxDateTime", js.undefined)
      
      @scala.inline
      def setMinDateTime(value: String | js.Date): Self = StObject.set(x, "minDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMinDateTimeDate(value: js.Date): Self = StObject.set(x, "minDateTime", value.asInstanceOf[js.Any])
