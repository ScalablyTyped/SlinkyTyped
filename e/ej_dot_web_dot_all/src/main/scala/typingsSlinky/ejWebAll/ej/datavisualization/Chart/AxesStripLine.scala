...
object AxesStripLine {
  ...
  @scala.inline
  implicit class AxesStripLineOps[Self <: AxesStripLine] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFont(value: AxesStripLineFont): Self = this.set("font", value.asInstanceOf[js.Any])
    @scala.inline
