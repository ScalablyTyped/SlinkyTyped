...
object Sparkline {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the theme for Sparkline.
      ...
      */
    var theme: js.UndefOr[typingsSlinky.ejWebAll.ej.Sparkline.Theme | String] = js.native
    ...
    /** Specifies the type of the series to render in sparkline.
      ...
      */
    var `type`: js.UndefOr[typingsSlinky.ejWebAll.ej.Sparkline.Type | String] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.datavisualization.Sparkline.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTheme(value: typingsSlinky.ejWebAll.ej.Sparkline.Theme | String): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setType(value: typingsSlinky.ejWebAll.ej.Sparkline.Type | String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait TooltipFont extends StObject {
    ...
    /** Specifies the font Style for the tooltip.
      * @Default {Normal}
      */
    var fontStyle: js.UndefOr[typingsSlinky.ejWebAll.ej.Sparkline.FontStyle | String] = js.native
    
    /** Specifies the font weight for the tooltip.
      * @Default {Regular}
      */
    var fontWeight: js.UndefOr[typingsSlinky.ejWebAll.ej.Sparkline.FontWeight | String] = js.native
  ...
  object TooltipFont {
    ...
    implicit class TooltipFontMutableBuilder[Self <: TooltipFont] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFontStyle(value: typingsSlinky.ejWebAll.ej.Sparkline.FontStyle | String): Self = StObject.set(x, "fontStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFontStyleUndefined: Self = StObject.set(x, "fontStyle", js.undefined)
      
      @scala.inline
      def setFontWeight(value: typingsSlinky.ejWebAll.ej.Sparkline.FontWeight | String): Self = StObject.set(x, "fontWeight", value.asInstanceOf[js.Any])
