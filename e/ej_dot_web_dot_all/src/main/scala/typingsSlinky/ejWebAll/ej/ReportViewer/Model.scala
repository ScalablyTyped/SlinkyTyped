...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableDatasourceBlockScroller)) __obj.updateDynamic("enableDatasourceBlockScroller")(enableDatasourceBlockScroller.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDropDownSearch)) __obj.updateDynamic("enableDropDownSearch")(enableDropDownSearch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableNotificationBar)) __obj.updateDynamic("enableNotificationBar")(enableNotificationBar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablePageCache)) __obj.updateDynamic("enablePageCache")(enablePageCache.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablePageVirtualization)) __obj.updateDynamic("enablePageVirtualization")(enablePageVirtualization.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableParameterBlockScroller)) __obj.updateDynamic("enableParameterBlockScroller")(enableParameterBlockScroller.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(printMode)) __obj.updateDynamic("printMode")(printMode.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showExceptionsInDialog)) __obj.updateDynamic("showExceptionsInDialog")(showExceptionsInDialog.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sizeToReportContent)) __obj.updateDynamic("sizeToReportContent")(sizeToReportContent.get.asInstanceOf[js.Any])
