...
object XLSearch {
  ...
  implicit class XLSearchOps[Self <: XLSearch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReplaceAllByBook(value: (String, String, Boolean, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("replaceAllByBook")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withReplaceAllBySheet(value: (String, String, Boolean, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("replaceAllBySheet")(js.Any.fromFunction4(value))
        ret
    }
  }
