...
trait ReportDesigner_ extends Widget_ {
  ...
  var defaults: typingsSlinky.ejWebAll.ej.ReportDesigner.Model = js.native
  ...
  @JSName("model")
  var model_ReportDesigner_ : typingsSlinky.ejWebAll.ej.ReportDesigner.Model = js.native
