...
object Tab {
  ...
  object AjaxSettings {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Tab.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Tab.AjaxSettings]
    }
    
    @scala.inline
    implicit class AjaxSettingsMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Tab.AjaxSettings] (val x: Self) extends AnyVal {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the content to the Tab control.
      */
    var ajaxSettings: js.UndefOr[typingsSlinky.ejWebAll.ej.Tab.AjaxSettings] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Tab.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Tab.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Tab.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAjaxSettings(value: typingsSlinky.ejWebAll.ej.Tab.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
