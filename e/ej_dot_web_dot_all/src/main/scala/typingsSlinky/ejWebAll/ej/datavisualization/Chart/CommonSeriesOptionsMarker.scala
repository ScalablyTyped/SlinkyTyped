...
object CommonSeriesOptionsMarker {
  ...
  implicit class CommonSeriesOptionsMarkerOps[Self <: CommonSeriesOptionsMarker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorder(value: CommonSeriesOptionsMarkerBorder): Self = {
    ...
    @scala.inline
    def withDataLabel(value: CommonSeriesOptionsMarkerDataLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: CommonSeriesOptionsMarkerSize): Self = {
        val ret = this.duplicate
