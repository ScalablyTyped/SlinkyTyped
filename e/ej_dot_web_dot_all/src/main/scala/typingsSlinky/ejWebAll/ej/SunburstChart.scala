...
object SunburstChart {
  ...
  trait Model extends StObject {
    ...
    /** Animation type of sunburst
      ...
      */
    var animationType: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.Sunburst.Animation | String] = js.native
    ...
    /** Options to customize the Sunburst tooltip.
      */
    var tooltip: js.UndefOr[typingsSlinky.ejWebAll.ej.SunburstChart.Tooltip] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.SunburstChart.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.SunburstChart.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.SunburstChart.Model] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAnimationType(value: typingsSlinky.ejWebAll.ej.datavisualization.Sunburst.Animation | String): Self = StObject.set(x, "animationType", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTooltip(value: typingsSlinky.ejWebAll.ej.SunburstChart.Tooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
  ...
  object Tooltip {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.SunburstChart.Tooltip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.SunburstChart.Tooltip]
    }
    
    @scala.inline
    implicit class TooltipMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.SunburstChart.Tooltip] (val x: Self) extends AnyVal {
