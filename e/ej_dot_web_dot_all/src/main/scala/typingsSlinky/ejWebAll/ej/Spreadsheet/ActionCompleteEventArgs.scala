...
object ActionCompleteEventArgs {
  ...
  implicit class ActionCompleteEventArgsOps[Self <: ActionCompleteEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSelectedCell(value: js.Array[_] | js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedCell")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSelectedCell: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedCell")(js.undefined)
        ret
    }
    @scala.inline
