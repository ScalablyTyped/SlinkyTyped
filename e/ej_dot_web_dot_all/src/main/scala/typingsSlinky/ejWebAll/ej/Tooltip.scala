...
object Tooltip {
  ...
  object Animation {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Tooltip.Animation = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Tooltip.Animation]
    }
    
    @scala.inline
    implicit class AnimationMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Tooltip.Animation] (val x: Self) extends AnyVal {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the animation behavior in  Tooltip. It contains the following sub properties.
      */
    var animation: js.UndefOr[typingsSlinky.ejWebAll.ej.Tooltip.Animation] = js.native
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Tooltip.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Tooltip.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Tooltip.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAnimation(value: typingsSlinky.ejWebAll.ej.Tooltip.Animation): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
