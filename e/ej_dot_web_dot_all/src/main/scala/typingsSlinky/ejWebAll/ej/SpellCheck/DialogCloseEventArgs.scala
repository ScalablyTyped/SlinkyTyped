...
object DialogCloseEventArgs {
  ...
  implicit class DialogCloseEventArgsOps[Self <: DialogCloseEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUpdatedText(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updatedText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUpdatedText: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updatedText")(js.undefined)
        ret
    }
  }
