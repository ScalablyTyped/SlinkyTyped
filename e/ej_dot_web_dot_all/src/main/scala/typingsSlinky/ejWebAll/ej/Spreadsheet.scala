...
import typingsSlinky.ejWebAll.ej.datavisualization.Chart.Theme
...
object Spreadsheet {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.Spreadsheet.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.Spreadsheet.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.Spreadsheet.Model] (val x: Self) extends AnyVal {
