...
object BufferStartEventArgs {
  ...
  @scala.inline
  implicit class BufferStartEventArgsOps[Self <: BufferStartEventArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withoutIsBuffering: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isBuffering")(js.undefined)
        ret
    }
    @scala.inline
