...
object PrimaryYAxisMultiLevelLabel {
  ...
  implicit class PrimaryYAxisMultiLevelLabelOps[Self <: PrimaryYAxisMultiLevelLabel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: PrimaryYAxisMultiLevelLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFont(value: PrimaryYAxisMultiLevelLabelsFont): Self = this.set("font", value.asInstanceOf[js.Any])
