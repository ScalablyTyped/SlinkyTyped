...
object ReportViewer {
  ...
  object Orientation extends StObject {
    ...
    sealed trait Landscape
      extends typingsSlinky.ejWebAll.ej.ReportViewer.Orientation
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.ReportViewer.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.ReportViewer.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.ReportViewer.Model] (val x: Self) extends AnyVal {
  ...
  trait PageSettings extends StObject {
    ...
    /** Specifies the print layout orientation.
      * @Default {null}
      */
    var orientation: js.UndefOr[typingsSlinky.ejWebAll.ej.Orientation | String] = js.native
  ...
  object PageSettings {
    ...
    implicit class PageSettingsMutableBuilder[Self <: PageSettings] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOrientation(value: typingsSlinky.ejWebAll.ej.Orientation | String): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
