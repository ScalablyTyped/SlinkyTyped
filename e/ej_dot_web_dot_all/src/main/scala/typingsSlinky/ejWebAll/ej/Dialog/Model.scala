...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowDraggable)) __obj.updateDynamic("allowDraggable")(allowDraggable.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(backgroundScroll)) __obj.updateDynamic("backgroundScroll")(backgroundScroll.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableModal)) __obj.updateDynamic("enableModal")(enableModal.get.asInstanceOf[js.Any])
