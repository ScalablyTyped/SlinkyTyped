...
class Signature_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsSlinky.ejWebAll.ej.Signature.Model) = this()
  def this(element: Element, options: typingsSlinky.ejWebAll.ej.Signature.Model) = this()
