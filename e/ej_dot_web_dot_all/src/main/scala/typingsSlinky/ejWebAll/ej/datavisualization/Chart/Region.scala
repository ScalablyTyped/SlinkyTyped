...
object Region extends js.Object {
  ...
  /* 0 */ @js.native
  object Chart
    extends TopLevel[typingsSlinky.ejWebAll.ej.datavisualization.Chart.Region.Chart with Double]
  
  /* 1 */ @js.native
  object Series
    extends TopLevel[typingsSlinky.ejWebAll.ej.datavisualization.Chart.Region.Series with Double]
