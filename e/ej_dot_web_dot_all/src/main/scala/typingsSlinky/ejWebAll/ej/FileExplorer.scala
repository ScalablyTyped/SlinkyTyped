...
object FileExplorer {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.FileExplorer.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.FileExplorer.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.FileExplorer.Model] (val x: Self) extends AnyVal {
  ...
  trait TemplateRefreshEventArgs extends StObject {
    ...
    /** Returns the cell object.
      */
    var cell: js.UndefOr[typingsSlinky.ejWebAll.ej.Model] = js.native
  ...
  object TemplateRefreshEventArgs {
    ...
    implicit class TemplateRefreshEventArgsMutableBuilder[Self <: TemplateRefreshEventArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCell(value: typingsSlinky.ejWebAll.ej.Model): Self = StObject.set(x, "cell", value.asInstanceOf[js.Any])
