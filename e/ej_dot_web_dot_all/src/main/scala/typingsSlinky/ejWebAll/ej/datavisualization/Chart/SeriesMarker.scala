...
object SeriesMarker {
  ...
  @scala.inline
  implicit class SeriesMarkerOps[Self <: SeriesMarker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SeriesMarkerBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBorder: Self = this.set("border", js.undefined)
    
    @scala.inline
    def setDataLabel(value: SeriesMarkerDataLabel): Self = this.set("dataLabel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSize(value: SeriesMarkerSize): Self = this.set("size", value.asInstanceOf[js.Any])
