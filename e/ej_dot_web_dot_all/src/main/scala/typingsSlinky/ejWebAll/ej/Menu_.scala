...
class Menu_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsSlinky.ejWebAll.ej.Menu.Model) = this()
  def this(element: Element, options: typingsSlinky.ejWebAll.ej.Menu.Model) = this()
  var defaults: typingsSlinky.ejWebAll.ej.Menu.Model = js.native
  @JSName("model")
  var model_Menu_ : typingsSlinky.ejWebAll.ej.Menu.Model = js.native
