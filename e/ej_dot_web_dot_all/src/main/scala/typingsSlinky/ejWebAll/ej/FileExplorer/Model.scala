...
object Model {
  ...
  def apply(
    ...
    virtualItemCount: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(enableThumbnailCompress)) __obj.updateDynamic("enableThumbnailCompress")(enableThumbnailCompress.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showNavigationPane)) __obj.updateDynamic("showNavigationPane")(showNavigationPane.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(virtualItemCount)) __obj.updateDynamic("virtualItemCount")(virtualItemCount.get.asInstanceOf[js.Any])
