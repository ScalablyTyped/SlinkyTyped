...
object DateRangePicker {
  ...
  object Model {
    ...
    @scala.inline
    def apply(): typingsSlinky.ejWebAll.ej.DateRangePicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.ejWebAll.ej.DateRangePicker.Model]
    }
    
    @scala.inline
    implicit class ModelMutableBuilder[Self <: typingsSlinky.ejWebAll.ej.DateRangePicker.Model] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndDate(value: String | js.Date): Self = StObject.set(x, "endDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStartDate(value: String | js.Date): Self = StObject.set(x, "startDate", value.asInstanceOf[js.Any])
