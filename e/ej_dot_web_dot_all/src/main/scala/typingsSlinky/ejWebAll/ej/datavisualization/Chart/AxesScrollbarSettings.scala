...
object AxesScrollbarSettings {
  ...
  @scala.inline
  implicit class AxesScrollbarSettingsOps[Self <: AxesScrollbarSettings] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRange(value: AxesScrollbarSettingsRange): Self = this.set("range", value.asInstanceOf[js.Any])
    @scala.inline
