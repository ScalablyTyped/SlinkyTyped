...
object BeforeUploadEventArgs {
  ...
  implicit class BeforeUploadEventArgsOps[Self <: BeforeUploadEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUploadItemDetails(value: js.Any): Self = this.set("uploadItemDetails", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUploadItemDetails: Self = this.set("uploadItemDetails", js.undefined)
  }
