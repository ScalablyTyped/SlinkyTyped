...
object ChangeEventArgs {
  ...
  implicit class ChangeEventArgsOps[Self <: ChangeEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChangeFrom(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeFrom")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutChangeFrom: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeFrom")(js.undefined)
        ret
    }
    @scala.inline
