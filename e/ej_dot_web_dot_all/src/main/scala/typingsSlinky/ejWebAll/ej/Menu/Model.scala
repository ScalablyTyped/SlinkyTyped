...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableCenterAlign)) __obj.updateDynamic("enableCenterAlign")(enableCenterAlign.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showRootLevelArrows)) __obj.updateDynamic("showRootLevelArrows")(showRootLevelArrows.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showSubLevelArrows)) __obj.updateDynamic("showSubLevelArrows")(showSubLevelArrows.get.asInstanceOf[js.Any])
