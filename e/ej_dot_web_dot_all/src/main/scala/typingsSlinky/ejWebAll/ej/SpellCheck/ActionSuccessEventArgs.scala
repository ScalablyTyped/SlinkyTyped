...
object ActionSuccessEventArgs {
  ...
  implicit class ActionSuccessEventArgsOps[Self <: ActionSuccessEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorWordDetails(value: js.Any): Self = this.set("errorWordDetails", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteErrorWordDetails: Self = this.set("errorWordDetails", js.undefined)
