...
trait Model extends js.Object {
  ...
  /** Specifies the selection mode of the treemap. Accepted selection mode values are Default and Multiple.
    * @Default {default}
    */
  var groupSelectionMode: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.TreeMap.groupSelectionMode | String] = js.undefined
  ...
  /** Specifies the selection mode of treemap item. Accepted selection mode values are Default and Multiple.
    * @Default {default}
    */
  var selectionMode: js.UndefOr[typingsSlinky.ejWebAll.ej.datavisualization.TreeMap.selectionMode | String] = js.undefined
