...
object TooltipAlignment {
  ...
  implicit class TooltipAlignmentOps[Self <: TooltipAlignment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHorizontal(value: HorizontalAlignment | String): Self = this.set("horizontal", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHorizontal: Self = this.set("horizontal", js.undefined)
    @scala.inline
    def setVertical(value: VerticalAlignment | String): Self = this.set("vertical", value.asInstanceOf[js.Any])
    @scala.inline
