...
object BeforePanelOpenEventArgs {
  ...
  implicit class BeforePanelOpenEventArgsOps[Self <: BeforePanelOpenEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActivationPanel(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activationPanel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutActivationPanel: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activationPanel")(js.undefined)
        ret
    }
    @scala.inline
