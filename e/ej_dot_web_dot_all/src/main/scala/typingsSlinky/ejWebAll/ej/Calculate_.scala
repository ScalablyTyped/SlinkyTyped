...
class Calculate_ protected () extends js.Object {
  ...
  def this(element: JQuery, options: typingsSlinky.ejWebAll.ej.Calculate.Model) = this()
  def this(element: Element, options: typingsSlinky.ejWebAll.ej.Calculate.Model) = this()
