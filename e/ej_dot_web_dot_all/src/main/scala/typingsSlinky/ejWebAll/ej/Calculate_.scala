...
object Calculate_ {
  ...
  implicit class Calculate_Ops[Self <: Calculate_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaults(value: typingsSlinky.ejWebAll.ej.Calculate.Model): Self = this.set("defaults", value.asInstanceOf[js.Any])
    @scala.inline
    def setModel(value: typingsSlinky.ejWebAll.ej.Calculate.Model): Self = this.set("model", value.asInstanceOf[js.Any])
  }
