...
object DestroyEventArgs {
  ...
  implicit class DestroyEventArgsOps[Self <: DestroyEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeleteIndex(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteIndex")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDeleteIndex: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteIndex")(js.undefined)
        ret
    }
    @scala.inline
