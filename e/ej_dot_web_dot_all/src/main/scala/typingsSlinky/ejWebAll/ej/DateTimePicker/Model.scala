...
object Model {
  ...
  implicit class ModelOps[Self <: Model] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxDateTimeDate(value: js.Date): Self = this.set("maxDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaxDateTime(value: String | js.Date): Self = this.set("maxDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaxDateTime: Self = this.set("maxDateTime", js.undefined)
    
    @scala.inline
    def setMinDateTimeDate(value: js.Date): Self = this.set("minDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinDateTime(value: String | js.Date): Self = this.set("minDateTime", value.asInstanceOf[js.Any])
