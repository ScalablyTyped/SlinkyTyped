...
class DocumentEditor protected ()
  extends typingsSlinky.ejWebAll.ej.DocumentEditor {
...
object DocumentEditor {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.DocumentEditor = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.DocumentEditor): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
