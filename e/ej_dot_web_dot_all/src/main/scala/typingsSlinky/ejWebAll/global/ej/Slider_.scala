...
class Slider_ protected ()
  extends typingsSlinky.ejWebAll.ej.Slider_ {
...
object Slider_ {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.Slider_ = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.Slider_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
