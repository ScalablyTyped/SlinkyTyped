...
object Grid {
  ...
  @JSGlobal("ej.Grid.fn")
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.Grid = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.Grid): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
