...
object Resizable {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.Resizable = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.Resizable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
