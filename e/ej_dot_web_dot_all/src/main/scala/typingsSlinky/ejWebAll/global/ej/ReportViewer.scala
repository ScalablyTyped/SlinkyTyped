...
object ReportViewer {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.ReportViewer = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.ReportViewer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
