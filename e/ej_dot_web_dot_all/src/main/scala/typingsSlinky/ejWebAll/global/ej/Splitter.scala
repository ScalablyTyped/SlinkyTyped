...
class Splitter protected ()
  extends typingsSlinky.ejWebAll.ej.Splitter {
...
object Splitter {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.Splitter = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.Splitter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
