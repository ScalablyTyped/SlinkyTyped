...
import typingsSlinky.ejWebAll.ej.Changes
...
class TableModel protected ()
  extends typingsSlinky.ejWebAll.ej.TableModel {
  def this(
    name: String,
    jsonArray: js.Array[_],
    dataManager: typingsSlinky.ejWebAll.ej.DataManager,
  ...
  /* CompleteClass */
  override def setDataManager(dataManager: typingsSlinky.ejWebAll.ej.DataManager): Unit = js.native
  /* CompleteClass */
