...
object Calculate {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.Calculate = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.Calculate): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
