...
class Calculate protected ()
  extends typingsSlinky.ejWebAll.ej.Calculate {
  ...
  /* CompleteClass */
  override var defaults: typingsSlinky.ejWebAll.ej.Calculate.Model = js.native
  /* CompleteClass */
  override var model: typingsSlinky.ejWebAll.ej.Calculate.Model = js.native
...
object Calculate extends js.Object {
  ...
  var fn: typingsSlinky.ejWebAll.ej.Calculate = js.native
}
