...
object Scroller {
  ...
  @js.native
  def fn: typingsSlinky.ejWebAll.ej.Scroller = js.native
  @scala.inline
  def fn_=(x: typingsSlinky.ejWebAll.ej.Scroller): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
