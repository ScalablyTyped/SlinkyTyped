package typingsSlinky.ejDotWebDotAll.ej.SpellCheck
...
trait DialogOpenEventArgs extends js.Object {
  ...
  /** Returns the SpellCheck model.
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.SpellCheck.Model] = js.undefined
...
object DialogOpenEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.SpellCheck.Model = null,
