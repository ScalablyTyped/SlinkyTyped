...
class RecurrenceEditor_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor.Model = js.native
  @JSName("model")
  var model_RecurrenceEditor_ : typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor.Model = js.native
