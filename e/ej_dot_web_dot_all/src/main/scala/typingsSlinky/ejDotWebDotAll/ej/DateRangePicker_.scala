...
class DateRangePicker_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.DateRangePicker.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.DateRangePicker.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.DateRangePicker.Model = js.native
  @JSName("model")
  var model_DateRangePicker_ : typingsSlinky.ejDotWebDotAll.ej.DateRangePicker.Model = js.native
