...
object CellSelectionMode extends js.Object {
  ...
  /* 1 */ val Box: typingsSlinky.ejDotWebDotAll.ej.Grid.CellSelectionMode.Box with Double = js.native
  /* 0 */ val Flow: typingsSlinky.ejDotWebDotAll.ej.Grid.CellSelectionMode.Flow with Double = js.native
  @JSBracketAccess
