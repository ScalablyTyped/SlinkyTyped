...
object ExportingMode extends js.Object {
  ...
  /* 1 */ val ClientSide: typingsSlinky.ejDotWebDotAll.ej.datavisualization.DigitalGauge.ExportingMode.ClientSide with Double = js.native
  /* 0 */ val ServerSide: typingsSlinky.ejDotWebDotAll.ej.datavisualization.DigitalGauge.ExportingMode.ServerSide with Double = js.native
  @JSBracketAccess
