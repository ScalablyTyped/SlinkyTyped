...
trait Model extends js.Object {
  ...
  /** An object that defines the description, appearance and alignments of tooltips
    * @Default {null}
    */
  var tooltip: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.Tooltip] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    tooltip: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.Tooltip = null,
    width: String = null,
