...
trait ItemDragStopEventArgs extends js.Object {
  ...
  /** Instance of the listbox model object.
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.ListBox.Model] = js.undefined
...
object ItemDragStopEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.ListBox.Model = null,
    text: String = null,
    `type`: String = null,
    value: String = null
  ): ItemDragStopEventArgs = {
