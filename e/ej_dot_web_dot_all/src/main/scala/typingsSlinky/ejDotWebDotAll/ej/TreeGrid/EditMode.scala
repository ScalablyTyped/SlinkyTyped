...
object EditMode extends js.Object {
  ...
  /* 3 */ val BatchEditing: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditMode.BatchEditing with Double = js.native
  /* 0 */ val CellEditing: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditMode.CellEditing with Double = js.native
  /* 2 */ val DialogEditing: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditMode.DialogEditing with Double = js.native
  /* 1 */ val RowEditing: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditMode.RowEditing with Double = js.native
  @JSBracketAccess
