...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Bold: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.FontWeight.Bold with Double = js.native
  /* 2 */ val Lighter: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.FontWeight.Regular with Double = js.native
  @JSBracketAccess
