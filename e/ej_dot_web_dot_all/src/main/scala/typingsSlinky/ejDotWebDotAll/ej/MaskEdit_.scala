...
@js.native
class MaskEdit_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.MaskEdit.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.MaskEdit.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.MaskEdit.Model = js.native
  @JSName("model")
  var model_MaskEdit_ : typingsSlinky.ejDotWebDotAll.ej.MaskEdit.Model = js.native
