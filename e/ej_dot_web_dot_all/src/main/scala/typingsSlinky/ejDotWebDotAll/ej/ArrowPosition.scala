...
object ArrowPosition extends js.Object {
  ...
  /* 3 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.ArrowPosition.Bottom with Double = js.native
  /* 0 */ val Left: typingsSlinky.ejDotWebDotAll.ej.ArrowPosition.Left with Double = js.native
  /* 1 */ val Right: typingsSlinky.ejDotWebDotAll.ej.ArrowPosition.Right with Double = js.native
  /* 2 */ val Top: typingsSlinky.ejDotWebDotAll.ej.ArrowPosition.Top with Double = js.native
  @JSBracketAccess
