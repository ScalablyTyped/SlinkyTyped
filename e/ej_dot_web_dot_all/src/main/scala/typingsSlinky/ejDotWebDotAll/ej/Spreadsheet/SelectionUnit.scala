...
object SelectionUnit extends js.Object {
  ...
  /* 2 */ val MultiRange: typingsSlinky.ejDotWebDotAll.ej.Spreadsheet.SelectionUnit.MultiRange with Double = js.native
  /* 1 */ val Range: typingsSlinky.ejDotWebDotAll.ej.Spreadsheet.SelectionUnit.Range with Double = js.native
  /* 0 */ val Single: typingsSlinky.ejDotWebDotAll.ej.Spreadsheet.SelectionUnit.Single with Double = js.native
  @JSBracketAccess
