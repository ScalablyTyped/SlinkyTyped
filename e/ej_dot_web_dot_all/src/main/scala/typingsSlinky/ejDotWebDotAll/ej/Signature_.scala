...
class Signature_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Signature.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Signature.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Signature.Model = js.native
  @JSName("model")
  var model_Signature_ : typingsSlinky.ejDotWebDotAll.ej.Signature.Model = js.native
