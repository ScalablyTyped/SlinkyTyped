...
class TagCloud_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.TagCloud.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.TagCloud.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.TagCloud.Model = js.native
  @JSName("model")
  var model_TagCloud_ : typingsSlinky.ejDotWebDotAll.ej.TagCloud.Model = js.native
