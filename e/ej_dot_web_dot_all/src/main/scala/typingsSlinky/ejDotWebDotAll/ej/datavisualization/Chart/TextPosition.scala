...
object TextPosition extends js.Object {
  ...
  /* 1 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.TextPosition.Bottom with Double = js.native
  /* 2 */ val Middle: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.TextPosition.Middle with Double = js.native
  /* 0 */ val Top: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.TextPosition.Top with Double = js.native
  @JSBracketAccess
