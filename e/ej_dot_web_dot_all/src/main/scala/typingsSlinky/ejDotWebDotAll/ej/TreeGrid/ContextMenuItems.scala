...
object ContextMenuItems extends js.Object {
  ...
  /* 0 */ val Add: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.ContextMenuItems.Add with Double = js.native
  /* 2 */ val Delete: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.ContextMenuItems.Delete with Double = js.native
  /* 1 */ val Edit: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.ContextMenuItems.Edit with Double = js.native
  @JSBracketAccess
