...
import typingsSlinky.ejDotWebDotAll.ej.TextAlign
import typingsSlinky.ejDotWebDotAll.ej.Type
import typingsSlinky.ejDotWebDotAll.ej.filterType
...
trait MultiColumnSettingsColumn extends js.Object {
  ...
  /** Specifies the search filter type. There are several types of search filter available such as â€˜startswithâ€™, â€˜containsâ€™, â€˜endswithâ€™, â€˜lessthanâ€™,
    ...
    */
  var filterType: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.filterType | String] = js.undefined
