...
object SliderType extends js.Object {
  ...
  /* 0 */ val Default: typingsSlinky.ejDotWebDotAll.ej.SliderType.Default with Double = js.native
  /* 1 */ val MinRange: typingsSlinky.ejDotWebDotAll.ej.SliderType.MinRange with Double = js.native
  /* 2 */ val Range: typingsSlinky.ejDotWebDotAll.ej.SliderType.Range with Double = js.native
  @JSBracketAccess
