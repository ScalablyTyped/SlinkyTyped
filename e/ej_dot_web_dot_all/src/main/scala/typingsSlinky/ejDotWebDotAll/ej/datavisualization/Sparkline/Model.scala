...
trait Model extends js.Object {
  ...
  /** Options to customize the tooltip.
    */
  var tooltip: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sparkline.Tooltip] = js.undefined
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sparkline.Type | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    tooltip: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sparkline.Tooltip = null,
