...
object AnnotationType extends js.Object {
  ...
  /* 2 */ val Highlight: typingsSlinky.ejDotWebDotAll.ej.PdfViewer.AnnotationType.Highlight with Double = js.native
  /* 1 */ val Strikethrough: typingsSlinky.ejDotWebDotAll.ej.PdfViewer.AnnotationType.Strikethrough with Double = js.native
  /* 0 */ val Underline: typingsSlinky.ejDotWebDotAll.ej.PdfViewer.AnnotationType.Underline with Double = js.native
  @JSBracketAccess
