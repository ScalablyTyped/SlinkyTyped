...
object LabelPlacement extends js.Object {
  ...
  /* 1 */ val BetweenTicks: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.LabelPlacement.BetweenTicks with Double = js.native
  /* 0 */ val OnTicks: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.LabelPlacement.OnTicks with Double = js.native
  @JSBracketAccess
