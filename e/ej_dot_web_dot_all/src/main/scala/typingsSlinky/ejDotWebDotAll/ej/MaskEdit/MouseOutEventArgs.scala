package typingsSlinky.ejDotWebDotAll.ej.MaskEdit
...
trait MouseOutEventArgs extends js.Object {
  ...
  /** returns the mask edit model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.MaskEdit.Model] = js.undefined
...
object MouseOutEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.MaskEdit.Model = null,
    `type`: String = null,
