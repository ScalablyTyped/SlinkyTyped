...
object TickAlignment extends js.Object {
  ...
  /* 0 */ val LeftOrTop: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.TickAlignment.LeftOrTop with Double = js.native
  /* 1 */ val RightOrBottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.TickAlignment.RightOrBottom with Double = js.native
  @JSBracketAccess
