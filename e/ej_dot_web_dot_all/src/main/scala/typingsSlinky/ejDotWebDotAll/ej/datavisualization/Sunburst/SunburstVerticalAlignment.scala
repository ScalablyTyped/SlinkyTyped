...
object SunburstVerticalAlignment extends js.Object {
  ...
  /* 1 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstVerticalAlignment.Bottom with Double = js.native
  /* 2 */ val Middle: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstVerticalAlignment.Middle with Double = js.native
  /* 0 */ val Top: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstVerticalAlignment.Top with Double = js.native
  @JSBracketAccess
