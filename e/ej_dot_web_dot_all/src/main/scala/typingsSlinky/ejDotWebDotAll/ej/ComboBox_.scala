...
class ComboBox_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.ComboBox.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.ComboBox.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.ComboBox.Model = js.native
  @JSName("model")
  var model_ComboBox_ : typingsSlinky.ejDotWebDotAll.ej.ComboBox.Model = js.native
