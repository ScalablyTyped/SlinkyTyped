...
class PivotGrid_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Model = js.native
  @JSName("model")
  var model_PivotGrid_ : typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Model = js.native
