...
trait Model extends js.Object {
  ...
  /** Specifies the sortOrder to sort the data source. The available type of sort orders are
    ...
    */
  var sortOrder: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.ComboBox.SortOrder | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    sortOrder: typingsSlinky.ejDotWebDotAll.ej.ComboBox.SortOrder | String = null,
    text: String = null,
