...
import typingsSlinky.ejDotWebDotAll.ej.Gantt.EjPredicate
...
class Gantt_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Gantt.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Gantt.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Gantt.Model = js.native
  @JSName("model")
  var model_Gantt_ : typingsSlinky.ejDotWebDotAll.ej.Gantt.Model = js.native
