...
object SunburstHighlightType extends js.Object {
  ...
  /* 1 */ val Color: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstHighlightType.Color with Double = js.native
  /* 0 */ val Opacity: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstHighlightType.Opacity with Double = js.native
  @JSBracketAccess
