...
class DropDownTree_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.DropDownTree.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.DropDownTree.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.DropDownTree.Model = js.native
  @JSName("model")
  var model_DropDownTree_ : typingsSlinky.ejDotWebDotAll.ej.DropDownTree.Model = js.native
