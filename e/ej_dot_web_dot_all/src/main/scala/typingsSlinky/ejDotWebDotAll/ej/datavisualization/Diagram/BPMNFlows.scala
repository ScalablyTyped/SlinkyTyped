...
object BPMNFlows extends js.Object {
  ...
  /* 1 */ val Association: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNFlows.Association with Double = js.native
  /* 2 */ val Message: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNFlows.Message with Double = js.native
  /* 0 */ val Sequence: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNFlows.Sequence with Double = js.native
  @JSBracketAccess
