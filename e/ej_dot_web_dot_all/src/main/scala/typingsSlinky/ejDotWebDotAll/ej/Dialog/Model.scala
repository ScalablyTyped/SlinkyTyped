...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the content to the Dialog control.
    * @Default {null}
    */
  var ajaxSettings: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Dialog.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typingsSlinky.ejDotWebDotAll.ej.Dialog.AjaxSettings = null,
