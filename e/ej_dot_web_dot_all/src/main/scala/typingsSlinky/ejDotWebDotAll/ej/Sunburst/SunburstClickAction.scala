...
object SunburstClickAction extends js.Object {
  ...
  /* 0 */ val None: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstClickAction.None with Double = js.native
  /* 2 */ val ToggleSegmentSelection: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstClickAction.ToggleSegmentSelection with Double = js.native
  /* 1 */ val ToggleSegmentVisibility: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstClickAction.ToggleSegmentVisibility with Double = js.native
  @JSBracketAccess
