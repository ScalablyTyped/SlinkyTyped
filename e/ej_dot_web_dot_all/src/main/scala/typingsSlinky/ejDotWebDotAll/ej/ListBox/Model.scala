...
import typingsSlinky.ejDotWebDotAll.ej.VirtualScrollMode
...
trait Model extends js.Object {
  ...
  /** Set to sort ListBox items either by Ascending or Descending order. By default sortOrder is set as enum type of &quot;None&quot;.You can use only below mentioned type for sorting
    ...
    */
  var sortOrder: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.ListBox.SortOrder | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    sortOrder: typingsSlinky.ejDotWebDotAll.ej.ListBox.SortOrder | String = null,
