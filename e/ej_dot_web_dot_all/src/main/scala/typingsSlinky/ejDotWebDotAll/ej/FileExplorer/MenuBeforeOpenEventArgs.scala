package typingsSlinky.ejDotWebDotAll.ej.FileExplorer
...
trait MenuBeforeOpenEventArgs extends js.Object {
  ...
  /** returns the FileExplorer model.
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.FileExplorer.Model] = js.undefined
...
object MenuBeforeOpenEventArgs {
  ...
  def apply(
    ...
    element: js.Any = null,
    events: js.Any = null,
    model: typingsSlinky.ejDotWebDotAll.ej.FileExplorer.Model = null,
    target: js.Any = null,
    `type`: String = null
