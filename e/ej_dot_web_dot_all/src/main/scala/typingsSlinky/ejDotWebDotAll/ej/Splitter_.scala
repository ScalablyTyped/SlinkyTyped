...
class Splitter_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Splitter.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Splitter.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Splitter.Model = js.native
  @JSName("model")
  var model_Splitter_ : typingsSlinky.ejDotWebDotAll.ej.Splitter.Model = js.native
