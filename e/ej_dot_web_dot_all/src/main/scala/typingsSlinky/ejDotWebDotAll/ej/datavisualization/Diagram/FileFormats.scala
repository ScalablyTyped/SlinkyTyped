...
object FileFormats extends js.Object {
  ...
  /* 2 */ val BMP: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.FileFormats.BMP with Double = js.native
  /* 0 */ val JPG: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.FileFormats.JPG with Double = js.native
  /* 1 */ val PNG: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.FileFormats.PNG with Double = js.native
  /* 3 */ val SVG: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.FileFormats.SVG with Double = js.native
  @JSBracketAccess
