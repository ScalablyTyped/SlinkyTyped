...
object UnitTextPlacement extends js.Object {
  ...
  /* 0 */ val Back: typingsSlinky.ejDotWebDotAll.ej.datavisualization.CircularGauge.UnitTextPlacement.Back with Double = js.native
  /* 1 */ val Front: typingsSlinky.ejDotWebDotAll.ej.datavisualization.CircularGauge.UnitTextPlacement.Front with Double = js.native
  @JSBracketAccess
