...
@js.native
class ColorPicker_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.ColorPicker.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.ColorPicker.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.ColorPicker.Model = js.native
  @JSName("model")
  var model_ColorPicker_ : typingsSlinky.ejDotWebDotAll.ej.ColorPicker.Model = js.native
