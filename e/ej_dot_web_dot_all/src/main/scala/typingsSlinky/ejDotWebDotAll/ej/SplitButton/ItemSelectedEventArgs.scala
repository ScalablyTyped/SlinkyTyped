package typingsSlinky.ejDotWebDotAll.ej.SplitButton
...
trait ItemSelectedEventArgs extends js.Object {
  ...
  /** returns the split button model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.SplitButton.Model] = js.undefined
...
object ItemSelectedEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.SplitButton.Model = null,
