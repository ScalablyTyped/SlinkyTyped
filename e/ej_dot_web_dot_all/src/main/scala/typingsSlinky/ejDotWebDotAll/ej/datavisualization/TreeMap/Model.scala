...
trait Model extends js.Object {
  ...
  var groupSelectionMode: js.UndefOr[
    typingsSlinky.ejDotWebDotAll.ej.datavisualization.TreeMap.groupSelectionMode | String
  ] = js.undefined
  ...
  /** Specifies the selection mode of treemap item. Accepted selection mode values are Default and Multiple.
    * @Default {default}
    */
  var selectionMode: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.TreeMap.selectionMode | String] = js.undefined
