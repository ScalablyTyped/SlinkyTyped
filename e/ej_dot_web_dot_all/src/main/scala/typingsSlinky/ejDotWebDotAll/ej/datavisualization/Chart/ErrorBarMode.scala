...
object ErrorBarMode extends js.Object {
  ...
  /* 0 */ val Both: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.ErrorBarMode.Both with Double = js.native
  /* 2 */ val Horizontal: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.ErrorBarMode.Horizontal with Double = js.native
  /* 1 */ val Vertical: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.ErrorBarMode.Vertical with Double = js.native
  @JSBracketAccess
