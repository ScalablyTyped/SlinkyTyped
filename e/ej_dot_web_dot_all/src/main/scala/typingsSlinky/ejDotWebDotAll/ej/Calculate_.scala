...
class Calculate_ protected () extends js.Object {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Calculate.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Calculate.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Calculate.Model = js.native
  var model: typingsSlinky.ejDotWebDotAll.ej.Calculate.Model = js.native
