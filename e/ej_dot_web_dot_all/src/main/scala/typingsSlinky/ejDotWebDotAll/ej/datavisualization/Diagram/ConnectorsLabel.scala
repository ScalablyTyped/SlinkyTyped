...
trait ConnectorsLabel extends js.Object {
  ...
  /** Defines how to align the text inside the label.
    ...
    */
  var textAlign: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.TextAlign | String] = js.undefined
...
object ConnectorsLabel {
  ...
  def apply(
    ...
    text: String = null,
    textAlign: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.TextAlign | String = null,
