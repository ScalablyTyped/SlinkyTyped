...
object FormPosition extends js.Object {
  ...
  /* 0 */ val BottomLeft: typingsSlinky.ejDotWebDotAll.ej.Grid.FormPosition.BottomLeft with Double = js.native
  /* 1 */ val TopRight: typingsSlinky.ejDotWebDotAll.ej.Grid.FormPosition.TopRight with Double = js.native
  @JSBracketAccess
