...
@js.native
class Accordion_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Accordion.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Accordion.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Accordion.Model = js.native
  @JSName("model")
  var model_Accordion_ : typingsSlinky.ejDotWebDotAll.ej.Accordion.Model = js.native
