...
class TimePicker_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.TimePicker.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.TimePicker.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.TimePicker.Model = js.native
  @JSName("model")
  var model_TimePicker_ : typingsSlinky.ejDotWebDotAll.ej.TimePicker.Model = js.native
