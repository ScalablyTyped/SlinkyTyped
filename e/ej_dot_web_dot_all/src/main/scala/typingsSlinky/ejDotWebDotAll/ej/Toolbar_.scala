...
class Toolbar_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Toolbar.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Toolbar.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Toolbar.Model = js.native
  @JSName("model")
  var model_Toolbar_ : typingsSlinky.ejDotWebDotAll.ej.Toolbar.Model = js.native
