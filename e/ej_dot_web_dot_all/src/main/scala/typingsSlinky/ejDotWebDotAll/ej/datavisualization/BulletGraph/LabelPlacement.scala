...
object LabelPlacement extends js.Object {
  ...
  /* 0 */ val Inside: typingsSlinky.ejDotWebDotAll.ej.datavisualization.BulletGraph.LabelPlacement.Inside with Double = js.native
  /* 1 */ val Outside: typingsSlinky.ejDotWebDotAll.ej.datavisualization.BulletGraph.LabelPlacement.Outside with Double = js.native
  @JSBracketAccess
