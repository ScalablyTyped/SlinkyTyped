...
object LabelRelativeMode extends js.Object {
  ...
  /* 1 */ val SegmentBounds: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.LabelRelativeMode.SegmentBounds with Double = js.native
  /* 0 */ val SegmentPath: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.LabelRelativeMode.SegmentPath with Double = js.native
  @JSBracketAccess
