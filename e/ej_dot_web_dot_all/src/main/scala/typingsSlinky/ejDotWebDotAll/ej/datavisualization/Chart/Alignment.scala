...
object Alignment extends js.Object {
  ...
  /* 0 */ val Center: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.Alignment.Center with Double = js.native
  /* 2 */ val Far: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.Alignment.Far with Double = js.native
  /* 1 */ val Near: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.Alignment.Near with Double = js.native
  @JSBracketAccess
