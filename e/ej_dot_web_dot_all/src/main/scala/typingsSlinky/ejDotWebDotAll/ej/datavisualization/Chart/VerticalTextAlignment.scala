...
object VerticalTextAlignment extends js.Object {
  ...
  /* 0 */ val Center: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.VerticalTextAlignment.Center with Double = js.native
  /* 2 */ val Far: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.VerticalTextAlignment.Far with Double = js.native
  /* 1 */ val Near: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.VerticalTextAlignment.Near with Double = js.native
  @JSBracketAccess
