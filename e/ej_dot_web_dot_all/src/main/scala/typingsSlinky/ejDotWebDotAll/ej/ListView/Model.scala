...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the items to the ListView control.
    * @Default {null}
    */
  var ajaxSettings: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.ListView.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typingsSlinky.ejDotWebDotAll.ej.ListView.AjaxSettings = null,
