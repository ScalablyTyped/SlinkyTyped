...
trait Model extends js.Object {
  ...
  /** Specifies the animation behavior in  Tooltip. It contains the following sub properties.
    */
  var animation: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Tooltip.Animation] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    animation: typingsSlinky.ejDotWebDotAll.ej.Tooltip.Animation = null,
