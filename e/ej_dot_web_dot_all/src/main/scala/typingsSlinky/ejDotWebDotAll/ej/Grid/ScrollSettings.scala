...
trait ScrollSettings extends js.Object {
  ...
  /** This is used to define the mode of virtual scrolling in grid. See virtualScrollMode
    ...
    */
  var virtualScrollMode: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Grid.VirtualScrollMode | String] = js.undefined
...
object ScrollSettings {
  ...
  def apply(
    ...
    virtualScrollMode: typingsSlinky.ejDotWebDotAll.ej.Grid.VirtualScrollMode | String = null,
