...
object SelectorConstraints extends js.Object {
  ...
  /* 7 */ val All: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.All with Double = js.native
  /* 6 */ val AutoHideThumbs: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.AutoHideThumbs with Double = js.native
  /* 5 */ val DragOnEmptySpace: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.DragOnEmptySpace with Double = js.native
  /* 0 */ val None: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.None with Double = js.native
  /* 2 */ val Resizer: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.Resizer with Double = js.native
  /* 1 */ val Rotator: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.Rotator with Double = js.native
  /* 4 */ val Tooltip: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.Tooltip with Double = js.native
  /* 3 */ val UserHandles: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.SelectorConstraints.UserHandles with Double = js.native
  @JSBracketAccess
