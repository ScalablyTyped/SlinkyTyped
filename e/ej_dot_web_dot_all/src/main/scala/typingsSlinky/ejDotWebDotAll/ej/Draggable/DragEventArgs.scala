package typingsSlinky.ejDotWebDotAll.ej.Draggable
...
trait DragEventArgs extends js.Object {
  ...
  /** returns the draggable model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Draggable.Model] = js.undefined
...
object DragEventArgs {
  ...
  def apply(
    ...
    event: js.Any = null,
    model: typingsSlinky.ejDotWebDotAll.ej.Draggable.Model = null,
    target: js.Any = null,
    `type`: String = null
  ): DragEventArgs = {
