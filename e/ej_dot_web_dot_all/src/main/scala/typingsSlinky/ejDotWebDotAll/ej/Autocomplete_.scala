...
class Autocomplete_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Autocomplete.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Autocomplete.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Autocomplete.Model = js.native
  @JSName("model")
  var model_Autocomplete_ : typingsSlinky.ejDotWebDotAll.ej.Autocomplete.Model = js.native
