...
object CaptionAlignment extends js.Object {
  ...
  /* 3 */ val Center: typingsSlinky.ejDotWebDotAll.ej.Tile.CaptionAlignment.Center with Double = js.native
  /* 1 */ val Left: typingsSlinky.ejDotWebDotAll.ej.Tile.CaptionAlignment.Left with Double = js.native
  /* 0 */ val Normal: typingsSlinky.ejDotWebDotAll.ej.Tile.CaptionAlignment.Normal with Double = js.native
  /* 2 */ val Right: typingsSlinky.ejDotWebDotAll.ej.Tile.CaptionAlignment.Right with Double = js.native
  @JSBracketAccess
