...
object ConnectorShapes extends js.Object {
  ...
  /* 0 */ val BPMN: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.ConnectorShapes.BPMN with Double = js.native
  /* 2 */ val UMLActivity: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.ConnectorShapes.UMLActivity with Double = js.native
  /* 1 */ val UMLClassifier: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.ConnectorShapes.UMLClassifier with Double = js.native
  @JSBracketAccess
