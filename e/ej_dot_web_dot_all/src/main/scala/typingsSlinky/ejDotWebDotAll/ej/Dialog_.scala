...
@JSGlobal("ej.Dialog")
@js.native
class Dialog_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Dialog.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Dialog.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Dialog.Model = js.native
  @JSName("model")
  var model_Dialog_ : typingsSlinky.ejDotWebDotAll.ej.Dialog.Model = js.native
