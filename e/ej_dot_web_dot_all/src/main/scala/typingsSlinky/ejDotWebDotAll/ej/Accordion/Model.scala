...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the content to the accordion control.
    * @Default {null}
    */
  var ajaxSettings: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Accordion.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typingsSlinky.ejDotWebDotAll.ej.Accordion.AjaxSettings = null,
