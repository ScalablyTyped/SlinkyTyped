...
class GroupButton_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.GroupButton.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.GroupButton.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.GroupButton.Model = js.native
  @JSName("model")
  var model_GroupButton_ : typingsSlinky.ejDotWebDotAll.ej.GroupButton.Model = js.native
