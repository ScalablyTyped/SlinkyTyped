...
class Schedule_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Schedule.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Schedule.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Schedule.Model = js.native
  @JSName("model")
  var model_Schedule_ : typingsSlinky.ejDotWebDotAll.ej.Schedule.Model = js.native
