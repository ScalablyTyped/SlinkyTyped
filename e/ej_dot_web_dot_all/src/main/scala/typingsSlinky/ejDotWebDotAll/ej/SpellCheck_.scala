...
class SpellCheck_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.SpellCheck.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.SpellCheck.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.SpellCheck.Model = js.native
  @JSName("model")
  var model_SpellCheck_ : typingsSlinky.ejDotWebDotAll.ej.SpellCheck.Model = js.native
