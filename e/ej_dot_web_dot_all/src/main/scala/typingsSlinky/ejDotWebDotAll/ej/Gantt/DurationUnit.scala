...
object DurationUnit extends js.Object {
  ...
  /* 0 */ val Day: typingsSlinky.ejDotWebDotAll.ej.Gantt.DurationUnit.Day with Double = js.native
  /* 1 */ val Hour: typingsSlinky.ejDotWebDotAll.ej.Gantt.DurationUnit.Hour with Double = js.native
  /* 2 */ val Minute: typingsSlinky.ejDotWebDotAll.ej.Gantt.DurationUnit.Minute with Double = js.native
  @JSBracketAccess
