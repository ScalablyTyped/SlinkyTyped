...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Bold: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sparkline.FontWeight.Bold with Double = js.native
  /* 2 */ val Lighter: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sparkline.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sparkline.FontWeight.Regular with Double = js.native
  @JSBracketAccess
