...
object AssociationFlows extends js.Object {
  ...
  /* 2 */ val BiDirectional: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.AssociationFlows.BiDirectional with Double = js.native
  /* 0 */ val Default: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.AssociationFlows.Default with Double = js.native
  /* 1 */ val Directional: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.AssociationFlows.Directional with Double = js.native
  @JSBracketAccess
