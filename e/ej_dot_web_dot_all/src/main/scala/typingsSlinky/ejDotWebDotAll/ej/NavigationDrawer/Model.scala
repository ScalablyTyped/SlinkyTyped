...
import typingsSlinky.ejDotWebDotAll.ej.Direction
...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the content to the NavigationDrawer control.
    * @Default {null}
    */
  var ajaxSettings: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.NavigationDrawer.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typingsSlinky.ejDotWebDotAll.ej.NavigationDrawer.AjaxSettings = null,
