...
object PPTFormats extends js.Object {
  ...
  /* 1 */ val PowerPoint2007: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PPTFormats.PowerPoint2007 with Double = js.native
  /* 2 */ val PowerPoint2010: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PPTFormats.PowerPoint2010 with Double = js.native
  /* 3 */ val PowerPoint2013: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PPTFormats.PowerPoint2013 with Double = js.native
  /* 0 */ val PowerPoint97to2003: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PPTFormats.PowerPoint97to2003 with Double = js.native
  @JSBracketAccess
