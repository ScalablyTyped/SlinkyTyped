...
object Horizontal extends js.Object {
  ...
  /* 1 */ val Center: typingsSlinky.ejDotWebDotAll.ej.datavisualization.HeatMap.Horizontal.Center with Double = js.native
  /* 0 */ val Left: typingsSlinky.ejDotWebDotAll.ej.datavisualization.HeatMap.Horizontal.Left with Double = js.native
  /* 2 */ val Right: typingsSlinky.ejDotWebDotAll.ej.datavisualization.HeatMap.Horizontal.Right with Double = js.native
  @JSBracketAccess
