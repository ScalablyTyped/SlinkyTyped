...
class FileExplorer_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.FileExplorer.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.FileExplorer.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.FileExplorer.Model = js.native
  @JSName("model")
  var model_FileExplorer_ : typingsSlinky.ejDotWebDotAll.ej.FileExplorer.Model = js.native
