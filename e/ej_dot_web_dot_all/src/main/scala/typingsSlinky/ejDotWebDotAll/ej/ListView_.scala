...
@js.native
class ListView_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.ListView.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.ListView.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.ListView.Model = js.native
  @JSName("model")
  var model_ListView_ : typingsSlinky.ejDotWebDotAll.ej.ListView.Model = js.native
