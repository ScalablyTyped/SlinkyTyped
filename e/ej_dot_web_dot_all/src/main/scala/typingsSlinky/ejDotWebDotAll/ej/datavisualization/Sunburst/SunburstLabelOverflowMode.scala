...
object SunburstLabelOverflowMode extends js.Object {
  ...
  /* 1 */ val Hide: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLabelOverflowMode.Hide with Double = js.native
  /* 2 */ val None: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLabelOverflowMode.None with Double = js.native
  /* 0 */ val Trim: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLabelOverflowMode.Trim with Double = js.native
  @JSBracketAccess
