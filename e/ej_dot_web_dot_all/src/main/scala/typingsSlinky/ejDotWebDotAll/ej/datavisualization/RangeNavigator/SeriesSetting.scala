...
trait SeriesSetting extends js.Object {
  ...
  /** Specifies the type of the series to render in chart.
    ...
    */
  var `type`: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.RangeNavigator.Type | String] = js.undefined
...
object SeriesSetting {
  ...
  def apply(
    ...
    fill: String = null,
    `type`: typingsSlinky.ejDotWebDotAll.ej.datavisualization.RangeNavigator.Type | String = null,
    xName: String = null,
    yName: String = null
  ): SeriesSetting = {
