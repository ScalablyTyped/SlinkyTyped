...
trait Model extends js.Object {
  ...
  /** Enables or disables selecting the animation style for the popup list. Animation types can be selected through either of the following options,
    * @Default {slide}
    */
  var animateType: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Autocomplete.Animation | String] = js.undefined
  ...
  /** Enables or disables selecting multiple values from the suggestion list. Multiple values can be selected through either of the following options,
    ...
    */
  var multiSelectMode: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Autocomplete.MultiSelectMode | String] = js.undefined
  ...
  /** Sort order specifies whether the suggestion list values has to be displayed in ascending or descending order.
    ...
    */
  var sortOrder: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Autocomplete.SortOrder | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    animateType: typingsSlinky.ejDotWebDotAll.ej.Autocomplete.Animation | String = null,
    ...
    multiSelectMode: typingsSlinky.ejDotWebDotAll.ej.Autocomplete.MultiSelectMode | String = null,
    ...
    sortOrder: typingsSlinky.ejDotWebDotAll.ej.Autocomplete.SortOrder | String = null,
