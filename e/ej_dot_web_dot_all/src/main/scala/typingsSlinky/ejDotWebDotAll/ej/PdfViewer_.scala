...
import typingsSlinky.ejDotWebDotAll.ej.PdfViewer.AnnotationType
...
class PdfViewer_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.PdfViewer.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.PdfViewer.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.PdfViewer.Model = js.native
  @JSName("model")
  var model_PdfViewer_ : typingsSlinky.ejDotWebDotAll.ej.PdfViewer.Model = js.native
