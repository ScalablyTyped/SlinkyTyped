package typingsSlinky.ejDotWebDotAll.ej.TreeView
...
trait BeforePasteEventArgs extends js.Object {
  ...
  /** returns the TreeView model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.TreeView.Model] = js.undefined
...
object BeforePasteEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.TreeView.Model = null,
