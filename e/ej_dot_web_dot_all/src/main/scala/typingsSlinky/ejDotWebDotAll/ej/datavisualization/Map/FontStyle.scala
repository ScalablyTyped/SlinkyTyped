...
object FontStyle extends js.Object {
  ...
  /* 1 */ val Italic: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.FontStyle.Italic with Double = js.native
  /* 0 */ val Normal: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.FontStyle.Normal with Double = js.native
  @JSBracketAccess
