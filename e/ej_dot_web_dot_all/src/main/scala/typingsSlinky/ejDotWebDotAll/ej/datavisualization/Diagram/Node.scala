...
object Node {
  ...
  def apply(
    ...
    if (subProcess != null) __obj.updateDynamic("subProcess")(subProcess.asInstanceOf[js.Any])
    if (task != null) __obj.updateDynamic("task")(task.asInstanceOf[js.Any])
    if (templateId != null) __obj.updateDynamic("templateId")(templateId.asInstanceOf[js.Any])
    if (textBlock != null) __obj.updateDynamic("textBlock")(textBlock.asInstanceOf[js.Any])
