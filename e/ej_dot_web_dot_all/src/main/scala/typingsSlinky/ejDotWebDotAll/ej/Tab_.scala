...
class Tab_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Tab.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Tab.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Tab.Model = js.native
  @JSName("model")
  var model_Tab_ : typingsSlinky.ejDotWebDotAll.ej.Tab.Model = js.native
