...
class Rotator_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Rotator.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Rotator.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Rotator.Model = js.native
  @JSName("model")
  var model_Rotator_ : typingsSlinky.ejDotWebDotAll.ej.Rotator.Model = js.native
