...
class Menu_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Menu.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Menu.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Menu.Model = js.native
  @JSName("model")
  var model_Menu_ : typingsSlinky.ejDotWebDotAll.ej.Menu.Model = js.native
