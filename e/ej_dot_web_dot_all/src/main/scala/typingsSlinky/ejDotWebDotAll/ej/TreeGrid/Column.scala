...
trait Column extends js.Object {
  ...
  /** Gets or sets a value to render either excel or menu filtering in TreeGrid column filtering.
    * @Default {null}
    */
  var filterType: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.TreeGrid.FilterType | String] = js.undefined
...
object Column {
  ...
  def apply(
    ...
    filterType: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.FilterType | String = null,
    format: js.Any = null,
