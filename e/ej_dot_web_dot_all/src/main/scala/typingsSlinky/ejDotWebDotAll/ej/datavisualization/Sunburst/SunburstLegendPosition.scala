...
object SunburstLegendPosition extends js.Object {
  ...
  /* 3 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Bottom with Double = js.native
  /* 0 */ val Left: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Left with Double = js.native
  /* 1 */ val Right: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Right with Double = js.native
  /* 2 */ val Top: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Top with Double = js.native
  @JSBracketAccess
