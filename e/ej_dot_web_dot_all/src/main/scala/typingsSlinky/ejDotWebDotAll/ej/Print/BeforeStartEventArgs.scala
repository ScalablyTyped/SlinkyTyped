package typingsSlinky.ejDotWebDotAll.ej.Print
...
trait BeforeStartEventArgs extends js.Object {
  ...
  /** Returns the Print model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Print.Model] = js.undefined
...
object BeforeStartEventArgs {
  ...
  def apply(
    ...
    content: js.Any = null,
    model: typingsSlinky.ejDotWebDotAll.ej.Print.Model = null,
    `type`: String = null
