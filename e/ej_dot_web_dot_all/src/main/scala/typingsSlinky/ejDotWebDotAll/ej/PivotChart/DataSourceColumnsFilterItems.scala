package typingsSlinky.ejDotWebDotAll.ej.PivotChart
...
trait DataSourceColumnsFilterItems extends js.Object {
  /** Sets the type of filter whether to include/exclude the mentioned values.
    ...
    */
  var filterType: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.PivotAnalysis.FilterType | String] = js.undefined
...
object DataSourceColumnsFilterItems {
  @scala.inline
  def apply(
    filterType: typingsSlinky.ejDotWebDotAll.ej.PivotAnalysis.FilterType | String = null,
