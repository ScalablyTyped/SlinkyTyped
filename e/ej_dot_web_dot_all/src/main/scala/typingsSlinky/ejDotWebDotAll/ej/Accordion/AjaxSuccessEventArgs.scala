package typingsSlinky.ejDotWebDotAll.ej.Accordion
...
trait AjaxSuccessEventArgs extends js.Object {
  ...
  /** returns the accordion model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Accordion.Model] = js.undefined
...
object AjaxSuccessEventArgs {
  ...
  def apply(
    ...
    content: String = null,
    data: String = null,
    model: typingsSlinky.ejDotWebDotAll.ej.Accordion.Model = null,
    `type`: String = null
