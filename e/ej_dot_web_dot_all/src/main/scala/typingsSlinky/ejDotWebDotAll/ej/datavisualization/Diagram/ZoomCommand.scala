...
object ZoomCommand extends js.Object {
  ...
  /* 0 */ val ZoomIn: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.ZoomCommand.ZoomIn with Double = js.native
  /* 1 */ val ZoomOut: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.ZoomCommand.ZoomOut with Double = js.native
  @JSBracketAccess
