...
@js.native
class RadialMenu_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.RadialMenu.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.RadialMenu.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.RadialMenu.Model = js.native
  @JSName("model")
  var model_RadialMenu_ : typingsSlinky.ejDotWebDotAll.ej.RadialMenu.Model = js.native
