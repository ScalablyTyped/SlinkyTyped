...
class ListBox_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.ListBox.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.ListBox.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.ListBox.Model = js.native
  @JSName("model")
  var model_ListBox_ : typingsSlinky.ejDotWebDotAll.ej.ListBox.Model = js.native
