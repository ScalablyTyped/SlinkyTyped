...
trait Scale extends js.Object {
  ...
  /** Specifies the scale Direction of the Scale. See
    ...
    */
  var direction: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.LinearGauge.Direction | String] = js.undefined
...
object Scale {
  ...
  def apply(
    ...
    direction: typingsSlinky.ejDotWebDotAll.ej.datavisualization.LinearGauge.Direction | String = null,
