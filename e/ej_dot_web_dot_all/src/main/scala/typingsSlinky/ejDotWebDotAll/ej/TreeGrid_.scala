...
import typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EjPredicate
...
class TreeGrid_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.Model = js.native
  @JSName("model")
  var model_TreeGrid_ : typingsSlinky.ejDotWebDotAll.ej.TreeGrid.Model = js.native
