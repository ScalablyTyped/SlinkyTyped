...
object LabelSize extends js.Object {
  ...
  /* 1 */ val Default: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LabelSize.Default with Double = js.native
  /* 0 */ val Fixed: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LabelSize.Fixed with Double = js.native
  @JSBracketAccess
