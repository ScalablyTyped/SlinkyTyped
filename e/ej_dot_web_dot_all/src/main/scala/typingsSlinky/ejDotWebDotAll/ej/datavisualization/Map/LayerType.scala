...
object LayerType extends js.Object {
  ...
  /* 2 */ val Bing: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LayerType.Bing with Double = js.native
  /* 0 */ val Geometry: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LayerType.Geometry with Double = js.native
  /* 1 */ val Osm: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LayerType.Osm with Double = js.native
  @JSBracketAccess
