...
class RTE_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.RTE.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.RTE.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.RTE.Model = js.native
  @JSName("model")
  var model_RTE_ : typingsSlinky.ejDotWebDotAll.ej.RTE.Model = js.native
