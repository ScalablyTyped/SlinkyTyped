...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the content to the Tab control.
    */
  var ajaxSettings: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Tab.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typingsSlinky.ejDotWebDotAll.ej.Tab.AjaxSettings = null,
