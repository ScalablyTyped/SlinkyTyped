...
@js.native
class PivotChart_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.PivotChart.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.PivotChart.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.PivotChart.Model = js.native
  @JSName("model")
  var model_PivotChart_ : typingsSlinky.ejDotWebDotAll.ej.PivotChart.Model = js.native
