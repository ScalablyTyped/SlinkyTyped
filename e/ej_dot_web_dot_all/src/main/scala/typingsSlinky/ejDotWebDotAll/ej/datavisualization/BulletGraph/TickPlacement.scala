...
object TickPlacement extends js.Object {
  ...
  /* 0 */ val Inside: typingsSlinky.ejDotWebDotAll.ej.datavisualization.BulletGraph.TickPlacement.Inside with Double = js.native
  /* 1 */ val Outside: typingsSlinky.ejDotWebDotAll.ej.datavisualization.BulletGraph.TickPlacement.Outside with Double = js.native
  @JSBracketAccess
