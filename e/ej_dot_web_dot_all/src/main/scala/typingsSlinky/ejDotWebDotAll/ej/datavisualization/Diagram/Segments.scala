...
object Segments extends js.Object {
  ...
  /* 2 */ val Bezier: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.Segments.Bezier with Double = js.native
  /* 1 */ val Orthogonal: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.Segments.Orthogonal with Double = js.native
  /* 0 */ val Straight: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.Segments.Straight with Double = js.native
  @JSBracketAccess
