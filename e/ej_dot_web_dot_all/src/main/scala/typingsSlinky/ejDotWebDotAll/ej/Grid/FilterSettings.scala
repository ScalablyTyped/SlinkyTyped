...
trait FilterSettings extends js.Object {
  ...
  /** This specifies the grid to show the filterBar or filterMenu to the grid records. See filterType
    ...
    */
  var filterType: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Grid.FilterType | String] = js.undefined
...
object FilterSettings {
  ...
  def apply(
    ...
    filterType: typingsSlinky.ejDotWebDotAll.ej.Grid.FilterType | String = null,
