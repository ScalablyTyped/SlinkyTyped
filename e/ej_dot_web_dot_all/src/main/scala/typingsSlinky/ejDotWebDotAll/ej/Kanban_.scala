...
import typingsSlinky.ejDotWebDotAll.ej.Kanban.KanbanEdit
import typingsSlinky.ejDotWebDotAll.ej.Kanban.KanbanFilter
import typingsSlinky.ejDotWebDotAll.ej.Kanban.KanbanSelection
import typingsSlinky.ejDotWebDotAll.ej.Kanban.KanbanSwimlane
...
class Kanban_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Kanban.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Kanban.Model) = this()
  ...
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Kanban.Model = js.native
  @JSName("model")
  var model_Kanban_ : typingsSlinky.ejDotWebDotAll.ej.Kanban.Model = js.native
