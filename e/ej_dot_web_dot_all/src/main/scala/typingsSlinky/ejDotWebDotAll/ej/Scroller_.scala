...
class Scroller_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Scroller.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Scroller.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Scroller.Model = js.native
  @JSName("model")
  var model_Scroller_ : typingsSlinky.ejDotWebDotAll.ej.Scroller.Model = js.native
