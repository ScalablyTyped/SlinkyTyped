...
object ExportingType extends js.Object {
  ...
  /* 1 */ val JPG: typingsSlinky.ejDotWebDotAll.ej.datavisualization.CircularGauge.ExportingType.JPG with Double = js.native
  /* 0 */ val PNG: typingsSlinky.ejDotWebDotAll.ej.datavisualization.CircularGauge.ExportingType.PNG with Double = js.native
  @JSBracketAccess
