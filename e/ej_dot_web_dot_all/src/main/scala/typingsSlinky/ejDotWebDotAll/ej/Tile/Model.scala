...
trait Model extends js.Object {
  ...
  /** Specifies the position of tile image.
    * @Default {center}
    */
  var imagePosition: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.Tile.ImagePosition | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    imagePosition: typingsSlinky.ejDotWebDotAll.ej.Tile.ImagePosition | String = null,
