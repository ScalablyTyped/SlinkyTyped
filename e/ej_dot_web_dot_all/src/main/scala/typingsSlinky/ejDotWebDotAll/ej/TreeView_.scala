...
class TreeView_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.TreeView.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.TreeView.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.TreeView.Model = js.native
  @JSName("model")
  var model_TreeView_ : typingsSlinky.ejDotWebDotAll.ej.TreeView.Model = js.native
