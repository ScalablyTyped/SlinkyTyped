...
object BeginEditAction extends js.Object {
  ...
  /* 1 */ val Click: typingsSlinky.ejDotWebDotAll.ej.Gantt.BeginEditAction.Click with Double = js.native
  /* 0 */ val DblClick: typingsSlinky.ejDotWebDotAll.ej.Gantt.BeginEditAction.DblClick with Double = js.native
  @JSBracketAccess
