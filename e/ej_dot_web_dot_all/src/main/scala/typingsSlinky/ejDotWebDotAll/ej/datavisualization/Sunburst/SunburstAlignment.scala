...
object SunburstAlignment extends js.Object {
  ...
  /* 0 */ val Center: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstAlignment.Center with Double = js.native
  /* 2 */ val Far: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstAlignment.Far with Double = js.native
  /* 1 */ val Near: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstAlignment.Near with Double = js.native
  @JSBracketAccess
