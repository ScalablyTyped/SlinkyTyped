...
object EditingType extends js.Object {
  ...
  /* 1 */ val Boolean: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.Boolean with Double = js.native
  /* 4 */ val DatePicker: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.DatePicker with Double = js.native
  /* 5 */ val DateTimePicker: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.DateTimePicker with Double = js.native
  /* 3 */ val Dropdown: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.Dropdown with Double = js.native
  /* 6 */ val Maskedit: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.Maskedit with Double = js.native
  /* 2 */ val Numeric: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.Numeric with Double = js.native
  /* 0 */ val String: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.EditingType.String with Double = js.native
  @JSBracketAccess
