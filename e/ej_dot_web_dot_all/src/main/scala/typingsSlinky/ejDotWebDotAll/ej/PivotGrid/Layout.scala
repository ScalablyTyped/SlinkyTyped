package typingsSlinky.ejDotWebDotAll.ej.PivotGrid
...
object Layout extends js.Object {
  ...
  /* 3 */ val ExcelLikeLayout: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Layout.ExcelLikeLayout with Double = js.native
  /* 2 */ val NoSummaries: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Layout.NoSummaries with Double = js.native
  /* 0 */ val Normal: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Layout.Normal with Double = js.native
  /* 1 */ val NormalTopSummary: typingsSlinky.ejDotWebDotAll.ej.PivotGrid.Layout.NormalTopSummary with Double = js.native
  @JSBracketAccess
