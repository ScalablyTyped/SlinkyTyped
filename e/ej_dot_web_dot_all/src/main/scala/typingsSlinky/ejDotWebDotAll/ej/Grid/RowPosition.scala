...
object RowPosition extends js.Object {
  ...
  /* 1 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.Grid.RowPosition.Bottom with Double = js.native
  /* 0 */ val Top: typingsSlinky.ejDotWebDotAll.ej.Grid.RowPosition.Top with Double = js.native
  @JSBracketAccess
