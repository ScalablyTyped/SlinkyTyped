...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Lighter: typingsSlinky.ejDotWebDotAll.ej.datavisualization.RangeNavigator.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typingsSlinky.ejDotWebDotAll.ej.datavisualization.RangeNavigator.FontWeight.Regular with Double = js.native
  @JSBracketAccess
