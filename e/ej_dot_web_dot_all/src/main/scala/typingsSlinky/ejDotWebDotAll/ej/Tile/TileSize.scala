...
object TileSize extends js.Object {
  ...
  /* 2 */ val Large: typingsSlinky.ejDotWebDotAll.ej.Tile.TileSize.Large with Double = js.native
  /* 0 */ val Medium: typingsSlinky.ejDotWebDotAll.ej.Tile.TileSize.Medium with Double = js.native
  /* 1 */ val Small: typingsSlinky.ejDotWebDotAll.ej.Tile.TileSize.Small with Double = js.native
  /* 3 */ val Wide: typingsSlinky.ejDotWebDotAll.ej.Tile.TileSize.Wide with Double = js.native
  @JSBracketAccess
