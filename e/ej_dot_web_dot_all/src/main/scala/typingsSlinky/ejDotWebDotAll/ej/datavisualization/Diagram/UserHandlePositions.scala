...
object UserHandlePositions extends js.Object {
  ...
  /* 6 */ val BottomCenter: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.BottomCenter with Double = js.native
  /* 5 */ val BottomLeft: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.BottomLeft with Double = js.native
  /* 7 */ val BottomRight: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.BottomRight with Double = js.native
  /* 3 */ val MiddleLeft: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.MiddleLeft with Double = js.native
  /* 4 */ val MiddleRight: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.MiddleRight with Double = js.native
  /* 1 */ val TopCenter: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.TopCenter with Double = js.native
  /* 0 */ val TopLeft: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.TopLeft with Double = js.native
  /* 2 */ val TopRight: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.UserHandlePositions.TopRight with Double = js.native
  @JSBracketAccess
