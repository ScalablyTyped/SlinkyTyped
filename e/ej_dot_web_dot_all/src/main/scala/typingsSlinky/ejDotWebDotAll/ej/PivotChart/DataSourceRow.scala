...
trait DataSourceRow extends js.Object {
  ...
  /** Allows you to set the sorting order of field members.
    ...
    */
  var sortOrder: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.PivotAnalysis.SortOrder | String] = js.undefined
}
...
object DataSourceRow {
  ...
  def apply(
    ...
    sortOrder: typingsSlinky.ejDotWebDotAll.ej.PivotAnalysis.SortOrder | String = null
  ): DataSourceRow = {
