...
object HorizontalTextAlignment extends js.Object {
  ...
  /* 0 */ val Center: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.HorizontalTextAlignment.Center with Double = js.native
  /* 2 */ val Far: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.HorizontalTextAlignment.Far with Double = js.native
  /* 1 */ val Near: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.HorizontalTextAlignment.Near with Double = js.native
  @JSBracketAccess
