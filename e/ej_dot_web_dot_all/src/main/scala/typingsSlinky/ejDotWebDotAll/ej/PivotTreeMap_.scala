...
@js.native
class PivotTreeMap_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.PivotTreeMap.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.PivotTreeMap.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.PivotTreeMap.Model = js.native
  @JSName("model")
  var model_PivotTreeMap_ : typingsSlinky.ejDotWebDotAll.ej.PivotTreeMap.Model = js.native
