...
class Rating_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Rating.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Rating.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Rating.Model = js.native
  @JSName("model")
  var model_Rating_ : typingsSlinky.ejDotWebDotAll.ej.Rating.Model = js.native
