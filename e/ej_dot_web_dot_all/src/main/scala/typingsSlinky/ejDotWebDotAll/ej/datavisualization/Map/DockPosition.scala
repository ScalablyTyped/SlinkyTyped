...
object DockPosition extends js.Object {
  ...
  /* 1 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.DockPosition.Bottom with Double = js.native
  /* 3 */ val Left: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.DockPosition.Left with Double = js.native
  /* 2 */ val Right: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.DockPosition.Right with Double = js.native
  /* 0 */ val Top: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.DockPosition.Top with Double = js.native
  @JSBracketAccess
