...
object LabelOrientation extends js.Object {
  ...
  /* 0 */ val Horizontal: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LabelOrientation.Horizontal with Double = js.native
  /* 1 */ val Vertical: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Map.LabelOrientation.Vertical with Double = js.native
  @JSBracketAccess
