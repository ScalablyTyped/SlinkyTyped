package typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor
...
trait ChangeEventArgs extends js.Object {
  ...
  /** Returns the Recurrence Editor model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor.Model] = js.undefined
...
object ChangeEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.RecurrenceEditor.Model = null,
