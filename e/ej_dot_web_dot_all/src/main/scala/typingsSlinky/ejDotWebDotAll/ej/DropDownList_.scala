...
@js.native
class DropDownList_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.DropDownList.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.DropDownList.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.DropDownList.Model = js.native
  @JSName("model")
  var model_DropDownList_ : typingsSlinky.ejDotWebDotAll.ej.DropDownList.Model = js.native
