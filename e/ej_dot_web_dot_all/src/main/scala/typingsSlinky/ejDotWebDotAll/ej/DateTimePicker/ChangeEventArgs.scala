package typingsSlinky.ejDotWebDotAll.ej.DateTimePicker
...
trait ChangeEventArgs extends js.Object {
  ...
  /** returns the TimePicker model
    */
  var model: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.DateTimePicker.Model] = js.undefined
...
object ChangeEventArgs {
  ...
  def apply(
    ...
    model: typingsSlinky.ejDotWebDotAll.ej.DateTimePicker.Model = null,
