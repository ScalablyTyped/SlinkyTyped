...
object SunburstTheme extends js.Object {
  ...
  /* 1 */ val FlatDark: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstTheme.FlatDark with Double = js.native
  /* 0 */ val FlatLight: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstTheme.FlatLight with Double = js.native
  @JSBracketAccess
