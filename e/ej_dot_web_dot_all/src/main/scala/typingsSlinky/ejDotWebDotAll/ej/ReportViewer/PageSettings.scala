...
trait PageSettings extends js.Object {
  /** Specifies the print layout orientation.
    * @Default {null}
    */
  var orientation: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.ReportViewer.Orientation | String] = js.undefined
...
object PageSettings {
  @scala.inline
  def apply(
    orientation: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.Orientation | String = null,
