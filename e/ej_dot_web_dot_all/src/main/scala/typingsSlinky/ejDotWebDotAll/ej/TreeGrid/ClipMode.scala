...
object ClipMode extends js.Object {
  ...
  /* 1 */ val Clip: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.ClipMode.Clip with Double = js.native
  /* 0 */ val Ellipsis: typingsSlinky.ejDotWebDotAll.ej.TreeGrid.ClipMode.Ellipsis with Double = js.native
  @JSBracketAccess
