...
class PivotClient_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.PivotClient.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.PivotClient.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.PivotClient.Model = js.native
  @JSName("model")
  var model_PivotClient_ : typingsSlinky.ejDotWebDotAll.ej.PivotClient.Model = js.native
