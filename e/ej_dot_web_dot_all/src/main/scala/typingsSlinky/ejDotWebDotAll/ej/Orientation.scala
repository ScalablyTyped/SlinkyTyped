...
object Orientation extends js.Object {
  ...
  /* 0 */ val Horizontal: typingsSlinky.ejDotWebDotAll.ej.Orientation.Horizontal with Double = js.native
  /* 1 */ val Vertical: typingsSlinky.ejDotWebDotAll.ej.Orientation.Vertical with Double = js.native
  @JSBracketAccess
