...
@JSGlobal("ej.Ribbon")
@js.native
class Ribbon_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Ribbon.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Ribbon.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Ribbon.Model = js.native
  @JSName("model")
  var model_Ribbon_ : typingsSlinky.ejDotWebDotAll.ej.Ribbon.Model = js.native
