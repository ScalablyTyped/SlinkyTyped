...
object VerticalAlignment extends js.Object {
  ...
  /* 1 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.VerticalAlignment.Bottom with Double = js.native
  /* 2 */ val Middle: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.VerticalAlignment.Middle with Double = js.native
  /* 0 */ val Top: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Chart.VerticalAlignment.Top with Double = js.native
  @JSBracketAccess
