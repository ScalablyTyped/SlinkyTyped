...
object SunburstLabelRotationMode extends js.Object {
  ...
  /* 0 */ val Angle: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstLabelRotationMode.Angle with Double = js.native
  /* 1 */ val Normal: typingsSlinky.ejDotWebDotAll.ej.Sunburst.SunburstLabelRotationMode.Normal with Double = js.native
  @JSBracketAccess
