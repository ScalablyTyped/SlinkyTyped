...
class ReportDesigner_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.ReportDesigner.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.ReportDesigner.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.ReportDesigner.Model = js.native
  @JSName("model")
  var model_ReportDesigner_ : typingsSlinky.ejDotWebDotAll.ej.ReportDesigner.Model = js.native
