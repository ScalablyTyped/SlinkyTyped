...
class Tooltip_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Tooltip.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Tooltip.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Tooltip.Model = js.native
  @JSName("model")
  var model_Tooltip_ : typingsSlinky.ejDotWebDotAll.ej.Tooltip.Model = js.native
