...
object TimescaleRoundMode extends js.Object {
  ...
  /* 0 */ val Auto: typingsSlinky.ejDotWebDotAll.ej.Gantt.TimescaleRoundMode.Auto with Double = js.native
  /* 2 */ val Month: typingsSlinky.ejDotWebDotAll.ej.Gantt.TimescaleRoundMode.Month with Double = js.native
  /* 1 */ val Week: typingsSlinky.ejDotWebDotAll.ej.Gantt.TimescaleRoundMode.Week with Double = js.native
  /* 3 */ val Year: typingsSlinky.ejDotWebDotAll.ej.Gantt.TimescaleRoundMode.Year with Double = js.native
  @JSBracketAccess
