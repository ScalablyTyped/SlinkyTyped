...
trait Scale extends js.Object {
  ...
  var direction: js.UndefOr[
    typingsSlinky.ejDotWebDotAll.ej.datavisualization.CircularGauge.Direction | String
  ] = js.undefined
...
object Scale {
  ...
  def apply(
    ...
    direction: typingsSlinky.ejDotWebDotAll.ej.datavisualization.CircularGauge.Direction | String = null,
