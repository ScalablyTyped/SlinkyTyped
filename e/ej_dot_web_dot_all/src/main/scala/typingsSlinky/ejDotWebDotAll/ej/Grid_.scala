...
@JSGlobal("ej.Grid")
@js.native
class Grid_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.Grid.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.Grid.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.Grid.Model = js.native
  @JSName("model")
  var model_Grid_ : typingsSlinky.ejDotWebDotAll.ej.Grid.Model = js.native
