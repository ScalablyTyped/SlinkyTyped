...
trait Model extends js.Object {
  ...
  /** Specify tooltip options of linear gauge
    * @Default {false}
    */
  var tooltip: js.UndefOr[typingsSlinky.ejDotWebDotAll.ej.datavisualization.LinearGauge.Tooltip] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    tooltip: typingsSlinky.ejDotWebDotAll.ej.datavisualization.LinearGauge.Tooltip = null,
