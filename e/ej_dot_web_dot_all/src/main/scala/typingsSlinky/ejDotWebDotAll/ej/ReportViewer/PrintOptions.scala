...
object PrintOptions extends js.Object {
  ...
  /* 0 */ val Default: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PrintOptions.Default with Double = js.native
  /* 1 */ val NewTab: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PrintOptions.NewTab with Double = js.native
  /* 2 */ val None: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.PrintOptions.None with Double = js.native
  @JSBracketAccess
