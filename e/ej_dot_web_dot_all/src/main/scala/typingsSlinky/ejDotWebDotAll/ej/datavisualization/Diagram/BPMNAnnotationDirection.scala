...
object BPMNAnnotationDirection extends js.Object {
  ...
  /* 3 */ val Bottom: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNAnnotationDirection.Bottom with Double = js.native
  /* 0 */ val Left: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNAnnotationDirection.Left with Double = js.native
  /* 1 */ val Right: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNAnnotationDirection.Right with Double = js.native
  /* 2 */ val Top: typingsSlinky.ejDotWebDotAll.ej.datavisualization.Diagram.BPMNAnnotationDirection.Top with Double = js.native
  @JSBracketAccess
