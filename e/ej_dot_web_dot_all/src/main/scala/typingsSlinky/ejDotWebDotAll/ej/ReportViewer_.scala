...
class ReportViewer_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.ReportViewer.Model = js.native
  @JSName("model")
  var model_ReportViewer_ : typingsSlinky.ejDotWebDotAll.ej.ReportViewer.Model = js.native
