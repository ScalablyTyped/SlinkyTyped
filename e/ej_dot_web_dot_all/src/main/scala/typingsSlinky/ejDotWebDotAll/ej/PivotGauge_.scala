...
class PivotGauge_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.PivotGauge.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.PivotGauge.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.PivotGauge.Model = js.native
  @JSName("model")
  var model_PivotGauge_ : typingsSlinky.ejDotWebDotAll.ej.PivotGauge.Model = js.native
