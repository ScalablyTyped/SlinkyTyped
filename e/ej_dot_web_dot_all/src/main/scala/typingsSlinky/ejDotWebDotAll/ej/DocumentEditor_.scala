...
class DocumentEditor_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typingsSlinky.ejDotWebDotAll.ej.DocumentEditor.Model) = this()
  def this(element: Element, options: typingsSlinky.ejDotWebDotAll.ej.DocumentEditor.Model) = this()
  var defaults: typingsSlinky.ejDotWebDotAll.ej.DocumentEditor.Model = js.native
  @JSName("model")
  var model_DocumentEditor_ : typingsSlinky.ejDotWebDotAll.ej.DocumentEditor.Model = js.native
