...
import typingsSlinky.ejDotWebDotAll.ej.DataManager
import typingsSlinky.ejDotWebDotAll.ej.Query
import typingsSlinky.ejDotWebDotAll.ej.browserInfoOptions
import typingsSlinky.ejDotWebDotAll.ej.culture
...
trait Typeofej extends js.Object {
  ...
  var Adaptor: Instantiable1[/* ds */ js.Any, typingsSlinky.ejDotWebDotAll.ej.Adaptor] = js.native
  val Autocomplete: TypeofClassAutocomplete = js.native
  val Button: TypeofClassButton = js.native
  var CacheAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.CacheAdaptor] = js.native
  ...
  var CurrencyTextbox: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.CurrencyTextbox] = js.native
  var DataManager: Instantiable3[
    js.UndefOr[/* dataSource */ js.Any], 
    js.UndefOr[/* query */ Query], 
    js.UndefOr[/* adaptor */ js.Any], 
    typingsSlinky.ejDotWebDotAll.ej.DataManager
  ] = js.native
  ...
  var ForeignKeyAdaptor: Instantiable2[
    /* data */ js.Any, 
    /* type */ String, 
    typingsSlinky.ejDotWebDotAll.ej.ForeignKeyAdaptor
  ] = js.native
  val Gantt: TypeofClassGantt = js.native
  val Grid: TypeofClassGrid = js.native
  val GroupButton: TypeofClassGroupButton = js.native
  var JsonAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.JsonAdaptor] = js.native
  ...
  var Model: Instantiable3[
    ...
    /* table */ String, 
    /* name */ String, 
    typingsSlinky.ejDotWebDotAll.ej.Model
  ] = js.native
  val NavigationDrawer: TypeofClassNavigationDrawer = js.native
  var NumericTextbox: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.NumericTextbox] = js.native
  var ODataAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.ODataAdaptor] = js.native
  var ODataV4Adaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.ODataV4Adaptor] = js.native
  val Pager: TypeofClassPager = js.native
  val PdfViewer: TypeofClassPdfViewer = js.native
  var PercentageTextbox: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.PercentageTextbox] = js.native
  ...
  var Predicate: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.Predicate] = js.native
  ...
  var TableModel: Instantiable4[
    ...
    typingsSlinky.ejDotWebDotAll.ej.TableModel
  ] = js.native
  ...
  var UrlAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.UrlAdaptor] = js.native
  val WaitingPopup: TypeofClassWaitingPopup = js.native
  var WebApiAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.WebApiAdaptor] = js.native
  var WebMethodAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.WebMethodAdaptor] = js.native
  var Widget: TypeofClassWidget = js.native
  var WidgetBase: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.WidgetBase] = js.native
  val cssUA: String = js.native
  val cultures: culture = js.native
  val dataUtil: typingsSlinky.ejDotWebDotAll.ej.dataUtil = js.native
  val datavisualization: Typeofdatavisualization = js.native
  val device: Typeofdevice = js.native
  val globalize: typingsSlinky.ejDotWebDotAll.ej.globalize = js.native
  var remoteSaveAdaptor: Instantiable0[typingsSlinky.ejDotWebDotAll.ej.remoteSaveAdaptor] = js.native
