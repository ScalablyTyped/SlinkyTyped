...
trait PartialColumn extends js.Object {
  ...
  var equivalentTo: js.UndefOr[js.Function1[/* other */ typingsSlinky.exceljs.mod.Column, Boolean]] = js.native
...
object PartialColumn {
  ...
  implicit class PartialColumnOps[Self <: PartialColumn] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEquivalentTo(value: /* other */ typingsSlinky.exceljs.mod.Column => Boolean): Self = this.set("equivalentTo", js.Any.fromFunction1(value))
    @scala.inline
