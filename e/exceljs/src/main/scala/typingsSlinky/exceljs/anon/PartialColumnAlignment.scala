...
trait PartialColumnAlignment extends js.Object {
  ...
  var equivalentTo: js.UndefOr[js.Function1[/* other */ typingsSlinky.exceljs.mod.Column, Boolean]] = js.undefined
...
object PartialColumnAlignment {
  ...
  def apply(
    ...
    equivalentTo: /* other */ typingsSlinky.exceljs.mod.Column => Boolean = null,
    fill: Fill = null,
