...
import typingsSlinky.exceljs.mod.Worksheet
...
trait PartialColumn extends js.Object {
  ...
  @JSName("toString")
  var toString_FPartialColumn: js.UndefOr[js.Function0[String]] = js.native
  var values: js.UndefOr[js.Array[CellValue]] = js.native
  var width: js.UndefOr[Double] = js.native
  var worksheet: js.UndefOr[Worksheet] = js.native
}

object PartialColumn {
  @scala.inline
  def apply(): PartialColumn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialColumn]
  }
  @scala.inline
  implicit class PartialColumnOps[Self <: PartialColumn] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withWorksheet(value: Worksheet): Self = {
        val ret = this.duplicate
