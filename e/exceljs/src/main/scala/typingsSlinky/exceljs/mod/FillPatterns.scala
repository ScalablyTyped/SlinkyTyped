...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.exceljs.exceljsStrings.none_
  - typingsSlinky.exceljs.exceljsStrings.solid
  - typingsSlinky.exceljs.exceljsStrings.darkVertical
  - typingsSlinky.exceljs.exceljsStrings.darkHorizontal
  - typingsSlinky.exceljs.exceljsStrings.darkGrid
  - typingsSlinky.exceljs.exceljsStrings.darkTrellis
  - typingsSlinky.exceljs.exceljsStrings.darkDown
  - typingsSlinky.exceljs.exceljsStrings.darkUp
  - typingsSlinky.exceljs.exceljsStrings.lightVertical
  - typingsSlinky.exceljs.exceljsStrings.lightHorizontal
  - typingsSlinky.exceljs.exceljsStrings.lightGrid
  - typingsSlinky.exceljs.exceljsStrings.lightTrellis
  - typingsSlinky.exceljs.exceljsStrings.lightDown
  - typingsSlinky.exceljs.exceljsStrings.lightUp
  - typingsSlinky.exceljs.exceljsStrings.darkGray
  - typingsSlinky.exceljs.exceljsStrings.mediumGray
  - typingsSlinky.exceljs.exceljsStrings.lightGray
  - typingsSlinky.exceljs.exceljsStrings.gray125
  - typingsSlinky.exceljs.exceljsStrings.gray0625
*/
