...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.exceljs.exceljsStrings.notBetween
  - typingsSlinky.exceljs.exceljsStrings.equal
  - typingsSlinky.exceljs.exceljsStrings.notEqual
  - typingsSlinky.exceljs.exceljsStrings.greaterThan
  - typingsSlinky.exceljs.exceljsStrings.lessThan
  - typingsSlinky.exceljs.exceljsStrings.greaterThanOrEqual
  - typingsSlinky.exceljs.exceljsStrings.lessThanOrEqual
*/
