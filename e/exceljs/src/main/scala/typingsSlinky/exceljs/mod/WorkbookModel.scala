...
object WorkbookModel {
  ...
  implicit class WorkbookModelMutableBuilder[Self <: WorkbookModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastPrinted(value: js.Date): Self = StObject.set(x, "lastPrinted", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModified(value: js.Date): Self = StObject.set(x, "modified", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProperties(value: WorkbookProperties): Self = StObject.set(x, "properties", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRevision(value: js.Date): Self = StObject.set(x, "revision", value.asInstanceOf[js.Any])
