...
object WorkbookModel {
  ...
  implicit class WorkbookModelOps[Self <: WorkbookModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreated(value: js.Date): Self = this.set("created", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastPrinted(value: js.Date): Self = this.set("lastPrinted", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setModified(value: js.Date): Self = this.set("modified", value.asInstanceOf[js.Any])
    @scala.inline
    def setProperties(value: WorkbookProperties): Self = this.set("properties", value.asInstanceOf[js.Any])
    @scala.inline
    def setRevision(value: js.Date): Self = this.set("revision", value.asInstanceOf[js.Any])
    @scala.inline
