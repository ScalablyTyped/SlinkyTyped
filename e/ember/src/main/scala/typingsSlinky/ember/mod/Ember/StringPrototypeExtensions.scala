...
trait StringPrototypeExtensions extends StObject {
  ...
  def loc(values: typingsSlinky.ember.mod.Ember.Array[java.lang.String]): java.lang.String = js.native
  
  def underscore(): java.lang.String = js.native
  
  def w(): typingsSlinky.ember.mod.Ember.Array[java.lang.String] = js.native
}
