...
object ENV {
  ...
  object EXTEND_PROTOTYPES {
    ...
    @JSImport("ember", "Ember.ENV.EXTEND_PROTOTYPES")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ember", "Ember.ENV.EXTEND_PROTOTYPES.Array")
    @js.native
    def Array: Boolean = js.native
    @scala.inline
    def Array_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Array")(x.asInstanceOf[js.Any])
    
    @JSImport("ember", "Ember.ENV.EXTEND_PROTOTYPES.Function")
    @js.native
    ...
    @JSImport("ember", "Ember.ENV.EXTEND_PROTOTYPES.String")
    @js.native
  ...
  @JSImport("ember", "Ember.ENV.LOG_BINDINGS")
  @js.native
  val LOG_BINDINGS: Boolean = js.native
  
  @JSImport("ember", "Ember.ENV.LOG_STACKTRACE_ON_DEPRECATION")
  @js.native
  val LOG_STACKTRACE_ON_DEPRECATION: Boolean = js.native
  
  @JSImport("ember", "Ember.ENV.LOG_VERSION")
  @js.native
  val LOG_VERSION: Boolean = js.native
  
  @JSImport("ember", "Ember.ENV.MODEL_FACTORY_INJECTIONS")
  @js.native
  val MODEL_FACTORY_INJECTIONS: Boolean = js.native
  
  @JSImport("ember", "Ember.ENV.RAISE_ON_DEPRECATION")
  @js.native
