...
object Handlebars extends js.Object {
  @js.native
  class Compiler ()
    extends typingsSlinky.ember.mod.Ember.Handlebars.Compiler
  
  @js.native
  class JavaScriptCompiler ()
    extends typingsSlinky.ember.mod.Ember.Handlebars.JavaScriptCompiler
  
  @js.native
  class SafeString ()
    extends typingsSlinky.emberTemplate.handlebarsMod.SafeString
