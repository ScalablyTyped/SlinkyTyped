...
object Test {
  ...
  @js.native
  class Adapter_ ()
    extends typingsSlinky.ember.mod.Ember.Test.Adapter_
  
  @JSImport("ember", "default.Test.Promise")
  @js.native
  class Promise_[T] protected ()
    extends typingsSlinky.ember.mod.Ember.Test.Promise_[T] {
  ...
  @js.native
  class QUnitAdapter ()
    extends typingsSlinky.ember.mod.Ember.Test.QUnitAdapter
  ...
  @JSImport("ember", "default.Test.adapter")
  @js.native
  val adapter: typingsSlinky.emberTest.adapterMod.default = js.native
  ...
  @js.native
  def onInjectHelpers(callback: js.Function1[/* app */ typingsSlinky.ember.mod.Ember.Application, Unit]): Unit = js.native
  ...
  ): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
  @JSImport("ember", "default.Test.promise")
  @js.native
  def promise[T](
    resolver: js.Function2[
  ...
  def registerAsyncHelper(
    ...
    helperMethod: js.Function2[/* app */ typingsSlinky.emberApplication.mod.default, /* repeated */ js.Any, _]
  ): Unit = js.native
  ...
  @js.native
  def resolve[T](): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
  @JSImport("ember", "default.Test.resolve")
  @js.native
  def resolve[T](value: T): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
  @JSImport("ember", "default.Test.resolve")
  @js.native
  def resolve[T](value: T, label: java.lang.String): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
  @JSImport("ember", "default.Test.resolve")
  @js.native
  def resolve[T](value: js.UndefOr[scala.Nothing], label: java.lang.String): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
  @JSImport("ember", "default.Test.resolve")
  @js.native
  def resolve[T](value: js.Thenable[T]): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
  @JSImport("ember", "default.Test.resolve")
  @js.native
  def resolve[T](value: js.Thenable[T], label: java.lang.String): typingsSlinky.ember.mod.Ember.Test.Promise_[T] = js.native
