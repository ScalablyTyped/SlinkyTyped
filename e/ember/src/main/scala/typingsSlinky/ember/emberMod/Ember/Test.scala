...
object Test extends js.Object {
  @js.native
  class Adapter ()
    extends typingsSlinky.atEmberTest.adapterMod.Adapter {
    /**
  ...
  class Promise[T] protected ()
    extends typingsSlinky.rsvp.rsvpMod.default.Promise[T] {
  ...
  val registerAsyncHelper: js.Function2[
    ...
    /* helperMethod */ js.Function2[
      /* app */ typingsSlinky.atEmberApplication.atEmberApplicationMod.default, 
      /* repeated */ js.Any, 
      js.Any
    ], 
    Unit
