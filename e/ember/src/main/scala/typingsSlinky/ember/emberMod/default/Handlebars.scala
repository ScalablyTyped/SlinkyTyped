...
object Handlebars extends js.Object {
  @js.native
  class Compiler ()
    extends typingsSlinky.ember.emberMod.Ember.Handlebars.Compiler
  
  @js.native
  class JavaScriptCompiler ()
    extends typingsSlinky.ember.emberMod.Ember.Handlebars.JavaScriptCompiler
  
  @js.native
  class SafeString ()
    extends typingsSlinky.atEmberTemplate.dashPrivateHandlebarsMod.SafeString
