...
trait LocationData extends js.Object {
  var coords: typingsSlinky.expoLocation.anon.Accuracy
...
object LocationData {
  ...
  implicit class LocationDataOps[Self <: LocationData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoords(value: typingsSlinky.expoLocation.anon.Accuracy): Self = this.set("coords", value.asInstanceOf[js.Any])
    @scala.inline
