...
object DataCenterName {
  @scala.inline
  def Amazon: typingsSlinky.eurekaDashJsDashClient.eurekaDashJsDashClientStrings.Amazon = this.cast("Amazon")
  @scala.inline
  def MyOwn: typingsSlinky.eurekaDashJsDashClient.eurekaDashJsDashClientStrings.MyOwn = this.cast("MyOwn")
  @scala.inline
  def Netflix: typingsSlinky.eurekaDashJsDashClient.eurekaDashJsDashClientStrings.Netflix = this.cast("Netflix")
  @scala.inline
