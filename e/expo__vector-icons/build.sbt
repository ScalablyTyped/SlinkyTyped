...
version := "9.0-dt-20190213Z-2b6b43"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-native" % "0.60-dt-20191028Z-da99e7",
  "org.scalablytyped.slinky" %%% "react-native-vector-icons" % "6.4-dt-20190930Z-2273ce",
