...
abstract class SharedApply_typingsSlinkyreactDashNativeDashVectorDashIconsiconModIconButtonProps_562613305[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
