...
object mod {
  ...
  object AntDesign extends Shortcut {
    ...
    @JSImport("@expo/vector-icons", "AntDesign")
    @js.native
    val ^ : Icon[String, anticon] = js.native
  ...
  object FontAwesome extends Shortcut {
    ...
    @JSImport("@expo/vector-icons", "FontAwesome")
    @js.native
    val ^ : Icon[String, typingsSlinky.expoVectorIcons.expoVectorIconsStrings.FontAwesome] = js.native
    ...
    type _To = Icon[String, typingsSlinky.expoVectorIcons.expoVectorIconsStrings.FontAwesome]
    
    /* This means you don't have to write `^`, but can instead just say `FontAwesome.foo` */
    override def _to: Icon[String, typingsSlinky.expoVectorIcons.expoVectorIconsStrings.FontAwesome] = ^
  }
  
  @JSImport("@expo/vector-icons", "FontAwesome5")
  @js.native
  ...
  object Fontisto extends Shortcut {
    ...
    @JSImport("@expo/vector-icons", "Fontisto")
    @js.native
    val ^ : Icon[String, typingsSlinky.expoVectorIcons.expoVectorIconsStrings.Fontisto] = js.native
    ...
    type _To = Icon[String, typingsSlinky.expoVectorIcons.expoVectorIconsStrings.Fontisto]
    
    /* This means you don't have to write `^`, but can instead just say `Fontisto.foo` */
    override def _to: Icon[String, typingsSlinky.expoVectorIcons.expoVectorIconsStrings.Fontisto] = ^
  }
  ...
  object Octicons extends Shortcut {
    ...
    @JSImport("@expo/vector-icons", "Octicons")
    @js.native
    val ^ : Icon[String, octicons] = js.native
