...
- typingsSlinky.reactNative.mod.TouchableHighlightProps because var conflicts: accessibilityActions, accessibilityComponentType, accessibilityElementsHidden, accessibilityHint, accessibilityIgnoresInvertColors, accessibilityLabel, accessibilityLiveRegion, accessibilityRole, accessibilityState, accessibilityTraits, accessibilityValue, accessibilityViewIsModal, accessible, hasTVPreferredFocus, hitSlop, importantForAccessibility, onAccessibilityAction, onAccessibilityEscape, onAccessibilityTap, onLayout, onMagicTap, style, testID, tvParallaxProperties. Inlined activeOpacity, onHideUnderlay, onShowUnderlay, underlayColor */ @js.native
...
object IconButtonProps {
  @scala.inline
  def apply[/* <: java.lang.String */ GLYPHS](name: GLYPHS): IconButtonProps[GLYPHS] = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[IconButtonProps[GLYPHS]]
  }
  @scala.inline
  implicit class IconButtonPropsOps[Self <: IconButtonProps[_], /* <: java.lang.String */ GLYPHS] (val x: Self with IconButtonProps[GLYPHS]) extends AnyVal {
    @scala.inline
