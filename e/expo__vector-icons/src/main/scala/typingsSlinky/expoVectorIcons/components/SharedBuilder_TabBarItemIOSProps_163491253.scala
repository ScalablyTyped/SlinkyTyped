...
@scala.inline
class SharedBuilder_TabBarItemIOSProps_163491253[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def icon(value: ImageURISource): this.type = set("icon", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def selectedIcon(value: ImageURISource): this.type = set("selectedIcon", value.asInstanceOf[js.Any])
  @scala.inline
  def selectedIconColor(value: String): this.type = set("selectedIconColor", value.asInstanceOf[js.Any])
  @scala.inline
  def selectedIconName(value: String): this.type = set("selectedIconName", value.asInstanceOf[js.Any])
  @scala.inline
