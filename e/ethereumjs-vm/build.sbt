...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ethereumjs-account" % "3.0.0-0a2191",
  "org.scalablytyped.slinky" %%% "ethereumjs-blockchain" % "4.0.4-945fc8",
  "org.scalablytyped.slinky" %%% "ethereumjs-common" % "1.5.2-9cabe0",
  "org.scalablytyped.slinky" %%% "ethereumjs-tx" % "2.1.2-88e7f5",
