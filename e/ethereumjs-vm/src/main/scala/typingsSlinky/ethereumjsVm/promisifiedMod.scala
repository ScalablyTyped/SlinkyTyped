...
import typingsSlinky.ethereumjsVm.stateManagerMod.StorageDump
...
object promisifiedMod {
  ...
  class default protected () extends PStateManager {
    def this(wrapped: typingsSlinky.ethereumjsVm.stateManagerMod.default) = this()
  }
  
  @js.native
  trait PStateManager extends StObject {
    
    var _wrapped: typingsSlinky.ethereumjsVm.stateManagerMod.default = js.native
    ...
    def getAccount(addr: Buffer): js.Promise[typingsSlinky.ethereumjsAccount.mod.default] = js.native
    ...
    def putAccount(addr: Buffer, account: typingsSlinky.ethereumjsAccount.mod.default): js.Promise[Unit] = js.native
  ...
  object PStateManager {
    ...
    @scala.inline
    def apply(
      _wrapped: typingsSlinky.ethereumjsVm.stateManagerMod.default,
      ...
      getAccount: Buffer => js.Promise[typingsSlinky.ethereumjsAccount.mod.default],
      ...
      putAccount: (Buffer, typingsSlinky.ethereumjsAccount.mod.default) => js.Promise[Unit],
    ...
    implicit class PStateManagerMutableBuilder[Self <: PStateManager] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetAccount(value: Buffer => js.Promise[typingsSlinky.ethereumjsAccount.mod.default]): Self = StObject.set(x, "getAccount", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setPutAccount(value: (Buffer, typingsSlinky.ethereumjsAccount.mod.default) => js.Promise[Unit]): Self = StObject.set(x, "putAccount", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def set_wrapped(value: typingsSlinky.ethereumjsVm.stateManagerMod.default): Self = StObject.set(x, "_wrapped", value.asInstanceOf[js.Any])
    }
  }
}
