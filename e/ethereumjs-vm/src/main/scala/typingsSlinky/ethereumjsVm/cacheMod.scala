...
object cacheMod {
  ...
  trait Cache extends StObject {
    ...
    def _update(
      key: Buffer,
      `val`: typingsSlinky.ethereumjsAccount.mod.default,
      modified: Boolean,
      deleted: Boolean
    ): Unit = js.native
    ...
    /**
      ...
      */
    def get(key: Buffer): typingsSlinky.ethereumjsAccount.mod.default = js.native
    ...
    /**
      ...
      * @param key - Address of account
      */
    def lookup(key: Buffer): js.UndefOr[typingsSlinky.ethereumjsAccount.mod.default] = js.native
    ...
    /**
      ...
      * @param val - Account
      */
    def put(key: Buffer, `val`: typingsSlinky.ethereumjsAccount.mod.default): Unit = js.native
    def put(key: Buffer, `val`: typingsSlinky.ethereumjsAccount.mod.default, fromTrie: Boolean): Unit = js.native
