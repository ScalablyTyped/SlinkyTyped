...
import typingsSlinky.ethereumjsVm.exceptionsMod.VmError
import typingsSlinky.ethereumjsVm.opFnsMod.OpHandler
import typingsSlinky.ethereumjsVm.opcodesMod.Opcode
...
object interpreterMod {
  ...
  class default protected () extends Interpreter {
    def this(vm: js.Any, eei: typingsSlinky.ethereumjsVm.eeiMod.default) = this()
  }
  
  @js.native
  trait Interpreter extends StObject {
    
    var _eei: typingsSlinky.ethereumjsVm.eeiMod.default = js.native
  ...
  trait InterpreterStep extends StObject {
    ...
    var account: typingsSlinky.ethereumjsAccount.mod.default = js.native
  ...
  object InterpreterStep {
    ...
    implicit class InterpreterStepMutableBuilder[Self <: InterpreterStep] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccount(value: typingsSlinky.ethereumjsAccount.mod.default): Self = StObject.set(x, "account", value.asInstanceOf[js.Any])
  ...
  object RunState {
    ...
    implicit class RunStateMutableBuilder[Self <: RunState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEei(value: typingsSlinky.ethereumjsVm.eeiMod.default): Self = StObject.set(x, "eei", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHighestMemCost(value: ^): Self = StObject.set(x, "highestMemCost", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMemory(value: typingsSlinky.ethereumjsVm.memoryMod.default): Self = StObject.set(x, "memory", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStack(value: typingsSlinky.ethereumjsVm.stackMod.default): Self = StObject.set(x, "stack", value.asInstanceOf[js.Any])
