...
import typingsSlinky.ethereumjsVm.opcodesMod.OpcodeList
import typingsSlinky.ethereumjsVm.runBlockMod.RunBlockOpts
import typingsSlinky.ethereumjsVm.runBlockMod.RunBlockResult
import typingsSlinky.ethereumjsVm.runCallMod.RunCallOpts
import typingsSlinky.ethereumjsVm.runCodeMod.RunCodeOpts
import typingsSlinky.ethereumjsVm.runTxMod.RunTxOpts
...
object mod {
  ...
  trait VM extends StObject {
    ...
    var blockchain: typingsSlinky.ethereumjsBlockchain.mod.default = js.native
    ...
    val pStateManager: typingsSlinky.ethereumjsVm.promisifiedMod.default = js.native
  ...
  object VM {
    ...
    def apply(
      ...
      blockchain: typingsSlinky.ethereumjsBlockchain.mod.default,
      copy: () => VM,
      opts: VMOpts,
      pStateManager: typingsSlinky.ethereumjsVm.promisifiedMod.default,
    ...
    implicit class VMMutableBuilder[Self <: VM] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBlockchain(value: typingsSlinky.ethereumjsBlockchain.mod.default): Self = StObject.set(x, "blockchain", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPStateManager(value: typingsSlinky.ethereumjsVm.promisifiedMod.default): Self = StObject.set(x, "pStateManager", value.asInstanceOf[js.Any])
  ...
  trait VMOpts extends StObject {
    ...
    /**
      ...
      */
    var blockchain: js.UndefOr[typingsSlinky.ethereumjsBlockchain.mod.default] = js.native
