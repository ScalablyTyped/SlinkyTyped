...
trait RunTxResult extends EVMResult {
  ...
  /**
    ...
    */
  var bloom: typingsSlinky.ethereumjsVm.bloomMod.default = js.native
...
object RunTxResult {
  ...
  def apply(
    amountSpent: ^,
    bloom: typingsSlinky.ethereumjsVm.bloomMod.default,
  ...
  implicit class RunTxResultOps[Self <: RunTxResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBloom(value: typingsSlinky.ethereumjsVm.bloomMod.default): Self = this.set("bloom", value.asInstanceOf[js.Any])
