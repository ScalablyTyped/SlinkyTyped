...
object StateManager {
  ...
  @scala.inline
  implicit class StateManagerOps[Self <: StateManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_cache(value: typingsSlinky.ethereumjsVm.cacheMod.default): Self = this.set("_cache", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_checkpointCount(value: Double): Self = this.set("_checkpointCount", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_clearOriginalStorageCache(value: () => Unit): Self = this.set("_clearOriginalStorageCache", js.Any.fromFunction0(value))
    
    @scala.inline
    def set_common(value: typingsSlinky.ethereumjsCommon.mod.default): Self = this.set("_common", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_getStorageTrie(value: (Buffer, js.Any) => Unit): Self = this.set("_getStorageTrie", js.Any.fromFunction2(value))
    
    @scala.inline
    def set_lookupStorageTrie(value: (Buffer, js.Any) => Unit): Self = this.set("_lookupStorageTrie", js.Any.fromFunction2(value))
    
    @scala.inline
    def set_modifyContractStorage(value: (Buffer, js.Any, js.Any) => Unit): Self = this.set("_modifyContractStorage", js.Any.fromFunction3(value))
    
    @scala.inline
    def set_originalStorageCache(value: Map[String, Map[String, Buffer]]): Self = this.set("_originalStorageCache", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_storageTries(value: js.Any): Self = this.set("_storageTries", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_touched(value: Set[String]): Self = this.set("_touched", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_touchedStackVarargs(value: Set[String]*): Self = this.set("_touchedStack", js.Array(value :_*))
    
    @scala.inline
    def set_touchedStack(value: js.Array[Set[String]]): Self = this.set("_touchedStack", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_trie(value: js.Any): Self = this.set("_trie", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAccountIsEmpty(value: (Buffer, js.Any) => Unit): Self = this.set("accountIsEmpty", js.Any.fromFunction2(value))
    
    @scala.inline
    def setCheckpoint(value: js.Any => Unit): Self = this.set("checkpoint", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCleanupTouchedAccounts(value: js.Any => Unit): Self = this.set("cleanupTouchedAccounts", js.Any.fromFunction1(value))
    
    @scala.inline
    def setClearContractStorage(value: (Buffer, js.Any) => Unit): Self = this.set("clearContractStorage", js.Any.fromFunction2(value))
    
    @scala.inline
    def setCommit(value: js.Any => Unit): Self = this.set("commit", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCopy(value: () => StateManager): Self = this.set("copy", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDumpStorage(value: (Buffer, js.Any) => Unit): Self = this.set("dumpStorage", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGenerateCanonicalGenesis(value: js.Any => Unit): Self = this.set("generateCanonicalGenesis", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGenerateGenesis(value: (js.Any, js.Any) => js.Any): Self = this.set("generateGenesis", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGetAccount(value: (Buffer, js.Any) => Unit): Self = this.set("getAccount", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGetContractCode(value: (Buffer, js.Any) => Unit): Self = this.set("getContractCode", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGetContractStorage(value: (Buffer, Buffer, js.Any) => Unit): Self = this.set("getContractStorage", js.Any.fromFunction3(value))
    
    @scala.inline
    def setGetOriginalContractStorage(value: (Buffer, Buffer, js.Any) => Unit): Self = this.set("getOriginalContractStorage", js.Any.fromFunction3(value))
    
    @scala.inline
    def setGetStateRoot(value: js.Any => Unit): Self = this.set("getStateRoot", js.Any.fromFunction1(value))
    
    @scala.inline
    def setHasGenesisState(value: js.Any => Unit): Self = this.set("hasGenesisState", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPutAccount(value: (Buffer, typingsSlinky.ethereumjsAccount.mod.default, js.Any) => Unit): Self = this.set("putAccount", js.Any.fromFunction3(value))
    
    @scala.inline
    def setPutContractCode(value: (Buffer, Buffer, js.Any) => Unit): Self = this.set("putContractCode", js.Any.fromFunction3(value))
    
    @scala.inline
    def setPutContractStorage(value: (Buffer, Buffer, Buffer, js.Any) => Unit): Self = this.set("putContractStorage", js.Any.fromFunction4(value))
    
    @scala.inline
    def setRevert(value: js.Any => Unit): Self = this.set("revert", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetStateRoot(value: (Buffer, js.Any) => Unit): Self = this.set("setStateRoot", js.Any.fromFunction2(value))
    
    @scala.inline
    def setTouchAccount(value: Buffer => Unit): Self = this.set("touchAccount", js.Any.fromFunction1(value))
  }
}
