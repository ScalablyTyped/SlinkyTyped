package typingsSlinky.ethereumjsVm.stateManagerMod
...
object StateManagerOpts {
  ...
  implicit class StateManagerOptsOps[Self <: StateManagerOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: typingsSlinky.ethereumjsCommon.mod.default): Self = this.set("common", value.asInstanceOf[js.Any])
