package typingsSlinky.ethereumjsVm.promisifiedMod
...
object PStateManager {
  ...
  implicit class PStateManagerOps[Self <: PStateManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_wrapped(value: typingsSlinky.ethereumjsVm.stateManagerMod.default): Self = this.set("_wrapped", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetAccount(value: Buffer => js.Promise[typingsSlinky.ethereumjsAccount.mod.default]): Self = this.set("getAccount", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPutAccount(value: (Buffer, typingsSlinky.ethereumjsAccount.mod.default) => js.Promise[Unit]): Self = this.set("putAccount", js.Any.fromFunction2(value))
