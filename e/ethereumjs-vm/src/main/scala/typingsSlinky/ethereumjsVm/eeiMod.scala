...
object eeiMod {
  ...
  class default protected () extends EEI {
    def this(
      env: Env,
      state: typingsSlinky.ethereumjsVm.promisifiedMod.default,
      evm: typingsSlinky.ethereumjsVm.evmMod.default,
      common: typingsSlinky.ethereumjsCommon.mod.default,
      gasLeft: ^
    ) = this()
  }
  ...
  trait Env extends StObject {
    ...
    var contract: typingsSlinky.ethereumjsAccount.mod.default = js.native
  ...
  object Env {
    ...
    def apply(
      ...
      code: Buffer,
      codeAddress: Buffer,
      contract: typingsSlinky.ethereumjsAccount.mod.default,
      depth: Double,
      gasPrice: Buffer,
      isStatic: Boolean,
      origin: Buffer
    ...
    implicit class EnvMutableBuilder[Self <: Env] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContract(value: typingsSlinky.ethereumjsAccount.mod.default): Self = StObject.set(x, "contract", value.asInstanceOf[js.Any])
