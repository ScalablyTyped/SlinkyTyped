package typingsSlinky.ethereumjsVm.eeiMod
...
trait EEI extends js.Object {
  ...
  def _baseCall(msg: typingsSlinky.ethereumjsVm.messageMod.default): js.Promise[^] = js.native
  
  var _common: typingsSlinky.ethereumjsCommon.mod.default = js.native
  
  var _env: Env = js.native
  
  var _evm: typingsSlinky.ethereumjsVm.evmMod.default = js.native
