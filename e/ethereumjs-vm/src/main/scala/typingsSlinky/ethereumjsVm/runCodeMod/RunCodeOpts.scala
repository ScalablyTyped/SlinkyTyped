...
trait RunCodeOpts extends js.Object {
  ...
  var evm: js.UndefOr[typingsSlinky.ethereumjsVm.evmMod.default] = js.native
...
object RunCodeOpts {
  ...
  implicit class RunCodeOptsOps[Self <: RunCodeOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvm(value: typingsSlinky.ethereumjsVm.evmMod.default): Self = this.set("evm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMessage(value: typingsSlinky.ethereumjsVm.messageMod.default): Self = this.set("message", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTxContext(value: typingsSlinky.ethereumjsVm.txContextMod.default): Self = this.set("txContext", value.asInstanceOf[js.Any])
