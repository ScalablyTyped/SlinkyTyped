...
object ServerOptions {
  ...
  implicit class ServerOptionsOps[Self <: ServerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialPacketArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("initialPacket", value.asInstanceOf[js.Any])
    @scala.inline
    def setInitialPacketArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("initialPacket", value.asInstanceOf[js.Any])
    @scala.inline
