...
object mod {
  ...
  @JSImport("engine.io", JSImport.Namespace)
  @js.native
  def apply(httpServer: typingsSlinky.node.netMod.Server): Server = js.native
  @JSImport("engine.io", JSImport.Namespace)
  @js.native
  def apply(httpServer: typingsSlinky.node.netMod.Server, opts: ServerOptions): Server = js.native
  ...
  @js.native
  def attach(http: typingsSlinky.node.netMod.Server): Server = js.native
  @JSImport("engine.io", "attach")
  @js.native
  def attach(http: typingsSlinky.node.netMod.Server, opts: ServerAttachOptions): Server = js.native
  ...
  type Message = String | Buffer | js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView
  ...
  object ServerOptions {
    ...
    implicit class ServerOptionsMutableBuilder[Self <: ServerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInitialPacketArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "initialPacket", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInitialPacketArrayBufferView(value: js.typedarray.ArrayBufferView): Self = StObject.set(x, "initialPacket", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object Transport {
    ...
    @scala.inline
    def polling: typingsSlinky.engineIo.engineIoStrings.polling = "polling".asInstanceOf[typingsSlinky.engineIo.engineIoStrings.polling]
    
    @scala.inline
    def websocket: typingsSlinky.engineIo.engineIoStrings.websocket = "websocket".asInstanceOf[typingsSlinky.engineIo.engineIoStrings.websocket]
  }
}
