...
import typingsSlinky.emberDebug.dataAdapterMod.DataAdapter.WrappedRecord
import typingsSlinky.emberDebug.dataAdapterMod.DataAdapter.WrappedType
...
object dataAdapterMod {
  ...
  trait DataAdapter
    ...
    /**
      ...
      * to list all models.
      */
    var containerDebugAdapter: typingsSlinky.emberDebug.containerDebugAdapterMod.default = js.native
