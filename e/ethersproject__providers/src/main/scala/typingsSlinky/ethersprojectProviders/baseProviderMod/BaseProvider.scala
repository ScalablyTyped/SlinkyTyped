package typingsSlinky.ethersprojectProviders.baseProviderMod
...
import typingsSlinky.ethersprojectAbstractProvider.mod.BlockWithTransactions
import typingsSlinky.ethersprojectAbstractProvider.mod.EventType
import typingsSlinky.ethersprojectAbstractProvider.mod.Filter
import typingsSlinky.ethersprojectAbstractProvider.mod.FilterByBlockHash
import typingsSlinky.ethersprojectAbstractProvider.mod.Listener
import typingsSlinky.ethersprojectAbstractProvider.mod.Log
...
import typingsSlinky.ethersprojectProviders.anon.BlockNumber
import typingsSlinky.ethersprojectProviders.anon.DeferrableTransactionRequ
import typingsSlinky.ethersprojectProviders.ethersprojectProvidersStrings.pending
