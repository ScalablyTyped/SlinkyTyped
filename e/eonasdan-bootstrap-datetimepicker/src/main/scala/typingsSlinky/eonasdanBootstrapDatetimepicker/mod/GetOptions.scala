...
object GetOptions {
  ...
  implicit class GetOptionsOps[Self <: GetOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDisabledDates(value: IndexedDates | Boolean): Self = {
    ...
    @scala.inline
    def withDisabledHours(value: IndexedHours | Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEnabledDates(value: IndexedDates | Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEnabledHours(value: IndexedHours | Boolean): Self = {
        val ret = this.duplicate
