...
object GetOptions {
  ...
  def apply(
    ...
    disabledDates: IndexedDates | Boolean = null,
    disabledHours: IndexedHours | Boolean = null,
    disabledTimeIntervals: Boolean | js.Array[FromTo] = null,
    enabledDates: IndexedDates | Boolean = null,
    enabledHours: IndexedHours | Boolean = null,
