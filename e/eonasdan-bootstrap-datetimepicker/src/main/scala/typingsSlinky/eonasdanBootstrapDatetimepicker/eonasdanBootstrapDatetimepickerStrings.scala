...
import typingsSlinky.eonasdanBootstrapDatetimepicker.mod.ToolbarPlacement
import typingsSlinky.eonasdanBootstrapDatetimepicker.mod.UseCurrent
import typingsSlinky.eonasdanBootstrapDatetimepicker.mod.ViewMode
