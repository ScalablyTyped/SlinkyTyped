...
object ExpressBusboyOptions {
  ...
  implicit class ExpressBusboyOptionsOps[Self <: ExpressBusboyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowedPathRegExp(value: js.RegExp): Self = this.set("allowedPath", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAllowedPath(value: String | js.RegExp | (js.Function1[/* url */ String, Boolean])): Self = this.set("allowedPath", value.asInstanceOf[js.Any])
