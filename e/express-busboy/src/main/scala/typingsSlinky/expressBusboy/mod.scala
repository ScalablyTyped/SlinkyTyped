...
object mod {
  ...
  object ExpressBusboyOptions {
    ...
    implicit class ExpressBusboyOptionsMutableBuilder[Self <: ExpressBusboyOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAllowedPath(value: String | js.RegExp | (js.Function1[/* url */ String, Boolean])): Self = StObject.set(x, "allowedPath", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowedPathFunction1(value: /* url */ String => Boolean): Self = StObject.set(x, "allowedPath", js.Any.fromFunction1(value))
      
      @scala.inline
      def setAllowedPathRegExp(value: js.RegExp): Self = StObject.set(x, "allowedPath", value.asInstanceOf[js.Any])
