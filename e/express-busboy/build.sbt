...
name := "express-busboy"
version := "6.0-dt-20190819Z-e7035f"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "busboy" % "v0.2.13-dt-20200226Z-ed2116",
  "org.scalablytyped.slinky" %%% "connect" % "v3.4.0-dt-20200226Z-196a23",
  "org.scalablytyped.slinky" %%% "connect-busboy" % "0.0-dt-20190819Z-68feba",
