...
name := "express-busboy"
version := "6.0-dt-20200515Z-2ea87d"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "busboy" % "v0.2.13-dt-20200515Z-81c16f",
  "org.scalablytyped.slinky" %%% "connect" % "v3.4.0-dt-20200515Z-49be3e",
  "org.scalablytyped.slinky" %%% "connect-busboy" % "0.0-dt-20200515Z-800d25",
