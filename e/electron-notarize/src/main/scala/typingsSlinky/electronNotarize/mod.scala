...
object mod {
  ...
  */
  ...
  object NotarizeCredentials {
    ...
    @scala.inline
    def NotarizeApiKeyCredentials(appleApiIssuer: String, appleApiKey: String): typingsSlinky.electronNotarize.mod.NotarizeApiKeyCredentials = {
      val __obj = js.Dynamic.literal(appleApiIssuer = appleApiIssuer.asInstanceOf[js.Any], appleApiKey = appleApiKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.electronNotarize.mod.NotarizeApiKeyCredentials]
    }
    
    @scala.inline
    def NotarizePasswordCredentials(appleId: String, appleIdPassword: String): typingsSlinky.electronNotarize.mod.NotarizePasswordCredentials = {
      val __obj = js.Dynamic.literal(appleId = appleId.asInstanceOf[js.Any], appleIdPassword = appleIdPassword.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.electronNotarize.mod.NotarizePasswordCredentials]
    }
  }
