...
import typingsSlinky.electronNotarize.electronNotarizeNumbers.`0`
import typingsSlinky.electronNotarize.electronNotarizeNumbers.`2`
import typingsSlinky.electronNotarize.electronNotarizeStrings.`in progress`
import typingsSlinky.electronNotarize.electronNotarizeStrings.invalid
import typingsSlinky.electronNotarize.electronNotarizeStrings.success
...
object helpersMod {
  ...
  object NotarizationInfo {
    ...
    @scala.inline
    def apply(date: js.Date, status: invalid | (`in progress`) | success, uuid: String): NotarizationInfo = {
