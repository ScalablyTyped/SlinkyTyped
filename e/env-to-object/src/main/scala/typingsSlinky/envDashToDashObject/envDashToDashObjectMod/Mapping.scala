package typingsSlinky.envDashToDashObject.envDashToDashObjectMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.envDashToDashObject.envDashToDashObjectStrings.boolean
import typingsSlinky.envDashToDashObject.envDashToDashObjectStrings.integer
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Rewritten from type alias, can be one of: 
  - typings.envDashToDashObject.envDashToDashObjectMod.IntegerMapping
  - typings.envDashToDashObject.envDashToDashObjectMod.BooleanMapping
  - typings.envDashToDashObject.envDashToDashObjectMod.GenericMapping
*/
