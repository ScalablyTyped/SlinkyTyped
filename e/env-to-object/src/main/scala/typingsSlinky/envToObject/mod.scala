...
object mod {
  ...
  */
  ...
  object Mapping {
    ...
    @scala.inline
    def BooleanMapping(strict: Boolean, `type`: boolean): typingsSlinky.envToObject.mod.BooleanMapping = {
      val __obj = js.Dynamic.literal(strict = strict.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.envToObject.mod.BooleanMapping]
    }
    
    @scala.inline
    def GenericMapping(keypath: String): typingsSlinky.envToObject.mod.GenericMapping = {
      val __obj = js.Dynamic.literal(keypath = keypath.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.envToObject.mod.GenericMapping]
    }
    
    @scala.inline
    def IntegerMapping(keypath: String, radix: Double, `type`: integer): typingsSlinky.envToObject.mod.IntegerMapping = {
      val __obj = js.Dynamic.literal(keypath = keypath.asInstanceOf[js.Any], radix = radix.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.envToObject.mod.IntegerMapping]
    }
  }
