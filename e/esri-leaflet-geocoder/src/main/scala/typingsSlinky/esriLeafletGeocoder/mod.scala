...
object mod {
  ...
  object esri {
    ...
    object Geocoding {
      ...
      @JSImport("leaflet", "esri.Geocoding.geosearch")
      @js.native
      def geosearch(): typingsSlinky.esriLeafletGeocoder.mod.esri.Geocoding.Geosearch_ = js.native
      @JSImport("leaflet", "esri.Geocoding.geosearch")
      @js.native
      def geosearch(options: GeosearchObject): typingsSlinky.esriLeafletGeocoder.mod.esri.Geocoding.Geosearch_ = js.native
