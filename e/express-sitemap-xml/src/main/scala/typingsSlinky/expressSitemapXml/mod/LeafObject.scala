...
object LeafObject {
  ...
  implicit class LeafObjectOps[Self <: LeafObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastModDate(value: js.Date): Self = this.set("lastMod", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastMod(value: String | js.Date): Self = this.set("lastMod", value.asInstanceOf[js.Any])
