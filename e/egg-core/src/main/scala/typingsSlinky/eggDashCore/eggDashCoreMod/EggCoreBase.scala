...
import typingsSlinky.depd.depdMod.Deprecate
import typingsSlinky.eggDashCore.Anon_IsWeakDep
...
trait EggCoreBase[Config] extends ^[DefaultState, DefaultContext] {
  ...
  def readyCallback(name: String, opts: Anon_IsWeakDep): js.Function0[Unit] = js.native
  /**
