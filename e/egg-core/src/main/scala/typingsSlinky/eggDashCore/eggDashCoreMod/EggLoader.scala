...
import typingsSlinky.eggDashCore.Anon_PathType
...
class EggLoader[T, Config] protected () extends js.Object {
  ...
  var ContextLoader: typingsSlinky.eggDashCore.eggDashCoreMod.ContextLoader = js.native
  var FileLoader: typingsSlinky.eggDashCore.eggDashCoreMod.FileLoader = js.native
  var app: T = js.native
