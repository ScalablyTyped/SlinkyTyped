...
name := "ember-qunit"
version := "3.4-dt-20200227Z-bdd660"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ember-test-helpers" % "1.0-dt-20200227Z-de4357",
  ...
  "org.scalablytyped.slinky" %%% "qunit" % "v2.9.2-dt-20200226Z-8706c4",
