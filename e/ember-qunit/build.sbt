...
name := "ember-qunit"
version := "3.4-dt-20200515Z-cff6a1"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ember-test-helpers" % "1.0-dt-20200515Z-0f94b0",
  ...
  "org.scalablytyped.slinky" %%% "qunit" % "v2.9.2-dt-20200515Z-c9dc32",
