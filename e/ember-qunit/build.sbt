...
name := "ember-qunit"
version := "3.4-dt-20191003Z-1a46fd"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ember-test-helpers" % "1.0-dt-20191003Z-a1ba15",
  ...
  "org.scalablytyped.slinky" %%% "qunit" % "v2.9.2-dt-20190429Z-f3551c",
