...
name := "ember-qunit"
version := "3.4-dt-20200328Z-1664ed"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ember-test-helpers" % "1.0-dt-20200328Z-a5f83c",
  ...
  "org.scalablytyped.slinky" %%% "qunit" % "v2.9.2-dt-20200401Z-0c19b9",
