...
name := "ember-qunit"
version := "3.4-dt-20191003Z-1ea5b6"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ember-test-helpers" % "1.0-dt-20191003Z-a5d56f",
  ...
  "org.scalablytyped.slinky" %%% "qunit" % "v2.9.2-dt-20190429Z-eed4fb",
