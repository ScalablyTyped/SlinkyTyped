...
name := "ember-qunit"
version := "3.4-dt-20201028Z-1200e9"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "ember-test-helpers" % "1.0-dt-20201028Z-308edc",
  ...
  "org.scalablytyped.slinky" %%% "qunit" % "v2.9.2-dt-20201028Z-db3ee3",
