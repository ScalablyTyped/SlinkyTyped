...
object LinearGradient
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.expo.globalsWebMod.LinearGradient] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.expo.globalsWebMod.LinearGradient] = {
