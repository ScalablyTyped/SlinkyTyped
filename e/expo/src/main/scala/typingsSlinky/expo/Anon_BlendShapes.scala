...
import typingsSlinky.expo.buildARMod.AnchorType.Face
import typingsSlinky.expo.buildARMod.FaceGeometry
...
trait Anon_BlendShapes extends js.Object {
  ...
  {[ shape in expo.expo/build/AR.BlendShape ]:? number}
    */ typingsSlinky.expo.expoStrings.Anon_BlendShapes with js.Any
  ] = js.undefined
...
object Anon_BlendShapes {
  ...
  {[ shape in expo.expo/build/AR.BlendShape ]:? number}
    */ typingsSlinky.expo.expoStrings.Anon_BlendShapes with js.Any = null,
