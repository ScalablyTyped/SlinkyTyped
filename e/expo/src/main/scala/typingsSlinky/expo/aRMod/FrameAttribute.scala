...
object FrameAttribute extends js.Object {
  ...
  object CapturedDepthData
    extends TopLevel[typingsSlinky.expo.aRMod.FrameAttribute.CapturedDepthData with String]
  
  /* "lightEstimation" */ @js.native
  object LightEstimation
    extends TopLevel[typingsSlinky.expo.aRMod.FrameAttribute.LightEstimation with String]
