...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "expo-linear-gradient" % "7.0.1-907d92",
  "org.scalablytyped.slinky" %%% "expo-sqlite" % "7.0.0-21df0a",
  "org.scalablytyped.slinky" %%% "expo__vector-icons" % "9.0-dt-20200515Z-1a4f04",
  ...
  "org.scalablytyped.slinky" %%% "react-native-view-shot" % "2.6.0-3369c3",
