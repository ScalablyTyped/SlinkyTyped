...
import typingsSlinky.emojiDashMart.distDashEsComponentsPickerPickerMod.default
...
import typingsSlinky.emojiDashMart.distDashEsUtilsSharedDashPropsMod.PickerProps
...
object Picker
  ...
  typingsSlinky.emojiDashMart.distDashEsComponentsPickerPickerMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
