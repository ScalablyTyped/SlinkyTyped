...
import typingsSlinky.emojiDashMart.distDashEsComponentsEmojiNimbleDashEmojiMod.NimbleEmojiProps
...
object NimbleDashEmoji
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], emoji = emoji.asInstanceOf[js.Any])
