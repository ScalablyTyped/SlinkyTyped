...
object anon {
  ...
  object RecordCategoryNameReactNo {
    ...
    implicit class RecordCategoryNameReactNoMutableBuilder[Self <: RecordCategoryNameReactNo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActivity(value: () => ReactElement): Self = StObject.set(x, "activity", js.Any.fromFunction0(value))
      
      @scala.inline
      def setCustom(value: () => ReactElement): Self = StObject.set(x, "custom", js.Any.fromFunction0(value))
      
      @scala.inline
      def setFlags(value: () => ReactElement): Self = StObject.set(x, "flags", js.Any.fromFunction0(value))
      
      @scala.inline
      def setFoods(value: () => ReactElement): Self = StObject.set(x, "foods", js.Any.fromFunction0(value))
      
      @scala.inline
      def setNature(value: () => ReactElement): Self = StObject.set(x, "nature", js.Any.fromFunction0(value))
      
      @scala.inline
      def setObjects(value: () => ReactElement): Self = StObject.set(x, "objects", js.Any.fromFunction0(value))
      
      @scala.inline
      def setPeople(value: () => ReactElement): Self = StObject.set(x, "people", js.Any.fromFunction0(value))
      
      @scala.inline
      def setPlaces(value: () => ReactElement): Self = StObject.set(x, "places", js.Any.fromFunction0(value))
      
      @scala.inline
      def setRecent(value: () => ReactElement): Self = StObject.set(x, "recent", js.Any.fromFunction0(value))
      
      @scala.inline
      def setSearch(value: () => ReactElement): Self = StObject.set(x, "search", js.Any.fromFunction0(value))
      
      @scala.inline
      def setSymbols(value: () => ReactElement): Self = StObject.set(x, "symbols", js.Any.fromFunction0(value))
    }
  }
