...
object EmojiProps {
  ...
  implicit class EmojiPropsOps[Self <: EmojiProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* emoji */ EmojiData, /* e */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    @scala.inline
    def setOnLeave(value: (/* emoji */ EmojiData, /* e */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onLeave", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnLeave: Self = this.set("onLeave", js.undefined)
    @scala.inline
    def setOnOver(value: (/* emoji */ EmojiData, /* e */ SyntheticMouseEvent[HTMLElement]) => Unit): Self = this.set("onOver", js.Any.fromFunction2(value))
    @scala.inline
