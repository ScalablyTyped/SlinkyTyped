...
object nimbleEmojiIndexMod {
  ...
  */
  ...
  object EmojiData {
    ...
    def BaseEmoji(
      ...
      val __obj = js.Dynamic.literal(colons = colons.asInstanceOf[js.Any], emoticons = emoticons.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], native = native.asInstanceOf[js.Any], unified = unified.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.emojiMart.nimbleEmojiIndexMod.BaseEmoji]
    }
    
    @scala.inline
    def CustomEmoji(imageUrl: String, name: String, short_names: js.Array[String]): typingsSlinky.emojiMart.nimbleEmojiIndexMod.CustomEmoji = {
      val __obj = js.Dynamic.literal(imageUrl = imageUrl.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], short_names = short_names.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.emojiMart.nimbleEmojiIndexMod.CustomEmoji]
    }
  }
  ...
  */
  ...
  object EmojiEntry {
    ...
    @scala.inline
    def variantinEmojiSkinEmojiDa(`1`: EmojiData, `2`: EmojiData, `3`: EmojiData, `4`: EmojiData, `5`: EmojiData, `6`: EmojiData): typingsSlinky.emojiMart.anon.variantinEmojiSkinEmojiDa = {
      ...
      __obj.asInstanceOf[typingsSlinky.emojiMart.anon.variantinEmojiSkinEmojiDa]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.emojiMart.emojiMartNumbers.`1`
    - typingsSlinky.emojiMart.emojiMartNumbers.`2`
    - typingsSlinky.emojiMart.emojiMartNumbers.`3`
    - typingsSlinky.emojiMart.emojiMartNumbers.`4`
    - typingsSlinky.emojiMart.emojiMartNumbers.`5`
    - typingsSlinky.emojiMart.emojiMartNumbers.`6`
  */
  trait EmojiSkin extends StObject
  object EmojiSkin {
    
    @scala.inline
    def `1`: typingsSlinky.emojiMart.emojiMartNumbers.`1` = 1.asInstanceOf[typingsSlinky.emojiMart.emojiMartNumbers.`1`]
    
    @scala.inline
    def `2`: typingsSlinky.emojiMart.emojiMartNumbers.`2` = 2.asInstanceOf[typingsSlinky.emojiMart.emojiMartNumbers.`2`]
    
    @scala.inline
    def `3`: typingsSlinky.emojiMart.emojiMartNumbers.`3` = 3.asInstanceOf[typingsSlinky.emojiMart.emojiMartNumbers.`3`]
    
    @scala.inline
    def `4`: typingsSlinky.emojiMart.emojiMartNumbers.`4` = 4.asInstanceOf[typingsSlinky.emojiMart.emojiMartNumbers.`4`]
    
    @scala.inline
    def `5`: typingsSlinky.emojiMart.emojiMartNumbers.`5` = 5.asInstanceOf[typingsSlinky.emojiMart.emojiMartNumbers.`5`]
    
    @scala.inline
    def `6`: typingsSlinky.emojiMart.emojiMartNumbers.`6` = 6.asInstanceOf[typingsSlinky.emojiMart.emojiMartNumbers.`6`]
  }
