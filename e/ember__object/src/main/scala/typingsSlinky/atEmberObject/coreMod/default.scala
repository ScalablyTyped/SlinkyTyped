...
import typingsSlinky.atEmberObject.TypeofClassCoreObject
...
object default extends js.Object {
  ...
  def create[Class /* <: TypeofClassCoreObject */](`this`: Class): InstanceType[Class] = js.native
  def create[Class /* <: TypeofClassCoreObject */, T1 /* <: EmberInstanceArguments[UnwrapComputedPropertySetters[InstanceType[Class]]] */](`this`: Class, arg1: T1 with (ThisType[T1 with InstanceType[Class]])): InstanceType[Class] with T1 = js.native
