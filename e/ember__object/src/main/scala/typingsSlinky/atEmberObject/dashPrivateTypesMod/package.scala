...
package object dashPrivateTypesMod {
  ...
  import typingsSlinky.atEmberObject.mixinMod.default
  ...
  */
  ...
  {[ K in keyof T ]: T[K]}
    */ typingsSlinky.atEmberObject.atEmberObjectStrings.Fix with T
  ...
  {[ P in keyof T ]: @ember/object.@ember/object/-private/types.UnwrapComputedPropertyGetter<T[P]>}
    */ typingsSlinky.atEmberObject.atEmberObjectStrings.UnwrapComputedPropertyGetters with T
  ...
  {[ P in keyof T ]: @ember/object.@ember/object/-private/types.UnwrapComputedPropertySetter<T[P]>}
    */ typingsSlinky.atEmberObject.atEmberObjectStrings.UnwrapComputedPropertySetters with T
}
