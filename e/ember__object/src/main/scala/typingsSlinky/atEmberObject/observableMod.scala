...
object observableMod extends js.Object {
  ...
  trait Observable extends js.Object {
    ...
    {[ KK in K ]: any}
      */ typingsSlinky.atEmberObject.atEmberObjectStrings.Observable with js.Any
  ...
  val default: typingsSlinky.atEmberObject.mixinMod.default[Observable, typingsSlinky.atEmberObject.coreMod.default] = js.native
}
