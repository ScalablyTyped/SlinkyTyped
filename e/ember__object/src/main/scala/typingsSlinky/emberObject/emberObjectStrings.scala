...
object emberObjectStrings {
  ...
  @js.native
  sealed trait Observable extends StObject
  @scala.inline
  def Observable: Observable = "Observable".asInstanceOf[Observable]
  
  @js.native
  sealed trait UnwrapComputedPropertyGetters extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait UnwrapComputedPropertySetters extends StObject
  @scala.inline
