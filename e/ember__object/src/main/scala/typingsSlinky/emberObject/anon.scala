...
import typingsSlinky.emberObject.coreMod.CoreObject
...
import typingsSlinky.emberObject.typesMod.Fix
import typingsSlinky.emberObject.typesMod.MixinOrLiteral
import typingsSlinky.emberObject.typesMod.Objectify
