...
object typesMod {
  ...
  */
  ...
  {[ K in keyof T ]: T[K]}
    */ typingsSlinky.emberObject.emberObjectStrings.Fix with TopLevel[T]
  ...
  {[ P in keyof T ]: @ember/object.@ember/object/-private/types.UnwrapComputedPropertyGetter<T[P]>}
    */ typingsSlinky.emberObject.emberObjectStrings.UnwrapComputedPropertyGetters with TopLevel[T]
  ...
  {[ P in keyof T ]: @ember/object.@ember/object/-private/types.UnwrapComputedPropertySetter<T[P]>}
    */ typingsSlinky.emberObject.emberObjectStrings.UnwrapComputedPropertySetters with TopLevel[T]
  
  trait _ComputedPropertyObj[T] extends StObject
  object _ComputedPropertyObj {
    
    @scala.inline
    def ComputedPropertyGetterObj[T](get: String => T): typingsSlinky.emberObject.typesMod.ComputedPropertyGetterObj[T] = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get))
      __obj.asInstanceOf[typingsSlinky.emberObject.typesMod.ComputedPropertyGetterObj[T]]
    }
    
    @scala.inline
    def ComputedPropertySetterObj[T](set: (String, T) => T): typingsSlinky.emberObject.typesMod.ComputedPropertySetterObj[T] = {
      val __obj = js.Dynamic.literal(set = js.Any.fromFunction2(set))
      __obj.asInstanceOf[typingsSlinky.emberObject.typesMod.ComputedPropertySetterObj[T]]
    }
  }
}
