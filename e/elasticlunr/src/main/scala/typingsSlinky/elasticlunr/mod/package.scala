...
package object mod {
  ...
  {[ K in keyof T ]:? {  bool? :elasticlunr.elasticlunr.Bool,   boost? :number,   expand? :boolean}}
    */ typingsSlinky.elasticlunr.elasticlunrStrings.FieldSearchConfig with js.Any
  ...
  type InvertedIndexDocs = org.scalablytyped.runtime.StringDictionary[typingsSlinky.elasticlunr.AnonTf]
