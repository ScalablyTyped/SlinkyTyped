package typingsSlinky.elasticlunr.elasticlunrMod
...
trait SerialisedDocumentStore[T] extends js.Object {
  var docInfo: StringDictionary[typingsSlinky.elasticlunr.elasticlunrStrings.SerialisedDocumentStore with js.Any]
...
object SerialisedDocumentStore {
  @scala.inline
  def apply[T](
    docInfo: StringDictionary[typingsSlinky.elasticlunr.elasticlunrStrings.SerialisedDocumentStore with js.Any],
