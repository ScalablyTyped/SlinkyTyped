...
class ShallowWrapper[P, S, C] protected () extends CommonWrapper[P, S, C] {
  ...
  def this(nodes: js.Array[Element], root: ShallowWrapper[_, _, ReactComponentClass[js.Object]]) = this()
  def this(nodes: Element, root: ShallowWrapper[_, _, ReactComponentClass[js.Object]]) = this()
  def this(
