...
import typingsSlinky.enzyme.anon.Adapter
...
object mod {
  ...
  @js.native
  def mount[P](node: ReactElement): ReactWrapper[P, _, ReactComponentClass[js.Object]] = js.native
  @JSImport("enzyme", "mount")
  @js.native
  def mount[P](node: ReactElement, options: MountRendererProps): ReactWrapper[P, _, ReactComponentClass[js.Object]] = js.native
  @JSImport("enzyme", "mount")
  @js.native
  def mount_C_ComponentObjectObjectWildcardPS[C /* <: ReactComponentClass[js.Object] */, P, S](node: ReactElement): ReactWrapper[P, S, C] = js.native
  @JSImport("enzyme", "mount")
  @js.native
  def mount_C_ComponentObjectObjectWildcardPS[C /* <: ReactComponentClass[js.Object] */, P, S](node: ReactElement, options: MountRendererProps): ReactWrapper[P, S, C] = js.native
  @JSImport("enzyme", "mount")
  @js.native
  def mount_PS[P, S](node: ReactElement): ReactWrapper[P, S, ReactComponentClass[js.Object]] = js.native
  @JSImport("enzyme", "mount")
  @js.native
  def mount_PS[P, S](node: ReactElement, options: MountRendererProps): ReactWrapper[P, S, ReactComponentClass[js.Object]] = js.native
  ...
  @js.native
  def shallow[P](node: ReactElement): ShallowWrapper[P, _, ReactComponentClass[js.Object]] = js.native
  @JSImport("enzyme", "shallow")
  @js.native
  def shallow[P](node: ReactElement, options: ShallowRendererProps): ShallowWrapper[P, _, ReactComponentClass[js.Object]] = js.native
  @JSImport("enzyme", "shallow")
  @js.native
  def shallow_C_ComponentObjectObjectWildcardPS[C /* <: ReactComponentClass[js.Object] */, P, S](node: ReactElement): ShallowWrapper[P, S, C] = js.native
  @JSImport("enzyme", "shallow")
  @js.native
  def shallow_C_ComponentObjectObjectWildcardPS[C /* <: ReactComponentClass[js.Object] */, P, S](node: ReactElement, options: ShallowRendererProps): ShallowWrapper[P, S, C] = js.native
  @JSImport("enzyme", "shallow")
  @js.native
  def shallow_PS[P, S](node: ReactElement): ShallowWrapper[P, S, ReactComponentClass[js.Object]] = js.native
  @JSImport("enzyme", "shallow")
  @js.native
  def shallow_PS[P, S](node: ReactElement, options: ShallowRendererProps): ShallowWrapper[P, S, ReactComponentClass[js.Object]] = js.native
  ...
  object MountRendererProps {
    ...
    implicit class MountRendererPropsMutableBuilder[Self <: MountRendererProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setWrappingComponentFunction2(value: (_, /* context */ js.UndefOr[js.Any]) => ReactElement | Null): Self = StObject.set(x, "wrappingComponent", js.Any.fromFunction2(value))
  ...
  type StatelessComponent[Props] = js.Function2[/* props */ Props, /* context */ js.UndefOr[js.Any], ReactElement | Null]
}
