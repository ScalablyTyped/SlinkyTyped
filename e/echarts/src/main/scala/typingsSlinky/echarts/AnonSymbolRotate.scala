...
@js.native
trait AnonSymbolRotate extends js.Object {
  /**
...
object AnonSymbolRotate {
  @scala.inline
  def apply(): AnonSymbolRotate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonSymbolRotate]
  }
  @scala.inline
  implicit class AnonSymbolRotateOps[Self <: AnonSymbolRotate] (val x: Self) extends AnyVal {
    @scala.inline
