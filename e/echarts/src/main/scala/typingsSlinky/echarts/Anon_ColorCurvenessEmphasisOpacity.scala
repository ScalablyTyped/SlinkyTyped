...
trait Anon_ColorCurvenessEmphasisOpacity extends js.Object {
  /**
    * Line color.
    *
...
object Anon_ColorCurvenessEmphasisOpacity {
  @scala.inline
  def apply(
    color: Color = null,
  ...
  ): Anon_ColorCurvenessEmphasisOpacity = {
    ...
    __obj.asInstanceOf[Anon_ColorCurvenessEmphasisOpacity]
  }
}
