...
@js.native
trait AnonExcludeComponents extends js.Object {
...
object AnonExcludeComponents {
  @scala.inline
  def apply(backgroundColor: String, pixelRatio: Double, `type`: String): AnonExcludeComponents = {
    ...
    __obj.asInstanceOf[AnonExcludeComponents]
  }
  @scala.inline
  implicit class AnonExcludeComponentsOps[Self <: AnonExcludeComponents] (val x: Self) extends AnyVal {
    @scala.inline
