...
@js.native
trait AnonAnimationDurationUpdate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[AnonSymbol] = js.native
  /**
    * Mark point style.
    *
    *
...
object AnonAnimationDurationUpdate {
  @scala.inline
  def apply(): AnonAnimationDurationUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAnimationDurationUpdate]
  }
  @scala.inline
  implicit class AnonAnimationDurationUpdateOps[Self <: AnonAnimationDurationUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withData(value: AnonSymbol): Self = {
        val ret = this.duplicate
