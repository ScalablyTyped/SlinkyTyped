...
object AnonItemStyleAnonBorderTypeLabelAnonDistance {
  @scala.inline
  def apply(): AnonItemStyleAnonBorderTypeLabelAnonDistance = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonItemStyleAnonBorderTypeLabelAnonDistance]
  }
  @scala.inline
  implicit class AnonItemStyleAnonBorderTypeLabelAnonDistanceOps[Self <: AnonItemStyleAnonBorderTypeLabelAnonDistance] (val x: Self) extends AnyVal {
    @scala.inline
