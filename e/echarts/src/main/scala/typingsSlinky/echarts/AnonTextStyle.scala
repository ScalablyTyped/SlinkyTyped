...
@js.native
trait AnonTextStyle extends js.Object {
  /**
  ...
  /**
    ...
    */
  var textStyle: js.UndefOr[AnonTextShadowOffsetY] = js.native
}

object AnonTextStyle {
  @scala.inline
  def apply(): AnonTextStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonTextStyle]
  }
  @scala.inline
  implicit class AnonTextStyleOps[Self <: AnonTextStyle] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTextStyle(value: AnonTextShadowOffsetY): Self = {
        val ret = this.duplicate
