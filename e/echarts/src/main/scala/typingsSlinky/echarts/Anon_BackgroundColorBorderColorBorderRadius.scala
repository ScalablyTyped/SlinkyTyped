...
trait Anon_BackgroundColorBorderColorBorderRadius extends js.Object {
  /**
...
object Anon_BackgroundColorBorderColorBorderRadius {
  @scala.inline
  def apply(
  ...
  StringDictionary[Anon_Align] = null,
  ...
  ): Anon_BackgroundColorBorderColorBorderRadius = {
    ...
    __obj.asInstanceOf[Anon_BackgroundColorBorderColorBorderRadius]
  }
}
