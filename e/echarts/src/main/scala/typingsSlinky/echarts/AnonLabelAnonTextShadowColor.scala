...
trait AnonLabelAnonTextShadowColor extends js.Object {
  ...
  /**
    ...
    */
  var label: js.UndefOr[AnonTextShadowColor] = js.native
}

object AnonLabelAnonTextShadowColor {
  @scala.inline
  def apply(): AnonLabelAnonTextShadowColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLabelAnonTextShadowColor]
  }
  @scala.inline
  implicit class AnonLabelAnonTextShadowColorOps[Self <: AnonLabelAnonTextShadowColor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: AnonTextShadowColor): Self = {
        val ret = this.duplicate
