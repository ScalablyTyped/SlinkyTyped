...
@js.native
trait AnonTextShadowOffsetX extends js.Object {
  /**
...
object AnonTextShadowOffsetX {
  @scala.inline
  def apply(): AnonTextShadowOffsetX = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonTextShadowOffsetX]
  }
  @scala.inline
  implicit class AnonTextShadowOffsetXOps[Self <: AnonTextShadowOffsetX] (val x: Self) extends AnyVal {
    @scala.inline
