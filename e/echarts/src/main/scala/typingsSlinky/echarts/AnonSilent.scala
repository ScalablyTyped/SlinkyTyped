...
trait AnonSilent extends js.Object {
  ...
  /**
    ...
    */
  var shape: js.UndefOr[AnonPercent] = js.native
  /**
  ...
  /**
    ...
    */
  var style: js.UndefOr[AnonFill] = js.native
  /**
...
object AnonSilent {
  ...
  implicit class AnonSilentOps[Self <: AnonSilent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShape(value: AnonPercent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStyle(value: AnonFill): Self = {
        val ret = this.duplicate
