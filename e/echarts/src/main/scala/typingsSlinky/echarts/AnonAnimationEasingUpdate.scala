...
trait AnonAnimationEasingUpdate extends js.Object {
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon0AnonValue] = js.native
  /**
...
object AnonAnimationEasingUpdate {
  @scala.inline
  def apply(): AnonAnimationEasingUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAnimationEasingUpdate]
  }
  @scala.inline
  implicit class AnonAnimationEasingUpdateOps[Self <: AnonAnimationEasingUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withData(value: Anon0AnonValue): Self = {
        val ret = this.duplicate
