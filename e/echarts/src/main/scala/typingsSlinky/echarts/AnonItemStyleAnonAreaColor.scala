...
trait AnonItemStyleAnonAreaColor extends js.Object {
  /**
    ...
    */
  var itemStyle: js.UndefOr[AnonAreaColor] = js.native
  /**
...
object AnonItemStyleAnonAreaColor {
  @scala.inline
  def apply(): AnonItemStyleAnonAreaColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonItemStyleAnonAreaColor]
  }
  @scala.inline
  implicit class AnonItemStyleAnonAreaColorOps[Self <: AnonItemStyleAnonAreaColor] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItemStyle(value: AnonAreaColor): Self = {
