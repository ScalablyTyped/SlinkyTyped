...
trait AnonAnimationThreshold extends js.Object {
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon0AnonSymbolOffset] = js.native
  /**
    * Mark line text.
    *
    *
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[AnonColorCurveness] = js.native
  /**
...
object AnonAnimationThreshold {
  @scala.inline
  def apply(): AnonAnimationThreshold = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAnimationThreshold]
  }
  @scala.inline
  implicit class AnonAnimationThresholdOps[Self <: AnonAnimationThreshold] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withData(value: Anon0AnonSymbolOffset): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLineStyle(value: AnonColorCurveness): Self = {
        val ret = this.duplicate
