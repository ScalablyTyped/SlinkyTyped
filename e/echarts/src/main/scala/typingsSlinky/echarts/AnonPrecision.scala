...
trait AnonPrecision extends js.Object {
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon0AnonValueDim] = js.native
  /**
    * Mark line text.
    *
    *
    ...
    */
  var label: js.UndefOr[AnonPosition] = js.native
  /**
    * Mark line style.
    *
    *
    ...
    */
  var lineStyle: js.UndefOr[AnonCurveness] = js.native
  /**
...
object AnonPrecision {
  ...
  implicit class AnonPrecisionOps[Self <: AnonPrecision] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: Anon0AnonValueDim): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: AnonPosition): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLineStyle(value: AnonCurveness): Self = {
        val ret = this.duplicate
