...
trait AnonPrecision extends js.Object {
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon0AnonValueDim] = js.undefined
  /**
    * Mark line text.
    *
    *
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[AnonCurveness] = js.undefined
  /**
...
object AnonPrecision {
  ...
  def apply(
    ...
    data: Anon0AnonValueDim = null,
    label: AnonPosition = null,
    lineStyle: AnonCurveness = null,
