...
@js.native
trait AnonChildrenVisibleMin extends js.Object {
  /**
...
object AnonChildrenVisibleMin {
  @scala.inline
  def apply(): AnonChildrenVisibleMin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonChildrenVisibleMin]
  }
  @scala.inline
  implicit class AnonChildrenVisibleMinOps[Self <: AnonChildrenVisibleMin] (val x: Self) extends AnyVal {
    @scala.inline
