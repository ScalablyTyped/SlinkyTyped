...
@js.native
trait AnonAnimationEasing extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon01] = js.native
  /**
    * Mark line text.
    *
    *
...
object AnonAnimationEasing {
  @scala.inline
  def apply(): AnonAnimationEasing = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAnimationEasing]
  }
  @scala.inline
  implicit class AnonAnimationEasingOps[Self <: AnonAnimationEasing] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withData(value: Anon01): Self = {
        val ret = this.duplicate
