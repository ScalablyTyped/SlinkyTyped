...
@js.native
trait AnonLabelAnonMinAngle extends js.Object {
  /**
...
object AnonLabelAnonMinAngle {
  @scala.inline
  def apply(): AnonLabelAnonMinAngle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLabelAnonMinAngle]
  }
  @scala.inline
  implicit class AnonLabelAnonMinAngleOps[Self <: AnonLabelAnonMinAngle] (val x: Self) extends AnyVal {
    @scala.inline
