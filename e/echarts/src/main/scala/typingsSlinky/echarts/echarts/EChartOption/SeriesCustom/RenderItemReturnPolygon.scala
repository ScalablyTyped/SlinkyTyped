...
/**
  ...
  */
@js.native
trait RenderItemReturnPolygon extends js.Object {
...
object RenderItemReturnPolygon {
  ...
  @scala.inline
  implicit class RenderItemReturnPolygonOps[Self <: RenderItemReturnPolygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShape(value: Points): Self = this.set("shape", value.asInstanceOf[js.Any])
