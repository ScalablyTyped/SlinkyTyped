...
object Slider {
  ...
  implicit class SliderOps[Self <: Slider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndValue(value: Double | String | js.Date): Self = this.set("endValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMaxValueSpanDate(value: js.Date): Self = this.set("maxValueSpan", value.asInstanceOf[js.Any])
    @scala.inline
    def setMaxValueSpan(value: Double | String | js.Date): Self = this.set("maxValueSpan", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMinValueSpanDate(value: js.Date): Self = this.set("minValueSpan", value.asInstanceOf[js.Any])
    @scala.inline
    def setMinValueSpan(value: Double | String | js.Date): Self = this.set("minValueSpan", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStartValue(value: Double | String | js.Date): Self = this.set("startValue", value.asInstanceOf[js.Any])
    @scala.inline
