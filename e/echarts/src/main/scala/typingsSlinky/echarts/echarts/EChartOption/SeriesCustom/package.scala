...
package object SeriesCustom {
  ...
  type RenderItem = js.Function2[
    /* params */ typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemParams, 
    /* api */ typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemApi, 
    typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnGroup | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnPath | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnImage | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnText | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnRect | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnCircle | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnRing | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnSector | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnArc | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnPolygon | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnPolyline | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnLine | typingsSlinky.echarts.echarts.EChartOption.SeriesCustom.RenderItemReturnBezierCurve
  ]
}
