...
object EChartOption_ {
  ...
  implicit class EChartOption_Ops[Self <: EChartOption_[_], TSeries] (val x: Self with EChartOption_[TSeries]) extends AnyVal {
    ...
    @scala.inline
    def setVisualMapVarargs(value: typingsSlinky.echarts.echarts.EChartOption.VisualMap*): Self = this.set("visualMap", js.Array(value :_*))
    
    @scala.inline
    def setVisualMap(value: js.Array[typingsSlinky.echarts.echarts.EChartOption.VisualMap]): Self = this.set("visualMap", value.asInstanceOf[js.Any])
