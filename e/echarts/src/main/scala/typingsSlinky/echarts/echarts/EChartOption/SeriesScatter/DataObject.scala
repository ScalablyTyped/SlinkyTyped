package typingsSlinky.echarts.echarts.EChartOption.SeriesScatter
...
import typingsSlinky.echarts.Anon_ItemStyleLabelAnonAlignBackgroundColorBorderColorBorderRadiusBorderWidth
