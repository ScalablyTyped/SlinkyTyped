...
@js.native
trait AnonCurveness extends js.Object {
  /**
    * Line color.
    *
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[AnonShadowBlur] = js.native
  /**
...
object AnonCurveness {
  @scala.inline
  def apply(): AnonCurveness = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCurveness]
  }
  @scala.inline
  implicit class AnonCurvenessOps[Self <: AnonCurveness] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmphasis(value: AnonShadowBlur): Self = {
        val ret = this.duplicate
