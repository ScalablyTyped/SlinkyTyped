...
@js.native
trait AnonInvisible extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[AnonR] = js.native
  /**
...
object AnonInvisible {
  @scala.inline
  def apply(): AnonInvisible = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonInvisible]
  }
  @scala.inline
  implicit class AnonInvisibleOps[Self <: AnonInvisible] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withShape(value: AnonR): Self = {
        val ret = this.duplicate
