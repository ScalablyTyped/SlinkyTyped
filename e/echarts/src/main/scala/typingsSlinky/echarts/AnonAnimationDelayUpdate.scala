...
@js.native
trait AnonAnimationDelayUpdate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon1] = js.native
  /**
...
object AnonAnimationDelayUpdate {
  @scala.inline
  def apply(): AnonAnimationDelayUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAnimationDelayUpdate]
  }
  @scala.inline
  implicit class AnonAnimationDelayUpdateOps[Self <: AnonAnimationDelayUpdate] (val x: Self) extends AnyVal {
    @scala.inline
