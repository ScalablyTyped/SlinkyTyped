...
trait AnonEmphasis extends js.Object {
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[AnonBorderType] = js.native
  /**
...
object AnonEmphasis {
  @scala.inline
  def apply(): AnonEmphasis = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonEmphasis]
  }
  @scala.inline
  implicit class AnonEmphasisOps[Self <: AnonEmphasis] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmphasis(value: AnonBorderType): Self = {
        val ret = this.duplicate
