...
trait Anon_IdIgnoreInfoInvisibleNameOriginPositionRotationScale extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[Anon_Percent] = js.undefined
  /**
...
object Anon_IdIgnoreInfoInvisibleNameOriginPositionRotationScale {
  @scala.inline
  def apply(
    id: String = null,
    ...
    shape: Anon_Percent = null,
    silent: js.UndefOr[Boolean] = js.undefined,
    style: Anon_Fill = null,
    styleEmphasis: js.Object = null,
    `type`: String = null,
    z2: Int | Double = null
  ): Anon_IdIgnoreInfoInvisibleNameOriginPositionRotationScale = {
    ...
    __obj.asInstanceOf[Anon_IdIgnoreInfoInvisibleNameOriginPositionRotationScale]
  }
}
