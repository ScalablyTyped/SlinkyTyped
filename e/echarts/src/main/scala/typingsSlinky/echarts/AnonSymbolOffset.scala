...
@js.native
trait AnonSymbolOffset extends js.Object {
  /**
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[AnonCurvenessEmphasis] = js.native
  /**
...
object AnonSymbolOffset {
  @scala.inline
  def apply(): AnonSymbolOffset = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonSymbolOffset]
  }
  @scala.inline
  implicit class AnonSymbolOffsetOps[Self <: AnonSymbolOffset] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLineStyle(value: AnonCurvenessEmphasis): Self = {
        val ret = this.duplicate
