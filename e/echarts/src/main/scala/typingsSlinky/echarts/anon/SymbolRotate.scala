...
@js.native
trait SymbolRotate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[CurvenessEmphasis] = js.native
  /**
...
object SymbolRotate {
  @scala.inline
  def apply(): SymbolRotate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SymbolRotate]
  }
  @scala.inline
  implicit class SymbolRotateOps[Self <: SymbolRotate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLineStyle(value: CurvenessEmphasis): Self = this.set("lineStyle", value.asInstanceOf[js.Any])
    @scala.inline
