...
trait LabelTextShadowColor extends js.Object {
  ...
  /**
    ...
    */
  var label: js.UndefOr[TextShadowColor] = js.native
}

object LabelTextShadowColor {
  @scala.inline
  def apply(): LabelTextShadowColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LabelTextShadowColor]
  }
  @scala.inline
  implicit class LabelTextShadowColorOps[Self <: LabelTextShadowColor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: TextShadowColor): Self = {
        val ret = this.duplicate
