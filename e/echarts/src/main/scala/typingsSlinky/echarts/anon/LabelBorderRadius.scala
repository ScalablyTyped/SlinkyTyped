...
@js.native
trait LabelBorderRadius extends js.Object {
  /**
...
object LabelBorderRadius {
  @scala.inline
  def apply(): LabelBorderRadius = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LabelBorderRadius]
  }
  @scala.inline
  implicit class LabelBorderRadiusOps[Self <: LabelBorderRadius] (val x: Self) extends AnyVal {
    @scala.inline
