...
trait `01` extends js.Object {
  /**
    ...
    */
  var `0`: js.UndefOr[SymbolKeepAspect] = js.native
  /**
    ...
    */
  var `1`: js.UndefOr[SymbolKeepAspect] = js.native
}
...
object `01` {
  ...
  implicit class `01Ops`[Self <: `01`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with0(value: SymbolKeepAspect): Self = {
    ...
    @scala.inline
    def with1(value: SymbolKeepAspect): Self = {
        val ret = this.duplicate
