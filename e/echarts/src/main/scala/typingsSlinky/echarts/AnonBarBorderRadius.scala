...
@js.native
trait AnonBarBorderRadius extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[AnonBarBorderWidth] = js.native
  /**
...
object AnonBarBorderRadius {
  @scala.inline
  def apply(): AnonBarBorderRadius = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBarBorderRadius]
  }
  @scala.inline
  implicit class AnonBarBorderRadiusOps[Self <: AnonBarBorderRadius] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEmphasis(value: AnonBarBorderWidth): Self = {
        val ret = this.duplicate
