...
trait Anon_ColorCurvenessOpacity extends js.Object {
  /**
    * Line color.
    *
...
object Anon_ColorCurvenessOpacity {
  @scala.inline
  def apply(
    color: String = null,
    ...
    __obj.asInstanceOf[Anon_ColorCurvenessOpacity]
  }
}
