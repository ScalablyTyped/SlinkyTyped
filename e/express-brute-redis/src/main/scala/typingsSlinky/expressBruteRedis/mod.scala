package typingsSlinky.expressBruteRedis

import typingsSlinky.expressBruteRedis.anon.ClientOptsclientRedisClie
...
object mod {
  ...
  trait RedisStore extends StObject {
    ...
    def get(key: String, callback: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): String | Null = js.native
