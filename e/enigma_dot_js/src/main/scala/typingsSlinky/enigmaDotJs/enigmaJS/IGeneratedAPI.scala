package typingsSlinky.enigmaDotJs.enigmaJS

import typingsSlinky.enigmaDotJs.enigmaDotJsStrings.changed
import typingsSlinky.enigmaDotJs.enigmaDotJsStrings.closed
