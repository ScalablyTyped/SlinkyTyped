...
object IResponseInterceptors {
  ...
  implicit class IResponseInterceptorsOps[Self <: IResponseInterceptors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnFulfilled(value: (/* session */ ISession, /* request */ js.Any, /* result */ js.Any) => js.Promise[_]): Self = {
    ...
    @scala.inline
    def withOnRejected(value: (/* session */ ISession, /* request */ js.Any, /* error */ js.Any) => js.Promise[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onRejected")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withoutOnRejected: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onRejected")(js.undefined)
        ret
    }
  }
