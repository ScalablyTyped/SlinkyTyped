package typingsSlinky.es6DashCollections
...
object es6DashCollectionsMod extends js.Object {
  @js.native
  class Map[K, V] ()
    extends typingsSlinky.es6DashCollections.Map[K, V] {
    def this(iterable: ForEachable[js.Tuple2[K, V]]) = this()
  }
  
  @js.native
  class Set[T] ()
    extends typingsSlinky.es6DashCollections.Set[T] {
    def this(iterable: ForEachable[T]) = this()
  }
  
  @js.native
  class WeakMap[K /* <: js.Object */, V] ()
    extends typingsSlinky.es6DashCollections.WeakMap[K, V] {
    def this(iterable: ForEachable[js.Tuple2[K, V]]) = this()
  }
  
  @js.native
  class WeakSet[T] ()
    extends typingsSlinky.es6DashCollections.WeakSet[T] {
    def this(iterable: ForEachable[T]) = this()
    /* CompleteClass */
    override def add(value: T): typingsSlinky.es6DashCollections.WeakSet[T] = js.native
    /* CompleteClass */
