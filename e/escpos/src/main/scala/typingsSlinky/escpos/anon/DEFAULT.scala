...
object DEFAULT {
  ...
  implicit class DEFAULTOps[Self <: DEFAULT] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDEFAULT(value: typingsSlinky.escpos.escposNumbers.`3`): Self = this.set("DEFAULT", value.asInstanceOf[js.Any])
    @scala.inline
    def setMAX(value: `16`): Self = this.set("MAX", value.asInstanceOf[js.Any])
    @scala.inline
    def setMIN(value: typingsSlinky.escpos.escposNumbers.`1`): Self = this.set("MIN", value.asInstanceOf[js.Any])
  }
