...
import typingsSlinky.escpos.Anon_A
import typingsSlinky.escpos.Anon_Align
import typingsSlinky.escpos.Anon_AlignCENTER
import typingsSlinky.escpos.Anon_Encoding
import typingsSlinky.escpos.Anon_Mode
