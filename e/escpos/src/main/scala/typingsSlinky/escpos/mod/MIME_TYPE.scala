...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.escpos.escposStrings.imageSlashpng
  - typingsSlinky.escpos.escposStrings.imageSlashjpg
  - typingsSlinky.escpos.escposStrings.imageSlashjpeg
  - typingsSlinky.escpos.escposStrings.imageSlashgif
  - typingsSlinky.escpos.escposStrings.imageSlashbmp
*/
