...
object RequestUtils {
  ...
  @scala.inline
  def ABSOLUTE_PATH_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ABSOLUTE_PATH")(x.asInstanceOf[js.Any])
  
  @JSGlobal("createjs.RequestUtils.EXTENSION_PATT")
  @js.native
  def EXTENSION_PATT: js.RegExp = js.native
  @scala.inline
  def EXTENSION_PATT_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EXTENSION_PATT")(x.asInstanceOf[js.Any])
  
  @JSGlobal("createjs.RequestUtils.RELATIVE_PATH")
  @js.native
  def RELATIVE_PATH: js.RegExp = js.native
  @scala.inline
  def RELATIVE_PATH_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RELATIVE_PATH")(x.asInstanceOf[js.Any])
