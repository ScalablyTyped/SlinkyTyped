...
@js.native
class Rectangle ()
  extends typingsSlinky.pixiJs.PIXI.Rectangle {
...
object Rectangle {
  ...
  @js.native
  def EMPTY: typingsSlinky.pixiJs.PIXI.Rectangle = js.native
  @scala.inline
  def EMPTY_=(x: typingsSlinky.pixiJs.PIXI.Rectangle): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EMPTY")(x.asInstanceOf[js.Any])
}
