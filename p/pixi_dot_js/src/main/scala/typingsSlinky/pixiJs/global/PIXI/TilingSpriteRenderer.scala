...
class TilingSpriteRenderer protected ()
  extends typingsSlinky.pixiJs.PIXI.TilingSpriteRenderer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val state: typingsSlinky.pixiJs.PIXI.State = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def render(`object`: typingsSlinky.pixiJs.PIXI.DisplayObject): Unit = js.native
  /**
    *
    * @param {PIXI.TilingSprite} ts tilingSprite to be rendered
    */
  /* CompleteClass */
  override def render(ts: typingsSlinky.pixiJs.PIXI.TilingSprite): Unit = js.native
  /**
