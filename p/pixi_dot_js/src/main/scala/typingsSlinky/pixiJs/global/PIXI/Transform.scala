...
@js.native
class Transform ()
  extends typingsSlinky.pixiJs.PIXI.Transform {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var localTransform: typingsSlinky.pixiJs.PIXI.Matrix = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var pivot: typingsSlinky.pixiJs.PIXI.ObservablePoint = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var position: typingsSlinky.pixiJs.PIXI.ObservablePoint = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var scale: typingsSlinky.pixiJs.PIXI.ObservablePoint = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var skew: typingsSlinky.pixiJs.PIXI.ObservablePoint = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var worldTransform: typingsSlinky.pixiJs.PIXI.Matrix = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setFromMatrix(matrix: typingsSlinky.pixiJs.PIXI.Matrix): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def updateTransform(parentTransform: typingsSlinky.pixiJs.PIXI.Transform): Unit = js.native
}
...
object Transform extends js.Object {
  /**
    ...
    */
  var IDENTITY: typingsSlinky.pixiJs.PIXI.Transform = js.native
}
