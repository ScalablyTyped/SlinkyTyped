...
class Text protected ()
  extends typingsSlinky.pixiJs.PIXI.Text {
  def this(text: String) = this()
  def this(text: String, style: js.Any) = this()
  def this(text: String, style: typingsSlinky.pixiJs.PIXI.TextStyle) = this()
  def this(text: String, style: js.Any, canvas: HTMLCanvasElement) = this()
  def this(text: String, style: typingsSlinky.pixiJs.PIXI.TextStyle, canvas: HTMLCanvasElement) = this()
}
