...
import typingsSlinky.pixiJs.anon.Font
...
class BitmapText protected ()
  extends typingsSlinky.pixiJs.PIXI.BitmapText {
...
object BitmapText extends js.Object {
  def registerFont(xml: XMLDocument, textures: js.Array[typingsSlinky.pixiJs.PIXI.Texture]): js.Any = js.native
  /**
    ...
    */
  def registerFont(xml: XMLDocument, textures: StringDictionary[typingsSlinky.pixiJs.PIXI.Texture]): js.Any = js.native
  def registerFont(xml: XMLDocument, textures: typingsSlinky.pixiJs.PIXI.Texture): js.Any = js.native
}
