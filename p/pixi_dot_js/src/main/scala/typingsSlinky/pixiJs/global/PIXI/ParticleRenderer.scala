...
class ParticleRenderer protected ()
  extends typingsSlinky.pixiJs.PIXI.ParticleRenderer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var shader: typingsSlinky.pixiJs.PIXI.Shader = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def render(container: typingsSlinky.pixiJs.PIXI.ParticleContainer): Unit = js.native
  /**
  ...
  override def uploadPosition(
    children: js.Array[typingsSlinky.pixiJs.PIXI.DisplayObject],
    startIndex: Double,
    amount: Double,
