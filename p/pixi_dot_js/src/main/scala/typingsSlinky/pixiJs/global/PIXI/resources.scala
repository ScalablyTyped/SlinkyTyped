...
object resources {
  ...
  class CubeResource ()
    ...
    def this(source: js.Array[String | typingsSlinky.pixiJs.PIXI.resources.Resource], options: AutoLoad) = this()
  }
  object CubeResource {
  ...
  @JSGlobal("PIXI.resources.autoDetectResource")
  @js.native
  def autoDetectResource(source: String, options: Crossorigin): typingsSlinky.pixiJs.PIXI.resources.Resource = js.native
  @JSGlobal("PIXI.resources.autoDetectResource")
  @js.native
  def autoDetectResource(source: js.Any): typingsSlinky.pixiJs.PIXI.resources.Resource = js.native
  @JSGlobal("PIXI.resources.autoDetectResource")
  @js.native
  def autoDetectResource(source: js.Any, options: Crossorigin): typingsSlinky.pixiJs.PIXI.resources.Resource = js.native
}
