...
object Antialias {
  ...
  implicit class AntialiasOps[Self <: Antialias] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResizeToHTMLElement(value: HTMLElement): Self = this.set("resizeTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResizeToWindow(value: Window): Self = this.set("resizeTo", value.asInstanceOf[js.Any])
