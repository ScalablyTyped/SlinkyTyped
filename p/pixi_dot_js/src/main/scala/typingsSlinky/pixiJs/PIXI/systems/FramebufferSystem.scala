...
import typingsSlinky.pixiJs.PIXI.BUFFER_BITS
import typingsSlinky.pixiJs.PIXI.Framebuffer
import typingsSlinky.pixiJs.PIXI.GLFramebuffer
import typingsSlinky.pixiJs.PIXI.MSAA_QUALITY
