...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.pixiJs.pixiJsStrings.pointercancel
  - typingsSlinky.pixiJs.pixiJsStrings.pointerup
  - typingsSlinky.pixiJs.pixiJsStrings.pointertap
  - typingsSlinky.pixiJs.pixiJsStrings.pointerupoutside
  - typingsSlinky.pixiJs.pixiJsStrings.pointermove
  - typingsSlinky.pixiJs.pixiJsStrings.pointerover
  - typingsSlinky.pixiJs.pixiJsStrings.pointerout
*/
trait InteractionPointerEvents extends StObject
