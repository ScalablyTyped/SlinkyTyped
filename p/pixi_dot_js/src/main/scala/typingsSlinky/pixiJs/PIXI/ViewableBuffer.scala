...
trait ViewableBuffer extends js.Object {
  /**
    ...
    */
  var float32View: js.typedarray.Float32Array
  /**
    * View on the raw binary data as a `Int16Array`.
    *
    * @member {Int16Array}
    */
  var int16View: js.typedarray.Int16Array
  /**
    * View on the raw binary data as a `Int32Array`.
    *
    * @member {Int32Array}
    */
  var int32View: js.typedarray.Int32Array
  /**
    * View on the raw binary data as a `Int8Array`.
    *
    * @member {Int8Array}
    */
  var int8View: js.typedarray.Int8Array
  /**
    ...
    */
  var rawBinaryData: js.typedarray.ArrayBuffer
  /**
    * View on the raw binary data as a `Uint16Array`.
    *
    * @member {Uint16Array}
    */
  var uint16View: js.typedarray.Uint16Array
  /**
    * View on the raw binary data as a `Uint32Array`.
    *
    * @member {Uint32Array} PIXI.ViewableBuffer#uint32View
    */
  var uint32View: js.typedarray.Uint32Array
  /**
    * View on the raw binary data as a `Uint8Array`.
    *
    * @member {Uint8Array}
    */
  var uint8View: js.typedarray.Uint8Array
  /**
