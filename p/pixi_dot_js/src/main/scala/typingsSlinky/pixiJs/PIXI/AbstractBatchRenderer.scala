...
object AbstractBatchRenderer {
  ...
  implicit class AbstractBatchRendererOps[Self <: AbstractBatchRenderer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPackInterleavedGeometry(value: (Sprite, ViewableBuffer, js.typedarray.Uint16Array, Double, Double) => Unit): Self = this.set("packInterleavedGeometry", js.Any.fromFunction5(value))
    @scala.inline
