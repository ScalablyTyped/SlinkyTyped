...
object AbstractBatchRenderer {
  ...
  implicit class AbstractBatchRendererMutableBuilder[Self <: AbstractBatchRenderer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPackInterleavedGeometry(value: (Sprite, ViewableBuffer, js.typedarray.Uint16Array, Double, Double) => Unit): Self = StObject.set(x, "packInterleavedGeometry", js.Any.fromFunction5(value))
