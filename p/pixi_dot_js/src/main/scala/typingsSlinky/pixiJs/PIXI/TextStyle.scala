...
object TextStyle {
  ...
  implicit class TextStyleOps[Self <: TextStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFillCanvasPattern(value: CanvasPattern): Self = this.set("fill", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFillVarargs(value: (Double | String)*): Self = this.set("fill", js.Array(value :_*))
    
    @scala.inline
    def setFillCanvasGradient(value: CanvasGradient): Self = this.set("fill", value.asInstanceOf[js.Any])
