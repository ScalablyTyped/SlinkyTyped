...
object TextStyle {
  ...
  implicit class TextStyleMutableBuilder[Self <: TextStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFillCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFillCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
