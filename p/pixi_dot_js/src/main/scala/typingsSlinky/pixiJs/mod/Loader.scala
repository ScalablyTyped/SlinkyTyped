...
@js.native
class Loader ()
  extends typingsSlinky.pixiJs.PIXI.Loader {
...
object Loader {
  ...
  @js.native
  def registerPlugin(plugin: ILoaderPlugin): typingsSlinky.pixiJs.PIXI.Loader = js.native
  ...
  @js.native
  def shared: typingsSlinky.pixiJs.PIXI.Loader = js.native
  @scala.inline
  def shared_=(x: typingsSlinky.pixiJs.PIXI.Loader): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("shared")(x.asInstanceOf[js.Any])
}
