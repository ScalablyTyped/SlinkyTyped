...
object TilingSprite extends js.Object {
  ...
  /**
    ...
    */
  def from(source: String, width: Double, height: Double): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
  ...
  def from(source: typingsSlinky.pixiJs.PIXI.Texture, width: Double, height: Double): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
  ...
  def from(source: HTMLCanvasElement, width: Double, height: Double): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
  ...
  def from(source: HTMLVideoElement, width: Double, height: Double): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
  ...
  /**
    ...
    */
  def fromFrame(frameId: String, width: Double, height: Double): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
  ...
  /**
    ...
    */
  def fromImage(imageId: String, width: Double, height: Double): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
  def fromImage(imageId: String, width: Double, height: Double, options: js.Any): typingsSlinky.pixiJs.PIXI.TilingSprite = js.native
}
