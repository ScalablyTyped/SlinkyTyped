...
class AbstractBatchRenderer protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var _shader: typingsSlinky.pixiJs.PIXI.Shader = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var shaderGenerator: typingsSlinky.pixiJs.PIXI.BatchShaderGenerator = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def bindAndClearTexArray(texArray: typingsSlinky.pixiJs.PIXI.BatchTextureArray): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def buildDrawCalls(texArray: typingsSlinky.pixiJs.PIXI.BatchTextureArray, start: Double, finish: Double): Unit = js.native
  /**
  ...
  override def packInterleavedGeometry(
    element: typingsSlinky.pixiJs.PIXI.Sprite,
    attributeBuffer: typingsSlinky.pixiJs.PIXI.ViewableBuffer,
