...
object autoDetectResource extends js.Object {
  /**
    ...
    */
  def apply(source: String): typingsSlinky.pixiJs.PIXI.resources.Resource = js.native
  def apply(source: String, options: Crossorigin): typingsSlinky.pixiJs.PIXI.resources.Resource = js.native
