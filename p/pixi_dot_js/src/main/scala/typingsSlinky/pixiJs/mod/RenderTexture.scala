...
class RenderTexture protected ()
  extends typingsSlinky.pixiJs.PIXI.RenderTexture {
  def this(baseRenderTexture: typingsSlinky.pixiJs.PIXI.BaseRenderTexture) = this()
  def this(
    baseRenderTexture: typingsSlinky.pixiJs.PIXI.BaseRenderTexture,
