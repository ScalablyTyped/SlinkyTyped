...
trait Level extends js.Object {
  /**
    ...
    * defaulting to `info`).
    */
  var level: js.UndefOr[typingsSlinky.pino.mod.Level | String] = js.undefined
  /**
    * Remotely record log messages.
    *
    * @description Called after writing the log message.
    */
  def send(level: typingsSlinky.pino.mod.Level, logEvent: LogEvent): Unit
}

object Level {
  @scala.inline
  def apply(
    send: (typingsSlinky.pino.mod.Level, LogEvent) => Unit,
    level: typingsSlinky.pino.mod.Level | String = null
  ): Level = {
