...
trait Bindings extends js.Object {
  /**
    ...
    */
  var bindings: js.UndefOr[js.Function1[/* bindings */ typingsSlinky.pino.mod.Bindings, js.Object]] = js.undefined
  /**
...
object Bindings {
  @scala.inline
  def apply(
    bindings: /* bindings */ typingsSlinky.pino.mod.Bindings => js.Object = null,
