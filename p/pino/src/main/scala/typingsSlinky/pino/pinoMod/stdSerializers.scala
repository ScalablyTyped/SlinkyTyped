package typingsSlinky.pino.pinoMod

import typingsSlinky.node.httpMod.IncomingMessage
import typingsSlinky.node.httpMod.ServerResponse
import typingsSlinky.pinoDashStdDashSerializers.Anon_Req
import typingsSlinky.pinoDashStdDashSerializers.Anon_Res
import typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.CustomErrorSerializer
import typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.CustomRequestSerializer
import typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.CustomResponseSerializer
...
object stdSerializers extends js.Object {
  /**
    ...
    */
  @JSName("err")
  var err_Original: js.Function1[
    /* err */ js.Error, 
    typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedError
  ] = js.native
  /**
    * Returns an object:
    * ```
  ...
  var mapHttpRequest_Original: js.Function1[/* req */ IncomingMessage, Anon_Req] = js.native
  /**
    * Returns an object:
    * ```
    * {
  ...
  var mapHttpResponse_Original: js.Function1[/* res */ ServerResponse, Anon_Res] = js.native
  /**
    * Generates a JSONifiable object from the HTTP `request` object passed to the `createServer` callback of Node's HTTP server.
    */
  @JSName("req")
  var req_Original: js.Function1[
    /* req */ IncomingMessage, 
    typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedRequest
  ] = js.native
  /**
    * Generates a JSONifiable object from the HTTP `response` object passed to the `createServer` callback of Node's HTTP server.
    */
  @JSName("res")
  var res_Original: js.Function1[
    /* res */ ServerResponse, 
    typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedResponse
  ] = js.native
  /**
  ...
  /**
    * Serializes an Error object.
    */
  def err(err: js.Error): typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedError = js.native
  /**
    * Returns an object:
    * ```
    * {
  ...
  /**
    * Generates a JSONifiable object from the HTTP `request` object passed to the `createServer` callback of Node's HTTP server.
    */
  def req(req: IncomingMessage): typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedRequest = js.native
  /**
    * Generates a JSONifiable object from the HTTP `response` object passed to the `createServer` callback of Node's HTTP server.
    */
  def res(res: ServerResponse): typingsSlinky.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedResponse = js.native
  /**
    * A utility method for wrapping the default error serializer. Allows custom serializers to work with the
    * already serialized object.
    * @param customSerializer The custom error serializer. Accepts a single parameter: the newly serialized
