...
import typingsSlinky.pino.anon.LogMethod
...
import typingsSlinky.sonicBoom.mod.^
...
object mod {
  ...
  object stdSerializers {
    ...
    @js.native
    def err: js.Function1[/* err */ js.Error, typingsSlinky.pinoStdSerializers.mod.SerializedError] = js.native
    /**
      * Serializes an Error object.
      */
    @JSImport("pino", "stdSerializers.err")
    ...
    @scala.inline
    def err_=(x: js.Function1[/* err */ js.Error, typingsSlinky.pinoStdSerializers.mod.SerializedError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("err")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def req: js.Function1[/* req */ IncomingMessage, typingsSlinky.pinoStdSerializers.mod.SerializedRequest] = js.native
    /**
      * Generates a JSONifiable object from the HTTP `request` object passed to the `createServer` callback of Node's HTTP server.
      */
    @JSImport("pino", "stdSerializers.req")
    ...
    @scala.inline
    def req_=(x: js.Function1[/* req */ IncomingMessage, typingsSlinky.pinoStdSerializers.mod.SerializedRequest]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("req")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def res: js.Function1[/* res */ ServerResponse, typingsSlinky.pinoStdSerializers.mod.SerializedResponse] = js.native
    /**
      * Generates a JSONifiable object from the HTTP `response` object passed to the `createServer` callback of Node's HTTP server.
      */
    @JSImport("pino", "stdSerializers.res")
    ...
    @scala.inline
    def res_=(x: js.Function1[/* res */ ServerResponse, typingsSlinky.pinoStdSerializers.mod.SerializedResponse]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("res")(x.asInstanceOf[js.Any])
  ...
  */
  ...
  object LoggerOptions {
    ...
    implicit class LoggerOptionsMutableBuilder[Self <: LoggerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormatters(value: typingsSlinky.pino.anon.Bindings): Self = StObject.set(x, "formatters", value.asInstanceOf[js.Any])
