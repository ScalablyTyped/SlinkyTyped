...
object stdSerializers extends js.Object {
  /**
    ...
    */
  @JSName("err")
  var err_Original: js.Function1[/* err */ js.Error, typingsSlinky.pinoStdSerializers.mod.SerializedError] = js.native
  /**
    * Returns an object:
    * ```
    * {
  ...
  /**
    ...
    */
  @JSName("req")
  var req_Original: js.Function1[/* req */ IncomingMessage, typingsSlinky.pinoStdSerializers.mod.SerializedRequest] = js.native
  /**
    * Generates a JSONifiable object from the HTTP `response` object passed to the `createServer` callback of Node's HTTP server.
    */
  @JSName("res")
  var res_Original: js.Function1[/* res */ ServerResponse, typingsSlinky.pinoStdSerializers.mod.SerializedResponse] = js.native
  /**
  ...
  /**
    * Serializes an Error object.
    */
  def err(err: js.Error): typingsSlinky.pinoStdSerializers.mod.SerializedError = js.native
  /**
    * Returns an object:
    * ```
    * {
  ...
  /**
    * Generates a JSONifiable object from the HTTP `request` object passed to the `createServer` callback of Node's HTTP server.
    */
  def req(req: IncomingMessage): typingsSlinky.pinoStdSerializers.mod.SerializedRequest = js.native
  /**
    * Generates a JSONifiable object from the HTTP `response` object passed to the `createServer` callback of Node's HTTP server.
    */
  def res(res: ServerResponse): typingsSlinky.pinoStdSerializers.mod.SerializedResponse = js.native
  /**
    * A utility method for wrapping the default error serializer. Allows custom serializers to work with the
    * already serialized object.
    * @param customSerializer The custom error serializer. Accepts a single parameter: the newly serialized
