...
@js.native
trait GenerateOptionstypearrayb extends js.Object {
  /**
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    (base64 | string | uint8array | arraybuffer | blob | nodebuffer) with arraybuffer
  ] = js.native
}

object GenerateOptionstypearrayb {
  @scala.inline
  def apply(): GenerateOptionstypearrayb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GenerateOptionstypearrayb]
  }
  @scala.inline
  implicit class GenerateOptionstypearraybOps[Self <: GenerateOptionstypearrayb] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: (base64 | string | uint8array | arraybuffer | blob | nodebuffer) with arraybuffer): Self = {
        val ret = this.duplicate
