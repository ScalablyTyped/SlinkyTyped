...
object ZipObject {
  ...
  implicit class ZipObjectOps[Self <: ZipObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsArrayBuffer(value: () => js.typedarray.ArrayBuffer): Self = this.set("asArrayBuffer", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setAsUint8Array(value: () => js.typedarray.Uint8Array): Self = this.set("asUint8Array", js.Any.fromFunction0(value))
    @scala.inline
