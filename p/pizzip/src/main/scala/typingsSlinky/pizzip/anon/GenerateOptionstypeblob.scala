...
object GenerateOptionstypeblob {
  ...
  @scala.inline
  implicit class GenerateOptionstypeblobOps[Self <: GenerateOptionstypeblob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: (js.UndefOr[base64 | string | uint8array | arraybuffer | blob | nodebuffer]) with blob): Self = this.set("type", value.asInstanceOf[js.Any])
