...
trait GenerateOptionstypenodebu extends js.Object {
  ...
  /**
    ...
    * @default "base64"
    */
  var `type`: js.UndefOr[(base64 | string | uint8array | arraybuffer | blob | nodebuffer) with nodebuffer] = js.undefined
}
...
object GenerateOptionstypenodebu {
  ...
  def apply(
    ...
    `type`: (base64 | string | uint8array | arraybuffer | blob | nodebuffer) with nodebuffer = null
