...
import typingsSlinky.pizzip.Anon_Arraybuffer
import typingsSlinky.pizzip.Anon_Base64String
import typingsSlinky.pizzip.Anon_Blob
import typingsSlinky.pizzip.Anon_Nodebuffer
import typingsSlinky.pizzip.Anon_Type
...
trait PizZip extends js.Object {
  ...
  @JSName("generate")
  def generate_ArrayBuffer(options: GenerateOptions with Anon_Arraybuffer): scala.scalajs.js.typedarray.ArrayBuffer = js.native
  @JSName("generate")
  ...
  @JSName("generate")
  def generate_Uint8Array(options: GenerateOptions with Anon_Type): scala.scalajs.js.typedarray.Uint8Array = js.native
  /**
