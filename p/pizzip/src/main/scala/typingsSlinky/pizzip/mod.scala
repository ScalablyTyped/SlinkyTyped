...
object mod {
  ...
  */
  ...
  object Compression {
    ...
    @scala.inline
    def DEFLATE: typingsSlinky.pizzip.pizzipStrings.DEFLATE = "DEFLATE".asInstanceOf[typingsSlinky.pizzip.pizzipStrings.DEFLATE]
    
    @scala.inline
    def STORE: typingsSlinky.pizzip.pizzipStrings.STORE = "STORE".asInstanceOf[typingsSlinky.pizzip.pizzipStrings.STORE]
  }
  ...
  object LoadOptions {
    ...
    implicit class LoadOptionsMutableBuilder[Self <: LoadOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDecodeFileName(value: /* bytes */ js.typedarray.Uint8Array | js.Array[Double] => String): Self = StObject.set(x, "decodeFileName", js.Any.fromFunction1(value))
  ...
  object ZipObject {
    ...
    implicit class ZipObjectMutableBuilder[Self <: ZipObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAsArrayBuffer(value: () => js.typedarray.ArrayBuffer): Self = StObject.set(x, "asArrayBuffer", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setAsUint8Array(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "asUint8Array", js.Any.fromFunction0(value))
