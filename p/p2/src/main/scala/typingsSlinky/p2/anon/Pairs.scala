...
object Pairs {
  ...
  implicit class PairsOps[Self <: Pairs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPairsVarargs(value: typingsSlinky.p2.mod.Body*): Self = this.set("pairs", js.Array(value :_*))
    
    @scala.inline
    def setPairs(value: js.Array[typingsSlinky.p2.mod.Body]): Self = this.set("pairs", value.asInstanceOf[js.Any])
