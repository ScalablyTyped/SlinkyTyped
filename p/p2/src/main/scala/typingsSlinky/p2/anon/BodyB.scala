...
object BodyB {
  ...
  implicit class BodyBOps[Self <: BodyB] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBodyA(value: typingsSlinky.p2.mod.Body): Self = this.set("bodyA", value.asInstanceOf[js.Any])
    @scala.inline
    def setBodyB(value: typingsSlinky.p2.mod.Body): Self = this.set("bodyB", value.asInstanceOf[js.Any])
    @scala.inline
