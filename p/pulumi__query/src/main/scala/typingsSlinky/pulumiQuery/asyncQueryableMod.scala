...
import typingsSlinky.pulumiQuery.baseMod.IterableBase
...
import typingsSlinky.pulumiQuery.interfacesMod.AsyncQueryableGrouping
import typingsSlinky.pulumiQuery.interfacesMod.Operator
import typingsSlinky.pulumiQuery.interfacesMod.OrderKey
...
object asyncQueryableMod {
  ...
  class AsyncQueryableImpl[TSource] protected () extends IterableBase[TSource] {
    ...
    /**
      ...
      */
    def concat(iter: AsyncQuerySource[TSource]): AsyncQueryable[TSource] = js.native
    ...
    /**
      ...
      */
    def filter(f: js.Function2[/* t */ TSource, /* i */ Double, Boolean | js.Promise[Boolean]]): AsyncQueryable[TSource] = js.native
    ...
    /**
      ...
      */
    def flatMap[TInner, TResult](selector: js.Function2[/* t */ TSource, /* index */ Double, AsyncQuerySource[TInner]]): AsyncQueryable[TResult] = js.native
    ...
    /**
      ...
      */
    def groupBy[TKey, TResult](keySelector: js.Function1[/* t */ TSource, js.Promise[TKey] | TKey]): AsyncQueryable[AsyncQueryableGrouping[TKey, TResult]] = js.native
    ...
    def groupJoin[TInner, TKey, TResult](
      ...
      resultSelector: js.Function2[/* to */ TSource, /* ti */ AsyncQuerySource[TInner], js.Promise[TResult] | TResult]
    ): AsyncQueryable[TResult] = js.native
    ...
    /**
      ...
      */
    def map[TResult](f: js.Function2[/* t */ TSource, /* i */ Double, js.Promise[TResult] | TResult]): AsyncQueryable[TResult] = js.native
  ...
  - typingsSlinky.pulumiQuery.interfacesMod.AsyncIterator because Already inherited
  - typingsSlinky.pulumiQuery.interfacesMod.AsyncIterableIterator because Already inherited
  - typingsSlinky.pulumiQuery.interfacesMod.AsyncQueryable because Already inherited
  - typingsSlinky.pulumiQuery.interfacesMod.GroupedAsyncIterableIterator because var conflicts: `return`, `throw`. Inlined key
  - typingsSlinky.pulumiQuery.interfacesMod.AsyncQueryableGrouping because var conflicts: `return`, `throw`. Inlined  */ @JSImport("@pulumi/query/asyncQueryable", "GroupingImpl")
  @js.native
