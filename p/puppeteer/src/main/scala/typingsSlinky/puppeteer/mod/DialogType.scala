...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.puppeteer.puppeteerStrings.alert
  - typingsSlinky.puppeteer.puppeteerStrings.beforeunload
  - typingsSlinky.puppeteer.puppeteerStrings.confirm
  - typingsSlinky.puppeteer.puppeteerStrings.prompt
*/
