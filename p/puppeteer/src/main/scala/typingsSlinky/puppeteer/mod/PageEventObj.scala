...
object PageEventObj {
  ...
  implicit class PageEventObjMutableBuilder[Self <: PageEventObj] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMetrics(value: typingsSlinky.puppeteer.anon.Metrics): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPageerror(value: js.Error): Self = StObject.set(x, "pageerror", value.asInstanceOf[js.Any])
