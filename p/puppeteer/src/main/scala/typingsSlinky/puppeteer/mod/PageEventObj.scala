...
object PageEventObj {
  ...
  implicit class PageEventObjOps[Self <: PageEventObj] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMetrics(value: typingsSlinky.puppeteer.anon.Metrics): Self = this.set("metrics", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPageerror(value: js.Error): Self = this.set("pageerror", value.asInstanceOf[js.Any])
