...
import typingsSlinky.puppeteer.mod.ConsoleMessageType
import typingsSlinky.puppeteer.mod.DialogType
import typingsSlinky.puppeteer.mod.ErrorCode
import typingsSlinky.puppeteer.mod.HttpMethod
import typingsSlinky.puppeteer.mod.LoadEvent
import typingsSlinky.puppeteer.mod.MediaType
import typingsSlinky.puppeteer.mod.MouseButtons
