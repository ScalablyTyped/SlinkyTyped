...
import typingsSlinky.puppeteer.Anon_DelayNumber
import typingsSlinky.puppeteer.Anon_Text
...
trait Keyboard extends js.Object {
  ...
  def down(key: String, options: Anon_Text): js.Promise[Unit] = js.native
  ...
  def `type`(text: String, options: Anon_DelayNumber): js.Promise[Unit] = js.native
  /**
