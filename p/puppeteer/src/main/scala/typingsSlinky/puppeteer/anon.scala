...
import typingsSlinky.puppeteer.mod.LayoutDimension
...
object anon {
  ...
  trait Metrics extends StObject {
    ...
    var metrics: typingsSlinky.puppeteer.mod.Metrics = js.native
  ...
  object Metrics {
    ...
    implicit class MetricsMutableBuilder[Self <: Metrics] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMetrics(value: typingsSlinky.puppeteer.mod.Metrics): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
  ...
  object TimeoutError {
    ...
    implicit class TimeoutErrorMutableBuilder[Self <: TimeoutError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTimeoutError(value: js.Error): Self = StObject.set(x, "TimeoutError", value.asInstanceOf[js.Any])
    }
  }
}
