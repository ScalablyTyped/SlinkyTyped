...
object AnonBottom {
  ...
  implicit class AnonBottomOps[Self <: AnonBottom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBottom(value: LayoutDimension): Self = {
    ...
    @scala.inline
    def withLeft(value: LayoutDimension): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRight(value: LayoutDimension): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTop(value: LayoutDimension): Self = {
        val ret = this.duplicate
