...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAgent(value: Agent | typingsSlinky.node.httpsMod.Agent | Agents | `false`): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
  ...
  object PackageNotFoundErrorClass {
    ...
    implicit class PackageNotFoundErrorClassMutableBuilder[Self <: PackageNotFoundErrorClass] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.packageJson.packageJsonStrings.PackageNotFoundError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
  ...
  object VersionNotFoundErrorClass {
    ...
    implicit class VersionNotFoundErrorClassMutableBuilder[Self <: VersionNotFoundErrorClass] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.packageJson.packageJsonStrings.VersionNotFoundError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
}
