...
trait PackageNotFoundErrorClass extends Error {
  @JSName("name")
  val name_PackageNotFoundErrorClass: typingsSlinky.packageJson.packageJsonStrings.PackageNotFoundError
}
...
object PackageNotFoundErrorClass {
  ...
  def apply(
    message: String,
    name: typingsSlinky.packageJson.packageJsonStrings.PackageNotFoundError,
    stack: String = null
