package typingsSlinky.polygon.polygonMod

import typingsSlinky.polygon.Anon_H
import typingsSlinky.polygon.Anon_Height
import typingsSlinky.polygon.Anon_Position
import typingsSlinky.polygon.Anon_X1
...
trait Polygon extends js.Object {
  ...
  /**
    ...
    */
  def center(): typingsSlinky.vec2.vec2Mod.^ = js.native
  /**
  ...
  /**
    ...
    */
  def closestPointTo(vec2: typingsSlinky.vec2.vec2Mod.^): typingsSlinky.vec2.vec2Mod.^ = js.native
  /**
    ...
    */
  def contains(thing: js.Array[typingsSlinky.vec2.vec2Mod.^]): Boolean = js.native
  def contains(thing: Anon_H): Boolean = js.native
  def contains(thing: Anon_Height): Boolean = js.native
  def contains(thing: Anon_Position): Boolean = js.native
  def contains(thing: Anon_X1): Boolean = js.native
  /**
    * Returns true if `vec2` is inside the polygon
    */
  def containsPoint(vec2: typingsSlinky.vec2.vec2Mod.^): Boolean = js.native
  /**
  ...
  def each(
    fn: js.Function4[
      /* prev */ typingsSlinky.vec2.vec2Mod.^, 
      /* current */ typingsSlinky.vec2.vec2Mod.^, 
      /* next */ typingsSlinky.vec2.vec2Mod.^, 
      /* idx */ Double, 
      _
    ]
  ): Polygon = js.native
  ...
  /**
    ...
    */
  def insert(vec2: typingsSlinky.vec2.vec2Mod.^, index: Double): Unit = js.native
  /**
    * Return an array `[startpoint, endpoint]` representing the line at the specified `index`
    */
  def line(index: Double): js.Tuple2[typingsSlinky.vec2.vec2Mod.^, typingsSlinky.vec2.vec2Mod.^] = js.native
  /**
    * Iterate over the lines in this polygon
    */
  def lines(
    fn: js.Function3[
      /* start */ typingsSlinky.vec2.vec2Mod.^, 
      /* end */ typingsSlinky.vec2.vec2Mod.^, 
      /* index */ Double, 
      _
    ]
  ): Polygon = js.native
  ...
  /**
    ...
    */
  def point(idx: Double): typingsSlinky.vec2.vec2Mod.^ = js.native
  /**
  ...
  /**
    ...
    */
  def remove(vecOrIndex: typingsSlinky.vec2.vec2Mod.^): Polygon = js.native
  /**
  ...
  /**
    ...
    */
  def rotate(rads: Double, vec2: typingsSlinky.vec2.vec2Mod.^): Polygon = js.native
  def rotate(rads: Double, vec2: typingsSlinky.vec2.vec2Mod.^, returnNew: Boolean): Polygon = js.native
  /**
    * Scales this polygon around `origin` (default is `this.center()`) and will return a new polygon if requested with `returnNew`
    */
  def scale(amount: Double, origin: typingsSlinky.vec2.vec2Mod.^): Polygon = js.native
  def scale(amount: Double, origin: typingsSlinky.vec2.vec2Mod.^, returnNew: Boolean): Polygon = js.native
  /**
  ...
  /**
    ...
    */
  def translate(vec2: typingsSlinky.vec2.vec2Mod.^): Polygon = js.native
  def translate(vec2: typingsSlinky.vec2.vec2Mod.^, returnNew: Boolean): Polygon = js.native
  /**
