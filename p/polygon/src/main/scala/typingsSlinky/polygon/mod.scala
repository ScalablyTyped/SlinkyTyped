package typingsSlinky.polygon

import typingsSlinky.polygon.anon.H
import typingsSlinky.polygon.anon.Height
import typingsSlinky.polygon.anon.Position
import typingsSlinky.polygon.anon.X
import typingsSlinky.polygon.anon.X1
...
object mod {
  ...
  class ^ protected () extends Polygon {
    def this(points: js.Array[js.Array[Double] | X | typingsSlinky.vec2.mod.^]) = this()
  }
  ...
  trait Polygon extends StObject {
    ...
    /**
      ...
      */
    def center(): typingsSlinky.vec2.mod.^ = js.native
    ...
    /**
      ...
      */
    def closestPointTo(vec2: typingsSlinky.vec2.mod.^): typingsSlinky.vec2.mod.^ = js.native
    ...
    /**
      ...
      */
    def contains(thing: js.Array[typingsSlinky.vec2.mod.^]): Boolean = js.native
    ...
    /**
      ...
      */
    def containsPoint(vec2: typingsSlinky.vec2.mod.^): Boolean = js.native
    ...
    def each(
      fn: js.Function4[
          /* prev */ typingsSlinky.vec2.mod.^, 
          /* current */ typingsSlinky.vec2.mod.^, 
          /* next */ typingsSlinky.vec2.mod.^, 
          /* idx */ Double, 
          _
        ]
    ): Polygon = js.native
    ...
    /**
      ...
      */
    def insert(vec2: typingsSlinky.vec2.mod.^, index: Double): Unit = js.native
    ...
    /**
      ...
      */
    def line(index: Double): js.Tuple2[typingsSlinky.vec2.mod.^, typingsSlinky.vec2.mod.^] = js.native
    ...
    def lines(
      fn: js.Function3[
          /* start */ typingsSlinky.vec2.mod.^, 
          /* end */ typingsSlinky.vec2.mod.^, 
          /* index */ Double, 
          _
        ]
    ): Polygon = js.native
    ...
    /**
      ...
      */
    def point(idx: Double): typingsSlinky.vec2.mod.^ = js.native
    
    val points: js.Array[typingsSlinky.vec2.mod.^] = js.native
    ...
    /**
      ...
      */
    def remove(vecOrIndex: typingsSlinky.vec2.mod.^): Polygon = js.native
    ...
    /**
      ...
      */
    def rotate(rads: Double, vec2: typingsSlinky.vec2.mod.^): Polygon = js.native
    def rotate(rads: Double, vec2: typingsSlinky.vec2.mod.^, returnNew: Boolean): Polygon = js.native
    
    /**
      * Scales this polygon around `origin` (default is `this.center()`) and will return a new polygon if requested with `returnNew`
      */
    def scale(amount: Double, origin: typingsSlinky.vec2.mod.^): Polygon = js.native
    def scale(amount: Double, origin: typingsSlinky.vec2.mod.^, returnNew: Boolean): Polygon = js.native
    ...
    /**
      ...
      */
    def translate(vec2: typingsSlinky.vec2.mod.^): Polygon = js.native
    def translate(vec2: typingsSlinky.vec2.mod.^, returnNew: Boolean): Polygon = js.native
