...
object mod {
  ...
  */
  ...
  object AnonymityLevel {
    ...
    @scala.inline
    def anonymous: typingsSlinky.proxyVerifier.proxyVerifierStrings.anonymous = "anonymous".asInstanceOf[typingsSlinky.proxyVerifier.proxyVerifierStrings.anonymous]
    
    @scala.inline
    def elite: typingsSlinky.proxyVerifier.proxyVerifierStrings.elite = "elite".asInstanceOf[typingsSlinky.proxyVerifier.proxyVerifierStrings.elite]
    
    @scala.inline
    def transparent: typingsSlinky.proxyVerifier.proxyVerifierStrings.transparent = "transparent".asInstanceOf[typingsSlinky.proxyVerifier.proxyVerifierStrings.transparent]
  }
  ...
  */
  ...
  object CustomTestResult {
    ...
    @scala.inline
    def CustomTestNotWorkingResult(data: String, error: Code, headers: Headers, ok: `false`, status: Double): typingsSlinky.proxyVerifier.mod.CustomTestNotWorkingResult = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], error = error.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], ok = ok.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.proxyVerifier.mod.CustomTestNotWorkingResult]
    }
    
    @scala.inline
    def CustomTestWorkingResult(data: String, headers: Headers, ok: `true`, status: Double): typingsSlinky.proxyVerifier.mod.CustomTestWorkingResult = {
      ...
      __obj.asInstanceOf[typingsSlinky.proxyVerifier.mod.CustomTestWorkingResult]
    }
  }
  ...
  */
  ...
  object Result {
    ...
    @scala.inline
    def NotWorkingResult(error: Code, ok: `false`): typingsSlinky.proxyVerifier.mod.NotWorkingResult = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], ok = ok.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.proxyVerifier.mod.NotWorkingResult]
    }
    
    @scala.inline
    def WorkingResult(ok: `true`): typingsSlinky.proxyVerifier.mod.WorkingResult = {
      val __obj = js.Dynamic.literal(ok = ok.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.proxyVerifier.mod.WorkingResult]
    }
  }
