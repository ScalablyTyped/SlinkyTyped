...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.pkgConf.mod.Config */ ConfigType](): Options[ConfigType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[ConfigType]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_], /* <: typingsSlinky.pkgConf.mod.Config */ ConfigType] (val x: Self with Options[ConfigType]) extends AnyVal {
    @scala.inline
