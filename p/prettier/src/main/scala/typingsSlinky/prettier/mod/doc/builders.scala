...
object builders {
  ...
  */
  ...
  object _Doc {
    ...
    @scala.inline
    def Align_(contents: Doc, n: Double | String | Type, `type`: align): typingsSlinky.prettier.mod.doc.builders.Align_ = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any], n = n.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Align_]
    }
    
    @scala.inline
    def BreakParent_(`type`: `break-parent`): typingsSlinky.prettier.mod.doc.builders.BreakParent_ = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.BreakParent_]
    }
    
    @scala.inline
    def Concat_(parts: js.Array[Doc], `type`: concat): typingsSlinky.prettier.mod.doc.builders.Concat_ = {
      val __obj = js.Dynamic.literal(parts = parts.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Concat_]
    }
    
    @scala.inline
    def Cursor_(placeholder: js.Symbol, `type`: typingsSlinky.prettier.prettierStrings.cursor): typingsSlinky.prettier.mod.doc.builders.Cursor_ = {
      val __obj = js.Dynamic.literal(placeholder = placeholder.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Cursor_]
    }
    
    @scala.inline
    def Fill_(parts: js.Array[Doc], `type`: fill): typingsSlinky.prettier.mod.doc.builders.Fill_ = {
      val __obj = js.Dynamic.literal(parts = parts.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Fill_]
    }
    
    @scala.inline
    def Group_(break: Boolean, contents: Doc, expandedStates: js.Array[Doc], `type`: group): typingsSlinky.prettier.mod.doc.builders.Group_ = {
      val __obj = js.Dynamic.literal(break = break.asInstanceOf[js.Any], contents = contents.asInstanceOf[js.Any], expandedStates = expandedStates.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Group_]
    }
    
    @scala.inline
    def IfBreak_(breakContents: Doc, flatContents: Doc, `type`: `if-break`): typingsSlinky.prettier.mod.doc.builders.IfBreak_ = {
      val __obj = js.Dynamic.literal(breakContents = breakContents.asInstanceOf[js.Any], flatContents = flatContents.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.IfBreak_]
    }
    
    @scala.inline
    def Indent_(contents: Doc, `type`: indent): typingsSlinky.prettier.mod.doc.builders.Indent_ = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Indent_]
    }
    
    @scala.inline
    def LineSuffixBoundary_(`type`: `line-suffix-boundary`): typingsSlinky.prettier.mod.doc.builders.LineSuffixBoundary_ = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.LineSuffixBoundary_]
    }
    
    @scala.inline
    def LineSuffix_(contents: Doc, `type`: `line-suffix`): typingsSlinky.prettier.mod.doc.builders.LineSuffix_ = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.LineSuffix_]
    }
    
    @scala.inline
    def Line_(`type`: typingsSlinky.prettier.prettierStrings.line): typingsSlinky.prettier.mod.doc.builders.Line_ = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Line_]
    }
    
    @scala.inline
    def Trim_(`type`: typingsSlinky.prettier.prettierStrings.trim): typingsSlinky.prettier.mod.doc.builders.Trim_ = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.prettier.mod.doc.builders.Trim_]
    }
  }
}
