...
object Config {
  @scala.inline
  def apply[/* <: typingsSlinky.pg.mod.Client */ T](): Config[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Config[T]]
  }
  @scala.inline
  implicit class ConfigOps[Self <: Config[_], /* <: typingsSlinky.pg.mod.Client */ T] (val x: Self with Config[T]) extends AnyVal {
    @scala.inline
