...
object ResponseDefinition {
  ...
  implicit class ResponseDefinitionOps[Self <: ResponseDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStreamUint8Array(value: js.typedarray.Uint8Array): Self = this.set("stream", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStream(value: Buffer | js.typedarray.Uint8Array): Self = this.set("stream", value.asInstanceOf[js.Any])
