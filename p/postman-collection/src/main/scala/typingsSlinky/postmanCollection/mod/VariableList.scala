...
class VariableList protected () extends PropertyList[Variable] {
  ...
  def syncFromObject(obj: StringDictionary[VariableDefinition]): js.UndefOr[AnonCreated] = js.native
  def syncFromObject(obj: StringDictionary[VariableDefinition], track: Boolean): js.UndefOr[AnonCreated] = js.native
  def syncFromObject(obj: StringDictionary[VariableDefinition], track: Boolean, prune: Boolean): js.UndefOr[AnonCreated] = js.native
