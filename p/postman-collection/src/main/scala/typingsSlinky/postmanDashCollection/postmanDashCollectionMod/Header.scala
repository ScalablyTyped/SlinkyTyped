...
- typings.postmanDashCollection.postmanDashCollectionMod.HeaderDefinition because var conflicts: description, disabled, id, name. Inlined key, value, system */ @JSImport("postman-collection", "Header")
@js.native
