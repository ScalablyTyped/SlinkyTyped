...
object mod extends js.Object {
  ...
  class BPlusTree[T] protected ()
    extends typingsSlinky.phosphorCollections.bplustreeMod.BPlusTree[T] {
    /**
  ...
  /**
    ...
    */
  class LinkedList[T] ()
    extends typingsSlinky.phosphorCollections.linkedlistMod.LinkedList[T]
  ...
  object BPlusTree extends js.Object {
    /**
      ...
      * `O(n log32 n)`
      */
    def from[T](items: IterableOrArrayLike[T], cmp: js.Function2[/* a */ T, /* b */ T, Double]): typingsSlinky.phosphorCollections.bplustreeMod.BPlusTree[T] = js.native
  }
  ...
  object LinkedList extends js.Object {
    ...
    class ForwardNodeIterator[T] ()
      extends typingsSlinky.phosphorCollections.linkedlistMod.LinkedList.ForwardNodeIterator[T] {
      /**
    ...
    class ForwardValueIterator[T] ()
      extends typingsSlinky.phosphorCollections.linkedlistMod.LinkedList.ForwardValueIterator[T] {
      /**
    ...
    class RetroNodeIterator[T] ()
      extends typingsSlinky.phosphorCollections.linkedlistMod.LinkedList.RetroNodeIterator[T] {
      /**
    ...
    class RetroValueIterator[T] ()
      extends typingsSlinky.phosphorCollections.linkedlistMod.LinkedList.RetroValueIterator[T] {
      /**
    ...
    /**
      ...
      * Linear.
      */
    def from[T](values: IterableOrArrayLike[T]): typingsSlinky.phosphorCollections.linkedlistMod.LinkedList[T] = js.native
  }
