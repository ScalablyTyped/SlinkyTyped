package typingsSlinky.atPhosphorCollections.libLinkedlistMod.LinkedList
...
trait INode[T] extends js.Object {
  /**
    ...
    */
  val list: typingsSlinky.atPhosphorCollections.libLinkedlistMod.LinkedList[T] | Null
  /**
...
object INode {
  ...
  def apply[T](
    value: T,
    list: typingsSlinky.atPhosphorCollections.libLinkedlistMod.LinkedList[T] = null,
    next: INode[T] = null,
    prev: INode[T] = null
  ): INode[T] = {
