package typingsSlinky.passportApple.anon

import typingsSlinky.passportApple.passportAppleStrings.`name email`
import typingsSlinky.passportApple.passportAppleStrings.form_post
