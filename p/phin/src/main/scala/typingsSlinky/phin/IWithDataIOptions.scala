...
trait IWithDataIOptions extends js.Object {
  ...
  var data: AnonToString = js.native
...
object IWithDataIOptions {
  @scala.inline
  def apply(data: AnonToString, url: String): IWithDataIOptions = {
  ...
  @scala.inline
  implicit class IWithDataIOptionsOps[Self <: IWithDataIOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withData(value: AnonToString): Self = {
