...
object mod {
  ...
  object defaultProps {
    ...
    @js.native
    def children: js.UndefOr[ReactElement] = js.native
    @scala.inline
    def children_=(x: js.UndefOr[ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def document: js.UndefOr[org.scalajs.dom.raw.Document] = js.native
    @scala.inline
    def document_=(x: js.UndefOr[org.scalajs.dom.raw.Document]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("document")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def loader: js.UndefOr[ReactElement] = js.native
    @scala.inline
    def loader_=(x: js.UndefOr[ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("loader")(x.asInstanceOf[js.Any])
  ...
  type AlertHandler = js.Function1[/* err */ Err, ReactElement]
  ...
  object PDFViewerProps {
    ...
    @scala.inline
    def apply(document: org.scalajs.dom.raw.Document): PDFViewerProps = {
    ...
    implicit class PDFViewerPropsMutableBuilder[Self <: PDFViewerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlert(value: /* err */ Err => ReactElement): Self = StObject.set(x, "alert", js.Any.fromFunction1(value))
