package typingsSlinky.pahoMqtt.mod._Global_.Paho
...
package object MQTT {
  /**
    ...
    *  <li>errorMessage
    */
  type OnConnectionLostHandler = js.Function1[/* error */ typingsSlinky.pahoMqtt.mod._Global_.Paho.MQTT.MQTTError, scala.Unit]
  /**
  ...
  type OnFailureCallback = js.Function1[
    /* e */ typingsSlinky.pahoMqtt.mod._Global_.Paho.MQTT.ErrorWithInvocationContext, 
    scala.Unit
  ]
  /**
    ...
    */
  type OnMessageHandler = js.Function1[/* message */ typingsSlinky.pahoMqtt.mod._Global_.Paho.MQTT.Message, scala.Unit]
  /**
  ...
  type OnSubscribeSuccessCallback = js.Function1[
    /* o */ typingsSlinky.pahoMqtt.mod._Global_.Paho.MQTT.OnSubscribeSuccessParams, 
    scala.Unit
  ]
  /**
  ...
  type OnSuccessCallback = js.Function1[
    /* o */ typingsSlinky.pahoMqtt.mod._Global_.Paho.MQTT.WithInvocationContext, 
    scala.Unit
  ]
  type TraceFunction = js.Function1[
    /* element */ typingsSlinky.pahoMqtt.mod._Global_.Paho.MQTT.TraceElement, 
    scala.Unit
  ]
