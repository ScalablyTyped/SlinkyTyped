...
object Qos {
  @scala.inline
  def `0`: typingsSlinky.pahoMqtt.pahoMqttNumbers.`0` = this.cast(0)
  @scala.inline
  def `1`: typingsSlinky.pahoMqtt.pahoMqttNumbers.`1` = this.cast(1)
  @scala.inline
  def `2`: typingsSlinky.pahoMqtt.pahoMqttNumbers.`2` = this.cast(2)
  @scala.inline
