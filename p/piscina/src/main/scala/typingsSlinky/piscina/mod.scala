...
import typingsSlinky.piscina.commonMod.TaskQueue
import typingsSlinky.piscina.commonMod.Transferable
import typingsSlinky.piscina.piscinaStrings.abort
import typingsSlinky.piscina.piscinaStrings.auto
...
object mod {
  ...
  @js.native
  def move(`val`: js.typedarray.ArrayBufferView): js.typedarray.ArrayBufferView | Transferable = js.native
  /* static member */
  @JSImport("piscina", "move")
  @js.native
  def move(`val`: Transferable): js.typedarray.ArrayBufferView | Transferable = js.native
  @JSImport("piscina", "move")
  @js.native
  def move(`val`: TransferListItem): js.typedarray.ArrayBufferView | Transferable = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.piscina.mod.AbortSignalEventTarget
    - typingsSlinky.piscina.mod.AbortSignalEventEmitter
  */
  ...
  @js.native
  trait Piscina
    extends typingsSlinky.eventemitterAsyncresource.mod.^ {
