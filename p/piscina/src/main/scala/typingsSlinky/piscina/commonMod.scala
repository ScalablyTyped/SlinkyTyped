...
import typingsSlinky.node.workerThreadsMod.MessagePort
import typingsSlinky.piscina.piscinaBooleans.`true`
...
object commonMod {
  ...
  trait StartupMessage extends StObject {
    ...
    var sharedBuffer: js.typedarray.Int32Array = js.native
  ...
  object StartupMessage {
    ...
    implicit class StartupMessageMutableBuilder[Self <: StartupMessage] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSharedBuffer(value: js.typedarray.Int32Array): Self = StObject.set(x, "sharedBuffer", value.asInstanceOf[js.Any])
