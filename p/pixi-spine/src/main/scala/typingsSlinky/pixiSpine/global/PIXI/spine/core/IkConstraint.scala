...
class IkConstraint protected ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.IkConstraint {
  def this(
    data: typingsSlinky.pixiSpine.PIXI.spine.core.IkConstraintData,
  ...
  /* CompleteClass */
  override var data: typingsSlinky.pixiSpine.PIXI.spine.core.IkConstraintData = js.native
  /* CompleteClass */
  ...
  override def apply2(
    ...
    child: typingsSlinky.pixiSpine.PIXI.spine.core.Bone,
    targetX: Double,
    targetY: Double,
    bendDir: Double,
    stretch: Boolean,
