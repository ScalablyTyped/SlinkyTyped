...
class TextureAtlasRegion ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.TextureAtlasRegion {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var page: typingsSlinky.pixiSpine.PIXI.spine.core.TextureAtlasPage = js.native
  /* CompleteClass */
