...
class Bone protected ()
  ...
  /* CompleteClass */
  override var children: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.Bone] = js.native
  /* CompleteClass */
  override var data: typingsSlinky.pixiSpine.PIXI.spine.core.BoneData = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var parent: typingsSlinky.pixiSpine.PIXI.spine.core.Bone = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var skeleton: typingsSlinky.pixiSpine.PIXI.spine.core.Skeleton = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def localToWorld(local: typingsSlinky.pixiSpine.PIXI.spine.core.Vector2): typingsSlinky.pixiSpine.PIXI.spine.core.Vector2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def worldToLocal(world: typingsSlinky.pixiSpine.PIXI.spine.core.Vector2): typingsSlinky.pixiSpine.PIXI.spine.core.Vector2 = js.native
  /* CompleteClass */
