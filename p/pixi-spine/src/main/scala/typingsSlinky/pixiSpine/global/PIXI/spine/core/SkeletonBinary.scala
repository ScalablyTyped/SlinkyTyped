...
import typingsSlinky.pixiSpine.PIXI.spine.core.AttachmentLoader
...
class SkeletonBinary protected ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.SkeletonBinary {
...
object SkeletonBinary {
  ...
  @js.native
  def BlendModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.BlendMode] = js.native
  @scala.inline
  def BlendModeValues_=(x: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.BlendMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BlendModeValues")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def PositionModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.PositionMode] = js.native
  @scala.inline
  def PositionModeValues_=(x: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.PositionMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PositionModeValues")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("PIXI.spine.core.SkeletonBinary.RotateModeValues")
  @js.native
  def RotateModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.RotateMode] = js.native
  @scala.inline
  def RotateModeValues_=(x: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.RotateMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RotateModeValues")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SpacingModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.SpacingMode] = js.native
  @scala.inline
  def SpacingModeValues_=(x: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.SpacingMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpacingModeValues")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("PIXI.spine.core.SkeletonBinary.TransformModeValues")
  @js.native
  def TransformModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.TransformMode] = js.native
  @scala.inline
  def TransformModeValues_=(x: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.TransformMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TransformModeValues")(x.asInstanceOf[js.Any])
}
