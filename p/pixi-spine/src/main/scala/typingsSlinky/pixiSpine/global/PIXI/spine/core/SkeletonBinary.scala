...
class SkeletonBinary protected ()
  ...
  /* CompleteClass */
  override def readSkeletonData(binary: js.typedarray.Uint8Array): typingsSlinky.pixiSpine.PIXI.spine.core.SkeletonData = js.native
  /* CompleteClass */
  override def setCurve(
    timeline: typingsSlinky.pixiSpine.PIXI.spine.core.CurveTimeline,
    frameIndex: Double,
    cx1: Double,
    cy1: Double,
    cx2: Double,
...
object SkeletonBinary extends js.Object {
  ...
  var BlendModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.BlendMode] = js.native
  ...
  var PositionModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.PositionMode] = js.native
  var RotateModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.RotateMode] = js.native
  var SLOT_ATTACHMENT: Double = js.native
  var SLOT_COLOR: Double = js.native
  var SLOT_TWO_COLOR: Double = js.native
  var SpacingModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.SpacingMode] = js.native
  var TransformModeValues: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.TransformMode] = js.native
}
