...
class ColorTimeline protected ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.ColorTimeline {
...
object ColorTimeline {
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.A")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.B")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.ENTRIES")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.G")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.PREV_A")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.PREV_B")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.PREV_G")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.PREV_R")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.PREV_TIME")
  @js.native
  ...
  /* static member */
  @JSGlobal("PIXI.spine.core.ColorTimeline.R")
  @js.native
