...
class PointAttachment protected ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.PointAttachment {
  ...
  /* CompleteClass */
  override def computeWorldPosition(
    bone: typingsSlinky.pixiSpine.PIXI.spine.core.Bone,
    point: typingsSlinky.pixiSpine.PIXI.spine.core.Vector2
  ): typingsSlinky.pixiSpine.PIXI.spine.core.Vector2 = js.native
  /* CompleteClass */
  override def computeWorldRotation(bone: typingsSlinky.pixiSpine.PIXI.spine.core.Bone): Double = js.native
  /* CompleteClass */
