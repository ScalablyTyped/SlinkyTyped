...
class PathConstraint protected ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.PathConstraint {
  def this(
    data: typingsSlinky.pixiSpine.PIXI.spine.core.PathConstraintData,
  ...
  /* CompleteClass */
  override var data: typingsSlinky.pixiSpine.PIXI.spine.core.PathConstraintData = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var target: typingsSlinky.pixiSpine.PIXI.spine.core.Slot = js.native
  /* CompleteClass */
  ...
  override def computeWorldPositions(
    path: typingsSlinky.pixiSpine.PIXI.spine.core.PathAttachment,
    spacesCount: Double,
    tangents: Boolean,
