...
class DeformTimeline protected ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.DeformTimeline {
  def this(frameCount: Double) = this()
  /* CompleteClass */
  override var attachment: typingsSlinky.pixiSpine.PIXI.spine.core.VertexAttachment = js.native
  /* CompleteClass */
