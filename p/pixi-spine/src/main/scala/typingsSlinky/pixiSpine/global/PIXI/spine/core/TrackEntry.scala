...
@js.native
class TrackEntry ()
  extends typingsSlinky.pixiSpine.PIXI.spine.core.TrackEntry {
  /* CompleteClass */
  override var alpha: Double = js.native
  /* CompleteClass */
  override var animation: typingsSlinky.pixiSpine.PIXI.spine.core.Animation = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var mixBlend: typingsSlinky.pixiSpine.PIXI.spine.core.MixBlend = js.native
  /* CompleteClass */
  override var mixDuration: Double = js.native
  /* CompleteClass */
  override var mixTime: Double = js.native
  /* CompleteClass */
  override var mixingFrom: typingsSlinky.pixiSpine.PIXI.spine.core.TrackEntry = js.native
  /* CompleteClass */
  override var mixingTo: typingsSlinky.pixiSpine.PIXI.spine.core.TrackEntry = js.native
  /* CompleteClass */
  override var next: typingsSlinky.pixiSpine.PIXI.spine.core.TrackEntry = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var timelineHoldMix: js.Array[typingsSlinky.pixiSpine.PIXI.spine.core.TrackEntry] = js.native
  /* CompleteClass */
