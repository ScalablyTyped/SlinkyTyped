...
object Bone {
  ...
  implicit class BoneOps[Self <: Bone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMatrix(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PIXI.Matrix */ js.Any
    ...
    @scala.inline
    def setWorldX(value: () => Double): Self = this.set("worldX", js.Any.fromFunction0(value))
    @scala.inline
    def setWorldY(value: () => Double): Self = this.set("worldY", js.Any.fromFunction0(value))
    @scala.inline
