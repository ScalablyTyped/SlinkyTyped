...
object MixDirection extends js.Object {
  ...
  /* 0 */ val mixIn: typingsSlinky.pixiDashSpine.PIXI.spine.core.MixDirection.mixIn with Double = js.native
  /* 1 */ val mixOut: typingsSlinky.pixiDashSpine.PIXI.spine.core.MixDirection.mixOut with Double = js.native
  @JSBracketAccess
