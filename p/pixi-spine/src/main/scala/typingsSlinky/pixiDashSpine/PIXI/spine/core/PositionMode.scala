...
object PositionMode extends js.Object {
  ...
  /* 0 */ val Fixed: typingsSlinky.pixiDashSpine.PIXI.spine.core.PositionMode.Fixed with Double = js.native
  /* 1 */ val Percent: typingsSlinky.pixiDashSpine.PIXI.spine.core.PositionMode.Percent with Double = js.native
  @JSBracketAccess
