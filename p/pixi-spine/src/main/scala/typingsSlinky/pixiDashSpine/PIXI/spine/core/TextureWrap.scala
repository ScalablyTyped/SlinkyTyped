...
object TextureWrap extends js.Object {
  ...
  /* 33071 */ val ClampToEdge: typingsSlinky.pixiDashSpine.PIXI.spine.core.TextureWrap.ClampToEdge with Double = js.native
  /* 33648 */ val MirroredRepeat: typingsSlinky.pixiDashSpine.PIXI.spine.core.TextureWrap.MirroredRepeat with Double = js.native
  /* 10497 */ val Repeat: typingsSlinky.pixiDashSpine.PIXI.spine.core.TextureWrap.Repeat with Double = js.native
  @JSBracketAccess
