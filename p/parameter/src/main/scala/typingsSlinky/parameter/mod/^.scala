...
object ^ extends js.Object {
  ...
  def addRule[T /* <: String */](`type`: T, check: js.RegExp): Unit = js.native
  def addRule[T /* <: String */](`type`: T, check: js.RegExp, convertType: ParameterConvertType): Unit = js.native
  def addRule[T /* <: String */](
    `type`: T,
    check: js.RegExp,
    `override`: js.UndefOr[scala.Nothing],
  ...
  def addRule[T /* <: String */](`type`: T, check: js.RegExp, `override`: Boolean): Unit = js.native
  def addRule[T /* <: String */](`type`: T, check: js.RegExp, `override`: Boolean, convertType: ParameterConvertType): Unit = js.native
}
