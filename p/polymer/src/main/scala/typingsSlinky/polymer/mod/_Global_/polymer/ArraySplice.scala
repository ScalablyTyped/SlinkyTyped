...
object ArraySplice {
  ...
  implicit class ArraySpliceOps[Self <: ArraySplice] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCalculateSplices(value: (js.Array[js.Any], js.Array[js.Any]) => js.Array[PolymerSplice]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calculateSplices")(js.Any.fromFunction2(value))
        ret
    }
  }
