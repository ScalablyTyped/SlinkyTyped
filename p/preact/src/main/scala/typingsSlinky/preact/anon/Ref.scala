...
trait Ref[RefType] extends js.Object {
  ...
  var ref: js.UndefOr[typingsSlinky.preact.mod.Ref[RefType]] = js.native
}
...
object Ref {
  ...
  @scala.inline
  implicit class RefOps[Self[reftype] <: Ref[reftype], RefType] (val x: Self[RefType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRef(value: typingsSlinky.preact.mod.Ref[RefType]): Self[RefType] = {
        val ret = this.duplicate
