...
object CurrentTarget {
  @scala.inline
  def apply[/* <: typingsSlinky.std.EventTarget */ Target](currentTarget: Target): CurrentTarget[Target] = {
    val __obj = js.Dynamic.literal(currentTarget = currentTarget.asInstanceOf[js.Any])
    __obj.asInstanceOf[CurrentTarget[Target]]
  }
  @scala.inline
  implicit class CurrentTargetOps[Self <: CurrentTarget[_], /* <: typingsSlinky.std.EventTarget */ Target] (val x: Self with CurrentTarget[Target]) extends AnyVal {
    @scala.inline
