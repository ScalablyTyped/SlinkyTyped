...
object h {
  ...
  object JSX {
    ...
    object HTMLAttributes {
      ...
      @scala.inline
      def apply[RefType /* <: EventTarget */](): typingsSlinky.preact.mod.h.JSX.HTMLAttributes[RefType] = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.preact.mod.h.JSX.HTMLAttributes[RefType]]
      }
      
      @scala.inline
      implicit class HTMLAttributesMutableBuilder[Self <: typingsSlinky.preact.mod.h.JSX.HTMLAttributes[_], RefType /* <: EventTarget */] (val x: Self with typingsSlinky.preact.mod.h.JSX.HTMLAttributes[RefType]) extends AnyVal {
    ...
    object SVGAttributes {
      ...
      @scala.inline
      def apply[Target /* <: EventTarget */](): typingsSlinky.preact.mod.h.JSX.SVGAttributes[Target] = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.preact.mod.h.JSX.SVGAttributes[Target]]
      }
      
      @scala.inline
      implicit class SVGAttributesMutableBuilder[Self <: typingsSlinky.preact.mod.h.JSX.SVGAttributes[_], Target /* <: EventTarget */] (val x: Self with typingsSlinky.preact.mod.h.JSX.SVGAttributes[Target]) extends AnyVal {
