...
object SVGAttributes {
  @scala.inline
  def apply[/* <: typingsSlinky.std.EventTarget */ Target](): SVGAttributes[Target] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGAttributes[Target]]
  }
  @scala.inline
  implicit class SVGAttributesOps[Self <: SVGAttributes[_], /* <: typingsSlinky.std.EventTarget */ Target] (val x: Self with SVGAttributes[Target]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStrokeMiterlimit(value: String | Double): Self = this.set("strokeMiterlimit", value.asInstanceOf[js.Any])
    @scala.inline
