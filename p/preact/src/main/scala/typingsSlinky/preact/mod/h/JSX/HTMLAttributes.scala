...
object HTMLAttributes {
  @scala.inline
  def apply[/* <: typingsSlinky.std.EventTarget */ RefType](): HTMLAttributes[RefType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributes[RefType]]
  }
  @scala.inline
  implicit class HTMLAttributesOps[Self <: HTMLAttributes[_], /* <: typingsSlinky.std.EventTarget */ RefType] (val x: Self with HTMLAttributes[RefType]) extends AnyVal {
    @scala.inline
