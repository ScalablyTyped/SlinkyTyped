...
object HTMLAttributes {
  @scala.inline
  def apply[RefType](): HTMLAttributes[RefType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributes[RefType]]
  }
  @scala.inline
  implicit class HTMLAttributesOps[Self[reftype] <: HTMLAttributes[reftype], RefType] (val x: Self[RefType]) extends AnyVal {
    @scala.inline
