...
object PropertiesFallback {
  ...
  @scala.inline
  implicit class PropertiesFallbackMutableBuilder[Self <: PropertiesFallback[_], TLength] (val x: Self with PropertiesFallback[TLength]) extends AnyVal {
