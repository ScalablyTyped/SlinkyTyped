...
object internalMod {
  ...
  object HookType extends StObject {
    ...
    /* 8 */ val useCallback: typingsSlinky.preact.internalMod.HookType.useCallback with Double = js.native
    
    @js.native
    sealed trait useContext extends HookType
    /* 9 */ val useContext: typingsSlinky.preact.internalMod.HookType.useContext with Double = js.native
    
    // Not a real hook, but the devtools treat is as such
    @js.native
    sealed trait useDebugvalue extends HookType
    /* 11 */ val useDebugvalue: typingsSlinky.preact.internalMod.HookType.useDebugvalue with Double = js.native
    
    @js.native
    sealed trait useEffect extends HookType
    /* 3 */ val useEffect: typingsSlinky.preact.internalMod.HookType.useEffect with Double = js.native
    
    @js.native
    sealed trait useErrorBoundary extends HookType
    /* 10 */ val useErrorBoundary: typingsSlinky.preact.internalMod.HookType.useErrorBoundary with Double = js.native
    
    @js.native
    sealed trait useImperativeHandle extends HookType
    /* 6 */ val useImperativeHandle: typingsSlinky.preact.internalMod.HookType.useImperativeHandle with Double = js.native
    
    @js.native
    sealed trait useLayoutEffect extends HookType
    /* 4 */ val useLayoutEffect: typingsSlinky.preact.internalMod.HookType.useLayoutEffect with Double = js.native
    
    @js.native
    sealed trait useMemo extends HookType
    /* 7 */ val useMemo: typingsSlinky.preact.internalMod.HookType.useMemo with Double = js.native
    
    @js.native
    sealed trait useReducer extends HookType
    /* 2 */ val useReducer: typingsSlinky.preact.internalMod.HookType.useReducer with Double = js.native
    
    @js.native
    sealed trait useRef extends HookType
    /* 5 */ val useRef: typingsSlinky.preact.internalMod.HookType.useRef with Double = js.native
    
    @js.native
    sealed trait useState extends HookType
    /* 1 */ val useState: typingsSlinky.preact.internalMod.HookType.useState with Double = js.native
  }
  ...
  - typingsSlinky.std.CharacterData because var conflicts: nodeValue, textContent. Inlined length, ownerDocument_CharacterData, data, appendData, deleteData, insertData, replaceData, substringData
  - typingsSlinky.std.Text because var conflicts: nodeValue, textContent. Inlined wholeText, splitText */ @js.native
