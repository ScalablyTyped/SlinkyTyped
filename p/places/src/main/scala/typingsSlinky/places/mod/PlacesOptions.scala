...
object PlacesOptions {
  ...
  implicit class PlacesOptionsOps[Self <: PlacesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainerNodeList(value: NodeList): Self = this.set("container", value.asInstanceOf[js.Any])
    @scala.inline
    def setContainerHTMLInputElement(value: HTMLInputElement): Self = this.set("container", value.asInstanceOf[js.Any])
    @scala.inline
