...
object mod {
  ...
  object PlacesOptions {
    ...
    implicit class PlacesOptionsMutableBuilder[Self <: PlacesOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContainerHTMLInputElement(value: HTMLInputElement): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContainerNodeList(value: NodeList): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
    }
  }
}
