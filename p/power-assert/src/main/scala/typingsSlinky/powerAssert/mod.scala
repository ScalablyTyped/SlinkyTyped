...
object mod {
  ...
  object strict {
    ...
    @js.native
    def AssertionError: Instantiable1[/* options */ js.UndefOr[Actual], typingsSlinky.powerAssert.mod.AssertionError] = js.native
  ...
  trait Options extends StObject {
    ...
    var output: js.UndefOr[typingsSlinky.powerAssertFormatter.mod.Options] = js.native
  }
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAssertion(value: typingsSlinky.empower.mod.Options): Self = StObject.set(x, "assertion", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAssertionUndefined: Self = StObject.set(x, "assertion", js.undefined)
      
      @scala.inline
      def setOutput(value: typingsSlinky.powerAssertFormatter.mod.Options): Self = StObject.set(x, "output", value.asInstanceOf[js.Any])
