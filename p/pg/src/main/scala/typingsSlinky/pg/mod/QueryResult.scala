...
object QueryResult {
  @scala.inline
  def apply[/* <: typingsSlinky.pg.mod.QueryResultRow */ R](command: String, fields: js.Array[FieldDef], oid: Double, rowCount: Double, rows: js.Array[R]): QueryResult[R] = {
  ...
  @scala.inline
  implicit class QueryResultOps[Self <: QueryResult[_], /* <: typingsSlinky.pg.mod.QueryResultRow */ R] (val x: Self with QueryResult[R]) extends AnyVal {
    @scala.inline
