...
object ResultBuilder {
  @scala.inline
  def apply[/* <: typingsSlinky.pg.mod.QueryResultRow */ R](
    addRow: R => Unit,
    command: String,
  ...
  @scala.inline
  implicit class ResultBuilderOps[Self <: ResultBuilder[_], /* <: typingsSlinky.pg.mod.QueryResultRow */ R] (val x: Self with ResultBuilder[R]) extends AnyVal {
    @scala.inline
