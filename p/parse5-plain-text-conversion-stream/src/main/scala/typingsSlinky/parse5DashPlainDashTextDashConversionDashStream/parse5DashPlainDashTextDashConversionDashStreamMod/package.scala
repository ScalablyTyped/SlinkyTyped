package typingsSlinky.parse5DashPlainDashTextDashConversionDashStream
...
package object parse5DashPlainDashTextDashConversionDashStreamMod {
  /**
    ...
    * ```
    */
  type PlainTextConversionStream[TDocument] = typingsSlinky.parse5DashParserDashStream.parse5DashParserDashStreamMod.^[TDocument]
}
