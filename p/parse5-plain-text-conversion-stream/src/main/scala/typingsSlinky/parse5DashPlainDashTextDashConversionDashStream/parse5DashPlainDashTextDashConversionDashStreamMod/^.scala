package typingsSlinky.parse5DashPlainDashTextDashConversionDashStream.parse5DashPlainDashTextDashConversionDashStreamMod
...
@js.native
class ^[TDocument] ()
  extends typingsSlinky.parse5DashParserDashStream.parse5DashParserDashStreamMod.^[TDocument]
