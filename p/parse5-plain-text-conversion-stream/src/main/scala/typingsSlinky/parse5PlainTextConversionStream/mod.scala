package typingsSlinky.parse5PlainTextConversionStream
...
object mod {
  ...
  @js.native
  class ^[TDocument] ()
    extends typingsSlinky.parse5ParserStream.mod.^[TDocument]
  ...
  /**
    ...
    * ```
    */
  type PlainTextConversionStream[TDocument] = typingsSlinky.parse5ParserStream.mod.^[TDocument]
}
