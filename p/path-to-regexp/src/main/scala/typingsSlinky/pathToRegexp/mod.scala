...
object mod {
  ...
  @JSImport("path-to-regexp", "pathToRegexp")
  @js.native
  def pathToRegexp(path: Path, keys: js.UndefOr[scala.Nothing], options: TokensToRegexpOptions with ParseOptions): js.RegExp = js.native
  @JSImport("path-to-regexp", "pathToRegexp")
  @js.native
  def pathToRegexp(path: Path, keys: js.Array[Key]): js.RegExp = js.native
  @JSImport("path-to-regexp", "pathToRegexp")
  @js.native
  def pathToRegexp(path: Path, keys: js.Array[Key], options: TokensToRegexpOptions with ParseOptions): js.RegExp = js.native
  ...
  @JSImport("path-to-regexp", "regexpToFunction")
  @js.native
  def regexpToFunction[P /* <: js.Object */](re: js.RegExp, keys: js.Array[Key], options: RegexpToFunctionOptions): MatchFunction[P] = js.native
  ...
  @JSImport("path-to-regexp", "tokensToRegexp")
  @js.native
  def tokensToRegexp(tokens: js.Array[Token], keys: js.UndefOr[scala.Nothing], options: TokensToRegexpOptions): js.RegExp = js.native
  @JSImport("path-to-regexp", "tokensToRegexp")
  @js.native
  def tokensToRegexp(tokens: js.Array[Token], keys: js.Array[Key]): js.RegExp = js.native
  @JSImport("path-to-regexp", "tokensToRegexp")
  @js.native
  def tokensToRegexp(tokens: js.Array[Token], keys: js.Array[Key], options: TokensToRegexpOptions): js.RegExp = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.pathToRegexp.pathToRegexpBooleans.`false`
    - typingsSlinky.pathToRegexp.mod.MatchResult[P]
  */
