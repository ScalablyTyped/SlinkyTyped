...
import typingsSlinky.pouchDashReduxDashMiddleware.Anon_BatchInsert
...
object Path {
  ...
  def apply[T](
    ...
    path: String,
    docs: js.Any = null,
    handleResponse: (/* err */ js.Error, /* data */ js.Any, /* errorCallback */ js.Function1[/* err */ js.Error, Unit]) => Unit = null,
    initialBatchDispatched: /* err */ js.UndefOr[js.Error] => Unit = null,
