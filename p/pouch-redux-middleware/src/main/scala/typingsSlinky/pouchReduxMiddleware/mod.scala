...
import typingsSlinky.pouchdbCore.PouchDB.Core.IdMeta
...
object mod {
  ...
  object Path {
    ...
    implicit class PathMutableBuilder[Self <: Path[_], T] (val x: Self with Path[T]) extends AnyVal {
      ...
      @scala.inline
      def setInitialBatchDispatched(value: /* err */ js.UndefOr[js.Error] => Unit): Self = StObject.set(x, "initialBatchDispatched", js.Any.fromFunction1(value))
