...
object validationsMod extends js.Object {
  ...
  class EnumerationValidation protected ()
    extends typingsSlinky.peculiarJsonSchema.enumerationMod.EnumerationValidation {
    def this(enumeration: js.Array[String]) = this()
  }
  
  @js.native
  class ExclusiveValidation ()
    extends typingsSlinky.peculiarJsonSchema.exclusiveMod.ExclusiveValidation {
  ...
  class InclusiveValidation ()
    extends typingsSlinky.peculiarJsonSchema.inclusiveMod.InclusiveValidation {
    def this(min: Double) = this()
    def this(min: Double, max: Double) = this()
  }
  ...
  class LengthValidation ()
    extends typingsSlinky.peculiarJsonSchema.lengthMod.LengthValidation {
  ...
  class PatternValidation protected ()
    extends typingsSlinky.peculiarJsonSchema.patternMod.PatternValidation {
