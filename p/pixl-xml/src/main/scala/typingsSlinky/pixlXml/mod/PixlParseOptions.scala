...
object PixlParseOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(forceArrays)) __obj.updateDynamic("forceArrays")(forceArrays.get.asInstanceOf[js.Any])
    if (!js.isUndefined(lowerCase)) __obj.updateDynamic("lowerCase")(lowerCase.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preserveAttributes)) __obj.updateDynamic("preserveAttributes")(preserveAttributes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preserveDocumentNode)) __obj.updateDynamic("preserveDocumentNode")(preserveDocumentNode.get.asInstanceOf[js.Any])
