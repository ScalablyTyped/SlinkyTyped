...
object mod {
  ...
  */
  ...
  object PromiseResult {
    ...
    @scala.inline
    def PromiseFulfilledResult[ValueType](isFulfilled: `true`, isRejected: `false`, value: ValueType): typingsSlinky.pReflect.mod.PromiseFulfilledResult[ValueType] = {
      val __obj = js.Dynamic.literal(isFulfilled = isFulfilled.asInstanceOf[js.Any], isRejected = isRejected.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.pReflect.mod.PromiseFulfilledResult[ValueType]]
    }
    
    @scala.inline
    def PromiseRejectedResult(isFulfilled: `false`, isRejected: `true`, reason: js.Any): typingsSlinky.pReflect.mod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(isFulfilled = isFulfilled.asInstanceOf[js.Any], isRejected = isRejected.asInstanceOf[js.Any], reason = reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.pReflect.mod.PromiseRejectedResult]
    }
  }
}
