...
import typingsSlinky.page.PageJS.RouteOptions
import typingsSlinky.page.PageJS.Static
...
object mod {
  ...
  object default extends Shortcut {
    ...
    class Context protected ()
      extends typingsSlinky.page.PageJS.Context {
      /**
    ...
    class Route protected ()
      extends typingsSlinky.page.PageJS.Route {
      /**
