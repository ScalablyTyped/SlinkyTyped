...
object Node {
  @scala.inline
  def apply[/* <: java.lang.String */ Name, T](end: Index_, name: Name, start: Index_, value: T): Node[Name, T] = {
  ...
  @scala.inline
  implicit class NodeOps[Self <: Node[_, _], /* <: java.lang.String */ Name, T] (val x: Self with (Node[Name, T])) extends AnyVal {
    @scala.inline
