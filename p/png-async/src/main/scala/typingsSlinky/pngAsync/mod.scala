...
object mod {
  ...
  object EDeflateStrategy extends StObject {
    ...
    /* 0 */ val DEFAULT_STRATEGY: typingsSlinky.pngAsync.mod.EDeflateStrategy.DEFAULT_STRATEGY with Double = js.native
    
    @js.native
    sealed trait FILTERED extends EDeflateStrategy
    /* 1 */ val FILTERED: typingsSlinky.pngAsync.mod.EDeflateStrategy.FILTERED with Double = js.native
    
    @js.native
    sealed trait FIXED extends EDeflateStrategy
    /* 4 */ val FIXED: typingsSlinky.pngAsync.mod.EDeflateStrategy.FIXED with Double = js.native
    
    @js.native
    sealed trait HUFFMAN_ONLY extends EDeflateStrategy
    /* 2 */ val HUFFMAN_ONLY: typingsSlinky.pngAsync.mod.EDeflateStrategy.HUFFMAN_ONLY with Double = js.native
    
    @js.native
    sealed trait RLE extends EDeflateStrategy
    /* 3 */ val RLE: typingsSlinky.pngAsync.mod.EDeflateStrategy.RLE with Double = js.native
  }
  ...
  object EFilterType extends StObject {
    ...
    /* -1 */ val Auto: typingsSlinky.pngAsync.mod.EFilterType.Auto with Double = js.native
    
    @js.native
    sealed trait Average extends EFilterType
    /* 3 */ val Average: typingsSlinky.pngAsync.mod.EFilterType.Average with Double = js.native
    
    @js.native
    sealed trait None extends EFilterType
    /* 0 */ val None: typingsSlinky.pngAsync.mod.EFilterType.None with Double = js.native
    
    @js.native
    sealed trait Paeth extends EFilterType
    /* 4 */ val Paeth: typingsSlinky.pngAsync.mod.EFilterType.Paeth with Double = js.native
    
    @js.native
    sealed trait Sub extends EFilterType
    /* 1 */ val Sub: typingsSlinky.pngAsync.mod.EFilterType.Sub with Double = js.native
    
    @js.native
    sealed trait Up extends EFilterType
    /* 2 */ val Up: typingsSlinky.pngAsync.mod.EFilterType.Up with Double = js.native
  }
