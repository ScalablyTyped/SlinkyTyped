...
object Volume {
  @scala.inline
  def SharedVolume(kind: typingsSlinky.atPulumiCloud.atPulumiCloudStrings.SharedVolume, name: String): Volume = {
    val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Volume]
  }
  @scala.inline
  def HostPathVolume(kind: typingsSlinky.atPulumiCloud.atPulumiCloudStrings.HostPathVolume, path: String): Volume = {
