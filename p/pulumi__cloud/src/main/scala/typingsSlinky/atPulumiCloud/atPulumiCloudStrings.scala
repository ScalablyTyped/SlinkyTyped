...
import typingsSlinky.atPulumiCloud.serviceMod.ContainerProtocol
import typingsSlinky.atPulumiCloud.serviceMod.HostOperatingSystem
import typingsSlinky.atPulumiCloud.serviceMod.VolumeKind
