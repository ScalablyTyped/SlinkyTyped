...
import typingsSlinky.pulumiCloud.serviceMod.ContainerProtocol
import typingsSlinky.pulumiCloud.serviceMod.HostOperatingSystem
import typingsSlinky.pulumiCloud.serviceMod.VolumeKind
