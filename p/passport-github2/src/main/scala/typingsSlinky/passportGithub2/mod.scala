package typingsSlinky.passportGithub2
...
import typingsSlinky.passportGithub2.passportGithub2Booleans.`false`
import typingsSlinky.passportGithub2.passportGithub2Booleans.`true`
