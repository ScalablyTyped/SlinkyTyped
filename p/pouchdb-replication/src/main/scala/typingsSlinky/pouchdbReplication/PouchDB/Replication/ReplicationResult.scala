...
object ReplicationResult {
  ...
  @scala.inline
  implicit class ReplicationResultOps[Self <: ReplicationResult[_], /* <: js.Object */ Content] (val x: Self with ReplicationResult[Content]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStart_time(value: js.Date): Self = this.set("start_time", value.asInstanceOf[js.Any])
  }
