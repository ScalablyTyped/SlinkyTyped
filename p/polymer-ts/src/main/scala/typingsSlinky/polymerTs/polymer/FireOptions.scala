...
object FireOptions {
  ...
  implicit class FireOptionsOps[Self <: FireOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNodeHTMLElement(value: HTMLElement): Self = this.set("node", value.asInstanceOf[js.Any])
    @scala.inline
    def setNode(value: HTMLElement | Base): Self = this.set("node", value.asInstanceOf[js.Any])
    @scala.inline
