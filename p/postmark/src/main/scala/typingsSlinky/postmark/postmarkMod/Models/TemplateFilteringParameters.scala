...
class TemplateFilteringParameters ()
  extends typingsSlinky.postmark.distClientModelsMod.TemplateFilteringParameters {
  def this(count: Double) = this()
  def this(count: Double, offset: Double) = this()
  def this(
    count: Double,
    offset: Double,
    templateType: typingsSlinky.postmark.distClientModelsTemplatesTemplateMod.TemplateTypes
  ) = this()
  def this(
    count: Double,
    offset: Double,
