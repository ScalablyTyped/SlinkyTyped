...
object InboundMessageDetails {
  ...
  implicit class InboundMessageDetailsOps[Self <: InboundMessageDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBlockedReason(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BlockedReason")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStrippedTextReply(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StrippedTextReply")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
