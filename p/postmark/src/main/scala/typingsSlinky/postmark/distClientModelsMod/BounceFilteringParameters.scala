...
class BounceFilteringParameters protected ()
  extends typingsSlinky.postmark.distClientModelsBouncesBounceFilteringParametersMod.BounceFilteringParameters {
  def this(
    count: js.UndefOr[Double],
    offset: js.UndefOr[Double],
    `type`: js.UndefOr[
        typingsSlinky.postmark.distClientModelsBouncesBounceFilteringParametersMod.BounceType
      ],
