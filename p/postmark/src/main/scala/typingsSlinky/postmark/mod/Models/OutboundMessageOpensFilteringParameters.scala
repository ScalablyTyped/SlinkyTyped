...
@JSImport("postmark", "Models.OutboundMessageOpensFilteringParameters")
@js.native
class OutboundMessageOpensFilteringParameters protected ()
  extends typingsSlinky.postmark.modelsMod.OutboundMessageOpensFilteringParameters {
  def this(
