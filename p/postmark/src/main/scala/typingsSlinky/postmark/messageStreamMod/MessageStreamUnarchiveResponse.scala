package typingsSlinky.postmark.messageStreamMod
...
trait MessageStreamUnarchiveResponse extends js.Object {
  ...
  var SubscriptionManagementConfiguration: typingsSlinky.postmark.messageStreamMod.SubscriptionManagementConfiguration = js.native
