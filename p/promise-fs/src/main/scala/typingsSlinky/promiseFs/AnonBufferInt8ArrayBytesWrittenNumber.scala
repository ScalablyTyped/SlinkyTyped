...
object AnonBufferInt8ArrayBytesWrittenNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Int8Array, bytesWritten: Double): AnonBufferInt8ArrayBytesWrittenNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferInt8ArrayBytesWrittenNumber]
  }
  @scala.inline
  implicit class AnonBufferInt8ArrayBytesWrittenNumberOps[Self <: AnonBufferInt8ArrayBytesWrittenNumber] (val x: Self) extends AnyVal {
    @scala.inline
