...
import typingsSlinky.promiseFs.AnonEncoding
...
object readFile extends js.Object {
  ...
  def apply(path: Double, options: AnonEncoding): js.Promise[Buffer] = js.native
  def apply(path: Double, options: typingsSlinky.promiseFs.AnonEncodingFlag): js.Promise[String | Buffer] = js.native
  def apply(path: Double, options: typingsSlinky.promiseFs.AnonFlag): js.Promise[String] = js.native
  ...
  def apply(path: PathLike, options: AnonEncoding): js.Promise[Buffer] = js.native
  def apply(path: PathLike, options: typingsSlinky.promiseFs.AnonEncodingFlag): js.Promise[String | Buffer] = js.native
  def apply(path: PathLike, options: typingsSlinky.promiseFs.AnonFlag): js.Promise[String] = js.native
