...
import typingsSlinky.promiseFs.Anon3
...
object readdir extends js.Object {
  ...
  def apply(path: PathLike, options: typingsSlinky.promiseFs.Anon4): js.Promise[js.Array[typingsSlinky.node.fsMod.Dirent]] = js.native
  def apply(path: PathLike, options: typingsSlinky.promiseFs.AnonEncodingWithFileTypes): js.Promise[js.Array[Buffer]] = js.native
  def apply(path: PathLike, options: typingsSlinky.promiseFs.AnonWithFileTypes): js.Promise[js.Array[String]] = js.native
