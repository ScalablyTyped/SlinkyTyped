...
import typingsSlinky.promiseFs.AnonBufferBytesWritten
import typingsSlinky.promiseFs.AnonBufferDataViewBytesWrittenNumber
import typingsSlinky.promiseFs.AnonBufferFloat32ArrayBytesWrittenNumber
import typingsSlinky.promiseFs.AnonBufferFloat64ArrayBytesWrittenNumber
import typingsSlinky.promiseFs.AnonBufferInt16ArrayBytesWrittenNumber
import typingsSlinky.promiseFs.AnonBufferInt32ArrayBytesWrittenNumber
import typingsSlinky.promiseFs.AnonBufferInt8ArrayBytesWrittenNumber
import typingsSlinky.promiseFs.AnonBufferString
import typingsSlinky.promiseFs.AnonBufferUint16Array
import typingsSlinky.promiseFs.AnonBytesWritten
import typingsSlinky.promiseFs.AnonBytesWrittenNumber
...
object write extends js.Object {
  ...
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array): js.Promise[typingsSlinky.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array, offset: Double): js.Promise[typingsSlinky.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array, offset: Double, length: Double): js.Promise[typingsSlinky.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array, offset: Double, length: Double, position: Double): js.Promise[typingsSlinky.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  ...
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray): js.Promise[typingsSlinky.node.AnonBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray, offset: Double): js.Promise[typingsSlinky.node.AnonBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray, offset: Double, length: Double): js.Promise[typingsSlinky.node.AnonBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray, offset: Double, length: Double, position: Double): js.Promise[typingsSlinky.node.AnonBytesWritten] = js.native
  /**
    * Asynchronously writes `string` to the file referenced by the supplied file descriptor.
    * @param fd A file descriptor.
    * @param string A string to write. If something other than a string is supplied it will be coerced to a string.
    ...
    */
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any): js.Promise[typingsSlinky.node.AnonBufferString] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any, position: Double): js.Promise[typingsSlinky.node.AnonBufferString] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any, position: Double, encoding: String): js.Promise[typingsSlinky.node.AnonBufferString] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any, position: Null, encoding: String): js.Promise[typingsSlinky.node.AnonBufferString] = js.native
}
