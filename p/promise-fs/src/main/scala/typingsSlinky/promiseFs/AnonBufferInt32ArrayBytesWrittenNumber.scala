...
object AnonBufferInt32ArrayBytesWrittenNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Int32Array, bytesWritten: Double): AnonBufferInt32ArrayBytesWrittenNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferInt32ArrayBytesWrittenNumber]
  }
  @scala.inline
  implicit class AnonBufferInt32ArrayBytesWrittenNumberOps[Self <: AnonBufferInt32ArrayBytesWrittenNumber] (val x: Self) extends AnyVal {
    @scala.inline
