...
object AnonBufferUint16Array {
  @scala.inline
  def apply(buffer: js.typedarray.Uint16Array, bytesWritten: Double): AnonBufferUint16Array = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferUint16Array]
  }
  @scala.inline
  implicit class AnonBufferUint16ArrayOps[Self <: AnonBufferUint16Array] (val x: Self) extends AnyVal {
    @scala.inline
