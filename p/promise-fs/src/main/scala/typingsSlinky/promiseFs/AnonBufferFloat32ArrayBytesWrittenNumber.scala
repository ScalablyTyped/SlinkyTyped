...
object AnonBufferFloat32ArrayBytesWrittenNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Float32Array, bytesWritten: Double): AnonBufferFloat32ArrayBytesWrittenNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferFloat32ArrayBytesWrittenNumber]
  }
  @scala.inline
  implicit class AnonBufferFloat32ArrayBytesWrittenNumberOps[Self <: AnonBufferFloat32ArrayBytesWrittenNumber] (val x: Self) extends AnyVal {
    @scala.inline
