...
object AnonBufferFloat64ArrayBytesWrittenNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Float64Array, bytesWritten: Double): AnonBufferFloat64ArrayBytesWrittenNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferFloat64ArrayBytesWrittenNumber]
  }
  @scala.inline
  implicit class AnonBufferFloat64ArrayBytesWrittenNumberOps[Self <: AnonBufferFloat64ArrayBytesWrittenNumber] (val x: Self) extends AnyVal {
    @scala.inline
