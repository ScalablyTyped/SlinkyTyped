...
object AnonBytesWritten {
  @scala.inline
  def apply(buffer: js.typedarray.Uint8Array, bytesWritten: Double): AnonBytesWritten = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBytesWritten]
  }
  @scala.inline
  implicit class AnonBytesWrittenOps[Self <: AnonBytesWritten] (val x: Self) extends AnyVal {
    @scala.inline
