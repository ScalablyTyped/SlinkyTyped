...
object AnonBufferInt16ArrayBytesWrittenNumber {
  @scala.inline
  def apply(buffer: js.typedarray.Int16Array, bytesWritten: Double): AnonBufferInt16ArrayBytesWrittenNumber = {
    val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], bytesWritten = bytesWritten.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBufferInt16ArrayBytesWrittenNumber]
  }
  @scala.inline
  implicit class AnonBufferInt16ArrayBytesWrittenNumberOps[Self <: AnonBufferInt16ArrayBytesWrittenNumber] (val x: Self) extends AnyVal {
    @scala.inline
