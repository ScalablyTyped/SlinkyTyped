...
object mkdtempSync extends js.Object {
  ...
  /**
    ...
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    */
  def apply(prefix: String, options: typingsSlinky.node.Anon_BufferEncoding): Buffer = js.native
  def apply(prefix: String, options: typingsSlinky.node.Anon_EncodingBufferEncoding): String = js.native
  def apply(prefix: String, options: typingsSlinky.node.Anon_EncodingNull): String | Buffer = js.native
