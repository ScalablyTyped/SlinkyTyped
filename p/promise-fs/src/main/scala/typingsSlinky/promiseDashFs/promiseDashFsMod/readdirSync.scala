...
object readdirSync extends js.Object {
  ...
  def apply(path: PathLike, options: typingsSlinky.node.Anon_EncodingFalseWithFileTypes): js.Array[Buffer | String] = js.native
  /**
    * Synchronous readdir(3) - read a directory.
    * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    * @param options If called with `withFileTypes: true` the result data will be an array of Dirent.
    */
  def apply(path: PathLike, options: typingsSlinky.node.Anon_EncodingTrue): js.Array[typingsSlinky.node.fsMod.Dirent] = js.native
