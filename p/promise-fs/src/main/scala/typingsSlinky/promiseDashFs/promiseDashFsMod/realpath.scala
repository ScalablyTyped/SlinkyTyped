...
object realpath extends js.Object {
  ...
  def apply(path: PathLike, options: typingsSlinky.promiseDashFs.Anon_EncodingBufferEncoding): js.Promise[String] = js.native
  def apply(path: PathLike, options: typingsSlinky.promiseDashFs.Anon_EncodingNull): js.Promise[String | Buffer] = js.native
