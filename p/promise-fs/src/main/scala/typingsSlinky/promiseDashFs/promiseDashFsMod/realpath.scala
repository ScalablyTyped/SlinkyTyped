...
import typingsSlinky.promiseDashFs.Anon_Buffer
import typingsSlinky.promiseDashFs.Anon_EncodingBufferEncoding
import typingsSlinky.promiseDashFs.Anon_EncodingNull
...
object realpath extends js.Object {
  ...
  /**
    ...
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    */
  def __promisify__(path: PathLike, options: typingsSlinky.node.Anon_BufferEncoding): js.Promise[Buffer] = js.native
  def __promisify__(path: PathLike, options: typingsSlinky.node.Anon_EncodingBufferEncoding): js.Promise[String] = js.native
  def __promisify__(path: PathLike, options: typingsSlinky.node.Anon_EncodingNull): js.Promise[String | Buffer] = js.native
