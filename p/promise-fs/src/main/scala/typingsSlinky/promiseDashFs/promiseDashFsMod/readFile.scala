...
import typingsSlinky.promiseDashFs.Anon_Encoding
import typingsSlinky.promiseDashFs.Anon_EncodingFlag
import typingsSlinky.promiseDashFs.Anon_EncodingFlagNull
...
object readFile extends js.Object {
  ...
  def apply(
    path: Double,
    options: typingsSlinky.node.Anon_EncodingFlagNull,
  ...
  def apply(
    path: Double,
    options: typingsSlinky.node.Anon_EncodingFlag,
    callback: js.Function2[/* err */ ErrnoException | Null, /* data */ Buffer, Unit]
  ): Unit = js.native
  def apply(path: Double, options: Anon_Encoding): js.Promise[Buffer] = js.native
  def apply(path: Double, options: Anon_EncodingFlag): js.Promise[String] = js.native
  ...
  def apply(path: PathLike, options: Anon_Encoding): js.Promise[Buffer] = js.native
  def apply(path: PathLike, options: Anon_EncodingFlag): js.Promise[String] = js.native
  ...
  def __promisify__(path: Double, options: typingsSlinky.node.Anon_EncodingFlag): js.Promise[Buffer] = js.native
  def __promisify__(path: Double, options: typingsSlinky.node.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
  ...
  def __promisify__(path: PathLike, options: typingsSlinky.node.Anon_EncodingFlag): js.Promise[Buffer] = js.native
  def __promisify__(path: PathLike, options: typingsSlinky.node.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
  /**
    * Asynchronously reads the entire contents of a file.
    * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    * URL support is _experimental_.
