...
object readFile extends js.Object {
  ...
  def apply(path: Double, options: typingsSlinky.promiseDashFs.Anon_EncodingFlag): js.Promise[String] = js.native
  def apply(path: Double, options: typingsSlinky.promiseDashFs.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
  ...
  def apply(path: PathLike, options: typingsSlinky.promiseDashFs.Anon_EncodingFlag): js.Promise[String] = js.native
  def apply(path: PathLike, options: typingsSlinky.promiseDashFs.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
