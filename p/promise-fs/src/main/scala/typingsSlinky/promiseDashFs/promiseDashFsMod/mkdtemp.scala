...
object mkdtemp extends js.Object {
  ...
  def apply(
    prefix: String,
    options: typingsSlinky.node.Anon_BufferEncoding,
  ...
  def apply(
    prefix: String,
    options: typingsSlinky.node.Anon_EncodingBufferEncoding,
  ...
  def apply(
    prefix: String,
    options: typingsSlinky.node.Anon_EncodingNull,
    callback: js.Function2[/* err */ ErrnoException | Null, /* folder */ String | Buffer, Unit]
  ): Unit = js.native
  def apply(
    prefix: String,
  ...
  /**
    ...
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    */
  def __promisify__(prefix: String, options: typingsSlinky.node.Anon_BufferEncoding): js.Promise[Buffer] = js.native
  def __promisify__(prefix: String, options: typingsSlinky.node.Anon_EncodingBufferEncoding): js.Promise[String] = js.native
  def __promisify__(prefix: String, options: typingsSlinky.node.Anon_EncodingNull): js.Promise[String | Buffer] = js.native
