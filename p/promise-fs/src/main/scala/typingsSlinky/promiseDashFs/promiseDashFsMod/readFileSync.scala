...
object readFileSync extends js.Object {
  ...
  def apply(path: Double, options: typingsSlinky.node.Anon_EncodingFlag): Buffer = js.native
  def apply(path: Double, options: typingsSlinky.node.Anon_EncodingFlagNull): String | Buffer = js.native
  ...
  def apply(path: PathLike, options: typingsSlinky.node.Anon_EncodingFlag): Buffer = js.native
  def apply(path: PathLike, options: typingsSlinky.node.Anon_EncodingFlagNull): String | Buffer = js.native
  /**
    * Synchronously reads the entire contents of a file.
    * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    * URL support is _experimental_.
