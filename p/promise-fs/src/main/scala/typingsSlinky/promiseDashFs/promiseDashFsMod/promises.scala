...
import typingsSlinky.node.Anon_BufferBytesReadNumberTBuffer
import typingsSlinky.node.Anon_BufferBytesWrittenNumberTBuffer
import typingsSlinky.node.Anon_BufferEncodingFalse
import typingsSlinky.node.Anon_EncodingFalseWithFileTypesBufferEncoding
import typingsSlinky.node.Anon_EncodingFlagBufferEncoding
import typingsSlinky.node.Anon_EncodingFlagModeNull
import typingsSlinky.node.Anon_EncodingFlagNullNumber
import typingsSlinky.node.Anon_EncodingFlagNullNumberString
...
object promises extends js.Object {
  ...
  /**
    ...
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    */
  def mkdtemp(prefix: String, options: typingsSlinky.node.Anon_BufferEncoding): js.Promise[Buffer] = js.native
  def mkdtemp(prefix: String, options: typingsSlinky.node.Anon_EncodingBufferEncoding): js.Promise[String] = js.native
  def mkdtemp(prefix: String, options: typingsSlinky.node.Anon_EncodingNull): js.Promise[String | Buffer] = js.native
  ...
  def readdir(path: PathLike, options: typingsSlinky.node.Anon_EncodingFalseWithFileTypes): js.Promise[js.Array[Buffer | String]] = js.native
  ...
  /**
    ...
    */
  def readdir(path: PathLike, options: typingsSlinky.node.Anon_EncodingTrue): js.Promise[js.Array[typingsSlinky.node.fsMod.Dirent]] = js.native
  ...
  /**
    ...
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    */
  def readlink(path: PathLike, options: typingsSlinky.node.Anon_BufferEncoding): js.Promise[Buffer] = js.native
  def readlink(path: PathLike, options: typingsSlinky.node.Anon_EncodingBufferEncoding): js.Promise[String] = js.native
  def readlink(path: PathLike, options: typingsSlinky.node.Anon_EncodingNull): js.Promise[String | Buffer] = js.native
  ...
  /**
    ...
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    */
  def realpath(path: PathLike, options: typingsSlinky.node.Anon_BufferEncoding): js.Promise[Buffer] = js.native
  def realpath(path: PathLike, options: typingsSlinky.node.Anon_EncodingBufferEncoding): js.Promise[String] = js.native
  def realpath(path: PathLike, options: typingsSlinky.node.Anon_EncodingNull): js.Promise[String | Buffer] = js.native
  ...
  /**
    ...
    */
  def write(handle: FileHandle, string: js.Any): js.Promise[typingsSlinky.node.Anon_BufferBytesWrittenNumberString] = js.native
  def write(handle: FileHandle, string: js.Any, position: Double): js.Promise[typingsSlinky.node.Anon_BufferBytesWrittenNumberString] = js.native
  def write(handle: FileHandle, string: js.Any, position: Double, encoding: String): js.Promise[typingsSlinky.node.Anon_BufferBytesWrittenNumberString] = js.native
  def write(handle: FileHandle, string: js.Any, position: Null, encoding: String): js.Promise[typingsSlinky.node.Anon_BufferBytesWrittenNumberString] = js.native
  /**
