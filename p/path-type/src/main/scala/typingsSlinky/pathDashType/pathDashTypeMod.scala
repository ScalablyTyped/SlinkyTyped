package typingsSlinky.pathDashType

import typingsSlinky.pathDashType.pathDashTypeMod.PathTypeFunction
import typingsSlinky.pathDashType.pathDashTypeMod.PathTypeSyncFunction
