...
import typingsSlinky.popmotionPose.anon.Ease
import typingsSlinky.popmotionPose.anon.ElementStyler
import typingsSlinky.popmotionPose.anon.Type
import typingsSlinky.popmotionPose.anon.`0`
import typingsSlinky.popmotionPose.anon.`1`
import typingsSlinky.popmotionPose.anon.`2`
import typingsSlinky.popmotionPose.anon.`3`
...
import typingsSlinky.tsEssentials.typesMod.Merge
...
object typesMod {
  ...
  object BoundingBoxDimension extends StObject {
    ...
    /* "bottom" */ val bottom: typingsSlinky.popmotionPose.typesMod.BoundingBoxDimension.bottom with String = js.native
    
    @js.native
    sealed trait height extends BoundingBoxDimension
    /* "height" */ val height: typingsSlinky.popmotionPose.typesMod.BoundingBoxDimension.height with String = js.native
    
    @js.native
    sealed trait left extends BoundingBoxDimension
    /* "left" */ val left: typingsSlinky.popmotionPose.typesMod.BoundingBoxDimension.left with String = js.native
    
    @js.native
    sealed trait right extends BoundingBoxDimension
    /* "right" */ val right: typingsSlinky.popmotionPose.typesMod.BoundingBoxDimension.right with String = js.native
    
    @js.native
    sealed trait top extends BoundingBoxDimension
    /* "top" */ val top: typingsSlinky.popmotionPose.typesMod.BoundingBoxDimension.top with String = js.native
    
    @js.native
    sealed trait width extends BoundingBoxDimension
    /* "width" */ val width: typingsSlinky.popmotionPose.typesMod.BoundingBoxDimension.width with String = js.native
  }
  ...
  {[ key in popmotion-pose.popmotion-pose/lib/types.BoundingBoxDimension ]: number}
    */ typingsSlinky.popmotionPose.popmotionPoseStrings.BoundingBox with TopLevel[js.Any]
  ...
  {[ key in popmotion-pose.popmotion-pose/lib/types.BoundingBoxDimension ]:? number | string}
    */ typingsSlinky.popmotionPose.popmotionPoseStrings.DragBounds with TopLevel[js.Any]
