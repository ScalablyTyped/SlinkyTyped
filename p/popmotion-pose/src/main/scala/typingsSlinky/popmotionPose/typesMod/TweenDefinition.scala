...
object TweenDefinition {
  ...
  implicit class TweenDefinitionOps[Self <: TweenDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrom(value: typingsSlinky.popmotion.valueMod.Value): Self = this.set("from", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTo(value: typingsSlinky.popmotion.valueMod.Value): Self = this.set("to", value.asInstanceOf[js.Any])
    @scala.inline
