...
trait Platform_ extends js.Object {
  ...
  var os: js.UndefOr[AnonArchitecture] = js.native
  var prerelease: js.UndefOr[String] = js.native
  var product: js.UndefOr[String] = js.native
  var ua: js.UndefOr[String] = js.native
  var version: js.UndefOr[String] = js.native
  def parse(ua: String): Platform_ = js.native
}

object Platform_ {
  @scala.inline
  def apply(parse: String => Platform_): Platform_ = {
    val __obj = js.Dynamic.literal(parse = js.Any.fromFunction1(parse))
    __obj.asInstanceOf[Platform_]
  }
  @scala.inline
  implicit class Platform_Ops[Self <: Platform_] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withParse(value: String => Platform_): Self = {
