...
object mod {
  ...
  object stdSerializers {
    ...
    @js.native
    def err: js.Function1[/* err */ js.Error, SerializedError] = js.native
    /**
      * Serializes an Error object.
      */
    @JSImport("pino-multi-stream", "stdSerializers.err")
    ...
    @scala.inline
    def err_=(x: js.Function1[/* err */ js.Error, SerializedError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("err")(x.asInstanceOf[js.Any])
    ...
    def wrapErrorSerializer: js.Function1[
        ...
        js.Function1[/* err */ js.Error, Record[String, js.Any]]
      ] = js.native
    /**
      * A utility method for wrapping the default error serializer. Allows custom serializers to work with the
      * already serialized object.
  ...
  type Level = typingsSlinky.pino.mod.Level
  
  type Logger = typingsSlinky.pino.mod.Logger
  ...
  object LoggerOptions {
    ...
    implicit class LoggerOptionsMutableBuilder[Self <: LoggerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStreamsVarargs(value: typingsSlinky.pinoMultiStream.anon.Level*): Self = StObject.set(x, "streams", js.Array(value :_*))
    }
  }
  ...
  type Streams = js.Array[typingsSlinky.pinoMultiStream.anon.Level]
}
