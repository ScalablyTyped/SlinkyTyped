...
import typingsSlinky.progressbarJs.anon.Typeofutils
...
object mod {
  ...
  @js.native
  class Circle ()
    extends typingsSlinky.progressbarJs.circleMod.^
  @JSImport("progressbar.js", "Circle")
  @js.native
  def Circle: Instantiable0[typingsSlinky.progressbarJs.circleMod.^] = js.native
  @scala.inline
  def Circle_=(x: Instantiable0[typingsSlinky.progressbarJs.circleMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Circle")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("progressbar.js", "Line")
  @js.native
  class Line ()
    extends typingsSlinky.progressbarJs.lineMod.^
  @JSImport("progressbar.js", "Line")
  @js.native
  def Line: Instantiable0[typingsSlinky.progressbarJs.lineMod.^] = js.native
  @scala.inline
  def Line_=(x: Instantiable0[typingsSlinky.progressbarJs.lineMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Line")(x.asInstanceOf[js.Any])
  ...
  def Path: Instantiable2[
    ...
    typingsSlinky.progressbarJs.pathMod.^[Element]
  ] = js.native
  @scala.inline
  def Path_=(
    x: Instantiable2[
  ...
  @js.native
  class SemiCircle ()
    extends typingsSlinky.progressbarJs.semicircleMod.^
  @JSImport("progressbar.js", "SemiCircle")
  @js.native
  def SemiCircle: Instantiable0[typingsSlinky.progressbarJs.semicircleMod.^] = js.native
  @scala.inline
  def SemiCircle_=(x: Instantiable0[typingsSlinky.progressbarJs.semicircleMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SemiCircle")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  class Shape ()
    extends typingsSlinky.progressbarJs.shapeMod.^ {
  ...
  def Shape: Instantiable2[
    ...
    typingsSlinky.progressbarJs.shapeMod.^
  ] = js.native
  @scala.inline
  def Shape_=(
    x: Instantiable2[
  ...
  @js.native
  class Square ()
    extends typingsSlinky.progressbarJs.squareMod.^
  @JSImport("progressbar.js", "Square")
  @js.native
  def Square: Instantiable0[typingsSlinky.progressbarJs.squareMod.^] = js.native
  @scala.inline
  def Square_=(x: Instantiable0[typingsSlinky.progressbarJs.squareMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Square")(x.asInstanceOf[js.Any])
  ...
  object AnimationOptions {
    ...
    implicit class AnimationOptionsMutableBuilder[Self <: AnimationOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStep(
        value: (/* state */ StringDictionary[js.Any], /* path */ typingsSlinky.progressbarJs.pathMod.^[SVGPathElement], /* attachement */ SVGPathElement) => Unit
  ...
  type StepFunction = js.Function3[
    ...
    /* path */ typingsSlinky.progressbarJs.pathMod.^[SVGPathElement], 
