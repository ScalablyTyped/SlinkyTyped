...
import typingsSlinky.phantom.Anon_Abort
import typingsSlinky.phantom.Anon_ErrorCode
import typingsSlinky.phantom.Anon_ErrorCodeErrorString
import typingsSlinky.phantom.Anon_File
import typingsSlinky.phantom.Anon_Format
import typingsSlinky.phantom.Anon_Height
import typingsSlinky.phantom.Anon_HeightWidth
import typingsSlinky.phantom.Anon_Left
import typingsSlinky.phantom.Anon_PageId
import typingsSlinky.phantom.phantomNumbers.`false`
...
trait WebPage extends js.Object {
  ...
  ): js.Promise[Anon_PageId] = js.native
  def on(event: onAlert, runOnPhantom: `false`, listener: js.Function1[/* msg */ String, Unit]): js.Promise[Anon_PageId] = js.native
  def on(event: onCallback, runOnPhantom: `false`, listener: js.Function1[/* data */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  def on(event: onClosing, runOnPhantom: `false`, listener: js.Function1[/* closingPage */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  def on(event: onConfirm, runOnPhantom: `false`, listener: js.Function1[/* msg */ String, Unit]): js.Promise[Anon_PageId] = js.native
  def on(
  ...
  def on(
    event: onError,
    runOnPhantom: `false`,
    listener: js.Function2[/* msg */ String, /* trace */ js.Array[Anon_File], Unit]
  ): js.Promise[Anon_PageId] = js.native
  def on(event: onFilePicker, runOnPhantom: `false`, listener: js.Function1[/* oldFile */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  def on(event: onInitialized, runOnPhantom: `false`, listener: js.Function0[Unit]): js.Promise[Anon_PageId] = js.native
  def on(event: onLoadFinished, listener: js.Function1[/* status */ success | fail, Unit]): js.Promise[Anon_PageId] = js.native
  def on(
    event: onLoadFinished,
    runOnPhantom: `false`,
    listener: js.Function1[/* status */ success | fail, Unit]
  ): js.Promise[Anon_PageId] = js.native
  def on(event: onLoadStarted, runOnPhantom: `false`, listener: js.Function0[Unit]): js.Promise[Anon_PageId] = js.native
  def on(
  ...
  def on(event: onPageCreated, runOnPhantom: `false`, listener: js.Function1[/* newPage */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  def on(
    event: onPrompt,
    runOnPhantom: `false`,
  ...
  def on(
    ...
    runOnPhantom: `false`,
    listener: js.Function1[/* resourceError */ Anon_ErrorCode, Unit]
  ): js.Promise[Anon_PageId] = js.native
  def on(
  ...
  def on(
    ...
    runOnPhantom: `false`,
    listener: js.Function2[/* requestData */ IRequestData, /* networkRequest */ Anon_Abort, Unit]
  ): js.Promise[Anon_PageId] = js.native
  def on(
    event: onResourceTimeout,
    runOnPhantom: `false`,
    listener: js.Function1[/* request */ IRequestData with Anon_ErrorCodeErrorString, Unit]
  ): js.Promise[Anon_PageId] = js.native
  def on(event: onUrlChanged, runOnPhantom: `false`, listener: js.Function1[/* targetUrl */ String, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onAlert(event: onAlert, listener: js.Function1[/* msg */ String, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onCallback(event: onCallback, listener: js.Function1[/* data */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onClosing(event: onClosing, listener: js.Function1[/* closingPage */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onConfirm(event: onConfirm, listener: js.Function1[/* msg */ String, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  ...
  @JSName("on")
  def on_onError(event: onError, listener: js.Function2[/* msg */ String, /* trace */ js.Array[Anon_File], Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onFilePicker(event: onFilePicker, listener: js.Function1[/* oldFile */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onInitialized(event: onInitialized, listener: js.Function0[Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onLoadStarted(event: onLoadStarted, listener: js.Function0[Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onPageCreated(event: onPageCreated, listener: js.Function1[/* newPage */ js.Any, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onPrompt(event: onPrompt, listener: js.Function2[/* msg */ String, /* defaultVal */ String, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onResourceError(event: onResourceError, listener: js.Function1[/* resourceError */ Anon_ErrorCode, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  def on_onResourceReceived(event: onResourceReceived, listener: js.Function1[/* response */ IResponse, Unit]): js.Promise[Anon_PageId] = js.native
  @JSName("on")
  ...
  @JSName("on")
  def on_onUrlChanged(event: onUrlChanged, listener: js.Function1[/* targetUrl */ String, Unit]): js.Promise[Anon_PageId] = js.native
  ...
  @JSName("property")
  def property_clipRect(key: clipRect): js.Promise[Anon_Height] = js.native
  @JSName("property")
  ...
  @JSName("property")
  def property_scrollPosition(key: scrollPosition): js.Promise[Anon_Left] = js.native
  @JSName("property")
  def property_viewportSize(key: viewportSize): js.Promise[Anon_HeightWidth] = js.native
  @JSName("property")
