...
object phantomStrings {
  ...
  @js.native
  sealed trait BackOrForward extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait FormResubmitted extends StObject
  @scala.inline
  def FormResubmitted: FormResubmitted = "FormResubmitted".asInstanceOf[FormResubmitted]
  
  @js.native
  sealed trait FormSubmitted extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait LinkClicked extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait XSSAuditingEnabled extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait canGoForward extends StObject
  @scala.inline
  def canGoForward: canGoForward = "canGoForward".asInstanceOf[canGoForward]
  
  @js.native
  sealed trait clipRect extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait cookies extends StObject
  @scala.inline
  def cookies: cookies = "cookies".asInstanceOf[cookies]
  
  @js.native
  sealed trait customHeaders extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait javascriptEnabled extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait libraryPath extends StObject
  @scala.inline
  def libraryPath: libraryPath = "libraryPath".asInstanceOf[libraryPath]
  
  @js.native
  sealed trait loadImages extends StObject
  @scala.inline
  def loadImages: loadImages = "loadImages".asInstanceOf[loadImages]
  
  @js.native
  sealed trait localToRemoteUrlAccessEnabled extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait pagesWindowName extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait phantom extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait resourceTimeout extends StObject
  @scala.inline
  def resourceTimeout: resourceTimeout = "resourceTimeout".asInstanceOf[resourceTimeout]
  
  @js.native
  sealed trait scrollPosition extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait viewportSize extends StObject
  @scala.inline
