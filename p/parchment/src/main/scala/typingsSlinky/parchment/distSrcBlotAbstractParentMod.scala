...
import typingsSlinky.parchment.distSrcBlotAbstractParentMod.ParentBlot
...
@js.native
object distSrcBlotAbstractParentMod extends js.Object {
  ...
  - typings.parchment.distSrcBlotAbstractBlotMod.Parent because var conflicts: domNode, next, parent, prev, scroll. Inlined children, appendChild, descendant, descendant, descendants, descendants, insertBefore, insertBefore, moveChildren, moveChildren, path, path, removeChild, unwrap */ @js.native
  trait ParentBlot
    extends typingsSlinky.parchment.distSrcBlotAbstractShadowMod.default {
    var children: typingsSlinky.parchment.distSrcCollectionLinkedDashListMod.default[Blot] = js.native
    @JSName("domNode")
    ...
    def descendant(criteria: Anon_Blot, index: Double): js.Tuple2[Blot | Null, Double] = js.native
    ...
    def descendants(criteria: Anon_Blot, index: Double, length: Double): js.Array[Blot] = js.native
