package typingsSlinky.parchment.distSrcAttributorStoreMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.parchment.distSrcBlotAbstractBlotMod.Formattable
...
trait AttributorStore extends js.Object {
  ...
  var domNode: js.Any
  def attribute(attribute: typingsSlinky.parchment.distSrcAttributorAttributorMod.default, value: js.Any): Unit
  def build(): Unit
...
object AttributorStore {
  @scala.inline
  def apply(
    attribute: (typingsSlinky.parchment.distSrcAttributorAttributorMod.default, js.Any) => Unit,
    attributes: js.Any,
    build: () => Unit,
