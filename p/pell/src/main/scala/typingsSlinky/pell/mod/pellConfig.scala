...
object pellConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.std.HTMLElement */ T](actions: js.Array[pellAction], element: T, onChange: String => Unit): pellConfig[T] = {
  ...
  @scala.inline
  implicit class pellConfigOps[Self <: pellConfig[_], /* <: typingsSlinky.std.HTMLElement */ T] (val x: Self with pellConfig[T]) extends AnyVal {
    @scala.inline
