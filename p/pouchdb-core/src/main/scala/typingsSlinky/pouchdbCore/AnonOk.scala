...
object AnonOk {
  @scala.inline
  def apply[Content](ok: Content with GetMeta): AnonOk[Content] = {
    val __obj = js.Dynamic.literal(ok = ok.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOk[Content]]
  }
  @scala.inline
  implicit class AnonOkOps[Self[content] <: AnonOk[content], Content] (val x: Self[Content]) extends AnyVal {
    @scala.inline
