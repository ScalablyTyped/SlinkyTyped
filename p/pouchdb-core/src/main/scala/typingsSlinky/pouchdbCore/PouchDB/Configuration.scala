...
object Configuration {
  ...
  */
  ...
  object DatabaseConfiguration {
    ...
    @scala.inline
    def LocalDatabaseConfiguration(): typingsSlinky.pouchdbCore.PouchDB.Configuration.LocalDatabaseConfiguration = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.pouchdbCore.PouchDB.Configuration.LocalDatabaseConfiguration]
    }
    
    @scala.inline
    def RemoteDatabaseConfiguration(): typingsSlinky.pouchdbCore.PouchDB.Configuration.RemoteDatabaseConfiguration = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.pouchdbCore.PouchDB.Configuration.RemoteDatabaseConfiguration]
    }
  }
