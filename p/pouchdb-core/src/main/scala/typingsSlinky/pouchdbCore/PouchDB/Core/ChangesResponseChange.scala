...
import typingsSlinky.pouchdbCore.anon.RevString
...
object ChangesResponseChange {
  @scala.inline
  def apply[Content](changes: js.Array[RevString], id: String, seq: Double | String): ChangesResponseChange[Content] = {
  ...
  implicit class ChangesResponseChangeOps[Self[content] <: ChangesResponseChange[content], Content] (val x: Self[Content]) extends AnyVal {
    ...
    @scala.inline
    def withChanges(value: js.Array[RevString]): Self[Content] = {
