...
import typingsSlinky.pouchdbCore.pouchdbCoreBooleans.`false`
import typingsSlinky.pouchdbCore.pouchdbCoreStrings.all_docs
import typingsSlinky.pouchdbCore.pouchdbCoreStrings.main_only
import typingsSlinky.pouchdbCore.pouchdbCoreStrings.now
