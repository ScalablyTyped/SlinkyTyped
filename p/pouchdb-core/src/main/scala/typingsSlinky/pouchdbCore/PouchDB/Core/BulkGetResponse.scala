...
object BulkGetResponse {
  @scala.inline
  def apply[/* <: js.Object */ Content](results: js.Array[Docs[Content]]): BulkGetResponse[Content] = {
    val __obj = js.Dynamic.literal(results = results.asInstanceOf[js.Any])
    __obj.asInstanceOf[BulkGetResponse[Content]]
  }
  @scala.inline
  implicit class BulkGetResponseOps[Self <: BulkGetResponse[_], /* <: js.Object */ Content] (val x: Self with BulkGetResponse[Content]) extends AnyVal {
    @scala.inline
