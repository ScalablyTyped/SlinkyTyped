...
import typingsSlinky.pouchdbCore.AnonDocs
...
trait BulkGetResponse[Content /* <: js.Object */] extends js.Object {
  var results: js.Array[AnonDocs[Content]] = js.native
}

object BulkGetResponse {
  @scala.inline
  def apply[Content](results: js.Array[AnonDocs[Content]]): BulkGetResponse[Content] = {
  ...
  implicit class BulkGetResponseOps[Self[content] <: BulkGetResponse[content], Content] (val x: Self[Content]) extends AnyVal {
    ...
    @scala.inline
    def withResults(value: js.Array[AnonDocs[Content]]): Self[Content] = {
