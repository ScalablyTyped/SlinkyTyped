...
object Docs {
  @scala.inline
  def apply[/* <: js.Object */ Content](docs: js.Array[Ok[Content] | Error], id: String): Docs[Content] = {
    val __obj = js.Dynamic.literal(docs = docs.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[Docs[Content]]
  }
  @scala.inline
  implicit class DocsOps[Self <: Docs[_], /* <: js.Object */ Content] (val x: Self with Docs[Content]) extends AnyVal {
    @scala.inline
