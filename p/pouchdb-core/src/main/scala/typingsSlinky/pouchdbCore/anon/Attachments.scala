...
trait Attachments extends js.Object {
  var _attachments: js.UndefOr[typingsSlinky.pouchdbCore.PouchDB.Core.Attachments] = js.undefined
...
object Attachments {
  @scala.inline
  def apply(
    _attachments: typingsSlinky.pouchdbCore.PouchDB.Core.Attachments = null,
