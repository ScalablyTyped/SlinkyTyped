...
import typingsSlinky.pouchdbDashCore.Anon_RevRevisionId
import typingsSlinky.pouchdbDashCore.Blob
import typingsSlinky.pouchdbDashCore.Buffer
import typingsSlinky.pouchdbDashCore.EventEmitter
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AllDocsOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AllDocsResponse
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AllDocsWithKeyOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AllDocsWithKeysOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AllDocsWithinRangeOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AttachmentData
import typingsSlinky.pouchdbDashCore.PouchDB.Core.AttachmentId
import typingsSlinky.pouchdbDashCore.PouchDB.Core.BulkDocsOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.BulkGetOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.BulkGetResponse
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Callback
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Changes
import typingsSlinky.pouchdbDashCore.PouchDB.Core.ChangesOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.CompactOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.DatabaseInfo
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Document
import typingsSlinky.pouchdbDashCore.PouchDB.Core.DocumentId
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Error
import typingsSlinky.pouchdbDashCore.PouchDB.Core.GetMeta
import typingsSlinky.pouchdbDashCore.PouchDB.Core.GetOpenRevisions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.GetOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Options
import typingsSlinky.pouchdbDashCore.PouchDB.Core.PostDocument
import typingsSlinky.pouchdbDashCore.PouchDB.Core.PutDocument
import typingsSlinky.pouchdbDashCore.PouchDB.Core.PutOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.RemoveAttachmentResponse
import typingsSlinky.pouchdbDashCore.PouchDB.Core.RemoveDocument
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Response
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Revision
import typingsSlinky.pouchdbDashCore.PouchDB.Core.RevisionDiffOptions
import typingsSlinky.pouchdbDashCore.PouchDB.Core.RevisionDiffResponse
import typingsSlinky.pouchdbDashCore.PouchDB.Core.RevisionId
...
trait Database[Content /* <: js.Object */] extends EventEmitter {
  ...
  def getAttachment(docId: DocumentId, attachmentId: AttachmentId, options: Anon_RevRevisionId): js.Promise[Blob | Buffer] = js.native
  /** Get attachment data */
  def getAttachment(
    docId: DocumentId,
    attachmentId: AttachmentId,
    options: Anon_RevRevisionId,
