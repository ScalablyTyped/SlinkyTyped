...
@js.native
object buildSrcDrawersSvgDrawerMod extends js.Object {
  @js.native
  class SVGDrawer protected () extends IDrawer {
    ...
    /**
      ...
      */
    var _root: Selection[SVGElement, _, _, _] = js.native
    /**
    ...
    def attachTo(parent: Selection[SVGElement, _, _, _]): Unit = js.native
    /**
    ...
    def getRoot(): Selection[SVGElement, _, _, _] = js.native
    /**
