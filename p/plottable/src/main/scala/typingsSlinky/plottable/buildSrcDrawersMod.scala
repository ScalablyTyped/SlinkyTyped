...
object buildSrcDrawersMod extends js.Object {
  ...
  class ArcOutlineSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersArcOutlineDrawerMod.ArcOutlineSVGDrawer
  
  @js.native
  class ArcSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersArcDrawerMod.ArcSVGDrawer
  
  @js.native
  class AreaSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersAreaDrawerMod.AreaSVGDrawer
  
  @js.native
  class CanvasDrawer protected ()
    extends typingsSlinky.plottable.buildSrcDrawersCanvasDrawerMod.CanvasDrawer {
    /**
  ...
  @js.native
  class LineSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersLineDrawerMod.LineSVGDrawer
  ...
  class RectangleCanvasDrawer protected ()
    extends typingsSlinky.plottable.buildSrcDrawersRectangleDrawerMod.RectangleCanvasDrawer {
    def this(ctx: CanvasRenderingContext2D) = this()
  }
  
  @js.native
  class RectangleSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersRectangleDrawerMod.RectangleSVGDrawer {
    def this(_rootClassName: String) = this()
  }
  
  @js.native
  class SVGDrawer protected ()
    extends typingsSlinky.plottable.buildSrcDrawersSvgDrawerMod.SVGDrawer {
    /**
  ...
  class SegmentSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersSegmentDrawerMod.SegmentSVGDrawer
  
  @js.native
  class SymbolSVGDrawer ()
    extends typingsSlinky.plottable.buildSrcDrawersSymbolDrawerMod.SymbolSVGDrawer
