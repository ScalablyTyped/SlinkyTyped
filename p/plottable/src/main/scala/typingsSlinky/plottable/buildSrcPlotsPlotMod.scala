...
import typingsSlinky.plottable.buildSrcDrawersDrawerMod.ProxyDrawer
...
@js.native
object buildSrcPlotsPlotMod extends js.Object {
  @js.native
  /**
  ...
  class Plot () extends Component {
    ...
    var _bufferCanvas: Selection[HTMLCanvasElement, _, _, _] = js.native
    ...
    /**
      ...
      * the canvas renderer).
      */
    var _canvas: Selection[HTMLCanvasElement, _, _, _] = js.native
    /**
    ...
    /**
      ...
      */
    var _propertyBindings: Map[IAccessorScaleBinding[_, _]] = js.native
    /**
    ...
    /**
      ...
      */
    var _renderArea: Selection[SVGGElement, _, _, _] = js.native
    ...
    /**
      ...
      */
    /* protected */ def _createNodesForDataset(dataset: Dataset): typingsSlinky.plottable.buildSrcDrawersMod.ProxyDrawer = js.native
    /* protected */ def _entityBounds(entity: ILightweightPlotEntity): Anon_HeightWidthXY = js.native
    /* protected */ def _entityBounds(entity: IPlotEntity): Anon_HeightWidthXY = js.native
    ...
    /* protected */ def _getDataToDraw(): typingsSlinky.plottable.buildSrcUtilsMod.Map[Dataset, js.Array[_]] = js.native
    /**
