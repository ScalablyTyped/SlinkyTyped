...
@js.native
object buildSrcDispatchersMod extends js.Object {
  @js.native
  /**
    ...
    */
  class Key ()
    extends typingsSlinky.plottable.buildSrcDispatchersKeyDispatcherMod.Key
  ...
  class Mouse protected ()
    extends typingsSlinky.plottable.buildSrcDispatchersMouseDispatcherMod.Mouse
  
  @js.native
  class Touch protected ()
    extends typingsSlinky.plottable.buildSrcDispatchersTouchDispatcherMod.Touch {
    /**
      * This constructor should not be invoked directly.
      *
