...
import typingsSlinky.plottable.drawerMod.ProxyDrawer
import typingsSlinky.plottable.entityStoreMod.IEntityStore
...
class Plot () extends Component {
  ...
  /**
    ...
    */
  /* protected */ def _createNodesForDataset(dataset: Dataset): typingsSlinky.plottable.drawersMod.ProxyDrawer = js.native
