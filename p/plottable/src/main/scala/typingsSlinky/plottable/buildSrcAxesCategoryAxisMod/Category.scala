...
class Category protected () extends Axis[String] {
  ...
  def getDownsampleInfo(scale: typingsSlinky.plottable.buildSrcScalesMod.Category): IDownsampleInfo = js.native
  def getDownsampleInfo(scale: typingsSlinky.plottable.buildSrcScalesMod.Category, domain: js.Array[String]): IDownsampleInfo = js.native
  /**
