...
import typingsSlinky.plottable.Anon_X
...
object Interactions extends js.Object {
  @js.native
  class Click ()
    extends typingsSlinky.plottable.buildSrcInteractionsMod.Click
  
  @js.native
  class Drag ()
    extends typingsSlinky.plottable.buildSrcInteractionsMod.Drag {
  ...
  /**
    ...
    */
  class PanZoom ()
    extends typingsSlinky.plottable.buildSrcInteractionsMod.PanZoom {
