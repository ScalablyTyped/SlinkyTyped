...
class Axis[D] protected ()
  extends typingsSlinky.plottable.buildSrcAxesAxisMod.Axis[D] {
  /**
    * Constructs an Axis.
    ...
    */
  def this(
    scale: typingsSlinky.plottable.buildSrcScalesScaleMod.Scale[D, Double],
    orientation: typingsSlinky.plottable.buildSrcAxesAxisMod.AxisOrientation
  ) = this()
}
