...
object Dispatchers extends js.Object {
  ...
  /**
    ...
    */
  class Key ()
    extends typingsSlinky.plottable.buildSrcDispatchersMod.Key
  ...
  class Mouse protected ()
    extends typingsSlinky.plottable.buildSrcDispatchersMod.Mouse
  
  @js.native
  class Touch protected ()
    extends typingsSlinky.plottable.buildSrcDispatchersMod.Touch {
    /**
      * This constructor should not be invoked directly.
      *
      * @param {SVGElement} svg The root <svg> to attach to.
      */
    def this(component: typingsSlinky.plottable.buildSrcComponentsComponentMod.Component) = this()
  }
  ...
  object Mouse extends js.Object {
    ...
    /**
      ...
      */
    def getDispatcher(component: typingsSlinky.plottable.buildSrcComponentsComponentMod.Component): typingsSlinky.plottable.buildSrcDispatchersMod.Mouse = js.native
  }
  ...
  object Touch extends js.Object {
    ...
    /**
      ...
      */
    def getDispatcher(component: typingsSlinky.plottable.buildSrcComponentsComponentMod.Component): typingsSlinky.plottable.buildSrcDispatchersMod.Touch = js.native
  }
