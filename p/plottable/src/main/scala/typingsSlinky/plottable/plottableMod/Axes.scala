...
object Axes extends js.Object {
  ...
  class Category protected ()
    extends typingsSlinky.plottable.buildSrcAxesMod.Category {
    /**
    ...
    def this(
      scale: typingsSlinky.plottable.buildSrcScalesMod.Category,
  ...
  class Numeric protected ()
    extends typingsSlinky.plottable.buildSrcAxesMod.Numeric {
    /**
      ...
      */
    def this(
      scale: typingsSlinky.plottable.buildSrcScalesQuantitativeScaleMod.QuantitativeScale[Double],
      orientation: typingsSlinky.plottable.buildSrcAxesAxisMod.AxisOrientation
    ) = this()
  }
  ...
  class Time protected ()
    extends typingsSlinky.plottable.buildSrcAxesMod.Time {
    /**
