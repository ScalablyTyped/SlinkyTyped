...
object Scales extends js.Object {
  ...
  /**
    ...
    */
  class Category ()
    extends typingsSlinky.plottable.buildSrcScalesMod.Category
  ...
  /**
    ...
    */
  class Color ()
    extends typingsSlinky.plottable.buildSrcScalesMod.Color {
  ...
  class InterpolatedColor ()
    extends typingsSlinky.plottable.buildSrcScalesMod.InterpolatedColor {
    def this(scaleType: String) = this()
  }
  ...
  /**
    ...
    */
  class Linear ()
    extends typingsSlinky.plottable.buildSrcScalesMod.Linear
  ...
  /**
    ...
    */
  class Log ()
    extends typingsSlinky.plottable.buildSrcScalesMod.Log {
  ...
  /**
    ...
    */
  class ModifiedLog ()
    extends typingsSlinky.plottable.buildSrcScalesMod.ModifiedLog {
    def this(base: Double) = this()
  }
  ...
  /**
    ...
    */
  class Time ()
    extends typingsSlinky.plottable.buildSrcScalesMod.Time
