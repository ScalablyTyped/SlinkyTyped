...
object RTree extends js.Object {
  @js.native
  class RTree[T] ()
    extends typingsSlinky.plottable.buildSrcUtilsMod.RTree.RTree[T] {
  ...
  class RTreeBounds protected ()
    extends typingsSlinky.plottable.buildSrcUtilsMod.RTree.RTreeBounds {
    def this(xl: Double, yl: Double, xh: Double, yh: Double) = this()
  }
  
  @js.native
  class RTreeNode[T] protected ()
    extends typingsSlinky.plottable.buildSrcUtilsMod.RTree.RTreeNode[T] {
