...
@js.native
object buildSrcAnimatorsMod extends js.Object {
  @js.native
  /**
    ...
    */
  class Easing ()
    extends typingsSlinky.plottable.buildSrcAnimatorsEasingAnimatorMod.Easing
  
  @js.native
  class Null ()
    extends typingsSlinky.plottable.buildSrcAnimatorsNullAnimatorMod.Null
