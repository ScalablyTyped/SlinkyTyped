...
import typingsSlinky.plottable.buildSrcPlotsBarPlotMod.Bar
import typingsSlinky.plottable.buildSrcPlotsBarPlotMod.BarOrientation
...
@js.native
object buildSrcPlotsClusteredBarPlotMod extends js.Object {
  @js.native
  /**
