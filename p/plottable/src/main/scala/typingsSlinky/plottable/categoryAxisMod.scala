...
object categoryAxisMod {
  ...
  class Category protected () extends Axis[String] {
    ...
    def getDownsampleInfo(scale: typingsSlinky.plottable.scalesMod.Category): IDownsampleInfo = js.native
    def getDownsampleInfo(scale: typingsSlinky.plottable.scalesMod.Category, domain: js.Array[String]): IDownsampleInfo = js.native
