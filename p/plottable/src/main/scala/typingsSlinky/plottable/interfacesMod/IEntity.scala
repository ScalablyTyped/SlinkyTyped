...
object IEntity {
  @scala.inline
  def apply[/* <: typingsSlinky.plottable.componentMod.Component */ C](bounds: IEntityBounds, component: C, datum: js.Any, position: Point, selection: SimpleSelection[_]): IEntity[C] = {
  ...
  @scala.inline
  implicit class IEntityOps[Self <: IEntity[_], /* <: typingsSlinky.plottable.componentMod.Component */ C] (val x: Self with IEntity[C]) extends AnyVal {
    @scala.inline
