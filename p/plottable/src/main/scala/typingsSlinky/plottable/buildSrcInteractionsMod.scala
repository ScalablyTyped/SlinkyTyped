...
@js.native
object buildSrcInteractionsMod extends js.Object {
  @js.native
  class Click ()
    extends typingsSlinky.plottable.buildSrcInteractionsClickInteractionMod.Click
  
  @js.native
  class Drag ()
    extends typingsSlinky.plottable.buildSrcInteractionsDragInteractionMod.Drag {
    def this(mouseButton: Double) = this()
  }
  
  @js.native
  class Key ()
    extends typingsSlinky.plottable.buildSrcInteractionsKeyInteractionMod.Key
  ...
  /**
    ...
    */
  class PanZoom ()
    extends typingsSlinky.plottable.buildSrcInteractionsPanZoomInteractionMod.PanZoom {
  ...
  @js.native
  class Pointer ()
    extends typingsSlinky.plottable.buildSrcInteractionsPointerInteractionMod.Pointer
