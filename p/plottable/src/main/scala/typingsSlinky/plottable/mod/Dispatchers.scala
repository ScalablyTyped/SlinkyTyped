...
object Dispatchers extends js.Object {
  ...
  /**
    ...
    */
  class Key ()
    extends typingsSlinky.plottable.dispatchersMod.Key
  ...
  class Mouse protected ()
    extends typingsSlinky.plottable.dispatchersMod.Mouse
  
  @js.native
  class Touch protected ()
    extends typingsSlinky.plottable.dispatchersMod.Touch {
    /**
      * This constructor should not be invoked directly.
      *
      * @param {SVGElement} svg The root <svg> to attach to.
      */
    def this(component: typingsSlinky.plottable.componentMod.Component) = this()
  }
  ...
  object Mouse extends js.Object {
    ...
    /**
      ...
      */
    def getDispatcher(component: typingsSlinky.plottable.componentMod.Component): typingsSlinky.plottable.dispatchersMod.Mouse = js.native
  }
  ...
  object Touch extends js.Object {
    ...
    /**
      ...
      */
    def getDispatcher(component: typingsSlinky.plottable.componentMod.Component): typingsSlinky.plottable.dispatchersMod.Touch = js.native
  }
