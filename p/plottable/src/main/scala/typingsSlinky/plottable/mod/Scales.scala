...
object Scales extends js.Object {
  ...
  /**
    ...
    */
  class Category ()
    extends typingsSlinky.plottable.scalesMod.Category
  ...
  /**
    ...
    */
  class Color ()
    extends typingsSlinky.plottable.scalesMod.Color {
  ...
  class InterpolatedColor ()
    extends typingsSlinky.plottable.scalesMod.InterpolatedColor {
    def this(scaleType: String) = this()
  }
  ...
  /**
    ...
    */
  class Linear ()
    extends typingsSlinky.plottable.scalesMod.Linear
  ...
  /**
    ...
    */
  class Log ()
    extends typingsSlinky.plottable.scalesMod.Log {
  ...
  /**
    ...
    */
  class ModifiedLog ()
    extends typingsSlinky.plottable.scalesMod.ModifiedLog {
    def this(base: Double) = this()
  }
  ...
  /**
    ...
    */
  class Time ()
    extends typingsSlinky.plottable.scalesMod.Time
