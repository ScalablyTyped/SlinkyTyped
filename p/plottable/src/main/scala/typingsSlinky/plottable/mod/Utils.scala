...
object Utils {
  ...
  class Bucket protected ()
    extends typingsSlinky.plottable.utilsMod.Bucket {
  ...
  class CallbackSet[CB /* <: js.Function */] ()
    extends typingsSlinky.plottable.utilsMod.CallbackSet[CB]
  ...
  class EntityStore[T /* <: IPositionedEntity */] ()
    extends typingsSlinky.plottable.utilsMod.EntityStore[T]
  ...
  object RTree {
    ...
    @js.native
    class RTree[T] ()
      extends typingsSlinky.plottable.utilsMod.RTree.RTree[T] {
    ...
    class RTreeBounds protected ()
      extends typingsSlinky.plottable.utilsMod.RTree.RTreeBounds {
    ...
    class RTreeNode[T] protected ()
      extends typingsSlinky.plottable.utilsMod.RTree.RTreeNode[T] {
  ...
  object Stacking {
    ...
    @js.native
    def stack(
      datasets: js.Array[typingsSlinky.plottable.datasetMod.Dataset],
  ...
  object Translator {
    ...
    @js.native
    def isEventInside(component: typingsSlinky.plottable.componentMod.Component, e: Event): Boolean = js.native
  }
  ...
  @js.native
  def getTranslator(component: typingsSlinky.plottable.componentMod.Component): typingsSlinky.plottable.transformAwareTranslatorMod.Translator = js.native
}
