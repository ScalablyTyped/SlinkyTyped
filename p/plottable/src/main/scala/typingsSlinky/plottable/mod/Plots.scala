...
object Plots {
  ...
  /**
    ...
    */
  class Area[X] ()
    extends typingsSlinky.plottable.plotsMod.Area[X]
  /* static members */
  object Area {
  ...
  /**
    ...
    */
  class Bar[X, Y] ()
    extends typingsSlinky.plottable.plotsMod.Bar[X, Y] {
  ...
  /**
    ...
    */
  class Line[X] ()
    extends typingsSlinky.plottable.plotsMod.Line[X]
  ...
  /**
    ...
    */
  class Scatter[X, Y] ()
    extends typingsSlinky.plottable.plotsMod.Scatter[X, Y]
  /* static members */
  object Scatter {
  ...
  /**
    ...
    */
  class StackedArea[X] ()
    extends typingsSlinky.plottable.plotsMod.StackedArea[X]
  /* static members */
  object StackedArea {
  ...
  class StackedBar[X, Y] ()
    extends typingsSlinky.plottable.plotsMod.StackedBar[X, Y] {
    def this(orientation: BarOrientation) = this()
  }
  /* static members */
  object StackedBar {
  ...
  @js.native
  class Waterfall[X, Y] ()
    extends typingsSlinky.plottable.plotsMod.Waterfall[X, Y]
  /* static members */
  object Waterfall {
