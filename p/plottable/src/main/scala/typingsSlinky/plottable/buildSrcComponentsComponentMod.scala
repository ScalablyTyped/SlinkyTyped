...
import typingsSlinky.plottable.buildSrcComponentsComponentMod.ComponentCallback
import typingsSlinky.plottable.buildSrcComponentsComponentMod.IResizeHandler
import typingsSlinky.plottable.buildSrcComponentsComponentMod.XAlignment
import typingsSlinky.plottable.buildSrcComponentsComponentMod.YAlignment
...
import typingsSlinky.plottable.buildSrcCoreInterfacesMod.SpaceRequest
...
@js.native
object buildSrcComponentsComponentMod extends js.Object {
  @js.native
  class Component () extends js.Object {
    ...
    def renderTo(element: Selection[typingsSlinky.std.HTMLElement, _, _, _]): this.type = js.native
