...
object PaginateOptions {
  @scala.inline
  def apply[/* <: js.Object */ Content](): PaginateOptions[Content] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PaginateOptions[Content]]
  }
  @scala.inline
  implicit class PaginateOptionsOps[Self <: PaginateOptions[_], /* <: js.Object */ Content] (val x: Self with PaginateOptions[Content]) extends AnyVal {
    @scala.inline
