...
import typingsSlinky.pegjs.pegjsStrings.parser
...
object mod {
  ...
  type Location = typingsSlinky.pegjs.mod.PEG.Location
  
  type LocationRange = typingsSlinky.pegjs.mod.PEG.LocationRange
  ...
  object PEG {
    ...
    object Location {
      ...
      @scala.inline
      def apply(column: Double, line: Double, offset: Double): typingsSlinky.pegjs.mod.PEG.Location = {
        val __obj = js.Dynamic.literal(column = column.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.pegjs.mod.PEG.Location]
      }
      
      @scala.inline
      implicit class LocationMutableBuilder[Self <: typingsSlinky.pegjs.mod.PEG.Location] (val x: Self) extends AnyVal {
    ...
    trait LocationRange extends StObject {
      ...
      var end: typingsSlinky.pegjs.mod.PEG.Location = js.native
      
      var start: typingsSlinky.pegjs.mod.PEG.Location = js.native
    }
    object LocationRange {
      
      @scala.inline
      def apply(end: typingsSlinky.pegjs.mod.PEG.Location, start: typingsSlinky.pegjs.mod.PEG.Location): typingsSlinky.pegjs.mod.PEG.LocationRange = {
        val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.pegjs.mod.PEG.LocationRange]
      }
      
      @scala.inline
      implicit class LocationRangeMutableBuilder[Self <: typingsSlinky.pegjs.mod.PEG.LocationRange] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setEnd(value: typingsSlinky.pegjs.mod.PEG.Location): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setStart(value: typingsSlinky.pegjs.mod.PEG.Location): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
      }
    }
    ...
    trait SyntaxError extends StObject {
      ...
      var location: typingsSlinky.pegjs.mod.PEG.LocationRange = js.native
    ...
    object SyntaxError {
      ...
      def apply(
        ...
        found: js.Any,
        line: Double,
        location: typingsSlinky.pegjs.mod.PEG.LocationRange,
        message: String,
        name: String,
        offset: Double
      ): SyntaxError = {
      ...
      implicit class SyntaxErrorMutableBuilder[Self <: SyntaxError] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setLocation(value: typingsSlinky.pegjs.mod.PEG.LocationRange): Self = StObject.set(x, "location", value.asInstanceOf[js.Any])
