...
object PropsHTMLBodyElementconte {
  ...
  implicit class PropsHTMLBodyElementconteMutableBuilder[Self <: PropsHTMLBodyElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnmessage(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ MessageEvent, _]): Self = StObject.set(x, "onmessage", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmessageerror(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ MessageEvent, _]): Self = StObject.set(x, "onmessageerror", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ ProgressEvent, _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
