...
object PropsSVGPathElementconten {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _]) => Unit = null,
    ...
    createSVGPathSegArcAbs: (/* x */ Double, /* y */ Double, /* r1 */ Double, /* r2 */ Double, /* angle */ Double, /* largeArcFlag */ Boolean, /* sweepFlag */ Boolean) => SVGPathSegArcAbs = null,
    createSVGPathSegArcRel: (/* x */ Double, /* y */ Double, /* r1 */ Double, /* r2 */ Double, /* angle */ Double, /* largeArcFlag */ Boolean, /* sweepFlag */ Boolean) => SVGPathSegArcRel = null,
    createSVGPathSegClosePath: () => SVGPathSegClosePath = null,
    createSVGPathSegCurvetoCubicAbs: (/* x */ Double, /* y */ Double, /* x1 */ Double, /* y1 */ Double, /* x2 */ Double, /* y2 */ Double) => SVGPathSegCurvetoCubicAbs = null,
    createSVGPathSegCurvetoCubicRel: (/* x */ Double, /* y */ Double, /* x1 */ Double, /* y1 */ Double, /* x2 */ Double, /* y2 */ Double) => SVGPathSegCurvetoCubicRel = null,
    createSVGPathSegCurvetoCubicSmoothAbs: (/* x */ Double, /* y */ Double, /* x2 */ Double, /* y2 */ Double) => SVGPathSegCurvetoCubicSmoothAbs = null,
    createSVGPathSegCurvetoCubicSmoothRel: (/* x */ Double, /* y */ Double, /* x2 */ Double, /* y2 */ Double) => SVGPathSegCurvetoCubicSmoothRel = null,
    createSVGPathSegCurvetoQuadraticAbs: (/* x */ Double, /* y */ Double, /* x1 */ Double, /* y1 */ Double) => SVGPathSegCurvetoQuadraticAbs = null,
    createSVGPathSegCurvetoQuadraticRel: (/* x */ Double, /* y */ Double, /* x1 */ Double, /* y1 */ Double) => SVGPathSegCurvetoQuadraticRel = null,
    createSVGPathSegCurvetoQuadraticSmoothAbs: (/* x */ Double, /* y */ Double) => SVGPathSegCurvetoQuadraticSmoothAbs = null,
    createSVGPathSegCurvetoQuadraticSmoothRel: (/* x */ Double, /* y */ Double) => SVGPathSegCurvetoQuadraticSmoothRel = null,
    createSVGPathSegLinetoAbs: (/* x */ Double, /* y */ Double) => SVGPathSegLinetoAbs = null,
    createSVGPathSegLinetoHorizontalAbs: /* x */ Double => SVGPathSegLinetoHorizontalAbs = null,
    createSVGPathSegLinetoHorizontalRel: /* x */ Double => SVGPathSegLinetoHorizontalRel = null,
    createSVGPathSegLinetoRel: (/* x */ Double, /* y */ Double) => SVGPathSegLinetoRel = null,
    createSVGPathSegLinetoVerticalAbs: /* y */ Double => SVGPathSegLinetoVerticalAbs = null,
    createSVGPathSegLinetoVerticalRel: /* y */ Double => SVGPathSegLinetoVerticalRel = null,
    createSVGPathSegMovetoAbs: (/* x */ Double, /* y */ Double) => SVGPathSegMovetoAbs = null,
    createSVGPathSegMovetoRel: (/* x */ Double, /* y */ Double) => SVGPathSegMovetoRel = null,
    ...
    getPathSegAtLength: /* distance */ Double => Double = null,
    getPointAtLength: /* distance */ Double => SVGPoint = null,
    ...
    oncancel: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    oncanplay: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    oncanplaythrough: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onchange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onclick: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ MouseEvent, _] = null,
    onclose: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    oncuechange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    ondragexit: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    ondurationchange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onemptied: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onended: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onerror: js.UndefOr[
    ...
    onfullscreenchange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onfullscreenerror: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ongotpointercapture: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ PointerEvent, _] = null,
    oninput: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    oninvalid: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    onload: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onloadeddata: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onloadedmetadata: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onloadstart: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    onpause: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onplay: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onplaying: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    onratechange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onreset: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onresize: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ UIEvent, _] = null,
    onscroll: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onsecuritypolicyviolation: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ SecurityPolicyViolationEvent, _] = null,
    onseeked: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onseeking: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onselect: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onselectionchange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onselectstart: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onstalled: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onsubmit: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onsuspend: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ontimeupdate: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ontoggle: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    onvolumechange: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    onwaiting: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGPathElementconten, /* ev */ Event, _]) => Unit = null,
    ...
    if (createSVGPathSegArcAbs != null) __obj.updateDynamic("createSVGPathSegArcAbs")(js.Any.fromFunction7(createSVGPathSegArcAbs))
    if (createSVGPathSegArcRel != null) __obj.updateDynamic("createSVGPathSegArcRel")(js.Any.fromFunction7(createSVGPathSegArcRel))
    if (createSVGPathSegClosePath != null) __obj.updateDynamic("createSVGPathSegClosePath")(js.Any.fromFunction0(createSVGPathSegClosePath))
    if (createSVGPathSegCurvetoCubicAbs != null) __obj.updateDynamic("createSVGPathSegCurvetoCubicAbs")(js.Any.fromFunction6(createSVGPathSegCurvetoCubicAbs))
    if (createSVGPathSegCurvetoCubicRel != null) __obj.updateDynamic("createSVGPathSegCurvetoCubicRel")(js.Any.fromFunction6(createSVGPathSegCurvetoCubicRel))
    if (createSVGPathSegCurvetoCubicSmoothAbs != null) __obj.updateDynamic("createSVGPathSegCurvetoCubicSmoothAbs")(js.Any.fromFunction4(createSVGPathSegCurvetoCubicSmoothAbs))
    if (createSVGPathSegCurvetoCubicSmoothRel != null) __obj.updateDynamic("createSVGPathSegCurvetoCubicSmoothRel")(js.Any.fromFunction4(createSVGPathSegCurvetoCubicSmoothRel))
    if (createSVGPathSegCurvetoQuadraticAbs != null) __obj.updateDynamic("createSVGPathSegCurvetoQuadraticAbs")(js.Any.fromFunction4(createSVGPathSegCurvetoQuadraticAbs))
    if (createSVGPathSegCurvetoQuadraticRel != null) __obj.updateDynamic("createSVGPathSegCurvetoQuadraticRel")(js.Any.fromFunction4(createSVGPathSegCurvetoQuadraticRel))
    if (createSVGPathSegCurvetoQuadraticSmoothAbs != null) __obj.updateDynamic("createSVGPathSegCurvetoQuadraticSmoothAbs")(js.Any.fromFunction2(createSVGPathSegCurvetoQuadraticSmoothAbs))
    if (createSVGPathSegCurvetoQuadraticSmoothRel != null) __obj.updateDynamic("createSVGPathSegCurvetoQuadraticSmoothRel")(js.Any.fromFunction2(createSVGPathSegCurvetoQuadraticSmoothRel))
    if (createSVGPathSegLinetoAbs != null) __obj.updateDynamic("createSVGPathSegLinetoAbs")(js.Any.fromFunction2(createSVGPathSegLinetoAbs))
    if (createSVGPathSegLinetoHorizontalAbs != null) __obj.updateDynamic("createSVGPathSegLinetoHorizontalAbs")(js.Any.fromFunction1(createSVGPathSegLinetoHorizontalAbs))
    if (createSVGPathSegLinetoHorizontalRel != null) __obj.updateDynamic("createSVGPathSegLinetoHorizontalRel")(js.Any.fromFunction1(createSVGPathSegLinetoHorizontalRel))
    if (createSVGPathSegLinetoRel != null) __obj.updateDynamic("createSVGPathSegLinetoRel")(js.Any.fromFunction2(createSVGPathSegLinetoRel))
    if (createSVGPathSegLinetoVerticalAbs != null) __obj.updateDynamic("createSVGPathSegLinetoVerticalAbs")(js.Any.fromFunction1(createSVGPathSegLinetoVerticalAbs))
    if (createSVGPathSegLinetoVerticalRel != null) __obj.updateDynamic("createSVGPathSegLinetoVerticalRel")(js.Any.fromFunction1(createSVGPathSegLinetoVerticalRel))
    if (createSVGPathSegMovetoAbs != null) __obj.updateDynamic("createSVGPathSegMovetoAbs")(js.Any.fromFunction2(createSVGPathSegMovetoAbs))
    if (createSVGPathSegMovetoRel != null) __obj.updateDynamic("createSVGPathSegMovetoRel")(js.Any.fromFunction2(createSVGPathSegMovetoRel))
    ...
    if (getPathSegAtLength != null) __obj.updateDynamic("getPathSegAtLength")(js.Any.fromFunction1(getPathSegAtLength))
