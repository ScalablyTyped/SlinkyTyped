...
trait PropsSVGSVGElementcontent extends js.Object {
  ...
  var animationsPaused: js.UndefOr[js.Function0[Boolean]] = js.undefined
  ...
  var checkEnclosure: js.UndefOr[js.Function2[/* element */ SVGElement, /* rect */ SVGRect, Boolean]] = js.undefined
  var checkIntersection: js.UndefOr[js.Function2[/* element */ SVGElement, /* rect */ SVGRect, Boolean]] = js.undefined
  ...
  var contentScriptType: js.UndefOr[String] = js.undefined
  var contentStyleType: js.UndefOr[String] = js.undefined
  ...
  var createEvent: js.UndefOr[js.Function1[AnimationEvent, org.scalajs.dom.raw.AnimationEvent]] = js.undefined
  var createSVGAngle: js.UndefOr[js.Function0[SVGAngle]] = js.undefined
  var createSVGLength: js.UndefOr[js.Function0[SVGLength]] = js.undefined
  var createSVGMatrix: js.UndefOr[js.Function0[SVGMatrix]] = js.undefined
  var createSVGNumber: js.UndefOr[js.Function0[SVGNumber]] = js.undefined
  var createSVGPoint: js.UndefOr[js.Function0[SVGPoint]] = js.undefined
  var createSVGRect: js.UndefOr[js.Function0[SVGRect]] = js.undefined
  var createSVGTransform: js.UndefOr[js.Function0[SVGTransform]] = js.undefined
  var createSVGTransformFromMatrix: js.UndefOr[js.Function1[/* matrix */ SVGMatrix, SVGTransform]] = js.undefined
  var currentScale: js.UndefOr[Double] = js.undefined
  var currentTranslate: js.UndefOr[SVGPoint] = js.undefined
  var dataset: js.UndefOr[DOMStringMap] = js.undefined
  var deselectAll: js.UndefOr[js.Function0[Unit]] = js.undefined
  ...
  var forceRedraw: js.UndefOr[js.Function0[Unit]] = js.undefined
  ...
  var getComputedStyle: js.UndefOr[js.Function1[/* elt */ Element, CSSStyleDeclaration]] = js.undefined
  var getCurrentTime: js.UndefOr[js.Function0[Double]] = js.undefined
  var getElementById: js.UndefOr[js.Function1[/* elementId */ String, Element]] = js.undefined
  ...
  var onunload: js.UndefOr[js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]] = js.undefined
  ...
  var onzoom: js.UndefOr[js.ThisFunction1[/* this */ this.type, /* ev */ SVGZoomEvent, _]] = js.undefined
  ...
  var pauseAnimations: js.UndefOr[js.Function0[Unit]] = js.undefined
  var pixelUnitToMillimeterX: js.UndefOr[Double] = js.undefined
  var pixelUnitToMillimeterY: js.UndefOr[Double] = js.undefined
  ...
  var screenPixelToMillimeterX: js.UndefOr[Double] = js.undefined
  var screenPixelToMillimeterY: js.UndefOr[Double] = js.undefined
  ...
  var setCurrentTime: js.UndefOr[js.Function1[/* seconds */ Double, Unit]] = js.undefined
  ...
  var suspendRedraw: js.UndefOr[js.Function1[/* maxWaitMilliseconds */ Double, Double]] = js.undefined
  ...
  var unpauseAnimations: js.UndefOr[js.Function0[Unit]] = js.undefined
  var unsuspendRedraw: js.UndefOr[js.Function1[/* suspendHandleID */ Double, Unit]] = js.undefined
  var unsuspendRedrawAll: js.UndefOr[js.Function0[Unit]] = js.undefined
  var viewBox: js.UndefOr[SVGAnimatedRect] = js.undefined
  var viewport: js.UndefOr[SVGRect] = js.undefined
  ...
  var zoomAndPan: js.UndefOr[Double] = js.undefined
}
...
object PropsSVGSVGElementcontent {
  ...
  def apply(
    ...
    addEventListener: (SVGUnload, /* listener */ js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]) => Unit = null,
    after: /* repeated */ Node | String => Unit = null,
    animate: /* keyframes */ js.Array[Keyframe] => Animation = null,
    animationsPaused: () => Boolean = null,
    ...
    blur: () => Unit = null,
    checkEnclosure: (/* element */ SVGElement, /* rect */ SVGRect) => Boolean = null,
    checkIntersection: (/* element */ SVGElement, /* rect */ SVGRect) => Boolean = null,
    ...
    createEvent: AnimationEvent => org.scalajs.dom.raw.AnimationEvent = null,
    createSVGAngle: () => SVGAngle = null,
    createSVGLength: () => SVGLength = null,
    createSVGMatrix: () => SVGMatrix = null,
    createSVGNumber: () => SVGNumber = null,
    createSVGPoint: () => SVGPoint = null,
    createSVGRect: () => SVGRect = null,
    createSVGTransform: () => SVGTransform = null,
    createSVGTransformFromMatrix: /* matrix */ SVGMatrix => SVGTransform = null,
    currentScale: js.UndefOr[Double] = js.undefined,
    currentTranslate: SVGPoint = null,
    dataset: DOMStringMap = null,
    deselectAll: () => Unit = null,
    dispatchEvent: /* event */ Event => Boolean = null,
    firstChild: ChildNode = null,
    firstElementChild: Element = null,
    focus: () => Unit = null,
    forceRedraw: () => Unit = null,
    ...
    getComputedStyle: /* elt */ Element => CSSStyleDeclaration = null,
    ...
    nonce: String = null,
    normalize: () => Unit = null,
    onabort: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ UIEvent, _] = null,
    onanimationcancel: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _] = null,
    onanimationend: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _] = null,
    onanimationiteration: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _] = null,
    onanimationstart: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _] = null,
    onauxclick: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onblur: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ FocusEvent, _] = null,
    oncancel: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    oncanplay: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    oncanplaythrough: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onchange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onclick: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onclose: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    oncontextmenu: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    oncopy: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ClipboardEvent, _] = null,
    oncuechange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    oncut: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ClipboardEvent, _] = null,
    ondblclick: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    ondrag: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondragend: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondragenter: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondragexit: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    ondragleave: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondragover: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondragstart: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondrop: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _] = null,
    ondurationchange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onemptied: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onended: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onerror: js.UndefOr[
    ...
    onfocus: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ FocusEvent, _] = null,
    onfullscreenchange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onfullscreenerror: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    ongotpointercapture: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    oninput: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    oninvalid: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onkeydown: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ KeyboardEvent, _] = null,
    onkeypress: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ KeyboardEvent, _] = null,
    onkeyup: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ KeyboardEvent, _] = null,
    onload: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onloadeddata: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onloadedmetadata: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onloadstart: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onlostpointercapture: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onmousedown: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onmouseenter: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onmouseleave: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onmousemove: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onmouseout: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onmouseover: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onmouseup: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _] = null,
    onpaste: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ClipboardEvent, _] = null,
    onpause: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onplay: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onplaying: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onpointercancel: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointerdown: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointerenter: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointerleave: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointermove: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointerout: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointerover: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onpointerup: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _] = null,
    onprogress: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ProgressEvent, _] = null,
    onratechange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onreset: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onresize: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ UIEvent, _] = null,
    onscroll: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onsecuritypolicyviolation: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ SecurityPolicyViolationEvent, _] = null,
    onseeked: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onseeking: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onselect: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onselectionchange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onselectstart: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onstalled: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onsubmit: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onsuspend: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    ontimeupdate: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    ontoggle: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    ontouchcancel: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _] = null,
    ontouchend: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _] = null,
    ontouchmove: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _] = null,
    ontouchstart: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _] = null,
    ontransitioncancel: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _] = null,
    ontransitionend: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _] = null,
    ontransitionrun: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _] = null,
    ontransitionstart: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _] = null,
    onunload: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onvolumechange: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onwaiting: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _] = null,
    onwheel: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ WheelEvent, _] = null,
    onzoom: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ SVGZoomEvent, _] = null,
    outerHTML: String = null,
    ownerDocument: Document = null,
    ownerSVGElement: SVGSVGElement = null,
    parentElement: HTMLElement = null,
    parentNode: Node with ParentNode = null,
    pauseAnimations: () => Unit = null,
    pixelUnitToMillimeterX: js.UndefOr[Double] = js.undefined,
    pixelUnitToMillimeterY: js.UndefOr[Double] = js.undefined,
    prefix: String = null,
    ...
    removeEventListener: (SVGUnload, /* listener */ js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]) => Unit = null,
    ...
    screenPixelToMillimeterX: js.UndefOr[Double] = js.undefined,
    screenPixelToMillimeterY: js.UndefOr[Double] = js.undefined,
    scroll: () => Unit = null,
    scrollBy: () => Unit = null,
    ...
    if (animationsPaused != null) __obj.updateDynamic("animationsPaused")(js.Any.fromFunction0(animationsPaused))
    ...
    if (checkEnclosure != null) __obj.updateDynamic("checkEnclosure")(js.Any.fromFunction2(checkEnclosure))
    if (checkIntersection != null) __obj.updateDynamic("checkIntersection")(js.Any.fromFunction2(checkIntersection))
    ...
    if (createSVGAngle != null) __obj.updateDynamic("createSVGAngle")(js.Any.fromFunction0(createSVGAngle))
    if (createSVGLength != null) __obj.updateDynamic("createSVGLength")(js.Any.fromFunction0(createSVGLength))
    if (createSVGMatrix != null) __obj.updateDynamic("createSVGMatrix")(js.Any.fromFunction0(createSVGMatrix))
    if (createSVGNumber != null) __obj.updateDynamic("createSVGNumber")(js.Any.fromFunction0(createSVGNumber))
    if (createSVGPoint != null) __obj.updateDynamic("createSVGPoint")(js.Any.fromFunction0(createSVGPoint))
    if (createSVGRect != null) __obj.updateDynamic("createSVGRect")(js.Any.fromFunction0(createSVGRect))
    if (createSVGTransform != null) __obj.updateDynamic("createSVGTransform")(js.Any.fromFunction0(createSVGTransform))
    if (createSVGTransformFromMatrix != null) __obj.updateDynamic("createSVGTransformFromMatrix")(js.Any.fromFunction1(createSVGTransformFromMatrix))
    if (!js.isUndefined(currentScale)) __obj.updateDynamic("currentScale")(currentScale.get.asInstanceOf[js.Any])
    if (currentTranslate != null) __obj.updateDynamic("currentTranslate")(currentTranslate.asInstanceOf[js.Any])
    if (dataset != null) __obj.updateDynamic("dataset")(dataset.asInstanceOf[js.Any])
    if (deselectAll != null) __obj.updateDynamic("deselectAll")(js.Any.fromFunction0(deselectAll))
    ...
    if (forceRedraw != null) __obj.updateDynamic("forceRedraw")(js.Any.fromFunction0(forceRedraw))
    ...
    if (getComputedStyle != null) __obj.updateDynamic("getComputedStyle")(js.Any.fromFunction1(getComputedStyle))
    if (getCurrentTime != null) __obj.updateDynamic("getCurrentTime")(js.Any.fromFunction0(getCurrentTime))
    if (getElementById != null) __obj.updateDynamic("getElementById")(js.Any.fromFunction1(getElementById))
    ...
    if (getEnclosureList != null) __obj.updateDynamic("getEnclosureList")(js.Any.fromFunction2(getEnclosureList))
    if (getIntersectionList != null) __obj.updateDynamic("getIntersectionList")(js.Any.fromFunction2(getIntersectionList))
    ...
    if (pauseAnimations != null) __obj.updateDynamic("pauseAnimations")(js.Any.fromFunction0(pauseAnimations))
    if (!js.isUndefined(pixelUnitToMillimeterX)) __obj.updateDynamic("pixelUnitToMillimeterX")(pixelUnitToMillimeterX.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pixelUnitToMillimeterY)) __obj.updateDynamic("pixelUnitToMillimeterY")(pixelUnitToMillimeterY.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(screenPixelToMillimeterX)) __obj.updateDynamic("screenPixelToMillimeterX")(screenPixelToMillimeterX.get.asInstanceOf[js.Any])
    if (!js.isUndefined(screenPixelToMillimeterY)) __obj.updateDynamic("screenPixelToMillimeterY")(screenPixelToMillimeterY.get.asInstanceOf[js.Any])
