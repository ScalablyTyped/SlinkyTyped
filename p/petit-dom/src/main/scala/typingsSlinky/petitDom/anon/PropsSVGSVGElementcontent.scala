...
import typingsSlinky.petitDom.petitDomStrings.AnimationEvent
import typingsSlinky.petitDom.petitDomStrings.SVGUnload
...
import typingsSlinky.std.SVGZoomEvent
...
/* Inlined petit-dom.petit-dom.PetitDom.Props<std.SVGSVGElement> & {  content :petit-dom.petit-dom.PetitDom.Content | std.ReadonlyArray<petit-dom.petit-dom.PetitDom.Content> | undefined} */
@js.native
trait PropsSVGSVGElementcontent extends StObject {
  ...
  var animationsPaused: js.UndefOr[js.Function0[Boolean]] = js.native
  ...
  var checkEnclosure: js.UndefOr[js.Function2[/* element */ SVGElement, /* rect */ SVGRect, Boolean]] = js.native
  
  var checkIntersection: js.UndefOr[js.Function2[/* element */ SVGElement, /* rect */ SVGRect, Boolean]] = js.native
  ...
  var contentScriptType: js.UndefOr[String] = js.native
  
  var contentStyleType: js.UndefOr[String] = js.native
  
  var correspondingElement: js.UndefOr[SVGElement] = js.native
  
  var correspondingUseElement: js.UndefOr[SVGUseElement] = js.native
  
  var createEvent: js.UndefOr[js.Function1[AnimationEvent, org.scalajs.dom.raw.AnimationEvent]] = js.native
  
  var createSVGAngle: js.UndefOr[js.Function0[SVGAngle]] = js.native
  
  var createSVGLength: js.UndefOr[js.Function0[SVGLength]] = js.native
  
  var createSVGMatrix: js.UndefOr[js.Function0[SVGMatrix]] = js.native
  
  var createSVGNumber: js.UndefOr[js.Function0[SVGNumber]] = js.native
  
  var createSVGPoint: js.UndefOr[js.Function0[SVGPoint]] = js.native
  
  var createSVGRect: js.UndefOr[js.Function0[SVGRect]] = js.native
  
  var createSVGTransform: js.UndefOr[js.Function0[SVGTransform]] = js.native
  
  var createSVGTransformFromMatrix: js.UndefOr[js.Function1[/* matrix */ SVGMatrix, SVGTransform]] = js.native
  
  var currentScale: js.UndefOr[Double] = js.native
  
  var currentTranslate: js.UndefOr[SVGPoint] = js.native
  
  var dataset: js.UndefOr[DOMStringMap] = js.native
  
  var deselectAll: js.UndefOr[js.Function0[Unit]] = js.native
  ...
  var forceRedraw: js.UndefOr[js.Function0[Unit]] = js.native
  ...
  var getComputedStyle: js.UndefOr[js.Function1[/* elt */ Element, CSSStyleDeclaration]] = js.native
  
  var getCurrentTime: js.UndefOr[js.Function0[Double]] = js.native
  
  var getElementById: js.UndefOr[js.Function1[/* elementId */ String, Element]] = js.native
  ...
  var onanimationcancel: js.UndefOr[
    (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.raw.AnimationEvent, _]) | Null
  ] = js.native
  ...
  var onzoom: js.UndefOr[(js.ThisFunction1[/* this */ this.type, /* ev */ SVGZoomEvent, _]) | Null] = js.native
  ...
  var pauseAnimations: js.UndefOr[js.Function0[Unit]] = js.native
  
  var pixelUnitToMillimeterX: js.UndefOr[Double] = js.native
  
  var pixelUnitToMillimeterY: js.UndefOr[Double] = js.native
  ...
  var screenPixelToMillimeterX: js.UndefOr[Double] = js.native
  
  var screenPixelToMillimeterY: js.UndefOr[Double] = js.native
  ...
  var setCurrentTime: js.UndefOr[js.Function1[/* seconds */ Double, Unit]] = js.native
  ...
  var suspendRedraw: js.UndefOr[js.Function1[/* maxWaitMilliseconds */ Double, Double]] = js.native
  ...
  var unpauseAnimations: js.UndefOr[js.Function0[Unit]] = js.native
  
  var unsuspendRedraw: js.UndefOr[js.Function1[/* suspendHandleID */ Double, Unit]] = js.native
  
  var unsuspendRedrawAll: js.UndefOr[js.Function0[Unit]] = js.native
  
  var viewBox: js.UndefOr[SVGAnimatedRect] = js.native
  
  var viewport: js.UndefOr[SVGRect] = js.native
  ...
  var zoomAndPan: js.UndefOr[Double] = js.native
}
object PropsSVGSVGElementcontent {
  
  @scala.inline
  def apply(): PropsSVGSVGElementcontent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PropsSVGSVGElementcontent]
  }
  
  @scala.inline
  implicit class PropsSVGSVGElementcontentMutableBuilder[Self <: PropsSVGSVGElementcontent] (val x: Self) extends AnyVal {
    ...
    def setAddEventListener(
      value: (SVGUnload, /* listener */ js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]) => Unit
    ...
    @scala.inline
    def setAnimationsPausedUndefined: Self = StObject.set(x, "animationsPaused", js.undefined)
    ...
    @scala.inline
    def setCheckEnclosure(value: (/* element */ SVGElement, /* rect */ SVGRect) => Boolean): Self = StObject.set(x, "checkEnclosure", js.Any.fromFunction2(value))
    
    @scala.inline
    def setCheckEnclosureUndefined: Self = StObject.set(x, "checkEnclosure", js.undefined)
    
    @scala.inline
    def setCheckIntersection(value: (/* element */ SVGElement, /* rect */ SVGRect) => Boolean): Self = StObject.set(x, "checkIntersection", js.Any.fromFunction2(value))
    
    @scala.inline
    def setCheckIntersectionUndefined: Self = StObject.set(x, "checkIntersection", js.undefined)
    ...
    @scala.inline
    def setChildNodes(value: NodeListOf[ChildNode with Node]): Self = StObject.set(x, "childNodes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCreateEvent(value: AnimationEvent => org.scalajs.dom.raw.AnimationEvent): Self = StObject.set(x, "createEvent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setCreateSVGAngleUndefined: Self = StObject.set(x, "createSVGAngle", js.undefined)
    
    @scala.inline
    def setCreateSVGLength(value: () => SVGLength): Self = StObject.set(x, "createSVGLength", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateSVGLengthUndefined: Self = StObject.set(x, "createSVGLength", js.undefined)
    
    @scala.inline
    def setCreateSVGMatrix(value: () => SVGMatrix): Self = StObject.set(x, "createSVGMatrix", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateSVGMatrixUndefined: Self = StObject.set(x, "createSVGMatrix", js.undefined)
    
    @scala.inline
    def setCreateSVGNumber(value: () => SVGNumber): Self = StObject.set(x, "createSVGNumber", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateSVGNumberUndefined: Self = StObject.set(x, "createSVGNumber", js.undefined)
    
    @scala.inline
    def setCreateSVGPoint(value: () => SVGPoint): Self = StObject.set(x, "createSVGPoint", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateSVGPointUndefined: Self = StObject.set(x, "createSVGPoint", js.undefined)
    
    @scala.inline
    def setCreateSVGRect(value: () => SVGRect): Self = StObject.set(x, "createSVGRect", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateSVGRectUndefined: Self = StObject.set(x, "createSVGRect", js.undefined)
    
    @scala.inline
    def setCreateSVGTransform(value: () => SVGTransform): Self = StObject.set(x, "createSVGTransform", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCreateSVGTransformFromMatrix(value: /* matrix */ SVGMatrix => SVGTransform): Self = StObject.set(x, "createSVGTransformFromMatrix", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCreateSVGTransformFromMatrixUndefined: Self = StObject.set(x, "createSVGTransformFromMatrix", js.undefined)
    
    @scala.inline
    def setCreateSVGTransformUndefined: Self = StObject.set(x, "createSVGTransform", js.undefined)
    
    @scala.inline
    def setCurrentScale(value: Double): Self = StObject.set(x, "currentScale", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentScaleUndefined: Self = StObject.set(x, "currentScale", js.undefined)
    
    @scala.inline
    def setCurrentTranslate(value: SVGPoint): Self = StObject.set(x, "currentTranslate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentTranslateUndefined: Self = StObject.set(x, "currentTranslate", js.undefined)
    ...
    @scala.inline
    def setGetComputedStyle(value: /* elt */ Element => CSSStyleDeclaration): Self = StObject.set(x, "getComputedStyle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetElementById(value: /* elementId */ String => Element): Self = StObject.set(x, "getElementById", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetElementByIdUndefined: Self = StObject.set(x, "getElementById", js.undefined)
    ...
    ): Self = StObject.set(x, "getEnclosureList", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetEnclosureListUndefined: Self = StObject.set(x, "getEnclosureList", js.undefined)
    ...
    ): Self = StObject.set(x, "getIntersectionList", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetIntersectionListUndefined: Self = StObject.set(x, "getIntersectionList", js.undefined)
    ...
    @scala.inline
    def setOnabort(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ UIEvent, _]): Self = StObject.set(x, "onabort", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationcancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _]): Self = StObject.set(x, "onanimationcancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _]): Self = StObject.set(x, "onanimationend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationiteration(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _]): Self = StObject.set(x, "onanimationiteration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ org.scalajs.dom.raw.AnimationEvent, _]): Self = StObject.set(x, "onanimationstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnauxclick(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onauxclick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnblur(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ FocusEvent, _]): Self = StObject.set(x, "onblur", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncanplay(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "oncanplay", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncanplaythrough(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "oncanplaythrough", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnchange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onchange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnclick(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onclick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnclose(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onclose", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncontextmenu(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "oncontextmenu", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncopy(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ClipboardEvent, _]): Self = StObject.set(x, "oncopy", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncuechange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "oncuechange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOncut(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ClipboardEvent, _]): Self = StObject.set(x, "oncut", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndblclick(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "ondblclick", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndrag(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondrag", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndragend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondragend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndragenter(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondragenter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndragexit(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "ondragexit", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndragleave(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondragleave", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndragover(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondragover", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndragstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondragstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndrop(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ DragEvent, _]): Self = StObject.set(x, "ondrop", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOndurationchange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "ondurationchange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnemptied(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onemptied", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnended(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onended", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnfocus(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ FocusEvent, _]): Self = StObject.set(x, "onfocus", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnfullscreenchange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onfullscreenchange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnfullscreenerror(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onfullscreenerror", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOngotpointercapture(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "ongotpointercapture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOninput(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "oninput", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOninvalid(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "oninvalid", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnkeydown(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ KeyboardEvent, _]): Self = StObject.set(x, "onkeydown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnkeypress(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ KeyboardEvent, _]): Self = StObject.set(x, "onkeypress", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnkeyup(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ KeyboardEvent, _]): Self = StObject.set(x, "onkeyup", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnload(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onload", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnloadeddata(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onloadeddata", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnloadedmetadata(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onloadedmetadata", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnloadstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onloadstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnlostpointercapture(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onlostpointercapture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmousedown(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmousedown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmouseenter(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmouseenter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmouseleave(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmouseleave", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmousemove(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmousemove", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmouseout(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmouseout", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmouseover(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmouseover", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnmouseup(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MouseEvent, _]): Self = StObject.set(x, "onmouseup", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpaste(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ClipboardEvent, _]): Self = StObject.set(x, "onpaste", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpause(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onpause", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnplay(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onplay", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnplaying(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onplaying", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointercancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointercancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointerdown(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointerdown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointerenter(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointerenter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointerleave(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointerleave", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointermove(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointermove", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointerout(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointerout", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointerover(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointerover", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnpointerup(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ PointerEvent, _]): Self = StObject.set(x, "onpointerup", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ProgressEvent, _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnratechange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onratechange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnreset(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onreset", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnresize(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ UIEvent, _]): Self = StObject.set(x, "onresize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnscroll(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onscroll", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnsecuritypolicyviolation(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ SecurityPolicyViolationEvent, _]): Self = StObject.set(x, "onsecuritypolicyviolation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnseeked(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onseeked", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnseeking(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onseeking", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnselect(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onselect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnselectionchange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onselectionchange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnselectstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onselectstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnstalled(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onstalled", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnsubmit(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onsubmit", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnsuspend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onsuspend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntimeupdate(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "ontimeupdate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntoggle(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "ontoggle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntouchcancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _]): Self = StObject.set(x, "ontouchcancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntouchend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _]): Self = StObject.set(x, "ontouchend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntouchmove(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _]): Self = StObject.set(x, "ontouchmove", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntouchstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TouchEvent, _]): Self = StObject.set(x, "ontouchstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntransitioncancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _]): Self = StObject.set(x, "ontransitioncancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntransitionend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _]): Self = StObject.set(x, "ontransitionend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntransitionrun(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _]): Self = StObject.set(x, "ontransitionrun", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOntransitionstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ TransitionEvent, _]): Self = StObject.set(x, "ontransitionstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnunload(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onunload", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnunloadNull: Self = StObject.set(x, "onunload", null)
    
    @scala.inline
    def setOnunloadUndefined: Self = StObject.set(x, "onunload", js.undefined)
    
    @scala.inline
    def setOnvolumechange(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onvolumechange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnwaiting(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, _]): Self = StObject.set(x, "onwaiting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnwheel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ WheelEvent, _]): Self = StObject.set(x, "onwheel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnzoom(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ SVGZoomEvent, _]): Self = StObject.set(x, "onzoom", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnzoomNull: Self = StObject.set(x, "onzoom", null)
    ...
    @scala.inline
    def setPixelUnitToMillimeterXUndefined: Self = StObject.set(x, "pixelUnitToMillimeterX", js.undefined)
    
    @scala.inline
    def setPixelUnitToMillimeterY(value: Double): Self = StObject.set(x, "pixelUnitToMillimeterY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPixelUnitToMillimeterYUndefined: Self = StObject.set(x, "pixelUnitToMillimeterY", js.undefined)
    ...
    @scala.inline
    def setQuerySelectorAll(value: a => NodeListOf[HTMLAnchorElement with Node]): Self = StObject.set(x, "querySelectorAll", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setScreenPixelToMillimeterXUndefined: Self = StObject.set(x, "screenPixelToMillimeterX", js.undefined)
    
    @scala.inline
    def setScreenPixelToMillimeterY(value: Double): Self = StObject.set(x, "screenPixelToMillimeterY", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScreenPixelToMillimeterYUndefined: Self = StObject.set(x, "screenPixelToMillimeterY", js.undefined)
    ...
    @scala.inline
    def setSetCurrentTime(value: /* seconds */ Double => Unit): Self = StObject.set(x, "setCurrentTime", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetCurrentTimeUndefined: Self = StObject.set(x, "setCurrentTime", js.undefined)
    ...
    @scala.inline
    def setSuspendRedraw(value: /* maxWaitMilliseconds */ Double => Double): Self = StObject.set(x, "suspendRedraw", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSuspendRedrawUndefined: Self = StObject.set(x, "suspendRedraw", js.undefined)
    ...
    @scala.inline
    def setUnpauseAnimationsUndefined: Self = StObject.set(x, "unpauseAnimations", js.undefined)
    
    @scala.inline
    def setUnsuspendRedraw(value: /* suspendHandleID */ Double => Unit): Self = StObject.set(x, "unsuspendRedraw", js.Any.fromFunction1(value))
    
    @scala.inline
    def setUnsuspendRedrawAll(value: () => Unit): Self = StObject.set(x, "unsuspendRedrawAll", js.Any.fromFunction0(value))
    
    @scala.inline
    def setUnsuspendRedrawAllUndefined: Self = StObject.set(x, "unsuspendRedrawAll", js.undefined)
    
    @scala.inline
    def setUnsuspendRedrawUndefined: Self = StObject.set(x, "unsuspendRedraw", js.undefined)
