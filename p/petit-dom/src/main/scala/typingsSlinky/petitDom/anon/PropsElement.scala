...
object PropsElement {
  ...
  implicit class PropsElementOps[Self <: PropsElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnfullscreenchange(value: js.ThisFunction1[PropsElement, /* ev */ Event, _]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnfullscreenerror(value: js.ThisFunction1[PropsElement, /* ev */ Event, _]): Self = {
        val ret = this.duplicate
