...
object IntrinsicClassAttributes {
  ...
  implicit class IntrinsicClassAttributesOps[Self[t] <: IntrinsicClassAttributes[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withDispatchEvent(value: /* event */ Event => Boolean): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnfullscreenchange(value: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _]): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnfullscreenerror(value: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _]): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOwnerDocument(value: Document): Self[T] = {
        val ret = this.duplicate
