...
object IntrinsicClassAttributes {
  ...
  @scala.inline
  implicit class IntrinsicClassAttributesOps[Self <: IntrinsicClassAttributes[_], T] (val x: Self with IntrinsicClassAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setFirstElementChild(value: org.scalajs.dom.raw.Element): Self = this.set("firstElementChild", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetElementsByClassName(value: /* classNames */ String => HTMLCollectionOf[org.scalajs.dom.raw.Element]): Self = this.set("getElementsByClassName", js.Any.fromFunction1(value))
    ...
    ): Self = this.set("insertAdjacentElement", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setLastElementChild(value: org.scalajs.dom.raw.Element): Self = this.set("lastElementChild", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnfullscreenchange(value: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _]): Self = this.set("onfullscreenchange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnfullscreenerror(value: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _]): Self = this.set("onfullscreenerror", value.asInstanceOf[js.Any])
