...
object IntrinsicClassAttributes {
  ...
  def apply[T](
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _]) => Unit = null,
    ...
    normalize: () => Unit = null,
    onfullscreenchange: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _] = null,
    onfullscreenerror: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event, _]) => Unit = null,
