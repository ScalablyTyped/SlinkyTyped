...
object h extends js.Object {
  ...
  def apply[T /* <: /* keyof petit-dom.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */, E /* <: /* import warning: importer.ImportType#apply Failed type conversion: petit-dom.ElementTagNameMap[T] */ js.Any */](`type`: T): ElementNode[T, E] = js.native
  def apply[T /* <: /* keyof petit-dom.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */, E /* <: /* import warning: importer.ImportType#apply Failed type conversion: petit-dom.ElementTagNameMap[T] */ js.Any */](`type`: T, children: Content*): ElementNode[T, E] = js.native
  def apply[T /* <: /* keyof petit-dom.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */, E /* <: /* import warning: importer.ImportType#apply Failed type conversion: petit-dom.ElementTagNameMap[T] */ js.Any */](`type`: T, props: Props[E], children: Content*): ElementNode[T, E] = js.native
}
