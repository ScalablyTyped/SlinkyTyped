...
object ComponentNode {
  @scala.inline
  def apply[/* <: typingsSlinky.petitDom.mod.PetitDom.ComponentProps */ P](content: js.Array[VNode], isSVG: Boolean, props: P with IntrinsicProps, `type`: Component[P]): ComponentNode[P] = {
  ...
  @scala.inline
  implicit class ComponentNodeOps[Self <: ComponentNode[_], /* <: typingsSlinky.petitDom.mod.PetitDom.ComponentProps */ P] (val x: Self with ComponentNode[P]) extends AnyVal {
    @scala.inline
