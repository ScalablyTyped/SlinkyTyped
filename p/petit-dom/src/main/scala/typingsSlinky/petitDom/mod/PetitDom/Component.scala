...
object Component {
  @scala.inline
  def apply[/* <: typingsSlinky.petitDom.mod.PetitDom.ComponentProps */ P](
  ...
  @scala.inline
  implicit class ComponentOps[Self <: Component[_], /* <: typingsSlinky.petitDom.mod.PetitDom.ComponentProps */ P] (val x: Self with Component[P]) extends AnyVal {
    @scala.inline
