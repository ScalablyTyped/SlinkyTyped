...
object ComponentClassNode {
  @scala.inline
  def apply[/* <: typingsSlinky.petitDom.mod.PetitDom.ComponentProps */ P](content: js.Array[VNode], isSVG: Boolean, props: P with IntrinsicProps, `type`: ComponentClass[P]): ComponentClassNode[P] = {
  ...
  @scala.inline
  implicit class ComponentClassNodeOps[Self <: ComponentClassNode[_], /* <: typingsSlinky.petitDom.mod.PetitDom.ComponentProps */ P] (val x: Self with ComponentClassNode[P]) extends AnyVal {
    @scala.inline
