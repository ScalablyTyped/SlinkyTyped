...
object PropsSVGFEFuncBElementcon {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEFuncBElementcon, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEFuncBElementcon, /* ev */ Event_, _]) => Unit = null,
