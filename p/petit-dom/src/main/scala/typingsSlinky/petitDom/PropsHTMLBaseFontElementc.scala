...
object PropsHTMLBaseFontElementc {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBaseFontElementc, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBaseFontElementc, /* ev */ Event_, _]) => Unit = null,
