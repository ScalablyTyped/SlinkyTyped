...
object PropsSVGClipPathElementco {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGClipPathElementco, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGClipPathElementco, /* ev */ Event_, _]) => Unit = null,
