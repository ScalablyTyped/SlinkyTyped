...
object PropsSVGLineElementconten {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGLineElementconten, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGLineElementconten, /* ev */ Event_, _]) => Unit = null,
