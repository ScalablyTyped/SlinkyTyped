...
object PropsHTMLTableHeaderCellE {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableHeaderCellE, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableHeaderCellE, /* ev */ Event_, _]) => Unit = null,
