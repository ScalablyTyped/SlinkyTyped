...
object PropsSVGFEBlendElementcon {
  ...
  def apply(
    ...
    SVG_FEBLEND_MODE_COLOR: Int | Double = null,
    SVG_FEBLEND_MODE_COLOR_BURN: Int | Double = null,
    SVG_FEBLEND_MODE_COLOR_DODGE: Int | Double = null,
    SVG_FEBLEND_MODE_DARKEN: Int | Double = null,
    SVG_FEBLEND_MODE_DIFFERENCE: Int | Double = null,
    SVG_FEBLEND_MODE_EXCLUSION: Int | Double = null,
    SVG_FEBLEND_MODE_HARD_LIGHT: Int | Double = null,
    SVG_FEBLEND_MODE_HUE: Int | Double = null,
    SVG_FEBLEND_MODE_LIGHTEN: Int | Double = null,
    SVG_FEBLEND_MODE_LUMINOSITY: Int | Double = null,
    SVG_FEBLEND_MODE_MULTIPLY: Int | Double = null,
    SVG_FEBLEND_MODE_NORMAL: Int | Double = null,
    SVG_FEBLEND_MODE_OVERLAY: Int | Double = null,
    SVG_FEBLEND_MODE_SATURATION: Int | Double = null,
    SVG_FEBLEND_MODE_SCREEN: Int | Double = null,
    SVG_FEBLEND_MODE_SOFT_LIGHT: Int | Double = null,
    SVG_FEBLEND_MODE_UNKNOWN: Int | Double = null,
    TEXT_NODE: Int | Double = null,
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _]) => Unit = null,
    ...
    oncancel: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    oncanplay: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    oncanplaythrough: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onchange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onclick: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ MouseEvent, _] = null,
    onclose: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    oncuechange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    ondragexit: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    ondurationchange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onemptied: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onended: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    onfullscreenchange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onfullscreenerror: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ongotpointercapture: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ PointerEvent, _] = null,
    oninput: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    oninvalid: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    onload: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onloadeddata: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onloadedmetadata: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onloadstart: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    onpause: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onplay: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onplaying: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    onratechange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onreset: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onresize: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ UIEvent, _] = null,
    onscroll: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onsecuritypolicyviolation: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ SecurityPolicyViolationEvent, _] = null,
    onseeked: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onseeking: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onselect: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onselectionchange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onselectstart: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onstalled: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onsubmit: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onsuspend: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ontimeupdate: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ontoggle: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    onvolumechange: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    onwaiting: js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEBlendElementcon, /* ev */ Event_, _]) => Unit = null,
    ...
    if (SVG_FEBLEND_MODE_COLOR != null) __obj.updateDynamic("SVG_FEBLEND_MODE_COLOR")(SVG_FEBLEND_MODE_COLOR.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_COLOR_BURN != null) __obj.updateDynamic("SVG_FEBLEND_MODE_COLOR_BURN")(SVG_FEBLEND_MODE_COLOR_BURN.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_COLOR_DODGE != null) __obj.updateDynamic("SVG_FEBLEND_MODE_COLOR_DODGE")(SVG_FEBLEND_MODE_COLOR_DODGE.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_DARKEN != null) __obj.updateDynamic("SVG_FEBLEND_MODE_DARKEN")(SVG_FEBLEND_MODE_DARKEN.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_DIFFERENCE != null) __obj.updateDynamic("SVG_FEBLEND_MODE_DIFFERENCE")(SVG_FEBLEND_MODE_DIFFERENCE.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_EXCLUSION != null) __obj.updateDynamic("SVG_FEBLEND_MODE_EXCLUSION")(SVG_FEBLEND_MODE_EXCLUSION.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_HARD_LIGHT != null) __obj.updateDynamic("SVG_FEBLEND_MODE_HARD_LIGHT")(SVG_FEBLEND_MODE_HARD_LIGHT.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_HUE != null) __obj.updateDynamic("SVG_FEBLEND_MODE_HUE")(SVG_FEBLEND_MODE_HUE.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_LIGHTEN != null) __obj.updateDynamic("SVG_FEBLEND_MODE_LIGHTEN")(SVG_FEBLEND_MODE_LIGHTEN.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_LUMINOSITY != null) __obj.updateDynamic("SVG_FEBLEND_MODE_LUMINOSITY")(SVG_FEBLEND_MODE_LUMINOSITY.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_MULTIPLY != null) __obj.updateDynamic("SVG_FEBLEND_MODE_MULTIPLY")(SVG_FEBLEND_MODE_MULTIPLY.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_NORMAL != null) __obj.updateDynamic("SVG_FEBLEND_MODE_NORMAL")(SVG_FEBLEND_MODE_NORMAL.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_OVERLAY != null) __obj.updateDynamic("SVG_FEBLEND_MODE_OVERLAY")(SVG_FEBLEND_MODE_OVERLAY.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_SATURATION != null) __obj.updateDynamic("SVG_FEBLEND_MODE_SATURATION")(SVG_FEBLEND_MODE_SATURATION.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_SCREEN != null) __obj.updateDynamic("SVG_FEBLEND_MODE_SCREEN")(SVG_FEBLEND_MODE_SCREEN.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_SOFT_LIGHT != null) __obj.updateDynamic("SVG_FEBLEND_MODE_SOFT_LIGHT")(SVG_FEBLEND_MODE_SOFT_LIGHT.asInstanceOf[js.Any])
    if (SVG_FEBLEND_MODE_UNKNOWN != null) __obj.updateDynamic("SVG_FEBLEND_MODE_UNKNOWN")(SVG_FEBLEND_MODE_UNKNOWN.asInstanceOf[js.Any])
