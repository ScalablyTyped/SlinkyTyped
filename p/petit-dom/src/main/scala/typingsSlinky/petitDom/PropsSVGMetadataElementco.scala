...
object PropsSVGMetadataElementco {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGMetadataElementco, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGMetadataElementco, /* ev */ Event_, _]) => Unit = null,
