...
object PropsSVGFEFuncAElementcon {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEFuncAElementcon, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEFuncAElementcon, /* ev */ Event_, _]) => Unit = null,
