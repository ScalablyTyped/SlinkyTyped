...
object PropsHTMLTableDataCellEle {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableDataCellEle, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableDataCellEle, /* ev */ Event_, _]) => Unit = null,
