...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomErrorMessage(value: (/* error */ js.Error, /* res */ ServerResponse) => String): Self = StObject.set(x, "customErrorMessage", js.Any.fromFunction2(value))
      
      @scala.inline
      def setCustomErrorMessageUndefined: Self = StObject.set(x, "customErrorMessage", js.undefined)
      
      @scala.inline
      def setCustomLogLevel(value: (/* res */ ServerResponse, /* error */ js.Error) => Level): Self = StObject.set(x, "customLogLevel", js.Any.fromFunction2(value))
  ...
  object httpAugmentingMod {
    ...
    object IncomingMessage {
      ...
      @scala.inline
      def apply(id: ReqId, log: Logger): typingsSlinky.pinoHttp.mod.httpAugmentingMod.IncomingMessage = {
        val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], log = log.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.pinoHttp.mod.httpAugmentingMod.IncomingMessage]
      }
      
      @scala.inline
      implicit class IncomingMessageMutableBuilder[Self <: typingsSlinky.pinoHttp.mod.httpAugmentingMod.IncomingMessage] (val x: Self) extends AnyVal {
    ...
    object ServerResponse {
      ...
      @scala.inline
      def apply(): typingsSlinky.pinoHttp.mod.httpAugmentingMod.ServerResponse = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.pinoHttp.mod.httpAugmentingMod.ServerResponse]
      }
      
      @scala.inline
      implicit class ServerResponseMutableBuilder[Self <: typingsSlinky.pinoHttp.mod.httpAugmentingMod.ServerResponse] (val x: Self) extends AnyVal {
