...
import typingsSlinky.powerappsComponentFramework.ComponentFramework.FactoryApi.Popup.PopupService
...
object Factory {
  ...
  implicit class FactoryOps[Self <: Factory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetPopupService(value: () => PopupService): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPopupService")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRequestRender(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requestRender")(js.Any.fromFunction0(value))
        ret
    }
  }
