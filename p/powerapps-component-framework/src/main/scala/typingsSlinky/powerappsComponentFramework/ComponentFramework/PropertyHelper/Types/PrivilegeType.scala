package typingsSlinky.powerappsComponentFramework.ComponentFramework.PropertyHelper.Types
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.powerappsComponentFramework.powerappsComponentFrameworkNumbers.`7`
  - typingsSlinky.powerappsComponentFramework.powerappsComponentFrameworkNumbers.`8`
*/
trait PrivilegeType extends js.Object
object PrivilegeType {
  ...
  @scala.inline
  def `7`: typingsSlinky.powerappsComponentFramework.powerappsComponentFrameworkNumbers.`7` = 7.asInstanceOf[typingsSlinky.powerappsComponentFramework.powerappsComponentFrameworkNumbers.`7`]
