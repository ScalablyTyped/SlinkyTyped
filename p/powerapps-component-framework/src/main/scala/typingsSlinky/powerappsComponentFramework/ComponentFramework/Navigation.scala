...
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.AlertDialogOptions
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.AlertDialogStrings
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.ConfirmDialogOptions
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.ConfirmDialogResponse
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.ConfirmDialogStrings
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.EntityFormOptions
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.ErrorDialogOptions
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.OpenFileOptions
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.OpenFormSuccessResponse
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.OpenUrlOptions
import typingsSlinky.powerappsComponentFramework.ComponentFramework.NavigationApi.OpenWebResourceOptions
