...
object PopupService {
  ...
  implicit class PopupServiceOps[Self <: PopupService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreatePopup(value: typingsSlinky.powerappsComponentFramework.ComponentFramework.FactoryApi.Popup.Popup => Unit): Self = this.set("createPopup", js.Any.fromFunction1(value))
