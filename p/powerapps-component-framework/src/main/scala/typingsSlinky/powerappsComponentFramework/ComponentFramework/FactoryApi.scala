...
object FactoryApi {
  ...
  object Popup {
    ...
    object Popup {
      ...
      @scala.inline
      def apply(content: HTMLElement, name: String, `type`: PopupType): typingsSlinky.powerappsComponentFramework.ComponentFramework.FactoryApi.Popup.Popup = {
        val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.powerappsComponentFramework.ComponentFramework.FactoryApi.Popup.Popup]
      }
      
      @scala.inline
      implicit class PopupMutableBuilder[Self <: typingsSlinky.powerappsComponentFramework.ComponentFramework.FactoryApi.Popup.Popup] (val x: Self) extends AnyVal {
    ...
    object PopupService {
      ...
      implicit class PopupServiceMutableBuilder[Self <: PopupService] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreatePopup(value: typingsSlinky.powerappsComponentFramework.ComponentFramework.FactoryApi.Popup.Popup => Unit): Self = StObject.set(x, "createPopup", js.Any.fromFunction1(value))
