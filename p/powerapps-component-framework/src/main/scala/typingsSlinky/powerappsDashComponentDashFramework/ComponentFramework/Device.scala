...
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.DeviceApi.CaptureImageOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.DeviceApi.PickFileOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.DeviceApi.Position
