...
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.AlertDialogOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.AlertDialogStrings
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.ConfirmDialogOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.ConfirmDialogResponse
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.ConfirmDialogStrings
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.EntityFormOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.ErrorDialogOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.OpenFileOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.OpenFormSuccessResponse
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.OpenUrlOptions
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.NavigationApi.OpenWebResourceOptions
