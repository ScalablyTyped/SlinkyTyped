package typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup
...
trait PopupService extends js.Object {
  ...
  /**
  			 ...
  			 */
  def createPopup(props: typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup): Unit
  /**
  ...
  def updatePopup(
    name: String,
    newProps: typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup
  ): Unit
}
...
object PopupService {
  ...
  def apply(
    ...
    createPopup: typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup => Unit,
    deletePopup: String => Unit,
    getPopupsId: () => String,
    openPopup: String => Unit,
    setPopupsId: String => Unit,
    updatePopup: (String, typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup) => Unit
  ): PopupService = {
