...
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.UserSettingApi.DateFormattingInfo
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.UserSettingApi.NumberFormattingInfo
