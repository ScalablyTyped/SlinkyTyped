package typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.UserSettingApi

import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.UserSettingApi.Types.DayOfWeek
