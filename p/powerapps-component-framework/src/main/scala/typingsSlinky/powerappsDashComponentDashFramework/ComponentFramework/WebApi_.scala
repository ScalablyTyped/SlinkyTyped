...
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.WebApi.Entity
import typingsSlinky.powerappsDashComponentDashFramework.ComponentFramework.WebApi.RetrieveMultipleResponse
