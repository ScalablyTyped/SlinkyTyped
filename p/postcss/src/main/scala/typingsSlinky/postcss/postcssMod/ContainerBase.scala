...
import typingsSlinky.postcss.Anon_Fast
...
trait ContainerBase extends NodeBase {
  ...
  def walkAtRules(callback: js.Function2[/* atRule */ AtRule, /* index */ Double, _]): Boolean | Unit = js.native
  /**
    * Traverses the container's descendant nodes, calling `callback` for each
    ...
    * container.
    */
  def walkAtRules(nameFilter: String, callback: js.Function2[/* atRule */ AtRule, /* index */ Double, _]): Boolean | Unit = js.native
  def walkAtRules(nameFilter: RegExp, callback: js.Function2[/* atRule */ AtRule, /* index */ Double, _]): Boolean | Unit = js.native
  /**
    * Traverses the container's descendant nodes, calling `callback` for each
    ...
    */
  def walkComments(callback: js.Function2[/* comment */ Comment, /* indexed */ Double, _]): Unit | Boolean = js.native
  ...
  def walkRules(callback: js.Function2[/* atRule */ Rule, /* index */ Double, _]): Boolean | Unit = js.native
  /**
    * Traverses the container's descendant nodes, calling `callback` for each
    ...
    * container.
    */
  def walkRules(selectorFilter: String, callback: js.Function2[/* atRule */ Rule, /* index */ Double, _]): Boolean | Unit = js.native
  def walkRules(selectorFilter: js.Any): Boolean | Unit = js.native
  def walkRules(selectorFilter: js.Any, callback: js.Function2[/* atRule */ Rule, /* index */ Double, _]): Boolean | Unit = js.native
  def walkRules(selectorFilter: RegExp, callback: js.Function2[/* atRule */ Rule, /* index */ Double, _]): Boolean | Unit = js.native
}
