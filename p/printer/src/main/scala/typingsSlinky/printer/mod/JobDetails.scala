...
object JobDetails {
  ...
  implicit class JobDetailsOps[Self <: JobDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompletedTime(value: js.Date): Self = this.set("completedTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProcessingTime(value: js.Date): Self = this.set("processingTime", value.asInstanceOf[js.Any])
