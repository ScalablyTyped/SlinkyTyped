...
trait CHAR0 extends js.Object {
  ...
  // regular expressions
  var REGEX_BACKSLASH: js.RegExp
  var REGEX_NON_SPECIAL_CHARS: js.RegExp
  var REGEX_REMOVE_BACKSLASH: js.RegExp
  var REGEX_SPECIAL_CHARS: js.RegExp
  var REGEX_SPECIAL_CHARS_BACKREF: js.RegExp
  var REGEX_SPECIAL_CHARS_GLOBAL: js.RegExp
