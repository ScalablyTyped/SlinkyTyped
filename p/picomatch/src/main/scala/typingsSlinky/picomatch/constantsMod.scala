...
object constantsMod {
  ...
  @scala.inline
  def REGEX_BACKSLASH_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REGEX_BACKSLASH")(x.asInstanceOf[js.Any])
  
  @JSImport("picomatch/constants", "REGEX_NON_SPECIAL_CHARS")
  @js.native
  def REGEX_NON_SPECIAL_CHARS: js.RegExp = js.native
  @scala.inline
  def REGEX_NON_SPECIAL_CHARS_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REGEX_NON_SPECIAL_CHARS")(x.asInstanceOf[js.Any])
  
  @JSImport("picomatch/constants", "REGEX_REMOVE_BACKSLASH")
  @js.native
  def REGEX_REMOVE_BACKSLASH: js.RegExp = js.native
  @scala.inline
  def REGEX_REMOVE_BACKSLASH_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REGEX_REMOVE_BACKSLASH")(x.asInstanceOf[js.Any])
  
  @JSImport("picomatch/constants", "REGEX_SPECIAL_CHARS")
  @js.native
  def REGEX_SPECIAL_CHARS: js.RegExp = js.native
  @scala.inline
  def REGEX_SPECIAL_CHARS_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REGEX_SPECIAL_CHARS")(x.asInstanceOf[js.Any])
  
  @JSImport("picomatch/constants", "REGEX_SPECIAL_CHARS_BACKREF")
  @js.native
  def REGEX_SPECIAL_CHARS_BACKREF: js.RegExp = js.native
  @scala.inline
  def REGEX_SPECIAL_CHARS_BACKREF_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REGEX_SPECIAL_CHARS_BACKREF")(x.asInstanceOf[js.Any])
  
  @JSImport("picomatch/constants", "REGEX_SPECIAL_CHARS_GLOBAL")
  @js.native
  def REGEX_SPECIAL_CHARS_GLOBAL: js.RegExp = js.native
  @scala.inline
  def REGEX_SPECIAL_CHARS_GLOBAL_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REGEX_SPECIAL_CHARS_GLOBAL")(x.asInstanceOf[js.Any])
