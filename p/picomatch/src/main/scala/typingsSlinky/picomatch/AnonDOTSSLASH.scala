...
@js.native
trait AnonDOTSSLASH extends js.Object {
...
object AnonDOTSSLASH {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonDOTSSLASH]
  }
  @scala.inline
  implicit class AnonDOTSSLASHOps[Self <: AnonDOTSSLASH] (val x: Self) extends AnyVal {
    @scala.inline
