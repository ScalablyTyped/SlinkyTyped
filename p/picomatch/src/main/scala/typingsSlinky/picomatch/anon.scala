...
object anon {
  ...
  object CHAR0 {
    ...
    implicit class CHAR0MutableBuilder[Self <: CHAR0] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setREGEX_BACKSLASH(value: js.RegExp): Self = StObject.set(x, "REGEX_BACKSLASH", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREGEX_NON_SPECIAL_CHARS(value: js.RegExp): Self = StObject.set(x, "REGEX_NON_SPECIAL_CHARS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREGEX_REMOVE_BACKSLASH(value: js.RegExp): Self = StObject.set(x, "REGEX_REMOVE_BACKSLASH", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREGEX_SPECIAL_CHARS(value: js.RegExp): Self = StObject.set(x, "REGEX_SPECIAL_CHARS", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREGEX_SPECIAL_CHARS_BACKREF(value: js.RegExp): Self = StObject.set(x, "REGEX_SPECIAL_CHARS_BACKREF", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setREGEX_SPECIAL_CHARS_GLOBAL(value: js.RegExp): Self = StObject.set(x, "REGEX_SPECIAL_CHARS_GLOBAL", value.asInstanceOf[js.Any])
