...
@js.native
trait AnonDOTLITERAL extends js.Object {
...
object AnonDOTLITERAL {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonDOTLITERAL]
  }
  @scala.inline
  implicit class AnonDOTLITERALOps[Self <: AnonDOTLITERAL] (val x: Self) extends AnyVal {
    @scala.inline
