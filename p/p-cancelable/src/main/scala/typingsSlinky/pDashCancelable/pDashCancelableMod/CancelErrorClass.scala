...
trait CancelErrorClass extends Error {
  val isCanceled: `true`
  @JSName("name")
  val name_CancelErrorClass: typingsSlinky.pDashCancelable.pDashCancelableStrings.CancelError
}
...
object CancelErrorClass {
  ...
  def apply(
    isCanceled: `true`,
    message: String,
    name: typingsSlinky.pDashCancelable.pDashCancelableStrings.CancelError,
    stack: String = null
  ): CancelErrorClass = {
