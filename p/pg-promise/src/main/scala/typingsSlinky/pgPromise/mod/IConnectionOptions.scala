...
object IConnectionOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C](): IConnectionOptions[C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IConnectionOptions[C]]
  }
  @scala.inline
  implicit class IConnectionOptionsOps[Self <: IConnectionOptions[_], /* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C] (val x: Self with IConnectionOptions[C]) extends AnyVal {
    @scala.inline
