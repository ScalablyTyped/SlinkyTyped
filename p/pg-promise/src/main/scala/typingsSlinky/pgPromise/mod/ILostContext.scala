...
object ILostContext {
  @scala.inline
  def apply[/* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C](client: C, cn: String, dc: js.Any, start: js.Date): ILostContext[C] = {
  ...
  @scala.inline
  implicit class ILostContextOps[Self <: ILostContext[_], /* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C] (val x: Self with ILostContext[C]) extends AnyVal {
    @scala.inline
