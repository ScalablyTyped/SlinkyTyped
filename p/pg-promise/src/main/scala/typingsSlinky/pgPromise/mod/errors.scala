...
import typingsSlinky.pgMinify.mod.SQLParsingError
...
object errors {
  ...
  object queryResultErrorCode extends StObject {
    ...
    /* 2 */ val multiple: typingsSlinky.pgPromise.mod.errors.queryResultErrorCode.multiple with Double = js.native
    
    @js.native
    sealed trait noData extends queryResultErrorCode
    /* 0 */ val noData: typingsSlinky.pgPromise.mod.errors.queryResultErrorCode.noData with Double = js.native
    
    @js.native
    sealed trait notEmpty extends queryResultErrorCode
    /* 1 */ val notEmpty: typingsSlinky.pgPromise.mod.errors.queryResultErrorCode.notEmpty with Double = js.native
  }
}
