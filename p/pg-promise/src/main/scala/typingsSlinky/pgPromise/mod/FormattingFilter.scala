...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.pgPromise.pgPromiseStrings.^
  - typingsSlinky.pgPromise.pgPromiseStrings.Tilde
  - typingsSlinky.pgPromise.pgPromiseStrings.Numbersign
  - typingsSlinky.pgPromise.pgPromiseStrings.Colonraw
  - typingsSlinky.pgPromise.pgPromiseStrings.Colonalias
  - typingsSlinky.pgPromise.pgPromiseStrings.Colonname
  - typingsSlinky.pgPromise.pgPromiseStrings.Colonjson
  - typingsSlinky.pgPromise.pgPromiseStrings.Coloncsv
  - typingsSlinky.pgPromise.pgPromiseStrings.Colonlist
  - typingsSlinky.pgPromise.pgPromiseStrings.Colonvalue
*/
