...
object IInitOptions {
  @scala.inline
  def apply[Ext, /* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C](): IInitOptions[Ext, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IInitOptions[Ext, C]]
  }
  @scala.inline
  implicit class IInitOptionsOps[Self <: IInitOptions[_, _], Ext, /* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C] (val x: Self with (IInitOptions[Ext, C])) extends AnyVal {
    @scala.inline
