...
object queryResult extends StObject {
  ...
  /* 6 */ val any: typingsSlinky.pgPromise.mod.queryResult.any with Double = js.native
  
  @js.native
  sealed trait many extends queryResult
  /* 2 */ val many: typingsSlinky.pgPromise.mod.queryResult.many with Double = js.native
  
  @js.native
  sealed trait none extends queryResult
  /* 4 */ val none: typingsSlinky.pgPromise.mod.queryResult.none with Double = js.native
  
  @js.native
  sealed trait one extends queryResult
  /* 1 */ val one: typingsSlinky.pgPromise.mod.queryResult.one with Double = js.native
}
