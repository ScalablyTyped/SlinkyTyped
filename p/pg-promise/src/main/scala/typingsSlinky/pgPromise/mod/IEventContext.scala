...
object IEventContext {
  @scala.inline
  def apply[/* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C](client: C, cn: js.Any, ctx: ITaskContext, dc: js.Any, params: js.Any, query: js.Any): IEventContext[C] = {
  ...
  @scala.inline
  implicit class IEventContextOps[Self <: IEventContext[_], /* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C] (val x: Self with IEventContext[C]) extends AnyVal {
    @scala.inline
