...
object IConnectionParameters {
  @scala.inline
  def apply[/* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C](): IConnectionParameters[C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IConnectionParameters[C]]
  }
  @scala.inline
  implicit class IConnectionParametersOps[Self <: IConnectionParameters[_], /* <: typingsSlinky.pgPromise.pgSubsetMod.IClient */ C] (val x: Self with IConnectionParameters[C]) extends AnyVal {
    @scala.inline
