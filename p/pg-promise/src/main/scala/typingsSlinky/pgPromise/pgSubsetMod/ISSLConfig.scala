...
object ISSLConfig {
  ...
  implicit class ISSLConfigOps[Self <: ISSLConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNPNProtocolsVarargs(value: (Buffer | String | js.typedarray.Uint8Array)*): Self = this.set("NPNProtocols", js.Array(value :_*))
    @scala.inline
    def setNPNProtocolsUint8Array(value: js.typedarray.Uint8Array): Self = this.set("NPNProtocols", value.asInstanceOf[js.Any])
    @scala.inline
    def setNPNProtocols(value: (js.Array[Buffer | String | js.typedarray.Uint8Array]) | Buffer | js.typedarray.Uint8Array): Self = this.set("NPNProtocols", value.asInstanceOf[js.Any])
    @scala.inline
