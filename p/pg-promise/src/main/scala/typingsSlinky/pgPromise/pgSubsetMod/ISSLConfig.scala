...
object ISSLConfig {
  ...
  implicit class ISSLConfigMutableBuilder[Self <: ISSLConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNPNProtocols(value: (js.Array[Buffer | String | js.typedarray.Uint8Array]) | Buffer | js.typedarray.Uint8Array): Self = StObject.set(x, "NPNProtocols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNPNProtocolsUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "NPNProtocols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNPNProtocolsUndefined: Self = StObject.set(x, "NPNProtocols", js.undefined)
    
    @scala.inline
    def setNPNProtocolsVarargs(value: (Buffer | String | js.typedarray.Uint8Array)*): Self = StObject.set(x, "NPNProtocols", js.Array(value :_*))
