...
trait Universal_
  ...
  @JSName("type")
  var type_Universal_ : typingsSlinky.postcssSelectorParser.postcssSelectorParserStrings.universal = js.native
}
object Universal_ {
  ...
  def apply(
    ...
    sourceIndex: Double,
    spaces: Spaces,
    `type`: typingsSlinky.postcssSelectorParser.postcssSelectorParserStrings.universal,
    value: String
  ): Universal_ = {
  ...
  implicit class Universal_MutableBuilder[Self <: Universal_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.postcssSelectorParser.postcssSelectorParserStrings.universal): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
