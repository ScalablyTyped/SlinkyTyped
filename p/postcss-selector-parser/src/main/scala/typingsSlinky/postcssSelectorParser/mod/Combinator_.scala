...
trait Combinator_
  ...
  @JSName("type")
  var type_Combinator_ : typingsSlinky.postcssSelectorParser.postcssSelectorParserStrings.combinator = js.native
}
object Combinator_ {
  ...
  def apply(
    ...
    sourceIndex: Double,
    spaces: Spaces,
    `type`: typingsSlinky.postcssSelectorParser.postcssSelectorParserStrings.combinator,
    value: String
  ): Combinator_ = {
  ...
  implicit class Combinator_MutableBuilder[Self <: Combinator_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.postcssSelectorParser.postcssSelectorParserStrings.combinator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
