...
object Base {
  @scala.inline
  def apply[/* <: js.UndefOr[java.lang.String] */ Value, /* <: js.UndefOr[typingsSlinky.postcssSelectorParser.mod.Container[java.lang.String]] */ ParentType](
  ...
  @scala.inline
  implicit class BaseOps[Self <: Base[_, _], /* <: js.UndefOr[java.lang.String] */ Value, /* <: js.UndefOr[typingsSlinky.postcssSelectorParser.mod.Container[java.lang.String]] */ ParentType] (val x: Self with (Base[Value, ParentType])) extends AnyVal {
    @scala.inline
