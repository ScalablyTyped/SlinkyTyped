...
object mod {
  ...
  object mode extends StObject {
    ...
    /* 0x01 */ val CPHA: typingsSlinky.piSpi.mod.mode.CPHA with Double = js.native
    
    @js.native
    sealed trait CPOL extends mode
    /* 0x02 */ val CPOL: typingsSlinky.piSpi.mod.mode.CPOL with Double = js.native
  }
  ...
  object order extends StObject {
    ...
    /* 1 */ val LSB_FIRST: typingsSlinky.piSpi.mod.order.LSB_FIRST with Double = js.native
    
    @js.native
    sealed trait MSB_FIRST extends order
    /* 0 */ val MSB_FIRST: typingsSlinky.piSpi.mod.order.MSB_FIRST with Double = js.native
  }
}
