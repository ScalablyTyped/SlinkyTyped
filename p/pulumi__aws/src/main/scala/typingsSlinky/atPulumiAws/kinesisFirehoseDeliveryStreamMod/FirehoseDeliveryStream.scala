...
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamElasticsearchConfiguration
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamExtendedS3Configuration
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamKinesisSourceConfiguration
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamRedshiftConfiguration
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamS3Configuration
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamServerSideEncryption
import typingsSlinky.atPulumiAws.typesOutputMod.kinesis.FirehoseDeliveryStreamSplunkConfiguration
