...
import typingsSlinky.atPulumiAws.typesInputMod.codepipeline.PipelineArtifactStore
import typingsSlinky.atPulumiAws.typesInputMod.codepipeline.PipelineStage
