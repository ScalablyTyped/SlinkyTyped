package typingsSlinky.atPulumiAws.cfgRuleMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesInputMod.cfg.RuleScope
import typingsSlinky.atPulumiAws.typesInputMod.cfg.RuleSource
