...
import typingsSlinky.atPulumiAws.ec2VpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociationArgs
import typingsSlinky.atPulumiAws.ec2VpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociationState
...
class VpcEndpointRouteTableAssociation protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcEndpointRouteTableAssociation {
  /**
...
object VpcEndpointRouteTableAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointRouteTableAssociationState): typingsSlinky.atPulumiAws.ec2VpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation = js.native
  def get(
    name: String,
    id: Input[ID],
    state: VpcEndpointRouteTableAssociationState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.ec2VpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation = js.native
  /**
