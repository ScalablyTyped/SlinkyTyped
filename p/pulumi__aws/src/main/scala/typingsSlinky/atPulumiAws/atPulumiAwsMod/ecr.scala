...
object ecr extends js.Object {
  ...
  class LifecyclePolicy protected ()
    extends typingsSlinky.atPulumiAws.ecrMod.LifecyclePolicy {
    /**
  ...
  class Repository protected ()
    extends typingsSlinky.atPulumiAws.ecrMod.Repository {
    /**
  ...
  class RepositoryPolicy protected ()
    extends typingsSlinky.atPulumiAws.ecrMod.RepositoryPolicy {
    /**
