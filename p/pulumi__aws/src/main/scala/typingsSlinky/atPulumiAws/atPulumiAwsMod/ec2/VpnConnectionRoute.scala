...
import typingsSlinky.atPulumiAws.ec2VpnConnectionRouteMod.VpnConnectionRouteArgs
import typingsSlinky.atPulumiAws.ec2VpnConnectionRouteMod.VpnConnectionRouteState
...
class VpnConnectionRoute protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpnConnectionRoute {
  /**
...
object VpnConnectionRoute extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpnConnectionRouteMod.VpnConnectionRoute = js.native
  def get(name: String, id: Input[ID], state: VpnConnectionRouteState): typingsSlinky.atPulumiAws.ec2VpnConnectionRouteMod.VpnConnectionRoute = js.native
  def get(name: String, id: Input[ID], state: VpnConnectionRouteState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpnConnectionRouteMod.VpnConnectionRoute = js.native
  /**
