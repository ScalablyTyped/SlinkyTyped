...
object codebuild extends js.Object {
  ...
  class Project protected ()
    extends typingsSlinky.atPulumiAws.codebuildMod.Project {
    /**
  ...
  class SourceCredential protected ()
    extends typingsSlinky.atPulumiAws.codebuildMod.SourceCredential {
    /**
  ...
  class Webhook protected ()
    extends typingsSlinky.atPulumiAws.codebuildMod.Webhook {
    /**
