...
import typingsSlinky.atPulumiAws.pinpointSmsChannelMod.SmsChannelArgs
import typingsSlinky.atPulumiAws.pinpointSmsChannelMod.SmsChannelState
...
class SmsChannel protected ()
  extends typingsSlinky.atPulumiAws.pinpointMod.SmsChannel {
  /**
...
object SmsChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointSmsChannelMod.SmsChannel = js.native
  def get(name: String, id: Input[ID], state: SmsChannelState): typingsSlinky.atPulumiAws.pinpointSmsChannelMod.SmsChannel = js.native
  def get(name: String, id: Input[ID], state: SmsChannelState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointSmsChannelMod.SmsChannel = js.native
  /**
