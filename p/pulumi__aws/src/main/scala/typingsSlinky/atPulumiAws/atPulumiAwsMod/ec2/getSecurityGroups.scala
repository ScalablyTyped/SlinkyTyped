...
import typingsSlinky.atPulumiAws.ec2GetSecurityGroupsMod.GetSecurityGroupsArgs
import typingsSlinky.atPulumiAws.ec2GetSecurityGroupsMod.GetSecurityGroupsResult
