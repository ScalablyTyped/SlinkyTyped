...
object cfg extends js.Object {
  ...
  class AggregateAuthorization protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.AggregateAuthorization {
    /**
  ...
  class ConfigurationAggregator protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.ConfigurationAggregator {
    /**
  ...
  class DeliveryChannel protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.DeliveryChannel {
    /**
  ...
  class OrganizationCustomRule protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.OrganizationCustomRule {
    /**
  ...
  class OrganizationManagedRule protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.OrganizationManagedRule {
    /**
  ...
  class Recorder protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.Recorder {
    /**
  ...
  class RecorderStatus protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.RecorderStatus {
    /**
  ...
  class Rule protected ()
    extends typingsSlinky.atPulumiAws.cfgMod.Rule {
    /**
