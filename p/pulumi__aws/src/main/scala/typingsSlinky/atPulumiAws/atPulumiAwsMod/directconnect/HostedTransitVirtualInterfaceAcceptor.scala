...
import typingsSlinky.atPulumiAws.directconnectHostedTransitVirtualInterfaceAcceptorMod.HostedTransitVirtualInterfaceAcceptorArgs
import typingsSlinky.atPulumiAws.directconnectHostedTransitVirtualInterfaceAcceptorMod.HostedTransitVirtualInterfaceAcceptorState
...
class HostedTransitVirtualInterfaceAcceptor protected ()
  extends typingsSlinky.atPulumiAws.directconnectMod.HostedTransitVirtualInterfaceAcceptor {
  /**
...
object HostedTransitVirtualInterfaceAcceptor extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.directconnectHostedTransitVirtualInterfaceAcceptorMod.HostedTransitVirtualInterfaceAcceptor = js.native
  def get(name: String, id: Input[ID], state: HostedTransitVirtualInterfaceAcceptorState): typingsSlinky.atPulumiAws.directconnectHostedTransitVirtualInterfaceAcceptorMod.HostedTransitVirtualInterfaceAcceptor = js.native
  def get(
    name: String,
    id: Input[ID],
    state: HostedTransitVirtualInterfaceAcceptorState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.directconnectHostedTransitVirtualInterfaceAcceptorMod.HostedTransitVirtualInterfaceAcceptor = js.native
  /**
