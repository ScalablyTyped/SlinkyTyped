...
import typingsSlinky.atPulumiAws.iamUserPolicyMod.UserPolicyArgs
import typingsSlinky.atPulumiAws.iamUserPolicyMod.UserPolicyState
...
class UserPolicy protected ()
  extends typingsSlinky.atPulumiAws.iamMod.UserPolicy {
  /**
...
object UserPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamUserPolicyMod.UserPolicy = js.native
  def get(name: String, id: Input[ID], state: UserPolicyState): typingsSlinky.atPulumiAws.iamUserPolicyMod.UserPolicy = js.native
  def get(name: String, id: Input[ID], state: UserPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamUserPolicyMod.UserPolicy = js.native
  /**
