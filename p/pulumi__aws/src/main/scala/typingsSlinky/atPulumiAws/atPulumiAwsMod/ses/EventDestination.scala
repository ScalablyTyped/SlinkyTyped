...
import typingsSlinky.atPulumiAws.sesEventDestinationMod.EventDestinationArgs
import typingsSlinky.atPulumiAws.sesEventDestinationMod.EventDestinationState
...
class EventDestination protected ()
  extends typingsSlinky.atPulumiAws.sesMod.EventDestination {
  /**
...
object EventDestination extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesEventDestinationMod.EventDestination = js.native
  def get(name: String, id: Input[ID], state: EventDestinationState): typingsSlinky.atPulumiAws.sesEventDestinationMod.EventDestination = js.native
  def get(name: String, id: Input[ID], state: EventDestinationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesEventDestinationMod.EventDestination = js.native
  /**
