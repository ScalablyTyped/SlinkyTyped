...
import typingsSlinky.atPulumiAws.ec2VpcEndpointSubnetAssociationMod.VpcEndpointSubnetAssociationArgs
import typingsSlinky.atPulumiAws.ec2VpcEndpointSubnetAssociationMod.VpcEndpointSubnetAssociationState
...
class VpcEndpointSubnetAssociation protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcEndpointSubnetAssociation {
  /**
...
object VpcEndpointSubnetAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcEndpointSubnetAssociationMod.VpcEndpointSubnetAssociation = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointSubnetAssociationState): typingsSlinky.atPulumiAws.ec2VpcEndpointSubnetAssociationMod.VpcEndpointSubnetAssociation = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointSubnetAssociationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpcEndpointSubnetAssociationMod.VpcEndpointSubnetAssociation = js.native
  /**
