...
object cloudfront extends js.Object {
  ...
  class Distribution protected ()
    extends typingsSlinky.atPulumiAws.cloudfrontMod.Distribution {
    /**
  ...
  class OriginAccessIdentity protected ()
    extends typingsSlinky.atPulumiAws.cloudfrontMod.OriginAccessIdentity {
    /**
  ...
  class PublicKey protected ()
    extends typingsSlinky.atPulumiAws.cloudfrontMod.PublicKey {
    /**
