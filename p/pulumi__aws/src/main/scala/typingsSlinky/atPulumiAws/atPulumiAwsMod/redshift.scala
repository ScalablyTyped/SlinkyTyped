...
object redshift extends js.Object {
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.Cluster {
    /**
  ...
  class EventSubscription protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.EventSubscription {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.ParameterGroup {
    /**
  ...
  class SecurityGroup protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.SecurityGroup {
    /**
  ...
  class SnapshotCopyGrant protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.SnapshotCopyGrant {
    /**
  ...
  class SnapshotSchedule protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.SnapshotSchedule {
    /**
  ...
  class SnapshotScheduleAssociation protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.SnapshotScheduleAssociation {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsSlinky.atPulumiAws.redshiftMod.SubnetGroup {
    /**
