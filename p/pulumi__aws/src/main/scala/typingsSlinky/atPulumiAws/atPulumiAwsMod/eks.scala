...
object eks extends js.Object {
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.eksMod.Cluster {
    /**
  ...
  class FargateProfile protected ()
    extends typingsSlinky.atPulumiAws.eksMod.FargateProfile {
    /**
  ...
  class NodeGroup protected ()
    extends typingsSlinky.atPulumiAws.eksMod.NodeGroup {
    /**
