...
object neptune extends js.Object {
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.Cluster {
    /**
  ...
  class ClusterInstance protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.ClusterInstance {
    /**
  ...
  class ClusterParameterGroup protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.ClusterParameterGroup {
    /**
  ...
  class ClusterSnapshot protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.ClusterSnapshot {
    /**
  ...
  class EventSubscription protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.EventSubscription {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.ParameterGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsSlinky.atPulumiAws.neptuneMod.SubnetGroup {
    /**
