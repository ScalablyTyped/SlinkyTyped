...
import typingsSlinky.atPulumiAws.wafregionalRegexMatchSetMod.RegexMatchSetArgs
import typingsSlinky.atPulumiAws.wafregionalRegexMatchSetMod.RegexMatchSetState
...
class RegexMatchSet protected ()
  extends typingsSlinky.atPulumiAws.wafregionalMod.RegexMatchSet {
  /**
...
object RegexMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.wafregionalRegexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState): typingsSlinky.atPulumiAws.wafregionalRegexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.wafregionalRegexMatchSetMod.RegexMatchSet = js.native
  /**
