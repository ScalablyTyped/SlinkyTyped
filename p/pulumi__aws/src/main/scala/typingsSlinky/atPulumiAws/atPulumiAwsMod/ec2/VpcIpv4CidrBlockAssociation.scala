...
import typingsSlinky.atPulumiAws.ec2VpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociationArgs
import typingsSlinky.atPulumiAws.ec2VpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociationState
...
class VpcIpv4CidrBlockAssociation protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcIpv4CidrBlockAssociation {
  /**
...
object VpcIpv4CidrBlockAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociation = js.native
  def get(name: String, id: Input[ID], state: VpcIpv4CidrBlockAssociationState): typingsSlinky.atPulumiAws.ec2VpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociation = js.native
  def get(name: String, id: Input[ID], state: VpcIpv4CidrBlockAssociationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociation = js.native
  /**
