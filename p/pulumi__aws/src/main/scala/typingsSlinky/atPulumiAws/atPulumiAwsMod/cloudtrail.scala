...
import typingsSlinky.atPulumiAws.cloudtrailGetServiceAccountMod.GetServiceAccountArgs
import typingsSlinky.atPulumiAws.cloudtrailGetServiceAccountMod.GetServiceAccountResult
import typingsSlinky.atPulumiAws.cloudtrailTrailMod.TrailArgs
import typingsSlinky.atPulumiAws.cloudtrailTrailMod.TrailState
...
object cloudtrail extends js.Object {
  ...
  class Trail protected ()
    extends typingsSlinky.atPulumiAws.cloudtrailMod.Trail {
    /**
  ...
  object Trail extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloudtrailTrailMod.Trail = js.native
    def get(name: String, id: Input[ID], state: TrailState): typingsSlinky.atPulumiAws.cloudtrailTrailMod.Trail = js.native
    def get(name: String, id: Input[ID], state: TrailState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloudtrailTrailMod.Trail = js.native
    /**
