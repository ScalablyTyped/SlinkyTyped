...
import typingsSlinky.atPulumiAws.ec2SpotInstanceRequestMod.SpotInstanceRequestArgs
import typingsSlinky.atPulumiAws.ec2SpotInstanceRequestMod.SpotInstanceRequestState
...
class SpotInstanceRequest protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.SpotInstanceRequest {
  /**
...
object SpotInstanceRequest extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2SpotInstanceRequestMod.SpotInstanceRequest = js.native
  def get(name: String, id: Input[ID], state: SpotInstanceRequestState): typingsSlinky.atPulumiAws.ec2SpotInstanceRequestMod.SpotInstanceRequest = js.native
  def get(name: String, id: Input[ID], state: SpotInstanceRequestState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2SpotInstanceRequestMod.SpotInstanceRequest = js.native
  /**
