...
import typingsSlinky.atPulumiAws.ec2DefaultVpcDhcpOptionsMod.DefaultVpcDhcpOptionsArgs
import typingsSlinky.atPulumiAws.ec2DefaultVpcDhcpOptionsMod.DefaultVpcDhcpOptionsState
...
class DefaultVpcDhcpOptions protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.DefaultVpcDhcpOptions {
  /**
...
object DefaultVpcDhcpOptions extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2DefaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = js.native
  def get(name: String, id: Input[ID], state: DefaultVpcDhcpOptionsState): typingsSlinky.atPulumiAws.ec2DefaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = js.native
  def get(name: String, id: Input[ID], state: DefaultVpcDhcpOptionsState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2DefaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = js.native
  /**
