...
import typingsSlinky.atPulumiAws.opsworksStaticWebLayerMod.StaticWebLayerArgs
import typingsSlinky.atPulumiAws.opsworksStaticWebLayerMod.StaticWebLayerState
...
class StaticWebLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksMod.StaticWebLayer {
  /**
...
object StaticWebLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksStaticWebLayerMod.StaticWebLayer = js.native
  def get(name: String, id: Input[ID], state: StaticWebLayerState): typingsSlinky.atPulumiAws.opsworksStaticWebLayerMod.StaticWebLayer = js.native
  def get(name: String, id: Input[ID], state: StaticWebLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksStaticWebLayerMod.StaticWebLayer = js.native
  /**
