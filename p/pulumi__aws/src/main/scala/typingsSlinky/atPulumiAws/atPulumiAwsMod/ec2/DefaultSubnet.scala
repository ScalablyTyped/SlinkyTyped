...
import typingsSlinky.atPulumiAws.ec2DefaultSubnetMod.DefaultSubnetArgs
import typingsSlinky.atPulumiAws.ec2DefaultSubnetMod.DefaultSubnetState
...
class DefaultSubnet protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.DefaultSubnet {
  /**
...
object DefaultSubnet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2DefaultSubnetMod.DefaultSubnet = js.native
  def get(name: String, id: Input[ID], state: DefaultSubnetState): typingsSlinky.atPulumiAws.ec2DefaultSubnetMod.DefaultSubnet = js.native
  def get(name: String, id: Input[ID], state: DefaultSubnetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2DefaultSubnetMod.DefaultSubnet = js.native
  /**
