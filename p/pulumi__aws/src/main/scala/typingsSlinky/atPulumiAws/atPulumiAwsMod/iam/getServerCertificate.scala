...
import typingsSlinky.atPulumiAws.iamGetServerCertificateMod.GetServerCertificateArgs
import typingsSlinky.atPulumiAws.iamGetServerCertificateMod.GetServerCertificateResult
