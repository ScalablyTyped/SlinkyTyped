...
import typingsSlinky.atPulumiAws.s3BucketPublicAccessBlockMod.BucketPublicAccessBlockArgs
import typingsSlinky.atPulumiAws.s3BucketPublicAccessBlockMod.BucketPublicAccessBlockState
...
class BucketPublicAccessBlock protected ()
  extends typingsSlinky.atPulumiAws.s3Mod.BucketPublicAccessBlock {
  /**
...
object BucketPublicAccessBlock extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.s3BucketPublicAccessBlockMod.BucketPublicAccessBlock = js.native
  def get(name: String, id: Input[ID], state: BucketPublicAccessBlockState): typingsSlinky.atPulumiAws.s3BucketPublicAccessBlockMod.BucketPublicAccessBlock = js.native
  def get(name: String, id: Input[ID], state: BucketPublicAccessBlockState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.s3BucketPublicAccessBlockMod.BucketPublicAccessBlock = js.native
  /**
