...
import typingsSlinky.atPulumiAws.dynamodbTableItemMod.TableItemArgs
import typingsSlinky.atPulumiAws.dynamodbTableItemMod.TableItemState
...
class TableItem protected ()
  extends typingsSlinky.atPulumiAws.dynamodbMod.TableItem {
  /**
...
object TableItem extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.dynamodbTableItemMod.TableItem = js.native
  def get(name: String, id: Input[ID], state: TableItemState): typingsSlinky.atPulumiAws.dynamodbTableItemMod.TableItem = js.native
  def get(name: String, id: Input[ID], state: TableItemState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.dynamodbTableItemMod.TableItem = js.native
  /**
