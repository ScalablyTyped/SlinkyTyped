...
import typingsSlinky.atPulumiAws.ec2PeeringConnectionOptionsMod.PeeringConnectionOptionsArgs
import typingsSlinky.atPulumiAws.ec2PeeringConnectionOptionsMod.PeeringConnectionOptionsState
...
class PeeringConnectionOptions protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.PeeringConnectionOptions {
  /**
...
object PeeringConnectionOptions extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2PeeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  def get(name: String, id: Input[ID], state: PeeringConnectionOptionsState): typingsSlinky.atPulumiAws.ec2PeeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  def get(name: String, id: Input[ID], state: PeeringConnectionOptionsState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2PeeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  /**
