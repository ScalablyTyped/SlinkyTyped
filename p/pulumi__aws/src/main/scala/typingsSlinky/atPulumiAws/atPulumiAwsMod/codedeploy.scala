...
object codedeploy extends js.Object {
  ...
  class Application protected ()
    extends typingsSlinky.atPulumiAws.codedeployMod.Application {
    /**
  ...
  class DeploymentConfig protected ()
    extends typingsSlinky.atPulumiAws.codedeployMod.DeploymentConfig {
    /**
  ...
  class DeploymentGroup protected ()
    extends typingsSlinky.atPulumiAws.codedeployMod.DeploymentGroup {
    /**
