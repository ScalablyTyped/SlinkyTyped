...
object docdb extends js.Object {
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.docdbMod.Cluster {
    /**
  ...
  class ClusterInstance protected ()
    extends typingsSlinky.atPulumiAws.docdbMod.ClusterInstance {
    /**
  ...
  class ClusterParameterGroup protected ()
    extends typingsSlinky.atPulumiAws.docdbMod.ClusterParameterGroup {
    /**
  ...
  class ClusterSnapshot protected ()
    extends typingsSlinky.atPulumiAws.docdbMod.ClusterSnapshot {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsSlinky.atPulumiAws.docdbMod.SubnetGroup {
    /**
