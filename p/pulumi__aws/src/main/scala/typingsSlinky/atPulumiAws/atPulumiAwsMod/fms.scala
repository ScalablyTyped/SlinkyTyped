...
import typingsSlinky.atPulumiAws.fmsAdminAccountMod.AdminAccountArgs
import typingsSlinky.atPulumiAws.fmsAdminAccountMod.AdminAccountState
...
object fms extends js.Object {
  ...
  class AdminAccount protected ()
    extends typingsSlinky.atPulumiAws.fmsMod.AdminAccount {
    /**
  ...
  object AdminAccount extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.fmsAdminAccountMod.AdminAccount = js.native
    def get(name: String, id: Input[ID], state: AdminAccountState): typingsSlinky.atPulumiAws.fmsAdminAccountMod.AdminAccount = js.native
    def get(name: String, id: Input[ID], state: AdminAccountState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.fmsAdminAccountMod.AdminAccount = js.native
    /**
