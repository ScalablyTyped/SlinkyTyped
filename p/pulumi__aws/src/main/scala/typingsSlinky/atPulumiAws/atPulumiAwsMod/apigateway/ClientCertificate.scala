...
import typingsSlinky.atPulumiAws.apigatewayClientCertificateMod.ClientCertificateArgs
import typingsSlinky.atPulumiAws.apigatewayClientCertificateMod.ClientCertificateState
...
class ClientCertificate protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMod.ClientCertificate {
  /**
...
object ClientCertificate extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayClientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: ClientCertificateState): typingsSlinky.atPulumiAws.apigatewayClientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: ClientCertificateState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayClientCertificateMod.ClientCertificate = js.native
  /**
