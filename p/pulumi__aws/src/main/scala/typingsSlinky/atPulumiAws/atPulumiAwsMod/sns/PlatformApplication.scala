...
import typingsSlinky.atPulumiAws.snsPlatformApplicationMod.PlatformApplicationArgs
import typingsSlinky.atPulumiAws.snsPlatformApplicationMod.PlatformApplicationState
...
class PlatformApplication protected ()
  extends typingsSlinky.atPulumiAws.snsMod.PlatformApplication {
  /**
...
object PlatformApplication extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.snsPlatformApplicationMod.PlatformApplication = js.native
  def get(name: String, id: Input[ID], state: PlatformApplicationState): typingsSlinky.atPulumiAws.snsPlatformApplicationMod.PlatformApplication = js.native
  def get(name: String, id: Input[ID], state: PlatformApplicationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.snsPlatformApplicationMod.PlatformApplication = js.native
  /**
