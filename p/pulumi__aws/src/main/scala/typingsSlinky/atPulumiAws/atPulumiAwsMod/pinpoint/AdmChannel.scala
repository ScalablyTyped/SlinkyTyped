...
import typingsSlinky.atPulumiAws.pinpointAdmChannelMod.AdmChannelArgs
import typingsSlinky.atPulumiAws.pinpointAdmChannelMod.AdmChannelState
...
class AdmChannel protected ()
  extends typingsSlinky.atPulumiAws.pinpointMod.AdmChannel {
  /**
...
object AdmChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointAdmChannelMod.AdmChannel = js.native
  def get(name: String, id: Input[ID], state: AdmChannelState): typingsSlinky.atPulumiAws.pinpointAdmChannelMod.AdmChannel = js.native
  def get(name: String, id: Input[ID], state: AdmChannelState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointAdmChannelMod.AdmChannel = js.native
  /**
