...
object sagemaker extends js.Object {
  ...
  class Endpoint protected ()
    extends typingsSlinky.atPulumiAws.sagemakerMod.Endpoint {
    /**
  ...
  class EndpointConfiguration protected ()
    extends typingsSlinky.atPulumiAws.sagemakerMod.EndpointConfiguration {
    /**
  ...
  class Model protected ()
    extends typingsSlinky.atPulumiAws.sagemakerMod.Model {
    /**
  ...
  class NotebookInstance protected ()
    extends typingsSlinky.atPulumiAws.sagemakerMod.NotebookInstance {
    /**
  ...
  class NotebookInstanceLifecycleConfiguration protected ()
    extends typingsSlinky.atPulumiAws.sagemakerMod.NotebookInstanceLifecycleConfiguration {
    /**
