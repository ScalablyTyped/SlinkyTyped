...
object transfer extends js.Object {
  ...
  class Server protected ()
    extends typingsSlinky.atPulumiAws.transferMod.Server {
    /**
  ...
  class SshKey protected ()
    extends typingsSlinky.atPulumiAws.transferMod.SshKey {
    /**
  ...
  class User protected ()
    extends typingsSlinky.atPulumiAws.transferMod.User {
    /**
