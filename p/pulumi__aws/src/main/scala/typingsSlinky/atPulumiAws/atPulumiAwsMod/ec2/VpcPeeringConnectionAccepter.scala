...
import typingsSlinky.atPulumiAws.ec2VpcPeeringConnectionAccepterMod.VpcPeeringConnectionAccepterArgs
import typingsSlinky.atPulumiAws.ec2VpcPeeringConnectionAccepterMod.VpcPeeringConnectionAccepterState
...
class VpcPeeringConnectionAccepter protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcPeeringConnectionAccepter {
  /**
...
object VpcPeeringConnectionAccepter extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcPeeringConnectionAccepterMod.VpcPeeringConnectionAccepter = js.native
  def get(name: String, id: Input[ID], state: VpcPeeringConnectionAccepterState): typingsSlinky.atPulumiAws.ec2VpcPeeringConnectionAccepterMod.VpcPeeringConnectionAccepter = js.native
  def get(name: String, id: Input[ID], state: VpcPeeringConnectionAccepterState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpcPeeringConnectionAccepterMod.VpcPeeringConnectionAccepter = js.native
  /**
