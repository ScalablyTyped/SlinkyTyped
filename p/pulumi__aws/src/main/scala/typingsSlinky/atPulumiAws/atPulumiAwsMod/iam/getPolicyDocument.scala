...
import typingsSlinky.atPulumiAws.iamGetPolicyDocumentMod.GetPolicyDocumentArgs
import typingsSlinky.atPulumiAws.iamGetPolicyDocumentMod.GetPolicyDocumentResult
