...
object athena extends js.Object {
  ...
  class Database protected ()
    extends typingsSlinky.atPulumiAws.athenaMod.Database {
    /**
  ...
  class NamedQuery protected ()
    extends typingsSlinky.atPulumiAws.athenaMod.NamedQuery {
    /**
  ...
  class Workgroup protected ()
    extends typingsSlinky.atPulumiAws.athenaMod.Workgroup {
    /**
