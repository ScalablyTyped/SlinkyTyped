...
object route53 extends js.Object {
  ...
  class DelegationSet protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.DelegationSet {
    /**
  ...
  class HealthCheck protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.HealthCheck {
    /**
  ...
  class QueryLog protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.QueryLog {
    /**
  ...
  class Record protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.Record {
    /**
  ...
  class ResolverEndpoint protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.ResolverEndpoint {
    /**
  ...
  class ResolverRule protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.ResolverRule {
    /**
  ...
  class ResolverRuleAssociation protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.ResolverRuleAssociation {
    /**
  ...
  class Zone protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.Zone {
    /**
  ...
  class ZoneAssociation protected ()
    extends typingsSlinky.atPulumiAws.route53Mod.ZoneAssociation {
    /**
