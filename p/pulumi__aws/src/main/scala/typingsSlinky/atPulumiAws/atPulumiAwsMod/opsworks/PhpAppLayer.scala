...
import typingsSlinky.atPulumiAws.opsworksPhpAppLayerMod.PhpAppLayerArgs
import typingsSlinky.atPulumiAws.opsworksPhpAppLayerMod.PhpAppLayerState
...
class PhpAppLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksMod.PhpAppLayer {
  /**
...
object PhpAppLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksPhpAppLayerMod.PhpAppLayer = js.native
  def get(name: String, id: Input[ID], state: PhpAppLayerState): typingsSlinky.atPulumiAws.opsworksPhpAppLayerMod.PhpAppLayer = js.native
  def get(name: String, id: Input[ID], state: PhpAppLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksPhpAppLayerMod.PhpAppLayer = js.native
  /**
