...
object elasticache extends js.Object {
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.elasticacheMod.Cluster {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsSlinky.atPulumiAws.elasticacheMod.ParameterGroup {
    /**
  ...
  class ReplicationGroup protected ()
    extends typingsSlinky.atPulumiAws.elasticacheMod.ReplicationGroup {
    /**
  ...
  class SecurityGroup protected ()
    extends typingsSlinky.atPulumiAws.elasticacheMod.SecurityGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsSlinky.atPulumiAws.elasticacheMod.SubnetGroup {
    /**
