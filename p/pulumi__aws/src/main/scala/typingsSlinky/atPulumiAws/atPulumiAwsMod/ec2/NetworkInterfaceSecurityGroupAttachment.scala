...
import typingsSlinky.atPulumiAws.ec2NetworkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachmentArgs
import typingsSlinky.atPulumiAws.ec2NetworkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachmentState
...
class NetworkInterfaceSecurityGroupAttachment protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.NetworkInterfaceSecurityGroupAttachment {
  /**
...
object NetworkInterfaceSecurityGroupAttachment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2NetworkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  def get(name: String, id: Input[ID], state: NetworkInterfaceSecurityGroupAttachmentState): typingsSlinky.atPulumiAws.ec2NetworkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  def get(
    name: String,
    id: Input[ID],
    state: NetworkInterfaceSecurityGroupAttachmentState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.ec2NetworkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  /**
