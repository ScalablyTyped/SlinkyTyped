...
object gamelift extends js.Object {
  ...
  class Alias protected ()
    extends typingsSlinky.atPulumiAws.gameliftMod.Alias {
    /**
  ...
  class Build protected ()
    extends typingsSlinky.atPulumiAws.gameliftMod.Build {
    /**
  ...
  class Fleet protected ()
    extends typingsSlinky.atPulumiAws.gameliftMod.Fleet {
    /**
  ...
  class GameSessionQueue protected ()
    extends typingsSlinky.atPulumiAws.gameliftMod.GameSessionQueue {
    /**
