...
import typingsSlinky.atPulumiAws.directconnectGatewayAssociationMod.GatewayAssociationArgs
import typingsSlinky.atPulumiAws.directconnectGatewayAssociationMod.GatewayAssociationState
...
class GatewayAssociation protected ()
  extends typingsSlinky.atPulumiAws.directconnectMod.GatewayAssociation {
  /**
...
object GatewayAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.directconnectGatewayAssociationMod.GatewayAssociation = js.native
  def get(name: String, id: Input[ID], state: GatewayAssociationState): typingsSlinky.atPulumiAws.directconnectGatewayAssociationMod.GatewayAssociation = js.native
  def get(name: String, id: Input[ID], state: GatewayAssociationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.directconnectGatewayAssociationMod.GatewayAssociation = js.native
  /**
