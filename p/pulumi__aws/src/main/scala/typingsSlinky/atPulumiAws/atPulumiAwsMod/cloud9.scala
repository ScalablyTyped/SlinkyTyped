...
import typingsSlinky.atPulumiAws.cloud9EnvironmentEC2Mod.EnvironmentEC2Args
import typingsSlinky.atPulumiAws.cloud9EnvironmentEC2Mod.EnvironmentEC2State
...
object cloud9 extends js.Object {
  ...
  class EnvironmentEC2 protected ()
    extends typingsSlinky.atPulumiAws.cloud9Mod.EnvironmentEC2 {
    /**
  ...
  object EnvironmentEC2 extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloud9EnvironmentEC2Mod.EnvironmentEC2 = js.native
    def get(name: String, id: Input[ID], state: EnvironmentEC2State): typingsSlinky.atPulumiAws.cloud9EnvironmentEC2Mod.EnvironmentEC2 = js.native
    def get(name: String, id: Input[ID], state: EnvironmentEC2State, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloud9EnvironmentEC2Mod.EnvironmentEC2 = js.native
    /**
