...
object guardduty extends js.Object {
  ...
  class Detector protected ()
    extends typingsSlinky.atPulumiAws.guarddutyMod.Detector {
    /**
  ...
  class IPSet protected ()
    extends typingsSlinky.atPulumiAws.guarddutyMod.IPSet {
    /**
  ...
  class InviteAccepter protected ()
    extends typingsSlinky.atPulumiAws.guarddutyMod.InviteAccepter {
    /**
  ...
  class Member protected ()
    extends typingsSlinky.atPulumiAws.guarddutyMod.Member {
    /**
  ...
  class ThreatIntelSet protected ()
    extends typingsSlinky.atPulumiAws.guarddutyMod.ThreatIntelSet {
    /**
