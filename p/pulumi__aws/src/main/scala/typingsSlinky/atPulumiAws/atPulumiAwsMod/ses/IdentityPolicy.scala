...
import typingsSlinky.atPulumiAws.sesIdentityPolicyMod.IdentityPolicyArgs
import typingsSlinky.atPulumiAws.sesIdentityPolicyMod.IdentityPolicyState
...
class IdentityPolicy protected ()
  extends typingsSlinky.atPulumiAws.sesMod.IdentityPolicy {
  /**
...
object IdentityPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesIdentityPolicyMod.IdentityPolicy = js.native
  def get(name: String, id: Input[ID], state: IdentityPolicyState): typingsSlinky.atPulumiAws.sesIdentityPolicyMod.IdentityPolicy = js.native
  def get(name: String, id: Input[ID], state: IdentityPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesIdentityPolicyMod.IdentityPolicy = js.native
  /**
