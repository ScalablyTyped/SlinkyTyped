...
object ram extends js.Object {
  ...
  class PrincipalAssociation protected ()
    extends typingsSlinky.atPulumiAws.ramMod.PrincipalAssociation {
    /**
  ...
  class ResourceAssociation protected ()
    extends typingsSlinky.atPulumiAws.ramMod.ResourceAssociation {
    /**
  ...
  class ResourceShare protected ()
    extends typingsSlinky.atPulumiAws.ramMod.ResourceShare {
    /**
  ...
  class ResourceShareAccepter protected ()
    extends typingsSlinky.atPulumiAws.ramMod.ResourceShareAccepter {
    /**
