...
import typingsSlinky.atPulumiAws.apigatewayDocumentationPartMod.DocumentationPartArgs
import typingsSlinky.atPulumiAws.apigatewayDocumentationPartMod.DocumentationPartState
...
class DocumentationPart protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMod.DocumentationPart {
  /**
...
object DocumentationPart extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayDocumentationPartMod.DocumentationPart = js.native
  def get(name: String, id: Input[ID], state: DocumentationPartState): typingsSlinky.atPulumiAws.apigatewayDocumentationPartMod.DocumentationPart = js.native
  def get(name: String, id: Input[ID], state: DocumentationPartState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayDocumentationPartMod.DocumentationPart = js.native
  /**
