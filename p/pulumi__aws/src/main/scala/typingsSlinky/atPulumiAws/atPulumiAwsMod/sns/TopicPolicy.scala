...
import typingsSlinky.atPulumiAws.snsTopicPolicyMod.TopicPolicyArgs
import typingsSlinky.atPulumiAws.snsTopicPolicyMod.TopicPolicyState
...
class TopicPolicy protected ()
  extends typingsSlinky.atPulumiAws.snsMod.TopicPolicy {
  /**
...
object TopicPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.snsTopicPolicyMod.TopicPolicy = js.native
  def get(name: String, id: Input[ID], state: TopicPolicyState): typingsSlinky.atPulumiAws.snsTopicPolicyMod.TopicPolicy = js.native
  def get(name: String, id: Input[ID], state: TopicPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.snsTopicPolicyMod.TopicPolicy = js.native
  /**
