...
object datasync extends js.Object {
  ...
  class Agent protected ()
    extends typingsSlinky.atPulumiAws.datasyncMod.Agent {
    /**
  ...
  class EfsLocation protected ()
    extends typingsSlinky.atPulumiAws.datasyncMod.EfsLocation {
    /**
  ...
  class NfsLocation protected ()
    extends typingsSlinky.atPulumiAws.datasyncMod.NfsLocation {
    /**
  ...
  class S3Location protected ()
    extends typingsSlinky.atPulumiAws.datasyncMod.S3Location {
    /**
  ...
  class Task protected ()
    extends typingsSlinky.atPulumiAws.datasyncMod.Task {
    /**
