...
import typingsSlinky.atPulumiAws.ec2VpcDhcpOptionsMod.VpcDhcpOptionsArgs
import typingsSlinky.atPulumiAws.ec2VpcDhcpOptionsMod.VpcDhcpOptionsState
...
class VpcDhcpOptions protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcDhcpOptions {
  /**
...
object VpcDhcpOptions extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcDhcpOptionsMod.VpcDhcpOptions = js.native
  def get(name: String, id: Input[ID], state: VpcDhcpOptionsState): typingsSlinky.atPulumiAws.ec2VpcDhcpOptionsMod.VpcDhcpOptions = js.native
  def get(name: String, id: Input[ID], state: VpcDhcpOptionsState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpcDhcpOptionsMod.VpcDhcpOptions = js.native
  /**
