...
object organizations extends js.Object {
  ...
  class Account protected ()
    extends typingsSlinky.atPulumiAws.organizationsMod.Account {
    /**
  ...
  class Organization protected ()
    extends typingsSlinky.atPulumiAws.organizationsMod.Organization {
    /**
  ...
  class OrganizationalUnit protected ()
    extends typingsSlinky.atPulumiAws.organizationsMod.OrganizationalUnit {
    /**
  ...
  class Policy protected ()
    extends typingsSlinky.atPulumiAws.organizationsMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typingsSlinky.atPulumiAws.organizationsMod.PolicyAttachment {
    /**
