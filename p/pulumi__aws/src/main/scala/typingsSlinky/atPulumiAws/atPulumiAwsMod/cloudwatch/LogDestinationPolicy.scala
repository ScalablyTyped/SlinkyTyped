...
import typingsSlinky.atPulumiAws.cloudwatchLogDestinationPolicyMod.LogDestinationPolicyArgs
import typingsSlinky.atPulumiAws.cloudwatchLogDestinationPolicyMod.LogDestinationPolicyState
...
class LogDestinationPolicy protected ()
  extends typingsSlinky.atPulumiAws.cloudwatchMod.LogDestinationPolicy {
  /**
...
object LogDestinationPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloudwatchLogDestinationPolicyMod.LogDestinationPolicy = js.native
  def get(name: String, id: Input[ID], state: LogDestinationPolicyState): typingsSlinky.atPulumiAws.cloudwatchLogDestinationPolicyMod.LogDestinationPolicy = js.native
  def get(name: String, id: Input[ID], state: LogDestinationPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloudwatchLogDestinationPolicyMod.LogDestinationPolicy = js.native
  /**
