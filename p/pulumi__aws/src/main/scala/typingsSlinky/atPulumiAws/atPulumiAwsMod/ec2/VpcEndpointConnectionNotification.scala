...
import typingsSlinky.atPulumiAws.ec2VpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotificationArgs
import typingsSlinky.atPulumiAws.ec2VpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotificationState
...
class VpcEndpointConnectionNotification protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcEndpointConnectionNotification {
  /**
...
object VpcEndpointConnectionNotification extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointConnectionNotificationState): typingsSlinky.atPulumiAws.ec2VpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  def get(
    name: String,
    id: Input[ID],
    state: VpcEndpointConnectionNotificationState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.ec2VpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  /**
