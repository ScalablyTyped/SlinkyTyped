...
import typingsSlinky.atPulumiAws.ec2SpotFleetRequestMod.SpotFleetRequestArgs
import typingsSlinky.atPulumiAws.ec2SpotFleetRequestMod.SpotFleetRequestState
...
class SpotFleetRequest protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.SpotFleetRequest {
  /**
...
object SpotFleetRequest extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2SpotFleetRequestMod.SpotFleetRequest = js.native
  def get(name: String, id: Input[ID], state: SpotFleetRequestState): typingsSlinky.atPulumiAws.ec2SpotFleetRequestMod.SpotFleetRequest = js.native
  def get(name: String, id: Input[ID], state: SpotFleetRequestState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2SpotFleetRequestMod.SpotFleetRequest = js.native
  /**
