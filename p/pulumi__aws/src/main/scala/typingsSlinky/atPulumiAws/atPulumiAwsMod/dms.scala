...
object dms extends js.Object {
  ...
  class Certificate protected ()
    extends typingsSlinky.atPulumiAws.dmsMod.Certificate {
    /**
  ...
  class Endpoint protected ()
    extends typingsSlinky.atPulumiAws.dmsMod.Endpoint {
    /**
  ...
  class ReplicationInstance protected ()
    extends typingsSlinky.atPulumiAws.dmsMod.ReplicationInstance {
    /**
  ...
  class ReplicationSubnetGroup protected ()
    extends typingsSlinky.atPulumiAws.dmsMod.ReplicationSubnetGroup {
    /**
  ...
  class ReplicationTask protected ()
    extends typingsSlinky.atPulumiAws.dmsMod.ReplicationTask {
    /**
