...
object appsync extends js.Object {
  ...
  class ApiKey protected ()
    extends typingsSlinky.atPulumiAws.appsyncMod.ApiKey {
    /**
  ...
  class DataSource protected ()
    extends typingsSlinky.atPulumiAws.appsyncMod.DataSource {
    /**
  ...
  class Function protected ()
    extends typingsSlinky.atPulumiAws.appsyncMod.Function {
    /**
  ...
  class GraphQLApi protected ()
    extends typingsSlinky.atPulumiAws.appsyncMod.GraphQLApi {
    /**
  ...
  class Resolver protected ()
    extends typingsSlinky.atPulumiAws.appsyncMod.Resolver {
    /**
