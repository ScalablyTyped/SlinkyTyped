...
import typingsSlinky.atPulumiAws.sesEmailIdentityMod.EmailIdentityArgs
import typingsSlinky.atPulumiAws.sesEmailIdentityMod.EmailIdentityState
...
class EmailIdentity protected ()
  extends typingsSlinky.atPulumiAws.sesMod.EmailIdentity {
  /**
...
object EmailIdentity extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesEmailIdentityMod.EmailIdentity = js.native
  def get(name: String, id: Input[ID], state: EmailIdentityState): typingsSlinky.atPulumiAws.sesEmailIdentityMod.EmailIdentity = js.native
  def get(name: String, id: Input[ID], state: EmailIdentityState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesEmailIdentityMod.EmailIdentity = js.native
  /**
