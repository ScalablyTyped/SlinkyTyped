...
object lb extends js.Object {
  ...
  class Listener protected ()
    extends typingsSlinky.atPulumiAws.lbMod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsSlinky.atPulumiAws.lbMod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsSlinky.atPulumiAws.lbMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsSlinky.atPulumiAws.lbMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsSlinky.atPulumiAws.lbMod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsSlinky.atPulumiAws.lbMod.TargetGroupAttachment {
    /**
