...
object ec2transitgateway extends js.Object {
  ...
  class Route protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.Route {
    /**
  ...
  class RouteTable protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.RouteTable {
    /**
  ...
  class RouteTableAssociation protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.RouteTableAssociation {
    /**
  ...
  class RouteTablePropagation protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.RouteTablePropagation {
    /**
  ...
  class TransitGateway protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.TransitGateway {
    /**
  ...
  class VpcAttachment protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.VpcAttachment {
    /**
  ...
  class VpcAttachmentAccepter protected ()
    extends typingsSlinky.atPulumiAws.ec2transitgatewayMod.VpcAttachmentAccepter {
    /**
