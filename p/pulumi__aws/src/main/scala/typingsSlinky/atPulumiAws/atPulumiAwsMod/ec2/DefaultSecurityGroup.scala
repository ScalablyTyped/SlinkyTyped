...
import typingsSlinky.atPulumiAws.ec2DefaultSecurityGroupMod.DefaultSecurityGroupArgs
import typingsSlinky.atPulumiAws.ec2DefaultSecurityGroupMod.DefaultSecurityGroupState
...
class DefaultSecurityGroup protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.DefaultSecurityGroup {
  /**
...
object DefaultSecurityGroup extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2DefaultSecurityGroupMod.DefaultSecurityGroup = js.native
  def get(name: String, id: Input[ID], state: DefaultSecurityGroupState): typingsSlinky.atPulumiAws.ec2DefaultSecurityGroupMod.DefaultSecurityGroup = js.native
  def get(name: String, id: Input[ID], state: DefaultSecurityGroupState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2DefaultSecurityGroupMod.DefaultSecurityGroup = js.native
  /**
