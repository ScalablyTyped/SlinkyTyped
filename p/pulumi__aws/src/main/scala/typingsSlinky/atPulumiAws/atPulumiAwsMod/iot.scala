...
object iot extends js.Object {
  ...
  class Certificate protected ()
    extends typingsSlinky.atPulumiAws.iotMod.Certificate {
    /**
  ...
  class Policy protected ()
    extends typingsSlinky.atPulumiAws.iotMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typingsSlinky.atPulumiAws.iotMod.PolicyAttachment {
    /**
  ...
  class RoleAlias protected ()
    extends typingsSlinky.atPulumiAws.iotMod.RoleAlias {
    /**
  ...
  class Thing protected ()
    extends typingsSlinky.atPulumiAws.iotMod.Thing {
    /**
  ...
  class ThingPrincipalAttachment protected ()
    extends typingsSlinky.atPulumiAws.iotMod.ThingPrincipalAttachment {
    /**
  ...
  class ThingType protected ()
    extends typingsSlinky.atPulumiAws.iotMod.ThingType {
    /**
  ...
  class TopicRule protected ()
    extends typingsSlinky.atPulumiAws.iotMod.TopicRule {
    /**
