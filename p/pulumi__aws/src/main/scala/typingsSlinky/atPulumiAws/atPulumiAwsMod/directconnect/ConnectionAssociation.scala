...
import typingsSlinky.atPulumiAws.directconnectConnectionAssociationMod.ConnectionAssociationArgs
import typingsSlinky.atPulumiAws.directconnectConnectionAssociationMod.ConnectionAssociationState
...
class ConnectionAssociation protected ()
  extends typingsSlinky.atPulumiAws.directconnectMod.ConnectionAssociation {
  /**
...
object ConnectionAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.directconnectConnectionAssociationMod.ConnectionAssociation = js.native
  def get(name: String, id: Input[ID], state: ConnectionAssociationState): typingsSlinky.atPulumiAws.directconnectConnectionAssociationMod.ConnectionAssociation = js.native
  def get(name: String, id: Input[ID], state: ConnectionAssociationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.directconnectConnectionAssociationMod.ConnectionAssociation = js.native
  /**
