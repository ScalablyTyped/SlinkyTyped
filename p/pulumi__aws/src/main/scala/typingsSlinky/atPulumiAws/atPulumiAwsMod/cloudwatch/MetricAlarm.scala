...
import typingsSlinky.atPulumiAws.cloudwatchMetricAlarmMod.MetricAlarmArgs
import typingsSlinky.atPulumiAws.cloudwatchMetricAlarmMod.MetricAlarmState
...
class MetricAlarm protected ()
  extends typingsSlinky.atPulumiAws.cloudwatchMod.MetricAlarm {
  /**
...
object MetricAlarm extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloudwatchMetricAlarmMod.MetricAlarm = js.native
  def get(name: String, id: Input[ID], state: MetricAlarmState): typingsSlinky.atPulumiAws.cloudwatchMetricAlarmMod.MetricAlarm = js.native
  def get(name: String, id: Input[ID], state: MetricAlarmState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloudwatchMetricAlarmMod.MetricAlarm = js.native
  /**
