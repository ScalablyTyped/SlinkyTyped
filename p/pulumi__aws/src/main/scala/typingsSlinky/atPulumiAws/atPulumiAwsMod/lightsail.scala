...
object lightsail extends js.Object {
  ...
  class Domain protected ()
    extends typingsSlinky.atPulumiAws.lightsailMod.Domain {
    /**
  ...
  class Instance protected ()
    extends typingsSlinky.atPulumiAws.lightsailMod.Instance {
    /**
  ...
  class KeyPair protected ()
    extends typingsSlinky.atPulumiAws.lightsailMod.KeyPair {
    /**
  ...
  class StaticIp protected ()
    extends typingsSlinky.atPulumiAws.lightsailMod.StaticIp {
    /**
  ...
  class StaticIpAttachment protected ()
    extends typingsSlinky.atPulumiAws.lightsailMod.StaticIpAttachment {
    /**
