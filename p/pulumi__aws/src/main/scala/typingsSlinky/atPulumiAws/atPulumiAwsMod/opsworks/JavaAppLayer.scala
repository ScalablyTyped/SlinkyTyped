...
import typingsSlinky.atPulumiAws.opsworksJavaAppLayerMod.JavaAppLayerArgs
import typingsSlinky.atPulumiAws.opsworksJavaAppLayerMod.JavaAppLayerState
...
class JavaAppLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksMod.JavaAppLayer {
  /**
...
object JavaAppLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksJavaAppLayerMod.JavaAppLayer = js.native
  def get(name: String, id: Input[ID], state: JavaAppLayerState): typingsSlinky.atPulumiAws.opsworksJavaAppLayerMod.JavaAppLayer = js.native
  def get(name: String, id: Input[ID], state: JavaAppLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksJavaAppLayerMod.JavaAppLayer = js.native
  /**
