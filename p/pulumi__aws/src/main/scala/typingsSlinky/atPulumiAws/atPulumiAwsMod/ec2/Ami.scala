...
import typingsSlinky.atPulumiAws.ec2AmiMod.AmiArgs
import typingsSlinky.atPulumiAws.ec2AmiMod.AmiState
...
@js.native
class Ami protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.Ami {
  /**
...
object Ami extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2AmiMod.Ami = js.native
  def get(name: String, id: Input[ID], state: AmiState): typingsSlinky.atPulumiAws.ec2AmiMod.Ami = js.native
  def get(name: String, id: Input[ID], state: AmiState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2AmiMod.Ami = js.native
  /**
