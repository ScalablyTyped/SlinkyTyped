...
import typingsSlinky.atPulumiAws.ec2VpcEndpointServiceAllowedPrincipleMod.VpcEndpointServiceAllowedPrincipleArgs
import typingsSlinky.atPulumiAws.ec2VpcEndpointServiceAllowedPrincipleMod.VpcEndpointServiceAllowedPrincipleState
...
class VpcEndpointServiceAllowedPrinciple protected ()
  extends typingsSlinky.atPulumiAws.ec2Mod.VpcEndpointServiceAllowedPrinciple {
  /**
...
object VpcEndpointServiceAllowedPrinciple extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcEndpointServiceAllowedPrincipleMod.VpcEndpointServiceAllowedPrinciple = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointServiceAllowedPrincipleState): typingsSlinky.atPulumiAws.ec2VpcEndpointServiceAllowedPrincipleMod.VpcEndpointServiceAllowedPrinciple = js.native
  def get(
    name: String,
    id: Input[ID],
    state: VpcEndpointServiceAllowedPrincipleState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.ec2VpcEndpointServiceAllowedPrincipleMod.VpcEndpointServiceAllowedPrinciple = js.native
  /**
