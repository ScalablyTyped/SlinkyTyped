...
import typingsSlinky.atPulumiAws.apigatewayResponseMod.ResponseArgs
import typingsSlinky.atPulumiAws.apigatewayResponseMod.ResponseState
...
class Response protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMod.Response {
  /**
...
object Response extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayResponseMod.Response = js.native
  def get(name: String, id: Input[ID], state: ResponseState): typingsSlinky.atPulumiAws.apigatewayResponseMod.Response = js.native
  def get(name: String, id: Input[ID], state: ResponseState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayResponseMod.Response = js.native
  /**
