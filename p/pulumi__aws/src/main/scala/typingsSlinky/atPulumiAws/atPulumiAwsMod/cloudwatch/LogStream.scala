...
import typingsSlinky.atPulumiAws.cloudwatchLogStreamMod.LogStreamArgs
import typingsSlinky.atPulumiAws.cloudwatchLogStreamMod.LogStreamState
...
class LogStream protected ()
  extends typingsSlinky.atPulumiAws.cloudwatchMod.LogStream {
  /**
...
object LogStream extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloudwatchLogStreamMod.LogStream = js.native
  def get(name: String, id: Input[ID], state: LogStreamState): typingsSlinky.atPulumiAws.cloudwatchLogStreamMod.LogStream = js.native
  def get(name: String, id: Input[ID], state: LogStreamState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloudwatchLogStreamMod.LogStream = js.native
  /**
