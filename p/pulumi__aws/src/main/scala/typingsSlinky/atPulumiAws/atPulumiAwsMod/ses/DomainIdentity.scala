...
import typingsSlinky.atPulumiAws.sesDomainIdentityMod.DomainIdentityArgs
import typingsSlinky.atPulumiAws.sesDomainIdentityMod.DomainIdentityState
...
class DomainIdentity protected ()
  extends typingsSlinky.atPulumiAws.sesMod.DomainIdentity {
  /**
...
object DomainIdentity extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesDomainIdentityMod.DomainIdentity = js.native
  def get(name: String, id: Input[ID], state: DomainIdentityState): typingsSlinky.atPulumiAws.sesDomainIdentityMod.DomainIdentity = js.native
  def get(name: String, id: Input[ID], state: DomainIdentityState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesDomainIdentityMod.DomainIdentity = js.native
  /**
