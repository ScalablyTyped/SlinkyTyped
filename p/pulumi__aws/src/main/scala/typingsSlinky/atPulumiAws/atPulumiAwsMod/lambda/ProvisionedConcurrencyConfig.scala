...
import typingsSlinky.atPulumiAws.lambdaProvisionedConcurrencyConfigMod.ProvisionedConcurrencyConfigArgs
import typingsSlinky.atPulumiAws.lambdaProvisionedConcurrencyConfigMod.ProvisionedConcurrencyConfigState
...
class ProvisionedConcurrencyConfig protected ()
  extends typingsSlinky.atPulumiAws.lambdaMod.ProvisionedConcurrencyConfig {
  /**
...
object ProvisionedConcurrencyConfig extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.lambdaProvisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig = js.native
  def get(name: String, id: Input[ID], state: ProvisionedConcurrencyConfigState): typingsSlinky.atPulumiAws.lambdaProvisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig = js.native
  def get(name: String, id: Input[ID], state: ProvisionedConcurrencyConfigState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.lambdaProvisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig = js.native
  /**
