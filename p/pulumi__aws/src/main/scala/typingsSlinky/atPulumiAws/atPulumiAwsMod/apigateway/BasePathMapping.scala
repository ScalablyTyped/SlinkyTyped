...
import typingsSlinky.atPulumiAws.apigatewayBasePathMappingMod.BasePathMappingArgs
import typingsSlinky.atPulumiAws.apigatewayBasePathMappingMod.BasePathMappingState
...
class BasePathMapping protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMod.BasePathMapping {
  /**
...
object BasePathMapping extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayBasePathMappingMod.BasePathMapping = js.native
  def get(name: String, id: Input[ID], state: BasePathMappingState): typingsSlinky.atPulumiAws.apigatewayBasePathMappingMod.BasePathMapping = js.native
  def get(name: String, id: Input[ID], state: BasePathMappingState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayBasePathMappingMod.BasePathMapping = js.native
  /**
