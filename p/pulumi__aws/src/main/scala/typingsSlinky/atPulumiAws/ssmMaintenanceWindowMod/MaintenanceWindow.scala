package typingsSlinky.atPulumiAws.ssmMaintenanceWindowMod
...
class MaintenanceWindow protected () extends CustomResource {
  ...
  /**
    ...
    */
  val allowUnassociatedTargets: Output[js.UndefOr[Boolean]] = js.native
  /**
    * The number of hours before the end of the Maintenance Window that Systems Manager stops scheduling new tasks for execution.
    */
  val cutoff: Output[Double] = js.native
  /**
    * The duration of the Maintenance Window in hours.
    */
  val duration: Output[Double] = js.native
  /**
  ...
  /**
    ...
    */
  val schedule: Output[String] = js.native
  /**
    * Timezone for schedule in [Internet Assigned Numbers Authority (IANA) Time Zone Database format](https://www.iana.org/time-zones). For example: `America/Los_Angeles`, `etc/UTC`, or `Asia/Seoul`.
    */
  val scheduleTimezone: Output[js.UndefOr[String]] = js.native
  /**
    * Timestamp in [ISO-8601 extended format](https://www.iso.org/iso-8601-date-and-time-format.html) when to begin the maintenance window.
    */
  val startDate: Output[js.UndefOr[String]] = js.native
  /**
