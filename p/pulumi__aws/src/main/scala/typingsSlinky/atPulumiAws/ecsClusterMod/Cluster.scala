...
import typingsSlinky.atPulumiAws.typesOutputMod.ecs.ClusterDefaultCapacityProviderStrategy
import typingsSlinky.atPulumiAws.typesOutputMod.ecs.ClusterSetting
