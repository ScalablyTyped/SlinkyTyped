package typingsSlinky.atPulumiAws.ec2transitgatewayTransitGatewayMod
...
class TransitGateway protected () extends CustomResource {
  ...
  /**
    ...
    */
  val amazonSideAsn: Output[js.UndefOr[Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val associationDefaultRouteTableId: Output[String] = js.native
  /**
    * Whether resource attachment requests are automatically accepted. Valid values: `disable`, `enable`. Default value: `disable`.
    */
  val autoAcceptSharedAttachments: Output[js.UndefOr[String]] = js.native
  /**
    * Whether resource attachments are automatically associated with the default association route table. Valid values: `disable`, `enable`. Default value: `enable`.
    */
  val defaultRouteTableAssociation: Output[js.UndefOr[String]] = js.native
  /**
    * Whether resource attachments automatically propagate routes to the default propagation route table. Valid values: `disable`, `enable`. Default value: `enable`.
    */
  val defaultRouteTablePropagation: Output[js.UndefOr[String]] = js.native
  /**
  ...
  /**
    ...
    */
  val propagationDefaultRouteTableId: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val vpnEcmpSupport: Output[js.UndefOr[String]] = js.native
}
