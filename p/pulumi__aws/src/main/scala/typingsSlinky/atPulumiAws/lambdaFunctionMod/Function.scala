...
import typingsSlinky.atPulumiAws.iamMod.Role
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.FunctionDeadLetterConfig
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.FunctionEnvironment
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.FunctionTracingConfig
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.FunctionVpcConfig
