...
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.GetFunctionDeadLetterConfig
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.GetFunctionEnvironment
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.GetFunctionTracingConfig
import typingsSlinky.atPulumiAws.typesOutputMod.lambda.GetFunctionVpcConfig
