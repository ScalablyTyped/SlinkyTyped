package typingsSlinky.atPulumiAws.elasticbeanstalkConfigurationTemplateMod

import typingsSlinky.atPulumiAws.typesOutputMod.elasticbeanstalk.ConfigurationTemplateSetting
...
class ConfigurationTemplate protected () extends CustomResource {
  ...
  /**
    ...
    */
  val application: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val environmentId: Output[js.UndefOr[String]] = js.native
  /**
  ...
  /**
    ...
    */
  val solutionStackName: Output[js.UndefOr[String]] = js.native
}
