...
object worklinkMod extends js.Object {
  ...
  class Fleet protected ()
    extends typingsSlinky.atPulumiAws.worklinkFleetMod.Fleet {
    /**
  ...
  class WebsiteCertificateAuthorityAssociation protected ()
    extends typingsSlinky.atPulumiAws.worklinkWebsiteCertificateAuthorityAssociationMod.WebsiteCertificateAuthorityAssociation {
    /**
