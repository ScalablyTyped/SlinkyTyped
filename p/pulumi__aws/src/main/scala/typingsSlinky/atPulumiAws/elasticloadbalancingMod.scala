...
object elasticloadbalancingMod extends js.Object {
  ...
  class AppCookieStickinessPolicy protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingAppCookieStickinessPolicyMod.AppCookieStickinessPolicy {
    /**
  ...
  class Attachment protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingAttachmentMod.Attachment {
    /**
  ...
  class ListenerPolicy protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingListenerPolicyMod.ListenerPolicy {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingLoadBalancerMod.LoadBalancer {
    /**
  ...
  class LoadBalancerBackendServerPolicy protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingLoadBalancerBackendServerPolicyMod.LoadBalancerBackendServerPolicy {
    /**
  ...
  class LoadBalancerCookieStickinessPolicy protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingLoadBalancerCookieStickinessPolicyMod.LoadBalancerCookieStickinessPolicy {
    /**
  ...
  class LoadBalancerPolicy protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingLoadBalancerPolicyMod.LoadBalancerPolicy {
    /**
  ...
  class SslNegotiationPolicy protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingSslNegotiationPolicyMod.SslNegotiationPolicy {
    /**
