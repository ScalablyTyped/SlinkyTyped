...
import typingsSlinky.atPulumiAws.shieldProtectionMod.ProtectionArgs
import typingsSlinky.atPulumiAws.shieldProtectionMod.ProtectionState
...
object shieldMod extends js.Object {
  ...
  class Protection protected ()
    extends typingsSlinky.atPulumiAws.shieldProtectionMod.Protection {
    /**
  ...
  object Protection extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.shieldProtectionMod.Protection = js.native
    def get(name: String, id: Input[ID], state: ProtectionState): typingsSlinky.atPulumiAws.shieldProtectionMod.Protection = js.native
    def get(name: String, id: Input[ID], state: ProtectionState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.shieldProtectionMod.Protection = js.native
    /**
