...
import typingsSlinky.atPulumiAws.kinesisKinesisMixinsMod.StreamEventSubscription
...
class Stream protected () extends CustomResource {
  ...
  /**
    ...
    */
  val encryptionType: Output[js.UndefOr[String]] = js.native
  /**
    * A boolean that indicates all registered consumers should be deregistered from the stream so that the stream can be destroyed without error. The default value is `false`.
    */
  val enforceConsumerDeletion: Output[js.UndefOr[Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val retentionPeriod: Output[js.UndefOr[Double]] = js.native
  /**
    ...
    */
  val shardCount: Output[Double] = js.native
  /**
    ...
    */
  val shardLevelMetrics: Output[js.UndefOr[js.Array[String]]] = js.native
  /**
