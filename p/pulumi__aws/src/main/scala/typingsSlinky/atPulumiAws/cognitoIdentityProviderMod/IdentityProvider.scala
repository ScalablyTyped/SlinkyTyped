...
class IdentityProvider protected () extends CustomResource {
  ...
  /**
    ...
    */
  val attributeMapping: Output[js.UndefOr[StringDictionary[_]]] = js.native
  /**
    * The list of identity providers.
    */
  val idpIdentifiers: Output[js.UndefOr[js.Array[String]]] = js.native
  /**
    * The map of identity details, such as access token
    */
  val providerDetails: Output[StringDictionary[_]] = js.native
  /**
    * The provider name
    */
  val providerName: Output[String] = js.native
  /**
    * The provider type.  [See AWS API for valid values](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_CreateIdentityProvider.html#CognitoUserPools-CreateIdentityProvider-request-ProviderType)
    */
  val providerType: Output[String] = js.native
  /**
    * The user pool id
    */
