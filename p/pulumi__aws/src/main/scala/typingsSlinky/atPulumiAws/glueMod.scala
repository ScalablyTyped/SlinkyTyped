...
object glueMod extends js.Object {
  ...
  class CatalogDatabase protected ()
    extends typingsSlinky.atPulumiAws.glueCatalogDatabaseMod.CatalogDatabase {
    /**
  ...
  class CatalogTable protected ()
    extends typingsSlinky.atPulumiAws.glueCatalogTableMod.CatalogTable {
    /**
  ...
  class Classifier protected ()
    extends typingsSlinky.atPulumiAws.glueClassifierMod.Classifier {
    /**
  ...
  class Connection protected ()
    extends typingsSlinky.atPulumiAws.glueConnectionMod.Connection {
    /**
  ...
  class Crawler protected ()
    extends typingsSlinky.atPulumiAws.glueCrawlerMod.Crawler {
    /**
  ...
  @js.native
  class Job protected ()
    extends typingsSlinky.atPulumiAws.glueJobMod.Job {
    /**
  ...
  class SecurityConfiguration protected ()
    extends typingsSlinky.atPulumiAws.glueSecurityConfigurationMod.SecurityConfiguration {
    /**
  ...
  class Trigger protected ()
    extends typingsSlinky.atPulumiAws.glueTriggerMod.Trigger {
    /**
  ...
  class Workflow protected ()
    extends typingsSlinky.atPulumiAws.glueWorkflowMod.Workflow {
    /**
