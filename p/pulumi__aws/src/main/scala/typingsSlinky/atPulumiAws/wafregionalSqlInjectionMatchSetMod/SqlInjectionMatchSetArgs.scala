package typingsSlinky.atPulumiAws.wafregionalSqlInjectionMatchSetMod

import typingsSlinky.atPulumiAws.typesInputMod.wafregional.SqlInjectionMatchSetSqlInjectionMatchTuple
