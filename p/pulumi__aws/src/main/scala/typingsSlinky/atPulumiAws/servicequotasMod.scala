...
import typingsSlinky.atPulumiAws.servicequotasGetServiceMod.GetServiceArgs
import typingsSlinky.atPulumiAws.servicequotasGetServiceMod.GetServiceResult
import typingsSlinky.atPulumiAws.servicequotasGetServiceQuotaMod.GetServiceQuotaArgs
import typingsSlinky.atPulumiAws.servicequotasGetServiceQuotaMod.GetServiceQuotaResult
import typingsSlinky.atPulumiAws.servicequotasServiceQuotaMod.ServiceQuotaArgs
import typingsSlinky.atPulumiAws.servicequotasServiceQuotaMod.ServiceQuotaState
...
object servicequotasMod extends js.Object {
  ...
  class ServiceQuota protected ()
    extends typingsSlinky.atPulumiAws.servicequotasServiceQuotaMod.ServiceQuota {
    /**
  ...
  object ServiceQuota extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.servicequotasServiceQuotaMod.ServiceQuota = js.native
    def get(name: String, id: Input[ID], state: ServiceQuotaState): typingsSlinky.atPulumiAws.servicequotasServiceQuotaMod.ServiceQuota = js.native
    def get(name: String, id: Input[ID], state: ServiceQuotaState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.servicequotasServiceQuotaMod.ServiceQuota = js.native
    /**
