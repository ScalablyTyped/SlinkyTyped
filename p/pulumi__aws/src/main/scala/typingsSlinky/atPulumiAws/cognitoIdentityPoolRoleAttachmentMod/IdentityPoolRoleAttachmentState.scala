...
import typingsSlinky.atPulumiAws.typesInputMod.cognito.IdentityPoolRoleAttachmentRoleMapping
import typingsSlinky.atPulumiAws.typesInputMod.cognito.IdentityPoolRoleAttachmentRoles
