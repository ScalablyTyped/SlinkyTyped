package typingsSlinky.atPulumiAws.cognitoIdentityPoolRoleAttachmentMod

import typingsSlinky.atPulumiAws.typesOutputMod.cognito.IdentityPoolRoleAttachmentRoleMapping
import typingsSlinky.atPulumiAws.typesOutputMod.cognito.IdentityPoolRoleAttachmentRoles
