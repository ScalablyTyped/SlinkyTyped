package typingsSlinky.atPulumiAws.applicationloadbalancingGetListenerMod

import typingsSlinky.atPulumiAws.typesOutputMod.applicationloadbalancing.GetListenerDefaultAction
