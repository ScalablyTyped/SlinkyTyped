...
object directoryserviceMod extends js.Object {
  ...
  class ConditionalForwader protected ()
    extends typingsSlinky.atPulumiAws.directoryserviceConditionalForwaderMod.ConditionalForwader {
    /**
  ...
  class Directory protected ()
    extends typingsSlinky.atPulumiAws.directoryserviceDirectoryMod.Directory {
    /**
  ...
  class LogService protected ()
    extends typingsSlinky.atPulumiAws.directoryserviceLogServiceMod.LogService {
    /**
