...
import typingsSlinky.atPulumiAws.typesOutputMod.ec2clientvpn.EndpointAuthenticationOptions
import typingsSlinky.atPulumiAws.typesOutputMod.ec2clientvpn.EndpointConnectionLogOptions
