package typingsSlinky.atPulumiAws.lbTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesOutputMod.lb.TargetGroupHealthCheck
import typingsSlinky.atPulumiAws.typesOutputMod.lb.TargetGroupStickiness
