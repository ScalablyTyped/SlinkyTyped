...
object ebsMod extends js.Object {
  ...
  class DefaultKmsKey protected ()
    extends typingsSlinky.atPulumiAws.ebsDefaultKmsKeyMod.DefaultKmsKey {
    /**
  ...
  class EncryptionByDefault protected ()
    extends typingsSlinky.atPulumiAws.ebsEncryptionByDefaultMod.EncryptionByDefault {
    /**
  ...
  class Snapshot protected ()
    extends typingsSlinky.atPulumiAws.ebsSnapshotMod.Snapshot {
    /**
  ...
  class SnapshotCopy protected ()
    extends typingsSlinky.atPulumiAws.ebsSnapshotCopyMod.SnapshotCopy {
    /**
  ...
  class Volume protected ()
    extends typingsSlinky.atPulumiAws.ebsVolumeMod.Volume {
    /**
