...
import typingsSlinky.atPulumiAws.rdsRoleAssociationMod.RoleAssociationArgs
import typingsSlinky.atPulumiAws.rdsRoleAssociationMod.RoleAssociationState
...
class RoleAssociation protected ()
  extends typingsSlinky.atPulumiAws.rdsRoleAssociationMod.RoleAssociation {
  /**
...
object RoleAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.rdsRoleAssociationMod.RoleAssociation = js.native
  def get(name: String, id: Input[ID], state: RoleAssociationState): typingsSlinky.atPulumiAws.rdsRoleAssociationMod.RoleAssociation = js.native
  def get(name: String, id: Input[ID], state: RoleAssociationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.rdsRoleAssociationMod.RoleAssociation = js.native
  /**
