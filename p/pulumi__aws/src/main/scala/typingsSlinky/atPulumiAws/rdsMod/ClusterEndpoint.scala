...
import typingsSlinky.atPulumiAws.rdsClusterEndpointMod.ClusterEndpointArgs
import typingsSlinky.atPulumiAws.rdsClusterEndpointMod.ClusterEndpointState
...
class ClusterEndpoint protected ()
  extends typingsSlinky.atPulumiAws.rdsClusterEndpointMod.ClusterEndpoint {
  /**
...
object ClusterEndpoint extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.rdsClusterEndpointMod.ClusterEndpoint = js.native
  def get(name: String, id: Input[ID], state: ClusterEndpointState): typingsSlinky.atPulumiAws.rdsClusterEndpointMod.ClusterEndpoint = js.native
  def get(name: String, id: Input[ID], state: ClusterEndpointState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.rdsClusterEndpointMod.ClusterEndpoint = js.native
  /**
