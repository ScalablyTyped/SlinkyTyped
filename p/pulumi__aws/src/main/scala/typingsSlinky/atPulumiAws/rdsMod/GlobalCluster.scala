...
import typingsSlinky.atPulumiAws.rdsGlobalClusterMod.GlobalClusterArgs
import typingsSlinky.atPulumiAws.rdsGlobalClusterMod.GlobalClusterState
...
class GlobalCluster protected ()
  extends typingsSlinky.atPulumiAws.rdsGlobalClusterMod.GlobalCluster {
  /**
...
object GlobalCluster extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.rdsGlobalClusterMod.GlobalCluster = js.native
  def get(name: String, id: Input[ID], state: GlobalClusterState): typingsSlinky.atPulumiAws.rdsGlobalClusterMod.GlobalCluster = js.native
  def get(name: String, id: Input[ID], state: GlobalClusterState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.rdsGlobalClusterMod.GlobalCluster = js.native
  /**
