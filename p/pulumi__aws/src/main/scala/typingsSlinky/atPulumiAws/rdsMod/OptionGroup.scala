...
import typingsSlinky.atPulumiAws.rdsOptionGroupMod.OptionGroupArgs
import typingsSlinky.atPulumiAws.rdsOptionGroupMod.OptionGroupState
...
class OptionGroup protected ()
  extends typingsSlinky.atPulumiAws.rdsOptionGroupMod.OptionGroup {
  /**
...
object OptionGroup extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.rdsOptionGroupMod.OptionGroup = js.native
  def get(name: String, id: Input[ID], state: OptionGroupState): typingsSlinky.atPulumiAws.rdsOptionGroupMod.OptionGroup = js.native
  def get(name: String, id: Input[ID], state: OptionGroupState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.rdsOptionGroupMod.OptionGroup = js.native
  /**
