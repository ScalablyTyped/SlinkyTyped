...
import typingsSlinky.atPulumiAws.typesOutputMod.mediaconvert.QueueReservationPlanSettings
...
class Queue protected () extends CustomResource {
  ...
  /**
    ...
    */
  val pricingPlan: Output[js.UndefOr[String]] = js.native
  /**
    * A detail pricing plan of the  reserved queue. See below.
    */
  val reservationPlanSettings: Output[QueueReservationPlanSettings] = js.native
  /**
    * A status of the queue. Valid values are `ACTIVE` or `RESERVED`. Default to `PAUSED`.
    */
  val status: Output[js.UndefOr[String]] = js.native
  /**
