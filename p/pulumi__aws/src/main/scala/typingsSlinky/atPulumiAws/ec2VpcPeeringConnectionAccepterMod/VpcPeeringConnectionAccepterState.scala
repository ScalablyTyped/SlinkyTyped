...
import typingsSlinky.atPulumiAws.typesInputMod.ec2.VpcPeeringConnectionAccepterAccepter
import typingsSlinky.atPulumiAws.typesInputMod.ec2.VpcPeeringConnectionAccepterRequester
