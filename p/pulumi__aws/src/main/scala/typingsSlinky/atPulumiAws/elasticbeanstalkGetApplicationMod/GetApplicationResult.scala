package typingsSlinky.atPulumiAws.elasticbeanstalkGetApplicationMod

import typingsSlinky.atPulumiAws.typesOutputMod.elasticbeanstalk.GetApplicationAppversionLifecycle
