...
import typingsSlinky.atPulumiAws.dynamodbDynamodbMixinsMod.TableEventSubscription
import typingsSlinky.atPulumiAws.dynamodbDynamodbMixinsMod.TableEventSubscriptionArgs
import typingsSlinky.atPulumiAws.typesOutputMod.dynamodb.TableAttribute
import typingsSlinky.atPulumiAws.typesOutputMod.dynamodb.TableGlobalSecondaryIndex
import typingsSlinky.atPulumiAws.typesOutputMod.dynamodb.TableLocalSecondaryIndex
import typingsSlinky.atPulumiAws.typesOutputMod.dynamodb.TablePointInTimeRecovery
import typingsSlinky.atPulumiAws.typesOutputMod.dynamodb.TableServerSideEncryption
import typingsSlinky.atPulumiAws.typesOutputMod.dynamodb.TableTtl
