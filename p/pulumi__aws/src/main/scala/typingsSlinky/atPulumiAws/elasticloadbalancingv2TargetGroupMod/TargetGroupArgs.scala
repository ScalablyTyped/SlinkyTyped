...
import typingsSlinky.atPulumiAws.typesInputMod.elasticloadbalancingv2.TargetGroupHealthCheck
import typingsSlinky.atPulumiAws.typesInputMod.elasticloadbalancingv2.TargetGroupStickiness
