...
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CrawlerCatalogTarget
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CrawlerDynamodbTarget
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CrawlerJdbcTarget
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CrawlerS3Target
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CrawlerSchemaChangePolicy
...
class Crawler protected () extends CustomResource {
  ...
  /**
    ...
    */
  val classifiers: Output[js.UndefOr[js.Array[String]]] = js.native
  /**
