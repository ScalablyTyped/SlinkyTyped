...
import typingsSlinky.atPulumiAws.typesOutputMod.ec2.AmiCopyEbsBlockDevice
import typingsSlinky.atPulumiAws.typesOutputMod.ec2.AmiCopyEphemeralBlockDevice
