...
import typingsSlinky.atPulumiAws.lambdaLambdaMixinsMod.Callback
...
object serverlessFunctionMod extends js.Object {
  ...
  class Function protected ()
    ...
    val lambda: typingsSlinky.atPulumiAws.lambdaMod.Function = js.native
    val options: FunctionOptions = js.native
    val role: js.UndefOr[Role] = js.native
  }
  
  type Context = typingsSlinky.atPulumiAws.lambdaLambdaMixinsMod.Context
