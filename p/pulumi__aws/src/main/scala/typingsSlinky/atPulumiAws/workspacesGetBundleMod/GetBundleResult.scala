...
import typingsSlinky.atPulumiAws.typesOutputMod.workspaces.GetBundleComputeType
import typingsSlinky.atPulumiAws.typesOutputMod.workspaces.GetBundleRootStorage
import typingsSlinky.atPulumiAws.typesOutputMod.workspaces.GetBundleUserStorage
