...
import typingsSlinky.atPulumiAws.ecsContainerMod.KernelCapability
import typingsSlinky.atPulumiAws.ecsContainerMod.LogDriver
import typingsSlinky.atPulumiAws.ecsContainerMod.Protocol
import typingsSlinky.atPulumiAws.ecsContainerMod.UlimitName
...
object atPulumiAwsStrings {
  ...
  sealed trait application
    extends LoadBalancerType
       with typingsSlinky.atPulumiAws.albLoadBalancerTypeMod.LoadBalancerType
  ...
  sealed trait dbDotm1Dotlarge
    extends typingsSlinky.atPulumiAws.rdsInstanceTypeMod.InstanceType
  ...
  sealed trait dualstack
    extends IpAddressType
       with typingsSlinky.atPulumiAws.albIpAddressTypeMod.IpAddressType
