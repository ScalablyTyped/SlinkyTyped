...
import typingsSlinky.atPulumiAws.apigatewayUsagePlanKeyMod.UsagePlanKeyArgs
import typingsSlinky.atPulumiAws.apigatewayUsagePlanKeyMod.UsagePlanKeyState
...
class UsagePlanKey protected ()
  extends typingsSlinky.atPulumiAws.apigatewayUsagePlanKeyMod.UsagePlanKey {
  /**
...
object UsagePlanKey extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayUsagePlanKeyMod.UsagePlanKey = js.native
  def get(name: String, id: Input[ID], state: UsagePlanKeyState): typingsSlinky.atPulumiAws.apigatewayUsagePlanKeyMod.UsagePlanKey = js.native
  def get(name: String, id: Input[ID], state: UsagePlanKeyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayUsagePlanKeyMod.UsagePlanKey = js.native
  /**
