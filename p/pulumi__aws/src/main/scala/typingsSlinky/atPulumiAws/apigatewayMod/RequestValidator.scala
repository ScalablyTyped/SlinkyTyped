...
import typingsSlinky.atPulumiAws.apigatewayRequestValidatorMod.RequestValidatorArgs
import typingsSlinky.atPulumiAws.apigatewayRequestValidatorMod.RequestValidatorState
...
class RequestValidator protected ()
  extends typingsSlinky.atPulumiAws.apigatewayRequestValidatorMod.RequestValidator {
  /**
...
object RequestValidator extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayRequestValidatorMod.RequestValidator = js.native
  def get(name: String, id: Input[ID], state: RequestValidatorState): typingsSlinky.atPulumiAws.apigatewayRequestValidatorMod.RequestValidator = js.native
  def get(name: String, id: Input[ID], state: RequestValidatorState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayRequestValidatorMod.RequestValidator = js.native
  /**
