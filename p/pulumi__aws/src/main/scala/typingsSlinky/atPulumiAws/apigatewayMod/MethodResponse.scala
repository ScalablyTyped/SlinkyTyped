...
import typingsSlinky.atPulumiAws.apigatewayMethodResponseMod.MethodResponseArgs
import typingsSlinky.atPulumiAws.apigatewayMethodResponseMod.MethodResponseState
...
class MethodResponse protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMethodResponseMod.MethodResponse {
  /**
...
object MethodResponse extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayMethodResponseMod.MethodResponse = js.native
  def get(name: String, id: Input[ID], state: MethodResponseState): typingsSlinky.atPulumiAws.apigatewayMethodResponseMod.MethodResponse = js.native
  def get(name: String, id: Input[ID], state: MethodResponseState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayMethodResponseMod.MethodResponse = js.native
  /**
