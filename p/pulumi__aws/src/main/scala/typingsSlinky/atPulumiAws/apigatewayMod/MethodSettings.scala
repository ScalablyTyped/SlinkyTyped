...
import typingsSlinky.atPulumiAws.apigatewayMethodSettingsMod.MethodSettingsArgs
import typingsSlinky.atPulumiAws.apigatewayMethodSettingsMod.MethodSettingsState
...
class MethodSettings protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMethodSettingsMod.MethodSettings {
  /**
...
object MethodSettings extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayMethodSettingsMod.MethodSettings = js.native
  def get(name: String, id: Input[ID], state: MethodSettingsState): typingsSlinky.atPulumiAws.apigatewayMethodSettingsMod.MethodSettings = js.native
  def get(name: String, id: Input[ID], state: MethodSettingsState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayMethodSettingsMod.MethodSettings = js.native
  /**
