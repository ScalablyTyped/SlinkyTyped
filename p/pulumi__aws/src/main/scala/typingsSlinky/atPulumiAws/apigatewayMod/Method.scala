...
import typingsSlinky.atPulumiAws.apigatewayMethodMod.MethodArgs
import typingsSlinky.atPulumiAws.apigatewayMethodMod.MethodState
...
class Method protected ()
  extends typingsSlinky.atPulumiAws.apigatewayMethodMod.Method {
  /**
...
object Method extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayMethodMod.Method = js.native
  def get(name: String, id: Input[ID], state: MethodState): typingsSlinky.atPulumiAws.apigatewayMethodMod.Method = js.native
  def get(name: String, id: Input[ID], state: MethodState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayMethodMod.Method = js.native
  /**
