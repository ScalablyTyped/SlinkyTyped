...
import typingsSlinky.atPulumiAws.apigatewayRestApiMod.RestApiArgs
import typingsSlinky.atPulumiAws.apigatewayRestApiMod.RestApiState
...
class RestApi protected ()
  extends typingsSlinky.atPulumiAws.apigatewayRestApiMod.RestApi {
  /**
...
object RestApi extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayRestApiMod.RestApi = js.native
  def get(name: String, id: Input[ID], state: RestApiState): typingsSlinky.atPulumiAws.apigatewayRestApiMod.RestApi = js.native
  def get(name: String, id: Input[ID], state: RestApiState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayRestApiMod.RestApi = js.native
  /**
