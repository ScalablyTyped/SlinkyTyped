...
import typingsSlinky.atPulumiAws.apigatewayVpcLinkMod.VpcLinkArgs
import typingsSlinky.atPulumiAws.apigatewayVpcLinkMod.VpcLinkState
...
class VpcLink protected ()
  extends typingsSlinky.atPulumiAws.apigatewayVpcLinkMod.VpcLink {
  /**
...
object VpcLink extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.apigatewayVpcLinkMod.VpcLink = js.native
  def get(name: String, id: Input[ID], state: VpcLinkState): typingsSlinky.atPulumiAws.apigatewayVpcLinkMod.VpcLink = js.native
  def get(name: String, id: Input[ID], state: VpcLinkState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.apigatewayVpcLinkMod.VpcLink = js.native
  /**
