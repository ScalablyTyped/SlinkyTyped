...
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CatalogTablePartitionKey
import typingsSlinky.atPulumiAws.typesOutputMod.glue.CatalogTableStorageDescriptor
