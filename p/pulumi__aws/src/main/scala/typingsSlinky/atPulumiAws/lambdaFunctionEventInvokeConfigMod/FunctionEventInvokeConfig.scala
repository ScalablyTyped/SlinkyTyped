package typingsSlinky.atPulumiAws.lambdaFunctionEventInvokeConfigMod

import typingsSlinky.atPulumiAws.typesOutputMod.lambda.FunctionEventInvokeConfigDestinationConfig
