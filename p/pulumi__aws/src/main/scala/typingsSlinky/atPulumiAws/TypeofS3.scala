...
import typingsSlinky.awsDashSdk.awsDashSdkMod.S3.PresignedPost
...
trait TypeofS3 extends js.Object {
  ...
  val PresignedPost: Instantiable0[typingsSlinky.awsDashSdk.awsDashSdkMod.S3.PresignedPost] = js.native
