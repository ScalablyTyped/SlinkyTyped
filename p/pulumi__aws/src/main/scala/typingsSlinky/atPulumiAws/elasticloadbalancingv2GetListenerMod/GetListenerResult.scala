package typingsSlinky.atPulumiAws.elasticloadbalancingv2GetListenerMod

import typingsSlinky.atPulumiAws.typesOutputMod.elasticloadbalancingv2.GetListenerDefaultAction
