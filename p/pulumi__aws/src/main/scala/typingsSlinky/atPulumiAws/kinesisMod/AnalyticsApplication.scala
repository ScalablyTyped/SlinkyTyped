...
import typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod.AnalyticsApplicationArgs
import typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod.AnalyticsApplicationState
...
class AnalyticsApplication protected ()
  extends typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod.AnalyticsApplication {
  /**
...
object AnalyticsApplication extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod.AnalyticsApplication = js.native
  def get(name: String, id: Input[ID], state: AnalyticsApplicationState): typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod.AnalyticsApplication = js.native
  def get(name: String, id: Input[ID], state: AnalyticsApplicationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod.AnalyticsApplication = js.native
  /**
