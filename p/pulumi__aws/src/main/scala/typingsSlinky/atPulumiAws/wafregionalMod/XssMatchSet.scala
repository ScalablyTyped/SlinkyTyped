...
import typingsSlinky.atPulumiAws.wafregionalXssMatchSetMod.XssMatchSetArgs
import typingsSlinky.atPulumiAws.wafregionalXssMatchSetMod.XssMatchSetState
...
class XssMatchSet protected ()
  extends typingsSlinky.atPulumiAws.wafregionalXssMatchSetMod.XssMatchSet {
  /**
...
object XssMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.wafregionalXssMatchSetMod.XssMatchSet = js.native
  def get(name: String, id: Input[ID], state: XssMatchSetState): typingsSlinky.atPulumiAws.wafregionalXssMatchSetMod.XssMatchSet = js.native
  def get(name: String, id: Input[ID], state: XssMatchSetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.wafregionalXssMatchSetMod.XssMatchSet = js.native
  /**
