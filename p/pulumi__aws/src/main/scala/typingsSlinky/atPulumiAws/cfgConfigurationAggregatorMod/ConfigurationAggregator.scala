...
import typingsSlinky.atPulumiAws.typesOutputMod.cfg.ConfigurationAggregatorAccountAggregationSource
import typingsSlinky.atPulumiAws.typesOutputMod.cfg.ConfigurationAggregatorOrganizationAggregationSource
