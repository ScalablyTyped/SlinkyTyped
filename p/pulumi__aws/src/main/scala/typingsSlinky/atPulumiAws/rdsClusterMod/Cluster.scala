package typingsSlinky.atPulumiAws.rdsClusterMod
...
import typingsSlinky.atPulumiAws.typesOutputMod.rds.ClusterS3Import
import typingsSlinky.atPulumiAws.typesOutputMod.rds.ClusterScalingConfiguration
