...
import typingsSlinky.atPulumiAws.typesOutputMod.directoryservice.DirectoryConnectSettings
import typingsSlinky.atPulumiAws.typesOutputMod.directoryservice.DirectoryVpcSettings
