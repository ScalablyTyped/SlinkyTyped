...
object elasticbeanstalkMod extends js.Object {
  ...
  class Application protected ()
    extends typingsSlinky.atPulumiAws.elasticbeanstalkApplicationMod.Application {
    /**
  ...
  class ApplicationVersion protected ()
    extends typingsSlinky.atPulumiAws.elasticbeanstalkApplicationVersionMod.ApplicationVersion {
    /**
  ...
  class ConfigurationTemplate protected ()
    extends typingsSlinky.atPulumiAws.elasticbeanstalkConfigurationTemplateMod.ConfigurationTemplate {
    /**
  ...
  class Environment protected ()
    extends typingsSlinky.atPulumiAws.elasticbeanstalkEnvironmentMod.Environment {
    /**
