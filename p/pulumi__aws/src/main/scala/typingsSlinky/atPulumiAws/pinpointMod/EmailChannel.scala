...
import typingsSlinky.atPulumiAws.pinpointEmailChannelMod.EmailChannelArgs
import typingsSlinky.atPulumiAws.pinpointEmailChannelMod.EmailChannelState
...
class EmailChannel protected ()
  extends typingsSlinky.atPulumiAws.pinpointEmailChannelMod.EmailChannel {
  /**
...
object EmailChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointEmailChannelMod.EmailChannel = js.native
  def get(name: String, id: Input[ID], state: EmailChannelState): typingsSlinky.atPulumiAws.pinpointEmailChannelMod.EmailChannel = js.native
  def get(name: String, id: Input[ID], state: EmailChannelState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointEmailChannelMod.EmailChannel = js.native
  /**
