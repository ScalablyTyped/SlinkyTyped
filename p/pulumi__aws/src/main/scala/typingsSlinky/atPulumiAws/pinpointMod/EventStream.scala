...
import typingsSlinky.atPulumiAws.pinpointEventStreamMod.EventStreamArgs
import typingsSlinky.atPulumiAws.pinpointEventStreamMod.EventStreamState
...
class EventStream protected ()
  extends typingsSlinky.atPulumiAws.pinpointEventStreamMod.EventStream {
  /**
...
object EventStream extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointEventStreamMod.EventStream = js.native
  def get(name: String, id: Input[ID], state: EventStreamState): typingsSlinky.atPulumiAws.pinpointEventStreamMod.EventStream = js.native
  def get(name: String, id: Input[ID], state: EventStreamState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointEventStreamMod.EventStream = js.native
  /**
