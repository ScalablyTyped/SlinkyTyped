...
import typingsSlinky.atPulumiAws.pinpointApnsSandboxChannelMod.ApnsSandboxChannelArgs
import typingsSlinky.atPulumiAws.pinpointApnsSandboxChannelMod.ApnsSandboxChannelState
...
class ApnsSandboxChannel protected ()
  extends typingsSlinky.atPulumiAws.pinpointApnsSandboxChannelMod.ApnsSandboxChannel {
  /**
...
object ApnsSandboxChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointApnsSandboxChannelMod.ApnsSandboxChannel = js.native
  def get(name: String, id: Input[ID], state: ApnsSandboxChannelState): typingsSlinky.atPulumiAws.pinpointApnsSandboxChannelMod.ApnsSandboxChannel = js.native
  def get(name: String, id: Input[ID], state: ApnsSandboxChannelState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointApnsSandboxChannelMod.ApnsSandboxChannel = js.native
  /**
