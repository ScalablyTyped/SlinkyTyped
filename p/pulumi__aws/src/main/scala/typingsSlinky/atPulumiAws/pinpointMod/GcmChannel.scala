...
import typingsSlinky.atPulumiAws.pinpointGcmChannelMod.GcmChannelArgs
import typingsSlinky.atPulumiAws.pinpointGcmChannelMod.GcmChannelState
...
class GcmChannel protected ()
  extends typingsSlinky.atPulumiAws.pinpointGcmChannelMod.GcmChannel {
  /**
...
object GcmChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointGcmChannelMod.GcmChannel = js.native
  def get(name: String, id: Input[ID], state: GcmChannelState): typingsSlinky.atPulumiAws.pinpointGcmChannelMod.GcmChannel = js.native
  def get(name: String, id: Input[ID], state: GcmChannelState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointGcmChannelMod.GcmChannel = js.native
  /**
