...
import typingsSlinky.atPulumiAws.pinpointApnsChannelMod.ApnsChannelArgs
import typingsSlinky.atPulumiAws.pinpointApnsChannelMod.ApnsChannelState
...
class ApnsChannel protected ()
  extends typingsSlinky.atPulumiAws.pinpointApnsChannelMod.ApnsChannel {
  /**
...
object ApnsChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.pinpointApnsChannelMod.ApnsChannel = js.native
  def get(name: String, id: Input[ID], state: ApnsChannelState): typingsSlinky.atPulumiAws.pinpointApnsChannelMod.ApnsChannel = js.native
  def get(name: String, id: Input[ID], state: ApnsChannelState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.pinpointApnsChannelMod.ApnsChannel = js.native
  /**
