...
import typingsSlinky.atPulumiAws.typesOutputMod.appautoscaling.PolicyStepScalingPolicyConfiguration
import typingsSlinky.atPulumiAws.typesOutputMod.appautoscaling.PolicyTargetTrackingScalingPolicyConfiguration
