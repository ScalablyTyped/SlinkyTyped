package typingsSlinky.atPulumiAws.appautoscalingPolicyMod

import typingsSlinky.atPulumiAws.typesInputMod.appautoscaling.PolicyStepScalingPolicyConfiguration
import typingsSlinky.atPulumiAws.typesInputMod.appautoscaling.PolicyTargetTrackingScalingPolicyConfiguration
