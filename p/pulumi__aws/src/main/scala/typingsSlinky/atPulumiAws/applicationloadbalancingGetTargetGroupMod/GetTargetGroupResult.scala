...
import typingsSlinky.atPulumiAws.typesOutputMod.applicationloadbalancing.GetTargetGroupHealthCheck
import typingsSlinky.atPulumiAws.typesOutputMod.applicationloadbalancing.GetTargetGroupStickiness
