...
import typingsSlinky.atPulumiAws.xraySamplingRuleMod.SamplingRuleArgs
import typingsSlinky.atPulumiAws.xraySamplingRuleMod.SamplingRuleState
...
object xrayMod extends js.Object {
  ...
  class SamplingRule protected ()
    extends typingsSlinky.atPulumiAws.xraySamplingRuleMod.SamplingRule {
    /**
  ...
  object SamplingRule extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.xraySamplingRuleMod.SamplingRule = js.native
    def get(name: String, id: Input[ID], state: SamplingRuleState): typingsSlinky.atPulumiAws.xraySamplingRuleMod.SamplingRule = js.native
    def get(name: String, id: Input[ID], state: SamplingRuleState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.xraySamplingRuleMod.SamplingRule = js.native
    /**
