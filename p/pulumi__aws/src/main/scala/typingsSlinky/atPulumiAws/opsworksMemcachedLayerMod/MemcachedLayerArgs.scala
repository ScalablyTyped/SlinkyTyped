package typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod

import typingsSlinky.atPulumiAws.typesInputMod.opsworks.MemcachedLayerEbsVolume
...
object MemcachedLayerArgs {
  ...
  def apply(
    ...
    ebsVolumes: Input[js.Array[Input[MemcachedLayerEbsVolume]]] = null,
