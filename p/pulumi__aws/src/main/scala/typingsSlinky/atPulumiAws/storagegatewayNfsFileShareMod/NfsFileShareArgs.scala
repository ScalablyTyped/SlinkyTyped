package typingsSlinky.atPulumiAws.storagegatewayNfsFileShareMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesInputMod.storagegateway.NfsFileShareNfsFileShareDefaults
