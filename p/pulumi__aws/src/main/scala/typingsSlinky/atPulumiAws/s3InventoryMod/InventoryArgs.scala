...
import typingsSlinky.atPulumiAws.typesInputMod.s3.InventoryDestination
import typingsSlinky.atPulumiAws.typesInputMod.s3.InventoryFilter
import typingsSlinky.atPulumiAws.typesInputMod.s3.InventorySchedule
