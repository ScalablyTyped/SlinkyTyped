package typingsSlinky.atPulumiAws.dynamodbMod

import typingsSlinky.atPulumiAws.dynamodbGetTableMod.GetTableArgs
import typingsSlinky.atPulumiAws.dynamodbGetTableMod.GetTableResult
