package typingsSlinky.atPulumiAws.autoscalingScheduleMod
...
class Schedule protected () extends CustomResource {
  ...
  /**
    ...
    */
  val endTime: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val recurrence: Output[String] = js.native
  /**
    * The name of this scaling action.
    */
  val scheduledActionName: Output[String] = js.native
  /**
    * The time for this action to start, in "YYYY-MM-DDThh:mm:ssZ" format in UTC/GMT only (for example, 2014-06-01T00:00:00Z ).
    * If you try to schedule your action in the past, Auto Scaling returns an error message.
    */
  val startTime: Output[String] = js.native
}
