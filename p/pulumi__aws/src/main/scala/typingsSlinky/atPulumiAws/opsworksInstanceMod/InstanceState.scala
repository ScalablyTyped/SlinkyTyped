...
import typingsSlinky.atPulumiAws.typesInputMod.opsworks.InstanceEbsBlockDevice
import typingsSlinky.atPulumiAws.typesInputMod.opsworks.InstanceEphemeralBlockDevice
import typingsSlinky.atPulumiAws.typesInputMod.opsworks.InstanceRootBlockDevice
