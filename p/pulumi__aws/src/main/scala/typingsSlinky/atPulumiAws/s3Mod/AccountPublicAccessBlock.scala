...
import typingsSlinky.atPulumiAws.s3AccountPublicAccessBlockMod.AccountPublicAccessBlockArgs
import typingsSlinky.atPulumiAws.s3AccountPublicAccessBlockMod.AccountPublicAccessBlockState
...
class AccountPublicAccessBlock protected ()
  extends typingsSlinky.atPulumiAws.s3AccountPublicAccessBlockMod.AccountPublicAccessBlock {
  /**
...
object AccountPublicAccessBlock extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.s3AccountPublicAccessBlockMod.AccountPublicAccessBlock = js.native
  def get(name: String, id: Input[ID], state: AccountPublicAccessBlockState): typingsSlinky.atPulumiAws.s3AccountPublicAccessBlockMod.AccountPublicAccessBlock = js.native
  def get(name: String, id: Input[ID], state: AccountPublicAccessBlockState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.s3AccountPublicAccessBlockMod.AccountPublicAccessBlock = js.native
  /**
