package typingsSlinky.atPulumiAws.iamUserLoginProfileMod
...
class UserLoginProfile protected () extends CustomResource {
  ...
  /**
    ...
    */
  val passwordLength: Output[js.UndefOr[Double]] = js.native
  /**
    * Whether the user should be forced to reset the generated password on resource creation. Only applies on resource creation. Drift detection is not possible with this argument.
    */
  val passwordResetRequired: Output[js.UndefOr[Boolean]] = js.native
  /**
    * Either a base-64 encoded PGP public key, or a keybase username in the form `keybase:username`. Only applies on resource creation. Drift detection is not possible with this argument.
    */
  val pgpKey: Output[String] = js.native
  /**
    * The IAM user's name.
    */
