package typingsSlinky.atPulumiAws.glueSecurityConfigurationMod

import typingsSlinky.atPulumiAws.typesOutputMod.glue.SecurityConfigurationEncryptionConfiguration
