...
import typingsSlinky.atPulumiAws.typesOutputMod.elasticloadbalancing.LoadBalancerAccessLogs
import typingsSlinky.atPulumiAws.typesOutputMod.elasticloadbalancing.LoadBalancerHealthCheck
import typingsSlinky.atPulumiAws.typesOutputMod.elasticloadbalancing.LoadBalancerListener
...
class LoadBalancer protected () extends CustomResource {
  ...
  /**
    ...
    */
  val healthCheck: Output[LoadBalancerHealthCheck] = js.native
  /**
  ...
  /**
    ...
    */
  val listeners: Output[js.Array[LoadBalancerListener]] = js.native
  /**
