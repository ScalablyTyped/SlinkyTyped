...
import typingsSlinky.awsDashSdk.awsDashSdkMod.DynamoDB.DocumentClient
...
trait TypeofDynamoDB extends js.Object {
  ...
  val DocumentClient: Instantiable0[typingsSlinky.awsDashSdk.awsDashSdkMod.DynamoDB.DocumentClient] = js.native
