package typingsSlinky.atPulumiAws.appmeshRouteMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesOutputMod.appmesh.RouteSpec
...
class Route protected () extends CustomResource {
  ...
  /**
    ...
    */
  val virtualRouterName: Output[String] = js.native
}
