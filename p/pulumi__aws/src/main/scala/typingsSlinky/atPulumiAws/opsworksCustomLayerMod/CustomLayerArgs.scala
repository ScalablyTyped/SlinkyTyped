package typingsSlinky.atPulumiAws.opsworksCustomLayerMod

import typingsSlinky.atPulumiAws.typesInputMod.opsworks.CustomLayerEbsVolume
...
trait CustomLayerArgs extends js.Object {
  ...
  /**
    ...
    */
  val ebsVolumes: js.UndefOr[Input[js.Array[Input[CustomLayerEbsVolume]]]] = js.native
  /**
  ...
  /**
    ...
    */
  val shortName: Input[String] = js.native
  /**
