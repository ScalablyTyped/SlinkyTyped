...
import typingsSlinky.atPulumiAws.cloudwatchLogGroupMod.LogGroupArgs
import typingsSlinky.atPulumiAws.cloudwatchLogGroupMod.LogGroupState
...
class LogGroup protected ()
  extends typingsSlinky.atPulumiAws.cloudwatchLogGroupMod.LogGroup {
  /**
...
object LogGroup extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloudwatchLogGroupMod.LogGroup = js.native
  def get(name: String, id: Input[ID], state: LogGroupState): typingsSlinky.atPulumiAws.cloudwatchLogGroupMod.LogGroup = js.native
  def get(name: String, id: Input[ID], state: LogGroupState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloudwatchLogGroupMod.LogGroup = js.native
  /**
