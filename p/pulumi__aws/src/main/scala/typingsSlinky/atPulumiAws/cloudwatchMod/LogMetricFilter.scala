...
import typingsSlinky.atPulumiAws.cloudwatchLogMetricFilterMod.LogMetricFilterArgs
import typingsSlinky.atPulumiAws.cloudwatchLogMetricFilterMod.LogMetricFilterState
...
class LogMetricFilter protected ()
  extends typingsSlinky.atPulumiAws.cloudwatchLogMetricFilterMod.LogMetricFilter {
  /**
...
object LogMetricFilter extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.cloudwatchLogMetricFilterMod.LogMetricFilter = js.native
  def get(name: String, id: Input[ID], state: LogMetricFilterState): typingsSlinky.atPulumiAws.cloudwatchLogMetricFilterMod.LogMetricFilter = js.native
  def get(name: String, id: Input[ID], state: LogMetricFilterState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.cloudwatchLogMetricFilterMod.LogMetricFilter = js.native
  /**
