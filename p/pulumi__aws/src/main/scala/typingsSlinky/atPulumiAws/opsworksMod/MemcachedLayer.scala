...
import typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod.MemcachedLayerArgs
import typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod.MemcachedLayerState
...
class MemcachedLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod.MemcachedLayer {
  /**
...
object MemcachedLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod.MemcachedLayer = js.native
  def get(name: String, id: Input[ID], state: MemcachedLayerState): typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod.MemcachedLayer = js.native
  def get(name: String, id: Input[ID], state: MemcachedLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksMemcachedLayerMod.MemcachedLayer = js.native
  /**
