...
import typingsSlinky.atPulumiAws.opsworksRailsAppLayerMod.RailsAppLayerArgs
import typingsSlinky.atPulumiAws.opsworksRailsAppLayerMod.RailsAppLayerState
...
class RailsAppLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksRailsAppLayerMod.RailsAppLayer {
  /**
...
object RailsAppLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksRailsAppLayerMod.RailsAppLayer = js.native
  def get(name: String, id: Input[ID], state: RailsAppLayerState): typingsSlinky.atPulumiAws.opsworksRailsAppLayerMod.RailsAppLayer = js.native
  def get(name: String, id: Input[ID], state: RailsAppLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksRailsAppLayerMod.RailsAppLayer = js.native
  /**
