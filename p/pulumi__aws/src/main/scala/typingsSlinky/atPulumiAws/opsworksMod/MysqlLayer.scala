...
import typingsSlinky.atPulumiAws.opsworksMysqlLayerMod.MysqlLayerArgs
import typingsSlinky.atPulumiAws.opsworksMysqlLayerMod.MysqlLayerState
...
class MysqlLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksMysqlLayerMod.MysqlLayer {
  /**
...
object MysqlLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksMysqlLayerMod.MysqlLayer = js.native
  def get(name: String, id: Input[ID], state: MysqlLayerState): typingsSlinky.atPulumiAws.opsworksMysqlLayerMod.MysqlLayer = js.native
  def get(name: String, id: Input[ID], state: MysqlLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksMysqlLayerMod.MysqlLayer = js.native
  /**
