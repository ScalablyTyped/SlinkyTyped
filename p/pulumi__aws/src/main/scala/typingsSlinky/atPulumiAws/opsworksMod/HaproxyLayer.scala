...
import typingsSlinky.atPulumiAws.opsworksHaproxyLayerMod.HaproxyLayerArgs
import typingsSlinky.atPulumiAws.opsworksHaproxyLayerMod.HaproxyLayerState
...
class HaproxyLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksHaproxyLayerMod.HaproxyLayer {
  /**
...
object HaproxyLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksHaproxyLayerMod.HaproxyLayer = js.native
  def get(name: String, id: Input[ID], state: HaproxyLayerState): typingsSlinky.atPulumiAws.opsworksHaproxyLayerMod.HaproxyLayer = js.native
  def get(name: String, id: Input[ID], state: HaproxyLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksHaproxyLayerMod.HaproxyLayer = js.native
  /**
