...
import typingsSlinky.atPulumiAws.opsworksCustomLayerMod.CustomLayerArgs
import typingsSlinky.atPulumiAws.opsworksCustomLayerMod.CustomLayerState
...
class CustomLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksCustomLayerMod.CustomLayer {
  /**
...
object CustomLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksCustomLayerMod.CustomLayer = js.native
  def get(name: String, id: Input[ID], state: CustomLayerState): typingsSlinky.atPulumiAws.opsworksCustomLayerMod.CustomLayer = js.native
  def get(name: String, id: Input[ID], state: CustomLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksCustomLayerMod.CustomLayer = js.native
  /**
