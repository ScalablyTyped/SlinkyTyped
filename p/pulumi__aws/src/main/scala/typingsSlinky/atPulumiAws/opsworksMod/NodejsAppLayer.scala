...
import typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod.NodejsAppLayerArgs
import typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod.NodejsAppLayerState
...
class NodejsAppLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod.NodejsAppLayer {
  /**
...
object NodejsAppLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod.NodejsAppLayer = js.native
  def get(name: String, id: Input[ID], state: NodejsAppLayerState): typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod.NodejsAppLayer = js.native
  def get(name: String, id: Input[ID], state: NodejsAppLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod.NodejsAppLayer = js.native
  /**
