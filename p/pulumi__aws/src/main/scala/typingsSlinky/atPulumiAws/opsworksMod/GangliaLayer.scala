...
import typingsSlinky.atPulumiAws.opsworksGangliaLayerMod.GangliaLayerArgs
import typingsSlinky.atPulumiAws.opsworksGangliaLayerMod.GangliaLayerState
...
class GangliaLayer protected ()
  extends typingsSlinky.atPulumiAws.opsworksGangliaLayerMod.GangliaLayer {
  /**
...
object GangliaLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.opsworksGangliaLayerMod.GangliaLayer = js.native
  def get(name: String, id: Input[ID], state: GangliaLayerState): typingsSlinky.atPulumiAws.opsworksGangliaLayerMod.GangliaLayer = js.native
  def get(name: String, id: Input[ID], state: GangliaLayerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.opsworksGangliaLayerMod.GangliaLayer = js.native
  /**
