package typingsSlinky.atPulumiAws.globalacceleratorEndpointGroupMod

import typingsSlinky.atPulumiAws.typesInputMod.globalaccelerator.EndpointGroupEndpointConfiguration
