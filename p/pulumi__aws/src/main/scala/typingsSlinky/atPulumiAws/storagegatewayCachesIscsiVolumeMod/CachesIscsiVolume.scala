package typingsSlinky.atPulumiAws.storagegatewayCachesIscsiVolumeMod
...
class CachesIscsiVolume protected () extends CustomResource {
  ...
  /**
    ...
    */
  val chapEnabled: Output[Boolean] = js.native
  /**
  ...
  /**
    * Logical disk number.
    */
  val lunNumber: Output[Double] = js.native
  /**
  ...
  /**
    ...
    */
  val networkInterfacePort: Output[Double] = js.native
  /**
  ...
  /**
    ...
    */
  val targetName: Output[String] = js.native
  /**
    * Volume Amazon Resource Name (ARN), e.g. `arn:aws:storagegateway:us-east-1:123456789012:gateway/sgw-12345678/volume/vol-12345678`.
    */
  val volumeArn: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val volumeSizeInBytes: Output[Double] = js.native
}
