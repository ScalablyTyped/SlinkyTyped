...
import typingsSlinky.atPulumiAws.typesInputMod.elasticloadbalancingv2.ListenerRuleAction
import typingsSlinky.atPulumiAws.typesInputMod.elasticloadbalancingv2.ListenerRuleCondition
