...
object batchMod extends js.Object {
  ...
  class ComputeEnvironment protected ()
    extends typingsSlinky.atPulumiAws.batchComputeEnvironmentMod.ComputeEnvironment {
    /**
  ...
  class JobDefinition protected ()
    extends typingsSlinky.atPulumiAws.batchJobDefinitionMod.JobDefinition {
    /**
  ...
  class JobQueue protected ()
    extends typingsSlinky.atPulumiAws.batchJobQueueMod.JobQueue {
    /**
