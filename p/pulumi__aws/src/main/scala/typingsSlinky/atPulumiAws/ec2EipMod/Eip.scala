...
class Eip protected () extends CustomResource {
  ...
  /**
    ...
    */
  val associateWithPrivateIp: Output[js.UndefOr[String]] = js.native
  ...
  /**
    ...
    */
  val networkInterface: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val publicIpv4Pool: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val vpc: Output[Boolean] = js.native
}
