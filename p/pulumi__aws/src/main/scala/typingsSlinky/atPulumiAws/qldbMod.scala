...
import typingsSlinky.atPulumiAws.qldbGetLedgerMod.GetLedgerArgs
import typingsSlinky.atPulumiAws.qldbGetLedgerMod.GetLedgerResult
import typingsSlinky.atPulumiAws.qldbLedgerMod.LedgerArgs
import typingsSlinky.atPulumiAws.qldbLedgerMod.LedgerState
...
object qldbMod extends js.Object {
  ...
  class Ledger protected ()
    extends typingsSlinky.atPulumiAws.qldbLedgerMod.Ledger {
    /**
  ...
  object Ledger extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.qldbLedgerMod.Ledger = js.native
    def get(name: String, id: Input[ID], state: LedgerState): typingsSlinky.atPulumiAws.qldbLedgerMod.Ledger = js.native
    def get(name: String, id: Input[ID], state: LedgerState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.qldbLedgerMod.Ledger = js.native
    /**
