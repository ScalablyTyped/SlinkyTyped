...
import typingsSlinky.atPulumiAws.typesOutputMod.applicationloadbalancing.LoadBalancerAccessLogs
import typingsSlinky.atPulumiAws.typesOutputMod.applicationloadbalancing.LoadBalancerSubnetMapping
