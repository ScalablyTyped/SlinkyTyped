package typingsSlinky.atPulumiAws.codebuildSourceCredentialMod
...
class SourceCredential protected () extends CustomResource {
  ...
  /**
    ...
    */
  val authType: Output[String] = js.native
  /**
    * The source provider used for this project.
    */
  val serverType: Output[String] = js.native
  /**
    * For `GitHub` or `GitHub Enterprise`, this is the personal access token. For `Bitbucket`, this is the app password.
    */
  val token: Output[String] = js.native
  /**
