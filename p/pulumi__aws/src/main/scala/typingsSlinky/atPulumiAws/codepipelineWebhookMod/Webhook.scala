...
import typingsSlinky.atPulumiAws.typesOutputMod.codepipeline.WebhookAuthenticationConfiguration
import typingsSlinky.atPulumiAws.typesOutputMod.codepipeline.WebhookFilter
