package typingsSlinky.atPulumiAws.opsworksPhpAppLayerMod

import typingsSlinky.atPulumiAws.typesInputMod.opsworks.PhpAppLayerEbsVolume
...
object PhpAppLayerArgs {
  ...
  def apply(
    ...
    ebsVolumes: Input[js.Array[Input[PhpAppLayerEbsVolume]]] = null,
