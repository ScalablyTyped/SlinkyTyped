...
object backupMod extends js.Object {
  ...
  class Plan protected ()
    extends typingsSlinky.atPulumiAws.backupPlanMod.Plan {
    /**
  ...
  class Selection protected ()
    extends typingsSlinky.atPulumiAws.backupSelectionMod.Selection {
    /**
  ...
  class Vault protected ()
    extends typingsSlinky.atPulumiAws.backupVaultMod.Vault {
    /**
