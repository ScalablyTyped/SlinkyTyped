package typingsSlinky.atPulumiAws.ec2VpcEndpointServiceAllowedPrincipleMod
...
class VpcEndpointServiceAllowedPrinciple protected () extends CustomResource {
  ...
  /**
    ...
    */
  val principalArn: Output[String] = js.native
  /**
    * The ID of the VPC endpoint service to allow permission.
    */
  val vpcEndpointServiceId: Output[String] = js.native
}
