...
import typingsSlinky.atPulumiAws.sqsQueuePolicyMod.QueuePolicyArgs
import typingsSlinky.atPulumiAws.sqsQueuePolicyMod.QueuePolicyState
...
class QueuePolicy protected ()
  extends typingsSlinky.atPulumiAws.sqsQueuePolicyMod.QueuePolicy {
  /**
...
object QueuePolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sqsQueuePolicyMod.QueuePolicy = js.native
  def get(name: String, id: Input[ID], state: QueuePolicyState): typingsSlinky.atPulumiAws.sqsQueuePolicyMod.QueuePolicy = js.native
  def get(name: String, id: Input[ID], state: QueuePolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sqsQueuePolicyMod.QueuePolicy = js.native
  /**
