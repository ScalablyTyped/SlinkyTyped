...
object cloudformationMod extends js.Object {
  ...
  class Stack protected ()
    extends typingsSlinky.atPulumiAws.cloudformationStackMod.Stack {
    /**
  ...
  class StackSet protected ()
    extends typingsSlinky.atPulumiAws.cloudformationStackSetMod.StackSet {
    /**
  ...
  class StackSetInstance protected ()
    extends typingsSlinky.atPulumiAws.cloudformationStackSetInstanceMod.StackSetInstance {
    /**
