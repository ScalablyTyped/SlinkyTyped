...
import typingsSlinky.atPulumiAws.sesMailFromMod.MailFromArgs
import typingsSlinky.atPulumiAws.sesMailFromMod.MailFromState
...
class MailFrom protected ()
  extends typingsSlinky.atPulumiAws.sesMailFromMod.MailFrom {
  /**
...
object MailFrom extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesMailFromMod.MailFrom = js.native
  def get(name: String, id: Input[ID], state: MailFromState): typingsSlinky.atPulumiAws.sesMailFromMod.MailFrom = js.native
  def get(name: String, id: Input[ID], state: MailFromState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesMailFromMod.MailFrom = js.native
  /**
