...
import typingsSlinky.atPulumiAws.sesReceiptRuleMod.ReceiptRuleArgs
import typingsSlinky.atPulumiAws.sesReceiptRuleMod.ReceiptRuleState
...
class ReceiptRule protected ()
  extends typingsSlinky.atPulumiAws.sesReceiptRuleMod.ReceiptRule {
  /**
...
object ReceiptRule extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesReceiptRuleMod.ReceiptRule = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleState): typingsSlinky.atPulumiAws.sesReceiptRuleMod.ReceiptRule = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesReceiptRuleMod.ReceiptRule = js.native
  /**
