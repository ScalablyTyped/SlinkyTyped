...
import typingsSlinky.atPulumiAws.sesReceiptFilterMod.ReceiptFilterArgs
import typingsSlinky.atPulumiAws.sesReceiptFilterMod.ReceiptFilterState
...
class ReceiptFilter protected ()
  extends typingsSlinky.atPulumiAws.sesReceiptFilterMod.ReceiptFilter {
  /**
...
object ReceiptFilter extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesReceiptFilterMod.ReceiptFilter = js.native
  def get(name: String, id: Input[ID], state: ReceiptFilterState): typingsSlinky.atPulumiAws.sesReceiptFilterMod.ReceiptFilter = js.native
  def get(name: String, id: Input[ID], state: ReceiptFilterState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesReceiptFilterMod.ReceiptFilter = js.native
  /**
