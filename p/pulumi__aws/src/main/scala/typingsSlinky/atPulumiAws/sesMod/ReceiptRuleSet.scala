...
import typingsSlinky.atPulumiAws.sesReceiptRuleSetMod.ReceiptRuleSetArgs
import typingsSlinky.atPulumiAws.sesReceiptRuleSetMod.ReceiptRuleSetState
...
class ReceiptRuleSet protected ()
  extends typingsSlinky.atPulumiAws.sesReceiptRuleSetMod.ReceiptRuleSet {
  /**
...
object ReceiptRuleSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesReceiptRuleSetMod.ReceiptRuleSet = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleSetState): typingsSlinky.atPulumiAws.sesReceiptRuleSetMod.ReceiptRuleSet = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleSetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesReceiptRuleSetMod.ReceiptRuleSet = js.native
  /**
