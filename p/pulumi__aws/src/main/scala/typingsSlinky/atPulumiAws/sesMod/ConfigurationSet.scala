...
import typingsSlinky.atPulumiAws.sesConfigurationSetMod.ConfigurationSetArgs
import typingsSlinky.atPulumiAws.sesConfigurationSetMod.ConfigurationSetState
...
class ConfigurationSet protected ()
  extends typingsSlinky.atPulumiAws.sesConfigurationSetMod.ConfigurationSet {
  /**
...
object ConfigurationSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.sesConfigurationSetMod.ConfigurationSet = js.native
  def get(name: String, id: Input[ID], state: ConfigurationSetState): typingsSlinky.atPulumiAws.sesConfigurationSetMod.ConfigurationSet = js.native
  def get(name: String, id: Input[ID], state: ConfigurationSetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.sesConfigurationSetMod.ConfigurationSet = js.native
  /**
