...
object autoscalingMod extends js.Object {
  ...
  class Attachment protected ()
    extends typingsSlinky.atPulumiAws.autoscalingAttachmentMod.Attachment {
    /**
  ...
  class Group protected ()
    extends typingsSlinky.atPulumiAws.autoscalingGroupMod.Group {
    /**
  ...
  class LifecycleHook protected ()
    extends typingsSlinky.atPulumiAws.autoscalingLifecycleHookMod.LifecycleHook {
    /**
  ...
  class Notification protected ()
    extends typingsSlinky.atPulumiAws.autoscalingNotificationMod.Notification {
    /**
  ...
  class Policy protected ()
    extends typingsSlinky.atPulumiAws.autoscalingPolicyMod.Policy {
    /**
  ...
  class Schedule protected ()
    extends typingsSlinky.atPulumiAws.autoscalingScheduleMod.Schedule {
    /**
