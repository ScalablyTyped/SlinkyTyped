...
import typingsSlinky.atPulumiAws.typesOutputMod.ec2.AmiFromInstanceEbsBlockDevice
import typingsSlinky.atPulumiAws.typesOutputMod.ec2.AmiFromInstanceEphemeralBlockDevice
