...
import typingsSlinky.atPulumiAws.typesOutputMod.sagemaker.ModelContainer
import typingsSlinky.atPulumiAws.typesOutputMod.sagemaker.ModelPrimaryContainer
import typingsSlinky.atPulumiAws.typesOutputMod.sagemaker.ModelVpcConfig
