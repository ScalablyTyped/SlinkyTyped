...
import typingsSlinky.atPulumiAws.lambdaLayerVersionMod.LayerVersionArgs
import typingsSlinky.atPulumiAws.lambdaLayerVersionMod.LayerVersionState
...
class LayerVersion protected ()
  extends typingsSlinky.atPulumiAws.lambdaLayerVersionMod.LayerVersion {
  /**
...
object LayerVersion extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.lambdaLayerVersionMod.LayerVersion = js.native
  def get(name: String, id: Input[ID], state: LayerVersionState): typingsSlinky.atPulumiAws.lambdaLayerVersionMod.LayerVersion = js.native
  def get(name: String, id: Input[ID], state: LayerVersionState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.lambdaLayerVersionMod.LayerVersion = js.native
  /**
