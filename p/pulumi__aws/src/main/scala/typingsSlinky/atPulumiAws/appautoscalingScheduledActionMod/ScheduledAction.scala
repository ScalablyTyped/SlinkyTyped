...
import typingsSlinky.atPulumiAws.typesOutputMod.appautoscaling.ScheduledActionScalableTargetAction
...
class ScheduledAction protected () extends CustomResource {
  ...
  /**
    ...
    */
  val scalableTargetAction: Output[js.UndefOr[ScheduledActionScalableTargetAction]] = js.native
  /**
