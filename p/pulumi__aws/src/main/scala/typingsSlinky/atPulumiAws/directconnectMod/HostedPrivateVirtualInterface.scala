...
import typingsSlinky.atPulumiAws.directconnectHostedPrivateVirtualInterfaceMod.HostedPrivateVirtualInterfaceArgs
import typingsSlinky.atPulumiAws.directconnectHostedPrivateVirtualInterfaceMod.HostedPrivateVirtualInterfaceState
...
class HostedPrivateVirtualInterface protected ()
  extends typingsSlinky.atPulumiAws.directconnectHostedPrivateVirtualInterfaceMod.HostedPrivateVirtualInterface {
  /**
...
object HostedPrivateVirtualInterface extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.directconnectHostedPrivateVirtualInterfaceMod.HostedPrivateVirtualInterface = js.native
  def get(name: String, id: Input[ID], state: HostedPrivateVirtualInterfaceState): typingsSlinky.atPulumiAws.directconnectHostedPrivateVirtualInterfaceMod.HostedPrivateVirtualInterface = js.native
  def get(
    name: String,
    id: Input[ID],
    state: HostedPrivateVirtualInterfaceState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.directconnectHostedPrivateVirtualInterfaceMod.HostedPrivateVirtualInterface = js.native
  /**
