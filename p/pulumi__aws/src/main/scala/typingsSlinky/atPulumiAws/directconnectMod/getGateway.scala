...
import typingsSlinky.atPulumiAws.directconnectGetGatewayMod.GetGatewayArgs
import typingsSlinky.atPulumiAws.directconnectGetGatewayMod.GetGatewayResult
