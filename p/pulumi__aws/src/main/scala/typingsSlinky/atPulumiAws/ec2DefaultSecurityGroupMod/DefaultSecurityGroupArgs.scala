...
import typingsSlinky.atPulumiAws.typesInputMod.ec2.DefaultSecurityGroupEgress
import typingsSlinky.atPulumiAws.typesInputMod.ec2.DefaultSecurityGroupIngress
