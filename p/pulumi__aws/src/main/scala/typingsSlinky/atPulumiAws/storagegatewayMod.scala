...
object storagegatewayMod extends js.Object {
  ...
  class Cache protected ()
    extends typingsSlinky.atPulumiAws.storagegatewayCacheMod.Cache {
    /**
  ...
  class CachesIscsiVolume protected ()
    extends typingsSlinky.atPulumiAws.storagegatewayCachesIscsiVolumeMod.CachesIscsiVolume {
    /**
  ...
  class Gateway protected ()
    extends typingsSlinky.atPulumiAws.storagegatewayGatewayMod.Gateway {
    /**
  ...
  class NfsFileShare protected ()
    extends typingsSlinky.atPulumiAws.storagegatewayNfsFileShareMod.NfsFileShare {
    /**
  ...
  class SmbFileShare protected ()
    extends typingsSlinky.atPulumiAws.storagegatewaySmbFileShareMod.SmbFileShare {
    /**
  ...
  class UploadBuffer protected ()
    extends typingsSlinky.atPulumiAws.storagegatewayUploadBufferMod.UploadBuffer {
    /**
  ...
  class WorkingStorage protected ()
    extends typingsSlinky.atPulumiAws.storagegatewayWorkingStorageMod.WorkingStorage {
    /**
