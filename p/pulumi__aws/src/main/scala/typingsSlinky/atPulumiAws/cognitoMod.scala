...
object cognitoMod extends js.Object {
  ...
  class IdentityPool protected ()
    extends typingsSlinky.atPulumiAws.cognitoIdentityPoolMod.IdentityPool {
    /**
  ...
  class IdentityPoolRoleAttachment protected ()
    extends typingsSlinky.atPulumiAws.cognitoIdentityPoolRoleAttachmentMod.IdentityPoolRoleAttachment {
    /**
  ...
  class IdentityProvider protected ()
    extends typingsSlinky.atPulumiAws.cognitoIdentityProviderMod.IdentityProvider {
    /**
  ...
  class ResourceServer protected ()
    extends typingsSlinky.atPulumiAws.cognitoResourceServerMod.ResourceServer {
    /**
  ...
  class UserGroup protected ()
    extends typingsSlinky.atPulumiAws.cognitoUserGroupMod.UserGroup {
    /**
  ...
  class UserPool protected ()
    extends typingsSlinky.atPulumiAws.cognitoUserPoolMod.UserPool {
    /**
  ...
  class UserPoolClient protected ()
    extends typingsSlinky.atPulumiAws.cognitoUserPoolClientMod.UserPoolClient {
    /**
  ...
  class UserPoolDomain protected ()
    extends typingsSlinky.atPulumiAws.cognitoUserPoolDomainMod.UserPoolDomain {
    /**
