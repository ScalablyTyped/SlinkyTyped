...
import typingsSlinky.atPulumiAws.typesInputMod.appsync.DataSourceDynamodbConfig
import typingsSlinky.atPulumiAws.typesInputMod.appsync.DataSourceElasticsearchConfig
import typingsSlinky.atPulumiAws.typesInputMod.appsync.DataSourceHttpConfig
import typingsSlinky.atPulumiAws.typesInputMod.appsync.DataSourceLambdaConfig
