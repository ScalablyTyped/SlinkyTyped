package typingsSlinky.atPulumiAws.secretsmanagerSecretMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesOutputMod.secretsmanager.SecretRotationRules
...
class Secret protected () extends CustomResource {
  ...
  /**
    ...
    */
  val recoveryWindowInDays: Output[js.UndefOr[Double]] = js.native
  /**
    * Specifies whether automatic rotation is enabled for this secret.
    */
  val rotationEnabled: Output[Boolean] = js.native
  /**
    * Specifies the ARN of the Lambda function that can rotate the secret.
    */
  val rotationLambdaArn: Output[js.UndefOr[String]] = js.native
  /**
