...
import typingsSlinky.atPulumiAws.typesInputMod.ses.EventDestinationCloudwatchDestination
import typingsSlinky.atPulumiAws.typesInputMod.ses.EventDestinationKinesisDestination
import typingsSlinky.atPulumiAws.typesInputMod.ses.EventDestinationSnsDestination
