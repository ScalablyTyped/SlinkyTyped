...
import typingsSlinky.atPulumiAws.typesOutputMod.elasticbeanstalk.EnvironmentAllSetting
import typingsSlinky.atPulumiAws.typesOutputMod.elasticbeanstalk.EnvironmentSetting
