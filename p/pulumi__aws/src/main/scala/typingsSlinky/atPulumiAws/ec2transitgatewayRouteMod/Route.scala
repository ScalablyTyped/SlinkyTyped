package typingsSlinky.atPulumiAws.ec2transitgatewayRouteMod
...
class Route protected () extends CustomResource {
  ...
  /**
    ...
    */
  val blackhole: Output[js.UndefOr[Boolean]] = js.native
  /**
    * IPv4 CIDR range used for destination matches. Routing decisions are based on the most specific match.
    */
  val destinationCidrBlock: Output[String] = js.native
  /**
    * Identifier of EC2 Transit Gateway Attachment (required if `blackhole` is set to false).
    */
  val transitGatewayAttachmentId: Output[js.UndefOr[String]] = js.native
  /**
