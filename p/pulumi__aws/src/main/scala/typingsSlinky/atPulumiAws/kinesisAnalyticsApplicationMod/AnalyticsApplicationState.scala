package typingsSlinky.atPulumiAws.kinesisAnalyticsApplicationMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.arnMod.ARN
import typingsSlinky.atPulumiAws.typesInputMod.kinesis.AnalyticsApplicationCloudwatchLoggingOptions
import typingsSlinky.atPulumiAws.typesInputMod.kinesis.AnalyticsApplicationInputs
import typingsSlinky.atPulumiAws.typesInputMod.kinesis.AnalyticsApplicationOutput
import typingsSlinky.atPulumiAws.typesInputMod.kinesis.AnalyticsApplicationReferenceDataSources
