package typingsSlinky.atPulumiAws.acmpcaGetCertificateAuthorityMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesInputMod.acmpca.GetCertificateAuthorityRevocationConfiguration
