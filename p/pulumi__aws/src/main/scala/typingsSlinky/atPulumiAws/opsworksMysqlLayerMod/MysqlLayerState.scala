package typingsSlinky.atPulumiAws.opsworksMysqlLayerMod

import typingsSlinky.atPulumiAws.typesInputMod.opsworks.MysqlLayerEbsVolume
...
trait MysqlLayerState extends js.Object {
  ...
  /**
    ...
    */
  val ebsVolumes: js.UndefOr[Input[js.Array[Input[MysqlLayerEbsVolume]]]] = js.native
  /**
...
object MysqlLayerState {
  ...
  def apply(
    ...
    ebsVolumes: Input[js.Array[Input[MysqlLayerEbsVolume]]] = null,
