...
import typingsSlinky.atPulumiAws.typesInputMod.opsworks.NodejsAppLayerEbsVolume
...
object NodejsAppLayerState {
  ...
  def apply(
    ...
    ebsVolumes: Input[js.Array[Input[NodejsAppLayerEbsVolume]]] = null,
    ...
    nodejsVersion: Input[String] = null,
