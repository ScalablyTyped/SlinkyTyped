package typingsSlinky.atPulumiAws.opsworksNodejsAppLayerMod

import typingsSlinky.atPulumiAws.typesOutputMod.opsworks.NodejsAppLayerEbsVolume
...
class NodejsAppLayer protected () extends CustomResource {
  ...
  /**
    ...
    */
  val ebsVolumes: Output[js.UndefOr[js.Array[NodejsAppLayerEbsVolume]]] = js.native
  /**
  ...
  /**
    ...
    */
  val nodejsVersion: Output[js.UndefOr[String]] = js.native
  /**
