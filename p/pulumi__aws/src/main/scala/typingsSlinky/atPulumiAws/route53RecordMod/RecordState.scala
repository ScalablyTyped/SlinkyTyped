package typingsSlinky.atPulumiAws.route53RecordMod

import typingsSlinky.atPulumiAws.route53RecordTypeMod.RecordType
import typingsSlinky.atPulumiAws.typesInputMod.route53.RecordAlias
import typingsSlinky.atPulumiAws.typesInputMod.route53.RecordFailoverRoutingPolicy
import typingsSlinky.atPulumiAws.typesInputMod.route53.RecordGeolocationRoutingPolicy
import typingsSlinky.atPulumiAws.typesInputMod.route53.RecordLatencyRoutingPolicy
import typingsSlinky.atPulumiAws.typesInputMod.route53.RecordWeightedRoutingPolicy
