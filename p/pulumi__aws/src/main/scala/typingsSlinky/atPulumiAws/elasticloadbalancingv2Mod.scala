...
object elasticloadbalancingv2Mod extends js.Object {
  ...
  class Listener protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingv2ListenerMod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingv2ListenerCertificateMod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingv2ListenerRuleMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingv2LoadBalancerMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingv2TargetGroupMod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsSlinky.atPulumiAws.elasticloadbalancingv2TargetGroupAttachmentMod.TargetGroupAttachment {
    /**
