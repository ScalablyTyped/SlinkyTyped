package typingsSlinky.atPulumiAws.albLoadBalancerMod
...
import typingsSlinky.atPulumiAws.typesOutputMod.alb.LoadBalancerAccessLogs
import typingsSlinky.atPulumiAws.typesOutputMod.alb.LoadBalancerSubnetMapping
