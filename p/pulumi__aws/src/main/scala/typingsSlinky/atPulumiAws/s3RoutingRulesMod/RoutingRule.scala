package typingsSlinky.atPulumiAws.s3RoutingRulesMod
...
trait RoutingRule extends js.Object {
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.atPulumiAws.s3RoutingRulesMod.Condition] = js.native
  /**
    ...
    */
  var Redirect: typingsSlinky.atPulumiAws.s3RoutingRulesMod.Redirect = js.native
}
