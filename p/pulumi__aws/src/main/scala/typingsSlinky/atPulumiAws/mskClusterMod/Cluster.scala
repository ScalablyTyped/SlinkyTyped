package typingsSlinky.atPulumiAws.mskClusterMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesOutputMod.msk.ClusterBrokerNodeGroupInfo
import typingsSlinky.atPulumiAws.typesOutputMod.msk.ClusterClientAuthentication
import typingsSlinky.atPulumiAws.typesOutputMod.msk.ClusterConfigurationInfo
import typingsSlinky.atPulumiAws.typesOutputMod.msk.ClusterEncryptionInfo
...
class Cluster protected () extends CustomResource {
  ...
  /**
    ...
    */
  val bootstrapBrokers: Output[String] = js.native
  /**
    ...
    */
  val bootstrapBrokersTls: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val currentVersion: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val enhancedMonitoring: Output[js.UndefOr[String]] = js.native
  /**
    * Specify the desired Kafka software version.
    */
  val kafkaVersion: Output[String] = js.native
  /**
    * The desired total number of broker nodes in the kafka cluster.  It must be a multiple of the number of specified client subnets.
    */
  val numberOfBrokerNodes: Output[Double] = js.native
  /**
  ...
  /**
    ...
    */
  val zookeeperConnectString: Output[String] = js.native
}
