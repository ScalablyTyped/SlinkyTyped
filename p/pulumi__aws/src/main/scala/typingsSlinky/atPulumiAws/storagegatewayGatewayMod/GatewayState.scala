package typingsSlinky.atPulumiAws.storagegatewayGatewayMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesInputMod.storagegateway.GatewaySmbActiveDirectorySettings
