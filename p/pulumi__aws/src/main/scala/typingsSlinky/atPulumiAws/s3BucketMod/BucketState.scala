package typingsSlinky.atPulumiAws.s3BucketMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.iamDocumentsMod.PolicyDocument
import typingsSlinky.atPulumiAws.s3CannedAclMod.CannedAcl
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketCorsRule
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketLifecycleRule
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketLogging
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketObjectLockConfiguration
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketReplicationConfiguration
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketServerSideEncryptionConfiguration
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketVersioning
import typingsSlinky.atPulumiAws.typesInputMod.s3.BucketWebsite
