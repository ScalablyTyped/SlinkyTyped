...
object appautoscalingMod extends js.Object {
  ...
  class Policy protected ()
    extends typingsSlinky.atPulumiAws.appautoscalingPolicyMod.Policy {
    /**
  ...
  class ScheduledAction protected ()
    extends typingsSlinky.atPulumiAws.appautoscalingScheduledActionMod.ScheduledAction {
    /**
  ...
  class Target protected ()
    extends typingsSlinky.atPulumiAws.appautoscalingTargetMod.Target {
    /**
