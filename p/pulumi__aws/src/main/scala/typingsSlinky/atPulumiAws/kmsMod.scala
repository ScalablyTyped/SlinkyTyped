...
object kmsMod extends js.Object {
  ...
  class Alias protected ()
    extends typingsSlinky.atPulumiAws.kmsAliasMod.Alias {
    /**
  ...
  class Ciphertext protected ()
    extends typingsSlinky.atPulumiAws.kmsCiphertextMod.Ciphertext {
    /**
  ...
  class ExternalKey protected ()
    extends typingsSlinky.atPulumiAws.kmsExternalKeyMod.ExternalKey {
    /**
  ...
  class Grant protected ()
    extends typingsSlinky.atPulumiAws.kmsGrantMod.Grant {
    /**
  ...
  @js.native
  class Key protected ()
    extends typingsSlinky.atPulumiAws.kmsKeyMod.Key {
    /**
