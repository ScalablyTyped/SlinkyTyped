...
class LicenseConfiguration protected () extends CustomResource {
  ...
  /**
    ...
    */
  val licenseCount: Output[js.UndefOr[Double]] = js.native
  /**
    * Sets the number of available licenses as a hard limit.
    */
  val licenseCountHardLimit: Output[js.UndefOr[Boolean]] = js.native
  /**
    * Dimension to use to track license inventory. Specify either `vCPU`, `Instance`, `Core` or `Socket`.
    */
  val licenseCountingType: Output[String] = js.native
  /**
    * Array of configured License Manager rules.
    */
  val licenseRules: Output[js.UndefOr[js.Array[String]]] = js.native
  /**
