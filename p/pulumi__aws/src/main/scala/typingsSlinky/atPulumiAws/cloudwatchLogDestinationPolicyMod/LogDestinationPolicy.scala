package typingsSlinky.atPulumiAws.cloudwatchLogDestinationPolicyMod
...
class LogDestinationPolicy protected () extends CustomResource {
  ...
  /**
    ...
    */
  val accessPolicy: Output[String] = js.native
  /**
    * A name for the subscription filter
    */
  val destinationName: Output[String] = js.native
}
