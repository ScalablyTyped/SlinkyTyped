...
import typingsSlinky.atPulumiAws.atPulumiAwsStrings.AT_TIMESTAMP
import typingsSlinky.atPulumiAws.atPulumiAwsStrings.LATEST
import typingsSlinky.atPulumiAws.atPulumiAwsStrings.TRIM_HORIZON
