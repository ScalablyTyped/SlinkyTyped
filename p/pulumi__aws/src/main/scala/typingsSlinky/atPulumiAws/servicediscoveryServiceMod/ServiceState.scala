package typingsSlinky.atPulumiAws.servicediscoveryServiceMod

import typingsSlinky.atPulumiAws.typesInputMod.servicediscovery.ServiceDnsConfig
import typingsSlinky.atPulumiAws.typesInputMod.servicediscovery.ServiceHealthCheckConfig
import typingsSlinky.atPulumiAws.typesInputMod.servicediscovery.ServiceHealthCheckCustomConfig
