package typingsSlinky.atPulumiAws.sagemakerEndpointConfigurationMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesOutputMod.sagemaker.EndpointConfigurationProductionVariant
