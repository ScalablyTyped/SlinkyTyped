...
object emrMod extends js.Object {
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.emrClusterMod.Cluster {
    /**
  ...
  class InstanceGroup protected ()
    extends typingsSlinky.atPulumiAws.emrInstanceGroupMod.InstanceGroup {
    /**
  ...
  class SecurityConfiguration protected ()
    extends typingsSlinky.atPulumiAws.emrSecurityConfigurationMod.SecurityConfiguration {
    /**
