...
object albMod extends js.Object {
  ...
  class Listener protected ()
    extends typingsSlinky.atPulumiAws.albListenerMod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsSlinky.atPulumiAws.albListenerCertificateMod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsSlinky.atPulumiAws.albListenerRuleMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsSlinky.atPulumiAws.albLoadBalancerMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsSlinky.atPulumiAws.albTargetGroupMod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsSlinky.atPulumiAws.albTargetGroupAttachmentMod.TargetGroupAttachment {
    /**
