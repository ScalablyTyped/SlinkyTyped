...
object ecsMod extends js.Object {
  ...
  class CapacityProvider protected ()
    extends typingsSlinky.atPulumiAws.ecsCapacityProviderMod.CapacityProvider {
    /**
  ...
  class Cluster protected ()
    extends typingsSlinky.atPulumiAws.ecsClusterMod.Cluster {
    /**
  ...
  class Service protected ()
    extends typingsSlinky.atPulumiAws.ecsServiceMod.Service {
    /**
  ...
  class TaskDefinition protected ()
    extends typingsSlinky.atPulumiAws.ecsTaskDefinitionMod.TaskDefinition {
    /**
