package typingsSlinky.atPulumiAws.ec2RouteMod
...
class Route protected () extends CustomResource {
  ...
  /**
    ...
    */
  val destinationCidrBlock: Output[js.UndefOr[String]] = js.native
  /**
    * The destination IPv6 CIDR block.
    */
  val destinationIpv6CidrBlock: Output[js.UndefOr[String]] = js.native
  val destinationPrefixListId: Output[String] = js.native
  /**
    * Identifier of a VPC Egress Only Internet Gateway.
    */
  val egressOnlyGatewayId: Output[String] = js.native
  /**
  ...
  val instanceOwnerId: Output[String] = js.native
  /**
    * Identifier of a VPC NAT gateway.
    */
  val natGatewayId: Output[String] = js.native
  /**
    * Identifier of an EC2 network interface.
    */
  val networkInterfaceId: Output[String] = js.native
  val origin: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val vpcPeeringConnectionId: Output[js.UndefOr[String]] = js.native
}
