package typingsSlinky.atPulumiAws.elasticbeanstalkApplicationMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atPulumiAws.typesOutputMod.elasticbeanstalk.ApplicationAppversionLifecycle
