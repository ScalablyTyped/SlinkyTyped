package typingsSlinky.atPulumiAws.applicationloadbalancingListenerMod

import typingsSlinky.atPulumiAws.typesOutputMod.applicationloadbalancing.ListenerDefaultAction
