...
object macieMod extends js.Object {
  ...
  class MemberAccountAssociation protected ()
    extends typingsSlinky.atPulumiAws.macieMemberAccountAssociationMod.MemberAccountAssociation {
    /**
  ...
  class S3BucketAssociation protected ()
    extends typingsSlinky.atPulumiAws.macieS3BucketAssociationMod.S3BucketAssociation {
    /**
