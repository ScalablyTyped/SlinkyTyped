...
import typingsSlinky.atPulumiAws.typesInputMod.acm.CertificateDomainValidationOption
import typingsSlinky.atPulumiAws.typesInputMod.acm.CertificateOptions
