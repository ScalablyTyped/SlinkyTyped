...
import typingsSlinky.atPulumiAws.ec2LaunchConfigurationMod.LaunchConfigurationArgs
import typingsSlinky.atPulumiAws.ec2LaunchConfigurationMod.LaunchConfigurationState
...
class LaunchConfiguration protected ()
  extends typingsSlinky.atPulumiAws.ec2LaunchConfigurationMod.LaunchConfiguration {
  /**
...
object LaunchConfiguration extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2LaunchConfigurationMod.LaunchConfiguration = js.native
  def get(name: String, id: Input[ID], state: LaunchConfigurationState): typingsSlinky.atPulumiAws.ec2LaunchConfigurationMod.LaunchConfiguration = js.native
  def get(name: String, id: Input[ID], state: LaunchConfigurationState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2LaunchConfigurationMod.LaunchConfiguration = js.native
  /**
