...
import typingsSlinky.atPulumiAws.ec2AmiCopyMod.AmiCopyArgs
import typingsSlinky.atPulumiAws.ec2AmiCopyMod.AmiCopyState
...
class AmiCopy protected ()
  extends typingsSlinky.atPulumiAws.ec2AmiCopyMod.AmiCopy {
  /**
...
object AmiCopy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2AmiCopyMod.AmiCopy = js.native
  def get(name: String, id: Input[ID], state: AmiCopyState): typingsSlinky.atPulumiAws.ec2AmiCopyMod.AmiCopy = js.native
  def get(name: String, id: Input[ID], state: AmiCopyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2AmiCopyMod.AmiCopy = js.native
  /**
