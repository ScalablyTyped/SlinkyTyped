...
import typingsSlinky.atPulumiAws.ec2DefaultRouteTableMod.DefaultRouteTableArgs
import typingsSlinky.atPulumiAws.ec2DefaultRouteTableMod.DefaultRouteTableState
...
class DefaultRouteTable protected ()
  extends typingsSlinky.atPulumiAws.ec2DefaultRouteTableMod.DefaultRouteTable {
  /**
...
object DefaultRouteTable extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2DefaultRouteTableMod.DefaultRouteTable = js.native
  def get(name: String, id: Input[ID], state: DefaultRouteTableState): typingsSlinky.atPulumiAws.ec2DefaultRouteTableMod.DefaultRouteTable = js.native
  def get(name: String, id: Input[ID], state: DefaultRouteTableState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2DefaultRouteTableMod.DefaultRouteTable = js.native
  /**
