...
import typingsSlinky.atPulumiAws.ec2GetInternetGatewayMod.GetInternetGatewayArgs
import typingsSlinky.atPulumiAws.ec2GetInternetGatewayMod.GetInternetGatewayResult
