...
import typingsSlinky.atPulumiAws.ec2SnapshotCreateVolumePermissionMod.SnapshotCreateVolumePermissionArgs
import typingsSlinky.atPulumiAws.ec2SnapshotCreateVolumePermissionMod.SnapshotCreateVolumePermissionState
...
class SnapshotCreateVolumePermission protected ()
  extends typingsSlinky.atPulumiAws.ec2SnapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission {
  /**
...
object SnapshotCreateVolumePermission extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2SnapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  def get(name: String, id: Input[ID], state: SnapshotCreateVolumePermissionState): typingsSlinky.atPulumiAws.ec2SnapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  def get(
    name: String,
    id: Input[ID],
    state: SnapshotCreateVolumePermissionState,
    opts: CustomResourceOptions
  ): typingsSlinky.atPulumiAws.ec2SnapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  /**
