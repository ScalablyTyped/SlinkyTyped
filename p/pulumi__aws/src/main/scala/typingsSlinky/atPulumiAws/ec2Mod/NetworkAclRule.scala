...
import typingsSlinky.atPulumiAws.ec2NetworkAclRuleMod.NetworkAclRuleArgs
import typingsSlinky.atPulumiAws.ec2NetworkAclRuleMod.NetworkAclRuleState
...
class NetworkAclRule protected ()
  extends typingsSlinky.atPulumiAws.ec2NetworkAclRuleMod.NetworkAclRule {
  /**
...
object NetworkAclRule extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2NetworkAclRuleMod.NetworkAclRule = js.native
  def get(name: String, id: Input[ID], state: NetworkAclRuleState): typingsSlinky.atPulumiAws.ec2NetworkAclRuleMod.NetworkAclRule = js.native
  def get(name: String, id: Input[ID], state: NetworkAclRuleState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2NetworkAclRuleMod.NetworkAclRule = js.native
  /**
