...
import typingsSlinky.atPulumiAws.ec2DefaultVpcMod.DefaultVpcArgs
import typingsSlinky.atPulumiAws.ec2DefaultVpcMod.DefaultVpcState
...
class DefaultVpc protected ()
  extends typingsSlinky.atPulumiAws.ec2DefaultVpcMod.DefaultVpc {
  /**
...
object DefaultVpc extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2DefaultVpcMod.DefaultVpc = js.native
  def get(name: String, id: Input[ID], state: DefaultVpcState): typingsSlinky.atPulumiAws.ec2DefaultVpcMod.DefaultVpc = js.native
  def get(name: String, id: Input[ID], state: DefaultVpcState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2DefaultVpcMod.DefaultVpc = js.native
  /**
