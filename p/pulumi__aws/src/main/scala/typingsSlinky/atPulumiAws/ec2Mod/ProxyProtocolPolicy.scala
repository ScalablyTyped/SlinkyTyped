...
import typingsSlinky.atPulumiAws.ec2ProxyProtocolPolicyMod.ProxyProtocolPolicyArgs
import typingsSlinky.atPulumiAws.ec2ProxyProtocolPolicyMod.ProxyProtocolPolicyState
...
class ProxyProtocolPolicy protected ()
  extends typingsSlinky.atPulumiAws.ec2ProxyProtocolPolicyMod.ProxyProtocolPolicy {
  /**
...
object ProxyProtocolPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2ProxyProtocolPolicyMod.ProxyProtocolPolicy = js.native
  def get(name: String, id: Input[ID], state: ProxyProtocolPolicyState): typingsSlinky.atPulumiAws.ec2ProxyProtocolPolicyMod.ProxyProtocolPolicy = js.native
  def get(name: String, id: Input[ID], state: ProxyProtocolPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2ProxyProtocolPolicyMod.ProxyProtocolPolicy = js.native
  /**
