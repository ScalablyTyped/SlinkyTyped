...
import typingsSlinky.atPulumiAws.ec2VpcEndpointServiceMod.VpcEndpointServiceArgs
import typingsSlinky.atPulumiAws.ec2VpcEndpointServiceMod.VpcEndpointServiceState
...
class VpcEndpointService protected ()
  extends typingsSlinky.atPulumiAws.ec2VpcEndpointServiceMod.VpcEndpointService {
  /**
...
object VpcEndpointService extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpcEndpointServiceMod.VpcEndpointService = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointServiceState): typingsSlinky.atPulumiAws.ec2VpcEndpointServiceMod.VpcEndpointService = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointServiceState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpcEndpointServiceMod.VpcEndpointService = js.native
  /**
