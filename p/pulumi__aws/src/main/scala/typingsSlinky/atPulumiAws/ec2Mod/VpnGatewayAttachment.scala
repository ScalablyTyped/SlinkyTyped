...
import typingsSlinky.atPulumiAws.ec2VpnGatewayAttachmentMod.VpnGatewayAttachmentArgs
import typingsSlinky.atPulumiAws.ec2VpnGatewayAttachmentMod.VpnGatewayAttachmentState
...
class VpnGatewayAttachment protected ()
  extends typingsSlinky.atPulumiAws.ec2VpnGatewayAttachmentMod.VpnGatewayAttachment {
  /**
...
object VpnGatewayAttachment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2VpnGatewayAttachmentMod.VpnGatewayAttachment = js.native
  def get(name: String, id: Input[ID], state: VpnGatewayAttachmentState): typingsSlinky.atPulumiAws.ec2VpnGatewayAttachmentMod.VpnGatewayAttachment = js.native
  def get(name: String, id: Input[ID], state: VpnGatewayAttachmentState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2VpnGatewayAttachmentMod.VpnGatewayAttachment = js.native
  /**
