...
import typingsSlinky.atPulumiAws.ec2InternetGatewayMod.InternetGatewayArgs
import typingsSlinky.atPulumiAws.ec2InternetGatewayMod.InternetGatewayState
...
class InternetGateway protected ()
  extends typingsSlinky.atPulumiAws.ec2InternetGatewayMod.InternetGateway {
  /**
...
object InternetGateway extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2InternetGatewayMod.InternetGateway = js.native
  def get(name: String, id: Input[ID], state: InternetGatewayState): typingsSlinky.atPulumiAws.ec2InternetGatewayMod.InternetGateway = js.native
  def get(name: String, id: Input[ID], state: InternetGatewayState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2InternetGatewayMod.InternetGateway = js.native
  /**
