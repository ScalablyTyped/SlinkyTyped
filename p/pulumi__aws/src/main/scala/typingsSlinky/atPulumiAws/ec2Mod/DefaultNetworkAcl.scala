...
import typingsSlinky.atPulumiAws.ec2DefaultNetworkAclMod.DefaultNetworkAclArgs
import typingsSlinky.atPulumiAws.ec2DefaultNetworkAclMod.DefaultNetworkAclState
...
class DefaultNetworkAcl protected ()
  extends typingsSlinky.atPulumiAws.ec2DefaultNetworkAclMod.DefaultNetworkAcl {
  /**
...
object DefaultNetworkAcl extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2DefaultNetworkAclMod.DefaultNetworkAcl = js.native
  def get(name: String, id: Input[ID], state: DefaultNetworkAclState): typingsSlinky.atPulumiAws.ec2DefaultNetworkAclMod.DefaultNetworkAcl = js.native
  def get(name: String, id: Input[ID], state: DefaultNetworkAclState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2DefaultNetworkAclMod.DefaultNetworkAcl = js.native
  /**
