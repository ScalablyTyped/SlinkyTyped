...
import typingsSlinky.atPulumiAws.ec2AmiFromInstanceMod.AmiFromInstanceArgs
import typingsSlinky.atPulumiAws.ec2AmiFromInstanceMod.AmiFromInstanceState
...
class AmiFromInstance protected ()
  extends typingsSlinky.atPulumiAws.ec2AmiFromInstanceMod.AmiFromInstance {
  /**
...
object AmiFromInstance extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.ec2AmiFromInstanceMod.AmiFromInstance = js.native
  def get(name: String, id: Input[ID], state: AmiFromInstanceState): typingsSlinky.atPulumiAws.ec2AmiFromInstanceMod.AmiFromInstance = js.native
  def get(name: String, id: Input[ID], state: AmiFromInstanceState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.ec2AmiFromInstanceMod.AmiFromInstance = js.native
  /**
