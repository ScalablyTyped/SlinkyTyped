...
import typingsSlinky.atPulumiAws.wafRegexMatchSetMod.RegexMatchSetArgs
import typingsSlinky.atPulumiAws.wafRegexMatchSetMod.RegexMatchSetState
...
class RegexMatchSet protected ()
  extends typingsSlinky.atPulumiAws.wafRegexMatchSetMod.RegexMatchSet {
  /**
...
object RegexMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.wafRegexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState): typingsSlinky.atPulumiAws.wafRegexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.wafRegexMatchSetMod.RegexMatchSet = js.native
  /**
