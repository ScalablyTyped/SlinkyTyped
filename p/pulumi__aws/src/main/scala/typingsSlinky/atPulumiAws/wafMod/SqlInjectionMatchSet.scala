...
import typingsSlinky.atPulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSetArgs
import typingsSlinky.atPulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSetState
...
class SqlInjectionMatchSet protected ()
  extends typingsSlinky.atPulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSet {
  /**
...
object SqlInjectionMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSet = js.native
  def get(name: String, id: Input[ID], state: SqlInjectionMatchSetState): typingsSlinky.atPulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSet = js.native
  def get(name: String, id: Input[ID], state: SqlInjectionMatchSetState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSet = js.native
  /**
