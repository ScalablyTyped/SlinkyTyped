...
import typingsSlinky.atPulumiAws.typesOutputMod.ec2.DefaultNetworkAclEgress
import typingsSlinky.atPulumiAws.typesOutputMod.ec2.DefaultNetworkAclIngress
