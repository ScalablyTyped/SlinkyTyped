...
object securityhubMod extends js.Object {
  ...
  class Account protected ()
    extends typingsSlinky.atPulumiAws.securityhubAccountMod.Account {
    /**
  ...
  class ProductSubscription protected ()
    extends typingsSlinky.atPulumiAws.securityhubProductSubscriptionMod.ProductSubscription {
    /**
  ...
  class StandardsSubscription protected ()
    extends typingsSlinky.atPulumiAws.securityhubStandardsSubscriptionMod.StandardsSubscription {
    /**
