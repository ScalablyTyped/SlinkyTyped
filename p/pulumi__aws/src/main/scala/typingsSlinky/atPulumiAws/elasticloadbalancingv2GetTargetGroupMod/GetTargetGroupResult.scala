...
import typingsSlinky.atPulumiAws.typesOutputMod.elasticloadbalancingv2.GetTargetGroupHealthCheck
import typingsSlinky.atPulumiAws.typesOutputMod.elasticloadbalancingv2.GetTargetGroupStickiness
