...
import typingsSlinky.atPulumiAws.Anon_ApproximateCreationDateTime
import typingsSlinky.atPulumiAws.Anon_PrincipalId
import typingsSlinky.atPulumiAws.atPulumiAwsStrings.INSERT
import typingsSlinky.atPulumiAws.atPulumiAwsStrings.MODIFY
import typingsSlinky.atPulumiAws.atPulumiAwsStrings.REMOVE
