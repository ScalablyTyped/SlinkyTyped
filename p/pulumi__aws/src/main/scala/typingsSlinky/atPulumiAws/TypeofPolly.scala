...
import typingsSlinky.awsDashSdk.awsDashSdkMod.Polly.Presigner
...
trait TypeofPolly extends js.Object {
  val Presigner: Instantiable0[typingsSlinky.awsDashSdk.awsDashSdkMod.Polly.Presigner] = js.native
