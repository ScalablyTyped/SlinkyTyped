...
import typingsSlinky.atPulumiAws.typesOutputMod.acmpca.CertificateAuthorityCertificateAuthorityConfiguration
import typingsSlinky.atPulumiAws.typesOutputMod.acmpca.CertificateAuthorityRevocationConfiguration
