...
import typingsSlinky.atPulumiAws.iamAccountPasswordPolicyMod.AccountPasswordPolicyArgs
import typingsSlinky.atPulumiAws.iamAccountPasswordPolicyMod.AccountPasswordPolicyState
...
class AccountPasswordPolicy protected ()
  extends typingsSlinky.atPulumiAws.iamAccountPasswordPolicyMod.AccountPasswordPolicy {
  /**
...
object AccountPasswordPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamAccountPasswordPolicyMod.AccountPasswordPolicy = js.native
  def get(name: String, id: Input[ID], state: AccountPasswordPolicyState): typingsSlinky.atPulumiAws.iamAccountPasswordPolicyMod.AccountPasswordPolicy = js.native
  def get(name: String, id: Input[ID], state: AccountPasswordPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamAccountPasswordPolicyMod.AccountPasswordPolicy = js.native
  /**
