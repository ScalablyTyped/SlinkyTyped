...
import typingsSlinky.atPulumiAws.iamServiceLinkedRoleMod.ServiceLinkedRoleArgs
import typingsSlinky.atPulumiAws.iamServiceLinkedRoleMod.ServiceLinkedRoleState
...
class ServiceLinkedRole protected ()
  extends typingsSlinky.atPulumiAws.iamServiceLinkedRoleMod.ServiceLinkedRole {
  /**
...
object ServiceLinkedRole extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamServiceLinkedRoleMod.ServiceLinkedRole = js.native
  def get(name: String, id: Input[ID], state: ServiceLinkedRoleState): typingsSlinky.atPulumiAws.iamServiceLinkedRoleMod.ServiceLinkedRole = js.native
  def get(name: String, id: Input[ID], state: ServiceLinkedRoleState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamServiceLinkedRoleMod.ServiceLinkedRole = js.native
  /**
