...
import typingsSlinky.atPulumiAws.iamUserGroupMembershipMod.UserGroupMembershipArgs
import typingsSlinky.atPulumiAws.iamUserGroupMembershipMod.UserGroupMembershipState
...
class UserGroupMembership protected ()
  extends typingsSlinky.atPulumiAws.iamUserGroupMembershipMod.UserGroupMembership {
  /**
...
object UserGroupMembership extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamUserGroupMembershipMod.UserGroupMembership = js.native
  def get(name: String, id: Input[ID], state: UserGroupMembershipState): typingsSlinky.atPulumiAws.iamUserGroupMembershipMod.UserGroupMembership = js.native
  def get(name: String, id: Input[ID], state: UserGroupMembershipState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamUserGroupMembershipMod.UserGroupMembership = js.native
  /**
