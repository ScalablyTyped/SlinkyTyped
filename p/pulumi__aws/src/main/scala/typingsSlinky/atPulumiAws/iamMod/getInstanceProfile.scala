...
import typingsSlinky.atPulumiAws.iamGetInstanceProfileMod.GetInstanceProfileArgs
import typingsSlinky.atPulumiAws.iamGetInstanceProfileMod.GetInstanceProfileResult
