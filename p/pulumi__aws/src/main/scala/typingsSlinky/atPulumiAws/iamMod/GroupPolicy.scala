...
import typingsSlinky.atPulumiAws.iamGroupPolicyMod.GroupPolicyArgs
import typingsSlinky.atPulumiAws.iamGroupPolicyMod.GroupPolicyState
...
class GroupPolicy protected ()
  extends typingsSlinky.atPulumiAws.iamGroupPolicyMod.GroupPolicy {
  /**
...
object GroupPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamGroupPolicyMod.GroupPolicy = js.native
  def get(name: String, id: Input[ID], state: GroupPolicyState): typingsSlinky.atPulumiAws.iamGroupPolicyMod.GroupPolicy = js.native
  def get(name: String, id: Input[ID], state: GroupPolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamGroupPolicyMod.GroupPolicy = js.native
  /**
