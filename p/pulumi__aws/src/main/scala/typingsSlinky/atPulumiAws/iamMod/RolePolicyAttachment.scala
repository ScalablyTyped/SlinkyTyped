...
import typingsSlinky.atPulumiAws.iamRolePolicyAttachmentMod.RolePolicyAttachmentArgs
import typingsSlinky.atPulumiAws.iamRolePolicyAttachmentMod.RolePolicyAttachmentState
...
class RolePolicyAttachment protected ()
  extends typingsSlinky.atPulumiAws.iamRolePolicyAttachmentMod.RolePolicyAttachment {
  /**
...
object RolePolicyAttachment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamRolePolicyAttachmentMod.RolePolicyAttachment = js.native
  def get(name: String, id: Input[ID], state: RolePolicyAttachmentState): typingsSlinky.atPulumiAws.iamRolePolicyAttachmentMod.RolePolicyAttachment = js.native
  def get(name: String, id: Input[ID], state: RolePolicyAttachmentState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamRolePolicyAttachmentMod.RolePolicyAttachment = js.native
  /**
