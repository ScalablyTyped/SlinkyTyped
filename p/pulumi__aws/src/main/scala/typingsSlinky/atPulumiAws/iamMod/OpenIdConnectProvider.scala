...
import typingsSlinky.atPulumiAws.iamOpenIdConnectProviderMod.OpenIdConnectProviderArgs
import typingsSlinky.atPulumiAws.iamOpenIdConnectProviderMod.OpenIdConnectProviderState
...
class OpenIdConnectProvider protected ()
  extends typingsSlinky.atPulumiAws.iamOpenIdConnectProviderMod.OpenIdConnectProvider {
  /**
...
object OpenIdConnectProvider extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamOpenIdConnectProviderMod.OpenIdConnectProvider = js.native
  def get(name: String, id: Input[ID], state: OpenIdConnectProviderState): typingsSlinky.atPulumiAws.iamOpenIdConnectProviderMod.OpenIdConnectProvider = js.native
  def get(name: String, id: Input[ID], state: OpenIdConnectProviderState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamOpenIdConnectProviderMod.OpenIdConnectProvider = js.native
  /**
