...
import typingsSlinky.atPulumiAws.iamSamlProviderMod.SamlProviderArgs
import typingsSlinky.atPulumiAws.iamSamlProviderMod.SamlProviderState
...
class SamlProvider protected ()
  extends typingsSlinky.atPulumiAws.iamSamlProviderMod.SamlProvider {
  /**
...
object SamlProvider extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamSamlProviderMod.SamlProvider = js.native
  def get(name: String, id: Input[ID], state: SamlProviderState): typingsSlinky.atPulumiAws.iamSamlProviderMod.SamlProvider = js.native
  def get(name: String, id: Input[ID], state: SamlProviderState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamSamlProviderMod.SamlProvider = js.native
  /**
