...
import typingsSlinky.atPulumiAws.iamUserPolicyAttachmentMod.UserPolicyAttachmentArgs
import typingsSlinky.atPulumiAws.iamUserPolicyAttachmentMod.UserPolicyAttachmentState
...
class UserPolicyAttachment protected ()
  extends typingsSlinky.atPulumiAws.iamUserPolicyAttachmentMod.UserPolicyAttachment {
  /**
...
object UserPolicyAttachment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamUserPolicyAttachmentMod.UserPolicyAttachment = js.native
  def get(name: String, id: Input[ID], state: UserPolicyAttachmentState): typingsSlinky.atPulumiAws.iamUserPolicyAttachmentMod.UserPolicyAttachment = js.native
  def get(name: String, id: Input[ID], state: UserPolicyAttachmentState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamUserPolicyAttachmentMod.UserPolicyAttachment = js.native
  /**
