...
import typingsSlinky.atPulumiAws.iamGroupPolicyAttachmentMod.GroupPolicyAttachmentArgs
import typingsSlinky.atPulumiAws.iamGroupPolicyAttachmentMod.GroupPolicyAttachmentState
...
class GroupPolicyAttachment protected ()
  extends typingsSlinky.atPulumiAws.iamGroupPolicyAttachmentMod.GroupPolicyAttachment {
  /**
...
object GroupPolicyAttachment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamGroupPolicyAttachmentMod.GroupPolicyAttachment = js.native
  def get(name: String, id: Input[ID], state: GroupPolicyAttachmentState): typingsSlinky.atPulumiAws.iamGroupPolicyAttachmentMod.GroupPolicyAttachment = js.native
  def get(name: String, id: Input[ID], state: GroupPolicyAttachmentState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamGroupPolicyAttachmentMod.GroupPolicyAttachment = js.native
  /**
