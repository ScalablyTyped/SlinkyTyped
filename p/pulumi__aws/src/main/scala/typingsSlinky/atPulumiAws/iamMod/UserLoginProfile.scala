...
import typingsSlinky.atPulumiAws.iamUserLoginProfileMod.UserLoginProfileArgs
import typingsSlinky.atPulumiAws.iamUserLoginProfileMod.UserLoginProfileState
...
class UserLoginProfile protected ()
  extends typingsSlinky.atPulumiAws.iamUserLoginProfileMod.UserLoginProfile {
  /**
...
object UserLoginProfile extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamUserLoginProfileMod.UserLoginProfile = js.native
  def get(name: String, id: Input[ID], state: UserLoginProfileState): typingsSlinky.atPulumiAws.iamUserLoginProfileMod.UserLoginProfile = js.native
  def get(name: String, id: Input[ID], state: UserLoginProfileState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamUserLoginProfileMod.UserLoginProfile = js.native
  /**
