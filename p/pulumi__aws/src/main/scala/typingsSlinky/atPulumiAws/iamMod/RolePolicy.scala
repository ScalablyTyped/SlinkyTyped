...
import typingsSlinky.atPulumiAws.iamRolePolicyMod.RolePolicyArgs
import typingsSlinky.atPulumiAws.iamRolePolicyMod.RolePolicyState
...
class RolePolicy protected ()
  extends typingsSlinky.atPulumiAws.iamRolePolicyMod.RolePolicy {
  /**
...
object RolePolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiAws.iamRolePolicyMod.RolePolicy = js.native
  def get(name: String, id: Input[ID], state: RolePolicyState): typingsSlinky.atPulumiAws.iamRolePolicyMod.RolePolicy = js.native
  def get(name: String, id: Input[ID], state: RolePolicyState, opts: CustomResourceOptions): typingsSlinky.atPulumiAws.iamRolePolicyMod.RolePolicy = js.native
  /**
