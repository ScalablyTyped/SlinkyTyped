...
@js.native
object ssmMod extends js.Object {
  @js.native
  class Activation protected ()
    extends typingsSlinky.atPulumiAws.ssmActivationMod.Activation {
    /**
  ...
  class Association protected ()
    extends typingsSlinky.atPulumiAws.ssmAssociationMod.Association {
    /**
  ...
  class Document protected ()
    extends typingsSlinky.atPulumiAws.ssmDocumentMod.Document {
    /**
  ...
  class MaintenanceWindow protected ()
    extends typingsSlinky.atPulumiAws.ssmMaintenanceWindowMod.MaintenanceWindow {
    /**
  ...
  class MaintenanceWindowTarget protected ()
    extends typingsSlinky.atPulumiAws.ssmMaintenanceWindowTargetMod.MaintenanceWindowTarget {
    /**
  ...
  class MaintenanceWindowTask protected ()
    extends typingsSlinky.atPulumiAws.ssmMaintenanceWindowTaskMod.MaintenanceWindowTask {
    /**
  ...
  class Parameter protected ()
    extends typingsSlinky.atPulumiAws.ssmParameterMod.Parameter {
    /**
  ...
  class PatchBaseline protected ()
    extends typingsSlinky.atPulumiAws.ssmPatchBaselineMod.PatchBaseline {
    /**
  ...
  class PatchGroup protected ()
    extends typingsSlinky.atPulumiAws.ssmPatchGroupMod.PatchGroup {
    /**
  ...
  class ResourceDataSync protected ()
    extends typingsSlinky.atPulumiAws.ssmResourceDataSyncMod.ResourceDataSync {
    /**
