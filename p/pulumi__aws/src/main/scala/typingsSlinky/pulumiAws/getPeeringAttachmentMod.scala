...
import typingsSlinky.pulumiAws.inputMod.ec2transitgateway.GetPeeringAttachmentFilter
...
object getPeeringAttachmentMod {
  ...
  trait GetPeeringAttachmentResult extends StObject {
    ...
    val filters: js.UndefOr[
        js.Array[typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetPeeringAttachmentFilter]
      ] = js.native
  ...
  object GetPeeringAttachmentResult {
    ...
    implicit class GetPeeringAttachmentResultMutableBuilder[Self <: GetPeeringAttachmentResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetPeeringAttachmentFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetPeeringAttachmentFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
