...
import typingsSlinky.pulumiAws.outputMod.s3.BucketOwnershipControlsRule
...
object bucketOwnershipControlsMod {
  ...
  trait BucketOwnershipControlsArgs extends StObject {
    ...
    /**
      * Configuration block(s) with Ownership Controls rules. Detailed below.
      */
    val rule: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketOwnershipControlsRule] = js.native
  }
  object BucketOwnershipControlsArgs {
    ...
    def apply(
      bucket: Input[String],
      rule: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketOwnershipControlsRule]
    ...
    implicit class BucketOwnershipControlsArgsMutableBuilder[Self <: BucketOwnershipControlsArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRule(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketOwnershipControlsRule]): Self = StObject.set(x, "rule", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait BucketOwnershipControlsState extends StObject {
    ...
    /**
      * Configuration block(s) with Ownership Controls rules. Detailed below.
      */
    val rule: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketOwnershipControlsRule]] = js.native
  }
