...
object daxClusterMod {
  ...
  trait ClusterArgs extends StObject {
    ...
    /**
      * Encrypt at rest options
      */
    val serverSideEncryption: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.dax.ClusterServerSideEncryption]] = js.native
  ...
  object ClusterArgs {
    ...
    implicit class ClusterArgsMutableBuilder[Self <: ClusterArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setServerSideEncryption(value: Input[typingsSlinky.pulumiAws.inputMod.dax.ClusterServerSideEncryption]): Self = StObject.set(x, "serverSideEncryption", value.asInstanceOf[js.Any])
  ...
  trait ClusterState extends StObject {
    ...
    /**
      ...
      * `${aws_dax_cluster.test.nodes.0.address}`
      */
    val nodes: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.dax.ClusterNode]]]] = js.native
  ...
  object ClusterState {
    ...
    implicit class ClusterStateMutableBuilder[Self <: ClusterState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNodes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.dax.ClusterNode]]]): Self = StObject.set(x, "nodes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNodesUndefined: Self = StObject.set(x, "nodes", js.undefined)
      
      @scala.inline
      def setNodesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.dax.ClusterNode]*): Self = StObject.set(x, "nodes", js.Array(value :_*))
