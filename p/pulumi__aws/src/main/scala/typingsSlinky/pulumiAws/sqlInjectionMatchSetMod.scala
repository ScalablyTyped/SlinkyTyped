...
import typingsSlinky.pulumiAws.outputMod.wafregional.SqlInjectionMatchSetSqlInjectionMatchTuple
  ...
  trait SqlInjectionMatchSetArgs extends StObject {
    ...
    val sqlInjectionMatchTuples: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.wafregional.SqlInjectionMatchSetSqlInjectionMatchTuple
            ]
          ]
        ]
      ] = js.native
