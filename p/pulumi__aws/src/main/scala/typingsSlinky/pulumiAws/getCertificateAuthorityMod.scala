...
object getCertificateAuthorityMod {
  ...
  trait GetCertificateAuthorityResult extends StObject {
    ...
    val revocationConfigurations: js.Array[
        typingsSlinky.pulumiAws.outputMod.acmpca.GetCertificateAuthorityRevocationConfiguration
      ] = js.native
  ...
  object GetCertificateAuthorityResult {
    ...
    implicit class GetCertificateAuthorityResultMutableBuilder[Self <: GetCertificateAuthorityResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRevocationConfigurationsVarargs(value: typingsSlinky.pulumiAws.outputMod.acmpca.GetCertificateAuthorityRevocationConfiguration*): Self = StObject.set(x, "revocationConfigurations", js.Array(value :_*))
