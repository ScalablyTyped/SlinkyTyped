...
object wafWebAclMod {
  ...
  trait WebAclArgs extends StObject {
    ...
    /**
      * Configuration block with action that you want AWS WAF to take when a request doesn't match the criteria in any of the rules that are associated with the web ACL. Detailed below.
      */
    val defaultAction: Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclDefaultAction] = js.native
    
    /**
      * Configuration block to enable WAF logging. Detailed below.
      */
    val loggingConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclLoggingConfiguration]] = js.native
    ...
    /**
      * Configuration blocks containing rules to associate with the web ACL and the settings for each rule. Detailed below.
      */
    val rules: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclRule]]]] = js.native
  ...
  object WebAclArgs {
    ...
    @scala.inline
    def apply(
      defaultAction: Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclDefaultAction],
    ...
    implicit class WebAclArgsMutableBuilder[Self <: WebAclArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultAction(value: Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclDefaultAction]): Self = StObject.set(x, "defaultAction", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLoggingConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclLoggingConfiguration]): Self = StObject.set(x, "loggingConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRules(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      @scala.inline
      def setRulesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
  ...
  trait WebAclState extends StObject {
    ...
    /**
      * Configuration block with action that you want AWS WAF to take when a request doesn't match the criteria in any of the rules that are associated with the web ACL. Detailed below.
      */
    val defaultAction: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.waf.WebAclDefaultAction]] = js.native
