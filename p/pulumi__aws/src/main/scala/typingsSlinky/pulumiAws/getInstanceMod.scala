...
import typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceMetadataOption
...
object getInstanceMod {
  ...
  trait GetInstanceResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceFilter]] = js.native
  ...
  object GetInstanceResult {
    ...
    implicit class GetInstanceResultMutableBuilder[Self <: GetInstanceResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
