...
object redshiftParameterGroupMod {
  ...
  object ParameterGroup {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/redshift/parameterGroup", "ParameterGroup.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/redshift/parameterGroup", "ParameterGroup.isInstance")
    @js.native
  ...
  trait ParameterGroupArgs extends StObject {
    ...
    val parameters: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.redshift.ParameterGroupParameter]]
        ]
      ] = js.native
  ...
  object ParameterGroupArgs {
    ...
    implicit class ParameterGroupArgsMutableBuilder[Self <: ParameterGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParametersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.redshift.ParameterGroupParameter]*): Self = StObject.set(x, "parameters", js.Array(value :_*))
