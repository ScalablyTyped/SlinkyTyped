...
import typingsSlinky.pulumiAws.outputMod.s3.InventoryDestination
import typingsSlinky.pulumiAws.outputMod.s3.InventoryFilter
import typingsSlinky.pulumiAws.outputMod.s3.InventorySchedule
