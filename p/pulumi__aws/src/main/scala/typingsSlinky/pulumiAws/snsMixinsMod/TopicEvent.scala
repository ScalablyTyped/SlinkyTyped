...
object TopicEvent {
  ...
  implicit class TopicEventOps[Self <: TopicEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRecordsVarargs(value: TopicRecord*): Self = this.set("Records", js.Array(value :_*))
    
    @scala.inline
    def setRecords(value: js.Array[TopicRecord]): Self = this.set("Records", value.asInstanceOf[js.Any])
  }
}
