...
import typingsSlinky.pulumiAws.outputMod.backup.SelectionSelectionTag
...
object selectionMod {
  ...
  trait SelectionArgs extends StObject {
    ...
    val selectionTags: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.SelectionSelectionTag]]]
      ] = js.native
  }
  object SelectionArgs {
    ...
    implicit class SelectionArgsMutableBuilder[Self <: SelectionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelectionTags(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.SelectionSelectionTag]]]): Self = StObject.set(x, "selectionTags", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectionTagsUndefined: Self = StObject.set(x, "selectionTags", js.undefined)
      
      @scala.inline
      def setSelectionTagsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.backup.SelectionSelectionTag]*): Self = StObject.set(x, "selectionTags", js.Array(value :_*))
    }
  }
