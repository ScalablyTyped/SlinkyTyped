...
import typingsSlinky.pulumiAws.outputMod.opsworks.StaticWebLayerEbsVolume
...
object staticWebLayerMod {
  ...
  class StaticWebLayer protected () extends CustomResource {
    ...
    /**
      ...
      */
    val ebsVolumes: Output_[js.UndefOr[js.Array[StaticWebLayerEbsVolume]]] = js.native
  ...
  object StaticWebLayer {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/staticWebLayer", "StaticWebLayer.get")
    @js.native
    def get(name: String, id: Input[ID]): StaticWebLayer = js.native
    @JSImport("@pulumi/aws/opsworks/staticWebLayer", "StaticWebLayer.get")
    @js.native
    def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): StaticWebLayer = js.native
    @JSImport("@pulumi/aws/opsworks/staticWebLayer", "StaticWebLayer.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/staticWebLayer", "StaticWebLayer.isInstance")
    @js.native
    def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/opsworks/staticWebLayer.StaticWebLayer */ Boolean = js.native
  }
  
  @js.native
  trait StaticWebLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.StaticWebLayerEbsVolume]]
        ]
      ] = js.native
  ...
  object StaticWebLayerArgs {
    ...
    @scala.inline
    implicit class StaticWebLayerArgsMutableBuilder[Self <: StaticWebLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.StaticWebLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  @js.native
  trait StaticWebLayerState extends StObject {
  ...
  object StaticWebLayerState {
    ...
    @scala.inline
    def apply(): StaticWebLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StaticWebLayerState]
    }
    
    @scala.inline
    implicit class StaticWebLayerStateMutableBuilder[Self <: StaticWebLayerState] (val x: Self) extends AnyVal {
