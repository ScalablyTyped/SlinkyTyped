...
@js.native
trait RepositoryPermissionsPolicyState extends js.Object {
...
object RepositoryPermissionsPolicyState {
  ...
  @scala.inline
  implicit class RepositoryPermissionsPolicyStateOps[Self <: RepositoryPermissionsPolicyState] (val x: Self) extends AnyVal {
