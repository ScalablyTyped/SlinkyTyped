...
import typingsSlinky.pulumiAws.inputMod.route53.GetResolverEndpointFilter
...
object getResolverEndpointMod {
  ...
  trait GetResolverEndpointResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.route53.GetResolverEndpointFilter]] = js.native
  ...
  object GetResolverEndpointResult {
    ...
    implicit class GetResolverEndpointResultMutableBuilder[Self <: GetResolverEndpointResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.route53.GetResolverEndpointFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.route53.GetResolverEndpointFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
