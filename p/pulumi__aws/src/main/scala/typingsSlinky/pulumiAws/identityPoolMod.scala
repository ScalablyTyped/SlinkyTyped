...
object identityPoolMod {
  ...
  trait IdentityPoolArgs extends StObject {
    ...
    val cognitoIdentityProviders: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.cognito.IdentityPoolCognitoIdentityProvider]
          ]
        ]
      ] = js.native
  ...
  object IdentityPoolArgs {
    ...
    implicit class IdentityPoolArgsMutableBuilder[Self <: IdentityPoolArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCognitoIdentityProvidersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.IdentityPoolCognitoIdentityProvider]*): Self = StObject.set(x, "cognitoIdentityProviders", js.Array(value :_*))
