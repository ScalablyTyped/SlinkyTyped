...
object getSubnetIdsMod {
  ...
  trait GetSubnetIdsResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetSubnetIdsFilter]] = js.native
  ...
  object GetSubnetIdsResult {
    ...
    implicit class GetSubnetIdsResultMutableBuilder[Self <: GetSubnetIdsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetSubnetIdsFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetSubnetIdsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
