...
import typingsSlinky.pulumiAws.inputMod.ec2transitgateway.GetVpcAttachmentFilter
...
object getVpcAttachmentMod {
  ...
  trait GetVpcAttachmentResult extends StObject {
    ...
    val filters: js.UndefOr[
        js.Array[typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetVpcAttachmentFilter]
      ] = js.native
  ...
  object GetVpcAttachmentResult {
    ...
    implicit class GetVpcAttachmentResultMutableBuilder[Self <: GetVpcAttachmentResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetVpcAttachmentFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetVpcAttachmentFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
