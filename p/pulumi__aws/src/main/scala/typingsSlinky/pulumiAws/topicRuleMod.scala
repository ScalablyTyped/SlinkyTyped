...
object topicRuleMod {
  ...
  trait TopicRuleArgs extends StObject {
    ...
    val cloudwatchAlarm: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleCloudwatchAlarm]] = js.native
    
    val cloudwatchMetric: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleCloudwatchMetric]] = js.native
    ...
    val dynamodb: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleDynamodb]] = js.native
    
    val dynamodbv2s: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleDynamodbv2]]]] = js.native
    
    val elasticsearch: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleElasticsearch]] = js.native
    ...
    /**
      * Configuration block with error action to be associated with the rule. See the documentation for `cloudwatchAlarm`, `cloudwatchMetric`, `dynamodb`, `dynamodbv2`, `elasticsearch`, `firehose`, `iotAnalytics`, `iotEvents`, `kinesis`, `lambda`, `republish`, `s3`, `stepFunctions`, `sns`, `sqs` configuration blocks for further configuration details.
      */
    val errorAction: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleErrorAction]] = js.native
    
    val firehose: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleFirehose]] = js.native
    
    val iotAnalytics: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotAnalytic]]]
      ] = js.native
    
    val iotEvents: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotEvent]]]] = js.native
    
    val kinesis: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleKinesis]] = js.native
    
    val lambda: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleLambda]] = js.native
    ...
    val republish: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleRepublish]] = js.native
    
    val s3: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleS3]] = js.native
    
    val sns: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleSns]] = js.native
    ...
    val sqs: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleSqs]] = js.native
    
    val stepFunctions: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleStepFunction]]]
      ] = js.native
  ...
  object TopicRuleArgs {
    ...
    implicit class TopicRuleArgsMutableBuilder[Self <: TopicRuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCloudwatchAlarm(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleCloudwatchAlarm]): Self = StObject.set(x, "cloudwatchAlarm", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCloudwatchAlarmUndefined: Self = StObject.set(x, "cloudwatchAlarm", js.undefined)
      
      @scala.inline
      def setCloudwatchMetric(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleCloudwatchMetric]): Self = StObject.set(x, "cloudwatchMetric", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDynamodb(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleDynamodb]): Self = StObject.set(x, "dynamodb", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDynamodbUndefined: Self = StObject.set(x, "dynamodb", js.undefined)
      
      @scala.inline
      def setDynamodbv2s(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleDynamodbv2]]]): Self = StObject.set(x, "dynamodbv2s", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDynamodbv2sUndefined: Self = StObject.set(x, "dynamodbv2s", js.undefined)
      
      @scala.inline
      def setDynamodbv2sVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleDynamodbv2]*): Self = StObject.set(x, "dynamodbv2s", js.Array(value :_*))
      
      @scala.inline
      def setElasticsearch(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleElasticsearch]): Self = StObject.set(x, "elasticsearch", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setErrorAction(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleErrorAction]): Self = StObject.set(x, "errorAction", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorActionUndefined: Self = StObject.set(x, "errorAction", js.undefined)
      
      @scala.inline
      def setFirehose(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleFirehose]): Self = StObject.set(x, "firehose", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFirehoseUndefined: Self = StObject.set(x, "firehose", js.undefined)
      
      @scala.inline
      def setIotAnalytics(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotAnalytic]]]): Self = StObject.set(x, "iotAnalytics", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIotAnalyticsUndefined: Self = StObject.set(x, "iotAnalytics", js.undefined)
      
      @scala.inline
      def setIotAnalyticsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotAnalytic]*): Self = StObject.set(x, "iotAnalytics", js.Array(value :_*))
      
      @scala.inline
      def setIotEvents(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotEvent]]]): Self = StObject.set(x, "iotEvents", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIotEventsUndefined: Self = StObject.set(x, "iotEvents", js.undefined)
      
      @scala.inline
      def setIotEventsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotEvent]*): Self = StObject.set(x, "iotEvents", js.Array(value :_*))
      
      @scala.inline
      def setKinesis(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleKinesis]): Self = StObject.set(x, "kinesis", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKinesisUndefined: Self = StObject.set(x, "kinesis", js.undefined)
      
      @scala.inline
      def setLambda(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleLambda]): Self = StObject.set(x, "lambda", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRepublish(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleRepublish]): Self = StObject.set(x, "republish", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRepublishUndefined: Self = StObject.set(x, "republish", js.undefined)
      
      @scala.inline
      def setS3(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleS3]): Self = StObject.set(x, "s3", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setS3Undefined: Self = StObject.set(x, "s3", js.undefined)
      
      @scala.inline
      def setSns(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleSns]): Self = StObject.set(x, "sns", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSqs(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleSqs]): Self = StObject.set(x, "sqs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSqsUndefined: Self = StObject.set(x, "sqs", js.undefined)
      
      @scala.inline
      def setStepFunctions(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleStepFunction]]]): Self = StObject.set(x, "stepFunctions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepFunctionsUndefined: Self = StObject.set(x, "stepFunctions", js.undefined)
      
      @scala.inline
      def setStepFunctionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.iot.TopicRuleStepFunction]*): Self = StObject.set(x, "stepFunctions", js.Array(value :_*))
