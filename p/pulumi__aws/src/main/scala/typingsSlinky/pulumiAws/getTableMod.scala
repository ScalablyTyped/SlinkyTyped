...
import typingsSlinky.pulumiAws.outputMod.dynamodb.GetTableReplica
...
object getTableMod {
  ...
  trait GetTableResult extends StObject {
    ...
    val serverSideEncryption: typingsSlinky.pulumiAws.outputMod.dynamodb.GetTableServerSideEncryption = js.native
  ...
  object GetTableResult {
    ...
    def apply(
      ...
      serverSideEncryption: typingsSlinky.pulumiAws.outputMod.dynamodb.GetTableServerSideEncryption,
      streamArn: String,
    ...
    implicit class GetTableResultMutableBuilder[Self <: GetTableResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setServerSideEncryption(value: typingsSlinky.pulumiAws.outputMod.dynamodb.GetTableServerSideEncryption): Self = StObject.set(x, "serverSideEncryption", value.asInstanceOf[js.Any])
