...
object ebsMod extends js.Object {
  ...
  class DefaultKmsKey protected ()
    extends typingsSlinky.pulumiAws.defaultKmsKeyMod.DefaultKmsKey {
    /**
  ...
  class EncryptionByDefault protected ()
    extends typingsSlinky.pulumiAws.encryptionByDefaultMod.EncryptionByDefault {
    /**
  ...
  class Snapshot protected ()
    extends typingsSlinky.pulumiAws.snapshotMod.Snapshot {
    /**
  ...
  class SnapshotCopy protected ()
    extends typingsSlinky.pulumiAws.snapshotCopyMod.SnapshotCopy {
    /**
  ...
  class Volume protected ()
    extends typingsSlinky.pulumiAws.volumeMod.Volume {
    /**
