...
import typingsSlinky.pulumiAws.outputMod.glue.UserDefinedFunctionResourceUri
...
object userDefinedFunctionMod {
  ...
  trait UserDefinedFunctionArgs extends StObject {
    ...
    val resourceUris: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.UserDefinedFunctionResourceUri]]
        ]
      ] = js.native
  }
  object UserDefinedFunctionArgs {
    ...
    implicit class UserDefinedFunctionArgsMutableBuilder[Self <: UserDefinedFunctionArgs] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "resourceUris", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResourceUrisUndefined: Self = StObject.set(x, "resourceUris", js.undefined)
      
      @scala.inline
      def setResourceUrisVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.UserDefinedFunctionResourceUri]*): Self = StObject.set(x, "resourceUris", js.Array(value :_*))
    }
  }
