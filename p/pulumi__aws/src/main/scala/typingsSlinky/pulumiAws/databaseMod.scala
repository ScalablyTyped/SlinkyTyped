...
import typingsSlinky.pulumiAws.outputMod.athena.DatabaseEncryptionConfiguration
...
object databaseMod {
  ...
  trait DatabaseArgs extends StObject {
    ...
    /**
      * The encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. An `encryptionConfiguration` block is documented below.
      */
    val encryptionConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.athena.DatabaseEncryptionConfiguration]] = js.native
  ...
  object DatabaseArgs {
    ...
    implicit class DatabaseArgsMutableBuilder[Self <: DatabaseArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptionConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.athena.DatabaseEncryptionConfiguration]): Self = StObject.set(x, "encryptionConfiguration", value.asInstanceOf[js.Any])
