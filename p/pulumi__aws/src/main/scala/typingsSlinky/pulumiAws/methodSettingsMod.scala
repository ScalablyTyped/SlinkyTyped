...
object methodSettingsMod {
  ...
  trait MethodSettingsArgs extends StObject {
    ...
    /**
      * The settings block, see below.
      */
    val settings: Input[typingsSlinky.pulumiAws.inputMod.apigateway.MethodSettingsSettings] = js.native
  ...
  object MethodSettingsArgs {
    ...
    def apply(
      ...
      settings: Input[typingsSlinky.pulumiAws.inputMod.apigateway.MethodSettingsSettings],
    ...
    implicit class MethodSettingsArgsMutableBuilder[Self <: MethodSettingsArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSettings(value: Input[typingsSlinky.pulumiAws.inputMod.apigateway.MethodSettingsSettings]): Self = StObject.set(x, "settings", value.asInstanceOf[js.Any])
  ...
  trait MethodSettingsState extends StObject {
    ...
    /**
      * The settings block, see below.
      */
    val settings: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigateway.MethodSettingsSettings]] = js.native
