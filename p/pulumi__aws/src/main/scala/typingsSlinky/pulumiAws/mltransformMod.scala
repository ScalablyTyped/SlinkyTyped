...
object mltransformMod {
  ...
  trait MLTransformArgs extends StObject {
    ...
    /**
      * A list of AWS Glue table definitions used by the transform. see Input Record Tables.
      */
    val inputRecordTables: Input[
        js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformInputRecordTable]]
      ] = js.native
    ...
    /**
      * The algorithmic parameters that are specific to the transform type used. Conditionally dependent on the transform type. see Parameters.
      */
    val parameters: Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformParameters] = js.native
  ...
  object MLTransformArgs {
    ...
    @scala.inline
    def apply(
      inputRecordTables: Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformInputRecordTable]]
        ],
      parameters: Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformParameters],
    ...
    implicit class MLTransformArgsMutableBuilder[Self <: MLTransformArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInputRecordTables(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformInputRecordTable]]
            ]
      ): Self = StObject.set(x, "inputRecordTables", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInputRecordTablesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformInputRecordTable]*): Self = StObject.set(x, "inputRecordTables", js.Array(value :_*))
      ...
      @scala.inline
      def setParameters(value: Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformParameters]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
  ...
  trait MLTransformState extends StObject {
    ...
    /**
      * The algorithmic parameters that are specific to the transform type used. Conditionally dependent on the transform type. see Parameters.
      */
    val parameters: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformParameters]] = js.native
    ...
    /**
      * The object that represents the schema that this transform accepts. see Schema.
      */
    val schemas: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformSchema]]]] = js.native
  ...
  object MLTransformState {
    ...
    implicit class MLTransformStateMutableBuilder[Self <: MLTransformState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSchemas(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformSchema]]]): Self = StObject.set(x, "schemas", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSchemasUndefined: Self = StObject.set(x, "schemas", js.undefined)
      
      @scala.inline
      def setSchemasVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.MLTransformSchema]*): Self = StObject.set(x, "schemas", js.Array(value :_*))
