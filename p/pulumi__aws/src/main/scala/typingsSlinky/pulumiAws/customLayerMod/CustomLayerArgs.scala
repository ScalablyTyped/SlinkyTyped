...
object CustomLayerArgs {
  ...
  @scala.inline
  implicit class CustomLayerArgsOps[Self <: CustomLayerArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[CustomLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[CustomLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
    @scala.inline
