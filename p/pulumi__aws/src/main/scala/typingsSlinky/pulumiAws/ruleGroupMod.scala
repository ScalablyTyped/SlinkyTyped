...
object ruleGroupMod {
  ...
  trait RuleGroupArgs extends StObject {
    ...
    /**
      * A configuration block that defines the rule group rules. Required unless `rules` is specified. See Rule Group below for details.
      */
    val ruleGroup: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.RuleGroupRuleGroup]] = js.native
  ...
  object RuleGroupArgs {
    ...
    implicit class RuleGroupArgsMutableBuilder[Self <: RuleGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRuleGroup(value: Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.RuleGroupRuleGroup]): Self = StObject.set(x, "ruleGroup", value.asInstanceOf[js.Any])
