...
object elbLoadBalancerBackendServerPolicyMod {
  ...
  object LoadBalancerBackendServerPolicy {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elb/loadBalancerBackendServerPolicy", "LoadBalancerBackendServerPolicy.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elb/loadBalancerBackendServerPolicy", "LoadBalancerBackendServerPolicy.isInstance")
    @js.native
