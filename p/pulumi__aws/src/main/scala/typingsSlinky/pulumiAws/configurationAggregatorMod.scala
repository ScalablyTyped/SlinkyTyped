...
import typingsSlinky.pulumiAws.outputMod.cfg.ConfigurationAggregatorAccountAggregationSource
import typingsSlinky.pulumiAws.outputMod.cfg.ConfigurationAggregatorOrganizationAggregationSource
...
object configurationAggregatorMod {
  ...
  trait ConfigurationAggregatorArgs extends StObject {
    ...
    val accountAggregationSource: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.cfg.ConfigurationAggregatorAccountAggregationSource
        ]
      ] = js.native
    ...
    val organizationAggregationSource: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.cfg.ConfigurationAggregatorOrganizationAggregationSource
        ]
      ] = js.native
  ...
  object ConfigurationAggregatorArgs {
    ...
    implicit class ConfigurationAggregatorArgsMutableBuilder[Self <: ConfigurationAggregatorArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccountAggregationSource(
        value: Input[
              typingsSlinky.pulumiAws.inputMod.cfg.ConfigurationAggregatorAccountAggregationSource
            ]
      ): Self = StObject.set(x, "accountAggregationSource", value.asInstanceOf[js.Any])
