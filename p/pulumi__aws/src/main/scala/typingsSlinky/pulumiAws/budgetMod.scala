...
object budgetMod {
  ...
  trait BudgetArgs extends StObject {
    ...
    /**
      * Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions..
      */
    val costTypes: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.budgets.BudgetCostTypes]] = js.native
    ...
    val notifications: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.budgets.BudgetNotification]]]
      ] = js.native
  ...
  object BudgetArgs {
    ...
    implicit class BudgetArgsMutableBuilder[Self <: BudgetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCostTypes(value: Input[typingsSlinky.pulumiAws.inputMod.budgets.BudgetCostTypes]): Self = StObject.set(x, "costTypes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNotifications(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.budgets.BudgetNotification]]]): Self = StObject.set(x, "notifications", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNotificationsUndefined: Self = StObject.set(x, "notifications", js.undefined)
      
      @scala.inline
      def setNotificationsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.budgets.BudgetNotification]*): Self = StObject.set(x, "notifications", js.Array(value :_*))
