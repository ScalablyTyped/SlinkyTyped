...
import typingsSlinky.pulumiAws.outputMod.lambda.EventSourceMappingDestinationConfig
...
object eventSourceMappingMod {
  ...
  trait EventSourceMappingArgs extends StObject {
    ...
    val destinationConfig: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.lambda.EventSourceMappingDestinationConfig]
      ] = js.native
  ...
  object EventSourceMappingArgs {
    ...
    implicit class EventSourceMappingArgsMutableBuilder[Self <: EventSourceMappingArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDestinationConfig(value: Input[typingsSlinky.pulumiAws.inputMod.lambda.EventSourceMappingDestinationConfig]): Self = StObject.set(x, "destinationConfig", value.asInstanceOf[js.Any])
