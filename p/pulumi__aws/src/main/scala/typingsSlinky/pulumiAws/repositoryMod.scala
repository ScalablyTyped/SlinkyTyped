...
object repositoryMod {
  ...
  trait RepositoryArgs extends StObject {
    ...
    /**
      * An array of external connections associated with the repository. Only one external connection can be set per repository. see External Connections.
      */
    val externalConnections: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.codeartifact.RepositoryExternalConnections]
      ] = js.native
    ...
    val upstreams: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.codeartifact.RepositoryUpstream]]
        ]
      ] = js.native
  }
  object RepositoryArgs {
    ...
    implicit class RepositoryArgsMutableBuilder[Self <: RepositoryArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExternalConnections(value: Input[typingsSlinky.pulumiAws.inputMod.codeartifact.RepositoryExternalConnections]): Self = StObject.set(x, "externalConnections", value.asInstanceOf[js.Any])
      ...
      ): Self = StObject.set(x, "upstreams", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUpstreamsUndefined: Self = StObject.set(x, "upstreams", js.undefined)
      
      @scala.inline
      def setUpstreamsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.codeartifact.RepositoryUpstream]*): Self = StObject.set(x, "upstreams", js.Array(value :_*))
    }
  }
