...
import typingsSlinky.pulumiAws.outputMod.alb.LoadBalancerAccessLogs
import typingsSlinky.pulumiAws.outputMod.alb.LoadBalancerSubnetMapping
...
object loadBalancerMod {
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    /**
      * An Access Logs block. Access Logs documented below.
      */
    val accessLogs: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.alb.LoadBalancerAccessLogs]] = js.native
    ...
    val subnetMappings: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.alb.LoadBalancerSubnetMapping]]]
      ] = js.native
  ...
  object LoadBalancerArgs {
    ...
    implicit class LoadBalancerArgsMutableBuilder[Self <: LoadBalancerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogs(value: Input[typingsSlinky.pulumiAws.inputMod.alb.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubnetMappings(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.alb.LoadBalancerSubnetMapping]]]): Self = StObject.set(x, "subnetMappings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubnetMappingsUndefined: Self = StObject.set(x, "subnetMappings", js.undefined)
      
      @scala.inline
      def setSubnetMappingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.alb.LoadBalancerSubnetMapping]*): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
