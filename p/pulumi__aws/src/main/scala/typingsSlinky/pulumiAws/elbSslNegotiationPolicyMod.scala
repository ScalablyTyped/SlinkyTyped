...
object elbSslNegotiationPolicyMod {
  ...
  trait SslNegotiationPolicyArgs extends StObject {
    ...
    val attributes: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.elb.SslNegotiationPolicyAttribute]]
        ]
      ] = js.native
  ...
  object SslNegotiationPolicyArgs {
    ...
    implicit class SslNegotiationPolicyArgsMutableBuilder[Self <: SslNegotiationPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttributesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elb.SslNegotiationPolicyAttribute]*): Self = StObject.set(x, "attributes", js.Array(value :_*))
