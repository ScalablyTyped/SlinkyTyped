...
object inventoryMod {
  ...
  trait InventoryArgs extends StObject {
    ...
    /**
      * Contains information about where to publish the inventory results (documented below).
      */
    val destination: Input[typingsSlinky.pulumiAws.inputMod.s3.InventoryDestination] = js.native
    ...
    /**
      * Specifies an inventory filter. The inventory only includes objects that meet the filter's criteria (documented below).
      */
    val filter: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.InventoryFilter]] = js.native
    ...
    /**
      * Specifies the schedule for generating inventory results (documented below).
      */
    val schedule: Input[typingsSlinky.pulumiAws.inputMod.s3.InventorySchedule] = js.native
  }
  object InventoryArgs {
    ...
    def apply(
      bucket: Input[String],
      destination: Input[typingsSlinky.pulumiAws.inputMod.s3.InventoryDestination],
      includedObjectVersions: Input[String],
      schedule: Input[typingsSlinky.pulumiAws.inputMod.s3.InventorySchedule]
    ): InventoryArgs = {
    ...
    implicit class InventoryArgsMutableBuilder[Self <: InventoryArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDestination(value: Input[typingsSlinky.pulumiAws.inputMod.s3.InventoryDestination]): Self = StObject.set(x, "destination", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilter(value: Input[typingsSlinky.pulumiAws.inputMod.s3.InventoryFilter]): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSchedule(value: Input[typingsSlinky.pulumiAws.inputMod.s3.InventorySchedule]): Self = StObject.set(x, "schedule", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait InventoryState extends StObject {
    ...
    /**
      * Contains information about where to publish the inventory results (documented below).
      */
    val destination: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.InventoryDestination]] = js.native
    ...
    /**
      * Specifies the schedule for generating inventory results (documented below).
      */
    val schedule: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.InventorySchedule]] = js.native
  }
