...
import typingsSlinky.pulumiAws.outputMod.acmpca.CertificateAuthorityCertificateAuthorityConfiguration
import typingsSlinky.pulumiAws.outputMod.acmpca.CertificateAuthorityRevocationConfiguration
...
object certificateAuthorityMod {
  ...
  trait CertificateAuthorityArgs extends StObject {
    ...
    val certificateAuthorityConfiguration: Input[
        typingsSlinky.pulumiAws.inputMod.acmpca.CertificateAuthorityCertificateAuthorityConfiguration
      ] = js.native
    ...
    val revocationConfiguration: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.acmpca.CertificateAuthorityRevocationConfiguration
        ]
      ] = js.native
  ...
  object CertificateAuthorityArgs {
    ...
    implicit class CertificateAuthorityArgsMutableBuilder[Self <: CertificateAuthorityArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRevocationConfiguration(
        value: Input[
              typingsSlinky.pulumiAws.inputMod.acmpca.CertificateAuthorityRevocationConfiguration
            ]
      ): Self = StObject.set(x, "revocationConfiguration", value.asInstanceOf[js.Any])
