...
object wafRuleMod {
  ...
  trait RuleArgs extends StObject {
    ...
    /**
      * The objects to include in a rule (documented below).
      */
    val predicates: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.RulePredicate]]]] = js.native
  ...
  object RuleArgs {
    ...
    implicit class RuleArgsMutableBuilder[Self <: RuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPredicates(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.RulePredicate]]]): Self = StObject.set(x, "predicates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPredicatesUndefined: Self = StObject.set(x, "predicates", js.undefined)
      
      @scala.inline
      def setPredicatesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.waf.RulePredicate]*): Self = StObject.set(x, "predicates", js.Array(value :_*))
