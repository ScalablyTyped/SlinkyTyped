...
import typingsSlinky.pulumiAws.outputMod.elasticache.ReplicationGroupClusterMode
...
object replicationGroupMod {
  ...
  trait ReplicationGroupArgs extends StObject {
    ...
    /**
      * Create a native redis cluster. `automaticFailoverEnabled` must be set to true. Cluster Mode documented below. Only 1 `clusterMode` block is allowed.
      */
    val clusterMode: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticache.ReplicationGroupClusterMode]] = js.native
  ...
  object ReplicationGroupArgs {
    ...
    implicit class ReplicationGroupArgsMutableBuilder[Self <: ReplicationGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClusterMode(value: Input[typingsSlinky.pulumiAws.inputMod.elasticache.ReplicationGroupClusterMode]): Self = StObject.set(x, "clusterMode", value.asInstanceOf[js.Any])
