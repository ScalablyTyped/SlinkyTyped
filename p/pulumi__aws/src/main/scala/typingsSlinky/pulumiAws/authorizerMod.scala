...
object authorizerMod {
  ...
  trait AuthorizerArgs extends StObject {
    ...
    /**
      ...
      * Supported only for HTTP APIs.
      */
    val jwtConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigatewayv2.AuthorizerJwtConfiguration]] = js.native
  ...
  object AuthorizerArgs {
    ...
    implicit class AuthorizerArgsMutableBuilder[Self <: AuthorizerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setJwtConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.apigatewayv2.AuthorizerJwtConfiguration]): Self = StObject.set(x, "jwtConfiguration", value.asInstanceOf[js.Any])
