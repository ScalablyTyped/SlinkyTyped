...
object glueSecurityConfigurationMod {
  ...
  trait SecurityConfigurationArgs extends StObject {
    ...
    /**
      * Configuration block containing encryption configuration. Detailed below.
      */
    val encryptionConfiguration: Input[
        typingsSlinky.pulumiAws.inputMod.glue.SecurityConfigurationEncryptionConfiguration
      ] = js.native
  ...
  object SecurityConfigurationArgs {
    ...
    implicit class SecurityConfigurationArgsMutableBuilder[Self <: SecurityConfigurationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptionConfiguration(
        value: Input[
              typingsSlinky.pulumiAws.inputMod.glue.SecurityConfigurationEncryptionConfiguration
            ]
      ): Self = StObject.set(x, "encryptionConfiguration", value.asInstanceOf[js.Any])
