...
object hostedPrivateVirtualInterfaceMod {
  ...
  object HostedPrivateVirtualInterface {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/directconnect/hostedPrivateVirtualInterface", "HostedPrivateVirtualInterface.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/directconnect/hostedPrivateVirtualInterface", "HostedPrivateVirtualInterface.isInstance")
    @js.native
