...
import typingsSlinky.pulumiAws.inputMod.ec2.GetVpcEndpointServiceFilter
...
object getVpcEndpointServiceMod {
  ...
  trait GetVpcEndpointServiceResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetVpcEndpointServiceFilter]] = js.native
  ...
  object GetVpcEndpointServiceResult {
    ...
    implicit class GetVpcEndpointServiceResultMutableBuilder[Self <: GetVpcEndpointServiceResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetVpcEndpointServiceFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetVpcEndpointServiceFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
