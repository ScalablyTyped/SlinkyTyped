...
object applicationloadbalancingLoadBalancerMod {
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    val accessLogs: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.LoadBalancerAccessLogs]
      ] = js.native
    ...
    val subnetMappings: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.LoadBalancerSubnetMapping
            ]
          ]
        ]
      ] = js.native
  ...
  object LoadBalancerArgs {
    ...
    implicit class LoadBalancerArgsMutableBuilder[Self <: LoadBalancerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogs(value: Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
