...
object RuleGroupRuleStatementAndStatementStatementRegexPatternSetReferenceStatement {
  ...
  implicit class RuleGroupRuleStatementAndStatementStatementRegexPatternSetReferenceStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementRegexPatternSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementAndStatementStatementRegexPatternSetReferenceStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
