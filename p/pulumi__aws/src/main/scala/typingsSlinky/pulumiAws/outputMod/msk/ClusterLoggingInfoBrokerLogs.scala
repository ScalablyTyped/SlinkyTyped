...
object ClusterLoggingInfoBrokerLogs {
  ...
  implicit class ClusterLoggingInfoBrokerLogsOps[Self <: ClusterLoggingInfoBrokerLogs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCloudwatchLogs(value: ClusterLoggingInfoBrokerLogsCloudwatchLogs): Self = this.set("cloudwatchLogs", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCloudwatchLogs: Self = this.set("cloudwatchLogs", js.undefined)
    @scala.inline
    def setFirehose(value: ClusterLoggingInfoBrokerLogsFirehose): Self = this.set("firehose", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFirehose: Self = this.set("firehose", js.undefined)
    @scala.inline
    def setS3(value: ClusterLoggingInfoBrokerLogsS3): Self = this.set("s3", value.asInstanceOf[js.Any])
    @scala.inline
