...
object ListenerDefaultAction {
  ...
  implicit class ListenerDefaultActionOps[Self <: ListenerDefaultAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuthenticateCognito(value: ListenerDefaultActionAuthenticateCognito): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withAuthenticateOidc(value: ListenerDefaultActionAuthenticateOidc): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFixedResponse(value: ListenerDefaultActionFixedResponse): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRedirect(value: ListenerDefaultActionRedirect): Self = {
        val ret = this.duplicate
