...
object EndpointConfigurationDataCaptureConfig {
  ...
  implicit class EndpointConfigurationDataCaptureConfigOps[Self <: EndpointConfigurationDataCaptureConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCaptureOptionsVarargs(value: EndpointConfigurationDataCaptureConfigCaptureOption*): Self = this.set("captureOptions", js.Array(value :_*))
    
    @scala.inline
    def setCaptureOptions(value: js.Array[EndpointConfigurationDataCaptureConfigCaptureOption]): Self = this.set("captureOptions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDestinationS3Uri(value: String): Self = this.set("destinationS3Uri", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialSamplingPercentage(value: Double): Self = this.set("initialSamplingPercentage", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCaptureContentTypeHeader(value: EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader): Self = this.set("captureContentTypeHeader", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCaptureContentTypeHeader: Self = this.set("captureContentTypeHeader", js.undefined)
    
    @scala.inline
    def setEnableCapture(value: Boolean): Self = this.set("enableCapture", value.asInstanceOf[js.Any])
