...
@js.native
trait NodejsAppLayerEbsVolume extends StObject {
...
object NodejsAppLayerEbsVolume {
  ...
  @scala.inline
  def apply(mountPoint: String, numberOfDisks: Double, size: Double): NodejsAppLayerEbsVolume = {
  ...
  @scala.inline
  implicit class NodejsAppLayerEbsVolumeMutableBuilder[Self <: NodejsAppLayerEbsVolume] (val x: Self) extends AnyVal {
