package typingsSlinky.pulumiAws.outputMod.autoscalingplans
...
trait ScalingPlanScalingInstruction extends js.Object {
  ...
  /**
    ...
    */
  var customizedLoadMetricSpecification: js.UndefOr[ScalingPlanScalingInstructionCustomizedLoadMetricSpecification] = js.native
  
  /**
    * Boolean controlling whether dynamic scaling by AWS Auto Scaling is disabled. Defaults to `false`.
    */
  var disableDynamicScaling: js.UndefOr[Boolean] = js.native
  ...
  /**
    ...
    */
  var minCapacity: Double = js.native
  ...
  /**
    ...
    */
  var predefinedLoadMetricSpecification: js.UndefOr[ScalingPlanScalingInstructionPredefinedLoadMetricSpecification] = js.native
  
  /**
    * Defines the behavior that should be applied if the forecast capacity approaches or exceeds the maximum capacity specified for the resource.
    * Valid values: `SetForecastCapacityToMaxCapacity`, `SetMaxCapacityAboveForecastCapacity`, `SetMaxCapacityToForecastCapacity`.
    */
  var predictiveScalingMaxCapacityBehavior: js.UndefOr[String] = js.native
  
  /**
    * The size of the capacity buffer to use when the forecast capacity is close to or exceeds the maximum capacity.
    */
  var predictiveScalingMaxCapacityBuffer: js.UndefOr[Double] = js.native
  
  /**
    * The predictive scaling mode. Valid values: `ForecastAndScale`, `ForecastOnly`.
    */
  var predictiveScalingMode: js.UndefOr[String] = js.native
  ...
  /**
    ...
    */
  var scalableDimension: String = js.native
  
  /**
    * Controls whether a resource's externally created scaling policies are kept or replaced. Valid values: `KeepExternalPolicies`, `ReplaceExternalPolicies`. Defaults to `KeepExternalPolicies`.
    */
  var scalingPolicyUpdateBehavior: js.UndefOr[String] = js.native
  
  /**
    * The amount of time, in seconds, to buffer the run time of scheduled scaling actions when scaling out.
    */
  var scheduledActionBufferTime: js.UndefOr[Double] = js.native
  ...
  /**
    ...
    */
  var targetTrackingConfigurations: js.Array[ScalingPlanScalingInstructionTargetTrackingConfiguration] = js.native
}
object ScalingPlanScalingInstruction {
  ...
  implicit class ScalingPlanScalingInstructionOps[Self <: ScalingPlanScalingInstruction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScalableDimension(value: String): Self = this.set("scalableDimension", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setServiceNamespace(value: String): Self = this.set("serviceNamespace", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTargetTrackingConfigurationsVarargs(value: ScalingPlanScalingInstructionTargetTrackingConfiguration*): Self = this.set("targetTrackingConfigurations", js.Array(value :_*))
    
    @scala.inline
    def setTargetTrackingConfigurations(value: js.Array[ScalingPlanScalingInstructionTargetTrackingConfiguration]): Self = this.set("targetTrackingConfigurations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomizedLoadMetricSpecification(value: ScalingPlanScalingInstructionCustomizedLoadMetricSpecification): Self = this.set("customizedLoadMetricSpecification", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCustomizedLoadMetricSpecification: Self = this.set("customizedLoadMetricSpecification", js.undefined)
    
    @scala.inline
    def setDisableDynamicScaling(value: Boolean): Self = this.set("disableDynamicScaling", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDisableDynamicScaling: Self = this.set("disableDynamicScaling", js.undefined)
    
    @scala.inline
    def setPredefinedLoadMetricSpecification(value: ScalingPlanScalingInstructionPredefinedLoadMetricSpecification): Self = this.set("predefinedLoadMetricSpecification", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePredefinedLoadMetricSpecification: Self = this.set("predefinedLoadMetricSpecification", js.undefined)
    
    @scala.inline
    def setPredictiveScalingMaxCapacityBehavior(value: String): Self = this.set("predictiveScalingMaxCapacityBehavior", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePredictiveScalingMaxCapacityBehavior: Self = this.set("predictiveScalingMaxCapacityBehavior", js.undefined)
    
    @scala.inline
    def setPredictiveScalingMaxCapacityBuffer(value: Double): Self = this.set("predictiveScalingMaxCapacityBuffer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePredictiveScalingMaxCapacityBuffer: Self = this.set("predictiveScalingMaxCapacityBuffer", js.undefined)
    
    @scala.inline
    def setPredictiveScalingMode(value: String): Self = this.set("predictiveScalingMode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePredictiveScalingMode: Self = this.set("predictiveScalingMode", js.undefined)
    
    @scala.inline
    def setScalingPolicyUpdateBehavior(value: String): Self = this.set("scalingPolicyUpdateBehavior", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteScalingPolicyUpdateBehavior: Self = this.set("scalingPolicyUpdateBehavior", js.undefined)
    
    @scala.inline
    def setScheduledActionBufferTime(value: Double): Self = this.set("scheduledActionBufferTime", value.asInstanceOf[js.Any])
