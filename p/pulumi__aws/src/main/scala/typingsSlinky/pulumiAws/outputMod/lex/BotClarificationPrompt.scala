...
object BotClarificationPrompt {
  ...
  implicit class BotClarificationPromptOps[Self <: BotClarificationPrompt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: BotClarificationPromptMessage*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: js.Array[BotClarificationPromptMessage]): Self = this.set("messages", value.asInstanceOf[js.Any])
