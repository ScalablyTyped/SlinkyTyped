...
object PolicyTargetTrackingScalingPolicyConfiguration {
  ...
  implicit class PolicyTargetTrackingScalingPolicyConfigurationOps[Self <: PolicyTargetTrackingScalingPolicyConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomizedMetricSpecification(value: PolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification): Self = this.set("customizedMetricSpecification", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPredefinedMetricSpecification(value: PolicyTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification): Self = this.set("predefinedMetricSpecification", value.asInstanceOf[js.Any])
    @scala.inline
