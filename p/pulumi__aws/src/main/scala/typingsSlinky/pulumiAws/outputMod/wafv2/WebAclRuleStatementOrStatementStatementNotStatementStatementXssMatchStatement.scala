...
@js.native
trait WebAclRuleStatementOrStatementStatementNotStatementStatementXssMatchStatement extends js.Object {
...
object WebAclRuleStatementOrStatementStatementNotStatementStatementXssMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementNotStatementStatementXssMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementNotStatementStatementXssMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementNotStatementStatementXssMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
