...
object ListenerRuleAction {
  ...
  implicit class ListenerRuleActionOps[Self <: ListenerRuleAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuthenticateCognito(value: ListenerRuleActionAuthenticateCognito): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withAuthenticateOidc(value: ListenerRuleActionAuthenticateOidc): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFixedResponse(value: ListenerRuleActionFixedResponse): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRedirect(value: ListenerRuleActionRedirect): Self = {
        val ret = this.duplicate
