...
object EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader {
  ...
  implicit class EndpointConfigurationDataCaptureConfigCaptureContentTypeHeaderOps[Self <: EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCsvContentTypesVarargs(value: String*): Self = this.set("csvContentTypes", js.Array(value :_*))
    
    @scala.inline
    def setCsvContentTypes(value: js.Array[String]): Self = this.set("csvContentTypes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCsvContentTypes: Self = this.set("csvContentTypes", js.undefined)
    
    @scala.inline
    def setJsonContentTypesVarargs(value: String*): Self = this.set("jsonContentTypes", js.Array(value :_*))
    
    @scala.inline
    def setJsonContentTypes(value: js.Array[String]): Self = this.set("jsonContentTypes", value.asInstanceOf[js.Any])
