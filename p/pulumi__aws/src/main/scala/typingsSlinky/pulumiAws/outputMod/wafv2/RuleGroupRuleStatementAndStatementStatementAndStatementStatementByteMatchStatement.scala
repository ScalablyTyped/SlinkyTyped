...
object RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatement {
  ...
  implicit class RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    def setTextTransformationsVarargs(
      value: RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementTextTransformation*
    ...
    @scala.inline
    def setFieldToMatch(
      value: RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementFieldToMatch
