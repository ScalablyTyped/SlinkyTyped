...
@js.native
trait RouteSpecHttp2RouteTimeoutIdle extends js.Object {
...
object RouteSpecHttp2RouteTimeoutIdle {
  ...
  @scala.inline
  implicit class RouteSpecHttp2RouteTimeoutIdleOps[Self <: RouteSpecHttp2RouteTimeoutIdle] (val x: Self) extends AnyVal {
