...
@js.native
trait VirtualNodeSpecListenerTimeoutTcp extends js.Object {
...
object VirtualNodeSpecListenerTimeoutTcp {
  ...
  @scala.inline
  implicit class VirtualNodeSpecListenerTimeoutTcpOps[Self <: VirtualNodeSpecListenerTimeoutTcp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdle(value: VirtualNodeSpecListenerTimeoutTcpIdle): Self = this.set("idle", value.asInstanceOf[js.Any])
