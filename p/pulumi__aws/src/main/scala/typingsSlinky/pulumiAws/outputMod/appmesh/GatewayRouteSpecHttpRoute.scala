...
object GatewayRouteSpecHttpRoute {
  ...
  implicit class GatewayRouteSpecHttpRouteOps[Self <: GatewayRouteSpecHttpRoute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAction(value: GatewayRouteSpecHttpRouteAction): Self = this.set("action", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMatch(value: GatewayRouteSpecHttpRouteMatch): Self = this.set("match", value.asInstanceOf[js.Any])
  }
}
