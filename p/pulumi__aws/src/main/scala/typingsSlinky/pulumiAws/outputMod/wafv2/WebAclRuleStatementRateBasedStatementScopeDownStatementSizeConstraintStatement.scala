...
@js.native
trait WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatement extends js.Object {
...
object WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatementOps[Self <: WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
