...
object WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
