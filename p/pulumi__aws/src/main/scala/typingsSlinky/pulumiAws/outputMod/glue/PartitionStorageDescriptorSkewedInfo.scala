...
@js.native
trait PartitionStorageDescriptorSkewedInfo extends js.Object {
...
object PartitionStorageDescriptorSkewedInfo {
  ...
  @scala.inline
  implicit class PartitionStorageDescriptorSkewedInfoOps[Self <: PartitionStorageDescriptorSkewedInfo] (val x: Self) extends AnyVal {
