...
object FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration {
  ...
  implicit class FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationOps[Self <: FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCloudwatchLoggingOptions(value: FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions): Self = this.set("cloudwatchLoggingOptions", value.asInstanceOf[js.Any])
    @scala.inline
