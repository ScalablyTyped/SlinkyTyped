...
@js.native
trait WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatement extends js.Object {
...
object WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatementOps[Self <: WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAndStatement(value: WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatementAndStatement): Self = this.set("andStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotStatement(value: WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatementNotStatement): Self = this.set("notStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNotStatement: Self = this.set("notStatement", js.undefined)
    
    @scala.inline
    def setOrStatement(value: WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementStatementOrStatement): Self = this.set("orStatement", value.asInstanceOf[js.Any])
