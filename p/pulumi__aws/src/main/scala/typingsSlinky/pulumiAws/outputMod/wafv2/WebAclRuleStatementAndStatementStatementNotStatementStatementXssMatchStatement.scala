...
object WebAclRuleStatementAndStatementStatementNotStatementStatementXssMatchStatement {
  ...
  implicit class WebAclRuleStatementAndStatementStatementNotStatementStatementXssMatchStatementOps[Self <: WebAclRuleStatementAndStatementStatementNotStatementStatementXssMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementAndStatementStatementNotStatementStatementXssMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
