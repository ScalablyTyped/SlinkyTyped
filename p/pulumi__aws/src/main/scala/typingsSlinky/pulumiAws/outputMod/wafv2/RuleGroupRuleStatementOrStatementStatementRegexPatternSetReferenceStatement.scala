...
object RuleGroupRuleStatementOrStatementStatementRegexPatternSetReferenceStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementRegexPatternSetReferenceStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementRegexPatternSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementOrStatementStatementRegexPatternSetReferenceStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
