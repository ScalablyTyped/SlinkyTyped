...
@js.native
trait IntentRejectionStatementMessage extends js.Object {
...
object IntentRejectionStatementMessage {
  ...
  @scala.inline
  implicit class IntentRejectionStatementMessageOps[Self <: IntentRejectionStatementMessage] (val x: Self) extends AnyVal {
