...
trait VirtualNodeSpecListenerTimeoutHttp extends js.Object {
  ...
  /**
    ...
    */
  var idle: js.UndefOr[VirtualNodeSpecListenerTimeoutHttpIdle] = js.native
  
  /**
    * The per request timeout.
    */
  var perRequest: js.UndefOr[VirtualNodeSpecListenerTimeoutHttpPerRequest] = js.native
}
object VirtualNodeSpecListenerTimeoutHttp {
  ...
  implicit class VirtualNodeSpecListenerTimeoutHttpOps[Self <: VirtualNodeSpecListenerTimeoutHttp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdle(value: VirtualNodeSpecListenerTimeoutHttpIdle): Self = this.set("idle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIdle: Self = this.set("idle", js.undefined)
    
    @scala.inline
    def setPerRequest(value: VirtualNodeSpecListenerTimeoutHttpPerRequest): Self = this.set("perRequest", value.asInstanceOf[js.Any])
