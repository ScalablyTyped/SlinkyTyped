...
@js.native
trait RouteSpecHttp2RouteRetryPolicyPerRetryTimeout extends js.Object {
...
object RouteSpecHttp2RouteRetryPolicyPerRetryTimeout {
  ...
  @scala.inline
  implicit class RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutOps[Self <: RouteSpecHttp2RouteRetryPolicyPerRetryTimeout] (val x: Self) extends AnyVal {
