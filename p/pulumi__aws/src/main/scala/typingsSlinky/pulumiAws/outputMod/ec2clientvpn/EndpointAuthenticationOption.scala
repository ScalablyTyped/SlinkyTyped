...
object EndpointAuthenticationOption {
  ...
  implicit class EndpointAuthenticationOptionOps[Self <: EndpointAuthenticationOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveDirectoryId(value: String): Self = this.set("activeDirectoryId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteActiveDirectoryId: Self = this.set("activeDirectoryId", js.undefined)
    @scala.inline
    def setRootCertificateChainArn(value: String): Self = this.set("rootCertificateChainArn", value.asInstanceOf[js.Any])
    @scala.inline
