...
object TaskOptions {
  ...
  implicit class TaskOptionsOps[Self <: TaskOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAtime(value: String): Self = {
    ...
    @scala.inline
    def withPosixPermissions(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreserveDeletedFiles(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreserveDevices(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVerifyMode(value: String): Self = {
        val ret = this.duplicate
