...
@js.native
trait MemcachedLayerEbsVolume extends StObject {
...
object MemcachedLayerEbsVolume {
  ...
  @scala.inline
  implicit class MemcachedLayerEbsVolumeMutableBuilder[Self <: MemcachedLayerEbsVolume] (val x: Self) extends AnyVal {
