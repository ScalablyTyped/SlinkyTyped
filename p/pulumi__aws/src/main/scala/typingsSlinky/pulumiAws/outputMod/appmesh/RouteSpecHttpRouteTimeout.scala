...
object RouteSpecHttpRouteTimeout {
  ...
  implicit class RouteSpecHttpRouteTimeoutOps[Self <: RouteSpecHttpRouteTimeout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdle(value: RouteSpecHttpRouteTimeoutIdle): Self = this.set("idle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIdle: Self = this.set("idle", js.undefined)
    
    @scala.inline
    def setPerRequest(value: RouteSpecHttpRouteTimeoutPerRequest): Self = this.set("perRequest", value.asInstanceOf[js.Any])
