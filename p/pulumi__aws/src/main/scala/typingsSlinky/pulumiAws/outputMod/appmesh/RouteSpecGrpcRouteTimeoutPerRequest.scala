...
@js.native
trait RouteSpecGrpcRouteTimeoutPerRequest extends js.Object {
...
object RouteSpecGrpcRouteTimeoutPerRequest {
  ...
  @scala.inline
  implicit class RouteSpecGrpcRouteTimeoutPerRequestOps[Self <: RouteSpecGrpcRouteTimeoutPerRequest] (val x: Self) extends AnyVal {
