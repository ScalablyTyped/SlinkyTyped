...
trait WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatement extends js.Object {
  ...
  /**
    ...
    */
  var statements: js.Array[WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatement] = js.native
}
object WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementOps[Self <: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatement*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: js.Array[WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatement]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
