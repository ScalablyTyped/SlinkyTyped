...
object WebAclDefaultAction {
  ...
  implicit class WebAclDefaultActionOps[Self <: WebAclDefaultAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllow(value: WebAclDefaultActionAllow): Self = this.set("allow", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllow: Self = this.set("allow", js.undefined)
    
    @scala.inline
    def setBlock(value: WebAclDefaultActionBlock): Self = this.set("block", value.asInstanceOf[js.Any])
