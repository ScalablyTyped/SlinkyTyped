...
@js.native
trait RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatch extends js.Object {
...
object RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatch {
  ...
  @scala.inline
  def apply(): RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatch]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchOps[Self <: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    def setAllQueryArguments(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchAllQueryArguments
    ...
    @scala.inline
    def setBody(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchBody
    ...
    @scala.inline
    def setMethod(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchMethod
    ...
    @scala.inline
    def setQueryString(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchQueryString
    ...
    @scala.inline
    def setSingleHeader(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchSingleHeader
    ...
    def setSingleQueryArgument(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchSingleQueryArgument
    ...
    @scala.inline
    def setUriPath(
      value: RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatchUriPath
