...
@js.native
trait WebAclRuleStatementOrStatementStatementNotStatementStatementByteMatchStatement extends js.Object {
...
object WebAclRuleStatementOrStatementStatementNotStatementStatementByteMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementNotStatementStatementByteMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementNotStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementNotStatementStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
