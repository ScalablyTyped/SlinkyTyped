...
object ProxyDefaultTargetGroupConnectionPoolConfig {
  ...
  implicit class ProxyDefaultTargetGroupConnectionPoolConfigOps[Self <: ProxyDefaultTargetGroupConnectionPoolConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConnectionBorrowTimeout(value: Double): Self = this.set("connectionBorrowTimeout", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxConnectionsPercent(value: Double): Self = this.set("maxConnectionsPercent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaxConnectionsPercent: Self = this.set("maxConnectionsPercent", js.undefined)
    
    @scala.inline
    def setMaxIdleConnectionsPercent(value: Double): Self = this.set("maxIdleConnectionsPercent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSessionPinningFilters(value: js.Array[String]): Self = this.set("sessionPinningFilters", value.asInstanceOf[js.Any])
