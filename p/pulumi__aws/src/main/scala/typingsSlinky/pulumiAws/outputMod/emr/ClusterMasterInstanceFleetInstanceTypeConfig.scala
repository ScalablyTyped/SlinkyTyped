...
trait ClusterMasterInstanceFleetInstanceTypeConfig extends js.Object {
  ...
  /**
    ...
    */
  var configurations: js.UndefOr[js.Array[ClusterMasterInstanceFleetInstanceTypeConfigConfiguration]] = js.native
  
  /**
    * Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
    */
  var ebsConfigs: js.Array[ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig] = js.native
...
object ClusterMasterInstanceFleetInstanceTypeConfig {
  ...
  implicit class ClusterMasterInstanceFleetInstanceTypeConfigOps[Self <: ClusterMasterInstanceFleetInstanceTypeConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEbsConfigsVarargs(value: ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig*): Self = this.set("ebsConfigs", js.Array(value :_*))
    
    @scala.inline
    def setEbsConfigs(value: js.Array[ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig]): Self = this.set("ebsConfigs", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setConfigurationsVarargs(value: ClusterMasterInstanceFleetInstanceTypeConfigConfiguration*): Self = this.set("configurations", js.Array(value :_*))
    
    @scala.inline
    def setConfigurations(value: js.Array[ClusterMasterInstanceFleetInstanceTypeConfigConfiguration]): Self = this.set("configurations", value.asInstanceOf[js.Any])
