...
@js.native
trait RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig extends StObject {
...
object RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig {
  
  @scala.inline
  def apply(fallbackBehavior: String, headerName: String, position: String): RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig = {
    ...
    __obj.asInstanceOf[RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigMutableBuilder[Self <: RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig] (val x: Self) extends AnyVal {
