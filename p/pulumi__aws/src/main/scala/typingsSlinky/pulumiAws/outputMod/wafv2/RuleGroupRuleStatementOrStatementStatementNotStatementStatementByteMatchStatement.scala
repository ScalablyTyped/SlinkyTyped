...
object RuleGroupRuleStatementOrStatementStatementNotStatementStatementByteMatchStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementNotStatementStatementByteMatchStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementNotStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    def setTextTransformationsVarargs(
      value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementByteMatchStatementTextTransformation*
    ...
    @scala.inline
    def setFieldToMatch(
      value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementByteMatchStatementFieldToMatch
