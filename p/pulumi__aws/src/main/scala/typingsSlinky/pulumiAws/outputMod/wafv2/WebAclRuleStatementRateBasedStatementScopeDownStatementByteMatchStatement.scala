...
@js.native
trait WebAclRuleStatementRateBasedStatementScopeDownStatementByteMatchStatement extends js.Object {
...
object WebAclRuleStatementRateBasedStatementScopeDownStatementByteMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementOps[Self <: WebAclRuleStatementRateBasedStatementScopeDownStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    def setTextTransformationsVarargs(
      value: WebAclRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementTextTransformation*
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
