...
@js.native
trait RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatch extends js.Object {
...
object RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatch {
  ...
  @scala.inline
  def apply(): RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatch]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatchOps[Self <: RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
