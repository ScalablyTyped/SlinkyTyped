...
object WebAclRuleStatementNotStatementStatementNotStatementStatement {
  ...
  implicit class WebAclRuleStatementNotStatementStatementNotStatementStatementOps[Self <: WebAclRuleStatementNotStatementStatementNotStatementStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAndStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementAndStatement): Self = this.set("andStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAndStatement: Self = this.set("andStatement", js.undefined)
    
    @scala.inline
    def setByteMatchStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementByteMatchStatement): Self = this.set("byteMatchStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteByteMatchStatement: Self = this.set("byteMatchStatement", js.undefined)
    
    @scala.inline
    def setGeoMatchStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementGeoMatchStatement): Self = this.set("geoMatchStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGeoMatchStatement: Self = this.set("geoMatchStatement", js.undefined)
    
    @scala.inline
    def setIpSetReferenceStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementIpSetReferenceStatement): Self = this.set("ipSetReferenceStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIpSetReferenceStatement: Self = this.set("ipSetReferenceStatement", js.undefined)
    
    @scala.inline
    def setNotStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementNotStatement): Self = this.set("notStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNotStatement: Self = this.set("notStatement", js.undefined)
    
    @scala.inline
    def setOrStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementOrStatement): Self = this.set("orStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSizeConstraintStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementSizeConstraintStatement): Self = this.set("sizeConstraintStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSizeConstraintStatement: Self = this.set("sizeConstraintStatement", js.undefined)
    
    @scala.inline
    def setSqliMatchStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementSqliMatchStatement): Self = this.set("sqliMatchStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSqliMatchStatement: Self = this.set("sqliMatchStatement", js.undefined)
    
    @scala.inline
    def setXssMatchStatement(value: WebAclRuleStatementNotStatementStatementNotStatementStatementXssMatchStatement): Self = this.set("xssMatchStatement", value.asInstanceOf[js.Any])
