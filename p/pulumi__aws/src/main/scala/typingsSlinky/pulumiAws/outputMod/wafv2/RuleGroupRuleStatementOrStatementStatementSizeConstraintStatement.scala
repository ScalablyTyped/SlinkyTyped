...
object RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementTextTransformation*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
