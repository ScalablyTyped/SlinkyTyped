...
@js.native
trait RuleGroupVisibilityConfig extends js.Object {
...
object RuleGroupVisibilityConfig {
  ...
  @scala.inline
  def apply(cloudwatchMetricsEnabled: Boolean, metricName: String, sampledRequestsEnabled: Boolean): RuleGroupVisibilityConfig = {
  ...
  @scala.inline
  implicit class RuleGroupVisibilityConfigOps[Self <: RuleGroupVisibilityConfig] (val x: Self) extends AnyVal {
