...
object VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust {
  ...
  implicit class VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustOps[Self <: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcm(value: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm): Self = this.set("acm", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAcm: Self = this.set("acm", js.undefined)
    
    @scala.inline
    def setFile(value: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile): Self = this.set("file", value.asInstanceOf[js.Any])
