...
object RuleSource {
  ...
  implicit class RuleSourceOps[Self <: RuleSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSourceDetailsVarargs(value: RuleSourceSourceDetail*): Self = this.set("sourceDetails", js.Array(value :_*))
    @scala.inline
    def setSourceDetails(value: js.Array[RuleSourceSourceDetail]): Self = this.set("sourceDetails", value.asInstanceOf[js.Any])
    @scala.inline
