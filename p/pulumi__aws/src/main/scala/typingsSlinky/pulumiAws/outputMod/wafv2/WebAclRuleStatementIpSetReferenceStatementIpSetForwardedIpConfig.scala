...
@js.native
trait WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig extends StObject {
...
object WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig {
  
  @scala.inline
  def apply(fallbackBehavior: String, headerName: String, position: String): WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig = {
    ...
    __obj.asInstanceOf[WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig]
  }
  
  @scala.inline
  implicit class WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigMutableBuilder[Self <: WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig] (val x: Self) extends AnyVal {
