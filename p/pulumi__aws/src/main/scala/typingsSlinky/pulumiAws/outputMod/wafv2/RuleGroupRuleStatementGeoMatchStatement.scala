...
trait RuleGroupRuleStatementGeoMatchStatement extends js.Object {
  ...
  /**
    ...
    */
  var forwardedIpConfig: js.UndefOr[RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig] = js.native
}
object RuleGroupRuleStatementGeoMatchStatement {
  ...
  implicit class RuleGroupRuleStatementGeoMatchStatementOps[Self <: RuleGroupRuleStatementGeoMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedIpConfig(value: RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig): Self = this.set("forwardedIpConfig", value.asInstanceOf[js.Any])
