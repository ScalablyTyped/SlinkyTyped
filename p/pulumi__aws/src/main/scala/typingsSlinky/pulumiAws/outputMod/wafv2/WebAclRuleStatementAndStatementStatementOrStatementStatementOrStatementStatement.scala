...
object WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatement {
  ...
  implicit class WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementMutableBuilder[Self <: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatement] (val x: Self) extends AnyVal {
    ...
    def setByteMatchStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementByteMatchStatement
    ...
    def setGeoMatchStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementGeoMatchStatement
    ...
    def setIpSetReferenceStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementIpSetReferenceStatement
    ...
    def setRegexPatternSetReferenceStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementRegexPatternSetReferenceStatement
    ...
    def setSizeConstraintStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementSizeConstraintStatement
    ...
    def setSqliMatchStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementSqliMatchStatement
    ...
    def setXssMatchStatement(
      value: WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatementStatementXssMatchStatement
