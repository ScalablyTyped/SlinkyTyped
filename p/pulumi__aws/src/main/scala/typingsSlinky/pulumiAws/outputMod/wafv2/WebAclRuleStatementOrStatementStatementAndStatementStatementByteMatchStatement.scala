...
@js.native
trait WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatement extends js.Object {
...
object WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
