...
@js.native
trait ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification extends js.Object {
...
object ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification {
  ...
  @scala.inline
  def apply(allocationStrategy: String): ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification = {
  ...
  @scala.inline
  implicit class ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecificationOps[Self <: ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification] (val x: Self) extends AnyVal {
