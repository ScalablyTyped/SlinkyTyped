...
object FirehoseDeliveryStreamExtendedS3Configuration {
  ...
  implicit class FirehoseDeliveryStreamExtendedS3ConfigurationOps[Self <: FirehoseDeliveryStreamExtendedS3Configuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCloudwatchLoggingOptions(value: FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDataFormatConversionConfiguration(value: FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withErrorOutputPrefix(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProcessingConfiguration(value: FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfiguration): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withS3BackupConfiguration(value: FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration): Self = {
        val ret = this.duplicate
