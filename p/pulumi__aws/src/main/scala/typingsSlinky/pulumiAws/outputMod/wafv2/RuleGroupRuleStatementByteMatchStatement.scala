...
@js.native
trait RuleGroupRuleStatementByteMatchStatement extends js.Object {
  
  /**
    * The part of a web request that you want AWS WAF to inspect. See Field to Match below for details.
    */
  var fieldToMatch: js.UndefOr[RuleGroupRuleStatementByteMatchStatementFieldToMatch] = js.native
  ...
  /**
    ...
    */
  var textTransformations: js.Array[RuleGroupRuleStatementByteMatchStatementTextTransformation] = js.native
}
object RuleGroupRuleStatementByteMatchStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementByteMatchStatementOps[Self <: RuleGroupRuleStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: RuleGroupRuleStatementByteMatchStatementTextTransformation*): Self = this.set("textTransformations", js.Array(value :_*))
    
    @scala.inline
    def setTextTransformations(value: js.Array[RuleGroupRuleStatementByteMatchStatementTextTransformation]): Self = this.set("textTransformations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
