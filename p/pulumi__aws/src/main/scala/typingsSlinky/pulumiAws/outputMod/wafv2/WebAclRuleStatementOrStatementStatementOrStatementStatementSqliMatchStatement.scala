...
@js.native
trait WebAclRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatement extends js.Object {
...
object WebAclRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
