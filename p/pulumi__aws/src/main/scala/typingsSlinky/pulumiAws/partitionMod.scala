...
import typingsSlinky.pulumiAws.outputMod.glue.PartitionStorageDescriptor
...
object partitionMod {
  ...
  trait PartitionArgs extends StObject {
    ...
    /**
      * A storage descriptor object containing information about the physical storage of this table. You can refer to the [Glue Developer Guide](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-catalog-tables.html#aws-glue-api-catalog-tables-StorageDescriptor) for a full explanation of this object.
      */
    val storageDescriptor: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.PartitionStorageDescriptor]] = js.native
  ...
  object PartitionArgs {
    ...
    implicit class PartitionArgsMutableBuilder[Self <: PartitionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStorageDescriptor(value: Input[typingsSlinky.pulumiAws.inputMod.glue.PartitionStorageDescriptor]): Self = StObject.set(x, "storageDescriptor", value.asInstanceOf[js.Any])
