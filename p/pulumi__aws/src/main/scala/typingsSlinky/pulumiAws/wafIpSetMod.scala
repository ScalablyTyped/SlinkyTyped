...
import typingsSlinky.pulumiAws.outputMod.waf.IpSetIpSetDescriptor
...
object wafIpSetMod {
  ...
  trait IpSetArgs extends StObject {
    ...
    val ipSetDescriptors: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.IpSetIpSetDescriptor]]]
      ] = js.native
  ...
  object IpSetArgs {
    ...
    implicit class IpSetArgsMutableBuilder[Self <: IpSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIpSetDescriptors(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.IpSetIpSetDescriptor]]]): Self = StObject.set(x, "ipSetDescriptors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIpSetDescriptorsUndefined: Self = StObject.set(x, "ipSetDescriptors", js.undefined)
      
      @scala.inline
      def setIpSetDescriptorsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.waf.IpSetIpSetDescriptor]*): Self = StObject.set(x, "ipSetDescriptors", js.Array(value :_*))
