...
import typingsSlinky.pulumiAws.outputMod.lb.ListenerRuleAction
import typingsSlinky.pulumiAws.outputMod.lb.ListenerRuleCondition
...
object lbListenerRuleMod {
  ...
  object ListenerRule {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/lb/listenerRule", "ListenerRule.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/lb/listenerRule", "ListenerRule.isInstance")
    @js.native
  ...
  trait ListenerRuleArgs extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val actions: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleAction]]] = js.native
    
    /**
      * A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
      */
    val conditions: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleCondition]]] = js.native
  ...
  object ListenerRuleArgs {
    ...
    @scala.inline
    def apply(
      actions: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleAction]]],
      conditions: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleCondition]]],
    ...
    implicit class ListenerRuleArgsMutableBuilder[Self <: ListenerRuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActions(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleAction]]]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setActionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleAction]*): Self = StObject.set(x, "actions", js.Array(value :_*))
      
      @scala.inline
      def setConditions(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleCondition]]]): Self = StObject.set(x, "conditions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConditionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleCondition]*): Self = StObject.set(x, "conditions", js.Array(value :_*))
  ...
  trait ListenerRuleState extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val actions: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleAction]]]] = js.native
    ...
    val conditions: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.lb.ListenerRuleCondition]]]
      ] = js.native
