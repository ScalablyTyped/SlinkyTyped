...
object fargateProfileMod {
  ...
  trait FargateProfileArgs extends StObject {
    ...
    /**
      * Configuration block(s) for selecting Kubernetes Pods to execute with this EKS Fargate Profile. Detailed below.
      */
    val selectors: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.eks.FargateProfileSelector]]] = js.native
  ...
  object FargateProfileArgs {
    ...
    def apply(
      ...
      selectors: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.eks.FargateProfileSelector]]]
    ): FargateProfileArgs = {
    ...
    implicit class FargateProfileArgsMutableBuilder[Self <: FargateProfileArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelectors(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.eks.FargateProfileSelector]]]): Self = StObject.set(x, "selectors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectorsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.eks.FargateProfileSelector]*): Self = StObject.set(x, "selectors", js.Array(value :_*))
  ...
  trait FargateProfileState extends StObject {
    ...
    /**
      * Configuration block(s) for selecting Kubernetes Pods to execute with this EKS Fargate Profile. Detailed below.
      */
    val selectors: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.eks.FargateProfileSelector]]]
      ] = js.native
