...
object transferMod extends js.Object {
  ...
  class Server protected ()
    extends typingsSlinky.pulumiAws.serverMod.Server {
    /**
  ...
  class SshKey protected ()
    extends typingsSlinky.pulumiAws.transferSshKeyMod.SshKey {
    /**
  ...
  class User protected ()
    extends typingsSlinky.pulumiAws.transferUserMod.User {
    /**
