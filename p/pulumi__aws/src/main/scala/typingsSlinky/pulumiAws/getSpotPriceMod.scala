...
import typingsSlinky.pulumiAws.inputMod.ec2.GetSpotPriceFilter
...
object getSpotPriceMod {
  ...
  trait GetSpotPriceResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetSpotPriceFilter]] = js.native
  ...
  object GetSpotPriceResult {
    ...
    implicit class GetSpotPriceResultMutableBuilder[Self <: GetSpotPriceResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetSpotPriceFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetSpotPriceFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
