...
import typingsSlinky.pulumiAws.outputMod.gamelift.FleetEc2InboundPermission
import typingsSlinky.pulumiAws.outputMod.gamelift.FleetResourceCreationLimitPolicy
import typingsSlinky.pulumiAws.outputMod.gamelift.FleetRuntimeConfiguration
...
object gameliftFleetMod {
  ...
  trait FleetArgs extends StObject {
    ...
    val ec2InboundPermissions: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetEc2InboundPermission]]
        ]
      ] = js.native
    ...
    val resourceCreationLimitPolicy: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetResourceCreationLimitPolicy]
      ] = js.native
    
    /**
      * Instructions for launching server processes on each instance in the fleet. See below.
      */
    val runtimeConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetRuntimeConfiguration]] = js.native
  ...
  object FleetArgs {
    ...
    implicit class FleetArgsMutableBuilder[Self <: FleetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEc2InboundPermissions(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetEc2InboundPermission]]
            ]
      ): Self = StObject.set(x, "ec2InboundPermissions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEc2InboundPermissionsUndefined: Self = StObject.set(x, "ec2InboundPermissions", js.undefined)
      
      @scala.inline
      def setEc2InboundPermissionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetEc2InboundPermission]*): Self = StObject.set(x, "ec2InboundPermissions", js.Array(value :_*))
      ...
      @scala.inline
      def setResourceCreationLimitPolicy(value: Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetResourceCreationLimitPolicy]): Self = StObject.set(x, "resourceCreationLimitPolicy", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResourceCreationLimitPolicyUndefined: Self = StObject.set(x, "resourceCreationLimitPolicy", js.undefined)
      
      @scala.inline
      def setRuntimeConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.gamelift.FleetRuntimeConfiguration]): Self = StObject.set(x, "runtimeConfiguration", value.asInstanceOf[js.Any])
