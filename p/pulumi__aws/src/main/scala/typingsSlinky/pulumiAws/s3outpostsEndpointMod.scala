...
import typingsSlinky.pulumiAws.outputMod.s3outposts.EndpointNetworkInterface
...
object s3outpostsEndpointMod {
  ...
  trait EndpointState extends StObject {
    ...
    val networkInterfaces: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3outposts.EndpointNetworkInterface]]
        ]
      ] = js.native
  ...
  object EndpointState {
    ...
    implicit class EndpointStateMutableBuilder[Self <: EndpointState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNetworkInterfacesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.s3outposts.EndpointNetworkInterface]*): Self = StObject.set(x, "networkInterfaces", js.Array(value :_*))
