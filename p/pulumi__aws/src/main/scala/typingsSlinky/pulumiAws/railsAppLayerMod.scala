...
import typingsSlinky.pulumiAws.outputMod.opsworks.RailsAppLayerEbsVolume
...
object railsAppLayerMod {
  ...
  trait RailsAppLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.RailsAppLayerEbsVolume]]
        ]
      ] = js.native
  ...
  object RailsAppLayerArgs {
    ...
    implicit class RailsAppLayerArgsMutableBuilder[Self <: RailsAppLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.RailsAppLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
