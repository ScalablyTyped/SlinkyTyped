package typingsSlinky.pulumiAws.getLocalGatewayVirtualInterfaceGroupsMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceGroupsFilter
