package typingsSlinky.pulumiAws.phpAppLayerMod

import typingsSlinky.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume
...
object PhpAppLayerState {
  ...
  implicit class PhpAppLayerStateOps[Self <: PhpAppLayerState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEbsVolumes(value: Input[js.Array[Input[PhpAppLayerEbsVolume]]]): Self = {
        val ret = this.duplicate
