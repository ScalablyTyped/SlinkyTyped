...
object elasticacheClusterMod {
  ...
  trait ClusterState extends StObject {
    ...
    val cacheNodes: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.elasticache.ClusterCacheNode]]]
      ] = js.native
  ...
  object ClusterState {
    ...
    implicit class ClusterStateMutableBuilder[Self <: ClusterState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCacheNodes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.elasticache.ClusterCacheNode]]]): Self = StObject.set(x, "cacheNodes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCacheNodesUndefined: Self = StObject.set(x, "cacheNodes", js.undefined)
      
      @scala.inline
      def setCacheNodesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticache.ClusterCacheNode]*): Self = StObject.set(x, "cacheNodes", js.Array(value :_*))
