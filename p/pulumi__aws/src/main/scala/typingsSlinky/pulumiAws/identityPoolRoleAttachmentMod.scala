...
object identityPoolRoleAttachmentMod {
  ...
  trait IdentityPoolRoleAttachmentArgs extends StObject {
    ...
    val roleMappings: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.cognito.IdentityPoolRoleAttachmentRoleMapping]
          ]
        ]
      ] = js.native
  ...
  object IdentityPoolRoleAttachmentArgs {
    ...
    implicit class IdentityPoolRoleAttachmentArgsMutableBuilder[Self <: IdentityPoolRoleAttachmentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRoleMappingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.IdentityPoolRoleAttachmentRoleMapping]*): Self = StObject.set(x, "roleMappings", js.Array(value :_*))
