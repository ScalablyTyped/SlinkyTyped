...
object ecr extends js.Object {
  ...
  class LifecyclePolicy protected ()
    extends typingsSlinky.pulumiAws.ecrMod.LifecyclePolicy {
    /**
  ...
  class Repository protected ()
    extends typingsSlinky.pulumiAws.ecrMod.Repository {
    /**
  ...
  class RepositoryPolicy protected ()
    extends typingsSlinky.pulumiAws.ecrMod.RepositoryPolicy {
    /**
