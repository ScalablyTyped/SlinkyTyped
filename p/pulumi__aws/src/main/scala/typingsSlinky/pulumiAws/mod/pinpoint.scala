...
object pinpoint {
  ...
  class ApnsVoipChannel protected ()
    extends typingsSlinky.pulumiAws.pinpointMod.ApnsVoipChannel {
    /**
  ...
  class ApnsVoipSandboxChannel protected ()
    extends typingsSlinky.pulumiAws.pinpointMod.ApnsVoipSandboxChannel {
    /**
  ...
  @js.native
  class App protected ()
    extends typingsSlinky.pulumiAws.pinpointMod.App {
    /**
