...
object rds {
  ...
  class ClusterEndpoint protected ()
    extends typingsSlinky.pulumiAws.rdsMod.ClusterEndpoint {
    /**
  ...
  class ClusterInstance protected ()
    extends typingsSlinky.pulumiAws.rdsMod.ClusterInstance {
    /**
  ...
  object EngineMode {
    ...
    @js.native
    val Serverless: typingsSlinky.pulumiAws.pulumiAwsStrings.serverless = js.native
  }
  ...
  class GlobalCluster protected ()
    extends typingsSlinky.pulumiAws.rdsMod.GlobalCluster {
    /**
  ...
  class Proxy protected ()
    extends typingsSlinky.pulumiAws.rdsMod.Proxy {
    /**
  ...
  class RoleAssociation protected ()
    extends typingsSlinky.pulumiAws.rdsMod.RoleAssociation {
    /**
