...
object config {
  ...
  @js.native
  def region: js.UndefOr[typingsSlinky.pulumiAws.enumsMod.Region] = js.native
  @scala.inline
  def region_=(x: js.UndefOr[typingsSlinky.pulumiAws.enumsMod.Region]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("region")(x.asInstanceOf[js.Any])
