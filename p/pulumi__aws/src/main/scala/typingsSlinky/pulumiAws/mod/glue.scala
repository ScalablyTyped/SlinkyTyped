...
object glue {
  ...
  class DataCatalogEncryptionSettings protected ()
    extends typingsSlinky.pulumiAws.glueMod.DataCatalogEncryptionSettings {
    /**
  ...
  class DevEndpoint protected ()
    extends typingsSlinky.pulumiAws.glueMod.DevEndpoint {
    /**
  ...
  class MLTransform protected ()
    extends typingsSlinky.pulumiAws.glueMod.MLTransform {
    /**
  ...
  class Partition protected ()
    extends typingsSlinky.pulumiAws.glueMod.Partition {
    /**
  ...
  class ResourcePolicy protected ()
    extends typingsSlinky.pulumiAws.glueMod.ResourcePolicy {
    /**
  ...
  class Trigger protected ()
    extends typingsSlinky.pulumiAws.glueMod.Trigger {
    /**
