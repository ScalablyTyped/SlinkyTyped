...
object wafregional {
  ...
  class GeoMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafregionalMod.GeoMatchSet {
    /**
  ...
  class RegexMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafregionalMod.RegexMatchSet {
    /**
  ...
  class RegexPatternSet protected ()
    extends typingsSlinky.pulumiAws.wafregionalMod.RegexPatternSet {
    /**
