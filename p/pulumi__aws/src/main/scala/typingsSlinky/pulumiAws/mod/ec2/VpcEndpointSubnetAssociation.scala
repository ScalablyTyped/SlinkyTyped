...
object VpcEndpointSubnetAssociation {
  ...
  @JSImport("@pulumi/aws", "ec2.VpcEndpointSubnetAssociation.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typingsSlinky.pulumiAws.vpcEndpointSubnetAssociationMod.VpcEndpointSubnetAssociation = js.native
  @JSImport("@pulumi/aws", "ec2.VpcEndpointSubnetAssociation.get")
  @js.native
