...
class MethodSettings protected ()
  extends typingsSlinky.pulumiAws.apigatewayMod.MethodSettings {
  /**
...
object MethodSettings {
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws", "apigateway.MethodSettings.get")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws", "apigateway.MethodSettings.isInstance")
  @js.native
