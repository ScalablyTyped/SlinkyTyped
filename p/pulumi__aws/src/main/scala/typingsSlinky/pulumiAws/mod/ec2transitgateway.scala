...
object ec2transitgateway extends js.Object {
  ...
  class PeeringAttachment protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.PeeringAttachment {
    /**
  ...
  class Route protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.Route {
    /**
  ...
  class RouteTable protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.RouteTable {
    /**
  ...
  class RouteTableAssociation protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.RouteTableAssociation {
    /**
  ...
  class RouteTablePropagation protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.RouteTablePropagation {
    /**
  ...
  class TransitGateway protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.TransitGateway {
    /**
  ...
  class VpcAttachment protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.VpcAttachment {
    /**
  ...
  class VpcAttachmentAccepter protected ()
    extends typingsSlinky.pulumiAws.ec2transitgatewayMod.VpcAttachmentAccepter {
    /**
