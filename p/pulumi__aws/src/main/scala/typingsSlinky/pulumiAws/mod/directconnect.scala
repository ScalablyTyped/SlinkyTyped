...
object directconnect {
  ...
  class ConnectionAssociation protected ()
    extends typingsSlinky.pulumiAws.directconnectMod.ConnectionAssociation {
    /**
  ...
  class GatewayAssociation protected ()
    extends typingsSlinky.pulumiAws.directconnectMod.GatewayAssociation {
    /**
  ...
  class HostedPrivateVirtualInterface protected ()
    extends typingsSlinky.pulumiAws.directconnectMod.HostedPrivateVirtualInterface {
    /**
  ...
  class HostedPrivateVirtualInterfaceAccepter protected ()
    extends typingsSlinky.pulumiAws.directconnectMod.HostedPrivateVirtualInterfaceAccepter {
    /**
  ...
  class PrivateVirtualInterface protected ()
    extends typingsSlinky.pulumiAws.directconnectMod.PrivateVirtualInterface {
    /**
  ...
  class TransitVirtualInterface protected ()
    extends typingsSlinky.pulumiAws.directconnectMod.TransitVirtualInterface {
    /**
