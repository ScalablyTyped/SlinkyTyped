...
import typingsSlinky.pulumiAws.getAvailabilityZoneMod.GetAvailabilityZoneArgs
import typingsSlinky.pulumiAws.getAvailabilityZoneMod.GetAvailabilityZoneResult
