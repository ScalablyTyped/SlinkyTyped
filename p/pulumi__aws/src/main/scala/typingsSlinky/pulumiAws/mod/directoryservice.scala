...
object directoryservice extends js.Object {
  ...
  class ConditionalForwader protected ()
    extends typingsSlinky.pulumiAws.directoryserviceMod.ConditionalForwader {
    /**
  ...
  class Directory protected ()
    extends typingsSlinky.pulumiAws.directoryserviceMod.Directory {
    /**
  ...
  class LogService protected ()
    extends typingsSlinky.pulumiAws.directoryserviceMod.LogService {
    /**
