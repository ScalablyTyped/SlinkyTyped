...
object iot extends js.Object {
  ...
  class Certificate protected ()
    extends typingsSlinky.pulumiAws.iotMod.Certificate {
    /**
  ...
  class Policy protected ()
    extends typingsSlinky.pulumiAws.iotMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typingsSlinky.pulumiAws.iotMod.PolicyAttachment {
    /**
  ...
  class RoleAlias protected ()
    extends typingsSlinky.pulumiAws.iotMod.RoleAlias {
    /**
  ...
  class Thing protected ()
    extends typingsSlinky.pulumiAws.iotMod.Thing {
    /**
  ...
  class ThingPrincipalAttachment protected ()
    extends typingsSlinky.pulumiAws.iotMod.ThingPrincipalAttachment {
    /**
  ...
  class ThingType protected ()
    extends typingsSlinky.pulumiAws.iotMod.ThingType {
    /**
  ...
  class TopicRule protected ()
    extends typingsSlinky.pulumiAws.iotMod.TopicRule {
    /**
