...
import typingsSlinky.pulumiAws.documentationPartMod.DocumentationPartArgs
import typingsSlinky.pulumiAws.documentationPartMod.DocumentationPartState
...
class DocumentationPart protected ()
  extends typingsSlinky.pulumiAws.apigatewayMod.DocumentationPart {
  /**
