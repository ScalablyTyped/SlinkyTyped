...
object kms extends js.Object {
  ...
  class Alias protected ()
    extends typingsSlinky.pulumiAws.kmsMod.Alias {
    /**
  ...
  class Ciphertext protected ()
    extends typingsSlinky.pulumiAws.kmsMod.Ciphertext {
    /**
  ...
  class ExternalKey protected ()
    extends typingsSlinky.pulumiAws.kmsMod.ExternalKey {
    /**
  ...
  class Grant protected ()
    extends typingsSlinky.pulumiAws.kmsMod.Grant {
    /**
  ...
  @js.native
  class Key protected ()
    extends typingsSlinky.pulumiAws.kmsMod.Key {
    /**
