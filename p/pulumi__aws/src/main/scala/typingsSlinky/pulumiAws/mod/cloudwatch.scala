...
object cloudwatch {
  ...
  class EventPermission protected ()
    extends typingsSlinky.pulumiAws.cloudwatchMod.EventPermission {
    /**
  ...
  class EventTarget protected ()
    extends typingsSlinky.pulumiAws.cloudwatchMod.EventTarget {
    /**
  ...
  class LogDestinationPolicy protected ()
    extends typingsSlinky.pulumiAws.cloudwatchMod.LogDestinationPolicy {
    /**
  ...
  class LogMetricFilter protected ()
    extends typingsSlinky.pulumiAws.cloudwatchMod.LogMetricFilter {
    /**
