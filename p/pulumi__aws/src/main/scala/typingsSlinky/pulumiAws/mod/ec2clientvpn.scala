...
object ec2clientvpn extends js.Object {
  ...
  class AuthorizationRule protected ()
    extends typingsSlinky.pulumiAws.ec2clientvpnMod.AuthorizationRule {
    /**
  ...
  class Endpoint protected ()
    extends typingsSlinky.pulumiAws.ec2clientvpnMod.Endpoint {
    /**
  ...
  class NetworkAssociation protected ()
    extends typingsSlinky.pulumiAws.ec2clientvpnMod.NetworkAssociation {
    /**
  ...
  class Route protected ()
    extends typingsSlinky.pulumiAws.ec2clientvpnMod.Route {
    /**
