...
object elb extends js.Object {
  ...
  class AppCookieStickinessPolicy protected ()
    extends typingsSlinky.pulumiAws.elbMod.AppCookieStickinessPolicy {
    /**
  ...
  class Attachment protected ()
    extends typingsSlinky.pulumiAws.elbMod.Attachment {
    /**
  ...
  class ListenerPolicy protected ()
    extends typingsSlinky.pulumiAws.elbMod.ListenerPolicy {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsSlinky.pulumiAws.elbMod.LoadBalancer {
    /**
  ...
  class LoadBalancerBackendServerPolicy protected ()
    extends typingsSlinky.pulumiAws.elbMod.LoadBalancerBackendServerPolicy {
    /**
  ...
  class LoadBalancerCookieStickinessPolicy protected ()
    extends typingsSlinky.pulumiAws.elbMod.LoadBalancerCookieStickinessPolicy {
    /**
  ...
  class LoadBalancerPolicy protected ()
    extends typingsSlinky.pulumiAws.elbMod.LoadBalancerPolicy {
    /**
  ...
  class SslNegotiationPolicy protected ()
    extends typingsSlinky.pulumiAws.elbMod.SslNegotiationPolicy {
    /**
