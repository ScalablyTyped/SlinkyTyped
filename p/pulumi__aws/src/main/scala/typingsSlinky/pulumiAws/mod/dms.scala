...
object dms extends js.Object {
  ...
  class Endpoint protected ()
    extends typingsSlinky.pulumiAws.dmsMod.Endpoint {
    /**
  ...
  class EventSubscription protected ()
    extends typingsSlinky.pulumiAws.dmsMod.EventSubscription {
    /**
  ...
  class ReplicationInstance protected ()
    extends typingsSlinky.pulumiAws.dmsMod.ReplicationInstance {
    /**
  ...
  class ReplicationSubnetGroup protected ()
    extends typingsSlinky.pulumiAws.dmsMod.ReplicationSubnetGroup {
    /**
  ...
  class ReplicationTask protected ()
    extends typingsSlinky.pulumiAws.dmsMod.ReplicationTask {
    /**
