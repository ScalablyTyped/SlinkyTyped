...
import typingsSlinky.pulumiAws.methodMod.MethodArgs
import typingsSlinky.pulumiAws.methodMod.MethodState
...
class Method protected ()
  extends typingsSlinky.pulumiAws.apigatewayMod.Method {
  /**
