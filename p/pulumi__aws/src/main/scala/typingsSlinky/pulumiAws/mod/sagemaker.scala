...
object sagemaker extends js.Object {
  ...
  class Endpoint protected ()
    extends typingsSlinky.pulumiAws.sagemakerMod.Endpoint {
    /**
  ...
  class EndpointConfiguration protected ()
    extends typingsSlinky.pulumiAws.sagemakerMod.EndpointConfiguration {
    /**
  ...
  class Model protected ()
    extends typingsSlinky.pulumiAws.sagemakerMod.Model {
    /**
  ...
  class NotebookInstance protected ()
    extends typingsSlinky.pulumiAws.sagemakerMod.NotebookInstance {
    /**
  ...
  class NotebookInstanceLifecycleConfiguration protected ()
    extends typingsSlinky.pulumiAws.sagemakerMod.NotebookInstanceLifecycleConfiguration {
    /**
