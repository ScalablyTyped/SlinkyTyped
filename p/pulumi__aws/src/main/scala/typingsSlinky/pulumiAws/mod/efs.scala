...
object efs extends js.Object {
  ...
  class AccessPoint protected ()
    extends typingsSlinky.pulumiAws.efsMod.AccessPoint {
    /**
  ...
  class FileSystem protected ()
    extends typingsSlinky.pulumiAws.efsMod.FileSystem {
    /**
  ...
  class FileSystemPolicy protected ()
    extends typingsSlinky.pulumiAws.efsMod.FileSystemPolicy {
    /**
  ...
  class MountTarget protected ()
    extends typingsSlinky.pulumiAws.efsMod.MountTarget {
    /**
