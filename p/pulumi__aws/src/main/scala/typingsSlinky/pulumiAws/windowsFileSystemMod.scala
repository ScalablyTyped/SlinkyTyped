...
import typingsSlinky.pulumiAws.outputMod.fsx.WindowsFileSystemSelfManagedActiveDirectory
...
object windowsFileSystemMod {
  ...
  trait WindowsFileSystemArgs extends StObject {
    ...
    val selfManagedActiveDirectory: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.fsx.WindowsFileSystemSelfManagedActiveDirectory]
      ] = js.native
  ...
  object WindowsFileSystemArgs {
    ...
    implicit class WindowsFileSystemArgsMutableBuilder[Self <: WindowsFileSystemArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelfManagedActiveDirectory(value: Input[typingsSlinky.pulumiAws.inputMod.fsx.WindowsFileSystemSelfManagedActiveDirectory]): Self = StObject.set(x, "selfManagedActiveDirectory", value.asInstanceOf[js.Any])
