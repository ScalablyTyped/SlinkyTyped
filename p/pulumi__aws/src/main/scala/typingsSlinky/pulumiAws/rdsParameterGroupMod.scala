...
import typingsSlinky.pulumiAws.outputMod.rds.ParameterGroupParameter
...
object rdsParameterGroupMod {
  ...
  trait ParameterGroupArgs extends StObject {
    ...
    val parameters: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.ParameterGroupParameter]]]
      ] = js.native
  ...
  object ParameterGroupArgs {
    ...
    implicit class ParameterGroupArgsMutableBuilder[Self <: ParameterGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParameters(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.ParameterGroupParameter]]]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
      
      @scala.inline
      def setParametersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.rds.ParameterGroupParameter]*): Self = StObject.set(x, "parameters", js.Array(value :_*))
