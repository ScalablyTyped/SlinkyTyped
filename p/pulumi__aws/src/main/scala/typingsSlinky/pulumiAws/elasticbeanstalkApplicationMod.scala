...
import typingsSlinky.pulumiAws.outputMod.elasticbeanstalk.ApplicationAppversionLifecycle
...
object elasticbeanstalkApplicationMod {
  ...
  trait ApplicationArgs extends StObject {
    ...
    val appversionLifecycle: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticbeanstalk.ApplicationAppversionLifecycle]
      ] = js.native
  ...
  object ApplicationArgs {
    ...
    implicit class ApplicationArgsMutableBuilder[Self <: ApplicationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAppversionLifecycle(value: Input[typingsSlinky.pulumiAws.inputMod.elasticbeanstalk.ApplicationAppversionLifecycle]): Self = StObject.set(x, "appversionLifecycle", value.asInstanceOf[js.Any])
