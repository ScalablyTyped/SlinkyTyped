...
import typingsSlinky.pulumiAws.outputMod.sagemaker.CodeRepositoryGitConfig
...
object codeRepositoryMod {
  ...
  trait CodeRepositoryArgs extends StObject {
    ...
    val gitConfig: Input[typingsSlinky.pulumiAws.inputMod.sagemaker.CodeRepositoryGitConfig] = js.native
  }
  object CodeRepositoryArgs {
    ...
    def apply(
      ...
      gitConfig: Input[typingsSlinky.pulumiAws.inputMod.sagemaker.CodeRepositoryGitConfig]
    ): CodeRepositoryArgs = {
    ...
    implicit class CodeRepositoryArgsMutableBuilder[Self <: CodeRepositoryArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGitConfig(value: Input[typingsSlinky.pulumiAws.inputMod.sagemaker.CodeRepositoryGitConfig]): Self = StObject.set(x, "gitConfig", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait CodeRepositoryState extends StObject {
    ...
    val gitConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.sagemaker.CodeRepositoryGitConfig]] = js.native
  }
