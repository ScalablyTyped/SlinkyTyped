package typingsSlinky.pulumiAws.apnsVoipSandboxChannelMod
...
object ApnsVoipSandboxChannelState {
  ...
  @scala.inline
  implicit class ApnsVoipSandboxChannelStateOps[Self <: ApnsVoipSandboxChannelState] (val x: Self) extends AnyVal {
    @scala.inline
