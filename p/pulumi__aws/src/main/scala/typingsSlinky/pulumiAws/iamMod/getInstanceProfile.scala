...
import typingsSlinky.pulumiAws.getInstanceProfileMod.GetInstanceProfileArgs
import typingsSlinky.pulumiAws.getInstanceProfileMod.GetInstanceProfileResult
