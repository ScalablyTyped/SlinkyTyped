...
class GroupPolicyAttachment protected ()
  extends typingsSlinky.pulumiAws.groupPolicyAttachmentMod.GroupPolicyAttachment {
  /**
...
object GroupPolicyAttachment {
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws/iam", "GroupPolicyAttachment.get")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws/iam", "GroupPolicyAttachment.isInstance")
  @js.native
