...
import typingsSlinky.pulumiAws.outputMod.codepipeline.PipelineArtifactStore
import typingsSlinky.pulumiAws.outputMod.codepipeline.PipelineStage
...
object pipelineMod {
  ...
  trait PipelineArgs extends StObject {
    ...
    /**
      * One or more artifactStore blocks. Artifact stores are documented below.
      */
    val artifactStore: Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineArtifactStore] = js.native
    ...
    /**
      * A stage block. Stages are documented below.
      */
    val stages: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineStage]]] = js.native
  ...
  object PipelineArgs {
    ...
    @scala.inline
    def apply(
      artifactStore: Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineArtifactStore],
      roleArn: Input[String],
      stages: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineStage]]]
    ): PipelineArgs = {
    ...
    implicit class PipelineArgsMutableBuilder[Self <: PipelineArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArtifactStore(value: Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineArtifactStore]): Self = StObject.set(x, "artifactStore", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStages(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineStage]]]): Self = StObject.set(x, "stages", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStagesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineStage]*): Self = StObject.set(x, "stages", js.Array(value :_*))
  ...
  trait PipelineState extends StObject {
    ...
    /**
      * One or more artifactStore blocks. Artifact stores are documented below.
      */
    val artifactStore: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineArtifactStore]] = js.native
    ...
    val stages: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codepipeline.PipelineStage]]]
      ] = js.native
