...
object redshiftClusterMod {
  ...
  trait ClusterArgs extends StObject {
    ...
    /**
      * Logging, documented below.
      */
    val logging: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.redshift.ClusterLogging]] = js.native
    ...
    /**
      * Configuration of automatic copy of snapshots from one region to another. Documented below.
      */
    val snapshotCopy: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.redshift.ClusterSnapshotCopy]] = js.native
  ...
  object ClusterArgs {
    ...
    implicit class ClusterArgsMutableBuilder[Self <: ClusterArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLogging(value: Input[typingsSlinky.pulumiAws.inputMod.redshift.ClusterLogging]): Self = StObject.set(x, "logging", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSnapshotCopy(value: Input[typingsSlinky.pulumiAws.inputMod.redshift.ClusterSnapshotCopy]): Self = StObject.set(x, "snapshotCopy", value.asInstanceOf[js.Any])
