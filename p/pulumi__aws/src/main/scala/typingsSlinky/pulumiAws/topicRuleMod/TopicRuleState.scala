...
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleDynamodbv2
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleElasticsearch
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleErrorAction
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleFirehose
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotAnalytic
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleIotEvent
...
import typingsSlinky.pulumiAws.inputMod.iot.TopicRuleStepFunction
...
object TopicRuleState {
  ...
  implicit class TopicRuleStateOps[Self <: TopicRuleState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def deleteSqlVersion: Self = this.set("sqlVersion", js.undefined)
