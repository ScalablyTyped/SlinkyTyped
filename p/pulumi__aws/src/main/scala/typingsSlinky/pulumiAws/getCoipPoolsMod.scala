...
import typingsSlinky.pulumiAws.inputMod.ec2.GetCoipPoolsFilter
...
object getCoipPoolsMod {
  ...
  trait GetCoipPoolsResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetCoipPoolsFilter]] = js.native
  ...
  object GetCoipPoolsResult {
    ...
    implicit class GetCoipPoolsResultMutableBuilder[Self <: GetCoipPoolsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetCoipPoolsFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetCoipPoolsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
