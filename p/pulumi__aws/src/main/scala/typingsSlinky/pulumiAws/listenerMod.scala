...
import typingsSlinky.pulumiAws.outputMod.alb.ListenerDefaultAction
...
object listenerMod {
  ...
  @JSImport("@pulumi/aws/alb/listener", "Listener")
  @js.native
  ...
  object Listener {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/alb/listener", "Listener.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/alb/listener", "Listener.isInstance")
    @js.native
  ...
  trait ListenerArgs extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val defaultActions: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.alb.ListenerDefaultAction]]] = js.native
  ...
  object ListenerArgs {
    ...
    @scala.inline
    def apply(
      defaultActions: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.alb.ListenerDefaultAction]]],
    ...
    implicit class ListenerArgsMutableBuilder[Self <: ListenerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultActions(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.alb.ListenerDefaultAction]]]): Self = StObject.set(x, "defaultActions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultActionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.alb.ListenerDefaultAction]*): Self = StObject.set(x, "defaultActions", js.Array(value :_*))
  ...
  trait ListenerState extends StObject {
    ...
    val defaultActions: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.alb.ListenerDefaultAction]]]
      ] = js.native
