package typingsSlinky.pulumiAws.botMod

import typingsSlinky.pulumiAws.inputMod.lex.BotAbortStatement
import typingsSlinky.pulumiAws.inputMod.lex.BotClarificationPrompt
import typingsSlinky.pulumiAws.inputMod.lex.BotIntent
...
@js.native
trait BotState extends js.Object {
  
  /**
    * The message that Amazon Lex uses to abort a conversation. Attributes are documented under statement.
    */
  val abortStatement: js.UndefOr[Input[BotAbortStatement]] = js.native
  ...
  /**
    ...
    */
  val intents: js.UndefOr[Input[js.Array[Input[BotIntent]]]] = js.native
...
object BotState {
  ...
  @scala.inline
  implicit class BotStateOps[Self <: BotState] (val x: Self) extends AnyVal {
