...
import typingsSlinky.pulumiAws.inputMod.dms.EndpointElasticsearchSettings
import typingsSlinky.pulumiAws.inputMod.dms.EndpointKafkaSettings
import typingsSlinky.pulumiAws.inputMod.dms.EndpointKinesisSettings
