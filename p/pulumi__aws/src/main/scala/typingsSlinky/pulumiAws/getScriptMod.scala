...
object getScriptMod {
  ...
  trait GetScriptResult extends StObject {
    ...
    val dagEdges: js.Array[typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagEdge] = js.native
    
    val dagNodes: js.Array[typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagNode] = js.native
  ...
  object GetScriptResult {
    ...
    @scala.inline
    def apply(
      dagEdges: js.Array[typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagEdge],
      dagNodes: js.Array[typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagNode],
      id: String,
      pythonScript: String,
      scalaCode: String
    ): GetScriptResult = {
    ...
    implicit class GetScriptResultMutableBuilder[Self <: GetScriptResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDagEdges(value: js.Array[typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagEdge]): Self = StObject.set(x, "dagEdges", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDagEdgesVarargs(value: typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagEdge*): Self = StObject.set(x, "dagEdges", js.Array(value :_*))
      
      @scala.inline
      def setDagNodes(value: js.Array[typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagNode]): Self = StObject.set(x, "dagNodes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDagNodesVarargs(value: typingsSlinky.pulumiAws.outputMod.glue.GetScriptDagNode*): Self = StObject.set(x, "dagNodes", js.Array(value :_*))
