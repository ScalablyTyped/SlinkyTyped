...
object getProductMod {
  ...
  trait GetProductResult extends StObject {
    ...
    val filters: js.Array[typingsSlinky.pulumiAws.outputMod.pricing.GetProductFilter] = js.native
  ...
  object GetProductResult {
    ...
    @scala.inline
    def apply(
      filters: js.Array[typingsSlinky.pulumiAws.outputMod.pricing.GetProductFilter],
      id: String,
      result: String,
      serviceCode: String
    ): GetProductResult = {
    ...
    implicit class GetProductResultMutableBuilder[Self <: GetProductResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.pricing.GetProductFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.pricing.GetProductFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
