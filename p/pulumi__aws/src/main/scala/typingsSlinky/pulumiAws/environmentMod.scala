...
object environmentMod {
  ...
  trait EnvironmentArgs extends StObject {
    ...
    val settings: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.elasticbeanstalk.EnvironmentSetting]]
        ]
      ] = js.native
  ...
  object EnvironmentArgs {
    ...
    implicit class EnvironmentArgsMutableBuilder[Self <: EnvironmentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSettingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticbeanstalk.EnvironmentSetting]*): Self = StObject.set(x, "settings", js.Array(value :_*))
  ...
  trait EnvironmentState extends StObject {
    ...
    val allSettings: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.elasticbeanstalk.EnvironmentAllSetting]]
        ]
      ] = js.native
  ...
  object EnvironmentState {
    ...
    implicit class EnvironmentStateMutableBuilder[Self <: EnvironmentState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAllSettingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticbeanstalk.EnvironmentAllSetting]*): Self = StObject.set(x, "allSettings", js.Array(value :_*))
