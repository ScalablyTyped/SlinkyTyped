...
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolAdminCreateUserConfig
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolDeviceConfiguration
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolEmailConfiguration
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolLambdaConfig
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolPasswordPolicy
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolSchema
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolSmsConfiguration
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolSoftwareTokenMfaConfiguration
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolUserPoolAddOns
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolUsernameConfiguration
import typingsSlinky.pulumiAws.outputMod.cognito.UserPoolVerificationMessageTemplate
...
object userPoolMod {
  ...
  trait UserPoolArgs extends StObject {
    ...
    /**
      * The configuration for AdminCreateUser requests.
      */
    val adminCreateUserConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolAdminCreateUserConfig]] = js.native
    ...
    /**
      * The configuration for the user pool's device tracking.
      */
    val deviceConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolDeviceConfiguration]] = js.native
    
    /**
      * The Email Configuration.
      */
    val emailConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolEmailConfiguration]] = js.native
    ...
    /**
      * A container for the AWS Lambda triggers associated with the user pool.
      */
    val lambdaConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolLambdaConfig]] = js.native
    ...
    /**
      * A container for information about the user pool password policy.
      */
    val passwordPolicy: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolPasswordPolicy]] = js.native
    
    /**
      * A container with the schema attributes of a user pool. Schema attributes from the [standard attribute set](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html#cognito-user-pools-standard-attributes) only need to be specified if they are different from the default configuration. Maximum of 50 attributes.
      */
    val schemas: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSchema]]]] = js.native
    ...
    /**
      * Configuration block for Short Message Service (SMS) settings. Detailed below. These settings apply to SMS user verification and SMS Multi-Factor Authentication (MFA). Due to Cognito API restrictions, the SMS configuration cannot be removed without recreating the Cognito User Pool. For user data safety, this resource will ignore the removal of this configuration by disabling drift detection. To force resource recreation after this configuration has been applied, see the [`up` command and use --replace](https://www.pulumi.com/docs/reference/cli/pulumi_up/).
      */
    val smsConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSmsConfiguration]] = js.native
    ...
    /**
      * Configuration block for software token Mult-Factor Authentication (MFA) settings. Detailed below.
      */
    val softwareTokenMfaConfiguration: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSoftwareTokenMfaConfiguration]
      ] = js.native
    ...
    /**
      * Configuration block for user pool add-ons to enable user pool advanced security mode features.
      */
    val userPoolAddOns: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolUserPoolAddOns]] = js.native
    ...
    /**
      * The Username Configuration.
      */
    val usernameConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolUsernameConfiguration]] = js.native
    
    /**
      * The verification message templates configuration.
      */
    val verificationMessageTemplate: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolVerificationMessageTemplate]
      ] = js.native
  }
  object UserPoolArgs {
    ...
    implicit class UserPoolArgsMutableBuilder[Self <: UserPoolArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdminCreateUserConfig(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolAdminCreateUserConfig]): Self = StObject.set(x, "adminCreateUserConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDeviceConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolDeviceConfiguration]): Self = StObject.set(x, "deviceConfiguration", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDeviceConfigurationUndefined: Self = StObject.set(x, "deviceConfiguration", js.undefined)
      
      @scala.inline
      def setEmailConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolEmailConfiguration]): Self = StObject.set(x, "emailConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLambdaConfig(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolLambdaConfig]): Self = StObject.set(x, "lambdaConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPasswordPolicy(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolPasswordPolicy]): Self = StObject.set(x, "passwordPolicy", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPasswordPolicyUndefined: Self = StObject.set(x, "passwordPolicy", js.undefined)
      
      @scala.inline
      def setSchemas(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSchema]]]): Self = StObject.set(x, "schemas", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSchemasUndefined: Self = StObject.set(x, "schemas", js.undefined)
      
      @scala.inline
      def setSchemasVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSchema]*): Self = StObject.set(x, "schemas", js.Array(value :_*))
      ...
      @scala.inline
      def setSmsConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSmsConfiguration]): Self = StObject.set(x, "smsConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSoftwareTokenMfaConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolSoftwareTokenMfaConfiguration]): Self = StObject.set(x, "softwareTokenMfaConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUserPoolAddOns(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolUserPoolAddOns]): Self = StObject.set(x, "userPoolAddOns", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUsernameConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolUsernameConfiguration]): Self = StObject.set(x, "usernameConfiguration", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUsernameConfigurationUndefined: Self = StObject.set(x, "usernameConfiguration", js.undefined)
      
      @scala.inline
      def setVerificationMessageTemplate(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.UserPoolVerificationMessageTemplate]): Self = StObject.set(x, "verificationMessageTemplate", value.asInstanceOf[js.Any])
