...
import typingsSlinky.pulumiAws.outputMod.appmesh.VirtualGatewaySpec
...
object virtualGatewayMod {
  ...
  trait VirtualGatewayArgs extends StObject {
    ...
    /**
      * The virtual gateway specification to apply.
      */
    val spec: Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualGatewaySpec] = js.native
  ...
  object VirtualGatewayArgs {
    ...
    @scala.inline
    def apply(meshName: Input[String], spec: Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualGatewaySpec]): VirtualGatewayArgs = {
    ...
    implicit class VirtualGatewayArgsMutableBuilder[Self <: VirtualGatewayArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualGatewaySpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
  ...
  trait VirtualGatewayState extends StObject {
    ...
    /**
      * The virtual gateway specification to apply.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualGatewaySpec]] = js.native
