...
object meshMod {
  ...
  trait MeshArgs extends StObject {
    ...
    /**
      * The service mesh specification to apply.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appmesh.MeshSpec]] = js.native
  ...
  object MeshArgs {
    ...
    implicit class MeshArgsMutableBuilder[Self <: MeshArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiAws.inputMod.appmesh.MeshSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
