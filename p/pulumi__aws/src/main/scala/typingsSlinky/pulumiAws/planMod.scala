...
object planMod {
  ...
  trait PlanArgs extends StObject {
    ...
    val advancedBackupSettings: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.PlanAdvancedBackupSetting]]
        ]
      ] = js.native
    ...
    /**
      * A rule object that specifies a scheduled task that is used to back up a selection of resources.
      */
    val rules: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.PlanRule]]] = js.native
  ...
  object PlanArgs {
    ...
    @scala.inline
    def apply(rules: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.PlanRule]]]): PlanArgs = {
    ...
    implicit class PlanArgsMutableBuilder[Self <: PlanArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdvancedBackupSettings(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.PlanAdvancedBackupSetting]]
            ]
      ): Self = StObject.set(x, "advancedBackupSettings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAdvancedBackupSettingsUndefined: Self = StObject.set(x, "advancedBackupSettings", js.undefined)
      
      @scala.inline
      def setAdvancedBackupSettingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.backup.PlanAdvancedBackupSetting]*): Self = StObject.set(x, "advancedBackupSettings", js.Array(value :_*))
      ...
      @scala.inline
      def setRules(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.PlanRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.backup.PlanRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
  ...
  trait PlanState extends StObject {
    ...
    /**
      * A rule object that specifies a scheduled task that is used to back up a selection of resources.
      */
    val rules: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.backup.PlanRule]]]] = js.native
