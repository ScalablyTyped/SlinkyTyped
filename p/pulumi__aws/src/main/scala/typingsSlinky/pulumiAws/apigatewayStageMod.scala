...
import typingsSlinky.pulumiAws.apigatewayMod.Deployment
...
object apigatewayStageMod {
  ...
  trait StageArgs extends StObject {
    ...
    /**
      * Enables access logs for the API stage. Detailed below.
      */
    val accessLogSettings: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigateway.StageAccessLogSettings]] = js.native
  ...
  object StageArgs {
    ...
    implicit class StageArgsMutableBuilder[Self <: StageArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogSettings(value: Input[typingsSlinky.pulumiAws.inputMod.apigateway.StageAccessLogSettings]): Self = StObject.set(x, "accessLogSettings", value.asInstanceOf[js.Any])
