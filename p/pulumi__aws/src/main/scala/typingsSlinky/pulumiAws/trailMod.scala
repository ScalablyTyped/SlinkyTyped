...
object trailMod {
  ...
  trait TrailArgs extends StObject {
    ...
    val eventSelectors: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.cloudtrail.TrailEventSelector]]]
      ] = js.native
    ...
    val insightSelectors: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.cloudtrail.TrailInsightSelector]]
        ]
      ] = js.native
  ...
  object TrailArgs {
    ...
    implicit class TrailArgsMutableBuilder[Self <: TrailArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEventSelectors(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.cloudtrail.TrailEventSelector]]]): Self = StObject.set(x, "eventSelectors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEventSelectorsUndefined: Self = StObject.set(x, "eventSelectors", js.undefined)
      
      @scala.inline
      def setEventSelectorsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cloudtrail.TrailEventSelector]*): Self = StObject.set(x, "eventSelectors", js.Array(value :_*))
      ...
      @scala.inline
      def setInsightSelectors(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.cloudtrail.TrailInsightSelector]]
            ]
      ): Self = StObject.set(x, "insightSelectors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInsightSelectorsUndefined: Self = StObject.set(x, "insightSelectors", js.undefined)
      
      @scala.inline
      def setInsightSelectorsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cloudtrail.TrailInsightSelector]*): Self = StObject.set(x, "insightSelectors", js.Array(value :_*))
