...
import typingsSlinky.pulumiAws.outputMod.codebuild.WebhookFilterGroup
...
object webhookMod {
  ...
  trait WebhookArgs extends StObject {
    ...
    val filterGroups: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codebuild.WebhookFilterGroup]]]
      ] = js.native
  ...
  object WebhookArgs {
    ...
    implicit class WebhookArgsMutableBuilder[Self <: WebhookArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilterGroups(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codebuild.WebhookFilterGroup]]]): Self = StObject.set(x, "filterGroups", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFilterGroupsUndefined: Self = StObject.set(x, "filterGroups", js.undefined)
      
      @scala.inline
      def setFilterGroupsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.codebuild.WebhookFilterGroup]*): Self = StObject.set(x, "filterGroups", js.Array(value :_*))
