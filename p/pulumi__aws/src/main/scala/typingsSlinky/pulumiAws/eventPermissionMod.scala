...
object eventPermissionMod {
  ...
  trait EventPermissionArgs extends StObject {
    ...
    /**
      * Configuration block to limit the event bus permissions you are granting to only accounts that fulfill the condition. Specified below.
      */
    val condition: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cloudwatch.EventPermissionCondition]] = js.native
  ...
  object EventPermissionArgs {
    ...
    implicit class EventPermissionArgsMutableBuilder[Self <: EventPermissionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCondition(value: Input[typingsSlinky.pulumiAws.inputMod.cloudwatch.EventPermissionCondition]): Self = StObject.set(x, "condition", value.asInstanceOf[js.Any])
