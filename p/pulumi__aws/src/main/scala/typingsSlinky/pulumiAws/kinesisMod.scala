...
object kinesisMod {
  ...
  class AnalyticsApplication protected ()
    extends typingsSlinky.pulumiAws.analyticsApplicationMod.AnalyticsApplication {
    /**
  ...
  class FirehoseDeliveryStream protected ()
    extends typingsSlinky.pulumiAws.firehoseDeliveryStreamMod.FirehoseDeliveryStream {
    /**
  ...
  class Stream protected ()
    extends typingsSlinky.pulumiAws.streamMod.Stream {
    /**
  ...
  class VideoStream protected ()
    extends typingsSlinky.pulumiAws.videoStreamMod.VideoStream {
    /**
