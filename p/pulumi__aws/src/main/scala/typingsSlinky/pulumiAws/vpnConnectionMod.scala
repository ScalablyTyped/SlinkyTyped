...
import typingsSlinky.pulumiAws.outputMod.ec2.VpnConnectionRoute
import typingsSlinky.pulumiAws.outputMod.ec2.VpnConnectionVgwTelemetry
...
object vpnConnectionMod {
  ...
  trait VpnConnectionState extends StObject {
    ...
    val routes: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.VpnConnectionRoute]]]] = js.native
    ...
    val vgwTelemetries: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.VpnConnectionVgwTelemetry]]]
      ] = js.native
  ...
  object VpnConnectionState {
    ...
    implicit class VpnConnectionStateMutableBuilder[Self <: VpnConnectionState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRoutes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.VpnConnectionRoute]]]): Self = StObject.set(x, "routes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRoutesUndefined: Self = StObject.set(x, "routes", js.undefined)
      
      @scala.inline
      def setRoutesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.VpnConnectionRoute]*): Self = StObject.set(x, "routes", js.Array(value :_*))
      ...
      @scala.inline
      def setVgwTelemetries(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.VpnConnectionVgwTelemetry]]]): Self = StObject.set(x, "vgwTelemetries", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVgwTelemetriesUndefined: Self = StObject.set(x, "vgwTelemetries", js.undefined)
      
      @scala.inline
      def setVgwTelemetriesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.VpnConnectionVgwTelemetry]*): Self = StObject.set(x, "vgwTelemetries", js.Array(value :_*))
