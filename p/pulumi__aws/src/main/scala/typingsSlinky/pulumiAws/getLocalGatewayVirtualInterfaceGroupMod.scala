...
import typingsSlinky.pulumiAws.inputMod.ec2.GetLocalGatewayVirtualInterfaceGroupFilter
...
object getLocalGatewayVirtualInterfaceGroupMod {
  ...
  trait GetLocalGatewayVirtualInterfaceGroupResult extends StObject {
    ...
    val filters: js.UndefOr[
        js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceGroupFilter]
      ] = js.native
  ...
  object GetLocalGatewayVirtualInterfaceGroupResult {
    ...
    implicit class GetLocalGatewayVirtualInterfaceGroupResultMutableBuilder[Self <: GetLocalGatewayVirtualInterfaceGroupResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceGroupFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceGroupFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
