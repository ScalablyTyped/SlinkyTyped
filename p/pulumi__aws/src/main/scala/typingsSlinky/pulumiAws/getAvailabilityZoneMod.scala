...
object getAvailabilityZoneMod {
  ...
  trait GetAvailabilityZoneResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.GetAvailabilityZoneFilter]] = js.native
  ...
  object GetAvailabilityZoneResult {
    ...
    implicit class GetAvailabilityZoneResultMutableBuilder[Self <: GetAvailabilityZoneResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.GetAvailabilityZoneFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.GetAvailabilityZoneFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
