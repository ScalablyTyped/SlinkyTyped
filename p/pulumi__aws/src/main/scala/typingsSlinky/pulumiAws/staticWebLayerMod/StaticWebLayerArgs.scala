package typingsSlinky.pulumiAws.staticWebLayerMod

import typingsSlinky.pulumiAws.inputMod.opsworks.StaticWebLayerEbsVolume
...
object StaticWebLayerArgs {
  ...
  implicit class StaticWebLayerArgsOps[Self <: StaticWebLayerArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEbsVolumes(value: Input[js.Array[Input[StaticWebLayerEbsVolume]]]): Self = {
        val ret = this.duplicate
