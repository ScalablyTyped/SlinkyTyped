...
import typingsSlinky.pulumiAws.inputMod.ebs.GetEbsVolumesFilter
...
object getEbsVolumesMod {
  ...
  trait GetEbsVolumesResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ebs.GetEbsVolumesFilter]] = js.native
  ...
  object GetEbsVolumesResult {
    ...
    implicit class GetEbsVolumesResultMutableBuilder[Self <: GetEbsVolumesResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ebs.GetEbsVolumesFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ebs.GetEbsVolumesFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
