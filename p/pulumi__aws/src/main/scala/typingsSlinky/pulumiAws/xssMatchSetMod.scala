...
import typingsSlinky.pulumiAws.outputMod.wafregional.XssMatchSetXssMatchTuple
...
object xssMatchSetMod {
  ...
  trait XssMatchSetArgs extends StObject {
    ...
    val xssMatchTuples: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.wafregional.XssMatchSetXssMatchTuple]]
        ]
      ] = js.native
  }
  object XssMatchSetArgs {
    ...
    implicit class XssMatchSetArgsMutableBuilder[Self <: XssMatchSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setXssMatchTuples(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.wafregional.XssMatchSetXssMatchTuple]]
            ]
      ): Self = StObject.set(x, "xssMatchTuples", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setXssMatchTuplesUndefined: Self = StObject.set(x, "xssMatchTuples", js.undefined)
      
      @scala.inline
      def setXssMatchTuplesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.wafregional.XssMatchSetXssMatchTuple]*): Self = StObject.set(x, "xssMatchTuples", js.Array(value :_*))
    }
  }
