...
import typingsSlinky.pulumiAws.outputMod.imagebuilder.DistributionConfigurationDistribution
...
object distributionConfigurationMod {
  ...
  trait DistributionConfigurationArgs extends StObject {
    ...
    val distributions: Input[
        js.Array[
          Input[
            typingsSlinky.pulumiAws.inputMod.imagebuilder.DistributionConfigurationDistribution
          ]
        ]
      ] = js.native
  ...
  object DistributionConfigurationArgs {
    ...
    implicit class DistributionConfigurationArgsMutableBuilder[Self <: DistributionConfigurationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDistributionsVarargs(
        value: (Input[
              typingsSlinky.pulumiAws.inputMod.imagebuilder.DistributionConfigurationDistribution
            ])*
      ): Self = StObject.set(x, "distributions", js.Array(value :_*))
