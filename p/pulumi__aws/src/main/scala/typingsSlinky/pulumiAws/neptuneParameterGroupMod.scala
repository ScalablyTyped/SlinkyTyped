...
object neptuneParameterGroupMod {
  ...
  trait ParameterGroupArgs extends StObject {
    ...
    val parameters: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.neptune.ParameterGroupParameter]]
        ]
      ] = js.native
  ...
  object ParameterGroupArgs {
    ...
    implicit class ParameterGroupArgsMutableBuilder[Self <: ParameterGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParametersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.neptune.ParameterGroupParameter]*): Self = StObject.set(x, "parameters", js.Array(value :_*))
