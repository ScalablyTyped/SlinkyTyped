...
import typingsSlinky.pulumiAws.outputMod.opsworks.StackCustomCookbooksSource
...
object opsworksStackMod {
  ...
  trait StackArgs extends StObject {
    ...
    val customCookbooksSources: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.StackCustomCookbooksSource]]
        ]
      ] = js.native
  ...
  object StackArgs {
    ...
    implicit class StackArgsMutableBuilder[Self <: StackArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomCookbooksSources(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.StackCustomCookbooksSource]]
            ]
      ): Self = StObject.set(x, "customCookbooksSources", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomCookbooksSourcesUndefined: Self = StObject.set(x, "customCookbooksSources", js.undefined)
      
      @scala.inline
      def setCustomCookbooksSourcesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.StackCustomCookbooksSource]*): Self = StObject.set(x, "customCookbooksSources", js.Array(value :_*))
