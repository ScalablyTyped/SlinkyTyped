...
import typingsSlinky.pulumiAws.outputMod.alb.TargetGroupHealthCheck
import typingsSlinky.pulumiAws.outputMod.alb.TargetGroupStickiness
...
object targetGroupMod {
  ...
  trait TargetGroupArgs extends StObject {
    ...
    /**
      * A Health Check block. Health Check blocks are documented below.
      */
    val healthCheck: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.alb.TargetGroupHealthCheck]] = js.native
    ...
    /**
      * A Stickiness block. Stickiness blocks are documented below.
      */
    val stickiness: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.alb.TargetGroupStickiness]] = js.native
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typingsSlinky.pulumiAws.inputMod.alb.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typingsSlinky.pulumiAws.inputMod.alb.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
