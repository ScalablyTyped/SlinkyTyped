...
import typingsSlinky.pulumiAws.inputMod.kinesisanalyticsv2.ApplicationApplicationConfiguration
import typingsSlinky.pulumiAws.inputMod.kinesisanalyticsv2.ApplicationCloudwatchLoggingOptions
