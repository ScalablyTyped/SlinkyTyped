...
import typingsSlinky.pulumiAws.launchTemplateMod.LaunchTemplateArgs
import typingsSlinky.pulumiAws.launchTemplateMod.LaunchTemplateState
...
class LaunchTemplate protected ()
  extends typingsSlinky.pulumiAws.launchTemplateMod.LaunchTemplate {
  /**
