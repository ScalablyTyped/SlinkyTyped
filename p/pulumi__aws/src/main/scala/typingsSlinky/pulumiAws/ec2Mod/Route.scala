...
import typingsSlinky.pulumiAws.ec2RouteMod.RouteArgs
import typingsSlinky.pulumiAws.ec2RouteMod.RouteState
...
class Route protected ()
  extends typingsSlinky.pulumiAws.ec2RouteMod.Route {
  /**
