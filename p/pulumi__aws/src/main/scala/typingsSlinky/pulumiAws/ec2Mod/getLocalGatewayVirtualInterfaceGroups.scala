...
import typingsSlinky.pulumiAws.getLocalGatewayVirtualInterfaceGroupsMod.GetLocalGatewayVirtualInterfaceGroupsArgs
import typingsSlinky.pulumiAws.getLocalGatewayVirtualInterfaceGroupsMod.GetLocalGatewayVirtualInterfaceGroupsResult
