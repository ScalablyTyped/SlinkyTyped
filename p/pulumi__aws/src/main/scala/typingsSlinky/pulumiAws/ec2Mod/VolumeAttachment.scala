...
object VolumeAttachment {
  ...
  @JSImport("@pulumi/aws/ec2", "VolumeAttachment.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typingsSlinky.pulumiAws.volumeAttachmentMod.VolumeAttachment = js.native
  @JSImport("@pulumi/aws/ec2", "VolumeAttachment.get")
  @js.native
