...
object opsworksInstanceMod {
  ...
  trait InstanceArgs extends StObject {
    ...
    val ebsBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceEbsBlockDevice]]
        ]
      ] = js.native
    ...
    val ephemeralBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceEphemeralBlockDevice]]
        ]
      ] = js.native
    ...
    val rootBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceRootBlockDevice]]
        ]
      ] = js.native
  ...
  object InstanceArgs {
    ...
    implicit class InstanceArgsMutableBuilder[Self <: InstanceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceEbsBlockDevice]*): Self = StObject.set(x, "ebsBlockDevices", js.Array(value :_*))
      ...
      @scala.inline
      def setEphemeralBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceEphemeralBlockDevice]*): Self = StObject.set(x, "ephemeralBlockDevices", js.Array(value :_*))
      ...
      @scala.inline
      def setRootBlockDevices(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceRootBlockDevice]]
            ]
      ): Self = StObject.set(x, "rootBlockDevices", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRootBlockDevicesUndefined: Self = StObject.set(x, "rootBlockDevices", js.undefined)
      
      @scala.inline
      def setRootBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.InstanceRootBlockDevice]*): Self = StObject.set(x, "rootBlockDevices", js.Array(value :_*))
