...
object s3BucketMod {
  ...
  trait BucketArgs extends StObject {
    ...
    /**
      * A rule of [Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html) (documented below).
      */
    val corsRules: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketCorsRule]]]] = js.native
    ...
    /**
      * An [ACL policy grant](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#sample-acl) (documented below). Conflicts with `acl`.
      */
    val grants: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketGrant]]]] = js.native
    ...
    /**
      * A configuration of [object lifecycle management](http://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html) (documented below).
      */
    val lifecycleRules: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketLifecycleRule]]]] = js.native
    
    /**
      * A settings of [bucket logging](https://docs.aws.amazon.com/AmazonS3/latest/UG/ManagingBucketLogging.html) (documented below).
      */
    val loggings: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketLogging]]]] = js.native
    
    /**
      * A configuration of [S3 object locking](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html) (documented below)
      */
    val objectLockConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketObjectLockConfiguration]] = js.native
    ...
    /**
      * A configuration of [replication configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/crr.html) (documented below).
      */
    val replicationConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketReplicationConfiguration]] = js.native
    ...
    val serverSideEncryptionConfiguration: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.s3.BucketServerSideEncryptionConfiguration]
      ] = js.native
    ...
    /**
      * A state of [versioning](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html) (documented below)
      */
    val versioning: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketVersioning]] = js.native
    
    /**
      * A website object (documented below).
      */
    val website: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketWebsite]] = js.native
  ...
  object BucketArgs {
    ...
    implicit class BucketArgsMutableBuilder[Self <: BucketArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCorsRules(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketCorsRule]]]): Self = StObject.set(x, "corsRules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCorsRulesUndefined: Self = StObject.set(x, "corsRules", js.undefined)
      
      @scala.inline
      def setCorsRulesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketCorsRule]*): Self = StObject.set(x, "corsRules", js.Array(value :_*))
      ...
      @scala.inline
      def setGrants(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketGrant]]]): Self = StObject.set(x, "grants", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGrantsUndefined: Self = StObject.set(x, "grants", js.undefined)
      
      @scala.inline
      def setGrantsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketGrant]*): Self = StObject.set(x, "grants", js.Array(value :_*))
      ...
      @scala.inline
      def setLifecycleRules(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketLifecycleRule]]]): Self = StObject.set(x, "lifecycleRules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLifecycleRulesUndefined: Self = StObject.set(x, "lifecycleRules", js.undefined)
      
      @scala.inline
      def setLifecycleRulesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketLifecycleRule]*): Self = StObject.set(x, "lifecycleRules", js.Array(value :_*))
      
      @scala.inline
      def setLoggings(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.s3.BucketLogging]]]): Self = StObject.set(x, "loggings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLoggingsUndefined: Self = StObject.set(x, "loggings", js.undefined)
      
      @scala.inline
      def setLoggingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketLogging]*): Self = StObject.set(x, "loggings", js.Array(value :_*))
      
      @scala.inline
      def setObjectLockConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketObjectLockConfiguration]): Self = StObject.set(x, "objectLockConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setReplicationConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketReplicationConfiguration]): Self = StObject.set(x, "replicationConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setServerSideEncryptionConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketServerSideEncryptionConfiguration]): Self = StObject.set(x, "serverSideEncryptionConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVersioning(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketVersioning]): Self = StObject.set(x, "versioning", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVersioningUndefined: Self = StObject.set(x, "versioning", js.undefined)
      
      @scala.inline
      def setWebsite(value: Input[typingsSlinky.pulumiAws.inputMod.s3.BucketWebsite]): Self = StObject.set(x, "website", value.asInstanceOf[js.Any])
