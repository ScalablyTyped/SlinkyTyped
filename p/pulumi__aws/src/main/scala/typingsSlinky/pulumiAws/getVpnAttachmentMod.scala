...
import typingsSlinky.pulumiAws.inputMod.ec2transitgateway.GetVpnAttachmentFilter
...
object getVpnAttachmentMod {
  ...
  trait GetVpnAttachmentResult extends StObject {
    ...
    val filters: js.UndefOr[
        js.Array[typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetVpnAttachmentFilter]
      ] = js.native
  ...
  object GetVpnAttachmentResult {
    ...
    implicit class GetVpnAttachmentResultMutableBuilder[Self <: GetVpnAttachmentResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetVpnAttachmentFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2transitgateway.GetVpnAttachmentFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
