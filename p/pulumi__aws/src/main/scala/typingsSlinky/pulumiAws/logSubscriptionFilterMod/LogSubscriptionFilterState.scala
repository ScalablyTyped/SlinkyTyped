...
import typingsSlinky.pulumiAws.cloudwatchMod.LogGroup
...
object LogSubscriptionFilterState {
  ...
  @scala.inline
  implicit class LogSubscriptionFilterStateOps[Self <: LogSubscriptionFilterState] (val x: Self) extends AnyVal {
    @scala.inline
