...
object organizationMod {
  ...
  trait OrganizationState extends StObject {
    ...
    val accounts: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationAccount]]
        ]
      ] = js.native
    ...
    val nonMasterAccounts: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationNonMasterAccount]
          ]
        ]
      ] = js.native
    ...
    val roots: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationRoot]]]
      ] = js.native
  }
  object OrganizationState {
    ...
    implicit class OrganizationStateMutableBuilder[Self <: OrganizationState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccountsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationAccount]*): Self = StObject.set(x, "accounts", js.Array(value :_*))
      ...
      @scala.inline
      def setNonMasterAccountsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationNonMasterAccount]*): Self = StObject.set(x, "nonMasterAccounts", js.Array(value :_*))
      
      @scala.inline
      def setRoots(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationRoot]]]): Self = StObject.set(x, "roots", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRootsUndefined: Self = StObject.set(x, "roots", js.undefined)
      
      @scala.inline
      def setRootsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationRoot]*): Self = StObject.set(x, "roots", js.Array(value :_*))
    }
  }
}
