package typingsSlinky.pulumiAws.lbTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.inputMod.lb.TargetGroupHealthCheck
import typingsSlinky.pulumiAws.inputMod.lb.TargetGroupStickiness
...
object TargetGroupArgs {
  ...
  @scala.inline
  implicit class TargetGroupArgsOps[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
    @scala.inline
