...
object s3Mod {
  ...
  class AccountPublicAccessBlock protected ()
    extends typingsSlinky.pulumiAws.accountPublicAccessBlockMod.AccountPublicAccessBlock {
    /**
  ...
  class Bucket protected ()
    extends typingsSlinky.pulumiAws.s3BucketMod.Bucket {
    /**
  ...
  class BucketObject protected ()
    extends typingsSlinky.pulumiAws.bucketObjectMod.BucketObject {
    /**
  ...
  class BucketPolicy protected ()
    extends typingsSlinky.pulumiAws.s3BucketPolicyMod.BucketPolicy {
    /**
