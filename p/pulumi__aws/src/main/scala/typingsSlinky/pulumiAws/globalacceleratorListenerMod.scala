...
object globalacceleratorListenerMod {
  ...
  trait ListenerArgs extends StObject {
    ...
    /**
      * The list of port ranges for the connections from clients to the accelerator. Fields documented below.
      */
    val portRanges: Input[
        js.Array[Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.ListenerPortRange]]
      ] = js.native
  ...
  object ListenerArgs {
    ...
    implicit class ListenerArgsMutableBuilder[Self <: ListenerArgs] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "portRanges", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPortRangesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.ListenerPortRange]*): Self = StObject.set(x, "portRanges", js.Array(value :_*))
