...
object getPolicyDocumentMod {
  ...
  trait GetPolicyDocumentResult extends StObject {
    ...
    val statements: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.iam.GetPolicyDocumentStatement]] = js.native
  ...
  object GetPolicyDocumentResult {
    ...
    implicit class GetPolicyDocumentResultMutableBuilder[Self <: GetPolicyDocumentResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStatements(value: js.Array[typingsSlinky.pulumiAws.outputMod.iam.GetPolicyDocumentStatement]): Self = StObject.set(x, "statements", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStatementsUndefined: Self = StObject.set(x, "statements", js.undefined)
      
      @scala.inline
      def setStatementsVarargs(value: typingsSlinky.pulumiAws.outputMod.iam.GetPolicyDocumentStatement*): Self = StObject.set(x, "statements", js.Array(value :_*))
