package typingsSlinky.pulumiAws.getInfrastructureConfigurationMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.outputMod.imagebuilder.GetInfrastructureConfigurationLogging
