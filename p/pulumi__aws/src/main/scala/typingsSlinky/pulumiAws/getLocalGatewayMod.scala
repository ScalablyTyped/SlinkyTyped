...
import typingsSlinky.pulumiAws.inputMod.ec2.GetLocalGatewayFilter
...
object getLocalGatewayMod {
  ...
  trait GetLocalGatewayResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayFilter]] = js.native
  ...
  object GetLocalGatewayResult {
    ...
    implicit class GetLocalGatewayResultMutableBuilder[Self <: GetLocalGatewayResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
