...
object peeringConnectionOptionsMod {
  ...
  trait PeeringConnectionOptionsArgs extends StObject {
    ...
    /**
      ...
      * the peering connection (a maximum of one).
      */
    val accepter: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.ec2.PeeringConnectionOptionsAccepter]] = js.native
    ...
    /**
      ...
      * the peering connection (a maximum of one).
      */
    val requester: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.ec2.PeeringConnectionOptionsRequester]] = js.native
  ...
  object PeeringConnectionOptionsArgs {
    ...
    implicit class PeeringConnectionOptionsArgsMutableBuilder[Self <: PeeringConnectionOptionsArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccepter(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.PeeringConnectionOptionsAccepter]): Self = StObject.set(x, "accepter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAccepterUndefined: Self = StObject.set(x, "accepter", js.undefined)
      
      @scala.inline
      def setRequester(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.PeeringConnectionOptionsRequester]): Self = StObject.set(x, "requester", value.asInstanceOf[js.Any])
