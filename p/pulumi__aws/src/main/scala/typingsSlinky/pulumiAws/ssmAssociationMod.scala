...
import typingsSlinky.pulumiAws.outputMod.ssm.AssociationOutputLocation
import typingsSlinky.pulumiAws.outputMod.ssm.AssociationTarget
...
object ssmAssociationMod {
  ...
  trait AssociationArgs extends StObject {
    ...
    /**
      * An output location block. Output Location is documented below.
      */
    val outputLocation: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.ssm.AssociationOutputLocation]] = js.native
    ...
    /**
      * A block containing the targets of the SSM association. Targets are documented below. AWS currently supports a maximum of 5 targets.
      */
    val targets: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ssm.AssociationTarget]]]] = js.native
  }
  object AssociationArgs {
    ...
    implicit class AssociationArgsMutableBuilder[Self <: AssociationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOutputLocation(value: Input[typingsSlinky.pulumiAws.inputMod.ssm.AssociationOutputLocation]): Self = StObject.set(x, "outputLocation", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTargets(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ssm.AssociationTarget]]]): Self = StObject.set(x, "targets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTargetsUndefined: Self = StObject.set(x, "targets", js.undefined)
      
      @scala.inline
      def setTargetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ssm.AssociationTarget]*): Self = StObject.set(x, "targets", js.Array(value :_*))
    }
  }
