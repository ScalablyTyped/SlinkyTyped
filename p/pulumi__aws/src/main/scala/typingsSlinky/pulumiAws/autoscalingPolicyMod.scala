...
object autoscalingPolicyMod {
  ...
  trait PolicyArgs extends StObject {
    ...
    val stepAdjustments: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.PolicyStepAdjustment]]
        ]
      ] = js.native
    ...
    val targetTrackingConfiguration: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.autoscaling.PolicyTargetTrackingConfiguration]
      ] = js.native
  }
  object PolicyArgs {
    ...
    implicit class PolicyArgsMutableBuilder[Self <: PolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStepAdjustments(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.PolicyStepAdjustment]]
            ]
      ): Self = StObject.set(x, "stepAdjustments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepAdjustmentsUndefined: Self = StObject.set(x, "stepAdjustments", js.undefined)
      
      @scala.inline
      def setStepAdjustmentsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.autoscaling.PolicyStepAdjustment]*): Self = StObject.set(x, "stepAdjustments", js.Array(value :_*))
      
      @scala.inline
      def setTargetTrackingConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.autoscaling.PolicyTargetTrackingConfiguration]): Self = StObject.set(x, "targetTrackingConfiguration", value.asInstanceOf[js.Any])
