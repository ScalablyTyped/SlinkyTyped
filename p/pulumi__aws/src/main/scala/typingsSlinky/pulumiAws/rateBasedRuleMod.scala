...
object rateBasedRuleMod {
  ...
  trait RateBasedRuleArgs extends StObject {
    ...
    val predicates: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.wafregional.RateBasedRulePredicate]]
        ]
      ] = js.native
  ...
  object RateBasedRuleArgs {
    ...
    implicit class RateBasedRuleArgsMutableBuilder[Self <: RateBasedRuleArgs] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "predicates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPredicatesUndefined: Self = StObject.set(x, "predicates", js.undefined)
      
      @scala.inline
      def setPredicatesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.wafregional.RateBasedRulePredicate]*): Self = StObject.set(x, "predicates", js.Array(value :_*))
