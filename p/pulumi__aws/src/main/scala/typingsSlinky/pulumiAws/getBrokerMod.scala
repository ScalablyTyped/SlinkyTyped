...
object getBrokerMod {
  ...
  trait GetBrokerResult extends StObject {
    ...
    val logs: js.UndefOr[typingsSlinky.pulumiAws.outputMod.mq.GetBrokerLogs] = js.native
  ...
  object GetBrokerResult {
    ...
    implicit class GetBrokerResultMutableBuilder[Self <: GetBrokerResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLogs(value: typingsSlinky.pulumiAws.outputMod.mq.GetBrokerLogs): Self = StObject.set(x, "logs", value.asInstanceOf[js.Any])
