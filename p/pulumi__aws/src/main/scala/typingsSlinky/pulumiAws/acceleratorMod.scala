...
object acceleratorMod {
  ...
  trait AcceleratorArgs extends StObject {
    ...
    /**
      * The attributes of the accelerator. Fields documented below.
      */
    val attributes: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.AcceleratorAttributes]] = js.native
  ...
  object AcceleratorArgs {
    ...
    implicit class AcceleratorArgsMutableBuilder[Self <: AcceleratorArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttributes(value: Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.AcceleratorAttributes]): Self = StObject.set(x, "attributes", value.asInstanceOf[js.Any])
  ...
  trait AcceleratorState extends StObject {
    ...
    val ipSets: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.AcceleratorIpSet]]
        ]
      ] = js.native
  ...
  object AcceleratorState {
    ...
    implicit class AcceleratorStateMutableBuilder[Self <: AcceleratorState] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "ipSets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIpSetsUndefined: Self = StObject.set(x, "ipSets", js.undefined)
      
      @scala.inline
      def setIpSetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.AcceleratorIpSet]*): Self = StObject.set(x, "ipSets", js.Array(value :_*))
