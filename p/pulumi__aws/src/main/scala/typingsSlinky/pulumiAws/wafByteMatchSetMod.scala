...
import typingsSlinky.pulumiAws.outputMod.waf.ByteMatchSetByteMatchTuple
...
object wafByteMatchSetMod {
  ...
  trait ByteMatchSetArgs extends StObject {
    ...
    val byteMatchTuples: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.ByteMatchSetByteMatchTuple]]]
      ] = js.native
  ...
  object ByteMatchSetArgs {
    ...
    implicit class ByteMatchSetArgsMutableBuilder[Self <: ByteMatchSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setByteMatchTuples(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.ByteMatchSetByteMatchTuple]]]): Self = StObject.set(x, "byteMatchTuples", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setByteMatchTuplesUndefined: Self = StObject.set(x, "byteMatchTuples", js.undefined)
      
      @scala.inline
      def setByteMatchTuplesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.waf.ByteMatchSetByteMatchTuple]*): Self = StObject.set(x, "byteMatchTuples", js.Array(value :_*))
