...
import typingsSlinky.pulumiAws.outputMod.lb.TargetGroupHealthCheck
import typingsSlinky.pulumiAws.outputMod.lb.TargetGroupStickiness
...
object lbTargetGroupMod {
  ...
  trait TargetGroupArgs extends StObject {
    ...
    /**
      * A Health Check block. Health Check blocks are documented below.
      */
    val healthCheck: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lb.TargetGroupHealthCheck]] = js.native
    ...
    /**
      * A Stickiness block. Stickiness blocks are documented below.
      */
    val stickiness: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lb.TargetGroupStickiness]] = js.native
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typingsSlinky.pulumiAws.inputMod.lb.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typingsSlinky.pulumiAws.inputMod.lb.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
