...
object applicationloadbalancingTargetGroupAttachmentMod {
  ...
  object TargetGroupAttachment {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/targetGroupAttachment", "TargetGroupAttachment.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/targetGroupAttachment", "TargetGroupAttachment.isInstance")
    @js.native
