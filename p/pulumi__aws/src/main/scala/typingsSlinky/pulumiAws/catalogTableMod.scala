...
object catalogTableMod {
  ...
  trait CatalogTableArgs extends StObject {
    ...
    val partitionKeys: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CatalogTablePartitionKey]]]
      ] = js.native
    ...
    /**
      * A storage descriptor object containing information about the physical storage of this table. You can refer to the [Glue Developer Guide](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-catalog-tables.html#aws-glue-api-catalog-tables-StorageDescriptor) for a full explanation of this object.
      */
    val storageDescriptor: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.CatalogTableStorageDescriptor]] = js.native
  ...
  object CatalogTableArgs {
    ...
    implicit class CatalogTableArgsMutableBuilder[Self <: CatalogTableArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPartitionKeys(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CatalogTablePartitionKey]]]): Self = StObject.set(x, "partitionKeys", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPartitionKeysUndefined: Self = StObject.set(x, "partitionKeys", js.undefined)
      
      @scala.inline
      def setPartitionKeysVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CatalogTablePartitionKey]*): Self = StObject.set(x, "partitionKeys", js.Array(value :_*))
      ...
      @scala.inline
      def setStorageDescriptor(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CatalogTableStorageDescriptor]): Self = StObject.set(x, "storageDescriptor", value.asInstanceOf[js.Any])
