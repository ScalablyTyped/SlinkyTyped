...
import typingsSlinky.pulumiAws.outputMod.acm.CertificateDomainValidationOption
import typingsSlinky.pulumiAws.outputMod.acm.CertificateOptions
...
object certificateMod {
  ...
  trait CertificateArgs extends StObject {
    ...
    /**
      ...
      * * Importing an existing certificate
      */
    val options: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.acm.CertificateOptions]] = js.native
  ...
  object CertificateArgs {
    ...
    implicit class CertificateArgsMutableBuilder[Self <: CertificateArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: Input[typingsSlinky.pulumiAws.inputMod.acm.CertificateOptions]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  trait CertificateState extends StObject {
    ...
    val domainValidationOptions: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.acm.CertificateDomainValidationOption]]
        ]
      ] = js.native
  ...
  object CertificateState {
    ...
    implicit class CertificateStateMutableBuilder[Self <: CertificateState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDomainValidationOptionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.acm.CertificateDomainValidationOption]*): Self = StObject.set(x, "domainValidationOptions", js.Array(value :_*))
