...
import typingsSlinky.pulumiAws.outputMod.ecs.CapacityProviderAutoScalingGroupProvider
...
object capacityProviderMod {
  ...
  trait CapacityProviderArgs extends StObject {
    ...
    /**
      * Nested argument defining the provider for the ECS auto scaling group. Defined below.
      */
    val autoScalingGroupProvider: Input[typingsSlinky.pulumiAws.inputMod.ecs.CapacityProviderAutoScalingGroupProvider] = js.native
  ...
  object CapacityProviderArgs {
    ...
    @scala.inline
    def apply(
      autoScalingGroupProvider: Input[typingsSlinky.pulumiAws.inputMod.ecs.CapacityProviderAutoScalingGroupProvider]
    ...
    implicit class CapacityProviderArgsMutableBuilder[Self <: CapacityProviderArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAutoScalingGroupProvider(value: Input[typingsSlinky.pulumiAws.inputMod.ecs.CapacityProviderAutoScalingGroupProvider]): Self = StObject.set(x, "autoScalingGroupProvider", value.asInstanceOf[js.Any])
  ...
  trait CapacityProviderState extends StObject {
    ...
    /**
      * Nested argument defining the provider for the ECS auto scaling group. Defined below.
      */
    val autoScalingGroupProvider: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.ecs.CapacityProviderAutoScalingGroupProvider]
      ] = js.native
