...
object lexMod {
  ...
  @js.native
  class Bot protected ()
    extends typingsSlinky.pulumiAws.botMod.Bot {
    /**
  ...
  class BotAlias protected ()
    extends typingsSlinky.pulumiAws.botAliasMod.BotAlias {
    /**
  ...
  class Intent protected ()
    extends typingsSlinky.pulumiAws.intentMod.Intent {
    /**
  ...
  class SlotType protected ()
    extends typingsSlinky.pulumiAws.slotTypeMod.SlotType {
    /**
