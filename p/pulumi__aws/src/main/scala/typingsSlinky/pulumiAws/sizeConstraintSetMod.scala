...
import typingsSlinky.pulumiAws.outputMod.wafregional.SizeConstraintSetSizeConstraint
...
object sizeConstraintSetMod {
  ...
  trait SizeConstraintSetArgs extends StObject {
    ...
    val sizeConstraints: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.wafregional.SizeConstraintSetSizeConstraint]
          ]
        ]
      ] = js.native
  }
  object SizeConstraintSetArgs {
    ...
    implicit class SizeConstraintSetArgsMutableBuilder[Self <: SizeConstraintSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSizeConstraintsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.wafregional.SizeConstraintSetSizeConstraint]*): Self = StObject.set(x, "sizeConstraints", js.Array(value :_*))
    }
  }
