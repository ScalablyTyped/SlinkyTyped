...
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancing.SslNegotiationPolicyAttribute
  ...
  trait SslNegotiationPolicyArgs extends StObject {
    ...
    val attributes: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.SslNegotiationPolicyAttribute
            ]
          ]
        ]
      ] = js.native
