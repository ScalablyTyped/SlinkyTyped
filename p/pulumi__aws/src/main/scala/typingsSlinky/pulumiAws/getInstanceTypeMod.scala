...
object getInstanceTypeMod {
  ...
  trait GetInstanceTypeResult extends StObject {
    ...
    /**
      ...
      * * `fpgas.#.name` - The name of the FPGA accelerator.
      */
    val fpgas: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeFpga] = js.native
    ...
    /**
      ...
      * * `gpus.#.name` - The name of the GPU accelerator.
      */
    val gpuses: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeGpus] = js.native
    ...
    val inferenceAccelerators: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInferenceAccelerator] = js.native
    ...
    /**
      ...
      * * `instance_disks.#.type` - The type of disk.
      */
    val instanceDisks: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInstanceDisk] = js.native
  ...
  object GetInstanceTypeResult {
    ...
    def apply(
      ...
      enaSupport: String,
      fpgas: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeFpga],
      freeTierEligible: Boolean,
      gpuses: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeGpus],
      hibernationSupported: Boolean,
      hypervisor: String,
      id: String,
      inferenceAccelerators: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInferenceAccelerator],
      instanceDisks: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInstanceDisk],
    ...
    implicit class GetInstanceTypeResultMutableBuilder[Self <: GetInstanceTypeResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFpgas(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeFpga]): Self = StObject.set(x, "fpgas", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFpgasVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeFpga*): Self = StObject.set(x, "fpgas", js.Array(value :_*))
      
      @scala.inline
      def setFreeTierEligible(value: Boolean): Self = StObject.set(x, "freeTierEligible", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGpuses(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeGpus]): Self = StObject.set(x, "gpuses", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGpusesVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeGpus*): Self = StObject.set(x, "gpuses", js.Array(value :_*))
      ...
      @scala.inline
      def setInferenceAccelerators(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInferenceAccelerator]): Self = StObject.set(x, "inferenceAccelerators", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInferenceAcceleratorsVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInferenceAccelerator*): Self = StObject.set(x, "inferenceAccelerators", js.Array(value :_*))
      
      @scala.inline
      def setInstanceDisks(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInstanceDisk]): Self = StObject.set(x, "instanceDisks", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInstanceDisksVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetInstanceTypeInstanceDisk*): Self = StObject.set(x, "instanceDisks", js.Array(value :_*))
