...
object GrantState {
  ...
  implicit class GrantStateOps[Self <: GrantState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGrantId(value: Input[String]): Self = this.set("grantId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteGrantId: Self = this.set("grantId", js.undefined)
    @scala.inline
    def setGrantToken(value: Input[String]): Self = this.set("grantToken", value.asInstanceOf[js.Any])
    @scala.inline
