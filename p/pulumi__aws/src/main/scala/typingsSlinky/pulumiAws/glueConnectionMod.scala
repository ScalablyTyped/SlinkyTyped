...
object glueConnectionMod {
  ...
  trait ConnectionArgs extends StObject {
    ...
    val physicalConnectionRequirements: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.glue.ConnectionPhysicalConnectionRequirements]
      ] = js.native
  }
  object ConnectionArgs {
    ...
    implicit class ConnectionArgsMutableBuilder[Self <: ConnectionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPhysicalConnectionRequirements(value: Input[typingsSlinky.pulumiAws.inputMod.glue.ConnectionPhysicalConnectionRequirements]): Self = StObject.set(x, "physicalConnectionRequirements", value.asInstanceOf[js.Any])
