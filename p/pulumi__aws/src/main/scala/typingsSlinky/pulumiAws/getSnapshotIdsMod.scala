...
import typingsSlinky.pulumiAws.inputMod.ebs.GetSnapshotIdsFilter
...
object getSnapshotIdsMod {
  ...
  trait GetSnapshotIdsResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ebs.GetSnapshotIdsFilter]] = js.native
  ...
  object GetSnapshotIdsResult {
    ...
    implicit class GetSnapshotIdsResultMutableBuilder[Self <: GetSnapshotIdsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ebs.GetSnapshotIdsFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ebs.GetSnapshotIdsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
