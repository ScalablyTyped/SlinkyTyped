...
object spotFleetRequestMod {
  ...
  trait SpotFleetRequestArgs extends StObject {
    ...
    val launchSpecifications: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.SpotFleetRequestLaunchSpecification]]
        ]
      ] = js.native
    ...
    val launchTemplateConfigs: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.SpotFleetRequestLaunchTemplateConfig]]
        ]
      ] = js.native
  ...
  object SpotFleetRequestArgs {
    ...
    implicit class SpotFleetRequestArgsMutableBuilder[Self <: SpotFleetRequestArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLaunchSpecificationsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.SpotFleetRequestLaunchSpecification]*): Self = StObject.set(x, "launchSpecifications", js.Array(value :_*))
      ...
      @scala.inline
      def setLaunchTemplateConfigsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.SpotFleetRequestLaunchTemplateConfig]*): Self = StObject.set(x, "launchTemplateConfigs", js.Array(value :_*))
