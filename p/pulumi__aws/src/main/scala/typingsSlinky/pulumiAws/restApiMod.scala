...
import typingsSlinky.pulumiAws.outputMod.apigateway.RestApiEndpointConfiguration
...
object restApiMod {
  ...
  object RestApi {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/apigateway/restApi", "RestApi.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/apigateway/restApi", "RestApi.isInstance")
    @js.native
  ...
  trait RestApiArgs extends StObject {
    ...
    /**
      * Nested argument defining API endpoint configuration including endpoint type. Defined below.
      */
    val endpointConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigateway.RestApiEndpointConfiguration]] = js.native
  ...
  object RestApiArgs {
    ...
    implicit class RestApiArgsMutableBuilder[Self <: RestApiArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndpointConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.apigateway.RestApiEndpointConfiguration]): Self = StObject.set(x, "endpointConfiguration", value.asInstanceOf[js.Any])
