...
import typingsSlinky.pulumiAws.inputMod.ec2.GetLocalGatewayVirtualInterfaceGroupsFilter
...
object getLocalGatewayVirtualInterfaceGroupsMod {
  ...
  trait GetLocalGatewayVirtualInterfaceGroupsResult extends StObject {
    ...
    val filters: js.UndefOr[
        js.Array[
          typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceGroupsFilter
        ]
      ] = js.native
  ...
  object GetLocalGatewayVirtualInterfaceGroupsResult {
    ...
    implicit class GetLocalGatewayVirtualInterfaceGroupsResultMutableBuilder[Self <: GetLocalGatewayVirtualInterfaceGroupsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceGroupsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
