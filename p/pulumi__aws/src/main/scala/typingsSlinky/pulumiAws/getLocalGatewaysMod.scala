...
import typingsSlinky.pulumiAws.inputMod.ec2.GetLocalGatewaysFilter
...
object getLocalGatewaysMod {
  ...
  trait GetLocalGatewaysResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewaysFilter]] = js.native
  ...
  object GetLocalGatewaysResult {
    ...
    implicit class GetLocalGatewaysResultMutableBuilder[Self <: GetLocalGatewaysResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewaysFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewaysFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
