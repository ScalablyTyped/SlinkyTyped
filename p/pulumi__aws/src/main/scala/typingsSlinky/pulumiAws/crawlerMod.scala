...
object crawlerMod {
  ...
  trait CrawlerArgs extends StObject {
    ...
    val catalogTargets: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerCatalogTarget]]]
      ] = js.native
    ...
    val dynamodbTargets: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerDynamodbTarget]]]
      ] = js.native
    
    /**
      * List of nested JBDC target arguments. See below.
      */
    val jdbcTargets: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerJdbcTarget]]]] = js.native
    
    /**
      * List nested MongoDB target arguments. See below.
      */
    val mongodbTargets: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerMongodbTarget]]]
      ] = js.native
    ...
    /**
      * List nested Amazon S3 target arguments. See below.
      */
    val s3Targets: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerS3Target]]]] = js.native
    ...
    /**
      * Policy for the crawler's update and deletion behavior.
      */
    val schemaChangePolicy: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerSchemaChangePolicy]] = js.native
  ...
  object CrawlerArgs {
    ...
    implicit class CrawlerArgsMutableBuilder[Self <: CrawlerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCatalogTargets(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerCatalogTarget]]]): Self = StObject.set(x, "catalogTargets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCatalogTargetsUndefined: Self = StObject.set(x, "catalogTargets", js.undefined)
      
      @scala.inline
      def setCatalogTargetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerCatalogTarget]*): Self = StObject.set(x, "catalogTargets", js.Array(value :_*))
      ...
      @scala.inline
      def setDynamodbTargets(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerDynamodbTarget]]]): Self = StObject.set(x, "dynamodbTargets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDynamodbTargetsUndefined: Self = StObject.set(x, "dynamodbTargets", js.undefined)
      
      @scala.inline
      def setDynamodbTargetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerDynamodbTarget]*): Self = StObject.set(x, "dynamodbTargets", js.Array(value :_*))
      
      @scala.inline
      def setJdbcTargets(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerJdbcTarget]]]): Self = StObject.set(x, "jdbcTargets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setJdbcTargetsUndefined: Self = StObject.set(x, "jdbcTargets", js.undefined)
      
      @scala.inline
      def setJdbcTargetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerJdbcTarget]*): Self = StObject.set(x, "jdbcTargets", js.Array(value :_*))
      
      @scala.inline
      def setMongodbTargets(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerMongodbTarget]]]): Self = StObject.set(x, "mongodbTargets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMongodbTargetsUndefined: Self = StObject.set(x, "mongodbTargets", js.undefined)
      
      @scala.inline
      def setMongodbTargetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerMongodbTarget]*): Self = StObject.set(x, "mongodbTargets", js.Array(value :_*))
      ...
      @scala.inline
      def setS3Targets(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerS3Target]]]): Self = StObject.set(x, "s3Targets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setS3TargetsUndefined: Self = StObject.set(x, "s3Targets", js.undefined)
      
      @scala.inline
      def setS3TargetsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerS3Target]*): Self = StObject.set(x, "s3Targets", js.Array(value :_*))
      ...
      @scala.inline
      def setSchemaChangePolicy(value: Input[typingsSlinky.pulumiAws.inputMod.glue.CrawlerSchemaChangePolicy]): Self = StObject.set(x, "schemaChangePolicy", value.asInstanceOf[js.Any])
