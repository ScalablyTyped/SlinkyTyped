...
import typingsSlinky.pulumiAws.outputMod.ecs.ClusterDefaultCapacityProviderStrategy
import typingsSlinky.pulumiAws.outputMod.ecs.ClusterSetting
...
object ecsClusterMod {
  ...
  trait ClusterArgs extends StObject {
    ...
    val defaultCapacityProviderStrategies: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.ecs.ClusterDefaultCapacityProviderStrategy]
          ]
        ]
      ] = js.native
    ...
    /**
      * Configuration block(s) with cluster settings. For example, this can be used to enable CloudWatch Container Insights for a cluster. Defined below.
      */
    val settings: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ecs.ClusterSetting]]]] = js.native
  ...
  object ClusterArgs {
    ...
    implicit class ClusterArgsMutableBuilder[Self <: ClusterArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultCapacityProviderStrategiesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ecs.ClusterDefaultCapacityProviderStrategy]*): Self = StObject.set(x, "defaultCapacityProviderStrategies", js.Array(value :_*))
      ...
      @scala.inline
      def setSettings(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ecs.ClusterSetting]]]): Self = StObject.set(x, "settings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSettingsUndefined: Self = StObject.set(x, "settings", js.undefined)
      
      @scala.inline
      def setSettingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ecs.ClusterSetting]*): Self = StObject.set(x, "settings", js.Array(value :_*))
