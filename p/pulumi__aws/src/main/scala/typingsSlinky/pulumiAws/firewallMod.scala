...
object firewallMod {
  ...
  trait FirewallArgs extends StObject {
    ...
    val subnetMappings: Input[
        js.Array[Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.FirewallSubnetMapping]]
      ] = js.native
  ...
  object FirewallArgs {
    ...
    implicit class FirewallArgsMutableBuilder[Self <: FirewallArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSubnetMappingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.FirewallSubnetMapping]*): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
