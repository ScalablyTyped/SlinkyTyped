...
import typingsSlinky.pulumiAws.outputMod.autoscaling.GroupTag
...
object groupMod {
  ...
  trait GroupArgs extends StObject {
    ...
    val initialLifecycleHooks: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupInitialLifecycleHook]]
        ]
      ] = js.native
    ...
    /**
      * Nested argument containing launch template settings along with the overrides to specify multiple instance types and weights. Defined below.
      */
    val launchTemplate: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupLaunchTemplate]] = js.native
    ...
    /**
      * Configuration block containing settings to define launch targets for Auto Scaling groups. Defined below.
      */
    val mixedInstancesPolicy: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupMixedInstancesPolicy]] = js.native
    ...
    /**
      * Configuration block(s) containing resource tags. Conflicts with `tags`. Documented below.
      */
    val tags: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupTag]]]] = js.native
  ...
  object GroupArgs {
    ...
    implicit class GroupArgsMutableBuilder[Self <: GroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInitialLifecycleHooksVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupInitialLifecycleHook]*): Self = StObject.set(x, "initialLifecycleHooks", js.Array(value :_*))
      ...
      @scala.inline
      def setLaunchTemplate(value: Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupLaunchTemplate]): Self = StObject.set(x, "launchTemplate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMixedInstancesPolicy(value: Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupMixedInstancesPolicy]): Self = StObject.set(x, "mixedInstancesPolicy", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTags(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupTag]]]): Self = StObject.set(x, "tags", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTagsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.autoscaling.GroupTag]*): Self = StObject.set(x, "tags", js.Array(value :_*))
