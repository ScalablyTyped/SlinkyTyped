...
object networkAclMod {
  ...
  trait NetworkAclArgs extends StObject {
    ...
    /**
      * Specifies an egress rule. Parameters defined below.
      */
    val egress: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.NetworkAclEgress]]]] = js.native
    
    /**
      * Specifies an ingress rule. Parameters defined below.
      */
    val ingress: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.NetworkAclIngress]]]] = js.native
  ...
  object NetworkAclArgs {
    ...
    implicit class NetworkAclArgsMutableBuilder[Self <: NetworkAclArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEgress(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.NetworkAclEgress]]]): Self = StObject.set(x, "egress", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEgressUndefined: Self = StObject.set(x, "egress", js.undefined)
      
      @scala.inline
      def setEgressVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.NetworkAclEgress]*): Self = StObject.set(x, "egress", js.Array(value :_*))
      
      @scala.inline
      def setIngress(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.NetworkAclIngress]]]): Self = StObject.set(x, "ingress", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIngressUndefined: Self = StObject.set(x, "ingress", js.undefined)
      
      @scala.inline
      def setIngressVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.NetworkAclIngress]*): Self = StObject.set(x, "ingress", js.Array(value :_*))
