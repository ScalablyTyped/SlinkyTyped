...
object virtualNodeMod {
  ...
  trait VirtualNodeArgs extends StObject {
    ...
    /**
      * The virtual node specification to apply.
      */
    val spec: Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualNodeSpec] = js.native
  ...
  object VirtualNodeArgs {
    ...
    @scala.inline
    def apply(meshName: Input[String], spec: Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualNodeSpec]): VirtualNodeArgs = {
    ...
    implicit class VirtualNodeArgsMutableBuilder[Self <: VirtualNodeArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualNodeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
  ...
  trait VirtualNodeState extends StObject {
    ...
    /**
      * The virtual node specification to apply.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appmesh.VirtualNodeSpec]] = js.native
