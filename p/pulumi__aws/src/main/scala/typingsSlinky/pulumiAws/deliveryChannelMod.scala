...
object deliveryChannelMod {
  ...
  trait DeliveryChannelArgs extends StObject {
    ...
    /**
      * Options for how AWS Config delivers configuration snapshots. See below
      */
    val snapshotDeliveryProperties: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.cfg.DeliveryChannelSnapshotDeliveryProperties]
      ] = js.native
  ...
  object DeliveryChannelArgs {
    ...
    implicit class DeliveryChannelArgsMutableBuilder[Self <: DeliveryChannelArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSnapshotDeliveryProperties(value: Input[typingsSlinky.pulumiAws.inputMod.cfg.DeliveryChannelSnapshotDeliveryProperties]): Self = StObject.set(x, "snapshotDeliveryProperties", value.asInstanceOf[js.Any])
