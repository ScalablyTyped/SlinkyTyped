...
object amiFromInstanceMod {
  ...
  trait AmiFromInstanceArgs extends StObject {
    ...
    val ebsBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiFromInstanceEbsBlockDevice]]
        ]
      ] = js.native
    ...
    val ephemeralBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiFromInstanceEphemeralBlockDevice]]
        ]
      ] = js.native
  ...
  object AmiFromInstanceArgs {
    ...
    implicit class AmiFromInstanceArgsMutableBuilder[Self <: AmiFromInstanceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiFromInstanceEbsBlockDevice]*): Self = StObject.set(x, "ebsBlockDevices", js.Array(value :_*))
      ...
      @scala.inline
      def setEphemeralBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiFromInstanceEphemeralBlockDevice]*): Self = StObject.set(x, "ephemeralBlockDevices", js.Array(value :_*))
