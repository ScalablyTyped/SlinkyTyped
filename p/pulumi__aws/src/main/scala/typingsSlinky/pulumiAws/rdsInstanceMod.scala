...
object rdsInstanceMod {
  ...
  trait InstanceArgs extends StObject {
    ...
    /**
      * A configuration block for restoring a DB instance to an arbitrary point in time. Requires the `identifier` argument to be set with the name of the new DB instance to be created. See Restore To Point In Time below for details.
      */
    val restoreToPointInTime: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.rds.InstanceRestoreToPointInTime]] = js.native
    
    /**
      * Restore from a Percona Xtrabackup in S3.  See [Importing Data into an Amazon RDS MySQL DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.html)
      */
    val s3Import: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.rds.InstanceS3Import]] = js.native
  ...
  object InstanceArgs {
    ...
    implicit class InstanceArgsMutableBuilder[Self <: InstanceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRestoreToPointInTime(value: Input[typingsSlinky.pulumiAws.inputMod.rds.InstanceRestoreToPointInTime]): Self = StObject.set(x, "restoreToPointInTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRestoreToPointInTimeUndefined: Self = StObject.set(x, "restoreToPointInTime", js.undefined)
      
      @scala.inline
      def setS3Import(value: Input[typingsSlinky.pulumiAws.inputMod.rds.InstanceS3Import]): Self = StObject.set(x, "s3Import", value.asInstanceOf[js.Any])
