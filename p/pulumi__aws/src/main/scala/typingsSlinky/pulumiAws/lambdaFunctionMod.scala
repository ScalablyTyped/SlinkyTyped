...
import typingsSlinky.pulumiAws.outputMod.lambda.FunctionFileSystemConfig
import typingsSlinky.pulumiAws.outputMod.lambda.FunctionTracingConfig
import typingsSlinky.pulumiAws.outputMod.lambda.FunctionVpcConfig
...
object lambdaFunctionMod {
  ...
  trait FunctionArgs extends StObject {
    ...
    /**
      * Nested block to configure the function's *dead letter queue*. See details below.
      */
    val deadLetterConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionDeadLetterConfig]] = js.native
    ...
    /**
      * The Lambda environment's configuration settings. Fields documented below.
      */
    val environment: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionEnvironment]] = js.native
    
    /**
      * The connection settings for an EFS file system. Fields documented below. Before creating or updating Lambda functions with `fileSystemConfig`, EFS mount targets much be in available lifecycle state. Use `dependsOn` to explicitly declare this dependency. See [Using Amazon EFS with Lambda](https://docs.aws.amazon.com/lambda/latest/dg/services-efs.html).
      */
    val fileSystemConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionFileSystemConfig]] = js.native
    ...
    val tracingConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionTracingConfig]] = js.native
    
    /**
      * Provide this to allow your function to access your VPC. Fields documented below. See [Lambda in VPC](http://docs.aws.amazon.com/lambda/latest/dg/vpc.html)
      */
    val vpcConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionVpcConfig]] = js.native
  }
  object FunctionArgs {
    ...
    implicit class FunctionArgsMutableBuilder[Self <: FunctionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDeadLetterConfig(value: Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionDeadLetterConfig]): Self = StObject.set(x, "deadLetterConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEnvironment(value: Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionEnvironment]): Self = StObject.set(x, "environment", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEnvironmentUndefined: Self = StObject.set(x, "environment", js.undefined)
      
      @scala.inline
      def setFileSystemConfig(value: Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionFileSystemConfig]): Self = StObject.set(x, "fileSystemConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTracingConfig(value: Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionTracingConfig]): Self = StObject.set(x, "tracingConfig", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTracingConfigUndefined: Self = StObject.set(x, "tracingConfig", js.undefined)
      
      @scala.inline
      def setVpcConfig(value: Input[typingsSlinky.pulumiAws.inputMod.lambda.FunctionVpcConfig]): Self = StObject.set(x, "vpcConfig", value.asInstanceOf[js.Any])
