...
object workspacesDirectoryMod {
  ...
  trait DirectoryArgs extends StObject {
    ...
    /**
      * Permissions to enable or disable self-service capabilities. Defined below.
      */
    val selfServicePermissions: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.workspaces.DirectorySelfServicePermissions]
      ] = js.native
    ...
    val workspaceCreationProperties: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.workspaces.DirectoryWorkspaceCreationProperties]
      ] = js.native
  }
  object DirectoryArgs {
    ...
    implicit class DirectoryArgsMutableBuilder[Self <: DirectoryArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelfServicePermissions(value: Input[typingsSlinky.pulumiAws.inputMod.workspaces.DirectorySelfServicePermissions]): Self = StObject.set(x, "selfServicePermissions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWorkspaceCreationProperties(value: Input[typingsSlinky.pulumiAws.inputMod.workspaces.DirectoryWorkspaceCreationProperties]): Self = StObject.set(x, "workspaceCreationProperties", value.asInstanceOf[js.Any])
