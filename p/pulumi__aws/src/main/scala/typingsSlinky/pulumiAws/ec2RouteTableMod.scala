...
object ec2RouteTableMod {
  ...
  trait RouteTableArgs extends StObject {
    ...
    /**
      * A list of route objects. Their keys are documented below.
      */
    val routes: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.RouteTableRoute]]]] = js.native
  ...
  object RouteTableArgs {
    ...
    implicit class RouteTableArgsMutableBuilder[Self <: RouteTableArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRoutes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.RouteTableRoute]]]): Self = StObject.set(x, "routes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRoutesUndefined: Self = StObject.set(x, "routes", js.undefined)
      
      @scala.inline
      def setRoutesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.RouteTableRoute]*): Self = StObject.set(x, "routes", js.Array(value :_*))
