...
object imagebuilderMod extends js.Object {
  ...
  class Component protected ()
    extends typingsSlinky.pulumiAws.componentMod.Component {
    /**
  ...
  class DistributionConfiguration protected ()
    extends typingsSlinky.pulumiAws.distributionConfigurationMod.DistributionConfiguration {
    /**
  ...
  class InfrastructureConfiguration protected ()
    extends typingsSlinky.pulumiAws.infrastructureConfigurationMod.InfrastructureConfiguration {
    /**
