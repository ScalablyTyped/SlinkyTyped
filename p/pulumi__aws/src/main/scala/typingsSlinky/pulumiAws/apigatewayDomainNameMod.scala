...
object apigatewayDomainNameMod {
  ...
  trait DomainNameArgs extends StObject {
    ...
    /**
      * Configuration block defining API endpoint information including type. Defined below.
      */
    val endpointConfiguration: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.apigateway.DomainNameEndpointConfiguration]
      ] = js.native
  ...
  object DomainNameArgs {
    ...
    implicit class DomainNameArgsMutableBuilder[Self <: DomainNameArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndpointConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.apigateway.DomainNameEndpointConfiguration]): Self = StObject.set(x, "endpointConfiguration", value.asInstanceOf[js.Any])
