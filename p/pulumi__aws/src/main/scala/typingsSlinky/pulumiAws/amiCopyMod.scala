...
object amiCopyMod {
  ...
  trait AmiCopyArgs extends StObject {
    ...
    val ebsBlockDevices: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiCopyEbsBlockDevice]]]
      ] = js.native
    ...
    val ephemeralBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiCopyEphemeralBlockDevice]]
        ]
      ] = js.native
  ...
  object AmiCopyArgs {
    ...
    implicit class AmiCopyArgsMutableBuilder[Self <: AmiCopyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsBlockDevices(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiCopyEbsBlockDevice]]]): Self = StObject.set(x, "ebsBlockDevices", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsBlockDevicesUndefined: Self = StObject.set(x, "ebsBlockDevices", js.undefined)
      
      @scala.inline
      def setEbsBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiCopyEbsBlockDevice]*): Self = StObject.set(x, "ebsBlockDevices", js.Array(value :_*))
      ...
      @scala.inline
      def setEphemeralBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.AmiCopyEphemeralBlockDevice]*): Self = StObject.set(x, "ephemeralBlockDevices", js.Array(value :_*))
