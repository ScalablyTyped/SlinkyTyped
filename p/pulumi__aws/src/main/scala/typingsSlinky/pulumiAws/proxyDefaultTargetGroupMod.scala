...
import typingsSlinky.pulumiAws.outputMod.rds.ProxyDefaultTargetGroupConnectionPoolConfig
...
object proxyDefaultTargetGroupMod {
  ...
  trait ProxyDefaultTargetGroupArgs extends StObject {
    ...
    /**
      * The settings that determine the size and behavior of the connection pool for the target group.
      */
    val connectionPoolConfig: Input[typingsSlinky.pulumiAws.inputMod.rds.ProxyDefaultTargetGroupConnectionPoolConfig] = js.native
  ...
  object ProxyDefaultTargetGroupArgs {
    ...
    @scala.inline
    def apply(
      connectionPoolConfig: Input[typingsSlinky.pulumiAws.inputMod.rds.ProxyDefaultTargetGroupConnectionPoolConfig],
    ...
    implicit class ProxyDefaultTargetGroupArgsMutableBuilder[Self <: ProxyDefaultTargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConnectionPoolConfig(value: Input[typingsSlinky.pulumiAws.inputMod.rds.ProxyDefaultTargetGroupConnectionPoolConfig]): Self = StObject.set(x, "connectionPoolConfig", value.asInstanceOf[js.Any])
  ...
  trait ProxyDefaultTargetGroupState extends StObject {
    ...
    val connectionPoolConfig: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.rds.ProxyDefaultTargetGroupConnectionPoolConfig]
      ] = js.native
