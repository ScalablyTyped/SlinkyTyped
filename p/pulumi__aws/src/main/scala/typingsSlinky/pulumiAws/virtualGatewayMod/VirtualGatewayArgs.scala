package typingsSlinky.pulumiAws.virtualGatewayMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.inputMod.appmesh.VirtualGatewaySpec
...
@js.native
trait VirtualGatewayArgs extends js.Object {
  ...
  /**
    ...
    */
  val spec: Input[VirtualGatewaySpec] = js.native
...
object VirtualGatewayArgs {
  ...
  @scala.inline
  def apply(meshName: Input[String], spec: Input[VirtualGatewaySpec]): VirtualGatewayArgs = {
  ...
  @scala.inline
  implicit class VirtualGatewayArgsOps[Self <: VirtualGatewayArgs] (val x: Self) extends AnyVal {
