...
object integrationMod {
  ...
  trait IntegrationArgs extends StObject {
    ...
    /**
      * The TLS configuration for a private integration. Supported only for HTTP APIs.
      */
    val tlsConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigatewayv2.IntegrationTlsConfig]] = js.native
  }
  object IntegrationArgs {
    ...
    implicit class IntegrationArgsMutableBuilder[Self <: IntegrationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTlsConfig(value: Input[typingsSlinky.pulumiAws.inputMod.apigatewayv2.IntegrationTlsConfig]): Self = StObject.set(x, "tlsConfig", value.asInstanceOf[js.Any])
