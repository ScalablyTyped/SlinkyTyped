...
object securityGroupMod {
  ...
  object SecurityGroup {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/ec2/securityGroup", "SecurityGroup.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/ec2/securityGroup", "SecurityGroup.isInstance")
    @js.native
  ...
  trait SecurityGroupArgs extends StObject {
    ...
    /**
      ...
      * egress rule. Each egress block supports fields documented below.
      */
    val egress: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.SecurityGroupEgress]]]] = js.native
    ...
    val ingress: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.SecurityGroupIngress]]]
      ] = js.native
  ...
  object SecurityGroupArgs {
    ...
    implicit class SecurityGroupArgsMutableBuilder[Self <: SecurityGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEgress(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.SecurityGroupEgress]]]): Self = StObject.set(x, "egress", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEgressUndefined: Self = StObject.set(x, "egress", js.undefined)
      
      @scala.inline
      def setEgressVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.SecurityGroupEgress]*): Self = StObject.set(x, "egress", js.Array(value :_*))
      
      @scala.inline
      def setIngress(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.SecurityGroupIngress]]]): Self = StObject.set(x, "ingress", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIngressUndefined: Self = StObject.set(x, "ingress", js.undefined)
      
      @scala.inline
      def setIngressVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.SecurityGroupIngress]*): Self = StObject.set(x, "ingress", js.Array(value :_*))
