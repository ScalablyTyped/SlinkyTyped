...
object customLayerMod {
  ...
  trait CustomLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.CustomLayerEbsVolume]]]
      ] = js.native
  ...
  object CustomLayerArgs {
    ...
    implicit class CustomLayerArgsMutableBuilder[Self <: CustomLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.CustomLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.CustomLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
