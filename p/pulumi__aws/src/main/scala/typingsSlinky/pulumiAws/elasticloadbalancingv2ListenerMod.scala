...
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.ListenerDefaultAction
...
object elasticloadbalancingv2ListenerMod {
  ...
  trait ListenerArgs extends StObject {
    ...
    val defaultActions: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.ListenerDefaultAction]
        ]
      ] = js.native
  ...
  object ListenerArgs {
    ...
    implicit class ListenerArgsMutableBuilder[Self <: ListenerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultActionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.ListenerDefaultAction]*): Self = StObject.set(x, "defaultActions", js.Array(value :_*))
