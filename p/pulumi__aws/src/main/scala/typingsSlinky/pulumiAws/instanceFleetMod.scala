...
import typingsSlinky.pulumiAws.outputMod.emr.InstanceFleetInstanceTypeConfig
import typingsSlinky.pulumiAws.outputMod.emr.InstanceFleetLaunchSpecifications
...
object instanceFleetMod {
  ...
  trait InstanceFleetArgs extends StObject {
    ...
    val instanceTypeConfigs: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceFleetInstanceTypeConfig]]
        ]
      ] = js.native
    ...
    /**
      * Configuration block for launch specification
      */
    val launchSpecifications: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceFleetLaunchSpecifications]] = js.native
  ...
  object InstanceFleetArgs {
    ...
    implicit class InstanceFleetArgsMutableBuilder[Self <: InstanceFleetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInstanceTypeConfigs(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceFleetInstanceTypeConfig]]
            ]
      ): Self = StObject.set(x, "instanceTypeConfigs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInstanceTypeConfigsUndefined: Self = StObject.set(x, "instanceTypeConfigs", js.undefined)
      
      @scala.inline
      def setInstanceTypeConfigsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceFleetInstanceTypeConfig]*): Self = StObject.set(x, "instanceTypeConfigs", js.Array(value :_*))
      
      @scala.inline
      def setLaunchSpecifications(value: Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceFleetLaunchSpecifications]): Self = StObject.set(x, "launchSpecifications", value.asInstanceOf[js.Any])
