...
import typingsSlinky.pulumiAws.outputMod.datasync.NfsLocationOnPremConfig
...
object nfsLocationMod {
  ...
  trait NfsLocationArgs extends StObject {
    ...
    /**
      * Configuration block containing information for connecting to the NFS File System.
      */
    val onPremConfig: Input[typingsSlinky.pulumiAws.inputMod.datasync.NfsLocationOnPremConfig] = js.native
  ...
  object NfsLocationArgs {
    ...
    @scala.inline
    def apply(
      onPremConfig: Input[typingsSlinky.pulumiAws.inputMod.datasync.NfsLocationOnPremConfig],
    ...
    implicit class NfsLocationArgsMutableBuilder[Self <: NfsLocationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnPremConfig(value: Input[typingsSlinky.pulumiAws.inputMod.datasync.NfsLocationOnPremConfig]): Self = StObject.set(x, "onPremConfig", value.asInstanceOf[js.Any])
  ...
  trait NfsLocationState extends StObject {
    ...
    /**
      * Configuration block containing information for connecting to the NFS File System.
      */
    val onPremConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.datasync.NfsLocationOnPremConfig]] = js.native
