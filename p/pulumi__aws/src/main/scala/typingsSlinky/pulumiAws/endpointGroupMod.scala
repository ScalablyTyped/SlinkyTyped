...
object endpointGroupMod {
  ...
  trait EndpointGroupArgs extends StObject {
    ...
    val endpointConfigurations: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.globalaccelerator.EndpointGroupEndpointConfiguration
            ]
          ]
        ]
      ] = js.native
    ...
    val portOverrides: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.EndpointGroupPortOverride]
          ]
        ]
      ] = js.native
  ...
  object EndpointGroupArgs {
    ...
    implicit class EndpointGroupArgsMutableBuilder[Self <: EndpointGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndpointConfigurationsVarargs(
        value: (Input[
              typingsSlinky.pulumiAws.inputMod.globalaccelerator.EndpointGroupEndpointConfiguration
            ])*
      ): Self = StObject.set(x, "endpointConfigurations", js.Array(value :_*))
      ...
      @scala.inline
      def setPortOverridesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.globalaccelerator.EndpointGroupPortOverride]*): Self = StObject.set(x, "portOverrides", js.Array(value :_*))
