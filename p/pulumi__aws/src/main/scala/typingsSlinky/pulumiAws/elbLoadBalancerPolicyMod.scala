...
object elbLoadBalancerPolicyMod {
  ...
  trait LoadBalancerPolicyArgs extends StObject {
    ...
    val policyAttributes: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.elb.LoadBalancerPolicyPolicyAttribute]]
        ]
      ] = js.native
  ...
  object LoadBalancerPolicyArgs {
    ...
    implicit class LoadBalancerPolicyArgsMutableBuilder[Self <: LoadBalancerPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPolicyAttributesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elb.LoadBalancerPolicyPolicyAttribute]*): Self = StObject.set(x, "policyAttributes", js.Array(value :_*))
