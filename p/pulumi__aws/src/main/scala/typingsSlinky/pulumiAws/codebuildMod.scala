...
object codebuildMod extends js.Object {
  ...
  class ReportGroup protected ()
    extends typingsSlinky.pulumiAws.reportGroupMod.ReportGroup {
    /**
  ...
  class SourceCredential protected ()
    extends typingsSlinky.pulumiAws.sourceCredentialMod.SourceCredential {
    /**
  ...
  class Webhook protected ()
    extends typingsSlinky.pulumiAws.webhookMod.Webhook {
    /**
