...
import typingsSlinky.pulumiAws.outputMod.emr.InstanceGroupEbsConfig
...
object instanceGroupMod {
  ...
  trait InstanceGroupArgs extends StObject {
    ...
    val ebsConfigs: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceGroupEbsConfig]]]
      ] = js.native
  ...
  object InstanceGroupArgs {
    ...
    implicit class InstanceGroupArgsMutableBuilder[Self <: InstanceGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsConfigs(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceGroupEbsConfig]]]): Self = StObject.set(x, "ebsConfigs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsConfigsUndefined: Self = StObject.set(x, "ebsConfigs", js.undefined)
      
      @scala.inline
      def setEbsConfigsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.emr.InstanceGroupEbsConfig]*): Self = StObject.set(x, "ebsConfigs", js.Array(value :_*))
