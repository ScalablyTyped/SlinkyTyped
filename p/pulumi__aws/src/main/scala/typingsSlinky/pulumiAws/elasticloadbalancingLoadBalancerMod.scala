...
object elasticloadbalancingLoadBalancerMod {
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    val accessLogs: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerAccessLogs]
      ] = js.native
    ...
    val healthCheck: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerHealthCheck]
      ] = js.native
    ...
    val listeners: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerListener]
        ]
      ] = js.native
  ...
  object LoadBalancerArgs {
    ...
    implicit class LoadBalancerArgsMutableBuilder[Self <: LoadBalancerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHealthCheck(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setListenersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerListener]*): Self = StObject.set(x, "listeners", js.Array(value :_*))
