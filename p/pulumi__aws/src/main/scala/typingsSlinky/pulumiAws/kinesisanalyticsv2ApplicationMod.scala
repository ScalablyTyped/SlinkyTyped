...
import typingsSlinky.pulumiAws.outputMod.kinesisanalyticsv2.ApplicationApplicationConfiguration
import typingsSlinky.pulumiAws.outputMod.kinesisanalyticsv2.ApplicationCloudwatchLoggingOptions
...
object kinesisanalyticsv2ApplicationMod {
  ...
  trait ApplicationArgs extends StObject {
    ...
    val applicationConfiguration: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.kinesisanalyticsv2.ApplicationApplicationConfiguration
        ]
      ] = js.native
    ...
    val cloudwatchLoggingOptions: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.kinesisanalyticsv2.ApplicationCloudwatchLoggingOptions
        ]
      ] = js.native
