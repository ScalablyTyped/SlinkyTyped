...
object filterMod {
  ...
  trait FilterArgs extends StObject {
    ...
    /**
      * Represents the criteria to be used in the filter for querying findings. Contains one or more `criterion` blocks, documented below.
      */
    val findingCriteria: Input[typingsSlinky.pulumiAws.inputMod.guardduty.FilterFindingCriteria] = js.native
  ...
  object FilterArgs {
    ...
    def apply(
      ...
      findingCriteria: Input[typingsSlinky.pulumiAws.inputMod.guardduty.FilterFindingCriteria],
      rank: Input[Double]
    ): FilterArgs = {
    ...
    implicit class FilterArgsMutableBuilder[Self <: FilterArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFindingCriteria(value: Input[typingsSlinky.pulumiAws.inputMod.guardduty.FilterFindingCriteria]): Self = StObject.set(x, "findingCriteria", value.asInstanceOf[js.Any])
  ...
  trait FilterState extends StObject {
    ...
    /**
      * Represents the criteria to be used in the filter for querying findings. Contains one or more `criterion` blocks, documented below.
      */
    val findingCriteria: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.guardduty.FilterFindingCriteria]] = js.native
