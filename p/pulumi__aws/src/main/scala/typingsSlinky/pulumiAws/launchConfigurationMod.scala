...
object launchConfigurationMod {
  ...
  trait LaunchConfigurationArgs extends StObject {
    ...
    val ebsBlockDevices: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.LaunchConfigurationEbsBlockDevice]]
        ]
      ] = js.native
    ...
    val ephemeralBlockDevices: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.ec2.LaunchConfigurationEphemeralBlockDevice]
          ]
        ]
      ] = js.native
    ...
    /**
      ...
      * device of the instance. See Block Devices below for details.
      */
    val rootBlockDevice: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.ec2.LaunchConfigurationRootBlockDevice]] = js.native
  ...
  object LaunchConfigurationArgs {
    ...
    implicit class LaunchConfigurationArgsMutableBuilder[Self <: LaunchConfigurationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.LaunchConfigurationEbsBlockDevice]*): Self = StObject.set(x, "ebsBlockDevices", js.Array(value :_*))
      ...
      @scala.inline
      def setEphemeralBlockDevicesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.LaunchConfigurationEphemeralBlockDevice]*): Self = StObject.set(x, "ephemeralBlockDevices", js.Array(value :_*))
      ...
      @scala.inline
      def setRootBlockDevice(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.LaunchConfigurationRootBlockDevice]): Self = StObject.set(x, "rootBlockDevice", value.asInstanceOf[js.Any])
