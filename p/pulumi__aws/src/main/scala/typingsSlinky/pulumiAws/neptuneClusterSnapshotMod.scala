...
object neptuneClusterSnapshotMod {
  ...
  object ClusterSnapshot {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/neptune/clusterSnapshot", "ClusterSnapshot.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/neptune/clusterSnapshot", "ClusterSnapshot.isInstance")
    @js.native
