...
object getInternetGatewayMod {
  ...
  trait GetInternetGatewayResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInternetGatewayFilter]] = js.native
  ...
  object GetInternetGatewayResult {
    ...
    implicit class GetInternetGatewayResultMutableBuilder[Self <: GetInternetGatewayResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetInternetGatewayFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetInternetGatewayFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
