...
import typingsSlinky.pulumiAws.inputMod.opsworks.GangliaLayerEbsVolume
...
object GangliaLayerArgs {
  ...
  @scala.inline
  implicit class GangliaLayerArgsOps[Self <: GangliaLayerArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEbsVolumes(value: Input[js.Array[Input[GangliaLayerEbsVolume]]]): Self = {
        val ret = this.duplicate
