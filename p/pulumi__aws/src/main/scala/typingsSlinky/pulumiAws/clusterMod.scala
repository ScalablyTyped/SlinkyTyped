...
import typingsSlinky.pulumiAws.outputMod.cloudhsmv2.ClusterClusterCertificate
...
object clusterMod {
  ...
  trait ClusterState extends StObject {
    ...
    val clusterCertificates: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.cloudhsmv2.ClusterClusterCertificate]]
        ]
      ] = js.native
  ...
  object ClusterState {
    ...
    implicit class ClusterStateMutableBuilder[Self <: ClusterState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClusterCertificates(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.cloudhsmv2.ClusterClusterCertificate]]
            ]
      ): Self = StObject.set(x, "clusterCertificates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClusterCertificatesUndefined: Self = StObject.set(x, "clusterCertificates", js.undefined)
      
      @scala.inline
      def setClusterCertificatesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cloudhsmv2.ClusterClusterCertificate]*): Self = StObject.set(x, "clusterCertificates", js.Array(value :_*))
