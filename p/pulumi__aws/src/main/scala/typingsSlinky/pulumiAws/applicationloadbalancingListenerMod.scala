...
import typingsSlinky.pulumiAws.outputMod.applicationloadbalancing.ListenerDefaultAction
...
object applicationloadbalancingListenerMod {
  ...
  object Listener {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/listener", "Listener.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/listener", "Listener.isInstance")
    @js.native
  ...
  trait ListenerArgs extends StObject {
    ...
    val defaultActions: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.ListenerDefaultAction]
        ]
      ] = js.native
  ...
  object ListenerArgs {
    ...
    implicit class ListenerArgsMutableBuilder[Self <: ListenerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultActionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.ListenerDefaultAction]*): Self = StObject.set(x, "defaultActions", js.Array(value :_*))
