...
import typingsSlinky.pulumiAws.inputMod.ec2.GetCoipPoolFilter
...
object getCoipPoolMod {
  ...
  trait GetCoipPoolResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetCoipPoolFilter]] = js.native
  ...
  object GetCoipPoolResult {
    ...
    implicit class GetCoipPoolResultMutableBuilder[Self <: GetCoipPoolResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetCoipPoolFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetCoipPoolFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
