...
import typingsSlinky.pulumiAws.inputMod.ec2.GetLocalGatewayRouteTableFilter
...
object getLocalGatewayRouteTableMod {
  ...
  trait GetLocalGatewayRouteTableResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayRouteTableFilter]] = js.native
  ...
  object GetLocalGatewayRouteTableResult {
    ...
    implicit class GetLocalGatewayRouteTableResultMutableBuilder[Self <: GetLocalGatewayRouteTableResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayRouteTableFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayRouteTableFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
