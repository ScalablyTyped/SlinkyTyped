package typingsSlinky.pulumiAws.elasticloadbalancingv2LoadBalancerMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs
import typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping
...
object LoadBalancerState {
  ...
  implicit class LoadBalancerStateOps[Self <: LoadBalancerState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLoadBalancerType(value: Input[String]): Self = {
        val ret = this.duplicate
