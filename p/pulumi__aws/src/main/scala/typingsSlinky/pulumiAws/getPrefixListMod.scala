...
object getPrefixListMod {
  ...
  trait GetPrefixListResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.GetPrefixListFilter]] = js.native
  ...
  object GetPrefixListResult {
    ...
    implicit class GetPrefixListResultMutableBuilder[Self <: GetPrefixListResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.GetPrefixListFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.GetPrefixListFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
