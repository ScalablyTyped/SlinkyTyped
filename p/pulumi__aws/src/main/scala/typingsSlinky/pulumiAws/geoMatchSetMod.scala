...
import typingsSlinky.pulumiAws.outputMod.wafregional.GeoMatchSetGeoMatchConstraint
...
object geoMatchSetMod {
  ...
  trait GeoMatchSetArgs extends StObject {
    ...
    val geoMatchConstraints: js.UndefOr[
        Input[
          js.Array[
            Input[typingsSlinky.pulumiAws.inputMod.wafregional.GeoMatchSetGeoMatchConstraint]
          ]
        ]
      ] = js.native
  ...
  object GeoMatchSetArgs {
    ...
    implicit class GeoMatchSetArgsMutableBuilder[Self <: GeoMatchSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeoMatchConstraintsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.wafregional.GeoMatchSetGeoMatchConstraint]*): Self = StObject.set(x, "geoMatchConstraints", js.Array(value :_*))
