...
object getVpcsMod {
  ...
  trait GetVpcsResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetVpcsFilter]] = js.native
  ...
  object GetVpcsResult {
    ...
    implicit class GetVpcsResultMutableBuilder[Self <: GetVpcsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetVpcsFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetVpcsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
