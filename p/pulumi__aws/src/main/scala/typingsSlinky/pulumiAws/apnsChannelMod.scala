...
object apnsChannelMod {
  ...
  object ApnsChannel {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/pinpoint/apnsChannel", "ApnsChannel.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/pinpoint/apnsChannel", "ApnsChannel.isInstance")
    @js.native
  ...
  @js.native
  trait ApnsChannelState extends StObject {
