...
import typingsSlinky.pulumiAws.outputMod.opsworks.JavaAppLayerEbsVolume
...
object JavaAppLayer extends js.Object {
  ...
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): JavaAppLayer = js.native
