...
object MemcachedLayerState {
  ...
  implicit class MemcachedLayerStateOps[Self <: MemcachedLayerState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllocatedMemory(value: Input[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allocatedMemory")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAllocatedMemory: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allocatedMemory")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withEbsVolumes(value: Input[js.Array[Input[MemcachedLayerEbsVolume]]]): Self = {
        val ret = this.duplicate
