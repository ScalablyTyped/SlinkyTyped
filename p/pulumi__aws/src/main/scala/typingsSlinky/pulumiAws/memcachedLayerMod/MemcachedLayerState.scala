package typingsSlinky.pulumiAws.memcachedLayerMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.inputMod.opsworks.MemcachedLayerEbsVolume
...
trait MemcachedLayerState extends js.Object {
  ...
  /**
    ...
    */
  val ebsVolumes: js.UndefOr[Input[js.Array[Input[MemcachedLayerEbsVolume]]]] = js.native
...
object MemcachedLayerState {
  ...
  @scala.inline
  implicit class MemcachedLayerStateOps[Self <: MemcachedLayerState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllocatedMemory(value: Input[Double]): Self = this.set("allocatedMemory", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllocatedMemory: Self = this.set("allocatedMemory", js.undefined)
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[MemcachedLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[MemcachedLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
