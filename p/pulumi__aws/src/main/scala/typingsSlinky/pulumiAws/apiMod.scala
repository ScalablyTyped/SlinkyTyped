...
import typingsSlinky.pulumiAws.outputMod.apigatewayv2.ApiCorsConfiguration
...
object apiMod {
  ...
  trait ApiArgs extends StObject {
    ...
    /**
      * The cross-origin resource sharing (CORS) [configuration](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-cors.html). Applicable for HTTP APIs.
      */
    val corsConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigatewayv2.ApiCorsConfiguration]] = js.native
  ...
  object ApiArgs {
    ...
    implicit class ApiArgsMutableBuilder[Self <: ApiArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCorsConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.apigatewayv2.ApiCorsConfiguration]): Self = StObject.set(x, "corsConfiguration", value.asInstanceOf[js.Any])
