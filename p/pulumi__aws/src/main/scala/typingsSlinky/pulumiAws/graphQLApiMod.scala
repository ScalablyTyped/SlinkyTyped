...
import typingsSlinky.pulumiAws.outputMod.appsync.GraphQLApiAdditionalAuthenticationProvider
import typingsSlinky.pulumiAws.outputMod.appsync.GraphQLApiLogConfig
import typingsSlinky.pulumiAws.outputMod.appsync.GraphQLApiOpenidConnectConfig
import typingsSlinky.pulumiAws.outputMod.appsync.GraphQLApiUserPoolConfig
...
object graphQLApiMod {
  ...
  trait GraphQLApiArgs extends StObject {
    ...
    val additionalAuthenticationProviders: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiAdditionalAuthenticationProvider
            ]
          ]
        ]
      ] = js.native
    ...
    /**
      * Nested argument containing logging configuration. Defined below.
      */
    val logConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiLogConfig]] = js.native
    ...
    /**
      * Nested argument containing OpenID Connect configuration. Defined below.
      */
    val openidConnectConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiOpenidConnectConfig]] = js.native
    ...
    /**
      * The Amazon Cognito User Pool configuration. Defined below.
      */
    val userPoolConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiUserPoolConfig]] = js.native
  ...
  object GraphQLApiArgs {
    ...
    implicit class GraphQLApiArgsMutableBuilder[Self <: GraphQLApiArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdditionalAuthenticationProvidersVarargs(
        value: (Input[
              typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiAdditionalAuthenticationProvider
            ])*
      ): Self = StObject.set(x, "additionalAuthenticationProviders", js.Array(value :_*))
      
      @scala.inline
      def setAuthenticationType(value: Input[String]): Self = StObject.set(x, "authenticationType", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLogConfig(value: Input[typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiLogConfig]): Self = StObject.set(x, "logConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOpenidConnectConfig(value: Input[typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiOpenidConnectConfig]): Self = StObject.set(x, "openidConnectConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUserPoolConfig(value: Input[typingsSlinky.pulumiAws.inputMod.appsync.GraphQLApiUserPoolConfig]): Self = StObject.set(x, "userPoolConfig", value.asInstanceOf[js.Any])
