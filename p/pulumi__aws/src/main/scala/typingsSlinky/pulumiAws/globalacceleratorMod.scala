...
object globalacceleratorMod extends js.Object {
  ...
  class Accelerator protected ()
    extends typingsSlinky.pulumiAws.acceleratorMod.Accelerator {
    /**
  ...
  class EndpointGroup protected ()
    extends typingsSlinky.pulumiAws.endpointGroupMod.EndpointGroup {
    /**
  ...
  class Listener protected ()
    extends typingsSlinky.pulumiAws.globalacceleratorListenerMod.Listener {
    /**
