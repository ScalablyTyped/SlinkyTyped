...
object resourceDataSyncMod {
  ...
  trait ResourceDataSyncArgs extends StObject {
    ...
    /**
      * Amazon S3 configuration details for the sync.
      */
    val s3Destination: Input[typingsSlinky.pulumiAws.inputMod.ssm.ResourceDataSyncS3Destination] = js.native
  }
  object ResourceDataSyncArgs {
    
    @scala.inline
    def apply(s3Destination: Input[typingsSlinky.pulumiAws.inputMod.ssm.ResourceDataSyncS3Destination]): ResourceDataSyncArgs = {
    ...
    implicit class ResourceDataSyncArgsMutableBuilder[Self <: ResourceDataSyncArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setS3Destination(value: Input[typingsSlinky.pulumiAws.inputMod.ssm.ResourceDataSyncS3Destination]): Self = StObject.set(x, "s3Destination", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait ResourceDataSyncState extends StObject {
    ...
    /**
      * Amazon S3 configuration details for the sync.
      */
    val s3Destination: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.ssm.ResourceDataSyncS3Destination]] = js.native
  }
