...
import typingsSlinky.pulumiAws.outputMod.codebuild.ReportGroupExportConfig
...
object reportGroupMod {
  ...
  trait ReportGroupArgs extends StObject {
    ...
    /**
      * Information about the destination where the raw data of this Report Group is exported. see Export Config documented below.
      */
    val exportConfig: Input[typingsSlinky.pulumiAws.inputMod.codebuild.ReportGroupExportConfig] = js.native
  ...
  object ReportGroupArgs {
    ...
    @scala.inline
    def apply(
      exportConfig: Input[typingsSlinky.pulumiAws.inputMod.codebuild.ReportGroupExportConfig],
      `type`: Input[String]
    ): ReportGroupArgs = {
    ...
    implicit class ReportGroupArgsMutableBuilder[Self <: ReportGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExportConfig(value: Input[typingsSlinky.pulumiAws.inputMod.codebuild.ReportGroupExportConfig]): Self = StObject.set(x, "exportConfig", value.asInstanceOf[js.Any])
  ...
  trait ReportGroupState extends StObject {
    ...
    /**
      * Information about the destination where the raw data of this Report Group is exported. see Export Config documented below.
      */
    val exportConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.codebuild.ReportGroupExportConfig]] = js.native
