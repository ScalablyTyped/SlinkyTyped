...
import typingsSlinky.pulumiAws.outputMod.networkfirewall.FirewallPolicyFirewallPolicy
...
object firewallPolicyMod {
  ...
  trait FirewallPolicyArgs extends StObject {
    ...
    /**
      * A configuration block describing the rule groups and policy actions to use in the firewall policy. See Firewall Policy below for details.
      */
    val firewallPolicy: Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.FirewallPolicyFirewallPolicy] = js.native
  ...
  object FirewallPolicyArgs {
    ...
    @scala.inline
    def apply(
      firewallPolicy: Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.FirewallPolicyFirewallPolicy]
    ): FirewallPolicyArgs = {
    ...
    implicit class FirewallPolicyArgsMutableBuilder[Self <: FirewallPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFirewallPolicy(value: Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.FirewallPolicyFirewallPolicy]): Self = StObject.set(x, "firewallPolicy", value.asInstanceOf[js.Any])
  ...
  trait FirewallPolicyState extends StObject {
    ...
    /**
      * A configuration block describing the rule groups and policy actions to use in the firewall policy. See Firewall Policy below for details.
      */
    val firewallPolicy: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.networkfirewall.FirewallPolicyFirewallPolicy]
      ] = js.native
