...
import typingsSlinky.pulumiAws.outputMod.glue.ClassifierCsvClassifier
import typingsSlinky.pulumiAws.outputMod.glue.ClassifierGrokClassifier
import typingsSlinky.pulumiAws.outputMod.glue.ClassifierJsonClassifier
import typingsSlinky.pulumiAws.outputMod.glue.ClassifierXmlClassifier
...
object classifierMod {
  ...
  trait ClassifierArgs extends StObject {
    ...
    /**
      * A classifier for Csv content. Defined below.
      */
    val csvClassifier: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierCsvClassifier]] = js.native
    
    /**
      * A classifier that uses grok patterns. Defined below.
      */
    val grokClassifier: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierGrokClassifier]] = js.native
    
    /**
      * A classifier for JSON content. Defined below.
      */
    val jsonClassifier: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierJsonClassifier]] = js.native
    ...
    /**
      * A classifier for XML content. Defined below.
      */
    val xmlClassifier: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierXmlClassifier]] = js.native
  }
  object ClassifierArgs {
    ...
    implicit class ClassifierArgsMutableBuilder[Self <: ClassifierArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCsvClassifier(value: Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierCsvClassifier]): Self = StObject.set(x, "csvClassifier", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCsvClassifierUndefined: Self = StObject.set(x, "csvClassifier", js.undefined)
      
      @scala.inline
      def setGrokClassifier(value: Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierGrokClassifier]): Self = StObject.set(x, "grokClassifier", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGrokClassifierUndefined: Self = StObject.set(x, "grokClassifier", js.undefined)
      
      @scala.inline
      def setJsonClassifier(value: Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierJsonClassifier]): Self = StObject.set(x, "jsonClassifier", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setXmlClassifier(value: Input[typingsSlinky.pulumiAws.inputMod.glue.ClassifierXmlClassifier]): Self = StObject.set(x, "xmlClassifier", value.asInstanceOf[js.Any])
