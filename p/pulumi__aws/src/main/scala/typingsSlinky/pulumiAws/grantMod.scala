...
object grantMod {
  ...
  trait GrantArgs extends StObject {
    ...
    /**
      * A structure that you can use to allow certain operations in the grant only when the desired encryption context is present. For more information about encryption context, see [Encryption Context](http://docs.aws.amazon.com/kms/latest/developerguide/encryption-context.html).
      */
    val constraints: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.kms.GrantConstraint]]]] = js.native
  ...
  object GrantArgs {
    ...
    implicit class GrantArgsMutableBuilder[Self <: GrantArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConstraints(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.kms.GrantConstraint]]]): Self = StObject.set(x, "constraints", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConstraintsUndefined: Self = StObject.set(x, "constraints", js.undefined)
      
      @scala.inline
      def setConstraintsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.kms.GrantConstraint]*): Self = StObject.set(x, "constraints", js.Array(value :_*))
