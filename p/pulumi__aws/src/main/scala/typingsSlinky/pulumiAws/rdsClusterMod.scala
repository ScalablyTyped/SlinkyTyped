...
object rdsClusterMod {
  ...
  trait ClusterArgs extends StObject {
    ...
    /**
      * Nested attribute for [point in time restore](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PIT.html). More details below.
      */
    val restoreToPointInTime: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.rds.ClusterRestoreToPointInTime]] = js.native
    
    val s3Import: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.rds.ClusterS3Import]] = js.native
    
    /**
      * Nested attribute with scaling properties. Only valid when `engineMode` is set to `serverless`. More details below.
      */
    val scalingConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.rds.ClusterScalingConfiguration]] = js.native
  ...
  object ClusterArgs {
    ...
    implicit class ClusterArgsMutableBuilder[Self <: ClusterArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRestoreToPointInTime(value: Input[typingsSlinky.pulumiAws.inputMod.rds.ClusterRestoreToPointInTime]): Self = StObject.set(x, "restoreToPointInTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRestoreToPointInTimeUndefined: Self = StObject.set(x, "restoreToPointInTime", js.undefined)
      
      @scala.inline
      def setS3Import(value: Input[typingsSlinky.pulumiAws.inputMod.rds.ClusterS3Import]): Self = StObject.set(x, "s3Import", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setS3ImportUndefined: Self = StObject.set(x, "s3Import", js.undefined)
      
      @scala.inline
      def setScalingConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.rds.ClusterScalingConfiguration]): Self = StObject.set(x, "scalingConfiguration", value.asInstanceOf[js.Any])
