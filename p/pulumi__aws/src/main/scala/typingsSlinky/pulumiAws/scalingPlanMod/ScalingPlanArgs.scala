package typingsSlinky.pulumiAws.scalingPlanMod

import typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanApplicationSource
import typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanScalingInstruction
