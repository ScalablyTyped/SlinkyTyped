...
object wafMod {
  ...
  class ByteMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafByteMatchSetMod.ByteMatchSet {
    /**
  ...
  class GeoMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafGeoMatchSetMod.GeoMatchSet {
    /**
  ...
  class RegexMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafRegexMatchSetMod.RegexMatchSet {
    /**
  ...
  class Rule protected ()
    extends typingsSlinky.pulumiAws.wafRuleMod.Rule {
    /**
  ...
  class SizeConstraintSet protected ()
    extends typingsSlinky.pulumiAws.wafSizeConstraintSetMod.SizeConstraintSet {
    /**
  ...
  class SqlInjectionMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafSqlInjectionMatchSetMod.SqlInjectionMatchSet {
    /**
  ...
  class XssMatchSet protected ()
    extends typingsSlinky.pulumiAws.wafXssMatchSetMod.XssMatchSet {
    /**
