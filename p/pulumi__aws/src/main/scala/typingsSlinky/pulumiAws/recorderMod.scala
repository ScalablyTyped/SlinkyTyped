...
object recorderMod {
  ...
  trait RecorderArgs extends StObject {
    ...
    /**
      * Recording group - see below.
      */
    val recordingGroup: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cfg.RecorderRecordingGroup]] = js.native
  ...
  object RecorderArgs {
    ...
    implicit class RecorderArgsMutableBuilder[Self <: RecorderArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRecordingGroup(value: Input[typingsSlinky.pulumiAws.inputMod.cfg.RecorderRecordingGroup]): Self = StObject.set(x, "recordingGroup", value.asInstanceOf[js.Any])
