...
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainAdvancedSecurityOptions
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainClusterConfig
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainCognitoOptions
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainDomainEndpointOptions
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainEbsOptions
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainEncryptAtRest
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainLogPublishingOption
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainNodeToNodeEncryption
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainSnapshotOptions
import typingsSlinky.pulumiAws.outputMod.elasticsearch.DomainVpcOptions
...
object elasticsearchDomainMod {
  ...
  trait DomainArgs extends StObject {
    ...
    /**
      * Options for [fine-grained access control](https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/fgac.html). See below for more details.
      */
    val advancedSecurityOptions: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainAdvancedSecurityOptions]
      ] = js.native
    
    /**
      * Cluster configuration of the domain, see below.
      */
    val clusterConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainClusterConfig]] = js.native
    
    val cognitoOptions: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainCognitoOptions]] = js.native
    
    /**
      * Domain endpoint HTTP(S) related options. See below.
      */
    val domainEndpointOptions: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainDomainEndpointOptions]
      ] = js.native
    ...
    /**
      * EBS related options, may be required based on chosen [instance size](https://aws.amazon.com/elasticsearch-service/pricing/). See below.
      */
    val ebsOptions: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainEbsOptions]] = js.native
    ...
    /**
      * Encrypt at rest options. Only available for [certain instance types](http://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/aes-supported-instance-types.html). See below.
      */
    val encryptAtRest: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainEncryptAtRest]] = js.native
    ...
    val logPublishingOptions: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainLogPublishingOption]]
        ]
      ] = js.native
    ...
    /**
      * Node-to-node encryption options. See below.
      */
    val nodeToNodeEncryption: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainNodeToNodeEncryption]] = js.native
    
    /**
      * Snapshot related options, see below.
      */
    val snapshotOptions: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainSnapshotOptions]] = js.native
    ...
    /**
      * VPC related options, see below. Adding or removing this configuration forces a new resource ([documentation](https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-vpc.html#es-vpc-limitations)).
      */
    val vpcOptions: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainVpcOptions]] = js.native
  }
  object DomainArgs {
    ...
    implicit class DomainArgsMutableBuilder[Self <: DomainArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdvancedSecurityOptions(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainAdvancedSecurityOptions]): Self = StObject.set(x, "advancedSecurityOptions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAdvancedSecurityOptionsUndefined: Self = StObject.set(x, "advancedSecurityOptions", js.undefined)
      
      @scala.inline
      def setClusterConfig(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainClusterConfig]): Self = StObject.set(x, "clusterConfig", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClusterConfigUndefined: Self = StObject.set(x, "clusterConfig", js.undefined)
      
      @scala.inline
      def setCognitoOptions(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainCognitoOptions]): Self = StObject.set(x, "cognitoOptions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCognitoOptionsUndefined: Self = StObject.set(x, "cognitoOptions", js.undefined)
      
      @scala.inline
      def setDomainEndpointOptions(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainDomainEndpointOptions]): Self = StObject.set(x, "domainEndpointOptions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEbsOptions(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainEbsOptions]): Self = StObject.set(x, "ebsOptions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEncryptAtRest(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainEncryptAtRest]): Self = StObject.set(x, "encryptAtRest", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLogPublishingOptionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainLogPublishingOption]*): Self = StObject.set(x, "logPublishingOptions", js.Array(value :_*))
      
      @scala.inline
      def setNodeToNodeEncryption(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainNodeToNodeEncryption]): Self = StObject.set(x, "nodeToNodeEncryption", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNodeToNodeEncryptionUndefined: Self = StObject.set(x, "nodeToNodeEncryption", js.undefined)
      
      @scala.inline
      def setSnapshotOptions(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainSnapshotOptions]): Self = StObject.set(x, "snapshotOptions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVpcOptions(value: Input[typingsSlinky.pulumiAws.inputMod.elasticsearch.DomainVpcOptions]): Self = StObject.set(x, "vpcOptions", value.asInstanceOf[js.Any])
