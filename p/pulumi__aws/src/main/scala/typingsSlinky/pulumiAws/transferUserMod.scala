...
object transferUserMod {
  ...
  trait UserArgs extends StObject {
    ...
    val homeDirectoryMappings: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.transfer.UserHomeDirectoryMapping]]
        ]
      ] = js.native
  ...
  object UserArgs {
    ...
    implicit class UserArgsMutableBuilder[Self <: UserArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHomeDirectoryMappings(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.transfer.UserHomeDirectoryMapping]]
            ]
      ): Self = StObject.set(x, "homeDirectoryMappings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHomeDirectoryMappingsUndefined: Self = StObject.set(x, "homeDirectoryMappings", js.undefined)
      
      @scala.inline
      def setHomeDirectoryMappingsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.transfer.UserHomeDirectoryMapping]*): Self = StObject.set(x, "homeDirectoryMappings", js.Array(value :_*))
