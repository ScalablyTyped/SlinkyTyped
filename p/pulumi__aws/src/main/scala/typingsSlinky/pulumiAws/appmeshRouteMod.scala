...
object appmeshRouteMod {
  ...
  trait RouteArgs extends StObject {
    ...
    /**
      * The route specification to apply.
      */
    val spec: Input[typingsSlinky.pulumiAws.inputMod.appmesh.RouteSpec] = js.native
  ...
  object RouteArgs {
    ...
    def apply(
      ...
      spec: Input[typingsSlinky.pulumiAws.inputMod.appmesh.RouteSpec],
    ...
    implicit class RouteArgsMutableBuilder[Self <: RouteArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiAws.inputMod.appmesh.RouteSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
  ...
  trait RouteState extends StObject {
    ...
    /**
      * The route specification to apply.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.appmesh.RouteSpec]] = js.native
