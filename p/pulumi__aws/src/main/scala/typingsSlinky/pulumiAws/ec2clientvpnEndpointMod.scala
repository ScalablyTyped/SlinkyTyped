...
object ec2clientvpnEndpointMod {
  ...
  trait EndpointArgs extends StObject {
    ...
    val authenticationOptions: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.ec2clientvpn.EndpointAuthenticationOption]
        ]
      ] = js.native
    ...
    /**
      * Information about the client connection logging options.
      */
    val connectionLogOptions: Input[typingsSlinky.pulumiAws.inputMod.ec2clientvpn.EndpointConnectionLogOptions] = js.native
  ...
  object EndpointArgs {
    ...
    def apply(
      ...
      connectionLogOptions: Input[typingsSlinky.pulumiAws.inputMod.ec2clientvpn.EndpointConnectionLogOptions],
    ...
    implicit class EndpointArgsMutableBuilder[Self <: EndpointArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuthenticationOptionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2clientvpn.EndpointAuthenticationOption]*): Self = StObject.set(x, "authenticationOptions", js.Array(value :_*))
      
      @scala.inline
      def setClientCidrBlock(value: Input[String]): Self = StObject.set(x, "clientCidrBlock", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConnectionLogOptions(value: Input[typingsSlinky.pulumiAws.inputMod.ec2clientvpn.EndpointConnectionLogOptions]): Self = StObject.set(x, "connectionLogOptions", value.asInstanceOf[js.Any])
  ...
  trait EndpointState extends StObject {
    ...
    val connectionLogOptions: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.ec2clientvpn.EndpointConnectionLogOptions]
      ] = js.native
