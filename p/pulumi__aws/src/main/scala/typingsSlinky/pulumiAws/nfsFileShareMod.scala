...
object nfsFileShareMod {
  ...
  trait NfsFileShareArgs extends StObject {
    ...
    val cacheAttributes: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.storagegateway.NfsFileShareCacheAttributes]
      ] = js.native
    ...
    val nfsFileShareDefaults: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.storagegateway.NfsFileShareNfsFileShareDefaults]
      ] = js.native
  ...
  object NfsFileShareArgs {
    ...
    implicit class NfsFileShareArgsMutableBuilder[Self <: NfsFileShareArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCacheAttributes(value: Input[typingsSlinky.pulumiAws.inputMod.storagegateway.NfsFileShareCacheAttributes]): Self = StObject.set(x, "cacheAttributes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNfsFileShareDefaults(value: Input[typingsSlinky.pulumiAws.inputMod.storagegateway.NfsFileShareNfsFileShareDefaults]): Self = StObject.set(x, "nfsFileShareDefaults", value.asInstanceOf[js.Any])
