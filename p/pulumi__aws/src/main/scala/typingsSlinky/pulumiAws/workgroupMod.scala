...
object workgroupMod {
  ...
  trait WorkgroupArgs extends StObject {
    ...
    /**
      * Configuration block with various settings for the workgroup. Documented below.
      */
    val configuration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.athena.WorkgroupConfiguration]] = js.native
  ...
  object WorkgroupArgs {
    ...
    implicit class WorkgroupArgsMutableBuilder[Self <: WorkgroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.athena.WorkgroupConfiguration]): Self = StObject.set(x, "configuration", value.asInstanceOf[js.Any])
