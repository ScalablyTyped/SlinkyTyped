...
object memcachedLayerMod {
  ...
  object MemcachedLayer {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/memcachedLayer", "MemcachedLayer.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/memcachedLayer", "MemcachedLayer.isInstance")
    @js.native
  ...
  trait MemcachedLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.MemcachedLayerEbsVolume]]
        ]
      ] = js.native
  ...
  object MemcachedLayerArgs {
    ...
    implicit class MemcachedLayerArgsMutableBuilder[Self <: MemcachedLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.MemcachedLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
