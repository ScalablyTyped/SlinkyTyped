...
import typingsSlinky.pulumiAws.outputMod.waf.RuleGroupActivatedRule
...
object wafRuleGroupMod {
  ...
  object RuleGroup {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/waf/ruleGroup", "RuleGroup.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/waf/ruleGroup", "RuleGroup.isInstance")
    @js.native
  ...
  trait RuleGroupArgs extends StObject {
    ...
    val activatedRules: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.RuleGroupActivatedRule]]]
      ] = js.native
  ...
  object RuleGroupArgs {
    ...
    implicit class RuleGroupArgsMutableBuilder[Self <: RuleGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActivatedRules(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.waf.RuleGroupActivatedRule]]]): Self = StObject.set(x, "activatedRules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setActivatedRulesUndefined: Self = StObject.set(x, "activatedRules", js.undefined)
      
      @scala.inline
      def setActivatedRulesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.waf.RuleGroupActivatedRule]*): Self = StObject.set(x, "activatedRules", js.Array(value :_*))
