...
import typingsSlinky.pulumiAws.outputMod.opsworks.NodejsAppLayerEbsVolume
...
object nodejsAppLayerMod {
  ...
  trait NodejsAppLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.NodejsAppLayerEbsVolume]]
        ]
      ] = js.native
  ...
  object NodejsAppLayerArgs {
    ...
    implicit class NodejsAppLayerArgsMutableBuilder[Self <: NodejsAppLayerArgs] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.NodejsAppLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
