...
import typingsSlinky.pulumiAws.outputMod.appautoscaling.PolicyStepScalingPolicyConfiguration
import typingsSlinky.pulumiAws.outputMod.appautoscaling.PolicyTargetTrackingScalingPolicyConfiguration
...
object policyMod {
  ...
  trait PolicyArgs extends StObject {
    ...
    val stepScalingPolicyConfiguration: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.appautoscaling.PolicyStepScalingPolicyConfiguration
        ]
      ] = js.native
    ...
    val targetTrackingScalingPolicyConfiguration: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.appautoscaling.PolicyTargetTrackingScalingPolicyConfiguration
        ]
      ] = js.native
  }
  object PolicyArgs {
    ...
    implicit class PolicyArgsMutableBuilder[Self <: PolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStepScalingPolicyConfiguration(
        value: Input[
              typingsSlinky.pulumiAws.inputMod.appautoscaling.PolicyStepScalingPolicyConfiguration
            ]
      ): Self = StObject.set(x, "stepScalingPolicyConfiguration", value.asInstanceOf[js.Any])
