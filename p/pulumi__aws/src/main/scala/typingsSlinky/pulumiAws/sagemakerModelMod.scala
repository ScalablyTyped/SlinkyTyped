...
object sagemakerModelMod {
  ...
  trait ModelArgs extends StObject {
    ...
    val containers: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelContainer]]]
      ] = js.native
    ...
    /**
      * The primary docker image containing inference code that is used when the model is deployed for predictions.  If not specified, the `container` argument is required. Fields are documented below.
      */
    val primaryContainer: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelPrimaryContainer]] = js.native
    ...
    /**
      * Specifies the VPC that you want your model to connect to. VpcConfig is used in hosting services and in batch transform.
      */
    val vpcConfig: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelVpcConfig]] = js.native
  }
  object ModelArgs {
    ...
    implicit class ModelArgsMutableBuilder[Self <: ModelArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContainers(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelContainer]]]): Self = StObject.set(x, "containers", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setContainersUndefined: Self = StObject.set(x, "containers", js.undefined)
      
      @scala.inline
      def setContainersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelContainer]*): Self = StObject.set(x, "containers", js.Array(value :_*))
      ...
      @scala.inline
      def setPrimaryContainer(value: Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelPrimaryContainer]): Self = StObject.set(x, "primaryContainer", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVpcConfig(value: Input[typingsSlinky.pulumiAws.inputMod.sagemaker.ModelVpcConfig]): Self = StObject.set(x, "vpcConfig", value.asInstanceOf[js.Any])
