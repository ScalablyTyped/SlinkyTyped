...
import typingsSlinky.pulumiAws.outputMod.ecr.GetRepositoryEncryptionConfiguration
import typingsSlinky.pulumiAws.outputMod.ecr.GetRepositoryImageScanningConfiguration
