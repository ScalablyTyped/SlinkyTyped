...
object HaproxyLayerState {
  ...
  @scala.inline
  implicit class HaproxyLayerStateOps[Self <: HaproxyLayerState] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEbsVolumes(value: Input[js.Array[Input[HaproxyLayerEbsVolume]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHealthcheckMethod(value: Input[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("healthcheckMethod")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHealthcheckMethod: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("healthcheckMethod")(js.undefined)
        ret
    }
    @scala.inline
    def withHealthcheckUrl(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStatsEnabled(value: Input[Boolean]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsEnabled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStatsEnabled: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsEnabled")(js.undefined)
        ret
    }
    @scala.inline
    def withStatsPassword(value: Input[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsPassword")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStatsPassword: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsPassword")(js.undefined)
        ret
    }
    @scala.inline
    def withStatsUrl(value: Input[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsUrl")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStatsUrl: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsUrl")(js.undefined)
        ret
    }
    @scala.inline
    def withStatsUser(value: Input[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsUser")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStatsUser: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("statsUser")(js.undefined)
        ret
    }
    @scala.inline
