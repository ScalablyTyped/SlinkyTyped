...
object s3bucketAssociationMod {
  ...
  trait S3BucketAssociationArgs extends StObject {
    ...
    /**
      * The configuration of how Amazon Macie classifies the S3 objects.
      */
    val classificationType: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.macie.S3BucketAssociationClassificationType]
      ] = js.native
  ...
  object S3BucketAssociationArgs {
    ...
    implicit class S3BucketAssociationArgsMutableBuilder[Self <: S3BucketAssociationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClassificationType(value: Input[typingsSlinky.pulumiAws.inputMod.macie.S3BucketAssociationClassificationType]): Self = StObject.set(x, "classificationType", value.asInstanceOf[js.Any])
