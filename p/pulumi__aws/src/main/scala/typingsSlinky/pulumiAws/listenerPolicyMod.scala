...
object listenerPolicyMod {
  ...
  object ListenerPolicy {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancing/listenerPolicy", "ListenerPolicy.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancing/listenerPolicy", "ListenerPolicy.isInstance")
    @js.native
