...
object getElasticIpMod {
  ...
  trait GetElasticIpResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.GetElasticIpFilter]] = js.native
  ...
  object GetElasticIpResult {
    ...
    implicit class GetElasticIpResultMutableBuilder[Self <: GetElasticIpResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.GetElasticIpFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.GetElasticIpFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
