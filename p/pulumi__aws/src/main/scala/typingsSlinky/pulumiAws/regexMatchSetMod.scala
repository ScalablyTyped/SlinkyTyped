...
import typingsSlinky.pulumiAws.outputMod.wafregional.RegexMatchSetRegexMatchTuple
...
object regexMatchSetMod {
  ...
  trait RegexMatchSetArgs extends StObject {
    ...
    val regexMatchTuples: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.wafregional.RegexMatchSetRegexMatchTuple]]
        ]
      ] = js.native
  }
  object RegexMatchSetArgs {
    ...
    implicit class RegexMatchSetArgsMutableBuilder[Self <: RegexMatchSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRegexMatchTuplesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.wafregional.RegexMatchSetRegexMatchTuple]*): Self = StObject.set(x, "regexMatchTuples", js.Array(value :_*))
    }
  }
