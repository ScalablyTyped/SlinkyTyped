...
import typingsSlinky.pulumiAws.inputMod.GetRegionsFilter
...
object getRegionsMod {
  ...
  trait GetRegionsResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.GetRegionsFilter]] = js.native
  ...
  object GetRegionsResult {
    ...
    implicit class GetRegionsResultMutableBuilder[Self <: GetRegionsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.GetRegionsFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.GetRegionsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
