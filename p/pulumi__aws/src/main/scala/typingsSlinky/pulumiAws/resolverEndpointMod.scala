...
object resolverEndpointMod {
  ...
  trait ResolverEndpointArgs extends StObject {
    ...
    /**
      ...
      * to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below.
      */
    val ipAddresses: Input[
        js.Array[Input[typingsSlinky.pulumiAws.inputMod.route53.ResolverEndpointIpAddress]]
      ] = js.native
  ...
  object ResolverEndpointArgs {
    ...
    implicit class ResolverEndpointArgsMutableBuilder[Self <: ResolverEndpointArgs] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "ipAddresses", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIpAddressesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.route53.ResolverEndpointIpAddress]*): Self = StObject.set(x, "ipAddresses", js.Array(value :_*))
