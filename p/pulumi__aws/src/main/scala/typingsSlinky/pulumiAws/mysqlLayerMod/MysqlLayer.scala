package typingsSlinky.pulumiAws.mysqlLayerMod

import typingsSlinky.pulumiAws.outputMod.opsworks.MysqlLayerEbsVolume
...
class MysqlLayer protected () extends CustomResource {
  ...
  /**
    ...
    */
  val ebsVolumes: Output_[js.UndefOr[js.Array[MysqlLayerEbsVolume]]] = js.native
  /**
  ...
  /**
    ...
    */
  val rootPassword: Output_[js.UndefOr[String]] = js.native
  /**
    * Whether to set the root user password to all instances in the stack so they can access the instances in this layer.
    */
  val rootPasswordOnAllInstances: Output_[js.UndefOr[Boolean]] = js.native
  /**
