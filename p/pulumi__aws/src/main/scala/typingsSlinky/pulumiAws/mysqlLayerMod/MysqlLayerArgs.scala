...
import typingsSlinky.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume
...
object MysqlLayerArgs {
  ...
  implicit class MysqlLayerArgsOps[Self <: MysqlLayerArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEbsVolumes(value: Input[js.Array[Input[MysqlLayerEbsVolume]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRootPassword(value: Input[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rootPassword")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRootPassword: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rootPassword")(js.undefined)
        ret
    }
    @scala.inline
    def withRootPasswordOnAllInstances(value: Input[Boolean]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rootPasswordOnAllInstances")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRootPasswordOnAllInstances: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rootPasswordOnAllInstances")(js.undefined)
        ret
    }
    @scala.inline
