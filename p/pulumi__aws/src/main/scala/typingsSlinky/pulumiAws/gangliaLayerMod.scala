...
import typingsSlinky.pulumiAws.outputMod.opsworks.GangliaLayerEbsVolume
...
object gangliaLayerMod {
  ...
  object GangliaLayer {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/gangliaLayer", "GangliaLayer.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/gangliaLayer", "GangliaLayer.isInstance")
    @js.native
    def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/opsworks/gangliaLayer.GangliaLayer */ Boolean = js.native
  }
  
  @js.native
  trait GangliaLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.GangliaLayerEbsVolume]]]
      ] = js.native
  ...
  object GangliaLayerArgs {
    ...
    @scala.inline
    def apply(password: Input[String], stackId: Input[String]): GangliaLayerArgs = {
    ...
    @scala.inline
    implicit class GangliaLayerArgsMutableBuilder[Self <: GangliaLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.GangliaLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.GangliaLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  @js.native
  trait GangliaLayerState extends StObject {
  ...
  object GangliaLayerState {
    ...
    @scala.inline
    def apply(): GangliaLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GangliaLayerState]
    }
    
    @scala.inline
    implicit class GangliaLayerStateMutableBuilder[Self <: GangliaLayerState] (val x: Self) extends AnyVal {
