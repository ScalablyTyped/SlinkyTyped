...
object AnonCodePathOptions {
  @scala.inline
  def apply(): AnonCodePathOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCodePathOptions]
  }
  @scala.inline
  implicit class AnonCodePathOptionsOps[Self <: AnonCodePathOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withCodePathOptions(value: CodePathOptions): Self = {
