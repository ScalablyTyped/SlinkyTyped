...
object smbFileShareMod {
  ...
  trait SmbFileShareArgs extends StObject {
    ...
    /**
      * Refresh cache information. see Cache Attributes for more details.
      */
    val cacheAttributes: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.storagegateway.SmbFileShareCacheAttributes]
      ] = js.native
  ...
  object SmbFileShareArgs {
    ...
    implicit class SmbFileShareArgsMutableBuilder[Self <: SmbFileShareArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCacheAttributes(value: Input[typingsSlinky.pulumiAws.inputMod.storagegateway.SmbFileShareCacheAttributes]): Self = StObject.set(x, "cacheAttributes", value.asInstanceOf[js.Any])
