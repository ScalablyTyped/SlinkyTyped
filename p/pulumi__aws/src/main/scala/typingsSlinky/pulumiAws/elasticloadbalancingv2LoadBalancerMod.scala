...
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.LoadBalancerAccessLogs
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping
...
object elasticloadbalancingv2LoadBalancerMod {
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    val accessLogs: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs]
      ] = js.native
    ...
    val subnetMappings: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping
            ]
          ]
        ]
      ] = js.native
  ...
  object LoadBalancerArgs {
    ...
    implicit class LoadBalancerArgsMutableBuilder[Self <: LoadBalancerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubnetMappingsVarargs(
        value: (Input[
              typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping
            ])*
      ): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
