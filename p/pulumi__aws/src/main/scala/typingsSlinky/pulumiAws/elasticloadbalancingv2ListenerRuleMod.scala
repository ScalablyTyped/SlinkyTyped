...
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.ListenerRuleAction
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.ListenerRuleCondition
...
object elasticloadbalancingv2ListenerRuleMod {
  ...
  trait ListenerRuleArgs extends StObject {
    ...
    val actions: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.ListenerRuleAction]
        ]
      ] = js.native
    ...
    val conditions: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.ListenerRuleCondition]
        ]
      ] = js.native
  ...
  object ListenerRuleArgs {
    ...
    implicit class ListenerRuleArgsMutableBuilder[Self <: ListenerRuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.ListenerRuleAction]*): Self = StObject.set(x, "actions", js.Array(value :_*))
      ...
      @scala.inline
      def setConditionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.ListenerRuleCondition]*): Self = StObject.set(x, "conditions", js.Array(value :_*))
