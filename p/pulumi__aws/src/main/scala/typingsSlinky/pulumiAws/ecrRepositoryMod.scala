...
object ecrRepositoryMod {
  ...
  trait RepositoryArgs extends StObject {
    ...
    val encryptionConfigurations: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.ecr.RepositoryEncryptionConfiguration]]
        ]
      ] = js.native
    ...
    /**
      * Configuration block that defines image scanning configuration for the repository. By default, image scanning must be manually triggered. See the [ECR User Guide](https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-scanning.html) for more information about image scanning.
      */
    val imageScanningConfiguration: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.ecr.RepositoryImageScanningConfiguration]] = js.native
  ...
  object RepositoryArgs {
    ...
    implicit class RepositoryArgsMutableBuilder[Self <: RepositoryArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptionConfigurationsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ecr.RepositoryEncryptionConfiguration]*): Self = StObject.set(x, "encryptionConfigurations", js.Array(value :_*))
      
      @scala.inline
      def setImageScanningConfiguration(value: Input[typingsSlinky.pulumiAws.inputMod.ecr.RepositoryImageScanningConfiguration]): Self = StObject.set(x, "imageScanningConfiguration", value.asInstanceOf[js.Any])
