...
object resourcegroupsGroupMod {
  ...
  trait GroupArgs extends StObject {
    ...
    /**
      * A `resourceQuery` block. Resource queries are documented below.
      */
    val resourceQuery: Input[typingsSlinky.pulumiAws.inputMod.resourcegroups.GroupResourceQuery] = js.native
  ...
  object GroupArgs {
    ...
    @scala.inline
    def apply(resourceQuery: Input[typingsSlinky.pulumiAws.inputMod.resourcegroups.GroupResourceQuery]): GroupArgs = {
    ...
    implicit class GroupArgsMutableBuilder[Self <: GroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResourceQuery(value: Input[typingsSlinky.pulumiAws.inputMod.resourcegroups.GroupResourceQuery]): Self = StObject.set(x, "resourceQuery", value.asInstanceOf[js.Any])
  ...
  trait GroupState extends StObject {
    ...
    /**
      * A `resourceQuery` block. Resource queries are documented below.
      */
    val resourceQuery: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.resourcegroups.GroupResourceQuery]] = js.native
