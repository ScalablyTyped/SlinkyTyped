...
object cloudformationMod extends js.Object {
  ...
  class Stack protected ()
    extends typingsSlinky.pulumiAws.stackMod.Stack {
    /**
  ...
  class StackSet protected ()
    extends typingsSlinky.pulumiAws.stackSetMod.StackSet {
    /**
  ...
  class StackSetInstance protected ()
    extends typingsSlinky.pulumiAws.stackSetInstanceMod.StackSetInstance {
    /**
