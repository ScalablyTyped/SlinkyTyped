...
import typingsSlinky.pulumiAws.outputMod.rds.SecurityGroupIngress
...
object rdsSecurityGroupMod {
  ...
  trait SecurityGroupArgs extends StObject {
    ...
    /**
      * A list of ingress rules.
      */
    val ingress: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.SecurityGroupIngress]]] = js.native
  ...
  object SecurityGroupArgs {
    ...
    @scala.inline
    def apply(ingress: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.SecurityGroupIngress]]]): SecurityGroupArgs = {
    ...
    implicit class SecurityGroupArgsMutableBuilder[Self <: SecurityGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIngress(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.SecurityGroupIngress]]]): Self = StObject.set(x, "ingress", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIngressVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.rds.SecurityGroupIngress]*): Self = StObject.set(x, "ingress", js.Array(value :_*))
  ...
  trait SecurityGroupState extends StObject {
    ...
    val ingress: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.SecurityGroupIngress]]]
      ] = js.native
