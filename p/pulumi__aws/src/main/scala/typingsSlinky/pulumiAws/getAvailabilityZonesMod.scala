...
object getAvailabilityZonesMod {
  ...
  trait GetAvailabilityZonesResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.GetAvailabilityZonesFilter]] = js.native
  ...
  object GetAvailabilityZonesResult {
    ...
    implicit class GetAvailabilityZonesResultMutableBuilder[Self <: GetAvailabilityZonesResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.GetAvailabilityZonesFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.GetAvailabilityZonesFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
