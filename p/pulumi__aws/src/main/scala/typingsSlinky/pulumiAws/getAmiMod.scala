...
object getAmiMod {
  ...
  trait GetAmiResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.GetAmiFilter]] = js.native
  ...
  object GetAmiResult {
    ...
    implicit class GetAmiResultMutableBuilder[Self <: GetAmiResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.GetAmiFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.GetAmiFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
