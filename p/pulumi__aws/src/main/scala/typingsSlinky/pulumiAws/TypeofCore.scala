...
object TypeofCore {
  ...
  implicit class TypeofCoreOps[Self <: TypeofCore] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHTTP_DATA(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HTTP_DATA")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSEND(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SEND")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withVALIDATE_CREDENTIALS(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("VALIDATE_CREDENTIALS")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withVALIDATE_PARAMETERS(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("VALIDATE_PARAMETERS")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withVALIDATE_REGION(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("VALIDATE_REGION")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRemoveListener(value: (String, js.Function) => Unit): Self = {
        val ret = this.duplicate
