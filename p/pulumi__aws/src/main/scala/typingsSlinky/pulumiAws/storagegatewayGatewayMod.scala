...
object storagegatewayGatewayMod {
  ...
  trait GatewayArgs extends StObject {
    ...
    val smbActiveDirectorySettings: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.storagegateway.GatewaySmbActiveDirectorySettings
        ]
      ] = js.native
  ...
  object GatewayArgs {
    ...
    implicit class GatewayArgsMutableBuilder[Self <: GatewayArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSmbActiveDirectorySettings(
        value: Input[
              typingsSlinky.pulumiAws.inputMod.storagegateway.GatewaySmbActiveDirectorySettings
            ]
      ): Self = StObject.set(x, "smbActiveDirectorySettings", value.asInstanceOf[js.Any])
