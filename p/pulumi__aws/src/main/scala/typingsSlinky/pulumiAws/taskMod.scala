...
import typingsSlinky.pulumiAws.outputMod.datasync.TaskOptions
...
object taskMod {
  ...
  trait TaskArgs extends StObject {
    ...
    /**
      * Configuration block containing option that controls the default behavior when you start an execution of this DataSync Task. For each individual task execution, you can override these options by specifying an overriding configuration in those executions.
      */
    val options: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.datasync.TaskOptions]] = js.native
  ...
  object TaskArgs {
    ...
    implicit class TaskArgsMutableBuilder[Self <: TaskArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: Input[typingsSlinky.pulumiAws.inputMod.datasync.TaskOptions]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
