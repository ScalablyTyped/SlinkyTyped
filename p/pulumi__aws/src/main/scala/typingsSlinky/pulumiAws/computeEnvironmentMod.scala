...
object computeEnvironmentMod {
  ...
  trait ComputeEnvironmentArgs extends StObject {
    ...
    /**
      * Details of the compute resources managed by the compute environment. This parameter is required for managed compute environments. See details below.
      */
    val computeResources: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.batch.ComputeEnvironmentComputeResources]] = js.native
  ...
  object ComputeEnvironmentArgs {
    ...
    implicit class ComputeEnvironmentArgsMutableBuilder[Self <: ComputeEnvironmentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComputeResources(value: Input[typingsSlinky.pulumiAws.inputMod.batch.ComputeEnvironmentComputeResources]): Self = StObject.set(x, "computeResources", value.asInstanceOf[js.Any])
