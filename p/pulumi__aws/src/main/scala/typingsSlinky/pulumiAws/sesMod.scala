...
object sesMod {
  ...
  class ActiveReceiptRuleSet protected ()
    extends typingsSlinky.pulumiAws.activeReceiptRuleSetMod.ActiveReceiptRuleSet {
    /**
  ...
  class ConfgurationSet protected ()
    extends typingsSlinky.pulumiAws.confgurationSetMod.ConfgurationSet {
    /**
  ...
  class ConfigurationSet protected ()
    extends typingsSlinky.pulumiAws.configurationSetMod.ConfigurationSet {
    /**
  ...
  class DomainDkim protected ()
    extends typingsSlinky.pulumiAws.domainDkimMod.DomainDkim {
    /**
  ...
  class DomainIdentity protected ()
    extends typingsSlinky.pulumiAws.domainIdentityMod.DomainIdentity {
    /**
  ...
  class DomainIdentityVerification protected ()
    extends typingsSlinky.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerification {
    /**
  ...
  class EventDestination protected ()
    extends typingsSlinky.pulumiAws.eventDestinationMod.EventDestination {
    /**
  ...
  class IdentityPolicy protected ()
    extends typingsSlinky.pulumiAws.identityPolicyMod.IdentityPolicy {
    /**
  ...
  class MailFrom protected ()
    extends typingsSlinky.pulumiAws.mailFromMod.MailFrom {
    /**
  ...
  class ReceiptFilter protected ()
    extends typingsSlinky.pulumiAws.receiptFilterMod.ReceiptFilter {
    /**
  ...
  class ReceiptRule protected ()
    extends typingsSlinky.pulumiAws.receiptRuleMod.ReceiptRule {
    /**
  ...
  class ReceiptRuleSet protected ()
    extends typingsSlinky.pulumiAws.receiptRuleSetMod.ReceiptRuleSet {
    /**
  ...
  class Template protected ()
    extends typingsSlinky.pulumiAws.templateMod.Template {
    /**
