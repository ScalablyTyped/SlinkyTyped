...
import typingsSlinky.pulumiAws.outputMod.datasync.LocationSmbMountOptions
...
object locationSmbMod {
  ...
  trait LocationSmbArgs extends StObject {
    ...
    /**
      * Configuration block containing mount options used by DataSync to access the SMB Server. Can be `AUTOMATIC`, `SMB2`, or `SMB3`.
      */
    val mountOptions: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.datasync.LocationSmbMountOptions]] = js.native
  ...
  object LocationSmbArgs {
    ...
    implicit class LocationSmbArgsMutableBuilder[Self <: LocationSmbArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMountOptions(value: Input[typingsSlinky.pulumiAws.inputMod.datasync.LocationSmbMountOptions]): Self = StObject.set(x, "mountOptions", value.asInstanceOf[js.Any])
