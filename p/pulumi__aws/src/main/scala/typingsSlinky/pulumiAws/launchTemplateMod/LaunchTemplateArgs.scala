...
import typingsSlinky.pulumiAws.inputMod.ec2.LaunchTemplateHibernationOptions
...
import typingsSlinky.pulumiAws.inputMod.ec2.LaunchTemplateMetadataOptions
...
object LaunchTemplateArgs {
  ...
  @scala.inline
  implicit class LaunchTemplateArgsOps[Self <: LaunchTemplateArgs] (val x: Self) extends AnyVal {
    @scala.inline
