...
import typingsSlinky.pulumiAws.outputMod.route53.ZoneVpc
...
object zoneMod {
  ...
  trait ZoneArgs extends StObject {
    ...
    /**
      * Configuration block(s) specifying VPC(s) to associate with a private hosted zone. Conflicts with the `delegationSetId` argument in this resource and any `aws.route53.ZoneAssociation` resource specifying the same zone ID. Detailed below.
      */
    val vpcs: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.route53.ZoneVpc]]]] = js.native
  }
  object ZoneArgs {
    ...
    implicit class ZoneArgsMutableBuilder[Self <: ZoneArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setVpcs(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.route53.ZoneVpc]]]): Self = StObject.set(x, "vpcs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVpcsUndefined: Self = StObject.set(x, "vpcs", js.undefined)
      
      @scala.inline
      def setVpcsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.route53.ZoneVpc]*): Self = StObject.set(x, "vpcs", js.Array(value :_*))
    }
  }
