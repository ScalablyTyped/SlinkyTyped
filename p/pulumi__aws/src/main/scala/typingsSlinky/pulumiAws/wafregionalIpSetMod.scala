...
import typingsSlinky.pulumiAws.outputMod.wafregional.IpSetIpSetDescriptor
...
object wafregionalIpSetMod {
  ...
  object IpSet {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/wafregional/ipSet", "IpSet.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/wafregional/ipSet", "IpSet.isInstance")
    @js.native
  ...
  trait IpSetArgs extends StObject {
    ...
    val ipSetDescriptors: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.wafregional.IpSetIpSetDescriptor]]
        ]
      ] = js.native
  ...
  object IpSetArgs {
    ...
    implicit class IpSetArgsMutableBuilder[Self <: IpSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIpSetDescriptors(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.wafregional.IpSetIpSetDescriptor]]
            ]
      ): Self = StObject.set(x, "ipSetDescriptors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIpSetDescriptorsUndefined: Self = StObject.set(x, "ipSetDescriptors", js.undefined)
      
      @scala.inline
      def setIpSetDescriptorsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.wafregional.IpSetIpSetDescriptor]*): Self = StObject.set(x, "ipSetDescriptors", js.Array(value :_*))
