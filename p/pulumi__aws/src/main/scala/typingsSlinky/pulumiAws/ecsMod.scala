...
object ecsMod extends js.Object {
  ...
  class CapacityProvider protected ()
    extends typingsSlinky.pulumiAws.capacityProviderMod.CapacityProvider {
    /**
  ...
  class Cluster protected ()
    extends typingsSlinky.pulumiAws.ecsClusterMod.Cluster {
    /**
  ...
  class Service protected ()
    extends typingsSlinky.pulumiAws.serviceMod.Service {
    /**
  ...
  class TaskDefinition protected ()
    extends typingsSlinky.pulumiAws.taskDefinitionMod.TaskDefinition {
    /**
