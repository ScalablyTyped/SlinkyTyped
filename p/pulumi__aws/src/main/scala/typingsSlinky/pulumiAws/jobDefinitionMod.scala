...
import typingsSlinky.pulumiAws.outputMod.batch.JobDefinitionRetryStrategy
import typingsSlinky.pulumiAws.outputMod.batch.JobDefinitionTimeout
...
object jobDefinitionMod {
  ...
  trait JobDefinitionArgs extends StObject {
    ...
    /**
      ...
      * Maximum number of `retryStrategy` is `1`.  Defined below.
      */
    val retryStrategy: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.batch.JobDefinitionRetryStrategy]] = js.native
    ...
    /**
      * Specifies the timeout for jobs so that if a job runs longer, AWS Batch terminates the job. Maximum number of `timeout` is `1`. Defined below.
      */
    val timeout: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.batch.JobDefinitionTimeout]] = js.native
  ...
  object JobDefinitionArgs {
    ...
    implicit class JobDefinitionArgsMutableBuilder[Self <: JobDefinitionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRetryStrategy(value: Input[typingsSlinky.pulumiAws.inputMod.batch.JobDefinitionRetryStrategy]): Self = StObject.set(x, "retryStrategy", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTimeout(value: Input[typingsSlinky.pulumiAws.inputMod.batch.JobDefinitionTimeout]): Self = StObject.set(x, "timeout", value.asInstanceOf[js.Any])
