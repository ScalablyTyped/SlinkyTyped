...
import typingsSlinky.pulumiAws.outputMod.secretsmanager.SecretRotationRotationRules
...
object secretRotationMod {
  ...
  trait SecretRotationArgs extends StObject {
    ...
    /**
      * A structure that defines the rotation configuration for this secret. Defined below.
      */
    val rotationRules: Input[typingsSlinky.pulumiAws.inputMod.secretsmanager.SecretRotationRotationRules] = js.native
  ...
  object SecretRotationArgs {
    ...
    def apply(
      ...
      rotationRules: Input[typingsSlinky.pulumiAws.inputMod.secretsmanager.SecretRotationRotationRules],
    ...
    implicit class SecretRotationArgsMutableBuilder[Self <: SecretRotationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRotationRules(value: Input[typingsSlinky.pulumiAws.inputMod.secretsmanager.SecretRotationRotationRules]): Self = StObject.set(x, "rotationRules", value.asInstanceOf[js.Any])
  ...
  trait SecretRotationState extends StObject {
    ...
    val rotationRules: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.secretsmanager.SecretRotationRotationRules]
      ] = js.native
