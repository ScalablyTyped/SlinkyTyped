...
import typingsSlinky.pulumiAws.outputMod.applicationloadbalancing.GetTargetGroupHealthCheck
import typingsSlinky.pulumiAws.outputMod.applicationloadbalancing.GetTargetGroupStickiness
