...
import typingsSlinky.pulumiAws.outputMod.autoscalingplans.ScalingPlanApplicationSource
import typingsSlinky.pulumiAws.outputMod.autoscalingplans.ScalingPlanScalingInstruction
...
object scalingPlanMod {
  ...
  trait ScalingPlanArgs extends StObject {
    ...
    /**
      * A CloudFormation stack or set of tags. You can create one scaling plan per application source.
      */
    val applicationSource: Input[typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanApplicationSource] = js.native
    ...
    val scalingInstructions: Input[
        js.Array[
          Input[typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanScalingInstruction]
        ]
      ] = js.native
  }
  object ScalingPlanArgs {
    ...
    @scala.inline
    def apply(
      applicationSource: Input[typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanApplicationSource],
    ...
    implicit class ScalingPlanArgsMutableBuilder[Self <: ScalingPlanArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApplicationSource(value: Input[typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanApplicationSource]): Self = StObject.set(x, "applicationSource", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setScalingInstructionsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanScalingInstruction]*): Self = StObject.set(x, "scalingInstructions", js.Array(value :_*))
    }
  }
  ...
  trait ScalingPlanState extends StObject {
    ...
    /**
      * A CloudFormation stack or set of tags. You can create one scaling plan per application source.
      */
    val applicationSource: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.autoscalingplans.ScalingPlanApplicationSource]
      ] = js.native
