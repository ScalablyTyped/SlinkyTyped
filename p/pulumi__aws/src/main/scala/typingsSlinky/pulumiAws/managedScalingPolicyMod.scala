...
object managedScalingPolicyMod {
  ...
  trait ManagedScalingPolicyArgs extends StObject {
    ...
    /**
      * Configuration block with compute limit settings. Described below.
      */
    val computeLimits: Input[
        js.Array[Input[typingsSlinky.pulumiAws.inputMod.emr.ManagedScalingPolicyComputeLimit]]
      ] = js.native
  }
  object ManagedScalingPolicyArgs {
    ...
    implicit class ManagedScalingPolicyArgsMutableBuilder[Self <: ManagedScalingPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComputeLimits(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.emr.ManagedScalingPolicyComputeLimit]]
            ]
      ): Self = StObject.set(x, "computeLimits", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComputeLimitsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.emr.ManagedScalingPolicyComputeLimit]*): Self = StObject.set(x, "computeLimits", js.Array(value :_*))
    }
  }
