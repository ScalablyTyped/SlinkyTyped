...
object secretMod {
  ...
  trait SecretArgs extends StObject {
    ...
    /**
      ...
      * @deprecated Use the aws_secretsmanager_secret_rotation resource instead
      */
    val rotationRules: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.secretsmanager.SecretRotationRules]] = js.native
  ...
  object SecretArgs {
    ...
    implicit class SecretArgsMutableBuilder[Self <: SecretArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRotationRules(value: Input[typingsSlinky.pulumiAws.inputMod.secretsmanager.SecretRotationRules]): Self = StObject.set(x, "rotationRules", value.asInstanceOf[js.Any])
