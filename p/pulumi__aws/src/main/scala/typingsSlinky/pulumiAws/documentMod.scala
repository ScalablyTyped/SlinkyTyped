...
import typingsSlinky.pulumiAws.outputMod.ssm.DocumentAttachmentsSource
import typingsSlinky.pulumiAws.outputMod.ssm.DocumentParameter
...
object documentMod {
  ...
  trait DocumentArgs extends StObject {
    ...
    /**
      * One or more configuration blocks describing attachments sources to a version of a document. Defined below.
      */
    val attachmentsSources: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ssm.DocumentAttachmentsSource]]]
      ] = js.native
  ...
  object DocumentArgs {
    ...
    implicit class DocumentArgsMutableBuilder[Self <: DocumentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttachmentsSources(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ssm.DocumentAttachmentsSource]]]): Self = StObject.set(x, "attachmentsSources", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAttachmentsSourcesUndefined: Self = StObject.set(x, "attachmentsSources", js.undefined)
      
      @scala.inline
      def setAttachmentsSourcesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ssm.DocumentAttachmentsSource]*): Self = StObject.set(x, "attachmentsSources", js.Array(value :_*))
  ...
  trait DocumentState extends StObject {
    ...
    /**
      * The parameters that are available to this document.
      */
    val parameters: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ssm.DocumentParameter]]]] = js.native
  ...
  object DocumentState {
    ...
    implicit class DocumentStateMutableBuilder[Self <: DocumentState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParameters(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ssm.DocumentParameter]]]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
      
      @scala.inline
      def setParametersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ssm.DocumentParameter]*): Self = StObject.set(x, "parameters", js.Array(value :_*))
