...
object triggerMod {
  ...
  trait TriggerArgs extends StObject {
    ...
    val triggers: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codecommit.TriggerTrigger]]] = js.native
  }
  object TriggerArgs {
    ...
    def apply(
      ...
      triggers: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codecommit.TriggerTrigger]]]
    ): TriggerArgs = {
    ...
    implicit class TriggerArgsMutableBuilder[Self <: TriggerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTriggers(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codecommit.TriggerTrigger]]]): Self = StObject.set(x, "triggers", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTriggersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.codecommit.TriggerTrigger]*): Self = StObject.set(x, "triggers", js.Array(value :_*))
    }
  }
  ...
  trait TriggerState extends StObject {
    ...
    val triggers: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.codecommit.TriggerTrigger]]]
      ] = js.native
  }
  object TriggerState {
