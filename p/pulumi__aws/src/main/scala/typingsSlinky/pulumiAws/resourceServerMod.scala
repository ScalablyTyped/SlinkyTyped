...
object resourceServerMod {
  ...
  trait ResourceServerArgs extends StObject {
    ...
    val scopes: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.cognito.ResourceServerScope]]]
      ] = js.native
  ...
  object ResourceServerArgs {
    ...
    implicit class ResourceServerArgsMutableBuilder[Self <: ResourceServerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScopes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.cognito.ResourceServerScope]]]): Self = StObject.set(x, "scopes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScopesUndefined: Self = StObject.set(x, "scopes", js.undefined)
      
      @scala.inline
      def setScopesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.cognito.ResourceServerScope]*): Self = StObject.set(x, "scopes", js.Array(value :_*))
