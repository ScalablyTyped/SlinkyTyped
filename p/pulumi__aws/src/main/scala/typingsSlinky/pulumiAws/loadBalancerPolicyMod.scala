...
object loadBalancerPolicyMod {
  ...
  object LoadBalancerPolicy {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancing/loadBalancerPolicy", "LoadBalancerPolicy.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancing/loadBalancerPolicy", "LoadBalancerPolicy.isInstance")
    @js.native
  ...
  trait LoadBalancerPolicyArgs extends StObject {
    ...
    val policyAttributes: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsSlinky.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerPolicyPolicyAttribute
            ]
          ]
        ]
      ] = js.native
