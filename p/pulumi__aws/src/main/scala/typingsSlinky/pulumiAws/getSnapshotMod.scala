...
object getSnapshotMod {
  ...
  trait GetSnapshotResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ebs.GetSnapshotFilter]] = js.native
  ...
  object GetSnapshotResult {
    ...
    implicit class GetSnapshotResultMutableBuilder[Self <: GetSnapshotResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ebs.GetSnapshotFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ebs.GetSnapshotFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
