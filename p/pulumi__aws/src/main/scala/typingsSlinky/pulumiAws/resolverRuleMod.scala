...
import typingsSlinky.pulumiAws.outputMod.route53.ResolverRuleTargetIp
...
object resolverRuleMod {
  ...
  object ResolverRule {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/route53/resolverRule", "ResolverRule.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/route53/resolverRule", "ResolverRule.isInstance")
    @js.native
  ...
  trait ResolverRuleArgs extends StObject {
    ...
    val targetIps: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.route53.ResolverRuleTargetIp]]]
      ] = js.native
  }
  object ResolverRuleArgs {
    ...
    implicit class ResolverRuleArgsMutableBuilder[Self <: ResolverRuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTargetIps(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.route53.ResolverRuleTargetIp]]]): Self = StObject.set(x, "targetIps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTargetIpsUndefined: Self = StObject.set(x, "targetIps", js.undefined)
      
      @scala.inline
      def setTargetIpsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.route53.ResolverRuleTargetIp]*): Self = StObject.set(x, "targetIps", js.Array(value :_*))
    }
  }
