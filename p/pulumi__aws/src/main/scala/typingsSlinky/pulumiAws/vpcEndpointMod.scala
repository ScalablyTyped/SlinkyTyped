...
object vpcEndpointMod {
  ...
  trait VpcEndpointState extends StObject {
    ...
    /**
      * The DNS entries for the VPC Endpoint. Applicable for endpoints of type `Interface`. DNS blocks are documented below.
      */
    val dnsEntries: js.UndefOr[Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.VpcEndpointDnsEntry]]]] = js.native
  ...
  object VpcEndpointState {
    ...
    implicit class VpcEndpointStateMutableBuilder[Self <: VpcEndpointState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDnsEntries(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.ec2.VpcEndpointDnsEntry]]]): Self = StObject.set(x, "dnsEntries", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDnsEntriesUndefined: Self = StObject.set(x, "dnsEntries", js.undefined)
      
      @scala.inline
      def setDnsEntriesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.ec2.VpcEndpointDnsEntry]*): Self = StObject.set(x, "dnsEntries", js.Array(value :_*))
