...
object accountMod {
  ...
  trait AccountState extends StObject {
    ...
    /**
      * Account-Level throttle settings. See exported fields below.
      */
    val throttleSettings: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.apigateway.AccountThrottleSettings]] = js.native
  }
  object AccountState {
    ...
    implicit class AccountStateMutableBuilder[Self <: AccountState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setThrottleSettings(value: Input[typingsSlinky.pulumiAws.inputMod.apigateway.AccountThrottleSettings]): Self = StObject.set(x, "throttleSettings", value.asInstanceOf[js.Any])
