...
object getNetworkAclsMod {
  ...
  trait GetNetworkAclsResult extends StObject {
    ...
    val filters: js.UndefOr[js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetNetworkAclsFilter]] = js.native
  ...
  object GetNetworkAclsResult {
    ...
    implicit class GetNetworkAclsResultMutableBuilder[Self <: GetNetworkAclsResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetNetworkAclsFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetNetworkAclsFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
