...
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.TargetGroupHealthCheck
import typingsSlinky.pulumiAws.outputMod.elasticloadbalancingv2.TargetGroupStickiness
...
object elasticloadbalancingv2TargetGroupMod {
  ...
  trait TargetGroupArgs extends StObject {
    ...
    val healthCheck: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupHealthCheck]
      ] = js.native
    ...
    val stickiness: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupStickiness]
      ] = js.native
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typingsSlinky.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
