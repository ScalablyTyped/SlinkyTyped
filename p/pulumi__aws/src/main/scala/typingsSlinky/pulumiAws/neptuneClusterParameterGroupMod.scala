...
import typingsSlinky.pulumiAws.outputMod.neptune.ClusterParameterGroupParameter
...
object neptuneClusterParameterGroupMod {
  ...
  trait ClusterParameterGroupArgs extends StObject {
    ...
    val parameters: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.neptune.ClusterParameterGroupParameter]]
        ]
      ] = js.native
  ...
  object ClusterParameterGroupArgs {
    ...
    implicit class ClusterParameterGroupArgsMutableBuilder[Self <: ClusterParameterGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParametersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.neptune.ClusterParameterGroupParameter]*): Self = StObject.set(x, "parameters", js.Array(value :_*))
