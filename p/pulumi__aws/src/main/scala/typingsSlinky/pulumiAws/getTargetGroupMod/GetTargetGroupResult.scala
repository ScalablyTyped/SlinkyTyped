package typingsSlinky.pulumiAws.getTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.pulumiAws.outputMod.alb.GetTargetGroupHealthCheck
import typingsSlinky.pulumiAws.outputMod.alb.GetTargetGroupStickiness
