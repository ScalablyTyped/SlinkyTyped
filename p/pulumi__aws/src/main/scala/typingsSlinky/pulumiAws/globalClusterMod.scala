...
object globalClusterMod {
  ...
  trait GlobalClusterState extends StObject {
    ...
    val globalClusterMembers: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.GlobalClusterGlobalClusterMember]]
        ]
      ] = js.native
  ...
  object GlobalClusterState {
    ...
    implicit class GlobalClusterStateMutableBuilder[Self <: GlobalClusterState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGlobalClusterMembers(
        value: Input[
              js.Array[Input[typingsSlinky.pulumiAws.inputMod.rds.GlobalClusterGlobalClusterMember]]
            ]
      ): Self = StObject.set(x, "globalClusterMembers", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGlobalClusterMembersUndefined: Self = StObject.set(x, "globalClusterMembers", js.undefined)
      
      @scala.inline
      def setGlobalClusterMembersVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.rds.GlobalClusterGlobalClusterMember]*): Self = StObject.set(x, "globalClusterMembers", js.Array(value :_*))
