...
object lambdaMod {
  ...
  class Alias protected ()
    extends typingsSlinky.pulumiAws.lambdaAliasMod.Alias {
    /**
  ...
  class EventSubscription protected ()
    extends typingsSlinky.pulumiAws.lambdaMixinsMod.EventSubscription {
  ...
  class Permission protected ()
    extends typingsSlinky.pulumiAws.permissionMod.Permission {
    /**
