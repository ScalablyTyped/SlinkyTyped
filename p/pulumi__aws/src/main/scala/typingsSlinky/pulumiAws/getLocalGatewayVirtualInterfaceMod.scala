...
object getLocalGatewayVirtualInterfaceMod {
  ...
  trait GetLocalGatewayVirtualInterfaceResult extends StObject {
    ...
    val filters: js.UndefOr[
        js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceFilter]
      ] = js.native
  ...
  object GetLocalGatewayVirtualInterfaceResult {
    ...
    implicit class GetLocalGatewayVirtualInterfaceResultMutableBuilder[Self <: GetLocalGatewayVirtualInterfaceResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceFilter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.pulumiAws.outputMod.ec2.GetLocalGatewayVirtualInterfaceFilter*): Self = StObject.set(x, "filters", js.Array(value :_*))
