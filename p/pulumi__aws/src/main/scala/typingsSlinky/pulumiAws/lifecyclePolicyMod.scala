...
import typingsSlinky.pulumiAws.outputMod.dlm.LifecyclePolicyPolicyDetails
...
object lifecyclePolicyMod {
  ...
  trait LifecyclePolicyArgs extends StObject {
    ...
    /**
      * See the `policyDetails` configuration block. Max of 1.
      */
    val policyDetails: Input[typingsSlinky.pulumiAws.inputMod.dlm.LifecyclePolicyPolicyDetails] = js.native
  ...
  object LifecyclePolicyArgs {
    ...
    def apply(
      ...
      policyDetails: Input[typingsSlinky.pulumiAws.inputMod.dlm.LifecyclePolicyPolicyDetails]
    ): LifecyclePolicyArgs = {
    ...
    implicit class LifecyclePolicyArgsMutableBuilder[Self <: LifecyclePolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPolicyDetails(value: Input[typingsSlinky.pulumiAws.inputMod.dlm.LifecyclePolicyPolicyDetails]): Self = StObject.set(x, "policyDetails", value.asInstanceOf[js.Any])
  ...
  trait LifecyclePolicyState extends StObject {
    ...
    /**
      * See the `policyDetails` configuration block. Max of 1.
      */
    val policyDetails: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.dlm.LifecyclePolicyPolicyDetails]] = js.native
