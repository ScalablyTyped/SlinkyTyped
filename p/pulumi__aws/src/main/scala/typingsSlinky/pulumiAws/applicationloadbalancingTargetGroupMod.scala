...
object applicationloadbalancingTargetGroupMod {
  ...
  trait TargetGroupArgs extends StObject {
    ...
    val healthCheck: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.TargetGroupHealthCheck]
      ] = js.native
    ...
    val stickiness: js.UndefOr[
        Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.TargetGroupStickiness]
      ] = js.native
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typingsSlinky.pulumiAws.inputMod.applicationloadbalancing.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
