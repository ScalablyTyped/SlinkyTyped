package typingsSlinky.pulumiAws.eventBusMod
...
@js.native
trait EventBusState extends js.Object {
...
object EventBusState {
  ...
  @scala.inline
  implicit class EventBusStateOps[Self <: EventBusState] (val x: Self) extends AnyVal {
