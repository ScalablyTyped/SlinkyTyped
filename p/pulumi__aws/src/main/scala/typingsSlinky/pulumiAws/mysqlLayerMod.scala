...
object mysqlLayerMod {
  ...
  trait MysqlLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]]]
      ] = js.native
  ...
  object MysqlLayerArgs {
    ...
    @scala.inline
    implicit class MysqlLayerArgsMutableBuilder[Self <: MysqlLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumes(value: Input[js.Array[Input[typingsSlinky.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
      ...
      @scala.inline
      def setRootPassword(value: Input[String]): Self = StObject.set(x, "rootPassword", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRootPasswordOnAllInstances(value: Input[Boolean]): Self = StObject.set(x, "rootPasswordOnAllInstances", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRootPasswordOnAllInstancesUndefined: Self = StObject.set(x, "rootPasswordOnAllInstances", js.undefined)
  ...
  object MysqlLayerState {
    ...
    @scala.inline
    def apply(): MysqlLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MysqlLayerState]
    }
    
    @scala.inline
    implicit class MysqlLayerStateMutableBuilder[Self <: MysqlLayerState] (val x: Self) extends AnyVal {
