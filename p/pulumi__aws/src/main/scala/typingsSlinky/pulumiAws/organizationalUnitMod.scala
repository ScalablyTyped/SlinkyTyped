...
object organizationalUnitMod {
  ...
  trait OrganizationalUnitState extends StObject {
    ...
    val accounts: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationalUnitAccount]]
        ]
      ] = js.native
  ...
  object OrganizationalUnitState {
    ...
    implicit class OrganizationalUnitStateMutableBuilder[Self <: OrganizationalUnitState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccountsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.organizations.OrganizationalUnitAccount]*): Self = StObject.set(x, "accounts", js.Array(value :_*))
