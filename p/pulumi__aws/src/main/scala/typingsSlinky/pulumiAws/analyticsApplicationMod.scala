...
import typingsSlinky.pulumiAws.outputMod.kinesis.AnalyticsApplicationCloudwatchLoggingOptions
import typingsSlinky.pulumiAws.outputMod.kinesis.AnalyticsApplicationInputs
import typingsSlinky.pulumiAws.outputMod.kinesis.AnalyticsApplicationOutput
import typingsSlinky.pulumiAws.outputMod.kinesis.AnalyticsApplicationReferenceDataSources
...
object analyticsApplicationMod {
  ...
  trait AnalyticsApplicationArgs extends StObject {
    ...
    val cloudwatchLoggingOptions: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationCloudwatchLoggingOptions
        ]
      ] = js.native
    ...
    /**
      * Input configuration of the application. See Inputs below for more details.
      */
    val inputs: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationInputs]] = js.native
    ...
    val outputs: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationOutput]]
        ]
      ] = js.native
    ...
    val referenceDataSources: js.UndefOr[
        Input[
          typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationReferenceDataSources
        ]
      ] = js.native
  ...
  object AnalyticsApplicationArgs {
    ...
    implicit class AnalyticsApplicationArgsMutableBuilder[Self <: AnalyticsApplicationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInputs(value: Input[typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationInputs]): Self = StObject.set(x, "inputs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOutputsVarargs(value: Input[typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationOutput]*): Self = StObject.set(x, "outputs", js.Array(value :_*))
      
      @scala.inline
      def setReferenceDataSources(
        value: Input[
              typingsSlinky.pulumiAws.inputMod.kinesis.AnalyticsApplicationReferenceDataSources
            ]
      ): Self = StObject.set(x, "referenceDataSources", value.asInstanceOf[js.Any])
