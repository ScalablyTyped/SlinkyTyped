...
trait RouteSpecGrpcRouteTimeout extends js.Object {
  ...
  /**
    ...
    */
  var idle: js.UndefOr[Input[RouteSpecGrpcRouteTimeoutIdle]] = js.native
  
  /**
    * The per request timeout.
    */
  var perRequest: js.UndefOr[Input[RouteSpecGrpcRouteTimeoutPerRequest]] = js.native
}
object RouteSpecGrpcRouteTimeout {
  ...
  implicit class RouteSpecGrpcRouteTimeoutOps[Self <: RouteSpecGrpcRouteTimeout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdle(value: Input[RouteSpecGrpcRouteTimeoutIdle]): Self = this.set("idle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIdle: Self = this.set("idle", js.undefined)
    
    @scala.inline
    def setPerRequest(value: Input[RouteSpecGrpcRouteTimeoutPerRequest]): Self = this.set("perRequest", value.asInstanceOf[js.Any])
