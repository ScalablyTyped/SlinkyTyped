...
@js.native
trait WebAclRuleStatementOrStatementStatementNotStatementStatementSizeConstraintStatement extends StObject {
...
object WebAclRuleStatementOrStatementStatementNotStatementStatementSizeConstraintStatement {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WebAclRuleStatementOrStatementStatementNotStatementStatementSizeConstraintStatement]
  }
  
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementNotStatementStatementSizeConstraintStatementMutableBuilder[Self <: WebAclRuleStatementOrStatementStatementNotStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
