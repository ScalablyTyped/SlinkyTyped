...
trait WebAclRuleOverrideAction extends js.Object {
  ...
  /**
    ...
    */
  var count: js.UndefOr[Input[WebAclRuleOverrideActionCount]] = js.native
  
  /**
    * Don't override the rule action setting. Configured as an empty block `{}`.
    */
  var none: js.UndefOr[Input[WebAclRuleOverrideActionNone]] = js.native
}
object WebAclRuleOverrideAction {
  ...
  implicit class WebAclRuleOverrideActionOps[Self <: WebAclRuleOverrideAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCount(value: Input[WebAclRuleOverrideActionCount]): Self = this.set("count", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCount: Self = this.set("count", js.undefined)
    
    @scala.inline
    def setNone(value: Input[WebAclRuleOverrideActionNone]): Self = this.set("none", value.asInstanceOf[js.Any])
