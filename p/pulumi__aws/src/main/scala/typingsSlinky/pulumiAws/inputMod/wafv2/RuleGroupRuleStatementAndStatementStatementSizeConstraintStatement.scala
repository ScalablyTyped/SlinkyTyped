...
trait RuleGroupRuleStatementAndStatementStatementSizeConstraintStatement extends js.Object {
  ...
  var fieldToMatch: js.UndefOr[
    Input[RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch]
  ] = js.native
...
object RuleGroupRuleStatementAndStatementStatementSizeConstraintStatement {
  ...
  implicit class RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: Input[RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
