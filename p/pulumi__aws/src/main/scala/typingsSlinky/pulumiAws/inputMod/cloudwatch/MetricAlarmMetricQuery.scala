...
object MetricAlarmMetricQuery {
  ...
  implicit class MetricAlarmMetricQueryOps[Self <: MetricAlarmMetricQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExpression(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMetric(value: Input[MetricAlarmMetricQueryMetric]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReturnData(value: Input[Boolean]): Self = {
        val ret = this.duplicate
