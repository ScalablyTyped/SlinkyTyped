...
object EndpointS3Settings {
  ...
  implicit class EndpointS3SettingsOps[Self <: EndpointS3Settings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBucketFolder(value: Input[String]): Self = {
    ...
    @scala.inline
    def withCompressionType(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCsvDelimiter(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCsvRowDelimiter(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withExternalTableDefinition(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withServiceAccessRoleArn(value: Input[String]): Self = {
        val ret = this.duplicate
