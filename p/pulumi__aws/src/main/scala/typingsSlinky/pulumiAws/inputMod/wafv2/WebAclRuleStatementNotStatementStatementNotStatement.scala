...
object WebAclRuleStatementNotStatementStatementNotStatement {
  ...
  implicit class WebAclRuleStatementNotStatementStatementNotStatementOps[Self <: WebAclRuleStatementNotStatementStatementNotStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[WebAclRuleStatementNotStatementStatementNotStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[WebAclRuleStatementNotStatementStatementNotStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
