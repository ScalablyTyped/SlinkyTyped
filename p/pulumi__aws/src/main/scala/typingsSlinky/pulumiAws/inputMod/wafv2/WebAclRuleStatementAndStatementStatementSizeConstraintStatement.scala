...
object WebAclRuleStatementAndStatementStatementSizeConstraintStatement {
  ...
  implicit class WebAclRuleStatementAndStatementStatementSizeConstraintStatementOps[Self <: WebAclRuleStatementAndStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: Input[WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
