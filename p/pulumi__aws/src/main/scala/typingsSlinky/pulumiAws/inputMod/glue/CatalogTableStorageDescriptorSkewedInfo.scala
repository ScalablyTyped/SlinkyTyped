...
object CatalogTableStorageDescriptorSkewedInfo {
  ...
  implicit class CatalogTableStorageDescriptorSkewedInfoOps[Self <: CatalogTableStorageDescriptorSkewedInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSkewedColumnNames(value: Input[js.Array[Input[String]]]): Self = {
    ...
    @scala.inline
    def withSkewedColumnValueLocationMaps(value: Input[StringDictionary[Input[String]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSkewedColumnValues(value: Input[js.Array[Input[String]]]): Self = {
        val ret = this.duplicate
