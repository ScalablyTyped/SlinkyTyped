...
object DeploymentGroupEc2TagSet {
  ...
  implicit class DeploymentGroupEc2TagSetMutableBuilder[Self <: DeploymentGroupEc2TagSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEc2TagFilters(value: Input[js.Array[Input[DeploymentGroupEc2TagSetEc2TagFilter]]]): Self = StObject.set(x, "ec2TagFilters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEc2TagFiltersUndefined: Self = StObject.set(x, "ec2TagFilters", js.undefined)
    
    @scala.inline
    def setEc2TagFiltersVarargs(value: Input[DeploymentGroupEc2TagSetEc2TagFilter]*): Self = StObject.set(x, "ec2TagFilters", js.Array(value :_*))
  }
}
