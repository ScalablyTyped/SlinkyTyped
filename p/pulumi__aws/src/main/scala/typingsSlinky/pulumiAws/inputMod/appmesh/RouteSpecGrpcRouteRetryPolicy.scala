...
trait RouteSpecGrpcRouteRetryPolicy extends js.Object {
  ...
  /**
    ...
    */
  var grpcRetryEvents: js.UndefOr[Input[js.Array[Input[String]]]] = js.native
  ...
  /**
    ...
    */
  var perRetryTimeout: Input[RouteSpecGrpcRouteRetryPolicyPerRetryTimeout] = js.native
...
object RouteSpecGrpcRouteRetryPolicy {
  ...
  implicit class RouteSpecGrpcRouteRetryPolicyOps[Self <: RouteSpecGrpcRouteRetryPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPerRetryTimeout(value: Input[RouteSpecGrpcRouteRetryPolicyPerRetryTimeout]): Self = this.set("perRetryTimeout", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGrpcRetryEventsVarargs(value: Input[String]*): Self = this.set("grpcRetryEvents", js.Array(value :_*))
    
    @scala.inline
    def setGrpcRetryEvents(value: Input[js.Array[Input[String]]]): Self = this.set("grpcRetryEvents", value.asInstanceOf[js.Any])
