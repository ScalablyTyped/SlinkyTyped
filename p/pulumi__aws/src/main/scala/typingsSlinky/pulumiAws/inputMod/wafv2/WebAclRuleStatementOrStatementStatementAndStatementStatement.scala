...
trait WebAclRuleStatementOrStatementStatementAndStatementStatement extends js.Object {
  ...
  /**
    ...
    */
  var andStatement: js.UndefOr[Input[WebAclRuleStatementOrStatementStatementAndStatementStatementAndStatement]] = js.native
  ...
  /**
    ...
    */
  var notStatement: js.UndefOr[Input[WebAclRuleStatementOrStatementStatementAndStatementStatementNotStatement]] = js.native
  
  /**
    * A logical rule statement used to combine other rule statements with OR logic. See OR Statement below for details.
    */
  var orStatement: js.UndefOr[Input[WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatement]] = js.native
...
object WebAclRuleStatementOrStatementStatementAndStatementStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementAndStatementStatementOps[Self <: WebAclRuleStatementOrStatementStatementAndStatementStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAndStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementAndStatement]): Self = this.set("andStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAndStatement: Self = this.set("andStatement", js.undefined)
    
    @scala.inline
    def setByteMatchStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatement]): Self = this.set("byteMatchStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteByteMatchStatement: Self = this.set("byteMatchStatement", js.undefined)
    
    @scala.inline
    def setGeoMatchStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementGeoMatchStatement]): Self = this.set("geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementNotStatement]): Self = this.set("notStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNotStatement: Self = this.set("notStatement", js.undefined)
    
    @scala.inline
    def setOrStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatement]): Self = this.set("orStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSqliMatchStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementSqliMatchStatement]): Self = this.set("sqliMatchStatement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSqliMatchStatement: Self = this.set("sqliMatchStatement", js.undefined)
    
    @scala.inline
    def setXssMatchStatement(value: Input[WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatement]): Self = this.set("xssMatchStatement", value.asInstanceOf[js.Any])
