...
trait IntentConclusionStatement extends js.Object {
  ...
  /**
    ...
    */
  var messages: Input[js.Array[Input[IntentConclusionStatementMessage]]] = js.native
...
object IntentConclusionStatement {
  ...
  implicit class IntentConclusionStatementOps[Self <: IntentConclusionStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: Input[IntentConclusionStatementMessage]*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: Input[js.Array[Input[IntentConclusionStatementMessage]]]): Self = this.set("messages", value.asInstanceOf[js.Any])
