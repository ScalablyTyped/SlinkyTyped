...
@js.native
trait IntentConfirmationPromptMessage extends js.Object {
...
object IntentConfirmationPromptMessage {
  ...
  @scala.inline
  implicit class IntentConfirmationPromptMessageOps[Self <: IntentConfirmationPromptMessage] (val x: Self) extends AnyVal {
