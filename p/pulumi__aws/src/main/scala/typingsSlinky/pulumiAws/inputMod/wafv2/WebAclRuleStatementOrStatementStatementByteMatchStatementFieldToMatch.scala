...
object WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatch {
  ...
  implicit class WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatchOps[Self <: WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatchBody]): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatchMethod]): Self = this.set("method", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMethod: Self = this.set("method", js.undefined)
    
    @scala.inline
    def setQueryString(value: Input[WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatchQueryString]): Self = this.set("queryString", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: Input[WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatchUriPath]): Self = this.set("uriPath", value.asInstanceOf[js.Any])
