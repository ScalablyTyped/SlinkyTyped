...
object WebAclRuleStatementOrStatementStatementByteMatchStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementByteMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: Input[WebAclRuleStatementOrStatementStatementByteMatchStatementTextTransformation]*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: Input[WebAclRuleStatementOrStatementStatementByteMatchStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
