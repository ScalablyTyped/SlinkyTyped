...
@js.native
trait WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch extends js.Object {
...
object WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch {
  ...
  @scala.inline
  def apply(): WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch]
  }
  
  @scala.inline
  implicit class WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchOps[Self <: WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchBody]): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchMethod]): Self = this.set("method", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: Input[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchUriPath]): Self = this.set("uriPath", value.asInstanceOf[js.Any])
