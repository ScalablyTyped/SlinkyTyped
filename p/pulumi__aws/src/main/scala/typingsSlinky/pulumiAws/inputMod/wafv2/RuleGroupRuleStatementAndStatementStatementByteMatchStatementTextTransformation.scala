...
object RuleGroupRuleStatementAndStatementStatementByteMatchStatementTextTransformation {
  
  @scala.inline
  def apply(priority: Input[Double], `type`: Input[String]): RuleGroupRuleStatementAndStatementStatementByteMatchStatementTextTransformation = {
    val __obj = js.Dynamic.literal(priority = priority.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementByteMatchStatementTextTransformation]
  }
