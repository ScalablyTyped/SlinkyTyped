...
object servicediscovery {
  ...
  object ServiceDnsConfig {
    ...
    implicit class ServiceDnsConfigMutableBuilder[Self <: ServiceDnsConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDnsRecords(value: Input[js.Array[Input[ServiceDnsConfigDnsRecord]]]): Self = StObject.set(x, "dnsRecords", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDnsRecordsVarargs(value: Input[ServiceDnsConfigDnsRecord]*): Self = StObject.set(x, "dnsRecords", js.Array(value :_*))
      
      @scala.inline
      def setNamespaceId(value: Input[String]): Self = StObject.set(x, "namespaceId", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRoutingPolicy(value: Input[String]): Self = StObject.set(x, "routingPolicy", value.asInstanceOf[js.Any])
