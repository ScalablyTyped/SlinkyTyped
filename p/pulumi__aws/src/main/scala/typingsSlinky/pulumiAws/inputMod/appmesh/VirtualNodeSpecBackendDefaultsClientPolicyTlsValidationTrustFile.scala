...
@js.native
trait VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile extends js.Object {
...
object VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile {
  ...
  @scala.inline
  implicit class VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFileOps[Self <: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile] (val x: Self) extends AnyVal {
