...
object pinpoint {
  ...
  object AppCampaignHook {
    ...
    implicit class AppCampaignHookMutableBuilder[Self <: AppCampaignHook] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLambdaFunctionName(value: Input[String]): Self = StObject.set(x, "lambdaFunctionName", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWebUrl(value: Input[String]): Self = StObject.set(x, "webUrl", value.asInstanceOf[js.Any])
  ...
  object AppLimits {
    ...
    implicit class AppLimitsMutableBuilder[Self <: AppLimits] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDaily(value: Input[Double]): Self = StObject.set(x, "daily", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDailyUndefined: Self = StObject.set(x, "daily", js.undefined)
      
      @scala.inline
      def setMaximumDuration(value: Input[Double]): Self = StObject.set(x, "maximumDuration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTotal(value: Input[Double]): Self = StObject.set(x, "total", value.asInstanceOf[js.Any])
  ...
  object AppQuietTime {
    ...
    implicit class AppQuietTimeMutableBuilder[Self <: AppQuietTime] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEnd(value: Input[String]): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEndUndefined: Self = StObject.set(x, "end", js.undefined)
      
      @scala.inline
      def setStart(value: Input[String]): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
