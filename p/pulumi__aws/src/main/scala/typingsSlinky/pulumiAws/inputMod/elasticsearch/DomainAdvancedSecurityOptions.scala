...
object DomainAdvancedSecurityOptions {
  ...
  implicit class DomainAdvancedSecurityOptionsOps[Self <: DomainAdvancedSecurityOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInternalUserDatabaseEnabled(value: Input[Boolean]): Self = this.set("internalUserDatabaseEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteInternalUserDatabaseEnabled: Self = this.set("internalUserDatabaseEnabled", js.undefined)
    
    @scala.inline
    def setMasterUserOptions(value: Input[DomainAdvancedSecurityOptionsMasterUserOptions]): Self = this.set("masterUserOptions", value.asInstanceOf[js.Any])
