...
@js.native
trait WebAclRuleStatementAndStatementStatementAndStatementStatementGeoMatchStatement extends js.Object {
  ...
  var forwardedIpConfig: js.UndefOr[
    Input[
      WebAclRuleStatementAndStatementStatementAndStatementStatementGeoMatchStatementForwardedIpConfig
    ]
  ] = js.native
}
object WebAclRuleStatementAndStatementStatementAndStatementStatementGeoMatchStatement {
  ...
  @scala.inline
  def apply(countryCodes: Input[js.Array[Input[String]]]): WebAclRuleStatementAndStatementStatementAndStatementStatementGeoMatchStatement = {
  ...
  @scala.inline
  implicit class WebAclRuleStatementAndStatementStatementAndStatementStatementGeoMatchStatementOps[Self <: WebAclRuleStatementAndStatementStatementAndStatementStatementGeoMatchStatement] (val x: Self) extends AnyVal {
