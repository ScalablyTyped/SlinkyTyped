...
@js.native
trait RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch extends StObject {
...
object RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch {
  
  @scala.inline
  def apply(): RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatchMutableBuilder[Self <: RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
