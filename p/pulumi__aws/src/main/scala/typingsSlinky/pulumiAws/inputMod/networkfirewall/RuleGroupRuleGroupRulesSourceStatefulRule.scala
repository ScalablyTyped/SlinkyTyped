...
object RuleGroupRuleGroupRulesSourceStatefulRule {
  ...
  implicit class RuleGroupRuleGroupRulesSourceStatefulRuleOps[Self <: RuleGroupRuleGroupRulesSourceStatefulRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeader(value: Input[RuleGroupRuleGroupRulesSourceStatefulRuleHeader]): Self = this.set("header", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRuleOptionsVarargs(value: Input[RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption]*): Self = this.set("ruleOptions", js.Array(value :_*))
    
    @scala.inline
    def setRuleOptions(value: Input[js.Array[Input[RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption]]]): Self = this.set("ruleOptions", value.asInstanceOf[js.Any])
  }
}
