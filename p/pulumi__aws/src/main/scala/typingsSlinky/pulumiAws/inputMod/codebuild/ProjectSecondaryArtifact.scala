...
object ProjectSecondaryArtifact {
  ...
  implicit class ProjectSecondaryArtifactOps[Self <: ProjectSecondaryArtifact] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArtifactIdentifier(value: Input[String]): Self = {
    ...
    @scala.inline
    def withEncryptionDisabled(value: Input[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNamespaceType(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOverrideArtifactName(value: Input[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPackaging(value: Input[String]): Self = {
        val ret = this.duplicate
