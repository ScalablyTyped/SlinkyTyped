...
object ClusterKerberosAttributes {
  ...
  implicit class ClusterKerberosAttributesOps[Self <: ClusterKerberosAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKdcAdminPassword(value: Input[String]): Self = this.set("kdcAdminPassword", value.asInstanceOf[js.Any])
    @scala.inline
    def setRealm(value: Input[String]): Self = this.set("realm", value.asInstanceOf[js.Any])
    @scala.inline
    def setAdDomainJoinPassword(value: Input[String]): Self = this.set("adDomainJoinPassword", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAdDomainJoinPassword: Self = this.set("adDomainJoinPassword", js.undefined)
    @scala.inline
    def setAdDomainJoinUser(value: Input[String]): Self = this.set("adDomainJoinUser", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAdDomainJoinUser: Self = this.set("adDomainJoinUser", js.undefined)
    @scala.inline
    def setCrossRealmTrustPrincipalPassword(value: Input[String]): Self = this.set("crossRealmTrustPrincipalPassword", value.asInstanceOf[js.Any])
    @scala.inline
