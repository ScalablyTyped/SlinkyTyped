...
object DistributionViewerCertificate {
  ...
  implicit class DistributionViewerCertificateOps[Self <: DistributionViewerCertificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAcmCertificateArn(value: Input[String]): Self = {
    ...
    @scala.inline
    def withCloudfrontDefaultCertificate(value: Input[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIamCertificateId(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMinimumProtocolVersion(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSslSupportMethod(value: Input[String]): Self = {
        val ret = this.duplicate
