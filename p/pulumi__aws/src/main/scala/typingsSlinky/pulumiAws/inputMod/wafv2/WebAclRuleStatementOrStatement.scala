...
object WebAclRuleStatementOrStatement {
  ...
  implicit class WebAclRuleStatementOrStatementOps[Self <: WebAclRuleStatementOrStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[WebAclRuleStatementOrStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[WebAclRuleStatementOrStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
