package typingsSlinky.pulumiAws.inputMod.ec2transitgateway
...
object GetDirectConnectGatewayAttachmentFilter {
  ...
  @scala.inline
  implicit class GetDirectConnectGatewayAttachmentFilterOps[Self <: GetDirectConnectGatewayAttachmentFilter] (val x: Self) extends AnyVal {
    @scala.inline
