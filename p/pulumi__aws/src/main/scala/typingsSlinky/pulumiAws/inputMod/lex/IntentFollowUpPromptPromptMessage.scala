...
@js.native
trait IntentFollowUpPromptPromptMessage extends js.Object {
...
object IntentFollowUpPromptPromptMessage {
  ...
  @scala.inline
  def apply(content: Input[String], contentType: Input[String]): IntentFollowUpPromptPromptMessage = {
    val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], contentType = contentType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IntentFollowUpPromptPromptMessage]
  }
  
  @scala.inline
  implicit class IntentFollowUpPromptPromptMessageOps[Self <: IntentFollowUpPromptPromptMessage] (val x: Self) extends AnyVal {
