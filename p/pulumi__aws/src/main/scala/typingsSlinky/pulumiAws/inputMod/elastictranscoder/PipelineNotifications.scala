...
object PipelineNotifications {
  ...
  implicit class PipelineNotificationsOps[Self <: PipelineNotifications] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompleted(value: Input[String]): Self = this.set("completed", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setProgressing(value: Input[String]): Self = this.set("progressing", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteProgressing: Self = this.set("progressing", js.undefined)
    @scala.inline
    def setWarning(value: Input[String]): Self = this.set("warning", value.asInstanceOf[js.Any])
    @scala.inline
