...
object RuleGroupRuleStatementNotStatementStatementSizeConstraintStatement {
  ...
  implicit class RuleGroupRuleStatementNotStatementStatementSizeConstraintStatementOps[Self <: RuleGroupRuleStatementNotStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: Input[RuleGroupRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
