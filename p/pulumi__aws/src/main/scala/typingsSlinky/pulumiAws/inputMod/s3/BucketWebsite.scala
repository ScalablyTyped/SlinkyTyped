...
import typingsSlinky.pulumiAws.routingRulesMod.RoutingRule
...
object BucketWebsite {
  ...
  implicit class BucketWebsiteOps[Self <: BucketWebsite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withErrorDocument(value: Input[String]): Self = {
    ...
    @scala.inline
    def withIndexDocument(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRedirectAllRequestsTo(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRoutingRules(value: Input[String | js.Array[RoutingRule]]): Self = {
        val ret = this.duplicate
