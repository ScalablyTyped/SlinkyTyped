...
@js.native
trait DirectoryWorkspaceCreationProperties extends js.Object {
...
object DirectoryWorkspaceCreationProperties {
  ...
  @scala.inline
  implicit class DirectoryWorkspaceCreationPropertiesOps[Self <: DirectoryWorkspaceCreationProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomSecurityGroupId(value: Input[String]): Self = this.set("customSecurityGroupId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCustomSecurityGroupId: Self = this.set("customSecurityGroupId", js.undefined)
    
    @scala.inline
    def setDefaultOu(value: Input[String]): Self = this.set("defaultOu", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDefaultOu: Self = this.set("defaultOu", js.undefined)
    
    @scala.inline
    def setEnableInternetAccess(value: Input[Boolean]): Self = this.set("enableInternetAccess", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEnableInternetAccess: Self = this.set("enableInternetAccess", js.undefined)
    
    @scala.inline
    def setEnableMaintenanceMode(value: Input[Boolean]): Self = this.set("enableMaintenanceMode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEnableMaintenanceMode: Self = this.set("enableMaintenanceMode", js.undefined)
    
    @scala.inline
    def setUserEnabledAsLocalAdministrator(value: Input[Boolean]): Self = this.set("userEnabledAsLocalAdministrator", value.asInstanceOf[js.Any])
