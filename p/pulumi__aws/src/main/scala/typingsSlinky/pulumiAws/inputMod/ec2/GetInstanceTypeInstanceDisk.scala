...
@js.native
trait GetInstanceTypeInstanceDisk extends js.Object {
...
object GetInstanceTypeInstanceDisk {
  ...
  @scala.inline
  implicit class GetInstanceTypeInstanceDiskOps[Self <: GetInstanceTypeInstanceDisk] (val x: Self) extends AnyVal {
