...
object WebAclLoggingConfigurationRedactedFields {
  ...
  implicit class WebAclLoggingConfigurationRedactedFieldsOps[Self <: WebAclLoggingConfigurationRedactedFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFieldToMatches(value: Input[js.Array[Input[WebAclLoggingConfigurationRedactedFieldsFieldToMatch]]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fieldToMatches")(value.asInstanceOf[js.Any])
        ret
    }
  }
