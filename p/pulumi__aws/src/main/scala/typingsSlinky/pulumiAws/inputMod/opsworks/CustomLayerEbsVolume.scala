...
@js.native
trait CustomLayerEbsVolume extends StObject {
...
object CustomLayerEbsVolume {
  ...
  @scala.inline
  def apply(mountPoint: Input[String], numberOfDisks: Input[Double], size: Input[Double]): CustomLayerEbsVolume = {
  ...
  @scala.inline
  implicit class CustomLayerEbsVolumeMutableBuilder[Self <: CustomLayerEbsVolume] (val x: Self) extends AnyVal {
