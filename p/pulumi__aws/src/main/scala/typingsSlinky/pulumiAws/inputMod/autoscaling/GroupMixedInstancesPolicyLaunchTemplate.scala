...
object GroupMixedInstancesPolicyLaunchTemplate {
  ...
  implicit class GroupMixedInstancesPolicyLaunchTemplateOps[Self <: GroupMixedInstancesPolicyLaunchTemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLaunchTemplateSpecification(value: Input[GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification]): Self = this.set("launchTemplateSpecification", value.asInstanceOf[js.Any])
    @scala.inline
    def setOverridesVarargs(value: Input[GroupMixedInstancesPolicyLaunchTemplateOverride]*): Self = this.set("overrides", js.Array(value :_*))
    @scala.inline
    def setOverrides(value: Input[js.Array[Input[GroupMixedInstancesPolicyLaunchTemplateOverride]]]): Self = this.set("overrides", value.asInstanceOf[js.Any])
    @scala.inline
