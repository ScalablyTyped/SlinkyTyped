...
object AppQuietTime {
  ...
  implicit class AppQuietTimeOps[Self <: AppQuietTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnd(value: Input[String]): Self = this.set("end", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEnd: Self = this.set("end", js.undefined)
    @scala.inline
    def setStart(value: Input[String]): Self = this.set("start", value.asInstanceOf[js.Any])
    @scala.inline
