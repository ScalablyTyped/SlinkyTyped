...
object RuleGroupRuleStatementIpSetReferenceStatement {
  ...
  implicit class RuleGroupRuleStatementIpSetReferenceStatementOps[Self <: RuleGroupRuleStatementIpSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIpSetForwardedIpConfig(value: Input[RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig]): Self = this.set("ipSetForwardedIpConfig", value.asInstanceOf[js.Any])
