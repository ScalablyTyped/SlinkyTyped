...
object DistributionOrderedCacheBehavior {
  ...
  implicit class DistributionOrderedCacheBehaviorOps[Self <: DistributionOrderedCacheBehavior] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForwardedValues(value: Input[DistributionOrderedCacheBehaviorForwardedValues]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forwardedValues")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPathPattern(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLambdaFunctionAssociations(value: Input[js.Array[Input[DistributionOrderedCacheBehaviorLambdaFunctionAssociation]]]): Self = {
        val ret = this.duplicate
