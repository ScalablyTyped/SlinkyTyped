...
@js.native
trait WebAclRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatch extends StObject {
...
object WebAclRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatch {
  
  @scala.inline
  def apply(): WebAclRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebAclRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatch]
  }
  
  @scala.inline
  implicit class WebAclRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatchMutableBuilder[Self <: WebAclRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
