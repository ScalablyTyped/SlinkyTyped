...
trait RuleGroupRuleStatementAndStatementStatementByteMatchStatement extends js.Object {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch]] = js.native
...
object RuleGroupRuleStatementAndStatementStatementByteMatchStatement {
  ...
  implicit class RuleGroupRuleStatementAndStatementStatementByteMatchStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementTextTransformation]*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
