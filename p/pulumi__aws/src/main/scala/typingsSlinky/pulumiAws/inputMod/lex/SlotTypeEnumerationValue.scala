...
object SlotTypeEnumerationValue {
  ...
  implicit class SlotTypeEnumerationValueOps[Self <: SlotTypeEnumerationValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSynonymsVarargs(value: Input[String]*): Self = this.set("synonyms", js.Array(value :_*))
    
    @scala.inline
    def setSynonyms(value: Input[js.Array[Input[String]]]): Self = this.set("synonyms", value.asInstanceOf[js.Any])
