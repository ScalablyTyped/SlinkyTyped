...
trait RuleGroupRuleStatementOrStatement extends js.Object {
  ...
  /**
    ...
    */
  var statements: Input[js.Array[Input[RuleGroupRuleStatementOrStatementStatement]]] = js.native
}
object RuleGroupRuleStatementOrStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementOps[Self <: RuleGroupRuleStatementOrStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[RuleGroupRuleStatementOrStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[RuleGroupRuleStatementOrStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
