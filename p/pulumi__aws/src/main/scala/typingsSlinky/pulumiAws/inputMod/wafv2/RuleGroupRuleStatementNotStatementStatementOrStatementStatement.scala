...
@js.native
trait RuleGroupRuleStatementNotStatementStatementOrStatementStatement extends js.Object {
...
object RuleGroupRuleStatementNotStatementStatementOrStatementStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementNotStatementStatementOrStatementStatementOps[Self <: RuleGroupRuleStatementNotStatementStatementOrStatementStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeoMatchStatement(value: Input[RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement]): Self = this.set("geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setXssMatchStatement(value: Input[RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatement]): Self = this.set("xssMatchStatement", value.asInstanceOf[js.Any])
