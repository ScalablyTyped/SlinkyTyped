...
@js.native
trait VirtualNodeSpecListenerTimeoutHttpIdle extends js.Object {
...
object VirtualNodeSpecListenerTimeoutHttpIdle {
  ...
  @scala.inline
  def apply(unit: Input[String], value: Input[Double]): VirtualNodeSpecListenerTimeoutHttpIdle = {
    val __obj = js.Dynamic.literal(unit = unit.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[VirtualNodeSpecListenerTimeoutHttpIdle]
  }
  
  @scala.inline
  implicit class VirtualNodeSpecListenerTimeoutHttpIdleOps[Self <: VirtualNodeSpecListenerTimeoutHttpIdle] (val x: Self) extends AnyVal {
