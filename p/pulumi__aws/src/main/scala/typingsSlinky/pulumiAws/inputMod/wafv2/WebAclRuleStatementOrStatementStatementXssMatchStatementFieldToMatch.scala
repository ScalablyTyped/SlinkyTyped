...
object WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch {
  ...
  implicit class WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchOps[Self <: WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchBody]): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchMethod]): Self = this.set("method", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMethod: Self = this.set("method", js.undefined)
    
    @scala.inline
    def setQueryString(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchQueryString]): Self = this.set("queryString", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteQueryString: Self = this.set("queryString", js.undefined)
    
    @scala.inline
    def setSingleHeader(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchSingleHeader]): Self = this.set("singleHeader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchUriPath]): Self = this.set("uriPath", value.asInstanceOf[js.Any])
