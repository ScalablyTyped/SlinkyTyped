...
trait WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch extends StObject {
  ...
  /**
    ...
    */
  var body: js.UndefOr[Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchBody]] = js.native
...
object WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch {
  ...
  implicit class WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchMutableBuilder[Self <: WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchBody]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBodyUndefined: Self = StObject.set(x, "body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchMethod]): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMethodUndefined: Self = StObject.set(x, "method", js.undefined)
    
    @scala.inline
    def setQueryString(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchQueryString]): Self = StObject.set(x, "queryString", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setQueryStringUndefined: Self = StObject.set(x, "queryString", js.undefined)
    
    @scala.inline
    def setSingleHeader(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchSingleHeader]): Self = StObject.set(x, "singleHeader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: Input[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchUriPath]): Self = StObject.set(x, "uriPath", value.asInstanceOf[js.Any])
