...
object WebAclLoggingConfigurationRedactedField {
  ...
  implicit class WebAclLoggingConfigurationRedactedFieldOps[Self <: WebAclLoggingConfigurationRedactedField] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllQueryArguments(value: Input[WebAclLoggingConfigurationRedactedFieldAllQueryArguments]): Self = this.set("allQueryArguments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllQueryArguments: Self = this.set("allQueryArguments", js.undefined)
    
    @scala.inline
    def setBody(value: Input[WebAclLoggingConfigurationRedactedFieldBody]): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[WebAclLoggingConfigurationRedactedFieldMethod]): Self = this.set("method", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMethod: Self = this.set("method", js.undefined)
    
    @scala.inline
    def setQueryString(value: Input[WebAclLoggingConfigurationRedactedFieldQueryString]): Self = this.set("queryString", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteQueryString: Self = this.set("queryString", js.undefined)
    
    @scala.inline
    def setSingleHeader(value: Input[WebAclLoggingConfigurationRedactedFieldSingleHeader]): Self = this.set("singleHeader", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSingleHeader: Self = this.set("singleHeader", js.undefined)
    
    @scala.inline
    def setSingleQueryArgument(value: Input[WebAclLoggingConfigurationRedactedFieldSingleQueryArgument]): Self = this.set("singleQueryArgument", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSingleQueryArgument: Self = this.set("singleQueryArgument", js.undefined)
    
    @scala.inline
    def setUriPath(value: Input[WebAclLoggingConfigurationRedactedFieldUriPath]): Self = this.set("uriPath", value.asInstanceOf[js.Any])
