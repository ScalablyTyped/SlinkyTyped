...
object RuleGroupRuleStatementRegexPatternSetReferenceStatement {
  ...
  implicit class RuleGroupRuleStatementRegexPatternSetReferenceStatementOps[Self <: RuleGroupRuleStatementRegexPatternSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: Input[RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation]*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: Input[RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
