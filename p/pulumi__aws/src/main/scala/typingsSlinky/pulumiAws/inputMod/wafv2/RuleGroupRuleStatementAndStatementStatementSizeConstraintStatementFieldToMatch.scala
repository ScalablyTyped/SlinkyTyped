...
@js.native
trait RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch extends StObject {
...
object RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch {
  
  @scala.inline
  def apply(): RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchMutableBuilder[Self <: RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch] (val x: Self) extends AnyVal {
