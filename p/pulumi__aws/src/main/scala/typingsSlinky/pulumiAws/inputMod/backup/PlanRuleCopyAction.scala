...
object PlanRuleCopyAction {
  ...
  implicit class PlanRuleCopyActionOps[Self <: PlanRuleCopyAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDestinationVaultArn(value: Input[String]): Self = this.set("destinationVaultArn", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLifecycle(value: Input[PlanRuleCopyActionLifecycle]): Self = this.set("lifecycle", value.asInstanceOf[js.Any])
