...
@js.native
trait RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatement extends StObject {
...
object RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatement {
  ...
  def apply(
    ...
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatement]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementMutableBuilder[Self <: RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
