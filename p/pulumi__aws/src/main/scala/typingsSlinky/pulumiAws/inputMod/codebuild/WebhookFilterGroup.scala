...
object WebhookFilterGroup {
  ...
  implicit class WebhookFilterGroupOps[Self <: WebhookFilterGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFiltersVarargs(value: Input[WebhookFilterGroupFilter]*): Self = this.set("filters", js.Array(value :_*))
    @scala.inline
    def setFilters(value: Input[js.Array[Input[WebhookFilterGroupFilter]]]): Self = this.set("filters", value.asInstanceOf[js.Any])
    @scala.inline
