...
@js.native
trait WebAclRuleStatementNotStatementStatementSizeConstraintStatement extends js.Object {
...
object WebAclRuleStatementNotStatementStatementSizeConstraintStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementNotStatementStatementSizeConstraintStatementOps[Self <: WebAclRuleStatementNotStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: Input[WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
