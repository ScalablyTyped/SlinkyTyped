...
@js.native
trait RuleGroupRuleStatementAndStatementStatementNotStatementStatementByteMatchStatement extends StObject {
...
object RuleGroupRuleStatementAndStatementStatementNotStatementStatementByteMatchStatement {
  ...
  def apply(
    ...
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementNotStatementStatementByteMatchStatement]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementAndStatementStatementNotStatementStatementByteMatchStatementMutableBuilder[Self <: RuleGroupRuleStatementAndStatementStatementNotStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
