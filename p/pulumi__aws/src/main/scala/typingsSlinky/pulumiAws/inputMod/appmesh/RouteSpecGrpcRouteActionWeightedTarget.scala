...
@js.native
trait RouteSpecGrpcRouteActionWeightedTarget extends js.Object {
...
object RouteSpecGrpcRouteActionWeightedTarget {
  ...
  @scala.inline
  implicit class RouteSpecGrpcRouteActionWeightedTargetOps[Self <: RouteSpecGrpcRouteActionWeightedTarget] (val x: Self) extends AnyVal {
