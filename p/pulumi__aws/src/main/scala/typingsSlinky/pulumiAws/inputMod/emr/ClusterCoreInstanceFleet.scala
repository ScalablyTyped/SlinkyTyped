...
trait ClusterCoreInstanceFleet extends StObject {
  ...
  /**
    ...
    */
  var instanceTypeConfigs: js.UndefOr[Input[js.Array[Input[ClusterCoreInstanceFleetInstanceTypeConfig]]]] = js.native
  
  /**
    * Configuration block for launch specification
    */
  var launchSpecifications: js.UndefOr[Input[ClusterCoreInstanceFleetLaunchSpecifications]] = js.native
