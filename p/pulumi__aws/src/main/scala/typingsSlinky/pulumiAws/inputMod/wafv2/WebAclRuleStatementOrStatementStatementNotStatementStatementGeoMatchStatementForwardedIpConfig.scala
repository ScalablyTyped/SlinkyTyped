...
@js.native
trait WebAclRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatementForwardedIpConfig extends js.Object {
...
object WebAclRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatementForwardedIpConfig {
  ...
  @scala.inline
  def apply(fallbackBehavior: Input[String], headerName: Input[String]): WebAclRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatementForwardedIpConfig = {
  ...
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatementForwardedIpConfigOps[Self <: WebAclRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatementForwardedIpConfig] (val x: Self) extends AnyVal {
