...
import typingsSlinky.pulumiAws.outputMod.sagemaker.ModelContainer
import typingsSlinky.pulumiAws.outputMod.sagemaker.ModelPrimaryContainer
import typingsSlinky.pulumiAws.outputMod.sagemaker.ModelVpcConfig
