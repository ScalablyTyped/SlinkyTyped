...
object SpotFleetRequestState {
  ...
  @scala.inline
  implicit class SpotFleetRequestStateOps[Self <: SpotFleetRequestState] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClientToken(value: Input[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withoutIamFleetRole: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iamFleetRole")(js.undefined)
        ret
    }
    @scala.inline
