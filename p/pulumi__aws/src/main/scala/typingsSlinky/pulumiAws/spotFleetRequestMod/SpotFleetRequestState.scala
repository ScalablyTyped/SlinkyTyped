...
import typingsSlinky.pulumiAws.inputMod.ec2.SpotFleetRequestLaunchTemplateConfig
...
object SpotFleetRequestState {
  ...
  implicit class SpotFleetRequestStateOps[Self <: SpotFleetRequestState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClientToken(value: Input[String]): Self = this.set("clientToken", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def deleteIamFleetRole: Self = this.set("iamFleetRole", js.undefined)
    @scala.inline
