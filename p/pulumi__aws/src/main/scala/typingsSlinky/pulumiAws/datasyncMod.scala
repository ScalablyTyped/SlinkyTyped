...
object datasyncMod extends js.Object {
  ...
  class Agent protected ()
    extends typingsSlinky.pulumiAws.agentMod.Agent {
    /**
  ...
  class EfsLocation protected ()
    extends typingsSlinky.pulumiAws.efsLocationMod.EfsLocation {
    /**
  ...
  class LocationSmb protected ()
    extends typingsSlinky.pulumiAws.locationSmbMod.LocationSmb {
    /**
  ...
  class NfsLocation protected ()
    extends typingsSlinky.pulumiAws.nfsLocationMod.NfsLocation {
    /**
  ...
  class S3Location protected ()
    extends typingsSlinky.pulumiAws.s3locationMod.S3Location {
    /**
  ...
  class Task protected ()
    extends typingsSlinky.pulumiAws.taskMod.Task {
    /**
