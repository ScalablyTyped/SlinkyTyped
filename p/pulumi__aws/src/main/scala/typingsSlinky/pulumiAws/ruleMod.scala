...
object ruleMod {
  ...
  trait RuleArgs extends StObject {
    ...
    /**
      * Scope defines which resources can trigger an evaluation for the rule as documented below.
      */
    val scope: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cfg.RuleScope]] = js.native
    
    /**
      * Source specifies the rule owner, the rule identifier, and the notifications that cause the function to evaluate your AWS resources as documented below.
      */
    val source: Input[typingsSlinky.pulumiAws.inputMod.cfg.RuleSource] = js.native
  ...
  object RuleArgs {
    ...
    @scala.inline
    def apply(source: Input[typingsSlinky.pulumiAws.inputMod.cfg.RuleSource]): RuleArgs = {
    ...
    implicit class RuleArgsMutableBuilder[Self <: RuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScope(value: Input[typingsSlinky.pulumiAws.inputMod.cfg.RuleScope]): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScopeUndefined: Self = StObject.set(x, "scope", js.undefined)
      
      @scala.inline
      def setSource(value: Input[typingsSlinky.pulumiAws.inputMod.cfg.RuleSource]): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
  ...
  trait RuleState extends StObject {
    ...
    /**
      * Source specifies the rule owner, the rule identifier, and the notifications that cause the function to evaluate your AWS resources as documented below.
      */
    val source: js.UndefOr[Input[typingsSlinky.pulumiAws.inputMod.cfg.RuleSource]] = js.native
