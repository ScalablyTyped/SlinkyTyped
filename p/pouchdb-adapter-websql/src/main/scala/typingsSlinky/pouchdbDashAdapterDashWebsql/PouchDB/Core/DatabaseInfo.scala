package typingsSlinky.pouchdbDashAdapterDashWebsql.PouchDB.Core

import typingsSlinky.pouchdbDashAdapterDashWebsql.pouchdbDashAdapterDashWebsqlStrings.`UTF-16`
import typingsSlinky.pouchdbDashAdapterDashWebsql.pouchdbDashAdapterDashWebsqlStrings.`UTF-8`
