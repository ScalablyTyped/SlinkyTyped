...
version := "1.0-dt-20200616Z-8d4e47"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "oauth" % "0.9-dt-20181015Z-26f164",
  "org.scalablytyped.slinky" %%% "passport" % "1.0-dt-20200706Z-c53698",
  "org.scalablytyped.slinky" %%% "passport-oauth2" % "1.4-dt-20200515Z-fbc845",
