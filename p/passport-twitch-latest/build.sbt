...
version := "1.0-dt-20200616Z-a9911f"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "oauth" % "0.9-dt-20181015Z-c3a5fa",
  "org.scalablytyped.slinky" %%% "passport" % "1.0-dt-20200706Z-84ba24",
  "org.scalablytyped.slinky" %%% "passport-oauth2" % "1.4-dt-20200515Z-be60de",
