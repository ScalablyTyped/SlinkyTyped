package typingsSlinky.pouchdbDashMapreduce.PouchDB

import typingsSlinky.pouchdbDashCore.PouchDB.Core.BasicResponse
import typingsSlinky.pouchdbDashCore.PouchDB.Core.Callback
import typingsSlinky.pouchdbDashMapreduce.PouchDB.Query.Options
import typingsSlinky.pouchdbDashMapreduce.PouchDB.Query.Response
