...
import typingsSlinky.phosphorCoreutils.jsonMod.ReadonlyJSONArray
...
object mod extends js.Object {
  @js.native
  class MimeData ()
    extends typingsSlinky.phosphorCoreutils.mimeMod.MimeData
  ...
  class PromiseDelegate[T] ()
    extends typingsSlinky.phosphorCoreutils.promiseMod.PromiseDelegate[T]
  
  @js.native
  class Token[T] protected ()
    extends typingsSlinky.phosphorCoreutils.tokenMod.Token[T] {
    /**
