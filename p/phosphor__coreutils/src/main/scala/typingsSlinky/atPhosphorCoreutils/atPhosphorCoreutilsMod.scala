package typingsSlinky.atPhosphorCoreutils

import typingsSlinky.atPhosphorCoreutils.libJsonMod.JSONValue
import typingsSlinky.atPhosphorCoreutils.libJsonMod.ReadonlyJSONArray
...
object atPhosphorCoreutilsMod extends js.Object {
  @js.native
  class MimeData ()
    extends typingsSlinky.atPhosphorCoreutils.libMimeMod.MimeData
  ...
  class PromiseDelegate[T] ()
    extends typingsSlinky.atPhosphorCoreutils.libPromiseMod.PromiseDelegate[T]
  
  @js.native
  class Token[T] protected ()
    extends typingsSlinky.atPhosphorCoreutils.libTokenMod.Token[T] {
    /**
