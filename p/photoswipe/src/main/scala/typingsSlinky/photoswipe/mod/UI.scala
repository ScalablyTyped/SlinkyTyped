...
object UI {
  @scala.inline
  def apply[/* <: typingsSlinky.photoswipe.mod.Options */ T](init: () => Unit): UI[T] = {
    val __obj = js.Dynamic.literal(init = js.Any.fromFunction0(init))
    __obj.asInstanceOf[UI[T]]
  }
  @scala.inline
  implicit class UIOps[Self <: UI[_], /* <: typingsSlinky.photoswipe.mod.Options */ T] (val x: Self with UI[T]) extends AnyVal {
    @scala.inline
