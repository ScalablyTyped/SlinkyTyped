...
trait OrganizationChartProps extends js.Object {
  ...
  var nodeTemplate: js.UndefOr[js.Function1[/* node */ OrganizationChartNodeData, ReactElement]] = js.native
...
object OrganizationChartProps {
  ...
  implicit class OrganizationChartPropsOps[Self <: OrganizationChartProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNodeTemplate(value: /* node */ OrganizationChartNodeData => ReactElement): Self = this.set("nodeTemplate", js.Any.fromFunction1(value))
    @scala.inline
