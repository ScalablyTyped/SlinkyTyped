package typingsSlinky.primereact.componentsDropdownDropdownItemMod

import typingsSlinky.primereact.Anon_Option
...
trait DropdownItemProps extends js.Object {
  var onClick: js.UndefOr[js.Function1[/* e */ Anon_Option, Unit]] = js.undefined
...
object DropdownItemProps {
  @scala.inline
  def apply(
    onClick: /* e */ Anon_Option => Unit = null,
