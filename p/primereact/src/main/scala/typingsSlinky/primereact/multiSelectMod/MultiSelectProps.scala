...
object MultiSelectProps {
  ...
  implicit class MultiSelectPropsOps[Self <: MultiSelectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemTemplate(value: /* item */ js.Any => js.UndefOr[ReactElement]): Self = this.set("itemTemplate", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSelectedItemTemplate(value: /* value */ js.Any => js.UndefOr[ReactElement]): Self = this.set("selectedItemTemplate", js.Any.fromFunction1(value))
