...
object primereactInplaceMod {
  ...
  class Inplace protected ()
    extends typingsSlinky.primereact.inplaceMod.Inplace {
  ...
  class InplaceContent protected ()
    extends typingsSlinky.primereact.inplaceMod.InplaceContent {
  ...
  class InplaceDisplay protected ()
    extends typingsSlinky.primereact.inplaceMod.InplaceDisplay {
    def this(props: js.Object) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
