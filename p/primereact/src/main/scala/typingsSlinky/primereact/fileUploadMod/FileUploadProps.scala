...
trait FileUploadProps extends js.Object {
  ...
  var onValidationFail: js.UndefOr[js.Function1[/* file */ org.scalajs.dom.raw.File, Unit]] = js.native
...
object FileUploadProps {
  ...
  implicit class FileUploadPropsOps[Self <: FileUploadProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnValidationFail(value: /* file */ org.scalajs.dom.raw.File => Unit): Self = this.set("onValidationFail", js.Any.fromFunction1(value))
    @scala.inline
