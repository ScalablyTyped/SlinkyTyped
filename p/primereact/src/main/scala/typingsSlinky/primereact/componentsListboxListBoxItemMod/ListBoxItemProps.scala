package typingsSlinky.primereact.componentsListboxListBoxItemMod

import typingsSlinky.primereact.Anon_OptionOriginalEvent
...
trait ListBoxItemProps extends js.Object {
  var onClick: js.UndefOr[js.Function1[/* e */ Anon_OptionOriginalEvent, Unit]] = js.undefined
  var onTouchEnd: js.UndefOr[js.Function1[/* e */ Anon_OptionOriginalEvent, Unit]] = js.undefined
...
object ListBoxItemProps {
  @scala.inline
  def apply(
    onClick: /* e */ Anon_OptionOriginalEvent => Unit = null,
    onTouchEnd: /* e */ Anon_OptionOriginalEvent => Unit = null,
    option: js.Any = null,
