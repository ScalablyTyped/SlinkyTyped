...
object dataTableMod {
  ...
  trait DataTableProps extends StObject {
    ...
    var rowGroupFooterTemplate: js.UndefOr[js.Function2[/* data */ js.Any, /* index */ Double, js.UndefOr[ReactElement]]] = js.native
    
    var rowGroupHeaderTemplate: js.UndefOr[js.Function2[/* data */ js.Any, /* index */ Double, js.UndefOr[ReactElement]]] = js.native
  ...
  object DataTableProps {
    ...
    implicit class DataTablePropsMutableBuilder[Self <: DataTableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRowExpansionTemplate(value: /* data */ js.Any => js.UndefOr[ReactElement]): Self = StObject.set(x, "rowExpansionTemplate", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRowExpansionTemplateUndefined: Self = StObject.set(x, "rowExpansionTemplate", js.undefined)
      
      @scala.inline
      def setRowGroupFooterTemplate(value: (/* data */ js.Any, /* index */ Double) => js.UndefOr[ReactElement]): Self = StObject.set(x, "rowGroupFooterTemplate", js.Any.fromFunction2(value))
      
      @scala.inline
      def setRowGroupFooterTemplateUndefined: Self = StObject.set(x, "rowGroupFooterTemplate", js.undefined)
      
      @scala.inline
      def setRowGroupHeaderTemplate(value: (/* data */ js.Any, /* index */ Double) => js.UndefOr[ReactElement]): Self = StObject.set(x, "rowGroupHeaderTemplate", js.Any.fromFunction2(value))
