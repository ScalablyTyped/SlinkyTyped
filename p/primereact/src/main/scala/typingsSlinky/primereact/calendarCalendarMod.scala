...
object calendarCalendarMod {
  ...
  trait CalendarProps extends StObject {
    ...
    var dateTemplate: js.UndefOr[js.Function1[/* dateMeta */ DateMetaData, ReactElement]] = js.native
    ...
    var footerTemplate: js.UndefOr[js.Function0[ReactElement]] = js.native
    
    var headerTemplate: js.UndefOr[js.Function0[ReactElement]] = js.native
  ...
  object CalendarProps {
    ...
    implicit class CalendarPropsMutableBuilder[Self <: CalendarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDateTemplate(value: /* dateMeta */ DateMetaData => ReactElement): Self = StObject.set(x, "dateTemplate", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setFooterTemplate(value: () => ReactElement): Self = StObject.set(x, "footerTemplate", js.Any.fromFunction0(value))
      
      @scala.inline
      def setFooterTemplateUndefined: Self = StObject.set(x, "footerTemplate", js.undefined)
      
      @scala.inline
      def setHeaderTemplate(value: () => ReactElement): Self = StObject.set(x, "headerTemplate", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setViewDate(value: js.Date): Self = StObject.set(x, "viewDate", value.asInstanceOf[js.Any])
