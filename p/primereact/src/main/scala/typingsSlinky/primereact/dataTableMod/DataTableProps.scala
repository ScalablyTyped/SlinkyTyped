...
object DataTableProps {
  ...
  implicit class DataTablePropsOps[Self <: DataTableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRowExpansionTemplate(value: /* data */ js.Any => js.UndefOr[ReactElement]): Self = this.set("rowExpansionTemplate", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRowExpansionTemplate: Self = this.set("rowExpansionTemplate", js.undefined)
    @scala.inline
    def setRowGroupFooterTemplate(value: (/* data */ js.Any, /* index */ Double) => js.UndefOr[ReactElement]): Self = this.set("rowGroupFooterTemplate", js.Any.fromFunction2(value))
    @scala.inline
    def deleteRowGroupFooterTemplate: Self = this.set("rowGroupFooterTemplate", js.undefined)
    @scala.inline
    def setRowGroupHeaderTemplate(value: (/* data */ js.Any, /* index */ Double) => js.UndefOr[ReactElement]): Self = this.set("rowGroupHeaderTemplate", js.Any.fromFunction2(value))
    @scala.inline
