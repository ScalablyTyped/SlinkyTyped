...
object dataViewMod {
  ...
  object DataViewProps {
    ...
    implicit class DataViewPropsMutableBuilder[Self <: DataViewProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFooter(value: ReactElement | String): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHeader(value: ReactElement | String): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setItemTemplate(value: (/* item */ js.Any, /* layout */ grid | list) => js.UndefOr[ReactElement]): Self = StObject.set(x, "itemTemplate", js.Any.fromFunction2(value))
