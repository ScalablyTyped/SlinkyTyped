...
object TieredMenu
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.primereactTieredmenuMod.TieredMenu] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.primereactTieredmenuMod.TieredMenu] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.primereact.primereactTieredmenuMod.TieredMenu] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.primereact.primereactTieredmenuMod.TieredMenu](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
