...
import typingsSlinky.primereact.componentsRadiobuttonRadioButtonMod.RadioButtonProps
...
object RadioButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.radiobuttonMod.RadioButton] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.radiobuttonMod.RadioButton] = {
