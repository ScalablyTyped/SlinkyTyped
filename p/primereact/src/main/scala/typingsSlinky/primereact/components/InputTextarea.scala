...
object InputTextarea {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.primereact.primereactInputtextareaMod.InputTextarea] {
    @scala.inline
    ...
    @scala.inline
    def onChange(value: SyntheticEvent[EventTarget with HTMLTextAreaElement, Event_] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: InputTextareaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: InputTextarea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
