...
import typingsSlinky.primereact.componentsInputtextareaInputTextareaMod.InputTextareaProps
...
object InputTextarea
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.inputtextareaMod.InputTextarea] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.inputtextareaMod.InputTextarea] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.primereact.inputtextareaMod.InputTextarea] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.primereact.inputtextareaMod.InputTextarea](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
