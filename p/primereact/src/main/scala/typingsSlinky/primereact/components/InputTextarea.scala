...
import typingsSlinky.primereact.inputTextareaMod.InputTextareaProps
...
object InputTextarea
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.primereactInputtextareaMod.InputTextarea] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.primereact.primereactInputtextareaMod.InputTextarea] = new slinky.core.BuildingComponent[
  slinky.web.html.textarea.tag.type, 
  typingsSlinky.primereact.primereactInputtextareaMod.InputTextarea](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
