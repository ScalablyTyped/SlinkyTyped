...
import typingsSlinky.primereact.componentsSidebarSidebarMod.SidebarProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object Sidebar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.sidebarMod.Sidebar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.sidebarMod.Sidebar] = {
