...
object Paginator
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.primereact.paginatorMod.Paginator] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.primereact.paginatorMod.Paginator](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
