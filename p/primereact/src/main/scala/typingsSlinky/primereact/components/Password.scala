...
object Password
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.passwordMod.Password] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.passwordMod.Password] = {
