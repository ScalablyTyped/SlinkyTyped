...
object Password {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.primereact.primereactPasswordMod.Password] {
    @scala.inline
    ...
    @scala.inline
    def feedback(value: Boolean): this.type = set("feedback", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def mediumLabel(value: String): this.type = set("mediumLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def promptLabel(value: String): this.type = set("promptLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def strongLabel(value: String): this.type = set("strongLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def weakLabel(value: String): this.type = set("weakLabel", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: Password.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
