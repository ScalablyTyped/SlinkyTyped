...
object Password
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.primereactPasswordMod.Password] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.primereactPasswordMod.Password] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.primereact.primereactPasswordMod.Password] = new slinky.core.BuildingComponent[
  slinky.web.html.input.tag.type, 
  typingsSlinky.primereact.primereactPasswordMod.Password](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
