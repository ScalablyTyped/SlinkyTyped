...
import typingsSlinky.primereact.inputTextMod.InputTextProps
...
object InputText
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.primereactInputtextMod.InputText] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.primereactInputtextMod.InputText] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.primereact.primereactInputtextMod.InputText] = new slinky.core.BuildingComponent[
  slinky.web.html.input.tag.type, 
  typingsSlinky.primereact.primereactInputtextMod.InputText](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
