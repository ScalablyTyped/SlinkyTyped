...
object InputText
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.primereact.inputtextMod.InputText] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.primereact.inputtextMod.InputText] = {
