...
object InputText {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.primereact.primereactInputtextMod.InputText] {
    ...
    @scala.inline
    def keyfilter(value: js.Any): this.type = set("keyfilter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onKeyPress(value: /* event */ SyntheticKeyboardEvent[HTMLInputElement] => Unit): this.type = set("onKeyPress", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def validateOnly(value: Boolean): this.type = set("validateOnly", value.asInstanceOf[js.Any])
