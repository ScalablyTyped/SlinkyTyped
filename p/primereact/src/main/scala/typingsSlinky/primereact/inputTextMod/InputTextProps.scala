...
trait InputTextProps
  ...
  @JSName("onInput")
  var onInput_InputTextProps: js.UndefOr[js.Function1[SyntheticEvent[EventTarget with HTMLInputElement, Event], Unit]] = js.undefined
  @JSName("onKeyPress")
  var onKeyPress_InputTextProps: js.UndefOr[js.Function1[/* event */ SyntheticKeyboardEvent[HTMLInputElement], Unit]] = js.undefined
...
object InputTextProps {
  ...
  def apply(
    ...
    onKeyPress: /* event */ SyntheticKeyboardEvent[HTMLInputElement] => Unit = null,
    tooltip: js.Any = null,
