...
object DataViewProps {
  ...
  implicit class DataViewPropsOps[Self <: DataViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFooter(value: ReactElement | String): Self = this.set("footer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHeader(value: ReactElement | String): Self = this.set("header", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemTemplate(value: (/* item */ js.Any, /* layout */ grid | list) => js.UndefOr[ReactElement]): Self = this.set("itemTemplate", js.Any.fromFunction2(value))
