...
object CalendarProps {
  ...
  implicit class CalendarPropsOps[Self <: CalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateTemplate(value: /* dateMeta */ DateMetaData => ReactElement): Self = this.set("dateTemplate", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setFooterTemplate(value: () => ReactElement): Self = this.set("footerTemplate", js.Any.fromFunction0(value))
    @scala.inline
    def deleteFooterTemplate: Self = this.set("footerTemplate", js.undefined)
    @scala.inline
    def setHeaderTemplate(value: () => ReactElement): Self = this.set("headerTemplate", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setViewDate(value: js.Date): Self = this.set("viewDate", value.asInstanceOf[js.Any])
    @scala.inline
