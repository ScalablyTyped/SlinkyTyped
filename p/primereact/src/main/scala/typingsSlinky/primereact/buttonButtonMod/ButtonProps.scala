...
trait ButtonProps
  ...
  var cornerStyleClass: js.UndefOr[String] = js.native
...
object ButtonProps {
  ...
  implicit class ButtonPropsOps[Self <: ButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCornerStyleClass(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cornerStyleClass")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCornerStyleClass: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cornerStyleClass")(js.undefined)
        ret
    }
    @scala.inline
