...
object HighlightProps {
  @scala.inline
  def apply(Prism: PrismLib, children: RenderProps => ReactElement, code: String, language: Language): HighlightProps = {
  ...
  implicit class HighlightPropsOps[Self <: HighlightProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: RenderProps => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
