...
object BasicStrategyOptions {
  @scala.inline
  def apply[/* <: scala.Boolean */ req](): BasicStrategyOptions[req] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BasicStrategyOptions[req]]
  }
  @scala.inline
  implicit class BasicStrategyOptionsOps[Self <: BasicStrategyOptions[_], /* <: scala.Boolean */ req] (val x: Self with BasicStrategyOptions[req]) extends AnyVal {
    @scala.inline
