...
object AnonArgCountFNotation {
  @scala.inline
  def apply(argCount: `1`, notation: postfix, precedence: `0`, rightToLeft: `0`, symbol: Rightparenthesis): AnonArgCountFNotation = {
  ...
  @scala.inline
  implicit class AnonArgCountFNotationOps[Self <: AnonArgCountFNotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withF(value: scala.Nothing): Self = {
        val ret = this.duplicate
