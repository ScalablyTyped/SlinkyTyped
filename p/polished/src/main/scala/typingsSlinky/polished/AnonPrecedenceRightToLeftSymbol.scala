...
@js.native
trait AnonPrecedenceRightToLeftSymbol extends js.Object {
...
object AnonPrecedenceRightToLeftSymbol {
  @scala.inline
  def apply(
    argCount: `1`,
    ...
    rightToLeft: `0`,
    symbol: sqrt
  ): AnonPrecedenceRightToLeftSymbol = {
    ...
    __obj.asInstanceOf[AnonPrecedenceRightToLeftSymbol]
  }
  @scala.inline
  implicit class AnonPrecedenceRightToLeftSymbolOps[Self <: AnonPrecedenceRightToLeftSymbol] (val x: Self) extends AnyVal {
    @scala.inline
