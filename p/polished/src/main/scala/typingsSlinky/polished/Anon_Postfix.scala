...
trait Anon_Postfix extends js.Object {
  var postfix: Anon_
...
object Anon_Postfix {
  @scala.inline
  def apply(postfix: Anon_, regSymbol: Exclamationmark, symbol: Exclamationmark): Anon_Postfix = {
    ...
    __obj.asInstanceOf[Anon_Postfix]
  }
}
