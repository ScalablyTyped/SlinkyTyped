...
trait Anon_PostfixRegSymbol extends js.Object {
  var postfix: Anon_01ArgCountF
  var regSymbol: BackslashRightparenthesis
  var symbol: Rightparenthesis
}

object Anon_PostfixRegSymbol {
  @scala.inline
  def apply(postfix: Anon_01ArgCountF, regSymbol: BackslashRightparenthesis, symbol: Rightparenthesis): Anon_PostfixRegSymbol = {
    ...
    __obj.asInstanceOf[Anon_PostfixRegSymbol]
  }
}
