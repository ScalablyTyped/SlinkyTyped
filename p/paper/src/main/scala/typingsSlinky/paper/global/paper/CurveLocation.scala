...
class CurveLocation protected ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override val normal: typingsSlinky.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override val path: typingsSlinky.paper.paper.Path = js.native
  /** 
    * The point which is defined by the {@link #curve} and
    * {@link #time}.
    */
  /* CompleteClass */
  override val point: typingsSlinky.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override val tangent: typingsSlinky.paper.paper.Point = js.native
  /** 
