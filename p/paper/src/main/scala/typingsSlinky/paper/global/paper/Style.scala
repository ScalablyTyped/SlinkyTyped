...
class Style protected ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var fillColor: typingsSlinky.paper.paper.Color | Null = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var selectedColor: typingsSlinky.paper.paper.Color | Null = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var shadowColor: typingsSlinky.paper.paper.Color | Null = js.native
  /** 
    * The shadow's offset.
    */
  /* CompleteClass */
  override var shadowOffset: typingsSlinky.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var strokeColor: typingsSlinky.paper.paper.Color | Null = js.native
  /** 
