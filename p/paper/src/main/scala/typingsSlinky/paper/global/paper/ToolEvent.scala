...
class ToolEvent ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var delta: typingsSlinky.paper.paper.Point = js.native
  /** 
    * The position of the mouse in project coordinates when the mouse button
    * was last clicked.
    */
  /* CompleteClass */
  override var downPoint: typingsSlinky.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var lastPoint: typingsSlinky.paper.paper.Point = js.native
  /** 
    ...
    */
  /* CompleteClass */
  override var middlePoint: typingsSlinky.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var point: typingsSlinky.paper.paper.Point = js.native
  /** 
