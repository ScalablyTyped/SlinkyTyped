...
class Color protected ()
  ...
  /** 
    ...
    */
  def this(
    gradient: typingsSlinky.paper.paper.Gradient,
    origin: typingsSlinky.paper.paper.Point,
    destination: typingsSlinky.paper.paper.Point
  ) = this()
  /** 
  ...
  def this(
    ...
    origin: typingsSlinky.paper.paper.Point,
    destination: typingsSlinky.paper.paper.Point,
    highlight: typingsSlinky.paper.paper.Point
  ) = this()
...
object Color {
  ...
  @js.native
  def random(): typingsSlinky.paper.paper.Color = js.native
}
