...
class CurveLocation protected ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override val curve: typingsSlinky.paper.paper.Curve = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override val intersection: typingsSlinky.paper.paper.CurveLocation = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override val segment: typingsSlinky.paper.paper.Segment = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override def equals(location: typingsSlinky.paper.paper.CurveLocation): Boolean = js.native
  /** 
