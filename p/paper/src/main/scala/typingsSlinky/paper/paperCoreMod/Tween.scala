...
class Tween protected ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override def start(): typingsSlinky.paper.paper.Tween = js.native
  /** 
    * Stop tweening.
    */
  /* CompleteClass */
  override def stop(): typingsSlinky.paper.paper.Tween = js.native
  /** 
    ...
    */
  /* CompleteClass */
  override def `then`(callback: js.Function): typingsSlinky.paper.paper.Tween = js.native
}
