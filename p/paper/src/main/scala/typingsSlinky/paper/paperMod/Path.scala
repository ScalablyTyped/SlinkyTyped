...
object Path extends js.Object {
  @js.native
  class Arc protected ()
    extends typingsSlinky.paper.paper.Path.Arc {
    /** 
  ...
  class Circle protected ()
    extends typingsSlinky.paper.paper.Path.Circle {
    /** 
  ...
  class Ellipse protected ()
    extends typingsSlinky.paper.paper.Path.Ellipse {
    /** 
  ...
  class Line protected ()
    extends typingsSlinky.paper.paper.Path.Line {
    /** 
  ...
  class Rectangle protected ()
    extends typingsSlinky.paper.paper.Path.Rectangle {
    /** 
  ...
  class RegularPolygon protected ()
    extends typingsSlinky.paper.paper.Path.RegularPolygon {
    /** 
  ...
  class Star protected ()
    extends typingsSlinky.paper.paper.Path.Star {
    /** 
