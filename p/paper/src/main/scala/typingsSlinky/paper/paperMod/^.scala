...
object ^ extends js.Object {
  /** 
    ...
    */
  var project: typingsSlinky.paper.paper.Project | Null = js.native
  /** 
    * The list of all open projects within the current Paper.js context.
    */
  var projects: js.Array[typingsSlinky.paper.paper.Project] | Null = js.native
  /** 
  ...
  /** 
    ...
    */
  var tool: typingsSlinky.paper.paper.Tool | Null = js.native
  /** 
    * The list of available tools.
    */
  var tools: js.Array[typingsSlinky.paper.paper.Tool] | Null = js.native
  /** 
