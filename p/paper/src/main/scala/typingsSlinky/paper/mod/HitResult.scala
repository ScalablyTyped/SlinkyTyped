...
class HitResult ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var item: typingsSlinky.paper.paper.Item = js.native
  /** 
    ...
    */
  /* CompleteClass */
  override var location: typingsSlinky.paper.paper.CurveLocation = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var segment: typingsSlinky.paper.paper.Segment = js.native
  /** 
