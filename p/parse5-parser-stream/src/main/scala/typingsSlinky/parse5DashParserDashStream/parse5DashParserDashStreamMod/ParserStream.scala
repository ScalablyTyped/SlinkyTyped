package typingsSlinky.parse5DashParserDashStream.parse5DashParserDashStreamMod

import typingsSlinky.node.streamMod.Writable
import typingsSlinky.parse5.parse5Mod.Element
import typingsSlinky.parse5DashParserDashStream.parse5DashParserDashStreamStrings.script
