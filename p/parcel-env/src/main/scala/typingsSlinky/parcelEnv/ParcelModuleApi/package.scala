package typingsSlinky.parcelEnv
...
package object ParcelModuleApi {
  ...
  type RequireLambda = typingsSlinky.parcelEnv.ParcelModuleApi.Require1 with typingsSlinky.parcelEnv.ParcelModuleApi.Require2
}
