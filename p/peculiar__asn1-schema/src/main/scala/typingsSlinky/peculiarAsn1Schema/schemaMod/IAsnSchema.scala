package typingsSlinky.peculiarAsn1Schema.schemaMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.peculiarAsn1Schema.enumsMod.AsnPropTypes
import typingsSlinky.peculiarAsn1Schema.enumsMod.AsnTypeTypes
