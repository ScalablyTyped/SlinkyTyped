...
object mod {
  ...
  object ParseOptions {
    ...
    implicit class ParseOptionsMutableBuilder[Self <: ParseOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomTlds(value: js.RegExp | js.Array[String]): Self = StObject.set(x, "customTlds", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomTldsRegExp(value: js.RegExp): Self = StObject.set(x, "customTlds", value.asInstanceOf[js.Any])
