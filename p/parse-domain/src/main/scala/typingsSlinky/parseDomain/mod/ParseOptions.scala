...
object ParseOptions {
  ...
  implicit class ParseOptionsOps[Self <: ParseOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomTldsRegExp(value: js.RegExp): Self = this.set("customTlds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomTlds(value: js.RegExp | js.Array[String]): Self = this.set("customTlds", value.asInstanceOf[js.Any])
