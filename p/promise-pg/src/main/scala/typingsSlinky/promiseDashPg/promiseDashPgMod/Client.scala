...
import typingsSlinky.promiseDashPg.promiseDashPgStrings.drain
import typingsSlinky.promiseDashPg.promiseDashPgStrings.error
import typingsSlinky.promiseDashPg.promiseDashPgStrings.notice
import typingsSlinky.promiseDashPg.promiseDashPgStrings.notification
...
class Client protected () extends js.Object {
  ...
  var raw: typingsSlinky.pg.pgMod.Client = js.native
