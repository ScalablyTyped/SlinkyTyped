...
object loggerMod {
  ...
  object LogLevel extends StObject {
    ...
    /* 3 */ val DEBUG: typingsSlinky.protractor.loggerMod.LogLevel.DEBUG with Double = js.native
    
    @js.native
    sealed trait ERROR extends LogLevel
    /* 0 */ val ERROR: typingsSlinky.protractor.loggerMod.LogLevel.ERROR with Double = js.native
    
    @js.native
    sealed trait INFO extends LogLevel
    /* 2 */ val INFO: typingsSlinky.protractor.loggerMod.LogLevel.INFO with Double = js.native
    
    @js.native
    sealed trait WARN extends LogLevel
    /* 1 */ val WARN: typingsSlinky.protractor.loggerMod.LogLevel.WARN with Double = js.native
  }
  ...
  object WriteTo extends StObject {
    ...
    /* 2 */ val BOTH: typingsSlinky.protractor.loggerMod.WriteTo.BOTH with Double = js.native
    
    @js.native
    sealed trait CONSOLE extends WriteTo
    /* 0 */ val CONSOLE: typingsSlinky.protractor.loggerMod.WriteTo.CONSOLE with Double = js.native
    
    @js.native
    sealed trait FILE extends WriteTo
    /* 1 */ val FILE: typingsSlinky.protractor.loggerMod.WriteTo.FILE with Double = js.native
    
    @js.native
    sealed trait NONE extends WriteTo
    /* 3 */ val NONE: typingsSlinky.protractor.loggerMod.WriteTo.NONE with Double = js.native
  }
}
