...
import typingsSlinky.protractor.builtDriverProvidersMod.DriverProvider
import typingsSlinky.protractor.builtPluginsMod.Plugins
...
@js.native
object builtRunnerMod extends js.Object {
  @js.native
