...
class WebDriver protected ()
  extends typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.WebDriver {
  def this(
    session: js.Promise[typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.Session],
    executor: Executor
  ) = this()
  // region Constructors
  /**
    ...
    */
  def this(session: typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.Session, executor: Executor) = this()
}
...
object WebDriver extends js.Object {
  ...
  def createSession(var_args: js.Any*): typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.WebDriver = js.native
}
