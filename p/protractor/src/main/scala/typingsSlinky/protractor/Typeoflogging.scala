...
import typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.IType
import typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.Level
import typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.Logger
...
trait Typeoflogging extends js.Object {
  ...
  var Entry: Instantiable2[
    /* level */ Level, 
    /* message */ String, 
    typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.Entry
  ] = js.native
  /**
  ...
  /**
    ...
    * @final
    */
  var LogManager: Instantiable0[typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.LogManager] = js.native
  /**
  ...
  var Logger: Instantiable1[
    /* name */ String, 
    typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.Logger
  ] = js.native
  /**
    * A hash describing log preferences.
    * @typedef {Object.<logging.Type, logging.LevelName>}
    */
  var Preferences: Instantiable0[typingsSlinky.seleniumDashWebdriver.seleniumDashWebdriverMod.logging.Preferences] = js.native
  /**
    * Common log types.
    * @enum {string}
    */
