...
trait Typeoffirefox extends js.Object {
  ...
  var Options: Instantiable0[typingsSlinky.seleniumWebdriver.firefoxMod.Options] = js.native
  var ServiceBuilder: Instantiable0[typingsSlinky.seleniumWebdriver.firefoxMod.ServiceBuilder] = js.native
