...
object mod {
  ...
  object exchangeType extends StObject {
    ...
    /* "direct" */ val direct: typingsSlinky.pagerJackrabbit.mod.exchangeType.direct with String = js.native
    
    @js.native
    sealed trait fanout extends exchangeType
    /* "fanout" */ val fanout: typingsSlinky.pagerJackrabbit.mod.exchangeType.fanout with String = js.native
    
    @js.native
    sealed trait topic extends exchangeType
    /* "topic" */ val topic: typingsSlinky.pagerJackrabbit.mod.exchangeType.topic with String = js.native
  }
  ...
  type Message = typingsSlinky.amqplib.propertiesMod.Message
