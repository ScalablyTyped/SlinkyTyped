...
import typingsSlinky.promiseDashPoller.promiseDashPollerStrings.`exponential-backoff`
import typingsSlinky.promiseDashPoller.promiseDashPollerStrings.`fixed-interval`
import typingsSlinky.promiseDashPoller.promiseDashPollerStrings.`linear-backoff`
