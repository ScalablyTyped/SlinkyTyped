...
import typingsSlinky.atPhosphorCommands.atPhosphorCommandsStrings.`many-changed`
import typingsSlinky.atPhosphorCommands.atPhosphorCommandsStrings.added
import typingsSlinky.atPhosphorCommands.atPhosphorCommandsStrings.changed
