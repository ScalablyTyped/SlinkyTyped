...
object BackendMessage {
  ...
  @scala.inline
  implicit class BackendMessageOps[Self <: BackendMessage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setName(value: MessageName): Self = this.set("name", value.asInstanceOf[js.Any])
  }
