...
object mod {
  ...
  */
  ...
  object PackageLocator {
    ...
    @scala.inline
    def PhysicalPackageLocator(name: String, reference: String): typingsSlinky.pnpapi.mod.PhysicalPackageLocator = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], reference = reference.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.pnpapi.mod.PhysicalPackageLocator]
    }
    
    @scala.inline
    def TopLevelPackageLocator(name: Null, reference: Null): typingsSlinky.pnpapi.mod.TopLevelPackageLocator = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], reference = reference.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.pnpapi.mod.TopLevelPackageLocator]
    }
  }
