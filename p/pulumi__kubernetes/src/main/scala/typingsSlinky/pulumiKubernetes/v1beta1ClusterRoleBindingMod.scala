...
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1beta1.RoleRef
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1beta1.Subject
...
object v1beta1ClusterRoleBindingMod {
  ...
  object ClusterRoleBinding {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRoleBinding", "ClusterRoleBinding.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRoleBinding", "ClusterRoleBinding.isInstance")
    @js.native
  ...
  trait ClusterRoleBindingArgs extends StObject {
    ...
    /**
      * RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
      */
    val roleRef: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.RoleRef] = js.native
    
    /**
      * Subjects holds references to the objects the role applies to.
      */
    val subjects: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.Subject]]]
      ] = js.native
  }
  object ClusterRoleBindingArgs {
    
    @scala.inline
    def apply(roleRef: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.RoleRef]): ClusterRoleBindingArgs = {
    ...
    implicit class ClusterRoleBindingArgsMutableBuilder[Self <: ClusterRoleBindingArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRoleRef(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.RoleRef]): Self = StObject.set(x, "roleRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubjects(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.Subject]]]): Self = StObject.set(x, "subjects", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubjectsUndefined: Self = StObject.set(x, "subjects", js.undefined)
      
      @scala.inline
      def setSubjectsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.Subject]*): Self = StObject.set(x, "subjects", js.Array(value :_*))
    }
  }
}
