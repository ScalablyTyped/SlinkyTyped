...
object v2alpha1CronJobMod {
  ...
  object CronJob {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/batch/v2alpha1/cronJob", "CronJob.get")
    @js.native
  ...
  trait CronJobArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJob]] = js.native
    ...
    /**
      * Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v2alpha1.CronJobSpec]] = js.native
  }
  object CronJobArgs {
    ...
    @scala.inline
    implicit class CronJobArgsMutableBuilder[Self <: CronJobArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJob]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v2alpha1.CronJobSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
