package typingsSlinky.pulumiKubernetes.namespaceMod

import typingsSlinky.pulumiKubernetes.inputMod.core.v1.NamespaceSpec
...
object NamespaceArgs {
  ...
  implicit class NamespaceArgsOps[Self <: NamespaceArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Namespace]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
