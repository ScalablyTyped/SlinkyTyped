...
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1beta1.RoleBinding
...
object v1beta1RoleBindingListMod {
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.RoleBinding]]
      ] = js.native
  ...
  object RoleBindingListArgs {
    ...
    implicit class RoleBindingListArgsMutableBuilder[Self <: RoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
