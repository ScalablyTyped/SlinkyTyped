...
@js.native
trait StorageClassArgs extends js.Object {
  ...
  /**
    ...
    */
  val allowedTopologies: js.UndefOr[Input[js.Array[Input[TopologySelectorTerm]]]] = js.native
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClass]] = js.native
...
object StorageClassArgs {
  ...
  @scala.inline
  implicit class StorageClassArgsOps[Self <: StorageClassArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClass]): Self = this.set("kind", value.asInstanceOf[js.Any])
