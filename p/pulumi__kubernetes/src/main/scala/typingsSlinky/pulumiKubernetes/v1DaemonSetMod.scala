...
object v1DaemonSetMod {
  ...
  object DaemonSet {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/daemonSet", "DaemonSet.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/daemonSet", "DaemonSet.isInstance")
    @js.native
  ...
  trait DaemonSetArgs extends StObject {
    ...
    /**
      * The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DaemonSetSpec]] = js.native
  }
  object DaemonSetArgs {
    ...
    implicit class DaemonSetArgsMutableBuilder[Self <: DaemonSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DaemonSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
