...
import typingsSlinky.pulumiKubernetes.outputMod.admissionregistration.v1beta1.ValidatingWebhookConfiguration
...
object validatingWebhookConfigurationListMod {
  ...
  object ValidatingWebhookConfigurationList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/validatingWebhookConfigurationList", "ValidatingWebhookConfigurationList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/validatingWebhookConfigurationList", "ValidatingWebhookConfigurationList.isInstance")
    @js.native
  ...
  trait ValidatingWebhookConfigurationListArgs extends StObject {
    ...
    val items: Input[
        js.Array[
          Input[
            typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhookConfiguration
          ]
        ]
      ] = js.native
