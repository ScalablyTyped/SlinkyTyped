...
object eventMod {
  ...
  trait EventArgs extends StObject {
    ...
    /**
      * The object that this event is about.
      */
    val involvedObject: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Event]] = js.native
    ...
    /**
      * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      */
    val metadata: Input[typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ObjectMeta] = js.native
    ...
    /**
      * Optional secondary object for more complex actions.
      */
    val related: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]] = js.native
    ...
    /**
      * Data about the Event series this event represents or nil if it's a singleton Event.
      */
    val series: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventSeries]] = js.native
    
    /**
      * The component reporting this event. Should be a short machine understandable string.
      */
    val source: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventSource]] = js.native
  ...
  object EventArgs {
    ...
    @scala.inline
    def apply(
      involvedObject: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference],
      metadata: Input[typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ObjectMeta]
    ): EventArgs = {
    ...
    implicit class EventArgsMutableBuilder[Self <: EventArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInvolvedObject(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]): Self = StObject.set(x, "involvedObject", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Event]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRelated(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]): Self = StObject.set(x, "related", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSeries(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventSeries]): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSeriesUndefined: Self = StObject.set(x, "series", js.undefined)
      
      @scala.inline
      def setSource(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventSource]): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
