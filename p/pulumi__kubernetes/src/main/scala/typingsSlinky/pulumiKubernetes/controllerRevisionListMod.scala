...
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta1.ControllerRevision
...
object controllerRevisionListMod {
  ...
  class ControllerRevisionList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList] = js.native
  ...
  object ControllerRevisionList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta1/controllerRevisionList", "ControllerRevisionList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta1/controllerRevisionList", "ControllerRevisionList.isInstance")
    @js.native
  ...
  trait ControllerRevisionListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.ControllerRevision]]
      ] = js.native
    ...
    /**
      ...
      */
    val kind: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList]
      ] = js.native
  ...
  object ControllerRevisionListArgs {
    ...
    implicit class ControllerRevisionListArgsMutableBuilder[Self <: ControllerRevisionListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.ControllerRevision]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
