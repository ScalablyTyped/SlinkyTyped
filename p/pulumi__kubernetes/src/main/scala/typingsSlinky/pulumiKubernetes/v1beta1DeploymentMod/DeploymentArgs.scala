package typingsSlinky.pulumiKubernetes.v1beta1DeploymentMod

import typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DeploymentSpec
...
trait DeploymentArgs extends js.Object {
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[DeploymentSpec]] = js.native
}
