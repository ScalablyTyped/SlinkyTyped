...
object podTemplateMod {
  ...
  trait PodTemplateArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate]] = js.native
    ...
    /**
      * Template defines the pods that will be created from this pod template. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val template: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplateSpec]] = js.native
  }
  object PodTemplateArgs {
    ...
    implicit class PodTemplateArgsMutableBuilder[Self <: PodTemplateArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTemplate(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplateSpec]): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
