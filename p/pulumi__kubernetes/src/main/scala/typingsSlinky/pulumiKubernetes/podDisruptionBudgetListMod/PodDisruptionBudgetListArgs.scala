package typingsSlinky.pulumiKubernetes.podDisruptionBudgetListMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudget
...
object PodDisruptionBudgetListArgs {
  ...
  implicit class PodDisruptionBudgetListArgsOps[Self <: PodDisruptionBudgetListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList]): Self = this.set("kind", value.asInstanceOf[js.Any])
