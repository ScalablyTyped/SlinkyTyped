...
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta2.ReplicaSet
...
object replicaSetListMod {
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    /**
      * List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet]]] = js.native
  ...
  object ReplicaSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet]]]): ReplicaSetListArgs = {
    ...
    implicit class ReplicaSetListArgsMutableBuilder[Self <: ReplicaSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
