...
object replicaSetListMod extends js.Object {
  ...
  class ReplicaSetList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSetList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSetList,
