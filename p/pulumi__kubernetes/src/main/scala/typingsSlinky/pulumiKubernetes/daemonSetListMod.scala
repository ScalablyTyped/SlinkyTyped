...
@JSImport("@pulumi/kubernetes/apps/v1beta2/DaemonSetList", JSImport.Namespace)
@js.native
object daemonSetListMod extends js.Object {
  @js.native
  class DaemonSetList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSetList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSetList,
