...
object daemonSetListMod {
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      * A list of daemon sets.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSetList]] = js.native
  ...
  object DaemonSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]]]): DaemonSetListArgs = {
    ...
    implicit class DaemonSetListArgsMutableBuilder[Self <: DaemonSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
