package typingsSlinky.pulumiKubernetes.roleListMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.Role
...
@js.native
trait RoleListArgs extends js.Object {
  /**
  ...
  /**
    ...
    */
  val items: Input[js.Array[Input[Role]]] = js.native
  /**
...
object RoleListArgs {
  @scala.inline
  def apply(items: Input[js.Array[Input[Role]]]): RoleListArgs = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[RoleListArgs]
  }
  @scala.inline
  implicit class RoleListArgsOps[Self <: RoleListArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Input[Role]*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: Input[js.Array[Input[Role]]]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RoleList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
