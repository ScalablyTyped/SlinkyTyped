...
object persistentVolumeClaimListMod {
  ...
  object PersistentVolumeClaimList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/persistentVolumeClaimList", "PersistentVolumeClaimList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/persistentVolumeClaimList", "PersistentVolumeClaimList.isInstance")
    @js.native
  ...
  trait PersistentVolumeClaimListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaim]]
      ] = js.native
  ...
  object PersistentVolumeClaimListArgs {
    ...
    implicit class PersistentVolumeClaimListArgsMutableBuilder[Self <: PersistentVolumeClaimListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaim]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaimList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
