package typingsSlinky.pulumiKubernetes.controllerRevisionListMod

import typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.ControllerRevision
...
object ControllerRevisionListArgs {
  ...
  implicit class ControllerRevisionListArgsOps[Self <: ControllerRevisionListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
