...
object v1beta1DeploymentListMod {
  ...
  object DeploymentList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/extensions/v1beta1/deploymentList", "DeploymentList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/extensions/v1beta1/deploymentList", "DeploymentList.isInstance")
    @js.native
  ...
  trait DeploymentListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.Deployment]]
      ] = js.native
  ...
  object DeploymentListArgs {
    ...
    implicit class DeploymentListArgsMutableBuilder[Self <: DeploymentListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.Deployment]*): Self = StObject.set(x, "items", js.Array(value :_*))
