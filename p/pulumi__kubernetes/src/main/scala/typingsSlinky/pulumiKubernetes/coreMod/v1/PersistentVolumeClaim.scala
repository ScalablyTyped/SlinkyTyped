...
class PersistentVolumeClaim protected ()
  extends typingsSlinky.pulumiKubernetes.coreV1Mod.PersistentVolumeClaim {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaim) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaim,
...
object PersistentVolumeClaim extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.persistentVolumeClaimMod.PersistentVolumeClaim = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.persistentVolumeClaimMod.PersistentVolumeClaim = js.native
  /**
