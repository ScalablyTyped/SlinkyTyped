...
class ResourceQuotaList protected ()
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuotaList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuotaList,
