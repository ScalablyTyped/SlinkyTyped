...
class ConfigMap protected ()
  extends typingsSlinky.pulumiKubernetes.coreV1Mod.ConfigMap {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMap) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMap,
