...
class ReplicationController protected ()
  extends typingsSlinky.pulumiKubernetes.coreV1Mod.ReplicationController {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ReplicationController) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ReplicationController,
