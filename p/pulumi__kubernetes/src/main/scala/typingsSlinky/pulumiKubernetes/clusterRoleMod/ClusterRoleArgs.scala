package typingsSlinky.pulumiKubernetes.clusterRoleMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ObjectMeta
import typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.AggregationRule
import typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.PolicyRule
...
object ClusterRoleArgs {
  ...
  implicit class ClusterRoleArgsOps[Self <: ClusterRoleArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRole]): Self = this.set("kind", value.asInstanceOf[js.Any])
