...
object podDisruptionBudgetMod {
  ...
  class PodDisruptionBudget protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget] = js.native
  ...
  trait PodDisruptionBudgetArgs extends StObject {
    ...
    /**
      ...
      */
    val kind: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget]
      ] = js.native
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudgetSpec]
      ] = js.native
  }
  object PodDisruptionBudgetArgs {
    ...
    implicit class PodDisruptionBudgetArgsMutableBuilder[Self <: PodDisruptionBudgetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudgetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
