...
object appsV1Mod extends js.Object {
  ...
  class ControllerRevision protected ()
    extends typingsSlinky.pulumiKubernetes.v1ControllerRevisionMod.ControllerRevision {
    /**
  ...
  class ControllerRevisionList protected ()
    extends typingsSlinky.pulumiKubernetes.v1ControllerRevisionListMod.ControllerRevisionList {
    /**
  ...
  class DaemonSet protected ()
    extends typingsSlinky.pulumiKubernetes.v1DaemonSetMod.DaemonSet {
    /**
  ...
  class DaemonSetList protected ()
    extends typingsSlinky.pulumiKubernetes.v1DaemonSetListMod.DaemonSetList {
    /**
  ...
  class Deployment protected ()
    extends typingsSlinky.pulumiKubernetes.v1DeploymentMod.Deployment {
    /**
  ...
  class DeploymentList protected ()
    extends typingsSlinky.pulumiKubernetes.v1DeploymentListMod.DeploymentList {
    /**
  ...
  class ReplicaSet protected ()
    extends typingsSlinky.pulumiKubernetes.v1ReplicaSetMod.ReplicaSet {
    /**
  ...
  class ReplicaSetList protected ()
    extends typingsSlinky.pulumiKubernetes.v1ReplicaSetListMod.ReplicaSetList {
    /**
  ...
  class StatefulSet protected ()
    extends typingsSlinky.pulumiKubernetes.v1StatefulSetMod.StatefulSet {
    /**
  ...
  class StatefulSetList protected ()
    extends typingsSlinky.pulumiKubernetes.v1StatefulSetListMod.StatefulSetList {
    /**
