...
object v1PriorityClassMod {
  ...
  object PriorityClass {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1/priorityClass", "PriorityClass.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1/priorityClass", "PriorityClass.isInstance")
    @js.native
