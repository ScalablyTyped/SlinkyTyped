...
object v1StatefulSetListMod {
  ...
  trait StatefulSetListArgs extends StObject {
    ...
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.StatefulSet]]] = js.native
  ...
  object StatefulSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.StatefulSet]]]): StatefulSetListArgs = {
    ...
    implicit class StatefulSetListArgsMutableBuilder[Self <: StatefulSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.StatefulSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
