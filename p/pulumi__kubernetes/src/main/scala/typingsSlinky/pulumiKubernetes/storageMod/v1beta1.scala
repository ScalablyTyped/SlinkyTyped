...
object v1beta1 extends js.Object {
  ...
  class CSIDriverList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class StorageClass protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.StorageClass) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.StorageClass,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class StorageClassList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.StorageClassList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.StorageClassList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class VolumeAttachment protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment,
      opts: CustomResourceOptions
    ) = this()
  }
