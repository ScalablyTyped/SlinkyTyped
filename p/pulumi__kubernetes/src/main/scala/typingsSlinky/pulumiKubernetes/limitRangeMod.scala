...
object limitRangeMod {
  ...
  trait LimitRangeArgs extends StObject {
    ...
    /**
      * Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRangeSpec]] = js.native
  }
  object LimitRangeArgs {
    ...
    implicit class LimitRangeArgsMutableBuilder[Self <: LimitRangeArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRange]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRangeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
