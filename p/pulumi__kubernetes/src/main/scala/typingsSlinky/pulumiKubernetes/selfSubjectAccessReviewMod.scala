...
@JSImport("@pulumi/kubernetes/authorization/v1beta1/SelfSubjectAccessReview", JSImport.Namespace)
@js.native
object selfSubjectAccessReviewMod extends js.Object {
  @js.native
  class SelfSubjectAccessReview protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.authorization.v1beta1.SelfSubjectAccessReview
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.authorization.v1beta1.SelfSubjectAccessReview,
