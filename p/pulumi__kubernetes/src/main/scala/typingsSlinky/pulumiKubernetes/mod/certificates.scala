...
object certificates extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class CertificateSigningRequest protected ()
      extends typingsSlinky.pulumiKubernetes.certificatesMod.v1.CertificateSigningRequest {
      /**
    ...
    class CertificateSigningRequestList protected ()
      extends typingsSlinky.pulumiKubernetes.certificatesMod.v1.CertificateSigningRequestList {
      /**
  ...
  object v1beta1 extends js.Object {
    ...
    @js.native
    class CertificateSigningRequest protected ()
      extends typingsSlinky.pulumiKubernetes.certificatesMod.v1beta1.CertificateSigningRequest {
      /**
        * Create a CertificateSigningRequest resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
    ...
    @js.native
    class CertificateSigningRequestList protected ()
      extends typingsSlinky.pulumiKubernetes.certificatesMod.v1beta1.CertificateSigningRequestList {
      /**
        * Create a CertificateSigningRequestList resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
