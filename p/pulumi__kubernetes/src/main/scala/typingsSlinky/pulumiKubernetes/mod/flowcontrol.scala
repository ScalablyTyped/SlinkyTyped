...
object flowcontrol extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class FlowSchema protected ()
      extends typingsSlinky.pulumiKubernetes.flowcontrolMod.v1alpha1.FlowSchema {
      /**
    ...
    class FlowSchemaList protected ()
      extends typingsSlinky.pulumiKubernetes.flowcontrolMod.v1alpha1.FlowSchemaList {
      /**
    ...
    class PriorityLevelConfiguration protected ()
      extends typingsSlinky.pulumiKubernetes.flowcontrolMod.v1alpha1.PriorityLevelConfiguration {
      /**
    ...
    class PriorityLevelConfigurationList protected ()
      extends typingsSlinky.pulumiKubernetes.flowcontrolMod.v1alpha1.PriorityLevelConfigurationList {
      /**
