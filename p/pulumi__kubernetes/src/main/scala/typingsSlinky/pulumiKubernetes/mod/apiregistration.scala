...
object apiregistration extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class APIService protected ()
      extends typingsSlinky.pulumiKubernetes.apiregistrationMod.v1.APIService {
      /**
      ...
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1.APIService) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1.APIService,
    ...
    class APIServiceList protected ()
      extends typingsSlinky.pulumiKubernetes.apiregistrationMod.v1.APIServiceList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1.APIServiceList) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1.APIServiceList,
        opts: CustomResourceOptions
      ) = this()
    }
  ...
  object v1beta1 extends js.Object {
    @js.native
    class APIService protected ()
      extends typingsSlinky.pulumiKubernetes.apiregistrationMod.v1beta1.APIService {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIService) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIService,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    @js.native
    class APIServiceList protected ()
      extends typingsSlinky.pulumiKubernetes.apiregistrationMod.v1beta1.APIServiceList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceList) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceList,
        opts: CustomResourceOptions
      ) = this()
    }
