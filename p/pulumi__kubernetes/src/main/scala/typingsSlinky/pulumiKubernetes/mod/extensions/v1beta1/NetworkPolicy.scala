...
class NetworkPolicy protected ()
  extends typingsSlinky.pulumiKubernetes.extensionsMod.v1beta1.NetworkPolicy {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy,
