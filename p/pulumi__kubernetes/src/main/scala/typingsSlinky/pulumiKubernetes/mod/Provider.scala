...
import typingsSlinky.pulumiKubernetes.providerMod.ProviderArgs
...
class Provider protected ()
  extends typingsSlinky.pulumiKubernetes.providerMod.Provider {
  /**
...
object Provider {
  ...
  /**
    ...
    */
  @JSImport("@pulumi/kubernetes", "Provider.isInstance")
  @js.native
