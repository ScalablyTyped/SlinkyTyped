...
class LimitRangeList protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.LimitRangeList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRangeList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRangeList,
...
object LimitRangeList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.limitRangeListMod.LimitRangeList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.limitRangeListMod.LimitRangeList = js.native
  /**
