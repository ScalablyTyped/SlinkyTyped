...
object apiextensions extends js.Object {
  ...
  class CustomResource protected ()
    extends typingsSlinky.pulumiKubernetes.apiextensionsMod.CustomResource {
    /**
  ...
  object v1 extends js.Object {
    ...
    class CustomResourceDefinition protected ()
      extends typingsSlinky.pulumiKubernetes.apiextensionsMod.v1.CustomResourceDefinition {
      /**
    ...
    class CustomResourceDefinitionList protected ()
      extends typingsSlinky.pulumiKubernetes.apiextensionsMod.v1.CustomResourceDefinitionList {
      /**
  ...
  object v1beta1 extends js.Object {
    ...
    @js.native
    class CustomResourceDefinition protected ()
      extends typingsSlinky.pulumiKubernetes.apiextensionsMod.v1beta1.CustomResourceDefinition {
      /**
        * Create a CustomResourceDefinition resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
    ...
    @js.native
    class CustomResourceDefinitionList protected ()
      extends typingsSlinky.pulumiKubernetes.apiextensionsMod.v1beta1.CustomResourceDefinitionList {
      /**
        * Create a CustomResourceDefinitionList resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
