...
class Namespace protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.Namespace {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.Namespace) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.Namespace,
