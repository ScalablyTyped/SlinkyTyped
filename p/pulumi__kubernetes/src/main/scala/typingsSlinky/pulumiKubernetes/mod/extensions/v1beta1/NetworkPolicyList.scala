...
class NetworkPolicyList protected ()
  extends typingsSlinky.pulumiKubernetes.extensionsMod.v1beta1.NetworkPolicyList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicyList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicyList,
