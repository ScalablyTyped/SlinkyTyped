...
object node {
  ...
  object v1alpha1 {
    ...
    class RuntimeClass protected ()
      extends typingsSlinky.pulumiKubernetes.pulumiKubernetesMod.v1alpha1.RuntimeClass {
      /**
    ...
    class RuntimeClassList protected ()
      extends typingsSlinky.pulumiKubernetes.pulumiKubernetesMod.v1alpha1.RuntimeClassList {
      /**
  ...
  object v1beta1 {
    ...
    @js.native
    class RuntimeClass protected ()
      extends typingsSlinky.pulumiKubernetes.pulumiKubernetesMod.v1beta1.RuntimeClass {
      /**
        * Create a RuntimeClass resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.v1beta1RuntimeClassMod.RuntimeClassArgs) = this()
      def this(name: String, args: js.UndefOr[scala.Nothing], opts: CustomResourceOptions) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.v1beta1RuntimeClassMod.RuntimeClassArgs,
    ...
    @js.native
    class RuntimeClassList protected ()
      extends typingsSlinky.pulumiKubernetes.pulumiKubernetesMod.v1beta1.RuntimeClassList {
      /**
        * Create a RuntimeClassList resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.v1beta1RuntimeClassListMod.RuntimeClassListArgs) = this()
      def this(name: String, args: js.UndefOr[scala.Nothing], opts: CustomResourceOptions) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.v1beta1RuntimeClassListMod.RuntimeClassListArgs,
        opts: CustomResourceOptions
      ) = this()
    }
    /* static members */
