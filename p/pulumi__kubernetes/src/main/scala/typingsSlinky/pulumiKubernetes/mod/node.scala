  ...
  object v1alpha1 extends js.Object {
    ...
    class RuntimeClassList protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClassList) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClassList,
        opts: CustomResourceOptions
      ) = this()
    }
  ...
  object v1beta1 extends js.Object {
    ...
    class RuntimeClass protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass,
        opts: CustomResourceOptions
      ) = this()
    }
