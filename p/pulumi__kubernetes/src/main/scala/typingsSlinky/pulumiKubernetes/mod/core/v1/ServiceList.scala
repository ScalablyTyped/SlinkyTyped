...
class ServiceList protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.ServiceList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceList,
