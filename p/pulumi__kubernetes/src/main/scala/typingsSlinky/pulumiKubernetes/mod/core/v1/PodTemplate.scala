...
class PodTemplate protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.PodTemplate {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplate) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplate,
...
object PodTemplate extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.podTemplateMod.PodTemplate = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.podTemplateMod.PodTemplate = js.native
  /**
