package typingsSlinky.pulumiKubernetes.mod.storage
...
object v1alpha1 extends js.Object {
  ...
  class VolumeAttachment protected ()
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachment) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachment,
  ...
  class VolumeAttachmentList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachmentList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachmentList,
      opts: CustomResourceOptions
    ) = this()
  }
