...
object events extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class Event protected ()
      extends typingsSlinky.pulumiKubernetes.eventsMod.v1.Event {
      /**
    ...
    class EventList protected ()
      extends typingsSlinky.pulumiKubernetes.eventsMod.v1.EventList {
      /**
  ...
  object v1beta1 extends js.Object {
    ...
    @js.native
    class Event protected ()
      extends typingsSlinky.pulumiKubernetes.eventsMod.v1beta1.Event {
      /**
        * Create a Event resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
    ...
    @js.native
    class EventList protected ()
      extends typingsSlinky.pulumiKubernetes.eventsMod.v1beta1.EventList {
      /**
        * Create a EventList resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
