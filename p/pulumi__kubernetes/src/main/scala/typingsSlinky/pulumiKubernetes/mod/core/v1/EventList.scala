...
class EventList protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.EventList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventList,
