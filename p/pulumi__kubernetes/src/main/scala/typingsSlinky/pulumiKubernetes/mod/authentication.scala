...
object authentication extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class TokenRequest protected ()
      ...
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenRequest) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenRequest,
    ...
    class TokenReview protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenReview) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenReview,
        opts: CustomResourceOptions
      ) = this()
    }
  ...
  object v1beta1 extends js.Object {
    ...
    class TokenReview protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.authentication.v1beta1.TokenReview) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.authentication.v1beta1.TokenReview,
        opts: CustomResourceOptions
      ) = this()
    }
