...
class SecretList protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.SecretList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.SecretList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.SecretList,
...
object SecretList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.secretListMod.SecretList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.secretListMod.SecretList = js.native
  /**
