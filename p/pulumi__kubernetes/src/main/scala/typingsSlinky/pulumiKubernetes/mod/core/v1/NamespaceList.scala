...
class NamespaceList protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.NamespaceList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.NamespaceList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.NamespaceList,
...
object NamespaceList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.namespaceListMod.NamespaceList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.namespaceListMod.NamespaceList = js.native
  /**
