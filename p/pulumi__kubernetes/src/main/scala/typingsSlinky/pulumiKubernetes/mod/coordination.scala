...
object coordination extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class Lease protected ()
      ...
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.Lease) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.Lease,
    ...
    class LeaseList protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.LeaseList) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.LeaseList,
        opts: CustomResourceOptions
      ) = this()
    }
  ...
  object v1beta1 extends js.Object {
    ...
    class Lease protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.Lease) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.Lease,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    class LeaseList protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.LeaseList) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.LeaseList,
        opts: CustomResourceOptions
      ) = this()
    }
