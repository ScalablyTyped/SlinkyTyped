...
object auditregistration {
  ...
  object v1alpha1 {
    ...
    class AuditSink protected ()
      extends typingsSlinky.pulumiKubernetes.auditregistrationMod.v1alpha1.AuditSink {
      /**
    ...
    class AuditSinkList protected ()
      extends typingsSlinky.pulumiKubernetes.auditregistrationMod.v1alpha1.AuditSinkList {
      /**
