...
class ReplicaSet protected ()
  extends typingsSlinky.pulumiKubernetes.extensionsMod.v1beta1.ReplicaSet {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.ReplicaSet) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.ReplicaSet,
