...
object meta extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class Status protected ()
      extends typingsSlinky.pulumiKubernetes.metaMod.v1.Status {
      /**
      ...
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.meta.v1.Status) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.meta.v1.Status,
