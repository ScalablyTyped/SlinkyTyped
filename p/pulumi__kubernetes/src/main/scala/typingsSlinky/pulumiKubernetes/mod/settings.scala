...
object settings extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class PodPreset protected ()
      extends typingsSlinky.pulumiKubernetes.settingsMod.v1alpha1.PodPreset {
      /**
      ...
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.settings.v1alpha1.PodPreset) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.settings.v1alpha1.PodPreset,
    ...
    class PodPresetList protected ()
      extends typingsSlinky.pulumiKubernetes.settingsMod.v1alpha1.PodPresetList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.settings.v1alpha1.PodPresetList) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.inputMod.settings.v1alpha1.PodPresetList,
        opts: CustomResourceOptions
      ) = this()
    }
