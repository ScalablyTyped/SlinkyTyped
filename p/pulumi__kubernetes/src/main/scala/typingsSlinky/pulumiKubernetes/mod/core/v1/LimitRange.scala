...
class LimitRange protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.LimitRange {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRange) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRange,
...
object LimitRange extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.limitRangeMod.LimitRange = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.limitRangeMod.LimitRange = js.native
  /**
