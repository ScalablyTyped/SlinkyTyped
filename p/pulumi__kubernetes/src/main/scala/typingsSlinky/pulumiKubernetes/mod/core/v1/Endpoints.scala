...
class Endpoints protected ()
  extends typingsSlinky.pulumiKubernetes.coreMod.v1.Endpoints {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.Endpoints) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.Endpoints,
