...
class DaemonSet protected ()
  extends typingsSlinky.pulumiKubernetes.extensionsMod.v1beta1.DaemonSet {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet,
