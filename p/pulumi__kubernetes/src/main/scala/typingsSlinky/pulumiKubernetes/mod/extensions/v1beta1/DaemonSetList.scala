...
class DaemonSetList protected ()
  extends typingsSlinky.pulumiKubernetes.extensionsMod.v1beta1.DaemonSetList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSetList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSetList,
