package typingsSlinky.pulumiKubernetes.v1EventMod
...
import typingsSlinky.pulumiKubernetes.inputMod.events.v1.EventSeries
...
trait EventArgs extends js.Object {
  ...
  /**
    ...
    */
  val apiVersion: js.UndefOr[Input[eventsDotk8sDotioSlashv1]] = js.native
...
object EventArgs {
  ...
  implicit class EventArgsOps[Self <: EventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Event]): Self = this.set("kind", value.asInstanceOf[js.Any])
