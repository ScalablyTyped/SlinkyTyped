package typingsSlinky.pulumiKubernetes.priorityLevelConfigurationMod

import typingsSlinky.pulumiKubernetes.inputMod.flowcontrol.v1alpha1.PriorityLevelConfigurationSpec
