...
import typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINode
...
@js.native
trait CSINodeListArgs extends js.Object {
  /**
  ...
  /**
    ...
    */
  val items: Input[js.Array[Input[CSINode]]] = js.native
  /**
...
object CSINodeListArgs {
  @scala.inline
  def apply(items: Input[js.Array[Input[CSINode]]]): CSINodeListArgs = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[CSINodeListArgs]
  }
  @scala.inline
  implicit class CSINodeListArgsOps[Self <: CSINodeListArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Input[CSINode]*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: Input[js.Array[Input[CSINode]]]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
