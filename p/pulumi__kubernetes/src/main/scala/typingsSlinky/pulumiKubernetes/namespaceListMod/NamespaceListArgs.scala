package typingsSlinky.pulumiKubernetes.namespaceListMod

import typingsSlinky.pulumiKubernetes.inputMod.core.v1.Namespace
...
object NamespaceListArgs {
  ...
  implicit class NamespaceListArgsOps[Self <: NamespaceListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NamespaceList]): Self = this.set("kind", value.asInstanceOf[js.Any])
