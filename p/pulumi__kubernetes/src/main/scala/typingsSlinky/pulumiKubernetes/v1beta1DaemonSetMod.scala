...
object v1beta1DaemonSetMod {
  ...
  trait DaemonSetArgs extends StObject {
    ...
    /**
      * The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSetSpec]] = js.native
  }
  object DaemonSetArgs {
    ...
    implicit class DaemonSetArgsMutableBuilder[Self <: DaemonSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
