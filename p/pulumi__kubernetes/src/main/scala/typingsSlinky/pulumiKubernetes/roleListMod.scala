...
object roleListMod extends js.Object {
  ...
  class RoleList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleList,
