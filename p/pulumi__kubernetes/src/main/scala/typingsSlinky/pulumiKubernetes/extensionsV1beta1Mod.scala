...
object extensionsV1beta1Mod {
  ...
  class DaemonSet protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1DaemonSetMod.DaemonSet {
    /**
  ...
  class Deployment protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1DeploymentMod.Deployment {
    /**
  ...
  class DeploymentList protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1DeploymentListMod.DeploymentList {
    /**
  ...
  class Ingress protected ()
    extends typingsSlinky.pulumiKubernetes.ingressMod.Ingress {
    /**
