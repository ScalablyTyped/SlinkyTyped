...
import typingsSlinky.pulumiKubernetes.outputMod.node.v1beta1.RuntimeClass
...
object v1beta1RuntimeClassListMod {
  ...
  object RuntimeClassList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/node/v1beta1/runtimeClassList", "RuntimeClassList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/node/v1beta1/runtimeClassList", "RuntimeClassList.isInstance")
    @js.native
  ...
  trait RuntimeClassListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass]]
      ] = js.native
  ...
  object RuntimeClassListArgs {
    ...
    implicit class RuntimeClassListArgsMutableBuilder[Self <: RuntimeClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
