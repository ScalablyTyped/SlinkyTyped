...
@js.native
object v1beta1RuntimeClassListMod extends js.Object {
  @js.native
  class RuntimeClassList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClassList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClassList,
