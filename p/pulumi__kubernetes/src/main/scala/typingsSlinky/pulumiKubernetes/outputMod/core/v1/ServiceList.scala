...
trait ServiceList extends js.Object {
  ...
  /**
    * List of services
    */
  val items: js.Array[Service] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceList = js.native
  /**
...
object ServiceList {
  ...
  implicit class ServiceListOps[Self <: ServiceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[Service]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceList): Self = {
        val ret = this.duplicate
