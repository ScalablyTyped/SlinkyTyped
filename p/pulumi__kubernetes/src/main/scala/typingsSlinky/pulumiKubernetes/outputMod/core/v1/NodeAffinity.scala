...
trait NodeAffinity extends js.Object {
  /**
    ...
    */
  val preferredDuringSchedulingIgnoredDuringExecution: js.Array[PreferredSchedulingTerm] = js.native
  /**
    ...
    */
  val requiredDuringSchedulingIgnoredDuringExecution: NodeSelector = js.native
}
...
object NodeAffinity {
  ...
  implicit class NodeAffinityOps[Self <: NodeAffinity] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPreferredDuringSchedulingIgnoredDuringExecution(value: js.Array[PreferredSchedulingTerm]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preferredDuringSchedulingIgnoredDuringExecution")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRequiredDuringSchedulingIgnoredDuringExecution(value: NodeSelector): Self = {
        val ret = this.duplicate
