...
trait Service extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service = js.native
  /**
...
object Service {
  ...
  implicit class ServiceOps[Self <: Service] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: ServiceSpec): Self = {
        val ret = this.duplicate
