...
trait CSIDriverList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[CSIDriver] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList = js.native
  /**
...
object CSIDriverList {
  ...
  @scala.inline
  implicit class CSIDriverListOps[Self <: CSIDriverList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[CSIDriver]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList): Self = {
        val ret = this.duplicate
