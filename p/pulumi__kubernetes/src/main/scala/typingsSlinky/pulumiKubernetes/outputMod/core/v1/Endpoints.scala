...
trait Endpoints extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Endpoints = js.native
...
object Endpoints {
  ...
  implicit class EndpointsMutableBuilder[Self <: Endpoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Endpoints): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
