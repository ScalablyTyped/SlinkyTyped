...
trait EndpointSliceList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[EndpointSlice] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList = js.native
  /**
...
object EndpointSliceList {
  ...
  implicit class EndpointSliceListOps[Self <: EndpointSliceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[EndpointSlice]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList): Self = {
        val ret = this.duplicate
