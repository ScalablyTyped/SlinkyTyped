...
trait EndpointSliceList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList
  /**
...
object EndpointSliceList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList,
    metadata: ListMeta
  ): EndpointSliceList = {
