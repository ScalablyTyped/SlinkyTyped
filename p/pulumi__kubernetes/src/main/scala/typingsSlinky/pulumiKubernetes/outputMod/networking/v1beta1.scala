package typingsSlinky.pulumiKubernetes.outputMod.networking

import typingsSlinky.pulumiKubernetes.outputMod.core.v1.LoadBalancerStatus
...
object v1beta1 {
  ...
  object Ingress {
    ...
    implicit class IngressMutableBuilder[Self <: Ingress] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Ingress): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
