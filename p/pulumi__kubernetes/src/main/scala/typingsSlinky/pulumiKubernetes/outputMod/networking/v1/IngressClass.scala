...
trait IngressClass extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass = js.native
...
object IngressClass {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass,
    metadata: ObjectMeta,
  ...
  implicit class IngressClassMutableBuilder[Self <: IngressClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
