  ...
  object v1alpha1 {
    ...
    trait RuntimeClass extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass = js.native
    ...
    object RuntimeClass {
      ...
      implicit class RuntimeClassMutableBuilder[Self <: RuntimeClass] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
