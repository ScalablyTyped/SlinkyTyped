...
trait PodTemplateList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[PodTemplate] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList = js.native
  /**
...
object PodTemplateList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList,
    metadata: ListMeta
  ): PodTemplateList = {
  ...
  implicit class PodTemplateListOps[Self <: PodTemplateList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[PodTemplate]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList): Self = {
        val ret = this.duplicate
