...
object CSIDriverSpec {
  ...
  implicit class CSIDriverSpecOps[Self <: CSIDriverSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttachRequired(value: Boolean): Self = this.set("attachRequired", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFsGroupPolicy(value: String): Self = this.set("fsGroupPolicy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPodInfoOnMount(value: Boolean): Self = this.set("podInfoOnMount", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStorageCapacity(value: Boolean): Self = this.set("storageCapacity", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVolumeLifecycleModesVarargs(value: String*): Self = this.set("volumeLifecycleModes", js.Array(value :_*))
    
    @scala.inline
    def setVolumeLifecycleModes(value: js.Array[String]): Self = this.set("volumeLifecycleModes", value.asInstanceOf[js.Any])
  }
}
