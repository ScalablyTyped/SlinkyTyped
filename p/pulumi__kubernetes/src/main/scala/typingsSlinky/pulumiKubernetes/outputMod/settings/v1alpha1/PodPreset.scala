...
trait PodPreset extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodPreset = js.native
  val metadata: ObjectMeta = js.native
  val spec: PodPresetSpec = js.native
}
...
object PodPreset {
  ...
  implicit class PodPresetOps[Self <: PodPreset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodPreset): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: PodPresetSpec): Self = {
        val ret = this.duplicate
