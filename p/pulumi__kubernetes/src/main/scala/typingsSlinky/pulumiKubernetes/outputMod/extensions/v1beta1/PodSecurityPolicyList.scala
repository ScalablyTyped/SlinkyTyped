...
trait PodSecurityPolicyList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[PodSecurityPolicy] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList = js.native
  /**
...
object PodSecurityPolicyList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList,
    metadata: ListMeta
  ...
  @scala.inline
  implicit class PodSecurityPolicyListOps[Self <: PodSecurityPolicyList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[PodSecurityPolicy]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList): Self = {
        val ret = this.duplicate
