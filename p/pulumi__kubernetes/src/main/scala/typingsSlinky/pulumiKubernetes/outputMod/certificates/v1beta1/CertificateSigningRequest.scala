...
trait CertificateSigningRequest extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest = js.native
  val metadata: ObjectMeta = js.native
  /**
    * The certificate request itself and any additional information.
    */
  val spec: CertificateSigningRequestSpec = js.native
  /**
    * Derived information about the request.
    */
  val status: CertificateSigningRequestStatus = js.native
}
...
object CertificateSigningRequest {
  ...
  implicit class CertificateSigningRequestOps[Self <: CertificateSigningRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: CertificateSigningRequestSpec): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spec")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStatus(value: CertificateSigningRequestStatus): Self = {
        val ret = this.duplicate
