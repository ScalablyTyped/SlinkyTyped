  ...
  object v1beta1 {
    ...
    trait EndpointSlice extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSlice = js.native
    ...
    object EndpointSlice {
      ...
      implicit class EndpointSliceMutableBuilder[Self <: EndpointSlice] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSlice): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
