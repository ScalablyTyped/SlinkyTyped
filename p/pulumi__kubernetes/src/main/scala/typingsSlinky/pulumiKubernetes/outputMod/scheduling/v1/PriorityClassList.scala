...
trait PriorityClassList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[PriorityClass] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList = js.native
  /**
...
object PriorityClassList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList,
    metadata: ListMeta
  ): PriorityClassList = {
  ...
  implicit class PriorityClassListOps[Self <: PriorityClassList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[PriorityClass]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList): Self = {
        val ret = this.duplicate
