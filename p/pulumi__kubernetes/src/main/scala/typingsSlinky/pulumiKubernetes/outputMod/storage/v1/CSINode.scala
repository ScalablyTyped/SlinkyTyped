...
trait CSINode extends js.Object {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINode = js.native
...
object CSINode {
  ...
  implicit class CSINodeOps[Self <: CSINode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINode): Self = this.set("kind", value.asInstanceOf[js.Any])
