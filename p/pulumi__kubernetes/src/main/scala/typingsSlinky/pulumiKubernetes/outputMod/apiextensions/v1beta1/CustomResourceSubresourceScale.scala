...
trait CustomResourceSubresourceScale extends js.Object {
  /**
    ...
    */
  val labelSelectorPath: String = js.native
  /**
    ...
    */
  val specReplicasPath: String = js.native
  /**
    ...
    */
  val statusReplicasPath: String = js.native
}
