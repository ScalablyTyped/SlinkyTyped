...
trait ScopeSelector extends js.Object {
  /**
    ...
    */
  val matchExpressions: js.Array[ScopedResourceSelectorRequirement] = js.native
}
...
object ScopeSelector {
  ...
  implicit class ScopeSelectorOps[Self <: ScopeSelector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMatchExpressions(value: js.Array[ScopedResourceSelectorRequirement]): Self = {
