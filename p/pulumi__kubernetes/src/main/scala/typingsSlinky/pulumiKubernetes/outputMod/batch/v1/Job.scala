...
trait Job extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job = js.native
  /**
  ...
  /**
    ...
    * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  val status: JobStatus = js.native
}
...
object Job {
  ...
  implicit class JobOps[Self <: Job] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job): Self = {
        val ret = this.duplicate
