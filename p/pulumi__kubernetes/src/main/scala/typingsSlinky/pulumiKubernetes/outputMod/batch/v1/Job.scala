...
object Job {
  ...
  implicit class JobOps[Self <: Job] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: batchSlashv1): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
