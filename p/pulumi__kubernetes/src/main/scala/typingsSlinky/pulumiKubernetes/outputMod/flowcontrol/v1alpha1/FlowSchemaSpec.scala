...
trait FlowSchemaSpec extends js.Object {
  /**
    ...
    * empty string.
    */
  val distinguisherMethod: FlowDistinguisherMethod = js.native
  /**
    ...
    */
  val matchingPrecedence: Double = js.native
  /**
    ...
    */
  val priorityLevelConfiguration: PriorityLevelConfigurationReference = js.native
  /**
    ...
    */
  val rules: js.Array[PolicyRulesWithSubjects] = js.native
}
