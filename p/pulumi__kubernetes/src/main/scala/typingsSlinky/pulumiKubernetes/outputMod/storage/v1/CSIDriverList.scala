...
trait CSIDriverList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList
  /**
...
object CSIDriverList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList,
    metadata: ListMeta
  ): CSIDriverList = {
