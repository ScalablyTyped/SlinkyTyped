...
trait StatefulSetList extends js.Object {
  ...
  val items: js.Array[StatefulSet] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList = js.native
...
object StatefulSetList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList,
    metadata: ListMeta
  ): StatefulSetList = {
  ...
  implicit class StatefulSetListOps[Self <: StatefulSetList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[StatefulSet]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList): Self = {
        val ret = this.duplicate
