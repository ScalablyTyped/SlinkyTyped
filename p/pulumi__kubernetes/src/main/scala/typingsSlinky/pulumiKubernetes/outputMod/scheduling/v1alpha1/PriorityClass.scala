package typingsSlinky.pulumiKubernetes.outputMod.scheduling.v1alpha1
...
trait PriorityClass extends js.Object {
  /**
    ...
    */
  val apiVersion: schedulingDotk8sDotioSlashv1alpha1 = js.native
  /**
...
object PriorityClass {
  ...
  implicit class PriorityClassOps[Self <: PriorityClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: schedulingDotk8sDotioSlashv1alpha1): Self = {
