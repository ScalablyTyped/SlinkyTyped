  ...
  object v1 {
    ...
    trait CertificateSigningRequest extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest = js.native
    ...
    object CertificateSigningRequest {
      ...
      def apply(
        ...
        kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest,
        metadata: ObjectMeta,
      ...
      implicit class CertificateSigningRequestMutableBuilder[Self <: CertificateSigningRequest] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
