...
trait FlowSchema extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema = js.native
...
object FlowSchema {
  ...
  implicit class FlowSchemaMutableBuilder[Self <: FlowSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
