...
trait ResourceQuota extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota = js.native
  /**
  ...
  /**
    ...
    */
  val spec: ResourceQuotaSpec = js.native
  /**
    * Status defines the actual enforced quota and its current usage.
    * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  val status: ResourceQuotaStatus = js.native
}
...
object ResourceQuota {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota,
    metadata: ObjectMeta,
  ...
  implicit class ResourceQuotaOps[Self <: ResourceQuota] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: ResourceQuotaSpec): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spec")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStatus(value: ResourceQuotaStatus): Self = {
        val ret = this.duplicate
