...
trait HorizontalPodAutoscalerList extends js.Object {
  /**
    ...
    */
  val apiVersion: autoscalingSlashv2beta1 = js.native
  /**
...
object HorizontalPodAutoscalerList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.HorizontalPodAutoscalerList,
    metadata: ListMeta
  ...
  implicit class HorizontalPodAutoscalerListOps[Self <: HorizontalPodAutoscalerList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: autoscalingSlashv2beta1): Self = {
