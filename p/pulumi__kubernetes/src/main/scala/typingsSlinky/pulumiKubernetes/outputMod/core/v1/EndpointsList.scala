...
trait EndpointsList extends js.Object {
  ...
  /**
    * List of endpoints.
    */
  val items: js.Array[Endpoints] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList = js.native
  /**
...
object EndpointsList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList,
    metadata: ListMeta
  ): EndpointsList = {
  ...
  implicit class EndpointsListOps[Self <: EndpointsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[Endpoints]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList): Self = {
        val ret = this.duplicate
