...
trait ComponentStatus extends js.Object {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatus = js.native
  /**
...
object ComponentStatus {
  ...
  implicit class ComponentStatusOps[Self <: ComponentStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatus): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
