...
trait ReplicaSet extends js.Object {
  /**
    ...
    */
  val apiVersion: appsSlashv1 = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet = js.native
  /**
  ...
  /**
    ...
    */
  val spec: ReplicaSetSpec = js.native
  /**
    ...
    * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  val status: ReplicaSetStatus = js.native
}
...
object ReplicaSet {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet,
    metadata: ObjectMeta,
    spec: ReplicaSetSpec,
  ...
  implicit class ReplicaSetOps[Self <: ReplicaSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: appsSlashv1): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("apiVersion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: ReplicaSetSpec): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spec")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStatus(value: ReplicaSetStatus): Self = {
        val ret = this.duplicate
