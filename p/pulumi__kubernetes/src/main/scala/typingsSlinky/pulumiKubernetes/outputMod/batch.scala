  ...
  object v1 {
    ...
    trait Job extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job = js.native
    ...
    object Job {
      ...
      def apply(
        ...
        kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job,
        metadata: ObjectMeta,
        spec: JobSpec,
        status: JobStatus
      ): Job = {
      ...
      implicit class JobMutableBuilder[Self <: Job] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
  ...
  object v1beta1 {
    ...
    trait CronJob extends StObject {
      ...
      /**
        * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        */
      var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJob = js.native
    ...
    object CronJob {
      ...
      implicit class CronJobMutableBuilder[Self <: CronJob] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJob): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
