...
trait ConfigMap extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMap = js.native
...
object ConfigMap {
  ...
  implicit class ConfigMapMutableBuilder[Self <: ConfigMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBinaryData(value: StringDictionary[String]): Self = StObject.set(x, "binaryData", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMap): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
