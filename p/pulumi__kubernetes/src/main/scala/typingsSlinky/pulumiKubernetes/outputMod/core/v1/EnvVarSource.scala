...
trait EnvVarSource extends js.Object {
  /**
    ...
    */
  val configMapKeyRef: ConfigMapKeySelector = js.native
  /**
  ...
  /**
    ...
    */
  val secretKeyRef: SecretKeySelector = js.native
}
...
object EnvVarSource {
  ...
  implicit class EnvVarSourceOps[Self <: EnvVarSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigMapKeyRef(value: ConfigMapKeySelector): Self = {
    ...
    @scala.inline
    def withSecretKeyRef(value: SecretKeySelector): Self = {
        val ret = this.duplicate
