...
trait LimitRange extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRange = js.native
  /**
  ...
  /**
    ...
    */
  val spec: LimitRangeSpec = js.native
}
...
object LimitRange {
  ...
  implicit class LimitRangeOps[Self <: LimitRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRange): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: LimitRangeSpec): Self = {
        val ret = this.duplicate
