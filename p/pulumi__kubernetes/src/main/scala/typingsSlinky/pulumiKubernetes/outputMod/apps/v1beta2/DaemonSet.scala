...
trait DaemonSet extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSet = js.native
...
object DaemonSet {
  ...
  implicit class DaemonSetMutableBuilder[Self <: DaemonSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSet): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
