...
trait Node extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Node = js.native
  /**
  ...
  /**
    ...
    * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  val status: NodeStatus = js.native
}
...
object Node {
  ...
  implicit class NodeOps[Self <: Node] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Node): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: NodeSpec): Self = {
        val ret = this.duplicate
