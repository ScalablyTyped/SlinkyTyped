...
trait ResourcePolicyRule extends js.Object {
  ...
  /**
    ...
    * non-empty list.
    */
  val clusterScope: Boolean = js.native
  /**
...
object ResourcePolicyRule {
  ...
  implicit class ResourcePolicyRuleOps[Self <: ResourcePolicyRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClusterScope(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clusterScope")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
