...
trait ClusterRoleList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[ClusterRole] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleList = js.native
  /**
...
object ClusterRoleList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleList,
    metadata: ListMeta
  ): ClusterRoleList = {
  ...
  implicit class ClusterRoleListOps[Self <: ClusterRoleList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[ClusterRole]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleList): Self = {
        val ret = this.duplicate
