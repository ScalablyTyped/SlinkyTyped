...
trait NetworkPolicy extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy = js.native
  /**
  ...
  /**
    ...
    */
  val spec: NetworkPolicySpec = js.native
}
...
object NetworkPolicy {
  ...
  implicit class NetworkPolicyOps[Self <: NetworkPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: NetworkPolicySpec): Self = {
        val ret = this.duplicate
