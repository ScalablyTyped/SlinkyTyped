...
trait TopologySelectorTerm extends js.Object {
  /**
    ...
    */
  val matchLabelExpressions: js.Array[TopologySelectorLabelRequirement] = js.native
}
...
object TopologySelectorTerm {
  ...
  implicit class TopologySelectorTermOps[Self <: TopologySelectorTerm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMatchLabelExpressions(value: js.Array[TopologySelectorLabelRequirement]): Self = {
