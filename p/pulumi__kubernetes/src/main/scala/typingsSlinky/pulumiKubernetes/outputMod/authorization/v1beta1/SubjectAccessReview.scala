...
trait SubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview = js.native
...
object SubjectAccessReview {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview,
    metadata: ObjectMeta,
  ...
  implicit class SubjectAccessReviewOps[Self <: SubjectAccessReview] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview): Self = {
        val ret = this.duplicate
