...
trait PriorityLevelConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[PriorityLevelConfiguration] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfigurationList = js.native
  /**
...
object PriorityLevelConfigurationList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfigurationList,
    metadata: ListMeta
  ...
  implicit class PriorityLevelConfigurationListOps[Self <: PriorityLevelConfigurationList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[PriorityLevelConfiguration]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfigurationList): Self = {
        val ret = this.duplicate
