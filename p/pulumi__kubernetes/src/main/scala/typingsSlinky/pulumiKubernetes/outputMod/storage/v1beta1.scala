package typingsSlinky.pulumiKubernetes.outputMod.storage
...
object v1beta1 {
  ...
  object CSIDriver {
    ...
    implicit class CSIDriverMutableBuilder[Self <: CSIDriver] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
  ...
  object CSINode {
    ...
    implicit class CSINodeMutableBuilder[Self <: CSINode] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINode): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
  ...
  trait StorageClass extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClass = js.native
  ...
  object StorageClass {
    ...
    implicit class StorageClassMutableBuilder[Self <: StorageClass] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClass): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
  ...
  object VolumeAttachment {
    ...
    implicit class VolumeAttachmentMutableBuilder[Self <: VolumeAttachment] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachment): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
