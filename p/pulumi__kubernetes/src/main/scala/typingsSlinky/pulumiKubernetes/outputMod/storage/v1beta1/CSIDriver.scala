...
trait CSIDriver extends js.Object {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver = js.native
...
object CSIDriver {
  ...
  implicit class CSIDriverOps[Self <: CSIDriver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver): Self = this.set("kind", value.asInstanceOf[js.Any])
