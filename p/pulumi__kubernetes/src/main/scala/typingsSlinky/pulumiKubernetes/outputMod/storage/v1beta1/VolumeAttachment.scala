...
trait VolumeAttachment extends js.Object {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachment = js.native
...
object VolumeAttachment {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachment,
    metadata: ObjectMeta,
  ...
  implicit class VolumeAttachmentOps[Self <: VolumeAttachment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachment): Self = this.set("kind", value.asInstanceOf[js.Any])
