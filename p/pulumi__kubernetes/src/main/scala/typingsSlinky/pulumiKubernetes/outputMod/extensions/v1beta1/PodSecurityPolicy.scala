...
trait PodSecurityPolicy extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy = js.native
...
object PodSecurityPolicy {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy,
    metadata: ObjectMeta,
  ...
  implicit class PodSecurityPolicyMutableBuilder[Self <: PodSecurityPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
