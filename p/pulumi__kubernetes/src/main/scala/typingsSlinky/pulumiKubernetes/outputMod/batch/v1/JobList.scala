...
trait JobList extends js.Object {
  /**
    ...
    */
  val apiVersion: batchSlashv1 = js.native
  /**
    * items is the list of Jobs.
    */
  val items: js.Array[Job] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.JobList = js.native
  /**
...
object JobList {
  ...
  implicit class JobListOps[Self <: JobList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: batchSlashv1): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("apiVersion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withItems(value: js.Array[Job]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.JobList): Self = {
        val ret = this.duplicate
