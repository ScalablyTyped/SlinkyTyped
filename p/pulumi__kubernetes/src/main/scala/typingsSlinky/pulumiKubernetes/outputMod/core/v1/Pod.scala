...
trait Pod extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Pod = js.native
  /**
  ...
  /**
    ...
    * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  val status: PodStatus = js.native
}
...
object Pod {
  ...
  implicit class PodOps[Self <: Pod] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Pod): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStatus(value: PodStatus): Self = {
        val ret = this.duplicate
