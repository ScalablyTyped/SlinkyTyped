...
trait ValidatingWebhookConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[ValidatingWebhookConfiguration] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfigurationList = js.native
  /**
...
object ValidatingWebhookConfigurationList {
  ...
  implicit class ValidatingWebhookConfigurationListOps[Self <: ValidatingWebhookConfigurationList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[ValidatingWebhookConfiguration]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfigurationList): Self = {
        val ret = this.duplicate
