...
trait ValidatingWebhookConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfigurationList
  /**
...
object ValidatingWebhookConfigurationList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfigurationList,
    metadata: ListMeta
