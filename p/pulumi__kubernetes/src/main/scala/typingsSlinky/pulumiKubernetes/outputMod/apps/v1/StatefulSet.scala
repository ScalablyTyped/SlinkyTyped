...
trait StatefulSet extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSet = js.native
  val metadata: ObjectMeta = js.native
  /**
    * Spec defines the desired identities of pods in this set.
    */
  val spec: StatefulSetSpec = js.native
  /**
    * Status is the current status of Pods in this StatefulSet. This data may be out of date by
    * some window of time.
    */
  val status: StatefulSetStatus = js.native
}
...
object StatefulSet {
  ...
  implicit class StatefulSetOps[Self <: StatefulSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSet): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: StatefulSetSpec): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spec")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStatus(value: StatefulSetStatus): Self = {
        val ret = this.duplicate
