...
trait PodTemplate extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate = js.native
  /**
...
object PodTemplate {
  ...
  implicit class PodTemplateOps[Self <: PodTemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate): Self = {
        val ret = this.duplicate
