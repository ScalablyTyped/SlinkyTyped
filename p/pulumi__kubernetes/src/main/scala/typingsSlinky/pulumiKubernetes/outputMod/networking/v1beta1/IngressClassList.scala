...
trait IngressClassList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList
  /**
...
object IngressClassList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList,
    metadata: ListMeta
  ): IngressClassList = {
