...
trait LimitRangeList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[LimitRange] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList = js.native
  /**
...
object LimitRangeList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList,
    metadata: ListMeta
  ): LimitRangeList = {
  ...
  implicit class LimitRangeListOps[Self <: LimitRangeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[LimitRange]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList): Self = {
        val ret = this.duplicate
