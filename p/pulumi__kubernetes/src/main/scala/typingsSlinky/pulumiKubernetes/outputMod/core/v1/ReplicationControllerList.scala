...
trait ReplicationControllerList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[ReplicationController] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList = js.native
  /**
...
object ReplicationControllerList {
  ...
  implicit class ReplicationControllerListOps[Self <: ReplicationControllerList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[ReplicationController]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList): Self = {
        val ret = this.duplicate
