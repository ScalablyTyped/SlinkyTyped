...
trait ReplicationControllerList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList
  /**
...
object ReplicationControllerList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList,
    metadata: ListMeta
