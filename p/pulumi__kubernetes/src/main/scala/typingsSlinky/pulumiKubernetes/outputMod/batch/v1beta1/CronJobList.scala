...
trait CronJobList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[CronJob] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJobList = js.native
  /**
...
object CronJobList {
  ...
  implicit class CronJobListOps[Self <: CronJobList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[CronJob]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJobList): Self = {
        val ret = this.duplicate
