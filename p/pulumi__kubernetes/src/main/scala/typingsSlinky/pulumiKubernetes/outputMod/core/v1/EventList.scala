...
trait EventList extends js.Object {
  ...
  /**
    * List of events
    */
  val items: js.Array[Event] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EventList = js.native
  /**
...
object EventList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EventList,
    metadata: ListMeta
  ): EventList = {
  ...
  implicit class EventListOps[Self <: EventList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EventList): Self = {
        val ret = this.duplicate
