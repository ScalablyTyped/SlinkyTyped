...
trait ServiceAccountList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[ServiceAccount] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccountList = js.native
  /**
...
object ServiceAccountList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccountList,
    metadata: ListMeta
  ): ServiceAccountList = {
  ...
  @scala.inline
  implicit class ServiceAccountListOps[Self <: ServiceAccountList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[ServiceAccount]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccountList): Self = {
        val ret = this.duplicate
