...
trait ConfigMapList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[ConfigMap] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList = js.native
  /**
    * More info:
...
object ConfigMapList {
  ...
  @scala.inline
  implicit class ConfigMapListOps[Self <: ConfigMapList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[ConfigMap]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList): Self = {
        val ret = this.duplicate
