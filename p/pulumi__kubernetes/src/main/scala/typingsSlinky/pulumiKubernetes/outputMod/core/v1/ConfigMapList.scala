...
trait ConfigMapList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList
  /**
    * More info:
...
object ConfigMapList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList,
    metadata: ListMeta
  ): ConfigMapList = {
