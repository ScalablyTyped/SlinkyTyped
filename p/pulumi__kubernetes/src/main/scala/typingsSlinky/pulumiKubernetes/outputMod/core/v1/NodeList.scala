...
trait NodeList extends js.Object {
  ...
  /**
    * List of nodes
    */
  val items: js.Array[Node] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NodeList = js.native
  /**
...
object NodeList {
  ...
  implicit class NodeListOps[Self <: NodeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[Node]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NodeList): Self = {
        val ret = this.duplicate
