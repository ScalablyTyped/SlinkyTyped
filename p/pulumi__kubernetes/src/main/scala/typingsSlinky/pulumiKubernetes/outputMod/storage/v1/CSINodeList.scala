...
trait CSINodeList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[CSINode] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList = js.native
  /**
...
object CSINodeList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList,
    metadata: ListMeta
  ): CSINodeList = {
  ...
  implicit class CSINodeListOps[Self <: CSINodeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[CSINode]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList): Self = {
        val ret = this.duplicate
