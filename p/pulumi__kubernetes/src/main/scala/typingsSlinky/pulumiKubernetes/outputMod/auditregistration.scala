  ...
  object v1alpha1 {
    ...
    trait AuditSink extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSink = js.native
    ...
    object AuditSink {
      ...
      implicit class AuditSinkMutableBuilder[Self <: AuditSink] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSink): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
