...
trait ComponentStatusList extends js.Object {
  ...
  /**
    ...
    */
  val items: js.Array[ComponentStatus] = js.native
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList = js.native
  /**
...
object ComponentStatusList {
  ...
  implicit class ComponentStatusListOps[Self <: ComponentStatusList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: js.Array[ComponentStatus]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList): Self = {
        val ret = this.duplicate
