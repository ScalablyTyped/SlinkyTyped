...
trait ComponentStatusList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList
  /**
...
object ComponentStatusList {
  ...
  def apply(
    ...
    kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList,
    metadata: ListMeta
  ): ComponentStatusList = {
