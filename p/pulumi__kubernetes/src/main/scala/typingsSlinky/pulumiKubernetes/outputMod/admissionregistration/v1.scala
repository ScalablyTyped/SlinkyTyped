package typingsSlinky.pulumiKubernetes.outputMod.admissionregistration
...
object v1 {
  ...
  object MutatingWebhookConfiguration {
    ...
    implicit class MutatingWebhookConfigurationMutableBuilder[Self <: MutatingWebhookConfiguration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfiguration): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
  ...
  trait ValidatingWebhookConfiguration extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfiguration = js.native
  ...
  object ValidatingWebhookConfiguration {
    ...
    implicit class ValidatingWebhookConfigurationMutableBuilder[Self <: ValidatingWebhookConfiguration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfiguration): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
