...
trait Binding extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding = js.native
  /**
  ...
  /**
    ...
    */
  val target: ObjectReference = js.native
}
...
object Binding {
  ...
  implicit class BindingOps[Self <: Binding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTarget(value: ObjectReference): Self = {
        val ret = this.duplicate
