...
object v1ClusterRoleMod {
  ...
  trait ClusterRoleArgs extends StObject {
    ...
    /**
      * AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.
      */
    val aggregationRule: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.AggregationRule]] = js.native
    ...
    val rules: js.UndefOr[
        Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.PolicyRule]]]
      ] = js.native
  }
  object ClusterRoleArgs {
    ...
    implicit class ClusterRoleArgsMutableBuilder[Self <: ClusterRoleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAggregationRule(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.AggregationRule]): Self = StObject.set(x, "aggregationRule", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRules(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.PolicyRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      @scala.inline
      def setRulesVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.PolicyRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
    }
  }
}
