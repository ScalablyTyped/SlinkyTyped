package typingsSlinky.pulumiKubernetes.tokenReviewMod

import typingsSlinky.pulumiKubernetes.inputMod.authentication.v1beta1.TokenReviewSpec
...
object TokenReviewArgs {
  ...
  implicit class TokenReviewArgsOps[Self <: TokenReviewArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: Input[authenticationDotk8sDotioSlashv1beta1]): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
