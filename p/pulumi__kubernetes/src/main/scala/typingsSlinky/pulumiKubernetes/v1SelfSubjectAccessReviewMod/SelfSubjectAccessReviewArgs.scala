package typingsSlinky.pulumiKubernetes.v1SelfSubjectAccessReviewMod

import typingsSlinky.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectAccessReviewSpec
...
object SelfSubjectAccessReviewArgs {
  ...
  implicit class SelfSubjectAccessReviewArgsOps[Self <: SelfSubjectAccessReviewArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectAccessReview]): Self = this.set("kind", value.asInstanceOf[js.Any])
