package typingsSlinky.pulumiKubernetes.v1beta2ControllerRevisionMod
...
trait ControllerRevisionArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevision]] = js.native
...
object ControllerRevisionArgs {
  ...
  implicit class ControllerRevisionArgsOps[Self <: ControllerRevisionArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevision]): Self = this.set("kind", value.asInstanceOf[js.Any])
