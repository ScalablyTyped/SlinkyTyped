...
import typingsSlinky.pulumiKubernetes.outputMod.networking.v1.IngressSpec
import typingsSlinky.pulumiKubernetes.outputMod.networking.v1.IngressStatus
...
object v1IngressMod {
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Ingress]] = js.native
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.IngressSpec]] = js.native
  }
  object IngressArgs {
    ...
    implicit class IngressArgsMutableBuilder[Self <: IngressArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.IngressSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
