...
@JSImport("@pulumi/kubernetes/core/v1/endpointsList", "EndpointsList")
@js.native
class EndpointsList protected () extends CustomResource {
  /**
  ...
  /**
    * List of endpoints.
    */
  val items: Output_[js.Array[Endpoints]] = js.native
  
  /**
    * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    */
  val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList] = js.native
...
object EndpointsList extends js.Object {
  ...
  /**
    ...
    */
  def get(name: String, id: Input[ID]): EndpointsList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): EndpointsList = js.native
