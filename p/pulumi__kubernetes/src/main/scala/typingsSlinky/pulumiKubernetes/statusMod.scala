...
object statusMod {
  ...
  class Status protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Status] = js.native
  ...
  trait StatusArgs extends StObject {
    ...
    /**
      * Extended data associated with the reason.  Each reason may define its own extended details. This field is optional and the data returned is not guaranteed to conform to any schema except that defined by the reason type.
      */
    val details: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.meta.v1.StatusDetails]] = js.native
  ...
  object StatusArgs {
    ...
    implicit class StatusArgsMutableBuilder[Self <: StatusArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDetails(value: Input[typingsSlinky.pulumiKubernetes.inputMod.meta.v1.StatusDetails]): Self = StObject.set(x, "details", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDetailsUndefined: Self = StObject.set(x, "details", js.undefined)
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Status]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
