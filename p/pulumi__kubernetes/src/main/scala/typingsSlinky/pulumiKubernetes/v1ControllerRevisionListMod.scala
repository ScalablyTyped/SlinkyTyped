...
object v1ControllerRevisionListMod {
  ...
  trait ControllerRevisionListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.ControllerRevision]]
      ] = js.native
  ...
  object ControllerRevisionListArgs {
    ...
    implicit class ControllerRevisionListArgsMutableBuilder[Self <: ControllerRevisionListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.ControllerRevision]*): Self = StObject.set(x, "items", js.Array(value :_*))
