...
object v1LeaseListMod {
  ...
  trait LeaseListArgs extends StObject {
    ...
    /**
      * Items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.Lease]]] = js.native
  ...
  object LeaseListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.Lease]]]): LeaseListArgs = {
    ...
    implicit class LeaseListArgsMutableBuilder[Self <: LeaseListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.Lease]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.Lease]*): Self = StObject.set(x, "items", js.Array(value :_*))
