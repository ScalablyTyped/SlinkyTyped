...
object storageClassListMod {
  ...
  trait StorageClassListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.StorageClass]]
      ] = js.native
  ...
  object StorageClassListArgs {
    ...
    implicit class StorageClassListArgsMutableBuilder[Self <: StorageClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.StorageClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
