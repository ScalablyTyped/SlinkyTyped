...
object replicationControllerListMod {
  ...
  class ReplicationControllerList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val items: Output_[js.Array[ReplicationController]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList] = js.native
  ...
  object ReplicationControllerList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/replicationControllerList", "ReplicationControllerList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/replicationControllerList", "ReplicationControllerList.isInstance")
    @js.native
  ...
  @js.native
  trait ReplicationControllerListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ReplicationController]]
      ] = js.native
  ...
  object ReplicationControllerListArgs {
    ...
    @scala.inline
    implicit class ReplicationControllerListArgsMutableBuilder[Self <: ReplicationControllerListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ReplicationController]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
