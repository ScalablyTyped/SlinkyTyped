...
object v1NetworkPolicyMod extends js.Object {
  ...
  class NetworkPolicy protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy,
