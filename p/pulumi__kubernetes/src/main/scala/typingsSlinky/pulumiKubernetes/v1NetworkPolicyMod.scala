...
import typingsSlinky.pulumiKubernetes.outputMod.networking.v1.NetworkPolicySpec
...
object v1NetworkPolicyMod {
  ...
  class NetworkPolicy protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy] = js.native
  ...
  trait NetworkPolicyArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy]] = js.native
    ...
    /**
      * Specification of the desired behavior for this NetworkPolicy.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.NetworkPolicySpec]] = js.native
  }
  object NetworkPolicyArgs {
    ...
    implicit class NetworkPolicyArgsMutableBuilder[Self <: NetworkPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.NetworkPolicySpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
