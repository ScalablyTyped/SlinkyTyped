...
object v1beta1ClusterRoleMod {
  ...
  object ClusterRole {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRole", "ClusterRole.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRole", "ClusterRole.isInstance")
    @js.native
  ...
  trait ClusterRoleArgs extends StObject {
    ...
    /**
      * AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.
      */
    val aggregationRule: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.AggregationRule]] = js.native
  ...
  object ClusterRoleArgs {
    ...
    implicit class ClusterRoleArgsMutableBuilder[Self <: ClusterRoleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAggregationRule(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1beta1.AggregationRule]): Self = StObject.set(x, "aggregationRule", value.asInstanceOf[js.Any])
