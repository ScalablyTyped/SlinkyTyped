package typingsSlinky.pulumiKubernetes.persistentVolumeClaimMod

import typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaimSpec
...
@js.native
trait PersistentVolumeClaimArgs extends js.Object {
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[PersistentVolumeClaimSpec]] = js.native
}
object PersistentVolumeClaimArgs {
  ...
  @scala.inline
  implicit class PersistentVolumeClaimArgsOps[Self <: PersistentVolumeClaimArgs] (val x: Self) extends AnyVal {
