...
object networkPolicyMod {
  ...
  trait NetworkPolicyArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicySpec]
      ] = js.native
  }
  object NetworkPolicyArgs {
    ...
    implicit class NetworkPolicyArgsMutableBuilder[Self <: NetworkPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicySpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
