package typingsSlinky.pulumiKubernetes.v1beta1IngressListMod

import typingsSlinky.pulumiKubernetes.outputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.outputMod.networking.v1beta1.Ingress
...
@JSImport("@pulumi/kubernetes/networking/v1beta1/ingressList", "IngressList")
@js.native
