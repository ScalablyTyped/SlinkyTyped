...
object v1SubjectAccessReviewMod {
  ...
  object SubjectAccessReview {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/authorization/v1/subjectAccessReview", "SubjectAccessReview.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/authorization/v1/subjectAccessReview", "SubjectAccessReview.isInstance")
    @js.native
  ...
  trait SubjectAccessReviewArgs extends StObject {
    ...
    /**
      * Spec holds information about the request being evaluated
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec] = js.native
  }
  object SubjectAccessReviewArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): SubjectAccessReviewArgs = {
    ...
    implicit class SubjectAccessReviewArgsMutableBuilder[Self <: SubjectAccessReviewArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApiVersion(value: Input[authorizationDotk8sDotioSlashv1]): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
