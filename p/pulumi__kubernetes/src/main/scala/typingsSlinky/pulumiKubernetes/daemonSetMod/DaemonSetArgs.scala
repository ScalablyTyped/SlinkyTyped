package typingsSlinky.pulumiKubernetes.daemonSetMod

import typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSetSpec
...
object DaemonSetArgs {
  ...
  implicit class DaemonSetArgsOps[Self <: DaemonSetArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSet]): Self = this.set("kind", value.asInstanceOf[js.Any])
