package typingsSlinky.pulumiKubernetes.serviceAccountMod

import typingsSlinky.pulumiKubernetes.inputMod.core.v1.LocalObjectReference
...
object ServiceAccountArgs {
  ...
  implicit class ServiceAccountArgsOps[Self <: ServiceAccountArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccount]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
