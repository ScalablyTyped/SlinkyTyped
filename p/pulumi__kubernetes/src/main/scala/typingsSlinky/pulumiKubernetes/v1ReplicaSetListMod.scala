...
object v1ReplicaSetListMod {
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    /**
      * List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]] = js.native
  ...
  object ReplicaSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]): ReplicaSetListArgs = {
    ...
    implicit class ReplicaSetListArgsMutableBuilder[Self <: ReplicaSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
