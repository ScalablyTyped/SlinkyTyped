...
import typingsSlinky.pulumiKubernetes.outputMod.admissionregistration.v1beta1.MutatingWebhook
...
object mutatingWebhookConfigurationMod extends js.Object {
  ...
  class MutatingWebhookConfiguration protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhookConfiguration
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhookConfiguration,
