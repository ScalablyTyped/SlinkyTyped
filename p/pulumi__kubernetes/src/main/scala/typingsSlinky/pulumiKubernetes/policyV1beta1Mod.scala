...
object policyV1beta1Mod extends js.Object {
  ...
  class PodDisruptionBudget protected ()
    extends typingsSlinky.pulumiKubernetes.podDisruptionBudgetMod.PodDisruptionBudget {
    /**
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudget) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudget,
  ...
  class PodDisruptionBudgetList protected ()
    extends typingsSlinky.pulumiKubernetes.podDisruptionBudgetListMod.PodDisruptionBudgetList {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudgetList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudgetList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class PodSecurityPolicy protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1PodSecurityPolicyMod.PodSecurityPolicy {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicy) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicy,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class PodSecurityPolicyList protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1PodSecurityPolicyListMod.PodSecurityPolicyList {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicyList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicyList,
      opts: CustomResourceOptions
    ) = this()
  }
