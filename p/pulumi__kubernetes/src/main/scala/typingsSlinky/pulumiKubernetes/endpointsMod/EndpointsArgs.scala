...
import typingsSlinky.pulumiKubernetes.inputMod.core.v1.EndpointSubset
...
@js.native
trait EndpointsArgs extends js.Object {
  ...
  /**
    ...
    */
  val subsets: js.UndefOr[Input[js.Array[Input[EndpointSubset]]]] = js.native
}
object EndpointsArgs {
  ...
  @scala.inline
  implicit class EndpointsArgsOps[Self <: EndpointsArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Endpoints]): Self = this.set("kind", value.asInstanceOf[js.Any])
