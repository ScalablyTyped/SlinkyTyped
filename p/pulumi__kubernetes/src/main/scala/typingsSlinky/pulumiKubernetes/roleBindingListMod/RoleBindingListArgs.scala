package typingsSlinky.pulumiKubernetes.roleBindingListMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding
...
object RoleBindingListArgs {
  ...
  implicit class RoleBindingListArgsOps[Self <: RoleBindingListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
