...
import typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenReviewSpec
...
object TokenReviewArgs {
  ...
  implicit class TokenReviewArgsOps[Self <: TokenReviewArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.TokenReview]): Self = this.set("kind", value.asInstanceOf[js.Any])
