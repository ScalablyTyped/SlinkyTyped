...
object schedulingV1Mod {
  ...
  class PriorityClass protected ()
    extends typingsSlinky.pulumiKubernetes.v1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsSlinky.pulumiKubernetes.v1PriorityClassListMod.PriorityClassList {
    /**
