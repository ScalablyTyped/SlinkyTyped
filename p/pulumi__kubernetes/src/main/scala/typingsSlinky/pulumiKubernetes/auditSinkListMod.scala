...
object auditSinkListMod {
  ...
  trait AuditSinkListArgs extends StObject {
    ...
    val items: Input[
        js.Array[
          Input[typingsSlinky.pulumiKubernetes.inputMod.auditregistration.v1alpha1.AuditSink]
        ]
      ] = js.native
  ...
  object AuditSinkListArgs {
    ...
    implicit class AuditSinkListArgsMutableBuilder[Self <: AuditSinkListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.auditregistration.v1alpha1.AuditSink]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
