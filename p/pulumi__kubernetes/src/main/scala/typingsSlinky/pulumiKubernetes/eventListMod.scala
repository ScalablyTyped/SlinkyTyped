...
object eventListMod {
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      * List of events
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.Event]]] = js.native
  ...
  object EventListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.Event]]]): EventListArgs = {
    ...
    implicit class EventListArgsMutableBuilder[Self <: EventListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.Event]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.Event]*): Self = StObject.set(x, "items", js.Array(value :_*))
