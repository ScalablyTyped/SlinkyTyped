...
object horizontalPodAutoscalerMod {
  ...
  object HorizontalPodAutoscaler {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v1/horizontalPodAutoscaler", "HorizontalPodAutoscaler.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v1/horizontalPodAutoscaler", "HorizontalPodAutoscaler.isInstance")
    @js.native
  ...
  trait HorizontalPodAutoscalerArgs extends StObject {
    ...
    val spec: js.UndefOr[
        Input[
          typingsSlinky.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscalerSpec
        ]
      ] = js.native
  }
