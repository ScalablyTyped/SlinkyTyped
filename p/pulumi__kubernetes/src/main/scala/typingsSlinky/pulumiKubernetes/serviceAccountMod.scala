...
object serviceAccountMod extends js.Object {
  ...
  class ServiceAccount protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceAccount) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceAccount,
