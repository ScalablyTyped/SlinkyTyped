...
object clusterRoleListMod {
  ...
  object ClusterRoleList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRoleList", "ClusterRoleList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRoleList", "ClusterRoleList.isInstance")
    @js.native
  ...
  trait ClusterRoleListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole]]
      ] = js.native
  ...
  object ClusterRoleListArgs {
    ...
    implicit class ClusterRoleListArgsMutableBuilder[Self <: ClusterRoleListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole]*): Self = StObject.set(x, "items", js.Array(value :_*))
