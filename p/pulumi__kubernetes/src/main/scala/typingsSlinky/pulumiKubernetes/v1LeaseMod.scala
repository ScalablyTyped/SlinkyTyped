...
object v1LeaseMod {
  ...
  object Lease {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/coordination/v1/lease", "Lease.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/coordination/v1/lease", "Lease.isInstance")
    @js.native
  ...
  trait LeaseArgs extends StObject {
    ...
    /**
      * Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.LeaseSpec]] = js.native
  }
  object LeaseArgs {
    ...
    implicit class LeaseArgsMutableBuilder[Self <: LeaseArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1.LeaseSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
