package typingsSlinky.pulumiKubernetes.mutatingWebhookConfigurationListMod

import typingsSlinky.pulumiKubernetes.outputMod.admissionregistration.v1beta1.MutatingWebhookConfiguration
