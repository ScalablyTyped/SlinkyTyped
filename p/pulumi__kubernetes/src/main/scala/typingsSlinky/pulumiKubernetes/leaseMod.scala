...
object leaseMod {
  ...
  object Lease {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/coordination/v1beta1/lease", "Lease.get")
    @js.native
  ...
  trait LeaseArgs extends StObject {
    ...
    /**
      * Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.LeaseSpec]] = js.native
  }
  object LeaseArgs {
    ...
    @scala.inline
    implicit class LeaseArgsMutableBuilder[Self <: LeaseArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Lease]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.LeaseSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
