...
@JSImport("@pulumi/kubernetes/apps/v1beta2/Deployment", JSImport.Namespace)
@js.native
object v1beta2DeploymentMod extends js.Object {
  @js.native
  class Deployment protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.Deployment) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.Deployment,
