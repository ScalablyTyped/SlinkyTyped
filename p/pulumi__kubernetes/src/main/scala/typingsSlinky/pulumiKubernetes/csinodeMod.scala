...
import typingsSlinky.pulumiKubernetes.outputMod.storage.v1beta1.CSINodeSpec
...
object csinodeMod {
  ...
  trait CSINodeArgs extends StObject {
    ...
    /**
      * spec is the specification of CSINode
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINodeSpec] = js.native
  }
  object CSINodeArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINodeSpec]): CSINodeArgs = {
    ...
    implicit class CSINodeArgsMutableBuilder[Self <: CSINodeArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINodeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
