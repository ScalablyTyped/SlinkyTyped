...
@JSImport("@pulumi/kubernetes/storage/v1beta1/CSINode", JSImport.Namespace)
@js.native
object csinodeMod extends js.Object {
  @js.native
  class CSINode protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINode) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINode,
