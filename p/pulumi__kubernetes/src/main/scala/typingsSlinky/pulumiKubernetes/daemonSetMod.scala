...
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta2.DaemonSetSpec
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta2.DaemonSetStatus
...
object daemonSetMod {
  ...
  trait DaemonSetArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSet]] = js.native
    ...
    /**
      * The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSetSpec]] = js.native
  }
  object DaemonSetArgs {
    ...
    implicit class DaemonSetArgsMutableBuilder[Self <: DaemonSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSet]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
