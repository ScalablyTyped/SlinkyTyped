...
object configMapListMod {
  ...
  object ConfigMapList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/configMapList", "ConfigMapList.get")
    @js.native
  ...
  trait ConfigMapListArgs extends StObject {
    ...
    /**
      * Items is the list of ConfigMaps.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMap]]] = js.native
  ...
  object ConfigMapListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMap]]]): ConfigMapListArgs = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
      __obj.asInstanceOf[ConfigMapListArgs]
    }
    
    @scala.inline
    implicit class ConfigMapListArgsMutableBuilder[Self <: ConfigMapListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMap]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMap]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
