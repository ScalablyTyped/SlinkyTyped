...
object v1CsinodeMod {
  ...
  class CSINode protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINode] = js.native
  ...
  object CSINode {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1/csinode", "CSINode.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1/csinode", "CSINode.isInstance")
    @js.native
  ...
  trait CSINodeArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINode]] = js.native
    ...
    /**
      * spec is the specification of CSINode
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINodeSpec] = js.native
  }
  object CSINodeArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINodeSpec]): CSINodeArgs = {
    ...
    implicit class CSINodeArgsMutableBuilder[Self <: CSINodeArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINode]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINodeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
