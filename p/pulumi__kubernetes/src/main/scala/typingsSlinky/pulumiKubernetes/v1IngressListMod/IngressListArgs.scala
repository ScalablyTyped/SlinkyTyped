package typingsSlinky.pulumiKubernetes.v1IngressListMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.networking.v1.Ingress
...
object IngressListArgs {
  ...
  implicit class IngressListArgsOps[Self <: IngressListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressList]): Self = this.set("kind", value.asInstanceOf[js.Any])
