...
@js.native
object v1beta1VolumeAttachmentListMod extends js.Object {
  @js.native
  class VolumeAttachmentList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentList,
