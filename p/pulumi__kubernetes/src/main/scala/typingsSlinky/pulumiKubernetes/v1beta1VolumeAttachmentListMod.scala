...
import typingsSlinky.pulumiKubernetes.outputMod.storage.v1beta1.VolumeAttachment
...
object v1beta1VolumeAttachmentListMod {
  ...
  object VolumeAttachmentList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1beta1/volumeAttachmentList", "VolumeAttachmentList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1beta1/volumeAttachmentList", "VolumeAttachmentList.isInstance")
    @js.native
  ...
  trait VolumeAttachmentListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment]]
      ] = js.native
  ...
  object VolumeAttachmentListArgs {
    ...
    implicit class VolumeAttachmentListArgsMutableBuilder[Self <: VolumeAttachmentListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment]*): Self = StObject.set(x, "items", js.Array(value :_*))
