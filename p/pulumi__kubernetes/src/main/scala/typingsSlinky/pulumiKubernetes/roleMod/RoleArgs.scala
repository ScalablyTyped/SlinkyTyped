package typingsSlinky.pulumiKubernetes.roleMod
...
object RoleArgs {
  ...
  implicit class RoleArgsOps[Self <: RoleArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Role]): Self = this.set("kind", value.asInstanceOf[js.Any])
