...
object v1beta1IngressMod {
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.IngressSpec]] = js.native
  }
  object IngressArgs {
    ...
    implicit class IngressArgsMutableBuilder[Self <: IngressArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.IngressSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
