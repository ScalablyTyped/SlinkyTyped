...
object policyMod {
  ...
  object v1beta1 {
    ...
    class PodDisruptionBudget protected ()
      extends typingsSlinky.pulumiKubernetes.policyV1beta1Mod.PodDisruptionBudget {
      /**
    ...
    class PodDisruptionBudgetList protected ()
      extends typingsSlinky.pulumiKubernetes.policyV1beta1Mod.PodDisruptionBudgetList {
      /**
    ...
    class PodSecurityPolicy protected ()
      extends typingsSlinky.pulumiKubernetes.policyV1beta1Mod.PodSecurityPolicy {
      /**
    ...
    class PodSecurityPolicyList protected ()
      extends typingsSlinky.pulumiKubernetes.policyV1beta1Mod.PodSecurityPolicyList {
      /**
