...
object v1DeploymentMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1/deployment", "Deployment")
  @js.native
  ...
  object Deployment {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/deployment", "Deployment.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/deployment", "Deployment.isInstance")
    @js.native
  ...
  trait DeploymentArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of the Deployment.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DeploymentSpec]] = js.native
  }
  object DeploymentArgs {
    ...
    implicit class DeploymentArgsMutableBuilder[Self <: DeploymentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DeploymentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
