...
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta1.StatefulSetSpec
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta1.StatefulSetStatus
...
object statefulSetMod {
  ...
  trait StatefulSetArgs extends StObject {
    ...
    /**
      * Spec defines the desired identities of pods in this set.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSetSpec]] = js.native
  }
  object StatefulSetArgs {
    ...
    implicit class StatefulSetArgsMutableBuilder[Self <: StatefulSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
