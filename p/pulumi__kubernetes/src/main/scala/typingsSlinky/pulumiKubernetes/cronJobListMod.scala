...
object cronJobListMod {
  ...
  object CronJobList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/batch/v1beta1/cronJobList", "CronJobList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/batch/v1beta1/cronJobList", "CronJobList.isInstance")
    @js.native
  ...
  trait CronJobListArgs extends StObject {
    ...
    /**
      * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
      */
    val apiVersion: js.UndefOr[Input[batchSlashv1beta1]] = js.native
    
    /**
      * items is the list of CronJobs.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]] = js.native
  ...
  object CronJobListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]): CronJobListArgs = {
    ...
    implicit class CronJobListArgsMutableBuilder[Self <: CronJobListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]*): Self = StObject.set(x, "items", js.Array(value :_*))
