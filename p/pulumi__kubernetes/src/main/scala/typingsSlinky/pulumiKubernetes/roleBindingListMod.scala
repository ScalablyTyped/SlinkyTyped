...
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1alpha1.RoleBinding
...
object roleBindingListMod {
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding]]
      ] = js.native
  ...
  object RoleBindingListArgs {
    ...
    implicit class RoleBindingListArgsMutableBuilder[Self <: RoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
