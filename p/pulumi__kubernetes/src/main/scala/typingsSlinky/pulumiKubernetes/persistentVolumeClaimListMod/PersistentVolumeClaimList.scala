package typingsSlinky.pulumiKubernetes.persistentVolumeClaimListMod
...
class PersistentVolumeClaimList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaimList] = js.native
