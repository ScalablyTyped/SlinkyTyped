...
import typingsSlinky.pulumiKubernetes.outputMod.policy.v1beta1.PodSecurityPolicySpec
...
object v1beta1PodSecurityPolicyMod {
  ...
  class PodSecurityPolicy protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy] = js.native
  ...
  object PodSecurityPolicy {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/policy/v1beta1/podSecurityPolicy", "PodSecurityPolicy.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/policy/v1beta1/podSecurityPolicy", "PodSecurityPolicy.isInstance")
    @js.native
  ...
  trait PodSecurityPolicyArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy]] = js.native
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicySpec]
      ] = js.native
  }
  object PodSecurityPolicyArgs {
    ...
    implicit class PodSecurityPolicyArgsMutableBuilder[Self <: PodSecurityPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicySpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
