...
object storageClassMod {
  ...
  trait StorageClassArgs extends StObject {
    ...
    val allowedTopologies: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.TopologySelectorTerm]]
        ]
      ] = js.native
  ...
  object StorageClassArgs {
    ...
    implicit class StorageClassArgsMutableBuilder[Self <: StorageClassArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAllowedTopologiesVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.TopologySelectorTerm]*): Self = StObject.set(x, "allowedTopologies", js.Array(value :_*))
