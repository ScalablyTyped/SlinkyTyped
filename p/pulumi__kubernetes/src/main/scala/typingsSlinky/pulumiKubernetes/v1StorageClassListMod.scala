...
object v1StorageClassListMod {
  ...
  object StorageClassList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1/storageClassList", "StorageClassList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1/storageClassList", "StorageClassList.isInstance")
    @js.native
  ...
  trait StorageClassListArgs extends StObject {
    ...
    /**
      * Items is the list of StorageClasses
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.StorageClass]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList]] = js.native
  ...
  object StorageClassListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.StorageClass]]]): StorageClassListArgs = {
    ...
    implicit class StorageClassListArgsMutableBuilder[Self <: StorageClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.StorageClass]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.StorageClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
