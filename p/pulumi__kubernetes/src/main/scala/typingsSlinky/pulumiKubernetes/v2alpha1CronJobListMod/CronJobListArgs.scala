...
import typingsSlinky.pulumiKubernetes.inputMod.batch.v2alpha1.CronJob
...
object CronJobListArgs {
  ...
  implicit class CronJobListArgsOps[Self <: CronJobListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CronJobList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
