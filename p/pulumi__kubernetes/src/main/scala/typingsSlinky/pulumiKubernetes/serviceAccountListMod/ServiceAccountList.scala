package typingsSlinky.pulumiKubernetes.serviceAccountListMod
...
class ServiceAccountList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccountList] = js.native
