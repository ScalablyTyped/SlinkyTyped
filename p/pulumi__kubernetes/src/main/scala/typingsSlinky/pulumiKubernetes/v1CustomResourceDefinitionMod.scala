...
object v1CustomResourceDefinitionMod {
  ...
  object CustomResourceDefinition {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiextensions/v1/customResourceDefinition", "CustomResourceDefinition.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiextensions/v1/customResourceDefinition", "CustomResourceDefinition.isInstance")
    @js.native
  ...
  trait CustomResourceDefinitionArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: Input[
        typingsSlinky.pulumiKubernetes.inputMod.apiextensions.v1.CustomResourceDefinitionSpec
      ] = js.native
  }
