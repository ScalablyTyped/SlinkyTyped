package typingsSlinky.pulumiKubernetes.v2beta1HorizontalPodAutoscalerMod

import typingsSlinky.pulumiKubernetes.inputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpec
...
object HorizontalPodAutoscalerArgs {
  ...
  implicit class HorizontalPodAutoscalerArgsOps[Self <: HorizontalPodAutoscalerArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: Input[autoscalingSlashv2beta1]): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteApiVersion: Self = this.set("apiVersion", js.undefined)
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.HorizontalPodAutoscaler]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
