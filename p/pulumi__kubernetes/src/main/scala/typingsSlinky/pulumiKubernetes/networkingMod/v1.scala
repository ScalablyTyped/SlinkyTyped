package typingsSlinky.pulumiKubernetes.networkingMod
...
object v1 extends js.Object {
  ...
  class Ingress protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1Mod.Ingress {
    /**
  ...
  class IngressClass protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1Mod.IngressClass {
    /**
  ...
  class IngressClassList protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1Mod.IngressClassList {
    /**
  ...
  class IngressList protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1Mod.IngressList {
    /**
  ...
  class NetworkPolicyList protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1Mod.NetworkPolicyList {
    /**
