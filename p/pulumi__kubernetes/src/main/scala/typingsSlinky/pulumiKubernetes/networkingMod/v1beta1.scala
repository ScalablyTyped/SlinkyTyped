...
object v1beta1 extends js.Object {
  ...
  class IngressClass protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1beta1Mod.IngressClass {
    /**
  ...
  class IngressClassList protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1beta1Mod.IngressClassList {
    /**
  ...
  class IngressList protected ()
    extends typingsSlinky.pulumiKubernetes.networkingV1beta1Mod.IngressList {
    /**
