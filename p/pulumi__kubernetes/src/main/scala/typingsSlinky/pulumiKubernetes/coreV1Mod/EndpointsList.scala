...
class EndpointsList protected ()
  extends typingsSlinky.pulumiKubernetes.endpointsListMod.EndpointsList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.EndpointsList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.EndpointsList,
