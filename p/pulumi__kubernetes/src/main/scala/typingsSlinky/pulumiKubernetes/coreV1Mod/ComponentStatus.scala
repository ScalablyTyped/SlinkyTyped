...
class ComponentStatus protected ()
  extends typingsSlinky.pulumiKubernetes.componentStatusMod.ComponentStatus {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ComponentStatus) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ComponentStatus,
...
object ComponentStatus extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.componentStatusMod.ComponentStatus = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.componentStatusMod.ComponentStatus = js.native
  /**
