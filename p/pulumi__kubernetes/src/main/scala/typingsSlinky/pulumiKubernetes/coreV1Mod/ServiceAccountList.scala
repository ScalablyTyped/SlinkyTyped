...
class ServiceAccountList protected ()
  extends typingsSlinky.pulumiKubernetes.serviceAccountListMod.ServiceAccountList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceAccountList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceAccountList,
