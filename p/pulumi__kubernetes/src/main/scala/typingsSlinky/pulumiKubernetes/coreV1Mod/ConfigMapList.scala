...
class ConfigMapList protected ()
  extends typingsSlinky.pulumiKubernetes.configMapListMod.ConfigMapList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMapList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ConfigMapList,
...
object ConfigMapList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.configMapListMod.ConfigMapList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.configMapListMod.ConfigMapList = js.native
  /**
