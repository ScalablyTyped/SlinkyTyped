...
class PersistentVolumeList protected ()
  extends typingsSlinky.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeList,
