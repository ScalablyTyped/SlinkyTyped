...
class ComponentStatusList protected ()
  extends typingsSlinky.pulumiKubernetes.componentStatusListMod.ComponentStatusList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ComponentStatusList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ComponentStatusList,
