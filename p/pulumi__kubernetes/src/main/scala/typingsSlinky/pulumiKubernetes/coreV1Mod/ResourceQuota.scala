...
import typingsSlinky.pulumiKubernetes.resourceQuotaMod.ResourceQuotaArgs
...
class ResourceQuota protected ()
  extends typingsSlinky.pulumiKubernetes.resourceQuotaMod.ResourceQuota {
  /**
...
object ResourceQuota {
  ...
  /**
    ...
    */
  @JSImport("@pulumi/kubernetes/core/v1", "ResourceQuota.get")
  @js.native
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.resourceQuotaMod.ResourceQuota = js.native
  @JSImport("@pulumi/kubernetes/core/v1", "ResourceQuota.get")
  @js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.resourceQuotaMod.ResourceQuota = js.native
  
  /**
    * Returns true if the given object is an instance of ResourceQuota.  This is designed to work even
    * when multiple copies of the Pulumi SDK have been loaded into the same process.
    */
  @JSImport("@pulumi/kubernetes/core/v1", "ResourceQuota.isInstance")
  @js.native
