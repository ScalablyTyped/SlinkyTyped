...
class ResourceQuota protected ()
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuota) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuota,
