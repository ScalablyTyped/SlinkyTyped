...
class PersistentVolumeClaimList protected ()
  extends typingsSlinky.pulumiKubernetes.persistentVolumeClaimListMod.PersistentVolumeClaimList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaimList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaimList,
