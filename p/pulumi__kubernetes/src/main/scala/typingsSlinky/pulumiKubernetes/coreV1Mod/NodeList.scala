...
class NodeList protected ()
  extends typingsSlinky.pulumiKubernetes.nodeListMod.NodeList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.NodeList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.NodeList,
