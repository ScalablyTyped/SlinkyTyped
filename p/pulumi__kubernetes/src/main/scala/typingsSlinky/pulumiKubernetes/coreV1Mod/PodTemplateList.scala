...
class PodTemplateList protected ()
  extends typingsSlinky.pulumiKubernetes.podTemplateListMod.PodTemplateList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplateList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplateList,
...
object PodTemplateList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.podTemplateListMod.PodTemplateList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.podTemplateListMod.PodTemplateList = js.native
  /**
