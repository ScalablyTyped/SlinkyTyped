...
class ReplicationControllerList protected ()
  extends typingsSlinky.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ReplicationControllerList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.ReplicationControllerList,
...
object ReplicationControllerList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList = js.native
  /**
