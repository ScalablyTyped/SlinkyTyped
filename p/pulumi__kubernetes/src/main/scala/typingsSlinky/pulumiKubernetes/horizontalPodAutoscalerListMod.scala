...
object horizontalPodAutoscalerListMod {
  ...
  trait HorizontalPodAutoscalerListArgs extends StObject {
    ...
    val items: Input[
        js.Array[
          Input[typingsSlinky.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscaler]
        ]
      ] = js.native
  ...
  object HorizontalPodAutoscalerListArgs {
    ...
    implicit class HorizontalPodAutoscalerListArgsMutableBuilder[Self <: HorizontalPodAutoscalerListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscaler]*): Self = StObject.set(x, "items", js.Array(value :_*))
