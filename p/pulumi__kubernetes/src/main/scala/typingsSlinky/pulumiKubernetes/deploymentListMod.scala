...
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta1.Deployment
...
object deploymentListMod {
  ...
  trait DeploymentListArgs extends StObject {
    ...
    /**
      * Items is the list of Deployments.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.Deployment]]] = js.native
  ...
  object DeploymentListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.Deployment]]]): DeploymentListArgs = {
    ...
    implicit class DeploymentListArgsMutableBuilder[Self <: DeploymentListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.Deployment]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.Deployment]*): Self = StObject.set(x, "items", js.Array(value :_*))
