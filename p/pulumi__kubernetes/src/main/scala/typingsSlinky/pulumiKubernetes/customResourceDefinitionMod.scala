...
import typingsSlinky.pulumiKubernetes.outputMod.apiextensions.v1beta1.CustomResourceDefinitionSpec
import typingsSlinky.pulumiKubernetes.outputMod.apiextensions.v1beta1.CustomResourceDefinitionStatus
...
object customResourceDefinitionMod {
  ...
  class CustomResourceDefinition protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CustomResourceDefinition] = js.native
  ...
  trait CustomResourceDefinitionArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: Input[
        typingsSlinky.pulumiKubernetes.inputMod.apiextensions.v1beta1.CustomResourceDefinitionSpec
      ] = js.native
  }
  object CustomResourceDefinitionArgs {
    ...
    @scala.inline
    implicit class CustomResourceDefinitionArgsMutableBuilder[Self <: CustomResourceDefinitionArgs] (val x: Self) extends AnyVal {
