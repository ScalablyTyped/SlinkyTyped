...
object v1RoleListMod {
  
  @JSImport("@pulumi/kubernetes/rbac/v1/roleList", "RoleList")
  @js.native
  ...
  object RoleList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/roleList", "RoleList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/roleList", "RoleList.isInstance")
    @js.native
  ...
  trait RoleListArgs extends StObject {
    ...
    /**
      * Items is a list of Roles
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.Role]]] = js.native
  ...
  object RoleListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.Role]]]): RoleListArgs = {
    ...
    implicit class RoleListArgsMutableBuilder[Self <: RoleListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.Role]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.Role]*): Self = StObject.set(x, "items", js.Array(value :_*))
