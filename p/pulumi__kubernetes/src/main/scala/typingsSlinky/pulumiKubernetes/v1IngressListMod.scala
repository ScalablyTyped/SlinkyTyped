...
object v1IngressListMod {
  ...
  trait IngressListArgs extends StObject {
    ...
    /**
      * Items is the list of Ingress.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.Ingress]]] = js.native
  ...
  object IngressListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.Ingress]]]): IngressListArgs = {
    ...
    implicit class IngressListArgsMutableBuilder[Self <: IngressListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.Ingress]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.Ingress]*): Self = StObject.set(x, "items", js.Array(value :_*))
