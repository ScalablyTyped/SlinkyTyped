...
object v1IngressClassListMod {
  ...
  class IngressClassList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList] = js.native
  ...
  trait IngressClassListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.IngressClass]]
      ] = js.native
  ...
  object IngressClassListArgs {
    ...
    implicit class IngressClassListArgsMutableBuilder[Self <: IngressClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.IngressClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
