...
object ingressListMod extends js.Object {
  ...
  class IngressList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.IngressList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.IngressList,
