...
object v1EventMod {
  ...
  trait EventArgs extends StObject {
    ...
    /**
      * series is data about the Event series this event represents or nil if it's a singleton Event.
      */
    val series: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1.EventSeries]] = js.native
  ...
  object EventArgs {
    ...
    implicit class EventArgsMutableBuilder[Self <: EventArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSeries(value: Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1.EventSeries]): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
