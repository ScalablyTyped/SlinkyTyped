...
object PersistentVolumeClaim {
  ...
  implicit class PersistentVolumeClaimOps[Self <: PersistentVolumeClaim] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaim]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[PersistentVolumeClaimSpec]): Self = {
        val ret = this.duplicate
