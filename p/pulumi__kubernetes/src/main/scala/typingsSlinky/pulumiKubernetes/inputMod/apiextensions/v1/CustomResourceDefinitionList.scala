...
trait CustomResourceDefinitionList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[CustomResourceDefinition]]] = js.native
  /**
...
object CustomResourceDefinitionList {
  @scala.inline
  def apply(items: Input[js.Array[Input[CustomResourceDefinition]]]): CustomResourceDefinitionList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[CustomResourceDefinitionList]
  }
  @scala.inline
  implicit class CustomResourceDefinitionListOps[Self <: CustomResourceDefinitionList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[CustomResourceDefinition]]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withApiVersion(value: Input[apiextensionsDotk8sDotioSlashv1]): Self = {
        val ret = this.duplicate
