...
trait ResourceQuotaList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[ResourceQuota]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuotaList]] = js.native
  /**
...
object ResourceQuotaList {
  @scala.inline
  def apply(items: Input[js.Array[Input[ResourceQuota]]]): ResourceQuotaList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResourceQuotaList]
  }
  @scala.inline
  implicit class ResourceQuotaListOps[Self <: ResourceQuotaList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[ResourceQuota]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuotaList]): Self = {
        val ret = this.duplicate
