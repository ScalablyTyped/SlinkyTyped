...
trait CSINodeList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[CSINode]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList]] = js.native
  /**
...
object CSINodeList {
  @scala.inline
  def apply(items: Input[js.Array[Input[CSINode]]]): CSINodeList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[CSINodeList]
  }
  @scala.inline
  implicit class CSINodeListOps[Self <: CSINodeList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[CSINode]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList]): Self = {
        val ret = this.duplicate
