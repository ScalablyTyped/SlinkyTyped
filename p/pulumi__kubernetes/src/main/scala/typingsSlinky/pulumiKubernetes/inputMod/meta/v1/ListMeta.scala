...
object ListMeta {
  ...
  implicit class ListMetaOps[Self <: ListMeta] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContinue(value: Input[String]): Self = {
    ...
    @scala.inline
    def withRemainingItemCount(value: Input[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remainingItemCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRemainingItemCount: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remainingItemCount")(js.undefined)
        ret
    }
    @scala.inline
