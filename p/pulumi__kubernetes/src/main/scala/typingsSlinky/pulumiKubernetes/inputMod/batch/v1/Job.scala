...
trait Job extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job]] = js.native
  /**
...
object Job {
  ...
  implicit class JobOps[Self <: Job] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: Input[batchSlashv1]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[JobSpec]): Self = {
        val ret = this.duplicate
