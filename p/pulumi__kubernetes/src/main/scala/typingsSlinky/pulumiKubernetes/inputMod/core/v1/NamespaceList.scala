...
trait NamespaceList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[Namespace]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NamespaceList]] = js.native
  /**
...
object NamespaceList {
  @scala.inline
  def apply(items: Input[js.Array[Input[Namespace]]]): NamespaceList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[NamespaceList]
  }
  @scala.inline
  implicit class NamespaceListOps[Self <: NamespaceList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[Namespace]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NamespaceList]): Self = {
        val ret = this.duplicate
