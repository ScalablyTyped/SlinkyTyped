...
trait Namespace extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Namespace]] = js.undefined
  /**
...
object Namespace {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Namespace] = null,
    metadata: Input[ObjectMeta] = null,
    spec: Input[NamespaceSpec] = null
  ): Namespace = {
