...
trait Namespace extends StObject {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Namespace]] = js.native
  ...
  /**
    ...
    */
  var spec: js.UndefOr[Input[NamespaceSpec]] = js.native
  
  /**
    * Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  var status: js.UndefOr[Input[NamespaceStatus]] = js.native
}
object Namespace {
  ...
  implicit class NamespaceMutableBuilder[Self <: Namespace] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: Input[NamespaceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    @scala.inline
    def setStatus(value: Input[NamespaceStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
