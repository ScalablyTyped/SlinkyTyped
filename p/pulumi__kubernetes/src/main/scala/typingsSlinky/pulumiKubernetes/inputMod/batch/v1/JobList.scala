...
trait JobList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[Job]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.JobList]] = js.native
  /**
...
object JobList {
  @scala.inline
  def apply(items: Input[js.Array[Input[Job]]]): JobList = {
  ...
  implicit class JobListOps[Self <: JobList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[Job]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.JobList]): Self = {
        val ret = this.duplicate
