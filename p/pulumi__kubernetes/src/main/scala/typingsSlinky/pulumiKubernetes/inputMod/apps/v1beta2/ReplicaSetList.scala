...
trait ReplicaSetList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[ReplicaSet]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSetList]] = js.native
  /**
...
object ReplicaSetList {
  @scala.inline
  def apply(items: Input[js.Array[Input[ReplicaSet]]]): ReplicaSetList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReplicaSetList]
  }
  @scala.inline
  implicit class ReplicaSetListOps[Self <: ReplicaSetList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[ReplicaSet]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSetList]): Self = {
        val ret = this.duplicate
