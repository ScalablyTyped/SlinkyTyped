...
trait HorizontalPodAutoscalerList extends js.Object {
  ...
  /**
    * list of horizontal pod autoscaler objects.
    */
  var items: Input[js.Array[Input[HorizontalPodAutoscaler]]] = js.native
  /**
...
object HorizontalPodAutoscalerList {
  @scala.inline
  def apply(items: Input[js.Array[Input[HorizontalPodAutoscaler]]]): HorizontalPodAutoscalerList = {
  ...
  implicit class HorizontalPodAutoscalerListOps[Self <: HorizontalPodAutoscalerList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[HorizontalPodAutoscaler]]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withApiVersion(value: Input[autoscalingSlashv1]): Self = {
        val ret = this.duplicate
