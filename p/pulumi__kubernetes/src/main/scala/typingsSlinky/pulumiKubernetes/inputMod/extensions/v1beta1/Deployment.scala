...
trait Deployment extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Deployment]] = js.native
  /**
...
object Deployment {
  ...
  implicit class DeploymentOps[Self <: Deployment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Deployment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[DeploymentSpec]): Self = {
        val ret = this.duplicate
