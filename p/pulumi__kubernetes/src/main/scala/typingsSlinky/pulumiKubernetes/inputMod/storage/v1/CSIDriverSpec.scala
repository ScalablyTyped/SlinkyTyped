...
object CSIDriverSpec {
  ...
  implicit class CSIDriverSpecOps[Self <: CSIDriverSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFsGroupPolicy(value: Input[String]): Self = this.set("fsGroupPolicy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFsGroupPolicy: Self = this.set("fsGroupPolicy", js.undefined)
    ...
    @scala.inline
    def setStorageCapacity(value: Input[Boolean]): Self = this.set("storageCapacity", value.asInstanceOf[js.Any])
