...
trait StatefulSetList extends js.Object {
  ...
  var items: Input[js.Array[Input[StatefulSet]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList]] = js.native
  var metadata: js.UndefOr[Input[ListMeta]] = js.native
}

object StatefulSetList {
  @scala.inline
  def apply(items: Input[js.Array[Input[StatefulSet]]]): StatefulSetList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[StatefulSetList]
  }
  @scala.inline
  implicit class StatefulSetListOps[Self <: StatefulSetList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[StatefulSet]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList]): Self = {
        val ret = this.duplicate
