...
trait RuntimeClass extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass]] = js.undefined
  /**
    * More info:
...
object RuntimeClass {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass] = null,
