...
object NetworkPolicySpec {
  ...
  implicit class NetworkPolicySpecOps[Self <: NetworkPolicySpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEgress(value: Input[js.Array[Input[NetworkPolicyEgressRule]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIngress(value: Input[js.Array[Input[NetworkPolicyIngressRule]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPolicyTypes(value: Input[js.Array[Input[String]]]): Self = {
        val ret = this.duplicate
