...
trait VolumeAttachmentList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[VolumeAttachment]]] = js.native
  /**
...
object VolumeAttachmentList {
  @scala.inline
  def apply(items: Input[js.Array[Input[VolumeAttachment]]]): VolumeAttachmentList = {
  ...
  implicit class VolumeAttachmentListOps[Self <: VolumeAttachmentList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[VolumeAttachment]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList]): Self = {
        val ret = this.duplicate
