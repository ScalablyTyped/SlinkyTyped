...
trait Service extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service]] = js.native
  /**
...
object Service {
  ...
  implicit class ServiceOps[Self <: Service] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[ServiceSpec]): Self = {
        val ret = this.duplicate
