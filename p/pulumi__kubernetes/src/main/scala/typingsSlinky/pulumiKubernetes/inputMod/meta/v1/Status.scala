...
trait Status extends js.Object {
  ...
  /**
    ...
    */
  var code: js.UndefOr[Input[Double]] = js.native
  /**
    ...
    */
  var details: js.UndefOr[Input[StatusDetails]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Status]] = js.native
  /**
...
object Status {
  ...
  implicit class StatusOps[Self <: Status] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCode(value: Input[Double]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDetails(value: Input[StatusDetails]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Status]): Self = {
        val ret = this.duplicate
