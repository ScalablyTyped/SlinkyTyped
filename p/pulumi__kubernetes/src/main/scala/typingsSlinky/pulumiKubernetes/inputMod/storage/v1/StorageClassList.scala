...
trait StorageClassList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[StorageClass]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList]] = js.native
  /**
...
object StorageClassList {
  @scala.inline
  def apply(items: Input[js.Array[Input[StorageClass]]]): StorageClassList = {
  ...
  implicit class StorageClassListOps[Self <: StorageClassList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[StorageClass]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList]): Self = {
        val ret = this.duplicate
