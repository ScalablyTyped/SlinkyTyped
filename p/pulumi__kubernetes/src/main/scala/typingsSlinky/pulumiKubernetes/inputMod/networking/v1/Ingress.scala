...
object Ingress {
  ...
  implicit class IngressOps[Self <: Ingress] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Ingress]): Self = this.set("kind", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpec(value: Input[IngressSpec]): Self = this.set("spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSpec: Self = this.set("spec", js.undefined)
    
    @scala.inline
    def setStatus(value: Input[IngressStatus]): Self = this.set("status", value.asInstanceOf[js.Any])
