...
trait MutatingWebhookConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[MutatingWebhookConfiguration]]] = js.native
  /**
...
object MutatingWebhookConfigurationList {
  @scala.inline
  def apply(items: Input[js.Array[Input[MutatingWebhookConfiguration]]]): MutatingWebhookConfigurationList = {
  ...
  implicit class MutatingWebhookConfigurationListOps[Self <: MutatingWebhookConfigurationList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[MutatingWebhookConfiguration]]]): Self = {
