...
trait ClusterRoleBinding extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBinding]] = js.undefined
  /**
...
object ClusterRoleBinding {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBinding] = null,
