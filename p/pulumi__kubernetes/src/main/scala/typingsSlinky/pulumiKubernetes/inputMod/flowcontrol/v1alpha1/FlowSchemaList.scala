...
trait FlowSchemaList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[FlowSchema]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]] = js.native
  /**
...
object FlowSchemaList {
  @scala.inline
  def apply(items: Input[js.Array[Input[FlowSchema]]]): FlowSchemaList = {
  ...
  implicit class FlowSchemaListOps[Self <: FlowSchemaList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[FlowSchema]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]): Self = {
        val ret = this.duplicate
