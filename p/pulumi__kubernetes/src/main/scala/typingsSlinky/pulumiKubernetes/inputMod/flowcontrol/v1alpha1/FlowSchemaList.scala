...
trait FlowSchemaList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]] = js.undefined
  /**
...
object FlowSchemaList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList] = null,
