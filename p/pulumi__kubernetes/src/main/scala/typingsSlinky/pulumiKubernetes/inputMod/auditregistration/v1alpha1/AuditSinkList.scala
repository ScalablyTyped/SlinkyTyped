...
trait AuditSinkList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[AuditSink]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList]] = js.native
  var metadata: js.UndefOr[Input[ListMeta]] = js.native
}

object AuditSinkList {
  @scala.inline
  def apply(items: Input[js.Array[Input[AuditSink]]]): AuditSinkList = {
  ...
  implicit class AuditSinkListOps[Self <: AuditSinkList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[AuditSink]]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("items")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withApiVersion(value: Input[auditregistrationDotk8sDotioSlashv1alpha1]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList]): Self = {
        val ret = this.duplicate
