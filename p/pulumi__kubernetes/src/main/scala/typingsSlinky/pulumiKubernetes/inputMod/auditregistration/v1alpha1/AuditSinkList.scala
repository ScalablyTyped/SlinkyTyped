...
trait AuditSinkList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList]] = js.undefined
...
object AuditSinkList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList] = null,
