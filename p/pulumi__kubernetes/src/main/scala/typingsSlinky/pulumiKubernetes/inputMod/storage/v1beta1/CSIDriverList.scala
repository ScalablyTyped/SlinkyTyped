...
trait CSIDriverList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[CSIDriver]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList]] = js.native
  /**
...
object CSIDriverList {
  @scala.inline
  def apply(items: Input[js.Array[Input[CSIDriver]]]): CSIDriverList = {
  ...
  implicit class CSIDriverListOps[Self <: CSIDriverList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[CSIDriver]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList]): Self = {
        val ret = this.duplicate
