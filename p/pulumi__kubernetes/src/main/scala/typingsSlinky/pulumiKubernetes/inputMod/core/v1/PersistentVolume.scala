...
object PersistentVolume {
  ...
  implicit class PersistentVolumeOps[Self <: PersistentVolume] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[PersistentVolumeSpec]): Self = {
        val ret = this.duplicate
