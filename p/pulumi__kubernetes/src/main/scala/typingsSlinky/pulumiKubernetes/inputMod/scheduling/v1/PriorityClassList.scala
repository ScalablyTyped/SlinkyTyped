...
trait PriorityClassList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[PriorityClass]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList]] = js.native
  /**
...
object PriorityClassList {
  @scala.inline
  def apply(items: Input[js.Array[Input[PriorityClass]]]): PriorityClassList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[PriorityClassList]
  }
  @scala.inline
  implicit class PriorityClassListOps[Self <: PriorityClassList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[PriorityClass]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList]): Self = {
        val ret = this.duplicate
