...
object MutatingWebhook {
  ...
  implicit class MutatingWebhookOps[Self <: MutatingWebhook] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReinvocationPolicy(value: Input[String]): Self = this.set("reinvocationPolicy", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteReinvocationPolicy: Self = this.set("reinvocationPolicy", js.undefined)
    @scala.inline
