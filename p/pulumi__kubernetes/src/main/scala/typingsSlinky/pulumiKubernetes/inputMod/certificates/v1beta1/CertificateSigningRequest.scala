...
object CertificateSigningRequest {
  ...
  implicit class CertificateSigningRequestOps[Self <: CertificateSigningRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: Input[certificatesDotk8sDotioSlashv1beta1]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[CertificateSigningRequestSpec]): Self = {
        val ret = this.duplicate
