...
trait NetworkPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[NetworkPolicy]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]] = js.native
  /**
...
object NetworkPolicyList {
  @scala.inline
  def apply(items: Input[js.Array[Input[NetworkPolicy]]]): NetworkPolicyList = {
  ...
  implicit class NetworkPolicyListOps[Self <: NetworkPolicyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[NetworkPolicy]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]): Self = {
        val ret = this.duplicate
