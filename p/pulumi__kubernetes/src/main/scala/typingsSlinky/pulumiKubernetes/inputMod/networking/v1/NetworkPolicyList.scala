...
trait NetworkPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]] = js.undefined
  /**
...
object NetworkPolicyList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList] = null,
