...
trait ReplicaSet extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet]] = js.native
  /**
...
object ReplicaSet {
  ...
  implicit class ReplicaSetOps[Self <: ReplicaSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[ReplicaSetSpec]): Self = {
        val ret = this.duplicate
