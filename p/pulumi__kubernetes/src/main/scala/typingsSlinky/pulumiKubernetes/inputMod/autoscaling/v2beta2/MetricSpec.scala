...
object MetricSpec {
  ...
  implicit class MetricSpecOps[Self <: MetricSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExternal(value: Input[ExternalMetricSource]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withObject(value: Input[ObjectMetricSource]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPods(value: Input[PodsMetricSource]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withResource(value: Input[ResourceMetricSource]): Self = {
        val ret = this.duplicate
