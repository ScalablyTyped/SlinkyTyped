...
trait CertificateSigningRequestList extends js.Object {
  ...
  var items: Input[js.Array[Input[CertificateSigningRequest]]] = js.native
  /**
...
object CertificateSigningRequestList {
  @scala.inline
  def apply(items: Input[js.Array[Input[CertificateSigningRequest]]]): CertificateSigningRequestList = {
  ...
  implicit class CertificateSigningRequestListOps[Self <: CertificateSigningRequestList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[CertificateSigningRequest]]]): Self = {
