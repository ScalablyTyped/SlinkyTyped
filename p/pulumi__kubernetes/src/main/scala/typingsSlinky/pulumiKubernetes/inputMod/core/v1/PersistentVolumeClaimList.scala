...
trait PersistentVolumeClaimList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[PersistentVolumeClaim]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaimList]
  ] = js.native
  /**
...
object PersistentVolumeClaimList {
  @scala.inline
  def apply(items: Input[js.Array[Input[PersistentVolumeClaim]]]): PersistentVolumeClaimList = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[PersistentVolumeClaimList]
  }
  @scala.inline
  implicit class PersistentVolumeClaimListOps[Self <: PersistentVolumeClaimList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: Input[js.Array[Input[PersistentVolumeClaim]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaimList]): Self = {
        val ret = this.duplicate
