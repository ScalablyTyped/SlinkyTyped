...
object DaemonSetSpec {
  ...
  implicit class DaemonSetSpecOps[Self <: DaemonSetSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTemplateGeneration(value: Input[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateGeneration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTemplateGeneration: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateGeneration")(js.undefined)
        ret
    }
    @scala.inline
