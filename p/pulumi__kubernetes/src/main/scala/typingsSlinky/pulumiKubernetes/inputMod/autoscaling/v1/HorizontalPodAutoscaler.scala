...
object HorizontalPodAutoscaler {
  ...
  implicit class HorizontalPodAutoscalerOps[Self <: HorizontalPodAutoscaler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.HorizontalPodAutoscaler]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[HorizontalPodAutoscalerSpec]): Self = {
        val ret = this.duplicate
