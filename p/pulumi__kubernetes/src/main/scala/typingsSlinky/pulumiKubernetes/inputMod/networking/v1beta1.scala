package typingsSlinky.pulumiKubernetes.inputMod.networking

import typingsSlinky.pulumiKubernetes.inputMod.core.v1.LoadBalancerStatus
import typingsSlinky.pulumiKubernetes.inputMod.core.v1.TypedLocalObjectReference
...
object v1beta1 {
  ...
  trait Ingress extends StObject {
    ...
    /**
      ...
      */
    var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Ingress]] = js.native
  ...
  object Ingress {
    ...
    implicit class IngressMutableBuilder[Self <: Ingress] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Ingress]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
  ...
  trait IngressClass extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass]] = js.native
