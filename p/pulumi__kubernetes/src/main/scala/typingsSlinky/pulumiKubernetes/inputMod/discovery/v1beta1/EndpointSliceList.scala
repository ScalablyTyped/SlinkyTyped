...
trait EndpointSliceList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList]] = js.undefined
  /**
...
object EndpointSliceList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList] = null,
