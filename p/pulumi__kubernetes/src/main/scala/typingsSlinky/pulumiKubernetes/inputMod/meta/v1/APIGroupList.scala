...
trait APIGroupList extends js.Object {
  ...
  /**
    ...
    */
  var groups: Input[js.Array[Input[APIGroup]]] = js.native
  /**
...
object APIGroupList {
  @scala.inline
  def apply(groups: Input[js.Array[Input[APIGroup]]]): APIGroupList = {
    val __obj = js.Dynamic.literal(groups = groups.asInstanceOf[js.Any])
    __obj.asInstanceOf[APIGroupList]
  }
  @scala.inline
  implicit class APIGroupListOps[Self <: APIGroupList] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withGroups(value: Input[js.Array[Input[APIGroup]]]): Self = {
