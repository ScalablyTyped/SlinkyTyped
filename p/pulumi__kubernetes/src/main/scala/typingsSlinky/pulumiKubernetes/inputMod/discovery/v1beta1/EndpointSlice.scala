...
trait EndpointSlice extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSlice]] = js.native
  /**
...
object EndpointSlice {
  ...
  implicit class EndpointSliceOps[Self <: EndpointSlice] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddressType(value: Input[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addressType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEndpoints(value: Input[js.Array[Input[Endpoint]]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSlice]): Self = {
        val ret = this.duplicate
