...
object VolumeAttachment {
  ...
  implicit class VolumeAttachmentOps[Self <: VolumeAttachment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSpec(value: Input[VolumeAttachmentSpec]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachment]): Self = {
        val ret = this.duplicate
