...
trait TokenReview extends js.Object {
  /**
    ...
    */
  var apiVersion: js.UndefOr[Input[authenticationDotk8sDotioSlashv1beta1]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.TokenReview]] = js.native
  var metadata: js.UndefOr[Input[ObjectMeta]] = js.native
  /**
    * Spec holds information about the request being evaluated
    */
  var spec: Input[TokenReviewSpec] = js.native
}

object TokenReview {
  @scala.inline
  def apply(spec: Input[TokenReviewSpec]): TokenReview = {
  ...
  implicit class TokenReviewOps[Self <: TokenReview] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSpec(value: Input[TokenReviewSpec]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spec")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withApiVersion(value: Input[authenticationDotk8sDotioSlashv1beta1]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.TokenReview]): Self = {
        val ret = this.duplicate
