...
trait PodSecurityPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[PodSecurityPolicy]]] = js.native
  /**
...
object PodSecurityPolicyList {
  @scala.inline
  def apply(items: Input[js.Array[Input[PodSecurityPolicy]]]): PodSecurityPolicyList = {
  ...
  implicit class PodSecurityPolicyListOps[Self <: PodSecurityPolicyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[PodSecurityPolicy]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList]): Self = {
        val ret = this.duplicate
