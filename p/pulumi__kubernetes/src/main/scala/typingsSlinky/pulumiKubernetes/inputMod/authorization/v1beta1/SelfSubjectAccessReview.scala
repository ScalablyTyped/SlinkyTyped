...
trait SelfSubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  var spec: Input[SelfSubjectAccessReviewSpec] = js.native
}

object SelfSubjectAccessReview {
  @scala.inline
  def apply(spec: Input[SelfSubjectAccessReviewSpec]): SelfSubjectAccessReview = {
  ...
  implicit class SelfSubjectAccessReviewOps[Self <: SelfSubjectAccessReview] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSpec(value: Input[SelfSubjectAccessReviewSpec]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectAccessReview]): Self = {
        val ret = this.duplicate
