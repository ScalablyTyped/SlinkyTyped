...
trait Binding extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding]] = js.native
  /**
  ...
  /**
    ...
    */
  var target: Input[ObjectReference] = js.native
}

object Binding {
  @scala.inline
  def apply(target: Input[ObjectReference]): Binding = {
  ...
  implicit class BindingOps[Self <: Binding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTarget(value: Input[ObjectReference]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding]): Self = {
        val ret = this.duplicate
