...
object QueuingConfiguration {
  ...
  implicit class QueuingConfigurationOps[Self <: QueuingConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHandSize(value: Input[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHandSize: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handSize")(js.undefined)
        ret
    }
    @scala.inline
    def withQueueLengthLimit(value: Input[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queueLengthLimit")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQueueLengthLimit: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queueLengthLimit")(js.undefined)
        ret
    }
    @scala.inline
    def withQueues(value: Input[Double]): Self = {
        val ret = this.duplicate
