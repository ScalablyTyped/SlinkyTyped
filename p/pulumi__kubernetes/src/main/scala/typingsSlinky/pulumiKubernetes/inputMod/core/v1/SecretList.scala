...
trait SecretList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[Secret]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SecretList]] = js.native
  /**
...
object SecretList {
  @scala.inline
  def apply(items: Input[js.Array[Input[Secret]]]): SecretList = {
  ...
  implicit class SecretListOps[Self <: SecretList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[Secret]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SecretList]): Self = {
        val ret = this.duplicate
