...
trait SecretList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[Secret]]]
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SecretList]] = js.undefined
  /**
...
object SecretList {
  @scala.inline
  def apply(
    items: Input[js.Array[Input[Secret]]],
    apiVersion: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.v1] = null,
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SecretList] = null,
