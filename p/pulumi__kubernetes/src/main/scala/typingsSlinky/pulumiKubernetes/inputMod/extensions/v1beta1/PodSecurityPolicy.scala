...
object PodSecurityPolicy {
  ...
  implicit class PodSecurityPolicyOps[Self <: PodSecurityPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[PodSecurityPolicySpec]): Self = {
        val ret = this.duplicate
