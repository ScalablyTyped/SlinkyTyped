...
trait PodSecurityPolicy extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy]] = js.native
  /**
...
object PodSecurityPolicy {
  ...
  implicit class PodSecurityPolicyOps[Self <: PodSecurityPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
