...
trait PodSecurityPolicy extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy]] = js.undefined
  /**
...
object PodSecurityPolicy {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicy] = null,
