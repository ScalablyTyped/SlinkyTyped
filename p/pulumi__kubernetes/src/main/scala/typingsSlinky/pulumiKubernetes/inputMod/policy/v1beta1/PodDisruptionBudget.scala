...
object PodDisruptionBudget {
  ...
  implicit class PodDisruptionBudgetOps[Self <: PodDisruptionBudget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[PodDisruptionBudgetSpec]): Self = {
        val ret = this.duplicate
