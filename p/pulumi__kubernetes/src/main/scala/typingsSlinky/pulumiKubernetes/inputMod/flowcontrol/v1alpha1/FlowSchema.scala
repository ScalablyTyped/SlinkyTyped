...
trait FlowSchema extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema]] = js.native
  /**
...
object FlowSchema {
  ...
  implicit class FlowSchemaOps[Self <: FlowSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[FlowSchemaSpec]): Self = {
        val ret = this.duplicate
