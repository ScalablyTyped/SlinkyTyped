...
trait EndpointsList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList]] = js.undefined
  /**
...
object EndpointsList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList] = null,
