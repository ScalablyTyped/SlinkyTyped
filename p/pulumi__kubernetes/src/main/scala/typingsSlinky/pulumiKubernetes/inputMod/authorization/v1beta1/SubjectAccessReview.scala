...
trait SubjectAccessReview extends js.Object {
  /**
    ...
    */
  var apiVersion: js.UndefOr[Input[authorizationDotk8sDotioSlashv1beta1]] = js.native
  /**
...
object SubjectAccessReview {
  ...
  implicit class SubjectAccessReviewOps[Self <: SubjectAccessReview] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApiVersion(value: Input[authorizationDotk8sDotioSlashv1beta1]): Self = {
        val ret = this.duplicate
