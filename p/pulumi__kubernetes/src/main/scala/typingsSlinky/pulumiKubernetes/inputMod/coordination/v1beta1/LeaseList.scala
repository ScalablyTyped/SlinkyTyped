...
trait LeaseList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LeaseList]] = js.undefined
  /**
...
object LeaseList {
  @scala.inline
  def apply(
    items: Input[js.Array[Input[Lease]]],
    apiVersion: Input[coordinationDotk8sDotioSlashv1beta1] = null,
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LeaseList] = null,
