...
trait LeaseList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[Lease]]] = js.native
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LeaseList]] = js.native
  /**
...
object LeaseList {
  @scala.inline
  def apply(items: Input[js.Array[Input[Lease]]]): LeaseList = {
  ...
  implicit class LeaseListOps[Self <: LeaseList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[Lease]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LeaseList]): Self = {
        val ret = this.duplicate
