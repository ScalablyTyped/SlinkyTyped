...
trait PersistentVolumeList extends js.Object {
  ...
  /**
    ...
    */
  var items: Input[js.Array[Input[PersistentVolume]]] = js.native
  /**
...
object PersistentVolumeList {
  @scala.inline
  def apply(items: Input[js.Array[Input[PersistentVolume]]]): PersistentVolumeList = {
  ...
  implicit class PersistentVolumeListOps[Self <: PersistentVolumeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItems(value: Input[js.Array[Input[PersistentVolume]]]): Self = {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeList]): Self = {
        val ret = this.duplicate
