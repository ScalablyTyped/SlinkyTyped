...
trait IngressClass extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass]] = js.undefined
  /**
...
object IngressClass {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass] = null,
    metadata: Input[ObjectMeta] = null,
    spec: Input[IngressClassSpec] = null
  ): IngressClass = {
