...
object IngressClass {
  ...
  implicit class IngressClassOps[Self <: IngressClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSpec(value: Input[IngressClassSpec]): Self = this.set("spec", value.asInstanceOf[js.Any])
    @scala.inline
