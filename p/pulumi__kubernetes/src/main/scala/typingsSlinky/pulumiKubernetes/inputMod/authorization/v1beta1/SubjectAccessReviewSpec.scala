...
object SubjectAccessReviewSpec {
  ...
  implicit class SubjectAccessReviewSpecOps[Self <: SubjectAccessReviewSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupVarargs(value: Input[String]*): Self = this.set("group", js.Array(value :_*))
    @scala.inline
    def setGroup(value: Input[js.Array[Input[String]]]): Self = this.set("group", value.asInstanceOf[js.Any])
    @scala.inline
