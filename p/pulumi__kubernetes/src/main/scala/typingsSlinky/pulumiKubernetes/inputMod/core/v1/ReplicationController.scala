...
object ReplicationController {
  ...
  implicit class ReplicationControllerOps[Self <: ReplicationController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[ReplicationControllerSpec]): Self = {
        val ret = this.duplicate
