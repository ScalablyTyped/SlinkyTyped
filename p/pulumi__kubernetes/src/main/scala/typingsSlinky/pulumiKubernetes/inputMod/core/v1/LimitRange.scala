...
trait LimitRange extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRange]] = js.native
  /**
...
object LimitRange {
  ...
  implicit class LimitRangeOps[Self <: LimitRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRange]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpec(value: Input[LimitRangeSpec]): Self = {
        val ret = this.duplicate
