...
object apiserviceListMod {
  ...
  trait APIServiceListArgs extends StObject {
    ...
    val items: Input[
        js.Array[
          Input[typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIService]
        ]
      ] = js.native
  ...
  object APIServiceListArgs {
    ...
    implicit class APIServiceListArgsMutableBuilder[Self <: APIServiceListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIService]*): Self = StObject.set(x, "items", js.Array(value :_*))
