...
object certificatesV1Mod extends js.Object {
  ...
  class CertificateSigningRequest protected ()
    extends typingsSlinky.pulumiKubernetes.v1CertificateSigningRequestMod.CertificateSigningRequest {
    /**
  ...
  class CertificateSigningRequestList protected ()
    extends typingsSlinky.pulumiKubernetes.v1CertificateSigningRequestListMod.CertificateSigningRequestList {
    /**
