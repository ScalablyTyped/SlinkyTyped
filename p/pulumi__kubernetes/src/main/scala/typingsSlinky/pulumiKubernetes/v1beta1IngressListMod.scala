...
object v1beta1IngressListMod {
  ...
  object IngressList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressList", "IngressList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressList", "IngressList.isInstance")
    @js.native
  ...
  trait IngressListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.Ingress]]
      ] = js.native
  ...
  object IngressListArgs {
    ...
    implicit class IngressListArgsMutableBuilder[Self <: IngressListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.Ingress]*): Self = StObject.set(x, "items", js.Array(value :_*))
