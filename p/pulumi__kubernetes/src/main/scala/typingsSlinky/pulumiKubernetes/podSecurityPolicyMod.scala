...
object podSecurityPolicyMod {
  ...
  trait PodSecurityPolicyArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicySpec]
      ] = js.native
  }
  object PodSecurityPolicyArgs {
    ...
    implicit class PodSecurityPolicyArgsMutableBuilder[Self <: PodSecurityPolicyArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicySpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
