...
object v1DaemonSetListMod {
  ...
  object DaemonSetList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/daemonSetList", "DaemonSetList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/daemonSetList", "DaemonSetList.isInstance")
    @js.native
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      * A list of daemon sets.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DaemonSet]]] = js.native
  ...
  object DaemonSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DaemonSet]]]): DaemonSetListArgs = {
    ...
    implicit class DaemonSetListArgsMutableBuilder[Self <: DaemonSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DaemonSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
