package typingsSlinky.pulumiKubernetes.v1beta1ReplicaSetMod

import typingsSlinky.pulumiKubernetes.outputMod.extensions.v1beta1.ReplicaSetSpec
import typingsSlinky.pulumiKubernetes.outputMod.extensions.v1beta1.ReplicaSetStatus
