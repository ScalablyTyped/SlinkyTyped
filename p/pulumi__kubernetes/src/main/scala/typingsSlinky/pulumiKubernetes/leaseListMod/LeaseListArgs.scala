...
import typingsSlinky.pulumiKubernetes.inputMod.coordination.v1beta1.Lease
...
object LeaseListArgs {
  ...
  implicit class LeaseListArgsOps[Self <: LeaseListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LeaseList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
