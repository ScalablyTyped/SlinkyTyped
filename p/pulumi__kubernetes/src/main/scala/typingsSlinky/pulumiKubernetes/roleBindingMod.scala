...
object roleBindingMod extends js.Object {
  ...
  class RoleBinding protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding,
