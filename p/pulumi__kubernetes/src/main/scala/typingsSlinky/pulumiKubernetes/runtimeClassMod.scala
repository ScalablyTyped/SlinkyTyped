...
@js.native
object runtimeClassMod extends js.Object {
  @js.native
  class RuntimeClass protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClass) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClass,
