...
object runtimeClassMod {
  ...
  class RuntimeClass protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass] = js.native
  ...
  trait RuntimeClassArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass]] = js.native
    ...
    /**
      * Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClassSpec] = js.native
  }
  object RuntimeClassArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClassSpec]): RuntimeClassArgs = {
    ...
    implicit class RuntimeClassArgsMutableBuilder[Self <: RuntimeClassArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1alpha1.RuntimeClassSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
