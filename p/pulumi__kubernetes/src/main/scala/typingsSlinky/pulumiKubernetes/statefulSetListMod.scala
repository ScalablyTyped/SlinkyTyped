...
import typingsSlinky.pulumiKubernetes.outputMod.apps.v1beta1.StatefulSet
...
object statefulSetListMod {
  ...
  trait StatefulSetListArgs extends StObject {
    ...
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]
      ] = js.native
  ...
  object StatefulSetListArgs {
    ...
    implicit class StatefulSetListArgsMutableBuilder[Self <: StatefulSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
