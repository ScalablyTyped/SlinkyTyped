...
@JSImport("@pulumi/kubernetes/authorization/v1beta1/SubjectAccessReview", JSImport.Namespace)
@js.native
object subjectAccessReviewMod extends js.Object {
  @js.native
  class SubjectAccessReview protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.authorization.v1beta1.SubjectAccessReview
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.authorization.v1beta1.SubjectAccessReview,
