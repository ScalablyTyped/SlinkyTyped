...
import typingsSlinky.pulumiKubernetes.outputMod.events.v1beta1.EventSeries
...
object v1beta1EventMod {
  ...
  trait EventArgs extends StObject {
    ...
    /**
      * deprecatedSource is the deprecated field assuring backward compatibility with core.v1 Event type.
      */
    val deprecatedSource: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventSource]] = js.native
    ...
    /**
      * regarding contains the object this Event is about. In most cases it's an Object reporting controller implements, e.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.
      */
    val regarding: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]] = js.native
    ...
    /**
      * series is data about the Event series this event represents or nil if it's a singleton Event.
      */
    val series: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.EventSeries]] = js.native
  ...
  object EventArgs {
    ...
    implicit class EventArgsMutableBuilder[Self <: EventArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDeprecatedSource(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.EventSource]): Self = StObject.set(x, "deprecatedSource", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRegarding(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]): Self = StObject.set(x, "regarding", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSeries(value: Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.EventSeries]): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
