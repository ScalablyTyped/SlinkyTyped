...
object v1DeploymentListMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1/deploymentList", "DeploymentList")
  @js.native
  ...
  object DeploymentList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/deploymentList", "DeploymentList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/deploymentList", "DeploymentList.isInstance")
    @js.native
  ...
  trait DeploymentListArgs extends StObject {
    ...
    /**
      * Items is the list of Deployments.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.Deployment]]] = js.native
  ...
  object DeploymentListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.Deployment]]]): DeploymentListArgs = {
    ...
    implicit class DeploymentListArgsMutableBuilder[Self <: DeploymentListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.Deployment]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1.Deployment]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DeploymentList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
