...
import typingsSlinky.pulumiKubernetes.inputMod.flowcontrol.v1alpha1.FlowSchemaSpec
...
@js.native
trait FlowSchemaArgs extends js.Object {
  /**
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[FlowSchemaSpec]] = js.native
}
...
object FlowSchemaArgs {
  ...
  @scala.inline
  implicit class FlowSchemaArgsOps[Self <: FlowSchemaArgs] (val x: Self) extends AnyVal {
    @scala.inline
