...
object eventsV1beta1Mod extends js.Object {
  ...
  class Event protected ()
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.Event) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.Event,
  ...
  class EventList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.EventList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.EventList,
      opts: CustomResourceOptions
    ) = this()
  }
