...
object limitRangeListMod {
  ...
  class LimitRangeList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList] = js.native
  ...
  trait LimitRangeListArgs extends StObject {
    ...
    /**
      * Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRange]]] = js.native
  ...
  object LimitRangeListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRange]]]): LimitRangeListArgs = {
    ...
    implicit class LimitRangeListArgsMutableBuilder[Self <: LimitRangeListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRange]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.LimitRange]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
