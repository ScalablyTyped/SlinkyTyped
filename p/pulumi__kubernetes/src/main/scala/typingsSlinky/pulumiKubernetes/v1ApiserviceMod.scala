...
object v1ApiserviceMod {
  ...
  object APIService {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiregistration/v1/apiservice", "APIService.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiregistration/v1/apiservice", "APIService.isInstance")
    @js.native
  ...
  trait APIServiceArgs extends StObject {
    ...
    /**
      * Spec contains information for locating and communicating with a server
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1.APIServiceSpec]] = js.native
  }
  object APIServiceArgs {
    ...
    implicit class APIServiceArgsMutableBuilder[Self <: APIServiceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.APIService]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1.APIServiceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
