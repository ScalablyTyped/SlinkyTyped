...
object clusterRoleMod extends js.Object {
  ...
  class ClusterRole protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole,
