...
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1alpha1.AggregationRule
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1alpha1.PolicyRule
...
object clusterRoleMod {
  ...
  object ClusterRole {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRole", "ClusterRole.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRole", "ClusterRole.isInstance")
    @js.native
  ...
  trait ClusterRoleArgs extends StObject {
    ...
    /**
      * AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.
      */
    val aggregationRule: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.AggregationRule]] = js.native
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRole]] = js.native
    ...
    val rules: js.UndefOr[
        Input[
          js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.PolicyRule]]
        ]
      ] = js.native
  }
  object ClusterRoleArgs {
    ...
    implicit class ClusterRoleArgsMutableBuilder[Self <: ClusterRoleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAggregationRule(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.AggregationRule]): Self = StObject.set(x, "aggregationRule", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRole]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRulesVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.PolicyRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
    }
  }
}
