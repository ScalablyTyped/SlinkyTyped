...
import typingsSlinky.pulumiKubernetes.outputMod.networking.v1beta1.IngressClassSpec
...
object ingressClassMod {
  
  @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClass", "IngressClass")
  @js.native
  class IngressClass protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass] = js.native
  ...
  object IngressClass {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClass", "IngressClass.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClass", "IngressClass.isInstance")
    @js.native
  ...
  trait IngressClassArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass]] = js.native
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.IngressClassSpec]
      ] = js.native
  }
  object IngressClassArgs {
    ...
    implicit class IngressClassArgsMutableBuilder[Self <: IngressClassArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.IngressClass]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.IngressClassSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
