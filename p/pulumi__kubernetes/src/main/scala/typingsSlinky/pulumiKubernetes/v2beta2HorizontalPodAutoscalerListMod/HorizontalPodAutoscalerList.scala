package typingsSlinky.pulumiKubernetes.v2beta2HorizontalPodAutoscalerListMod

import typingsSlinky.pulumiKubernetes.outputMod.autoscaling.v2beta2.HorizontalPodAutoscaler
