package typingsSlinky.pulumiKubernetes.statusMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.StatusDetails
...
trait StatusArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Status]] = js.native
  /**
...
object StatusArgs {
  ...
  implicit class StatusArgsOps[Self <: StatusArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Status]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
