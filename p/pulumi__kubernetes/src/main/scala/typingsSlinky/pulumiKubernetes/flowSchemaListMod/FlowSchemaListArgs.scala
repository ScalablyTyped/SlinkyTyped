package typingsSlinky.pulumiKubernetes.flowSchemaListMod

import typingsSlinky.pulumiKubernetes.inputMod.flowcontrol.v1alpha1.FlowSchema
...
object FlowSchemaListArgs {
  ...
  implicit class FlowSchemaListArgsOps[Self <: FlowSchemaListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]): Self = this.set("kind", value.asInstanceOf[js.Any])
