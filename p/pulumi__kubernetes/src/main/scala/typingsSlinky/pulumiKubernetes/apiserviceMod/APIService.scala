...
import typingsSlinky.pulumiKubernetes.outputMod.apiregistration.v1beta1.APIServiceSpec
import typingsSlinky.pulumiKubernetes.outputMod.apiregistration.v1beta1.APIServiceStatus
