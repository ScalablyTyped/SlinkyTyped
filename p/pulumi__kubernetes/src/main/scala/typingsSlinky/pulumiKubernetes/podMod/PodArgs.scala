...
import typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodSpec
...
@js.native
trait PodArgs extends js.Object {
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[PodSpec]] = js.native
}
object PodArgs {
  ...
  @scala.inline
  implicit class PodArgsOps[Self <: PodArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Pod]): Self = this.set("kind", value.asInstanceOf[js.Any])
