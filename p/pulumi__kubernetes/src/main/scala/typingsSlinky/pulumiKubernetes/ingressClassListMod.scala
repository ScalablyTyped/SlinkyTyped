...
object ingressClassListMod {
  ...
  trait IngressClassListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.IngressClass]]
      ] = js.native
  ...
  object IngressClassListArgs {
    ...
    implicit class IngressClassListArgsMutableBuilder[Self <: IngressClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1beta1.IngressClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
