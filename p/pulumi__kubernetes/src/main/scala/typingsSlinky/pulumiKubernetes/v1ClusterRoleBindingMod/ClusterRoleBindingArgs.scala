package typingsSlinky.pulumiKubernetes.v1ClusterRoleBindingMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ObjectMeta
import typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.RoleRef
import typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.Subject
...
object ClusterRoleBindingArgs {
  ...
  implicit class ClusterRoleBindingArgsOps[Self <: ClusterRoleBindingArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBinding]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
