package typingsSlinky.pulumiKubernetes.podPresetMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ObjectMeta
import typingsSlinky.pulumiKubernetes.inputMod.settings.v1alpha1.PodPresetSpec
...
@js.native
trait PodPresetArgs extends js.Object {
  /**
  ...
  val spec: js.UndefOr[Input[PodPresetSpec]] = js.native
}
...
object PodPresetArgs {
  ...
  @scala.inline
  implicit class PodPresetArgsOps[Self <: PodPresetArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodPreset]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
