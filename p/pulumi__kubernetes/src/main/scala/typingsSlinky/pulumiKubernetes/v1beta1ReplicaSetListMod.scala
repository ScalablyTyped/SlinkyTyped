...
object v1beta1ReplicaSetListMod {
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.ReplicaSet]]
      ] = js.native
  ...
  object ReplicaSetListArgs {
    ...
    implicit class ReplicaSetListArgsMutableBuilder[Self <: ReplicaSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.ReplicaSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
