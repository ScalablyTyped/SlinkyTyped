package typingsSlinky.pulumiKubernetes.v2beta2HorizontalPodAutoscalerMod

import typingsSlinky.pulumiKubernetes.inputMod.autoscaling.v2beta2.HorizontalPodAutoscalerSpec
