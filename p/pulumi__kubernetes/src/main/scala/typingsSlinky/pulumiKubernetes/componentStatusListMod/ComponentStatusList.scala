...
import typingsSlinky.pulumiKubernetes.outputMod.core.v1.ComponentStatus
...
class ComponentStatusList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList] = js.native
