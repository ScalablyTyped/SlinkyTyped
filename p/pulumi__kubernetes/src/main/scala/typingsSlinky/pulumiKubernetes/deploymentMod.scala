...
object deploymentMod {
  ...
  trait DeploymentArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of the Deployment.
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.DeploymentSpec]] = js.native
  }
  object DeploymentArgs {
    ...
    implicit class DeploymentArgsMutableBuilder[Self <: DeploymentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta1.DeploymentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
