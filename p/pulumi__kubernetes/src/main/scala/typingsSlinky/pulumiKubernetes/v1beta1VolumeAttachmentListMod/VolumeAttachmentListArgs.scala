package typingsSlinky.pulumiKubernetes.v1beta1VolumeAttachmentListMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment
...
object VolumeAttachmentListArgs {
  ...
  implicit class VolumeAttachmentListArgsOps[Self <: VolumeAttachmentListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
