package typingsSlinky.pulumiKubernetes.endpointSliceMod

import typingsSlinky.pulumiKubernetes.inputMod.discovery.v1beta1.Endpoint
import typingsSlinky.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointPort
...
@js.native
trait EndpointSliceArgs extends js.Object {
  /**
  ...
  /**
    ...
    */
  val endpoints: Input[js.Array[Input[Endpoint]]] = js.native
  /**
  ...
  /**
    ...
    */
  val ports: js.UndefOr[Input[js.Array[Input[EndpointPort]]]] = js.native
}

object EndpointSliceArgs {
  @scala.inline
  def apply(addressType: Input[String], endpoints: Input[js.Array[Input[Endpoint]]]): EndpointSliceArgs = {
  ...
  @scala.inline
  implicit class EndpointSliceArgsOps[Self <: EndpointSliceArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EndpointSlice]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
