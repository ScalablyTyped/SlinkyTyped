package typingsSlinky.pulumiKubernetes.v1beta1DaemonSetListMod

import typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet
...
object DaemonSetListArgs {
  ...
  implicit class DaemonSetListArgsOps[Self <: DaemonSetListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.DaemonSetList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
