...
@JSImport("@pulumi/kubernetes/certificates/v1beta1/CertificateSigningRequestList", JSImport.Namespace)
@js.native
object certificateSigningRequestListMod extends js.Object {
  @js.native
  class CertificateSigningRequestList protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.certificates.v1beta1.CertificateSigningRequestList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.certificates.v1beta1.CertificateSigningRequestList,
