...
object bindingMod {
  ...
  class Binding protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding] = js.native
  ...
  object Binding {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/binding", "Binding.get")
    @js.native
  ...
  trait BindingArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding]] = js.native
    ...
    /**
      * The target object that you want to bind to the standard object.
      */
    val target: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference] = js.native
  }
  object BindingArgs {
    
    @scala.inline
    def apply(target: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]): BindingArgs = {
      val __obj = js.Dynamic.literal(target = target.asInstanceOf[js.Any])
      __obj.asInstanceOf[BindingArgs]
    }
    
    @scala.inline
    implicit class BindingArgsMutableBuilder[Self <: BindingArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Binding]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTarget(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ObjectReference]): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
    }
  }
}
