...
object v1beta1PodSecurityPolicyListMod {
  ...
  trait PodSecurityPolicyListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicy]]
      ] = js.native
  ...
  object PodSecurityPolicyListArgs {
    ...
    implicit class PodSecurityPolicyListArgsMutableBuilder[Self <: PodSecurityPolicyListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicy]*): Self = StObject.set(x, "items", js.Array(value :_*))
