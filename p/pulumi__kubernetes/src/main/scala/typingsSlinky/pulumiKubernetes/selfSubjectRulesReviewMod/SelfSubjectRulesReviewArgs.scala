package typingsSlinky.pulumiKubernetes.selfSubjectRulesReviewMod

import typingsSlinky.pulumiKubernetes.inputMod.authorization.v1beta1.SelfSubjectRulesReviewSpec
...
object SelfSubjectRulesReviewArgs {
  ...
  implicit class SelfSubjectRulesReviewArgsOps[Self <: SelfSubjectRulesReviewArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
