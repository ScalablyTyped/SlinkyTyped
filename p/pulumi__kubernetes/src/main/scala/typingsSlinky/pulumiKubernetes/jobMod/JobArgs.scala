package typingsSlinky.pulumiKubernetes.jobMod

import typingsSlinky.pulumiKubernetes.inputMod.batch.v1.JobSpec
...
trait JobArgs extends js.Object {
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[JobSpec]] = js.native
}
object JobArgs {
  ...
  implicit class JobArgsOps[Self <: JobArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Job]): Self = this.set("kind", value.asInstanceOf[js.Any])
