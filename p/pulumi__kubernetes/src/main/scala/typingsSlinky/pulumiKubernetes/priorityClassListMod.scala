...
import typingsSlinky.pulumiKubernetes.outputMod.scheduling.v1alpha1.PriorityClass
...
object priorityClassListMod {
  ...
  object PriorityClassList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1alpha1/priorityClassList", "PriorityClassList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1alpha1/priorityClassList", "PriorityClassList.isInstance")
    @js.native
  ...
  trait PriorityClassListArgs extends StObject {
    ...
    /**
      * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
      */
    val apiVersion: js.UndefOr[Input[schedulingDotk8sDotioSlashv1alpha1]] = js.native
    
    /**
      * items is the list of PriorityClasses
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.scheduling.v1alpha1.PriorityClass]]
      ] = js.native
  ...
  object PriorityClassListArgs {
    ...
    implicit class PriorityClassListArgsMutableBuilder[Self <: PriorityClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.scheduling.v1alpha1.PriorityClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
