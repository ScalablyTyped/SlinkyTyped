...
object v1CsidriverListMod {
  ...
  trait CSIDriverListArgs extends StObject {
    ...
    /**
      * items is the list of CSIDriver
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriver]]] = js.native
  ...
  object CSIDriverListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriver]]]): CSIDriverListArgs = {
    ...
    implicit class CSIDriverListArgsMutableBuilder[Self <: CSIDriverListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriver]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriver]*): Self = StObject.set(x, "items", js.Array(value :_*))
