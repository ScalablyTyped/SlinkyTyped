...
object replicaSetMod {
  ...
  trait ReplicaSetArgs extends StObject {
    ...
    /**
      * Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSetSpec]] = js.native
  }
  object ReplicaSetArgs {
    ...
    implicit class ReplicaSetArgsMutableBuilder[Self <: ReplicaSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
