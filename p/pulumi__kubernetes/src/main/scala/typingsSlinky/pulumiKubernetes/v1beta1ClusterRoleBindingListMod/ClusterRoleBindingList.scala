package typingsSlinky.pulumiKubernetes.v1beta1ClusterRoleBindingListMod

import typingsSlinky.pulumiKubernetes.outputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1beta1.ClusterRoleBinding
...
@JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRoleBindingList", "ClusterRoleBindingList")
@js.native
class ClusterRoleBindingList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBindingList] = js.native
