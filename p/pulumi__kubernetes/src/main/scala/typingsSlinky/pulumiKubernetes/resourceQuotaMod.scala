...
object resourceQuotaMod {
  ...
  class ResourceQuota protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota] = js.native
  ...
  trait ResourceQuotaArgs extends StObject {
    ...
    /**
      * Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuotaSpec]] = js.native
  }
  object ResourceQuotaArgs {
    ...
    implicit class ResourceQuotaArgsMutableBuilder[Self <: ResourceQuotaArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuotaSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
