package typingsSlinky.pulumiKubernetes.v1CustomResourceDefinitionListMod

import typingsSlinky.pulumiKubernetes.inputMod.apiextensions.v1.CustomResourceDefinition
