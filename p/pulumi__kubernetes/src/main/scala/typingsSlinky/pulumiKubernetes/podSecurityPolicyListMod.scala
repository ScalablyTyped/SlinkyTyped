...
@JSImport("@pulumi/kubernetes/extensions/v1beta1/PodSecurityPolicyList", JSImport.Namespace)
@js.native
object podSecurityPolicyListMod extends js.Object {
  @js.native
  class PodSecurityPolicyList protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicyList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicyList,
