...
object csinodelistMod extends js.Object {
  ...
  class CSINodeList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINodeList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSINodeList,
