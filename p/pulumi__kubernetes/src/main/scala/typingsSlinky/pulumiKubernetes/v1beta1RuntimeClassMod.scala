...
object v1beta1RuntimeClassMod {
  ...
  trait RuntimeClassArgs extends StObject {
    ...
    /**
      * Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. For more details, see https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.
      */
    val overhead: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.Overhead]] = js.native
    
    /**
      * Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
      */
    val scheduling: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.Scheduling]] = js.native
  }
  object RuntimeClassArgs {
    ...
    implicit class RuntimeClassArgsMutableBuilder[Self <: RuntimeClassArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOverhead(value: Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.Overhead]): Self = StObject.set(x, "overhead", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOverheadUndefined: Self = StObject.set(x, "overhead", js.undefined)
      
      @scala.inline
      def setScheduling(value: Input[typingsSlinky.pulumiKubernetes.inputMod.node.v1beta1.Scheduling]): Self = StObject.set(x, "scheduling", value.asInstanceOf[js.Any])
