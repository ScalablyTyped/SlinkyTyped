...
object discoveryV1beta1Mod extends js.Object {
  ...
  class EndpointSlice protected ()
    extends typingsSlinky.pulumiKubernetes.endpointSliceMod.EndpointSlice {
    /**
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSlice) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSlice,
  ...
  class EndpointSliceList protected ()
    extends typingsSlinky.pulumiKubernetes.endpointSliceListMod.EndpointSliceList {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSliceList) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSliceList,
      opts: CustomResourceOptions
    ) = this()
  }
