...
object serviceMod {
  ...
  class Service protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service] = js.native
  ...
  object Service {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/service", "Service.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/service", "Service.isInstance")
    @js.native
  ...
  trait ServiceArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service]] = js.native
    ...
    /**
      * Spec defines the behavior of a service. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceSpec]] = js.native
  }
  object ServiceArgs {
    ...
    implicit class ServiceArgsMutableBuilder[Self <: ServiceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Service]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.ServiceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
