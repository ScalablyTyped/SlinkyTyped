...
object roleMod extends js.Object {
  ...
  class Role protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.Role) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.Role,
