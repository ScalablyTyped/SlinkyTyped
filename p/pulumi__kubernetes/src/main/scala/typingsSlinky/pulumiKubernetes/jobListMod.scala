...
object jobListMod {
  ...
  class JobList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.JobList] = js.native
  ...
  object JobList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/batch/v1/jobList", "JobList.get")
    @js.native
  ...
  trait JobListArgs extends StObject {
    ...
    /**
      * items is the list of Jobs.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1.Job]]] = js.native
  ...
  object JobListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1.Job]]]): JobListArgs = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
      __obj.asInstanceOf[JobListArgs]
    }
    
    @scala.inline
    implicit class JobListArgsMutableBuilder[Self <: JobListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1.Job]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.batch.v1.Job]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.JobList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
