...
object volumeAttachmentListMod {
  ...
  trait VolumeAttachmentListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachment]]
      ] = js.native
  ...
  object VolumeAttachmentListArgs {
    ...
    implicit class VolumeAttachmentListArgsMutableBuilder[Self <: VolumeAttachmentListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachment]*): Self = StObject.set(x, "items", js.Array(value :_*))
