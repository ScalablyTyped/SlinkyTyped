...
import typingsSlinky.pulumiKubernetes.v1PriorityClassListMod.PriorityClassListArgs
import typingsSlinky.pulumiKubernetes.v1PriorityClassMod.PriorityClassArgs
  ...
  object v1alpha1 extends js.Object {
    ...
    class PriorityClass protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.priorityClassMod.PriorityClassArgs) = this()
      def this(name: String, args: js.UndefOr[scala.Nothing], opts: CustomResourceOptions) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.priorityClassMod.PriorityClassArgs,
    ...
    class PriorityClassList protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.priorityClassListMod.PriorityClassListArgs) = this()
      def this(name: String, args: js.UndefOr[scala.Nothing], opts: CustomResourceOptions) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.priorityClassListMod.PriorityClassListArgs,
        opts: CustomResourceOptions
      ) = this()
    }
    /* static members */
  ...
  object v1beta1 extends js.Object {
    ...
    class PriorityClass protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.pulumiKubernetes.v1beta1PriorityClassMod.PriorityClassArgs) = this()
      def this(name: String, args: js.UndefOr[scala.Nothing], opts: CustomResourceOptions) = this()
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.v1beta1PriorityClassMod.PriorityClassArgs,
        opts: CustomResourceOptions
      ) = this()
    }
    /* static members */
    ...
    class PriorityClassList protected ()
      ...
      def this(
        name: String,
        args: typingsSlinky.pulumiKubernetes.v1beta1PriorityClassListMod.PriorityClassListArgs
      ) = this()
      def this(name: String, args: js.UndefOr[scala.Nothing], opts: CustomResourceOptions) = this()
      def this(
        name: String,
