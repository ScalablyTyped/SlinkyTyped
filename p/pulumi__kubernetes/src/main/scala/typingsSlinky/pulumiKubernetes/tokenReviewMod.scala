...
import typingsSlinky.pulumiKubernetes.outputMod.authentication.v1beta1.TokenReviewSpec
import typingsSlinky.pulumiKubernetes.outputMod.authentication.v1beta1.TokenReviewStatus
...
object tokenReviewMod {
  ...
  trait TokenReviewArgs extends StObject {
    ...
    /**
      * Spec holds information about the request being evaluated
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.authentication.v1beta1.TokenReviewSpec] = js.native
  }
  object TokenReviewArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.authentication.v1beta1.TokenReviewSpec]): TokenReviewArgs = {
    ...
    implicit class TokenReviewArgsMutableBuilder[Self <: TokenReviewArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.authentication.v1beta1.TokenReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
