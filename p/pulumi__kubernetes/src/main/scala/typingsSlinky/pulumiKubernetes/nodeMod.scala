...
object nodeMod {
  ...
  @JSImport("@pulumi/kubernetes/core/v1/node", "Node")
  @js.native
  class Node protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Node] = js.native
  ...
  object Node {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/node", "Node.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/node", "Node.isInstance")
    @js.native
  ...
  trait NodeArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Node]] = js.native
    ...
    /**
      * Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.NodeSpec]] = js.native
  }
  object NodeArgs {
    ...
    implicit class NodeArgsMutableBuilder[Self <: NodeArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.Node]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.NodeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
