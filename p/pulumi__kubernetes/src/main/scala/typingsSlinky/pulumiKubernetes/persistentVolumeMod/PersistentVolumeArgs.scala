package typingsSlinky.pulumiKubernetes.persistentVolumeMod
...
object PersistentVolumeArgs {
  ...
  implicit class PersistentVolumeArgsOps[Self <: PersistentVolumeArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume]): Self = this.set("kind", value.asInstanceOf[js.Any])
