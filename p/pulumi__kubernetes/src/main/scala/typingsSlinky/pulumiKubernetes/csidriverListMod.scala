...
import typingsSlinky.pulumiKubernetes.outputMod.storage.v1beta1.CSIDriver
...
object csidriverListMod {
  ...
  class CSIDriverList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList] = js.native
  ...
  object CSIDriverList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriverList", "CSIDriverList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriverList", "CSIDriverList.isInstance")
    @js.native
  ...
  trait CSIDriverListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriver]]
      ] = js.native
  ...
  object CSIDriverListArgs {
    ...
    implicit class CSIDriverListArgsMutableBuilder[Self <: CSIDriverListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriver]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
