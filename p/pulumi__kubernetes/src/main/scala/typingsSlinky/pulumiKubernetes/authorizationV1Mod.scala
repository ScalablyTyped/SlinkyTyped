...
object authorizationV1Mod extends js.Object {
  ...
  class LocalSubjectAccessReview protected ()
    extends typingsSlinky.pulumiKubernetes.v1LocalSubjectAccessReviewMod.LocalSubjectAccessReview {
    /**
  ...
  class SelfSubjectAccessReview protected ()
    extends typingsSlinky.pulumiKubernetes.v1SelfSubjectAccessReviewMod.SelfSubjectAccessReview {
    /**
  ...
  class SelfSubjectRulesReview protected ()
    extends typingsSlinky.pulumiKubernetes.v1SelfSubjectRulesReviewMod.SelfSubjectRulesReview {
    /**
  ...
  class SubjectAccessReview protected ()
    extends typingsSlinky.pulumiKubernetes.v1SubjectAccessReviewMod.SubjectAccessReview {
    /**
