...
object v1ClusterRoleListMod {
  ...
  object ClusterRoleList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/clusterRoleList", "ClusterRoleList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/clusterRoleList", "ClusterRoleList.isInstance")
    @js.native
  ...
  trait ClusterRoleListArgs extends StObject {
    ...
    /**
      * Items is a list of ClusterRoles
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.ClusterRole]]] = js.native
  ...
  object ClusterRoleListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.ClusterRole]]]): ClusterRoleListArgs = {
    ...
    implicit class ClusterRoleListArgsMutableBuilder[Self <: ClusterRoleListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.ClusterRole]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.ClusterRole]*): Self = StObject.set(x, "items", js.Array(value :_*))
