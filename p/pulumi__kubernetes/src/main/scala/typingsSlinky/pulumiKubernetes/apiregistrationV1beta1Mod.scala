...
import typingsSlinky.pulumiKubernetes.apiserviceListMod.APIServiceListArgs
import typingsSlinky.pulumiKubernetes.apiserviceMod.APIServiceArgs
...
object apiregistrationV1beta1Mod {
  ...
  class APIService protected ()
    extends typingsSlinky.pulumiKubernetes.apiserviceMod.APIService {
    /**
  ...
  class APIServiceList protected ()
    extends typingsSlinky.pulumiKubernetes.apiserviceListMod.APIServiceList {
    /**
