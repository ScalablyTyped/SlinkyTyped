...
object podDisruptionBudgetListMod {
  ...
  class PodDisruptionBudgetList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList] = js.native
  ...
  trait PodDisruptionBudgetListArgs extends StObject {
    ...
    val items: Input[
        js.Array[
          Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudget]
        ]
      ] = js.native
  ...
  object PodDisruptionBudgetListArgs {
    ...
    implicit class PodDisruptionBudgetListArgsMutableBuilder[Self <: PodDisruptionBudgetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudget]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
