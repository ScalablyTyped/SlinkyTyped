...
object priorityClassMod {
  ...
  class PriorityClass protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass] = js.native
  ...
  object PriorityClass {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1alpha1/priorityClass", "PriorityClass.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1alpha1/priorityClass", "PriorityClass.isInstance")
    @js.native
  ...
  trait PriorityClassArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass]] = js.native
  ...
  object PriorityClassArgs {
    ...
    implicit class PriorityClassArgsMutableBuilder[Self <: PriorityClassArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
