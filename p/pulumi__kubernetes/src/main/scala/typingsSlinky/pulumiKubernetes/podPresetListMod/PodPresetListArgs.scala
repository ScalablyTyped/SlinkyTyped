...
import typingsSlinky.pulumiKubernetes.inputMod.settings.v1alpha1.PodPreset
...
object PodPresetListArgs {
  ...
  implicit class PodPresetListArgsOps[Self <: PodPresetListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodPresetList]): Self = this.set("kind", value.asInstanceOf[js.Any])
