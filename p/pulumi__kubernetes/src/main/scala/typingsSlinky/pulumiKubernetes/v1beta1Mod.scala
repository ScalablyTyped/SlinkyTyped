...
object v1beta1Mod extends js.Object {
  ...
  class MutatingWebhookConfigurationList protected ()
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhookConfigurationList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhookConfigurationList,
  ...
  class ValidatingWebhookConfigurationList protected ()
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhookConfigurationList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhookConfigurationList,
