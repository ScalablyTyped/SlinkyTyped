...
import typingsSlinky.pulumiKubernetes.mutatingWebhookConfigurationListMod.MutatingWebhookConfigurationListArgs
import typingsSlinky.pulumiKubernetes.mutatingWebhookConfigurationMod.MutatingWebhookConfigurationArgs
import typingsSlinky.pulumiKubernetes.validatingWebhookConfigurationListMod.ValidatingWebhookConfigurationListArgs
import typingsSlinky.pulumiKubernetes.validatingWebhookConfigurationMod.ValidatingWebhookConfigurationArgs
...
object v1beta1Mod extends js.Object {
  ...
  class MutatingWebhookConfiguration protected ()
    extends typingsSlinky.pulumiKubernetes.mutatingWebhookConfigurationMod.MutatingWebhookConfiguration {
    /**
  ...
  class MutatingWebhookConfigurationList protected ()
    extends typingsSlinky.pulumiKubernetes.mutatingWebhookConfigurationListMod.MutatingWebhookConfigurationList {
    /**
  ...
  class ValidatingWebhookConfiguration protected ()
    extends typingsSlinky.pulumiKubernetes.validatingWebhookConfigurationMod.ValidatingWebhookConfiguration {
    /**
  ...
  class ValidatingWebhookConfigurationList protected ()
    extends typingsSlinky.pulumiKubernetes.validatingWebhookConfigurationListMod.ValidatingWebhookConfigurationList {
    /**
