...
object clusterRoleBindingMod extends js.Object {
  ...
  class ClusterRoleBinding protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRoleBinding) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRoleBinding,
