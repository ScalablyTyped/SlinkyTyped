...
object clusterRoleBindingMod {
  ...
  object ClusterRoleBinding {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRoleBinding", "ClusterRoleBinding.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRoleBinding", "ClusterRoleBinding.isInstance")
    @js.native
  ...
  object ClusterRoleBindingArgs {
    ...
    @scala.inline
    def apply(roleRef: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleRef]): ClusterRoleBindingArgs = {
