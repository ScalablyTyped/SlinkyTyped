...
object v1RoleBindingListMod {
  ...
  class RoleBindingList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList] = js.native
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      * Items is a list of RoleBindings
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList]] = js.native
  ...
  object RoleBindingListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]): RoleBindingListArgs = {
    ...
    implicit class RoleBindingListArgsMutableBuilder[Self <: RoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
