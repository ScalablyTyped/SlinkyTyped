...
object apiserviceMod {
  ...
  object APIService {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiregistration/v1beta1/apiservice", "APIService.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiregistration/v1beta1/apiservice", "APIService.isInstance")
    @js.native
  ...
  trait APIServiceArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceSpec]
      ] = js.native
  }
  object APIServiceArgs {
    ...
    implicit class APIServiceArgsMutableBuilder[Self <: APIServiceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
