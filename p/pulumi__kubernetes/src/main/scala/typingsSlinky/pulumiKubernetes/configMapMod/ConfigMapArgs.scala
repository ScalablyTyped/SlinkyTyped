...
trait ConfigMapArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMap]] = js.native
...
object ConfigMapArgs {
  ...
  implicit class ConfigMapArgsOps[Self <: ConfigMapArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ConfigMap]): Self = this.set("kind", value.asInstanceOf[js.Any])
