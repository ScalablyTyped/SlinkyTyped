package typingsSlinky.pulumiKubernetes.networkPolicyListMod

import typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy
...
object NetworkPolicyListArgs {
  ...
  implicit class NetworkPolicyListArgsOps[Self <: NetworkPolicyListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
