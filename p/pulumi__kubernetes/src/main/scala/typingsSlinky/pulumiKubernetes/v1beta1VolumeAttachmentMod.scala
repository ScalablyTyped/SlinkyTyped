...
object v1beta1VolumeAttachmentMod {
  ...
  trait VolumeAttachmentArgs extends StObject {
    ...
    /**
      * Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentSpec] = js.native
  }
  object VolumeAttachmentArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentSpec]): VolumeAttachmentArgs = {
    ...
    implicit class VolumeAttachmentArgsMutableBuilder[Self <: VolumeAttachmentArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
