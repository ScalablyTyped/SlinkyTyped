...
object persistentVolumeMod extends js.Object {
  ...
  class PersistentVolume protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolume) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.core.v1.PersistentVolume,
