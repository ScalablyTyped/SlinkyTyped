...
object v1EventListMod {
  ...
  object EventList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/events/v1/eventList", "EventList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/events/v1/eventList", "EventList.isInstance")
    @js.native
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      * items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1.Event]]] = js.native
  ...
  object EventListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1.Event]]]): EventListArgs = {
    ...
    implicit class EventListArgsMutableBuilder[Self <: EventListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1.Event]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1.Event]*): Self = StObject.set(x, "items", js.Array(value :_*))
