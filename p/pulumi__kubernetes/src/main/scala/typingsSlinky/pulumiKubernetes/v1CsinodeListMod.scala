...
object v1CsinodeListMod {
  ...
  trait CSINodeListArgs extends StObject {
    ...
    /**
      * items is the list of CSINode
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINode]]] = js.native
  ...
  object CSINodeListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINode]]]): CSINodeListArgs = {
    ...
    implicit class CSINodeListArgsMutableBuilder[Self <: CSINodeListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINode]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSINode]*): Self = StObject.set(x, "items", js.Array(value :_*))
