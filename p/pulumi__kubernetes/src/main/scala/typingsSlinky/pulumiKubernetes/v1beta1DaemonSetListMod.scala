...
object v1beta1DaemonSetListMod {
  ...
  object DaemonSetList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/extensions/v1beta1/daemonSetList", "DaemonSetList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/extensions/v1beta1/daemonSetList", "DaemonSetList.isInstance")
    @js.native
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet]]
      ] = js.native
  ...
  object DaemonSetListArgs {
    ...
    implicit class DaemonSetListArgsMutableBuilder[Self <: DaemonSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
