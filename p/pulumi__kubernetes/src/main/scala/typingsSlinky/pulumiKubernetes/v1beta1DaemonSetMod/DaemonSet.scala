package typingsSlinky.pulumiKubernetes.v1beta1DaemonSetMod

import typingsSlinky.pulumiKubernetes.outputMod.extensions.v1beta1.DaemonSetSpec
import typingsSlinky.pulumiKubernetes.outputMod.extensions.v1beta1.DaemonSetStatus
