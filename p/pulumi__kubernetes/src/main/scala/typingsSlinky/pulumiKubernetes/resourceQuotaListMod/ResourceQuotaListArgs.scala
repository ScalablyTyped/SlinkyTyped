package typingsSlinky.pulumiKubernetes.resourceQuotaListMod

import typingsSlinky.pulumiKubernetes.inputMod.core.v1.ResourceQuota
...
trait ResourceQuotaListArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuotaList]] = js.native
...
object ResourceQuotaListArgs {
  ...
  implicit class ResourceQuotaListArgsOps[Self <: ResourceQuotaListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuotaList]): Self = this.set("kind", value.asInstanceOf[js.Any])
