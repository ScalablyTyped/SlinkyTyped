package typingsSlinky.pulumiKubernetes.v1beta1PriorityClassMod
...
object PriorityClassArgs {
  ...
  implicit class PriorityClassArgsOps[Self <: PriorityClassArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
