...
import typingsSlinky.pulumiKubernetes.customResourceDefinitionListMod.CustomResourceDefinitionListArgs
import typingsSlinky.pulumiKubernetes.customResourceDefinitionMod.CustomResourceDefinitionArgs
...
object apiextensionsV1beta1Mod {
  ...
  class CustomResourceDefinition protected ()
    extends typingsSlinky.pulumiKubernetes.customResourceDefinitionMod.CustomResourceDefinition {
    /**
  ...
  class CustomResourceDefinitionList protected ()
    extends typingsSlinky.pulumiKubernetes.customResourceDefinitionListMod.CustomResourceDefinitionList {
    /**
