...
object tokenRequestMod {
  ...
  trait TokenRequestArgs extends StObject {
    ...
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenRequestSpec] = js.native
  }
  object TokenRequestArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenRequestSpec]): TokenRequestArgs = {
    ...
    implicit class TokenRequestArgsMutableBuilder[Self <: TokenRequestArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.TokenRequest]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.authentication.v1.TokenRequestSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
