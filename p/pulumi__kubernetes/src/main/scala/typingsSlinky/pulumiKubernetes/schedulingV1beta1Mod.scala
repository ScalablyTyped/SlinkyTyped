...
import typingsSlinky.pulumiKubernetes.v1beta1PriorityClassListMod.PriorityClassListArgs
import typingsSlinky.pulumiKubernetes.v1beta1PriorityClassMod.PriorityClassArgs
...
object schedulingV1beta1Mod extends js.Object {
  ...
  class PriorityClass protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsSlinky.pulumiKubernetes.v1beta1PriorityClassListMod.PriorityClassList {
    /**
