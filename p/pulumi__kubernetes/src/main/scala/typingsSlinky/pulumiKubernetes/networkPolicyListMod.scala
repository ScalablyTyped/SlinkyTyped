...
object networkPolicyListMod {
  ...
  trait NetworkPolicyListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy]]
      ] = js.native
  ...
  object NetworkPolicyListArgs {
    ...
    implicit class NetworkPolicyListArgsMutableBuilder[Self <: NetworkPolicyListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy]*): Self = StObject.set(x, "items", js.Array(value :_*))
