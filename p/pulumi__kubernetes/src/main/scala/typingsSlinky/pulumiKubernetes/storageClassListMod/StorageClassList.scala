package typingsSlinky.pulumiKubernetes.storageClassListMod

import typingsSlinky.pulumiKubernetes.outputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.outputMod.storage.v1beta1.StorageClass
...
class StorageClassList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList] = js.native
