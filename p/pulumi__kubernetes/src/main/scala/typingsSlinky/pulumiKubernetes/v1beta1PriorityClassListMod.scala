...
object v1beta1PriorityClassListMod {
  ...
  trait PriorityClassListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.scheduling.v1beta1.PriorityClass]]
      ] = js.native
  ...
  object PriorityClassListArgs {
    ...
    implicit class PriorityClassListArgsMutableBuilder[Self <: PriorityClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.scheduling.v1beta1.PriorityClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
