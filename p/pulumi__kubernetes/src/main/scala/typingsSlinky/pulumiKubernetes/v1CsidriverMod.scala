...
object v1CsidriverMod {
  ...
  trait CSIDriverArgs extends StObject {
    ...
    /**
      * Specification of the CSI Driver.
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriverSpec] = js.native
  }
  object CSIDriverArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriverSpec]): CSIDriverArgs = {
    ...
    implicit class CSIDriverArgsMutableBuilder[Self <: CSIDriverArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1.CSIDriverSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
