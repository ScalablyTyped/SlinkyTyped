...
object podTemplateListMod {
  ...
  class PodTemplateList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList] = js.native
  ...
  trait PodTemplateListArgs extends StObject {
    ...
    /**
      * List of pod templates
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplate]]] = js.native
  ...
  object PodTemplateListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplate]]]): PodTemplateListArgs = {
    ...
    implicit class PodTemplateListArgsMutableBuilder[Self <: PodTemplateListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplate]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.core.v1.PodTemplate]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
