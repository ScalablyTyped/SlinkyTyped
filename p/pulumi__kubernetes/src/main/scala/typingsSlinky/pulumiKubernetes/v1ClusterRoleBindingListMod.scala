...
object v1ClusterRoleBindingListMod {
  ...
  trait ClusterRoleBindingListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.ClusterRoleBinding]]
      ] = js.native
  ...
  object ClusterRoleBindingListArgs {
    ...
    implicit class ClusterRoleBindingListArgsMutableBuilder[Self <: ClusterRoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.rbac.v1.ClusterRoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBindingList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
