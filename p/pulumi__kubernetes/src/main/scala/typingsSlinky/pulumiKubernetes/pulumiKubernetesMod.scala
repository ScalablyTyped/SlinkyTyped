...
object pulumiKubernetesMod extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class RuntimeClass protected ()
      extends typingsSlinky.pulumiKubernetes.nodeV1alpha1Mod.RuntimeClass {
      /**
    ...
    class RuntimeClassList protected ()
      extends typingsSlinky.pulumiKubernetes.nodeV1alpha1Mod.RuntimeClassList {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class RuntimeClass protected ()
      extends typingsSlinky.pulumiKubernetes.nodeV1beta1Mod.RuntimeClass {
      /**
        * Create a RuntimeClass resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
    ...
    @js.native
    class RuntimeClassList protected ()
      extends typingsSlinky.pulumiKubernetes.nodeV1beta1Mod.RuntimeClassList {
      /**
        * Create a RuntimeClassList resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
