package typingsSlinky.pulumiKubernetes.clusterRoleListMod

import typingsSlinky.pulumiKubernetes.outputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.outputMod.rbac.v1alpha1.ClusterRole
...
@JSImport("@pulumi/kubernetes/rbac/v1alpha1/clusterRoleList", "ClusterRoleList")
@js.native
