...
object v1IngressClassMod {
  ...
  trait IngressClassArgs extends StObject {
    ...
    /**
      * Spec is the desired state of the IngressClass. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.IngressClassSpec]] = js.native
  }
  object IngressClassArgs {
    ...
    implicit class IngressClassArgsMutableBuilder[Self <: IngressClassArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.networking.v1.IngressClassSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
