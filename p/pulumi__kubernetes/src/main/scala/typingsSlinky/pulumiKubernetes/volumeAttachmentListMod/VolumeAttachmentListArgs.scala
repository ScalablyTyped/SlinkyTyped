package typingsSlinky.pulumiKubernetes.volumeAttachmentListMod

import typingsSlinky.pulumiKubernetes.inputMod.meta.v1.ListMeta
import typingsSlinky.pulumiKubernetes.inputMod.storage.v1alpha1.VolumeAttachment
...
object VolumeAttachmentListArgs {
  ...
  implicit class VolumeAttachmentListArgsOps[Self <: VolumeAttachmentListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: Input[storageDotk8sDotioSlashv1alpha1]): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
    @scala.inline
