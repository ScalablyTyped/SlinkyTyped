...
@js.native
object validatingWebhookConfigurationMod extends js.Object {
  @js.native
  class ValidatingWebhookConfiguration protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhookConfiguration
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhookConfiguration,
