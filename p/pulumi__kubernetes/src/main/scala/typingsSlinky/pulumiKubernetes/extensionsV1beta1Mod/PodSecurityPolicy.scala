...
class PodSecurityPolicy protected ()
  extends typingsSlinky.pulumiKubernetes.podSecurityPolicyMod.PodSecurityPolicy {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicy) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicy,
