...
class ReplicaSetList protected ()
  extends typingsSlinky.pulumiKubernetes.v1beta1ReplicaSetListMod.ReplicaSetList {
  /**
  ...
  def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.ReplicaSetList) = this()
  def this(
    name: String,
    args: typingsSlinky.pulumiKubernetes.inputMod.extensions.v1beta1.ReplicaSetList,
