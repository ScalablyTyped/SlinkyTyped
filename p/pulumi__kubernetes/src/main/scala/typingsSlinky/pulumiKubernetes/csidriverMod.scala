...
import typingsSlinky.pulumiKubernetes.outputMod.storage.v1beta1.CSIDriverSpec
...
object csidriverMod {
  ...
  class CSIDriver protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver] = js.native
  ...
  object CSIDriver {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriver", "CSIDriver.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriver", "CSIDriver.isInstance")
    @js.native
  ...
  trait CSIDriverArgs extends StObject {
    ...
    /**
      * Specification of the CSI Driver.
      */
    val spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverSpec] = js.native
  }
  object CSIDriverArgs {
    
    @scala.inline
    def apply(spec: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverSpec]): CSIDriverArgs = {
      val __obj = js.Dynamic.literal(spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[CSIDriverArgs]
    }
    
    @scala.inline
    implicit class CSIDriverArgsMutableBuilder[Self <: CSIDriverArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
