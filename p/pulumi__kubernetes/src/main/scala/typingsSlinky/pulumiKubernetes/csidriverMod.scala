...
@js.native
object csidriverMod extends js.Object {
  @js.native
  class CSIDriver protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriver) = this()
    def this(
      name: String,
      args: typingsSlinky.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriver,
