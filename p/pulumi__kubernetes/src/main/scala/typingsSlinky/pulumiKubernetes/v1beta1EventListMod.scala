...
object v1beta1EventListMod {
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      * items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.Event]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EventList]] = js.native
  ...
  object EventListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.Event]]]): EventListArgs = {
    ...
    implicit class EventListArgsMutableBuilder[Self <: EventListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.Event]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typingsSlinky.pulumiKubernetes.inputMod.events.v1beta1.Event]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typingsSlinky.pulumiKubernetes.pulumiKubernetesStrings.EventList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
