...
import typingsSlinky.atPulumiKubernetes.rbacV1beta1RoleBindingMod.RoleBinding
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ObjectMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1beta1.RoleRef
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1beta1.Subject
...
@JSImport("@pulumi/kubernetes/rbac/v1beta1/RoleBinding", JSImport.Namespace)
@js.native
object rbacV1beta1RoleBindingMod extends js.Object {
  @js.native
  class RoleBinding protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1beta1.RoleBinding) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1beta1.RoleBinding,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RoleBinding] = js.native
    /**
