...
import typingsSlinky.atPulumiKubernetes.appsV1beta1StatefulSetListMod.StatefulSetList
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta1.StatefulSet
...
@JSImport("@pulumi/kubernetes/apps/v1beta1/StatefulSetList", JSImport.Namespace)
@js.native
object appsV1beta1StatefulSetListMod extends js.Object {
  @js.native
