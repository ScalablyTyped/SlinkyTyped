...
import typingsSlinky.atPulumiKubernetes.appsV1beta2DaemonSetMod.DaemonSet
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta2.DaemonSetSpec
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta2.DaemonSetStatus
...
@js.native
object appsV1beta2DaemonSetMod extends js.Object {
  @js.native
  class DaemonSet protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.apps.v1beta2.DaemonSet) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apps.v1beta2.DaemonSet,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.DaemonSet] = js.native
    /**
