...
@JSImport("@pulumi/kubernetes/extensions/v1beta1/DaemonSetList", JSImport.Namespace)
@js.native
object extensionsV1beta1DaemonSetListMod extends js.Object {
  @js.native
  class DaemonSetList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.DaemonSetList] = js.native
    /**
