...
import typingsSlinky.atPulumiKubernetes.rbacV1beta1ClusterRoleListMod.ClusterRoleList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1beta1.ClusterRole
