...
import typingsSlinky.atPulumiKubernetes.batchV1beta1CronJobListMod.CronJobList
...
@js.native
object batchV1beta1CronJobListMod extends js.Object {
  @js.native
  class CronJobList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CronJobList] = js.native
    /**
