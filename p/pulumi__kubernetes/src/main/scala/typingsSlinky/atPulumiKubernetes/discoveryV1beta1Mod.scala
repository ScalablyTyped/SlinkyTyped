...
object discoveryV1beta1Mod extends js.Object {
  ...
  class EndpointSlice protected ()
    extends typingsSlinky.atPulumiKubernetes.discoveryV1beta1EndpointSliceMod.EndpointSlice {
    /**
  ...
  class EndpointSliceList protected ()
    extends typingsSlinky.atPulumiKubernetes.discoveryV1beta1EndpointSliceListMod.EndpointSliceList {
    /**
