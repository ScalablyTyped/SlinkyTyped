...
import typingsSlinky.atPulumiKubernetes.auditregistrationV1alpha1AuditSinkMod.AuditSink
...
@JSImport("@pulumi/kubernetes/auditregistration/v1alpha1/AuditSink", JSImport.Namespace)
@js.native
object auditregistrationV1alpha1AuditSinkMod extends js.Object {
  @js.native
  class AuditSink protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.AuditSink] = js.native
    val metadata: Output[ObjectMeta] = js.native
    /**
      * Spec defines the audit configuration spec
      */
    val spec: Output[AuditSinkSpec] = js.native
  }
