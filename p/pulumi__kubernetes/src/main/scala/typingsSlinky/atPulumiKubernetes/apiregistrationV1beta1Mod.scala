...
object apiregistrationV1beta1Mod extends js.Object {
  ...
  class APIService protected ()
    extends typingsSlinky.atPulumiKubernetes.apiregistrationV1beta1APIServiceMod.APIService {
    /**
  ...
  class APIServiceList protected ()
    extends typingsSlinky.atPulumiKubernetes.apiregistrationV1beta1APIServiceListMod.APIServiceList {
    /**
