...
object autoscalingV1Mod extends js.Object {
  ...
  class HorizontalPodAutoscaler protected ()
    extends typingsSlinky.atPulumiKubernetes.autoscalingV1HorizontalPodAutoscalerMod.HorizontalPodAutoscaler {
    /**
  ...
  class HorizontalPodAutoscalerList protected ()
    extends typingsSlinky.atPulumiKubernetes.autoscalingV1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList {
    /**
