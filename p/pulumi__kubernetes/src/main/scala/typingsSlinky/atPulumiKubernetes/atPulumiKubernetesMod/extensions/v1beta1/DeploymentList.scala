...
class DeploymentList protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsMod.v1beta1.DeploymentList {
  /**
...
object DeploymentList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1DeploymentListMod.DeploymentList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1DeploymentListMod.DeploymentList = js.native
  /**
