...
object auditregistration extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class AuditSink protected ()
      extends typingsSlinky.atPulumiKubernetes.auditregistrationMod.v1alpha1.AuditSink {
      /**
      ...
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.auditregistration.v1alpha1.AuditSink
      ) = this()
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.auditregistration.v1alpha1.AuditSink,
    ...
    class AuditSinkList protected ()
      extends typingsSlinky.atPulumiKubernetes.auditregistrationMod.v1alpha1.AuditSinkList {
      /**
      ...
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.auditregistration.v1alpha1.AuditSinkList
      ) = this()
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.auditregistration.v1alpha1.AuditSinkList,
    ...
    object AuditSink extends js.Object {
      /**
        ...
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.auditregistrationV1alpha1AuditSinkMod.AuditSink = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.auditregistrationV1alpha1AuditSinkMod.AuditSink = js.native
      /**
    ...
    object AuditSinkList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.auditregistrationV1alpha1AuditSinkListMod.AuditSinkList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.auditregistrationV1alpha1AuditSinkListMod.AuditSinkList = js.native
      /**
