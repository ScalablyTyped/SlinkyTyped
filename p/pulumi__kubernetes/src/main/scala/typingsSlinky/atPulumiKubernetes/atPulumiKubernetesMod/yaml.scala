...
object yaml extends js.Object {
  ...
  abstract class CollectionComponentResource protected ()
    extends typingsSlinky.atPulumiKubernetes.yamlMod.CollectionComponentResource {
  ...
  class ConfigFile protected ()
    extends typingsSlinky.atPulumiKubernetes.yamlMod.ConfigFile {
  ...
  class ConfigGroup protected ()
    extends typingsSlinky.atPulumiKubernetes.yamlMod.ConfigGroup {
