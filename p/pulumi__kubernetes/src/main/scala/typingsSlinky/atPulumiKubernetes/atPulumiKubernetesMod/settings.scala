...
object settings extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class PodPreset protected ()
      extends typingsSlinky.atPulumiKubernetes.settingsMod.v1alpha1.PodPreset {
      /**
      ...
      def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.settings.v1alpha1.PodPreset) = this()
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.settings.v1alpha1.PodPreset,
    ...
    class PodPresetList protected ()
      extends typingsSlinky.atPulumiKubernetes.settingsMod.v1alpha1.PodPresetList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.settings.v1alpha1.PodPresetList) = this()
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.settings.v1alpha1.PodPresetList,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    object PodPreset extends js.Object {
      /**
        ...
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.settingsV1alpha1PodPresetMod.PodPreset = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.settingsV1alpha1PodPresetMod.PodPreset = js.native
      /**
    ...
    object PodPresetList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.settingsV1alpha1PodPresetListMod.PodPresetList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.settingsV1alpha1PodPresetListMod.PodPresetList = js.native
      /**
