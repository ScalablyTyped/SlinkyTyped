...
object discovery extends js.Object {
  ...
  object v1beta1 extends js.Object {
    ...
    class EndpointSlice protected ()
      extends typingsSlinky.atPulumiKubernetes.discoveryMod.v1beta1.EndpointSlice {
      /**
    ...
    class EndpointSliceList protected ()
      extends typingsSlinky.atPulumiKubernetes.discoveryMod.v1beta1.EndpointSliceList {
      /**
      ...
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.discovery.v1beta1.EndpointSliceList
      ) = this()
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.discovery.v1beta1.EndpointSliceList,
    ...
    object EndpointSlice extends js.Object {
      /**
        ...
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.discoveryV1beta1EndpointSliceMod.EndpointSlice = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.discoveryV1beta1EndpointSliceMod.EndpointSlice = js.native
      /**
    ...
    object EndpointSliceList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.discoveryV1beta1EndpointSliceListMod.EndpointSliceList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.discoveryV1beta1EndpointSliceListMod.EndpointSliceList = js.native
      /**
