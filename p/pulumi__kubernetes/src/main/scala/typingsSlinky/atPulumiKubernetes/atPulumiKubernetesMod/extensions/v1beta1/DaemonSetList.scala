...
class DaemonSetList protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsMod.v1beta1.DaemonSetList {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetList
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetList,
...
object DaemonSetList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1DaemonSetListMod.DaemonSetList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1DaemonSetListMod.DaemonSetList = js.native
  /**
