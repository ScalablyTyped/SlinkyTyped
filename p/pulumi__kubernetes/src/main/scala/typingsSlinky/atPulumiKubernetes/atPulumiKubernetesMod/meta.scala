...
object meta extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class Status protected ()
      extends typingsSlinky.atPulumiKubernetes.metaMod.v1.Status {
      /**
      ...
      def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.meta.v1.Status) = this()
      def this(
        name: String,
        args: typingsSlinky.atPulumiKubernetes.typesInputMod.meta.v1.Status,
    ...
    object Status extends js.Object {
      /**
        ...
        */
      def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.metaV1StatusMod.Status = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.metaV1StatusMod.Status = js.native
      /**
