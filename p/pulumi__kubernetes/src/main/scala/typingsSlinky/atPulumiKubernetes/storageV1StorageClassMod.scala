...
@js.native
object storageV1StorageClassMod extends js.Object {
  @js.native
  class StorageClass protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.StorageClass) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.StorageClass,
