...
import typingsSlinky.atPulumiKubernetes.coreV1EventListMod.EventList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.core.v1.Event
...
@JSImport("@pulumi/kubernetes/core/v1/EventList", JSImport.Namespace)
@js.native
object coreV1EventListMod extends js.Object {
  @js.native
  class EventList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EventList] = js.native
    /**
