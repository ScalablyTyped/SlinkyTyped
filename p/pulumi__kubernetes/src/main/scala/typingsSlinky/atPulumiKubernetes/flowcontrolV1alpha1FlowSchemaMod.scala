...
@js.native
object flowcontrolV1alpha1FlowSchemaMod extends js.Object {
  @js.native
  class FlowSchema protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchema] = js.native
    /**
    ...
    /**
      ...
      */
    val spec: Output[FlowSchemaSpec] = js.native
    /**
      * `status` is the current status of a FlowSchema. More info:
      * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val status: Output[FlowSchemaStatus] = js.native
  }
