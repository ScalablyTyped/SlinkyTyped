...
class ReplicaSetList protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsV1beta1Mod.ReplicaSetList {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetList
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetList,
...
object ReplicaSetList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList = js.native
  /**
