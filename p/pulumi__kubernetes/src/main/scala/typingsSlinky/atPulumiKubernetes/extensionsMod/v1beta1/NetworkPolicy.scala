...
class NetworkPolicy protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsV1beta1Mod.NetworkPolicy {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicy
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicy,
...
object NetworkPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1NetworkPolicyMod.NetworkPolicy = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1NetworkPolicyMod.NetworkPolicy = js.native
  /**
