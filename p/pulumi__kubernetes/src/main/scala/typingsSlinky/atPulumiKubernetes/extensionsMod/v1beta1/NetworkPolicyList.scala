...
class NetworkPolicyList protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsV1beta1Mod.NetworkPolicyList {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicyList
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicyList,
...
object NetworkPolicyList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1NetworkPolicyListMod.NetworkPolicyList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1NetworkPolicyListMod.NetworkPolicyList = js.native
  /**
