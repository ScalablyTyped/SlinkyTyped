...
class PodSecurityPolicy protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsV1beta1Mod.PodSecurityPolicy {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.PodSecurityPolicy
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.PodSecurityPolicy,
...
object PodSecurityPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy = js.native
  /**
