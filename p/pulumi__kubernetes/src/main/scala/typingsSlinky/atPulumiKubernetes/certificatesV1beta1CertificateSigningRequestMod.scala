...
import typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest
...
@js.native
object certificatesV1beta1CertificateSigningRequestMod extends js.Object {
  @js.native
  class CertificateSigningRequest protected () extends CustomResource {
    ...
    /**
      ...
      */
    val spec: Output[CertificateSigningRequestSpec] = js.native
    /**
      * Derived information about the request.
      */
    val status: Output[CertificateSigningRequestStatus] = js.native
  }
