...
object apiextensionsV1beta1Mod extends js.Object {
  ...
  class CustomResourceDefinition protected ()
    extends typingsSlinky.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionMod.CustomResourceDefinition {
    /**
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apiextensions.v1beta1.CustomResourceDefinition
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apiextensions.v1beta1.CustomResourceDefinition,
  ...
  class CustomResourceDefinitionList protected ()
    extends typingsSlinky.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionListMod.CustomResourceDefinitionList {
    /**
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apiextensions.v1beta1.CustomResourceDefinitionList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apiextensions.v1beta1.CustomResourceDefinitionList,
  ...
  object CustomResourceDefinition extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionMod.CustomResourceDefinition = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionMod.CustomResourceDefinition = js.native
    /**
  ...
  object CustomResourceDefinitionList extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionListMod.CustomResourceDefinitionList = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionListMod.CustomResourceDefinitionList = js.native
    /**
