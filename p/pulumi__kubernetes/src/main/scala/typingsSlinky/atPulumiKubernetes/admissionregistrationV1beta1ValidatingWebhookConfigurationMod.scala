...
import typingsSlinky.atPulumiKubernetes.admissionregistrationV1beta1ValidatingWebhookConfigurationMod.ValidatingWebhookConfiguration
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`admissionregistrationDOTk8sDOTio/v1beta1`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.ValidatingWebhook
