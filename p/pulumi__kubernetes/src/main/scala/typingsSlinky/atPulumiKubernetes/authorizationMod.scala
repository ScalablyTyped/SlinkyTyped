...
object authorizationMod extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class LocalSubjectAccessReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1Mod.LocalSubjectAccessReview {
      /**
    ...
    class SelfSubjectAccessReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1Mod.SelfSubjectAccessReview {
      /**
    ...
    class SelfSubjectRulesReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1Mod.SelfSubjectRulesReview {
      /**
    ...
    class SubjectAccessReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1Mod.SubjectAccessReview {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class LocalSubjectAccessReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1Mod.LocalSubjectAccessReview {
      /**
    ...
    @js.native
    class SelfSubjectAccessReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1Mod.SelfSubjectAccessReview {
      /**
    ...
    @js.native
    class SelfSubjectRulesReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1Mod.SelfSubjectRulesReview {
      /**
    ...
    @js.native
    class SubjectAccessReview protected ()
      extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1Mod.SubjectAccessReview {
      /**
