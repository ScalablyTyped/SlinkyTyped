...
object schedulingV1beta1Mod extends js.Object {
  ...
  class PriorityClass protected ()
    extends typingsSlinky.atPulumiKubernetes.schedulingV1beta1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsSlinky.atPulumiKubernetes.schedulingV1beta1PriorityClassListMod.PriorityClassList {
    /**
