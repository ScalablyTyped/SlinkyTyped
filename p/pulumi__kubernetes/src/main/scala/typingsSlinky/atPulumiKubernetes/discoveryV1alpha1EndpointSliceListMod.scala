...
import typingsSlinky.atPulumiKubernetes.discoveryV1alpha1EndpointSliceListMod.EndpointSliceList
...
@JSImport("@pulumi/kubernetes/discovery/v1alpha1/EndpointSliceList", JSImport.Namespace)
@js.native
object discoveryV1alpha1EndpointSliceListMod extends js.Object {
  @js.native
  class EndpointSliceList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSliceList] = js.native
    /**
