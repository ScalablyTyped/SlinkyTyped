...
import typingsSlinky.atPulumiKubernetes.rbacV1alpha1ClusterRoleBindingMod.ClusterRoleBinding
...
@js.native
object rbacV1alpha1ClusterRoleBindingMod extends js.Object {
  @js.native
