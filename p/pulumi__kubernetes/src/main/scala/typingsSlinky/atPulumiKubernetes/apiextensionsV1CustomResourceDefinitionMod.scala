...
import typingsSlinky.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionMod.CustomResourceDefinition
...
object apiextensionsV1CustomResourceDefinitionMod extends js.Object {
  ...
  class CustomResourceDefinition protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apiextensions.v1.CustomResourceDefinition
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apiextensions.v1.CustomResourceDefinition,
