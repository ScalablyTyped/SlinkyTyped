...
import typingsSlinky.atPulumiKubernetes.admissionregistrationV1beta1ValidatingWebhookConfigurationListMod.ValidatingWebhookConfigurationList
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`admissionregistrationDOTk8sDOTio/v1beta1`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.ValidatingWebhookConfiguration
...
@JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/ValidatingWebhookConfigurationList", JSImport.Namespace)
@js.native
object admissionregistrationV1beta1ValidatingWebhookConfigurationListMod extends js.Object {
  @js.native
  class ValidatingWebhookConfigurationList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[
        typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ValidatingWebhookConfigurationList
      ] = js.native
    /**
