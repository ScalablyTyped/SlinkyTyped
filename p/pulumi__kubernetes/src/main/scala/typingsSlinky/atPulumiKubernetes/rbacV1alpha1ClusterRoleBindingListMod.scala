...
import typingsSlinky.atPulumiKubernetes.rbacV1alpha1ClusterRoleBindingListMod.ClusterRoleBindingList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1alpha1.ClusterRoleBinding
...
@JSImport("@pulumi/kubernetes/rbac/v1alpha1/ClusterRoleBindingList", JSImport.Namespace)
@js.native
object rbacV1alpha1ClusterRoleBindingListMod extends js.Object {
  @js.native
  class ClusterRoleBindingList protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleBindingList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleBindingList,
    ...
    /**
      ...
      */
    val kind: Output[
        typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ClusterRoleBindingList
      ] = js.native
    /**
