...
import typingsSlinky.atPulumiKubernetes.storageV1VolumeAttachmentMod.VolumeAttachment
...
@js.native
object storageV1VolumeAttachmentMod extends js.Object {
  @js.native
  class VolumeAttachment protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.VolumeAttachment) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.VolumeAttachment,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachment] = js.native
    /**
