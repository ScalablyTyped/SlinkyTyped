...
import typingsSlinky.atPulumiKubernetes.coreV1LimitRangeMod.LimitRange
...
@JSImport("@pulumi/kubernetes/core/v1/LimitRange", JSImport.Namespace)
@js.native
object coreV1LimitRangeMod extends js.Object {
  @js.native
  class LimitRange protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.LimitRange] = js.native
    /**
    ...
    /**
      ...
      */
    val spec: Output[LimitRangeSpec] = js.native
  }
