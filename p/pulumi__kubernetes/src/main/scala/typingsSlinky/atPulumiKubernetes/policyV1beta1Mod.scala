...
object policyV1beta1Mod extends js.Object {
  ...
  class PodDisruptionBudget protected ()
    extends typingsSlinky.atPulumiKubernetes.policyV1beta1PodDisruptionBudgetMod.PodDisruptionBudget {
    /**
  ...
  class PodDisruptionBudgetList protected ()
    extends typingsSlinky.atPulumiKubernetes.policyV1beta1PodDisruptionBudgetListMod.PodDisruptionBudgetList {
    /**
  ...
  class PodSecurityPolicy protected ()
    extends typingsSlinky.atPulumiKubernetes.policyV1beta1PodSecurityPolicyMod.PodSecurityPolicy {
    /**
  ...
  class PodSecurityPolicyList protected ()
    extends typingsSlinky.atPulumiKubernetes.policyV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList {
    /**
