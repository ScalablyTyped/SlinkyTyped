...
import typingsSlinky.atPulumiKubernetes.appsV1beta2ControllerRevisionMod.ControllerRevision
...
object appsV1beta2ControllerRevisionMod extends js.Object {
  ...
  class ControllerRevision protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.apps.v1beta2.ControllerRevision) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apps.v1beta2.ControllerRevision,
