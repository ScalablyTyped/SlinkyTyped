...
import typingsSlinky.atPulumiKubernetes.coreV1PersistentVolumeMod.PersistentVolume
...
@js.native
object coreV1PersistentVolumeMod extends js.Object {
  @js.native
  class PersistentVolume protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.PersistentVolume) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.PersistentVolume,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolume] = js.native
    /**
