...
object nodeV1beta1Mod extends js.Object {
  ...
  class RuntimeClass protected ()
    extends typingsSlinky.atPulumiKubernetes.nodeV1beta1RuntimeClassMod.RuntimeClass {
    /**
  ...
  class RuntimeClassList protected ()
    extends typingsSlinky.atPulumiKubernetes.nodeV1beta1RuntimeClassListMod.RuntimeClassList {
    /**
