...
@JSImport("@pulumi/kubernetes/storage/v1/CSINode", JSImport.Namespace)
@js.native
object storageV1CSINodeMod extends js.Object {
  @js.native
  class CSINode protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.CSINode) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.CSINode,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CSINode] = js.native
    /**
