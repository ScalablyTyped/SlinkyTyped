...
import typingsSlinky.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSet
