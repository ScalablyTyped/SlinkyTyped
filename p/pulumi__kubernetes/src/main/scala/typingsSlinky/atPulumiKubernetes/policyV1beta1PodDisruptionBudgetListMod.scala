...
import typingsSlinky.atPulumiKubernetes.policyV1beta1PodDisruptionBudgetListMod.PodDisruptionBudgetList
...
object policyV1beta1PodDisruptionBudgetListMod extends js.Object {
  ...
  class PodDisruptionBudgetList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[
        typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudgetList
      ] = js.native
