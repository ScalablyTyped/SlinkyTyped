...
import typingsSlinky.atPulumiKubernetes.storageV1StorageClassListMod.StorageClassList
...
object storageV1StorageClassListMod extends js.Object {
  ...
  class StorageClassList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.StorageClassList) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.StorageClassList,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClassList] = js.native
    /**
