...
import typingsSlinky.atPulumiKubernetes.batchV1JobMod.Job
...
@js.native
object batchV1JobMod extends js.Object {
  @js.native
  class Job protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Job] = js.native
    /**
