...
import typingsSlinky.atPulumiKubernetes.rbacV1beta1RoleListMod.RoleList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1beta1.Role
...
@js.native
object rbacV1beta1RoleListMod extends js.Object {
  @js.native
  class RoleList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1beta1.RoleList) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1beta1.RoleList,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RoleList] = js.native
    /**
