...
import typingsSlinky.atPulumiKubernetes.storageV1VolumeAttachmentListMod.VolumeAttachmentList
...
@JSImport("@pulumi/kubernetes/storage/v1/VolumeAttachmentList", JSImport.Namespace)
@js.native
object storageV1VolumeAttachmentListMod extends js.Object {
  @js.native
  class VolumeAttachmentList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.VolumeAttachmentList) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1.VolumeAttachmentList,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachmentList] = js.native
    /**
