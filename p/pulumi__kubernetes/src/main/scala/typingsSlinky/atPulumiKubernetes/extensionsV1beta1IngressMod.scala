...
import typingsSlinky.atPulumiKubernetes.extensionsV1beta1IngressMod.Ingress
...
@JSImport("@pulumi/kubernetes/extensions/v1beta1/Ingress", JSImport.Namespace)
@js.native
object extensionsV1beta1IngressMod extends js.Object {
  @js.native
  class Ingress protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.Ingress) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.Ingress,
