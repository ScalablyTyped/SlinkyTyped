...
import typingsSlinky.atPulumiKubernetes.storageV1beta1StorageClassMod.StorageClass
...
@js.native
object storageV1beta1StorageClassMod extends js.Object {
  @js.native
  class StorageClass protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1beta1.StorageClass) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1beta1.StorageClass,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClass] = js.native
    /**
