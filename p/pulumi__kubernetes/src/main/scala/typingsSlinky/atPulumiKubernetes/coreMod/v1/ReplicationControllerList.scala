...
class ReplicationControllerList protected ()
  extends typingsSlinky.atPulumiKubernetes.coreV1Mod.ReplicationControllerList {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.ReplicationControllerList
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.ReplicationControllerList,
...
object ReplicationControllerList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.coreV1ReplicationControllerListMod.ReplicationControllerList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.coreV1ReplicationControllerListMod.ReplicationControllerList = js.native
  /**
