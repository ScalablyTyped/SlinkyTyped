package typingsSlinky.atPulumiKubernetes.storageMod
...
object v1alpha1 extends js.Object {
  ...
  class VolumeAttachment protected ()
    extends typingsSlinky.atPulumiKubernetes.storageV1alpha1Mod.VolumeAttachment {
    /**
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachment
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachment,
  ...
  class VolumeAttachmentList protected ()
    extends typingsSlinky.atPulumiKubernetes.storageV1alpha1Mod.VolumeAttachmentList {
    /**
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachmentList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachmentList,
  ...
  object VolumeAttachment extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentMod.VolumeAttachment = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentMod.VolumeAttachment = js.native
    /**
  ...
  object VolumeAttachmentList extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentListMod.VolumeAttachmentList = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentListMod.VolumeAttachmentList = js.native
    /**
