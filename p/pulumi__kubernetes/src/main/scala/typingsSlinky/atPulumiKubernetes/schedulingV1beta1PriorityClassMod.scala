...
import typingsSlinky.atPulumiKubernetes.schedulingV1beta1PriorityClassMod.PriorityClass
...
@js.native
object schedulingV1beta1PriorityClassMod extends js.Object {
  @js.native
  class PriorityClass protected () extends CustomResource {
    ...
    /**
      ...
      */
    val globalDefault: Output[Boolean] = js.native
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClass] = js.native
    /**
    ...
    /**
      ...
      */
    val preemptionPolicy: Output[String] = js.native
    /**
