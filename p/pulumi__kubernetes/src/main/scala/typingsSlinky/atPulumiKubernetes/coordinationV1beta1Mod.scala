...
object coordinationV1beta1Mod extends js.Object {
  ...
  class Lease protected ()
    extends typingsSlinky.atPulumiKubernetes.coordinationV1beta1LeaseMod.Lease {
    /**
  ...
  class LeaseList protected ()
    extends typingsSlinky.atPulumiKubernetes.coordinationV1beta1LeaseListMod.LeaseList {
    /**
