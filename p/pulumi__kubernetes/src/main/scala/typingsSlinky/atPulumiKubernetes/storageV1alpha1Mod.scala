...
object storageV1alpha1Mod extends js.Object {
  ...
  class VolumeAttachment protected ()
    extends typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentMod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentListMod.VolumeAttachmentList {
    /**
