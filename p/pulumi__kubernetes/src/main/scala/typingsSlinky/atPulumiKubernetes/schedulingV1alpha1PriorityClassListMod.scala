...
import typingsSlinky.atPulumiKubernetes.schedulingV1alpha1PriorityClassListMod.PriorityClassList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.scheduling.v1alpha1.PriorityClass
