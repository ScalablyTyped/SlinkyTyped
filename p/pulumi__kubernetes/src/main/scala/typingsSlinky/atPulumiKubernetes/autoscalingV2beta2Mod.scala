...
@js.native
object autoscalingV2beta2Mod extends js.Object {
  @js.native
  class HorizontalPodAutoscaler protected ()
    extends typingsSlinky.atPulumiKubernetes.autoscalingV2beta2HorizontalPodAutoscalerMod.HorizontalPodAutoscaler {
    /**
  ...
  class HorizontalPodAutoscalerList protected ()
    extends typingsSlinky.atPulumiKubernetes.autoscalingV2beta2HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList {
    /**
