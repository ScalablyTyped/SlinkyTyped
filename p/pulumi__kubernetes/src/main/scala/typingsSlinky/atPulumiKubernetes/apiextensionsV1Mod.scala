...
object apiextensionsV1Mod extends js.Object {
  ...
  class CustomResourceDefinition protected ()
    extends typingsSlinky.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionMod.CustomResourceDefinition {
    /**
  ...
  class CustomResourceDefinitionList protected ()
    extends typingsSlinky.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionListMod.CustomResourceDefinitionList {
    /**
