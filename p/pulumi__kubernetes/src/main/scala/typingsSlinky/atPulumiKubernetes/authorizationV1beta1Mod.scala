...
object authorizationV1beta1Mod extends js.Object {
  ...
  class LocalSubjectAccessReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1LocalSubjectAccessReviewMod.LocalSubjectAccessReview {
    /**
  ...
  class SelfSubjectAccessReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1SelfSubjectAccessReviewMod.SelfSubjectAccessReview {
    /**
  ...
  class SelfSubjectRulesReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1SelfSubjectRulesReviewMod.SelfSubjectRulesReview {
    /**
  ...
  class SubjectAccessReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1beta1SubjectAccessReviewMod.SubjectAccessReview {
    /**
