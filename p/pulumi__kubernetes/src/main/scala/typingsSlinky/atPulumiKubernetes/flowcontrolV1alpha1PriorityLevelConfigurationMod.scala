...
@js.native
object flowcontrolV1alpha1PriorityLevelConfigurationMod extends js.Object {
  @js.native
  class PriorityLevelConfiguration protected () extends CustomResource {
    ...
    /**
      ...
      */
    val spec: Output[PriorityLevelConfigurationSpec] = js.native
    /**
      * `status` is the current status of a "request-priority". More info:
      * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val status: Output[PriorityLevelConfigurationStatus] = js.native
  }
