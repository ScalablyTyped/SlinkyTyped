...
import typingsSlinky.atPulumiKubernetes.storageV1alpha1VolumeAttachmentMod.VolumeAttachment
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ObjectMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachmentSpec
import typingsSlinky.atPulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachmentStatus
