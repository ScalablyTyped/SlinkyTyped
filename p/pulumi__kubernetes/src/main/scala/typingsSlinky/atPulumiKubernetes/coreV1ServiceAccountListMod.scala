...
@js.native
object coreV1ServiceAccountListMod extends js.Object {
  @js.native
  class ServiceAccountList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.ServiceAccountList) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.ServiceAccountList,
    ...
    /**
      ...
      */
    val items: Output[js.Array[ServiceAccount]] = js.native
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ServiceAccountList] = js.native
    /**
