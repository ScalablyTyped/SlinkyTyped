...
import typingsSlinky.atPulumiKubernetes.coreV1EndpointsMod.Endpoints
...
@JSImport("@pulumi/kubernetes/core/v1/Endpoints", JSImport.Namespace)
@js.native
object coreV1EndpointsMod extends js.Object {
  @js.native
  class Endpoints protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Endpoints] = js.native
    /**
