...
import typingsSlinky.atPulumiKubernetes.policyV1beta1PodDisruptionBudgetMod.PodDisruptionBudget
...
@js.native
object policyV1beta1PodDisruptionBudgetMod extends js.Object {
  @js.native
  class PodDisruptionBudget protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudget] = js.native
