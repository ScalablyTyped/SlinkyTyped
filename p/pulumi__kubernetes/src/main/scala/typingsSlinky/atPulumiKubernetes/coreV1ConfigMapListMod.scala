...
import typingsSlinky.atPulumiKubernetes.coreV1ConfigMapListMod.ConfigMapList
...
@JSImport("@pulumi/kubernetes/core/v1/ConfigMapList", JSImport.Namespace)
@js.native
object coreV1ConfigMapListMod extends js.Object {
  @js.native
  class ConfigMapList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val items: Output[js.Array[ConfigMap]] = js.native
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ConfigMapList] = js.native
    /**
      * More info:
