...
import typingsSlinky.atPulumiKubernetes.authorizationV1beta1SelfSubjectAccessReviewMod.SelfSubjectAccessReview
import typingsSlinky.atPulumiKubernetes.typesOutputMod.authorization.v1beta1.SelfSubjectAccessReviewSpec
