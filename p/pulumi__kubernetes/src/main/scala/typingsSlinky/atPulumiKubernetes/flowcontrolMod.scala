...
object flowcontrolMod extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class FlowSchema protected ()
      extends typingsSlinky.atPulumiKubernetes.flowcontrolV1alpha1Mod.FlowSchema {
      /**
    ...
    class FlowSchemaList protected ()
      extends typingsSlinky.atPulumiKubernetes.flowcontrolV1alpha1Mod.FlowSchemaList {
      /**
    ...
    class PriorityLevelConfiguration protected ()
      extends typingsSlinky.atPulumiKubernetes.flowcontrolV1alpha1Mod.PriorityLevelConfiguration {
      /**
    ...
    class PriorityLevelConfigurationList protected ()
      extends typingsSlinky.atPulumiKubernetes.flowcontrolV1alpha1Mod.PriorityLevelConfigurationList {
      /**
