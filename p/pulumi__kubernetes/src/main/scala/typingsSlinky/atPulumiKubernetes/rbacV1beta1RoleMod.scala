...
import typingsSlinky.atPulumiKubernetes.rbacV1beta1RoleMod.Role
...
@JSImport("@pulumi/kubernetes/rbac/v1beta1/Role", JSImport.Namespace)
@js.native
object rbacV1beta1RoleMod extends js.Object {
  @js.native
