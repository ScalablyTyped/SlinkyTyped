...
import typingsSlinky.atPulumiKubernetes.appsV1beta2ReplicaSetMod.ReplicaSet
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta2.ReplicaSetSpec
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta2.ReplicaSetStatus
...
object appsV1beta2ReplicaSetMod extends js.Object {
  ...
  class ReplicaSet protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.apps.v1beta2.ReplicaSet) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.apps.v1beta2.ReplicaSet,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicaSet] = js.native
    /**
