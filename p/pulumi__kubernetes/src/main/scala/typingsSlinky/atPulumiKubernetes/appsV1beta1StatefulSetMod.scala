...
import typingsSlinky.atPulumiKubernetes.appsV1beta1StatefulSetMod.StatefulSet
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta1.StatefulSetSpec
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta1.StatefulSetStatus
