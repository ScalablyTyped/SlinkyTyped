...
trait LocalSubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.LocalSubjectAccessReview
...
object LocalSubjectAccessReview {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.LocalSubjectAccessReview,
    metadata: ObjectMeta,
