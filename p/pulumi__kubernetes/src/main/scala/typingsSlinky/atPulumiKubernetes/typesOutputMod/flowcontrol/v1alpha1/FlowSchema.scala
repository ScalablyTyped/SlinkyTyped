...
trait FlowSchema extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchema
  /**
...
object FlowSchema {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchema,
    metadata: ObjectMeta,
    spec: FlowSchemaSpec,
