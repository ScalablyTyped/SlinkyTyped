package typingsSlinky.atPulumiKubernetes.typesOutputMod.admissionregistration.v1beta1
...
trait ValidatingWebhookConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ValidatingWebhookConfigurationList
  /**
...
object ValidatingWebhookConfigurationList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ValidatingWebhookConfigurationList,
    metadata: ListMeta
