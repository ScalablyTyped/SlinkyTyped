...
trait CertificateSigningRequestList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CertificateSigningRequestList
...
object CertificateSigningRequestList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CertificateSigningRequestList,
    metadata: ListMeta
