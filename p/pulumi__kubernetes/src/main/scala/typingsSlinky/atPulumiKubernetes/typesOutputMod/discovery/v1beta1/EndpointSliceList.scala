package typingsSlinky.atPulumiKubernetes.typesOutputMod.discovery.v1beta1
...
trait EndpointSliceList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSliceList
  /**
...
object EndpointSliceList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSliceList,
    metadata: ListMeta
  ): EndpointSliceList = {
