...
trait StorageClass extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClass
  /**
...
object StorageClass {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClass,
    metadata: ObjectMeta,
