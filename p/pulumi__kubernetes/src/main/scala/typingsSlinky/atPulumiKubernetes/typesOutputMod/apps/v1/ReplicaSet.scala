...
trait ReplicaSet extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicaSet
  /**
...
object ReplicaSet {
  ...
  def apply(
    apiVersion: `apps/v1`,
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicaSet,
    metadata: ObjectMeta,
    spec: ReplicaSetSpec,
