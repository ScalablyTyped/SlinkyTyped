...
trait PodSecurityPolicy extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodSecurityPolicy
  /**
...
object PodSecurityPolicy {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodSecurityPolicy,
    metadata: ObjectMeta,
