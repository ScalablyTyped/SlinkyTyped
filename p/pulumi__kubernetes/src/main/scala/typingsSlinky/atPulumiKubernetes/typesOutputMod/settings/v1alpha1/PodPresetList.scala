...
trait PodPresetList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodPresetList
  /**
...
object PodPresetList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodPresetList,
    metadata: ListMeta
  ): PodPresetList = {
