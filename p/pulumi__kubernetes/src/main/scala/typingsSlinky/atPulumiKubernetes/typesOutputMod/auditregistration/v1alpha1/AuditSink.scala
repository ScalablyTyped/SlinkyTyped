...
trait AuditSink extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.AuditSink
...
object AuditSink {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.AuditSink,
    metadata: ObjectMeta,
    spec: AuditSinkSpec
  ): AuditSink = {
