...
trait PersistentVolume extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolume
  /**
...
object PersistentVolume {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolume,
    metadata: ObjectMeta,
