...
trait CSINodeList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CSINodeList
  /**
...
object CSINodeList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CSINodeList,
    metadata: ListMeta
  ): CSINodeList = {
