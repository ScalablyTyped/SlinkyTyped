...
trait PodSecurityPolicyList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodSecurityPolicyList
  /**
...
object PodSecurityPolicyList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodSecurityPolicyList,
    metadata: ListMeta
