package typingsSlinky.atPulumiKubernetes.typesOutputMod.scheduling.v1
...
trait PriorityClass extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClass
  /**
...
object PriorityClass {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClass,
    metadata: ObjectMeta,
