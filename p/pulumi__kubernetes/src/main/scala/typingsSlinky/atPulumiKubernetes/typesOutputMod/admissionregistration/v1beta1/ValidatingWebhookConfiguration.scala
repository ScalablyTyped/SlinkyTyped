...
trait ValidatingWebhookConfiguration extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ValidatingWebhookConfiguration
  /**
...
object ValidatingWebhookConfiguration {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ValidatingWebhookConfiguration,
    metadata: ObjectMeta,
