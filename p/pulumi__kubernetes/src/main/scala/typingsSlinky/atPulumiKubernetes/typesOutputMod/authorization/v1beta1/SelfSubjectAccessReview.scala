...
trait SelfSubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.SelfSubjectAccessReview
...
object SelfSubjectAccessReview {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.SelfSubjectAccessReview,
    metadata: ObjectMeta,
