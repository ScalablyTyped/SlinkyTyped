...
trait RoleBinding extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RoleBinding
  /**
...
object RoleBinding {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RoleBinding,
    metadata: ObjectMeta,
    roleRef: RoleRef,
