...
trait RuntimeClass extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RuntimeClass
  /**
    * More info:
...
object RuntimeClass {
  ...
  def apply(
    ...
    handler: String,
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RuntimeClass,
    metadata: ObjectMeta,
    overhead: Overhead,
