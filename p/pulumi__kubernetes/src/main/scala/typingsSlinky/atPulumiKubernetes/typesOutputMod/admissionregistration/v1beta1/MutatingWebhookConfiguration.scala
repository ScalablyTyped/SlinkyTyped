...
trait MutatingWebhookConfiguration extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.MutatingWebhookConfiguration
  /**
...
object MutatingWebhookConfiguration {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.MutatingWebhookConfiguration,
    metadata: ObjectMeta,
