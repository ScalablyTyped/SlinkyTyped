...
trait NetworkPolicyList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicyList
  /**
...
object NetworkPolicyList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicyList,
    metadata: ListMeta
  ): NetworkPolicyList = {
