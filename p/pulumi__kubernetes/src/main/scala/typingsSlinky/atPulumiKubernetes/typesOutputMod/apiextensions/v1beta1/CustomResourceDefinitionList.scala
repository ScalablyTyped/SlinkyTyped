package typingsSlinky.atPulumiKubernetes.typesOutputMod.apiextensions.v1beta1
...
trait CustomResourceDefinitionList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CustomResourceDefinitionList
...
object CustomResourceDefinitionList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CustomResourceDefinitionList,
    metadata: ListMeta
