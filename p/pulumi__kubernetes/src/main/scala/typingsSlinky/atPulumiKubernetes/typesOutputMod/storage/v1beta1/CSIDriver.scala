...
trait CSIDriver extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CSIDriver
  /**
...
object CSIDriver {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CSIDriver,
    metadata: ObjectMeta,
    spec: CSIDriverSpec
  ): CSIDriver = {
