...
trait PriorityLevelConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityLevelConfigurationList
  /**
...
object PriorityLevelConfigurationList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityLevelConfigurationList,
    metadata: ListMeta
