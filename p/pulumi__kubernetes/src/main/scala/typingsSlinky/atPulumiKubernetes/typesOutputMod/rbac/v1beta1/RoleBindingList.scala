...
trait RoleBindingList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RoleBindingList
  /**
...
object RoleBindingList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RoleBindingList,
    metadata: ListMeta
  ): RoleBindingList = {
