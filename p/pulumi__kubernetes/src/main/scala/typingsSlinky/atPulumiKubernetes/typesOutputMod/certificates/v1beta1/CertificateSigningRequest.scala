package typingsSlinky.atPulumiKubernetes.typesOutputMod.certificates.v1beta1
...
trait CertificateSigningRequest extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CertificateSigningRequest
...
object CertificateSigningRequest {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CertificateSigningRequest,
    metadata: ObjectMeta,
