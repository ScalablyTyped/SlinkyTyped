...
trait VolumeAttachmentList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachmentList
  /**
...
object VolumeAttachmentList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachmentList,
    metadata: ListMeta
