...
trait PriorityLevelConfiguration extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityLevelConfiguration
  /**
...
object PriorityLevelConfiguration {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityLevelConfiguration,
    metadata: ObjectMeta,
