...
trait NetworkPolicy extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicy
  /**
...
object NetworkPolicy {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicy,
    metadata: ObjectMeta,
