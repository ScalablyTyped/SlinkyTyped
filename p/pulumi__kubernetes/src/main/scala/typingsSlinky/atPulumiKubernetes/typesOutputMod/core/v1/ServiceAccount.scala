...
trait ServiceAccount extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ServiceAccount
  /**
...
object ServiceAccount {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ServiceAccount,
    metadata: ObjectMeta,
