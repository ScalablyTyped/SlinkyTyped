...
trait PodDisruptionBudget extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudget
...
object PodDisruptionBudget {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudget,
    metadata: ObjectMeta,
