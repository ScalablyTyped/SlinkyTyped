...
trait TokenRequest extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.TokenRequest
...
object TokenRequest {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.TokenRequest,
    metadata: ObjectMeta,
