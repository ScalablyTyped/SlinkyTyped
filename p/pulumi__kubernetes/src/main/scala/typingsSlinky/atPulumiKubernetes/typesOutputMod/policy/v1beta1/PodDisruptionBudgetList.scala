package typingsSlinky.atPulumiKubernetes.typesOutputMod.policy.v1beta1
...
trait PodDisruptionBudgetList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudgetList
...
object PodDisruptionBudgetList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudgetList,
    metadata: ListMeta
