package typingsSlinky.atPulumiKubernetes.typesOutputMod.autoscaling.v2beta2
...
trait HorizontalPodAutoscalerList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.HorizontalPodAutoscalerList
  /**
