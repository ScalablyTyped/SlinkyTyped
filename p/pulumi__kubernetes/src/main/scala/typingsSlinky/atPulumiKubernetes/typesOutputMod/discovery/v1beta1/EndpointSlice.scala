...
trait EndpointSlice extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSlice
  /**
...
object EndpointSlice {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSlice,
    metadata: ObjectMeta,
