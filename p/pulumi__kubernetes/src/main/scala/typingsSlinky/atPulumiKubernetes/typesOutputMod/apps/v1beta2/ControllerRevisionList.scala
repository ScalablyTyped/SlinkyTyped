package typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta2
...
trait ControllerRevisionList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ControllerRevisionList
  /**
    * More info:
...
object ControllerRevisionList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ControllerRevisionList,
    metadata: ListMeta
