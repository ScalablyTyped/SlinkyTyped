package typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta1
...
trait StatefulSet extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StatefulSet
...
object StatefulSet {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StatefulSet,
    metadata: ObjectMeta,
