package typingsSlinky.atPulumiKubernetes.typesOutputMod.authorization.v1
...
trait SelfSubjectRulesReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.SelfSubjectRulesReview
...
object SelfSubjectRulesReview {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.SelfSubjectRulesReview,
    metadata: ObjectMeta,
