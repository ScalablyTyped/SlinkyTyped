...
trait ReplicaSetList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicaSetList
  /**
...
object ReplicaSetList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicaSetList,
    metadata: ListMeta
  ): ReplicaSetList = {
