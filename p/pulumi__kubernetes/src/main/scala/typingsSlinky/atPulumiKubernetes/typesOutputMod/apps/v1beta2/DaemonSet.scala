...
trait DaemonSet extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.DaemonSet
  /**
...
object DaemonSet {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.DaemonSet,
    metadata: ObjectMeta,
    spec: DaemonSetSpec,
