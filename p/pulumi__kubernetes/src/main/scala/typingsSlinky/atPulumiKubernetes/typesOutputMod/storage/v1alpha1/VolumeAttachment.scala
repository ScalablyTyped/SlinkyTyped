package typingsSlinky.atPulumiKubernetes.typesOutputMod.storage.v1alpha1
...
trait VolumeAttachment extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachment
  /**
...
object VolumeAttachment {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachment,
    metadata: ObjectMeta,
