package typingsSlinky.atPulumiKubernetes.typesOutputMod.networking.v1beta1
...
trait Ingress extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Ingress
  /**
...
object Ingress {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Ingress,
    metadata: ObjectMeta,
    spec: IngressSpec,
