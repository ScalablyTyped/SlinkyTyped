...
trait DeploymentList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.DeploymentList
  /**
...
object DeploymentList {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.DeploymentList,
    metadata: ListMeta
  ): DeploymentList = {
