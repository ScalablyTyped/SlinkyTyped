...
trait Endpoints extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Endpoints
  /**
...
object Endpoints {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Endpoints,
    metadata: ObjectMeta,
