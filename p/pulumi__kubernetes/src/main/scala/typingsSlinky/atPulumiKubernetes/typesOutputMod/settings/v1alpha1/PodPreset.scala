package typingsSlinky.atPulumiKubernetes.typesOutputMod.settings.v1alpha1
...
trait PodPreset extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodPreset
...
object PodPreset {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodPreset,
    metadata: ObjectMeta,
    spec: PodPresetSpec
  ): PodPreset = {
