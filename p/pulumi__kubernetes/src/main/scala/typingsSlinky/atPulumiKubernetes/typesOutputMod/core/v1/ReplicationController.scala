...
trait ReplicationController extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicationController
  /**
...
object ReplicationController {
  ...
  def apply(
    ...
    kind: typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicationController,
    metadata: ObjectMeta,
