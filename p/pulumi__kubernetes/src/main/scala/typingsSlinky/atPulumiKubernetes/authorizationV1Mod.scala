...
object authorizationV1Mod extends js.Object {
  ...
  class LocalSubjectAccessReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1LocalSubjectAccessReviewMod.LocalSubjectAccessReview {
    /**
  ...
  class SelfSubjectAccessReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1SelfSubjectAccessReviewMod.SelfSubjectAccessReview {
    /**
  ...
  class SelfSubjectRulesReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1SelfSubjectRulesReviewMod.SelfSubjectRulesReview {
    /**
  ...
  class SubjectAccessReview protected ()
    extends typingsSlinky.atPulumiKubernetes.authorizationV1SubjectAccessReviewMod.SubjectAccessReview {
    /**
