...
import typingsSlinky.atPulumiKubernetes.batchV2alpha1CronJobMod.CronJob
import typingsSlinky.atPulumiKubernetes.typesOutputMod.batch.v2alpha1.CronJobSpec
import typingsSlinky.atPulumiKubernetes.typesOutputMod.batch.v2alpha1.CronJobStatus
