...
class PodSecurityPolicyList protected ()
  extends typingsSlinky.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.PodSecurityPolicyList
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.extensions.v1beta1.PodSecurityPolicyList,
...
object PodSecurityPolicyList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList = js.native
  /**
