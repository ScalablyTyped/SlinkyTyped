...
import typingsSlinky.atPulumiKubernetes.appsV1beta2ReplicaSetListMod.ReplicaSetList
import typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typingsSlinky.atPulumiKubernetes.typesOutputMod.apps.v1beta2.ReplicaSet
