...
object schedulingV1alpha1Mod extends js.Object {
  ...
  class PriorityClass protected ()
    extends typingsSlinky.atPulumiKubernetes.schedulingV1alpha1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsSlinky.atPulumiKubernetes.schedulingV1alpha1PriorityClassListMod.PriorityClassList {
    /**
