...
object schedulingV1Mod extends js.Object {
  ...
  class PriorityClass protected ()
    extends typingsSlinky.atPulumiKubernetes.schedulingV1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsSlinky.atPulumiKubernetes.schedulingV1PriorityClassListMod.PriorityClassList {
    /**
