...
trait VolumeAttachmentList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachmentList]
  ] = js.undefined
  /**
...
object VolumeAttachmentList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.VolumeAttachmentList] = null,
