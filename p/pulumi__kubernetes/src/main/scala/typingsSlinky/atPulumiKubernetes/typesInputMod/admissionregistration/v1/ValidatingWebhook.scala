package typingsSlinky.atPulumiKubernetes.typesInputMod.admissionregistration.v1

import typingsSlinky.atPulumiKubernetes.typesInputMod.meta.v1.LabelSelector
