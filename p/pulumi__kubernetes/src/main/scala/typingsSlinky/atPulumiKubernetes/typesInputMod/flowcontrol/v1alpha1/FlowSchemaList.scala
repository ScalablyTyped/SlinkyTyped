...
trait FlowSchemaList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchemaList]] = js.undefined
  /**
...
object FlowSchemaList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchemaList] = null,
