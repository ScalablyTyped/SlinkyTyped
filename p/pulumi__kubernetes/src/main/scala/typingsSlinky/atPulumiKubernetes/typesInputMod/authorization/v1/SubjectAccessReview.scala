...
trait SubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.SubjectAccessReview]
  ] = js.undefined
...
object SubjectAccessReview {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.SubjectAccessReview] = null,
