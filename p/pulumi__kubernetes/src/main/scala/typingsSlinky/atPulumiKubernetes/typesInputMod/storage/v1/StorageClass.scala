...
import typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.TopologySelectorTerm
...
trait StorageClass extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClass]] = js.undefined
  /**
...
object StorageClass {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClass] = null,
