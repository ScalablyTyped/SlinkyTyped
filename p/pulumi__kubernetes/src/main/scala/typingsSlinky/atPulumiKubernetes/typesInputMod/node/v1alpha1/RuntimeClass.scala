...
trait RuntimeClass extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RuntimeClass]] = js.undefined
  /**
    * More info:
...
object RuntimeClass {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RuntimeClass] = null,
