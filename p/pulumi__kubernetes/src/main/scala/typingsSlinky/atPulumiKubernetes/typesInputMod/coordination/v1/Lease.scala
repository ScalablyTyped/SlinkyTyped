package typingsSlinky.atPulumiKubernetes.typesInputMod.coordination.v1
...
trait Lease extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Lease]] = js.undefined
  /**
    * More info:
...
object Lease {
  @scala.inline
  def apply(
    apiVersion: Input[coordinationDotk8sDotioSlashv1] = null,
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Lease] = null,
    metadata: Input[ObjectMeta] = null,
    spec: Input[LeaseSpec] = null
  ): Lease = {
