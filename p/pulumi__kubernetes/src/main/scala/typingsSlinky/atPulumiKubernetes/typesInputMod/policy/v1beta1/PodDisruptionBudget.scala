...
trait PodDisruptionBudget extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudget]
  ] = js.undefined
...
object PodDisruptionBudget {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PodDisruptionBudget] = null,
