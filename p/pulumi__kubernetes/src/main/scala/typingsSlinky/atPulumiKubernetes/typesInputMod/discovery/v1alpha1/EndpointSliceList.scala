package typingsSlinky.atPulumiKubernetes.typesInputMod.discovery.v1alpha1
...
trait EndpointSliceList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSliceList]
  ] = js.undefined
  /**
...
object EndpointSliceList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.EndpointSliceList] = null,
