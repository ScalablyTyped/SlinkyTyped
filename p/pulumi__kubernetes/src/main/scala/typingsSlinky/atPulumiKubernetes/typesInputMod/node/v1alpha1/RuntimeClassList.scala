...
trait RuntimeClassList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RuntimeClassList]
  ] = js.undefined
  /**
...
object RuntimeClassList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.RuntimeClassList] = null,
