package typingsSlinky.atPulumiKubernetes.typesInputMod.scheduling.v1
...
trait PriorityClass extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClass]] = js.undefined
  /**
...
object PriorityClass {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClass] = null,
