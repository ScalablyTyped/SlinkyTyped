...
trait ClusterRoleList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ClusterRoleList]
  ] = js.undefined
  /**
...
object ClusterRoleList {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ClusterRoleList] = null,
