...
trait NetworkPolicy extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicy]] = js.undefined
  /**
...
object NetworkPolicy {
  ...
  def apply(
    ...
    kind: Input[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicy] = null,
