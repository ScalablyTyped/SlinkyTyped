...
class PersistentVolumeClaimList protected ()
  extends typingsSlinky.atPulumiKubernetes.coreV1PersistentVolumeClaimListMod.PersistentVolumeClaimList {
  /**
  ...
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.PersistentVolumeClaimList
  ) = this()
  def this(
    name: String,
    args: typingsSlinky.atPulumiKubernetes.typesInputMod.core.v1.PersistentVolumeClaimList,
...
object PersistentVolumeClaimList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.coreV1PersistentVolumeClaimListMod.PersistentVolumeClaimList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.coreV1PersistentVolumeClaimListMod.PersistentVolumeClaimList = js.native
  /**
