...
class Node protected ()
  extends typingsSlinky.atPulumiKubernetes.coreV1NodeMod.Node {
  /**
...
object Node extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.coreV1NodeMod.Node = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.coreV1NodeMod.Node = js.native
  /**
