...
object certificatesV1beta1Mod extends js.Object {
  ...
  class CertificateSigningRequest protected ()
    extends typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest {
    /**
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequest
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequest,
  ...
  class CertificateSigningRequestList protected ()
    extends typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestListMod.CertificateSigningRequestList {
    /**
    ...
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequestList
    ) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequestList,
  ...
  object CertificateSigningRequest extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest = js.native
    /**
  ...
  object CertificateSigningRequestList extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: String, id: Input[ID]): typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestListMod.CertificateSigningRequestList = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsSlinky.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestListMod.CertificateSigningRequestList = js.native
    /**
