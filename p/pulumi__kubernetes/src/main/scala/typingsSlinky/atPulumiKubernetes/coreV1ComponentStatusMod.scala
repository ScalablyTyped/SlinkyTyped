...
@js.native
object coreV1ComponentStatusMod extends js.Object {
  @js.native
  class ComponentStatus protected () extends CustomResource {
    ...
    /**
      ...
      */
    val conditions: Output[js.Array[ComponentCondition]] = js.native
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.ComponentStatus] = js.native
    /**
