...
import typingsSlinky.atPulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList
import typingsSlinky.atPulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscaler
...
@JSImport("@pulumi/kubernetes/autoscaling/v2beta1/HorizontalPodAutoscalerList", JSImport.Namespace)
@js.native
object autoscalingV2beta1HorizontalPodAutoscalerListMod extends js.Object {
  @js.native
  class HorizontalPodAutoscalerList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[
        typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.HorizontalPodAutoscalerList
      ] = js.native
    /**
