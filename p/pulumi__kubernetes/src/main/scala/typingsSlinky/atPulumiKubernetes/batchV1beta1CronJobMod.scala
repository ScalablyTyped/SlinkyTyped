...
import typingsSlinky.atPulumiKubernetes.batchV1beta1CronJobMod.CronJob
...
@JSImport("@pulumi/kubernetes/batch/v1beta1/CronJob", JSImport.Namespace)
@js.native
object batchV1beta1CronJobMod extends js.Object {
  @js.native
  class CronJob protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.batch.v1beta1.CronJob) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.batch.v1beta1.CronJob,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.CronJob] = js.native
    /**
