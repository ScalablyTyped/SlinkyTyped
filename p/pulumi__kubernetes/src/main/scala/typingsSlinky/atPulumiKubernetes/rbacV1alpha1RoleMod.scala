...
import typingsSlinky.atPulumiKubernetes.rbacV1alpha1RoleMod.Role
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ObjectMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1alpha1.PolicyRule
...
object rbacV1alpha1RoleMod extends js.Object {
  ...
  class Role protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.Role) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.Role,
    ...
    /**
      ...
      */
    val kind: Output[typingsSlinky.atPulumiKubernetes.atPulumiKubernetesStrings.Role] = js.native
    /**
