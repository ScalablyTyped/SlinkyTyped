...
import typingsSlinky.atPulumiKubernetes.rbacV1alpha1RoleBindingMod.RoleBinding
import typingsSlinky.atPulumiKubernetes.typesOutputMod.meta.v1.ObjectMeta
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1alpha1.RoleRef
import typingsSlinky.atPulumiKubernetes.typesOutputMod.rbac.v1alpha1.Subject
...
object rbacV1alpha1RoleBindingMod extends js.Object {
  ...
  class RoleBinding protected () extends CustomResource {
    ...
    def this(name: String, args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleBinding) = this()
    def this(
      name: String,
      args: typingsSlinky.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleBinding,
