...
object domelementMod extends Shortcut {
  
  @JSImport("pretty-format/build/plugins/DOMElement", JSImport.Default)
  @js.native
  ...
  @JSImport("pretty-format/build/plugins/DOMElement", "test")
  @js.native
  val test: Test = js.native
  
  type _To = NewPlugin
  
  /* This means you don't have to write `default`, but can instead just say `domelementMod.foo` */
