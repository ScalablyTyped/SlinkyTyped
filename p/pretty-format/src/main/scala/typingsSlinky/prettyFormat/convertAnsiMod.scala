...
object convertAnsiMod extends Shortcut {
  ...
  @JSImport("pretty-format/build/plugins/ConvertAnsi", JSImport.Default)
  @js.native
  val default: NewPlugin = js.native
  
  @JSImport("pretty-format/build/plugins/ConvertAnsi", "serialize")
  @js.native
  ...
  @JSImport("pretty-format/build/plugins/ConvertAnsi", "test")
  @js.native
  val test: Test = js.native
  
  type _To = NewPlugin
  
  /* This means you don't have to write `default`, but can instead just say `convertAnsiMod.foo` */
