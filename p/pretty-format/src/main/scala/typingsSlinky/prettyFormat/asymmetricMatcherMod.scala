...
object asymmetricMatcherMod extends Shortcut {
  
  @JSImport("pretty-format/build/plugins/AsymmetricMatcher", JSImport.Default)
  @js.native
  val default: NewPlugin = js.native
  
  @JSImport("pretty-format/build/plugins/AsymmetricMatcher", "serialize")
  @js.native
  ...
  @JSImport("pretty-format/build/plugins/AsymmetricMatcher", "test")
  @js.native
  val test: Test = js.native
  
  type _To = NewPlugin
  
  /* This means you don't have to write `default`, but can instead just say `asymmetricMatcherMod.foo` */
