...
import typingsSlinky.prettyFormat.AnonClose
...
trait Colors extends js.Object {
  var comment: AnonClose = js.native
  var content: AnonClose = js.native
  var prop: AnonClose = js.native
  var tag: AnonClose = js.native
  var value: AnonClose = js.native
}
...
object Colors {
  ...
  implicit class ColorsOps[Self <: Colors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComment(value: AnonClose): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("comment")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withContent(value: AnonClose): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("content")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProp(value: AnonClose): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prop")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTag(value: AnonClose): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withValue(value: AnonClose): Self = {
        val ret = this.duplicate
