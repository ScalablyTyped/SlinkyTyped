...
import typingsSlinky.prettyFormat.anon.Close
  ...
  */
  ...
  object Plugin {
    ...
    def NewPlugin(
      ...
      val __obj = js.Dynamic.literal(serialize = js.Any.fromFunction6(serialize), test = js.Any.fromFunction1(test))
      __obj.asInstanceOf[typingsSlinky.prettyFormat.typesMod.NewPlugin]
    }
    ...
    def OldPlugin(
      ...
      val __obj = js.Dynamic.literal(print = js.Any.fromFunction5(print), test = js.Any.fromFunction1(test))
      __obj.asInstanceOf[typingsSlinky.prettyFormat.typesMod.OldPlugin]
    }
  }
