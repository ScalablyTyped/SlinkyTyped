...
import typingsSlinky.prosemirrorDashState.Anon_Plugins
import typingsSlinky.prosemirrorDashState.Anon_PluginsSchema
import typingsSlinky.prosemirrorDashState.Anon_State
...
class EditorState[S /* <: Schema[_, _] */] () extends js.Object {
  ...
  /**
    ...
    */
  def applyTransaction(tr: Transaction[S]): Anon_State[S] = js.native
  /**
    ...
    */
  def reconfigure(config: Anon_Plugins[S]): EditorState[S] = js.native
  /**
