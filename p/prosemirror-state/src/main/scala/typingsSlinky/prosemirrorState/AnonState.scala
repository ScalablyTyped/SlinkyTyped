...
object AnonState {
  @scala.inline
  def apply[S](state: EditorState[S], transactions: js.Array[Transaction[S]]): AnonState[S] = {
  ...
  @scala.inline
  implicit class AnonStateOps[Self[s] <: AnonState[s], S] (val x: Self[S]) extends AnyVal {
    @scala.inline
