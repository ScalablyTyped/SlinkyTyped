...
object anon {
  ...
  @js.native
  trait Destroy[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] extends StObject {
  ...
  object Destroy {
    ...
    @scala.inline
    def apply[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */](): Destroy[S] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Destroy[S]]
    }
    
    @scala.inline
    implicit class DestroyMutableBuilder[Self <: Destroy[_], S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] (val x: Self with Destroy[S]) extends AnyVal {
  ...
  @js.native
  trait Doc[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] extends StObject {
  ...
  object Doc {
    ...
    @scala.inline
    def apply[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */](): Doc[S] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Doc[S]]
    }
    
    @scala.inline
    implicit class DocMutableBuilder[Self <: Doc[_], S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] (val x: Self with Doc[S]) extends AnyVal {
  ...
  @js.native
  trait Plugins[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] extends StObject {
  ...
  object Plugins {
    ...
    @scala.inline
    def apply[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */](): Plugins[S] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Plugins[S]]
    }
    
    @scala.inline
    implicit class PluginsMutableBuilder[Self <: Plugins[_], S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] (val x: Self with Plugins[S]) extends AnyVal {
  ...
  @js.native
  trait Schema[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] extends StObject {
  ...
  object Schema {
    ...
    @scala.inline
    def apply[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */](schema: S): Schema[S] = {
      val __obj = js.Dynamic.literal(schema = schema.asInstanceOf[js.Any])
      __obj.asInstanceOf[Schema[S]]
    }
    
    @scala.inline
    implicit class SchemaMutableBuilder[Self <: Schema[_], S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] (val x: Self with Schema[S]) extends AnyVal {
  ...
  @js.native
  trait State[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] extends StObject {
  ...
  object State {
    ...
    @scala.inline
    def apply[S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */](state: EditorState[S], transactions: js.Array[Transaction[S]]): State[S] = {
    ...
    @scala.inline
    implicit class StateMutableBuilder[Self <: State[_], S /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */] (val x: Self with State[S]) extends AnyVal {
