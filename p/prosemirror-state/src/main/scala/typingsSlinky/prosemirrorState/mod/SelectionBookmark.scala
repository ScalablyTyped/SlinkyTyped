...
object SelectionBookmark {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](map: Mapping => SelectionBookmark[S], resolve: Node[S] => Selection[S]): SelectionBookmark[S] = {
  ...
  @scala.inline
  implicit class SelectionBookmarkOps[Self <: SelectionBookmark[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with SelectionBookmark[S]) extends AnyVal {
    @scala.inline
