...
object StateField {
  @scala.inline
  def apply[T, /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](
  ...
  @scala.inline
  implicit class StateFieldOps[Self <: StateField[_, _], T, /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with (StateField[T, S])) extends AnyVal {
    @scala.inline
