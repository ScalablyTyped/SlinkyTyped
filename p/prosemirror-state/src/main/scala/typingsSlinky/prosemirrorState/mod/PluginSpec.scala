...
object PluginSpec {
  @scala.inline
  def apply[T, /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): PluginSpec[T, S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PluginSpec[T, S]]
  }
  @scala.inline
  implicit class PluginSpecOps[Self <: PluginSpec[_, _], T, /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with (PluginSpec[T, S])) extends AnyVal {
    @scala.inline
