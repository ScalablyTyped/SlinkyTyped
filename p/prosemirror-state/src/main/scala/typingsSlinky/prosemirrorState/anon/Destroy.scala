...
object Destroy {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): Destroy[S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Destroy[S]]
  }
  @scala.inline
  implicit class DestroyOps[Self <: Destroy[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Destroy[S]) extends AnyVal {
    @scala.inline
