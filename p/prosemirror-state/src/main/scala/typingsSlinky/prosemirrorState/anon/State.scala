...
object State {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](state: EditorState[S], transactions: js.Array[Transaction[S]]): State[S] = {
  ...
  @scala.inline
  implicit class StateOps[Self <: State[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with State[S]) extends AnyVal {
    @scala.inline
