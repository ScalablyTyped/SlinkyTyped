...
object Doc {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): Doc[S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Doc[S]]
  }
  @scala.inline
  implicit class DocOps[Self <: Doc[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Doc[S]) extends AnyVal {
    @scala.inline
