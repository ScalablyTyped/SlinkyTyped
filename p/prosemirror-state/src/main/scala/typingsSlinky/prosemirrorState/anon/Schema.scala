...
object Schema {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](schema: S): Schema[S] = {
    val __obj = js.Dynamic.literal(schema = schema.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema[S]]
  }
  @scala.inline
  implicit class SchemaOps[Self <: Schema[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Schema[S]) extends AnyVal {
    @scala.inline
