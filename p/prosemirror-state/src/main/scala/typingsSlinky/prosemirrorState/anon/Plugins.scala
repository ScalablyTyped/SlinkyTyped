...
object Plugins {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): Plugins[S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Plugins[S]]
  }
  @scala.inline
  implicit class PluginsOps[Self <: Plugins[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Plugins[S]) extends AnyVal {
    @scala.inline
