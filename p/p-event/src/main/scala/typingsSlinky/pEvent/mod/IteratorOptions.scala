...
object IteratorOptions {
  @scala.inline
  def apply[/* <: js.Array[_] */ EmittedType](): IteratorOptions[EmittedType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IteratorOptions[EmittedType]]
  }
  @scala.inline
  implicit class IteratorOptionsOps[Self <: IteratorOptions[_], /* <: js.Array[_] */ EmittedType] (val x: Self with IteratorOptions[EmittedType]) extends AnyVal {
    @scala.inline
