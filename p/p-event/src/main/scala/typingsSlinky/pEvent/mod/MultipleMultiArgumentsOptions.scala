...
object MultipleMultiArgumentsOptions {
  ...
  @scala.inline
  implicit class MultipleMultiArgumentsOptionsOps[Self <: MultipleMultiArgumentsOptions[_], EmittedType /* <: js.Array[_] */] (val x: Self with MultipleMultiArgumentsOptions[EmittedType]) extends AnyVal {
