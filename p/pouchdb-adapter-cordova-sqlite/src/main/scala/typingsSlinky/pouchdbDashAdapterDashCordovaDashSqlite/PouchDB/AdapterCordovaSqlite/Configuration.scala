package typingsSlinky.pouchdbDashAdapterDashCordovaDashSqlite.PouchDB.AdapterCordovaSqlite

import typingsSlinky.pouchdbDashAdapterDashCordovaDashSqlite.pouchdbDashAdapterDashCordovaDashSqliteStrings.`cordova-sqlite`
import typingsSlinky.pouchdbDashCore.PouchDB.Configuration.LocalDatabaseConfiguration
