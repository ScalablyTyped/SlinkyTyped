...
import typingsSlinky.playable.anon.AutoJoinPolicy
import typingsSlinky.playable.anon.GetInstance
import typingsSlinky.playable.anon.GetMediaSession
...
object chomecastApiMockMod {
  ...
  class CastTestFramework () extends StObject {
    ...
    var RemotePlayer: Instantiable0[typingsSlinky.playable.chomecastApiMockMod.RemotePlayer] = js.native
    
    var RemotePlayerController: Instantiable1[
        /* player */ RemotePlayer, 
        typingsSlinky.playable.chomecastApiMockMod.RemotePlayerController
      ] = js.native
  ...
  object SessionState extends StObject {
    ...
    /* "NO_SESSION" */ val NO_SESSION: typingsSlinky.playable.chomecastApiMockMod.SessionState.NO_SESSION with String = js.native
    
    @js.native
    sealed trait SESSION_ENDED extends SessionState
    /* "SESSION_ENDED" */ val SESSION_ENDED: typingsSlinky.playable.chomecastApiMockMod.SessionState.SESSION_ENDED with String = js.native
    
    @js.native
    sealed trait SESSION_ENDING extends SessionState
    /* "SESSION_ENDING" */ val SESSION_ENDING: typingsSlinky.playable.chomecastApiMockMod.SessionState.SESSION_ENDING with String = js.native
    
    @js.native
    sealed trait SESSION_RESUMED extends SessionState
    /* "SESSION_RESUMED" */ val SESSION_RESUMED: typingsSlinky.playable.chomecastApiMockMod.SessionState.SESSION_RESUMED with String = js.native
    
    @js.native
    sealed trait SESSION_STARTED extends SessionState
    /* "SESSION_STARTED" */ val SESSION_STARTED: typingsSlinky.playable.chomecastApiMockMod.SessionState.SESSION_STARTED with String = js.native
    
    @js.native
    sealed trait SESSION_STARTING extends SessionState
    /* "SESSION_STARTING" */ val SESSION_STARTING: typingsSlinky.playable.chomecastApiMockMod.SessionState.SESSION_STARTING with String = js.native
    
    @js.native
    sealed trait SESSION_START_FAILED extends SessionState
    /* "SESSION_START_FAILED" */ val SESSION_START_FAILED: typingsSlinky.playable.chomecastApiMockMod.SessionState.SESSION_START_FAILED with String = js.native
  }
  ...
  object eventType extends StObject {
    ...
    /* "caststatechanged" */ val CAST_STATE_CHANGED: typingsSlinky.playable.chomecastApiMockMod.eventType.CAST_STATE_CHANGED with String = js.native
    
    @js.native
    sealed trait SESSION_STATE_CHANGED extends eventType
    /* "sessionstatechanged" */ val SESSION_STATE_CHANGED: typingsSlinky.playable.chomecastApiMockMod.eventType.SESSION_STATE_CHANGED with String = js.native
  }
