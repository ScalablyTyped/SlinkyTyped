...
import typingsSlinky.playable.anon.BottomBlock
...
object chromecastMod {
  ...
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsSlinky.playable.chromecastViewMod.default
      ] = js.native
    @scala.inline
    def View_=(
      x: Instantiable1[
  ...
  object ChromecastButton {
    ...
    implicit class ChromecastButtonMutableBuilder[Self <: ChromecastButton] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.playable.chromecastViewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
