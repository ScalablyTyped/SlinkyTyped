package typingsSlinky.playable.withDashMod.default
...
@JSImport("playable/dist/src/with-dash", JSImport.Default)
@js.native
object ^ extends js.Object {
  ...
  var Tooltip: Instantiable0[typingsSlinky.playable.tooltipMod.Tooltip] = js.native
