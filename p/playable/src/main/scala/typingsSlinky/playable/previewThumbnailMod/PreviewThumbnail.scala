package typingsSlinky.playable.previewThumbnailMod
...
trait PreviewThumbnail extends IPreviewThumbnail {
  ...
  var view: typingsSlinky.playable.previewThumbnailViewMod.default = js.native
}
object PreviewThumbnail {
  ...
  def apply(
    ...
    setTime: String => Unit,
    showAt: Double => Unit,
    view: typingsSlinky.playable.previewThumbnailViewMod.default
  ): PreviewThumbnail = {
  ...
  implicit class PreviewThumbnailOps[Self <: PreviewThumbnail] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setView(value: typingsSlinky.playable.previewThumbnailViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
