...
import typingsSlinky.playable.anon.CurrentBitrate
import typingsSlinky.playable.playbackEngineTypesMod.IEngineDebugInfo
...
trait DebugPanel extends js.Object {
  ...
  var view: typingsSlinky.playable.debugPanelViewMod.default = js.native
}
object DebugPanel {
  ...
  def apply(
    ...
    show: () => Unit,
    updateInfo: () => Unit,
    view: typingsSlinky.playable.debugPanelViewMod.default
  ): DebugPanel = {
  ...
  implicit class DebugPanelOps[Self <: DebugPanel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setView(value: typingsSlinky.playable.debugPanelViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
