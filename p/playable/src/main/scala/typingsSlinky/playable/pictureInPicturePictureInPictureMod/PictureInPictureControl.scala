package typingsSlinky.playable.pictureInPicturePictureInPictureMod
...
trait PictureInPictureControl extends IPictureInPictureControl {
  ...
  var view: typingsSlinky.playable.pictureInPictureViewMod.default = js.native
}
object PictureInPictureControl {
  ...
  def apply(
    ...
    isHidden: Boolean,
    show: () => Unit,
    view: typingsSlinky.playable.pictureInPictureViewMod.default
  ...
  implicit class PictureInPictureControlOps[Self <: PictureInPictureControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setView(value: typingsSlinky.playable.pictureInPictureViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
