package typingsSlinky.playable.fullScreenMod
...
object FullScreenControl {
  ...
  implicit class FullScreenControlOps[Self <: FullScreenControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setView(value: typingsSlinky.playable.fullScreenViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
