package typingsSlinky.playable.progressMod
...
object ProgressControl {
  ...
  implicit class ProgressControlOps[Self <: ProgressControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setView(value: typingsSlinky.playable.progressViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
