package typingsSlinky.playable.interactionIndicatorMod
...
trait InteractionIndicator extends IInteractionIndicator {
  ...
  var view: typingsSlinky.playable.interactionIndicatorViewMod.default = js.native
}
object InteractionIndicator {
  ...
  def apply(
    ...
    showPlay: () => Unit,
    showRewind: () => Unit,
    view: typingsSlinky.playable.interactionIndicatorViewMod.default
  ...
  implicit class InteractionIndicatorOps[Self <: InteractionIndicator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setView(value: typingsSlinky.playable.interactionIndicatorViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
