...
import typingsSlinky.playable.anon.PreviewServiceIPreviewService
...
object previewThumbnailMod {
  ...
  object default {
    ...
    @js.native
    def View: Instantiable0[typingsSlinky.playable.previewThumbnailViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable0[typingsSlinky.playable.previewThumbnailViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  object PreviewThumbnail {
    ...
    implicit class PreviewThumbnailMutableBuilder[Self <: PreviewThumbnail] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.playable.previewThumbnailViewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
