...
import typingsSlinky.playable.anon.ConfigEngine
...
object loaderMod {
  ...
  object default {
    ...
    @js.native
    def View: Instantiable0[typingsSlinky.playable.loaderViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable0[typingsSlinky.playable.loaderViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait Loader extends ILoader {
    ...
    var view: typingsSlinky.playable.loaderViewMod.default = js.native
  }
}
