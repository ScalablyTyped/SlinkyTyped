...
import typingsSlinky.playable.anon.Loader
import typingsSlinky.playable.overlayTypesMod.IOverlay
...
object overlayMod {
  ...
  object default {
    ...
    class View protected ()
      extends typingsSlinky.playable.overlayViewMod.default {
    ...
    @JSImport("playable/dist/src/modules/ui/overlay/overlay", "default.View")
    @js.native
    def View: Instantiable1[/* config */ IOverlayViewConfig, typingsSlinky.playable.overlayViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable1[/* config */ IOverlayViewConfig, typingsSlinky.playable.overlayViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait Overlay extends IOverlay {
    ...
    var view: typingsSlinky.playable.overlayViewMod.default = js.native
  }
  object Overlay {
    ...
    def apply(
      ...
      view: typingsSlinky.playable.overlayViewMod.default
    ): Overlay = {
    ...
    implicit class OverlayMutableBuilder[Self <: Overlay] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.playable.overlayViewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
