...
object topBlockMod {
  ...
  object default {
    ...
    class View protected ()
      extends typingsSlinky.playable.topBlockViewMod.default {
    ...
    @JSImport("playable/dist/src/modules/ui/top-block/top-block", "default.View")
    @js.native
    def View: Instantiable1[/* config */ ITopBlockViewConfig, typingsSlinky.playable.topBlockViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable1[/* config */ ITopBlockViewConfig, typingsSlinky.playable.topBlockViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
