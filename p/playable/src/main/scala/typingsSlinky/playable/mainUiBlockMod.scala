...
import typingsSlinky.playable.anon.Screen
...
object mainUiBlockMod {
  ...
  object default {
    ...
    class View protected ()
      extends typingsSlinky.playable.mainUiBlockViewMod.default {
  ...
  trait MainUIBlock extends IMainUIBlock {
    ...
    var view: typingsSlinky.playable.mainUiBlockViewMod.default = js.native
  }
  object MainUIBlock {
    
    /* was `typeof MainUIBlockView` */
    type View = typingsSlinky.playable.mainUiBlockViewMod.default
  }
}
