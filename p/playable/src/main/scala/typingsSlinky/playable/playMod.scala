...
import typingsSlinky.playable.anon.Theme
...
object playMod {
  ...
  object default {
    ...
    @js.native
    def View: Instantiable1[/* config */ IPlayViewConfig, typingsSlinky.playable.playViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable1[/* config */ IPlayViewConfig, typingsSlinky.playable.playViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait PlayControl extends IPlayControl {
    ...
    var view: typingsSlinky.playable.playViewMod.default = js.native
  }
  object PlayControl {
    ...
    def apply(
      ...
      view: typingsSlinky.playable.playViewMod.default
    ): PlayControl = {
    ...
    implicit class PlayControlMutableBuilder[Self <: PlayControl] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.playable.playViewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
