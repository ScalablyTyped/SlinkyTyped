...
import typingsSlinky.playable.anon.PictureInPicture
...
object pictureInPicturePictureInPictureMod {
  ...
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsSlinky.playable.pictureInPictureViewMod.default
      ] = js.native
    @scala.inline
    def View_=(
      x: Instantiable1[
  ...
  object PictureInPictureControl {
    ...
    implicit class PictureInPictureControlMutableBuilder[Self <: PictureInPictureControl] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.playable.pictureInPictureViewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
