package typingsSlinky.playable.topBlockTypesMod
...
@js.native
trait ITopBlockViewCallbacks extends js.Object {
...
object ITopBlockViewCallbacks {
  ...
  @scala.inline
  implicit class ITopBlockViewCallbacksOps[Self <: ITopBlockViewCallbacks] (val x: Self) extends AnyVal {
