...
object screenMod {
  ...
  object default {
    ...
    class View protected ()
      extends typingsSlinky.playable.screenViewMod.default {
    ...
    @JSImport("playable/dist/src/modules/ui/screen/screen", "default.View")
    @js.native
    def View: Instantiable1[/* config */ IScreenViewConfig, typingsSlinky.playable.screenViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable1[/* config */ IScreenViewConfig, typingsSlinky.playable.screenViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait Screen extends IScreen {
    ...
    var view: typingsSlinky.playable.screenViewMod.default = js.native
  }
}
