...
import typingsSlinky.playable.anon.RootContainer
...
object interactionIndicatorMod {
  ...
  object default {
    ...
    @js.native
    def View: Instantiable0[typingsSlinky.playable.interactionIndicatorViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable0[typingsSlinky.playable.interactionIndicatorViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  object InteractionIndicator {
    ...
    implicit class InteractionIndicatorMutableBuilder[Self <: InteractionIndicator] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setView(value: typingsSlinky.playable.interactionIndicatorViewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
