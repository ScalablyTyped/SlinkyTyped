...
@js.native
trait IDownloadViewConfig extends js.Object {
...
object IDownloadViewConfig {
  ...
  @scala.inline
  implicit class IDownloadViewConfigOps[Self <: IDownloadViewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallbacks(value: IDownloadViewCallbacks): Self = this.set("callbacks", value.asInstanceOf[js.Any])
