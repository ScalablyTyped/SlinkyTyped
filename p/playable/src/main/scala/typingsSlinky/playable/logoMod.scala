...
object logoMod {
  ...
  object default {
    ...
    class View protected ()
      extends typingsSlinky.playable.logoViewMod.default {
    ...
    @JSImport("playable/dist/src/modules/ui/controls/logo/logo", "default.View")
    @js.native
    def View: Instantiable1[/* config */ ILogoViewConfig, typingsSlinky.playable.logoViewMod.default] = js.native
    @scala.inline
    def View_=(x: Instantiable1[/* config */ ILogoViewConfig, typingsSlinky.playable.logoViewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait Logo extends ILogoControl {
    ...
    var view: typingsSlinky.playable.logoViewMod.default = js.native
  }
}
