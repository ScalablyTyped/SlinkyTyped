...
@js.native
trait IPictureInPictureViewCallbacks extends js.Object {
...
object IPictureInPictureViewCallbacks {
  ...
  @scala.inline
  implicit class IPictureInPictureViewCallbacksOps[Self <: IPictureInPictureViewCallbacks] (val x: Self) extends AnyVal {
