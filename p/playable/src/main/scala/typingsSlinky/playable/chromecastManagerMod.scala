...
object chromecastManagerMod {
  ...
  object ChromecastEvents extends StObject {
    ...
    /* "ui-events/chromecast-resumed" */ val CHROMECAST_CASTS_RESUMED: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_CASTS_RESUMED with String = js.native
    
    @js.native
    sealed trait CHROMECAST_CASTS_STARTED extends ChromecastEvents
    /* "ui-events/chromecast-started" */ val CHROMECAST_CASTS_STARTED: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_CASTS_STARTED with String = js.native
    
    @js.native
    sealed trait CHROMECAST_CASTS_STOPED extends ChromecastEvents
    /* "ui-events/chromecast-stoped" */ val CHROMECAST_CASTS_STOPED: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_CASTS_STOPED with String = js.native
    
    @js.native
    sealed trait CHROMECAST_CONNECTED extends ChromecastEvents
    /* "ui-events/chromecast-connected" */ val CHROMECAST_CONNECTED: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_CONNECTED with String = js.native
    
    @js.native
    sealed trait CHROMECAST_CONNECTING extends ChromecastEvents
    /* "ui-events/chromecast-connecting" */ val CHROMECAST_CONNECTING: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_CONNECTING with String = js.native
    
    @js.native
    sealed trait CHROMECAST_INITED extends ChromecastEvents
    /* "ui-events/chromecast-inited" */ val CHROMECAST_INITED: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_INITED with String = js.native
    
    @js.native
    sealed trait CHROMECAST_NOT_CONNECTED extends ChromecastEvents
    /* "ui-events/chromecast-not-connected" */ val CHROMECAST_NOT_CONNECTED: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_NOT_CONNECTED with String = js.native
    
    @js.native
    sealed trait CHROMECAST_NO_DEVICES_AVAILABLE extends ChromecastEvents
    /* "ui-events/chromecast-not-available" */ val CHROMECAST_NO_DEVICES_AVAILABLE: typingsSlinky.playable.chromecastManagerMod.ChromecastEvents.CHROMECAST_NO_DEVICES_AVAILABLE with String = js.native
  }
