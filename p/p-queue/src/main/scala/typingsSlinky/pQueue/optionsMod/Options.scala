...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.pQueue.queueMod.Queue[typingsSlinky.pQueue.queueMod.RunFunction, QueueOptions] */ QueueType, /* <: typingsSlinky.pQueue.optionsMod.QueueAddOptions */ QueueOptions](): Options[QueueType, QueueOptions] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[QueueType, QueueOptions]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _], /* <: typingsSlinky.pQueue.queueMod.Queue[typingsSlinky.pQueue.queueMod.RunFunction, QueueOptions] */ QueueType, /* <: typingsSlinky.pQueue.optionsMod.QueueAddOptions */ QueueOptions] (val x: Self with (Options[QueueType, QueueOptions])) extends AnyVal {
    @scala.inline
