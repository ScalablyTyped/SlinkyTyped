...
object SubscriptionType {
  @scala.inline
  def Exclusive: typingsSlinky.pulsarClient.pulsarClientStrings.Exclusive = "Exclusive".asInstanceOf[typingsSlinky.pulsarClient.pulsarClientStrings.Exclusive]
  @scala.inline
