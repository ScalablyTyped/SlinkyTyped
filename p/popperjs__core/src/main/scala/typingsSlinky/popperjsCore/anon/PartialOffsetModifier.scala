...
object PartialOffsetModifier {
  ...
  @scala.inline
  implicit class PartialOffsetModifierOps[Self <: PartialOffsetModifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: offset): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteName: Self = this.set("name", js.undefined)
    
    @scala.inline
    def setOptions(value: PartialOptionsOffset): Self = this.set("options", value.asInstanceOf[js.Any])
