...
object PartialArrowModifier {
  ...
  @scala.inline
  implicit class PartialArrowModifierOps[Self <: PartialArrowModifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: arrow): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteName: Self = this.set("name", js.undefined)
    
    @scala.inline
    def setOptions(value: PartialOptionsElement): Self = this.set("options", value.asInstanceOf[js.Any])
