...
object PartialOptionsAllowedAutoPlacements {
  ...
  implicit class PartialOptionsAllowedAutoPlacementsOps[Self <: PartialOptionsAllowedAutoPlacements] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowedAutoPlacementsVarargs(value: typingsSlinky.popperjsCore.enumsMod.Placement*): Self = this.set("allowedAutoPlacements", js.Array(value :_*))
    
    @scala.inline
    def setAllowedAutoPlacements(value: js.Array[typingsSlinky.popperjsCore.enumsMod.Placement]): Self = this.set("allowedAutoPlacements", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFallbackPlacementsVarargs(value: typingsSlinky.popperjsCore.enumsMod.Placement*): Self = this.set("fallbackPlacements", js.Array(value :_*))
    
    @scala.inline
    def setFallbackPlacements(value: js.Array[typingsSlinky.popperjsCore.enumsMod.Placement]): Self = this.set("fallbackPlacements", value.asInstanceOf[js.Any])
