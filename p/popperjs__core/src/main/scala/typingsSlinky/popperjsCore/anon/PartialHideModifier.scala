...
import typingsSlinky.popperjsCore.popperjsCoreStrings.hide
...
object PartialHideModifier {
  ...
  @scala.inline
  implicit class PartialHideModifierOps[Self <: PartialHideModifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: hide): Self = this.set("name", value.asInstanceOf[js.Any])
