...
@js.native
trait PartialPopperOffsetsModif extends StrictModifiers {
  ...
  var name: js.UndefOr[popperOffsets] = js.native
...
object PartialPopperOffsetsModif {
  ...
  @scala.inline
  implicit class PartialPopperOffsetsModifOps[Self <: PartialPopperOffsetsModif] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: popperOffsets): Self = this.set("name", value.asInstanceOf[js.Any])
