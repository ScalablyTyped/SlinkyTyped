...
trait Placement extends StObject {
  ...
  var placement: typingsSlinky.popperjsCore.enumsMod.Placement = js.native
...
object Placement {
  ...
  @scala.inline
  def apply(placement: typingsSlinky.popperjsCore.enumsMod.Placement, popper: Rect, reference: Rect): Placement = {
