...
object mod {
  ...
  object MultiSliderProps {
    ...
    implicit class MultiSliderPropsMutableBuilder[Self <: MultiSliderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCustomMarkerLeft(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarkerLeft", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerLeftComponentClass(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarkerLeft", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerLeftFunctionComponent(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarkerLeft", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerLeftUndefined: Self = StObject.set(x, "customMarkerLeft", js.undefined)
      
      @scala.inline
      def setCustomMarkerRight(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarkerRight", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerRightComponentClass(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarkerRight", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCustomMarkerRightFunctionComponent(value: ReactComponentClass[MarkerProps]): Self = StObject.set(x, "customMarkerRight", value.asInstanceOf[js.Any])
