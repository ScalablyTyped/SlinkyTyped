...
object MultiSliderProps {
  ...
  implicit class MultiSliderPropsOps[Self <: MultiSliderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomMarkerFunctionComponent(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarker", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomMarkerComponentClass(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarker", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomMarker(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarker", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCustomMarker: Self = this.set("customMarker", js.undefined)
    @scala.inline
    def setCustomMarkerLeftFunctionComponent(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarkerLeft", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomMarkerLeftComponentClass(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarkerLeft", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomMarkerLeft(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarkerLeft", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCustomMarkerLeft: Self = this.set("customMarkerLeft", js.undefined)
    @scala.inline
    def setCustomMarkerRightFunctionComponent(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarkerRight", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomMarkerRightComponentClass(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarkerRight", value.asInstanceOf[js.Any])
    @scala.inline
    def setCustomMarkerRight(value: ReactComponentClass[MarkerProps]): Self = this.set("customMarkerRight", value.asInstanceOf[js.Any])
    @scala.inline
