...
@js.native
class Button ()
  extends typingsSlinky.photonui.photonui.Button {
  /* CompleteClass */
  override var absolutePosition: X = js.native
  /* CompleteClass */
  override var appearance: String = js.native
   //  normal | flat
  /* CompleteClass */
  override var buttonColor: String = js.native
   // readonly
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var leftIcon: typingsSlinky.photonui.photonui.BaseIcon = js.native
  /* CompleteClass */
  override var leftIconName: String = js.native
  /* CompleteClass */
  override var leftIconVisible: Boolean = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var rightIcon: typingsSlinky.photonui.photonui.BaseIcon = js.native
  /* CompleteClass */
  override var rightIconName: String = js.native
  /* CompleteClass */
  override var rightIconVisible: Boolean = js.native
  /* CompleteClass */
