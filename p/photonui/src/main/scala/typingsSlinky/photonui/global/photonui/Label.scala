...
@js.native
class Label ()
  extends typingsSlinky.photonui.photonui.Label {
  ...
  /* CompleteClass */
  override var forInput: typingsSlinky.photonui.photonui.Field | typingsSlinky.photonui.photonui.CheckBox = js.native
  /* CompleteClass */
