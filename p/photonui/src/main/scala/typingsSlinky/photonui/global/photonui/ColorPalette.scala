...
@js.native
class ColorPalette ()
  extends typingsSlinky.photonui.photonui.ColorPalette {
  /* CompleteClass */
  override var absolutePosition: X = js.native
  /* CompleteClass */
  override var color: typingsSlinky.photonui.photonui.Color = js.native
   // readonly
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var palette: js.Array[js.Array[String]] = js.native
   // readonly
  /* CompleteClass */
