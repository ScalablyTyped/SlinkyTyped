...
object Viewport {
  ...
  implicit class ViewportOps[Self <: Viewport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHorizontalScrollbar(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("horizontalScrollbar")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withVerticalScrollbar(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("verticalScrollbar")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
