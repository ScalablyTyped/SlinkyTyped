...
object Dialog {
  ...
  implicit class DialogOps[Self <: Dialog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddButton(value: (Widget, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addButton")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withButtonNames(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("buttonNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withButtons(value: js.Array[Widget]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("buttons")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRemoveButton(value: Widget => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeButton")(js.Any.fromFunction1(value))
        ret
    }
  }
