...
object PopupWindow {
  ...
  implicit class PopupWindowOps[Self <: PopupWindow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPopupWidget(value: Widget => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("popupWidget")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPopupXY(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("popupXY")(js.Any.fromFunction2(value))
        ret
    }
  }
