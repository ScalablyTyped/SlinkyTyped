...
import typingsSlinky.passport.Anon_PauseStream
import typingsSlinky.passport.Anon_UserProperty
...
trait Authenticator[InitializeRet, AuthenticateRet, AuthorizeRet, AuthorizeOptions] extends js.Object {
  ...
  def session(options: Anon_PauseStream): AuthenticateRet = js.native
