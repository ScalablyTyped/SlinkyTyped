...
object global {
  ...
  @JSGlobal("Connection")
  @js.native
  def Connection: typingsSlinky.phonegap.Connection = js.native
  @scala.inline
  def Connection_=(x: Connection): Unit = js.Dynamic.global.updateDynamic("Connection")(x.asInstanceOf[js.Any])
  ...
  class ContactFindOptions ()
    extends typingsSlinky.phonegap.ContactFindOptions
  ...
  class DirectoryEntry protected ()
    extends typingsSlinky.phonegap.DirectoryEntry {
    def this(name: String, root: typingsSlinky.phonegap.DirectoryEntry) = this()
  }
  ...
  @js.native
  class FileTransfer ()
    extends typingsSlinky.phonegap.FileTransfer
  ...
  object GlobalizationError {
    ...
    @scala.inline
    def FORMATTING_ERROR_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FORMATTING_ERROR")(x.asInstanceOf[js.Any])
    
    @JSGlobal("GlobalizationError.PARSING_ERROR")
    @js.native
    def PARSING_ERROR: Double = js.native
    @scala.inline
    def PARSING_ERROR_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PARSING_ERROR")(x.asInstanceOf[js.Any])
    
    @JSGlobal("GlobalizationError.PATTERN_ERROR")
    @js.native
    def PATTERN_ERROR: Double = js.native
    @scala.inline
    def PATTERN_ERROR_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PATTERN_ERROR")(x.asInstanceOf[js.Any])
  ...
  @JSGlobal("Keyboard")
  @js.native
  def Keyboard: typingsSlinky.phonegap.Keyboard = js.native
  @scala.inline
  def Keyboard_=(x: Keyboard): Unit = js.Dynamic.global.updateDynamic("Keyboard")(x.asInstanceOf[js.Any])
  
  @JSGlobal("LocalFileSystem")
  @js.native
  def LocalFileSystem: typingsSlinky.phonegap.LocalFileSystem = js.native
  @scala.inline
  def LocalFileSystem_=(x: LocalFileSystem): Unit = js.Dynamic.global.updateDynamic("LocalFileSystem")(x.asInstanceOf[js.Any])
  ...
  @JSGlobal("StatusBar")
  @js.native
  def StatusBar: typingsSlinky.phonegap.StatusBar = js.native
  @scala.inline
  ...
  @scala.inline
  def phoneGapNavigator_=(x: Navigator): Unit = js.Dynamic.global.updateDynamic("phoneGapNavigator")(x.asInstanceOf[js.Any])
}
