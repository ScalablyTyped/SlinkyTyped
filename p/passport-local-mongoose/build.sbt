...
version := "4.0.0-dt-20200226Z-a14465"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "passport-local" % "1.0.0-dt-20200225Z-5b0466",
  "org.scalablytyped.slinky" %%% "passport-strategy" % "v0.2.0-dt-20200225Z-90bf36",
