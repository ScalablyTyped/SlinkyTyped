...
@js.native
trait AuthorizationResponseDetails extends js.Object {
...
object AuthorizationResponseDetails {
  ...
  @scala.inline
  implicit class AuthorizationResponseDetailsOps[Self <: AuthorizationResponseDetails] (val x: Self) extends AnyVal {
