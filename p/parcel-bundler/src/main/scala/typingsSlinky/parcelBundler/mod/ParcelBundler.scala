...
trait ParcelBundler extends js.Object {
  ...
  def serve(port: js.UndefOr[scala.Nothing], https: js.UndefOr[scala.Nothing], host: String): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  def serve(port: js.UndefOr[scala.Nothing], https: HttpsOptions): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  def serve(port: js.UndefOr[scala.Nothing], https: HttpsOptions, host: String): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  def serve(port: Double): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  def serve(port: Double, https: js.UndefOr[scala.Nothing], host: String): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  ...
  @JSName("serve")
  def serve_false(port: js.UndefOr[scala.Nothing], https: `false`): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  @JSName("serve")
  def serve_false(port: js.UndefOr[scala.Nothing], https: `false`, host: String): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  @JSName("serve")
  ...
  @JSName("serve")
  def serve_true(port: js.UndefOr[scala.Nothing], https: `true`): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  @JSName("serve")
  def serve_true(port: js.UndefOr[scala.Nothing], https: `true`, host: String): js.Promise[Server | typingsSlinky.node.httpsMod.Server] = js.native
  @JSName("serve")
