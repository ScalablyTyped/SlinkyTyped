...
import typingsSlinky.trouter.mod.^
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var onError: js.UndefOr[
        js.Function4[/* err */ js.Error, /* req */ Request, /* res */ ServerResponse, /* next */ Next, Unit]
      ] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnError(value: (/* err */ js.Error, /* req */ Request, /* res */ ServerResponse, /* next */ Next) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction4(value))
