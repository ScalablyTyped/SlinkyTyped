package typingsSlinky.polka.mod
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnError(value: (/* err */ js.Error, /* req */ Request, /* res */ ServerResponse, /* next */ Next) => Unit): Self = this.set("onError", js.Any.fromFunction4(value))
    @scala.inline
