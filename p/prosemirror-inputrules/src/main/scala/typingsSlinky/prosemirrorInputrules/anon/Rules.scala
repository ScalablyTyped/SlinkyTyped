...
object Rules {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](rules: js.Array[InputRule[S]]): Rules[S] = {
    val __obj = js.Dynamic.literal(rules = rules.asInstanceOf[js.Any])
    __obj.asInstanceOf[Rules[S]]
  }
  @scala.inline
  implicit class RulesOps[Self <: Rules[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Rules[S]) extends AnyVal {
    @scala.inline
