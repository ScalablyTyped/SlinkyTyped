package typingsSlinky.picturefill

import org.scalajs.dom.raw.Element
import org.scalajs.dom.raw.NodeList
import typingsSlinky.picturefill.mod.Picturefill.EvaluateArg
  ...
  object Picturefill {
    ...
    object EvaluateArg {
      ...
      implicit class EvaluateArgMutableBuilder[Self <: EvaluateArg] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setElementsNodeList(value: NodeList): Self = StObject.set(x, "elements", value.asInstanceOf[js.Any])
