...
trait Parser extends js.Object {
  def decoder(data: js.Any, fn: js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]): Unit
  def encoder(data: js.Any, fn: js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]): Unit
}
