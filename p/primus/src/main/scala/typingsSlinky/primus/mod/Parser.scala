...
object Parser {
  ...
  implicit class ParserOps[Self <: Parser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDecoder(value: (js.Any, js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]) => Unit): Self = this.set("decoder", js.Any.fromFunction2(value))
    
    @scala.inline
    def setEncoder(value: (js.Any, js.Function2[/* error */ js.Error, /* response */ js.Any, Unit]) => Unit): Self = this.set("encoder", js.Any.fromFunction2(value))
  }
}
