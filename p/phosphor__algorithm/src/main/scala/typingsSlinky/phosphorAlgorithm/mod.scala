...
import typingsSlinky.phosphorAlgorithm.anon.Index
import typingsSlinky.phosphorAlgorithm.arrayMod.ArrayExt.MutableArrayLike
import typingsSlinky.phosphorAlgorithm.arrayMod.ArrayExt.slice.IOptions
...
import typingsSlinky.phosphorAlgorithm.retroMod.RetroableOrArrayLike
import typingsSlinky.phosphorAlgorithm.stringMod.StringExt.IMatchResult
...
object mod extends js.Object {
  ...
  class ArrayIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.iterMod.ArrayIterator[T] {
    /**
  ...
  class ChainIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.chainMod.ChainIterator[T] {
    /**
  ...
  class EmptyIterator[T] ()
    extends typingsSlinky.phosphorAlgorithm.emptyMod.EmptyIterator[T]
  
  @js.native
  class EnumerateIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.enumerateMod.EnumerateIterator[T] {
    /**
  ...
  class FilterIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.filterMod.FilterIterator[T] {
    /**
  ...
  class FnIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.iterMod.FnIterator[T] {
    /**
  ...
  class ItemIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.iterMod.ItemIterator[T] {
    /**
  ...
  class KeyIterator protected ()
    extends typingsSlinky.phosphorAlgorithm.iterMod.KeyIterator {
    /**
  ...
  class MapIterator[T, U] protected ()
    extends typingsSlinky.phosphorAlgorithm.mapMod.MapIterator[T, U] {
    /**
  ...
  class RangeIterator protected ()
    extends typingsSlinky.phosphorAlgorithm.rangeMod.RangeIterator {
    /**
  ...
  class RepeatIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.repeatMod.RepeatIterator[T] {
    /**
  ...
  class RetroArrayIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.retroMod.RetroArrayIterator[T] {
    /**
  ...
  class StrideIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.strideMod.StrideIterator[T] {
    /**
  ...
  class TakeIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.takeMod.TakeIterator[T] {
    /**
  ...
  class ValueIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.iterMod.ValueIterator[T] {
    /**
  ...
  class ZipIterator[T] protected ()
    extends typingsSlinky.phosphorAlgorithm.zipMod.ZipIterator[T] {
    /**
