...
object mod {
  ...
  {[ K in keyof V ]: -? prop-types.prop-types.InferType<V[K]>}
    */ typingsSlinky.propTypes.propTypesStrings.InferPropsInner with TopLevel[V]
  
  type InferType[V] = js.Any
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.propTypes.propTypesBooleans.`false`
    - typingsSlinky.propTypes.propTypesBooleans.`true`
  */
  ...
  */
  ...
  {[ K in keyof T ]:? prop-types.prop-types.Validator<T[K]>}
    */ typingsSlinky.propTypes.propTypesStrings.ValidationMap with TopLevel[T]
