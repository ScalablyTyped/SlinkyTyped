...
package object mod {
  ...
  {[ K in keyof V ]: -? prop-types.prop-types.InferType<V[K]>}
    */ typingsSlinky.propTypes.propTypesStrings.InferPropsInner with V
  type InferType[V] = js.Any
  type OptionalKeys[V] = typingsSlinky.std.Exclude[java.lang.String, typingsSlinky.propTypes.mod.RequiredKeys[V]]
  ...
  */
  ...
  {[ K in keyof T ]:? prop-types.prop-types.Validator<T[K]>}
    */ typingsSlinky.propTypes.propTypesStrings.ValidationMap with T
}
