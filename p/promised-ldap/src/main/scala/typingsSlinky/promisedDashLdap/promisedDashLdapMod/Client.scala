package typingsSlinky.promisedDashLdap.promisedDashLdapMod

import typingsSlinky.ldapjs.ldapjsMod.Change
import typingsSlinky.ldapjs.ldapjsMod.Control
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.promisedDashLdap.Anon_Email
import typingsSlinky.promisedDashLdap.Anon_Entries
...
trait Client extends EventEmitter {
  def _search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions, _bypass: Boolean): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions, controls: js.Array[Control]): js.Promise[EventEmitter] = js.native
  def _search(
    base: String,
    options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions,
    controls: js.Array[Control],
    _bypass: Boolean
  ): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions, controls: Control): js.Promise[EventEmitter] = js.native
  def _search(
    base: String,
    options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions,
    controls: Control,
  ...
  def search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions): js.Promise[Anon_Entries] = js.native
  def search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions, controls: js.Array[Control]): js.Promise[Anon_Entries] = js.native
  def search(base: String, options: typingsSlinky.ldapjs.ldapjsMod.SearchOptions, controls: Control): js.Promise[Anon_Entries] = js.native
