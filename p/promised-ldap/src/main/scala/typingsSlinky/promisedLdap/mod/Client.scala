package typingsSlinky.promisedLdap.mod

import typingsSlinky.ldapjs.mod.Change
import typingsSlinky.ldapjs.mod.Control
import typingsSlinky.node.eventsMod.EventEmitter
import typingsSlinky.promisedLdap.AnonEmail
import typingsSlinky.promisedLdap.AnonEntries
...
trait Client extends EventEmitter {
  ...
  def search(base: String, options: typingsSlinky.ldapjs.mod.SearchOptions): js.Promise[AnonEntries] = js.native
  def search(base: String, options: typingsSlinky.ldapjs.mod.SearchOptions, controls: js.Array[Control]): js.Promise[AnonEntries] = js.native
  def search(base: String, options: typingsSlinky.ldapjs.mod.SearchOptions, controls: Control): js.Promise[AnonEntries] = js.native
