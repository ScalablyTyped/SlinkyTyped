...
import typingsSlinky.prosemirrorTables.anon.Buttom
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.table
    - typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.row
    - typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.cell
    - typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.header_cell
  */
  trait TableRoles extends StObject
  object TableRoles {
    
    @scala.inline
    def cell: typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.cell = "cell".asInstanceOf[typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.cell]
    
    @scala.inline
    def header_cell: typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.header_cell = "header_cell".asInstanceOf[typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.header_cell]
    
    @scala.inline
    def row: typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.row = "row".asInstanceOf[typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.row]
    
    @scala.inline
    def table: typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.table = "table".asInstanceOf[typingsSlinky.prosemirrorTables.prosemirrorTablesStrings.table]
  }
