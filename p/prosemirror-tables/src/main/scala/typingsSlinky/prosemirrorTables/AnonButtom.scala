...
@js.native
trait AnonButtom extends js.Object {
...
object AnonButtom {
  @scala.inline
  def apply(buttom: Double, left: Double, right: Double, top: Double): AnonButtom = {
    ...
    __obj.asInstanceOf[AnonButtom]
  }
  @scala.inline
  implicit class AnonButtomOps[Self <: AnonButtom] (val x: Self) extends AnyVal {
    @scala.inline
