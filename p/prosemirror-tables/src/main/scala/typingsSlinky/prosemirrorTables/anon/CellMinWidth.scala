...
object CellMinWidth {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): CellMinWidth[S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CellMinWidth[S]]
  }
  @scala.inline
  implicit class CellMinWidthOps[Self <: CellMinWidth[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with CellMinWidth[S]) extends AnyVal {
    @scala.inline
