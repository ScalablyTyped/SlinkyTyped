...
object PromptObject {
  ...
  implicit class PromptObjectOps[Self <: PromptObject[_], /* <: java.lang.String */ T] (val x: Self with PromptObject[T]) extends AnyVal {
    ...
    @scala.inline
    def setInitialDate(value: js.Date): Self = this.set("initial", value.asInstanceOf[js.Any])
    @scala.inline
    def setInitial(value: String | Double | Boolean | js.Date): Self = this.set("initial", value.asInstanceOf[js.Any])
    @scala.inline
