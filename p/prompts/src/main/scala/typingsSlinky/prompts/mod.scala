...
import typingsSlinky.prompts.promptsBooleans.`false`
...
object mod {
  ...
  {[ id in T ]: any}
    */ typingsSlinky.prompts.promptsStrings.Answers with TopLevel[js.Any]
  ...
  object PromptObject {
    ...
    implicit class PromptObjectMutableBuilder[Self <: PromptObject[_], T /* <: String */] (val x: Self with PromptObject[T]) extends AnyVal {
      ...
      @scala.inline
      def setInitial(value: String | Double | Boolean | js.Date): Self = StObject.set(x, "initial", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInitialDate(value: js.Date): Self = StObject.set(x, "initial", value.asInstanceOf[js.Any])
