...
object springForceMod {
  ...
  @JSImport("@popmotion/popcorn/lib/utils/spring-force", "springForce")
  @js.native
  ...
  @JSImport("@popmotion/popcorn/lib/utils/spring-force", "springForceExpo")
  @js.native
  ...
  @JSImport("@popmotion/popcorn/lib/utils/spring-force", "springForceLinear")
  @js.native
