...
object typesMod {
  ...
  */
  ...
  object Point {
    ...
    @scala.inline
    def Point2D(x: Double, y: Double): typingsSlinky.popmotionPopcorn.typesMod.Point2D = {
      val __obj = js.Dynamic.literal(x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.popmotionPopcorn.typesMod.Point2D]
    }
    
    @scala.inline
    def Point3D(x: Double, y: Double, z: Double): typingsSlinky.popmotionPopcorn.typesMod.Point3D = {
      val __obj = js.Dynamic.literal(x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any], z = z.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.popmotionPopcorn.typesMod.Point3D]
    }
  }
