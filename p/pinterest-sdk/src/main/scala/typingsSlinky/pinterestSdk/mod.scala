...
object mod {
  ...
  object HttpMethod extends StObject {
    ...
    /* 3 */ val delete: typingsSlinky.pinterestSdk.mod.HttpMethod.delete with Double = js.native
    
    @js.native
    sealed trait get extends HttpMethod
    /* 0 */ val get: typingsSlinky.pinterestSdk.mod.HttpMethod.get with Double = js.native
    
    @js.native
    sealed trait post extends HttpMethod
    /* 2 */ val post: typingsSlinky.pinterestSdk.mod.HttpMethod.post with Double = js.native
    
    @js.native
    sealed trait put extends HttpMethod
    /* 1 */ val put: typingsSlinky.pinterestSdk.mod.HttpMethod.put with Double = js.native
  }
  ...
  object OAuthScopes extends StObject {
    ...
    /* 0 */ val read_public: typingsSlinky.pinterestSdk.mod.OAuthScopes.read_public with Double = js.native
    
    @js.native
    sealed trait read_relationships extends OAuthScopes
    /* 2 */ val read_relationships: typingsSlinky.pinterestSdk.mod.OAuthScopes.read_relationships with Double = js.native
    
    @js.native
    sealed trait write_public extends OAuthScopes
    /* 1 */ val write_public: typingsSlinky.pinterestSdk.mod.OAuthScopes.write_public with Double = js.native
    
    @js.native
    sealed trait write_relationships extends OAuthScopes
    /* 3 */ val write_relationships: typingsSlinky.pinterestSdk.mod.OAuthScopes.write_relationships with Double = js.native
  }
