...
object GetMembershipsResponse {
  @scala.inline
  def apply(data: js.Array[ObjectData], status: Double): GetMembershipsResponse = {
  ...
  @scala.inline
  implicit class GetMembershipsResponseOps[Self <: GetMembershipsResponse] (val x: Self) extends AnyVal {
    @scala.inline
