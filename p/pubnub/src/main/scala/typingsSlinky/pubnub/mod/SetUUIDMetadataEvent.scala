...
object SetUUIDMetadataEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ UUIDCustom](channel: String, message: DataEventType[UUIDCustom], timetoken: Double): SetUUIDMetadataEvent[UUIDCustom] = {
  ...
  @scala.inline
  implicit class SetUUIDMetadataEventOps[Self <: SetUUIDMetadataEvent[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ UUIDCustom] (val x: Self with SetUUIDMetadataEvent[UUIDCustom]) extends AnyVal {
    @scala.inline
