...
object v2ObjectParam {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](): v2ObjectParam[Custom] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[v2ObjectParam[Custom]]
  }
  @scala.inline
  implicit class v2ObjectParamOps[Self <: v2ObjectParam[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with v2ObjectParam[Custom]) extends AnyVal {
    @scala.inline
