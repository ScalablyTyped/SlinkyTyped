...
object SetChannelMetadataEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ ChannelCustom](channel: String, message: DataChannelMetadataObject[ChannelCustom], timetoken: Double): SetChannelMetadataEvent[ChannelCustom] = {
  ...
  @scala.inline
  implicit class SetChannelMetadataEventOps[Self <: SetChannelMetadataEvent[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ ChannelCustom] (val x: Self with SetChannelMetadataEvent[ChannelCustom]) extends AnyVal {
    @scala.inline
