...
object SetChannelMetadataParameters {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](channel: String, data: ChannelMetadata[Custom]): SetChannelMetadataParameters[Custom] = {
  ...
  @scala.inline
  implicit class SetChannelMetadataParametersOps[Self <: SetChannelMetadataParameters[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with SetChannelMetadataParameters[Custom]) extends AnyVal {
    @scala.inline
