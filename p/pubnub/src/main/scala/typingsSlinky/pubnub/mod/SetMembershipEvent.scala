...
object SetMembershipEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom](channel: String, message: DataChannel[MembershipCustom], timetoken: Double): SetMembershipEvent[MembershipCustom] = {
  ...
  @scala.inline
  implicit class SetMembershipEventOps[Self <: SetMembershipEvent[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom] (val x: Self with SetMembershipEvent[MembershipCustom]) extends AnyVal {
    @scala.inline
