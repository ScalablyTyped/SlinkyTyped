...
object ChannelMetadataObject {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](eTag: String, id: String, updated: String): ChannelMetadataObject[Custom] = {
  ...
  @scala.inline
  implicit class ChannelMetadataObjectOps[Self <: ChannelMetadataObject[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with ChannelMetadataObject[Custom]) extends AnyVal {
    @scala.inline
