...
object UUIDMetadataObject {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](eTag: String, id: String, updated: String): UUIDMetadataObject[Custom] = {
  ...
  @scala.inline
  implicit class UUIDMetadataObjectOps[Self <: UUIDMetadataObject[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with UUIDMetadataObject[Custom]) extends AnyVal {
    @scala.inline
