...
object SetChannelMembersParameters {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](channel: String, uuids: js.Array[String | SetCustom[Custom]]): SetChannelMembersParameters[Custom] = {
  ...
  @scala.inline
  implicit class SetChannelMembersParametersOps[Self <: SetChannelMembersParameters[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with SetChannelMembersParameters[Custom]) extends AnyVal {
    @scala.inline
