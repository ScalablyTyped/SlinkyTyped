...
object SetUUIDMetadataParameters {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](data: UUIDMetadata[Custom]): SetUUIDMetadataParameters[Custom] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    __obj.asInstanceOf[SetUUIDMetadataParameters[Custom]]
  }
  @scala.inline
  implicit class SetUUIDMetadataParametersOps[Self <: SetUUIDMetadataParameters[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with SetUUIDMetadataParameters[Custom]) extends AnyVal {
    @scala.inline
