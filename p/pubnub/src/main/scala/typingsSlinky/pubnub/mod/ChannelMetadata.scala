...
object ChannelMetadata {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](): ChannelMetadata[Custom] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChannelMetadata[Custom]]
  }
  @scala.inline
  implicit class ChannelMetadataOps[Self <: ChannelMetadata[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with ChannelMetadata[Custom]) extends AnyVal {
    @scala.inline
