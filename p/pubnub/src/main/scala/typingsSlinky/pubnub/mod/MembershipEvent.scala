...
object MembershipEvent {
  ...
  @scala.inline
  implicit class MembershipEventMutableBuilder[Self <: MembershipEvent] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setChannel(value: String): Self = StObject.set(x, "channel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMessage(value: Type): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
