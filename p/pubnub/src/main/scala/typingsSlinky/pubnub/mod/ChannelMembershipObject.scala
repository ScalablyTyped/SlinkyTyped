...
object ChannelMembershipObject {
  ...
  @scala.inline
  implicit class ChannelMembershipObjectOps[Self <: ChannelMembershipObject[_, _], MembershipCustom /* <: ObjectCustom */, ChannelCustom /* <: ObjectCustom */] (val x: Self with (ChannelMembershipObject[MembershipCustom, ChannelCustom])) extends AnyVal {
