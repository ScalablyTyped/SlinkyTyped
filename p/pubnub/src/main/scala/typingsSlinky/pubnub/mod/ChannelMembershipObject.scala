...
object ChannelMembershipObject {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom, /* <: typingsSlinky.pubnub.mod.ObjectCustom */ ChannelCustom](channel: ChannelMetadataObject[ChannelCustom] | Id, eTag: String, updated: String): ChannelMembershipObject[MembershipCustom, ChannelCustom] = {
  ...
  @scala.inline
  implicit class ChannelMembershipObjectOps[Self <: ChannelMembershipObject[_, _], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom, /* <: typingsSlinky.pubnub.mod.ObjectCustom */ ChannelCustom] (val x: Self with (ChannelMembershipObject[MembershipCustom, ChannelCustom])) extends AnyVal {
    @scala.inline
