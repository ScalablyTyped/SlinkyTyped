...
object RemoveChannelMetadataEvent {
  ...
  @scala.inline
  implicit class RemoveChannelMetadataEventOps[Self <: RemoveChannelMetadataEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessage(value: DataIdEvent): Self = this.set("message", value.asInstanceOf[js.Any])
  }
}
