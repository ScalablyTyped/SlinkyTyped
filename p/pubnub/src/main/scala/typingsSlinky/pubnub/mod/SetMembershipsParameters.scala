...
object SetMembershipsParameters {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](): SetMembershipsParameters[Custom] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SetMembershipsParameters[Custom]]
  }
  @scala.inline
  implicit class SetMembershipsParametersOps[Self <: SetMembershipsParameters[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with SetMembershipsParameters[Custom]) extends AnyVal {
    @scala.inline
