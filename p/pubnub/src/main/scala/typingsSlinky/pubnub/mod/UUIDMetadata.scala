...
object UUIDMetadata {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom](): UUIDMetadata[Custom] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UUIDMetadata[Custom]]
  }
  @scala.inline
  implicit class UUIDMetadataOps[Self <: UUIDMetadata[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ Custom] (val x: Self with UUIDMetadata[Custom]) extends AnyVal {
    @scala.inline
