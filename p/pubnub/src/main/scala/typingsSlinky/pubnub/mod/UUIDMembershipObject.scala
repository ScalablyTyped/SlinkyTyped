...
import typingsSlinky.pubnub.anon.Id
...
object UUIDMembershipObject {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom, /* <: typingsSlinky.pubnub.mod.ObjectCustom */ UUIDCustom](eTag: String, updated: String, uuid: UUIDMetadataObject[UUIDCustom] | Id): UUIDMembershipObject[MembershipCustom, UUIDCustom] = {
  ...
  @scala.inline
  implicit class UUIDMembershipObjectOps[Self <: UUIDMembershipObject[_, _], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom, /* <: typingsSlinky.pubnub.mod.ObjectCustom */ UUIDCustom] (val x: Self with (UUIDMembershipObject[MembershipCustom, UUIDCustom])) extends AnyVal {
    @scala.inline
