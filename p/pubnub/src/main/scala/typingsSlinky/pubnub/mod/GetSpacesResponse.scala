...
trait GetSpacesResponse extends js.Object {
  var data: js.Array[SpaceData] = js.native
...
object GetSpacesResponse {
  @scala.inline
  def apply(data: js.Array[SpaceData], status: Double): GetSpacesResponse = {
  ...
  @scala.inline
  implicit class GetSpacesResponseOps[Self <: GetSpacesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withData(value: js.Array[SpaceData]): Self = {
