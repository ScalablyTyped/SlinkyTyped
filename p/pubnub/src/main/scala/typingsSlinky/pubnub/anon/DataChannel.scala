...
object DataChannel {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom](data: Channel[MembershipCustom], event: set, `type`: membership): DataChannel[MembershipCustom] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataChannel[MembershipCustom]]
  }
  @scala.inline
  implicit class DataChannelOps[Self <: DataChannel[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom] (val x: Self with DataChannel[MembershipCustom]) extends AnyVal {
    @scala.inline
