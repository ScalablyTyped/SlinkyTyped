...
object Channel {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom](channel: Id, eTag: String, updated: String, uuid: Id): Channel[MembershipCustom] = {
  ...
  @scala.inline
  implicit class ChannelOps[Self <: Channel[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ MembershipCustom] (val x: Self with Channel[MembershipCustom]) extends AnyVal {
    @scala.inline
