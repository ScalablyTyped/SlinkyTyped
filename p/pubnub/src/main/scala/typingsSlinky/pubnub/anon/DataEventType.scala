...
object DataEventType {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ UUIDCustom](data: UUIDMetadataObject[UUIDCustom], event: set, `type`: uuid): DataEventType[UUIDCustom] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataEventType[UUIDCustom]]
  }
  @scala.inline
  implicit class DataEventTypeOps[Self <: DataEventType[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ UUIDCustom] (val x: Self with DataEventType[UUIDCustom]) extends AnyVal {
    @scala.inline
