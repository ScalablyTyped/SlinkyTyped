...
object DataChannelMetadataObject {
  @scala.inline
  def apply[/* <: typingsSlinky.pubnub.mod.ObjectCustom */ ChannelCustom](data: ChannelMetadataObject[ChannelCustom], event: set, `type`: channel): DataChannelMetadataObject[ChannelCustom] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataChannelMetadataObject[ChannelCustom]]
  }
  @scala.inline
  implicit class DataChannelMetadataObjectOps[Self <: DataChannelMetadataObject[_], /* <: typingsSlinky.pubnub.mod.ObjectCustom */ ChannelCustom] (val x: Self with DataChannelMetadataObject[ChannelCustom]) extends AnyVal {
    @scala.inline
