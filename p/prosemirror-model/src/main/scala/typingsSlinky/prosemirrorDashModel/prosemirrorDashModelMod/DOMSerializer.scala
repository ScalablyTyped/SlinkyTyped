...
import typingsSlinky.prosemirrorDashModel.Anon_ContentDOM
...
class DOMSerializer[S /* <: Schema[_, _] */] protected () extends js.Object {
  ...
  /**
    ...
    */
  def serializeNode(node: ProsemirrorNode[S]): org.scalajs.dom.raw.Node = js.native
  def serializeNode(node: ProsemirrorNode[S], options: StringDictionary[js.Any]): org.scalajs.dom.raw.Node = js.native
}
