...
trait SchemaSpec[N /* <: String */, M /* <: String */] extends js.Object {
  ...
  {[ name in M ]: prosemirror-model.prosemirror-model.MarkSpec}
    */ typingsSlinky.prosemirrorDashModel.prosemirrorDashModelStrings.SchemaSpec with js.Any) | ^[MarkSpec] | Null
  ] = js.undefined
  /**
  ...
  {[ name in N ]: prosemirror-model.prosemirror-model.NodeSpec}
    */ typingsSlinky.prosemirrorDashModel.prosemirrorDashModelStrings.SchemaSpec with js.Any) | ^[NodeSpec]
  /**
