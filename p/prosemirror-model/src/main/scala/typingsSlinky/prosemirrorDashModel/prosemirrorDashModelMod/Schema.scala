package typingsSlinky.prosemirrorDashModel.prosemirrorDashModelMod
...
class Schema[N /* <: String */, M /* <: String */] protected () extends js.Object {
  ...
  /**
    ...
    */
  var marks: typingsSlinky.prosemirrorDashModel.prosemirrorDashModelStrings.Schema with js.Any with (StringDictionary[MarkType[Schema[N, M]]]) = js.native
  /**
    * An object mapping the schema's node names to node type objects.
    */
  var nodes: typingsSlinky.prosemirrorDashModel.prosemirrorDashModelStrings.Schema with js.Any with (StringDictionary[NodeType[Schema[N, M]]]) = js.native
  /**
