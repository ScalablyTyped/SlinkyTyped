...
object anon {
  ...
  object ContentDOM {
    ...
    implicit class ContentDOMMutableBuilder[Self <: ContentDOM] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContentDOM(value: org.scalajs.dom.raw.Node): Self = StObject.set(x, "contentDOM", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDom(value: org.scalajs.dom.raw.Node): Self = StObject.set(x, "dom", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Node {
    ...
    implicit class NodeMutableBuilder[Self <: Node] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNode(value: org.scalajs.dom.raw.Node): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
