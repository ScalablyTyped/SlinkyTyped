...
class Schema[N /* <: String */, M /* <: String */] protected () extends js.Object {
  ...
  /**
    ...
    */
  var marks: typingsSlinky.prosemirrorModel.prosemirrorModelStrings.Schema with js.Any with (StringDictionary[MarkType[Schema[N, M]]]) = js.native
  /**
    * An object mapping the schema's node names to node type objects.
    */
  var nodes: typingsSlinky.prosemirrorModel.prosemirrorModelStrings.Schema with js.Any with (StringDictionary[NodeType[Schema[N, M]]]) = js.native
  /**
