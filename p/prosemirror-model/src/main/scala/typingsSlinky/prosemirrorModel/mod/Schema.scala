...
class Schema[N /* <: String */, M /* <: String */] protected () extends StObject {
  ...
  /**
    ...
    */
  var marks: typingsSlinky.prosemirrorModel.prosemirrorModelStrings.Schema with TopLevel[js.Any] with (StringDictionary[MarkType[Schema[N, M]]]) = js.native
  ...
  /**
    ...
    */
  var nodes: typingsSlinky.prosemirrorModel.prosemirrorModelStrings.Schema with TopLevel[js.Any] with (StringDictionary[NodeType[Schema[N, M]]]) = js.native
