...
trait SchemaSpec[N /* <: String */, M /* <: String */] extends js.Object {
  ...
  {[ name in M ]: prosemirror-model.prosemirror-model.MarkSpec}
    */ typingsSlinky.prosemirrorModel.prosemirrorModelStrings.SchemaSpec with js.Any) | ^[MarkSpec] | Null
  ] = js.undefined
  /**
  ...
  {[ name in N ]: prosemirror-model.prosemirror-model.NodeSpec}
    */ typingsSlinky.prosemirrorModel.prosemirrorModelStrings.SchemaSpec with js.Any) | ^[NodeSpec]
  /**
