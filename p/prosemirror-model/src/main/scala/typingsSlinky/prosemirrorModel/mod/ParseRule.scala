...
object ParseRule {
  ...
  implicit class ParseRuleOps[Self <: ParseRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentElementFunction1(value: /* p */ org.scalajs.dom.raw.Node => org.scalajs.dom.raw.Node): Self = this.set("contentElement", js.Any.fromFunction1(value))
    
    @scala.inline
    def setContentElement(value: String | (js.Function1[/* p */ org.scalajs.dom.raw.Node, org.scalajs.dom.raw.Node])): Self = this.set("contentElement", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("getAttrs", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetContent(value: (/* p */ org.scalajs.dom.raw.Node, /* schema */ js.Any) => Fragment[_]): Self = this.set("getContent", js.Any.fromFunction2(value))
