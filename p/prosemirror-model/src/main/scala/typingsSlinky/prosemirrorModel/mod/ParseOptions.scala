...
object ParseOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): ParseOptions[S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParseOptions[S]]
  }
  @scala.inline
  implicit class ParseOptionsOps[Self <: ParseOptions[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with ParseOptions[S]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFindPositionsVarargs(value: typingsSlinky.prosemirrorModel.anon.Node*): Self = this.set("findPositions", js.Array(value :_*))
    @scala.inline
    def setFindPositions(value: js.Array[typingsSlinky.prosemirrorModel.anon.Node]): Self = this.set("findPositions", value.asInstanceOf[js.Any])
    @scala.inline
