...
object ParseOptions {
  ...
  implicit class ParseOptionsMutableBuilder[Self <: ParseOptions[_], S /* <: Schema[_, _] */] (val x: Self with ParseOptions[S]) extends AnyVal {
    ...
    @scala.inline
    def setFindPositions(value: js.Array[typingsSlinky.prosemirrorModel.anon.Node]): Self = StObject.set(x, "findPositions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFindPositionsVarargs(value: typingsSlinky.prosemirrorModel.anon.Node*): Self = StObject.set(x, "findPositions", js.Array(value :_*))
