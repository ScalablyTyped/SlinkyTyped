...
object Index {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](index: Double, offset: Double): Index[S] = {
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any])
    __obj.asInstanceOf[Index[S]]
  }
  @scala.inline
  implicit class IndexOps[Self <: Index[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Index[S]) extends AnyVal {
    @scala.inline
