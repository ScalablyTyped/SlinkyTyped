package typingsSlinky.pDashAny

import typingsSlinky.pDashAny.pDashAnyMod.CancelablePromise
import typingsSlinky.pDashAny.pDashAnyMod.Options
import typingsSlinky.pDashAny.pDashAnyMod.Value
import typingsSlinky.pDashAny.pDashAnyStrings.count
import typingsSlinky.pDashCancelable.pDashCancelableMod.^
import typingsSlinky.typeDashFest.typeDashFestMod.Omit
...
object pDashAnyMod extends js.Object {
  ...
  type AggregateError = typingsSlinky.pDashSome.pDashSomeMod.AggregateError
  type CancelablePromise[ValueType] = ^[ValueType]
  type Options[ValueType] = Omit[typingsSlinky.pDashSome.pDashSomeMod.Options[ValueType], count]
