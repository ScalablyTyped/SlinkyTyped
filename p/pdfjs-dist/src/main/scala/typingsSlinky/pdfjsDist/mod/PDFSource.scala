...
object PDFSource {
  ...
  implicit class PDFSourceOps[Self <: PDFSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.typedarray.Uint8Array | BufferSource | String): Self = this.set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInitialDataUint8Array(value: js.typedarray.Uint8Array): Self = this.set("initialData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialDataArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("initialData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialDataArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("initialData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialData(value: js.typedarray.Uint8Array | BufferSource): Self = this.set("initialData", value.asInstanceOf[js.Any])
