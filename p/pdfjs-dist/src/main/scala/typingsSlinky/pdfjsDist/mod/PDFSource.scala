...
object PDFSource {
  ...
  implicit class PDFSourceMutableBuilder[Self <: PDFSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.typedarray.Uint8Array | BufferSource | String): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInitialData(value: js.typedarray.Uint8Array | BufferSource): Self = StObject.set(x, "initialData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialDataArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "initialData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialDataArrayBufferView(value: js.typedarray.ArrayBufferView): Self = StObject.set(x, "initialData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialDataUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "initialData", value.asInstanceOf[js.Any])
