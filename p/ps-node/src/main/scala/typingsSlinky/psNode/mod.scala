...
object mod {
  ...
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: String, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(
    pID: String,
  ...
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: String, signal: String, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: String, signal: Signal): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: String, signal: Signal, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: Double): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: Double, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(
    pID: Double,
  ...
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: Double, signal: String, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: Double, signal: Signal): Unit = js.native
  @JSImport("ps-node", "kill")
  @js.native
  def kill(pID: Double, signal: Signal, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  
  @JSImport("ps-node", "lookup")
  @js.native
  def lookup(query: Query, cb: js.Function2[/* err */ js.Error, /* list */ js.Array[Program], Unit]): Unit = js.native
  ...
  trait Query extends StObject {
    ...
    var arguments: js.UndefOr[String | js.RegExp] = js.native
    
    var command: js.UndefOr[String | js.RegExp] = js.native
  ...
  object Query {
    ...
    implicit class QueryMutableBuilder[Self <: Query] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArguments(value: String | js.RegExp): Self = StObject.set(x, "arguments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setArgumentsRegExp(value: js.RegExp): Self = StObject.set(x, "arguments", value.asInstanceOf[js.Any])
