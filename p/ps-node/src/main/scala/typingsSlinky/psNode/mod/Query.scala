...
object Query {
  ...
  implicit class QueryOps[Self <: Query] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgumentsRegExp(value: js.RegExp): Self = this.set("arguments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setArguments(value: String | js.RegExp): Self = this.set("arguments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteArguments: Self = this.set("arguments", js.undefined)
    
    @scala.inline
    def setCommandRegExp(value: js.RegExp): Self = this.set("command", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCommand(value: String | js.RegExp): Self = this.set("command", value.asInstanceOf[js.Any])
