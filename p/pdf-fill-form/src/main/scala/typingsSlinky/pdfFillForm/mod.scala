...
import typingsSlinky.pdfFillForm.anon.Id
...
object mod {
  ...
  */
  ...
  object Options {
    ...
    @scala.inline
    def ImgPdfOptions(): typingsSlinky.pdfFillForm.mod.ImgPdfOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.pdfFillForm.mod.ImgPdfOptions]
    }
    
    @scala.inline
    def PdfOptions(): typingsSlinky.pdfFillForm.mod.PdfOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.pdfFillForm.mod.PdfOptions]
    }
  }
