...
object util {
  ...
  @JSImport("protobufjs/minimal", "util.Array")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("protobufjs/minimal", "util.Buffer")
  @js.native
  ...
  @JSImport("protobufjs/minimal", "util.EventEmitter")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("protobufjs/minimal", "util.Long")
  @js.native
  ...
  @JSImport("protobufjs/minimal", "util.LongBits")
  @js.native
  ...
  object LongBits {
    ...
    @JSImport("protobufjs/minimal", "util.LongBits.from")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("protobufjs/minimal", "util.LongBits.fromHash")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("protobufjs/minimal", "util.LongBits.fromNumber")
    @js.native
    def fromNumber(value: Double): typingsSlinky.protobufjs.mod.util.LongBits = js.native
    
    /** Zero bits. */
    /* static member */
    @JSImport("protobufjs/minimal", "util.LongBits.zero")
    @js.native
    def zero: typingsSlinky.protobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport("protobufjs/minimal", "util.LongBits.zeroHash")
    @js.native
  ...
  @JSImport("protobufjs/minimal", "util.ProtocolError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.asPromise")
  @js.native
  ...
  object base64 {
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.base64.decode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.base64.encode")
    @js.native
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("protobufjs/minimal", "util.base64.length")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.base64.test")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.camelCase")
  @js.native
  ...
  object codegen {
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.codegen")
    @js.native
    ...
    @JSImport("protobufjs/minimal", "util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.compareFieldsById")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.decorateEnum")
  @js.native
  def decorateEnum(`object`: js.Object): typingsSlinky.protobufjs.mod.Enum = js.native
  
  /** Decorator root (TypeScript). */
  @JSImport("protobufjs/minimal", "util.decorateRoot")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.decorateType")
  @js.native
  ...
  @JSImport("protobufjs/minimal", "util.emptyArray")
  @js.native
  val emptyArray: js.Array[js.Any] = js.native
  
  /** An immutable empty object. */
  @JSImport("protobufjs/minimal", "util.emptyObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.fetch")
  @js.native
  ...
  object float {
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("protobufjs/minimal", "util.float.readDoubleBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("protobufjs/minimal", "util.float.readDoubleLE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("protobufjs/minimal", "util.float.readFloatBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("protobufjs/minimal", "util.float.readFloatLE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.float.writeDoubleBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("protobufjs/minimal", "util.float.writeDoubleLE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("protobufjs/minimal", "util.float.writeFloatBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("protobufjs/minimal", "util.float.writeFloatLE")
    @js.native
    def writeFloatLE(`val`: Double, buf: js.typedarray.Uint8Array, pos: Double): Unit = js.native
  }
  
  /** Global object reference. */
  @JSImport("protobufjs/minimal", "util.global")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.inquire")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.isInteger")
  @js.native
  def isInteger(value: js.Any): Boolean = js.native
  
  /** Whether running within node or not. */
  @JSImport("protobufjs/minimal", "util.isNode")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.isObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.isReserved")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.isSet")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.isString")
  @js.native
  ...
  @JSImport("protobufjs/minimal", "util.key2Re")
  @js.native
  val key2Re: js.RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSImport("protobufjs/minimal", "util.key32Re")
  @js.native
  val key32Re: js.RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSImport("protobufjs/minimal", "util.key64Re")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("protobufjs/minimal", "util.lcFirst")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.longFromHash")
  @js.native
  ...
  @JSImport("protobufjs/minimal", "util.longToHash")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.merge")
  @js.native
  ...
  /**
    ...
    * @returns Buffer
    */
  @JSImport("protobufjs/minimal", "util.newBuffer")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.newError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.oneOfGetter")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.oneOfSetter")
  @js.native
  ...
  object path {
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.path.isAbsolute")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.path.normalize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.path.resolve")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.pool")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.safeProp")
  @js.native
  ...
  /**
    ...
    * @returns Destination object
    */
  @JSImport("protobufjs/minimal", "util.setProperty")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.toArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.toJSONOptions")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "util.toObject")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("protobufjs/minimal", "util.ucFirst")
  @js.native
  ...
  object utf8 {
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("protobufjs/minimal", "util.utf8.length")
    @js.native
    def length(string: String): Double = js.native
    ...
    /**
      ...
      * @returns String read
      */
    @JSImport("protobufjs/minimal", "util.utf8.read")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("protobufjs/minimal", "util.utf8.write")
    @js.native
