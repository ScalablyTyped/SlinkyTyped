...
import typingsSlinky.protobufjs.mod.util.EventEmitter
...
object rpc extends js.Object {
  ...
  class Service protected () extends EventEmitter {
    ...
    /**
      ...
      * @returns `this`
      */
    def end(): typingsSlinky.protobufjs.mod.rpc.Service = js.native
    def end(endedByRPC: Boolean): typingsSlinky.protobufjs.mod.rpc.Service = js.native
    /**
