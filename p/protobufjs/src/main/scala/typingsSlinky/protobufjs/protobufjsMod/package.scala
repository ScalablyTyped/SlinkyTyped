...
package object protobufjsMod {
  ...
  import typingsSlinky.protobufjs.protobufjsMod.rpc.ServiceMethod
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsSlinky.protobufjs.protobufjsStrings.Properties with T
  /**
  ...
  type RPCImplCallback = js.Function2[
    /* error */ js.Error | Null, 
    /* response */ js.UndefOr[scala.scalajs.js.typedarray.Uint8Array | Null], 
    Unit
  ]
  /**
  ...
  /**
    ...
    */
  type asPromiseCallback = js.Function2[/* error */ js.Error | Null, /* repeated */ js.Any, Unit]
}
