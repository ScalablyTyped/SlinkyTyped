...
class Service protected () extends NamespaceBase {
  ...
  /**
    ...
    */
  def create(rpcImpl: RPCImpl): typingsSlinky.protobufjs.protobufjsMod.rpc.Service = js.native
  def create(rpcImpl: RPCImpl, requestDelimited: Boolean): typingsSlinky.protobufjs.protobufjsMod.rpc.Service = js.native
  def create(rpcImpl: RPCImpl, requestDelimited: Boolean, responseDelimited: Boolean): typingsSlinky.protobufjs.protobufjsMod.rpc.Service = js.native
}
