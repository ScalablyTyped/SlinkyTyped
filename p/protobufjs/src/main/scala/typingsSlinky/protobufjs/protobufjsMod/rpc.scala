...
import typingsSlinky.protobufjs.protobufjsMod.rpc.ServiceMethodCallback
import typingsSlinky.protobufjs.protobufjsMod.util.EventEmitter
...
object rpc extends js.Object {
  ...
  class Service protected () extends EventEmitter {
    ...
    /**
      ...
      * @returns `this`
      */
    def end(): typingsSlinky.protobufjs.protobufjsMod.rpc.Service = js.native
    def end(endedByRPC: Boolean): typingsSlinky.protobufjs.protobufjsMod.rpc.Service = js.native
    /**
