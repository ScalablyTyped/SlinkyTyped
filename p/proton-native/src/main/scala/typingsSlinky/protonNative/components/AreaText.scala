...
object AreaText
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonNative.mod.AreaText] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonNative.mod.AreaText] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.protonNative.mod.AreaText] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.protonNative.mod.AreaText](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
