...
import typingsSlinky.protonNative.mod.AreaCircleProps
...
object AreaCircle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonNative.mod.AreaCircle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonNative.mod.AreaCircle] = {
