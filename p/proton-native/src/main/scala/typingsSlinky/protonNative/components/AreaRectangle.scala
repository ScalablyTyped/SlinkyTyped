...
object AreaRectangle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonNative.mod.AreaRectangle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonNative.mod.AreaRectangle] = {
