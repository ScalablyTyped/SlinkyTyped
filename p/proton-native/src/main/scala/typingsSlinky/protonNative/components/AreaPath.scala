...
object AreaPath
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonNative.mod.AreaPath] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonNative.mod.AreaPath] = {
