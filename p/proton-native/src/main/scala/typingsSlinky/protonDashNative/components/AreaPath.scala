...
import typingsSlinky.protonDashNative.protonDashNativeMod.AreaPathProps
...
object AreaPath
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaPath] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaPath] = {
