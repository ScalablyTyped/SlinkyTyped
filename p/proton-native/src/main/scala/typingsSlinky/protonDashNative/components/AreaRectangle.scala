...
import typingsSlinky.protonDashNative.protonDashNativeMod.AreaRectangleProps
...
object AreaRectangle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaRectangle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaRectangle] = {
