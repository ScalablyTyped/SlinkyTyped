...
import typingsSlinky.protonDashNative.protonDashNativeMod.AreaGroupProps
...
object AreaGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaGroup] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaGroup] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaGroup] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.protonDashNative.protonDashNativeMod.AreaGroup](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
