...
import typingsSlinky.protonDashNative.protonDashNativeMod.AreaLineProps
...
object AreaLine
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaLine] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaLine] = {
