...
import typingsSlinky.protonDashNative.protonDashNativeMod.AreaCircleProps
...
object AreaCircle
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaCircle] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.protonDashNative.protonDashNativeMod.AreaCircle] = {
