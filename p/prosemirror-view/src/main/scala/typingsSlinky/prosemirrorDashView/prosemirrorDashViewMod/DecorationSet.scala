package typingsSlinky.prosemirrorDashView.prosemirrorDashViewMod
...
import typingsSlinky.prosemirrorDashView.Anon_DecorationSpec
...
class DecorationSet[S /* <: Schema[_, _] */] () extends js.Object {
  ...
  def map(mapping: Mapping, doc: Node[S], options: Anon_DecorationSpec): DecorationSet[S] = js.native
  /**
