...
import typingsSlinky.prosemirrorDashView.Anon_Selection
...
trait NodeView[S /* <: Schema[_, _] */] extends js.Object {
  ...
  var update: js.UndefOr[
    (js.Function2[
      /* node */ typingsSlinky.prosemirrorDashModel.prosemirrorDashModelMod.Node[S], 
...
object NodeView {
  ...
  def apply[S /* <: Schema[_, _] */](
    ...
    update: (/* node */ typingsSlinky.prosemirrorDashModel.prosemirrorDashModelMod.Node[S], /* decorations */ js.Array[Decoration[StringDictionary[_]]]) => Boolean = null
  ): NodeView[S] = {
