...
object NodeView {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](): NodeView[S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeView[S]]
  }
  @scala.inline
  implicit class NodeViewOps[Self <: NodeView[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with NodeView[S]) extends AnyVal {
    @scala.inline
