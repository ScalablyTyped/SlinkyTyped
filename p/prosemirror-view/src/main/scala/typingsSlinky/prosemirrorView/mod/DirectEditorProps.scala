...
object DirectEditorProps {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](
  ...
  @scala.inline
  implicit class DirectEditorPropsOps[Self <: DirectEditorProps[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with DirectEditorProps[S]) extends AnyVal {
    @scala.inline
