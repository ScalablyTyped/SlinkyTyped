...
object Move {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](move: Boolean, slice: Slice[S]): Move[S] = {
    val __obj = js.Dynamic.literal(move = move.asInstanceOf[js.Any], slice = slice.asInstanceOf[js.Any])
    __obj.asInstanceOf[Move[S]]
  }
  @scala.inline
  implicit class MoveOps[Self <: Move[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Move[S]) extends AnyVal {
    @scala.inline
