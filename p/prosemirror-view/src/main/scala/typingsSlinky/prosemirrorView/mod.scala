...
import typingsSlinky.prosemirrorView.anon.OnRemove
...
object mod {
  ...
  class DecorationSet[S /* <: Schema[_, _] */] () extends StObject {
    ...
    /**
      ...
      */
    def add(
      doc: typingsSlinky.prosemirrorModel.mod.Node[S],
    ...
    /**
      ...
      * document.
      */
    def map(mapping: Mapping, doc: typingsSlinky.prosemirrorModel.mod.Node[S]): DecorationSet[S] = js.native
    def map(mapping: Mapping, doc: typingsSlinky.prosemirrorModel.mod.Node[S], options: OnRemove): DecorationSet[S] = js.native
  ...
  trait HandleDOMEventsProp[ThisT, S /* <: Schema[_, _] */]
    ...
    var progress: js.UndefOr[
        js.ThisFunction2[/* this */ ThisT, /* view */ EditorView[S], /* event */ ProgressEvent, Boolean]
      ] = js.native
  ...
  object HandleDOMEventsProp {
    ...
    implicit class HandleDOMEventsPropMutableBuilder[Self <: HandleDOMEventsProp[_, _], ThisT, S /* <: Schema[_, _] */] (val x: Self with (HandleDOMEventsProp[ThisT, S])) extends AnyVal {
      ...
      @scala.inline
      def setProgress(
        value: js.ThisFunction2[/* this */ ThisT, /* view */ EditorView[S], /* event */ ProgressEvent, Boolean]
