...
import typingsSlinky.prosemirrorMarkdown.anon.Leading
import typingsSlinky.prosemirrorMarkdown.anon.TightLists
...
object mod {
  ...
  class MarkdownParser[S /* <: Schema[_, _] */] protected () extends StObject {
    ...
    /**
      ...
      * parsers on.
      */
    var tokens: StringDictionary[typingsSlinky.markdownIt.tokenMod.^] = js.native
  }
  ...
  object TokenConfig {
    ...
    implicit class TokenConfigMutableBuilder[Self <: TokenConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetAttrs(value: /* token */ typingsSlinky.markdownIt.tokenMod.^ => Record[String, _]): Self = StObject.set(x, "getAttrs", js.Any.fromFunction1(value))
