...
object MarkSerializerConfig {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](close: String | MarkSerializerMethod[S], open: String | MarkSerializerMethod[S]): MarkSerializerConfig[S] = {
    val __obj = js.Dynamic.literal(close = close.asInstanceOf[js.Any], open = open.asInstanceOf[js.Any])
    __obj.asInstanceOf[MarkSerializerConfig[S]]
  }
  @scala.inline
  implicit class MarkSerializerConfigOps[Self <: MarkSerializerConfig[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with MarkSerializerConfig[S]) extends AnyVal {
    @scala.inline
