...
trait TokenConfig extends js.Object {
  ...
  /**
    ...
    */
  var getAttrs: js.UndefOr[js.Function1[/* token */ typingsSlinky.markdownIt.tokenMod.^, Record[String, _]]] = js.undefined
  /**
...
object TokenConfig {
  ...
  def apply(
    ...
    block: String = null,
    getAttrs: /* token */ typingsSlinky.markdownIt.tokenMod.^ => Record[String, _] = null,
