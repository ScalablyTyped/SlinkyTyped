package typingsSlinky.prosemirrorDashMarkdown.prosemirrorDashMarkdownMod
...
class MarkdownParser[S /* <: Schema[_, _] */] protected () extends js.Object {
  ...
  /**
    ...
    * parsers on.
    */
  var tokens: StringDictionary[typingsSlinky.markdownDashIt.libTokenMod.^] = js.native
  /**
