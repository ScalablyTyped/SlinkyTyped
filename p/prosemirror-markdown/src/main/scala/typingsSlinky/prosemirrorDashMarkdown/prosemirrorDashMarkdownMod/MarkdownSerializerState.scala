...
import typingsSlinky.prosemirrorDashMarkdown.Anon_Leading
import typingsSlinky.prosemirrorDashMarkdown.Anon_TightLists
...
class MarkdownSerializerState[S /* <: Schema[_, _] */] () extends js.Object {
  /**
    ...
    */
  var options: Anon_TightLists = js.native
  /**
