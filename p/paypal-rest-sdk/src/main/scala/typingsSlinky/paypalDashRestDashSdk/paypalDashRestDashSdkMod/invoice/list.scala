...
import typingsSlinky.paypalDashRestDashSdk.paypalDashRestDashSdkMod.QueryParameters
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("paypal-rest-sdk", "invoice.list")
@js.native
object list extends js.Object {
  ...
  def apply(data: QueryParameters, config: CallbackFunction[ListResponse], cb: CallbackFunction[ListResponse]): Unit = js.native
}
