package typingsSlinky.prosemirrorDashTestDashBuilder
...
package object prosemirrorDashTestDashBuilderMod {
  ...
  type Builder = js.Function2[
    ...
    (Record[String, NodeBuilderMethod[Schema[String, String]]]) with (Record[String, MarkBuilderMethod[Schema[String, String]]]) with typingsSlinky.prosemirrorDashTestDashBuilder.prosemirrorDashTestDashBuilderStrings.Builder with (Record[String, NodeTypeAttributes | MarkTypeAttributes])
  ]
