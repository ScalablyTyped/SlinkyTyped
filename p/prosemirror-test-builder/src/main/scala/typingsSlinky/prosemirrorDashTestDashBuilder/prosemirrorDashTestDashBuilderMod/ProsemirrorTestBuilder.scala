...
trait ProsemirrorTestBuilder extends js.Object {
  ...
  def builders[Obj /* <: Record[String, NodeTypeAttributes | MarkTypeAttributes] */, N /* <: String */, M /* <: String */](testSchema: Schema[N, M], names: Obj): (Record[N, NodeBuilderMethod[Schema[N, M]]]) with (Record[M, MarkBuilderMethod[Schema[N, M]]]) with typingsSlinky.prosemirrorDashTestDashBuilder.prosemirrorDashTestDashBuilderStrings.ProsemirrorTestBuilder with Obj = js.native
  def bullet_list(
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param args because its type Args is not an array type */ args: Args
  ): TaggedProsemirrorNode[TestSchema] = js.native
  def code(
