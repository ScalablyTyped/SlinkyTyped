...
object TaggedFlatObject {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](flat: js.Array[TaggedProsemirrorNode[S] | TaggedFlatObject[S]], tag: Record[String, Double]): TaggedFlatObject[S] = {
  ...
  @scala.inline
  implicit class TaggedFlatObjectOps[Self <: TaggedFlatObject[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with TaggedFlatObject[S]) extends AnyVal {
    @scala.inline
