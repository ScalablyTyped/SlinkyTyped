...
trait PopperOptions extends js.Object {
  ...
  var modifiers: js.UndefOr[typingsSlinky.popperDotJs.popperDotJsMod.Popper.Modifiers] = js.undefined
  var onCreate: js.UndefOr[
    js.Function1[/* data */ typingsSlinky.popperDotJs.popperDotJsMod.Popper.Data, Unit]
  ] = js.undefined
  var onUpdate: js.UndefOr[
    js.Function1[/* data */ typingsSlinky.popperDotJs.popperDotJsMod.Popper.Data, Unit]
  ] = js.undefined
  var placement: js.UndefOr[typingsSlinky.popperDotJs.popperDotJsMod.Popper.Placement] = js.undefined
...
object PopperOptions {
  ...
  def apply(
    ...
    modifiers: typingsSlinky.popperDotJs.popperDotJsMod.Popper.Modifiers = null,
    onCreate: /* data */ typingsSlinky.popperDotJs.popperDotJsMod.Popper.Data => Unit = null,
    onUpdate: /* data */ typingsSlinky.popperDotJs.popperDotJsMod.Popper.Data => Unit = null,
    placement: typingsSlinky.popperDotJs.popperDotJsMod.Popper.Placement = null,
