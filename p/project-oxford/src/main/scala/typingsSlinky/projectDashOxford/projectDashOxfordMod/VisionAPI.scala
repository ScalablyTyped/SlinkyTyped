...
import typingsSlinky.projectDashOxford.projectDashOxfordMod.Options.Analyze
import typingsSlinky.projectDashOxford.projectDashOxfordMod.Options.Ocr
import typingsSlinky.projectDashOxford.projectDashOxfordMod.Options.Thumbnail
...
class VisionAPI () extends js.Object {
  /**
    ...
    */
  def analyzeImage(options: Analyze): ^[typingsSlinky.projectDashOxford.projectDashOxfordMod.VisionResponses.Analyze] = js.native
  /**
    ...
    * @return {Promise}                            - Promise resolving with the resulting JSON
    */
  def ocr(options: Ocr): ^[typingsSlinky.projectDashOxford.projectDashOxfordMod.VisionResponses.Ocr] = js.native
  /**
