...
import typingsSlinky.projectDashOxford.Anon_PersonId
import typingsSlinky.projectDashOxford.projectDashOxfordMod.PersonResponses.Face
...
class Person () extends js.Object {
  ...
  /**
    ...
    * @return {Promise}                 - Promise resolving with the resulting JSON
    */
  def get(personGroupId: String, personId: String): ^[typingsSlinky.projectDashOxford.projectDashOxfordMod.PersonResponses.Person] = js.native
  /**
  ...
  def list(personGroupId: String): ^[
    js.Array[typingsSlinky.projectDashOxford.projectDashOxfordMod.PersonResponses.Person]
  ] = js.native
  /**
