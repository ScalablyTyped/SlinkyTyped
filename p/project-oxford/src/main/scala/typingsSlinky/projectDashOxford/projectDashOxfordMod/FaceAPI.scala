...
import typingsSlinky.projectDashOxford.projectDashOxfordMod.FaceResponses.Grouping
import typingsSlinky.projectDashOxford.projectDashOxfordMod.FaceResponses.Similar
import typingsSlinky.projectDashOxford.projectDashOxfordMod.FaceResponses.Verify
import typingsSlinky.projectDashOxford.projectDashOxfordMod.Options.Detect
import typingsSlinky.projectDashOxford.projectDashOxfordMod.Options.Identify
...
class FaceAPI () extends js.Object {
  ...
  /**
    ...
    */
  def detect(options: Detect): ^[
    js.Array[typingsSlinky.projectDashOxford.projectDashOxfordMod.FaceResponses.Detect]
  ] = js.native
  /**
  ...
  def identify(faceIDs: js.Array[String], options: Identify): ^[
    js.Array[typingsSlinky.projectDashOxford.projectDashOxfordMod.FaceResponses.Identify]
  ] = js.native
  /**
