package typingsSlinky.projectDashOxford.projectDashOxfordMod

import typingsSlinky.bluebird.bluebirdMod.^
import typingsSlinky.projectDashOxford.projectDashOxfordMod.PersonGroupResponses.TrainingStatus
...
class PersonGroup () extends js.Object {
  ...
  def get(personGroupId: String): ^[
    typingsSlinky.projectDashOxford.projectDashOxfordMod.PersonGroupResponses.PersonGroup
  ] = js.native
  /**
