...
object PersonResponses {
  ...
  object Person {
    ...
    @scala.inline
    def apply(faceIds: js.Array[String], name: String, personId: String, userData: String): typingsSlinky.projectOxford.mod.PersonResponses.Person = {
      ...
      __obj.asInstanceOf[typingsSlinky.projectOxford.mod.PersonResponses.Person]
    }
    
    @scala.inline
    implicit class PersonMutableBuilder[Self <: typingsSlinky.projectOxford.mod.PersonResponses.Person] (val x: Self) extends AnyVal {
