...
class Person () extends StObject {
  ...
  /**
    ...
    * @return {Promise}                 - Promise resolving with the resulting JSON
    */
  def get(personGroupId: String, personId: String): ^[typingsSlinky.projectOxford.mod.PersonResponses.Person] = js.native
  ...
  /**
    ...
    * @return {Promise}                 - Promise resolving with the resulting JSON
    */
  def list(personGroupId: String): ^[js.Array[typingsSlinky.projectOxford.mod.PersonResponses.Person]] = js.native
