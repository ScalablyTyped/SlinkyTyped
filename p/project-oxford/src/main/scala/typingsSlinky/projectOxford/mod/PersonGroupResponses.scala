...
object PersonGroupResponses {
  ...
  object PersonGroup {
    ...
    @scala.inline
    def apply(name: String, personGroupId: String, userData: String): typingsSlinky.projectOxford.mod.PersonGroupResponses.PersonGroup = {
      ...
      __obj.asInstanceOf[typingsSlinky.projectOxford.mod.PersonGroupResponses.PersonGroup]
    }
    
    @scala.inline
    implicit class PersonGroupMutableBuilder[Self <: typingsSlinky.projectOxford.mod.PersonGroupResponses.PersonGroup] (val x: Self) extends AnyVal {
