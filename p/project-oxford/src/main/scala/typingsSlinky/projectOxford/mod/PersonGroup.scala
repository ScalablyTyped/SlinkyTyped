...
class PersonGroup () extends js.Object {
  ...
  /**
    ...
    * @return {Promise}                    - Promise resolving with the resulting JSON
    */
  def get(personGroupId: String): ^[typingsSlinky.projectOxford.mod.PersonGroupResponses.PersonGroup] = js.native
  
  /**
    * Lists all person groups in the current subscription.
    * @return {Promise}                    - Promise resolving with the resulting JSON
    */
  def list(): ^[js.Array[typingsSlinky.projectOxford.mod.PersonGroupResponses.PersonGroup]] = js.native
