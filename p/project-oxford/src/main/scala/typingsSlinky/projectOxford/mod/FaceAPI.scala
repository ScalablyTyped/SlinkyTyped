...
import typingsSlinky.projectOxford.mod.FaceResponses.Grouping
import typingsSlinky.projectOxford.mod.FaceResponses.Similar
import typingsSlinky.projectOxford.mod.FaceResponses.Verify
import typingsSlinky.projectOxford.mod.Options.Detect
import typingsSlinky.projectOxford.mod.Options.Identify
...
class FaceAPI () extends js.Object {
  ...
  /**
    ...
    */
  def detect(options: Detect): ^[js.Array[typingsSlinky.projectOxford.mod.FaceResponses.Detect]] = js.native
  ...
  /**
    ...
    * @return {Promise}            - Promise resolving with the resulting JSON
    */
  def identify(faceIDs: js.Array[String], options: Identify): ^[js.Array[typingsSlinky.projectOxford.mod.FaceResponses.Identify]] = js.native
