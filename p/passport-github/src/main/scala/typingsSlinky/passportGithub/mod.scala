package typingsSlinky.passportGithub

import typingsSlinky.express.mod.Request_
import typingsSlinky.expressServeStaticCore.mod.ParamsDictionary
import typingsSlinky.expressServeStaticCore.mod.Query
import typingsSlinky.node.httpMod.OutgoingHttpHeaders
import typingsSlinky.passportGithub.passportGithubBooleans.`false`
import typingsSlinky.passportGithub.passportGithubBooleans.`true`
...
object mod {
  ...
  type Strategy = typingsSlinky.passportOauth2.mod.Strategy
