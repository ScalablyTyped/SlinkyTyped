...
import typingsSlinky.plugapi.plugapiMod.Event.Advance
import typingsSlinky.plugapi.plugapiMod.Event.BoothCycle
import typingsSlinky.plugapi.plugapiMod.Event.BoothLocked
import typingsSlinky.plugapi.plugapiMod.Event.Chat
import typingsSlinky.plugapi.plugapiMod.Event.ChatDelete
import typingsSlinky.plugapi.plugapiMod.Event.Command
import typingsSlinky.plugapi.plugapiMod.Event.DJListUpdate
import typingsSlinky.plugapi.plugapiMod.Event.Emote
import typingsSlinky.plugapi.plugapiMod.Event.FollowJoin
import typingsSlinky.plugapi.plugapiMod.Event.Grab
import typingsSlinky.plugapi.plugapiMod.Event.ModAddDJ
import typingsSlinky.plugapi.plugapiMod.Event.ModBan
import typingsSlinky.plugapi.plugapiMod.Event.ModMoveDJ
import typingsSlinky.plugapi.plugapiMod.Event.ModRemoveDJ
import typingsSlinky.plugapi.plugapiMod.Event.ModSkip
import typingsSlinky.plugapi.plugapiMod.Event.RoomJoin
import typingsSlinky.plugapi.plugapiMod.Event.RoomMinChatLevelUpdate
import typingsSlinky.plugapi.plugapiMod.Event.UserJoin
import typingsSlinky.plugapi.plugapiMod.Event.UserLeave
import typingsSlinky.plugapi.plugapiMod.Event.UserUpdate
import typingsSlinky.plugapi.plugapiMod.Event.Vote
import typingsSlinky.plugapi.plugapiMod.User.Audience
import typingsSlinky.plugapi.plugapiMod.User.DJ
import typingsSlinky.plugapi.plugapiMod.User.Extended
