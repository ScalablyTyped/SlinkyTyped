...
trait RoomMinChatLevelUpdate extends js.Object {
  var id: Double
  var level: Double
  var user: typingsSlinky.plugapi.plugapiMod.User.User
}

object RoomMinChatLevelUpdate {
  @scala.inline
  def apply(id: Double, level: Double, user: typingsSlinky.plugapi.plugapiMod.User.User): RoomMinChatLevelUpdate = {
