...
object User {
  ...
  object User {
    ...
    def apply(
      ...
      sub: Double,
      username: String
    ): typingsSlinky.plugapi.mod.User.User = {
      ...
      __obj.asInstanceOf[typingsSlinky.plugapi.mod.User.User]
    }
    
    @scala.inline
    implicit class UserMutableBuilder[Self <: typingsSlinky.plugapi.mod.User.User] (val x: Self) extends AnyVal {
