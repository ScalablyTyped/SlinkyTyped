package typingsSlinky.pouchdbDashAdapterDashLocalstorage.PouchDB.LocalStorageAdapter

import typingsSlinky.pouchdbDashAdapterDashLocalstorage.pouchdbDashAdapterDashLocalstorageStrings.localstorage
