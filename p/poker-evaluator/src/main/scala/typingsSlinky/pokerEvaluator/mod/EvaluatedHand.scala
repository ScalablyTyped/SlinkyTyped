package typingsSlinky.pokerEvaluator.mod
...
object EvaluatedHand {
  ...
  implicit class EvaluatedHandOps[Self <: EvaluatedHand] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHandName(value: HandName): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHandRank(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handRank")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHandType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
