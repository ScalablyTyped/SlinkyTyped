package typingsSlinky.atPhosphorWidgets.libDockpanelMod
...
import typingsSlinky.atPhosphorWidgets.libDockpanelMod.DockPanel.IAddOptions
import typingsSlinky.atPhosphorWidgets.libDockpanelMod.DockPanel.ILayoutConfig
