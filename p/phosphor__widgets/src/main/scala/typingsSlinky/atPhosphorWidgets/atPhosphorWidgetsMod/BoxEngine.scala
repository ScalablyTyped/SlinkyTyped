...
object BoxEngine extends js.Object {
  /**
    ...
    */
  def adjust(
    sizers: ArrayLike[typingsSlinky.atPhosphorWidgets.libBoxengineMod.BoxSizer],
    index: Double,
    delta: Double
  ): Unit = js.native
  /**
    ...
    */
  def calc(sizers: ArrayLike[typingsSlinky.atPhosphorWidgets.libBoxengineMod.BoxSizer], space: Double): Double = js.native
}
