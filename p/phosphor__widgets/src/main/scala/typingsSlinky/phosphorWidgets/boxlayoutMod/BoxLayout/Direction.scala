...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.phosphorWidgets.phosphorWidgetsStrings.`left-to-right`
  - typingsSlinky.phosphorWidgets.phosphorWidgetsStrings.`right-to-left`
  - typingsSlinky.phosphorWidgets.phosphorWidgetsStrings.`top-to-bottom`
  - typingsSlinky.phosphorWidgets.phosphorWidgetsStrings.`bottom-to-top`
*/
