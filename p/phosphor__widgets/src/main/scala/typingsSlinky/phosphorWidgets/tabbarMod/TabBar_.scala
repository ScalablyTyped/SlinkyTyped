...
import typingsSlinky.phosphorWidgets.tabbarMod.TabBar.ITabActivateRequestedArgs
import typingsSlinky.phosphorWidgets.tabbarMod.TabBar.ITabCloseRequestedArgs
import typingsSlinky.phosphorWidgets.tabbarMod.TabBar.ITabDetachRequestedArgs
import typingsSlinky.phosphorWidgets.tabbarMod.TabBar.ITabMovedArgs
...
class TabBar_[T] () extends Widget {
  ...
  def addTab(value: typingsSlinky.phosphorWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  /**
  ...
  def insertTab(index: Double, value: typingsSlinky.phosphorWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  /**
    * Release the mouse and restore the non-dragged tab positions.
    *
    * #### Notes
