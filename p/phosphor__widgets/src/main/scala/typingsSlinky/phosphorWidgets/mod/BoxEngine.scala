...
object BoxEngine extends js.Object {
  /**
    ...
    */
  def adjust(
    sizers: ArrayLike[typingsSlinky.phosphorWidgets.boxengineMod.BoxSizer],
    index: Double,
    delta: Double
  ): Unit = js.native
  /**
    ...
    */
  def calc(sizers: ArrayLike[typingsSlinky.phosphorWidgets.boxengineMod.BoxSizer], space: Double): Double = js.native
}
