...
object mod {
  ...
  object PikadayOptions {
    ...
    implicit class PikadayOptionsMutableBuilder[Self <: PikadayOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnSelect(value: js.ThisFunction1[/* this */ Pikaday, /* date */ js.Date, Unit]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOnSelectUndefined: Self = StObject.set(x, "onSelect", js.undefined)
      
      @scala.inline
      def setParse(value: (/* date */ String, /* format */ String) => js.Date | Null): Self = StObject.set(x, "parse", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setToString_(value: (/* date */ js.Date, /* format */ js.UndefOr[String]) => String): Self = StObject.set(x, "toString", js.Any.fromFunction2(value))
