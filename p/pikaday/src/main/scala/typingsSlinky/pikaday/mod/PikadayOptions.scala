...
object PikadayOptions {
  ...
  def apply(
    ...
    onDraw: () => Unit = null,
    onOpen: () => Unit = null,
    onSelect: js.ThisFunction1[/* this */ Pikaday, /* date */ js.Date, Unit] = null,
    parse: (/* date */ String, /* format */ String) => js.Date | Null = null,
    ...
    theme: String = null,
    toString: (/* date */ js.Date, /* format */ js.UndefOr[String]) => String = null,
