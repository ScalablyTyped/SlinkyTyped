...
object PikadayOptions {
  ...
  implicit class PikadayOptionsOps[Self <: PikadayOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableDayFn(value: /* date */ js.Date => Boolean): Self = this.set("disableDayFn", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnSelect(value: js.ThisFunction1[/* this */ Pikaday, /* date */ js.Date, Unit]): Self = this.set("onSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnSelect: Self = this.set("onSelect", js.undefined)
    
    @scala.inline
    def setParse(value: (/* date */ String, /* format */ String) => js.Date | Null): Self = this.set("parse", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setToString(value: (/* date */ js.Date, /* format */ js.UndefOr[String]) => String): Self = this.set("toString", js.Any.fromFunction2(value))
