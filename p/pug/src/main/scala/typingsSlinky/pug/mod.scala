...
import typingsSlinky.pug.anon.Body
...
object mod {
  ...
  @JSImport("pug", "render")
  @js.native
  def render(template: String, callback: js.Function2[/* err */ js.Error | Null, /* html */ String, Unit]): Unit = js.native
  @JSImport("pug", "render")
  @js.native
  ...
  @JSImport("pug", "renderFile")
  @js.native
  def renderFile(path: String, callback: js.Function2[/* err */ js.Error | Null, /* html */ String, Unit]): Unit = js.native
  @JSImport("pug", "renderFile")
  @js.native
