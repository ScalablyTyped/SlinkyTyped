...
object StrategyValues extends StObject {
  ...
  /* 0 */ val Z_DEFAULT_STRATEGY: typingsSlinky.pako.mod.StrategyValues.Z_DEFAULT_STRATEGY with Double = js.native
  
  @js.native
  sealed trait Z_FILTERED extends StrategyValues
  /* 1 */ val Z_FILTERED: typingsSlinky.pako.mod.StrategyValues.Z_FILTERED with Double = js.native
  
  @js.native
  sealed trait Z_FIXED extends StrategyValues
  /* 4 */ val Z_FIXED: typingsSlinky.pako.mod.StrategyValues.Z_FIXED with Double = js.native
  
  @js.native
  sealed trait Z_HUFFMAN_ONLY extends StrategyValues
  /* 2 */ val Z_HUFFMAN_ONLY: typingsSlinky.pako.mod.StrategyValues.Z_HUFFMAN_ONLY with Double = js.native
  
  @js.native
  sealed trait Z_RLE extends StrategyValues
  /* 3 */ val Z_RLE: typingsSlinky.pako.mod.StrategyValues.Z_RLE with Double = js.native
}
