...
import typingsSlinky.phoenix.Anon_Joins
...
object Presence extends js.Object {
  ...
  def syncDiff(currentState: js.Object, diff: Anon_Joins): js.Any = js.native
  def syncDiff(currentState: js.Object, diff: Anon_Joins, onJoin: PresenceOnJoinCallback): js.Any = js.native
  def syncDiff(
