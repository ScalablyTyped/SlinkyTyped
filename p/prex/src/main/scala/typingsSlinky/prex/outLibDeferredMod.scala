...
@js.native
object outLibDeferredMod extends js.Object {
  @js.native
  /**
  ...
  class Deferred[T] () extends js.Object {
    ...
    /**
      ...
      */
    val callback: (js.Function2[/* err */ js.UndefOr[js.Error | Null], /* value */ T, Unit]) | (js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) = js.native
    /**
      * Gets the promise.
      */
    ...
    /**
      ...
      */
    def createCallback[A /* <: js.Array[_] */](selector: js.Function1[/* args */ A, T]): js.Function2[/* err */ js.UndefOr[js.Error | Null], /* args */ A, Unit] = js.native
    /**
