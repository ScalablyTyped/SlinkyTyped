...
import typingsSlinky.pDashLoading.pDashLoadingStrings.destroy
import typingsSlinky.pDashLoading.pDashLoadingStrings.hide
import typingsSlinky.pDashLoading.pDashLoadingStrings.show
