...
import typingsSlinky.parse.Parse.Query.AggregationOptions
import typingsSlinky.parse.Parse.Query.CountOptions
import typingsSlinky.parse.Parse.Query.EachOptions
import typingsSlinky.parse.Parse.Query.FindOptions
import typingsSlinky.parse.Parse.Query.FirstOptions
import typingsSlinky.parse.Parse.Query.FullTextOptions
import typingsSlinky.parse.Parse.Query.GetOptions
...
class Query_[T /* <: Object[_] */] protected () extends BaseObject {
  ...
  def matches(key: String, regex: js.RegExp, modifiers: js.Any): Query[T] = js.native
