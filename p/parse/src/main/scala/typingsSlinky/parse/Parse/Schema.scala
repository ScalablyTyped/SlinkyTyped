...
import typingsSlinky.parse.Parse.Schema.Index
import typingsSlinky.parse.Parse.Schema.TYPE
import typingsSlinky.parse.Parse.Schema._TYPE
...
object Schema extends js.Object {
  ...
  */
  type TYPE = _TYPE | js.Array[js.Any] | (Relation[Object[js.Any], Object[js.Any]]) | String | Double | Boolean | js.Date | js.Object
}
