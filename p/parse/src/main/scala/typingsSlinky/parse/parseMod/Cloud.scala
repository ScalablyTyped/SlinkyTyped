...
import typingsSlinky.parse.Parse.Cloud.AfterDeleteRequest
import typingsSlinky.parse.Parse.Cloud.AfterFindRequest
import typingsSlinky.parse.Parse.Cloud.AfterSaveRequest
import typingsSlinky.parse.Parse.Cloud.BeforeDeleteRequest
import typingsSlinky.parse.Parse.Cloud.BeforeFindRequest
import typingsSlinky.parse.Parse.Cloud.BeforeSaveRequest
import typingsSlinky.parse.Parse.Cloud.FunctionRequest
import typingsSlinky.parse.Parse.Cloud.HTTPOptions
import typingsSlinky.parse.Parse.Cloud.HttpResponse
import typingsSlinky.parse.Parse.Cloud.JobRequest
import typingsSlinky.parse.Parse.Cloud.RunOptions
import typingsSlinky.parse.Parse.Cloud.TriggerRequest
...
object Cloud extends js.Object {
  /**
    ...
    */
  var HTTPOptions: Instantiable0[typingsSlinky.parse.Parse.Cloud.HTTPOptions] = js.native
  ...
  def beforeFind(
    ...
    func: js.Function1[
      ...
      (js.Promise[typingsSlinky.parse.Parse.Query[typingsSlinky.parse.Parse.Object[_]] | Unit]) | typingsSlinky.parse.Parse.Query[typingsSlinky.parse.Parse.Object[_]] | Unit
    ]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def getJobStatus(jobStatusId: String): js.Promise[typingsSlinky.parse.Parse.Object[_]] = js.native
  /**
    * Gets data for the current set of cloud jobs.
    * @returns A promise that will be resolved with the result of the function.
    */
  def getJobsData(): js.Promise[typingsSlinky.parse.Parse.Object[_]] = js.native
  ...
  object ReadPreferenceOption extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsSlinky.parse.Parse.Cloud.ReadPreferenceOption with String] = js.native
  }
