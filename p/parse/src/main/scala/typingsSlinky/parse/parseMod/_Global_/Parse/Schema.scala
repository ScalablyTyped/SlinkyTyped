...
import typingsSlinky.parse.parseMod._Global_.Parse.Schema.Index
import typingsSlinky.parse.parseMod._Global_.Parse.Schema.TYPE
...
object Schema extends js.Object {
  ...
  typings.parse.parseMod._Global_.Parse.Object[typings.parse.parseMod._Global_.Parse.Attributes]]
  */
  type TYPE = _TYPE | js.Array[js.Any] | (Relation[Object[Attributes], Object[Attributes]]) | String | Double | Boolean | js.Date | js.Object
}
