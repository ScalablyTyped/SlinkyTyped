...
import typingsSlinky.parse.mod.global.Parse.Installation
...
object PushData {
  ...
  implicit class PushDataOps[Self <: PushData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpiration_time(value: js.Date): Self = this.set("expiration_time", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPush_time(value: js.Date): Self = this.set("push_time", value.asInstanceOf[js.Any])
