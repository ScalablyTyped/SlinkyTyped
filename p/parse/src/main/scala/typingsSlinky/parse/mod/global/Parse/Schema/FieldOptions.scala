...
object FieldOptions {
  ...
  @scala.inline
  implicit class FieldOptionsOps[Self <: FieldOptions[_], T /* <: String | Double | Boolean | js.Date | File | GeoPoint | Polygon | js.Array[_] | js.Object | Pointer | (Relation[Object[Attributes], Object[Attributes]]) */] (val x: Self with FieldOptions[T]) extends AnyVal {
