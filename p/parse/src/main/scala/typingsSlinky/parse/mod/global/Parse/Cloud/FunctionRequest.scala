...
object FunctionRequest {
  @scala.inline
  def apply[/* <: typingsSlinky.parse.mod.global.Parse.Cloud.Params */ T](params: T): FunctionRequest[T] = {
    val __obj = js.Dynamic.literal(params = params.asInstanceOf[js.Any])
    __obj.asInstanceOf[FunctionRequest[T]]
  }
  @scala.inline
  implicit class FunctionRequestOps[Self <: FunctionRequest[_], /* <: typingsSlinky.parse.mod.global.Parse.Cloud.Params */ T] (val x: Self with FunctionRequest[T]) extends AnyVal {
    @scala.inline
