...
object Push {
  ...
  trait PushData extends StObject {
    ...
    var where: js.UndefOr[Query[typingsSlinky.parse.mod.global.Parse.Installation[Attributes]]] = js.native
  }
  object PushData {
    ...
    implicit class PushDataMutableBuilder[Self <: PushData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExpiration_time(value: js.Date): Self = StObject.set(x, "expiration_time", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPush_time(value: js.Date): Self = StObject.set(x, "push_time", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWhere(value: Query[typingsSlinky.parse.mod.global.Parse.Installation[Attributes]]): Self = StObject.set(x, "where", value.asInstanceOf[js.Any])
