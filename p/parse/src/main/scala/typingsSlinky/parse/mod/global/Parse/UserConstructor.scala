...
trait UserConstructor
  ...
  def logInWith[T /* <: User[Attributes] */](provider: String, options: typingsSlinky.parse.anon.AuthData): js.Promise[T] = js.native
  def logInWith[T /* <: User[Attributes] */](provider: String, options: typingsSlinky.parse.anon.AuthData, saveOpts: FullOptions): js.Promise[T] = js.native
  def logInWith[T /* <: User[Attributes] */](provider: AuthProvider, options: typingsSlinky.parse.anon.AuthData): js.Promise[T] = js.native
  def logInWith[T /* <: User[Attributes] */](provider: AuthProvider, options: typingsSlinky.parse.anon.AuthData, saveOpts: FullOptions): js.Promise[T] = js.native
