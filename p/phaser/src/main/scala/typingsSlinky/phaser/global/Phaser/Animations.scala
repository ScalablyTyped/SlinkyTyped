...
object Animations {
  ...
  class Animation protected ()
    extends typingsSlinky.phaser.Phaser.Animations.Animation {
    /**
      * 
      ...
      */
    def this(
      manager: typingsSlinky.phaser.Phaser.Animations.AnimationManager,
      key: String,
      config: typingsSlinky.phaser.Phaser.Types.Animations.Animation
    ) = this()
  }
  ...
  class AnimationFrame protected ()
    extends typingsSlinky.phaser.Phaser.Animations.AnimationFrame {
    /**
      * 
  ...
  class AnimationManager protected ()
    extends typingsSlinky.phaser.Phaser.Animations.AnimationManager {
    /**
      * 
  ...
  object Events {
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_COMPLETE")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_KEY_COMPLETE")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_KEY_REPEAT")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_KEY_RESTART")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_KEY_START")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_KEY_UPDATE")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_REPEAT")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_RESTART")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_START")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Animations.Events.SPRITE_ANIMATION_UPDATE")
    @js.native
