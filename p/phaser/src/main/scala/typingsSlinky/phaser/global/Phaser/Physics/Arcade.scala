package typingsSlinky.phaser.global.Phaser.Physics
...
object Arcade extends js.Object {
  ...
  class ArcadePhysics protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.ArcadePhysics {
    /**
      * 
  ...
  class Body protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.Body {
    /**
      * 
      * @param world The Arcade Physics simulation this Body belongs to.
      * @param gameObject The Game Object this Body belongs to.
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Arcade.World, gameObject: GameObject) = this()
  }
  ...
  class Collider protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.Collider {
    /**
      * 
      ...
      */
    def this(
      world: typingsSlinky.phaser.Phaser.Physics.Arcade.World,
      overlapOnly: Boolean,
  ...
  class Factory protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.Factory {
    /**
      * 
      * @param world The Arcade Physics World instance.
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Arcade.World) = this()
  }
  ...
  class Group protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.Group {
    /**
      * 
      ...
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Arcade.World, scene: Scene) = this()
    def this(
      world: typingsSlinky.phaser.Phaser.Physics.Arcade.World,
      scene: Scene,
      children: js.Array[GameObject]
    ) = this()
    def this(world: typingsSlinky.phaser.Phaser.Physics.Arcade.World, scene: Scene, children: GroupCreateConfig) = this()
    def this(
      world: typingsSlinky.phaser.Phaser.Physics.Arcade.World,
      scene: Scene,
  ...
  class Image protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.Image {
    /**
      * 
  ...
  class Sprite protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.Sprite {
    /**
      * 
      * @param scene The Scene to which this Game Object belongs. A Game Object can only belong to one Scene at a time.
      * @param x The horizontal position of this Game Object in the world.
  ...
  class StaticBody protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.StaticBody {
    /**
      * 
  ...
  class StaticGroup protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.StaticGroup {
    /**
      * 
      * @param world The physics simulation.
      * @param scene The scene this group belongs to.
    ...
    def this(world: typingsSlinky.phaser.Phaser.Physics.Arcade.World, scene: Scene, children: GroupConfig) = this()
    def this(world: typingsSlinky.phaser.Phaser.Physics.Arcade.World, scene: Scene, children: GroupCreateConfig) = this()
    def this(
      world: typingsSlinky.phaser.Phaser.Physics.Arcade.World,
      scene: Scene,
  ...
  class World protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Arcade.World {
    /**
      * 
  ...
  /**
    ...
    */
  def GetOverlapX(
    body1: typingsSlinky.phaser.Phaser.Physics.Arcade.Body,
    body2: typingsSlinky.phaser.Phaser.Physics.Arcade.Body,
    overlapOnly: Boolean,
    bias: Double
  ): Double = js.native
  /**
  ...
  object Tilemap extends js.Object {
    /**
      ...
      */
    def ProcessTileCallbacks(tile: Tile, sprite: typingsSlinky.phaser.Phaser.GameObjects.Sprite): Boolean = js.native
    /**
      * Internal function to process the separation of a physics body from a tile.
      * @param body The Body object to separate.
      * @param x The x separation amount.
      */
    def ProcessTileSeparationX(body: typingsSlinky.phaser.Phaser.Physics.Arcade.Body, x: Double): Unit = js.native
    /**
      * Internal function to process the separation of a physics body from a tile.
      * @param body The Body object to separate.
      * @param y The y separation amount.
      */
    def ProcessTileSeparationY(body: typingsSlinky.phaser.Phaser.Physics.Arcade.Body, y: Double): Unit = js.native
    /**
    ...
    def SeparateTile(
      i: Double,
      body: typingsSlinky.phaser.Phaser.Physics.Arcade.Body,
      tile: Tile,
    ...
    /**
      ...
      */
    def TileIntersectsBody(tileWorldRect: js.Object, body: typingsSlinky.phaser.Phaser.Physics.Arcade.Body): Boolean = js.native
  }
