...
class SkeletonClipping ()
  extends typingsSlinky.phaser.spine.SkeletonClipping {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def clipEndWithSlot(slot: typingsSlinky.phaser.spine.Slot): Unit = js.native
  /* CompleteClass */
  override def clipStart(slot: typingsSlinky.phaser.spine.Slot, clip: typingsSlinky.phaser.spine.ClippingAttachment): Double = js.native
  /* CompleteClass */
