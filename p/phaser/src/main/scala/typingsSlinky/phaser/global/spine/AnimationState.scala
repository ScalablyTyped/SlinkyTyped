...
object AnimationState {
  ...
  @scala.inline
  def HOLD_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("HOLD")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def NOT_LAST_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NOT_LAST")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def emptyAnimation: typingsSlinky.phaser.spine.Animation = js.native
  @scala.inline
  def emptyAnimation_=(x: typingsSlinky.phaser.spine.Animation): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("emptyAnimation")(x.asInstanceOf[js.Any])
}
