...
class Bone protected ()
  extends typingsSlinky.phaser.spine.Bone {
  def this(
    data: typingsSlinky.phaser.spine.BoneData,
  ...
  /* CompleteClass */
  override var children: js.Array[typingsSlinky.phaser.spine.Bone] = js.native
  /* CompleteClass */
  override var d: Double = js.native
  /* CompleteClass */
  override var data: typingsSlinky.phaser.spine.BoneData = js.native
  /* CompleteClass */
  override var parent: typingsSlinky.phaser.spine.Bone = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var skeleton: typingsSlinky.phaser.spine.Skeleton = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def localToWorld(local: typingsSlinky.phaser.spine.Vector2): typingsSlinky.phaser.spine.Vector2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def worldToLocal(world: typingsSlinky.phaser.spine.Vector2): typingsSlinky.phaser.spine.Vector2 = js.native
  /* CompleteClass */
