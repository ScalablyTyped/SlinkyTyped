...
package object GameObjects {
  ...
  ): typingsSlinky.phaser.Phaser.GameObjects.GameObject = (typingsSlinky.phaser.global.Phaser.GameObjects.^.asInstanceOf[js.Dynamic].applyDynamic("BuildGameObject")(scene.asInstanceOf[js.Any], gameObject.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.phaser.Phaser.GameObjects.GameObject]
