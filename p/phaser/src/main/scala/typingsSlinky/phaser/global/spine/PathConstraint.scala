...
class PathConstraint protected ()
  extends typingsSlinky.phaser.spine.PathConstraint {
  def this(data: typingsSlinky.phaser.spine.PathConstraintData, skeleton: typingsSlinky.phaser.spine.Skeleton) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var data: typingsSlinky.phaser.spine.PathConstraintData = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var target: typingsSlinky.phaser.spine.Slot = js.native
  /* CompleteClass */
  ...
  override def computeWorldPositions(
    path: typingsSlinky.phaser.spine.PathAttachment,
    spacesCount: Double,
    tangents: Boolean,
