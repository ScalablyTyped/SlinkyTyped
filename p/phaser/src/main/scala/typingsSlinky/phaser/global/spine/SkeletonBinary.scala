...
object SkeletonBinary extends js.Object {
  ...
  var BlendModeValues: js.Array[typingsSlinky.phaser.spine.BlendMode] = js.native
  ...
  var PositionModeValues: js.Array[typingsSlinky.phaser.spine.PositionMode] = js.native
  
  var RotateModeValues: js.Array[typingsSlinky.phaser.spine.RotateMode] = js.native
  ...
  var SpacingModeValues: js.Array[typingsSlinky.phaser.spine.SpacingMode] = js.native
  
  var TransformModeValues: js.Array[typingsSlinky.phaser.spine.TransformMode] = js.native
}
