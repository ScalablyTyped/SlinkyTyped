...
object SkeletonBinary {
  ...
  @js.native
  def BlendModeValues: js.Array[typingsSlinky.phaser.spine.BlendMode] = js.native
  @scala.inline
  def BlendModeValues_=(x: js.Array[typingsSlinky.phaser.spine.BlendMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BlendModeValues")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def PositionModeValues: js.Array[typingsSlinky.phaser.spine.PositionMode] = js.native
  @scala.inline
  def PositionModeValues_=(x: js.Array[typingsSlinky.phaser.spine.PositionMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PositionModeValues")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("spine.SkeletonBinary.RotateModeValues")
  @js.native
  def RotateModeValues: js.Array[typingsSlinky.phaser.spine.RotateMode] = js.native
  @scala.inline
  def RotateModeValues_=(x: js.Array[typingsSlinky.phaser.spine.RotateMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RotateModeValues")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SpacingModeValues: js.Array[typingsSlinky.phaser.spine.SpacingMode] = js.native
  @scala.inline
  def SpacingModeValues_=(x: js.Array[typingsSlinky.phaser.spine.SpacingMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpacingModeValues")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("spine.SkeletonBinary.TransformModeValues")
  @js.native
  def TransformModeValues: js.Array[typingsSlinky.phaser.spine.TransformMode] = js.native
  @scala.inline
  def TransformModeValues_=(x: js.Array[typingsSlinky.phaser.spine.TransformMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TransformModeValues")(x.asInstanceOf[js.Any])
}
