...
object webgl {
  ...
  object ResizeMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.phaser.spine.webgl.ResizeMode with Double] = js.native
  ...
  class ShapeRenderer protected ()
    extends typingsSlinky.phaser.spine.webgl.ShapeRenderer {
    def this(context: WebGLRenderingContext) = this()
    def this(context: typingsSlinky.phaser.spine.webgl.ManagedWebGLRenderingContext) = this()
  ...
  class SkeletonDebugRenderer protected ()
    extends typingsSlinky.phaser.spine.webgl.SkeletonDebugRenderer {
    def this(context: WebGLRenderingContext) = this()
    def this(context: typingsSlinky.phaser.spine.webgl.ManagedWebGLRenderingContext) = this()
  }
  ...
  class SkeletonRenderer protected ()
    extends typingsSlinky.phaser.spine.webgl.SkeletonRenderer {
    def this(context: typingsSlinky.phaser.spine.webgl.ManagedWebGLRenderingContext) = this()
    def this(context: typingsSlinky.phaser.spine.webgl.ManagedWebGLRenderingContext, twoColorTint: Boolean) = this()
  }
  ...
  object VertexAttributeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.phaser.spine.webgl.VertexAttributeType with Double] = js.native
  ...
  object WebGLBlendModeConverter {
    ...
    @js.native
    def getDestGLBlendMode(blendMode: typingsSlinky.phaser.spine.BlendMode): Double = js.native
    
    /* static member */
    @JSGlobal("spine.webgl.WebGLBlendModeConverter.getSourceGLBlendMode")
    @js.native
    def getSourceGLBlendMode(blendMode: typingsSlinky.phaser.spine.BlendMode): Double = js.native
    @JSGlobal("spine.webgl.WebGLBlendModeConverter.getSourceGLBlendMode")
    @js.native
    def getSourceGLBlendMode(blendMode: typingsSlinky.phaser.spine.BlendMode, premultipliedAlpha: Boolean): Double = js.native
  }
}
