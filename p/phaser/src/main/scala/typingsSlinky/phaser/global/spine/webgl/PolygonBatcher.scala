...
class PolygonBatcher protected ()
  extends typingsSlinky.phaser.spine.webgl.PolygonBatcher {
  ...
  def this(context: typingsSlinky.phaser.spine.webgl.ManagedWebGLRenderingContext, twoColorTint: Boolean) = this()
  ...
  /* CompleteClass */
  override def begin(shader: typingsSlinky.phaser.spine.webgl.Shader): Unit = js.native
  /* CompleteClass */
  override def dispose(): Unit = js.native
  /* CompleteClass */
  override def draw(
    texture: typingsSlinky.phaser.spine.webgl.GLTexture,
