...
object Cache extends js.Object {
  ...
  @js.native
  class BaseCache ()
    extends typingsSlinky.phaser.Phaser.Cache.BaseCache {
    /**
      ...
      */
    /* CompleteClass */
    override var entries: Map[String, _] = js.native
    /**
  ...
  class CacheManager protected ()
    extends typingsSlinky.phaser.Phaser.Cache.CacheManager {
    /**
      * 
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var audio: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all binary files, typically added via the Loader.
      */
    /* CompleteClass */
    override var binary: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all bitmap font data files, typically added via the Loader.
      * Only the font data is stored in this cache, the textures are part of the Texture Manager.
      */
    /* CompleteClass */
    override var bitmapFont: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * An object that contains your own custom BaseCache entries.
      * Add to this via the `addCustom` method.
      */
    /* CompleteClass */
    override var custom: StringDictionary[typingsSlinky.phaser.Phaser.Cache.BaseCache] = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var html: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all JSON data files, typically added via the Loader.
      */
    /* CompleteClass */
    override var json: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all WaveFront OBJ files, typically added via the Loader.
      */
    /* CompleteClass */
    override var obj: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all physics data files, typically added via the Loader.
      */
    /* CompleteClass */
    override var physics: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all shader source files, typically added via the Loader.
      */
    /* CompleteClass */
    override var shader: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all text files, typically added via the Loader.
      */
    /* CompleteClass */
    override var text: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all tilemap data files, typically added via the Loader.
      * Only the data is stored in this cache, the textures are part of the Texture Manager.
      */
    /* CompleteClass */
    override var tilemap: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all non-streaming video files, typically added via the Loader.
      */
    /* CompleteClass */
    override var video: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all xml data files, typically added via the Loader.
      */
    /* CompleteClass */
    override var xml: typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def addCustom(key: String): typingsSlinky.phaser.Phaser.Cache.BaseCache = js.native
    /**
