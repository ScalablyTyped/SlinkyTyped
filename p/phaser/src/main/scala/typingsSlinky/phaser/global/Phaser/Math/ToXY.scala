...
object ToXY extends js.Object {
  /**
    ...
    */
  def apply(index: integer, width: integer, height: integer): typingsSlinky.phaser.Phaser.Math.Vector2 = js.native
  def apply(index: integer, width: integer, height: integer, out: typingsSlinky.phaser.Phaser.Math.Vector2): typingsSlinky.phaser.Phaser.Math.Vector2 = js.native
}
