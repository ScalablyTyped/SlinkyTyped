...
@js.native
class TrackEntry ()
  extends typingsSlinky.phaser.spine.TrackEntry {
  /* CompleteClass */
  override var alpha: Double = js.native
  /* CompleteClass */
  override var animation: typingsSlinky.phaser.spine.Animation = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var listener: AnimationStateListener2 = js.native
  /* CompleteClass */
  override var loop: Boolean = js.native
  /* CompleteClass */
  override var mixBlend: typingsSlinky.phaser.spine.MixBlend = js.native
  /* CompleteClass */
  override var mixDuration: Double = js.native
  /* CompleteClass */
  override var mixTime: Double = js.native
  /* CompleteClass */
  override var mixingFrom: typingsSlinky.phaser.spine.TrackEntry = js.native
  /* CompleteClass */
  override var mixingTo: typingsSlinky.phaser.spine.TrackEntry = js.native
  /* CompleteClass */
  override var next: typingsSlinky.phaser.spine.TrackEntry = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var timelineHoldMix: js.Array[typingsSlinky.phaser.spine.TrackEntry] = js.native
  /* CompleteClass */
