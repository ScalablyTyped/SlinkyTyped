...
import typingsSlinky.phaser.Phaser.Types.Display.ColorObject
...
object Display extends js.Object {
  ...
  class BaseShader protected ()
    extends typingsSlinky.phaser.Phaser.Display.BaseShader {
    /**
      * 
  ...
  /**
    ...
    */
  class Color ()
    extends typingsSlinky.phaser.Phaser.Display.Color {
  ...
  object Color extends js.Object {
    ...
    /**
      ...
      */
    def HSLToColor(h: Double, s: Double, l: Double): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def HSVToRGB(h: Double, s: Double, v: Double): ColorObject | typingsSlinky.phaser.Phaser.Display.Color = js.native
    def HSVToRGB(h: Double, s: Double, v: Double, out: typingsSlinky.phaser.Phaser.Display.Color): ColorObject | typingsSlinky.phaser.Phaser.Display.Color = js.native
    def HSVToRGB(h: Double, s: Double, v: Double, out: ColorObject): ColorObject | typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def HexStringToColor(hex: String): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def IntegerToColor(input: integer): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def ObjectToColor(input: InputColorObject): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def RGBStringToColor(rgb: String): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def RGBToHSV(r: integer, g: integer, b: integer): HSVColorObject | typingsSlinky.phaser.Phaser.Display.Color = js.native
    def RGBToHSV(r: integer, g: integer, b: integer, out: typingsSlinky.phaser.Phaser.Display.Color): HSVColorObject | typingsSlinky.phaser.Phaser.Display.Color = js.native
    def RGBToHSV(r: integer, g: integer, b: integer, out: HSVColorObject): HSVColorObject | typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def RandomRGB(): typingsSlinky.phaser.Phaser.Display.Color = js.native
    def RandomRGB(min: js.UndefOr[scala.Nothing], max: integer): typingsSlinky.phaser.Phaser.Display.Color = js.native
    def RandomRGB(min: integer): typingsSlinky.phaser.Phaser.Display.Color = js.native
    def RandomRGB(min: integer, max: integer): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    /**
      ...
      */
    def ValueToColor(input: String): typingsSlinky.phaser.Phaser.Display.Color = js.native
    def ValueToColor(input: Double): typingsSlinky.phaser.Phaser.Display.Color = js.native
    def ValueToColor(input: InputColorObject): typingsSlinky.phaser.Phaser.Display.Color = js.native
    ...
    object Interpolate extends js.Object {
      ...
      /**
        ...
        */
      def ColorWithColor(
        color1: typingsSlinky.phaser.Phaser.Display.Color,
        color2: typingsSlinky.phaser.Phaser.Display.Color
      ...
      /**
        ...
        * @param index Index to start from. Default 0.
        */
      def ColorWithRGB(color1: typingsSlinky.phaser.Phaser.Display.Color, r: Double, g: Double, b: Double): ColorObject = js.native
      def ColorWithRGB(
        color1: typingsSlinky.phaser.Phaser.Display.Color,
        r: Double,
        g: Double,
      ...
      def ColorWithRGB(color1: typingsSlinky.phaser.Phaser.Display.Color, r: Double, g: Double, b: Double, length: Double): ColorObject = js.native
      def ColorWithRGB(
        color1: typingsSlinky.phaser.Phaser.Display.Color,
        r: Double,
        g: Double,
  ...
  object Masks extends js.Object {
    ...
    class BitmapMask protected ()
      extends typingsSlinky.phaser.Phaser.Display.Masks.BitmapMask {
      /**
        * 
        ...
        */
      def this(scene: typingsSlinky.phaser.Phaser.Scene, renderable: GameObject) = this()
    }
    ...
    class GeometryMask protected ()
      extends typingsSlinky.phaser.Phaser.Display.Masks.GeometryMask {
      /**
        * 
        ...
        */
      def this(scene: typingsSlinky.phaser.Phaser.Scene, graphicsGeometry: Graphics) = this()
    }
  }
}
