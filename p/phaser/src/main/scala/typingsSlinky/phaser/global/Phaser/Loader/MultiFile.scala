...
class MultiFile protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var files: js.Array[typingsSlinky.phaser.Phaser.Loader.File] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var loader: typingsSlinky.phaser.Phaser.Loader.LoaderPlugin = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addToMultiFile(files: typingsSlinky.phaser.Phaser.Loader.File): typingsSlinky.phaser.Phaser.Loader.MultiFile = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def onFileComplete(file: typingsSlinky.phaser.Phaser.Loader.File): Unit = js.native
  /**
    * Called by each File that fails to load.
    * @param file The File that has failed to load.
    */
  /* CompleteClass */
  override def onFileFailed(file: typingsSlinky.phaser.Phaser.Loader.File): Unit = js.native
}
