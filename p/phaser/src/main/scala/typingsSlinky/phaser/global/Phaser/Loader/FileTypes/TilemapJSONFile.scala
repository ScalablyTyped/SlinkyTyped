...
class TilemapJSONFile protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def onError(xhr: XMLHttpRequest, event: ProgressEvent): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def onLoad(xhr: XMLHttpRequest, event: ProgressEvent): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def onProgress(event: ProgressEvent): Unit = js.native
  /**
