...
class File protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var linkFile: typingsSlinky.phaser.Phaser.Loader.File = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var multiFile: typingsSlinky.phaser.Phaser.Loader.MultiFile = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLink(fileB: typingsSlinky.phaser.Phaser.Loader.File): Unit = js.native
}
