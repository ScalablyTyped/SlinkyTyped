...
import typingsSlinky.phaser.MatterJS.ICompositeDefinition
...
@js.native
class Composite ()
  extends typingsSlinky.phaser.MatterJS.Composite
/* static members */
@JSGlobal("MatterJS.Composite")
@js.native
object Composite extends js.Object {
  ...
  /**
    ...
    */
  def rotate(composite: CompositeType, rotation: Double, point: typingsSlinky.phaser.MatterJS.Vector): Unit = js.native
  def rotate(
  ...
  /**
    ...
    * @param {bool} [recursive=true]
    */
  def translate(composite: CompositeType, translation: typingsSlinky.phaser.MatterJS.Vector): Unit = js.native
  def translate(composite: CompositeType, translation: typingsSlinky.phaser.MatterJS.Vector, recursive: Boolean): Unit = js.native
}
