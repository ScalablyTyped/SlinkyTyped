...
object Matter extends js.Object {
  ...
  @js.native
  class BodyBounds ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.BodyBounds
  ...
  class Factory protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.Factory {
    /**
      * 
      * @param world The Matter World which this Factory adds to.
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Matter.World) = this()
  }
  ...
  class Image protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.Image {
    /**
      * 
      ...
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Matter.World, x: Double, y: Double, texture: String) = this()
    def this(world: typingsSlinky.phaser.Phaser.Physics.Matter.World, x: Double, y: Double, texture: Texture) = this()
    def this(
  ...
  class MatterPhysics protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.MatterPhysics {
    /**
      * 
  ...
  class PointerConstraint protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.PointerConstraint {
    /**
      * 
  ...
  class Sprite protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.Sprite {
    /**
      * 
      * @param world A reference to the Matter.World instance that this body belongs to.
      * @param x The horizontal position of this Game Object in the world.
  ...
  class TileBody protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.TileBody {
    /**
      * 
      ...
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Matter.World, tile: Tile) = this()
    def this(world: typingsSlinky.phaser.Phaser.Physics.Matter.World, tile: Tile, options: MatterTileOptions) = this()
  }
  ...
  class World protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Matter.World {
    /**
      * 
  ...
  /**
    ...
    */
  def MatterGameObject(world: typingsSlinky.phaser.Phaser.Physics.Matter.World, gameObject: GameObject): GameObject = js.native
  ...
  def MatterGameObject(world: typingsSlinky.phaser.Phaser.Physics.Matter.World, gameObject: GameObject, options: Body): GameObject = js.native
  def MatterGameObject(
    world: typingsSlinky.phaser.Phaser.Physics.Matter.World,
    gameObject: GameObject,
    options: Body,
