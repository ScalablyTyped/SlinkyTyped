...
import typingsSlinky.phaser.phaserStrings.mousedown
import typingsSlinky.phaser.phaserStrings.mousemove
import typingsSlinky.phaser.phaserStrings.mouseup
