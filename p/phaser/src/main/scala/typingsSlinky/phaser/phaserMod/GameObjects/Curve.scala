...
/**
  ...
  * jagged, shapes.
  */
@JSImport("phaser", "GameObjects.Curve")
@js.native
class Curve protected ()
  extends typingsSlinky.phaser.Phaser.GameObjects.Curve {
  /**
    * 
  ...
  def this(scene: Scene, x: Double, y: Double, curve: typingsSlinky.phaser.Phaser.Curves.Curve) = this()
  def this(
    scene: Scene,
    x: js.UndefOr[scala.Nothing],
    y: js.UndefOr[scala.Nothing],
