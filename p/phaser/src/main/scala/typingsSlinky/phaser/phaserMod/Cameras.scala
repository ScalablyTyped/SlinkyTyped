...
import typingsSlinky.phaser.Phaser.Types.Cameras.Controls.FixedKeyControlConfig
import typingsSlinky.phaser.Phaser.Types.Cameras.Controls.SmoothedKeyControlConfig
...
object Cameras extends js.Object {
  ...
  object Controls extends js.Object {
    ...
    class FixedKeyControl protected ()
      extends typingsSlinky.phaser.Phaser.Cameras.Controls.FixedKeyControl {
      /**
        * 
    ...
    class SmoothedKeyControl protected ()
      extends typingsSlinky.phaser.Phaser.Cameras.Controls.SmoothedKeyControl {
      /**
        * 
  ...
  object Scene2D extends js.Object {
    ...
    class BaseCamera protected ()
      extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.BaseCamera {
      /**
        * 
    ...
    class Camera protected ()
      extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Camera {
      /**
        * 
        * @param x The x position of the Camera, relative to the top-left of the game canvas.
        * @param y The y position of the Camera, relative to the top-left of the game canvas.
    ...
    class CameraManager protected ()
      extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.CameraManager {
      /**
        * 
    ...
    object Effects extends js.Object {
      ...
      class Fade protected ()
        extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Effects.Fade {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
        def this(camera: typingsSlinky.phaser.Phaser.Cameras.Scene2D.Camera) = this()
        /**
          * The Camera this effect belongs to.
          */
        /* CompleteClass */
        override val camera: typingsSlinky.phaser.Phaser.Cameras.Scene2D.Camera = js.native
        /**
        ...
        ): typingsSlinky.phaser.Phaser.Cameras.Scene2D.Camera = js.native
        /**
      ...
      class Flash protected ()
        extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Effects.Flash {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      @js.native
      class Pan protected ()
        extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Effects.Pan {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class RotateTo protected ()
        extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Effects.RotateTo {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class Shake protected ()
        extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Effects.Shake {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class Zoom protected ()
        extends typingsSlinky.phaser.Phaser.Cameras.Scene2D.Effects.Zoom {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
