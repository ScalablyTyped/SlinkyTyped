...
object Renderer extends js.Object {
  ...
  object Canvas extends js.Object {
    ...
    class CanvasRenderer protected ()
      extends typingsSlinky.phaser.Phaser.Renderer.Canvas.CanvasRenderer {
      /**
        * 
    ...
    /**
      ...
      */
    def SetTransform(
      renderer: typingsSlinky.phaser.Phaser.Renderer.Canvas.CanvasRenderer,
  ...
  object WebGL extends js.Object {
    ...
    class WebGLPipeline protected ()
      extends typingsSlinky.phaser.Phaser.Renderer.WebGL.WebGLPipeline {
      /**
        * 
      ...
      /**
        ...
        */
      /* CompleteClass */
      override var bytes: js.typedarray.Uint8Array = js.native
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override var renderer: typingsSlinky.phaser.Phaser.Renderer.WebGL.WebGLRenderer = js.native
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override var vertexData: js.typedarray.ArrayBuffer = js.native
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def onRender(scene: typingsSlinky.phaser.Phaser.Scene, camera: Camera): this.type = js.native
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def setFloat1v(name: String, arr: js.typedarray.Float32Array): this.type = js.native
      /**
        * Set a uniform value of the current pipeline program.
        * @param name The name of the uniform to look-up and modify.
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def setFloat2v(name: String, arr: js.typedarray.Float32Array): this.type = js.native
      /**
        * Set a uniform value of the current pipeline program.
        * @param name The name of the uniform to look-up and modify.
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def setFloat3v(name: String, arr: js.typedarray.Float32Array): this.type = js.native
      /**
        * Set a uniform value of the current pipeline program.
        * @param name The name of the uniform to look-up and modify.
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def setFloat4v(name: String, arr: js.typedarray.Float32Array): this.type = js.native
      /**
        * Set a uniform value of the current pipeline program.
        * @param name The name of the uniform to look-up and modify.
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def setMatrix2(name: String, transpose: Boolean, matrix: js.typedarray.Float32Array): this.type = js.native
      /**
        * Set a uniform value of the current pipeline program.
        * @param name The name of the uniform to look-up and modify.
        * @param transpose Whether to transpose the matrix. Should be `false`.
        ...
        */
      /* CompleteClass */
      override def setMatrix3(name: String, transpose: Boolean, matrix: js.typedarray.Float32Array): this.type = js.native
      /**
        * Set a uniform value of the current pipeline program.
        * @param name The name of the uniform to look-up and modify.
        ...
        */
      /* CompleteClass */
      override def setMatrix4(name: String, transpose: Boolean, matrix: js.typedarray.Float32Array): this.type = js.native
      /**
    ...
    class WebGLRenderer protected ()
      extends typingsSlinky.phaser.Phaser.Renderer.WebGL.WebGLRenderer {
      /**
        * 
    ...
    object Pipelines extends js.Object {
      ...
      class BitmapMaskPipeline protected ()
        extends typingsSlinky.phaser.Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline {
        /**
          * 
        ...
        /**
          ...
          */
        /* CompleteClass */
        override var vertexViewF32: js.typedarray.Float32Array = js.native
        /**
          * The canvas which this WebGL Pipeline renders to.
          */
        /* CompleteClass */
      ...
      class ForwardDiffuseLightPipeline protected ()
        extends typingsSlinky.phaser.Phaser.Renderer.WebGL.Pipelines.ForwardDiffuseLightPipeline {
        /**
          * 
      ...
      class TextureTintPipeline protected ()
        extends typingsSlinky.phaser.Phaser.Renderer.WebGL.Pipelines.TextureTintPipeline {
        /**
          * 
      ...
      class TextureTintStripPipeline protected ()
        extends typingsSlinky.phaser.Phaser.Renderer.WebGL.Pipelines.TextureTintStripPipeline {
        /**
          * 
          * @param config The configuration options for this Texture Tint Pipeline, as described above.
          */
