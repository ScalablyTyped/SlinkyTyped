...
object Scenes {
  ...
  @js.native
  def GetPhysicsPlugins(sys: typingsSlinky.phaser.Phaser.Scenes.Systems): js.Array[_] = js.native
  ...
  @js.native
  def GetScenePlugins(sys: typingsSlinky.phaser.Phaser.Scenes.Systems): js.Array[_] = js.native
  ...
  class SceneManager protected ()
    extends typingsSlinky.phaser.Phaser.Scenes.SceneManager {
    /**
      * 
      * @param game The Phaser.Game instance this Scene Manager belongs to.
      * @param sceneConfig Scene specific configuration settings.
      */
    def this(game: typingsSlinky.phaser.Phaser.Game, sceneConfig: js.Object) = this()
  }
  ...
  class ScenePlugin protected ()
    extends typingsSlinky.phaser.Phaser.Scenes.ScenePlugin {
    /**
      * 
  ...
  class Systems protected ()
    extends typingsSlinky.phaser.Phaser.Scenes.Systems {
    /**
      * 
      * @param scene The Scene that owns this Systems instance.
      * @param config Scene specific configuration settings.
      */
    def this(scene: typingsSlinky.phaser.Phaser.Scene, config: String) = this()
    def this(scene: typingsSlinky.phaser.Phaser.Scene, config: SettingsConfig) = this()
  }
}
