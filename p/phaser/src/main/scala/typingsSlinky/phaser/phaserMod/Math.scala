...
import typingsSlinky.phaser.Phaser.Types.Math.SinCosTable
...
object Math {
  ...
  object Angle {
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.Between")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.BetweenPoints")
    @js.native
    ...
    /**
      ...
      * @param point2 The second point.
      */
    @JSImport("phaser", "Math.Angle.BetweenPointsY")
    @js.native
    ...
    /**
      ...
      * @param y2 The y coordinate of the second point.
      */
    @JSImport("phaser", "Math.Angle.BetweenY")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.CounterClockwise")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.Normalize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.Random")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.RandomDegrees")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.Reverse")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.RotateTo")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.ShortestBetween")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.Wrap")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Angle.WrapDegrees")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.Bernstein")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.CatmullRom")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.Difference")
  @js.native
  ...
  object Distance {
    ...
    /**
      ...
      * @param y2 The y coordinate of the second point.
      */
    @JSImport("phaser", "Math.Distance.Between")
    @js.native
    def Between(x1: Double, y1: Double, x2: Double, y2: Double): Double = js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Distance.BetweenPoints")
    @js.native
    ...
    /**
      ...
      * @param b The second point.
      */
    @JSImport("phaser", "Math.Distance.BetweenPointsSquared")
    @js.native
    ...
    /**
      ...
      * @param y2 The y coordinate of the second point.
      */
    @JSImport("phaser", "Math.Distance.Chebyshev")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Distance.Power")
    @js.native
    ...
    /**
      ...
      * @param y2 The y coordinate of the second point.
      */
    @JSImport("phaser", "Math.Distance.Snake")
    @js.native
    ...
    /**
      ...
      * @param y2 The y coordinate of the second point.
      */
    @JSImport("phaser", "Math.Distance.Squared")
    @js.native
  ...
  object Easing {
    ...
    object Back {
      ...
      /**
        ...
        */
      @JSImport("phaser", "Math.Easing.Back.In")
      @js.native
      ...
      /**
        ...
        * @param overshoot The overshoot amount. Default 1.70158.
        */
      @JSImport("phaser", "Math.Easing.Back.InOut")
      @js.native
      ...
      /**
        ...
        * @param overshoot The overshoot amount. Default 1.70158.
        */
      @JSImport("phaser", "Math.Easing.Back.Out")
      @js.native
    ...
    object Bounce {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Bounce.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Bounce.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Bounce.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    object Circular {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Circular.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Circular.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Circular.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    object Cubic {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Cubic.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Cubic.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Cubic.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    object Elastic {
      ...
      /**
        ...
        */
      @JSImport("phaser", "Math.Easing.Elastic.In")
      @js.native
      def In(v: Double): Double = js.native
      @JSImport("phaser", "Math.Easing.Elastic.In")
      @js.native
      ...
      /**
        ...
        * @param period Sets how tight the sine-wave is, where smaller values are tighter waves, which result in more cycles. Default 0.1.
        */
      @JSImport("phaser", "Math.Easing.Elastic.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      @JSImport("phaser", "Math.Easing.Elastic.InOut")
      @js.native
      ...
      /**
        ...
        * @param period Sets how tight the sine-wave is, where smaller values are tighter waves, which result in more cycles. Default 0.1.
        */
      @JSImport("phaser", "Math.Easing.Elastic.Out")
      @js.native
      def Out(v: Double): Double = js.native
      @JSImport("phaser", "Math.Easing.Elastic.Out")
      @js.native
    ...
    object Expo {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Expo.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Expo.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Expo.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    /**
      ...
      * @param v The value to be tweened.
      */
    @JSImport("phaser", "Math.Easing.Linear")
    @js.native
    ...
    object Quadratic {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quadratic.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quadratic.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quadratic.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    object Quartic {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quartic.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quartic.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quartic.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    object Quintic {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quintic.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quintic.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Quintic.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    object Sine {
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Sine.In")
      @js.native
      def In(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Sine.InOut")
      @js.native
      def InOut(v: Double): Double = js.native
      ...
      /**
        ...
        * @param v The value to be tweened.
        */
      @JSImport("phaser", "Math.Easing.Sine.Out")
      @js.native
      def Out(v: Double): Double = js.native
    }
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Easing.Stepped")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.Factorial")
  @js.native
  ...
  /**
    ...
    * @param max The maximum value.
    */
  @JSImport("phaser", "Math.FromPercent")
  @js.native
  ...
  object Fuzzy {
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Fuzzy.Ceil")
    @js.native
    ...
    /**
      ...
      * @param epsilon The epsilon. Default 0.0001.
      */
    @JSImport("phaser", "Math.Fuzzy.Equal")
    @js.native
    ...
    /**
      ...
      * @param epsilon The epsilon. Default 0.0001.
      */
    @JSImport("phaser", "Math.Fuzzy.Floor")
    @js.native
    ...
    /**
      ...
      * @param epsilon The epsilon. Default 0.0001.
      */
    @JSImport("phaser", "Math.Fuzzy.GreaterThan")
    @js.native
    ...
    /**
      ...
      * @param epsilon The epsilon. Default 0.0001.
      */
    @JSImport("phaser", "Math.Fuzzy.LessThan")
    @js.native
  ...
  object Interpolation {
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Interpolation.Bezier")
    @js.native
    ...
    /**
      ...
      * @param k The percentage of interpolation, between 0 and 1.
      */
    @JSImport("phaser", "Math.Interpolation.CatmullRom")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Interpolation.CubicBezier")
    @js.native
    ...
    /**
      ...
      * @param k The percentage of interpolation, between 0 and 1.
      */
    @JSImport("phaser", "Math.Interpolation.Linear")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Interpolation.QuadraticBezier")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Interpolation.SmoothStep")
    @js.native
    ...
    /**
      ...
      * @param max The maximum value, also known as the 'right edge', assumed greater than the 'left edge'.
      */
    @JSImport("phaser", "Math.Interpolation.SmootherStep")
    @js.native
  ...
  /**
    ...
    * @param value The number to perform the check with.
    */
  @JSImport("phaser", "Math.IsEvenStrict")
  @js.native
  ...
  /**
    ...
    */
  class Matrix4 ()
    extends typingsSlinky.phaser.Phaser.Math.Matrix4 {
    def this(m: typingsSlinky.phaser.Phaser.Math.Matrix4) = this()
  }
  ...
  object Pow2 {
    ...
    /**
      ...
      * @param value The value.
      */
    @JSImport("phaser", "Math.Pow2.GetNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Pow2.IsSize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Pow2.IsValue")
    @js.native
  ...
  /**
    ...
    */
  class Quaternion ()
    extends typingsSlinky.phaser.Phaser.Math.Quaternion {
  ...
  @js.native
  def RND: typingsSlinky.phaser.Phaser.Math.RandomDataGenerator = js.native
  @scala.inline
  def RND_=(x: typingsSlinky.phaser.Phaser.Math.RandomDataGenerator): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RND")(x.asInstanceOf[js.Any])
  
  /**
    * Convert the given angle in radians, to the equivalent angle in degrees.
    * @param radians The angle in radians to convert ot degrees.
    */
  @JSImport("phaser", "Math.RadToDeg")
  @js.native
  ...
  class RandomDataGenerator ()
    extends typingsSlinky.phaser.Phaser.Math.RandomDataGenerator {
  ...
  @js.native
  def RandomXY(vector: typingsSlinky.phaser.Phaser.Math.Vector2): typingsSlinky.phaser.Phaser.Math.Vector2 = js.native
  @JSImport("phaser", "Math.RandomXY")
  @js.native
  def RandomXY(vector: typingsSlinky.phaser.Phaser.Math.Vector2, scale: Double): typingsSlinky.phaser.Phaser.Math.Vector2 = js.native
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.RandomXYZ")
  @js.native
  def RandomXYZ(vec3: typingsSlinky.phaser.Phaser.Math.Vector3): typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
  @JSImport("phaser", "Math.RandomXYZ")
  @js.native
  def RandomXYZ(vec3: typingsSlinky.phaser.Phaser.Math.Vector3, radius: Double): typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
  ...
  /**
    ...
    * @param scale The scale of the random values. Default 1.
    */
  @JSImport("phaser", "Math.RandomXYZW")
  @js.native
  def RandomXYZW(vec4: typingsSlinky.phaser.Phaser.Math.Vector4): typingsSlinky.phaser.Phaser.Math.Vector4 = js.native
  @JSImport("phaser", "Math.RandomXYZW")
  @js.native
  def RandomXYZW(vec4: typingsSlinky.phaser.Phaser.Math.Vector4, scale: Double): typingsSlinky.phaser.Phaser.Math.Vector4 = js.native
  ...
  @js.native
  def RotateVec3(
    vec: typingsSlinky.phaser.Phaser.Math.Vector3,
    axis: typingsSlinky.phaser.Phaser.Math.Vector3,
    radians: Double
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.RoundAwayFromZero")
  @js.native
  ...
  /**
    ...
    * @param max The maximum value, also known as the 'right edge', assumed greater than the 'left edge'.
    */
  @JSImport("phaser", "Math.SmoothStep")
  @js.native
  ...
  object Snap {
    ...
    /**
      ...
      */
    @JSImport("phaser", "Math.Snap.Ceil")
    @js.native
    ...
    /**
      ...
      * @param divide If `true` it will divide the snapped value by the gap before returning. Default false.
      */
    @JSImport("phaser", "Math.Snap.Floor")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("phaser", "Math.ToXY")
  @js.native
  def ToXY(index: integer, width: integer, height: integer): typingsSlinky.phaser.Phaser.Math.Vector2 = js.native
  @JSImport("phaser", "Math.ToXY")
  @js.native
  def ToXY(index: integer, width: integer, height: integer, out: typingsSlinky.phaser.Phaser.Math.Vector2): typingsSlinky.phaser.Phaser.Math.Vector2 = js.native
  ...
  /**
    ...
    */
  class Vector3 ()
    extends typingsSlinky.phaser.Phaser.Math.Vector3 {
    def this(x: Double) = this()
    def this(x: js.UndefOr[scala.Nothing], y: Double) = this()
    def this(x: Double, y: Double) = this()
    def this(x: js.UndefOr[scala.Nothing], y: js.UndefOr[scala.Nothing], z: Double) = this()
  ...
  object Vector3 {
    ...
    @js.native
    val BACK: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val DOWN: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val FORWARD: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val LEFT: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val ONE: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val RIGHT: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val UP: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
    ...
    @js.native
    val ZERO: typingsSlinky.phaser.Phaser.Math.Vector3 = js.native
  }
  ...
  /**
    ...
    */
  class Vector4 ()
    extends typingsSlinky.phaser.Phaser.Math.Vector4 {
    def this(x: Double) = this()
    def this(x: js.UndefOr[scala.Nothing], y: Double) = this()
    def this(x: Double, y: Double) = this()
    def this(x: js.UndefOr[scala.Nothing], y: js.UndefOr[scala.Nothing], z: Double) = this()
