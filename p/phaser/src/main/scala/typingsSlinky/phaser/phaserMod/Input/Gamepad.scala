...
object Gamepad extends js.Object {
  ...
  class Axis protected ()
    extends typingsSlinky.phaser.Phaser.Input.Gamepad.Axis {
    /**
      * 
      * @param pad A reference to the Gamepad that this Axis belongs to.
      * @param index The index of this Axis.
      */
    def this(pad: typingsSlinky.phaser.Phaser.Input.Gamepad.Gamepad, index: integer) = this()
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var pad: typingsSlinky.phaser.Phaser.Input.Gamepad.Gamepad = js.native
    /**
  ...
  class Button protected ()
    extends typingsSlinky.phaser.Phaser.Input.Gamepad.Button {
    /**
      * 
  ...
  class Gamepad protected ()
    extends typingsSlinky.phaser.Phaser.Input.Gamepad.Gamepad {
    /**
      * 
      * @param manager A reference to the Gamepad Plugin.
      * @param pad The Gamepad object, as extracted from GamepadEvent.
      */
    def this(manager: typingsSlinky.phaser.Phaser.Input.Gamepad.GamepadPlugin, pad: Pad) = this()
  }
  ...
  class GamepadPlugin protected ()
    extends typingsSlinky.phaser.Phaser.Input.Gamepad.GamepadPlugin {
    /**
      * 
