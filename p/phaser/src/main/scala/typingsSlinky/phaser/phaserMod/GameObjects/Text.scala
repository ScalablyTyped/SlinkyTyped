...
class Text protected ()
  extends typingsSlinky.phaser.Phaser.GameObjects.Text {
  /**
    * 
...
object Text {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("phaser", "GameObjects.Text.GetTextSize")
  @js.native
  def GetTextSize(text: typingsSlinky.phaser.Phaser.GameObjects.Text, size: TextMetrics, lines: js.Array[_]): js.Object = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("phaser", "GameObjects.Text.MeasureText")
  @js.native
  def MeasureText(textStyle: typingsSlinky.phaser.Phaser.GameObjects.TextStyle): TextMetrics = js.native
}
