...
class Group protected ()
  ...
  def this(scene: typingsSlinky.phaser.Phaser.Scene, children: GroupConfig) = this()
  def this(scene: typingsSlinky.phaser.Phaser.Scene, children: GroupCreateConfig) = this()
  def this(
    scene: typingsSlinky.phaser.Phaser.Scene,
    children: js.Array[typingsSlinky.phaser.Phaser.GameObjects.GameObject],
    config: GroupConfig
  ...
  def this(scene: typingsSlinky.phaser.Phaser.Scene, children: GroupConfig, config: GroupConfig) = this()
  def this(scene: typingsSlinky.phaser.Phaser.Scene, children: GroupConfig, config: GroupCreateConfig) = this()
  def this(scene: typingsSlinky.phaser.Phaser.Scene, children: GroupCreateConfig, config: GroupConfig) = this()
  def this(scene: typingsSlinky.phaser.Phaser.Scene, children: GroupCreateConfig, config: GroupCreateConfig) = this()
}
