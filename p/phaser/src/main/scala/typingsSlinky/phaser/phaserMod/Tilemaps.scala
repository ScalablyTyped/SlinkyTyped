...
import typingsSlinky.phaser.Phaser.Types.Tilemaps.GIDData
import typingsSlinky.phaser.Phaser.Types.Tilemaps.LayerDataConfig
import typingsSlinky.phaser.Phaser.Types.Tilemaps.MapDataConfig
import typingsSlinky.phaser.Phaser.Types.Tilemaps.ObjectLayerConfig
import typingsSlinky.phaser.Phaser.Types.Tilemaps.TiledObject
...
object Tilemaps extends js.Object {
  ...
  class DynamicTilemapLayer protected ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.DynamicTilemapLayer {
    /**
      * 
    ...
    def this(
      ...
      tilemap: typingsSlinky.phaser.Phaser.Tilemaps.Tilemap,
      layerIndex: integer,
      tileset: String
    ) = this()
    def this(
      ...
      tilemap: typingsSlinky.phaser.Phaser.Tilemaps.Tilemap,
      layerIndex: integer,
      tileset: js.Array[String | typingsSlinky.phaser.Phaser.Tilemaps.Tileset]
    ) = this()
    def this(
      scene: typingsSlinky.phaser.Phaser.Scene,
      tilemap: typingsSlinky.phaser.Phaser.Tilemaps.Tilemap,
      layerIndex: integer,
      tileset: typingsSlinky.phaser.Phaser.Tilemaps.Tileset
    ) = this()
    def this(
      scene: typingsSlinky.phaser.Phaser.Scene,
      tilemap: typingsSlinky.phaser.Phaser.Tilemaps.Tilemap,
  ...
  class ImageCollection protected ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.ImageCollection {
    /**
      * 
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def addImage(gid: integer, image: String): typingsSlinky.phaser.Phaser.Tilemaps.ImageCollection = js.native
    /**
  ...
  /**
    ...
    */
  class LayerData ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.LayerData {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var data: js.Array[js.Array[typingsSlinky.phaser.Phaser.Tilemaps.Tile]] = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var tilemapLayer: typingsSlinky.phaser.Phaser.Tilemaps.DynamicTilemapLayer | typingsSlinky.phaser.Phaser.Tilemaps.StaticTilemapLayer = js.native
    /**
  ...
  /**
    ...
    */
  class MapData ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.MapData {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var layers: js.Array[typingsSlinky.phaser.Phaser.Tilemaps.LayerData] | typingsSlinky.phaser.Phaser.Tilemaps.ObjectLayer = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var tilesets: js.Array[typingsSlinky.phaser.Phaser.Tilemaps.Tileset] = js.native
    /**
  ...
  /**
    ...
    */
  class ObjectLayer ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.ObjectLayer {
  ...
  class StaticTilemapLayer protected ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.StaticTilemapLayer {
    /**
      * 
      * @param scene The Scene to which this Game Object belongs.
      * @param tilemap The Tilemap this layer is a part of.
  ...
  class Tile protected ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.Tile {
    /**
      * 
      ...
      */
    def this(
      layer: typingsSlinky.phaser.Phaser.Tilemaps.LayerData,
      index: integer,
      x: integer,
      y: integer,
      width: integer,
  ...
  class Tilemap protected ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.Tilemap {
    /**
      * 
      * @param scene The Scene to which this Tilemap belongs.
      * @param mapData A MapData instance containing Tilemap data.
      */
    def this(scene: typingsSlinky.phaser.Phaser.Scene, mapData: typingsSlinky.phaser.Phaser.Tilemaps.MapData) = this()
  }
  ...
  class Tileset protected ()
    extends typingsSlinky.phaser.Phaser.Tilemaps.Tileset {
    /**
      * 
  ...
  ): typingsSlinky.phaser.Phaser.Tilemaps.Tilemap = js.native
  @js.native
  ...
  object Parsers extends js.Object {
    def Parse(
      ...
      tileHeight: integer,
      insertNull: Boolean
    ): typingsSlinky.phaser.Phaser.Tilemaps.MapData = js.native
    /**
    ...
    /**
      ...
      * the default value set.
      */
    def ParseCSV(name: String, data: String, tileWidth: integer, tileHeight: integer, insertNull: Boolean): typingsSlinky.phaser.Phaser.Tilemaps.MapData = js.native
    @js.native
    object Impact extends js.Object {
      /**
        ...
        */
      def ParseTileLayers(json: js.Object, insertNull: Boolean): js.Array[typingsSlinky.phaser.Phaser.Tilemaps.LayerData] = js.native
      /**
      ...
      /**
        ...
        * the default value set.
        */
      def ParseWeltmeister(name: String, json: js.Object, insertNull: Boolean): typingsSlinky.phaser.Phaser.Tilemaps.MapData = js.native
    }
    ...
    object Tiled extends js.Object {
      /**
        ...
        */
      def AssignTileProperties(mapData: typingsSlinky.phaser.Phaser.Tilemaps.MapData): Unit = js.native
      /**
      ...
      /**
        ...
        * @param mapData The Map Data object.
        */
      def BuildTilesetIndex(mapData: typingsSlinky.phaser.Phaser.Tilemaps.MapData): js.Array[_] = js.native
      /**
      ...
      /**
        ...
        * the default value set.
        */
      def ParseJSONTiled(name: String, json: js.Object, insertNull: Boolean): typingsSlinky.phaser.Phaser.Tilemaps.MapData = js.native
      /**
