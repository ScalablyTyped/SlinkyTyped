...
object Structs extends js.Object {
  ...
  class List[T] protected ()
    extends typingsSlinky.phaser.Phaser.Structs.List[T] {
    /**
      * 
  ...
  class Map[K, V] protected ()
    extends typingsSlinky.phaser.Phaser.Structs.Map[K, V] {
    /**
      * 
  ...
  class ProcessQueue[T] ()
    extends typingsSlinky.phaser.Phaser.Structs.ProcessQueue[T]
  ...
  @js.native
  class RTree ()
    extends typingsSlinky.phaser.Phaser.Structs.RTree
  ...
  /**
    ...
    */
  class Set[T] ()
    extends typingsSlinky.phaser.Phaser.Structs.Set[T] {
  ...
  /**
    ...
    */
  class Size ()
    extends typingsSlinky.phaser.Phaser.Structs.Size {
