...
object Plugins extends js.Object {
  ...
  class BasePlugin protected ()
    extends typingsSlinky.phaser.Phaser.Plugins.BasePlugin {
    /**
      * 
      * @param pluginManager A reference to the Plugin Manager.
      */
    def this(pluginManager: typingsSlinky.phaser.Phaser.Plugins.PluginManager) = this()
  }
  ...
  class PluginManager protected ()
    extends typingsSlinky.phaser.Phaser.Plugins.PluginManager {
    /**
      * 
  ...
  class ScenePlugin protected ()
    extends typingsSlinky.phaser.Phaser.Plugins.ScenePlugin {
    /**
      * 
    ...
    def this(
      ...
      pluginManager: typingsSlinky.phaser.Phaser.Plugins.PluginManager
    ) = this()
  }
