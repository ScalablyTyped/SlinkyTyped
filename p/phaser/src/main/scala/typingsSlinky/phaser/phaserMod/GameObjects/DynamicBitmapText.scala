...
class DynamicBitmapText protected ()
  extends typingsSlinky.phaser.Phaser.GameObjects.DynamicBitmapText {
  /**
    * 
    ...
    */
  def this(scene: typingsSlinky.phaser.Phaser.Scene, x: Double, y: Double, font: String) = this()
  def this(scene: typingsSlinky.phaser.Phaser.Scene, x: Double, y: Double, font: String, text: String) = this()
  def this(
