...
class Polygon protected ()
  extends typingsSlinky.phaser.Phaser.GameObjects.Polygon {
  /**
    * 
  ...
  def this(scene: typingsSlinky.phaser.Phaser.Scene, x: Double, y: Double, points: js.Any) = this()
  def this(scene: typingsSlinky.phaser.Phaser.Scene, x: Double, y: Double, points: js.Any, fillColor: Double) = this()
  def this(
