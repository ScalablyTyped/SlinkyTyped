...
object Particles extends js.Object {
  ...
  class ParticleEmitterManager protected ()
    ...
    /**
      ...
      */
    def this(scene: typingsSlinky.phaser.Phaser.Scene, texture: String) = this()
    def this(scene: typingsSlinky.phaser.Phaser.Scene, texture: String, frame: String) = this()
    def this(scene: typingsSlinky.phaser.Phaser.Scene, texture: String, frame: integer) = this()
    def this(
