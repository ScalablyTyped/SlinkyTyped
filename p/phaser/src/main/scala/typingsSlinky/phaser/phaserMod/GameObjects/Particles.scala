...
object Particles extends js.Object {
  ...
  class EmitterOp protected ()
    extends typingsSlinky.phaser.Phaser.GameObjects.Particles.EmitterOp {
    /**
      * 
  ...
  /**
    ...
    */
  class GravityWell ()
    extends typingsSlinky.phaser.Phaser.GameObjects.Particles.GravityWell {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def update(particle: typingsSlinky.phaser.Phaser.GameObjects.Particles.Particle, delta: Double, step: Double): Unit = js.native
  }
  ...
  class Particle protected ()
    extends typingsSlinky.phaser.Phaser.GameObjects.Particles.Particle {
    /**
      * 
      * @param emitter The Emitter to which this Particle belongs.
      */
    def this(emitter: typingsSlinky.phaser.Phaser.GameObjects.Particles.ParticleEmitter) = this()
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var emitter: typingsSlinky.phaser.Phaser.GameObjects.Particles.ParticleEmitter = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def checkBounds(emitter: typingsSlinky.phaser.Phaser.GameObjects.Particles.ParticleEmitter): Unit = js.native
    /**
  ...
  class ParticleEmitter protected ()
    extends typingsSlinky.phaser.Phaser.GameObjects.Particles.ParticleEmitter {
    /**
      * 
      ...
      */
    def this(
      manager: typingsSlinky.phaser.Phaser.GameObjects.Particles.ParticleEmitterManager,
  ...
  class ParticleEmitterManager protected ()
    extends typingsSlinky.phaser.Phaser.GameObjects.Particles.ParticleEmitterManager {
    /**
      * 
  ...
  object Zones extends js.Object {
    ...
    class DeathZone protected ()
      extends typingsSlinky.phaser.Phaser.GameObjects.Particles.Zones.DeathZone {
      /**
        * 
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def willKill(particle: typingsSlinky.phaser.Phaser.GameObjects.Particles.Particle): Boolean = js.native
    }
    ...
    class EdgeZone protected ()
      extends typingsSlinky.phaser.Phaser.GameObjects.Particles.Zones.EdgeZone {
      /**
        * 
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getPoint(particle: typingsSlinky.phaser.Phaser.GameObjects.Particles.Particle): Unit = js.native
      /**
    ...
    class RandomZone protected ()
      extends typingsSlinky.phaser.Phaser.GameObjects.Particles.Zones.RandomZone {
      /**
        * 
