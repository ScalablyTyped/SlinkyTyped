...
object Impact extends js.Object {
  ...
  class Body protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.Body {
    /**
      * 
      ...
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Impact.World, x: Double, y: Double) = this()
    def this(world: typingsSlinky.phaser.Phaser.Physics.Impact.World, x: Double, y: Double, sx: Double) = this()
    def this(
      world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
      x: Double,
      y: Double,
      sx: Double,
      sy: Double
  ...
  /**
    ...
    */
  class CollisionMap ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.CollisionMap {
  ...
  class Factory protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.Factory {
    /**
      * 
      * @param world A reference to the Impact Physics world.
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Impact.World) = this()
  }
  ...
  class ImpactBody protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.ImpactBody {
    /**
      * 
      * @param world [description]
  ...
  class ImpactImage protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.ImpactImage {
    /**
      * 
      ...
      */
    def this(world: typingsSlinky.phaser.Phaser.Physics.Impact.World, x: Double, y: Double, texture: String) = this()
    def this(
      world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
      x: Double,
      y: Double,
  ...
  class ImpactPhysics protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.ImpactPhysics {
    /**
      * 
  ...
  class ImpactSprite protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.ImpactSprite {
    /**
      * 
      * @param world [description]
      * @param x The horizontal position of this Game Object in the world.
  ...
  class World protected ()
    extends typingsSlinky.phaser.Phaser.Physics.Impact.World {
    /**
      * 
  ...
  def SeparateX(
    world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
    left: typingsSlinky.phaser.Phaser.Physics.Impact.Body,
    right: typingsSlinky.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  def SeparateX(
    world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
    left: typingsSlinky.phaser.Phaser.Physics.Impact.Body,
    right: typingsSlinky.phaser.Phaser.Physics.Impact.Body,
    weak: typingsSlinky.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  /**
    * [description]
    * @param world [description]
  ...
  def SeparateY(
    world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
    top: typingsSlinky.phaser.Phaser.Physics.Impact.Body,
    bottom: typingsSlinky.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  def SeparateY(
    world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
    top: typingsSlinky.phaser.Phaser.Physics.Impact.Body,
  ...
  def Solver(
    world: typingsSlinky.phaser.Phaser.Physics.Impact.World,
    bodyA: typingsSlinky.phaser.Phaser.Physics.Impact.Body,
    bodyB: typingsSlinky.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  /**
    ...
    */
  def UpdateMotion(body: typingsSlinky.phaser.Phaser.Physics.Impact.Body, res: js.Object): Unit = js.native
  /**
  ...
  object COLLIDES extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.phaser.Phaser.Physics.Impact.COLLIDES with Double] = js.native
  }
  ...
  object TYPE extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.phaser.Phaser.Physics.Impact.TYPE with Double] = js.native
  }
