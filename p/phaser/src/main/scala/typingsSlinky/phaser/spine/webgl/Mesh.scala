...
object Mesh {
  ...
  implicit class MeshOps[Self <: Mesh] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetIndices(value: () => js.typedarray.Uint16Array): Self = this.set("getIndices", js.Any.fromFunction0(value))
    @scala.inline
    def setGetVertexSizeInFloats(value: () => Double): Self = this.set("getVertexSizeInFloats", js.Any.fromFunction0(value))
    @scala.inline
    def setGetVertices(value: () => js.typedarray.Float32Array): Self = this.set("getVertices", js.Any.fromFunction0(value))
    @scala.inline
