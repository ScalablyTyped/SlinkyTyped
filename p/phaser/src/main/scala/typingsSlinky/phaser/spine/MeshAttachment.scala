...
object MeshAttachment {
  ...
  implicit class MeshAttachmentOps[Self <: MeshAttachment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRegionUVs(value: ArrayLike[Double]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUpdateUVs(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateUVs")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
