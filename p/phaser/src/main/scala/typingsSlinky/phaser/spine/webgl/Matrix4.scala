...
object Matrix4 {
  ...
  implicit class Matrix4Ops[Self <: Matrix4] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemp(value: js.typedarray.Float32Array): Self = this.set("temp", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setValues(value: js.typedarray.Float32Array): Self = this.set("values", value.asInstanceOf[js.Any])
  }
