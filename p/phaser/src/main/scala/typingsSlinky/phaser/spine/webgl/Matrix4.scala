...
object Matrix4 {
  ...
  implicit class Matrix4MutableBuilder[Self <: Matrix4] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemp(value: js.typedarray.Float32Array): Self = StObject.set(x, "temp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValues(value: js.typedarray.Float32Array): Self = StObject.set(x, "values", value.asInstanceOf[js.Any])
  }
}
