...
import typingsSlinky.phaser.Phaser.Types.Core.TimeStepCallback
...
object Core {
  ...
  object Config {
    ...
    implicit class ConfigMutableBuilder[Self <: Config] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContextCanvasRenderingContext2D(value: CanvasRenderingContext2D): Self = StObject.set(x, "context", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFullscreenTargetHTMLElement(value: HTMLElement): Self = StObject.set(x, "fullscreenTarget", value.asInstanceOf[js.Any])
