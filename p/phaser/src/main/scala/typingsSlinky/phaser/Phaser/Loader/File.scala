...
object File {
  ...
  implicit class FileOps[Self <: File] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnError(value: (XMLHttpRequest, ProgressEvent) => Unit): Self = this.set("onError", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnLoad(value: (XMLHttpRequest, ProgressEvent) => Unit): Self = this.set("onLoad", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnProgress(value: ProgressEvent => Unit): Self = this.set("onProgress", js.Any.fromFunction1(value))
