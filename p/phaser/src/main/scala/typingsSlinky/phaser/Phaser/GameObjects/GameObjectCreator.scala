...
import typingsSlinky.phaser.Phaser.Types.GameObjects.BitmapText.BitmapTextConfig
...
import typingsSlinky.phaser.Phaser.Types.GameObjects.RenderTexture.RenderTextureConfig
