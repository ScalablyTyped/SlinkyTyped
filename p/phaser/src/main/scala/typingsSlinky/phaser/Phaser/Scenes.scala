...
import typingsSlinky.phaser.Phaser.GameObjects.UpdateList
...
import typingsSlinky.phaser.Phaser.Types.Scenes.SceneTransitionConfig
...
object Scenes extends js.Object {
  ...
  class SceneManager protected () extends js.Object {
    /**
      ...
      */
    def this(game: Game, sceneConfig: js.Object) = this()
    /**
  ...
  class Systems protected () extends js.Object {
    /**
      ...
      */
    def this(scene: Scene, config: String) = this()
    def this(scene: Scene, config: SettingsConfig) = this()
    /**
