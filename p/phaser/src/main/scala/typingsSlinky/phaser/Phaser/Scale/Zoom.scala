...
object Zoom extends js.Object {
  ...
  /* 3 */ @js.native
  object MAX_ZOOM
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Zoom.MAX_ZOOM with Double]
  
  /* 0 */ @js.native
  object NO_ZOOM
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Zoom.NO_ZOOM with Double]
  
  /* 1 */ @js.native
  object ZOOM_2X
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Zoom.ZOOM_2X with Double]
  
  /* 2 */ @js.native
  object ZOOM_4X
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Zoom.ZOOM_4X with Double]
