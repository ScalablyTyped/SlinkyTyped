...
object Particle {
  ...
  implicit class ParticleOps[Self <: Particle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCheckBounds(value: ParticleEmitter => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("checkBounds")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withComputeVelocity(value: (ParticleEmitter, Double, Double, js.Array[_]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("computeVelocity")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withDelayCurrent(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delayCurrent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEmitter(value: ParticleEmitter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("emitter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFire(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fire")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLifeCurrent(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lifeCurrent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLifeT(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lifeT")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withResetPosition(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resetPosition")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTint(value: integer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tint")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUpdate(value: (Double, Double, js.Array[_]) => Boolean): Self = {
        val ret = this.duplicate
