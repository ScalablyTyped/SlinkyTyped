...
object Text {
  ...
  object TextWordWrap {
    ...
    implicit class TextWordWrapMutableBuilder[Self <: TextWordWrap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCallback(value: (/* text */ String, /* textObject */ typingsSlinky.phaser.Phaser.GameObjects.Text) => Unit): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
