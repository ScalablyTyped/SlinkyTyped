...
import typingsSlinky.phaser.Phaser.Types.Physics.Matter.MatterCollisionData
...
object CollisionActiveEvent {
  ...
  @scala.inline
  implicit class CollisionActiveEventOps[Self <: CollisionActiveEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPairs(value: js.Array[MatterCollisionData]): Self = {
        val ret = this.duplicate
