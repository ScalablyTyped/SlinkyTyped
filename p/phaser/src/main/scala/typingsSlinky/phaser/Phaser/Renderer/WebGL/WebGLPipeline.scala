...
trait WebGLPipeline extends js.Object {
  ...
  /**
    ...
    */
  var vertexData: js.typedarray.ArrayBuffer
  /**
  ...
  /**
    ...
    */
  def setFloat1v(name: String, arr: js.typedarray.Float32Array): this.type
  /**
    * Set a uniform value of the current pipeline program.
    * @param name The name of the uniform to look-up and modify.
  ...
  /**
    ...
    * @param arr The new value to be used for the uniform variable.
    */
  def setFloat2v(name: String, arr: js.typedarray.Float32Array): this.type
  /**
    * Set a uniform value of the current pipeline program.
    * @param name The name of the uniform to look-up and modify.
  ...
  /**
    ...
    * @param arr The new value to be used for the uniform variable.
    */
  def setFloat3v(name: String, arr: js.typedarray.Float32Array): this.type
  /**
    * Set a uniform value of the current pipeline program.
    * @param name The name of the uniform to look-up and modify.
  ...
  /**
    ...
    * @param arr The new value to be used for the uniform variable.
    */
  def setFloat4v(name: String, arr: js.typedarray.Float32Array): this.type
  /**
    * Set a uniform value of the current pipeline program.
    * @param name The name of the uniform to look-up and modify.
  ...
  /**
    ...
    */
  def setMatrix2(name: String, transpose: Boolean, matrix: js.typedarray.Float32Array): this.type
  /**
    * Set a uniform value of the current pipeline program.
    * @param name The name of the uniform to look-up and modify.
    * @param transpose Whether to transpose the matrix. Should be `false`.
    ...
    */
  def setMatrix3(name: String, transpose: Boolean, matrix: js.typedarray.Float32Array): this.type
  /**
    * Set a uniform value of the current pipeline program.
    * @param name The name of the uniform to look-up and modify.
    ...
    */
  def setMatrix4(name: String, transpose: Boolean, matrix: js.typedarray.Float32Array): this.type
  /**
