...
@js.native
trait SceneFileConfig extends StObject {
...
object SceneFileConfig {
  ...
  @scala.inline
  def apply(key: String): SceneFileConfig = {
    val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
    __obj.asInstanceOf[SceneFileConfig]
  }
  
  @scala.inline
  implicit class SceneFileConfigMutableBuilder[Self <: SceneFileConfig] (val x: Self) extends AnyVal {
