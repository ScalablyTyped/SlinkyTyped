...
trait Container
  ...
  /**
    ...
    */
  def getBounds(): typingsSlinky.phaser.Phaser.Geom.Rectangle = js.native
  def getBounds(output: typingsSlinky.phaser.Phaser.Geom.Rectangle): typingsSlinky.phaser.Phaser.Geom.Rectangle = js.native
  /**
