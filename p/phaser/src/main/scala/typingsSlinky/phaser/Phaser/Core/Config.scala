...
object Config {
  ...
  implicit class ConfigOps[Self <: Config] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContextCanvasRenderingContext2D(value: CanvasRenderingContext2D): Self = this.set("context", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFullscreenTargetHTMLElement(value: HTMLElement): Self = this.set("fullscreenTarget", value.asInstanceOf[js.Any])
    @scala.inline
