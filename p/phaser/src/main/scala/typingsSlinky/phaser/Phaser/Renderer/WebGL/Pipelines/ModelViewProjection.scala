...
object ModelViewProjection {
  ...
  implicit class ModelViewProjectionOps[Self <: ModelViewProjection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModelMatrix(value: js.typedarray.Float32Array): Self = this.set("modelMatrix", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setViewLoad(value: js.typedarray.Float32Array => ModelViewProjection): Self = this.set("viewLoad", js.Any.fromFunction1(value))
    @scala.inline
    def setViewLoad2D(value: js.typedarray.Float32Array => ModelViewProjection): Self = this.set("viewLoad2D", js.Any.fromFunction1(value))
    @scala.inline
