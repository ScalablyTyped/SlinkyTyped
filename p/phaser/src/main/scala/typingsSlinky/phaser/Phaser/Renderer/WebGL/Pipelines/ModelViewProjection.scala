...
trait ModelViewProjection extends js.Object {
  /**
    * Model matrix
    */
  var modelMatrix: js.typedarray.Float32Array
  /**
  ...
  /**
    * View matrix
    */
  var viewMatrix: js.typedarray.Float32Array
  /**
  ...
  /**
    ...
    */
  def viewLoad(matrix: js.typedarray.Float32Array): this.type
  /**
    * Loads a 2D view matrix (3x2 matrix) into a 4x4 view matrix
    * @param matrix2D The Matrix2D.
    */
  def viewLoad2D(matrix2D: js.typedarray.Float32Array): this.type
  /**
