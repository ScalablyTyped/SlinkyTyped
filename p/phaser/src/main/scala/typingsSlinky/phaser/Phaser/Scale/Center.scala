...
object Center extends js.Object {
  ...
  /* 1 */ @js.native
  object CENTER_BOTH
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Center.CENTER_BOTH with Double]
  
  /* 2 */ @js.native
  object CENTER_HORIZONTALLY
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Center.CENTER_HORIZONTALLY with Double]
  
  /* 3 */ @js.native
  object CENTER_VERTICALLY
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Center.CENTER_VERTICALLY with Double]
  
  /* 0 */ @js.native
  object NO_CENTER
    extends TopLevel[typingsSlinky.phaser.Phaser.Scale.Center.NO_CENTER with Double]
