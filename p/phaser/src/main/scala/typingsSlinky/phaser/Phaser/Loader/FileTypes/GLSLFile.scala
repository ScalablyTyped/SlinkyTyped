...
object GLSLFile {
  ...
  implicit class GLSLFileOps[Self <: GLSLFile] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetShaderName(value: js.Array[String] => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getShaderName")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetShaderType(value: js.Array[String] => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getShaderType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetShaderUniforms(value: js.Array[String] => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getShaderUniforms")(js.Any.fromFunction1(value))
        ret
    }
  }
