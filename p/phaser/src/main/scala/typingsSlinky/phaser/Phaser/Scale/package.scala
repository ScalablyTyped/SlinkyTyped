...
package object Scale {
  ...
  /**
    ...
    */
  type CenterType = typingsSlinky.phaser.Phaser.Scale.Center
  ...
  /**
    ...
    */
  type OrientationType = typingsSlinky.phaser.Phaser.Scale.Orientation
  ...
  /**
    ...
    */
  type ScaleModeType = typingsSlinky.phaser.Phaser.Scale.ScaleModes
  ...
  /**
    ...
    */
  type ZoomType = typingsSlinky.phaser.Phaser.Scale.Zoom
}
