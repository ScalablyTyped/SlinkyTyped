...
class TextStyle protected () extends js.Object {
  /**
    ...
    */
  def this(text: Text, style: typingsSlinky.phaser.Phaser.Types.GameObjects.Text.TextStyle) = this()
  /**
    * The text alignment.
    */
  ...
  /**
    ...
    */
  def setStyle(style: typingsSlinky.phaser.Phaser.Types.GameObjects.Text.TextStyle): Text = js.native
  def setStyle(style: typingsSlinky.phaser.Phaser.Types.GameObjects.Text.TextStyle, updateText: Boolean): Text = js.native
  def setStyle(
