...
trait ParticleEmitter
  ...
  /**
    ...
    */
  def setAlpha(value: EmitterOpOnEmitType): ParticleEmitter = js.native
  def setAlpha(value: EmitterOpOnUpdateType): ParticleEmitter = js.native
  /**
  ...
  /**
    ...
    */
  def setScale(value: EmitterOpOnEmitType): ParticleEmitter = js.native
  def setScale(value: EmitterOpOnUpdateType): ParticleEmitter = js.native
  /**
    * Sets the horizontal scale of emitted particles.
    * @param value The scale, relative to 1.
    */
  def setScaleX(value: EmitterOpOnEmitType): ParticleEmitter = js.native
  def setScaleX(value: EmitterOpOnUpdateType): ParticleEmitter = js.native
  /**
    * Sets the vertical scale of emitted particles.
    * @param value The scale, relative to 1.
    */
  def setScaleY(value: EmitterOpOnEmitType): ParticleEmitter = js.native
  def setScaleY(value: EmitterOpOnUpdateType): ParticleEmitter = js.native
  /**
  ...
  /**
    ...
    */
  def setTint(value: EmitterOpOnEmitType): ParticleEmitter = js.native
  def setTint(value: EmitterOpOnUpdateType): ParticleEmitter = js.native
  /**
