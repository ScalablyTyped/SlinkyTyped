...
object DOMContainerConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(behindCanvas)) __obj.updateDynamic("behindCanvas")(behindCanvas.get.asInstanceOf[js.Any])
    if (!js.isUndefined(createContainer)) __obj.updateDynamic("createContainer")(createContainer.get.asInstanceOf[js.Any])
