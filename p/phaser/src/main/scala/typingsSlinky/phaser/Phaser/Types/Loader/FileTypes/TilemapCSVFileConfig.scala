...
trait TilemapCSVFileConfig extends js.Object {
  /**
...
object TilemapCSVFileConfig {
  @scala.inline
  def apply(key: String, extension: String = null, url: String = null, xhrSettings: XHRSettingsObject = null): TilemapCSVFileConfig = {
