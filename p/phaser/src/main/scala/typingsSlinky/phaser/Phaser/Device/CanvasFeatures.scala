...
object CanvasFeatures {
  ...
  implicit class CanvasFeaturesOps[Self <: CanvasFeatures] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSupportInverseAlpha(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportInverseAlpha")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportNewBlendModes(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportNewBlendModes")(value.asInstanceOf[js.Any])
        ret
    }
  }
