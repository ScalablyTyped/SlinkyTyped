...
object TweenBuilderConfig {
  ...
  implicit class TweenBuilderConfigOps[Self <: TweenBuilderConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDelay(value: Double | js.Function): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnActive(value: (/* tween */ Tween, /* target */ js.Any, /* repeated */ js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onActive")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOnActiveParams(value: js.Array[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onActiveParams")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOnActiveParams: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onActiveParams")(js.undefined)
        ret
    }
    @scala.inline
    def withOnActiveScope(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onActiveScope")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOnActiveScope: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onActiveScope")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withProps(value: StringDictionary[Double | String | GetEndCallback | TweenPropConfig]): Self = {
        val ret = this.duplicate
