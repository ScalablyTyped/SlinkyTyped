...
import typingsSlinky.phaser.MatterJS.Engine
import typingsSlinky.phaser.MatterJS.Grid
import typingsSlinky.phaser.MatterJS.Pair
...
import typingsSlinky.phaser.Phaser.Types.Physics.Matter.MatterDebugConfig
import typingsSlinky.phaser.Phaser.Types.Physics.Matter.MatterRunnerConfig
...
class World protected () extends EventEmitter {
  ...
  /**
    ...
    */
  var localWorld: typingsSlinky.phaser.MatterJS.World = js.native
  /**
