...
import typingsSlinky.phaser.MatterJS.IEngineTimingOptions
...
class Engine ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var broadphase: typingsSlinky.phaser.MatterJS.Grid = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var world: typingsSlinky.phaser.MatterJS.World = js.native
}
