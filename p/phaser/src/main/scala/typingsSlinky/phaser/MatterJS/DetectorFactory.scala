...
object DetectorFactory {
  ...
  implicit class DetectorFactoryOps[Self <: DetectorFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanCollide(value: (ICollisionFilter, ICollisionFilter) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("canCollide")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withCollisions(value: (js.Array[IPair], Engine) => js.Array[ICollisionData]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collisions")(js.Any.fromFunction2(value))
        ret
    }
  }
