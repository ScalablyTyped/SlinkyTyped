...
object Events extends js.Object {
  ...
  /**
    ...
    */
  @JSName("on")
  def on_afterAdd(obj: Engine, name: afterAdd, callback: js.Function1[/* e */ IEventComposite[CompositeType], Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("on")
  def on_afterRender(obj: Engine, name: afterRender, callback: js.Function1[/* e */ IEventTimestamped[Runner], Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("on")
  def on_beforeAdd(obj: Engine, name: beforeAdd, callback: js.Function1[/* e */ IEventComposite[CompositeType], Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("on")
  def on_beforeRender(obj: Engine, name: beforeRender, callback: js.Function1[/* e */ IEventTimestamped[Runner], Unit]): Unit = js.native
  /**
