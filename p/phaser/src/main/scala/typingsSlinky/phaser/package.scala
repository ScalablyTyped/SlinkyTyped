...
package object phaser {
  import typingsSlinky.phaser.Phaser.GameObjects.Bob
  import typingsSlinky.phaser.Phaser.GameObjects.GameObject
  import typingsSlinky.phaser.Phaser.GameObjects.Light
  import typingsSlinky.phaser.Phaser.GameObjects.Text
