...
object Attrs {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](`type`: NodeType[S]): Attrs[S] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Attrs[S]]
  }
  @scala.inline
  implicit class AttrsOps[Self <: Attrs[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Attrs[S]) extends AnyVal {
    @scala.inline
