package typingsSlinky.prosemirrorTransform
...
object AnonAttrs {
  @scala.inline
  def apply[S](`type`: NodeType[S]): AnonAttrs[S] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAttrs[S]]
  }
  @scala.inline
  implicit class AnonAttrsOps[Self[s] <: AnonAttrs[s], S] (val x: Self[S]) extends AnyVal {
    @scala.inline
