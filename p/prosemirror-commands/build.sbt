...
version := "1.0-dt-20180420Z-d326f5"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "prosemirror-state" % "1.2-dt-20190222Z-80648d",
  "org.scalablytyped.slinky" %%% "prosemirror-transform" % "1.1-dt-20191101Z-b0a6f6",
  "org.scalablytyped.slinky" %%% "prosemirror-view" % "1.11-dt-20190930Z-1b33d4",
