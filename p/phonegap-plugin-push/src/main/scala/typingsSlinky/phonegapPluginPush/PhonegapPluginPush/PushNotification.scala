...
import typingsSlinky.phonegapPluginPush.phonegapPluginPushStrings.error
import typingsSlinky.phonegapPluginPush.phonegapPluginPushStrings.notification
import typingsSlinky.phonegapPluginPush.phonegapPluginPushStrings.registration
...
trait PushNotification extends js.Object {
  ...
  @JSName("off")
  def off_error(event: error, callback: js.Function1[/* response */ js.Error, _]): Unit = js.native
  @JSName("off")
  ...
  /**
  		 ...
  		 */
  @JSName("on")
  def on_error(event: error, callback: js.Function1[/* response */ js.Error, _]): Unit = js.native
  /**
