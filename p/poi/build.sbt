...
name := "poi"
version := "12.5-dt-20190414Z-0a8dce"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "webpack-chain" % "6.5.1-676f5a",
  "org.scalablytyped.slinky" %%% "webpack-dev-server" % "3.11-dt-20201030Z-855022")
