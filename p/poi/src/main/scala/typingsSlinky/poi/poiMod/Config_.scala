...
import typingsSlinky.poi.poiMod.Config.Assets
import typingsSlinky.poi.poiMod.Config.Babel
import typingsSlinky.poi.poiMod.Config.ChainWebpack
import typingsSlinky.poi.poiMod.Config.ConfigureWebpack
import typingsSlinky.poi.poiMod.Config.Constants
import typingsSlinky.poi.poiMod.Config.Css
import typingsSlinky.poi.poiMod.Config.DevServer
import typingsSlinky.poi.poiMod.Config.Entry
import typingsSlinky.poi.poiMod.Config.Envs
import typingsSlinky.poi.poiMod.Config.Output
import typingsSlinky.poi.poiMod.Config.Pages
import typingsSlinky.poi.poiMod.Config.Plugins
import typingsSlinky.poi.poiMod.Config.PublicFolder
...
object Config_ {
  ...
  def apply(
    assets: Assets = null,
    babel: Babel = null,
    chainWebpack: (/* config */ typingsSlinky.webpackDashChain.webpackDashChainMod.^, /* opts */ Opts) => Unit = null,
