...
import typingsSlinky.poi.Anon_CacheDirectory
import typingsSlinky.webpack.webpackMod.Configuration
import typingsSlinky.webpack.webpackMod.ICompiler
...
trait PoiCore extends js.Object {
  ...
  def createWebpackChain(): typingsSlinky.webpackDashChain.webpackDashChainMod.^ = js.native
  def createWebpackChain(opts: StringDictionary[js.Any]): typingsSlinky.webpackDashChain.webpackDashChainMod.^ = js.native
  def createWebpackCompiler(config: Configuration): ICompiler = js.native
  def getCacheConfig(dir: String, keys: StringDictionary[String], files: js.Array[String]): Anon_CacheDirectory = js.native
