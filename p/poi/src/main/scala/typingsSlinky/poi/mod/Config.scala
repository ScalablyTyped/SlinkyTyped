...
import typingsSlinky.poi.anon.PartialOptionsentrystring
...
object Config {
  ...
  type ChainWebpack = js.Function2[/* config */ typingsSlinky.webpackChain.mod.^, /* opts */ Opts, Unit]
  ...
  implicit class ConfigMutableBuilder[Self <: Config] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChainWebpack(value: (/* config */ typingsSlinky.webpackChain.mod.^, /* opts */ Opts) => Unit): Self = StObject.set(x, "chainWebpack", js.Any.fromFunction2(value))
