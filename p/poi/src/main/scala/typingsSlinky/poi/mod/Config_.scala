...
import typingsSlinky.poi.mod.Config.PluginOption
...
object Config_ {
  ...
  implicit class Config_Ops[Self <: Config_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChainWebpack(value: (/* config */ typingsSlinky.webpackChain.mod.^, /* opts */ Opts) => Unit): Self = this.set("chainWebpack", js.Any.fromFunction2(value))
