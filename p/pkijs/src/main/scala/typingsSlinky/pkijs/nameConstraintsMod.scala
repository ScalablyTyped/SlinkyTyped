...
object nameConstraintsMod {
  ...
  object NameConstraints {
    ...
    implicit class NameConstraintsMutableBuilder[Self <: NameConstraints] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExcludedSubtrees(value: js.Array[typingsSlinky.pkijs.generalSubtreeMod.default]): Self = StObject.set(x, "excludedSubtrees", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExcludedSubtreesUndefined: Self = StObject.set(x, "excludedSubtrees", js.undefined)
      
      @scala.inline
      def setExcludedSubtreesVarargs(value: typingsSlinky.pkijs.generalSubtreeMod.default*): Self = StObject.set(x, "excludedSubtrees", js.Array(value :_*))
      
      @scala.inline
      def setFromSchema(value: js.Any => Unit): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1(value))
      
      @scala.inline
      def setPermittedSubtrees(value: js.Array[typingsSlinky.pkijs.generalSubtreeMod.default]): Self = StObject.set(x, "permittedSubtrees", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPermittedSubtreesUndefined: Self = StObject.set(x, "permittedSubtrees", js.undefined)
      
      @scala.inline
      def setPermittedSubtreesVarargs(value: typingsSlinky.pkijs.generalSubtreeMod.default*): Self = StObject.set(x, "permittedSubtrees", js.Array(value :_*))
