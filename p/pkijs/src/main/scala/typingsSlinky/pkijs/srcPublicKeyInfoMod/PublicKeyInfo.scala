package typingsSlinky.pkijs.srcPublicKeyInfoMod
...
trait PublicKeyInfo extends js.Object {
  ...
  var parsedKey: js.UndefOr[
    typingsSlinky.pkijs.srcECPublicKeyMod.default | typingsSlinky.pkijs.srcRSAPublicKeyMod.default
  ] = js.undefined
...
object PublicKeyInfo {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    parsedKey: typingsSlinky.pkijs.srcECPublicKeyMod.default | typingsSlinky.pkijs.srcRSAPublicKeyMod.default = null
  ): PublicKeyInfo = {
