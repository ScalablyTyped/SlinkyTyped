...
object certificatePoliciesMod {
  ...
  object CertificatePolicies {
    ...
    implicit class CertificatePoliciesMutableBuilder[Self <: CertificatePolicies] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCertificatePolicies(value: js.Array[typingsSlinky.pkijs.policyInformationMod.default]): Self = StObject.set(x, "certificatePolicies", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCertificatePoliciesVarargs(value: typingsSlinky.pkijs.policyInformationMod.default*): Self = StObject.set(x, "certificatePolicies", js.Array(value :_*))
