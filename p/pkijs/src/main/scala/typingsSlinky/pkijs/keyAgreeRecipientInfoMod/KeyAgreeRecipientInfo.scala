...
object KeyAgreeRecipientInfo {
  ...
  implicit class KeyAgreeRecipientInfoOps[Self <: KeyAgreeRecipientInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginator(value: typingsSlinky.pkijs.originatorIdentifierOrKeyMod.default): Self = this.set("originator", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRecipientEncryptedKeys(value: typingsSlinky.pkijs.recipientEncryptedKeysMod.default): Self = this.set("recipientEncryptedKeys", value.asInstanceOf[js.Any])
    @scala.inline
