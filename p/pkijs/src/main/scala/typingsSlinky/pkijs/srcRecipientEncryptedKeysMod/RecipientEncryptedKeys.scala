...
trait RecipientEncryptedKeys extends js.Object {
  var encryptedKeys: js.Array[typingsSlinky.pkijs.srcRecipientEncryptedKeyMod.default]
...
object RecipientEncryptedKeys {
  @scala.inline
  def apply(
    encryptedKeys: js.Array[typingsSlinky.pkijs.srcRecipientEncryptedKeyMod.default],
