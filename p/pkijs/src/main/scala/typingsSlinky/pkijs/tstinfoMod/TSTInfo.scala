...
trait TSTInfo extends js.Object {
  var accuracy: js.UndefOr[typingsSlinky.pkijs.accuracyMod.default] = js.undefined
  var extensions: js.UndefOr[js.Array[typingsSlinky.pkijs.extensionMod.default]] = js.undefined
  var genTime: js.Date
  var messageImprint: typingsSlinky.pkijs.messageImprintMod.default
  var nonce: js.UndefOr[Integer] = js.undefined
  var ordering: js.UndefOr[Boolean] = js.undefined
  var policy: String
  var serialNumber: Integer
  var tsa: js.UndefOr[typingsSlinky.pkijs.generalNameMod.default] = js.undefined
  var version: Double
...
object TSTInfo {
  ...
  def apply(
    ...
    version: Double,
    accuracy: typingsSlinky.pkijs.accuracyMod.default = null,
    extensions: js.Array[typingsSlinky.pkijs.extensionMod.default] = null,
    nonce: Integer = null,
    ordering: js.UndefOr[Boolean] = js.undefined,
    tsa: typingsSlinky.pkijs.generalNameMod.default = null
  ): TSTInfo = {
