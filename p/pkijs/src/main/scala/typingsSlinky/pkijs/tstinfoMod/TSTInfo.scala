...
object TSTInfo {
  ...
  implicit class TSTInfoOps[Self <: TSTInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGenTime(value: js.Date): Self = this.set("genTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setMessageImprint(value: typingsSlinky.pkijs.messageImprintMod.default): Self = this.set("messageImprint", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setAccuracy(value: typingsSlinky.pkijs.accuracyMod.default): Self = this.set("accuracy", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTsa(value: typingsSlinky.pkijs.generalNameMod.default): Self = this.set("tsa", value.asInstanceOf[js.Any])
    @scala.inline
