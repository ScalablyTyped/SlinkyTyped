...
object tstinfoMod {
  ...
  object TSTInfo {
    ...
    implicit class TSTInfoMutableBuilder[Self <: TSTInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccuracy(value: typingsSlinky.pkijs.accuracyMod.default): Self = StObject.set(x, "accuracy", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAccuracyUndefined: Self = StObject.set(x, "accuracy", js.undefined)
      
      @scala.inline
      def setExtensions(value: js.Array[typingsSlinky.pkijs.extensionMod.default]): Self = StObject.set(x, "extensions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExtensionsUndefined: Self = StObject.set(x, "extensions", js.undefined)
      
      @scala.inline
      def setExtensionsVarargs(value: typingsSlinky.pkijs.extensionMod.default*): Self = StObject.set(x, "extensions", js.Array(value :_*))
      
      @scala.inline
      def setFromSchema(value: js.Any => Unit): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGenTime(value: js.Date): Self = StObject.set(x, "genTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMessageImprint(value: typingsSlinky.pkijs.messageImprintMod.default): Self = StObject.set(x, "messageImprint", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTsa(value: typingsSlinky.pkijs.generalNameMod.default): Self = StObject.set(x, "tsa", value.asInstanceOf[js.Any])
