...
object infoAccessMod {
  ...
  object InfoAccess {
    ...
    implicit class InfoAccessMutableBuilder[Self <: InfoAccess] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessDescriptions(value: js.Array[typingsSlinky.pkijs.accessDescriptionMod.default]): Self = StObject.set(x, "accessDescriptions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAccessDescriptionsVarargs(value: typingsSlinky.pkijs.accessDescriptionMod.default*): Self = StObject.set(x, "accessDescriptions", js.Array(value :_*))
