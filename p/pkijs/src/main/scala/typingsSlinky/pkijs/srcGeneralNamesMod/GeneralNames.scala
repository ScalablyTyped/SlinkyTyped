package typingsSlinky.pkijs.srcGeneralNamesMod
...
trait GeneralNames extends js.Object {
  var names: js.Array[typingsSlinky.pkijs.srcGeneralNameMod.default]
...
object GeneralNames {
  ...
  def apply(
    ...
    names: js.Array[typingsSlinky.pkijs.srcGeneralNameMod.default],
    toJSON: () => js.Any,
    toSchema: () => js.Any
  ): GeneralNames = {
