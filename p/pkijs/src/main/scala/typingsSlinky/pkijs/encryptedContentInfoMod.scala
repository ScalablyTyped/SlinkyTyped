...
object encryptedContentInfoMod {
  ...
  object EncryptedContentInfo {
    ...
    implicit class EncryptedContentInfoMutableBuilder[Self <: EncryptedContentInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContentEncryptionAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "contentEncryptionAlgorithm", value.asInstanceOf[js.Any])
