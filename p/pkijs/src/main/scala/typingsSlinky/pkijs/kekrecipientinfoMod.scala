...
object kekrecipientinfoMod {
  ...
  object KEKRecipientInfo {
    ...
    implicit class KEKRecipientInfoMutableBuilder[Self <: KEKRecipientInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKekid(value: typingsSlinky.pkijs.kekidentifierMod.default): Self = StObject.set(x, "kekid", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPreDefinedKEK(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "preDefinedKEK", value.asInstanceOf[js.Any])
