...
object altNameMod {
  ...
  object AltName {
    ...
    implicit class AltNameMutableBuilder[Self <: AltName] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAltNames(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = StObject.set(x, "altNames", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAltNamesVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = StObject.set(x, "altNames", js.Array(value :_*))
