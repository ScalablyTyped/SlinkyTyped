...
object InfoAccess {
  ...
  implicit class InfoAccessOps[Self <: InfoAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessDescriptionsVarargs(value: typingsSlinky.pkijs.accessDescriptionMod.default*): Self = this.set("accessDescriptions", js.Array(value :_*))
    
    @scala.inline
    def setAccessDescriptions(value: js.Array[typingsSlinky.pkijs.accessDescriptionMod.default]): Self = this.set("accessDescriptions", value.asInstanceOf[js.Any])
