...
object ECPublicKey {
  ...
  implicit class ECPublicKeyOps[Self <: ECPublicKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setX(value: js.typedarray.ArrayBuffer): Self = this.set("x", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setY(value: js.typedarray.ArrayBuffer): Self = this.set("y", value.asInstanceOf[js.Any])
  }
}
