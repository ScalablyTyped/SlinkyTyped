package typingsSlinky.pkijs.digestInfoMod
...
object DigestInfo {
  ...
  implicit class DigestInfoOps[Self <: DigestInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDigestAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = this.set("digestAlgorithm", value.asInstanceOf[js.Any])
