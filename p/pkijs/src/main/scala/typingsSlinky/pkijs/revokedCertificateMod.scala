...
object revokedCertificateMod {
  ...
  object RevokedCertificate {
    ...
    implicit class RevokedCertificateMutableBuilder[Self <: RevokedCertificate] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCrlEntryExtensions(value: typingsSlinky.pkijs.extensionsMod.default): Self = StObject.set(x, "crlEntryExtensions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFromSchema(value: js.Any => Unit): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1(value))
      
      @scala.inline
      def setRevocationDate(value: typingsSlinky.pkijs.timeMod.default): Self = StObject.set(x, "revocationDate", value.asInstanceOf[js.Any])
