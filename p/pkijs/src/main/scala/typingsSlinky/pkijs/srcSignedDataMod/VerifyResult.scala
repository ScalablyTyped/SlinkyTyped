...
trait VerifyResult extends js.Object {
  ...
  var signerCertificate: js.UndefOr[typingsSlinky.pkijs.srcCertificateMod.default] = js.undefined
...
object VerifyResult {
  ...
  def apply(
    ...
    signerCertificate: typingsSlinky.pkijs.srcCertificateMod.default = null,
