...
trait VerifyParams extends js.Object {
  ...
  var trustedCerts: js.UndefOr[js.Array[typingsSlinky.pkijs.srcCertificateMod.default]] = js.undefined
}
...
object VerifyParams {
  ...
  def apply(
    ...
    trustedCerts: js.Array[typingsSlinky.pkijs.srcCertificateMod.default] = null
  ): VerifyParams = {
