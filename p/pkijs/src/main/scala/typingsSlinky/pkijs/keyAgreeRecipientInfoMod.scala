...
object keyAgreeRecipientInfoMod {
  ...
  object KeyAgreeRecipientInfo {
    ...
    implicit class KeyAgreeRecipientInfoMutableBuilder[Self <: KeyAgreeRecipientInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOriginator(value: typingsSlinky.pkijs.originatorIdentifierOrKeyMod.default): Self = StObject.set(x, "originator", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRecipientEncryptedKeys(value: typingsSlinky.pkijs.recipientEncryptedKeysMod.default): Self = StObject.set(x, "recipientEncryptedKeys", value.asInstanceOf[js.Any])
