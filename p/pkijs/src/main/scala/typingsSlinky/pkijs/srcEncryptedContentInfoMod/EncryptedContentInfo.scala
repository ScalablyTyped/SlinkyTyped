package typingsSlinky.pkijs.srcEncryptedContentInfoMod
...
trait EncryptedContentInfo extends js.Object {
  var contentEncryptionAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default
...
object EncryptedContentInfo {
  @scala.inline
  def apply(
    contentEncryptionAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default,
    eContentType: String,
