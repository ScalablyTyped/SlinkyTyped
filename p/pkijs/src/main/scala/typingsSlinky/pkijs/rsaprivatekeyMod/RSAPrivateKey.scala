...
object RSAPrivateKey {
  ...
  implicit class RSAPrivateKeyOps[Self <: RSAPrivateKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOtherPrimeInfosVarargs(value: typingsSlinky.pkijs.otherPrimeInfoMod.default*): Self = this.set("otherPrimeInfos", js.Array(value :_*))
    
    @scala.inline
    def setOtherPrimeInfos(value: js.Array[typingsSlinky.pkijs.otherPrimeInfoMod.default]): Self = this.set("otherPrimeInfos", value.asInstanceOf[js.Any])
