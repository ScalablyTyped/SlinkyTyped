...
object passwordRecipientinfoMod {
  ...
  object PasswordRecipientinfo {
    ...
    implicit class PasswordRecipientinfoMutableBuilder[Self <: PasswordRecipientinfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeyDerivationAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "keyDerivationAlgorithm", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPassword(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "password", value.asInstanceOf[js.Any])
