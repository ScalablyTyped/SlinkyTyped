package typingsSlinky.pkijs.srcExtensionsMod
...
trait Extensions extends js.Object {
  var extensions: js.Array[typingsSlinky.pkijs.srcExtensionMod.default]
...
object Extensions {
  @scala.inline
  def apply(
    extensions: js.Array[typingsSlinky.pkijs.srcExtensionMod.default],
