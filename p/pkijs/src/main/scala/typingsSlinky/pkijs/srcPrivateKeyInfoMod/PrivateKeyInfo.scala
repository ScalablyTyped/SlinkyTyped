package typingsSlinky.pkijs.srcPrivateKeyInfoMod
...
trait PrivateKeyInfo extends js.Object {
  var attributes: js.UndefOr[js.Array[typingsSlinky.pkijs.srcAttributeMod.default]] = js.undefined
  var parsedKey: js.UndefOr[
    typingsSlinky.pkijs.srcECPrivateKeyMod.default | typingsSlinky.pkijs.srcRSAPrivateKeyMod.default
  ] = js.undefined
  var privateKey: OctetString
  var privateKeyAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default
  var version: Double
  /**
...
object PrivateKeyInfo {
  ...
  def apply(
    ...
    privateKeyAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default,
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    version: Double,
    attributes: js.Array[typingsSlinky.pkijs.srcAttributeMod.default] = null,
    parsedKey: typingsSlinky.pkijs.srcECPrivateKeyMod.default | typingsSlinky.pkijs.srcRSAPrivateKeyMod.default = null
  ): PrivateKeyInfo = {
