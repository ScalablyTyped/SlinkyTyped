...
object AltName {
  ...
  implicit class AltNameOps[Self <: AltName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAltNamesVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = this.set("altNames", js.Array(value :_*))
    
    @scala.inline
    def setAltNames(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = this.set("altNames", value.asInstanceOf[js.Any])
