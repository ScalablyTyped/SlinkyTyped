...
trait InfoAccess extends js.Object {
  var accessDescriptions: js.Array[typingsSlinky.pkijs.srcAccessDescriptionMod.default]
...
object InfoAccess {
  @scala.inline
  def apply(
    accessDescriptions: js.Array[typingsSlinky.pkijs.srcAccessDescriptionMod.default],
