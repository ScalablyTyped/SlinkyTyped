...
trait IssuingDistributionPoint extends js.Object {
  var distributionPoint: js.UndefOr[
    js.Array[typingsSlinky.pkijs.srcGeneralNameMod.default] | typingsSlinky.pkijs.srcRelativeDistinguishedNamesMod.default
  ] = js.undefined
...
object IssuingDistributionPoint {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    distributionPoint: js.Array[typingsSlinky.pkijs.srcGeneralNameMod.default] | typingsSlinky.pkijs.srcRelativeDistinguishedNamesMod.default = null
