...
object CRLDistributionPoints {
  ...
  implicit class CRLDistributionPointsOps[Self <: CRLDistributionPoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDistributionPointsVarargs(value: typingsSlinky.pkijs.distributionPointMod.default*): Self = this.set("distributionPoints", js.Array(value :_*))
    @scala.inline
    def setDistributionPoints(value: js.Array[typingsSlinky.pkijs.distributionPointMod.default]): Self = this.set("distributionPoints", value.asInstanceOf[js.Any])
    @scala.inline
