...
object privateKeyInfoMod {
  ...
  object PrivateKeyInfo {
    ...
    implicit class PrivateKeyInfoMutableBuilder[Self <: PrivateKeyInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParsedKey(value: typingsSlinky.pkijs.ecprivatekeyMod.default | typingsSlinky.pkijs.rsaprivatekeyMod.default): Self = StObject.set(x, "parsedKey", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPrivateKeyAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "privateKeyAlgorithm", value.asInstanceOf[js.Any])
