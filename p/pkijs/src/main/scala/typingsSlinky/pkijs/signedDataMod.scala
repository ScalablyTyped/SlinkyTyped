...
object signedDataMod {
  ...
  object VerifyParams {
    ...
    implicit class VerifyParamsMutableBuilder[Self <: VerifyParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCheckDate(value: js.Date): Self = StObject.set(x, "checkDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTrustedCerts(value: js.Array[typingsSlinky.pkijs.certificateMod.default]): Self = StObject.set(x, "trustedCerts", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTrustedCertsUndefined: Self = StObject.set(x, "trustedCerts", js.undefined)
      
      @scala.inline
      def setTrustedCertsVarargs(value: typingsSlinky.pkijs.certificateMod.default*): Self = StObject.set(x, "trustedCerts", js.Array(value :_*))
    }
  }
  ...
  object VerifyResult {
    ...
    implicit class VerifyResultMutableBuilder[Self <: VerifyResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSignerCertificate(value: typingsSlinky.pkijs.certificateMod.default): Self = StObject.set(x, "signerCertificate", value.asInstanceOf[js.Any])
