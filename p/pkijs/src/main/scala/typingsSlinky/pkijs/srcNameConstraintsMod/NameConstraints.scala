...
trait NameConstraints extends js.Object {
  var excludedSubtrees: js.UndefOr[js.Array[typingsSlinky.pkijs.srcGeneralSubtreeMod.default]] = js.undefined
  var permittedSubtrees: js.UndefOr[js.Array[typingsSlinky.pkijs.srcGeneralSubtreeMod.default]] = js.undefined
...
object NameConstraints {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    excludedSubtrees: js.Array[typingsSlinky.pkijs.srcGeneralSubtreeMod.default] = null,
    permittedSubtrees: js.Array[typingsSlinky.pkijs.srcGeneralSubtreeMod.default] = null
  ): NameConstraints = {
