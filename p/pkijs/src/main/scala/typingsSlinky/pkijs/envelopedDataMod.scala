...
object envelopedDataMod {
  ...
  object EnvelopedData {
    ...
    implicit class EnvelopedDataMutableBuilder[Self <: EnvelopedData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddRecipientByCertificate(value: (typingsSlinky.pkijs.certificateMod.default, KdfAlgorithm, Double) => Boolean): Self = StObject.set(x, "addRecipientByCertificate", js.Any.fromFunction3(value))
      
      @scala.inline
      def setAddRecipientByPreDefinedData(value: (js.typedarray.ArrayBuffer, HmacHashAlgorithm, Double) => Boolean): Self = StObject.set(x, "addRecipientByPreDefinedData", js.Any.fromFunction3(value))
      
      @scala.inline
      def setDecrypt(value: (Double, RecipientCertificate) => js.Thenable[js.typedarray.ArrayBuffer]): Self = StObject.set(x, "decrypt", js.Any.fromFunction2(value))
      
      @scala.inline
      def setEncrypt(value: (Algorithm, js.typedarray.ArrayBuffer) => js.Thenable[js.typedarray.ArrayBuffer]): Self = StObject.set(x, "encrypt", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOriginatorInfo(value: typingsSlinky.pkijs.originatorInfoMod.default): Self = StObject.set(x, "originatorInfo", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOriginatorInfoUndefined: Self = StObject.set(x, "originatorInfo", js.undefined)
      
      @scala.inline
      def setRecipientInfos(value: js.Array[typingsSlinky.pkijs.recipientInfoMod.default]): Self = StObject.set(x, "recipientInfos", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRecipientInfosVarargs(value: typingsSlinky.pkijs.recipientInfoMod.default*): Self = StObject.set(x, "recipientInfos", js.Array(value :_*))
