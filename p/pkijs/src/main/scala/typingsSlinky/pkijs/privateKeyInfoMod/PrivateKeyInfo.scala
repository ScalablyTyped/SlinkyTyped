...
object PrivateKeyInfo {
  ...
  implicit class PrivateKeyInfoOps[Self <: PrivateKeyInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKeyAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = this.set("privateKeyAlgorithm", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setParsedKey(value: typingsSlinky.pkijs.ecprivatekeyMod.default | typingsSlinky.pkijs.rsaprivatekeyMod.default): Self = this.set("parsedKey", value.asInstanceOf[js.Any])
    @scala.inline
