...
object PasswordRecipientinfo {
  ...
  implicit class PasswordRecipientinfoOps[Self <: PasswordRecipientinfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPassword(value: js.typedarray.ArrayBuffer): Self = this.set("password", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setKeyDerivationAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = this.set("keyDerivationAlgorithm", value.asInstanceOf[js.Any])
    @scala.inline
