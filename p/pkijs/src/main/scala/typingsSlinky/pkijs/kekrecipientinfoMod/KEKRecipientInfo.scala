...
object KEKRecipientInfo {
  ...
  implicit class KEKRecipientInfoOps[Self <: KEKRecipientInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKekid(value: typingsSlinky.pkijs.kekidentifierMod.default): Self = this.set("kekid", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPreDefinedKEK(value: js.typedarray.ArrayBuffer): Self = this.set("preDefinedKEK", value.asInstanceOf[js.Any])
    @scala.inline
