...
object originatorInfoMod {
  ...
  object OriginatorInfo {
    ...
    implicit class OriginatorInfoMutableBuilder[Self <: OriginatorInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCerts(value: typingsSlinky.pkijs.certificateSetMod.default): Self = StObject.set(x, "certs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCrls(value: typingsSlinky.pkijs.revocationInfoChoicesMod.default): Self = StObject.set(x, "crls", value.asInstanceOf[js.Any])
