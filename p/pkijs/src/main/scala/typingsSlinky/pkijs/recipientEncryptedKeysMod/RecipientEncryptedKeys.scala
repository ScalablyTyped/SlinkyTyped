...
object RecipientEncryptedKeys {
  ...
  implicit class RecipientEncryptedKeysOps[Self <: RecipientEncryptedKeys] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncryptedKeysVarargs(value: typingsSlinky.pkijs.recipientEncryptedKeyMod.default*): Self = this.set("encryptedKeys", js.Array(value :_*))
    @scala.inline
    def setEncryptedKeys(value: js.Array[typingsSlinky.pkijs.recipientEncryptedKeyMod.default]): Self = this.set("encryptedKeys", value.asInstanceOf[js.Any])
    @scala.inline
