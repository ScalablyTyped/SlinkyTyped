...
object keyTransRecipientInfoMod {
  ...
  object KeyTransRecipientInfo {
    ...
    implicit class KeyTransRecipientInfoMutableBuilder[Self <: KeyTransRecipientInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeyEncryptionAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "keyEncryptionAlgorithm", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRecipientCertificate(value: typingsSlinky.pkijs.certificateMod.default): Self = StObject.set(x, "recipientCertificate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRid(value: typingsSlinky.pkijs.recipientIdentifierMod.default): Self = StObject.set(x, "rid", value.asInstanceOf[js.Any])
