...
trait OCSPResponse extends js.Object {
  var responseBytes: js.UndefOr[typingsSlinky.pkijs.srcResponseBytesMod.default] = js.undefined
...
object OCSPResponse {
  ...
  def apply(
    ...
    getCertificateStatus: (typingsSlinky.pkijs.srcCertificateMod.default, typingsSlinky.pkijs.srcCertificateMod.default) => js.Thenable[GetCertificateStatusResult],
    responseStatus: Enumerated,
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    responseBytes: typingsSlinky.pkijs.srcResponseBytesMod.default = null
  ): OCSPResponse = {
