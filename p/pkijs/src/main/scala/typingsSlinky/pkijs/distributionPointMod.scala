...
object distributionPointMod {
  ...
  object DistributionPoint {
    ...
    implicit class DistributionPointMutableBuilder[Self <: DistributionPoint] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCRLIssuer(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = StObject.set(x, "cRLIssuer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCRLIssuerUndefined: Self = StObject.set(x, "cRLIssuer", js.undefined)
      
      @scala.inline
      def setCRLIssuerVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = StObject.set(x, "cRLIssuer", js.Array(value :_*))
      
      @scala.inline
      def setDistributionPoint(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = StObject.set(x, "distributionPoint", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDistributionPointUndefined: Self = StObject.set(x, "distributionPoint", js.undefined)
      
      @scala.inline
      def setDistributionPointVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = StObject.set(x, "distributionPoint", js.Array(value :_*))
