...
object OCSPResponse {
  ...
  implicit class OCSPResponseOps[Self <: OCSPResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponseBytes(value: typingsSlinky.pkijs.responseBytesMod.default): Self = this.set("responseBytes", value.asInstanceOf[js.Any])
