package typingsSlinky.pkijs.keyAgreeRecipientIdentifierMod
...
object KeyAgreeRecipientIdentifier {
  ...
  @scala.inline
  implicit class KeyAgreeRecipientIdentifierOps[Self <: KeyAgreeRecipientIdentifier] (val x: Self) extends AnyVal {
    @scala.inline
