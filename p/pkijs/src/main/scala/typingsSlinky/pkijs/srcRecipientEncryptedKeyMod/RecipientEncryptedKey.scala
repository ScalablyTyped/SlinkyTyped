package typingsSlinky.pkijs.srcRecipientEncryptedKeyMod
...
trait RecipientEncryptedKey extends js.Object {
  ...
  var rid: typingsSlinky.pkijs.srcKeyAgreeRecipientIdentifierMod.default
...
object RecipientEncryptedKey {
  ...
  def apply(
    ...
    rid: typingsSlinky.pkijs.srcKeyAgreeRecipientIdentifierMod.default,
    toJSON: () => js.Any,
    toSchema: () => js.Any
