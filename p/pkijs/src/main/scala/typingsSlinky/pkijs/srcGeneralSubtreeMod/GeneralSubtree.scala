package typingsSlinky.pkijs.srcGeneralSubtreeMod
...
trait GeneralSubtree extends js.Object {
  var base: typingsSlinky.pkijs.srcGeneralNameMod.default
...
object GeneralSubtree {
  @scala.inline
  def apply(
    base: typingsSlinky.pkijs.srcGeneralNameMod.default,
