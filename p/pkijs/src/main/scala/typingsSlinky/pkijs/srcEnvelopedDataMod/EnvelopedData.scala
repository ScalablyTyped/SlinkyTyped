...
trait EnvelopedData extends js.Object {
  ...
  var originatorInfo: js.UndefOr[typingsSlinky.pkijs.srcOriginatorInfoMod.default] = js.undefined
  var recipientInfos: js.Array[typingsSlinky.pkijs.srcRecipientInfoMod.default]
  var unprotectedAttrs: js.UndefOr[js.Array[typingsSlinky.pkijs.srcAttributeMod.default]] = js.undefined
  var version: Double
  /**
  ...
  /**
    ...
    * @returns {Promise}
    */
  def decrypt(recipientIndex: Double, parameters: Anon_RecipientCertificate): js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer]
  /**
...
object EnvelopedData {
  @scala.inline
  def apply(
    addRecipientByCertificate: (typingsSlinky.pkijs.srcCertificateMod.default, Anon_KdfAlgorithm, Double) => Boolean,
    addRecipientByPreDefinedData: (scala.scalajs.js.typedarray.ArrayBuffer, Anon_HmacHashAlgorithm, Double) => Boolean,
    decrypt: (Double, Anon_RecipientCertificate) => js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer],
    encrypt: (Algorithm, scala.scalajs.js.typedarray.ArrayBuffer) => js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer],
    encryptedContentInfo: typingsSlinky.pkijs.srcEncryptedContentInfoMod.default,
    fromSchema: js.Any => Unit,
    recipientInfos: js.Array[typingsSlinky.pkijs.srcRecipientInfoMod.default],
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    version: Double,
    originatorInfo: typingsSlinky.pkijs.srcOriginatorInfoMod.default = null,
    unprotectedAttrs: js.Array[typingsSlinky.pkijs.srcAttributeMod.default] = null
  ): EnvelopedData = {
