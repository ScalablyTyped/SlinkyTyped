package typingsSlinky.pkijs.srcEnvelopedDataMod

import org.scalajs.dom.crypto.Algorithm
import typingsSlinky.pkijs.Anon_HmacHashAlgorithm
import typingsSlinky.pkijs.Anon_KdfAlgorithm
import typingsSlinky.pkijs.Anon_RecipientCertificate
...
class default () extends EnvelopedData {
  ...
  /* CompleteClass */
  override var recipientInfos: js.Array[typingsSlinky.pkijs.srcRecipientInfoMod.default] = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def decrypt(recipientIndex: Double, parameters: Anon_RecipientCertificate): js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def encrypt(contentEncryptionAlgorithm: Algorithm, contentToEncrypt: scala.scalajs.js.typedarray.ArrayBuffer): js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer] = js.native
  /* CompleteClass */
