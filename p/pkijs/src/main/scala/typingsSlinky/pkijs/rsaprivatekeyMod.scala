...
object rsaprivatekeyMod {
  ...
  object RSAPrivateKey {
    ...
    implicit class RSAPrivateKeyMutableBuilder[Self <: RSAPrivateKey] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOtherPrimeInfos(value: js.Array[typingsSlinky.pkijs.otherPrimeInfoMod.default]): Self = StObject.set(x, "otherPrimeInfos", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOtherPrimeInfosUndefined: Self = StObject.set(x, "otherPrimeInfos", js.undefined)
      
      @scala.inline
      def setOtherPrimeInfosVarargs(value: typingsSlinky.pkijs.otherPrimeInfoMod.default*): Self = StObject.set(x, "otherPrimeInfos", js.Array(value :_*))
