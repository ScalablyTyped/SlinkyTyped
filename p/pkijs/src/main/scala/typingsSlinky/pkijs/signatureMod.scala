...
object signatureMod {
  ...
  object Signature {
    ...
    implicit class SignatureMutableBuilder[Self <: Signature] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCerts(value: js.Array[typingsSlinky.pkijs.certificateMod.default]): Self = StObject.set(x, "certs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCertsUndefined: Self = StObject.set(x, "certs", js.undefined)
      
      @scala.inline
      def setCertsVarargs(value: typingsSlinky.pkijs.certificateMod.default*): Self = StObject.set(x, "certs", js.Array(value :_*))
