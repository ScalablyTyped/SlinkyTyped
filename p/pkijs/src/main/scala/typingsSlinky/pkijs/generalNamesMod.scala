...
object generalNamesMod {
  ...
  object GeneralNames {
    ...
    implicit class GeneralNamesMutableBuilder[Self <: GeneralNames] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNames(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = StObject.set(x, "names", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNamesVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = StObject.set(x, "names", js.Array(value :_*))
