...
object recipientEncryptedKeysMod {
  ...
  object RecipientEncryptedKeys {
    ...
    implicit class RecipientEncryptedKeysMutableBuilder[Self <: RecipientEncryptedKeys] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptedKeys(value: js.Array[typingsSlinky.pkijs.recipientEncryptedKeyMod.default]): Self = StObject.set(x, "encryptedKeys", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncryptedKeysVarargs(value: typingsSlinky.pkijs.recipientEncryptedKeyMod.default*): Self = StObject.set(x, "encryptedKeys", js.Array(value :_*))
