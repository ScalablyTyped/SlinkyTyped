package typingsSlinky.pkijs.srcRevokedCertificateMod
...
trait RevokedCertificate extends js.Object {
  var crlEntryExtensions: typingsSlinky.pkijs.srcExtensionsMod.default
  var revocationDate: typingsSlinky.pkijs.srcTimeMod.default
...
object RevokedCertificate {
  @scala.inline
  def apply(
    crlEntryExtensions: typingsSlinky.pkijs.srcExtensionsMod.default,
    fromSchema: js.Any => Unit,
    revocationDate: typingsSlinky.pkijs.srcTimeMod.default,
    toJSON: () => js.Any,
    toSchema: () => js.Any,
