package typingsSlinky.pkijs.srcCertificatePoliciesMod
...
trait CertificatePolicies extends js.Object {
  var certificatePolicies: js.Array[typingsSlinky.pkijs.srcPolicyInformationMod.default]
...
object CertificatePolicies {
  @scala.inline
  def apply(
    certificatePolicies: js.Array[typingsSlinky.pkijs.srcPolicyInformationMod.default],
