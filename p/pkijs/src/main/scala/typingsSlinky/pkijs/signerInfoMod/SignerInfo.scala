...
object SignerInfo {
  ...
  implicit class SignerInfoOps[Self <: SignerInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSignedAttrs(value: typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default): Self = this.set("signedAttrs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSignedAttrs: Self = this.set("signedAttrs", js.undefined)
    
    @scala.inline
    def setUnsignedAttrs(value: typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default): Self = this.set("unsignedAttrs", value.asInstanceOf[js.Any])
