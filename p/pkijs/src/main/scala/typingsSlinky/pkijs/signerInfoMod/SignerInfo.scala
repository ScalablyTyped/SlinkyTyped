...
trait SignerInfo extends js.Object {
  ...
  var signedAttrs: js.UndefOr[typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default] = js.undefined
  var unsignedAttrs: js.UndefOr[typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default] = js.undefined
  var version: Double
...
object SignerInfo {
  ...
  def apply(
    ...
    toSchema: () => js.Any,
    version: Double,
    signedAttrs: typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default = null,
    unsignedAttrs: typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default = null
  ): SignerInfo = {
