...
trait Signature extends js.Object {
  var certs: js.UndefOr[js.Array[typingsSlinky.pkijs.certificateMod.default]] = js.undefined
  var signature: BitString
  var signatureAlgorithm: typingsSlinky.pkijs.algorithmIdentifierMod.default
...
object Signature {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    certs: js.Array[typingsSlinky.pkijs.certificateMod.default] = null
  ): Signature = {
