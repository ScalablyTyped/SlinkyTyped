...
trait RSAPrivateKey extends js.Object {
  ...
  var modulus: Integer
  var otherPrimeInfos: js.UndefOr[js.Array[typingsSlinky.pkijs.srcOtherPrimeInfoMod.default]] = js.undefined
  var prime1: Integer
  var prime2: Integer
...
object RSAPrivateKey {
  ...
  def apply(
    ...
    toSchema: () => js.Any,
    version: Double,
    otherPrimeInfos: js.Array[typingsSlinky.pkijs.srcOtherPrimeInfoMod.default] = null
  ): RSAPrivateKey = {
