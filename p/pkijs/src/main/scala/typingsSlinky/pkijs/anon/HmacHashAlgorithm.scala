...
object HmacHashAlgorithm {
  ...
  implicit class HmacHashAlgorithmOps[Self <: HmacHashAlgorithm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyEncryptionAlgorithm(value: org.scalajs.dom.crypto.Algorithm): Self = this.set("keyEncryptionAlgorithm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setKeyIdentifier(value: js.typedarray.ArrayBuffer): Self = this.set("keyIdentifier", value.asInstanceOf[js.Any])
