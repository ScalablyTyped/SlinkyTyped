...
object ContentEncryptionAlgorithm {
  ...
  implicit class ContentEncryptionAlgorithmOps[Self <: ContentEncryptionAlgorithm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentEncryptionAlgorithm(value: org.scalajs.dom.crypto.Algorithm): Self = this.set("contentEncryptionAlgorithm", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContentToEncryptArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("contentToEncrypt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContentToEncryptArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("contentToEncrypt", value.asInstanceOf[js.Any])
