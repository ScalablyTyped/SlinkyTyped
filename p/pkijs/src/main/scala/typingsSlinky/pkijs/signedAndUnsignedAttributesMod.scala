...
object signedAndUnsignedAttributesMod {
  ...
  object SignedAndUnsignedAttributes {
    ...
    implicit class SignedAndUnsignedAttributesMutableBuilder[Self <: SignedAndUnsignedAttributes] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttributes(value: js.Array[typingsSlinky.pkijs.attributeMod.default]): Self = StObject.set(x, "attributes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAttributesVarargs(value: typingsSlinky.pkijs.attributeMod.default*): Self = StObject.set(x, "attributes", js.Array(value :_*))
      
      @scala.inline
      def setEncodedValue(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "encodedValue", value.asInstanceOf[js.Any])
