...
object authorityKeyIdentifierMod {
  ...
  object AuthorityKeyIdentifier {
    ...
    implicit class AuthorityKeyIdentifierMutableBuilder[Self <: AuthorityKeyIdentifier] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuthorityCertIssuer(value: js.Array[typingsSlinky.pkijs.accessDescriptionMod.default]): Self = StObject.set(x, "authorityCertIssuer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAuthorityCertIssuerVarargs(value: typingsSlinky.pkijs.accessDescriptionMod.default*): Self = StObject.set(x, "authorityCertIssuer", js.Array(value :_*))
