...
object PBES2Params {
  ...
  implicit class PBES2ParamsOps[Self <: PBES2Params] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncryptionScheme(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = this.set("encryptionScheme", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFromSchema(value: js.Any => Unit): Self = this.set("fromSchema", js.Any.fromFunction1(value))
    
    @scala.inline
    def setKeyDerivationFunc(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = this.set("keyDerivationFunc", value.asInstanceOf[js.Any])
