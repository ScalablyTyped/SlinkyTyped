...
object PolicyInformation {
  ...
  implicit class PolicyInformationOps[Self <: PolicyInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPolicyQualifiersVarargs(value: typingsSlinky.pkijs.policyQualifierInfoMod.default*): Self = this.set("policyQualifiers", js.Array(value :_*))
    @scala.inline
    def setPolicyQualifiers(value: js.Array[typingsSlinky.pkijs.policyQualifierInfoMod.default]): Self = this.set("policyQualifiers", value.asInstanceOf[js.Any])
    @scala.inline
