...
object SignedAndUnsignedAttributes {
  ...
  implicit class SignedAndUnsignedAttributesOps[Self <: SignedAndUnsignedAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttributesVarargs(value: typingsSlinky.pkijs.attributeMod.default*): Self = this.set("attributes", js.Array(value :_*))
    @scala.inline
    def setAttributes(value: js.Array[typingsSlinky.pkijs.attributeMod.default]): Self = this.set("attributes", value.asInstanceOf[js.Any])
    @scala.inline
    def setEncodedValue(value: js.typedarray.ArrayBuffer): Self = this.set("encodedValue", value.asInstanceOf[js.Any])
    @scala.inline
