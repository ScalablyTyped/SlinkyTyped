...
object VerifyParams {
  ...
  implicit class VerifyParamsOps[Self <: VerifyParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckDate(value: js.Date): Self = this.set("checkDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTrustedCertsVarargs(value: typingsSlinky.pkijs.certificateMod.default*): Self = this.set("trustedCerts", js.Array(value :_*))
    @scala.inline
    def setTrustedCerts(value: js.Array[typingsSlinky.pkijs.certificateMod.default]): Self = this.set("trustedCerts", value.asInstanceOf[js.Any])
    @scala.inline
