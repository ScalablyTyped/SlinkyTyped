...
trait VerifyResult extends js.Object {
  ...
  var signerCertificate: js.UndefOr[typingsSlinky.pkijs.certificateMod.default] = js.undefined
...
object VerifyResult {
  ...
  def apply(
    ...
    signerCertificate: typingsSlinky.pkijs.certificateMod.default = null,
