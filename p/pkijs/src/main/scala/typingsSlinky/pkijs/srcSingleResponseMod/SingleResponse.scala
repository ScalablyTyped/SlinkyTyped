...
trait SingleResponse extends js.Object {
  var certID: typingsSlinky.pkijs.srcCertIDMod.default
  var certStatus: js.Any
  var nextUpdate: js.UndefOr[js.Date] = js.undefined
  var singleExtensions: js.Array[typingsSlinky.pkijs.srcExtensionMod.default]
...
object SingleResponse {
  @scala.inline
  def apply(
    certID: typingsSlinky.pkijs.srcCertIDMod.default,
    certStatus: js.Any,
    fromSchema: js.Any => Unit,
    singleExtensions: js.Array[typingsSlinky.pkijs.srcExtensionMod.default],
    thisUpdate: js.Date,
    toJSON: () => js.Any,
    toSchema: () => js.Any,
