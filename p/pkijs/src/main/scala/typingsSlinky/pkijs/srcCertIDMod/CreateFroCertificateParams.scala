...
trait CreateFroCertificateParams extends js.Object {
  ...
  var issuerCertificate: typingsSlinky.pkijs.srcCertificateMod.default
}

object CreateFroCertificateParams {
  @scala.inline
  def apply(hashAlgorithm: String, issuerCertificate: typingsSlinky.pkijs.srcCertificateMod.default): CreateFroCertificateParams = {
