package typingsSlinky.pkijs.srcCertIDMod
...
trait CertID extends js.Object {
  var hashAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default
  ...
  /**
    ...
    * @returns {Promise}
    */
  def createForCertificate(certificate: typingsSlinky.pkijs.srcCertificateMod.default, parameters: CreateFroCertificateParams): js.Thenable[Unit]
...
object CertID {
  @scala.inline
  def apply(
    createForCertificate: (typingsSlinky.pkijs.srcCertificateMod.default, CreateFroCertificateParams) => js.Thenable[Unit],
    fromSchema: js.Any => Unit,
    hashAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default,
