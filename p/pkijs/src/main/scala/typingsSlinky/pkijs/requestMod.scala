...
object requestMod {
  ...
  object Request {
    ...
    implicit class RequestMutableBuilder[Self <: Request] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReqCert(value: typingsSlinky.pkijs.certIDMod.default): Self = StObject.set(x, "reqCert", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSingleRequestExtensions(value: js.Array[typingsSlinky.pkijs.extensionMod.default]): Self = StObject.set(x, "singleRequestExtensions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSingleRequestExtensionsUndefined: Self = StObject.set(x, "singleRequestExtensions", js.undefined)
      
      @scala.inline
      def setSingleRequestExtensionsVarargs(value: typingsSlinky.pkijs.extensionMod.default*): Self = StObject.set(x, "singleRequestExtensions", js.Array(value :_*))
