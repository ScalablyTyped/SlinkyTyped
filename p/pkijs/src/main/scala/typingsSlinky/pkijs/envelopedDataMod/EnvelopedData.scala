...
object EnvelopedData {
  ...
  def apply(
    ...
    addRecipientByPreDefinedData: (scala.scalajs.js.typedarray.ArrayBuffer, AnonHmacHashAlgorithm, Double) => Boolean,
    decrypt: (Double, AnonRecipientCertificate) => js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer],
