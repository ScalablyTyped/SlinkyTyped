...
trait EnvelopedData extends js.Object {
  ...
  var originatorInfo: js.UndefOr[typingsSlinky.pkijs.originatorInfoMod.default] = js.undefined
  var recipientInfos: js.Array[typingsSlinky.pkijs.recipientInfoMod.default]
  var unprotectedAttrs: js.UndefOr[js.Array[typingsSlinky.pkijs.attributeMod.default]] = js.undefined
  var version: Double
  /**
    ...
    */
  def addRecipientByCertificate(certificate: typingsSlinky.pkijs.certificateMod.default, parameters: KdfAlgorithm, variant: Double): Boolean
  /**
    ...
    */
  def addRecipientByPreDefinedData(preDefinedData: js.typedarray.ArrayBuffer, parameters: HmacHashAlgorithm, variant: Double): Boolean
  /**
    ...
    * @returns {Promise}
    */
  def decrypt(recipientIndex: Double, parameters: RecipientCertificate): js.Thenable[js.typedarray.ArrayBuffer]
  /**
    ...
    * @returns {Promise}
    */
  def encrypt(contentEncryptionAlgorithm: Algorithm, contentToEncrypt: js.typedarray.ArrayBuffer): js.Thenable[js.typedarray.ArrayBuffer]
...
object EnvelopedData {
  ...
  def apply(
    ...
    toSchema: () => js.Any,
    version: Double,
    originatorInfo: typingsSlinky.pkijs.originatorInfoMod.default = null,
    unprotectedAttrs: js.Array[typingsSlinky.pkijs.attributeMod.default] = null
  ): EnvelopedData = {
