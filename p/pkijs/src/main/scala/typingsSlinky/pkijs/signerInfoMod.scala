...
object signerInfoMod {
  ...
  object SignerInfo {
    ...
    implicit class SignerInfoMutableBuilder[Self <: SignerInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDigestAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "digestAlgorithm", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSignatureAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "signatureAlgorithm", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSignedAttrs(value: typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default): Self = StObject.set(x, "signedAttrs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUnsignedAttrs(value: typingsSlinky.pkijs.signedAndUnsignedAttributesMod.default): Self = StObject.set(x, "unsignedAttrs", value.asInstanceOf[js.Any])
