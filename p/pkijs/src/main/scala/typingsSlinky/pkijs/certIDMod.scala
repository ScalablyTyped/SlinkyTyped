...
object certIDMod {
  ...
  object CertID {
    ...
    implicit class CertIDMutableBuilder[Self <: CertID] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "createForCertificate", js.Any.fromFunction2(value))
  ...
  object CreateFroCertificateParams {
    ...
    implicit class CreateFroCertificateParamsMutableBuilder[Self <: CreateFroCertificateParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIssuerCertificate(value: typingsSlinky.pkijs.certificateMod.default): Self = StObject.set(x, "issuerCertificate", value.asInstanceOf[js.Any])
    }
  }
}
