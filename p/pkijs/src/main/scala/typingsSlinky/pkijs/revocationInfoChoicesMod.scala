...
object revocationInfoChoicesMod {
  ...
  object RevocationInfoChoices {
    ...
    implicit class RevocationInfoChoicesMutableBuilder[Self <: RevocationInfoChoices] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCrls(value: js.Array[typingsSlinky.pkijs.certificateRevocationListMod.default]): Self = StObject.set(x, "crls", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCrlsVarargs(value: typingsSlinky.pkijs.certificateRevocationListMod.default*): Self = StObject.set(x, "crls", js.Array(value :_*))
      
      @scala.inline
      def setFromSchema(value: js.Any => Unit): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOtherRevocationInfos(value: js.Array[typingsSlinky.pkijs.otherRevocationInfoFormatMod.default]): Self = StObject.set(x, "otherRevocationInfos", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOtherRevocationInfosVarargs(value: typingsSlinky.pkijs.otherRevocationInfoFormatMod.default*): Self = StObject.set(x, "otherRevocationInfos", js.Array(value :_*))
