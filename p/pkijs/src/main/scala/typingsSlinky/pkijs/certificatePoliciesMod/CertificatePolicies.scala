...
object CertificatePolicies {
  ...
  implicit class CertificatePoliciesOps[Self <: CertificatePolicies] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCertificatePoliciesVarargs(value: typingsSlinky.pkijs.policyInformationMod.default*): Self = this.set("certificatePolicies", js.Array(value :_*))
    @scala.inline
    def setCertificatePolicies(value: js.Array[typingsSlinky.pkijs.policyInformationMod.default]): Self = this.set("certificatePolicies", value.asInstanceOf[js.Any])
    @scala.inline
