...
import typingsSlinky.pkijs.srcCertificateChainValidationEngineMod.CertificateChainValidationEngine
...
@js.native
object srcCertificateChainValidationEngineMod extends js.Object {
  @js.native
  trait CertificateChainValidationEngine extends js.Object {
    var certs: js.Array[typingsSlinky.pkijs.srcCertificateMod.default] = js.native
    var checkDate: js.Date = js.native
    var crls: js.Array[typingsSlinky.pkijs.srcCertificateRevocationListMod.default] = js.native
    var ocsp: typingsSlinky.pkijs.srcOCSPResponseMod.default = js.native
    var trustedCerts: js.Array[typingsSlinky.pkijs.srcCertificateMod.default] = js.native
