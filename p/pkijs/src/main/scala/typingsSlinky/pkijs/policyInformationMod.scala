...
object policyInformationMod {
  ...
  object PolicyInformation {
    ...
    implicit class PolicyInformationMutableBuilder[Self <: PolicyInformation] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPolicyQualifiers(value: js.Array[typingsSlinky.pkijs.policyQualifierInfoMod.default]): Self = StObject.set(x, "policyQualifiers", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPolicyQualifiersVarargs(value: typingsSlinky.pkijs.policyQualifierInfoMod.default*): Self = StObject.set(x, "policyQualifiers", js.Array(value :_*))
