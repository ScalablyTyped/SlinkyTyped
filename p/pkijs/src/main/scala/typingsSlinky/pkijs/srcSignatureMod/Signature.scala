...
trait Signature extends js.Object {
  var certs: js.UndefOr[js.Array[typingsSlinky.pkijs.srcCertificateMod.default]] = js.undefined
...
object Signature {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    certs: js.Array[typingsSlinky.pkijs.srcCertificateMod.default] = null
  ): Signature = {
