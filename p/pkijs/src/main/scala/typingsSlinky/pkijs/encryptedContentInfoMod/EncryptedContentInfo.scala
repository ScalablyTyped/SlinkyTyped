...
object EncryptedContentInfo {
  ...
  implicit class EncryptedContentInfoOps[Self <: EncryptedContentInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentEncryptionAlgorithm(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = this.set("contentEncryptionAlgorithm", value.asInstanceOf[js.Any])
