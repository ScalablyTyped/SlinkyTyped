...
object mod {
  ...
  @js.native
  def createCMSECDSASignature(signatureBuffer: js.typedarray.ArrayBuffer): js.typedarray.ArrayBuffer = js.native
  ...
  @js.native
  def createECDSASignatureFromCMS(cmsSignature: Sequence): js.typedarray.ArrayBuffer = js.native
  ...
  @js.native
  def getAlgorithmParameters(algorithmName: String, operation: String): typingsSlinky.pkijs.anon.Algorithm = js.native
  ...
  @js.native
  def getRandomValues(view: js.typedarray.ArrayBufferView): js.typedarray.ArrayBufferView = js.native
