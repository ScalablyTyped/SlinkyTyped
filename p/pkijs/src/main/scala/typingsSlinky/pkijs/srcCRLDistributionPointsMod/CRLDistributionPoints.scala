...
trait CRLDistributionPoints extends js.Object {
  var distributionPoints: js.Array[typingsSlinky.pkijs.srcDistributionPointMod.default]
...
object CRLDistributionPoints {
  @scala.inline
  def apply(
    distributionPoints: js.Array[typingsSlinky.pkijs.srcDistributionPointMod.default],
