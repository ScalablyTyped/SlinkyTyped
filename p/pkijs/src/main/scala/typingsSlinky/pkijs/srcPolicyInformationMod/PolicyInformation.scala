package typingsSlinky.pkijs.srcPolicyInformationMod
...
trait PolicyInformation extends js.Object {
  ...
  /**
    ...
    */
  var policyQualifiers: js.Array[typingsSlinky.pkijs.srcPolicyQualifierInfoMod.default]
...
object PolicyInformation {
  ...
  def apply(
    ...
    policyQualifiers: js.Array[typingsSlinky.pkijs.srcPolicyQualifierInfoMod.default],
    toJSON: () => js.Any,
    toSchema: () => js.Any
  ): PolicyInformation = {
