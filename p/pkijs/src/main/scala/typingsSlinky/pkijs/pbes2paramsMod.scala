...
object pbes2paramsMod {
  ...
  object PBES2Params {
    ...
    implicit class PBES2ParamsMutableBuilder[Self <: PBES2Params] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptionScheme(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "encryptionScheme", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFromSchema(value: js.Any => Unit): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1(value))
      
      @scala.inline
      def setKeyDerivationFunc(value: typingsSlinky.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "keyDerivationFunc", value.asInstanceOf[js.Any])
