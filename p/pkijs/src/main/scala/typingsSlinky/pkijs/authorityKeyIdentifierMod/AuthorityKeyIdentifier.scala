...
object AuthorityKeyIdentifier {
  ...
  implicit class AuthorityKeyIdentifierOps[Self <: AuthorityKeyIdentifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthorityCertIssuerVarargs(value: typingsSlinky.pkijs.accessDescriptionMod.default*): Self = this.set("authorityCertIssuer", js.Array(value :_*))
    @scala.inline
    def setAuthorityCertIssuer(value: js.Array[typingsSlinky.pkijs.accessDescriptionMod.default]): Self = this.set("authorityCertIssuer", value.asInstanceOf[js.Any])
    @scala.inline
