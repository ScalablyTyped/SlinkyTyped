...
object RevokedCertificate {
  ...
  implicit class RevokedCertificateOps[Self <: RevokedCertificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCrlEntryExtensions(value: typingsSlinky.pkijs.extensionsMod.default): Self = this.set("crlEntryExtensions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFromSchema(value: js.Any => Unit): Self = this.set("fromSchema", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRevocationDate(value: typingsSlinky.pkijs.timeMod.default): Self = this.set("revocationDate", value.asInstanceOf[js.Any])
