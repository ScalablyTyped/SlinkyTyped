...
object policyMappingsMod {
  ...
  object PolicyMappings {
    ...
    implicit class PolicyMappingsMutableBuilder[Self <: PolicyMappings] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMappings(value: js.Array[typingsSlinky.pkijs.policyMappingMod.default]): Self = StObject.set(x, "mappings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMappingsVarargs(value: typingsSlinky.pkijs.policyMappingMod.default*): Self = StObject.set(x, "mappings", js.Array(value :_*))
