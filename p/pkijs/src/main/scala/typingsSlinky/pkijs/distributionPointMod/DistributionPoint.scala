...
object DistributionPoint {
  ...
  implicit class DistributionPointOps[Self <: DistributionPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCRLIssuerVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = this.set("cRLIssuer", js.Array(value :_*))
    
    @scala.inline
    def setCRLIssuer(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = this.set("cRLIssuer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCRLIssuer: Self = this.set("cRLIssuer", js.undefined)
    
    @scala.inline
    def setDistributionPointVarargs(value: typingsSlinky.pkijs.generalNameMod.default*): Self = this.set("distributionPoint", js.Array(value :_*))
    
    @scala.inline
    def setDistributionPoint(value: js.Array[typingsSlinky.pkijs.generalNameMod.default]): Self = this.set("distributionPoint", value.asInstanceOf[js.Any])
