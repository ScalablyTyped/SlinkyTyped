...
trait DistributionPoint extends js.Object {
  var cRLIssuer: js.UndefOr[js.Array[typingsSlinky.pkijs.generalNameMod.default]] = js.undefined
  var distributionPoint: js.UndefOr[js.Array[typingsSlinky.pkijs.generalNameMod.default]] = js.undefined
...
object DistributionPoint {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    cRLIssuer: js.Array[typingsSlinky.pkijs.generalNameMod.default] = null,
    distributionPoint: js.Array[typingsSlinky.pkijs.generalNameMod.default] = null,
