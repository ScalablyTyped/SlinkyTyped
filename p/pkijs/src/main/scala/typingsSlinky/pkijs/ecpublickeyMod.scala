...
object ecpublickeyMod {
  ...
  object ECPublicKey {
    ...
    implicit class ECPublicKeyMutableBuilder[Self <: ECPublicKey] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setX(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "x", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setY(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "y", value.asInstanceOf[js.Any])
    }
  }
}
