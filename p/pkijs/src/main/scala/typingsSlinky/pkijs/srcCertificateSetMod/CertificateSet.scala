package typingsSlinky.pkijs.srcCertificateSetMod
...
trait CertificateSet extends js.Object {
  var certificates: js.Array[typingsSlinky.pkijs.srcCertificateMod.default]
...
object CertificateSet {
  @scala.inline
  def apply(
    certificates: js.Array[typingsSlinky.pkijs.srcCertificateMod.default],
