...
object RevocationInfoChoices {
  ...
  implicit class RevocationInfoChoicesOps[Self <: RevocationInfoChoices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCrlsVarargs(value: typingsSlinky.pkijs.certificateRevocationListMod.default*): Self = this.set("crls", js.Array(value :_*))
    @scala.inline
    def setCrls(value: js.Array[typingsSlinky.pkijs.certificateRevocationListMod.default]): Self = this.set("crls", value.asInstanceOf[js.Any])
    @scala.inline
    def setFromSchema(value: js.Any => Unit): Self = this.set("fromSchema", js.Any.fromFunction1(value))
    @scala.inline
    def setOtherRevocationInfosVarargs(value: typingsSlinky.pkijs.otherRevocationInfoFormatMod.default*): Self = this.set("otherRevocationInfos", js.Array(value :_*))
    @scala.inline
    def setOtherRevocationInfos(value: js.Array[typingsSlinky.pkijs.otherRevocationInfoFormatMod.default]): Self = this.set("otherRevocationInfos", value.asInstanceOf[js.Any])
    @scala.inline
