...
object NameConstraints {
  ...
  implicit class NameConstraintsOps[Self <: NameConstraints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludedSubtreesVarargs(value: typingsSlinky.pkijs.generalSubtreeMod.default*): Self = this.set("excludedSubtrees", js.Array(value :_*))
    
    @scala.inline
    def setExcludedSubtrees(value: js.Array[typingsSlinky.pkijs.generalSubtreeMod.default]): Self = this.set("excludedSubtrees", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteExcludedSubtrees: Self = this.set("excludedSubtrees", js.undefined)
    
    @scala.inline
    def setPermittedSubtreesVarargs(value: typingsSlinky.pkijs.generalSubtreeMod.default*): Self = this.set("permittedSubtrees", js.Array(value :_*))
    
    @scala.inline
    def setPermittedSubtrees(value: js.Array[typingsSlinky.pkijs.generalSubtreeMod.default]): Self = this.set("permittedSubtrees", value.asInstanceOf[js.Any])
