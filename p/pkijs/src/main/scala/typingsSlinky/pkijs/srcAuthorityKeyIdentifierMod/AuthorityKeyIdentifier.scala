...
trait AuthorityKeyIdentifier extends js.Object {
  var authorityCertIssuer: js.Array[typingsSlinky.pkijs.srcAccessDescriptionMod.default]
...
object AuthorityKeyIdentifier {
  @scala.inline
  def apply(
    authorityCertIssuer: js.Array[typingsSlinky.pkijs.srcAccessDescriptionMod.default],
