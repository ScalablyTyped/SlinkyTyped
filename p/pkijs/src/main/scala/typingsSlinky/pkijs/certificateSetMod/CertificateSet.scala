...
object CertificateSet {
  ...
  implicit class CertificateSetOps[Self <: CertificateSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCertificatesVarargs(value: typingsSlinky.pkijs.certificateMod.default*): Self = this.set("certificates", js.Array(value :_*))
    @scala.inline
    def setCertificates(value: js.Array[typingsSlinky.pkijs.certificateMod.default]): Self = this.set("certificates", value.asInstanceOf[js.Any])
    @scala.inline
