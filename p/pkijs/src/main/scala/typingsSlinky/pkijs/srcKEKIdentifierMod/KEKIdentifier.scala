package typingsSlinky.pkijs.srcKEKIdentifierMod

import typingsSlinky.asn1js.asn1jsMod.GeneralizedTime
...
trait KEKIdentifier extends js.Object {
  ...
  var other: js.UndefOr[typingsSlinky.pkijs.srcOtherKeyAttributeMod.default] = js.undefined
...
object KEKIdentifier {
  ...
  def apply(
    ...
    other: typingsSlinky.pkijs.srcOtherKeyAttributeMod.default = null
  ): KEKIdentifier = {
