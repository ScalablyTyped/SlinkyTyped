...
object certificateSetMod {
  ...
  object CertificateSet {
    ...
    implicit class CertificateSetMutableBuilder[Self <: CertificateSet] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCertificates(value: js.Array[typingsSlinky.pkijs.certificateMod.default]): Self = StObject.set(x, "certificates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCertificatesVarargs(value: typingsSlinky.pkijs.certificateMod.default*): Self = StObject.set(x, "certificates", js.Array(value :_*))
