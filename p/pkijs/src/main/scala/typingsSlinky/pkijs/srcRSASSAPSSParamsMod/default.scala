package typingsSlinky.pkijs.srcRSASSAPSSParamsMod
...
class default () extends RSASSAPSSParams {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var hashAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var maskGenAlgorithm: typingsSlinky.pkijs.srcAlgorithmIdentifierMod.default = js.native
  /**
