...
object PublicKeyInfo {
  ...
  implicit class PublicKeyInfoOps[Self <: PublicKeyInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParsedKey(value: typingsSlinky.pkijs.ecpublickeyMod.default | typingsSlinky.pkijs.rsapublickeyMod.default): Self = this.set("parsedKey", value.asInstanceOf[js.Any])
