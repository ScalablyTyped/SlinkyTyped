...
trait Request extends js.Object {
  var reqCert: typingsSlinky.pkijs.certIDMod.default
  var singleRequestExtensions: js.UndefOr[js.Array[typingsSlinky.pkijs.extensionMod.default]] = js.undefined
...
object Request {
  ...
  def apply(
    ...
    toJSON: () => js.Any,
    toSchema: () => js.Any,
    singleRequestExtensions: js.Array[typingsSlinky.pkijs.extensionMod.default] = null
  ): Request = {
