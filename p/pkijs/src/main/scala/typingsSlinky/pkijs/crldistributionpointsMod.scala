...
object crldistributionpointsMod {
  ...
  object CRLDistributionPoints {
    ...
    implicit class CRLDistributionPointsMutableBuilder[Self <: CRLDistributionPoints] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDistributionPoints(value: js.Array[typingsSlinky.pkijs.distributionPointMod.default]): Self = StObject.set(x, "distributionPoints", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDistributionPointsVarargs(value: typingsSlinky.pkijs.distributionPointMod.default*): Self = StObject.set(x, "distributionPoints", js.Array(value :_*))
