...
trait EncryptedData extends js.Object {
  ...
  /**
    ...
    */
  def decrypt(parameters: Password): js.Thenable[js.typedarray.ArrayBuffer]
  /**
    * Create a new CMS Encrypted Data content
    * @param {*} parameters Parameters neccessary for encryption
    * @returns {Promise}
    */
  def encrypt(parameters: ContentEncryptionAlgorithm): js.Thenable[js.typedarray.ArrayBuffer]
