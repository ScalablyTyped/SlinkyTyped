...
trait EncryptedData extends js.Object {
  var encryptedContentInfo: typingsSlinky.pkijs.encryptedContentInfoMod.default
  var unprotectedAttrs: js.Array[typingsSlinky.pkijs.attributeMod.default]
  var version: Double
  /**
...
object EncryptedData {
  @scala.inline
  def apply(
    decrypt: AnonPassword => js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer],
    encrypt: AnonContentEncryptionAlgorithm => js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer],
