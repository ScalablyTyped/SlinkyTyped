...
object OriginatorInfo {
  ...
  implicit class OriginatorInfoOps[Self <: OriginatorInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCerts(value: typingsSlinky.pkijs.certificateSetMod.default): Self = this.set("certs", value.asInstanceOf[js.Any])
    @scala.inline
    def setCrls(value: typingsSlinky.pkijs.revocationInfoChoicesMod.default): Self = this.set("crls", value.asInstanceOf[js.Any])
    @scala.inline
