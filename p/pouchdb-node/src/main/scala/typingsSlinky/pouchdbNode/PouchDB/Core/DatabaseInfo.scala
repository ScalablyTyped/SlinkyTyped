...
object DatabaseInfo {
  ...
  implicit class DatabaseInfoOps[Self <: DatabaseInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackend_adapter(value: String): Self = this.set("backend_adapter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBackend_adapter: Self = this.set("backend_adapter", js.undefined)
  }
}
