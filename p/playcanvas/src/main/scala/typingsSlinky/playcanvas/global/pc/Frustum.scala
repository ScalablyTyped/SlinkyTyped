...
class Frustum protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def containsPoint(point: typingsSlinky.playcanvas.pc.Vec3): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def containsSphere(sphere: typingsSlinky.playcanvas.pc.BoundingSphere): Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def update(projectionMatrix: typingsSlinky.playcanvas.pc.Mat4, viewMatrix: typingsSlinky.playcanvas.pc.Mat4): Unit = js.native
}
