...
class MeshInstance protected ()
  extends typingsSlinky.playcanvas.pc.MeshInstance {
  def this(
    node: typingsSlinky.playcanvas.pc.GraphNode,
    mesh: typingsSlinky.playcanvas.pc.Mesh,
    material: typingsSlinky.playcanvas.pc.Material
  ) = this()
}
