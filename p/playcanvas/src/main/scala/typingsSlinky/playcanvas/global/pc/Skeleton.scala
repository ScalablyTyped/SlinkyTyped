...
class Skeleton protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var animation: typingsSlinky.playcanvas.pc.Animation = js.native
  /**
  ...
  /* CompleteClass */
  override def blend(
    skel1: typingsSlinky.playcanvas.pc.Skeleton,
    skel2: typingsSlinky.playcanvas.pc.Skeleton,
    alpha: Double
  ): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setGraph(graph: typingsSlinky.playcanvas.pc.GraphNode): Unit = js.native
  /**
