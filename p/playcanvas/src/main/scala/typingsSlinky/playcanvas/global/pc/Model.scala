...
@js.native
class Model ()
  extends typingsSlinky.playcanvas.pc.Model {
  /**
    * The root node of the model's graph node hierarchy.
    */
  /* CompleteClass */
  override var graph: typingsSlinky.playcanvas.pc.GraphNode = js.native
  /**
    * An array of MeshInstances contained in this model.
    */
  /* CompleteClass */
  override var meshInstances: js.Array[typingsSlinky.playcanvas.pc.MeshInstance] = js.native
  /**
    * An array of MorphInstances contained in this model.
    */
  /* CompleteClass */
  override var morphInstances: js.Array[typingsSlinky.playcanvas.pc.MorphInstance] = js.native
  /**
    * An array of SkinInstances contained in this model.
    */
  /* CompleteClass */
  override var skinInstances: js.Array[typingsSlinky.playcanvas.pc.SkinInstance] = js.native
  /**
