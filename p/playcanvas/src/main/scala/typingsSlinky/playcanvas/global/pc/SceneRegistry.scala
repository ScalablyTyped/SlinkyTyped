...
import typingsSlinky.playcanvas.pc.callbacks.LoadScene
...
class SceneRegistry protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def find(name: String): typingsSlinky.playcanvas.pc.SceneRegistryItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findByUrl(url: String): typingsSlinky.playcanvas.pc.SceneRegistryItem = js.native
  /**
    * Return the list of scene.
    * @returns All items in the registry.
    */
  /* CompleteClass */
  override def list(): js.Array[typingsSlinky.playcanvas.pc.SceneRegistryItem] = js.native
  /**
