...
class ScopeSpace protected ()
  extends typingsSlinky.playcanvas.pc.ScopeSpace {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSubSpace(name: String): typingsSlinky.playcanvas.pc.ScopeSpace = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def resolve(name: String): typingsSlinky.playcanvas.pc.ScopeId = js.native
}
