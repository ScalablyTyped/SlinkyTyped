...
class MorphInstance protected ()
  extends typingsSlinky.playcanvas.pc.MorphInstance {
  def this(morph: typingsSlinky.playcanvas.pc.Morph) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def update(mesh: typingsSlinky.playcanvas.pc.Mesh): Unit = js.native
  /**
    * Calculates AABB for this morph instance. Called automatically by renderer.
    * @param mesh - Base mesh for the morph.
    */
  /* CompleteClass */
  override def updateBounds(mesh: typingsSlinky.playcanvas.pc.Mesh): Unit = js.native
}
