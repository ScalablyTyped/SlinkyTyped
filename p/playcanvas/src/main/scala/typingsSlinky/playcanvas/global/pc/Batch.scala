...
class Batch protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var meshInstance: typingsSlinky.playcanvas.pc.MeshInstance = js.native
  /**
    * A handy model object.
    */
  /* CompleteClass */
  override var model: typingsSlinky.playcanvas.pc.Model = js.native
  /**
    * An array of original mesh instances, from which this batch was generated.
    */
  /* CompleteClass */
  override var origMeshInstances: js.Array[typingsSlinky.playcanvas.pc.MeshInstance] = js.native
}
