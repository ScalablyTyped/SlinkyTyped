...
object createScript extends js.Object {
  /**
    ...
    * };
    */
  def apply(name: String): typingsSlinky.playcanvas.pc.ScriptType = js.native
  def apply(name: String, app: typingsSlinky.playcanvas.pc.Application): typingsSlinky.playcanvas.pc.ScriptType = js.native
}
