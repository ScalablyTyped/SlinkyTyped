...
class PostEffect protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var device: typingsSlinky.playcanvas.pc.GraphicsDevice = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var shader: typingsSlinky.playcanvas.pc.Shader | Null = js.native
  /**
    * The vertex buffer for the fullscreen quad. Used when calling {@link pc.drawFullscreenQuad}. [read only].
    */
  /* CompleteClass */
  override var vertexBuffer: typingsSlinky.playcanvas.pc.VertexBuffer = js.native
  /**
  ...
  /* CompleteClass */
  override def render(
    inputTarget: typingsSlinky.playcanvas.pc.RenderTarget,
    outputTarget: typingsSlinky.playcanvas.pc.RenderTarget,
