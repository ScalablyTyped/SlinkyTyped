...
import typingsSlinky.playcanvas.AnonRadius
...
object createSphere extends js.Object {
  ...
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, opts: AnonRadius): typingsSlinky.playcanvas.pc.Mesh = js.native
}
