...
class PostEffectQueue protected ()
  extends typingsSlinky.playcanvas.pc.PostEffectQueue {
  def this(app: typingsSlinky.playcanvas.pc.Application, camera: typingsSlinky.playcanvas.pc.CameraComponent) = this()
  /**
    ...
    */
  /* CompleteClass */
  override def addEffect(effect: typingsSlinky.playcanvas.pc.PostEffect): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeEffect(effect: typingsSlinky.playcanvas.pc.PostEffect): Unit = js.native
}
