...
class Ray ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var direction: typingsSlinky.playcanvas.pc.Vec3 = js.native
  /**
    * The starting point of the ray.
    */
  /* CompleteClass */
  override var origin: typingsSlinky.playcanvas.pc.Vec3 = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def set(origin: typingsSlinky.playcanvas.pc.Vec3, direction: typingsSlinky.playcanvas.pc.Vec3): typingsSlinky.playcanvas.pc.Ray = js.native
}
