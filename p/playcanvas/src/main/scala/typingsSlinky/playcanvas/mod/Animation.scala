...
class Animation ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val nodes: js.Array[typingsSlinky.playcanvas.pc.Node] = js.native
  /**
    * Adds a node to the internal nodes array.
    * @param node - The node to add.
    */
  /* CompleteClass */
  override def addNode(node: typingsSlinky.playcanvas.pc.Node): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getNode(name: String): typingsSlinky.playcanvas.pc.Node = js.native
}
