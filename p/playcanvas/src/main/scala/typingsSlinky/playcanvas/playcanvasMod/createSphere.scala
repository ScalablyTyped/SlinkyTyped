...
import typingsSlinky.playcanvas.Anon_Radius
...
object createSphere extends js.Object {
  ...
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, opts: Anon_Radius): typingsSlinky.playcanvas.pc.Mesh = js.native
}
