...
import typingsSlinky.playcanvas.Anon_HalfExtentsHeightSegments
...
object createBox extends js.Object {
  ...
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, opts: Anon_HalfExtentsHeightSegments): typingsSlinky.playcanvas.pc.Mesh = js.native
}
