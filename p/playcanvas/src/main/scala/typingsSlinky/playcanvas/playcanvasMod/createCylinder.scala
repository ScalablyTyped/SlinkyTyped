...
import typingsSlinky.playcanvas.Anon_CapSegments
...
object createCylinder extends js.Object {
  ...
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, opts: Anon_CapSegments): typingsSlinky.playcanvas.pc.Mesh = js.native
}
