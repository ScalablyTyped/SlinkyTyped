...
import typingsSlinky.playcanvas.Anon_Colors
...
object createMesh extends js.Object {
  /**
    ...
    *     });
    */
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, positions: js.Array[Number]): typingsSlinky.playcanvas.pc.Mesh = js.native
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, positions: js.Array[Number], opts: Anon_Colors): typingsSlinky.playcanvas.pc.Mesh = js.native
}
