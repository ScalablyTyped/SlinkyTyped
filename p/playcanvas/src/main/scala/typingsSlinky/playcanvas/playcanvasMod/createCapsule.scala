...
import typingsSlinky.playcanvas.Anon_Height
...
object createCapsule extends js.Object {
  ...
  def apply(device: typingsSlinky.playcanvas.pc.GraphicsDevice, opts: Anon_Height): typingsSlinky.playcanvas.pc.Mesh = js.native
}
