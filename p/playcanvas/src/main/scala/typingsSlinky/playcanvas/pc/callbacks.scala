...
object callbacks {
  ...
  /**
    ...
    */
  type HttpResponse = js.Function2[/* err */ Double | String | js.Error | Null, /* response */ js.UndefOr[js.Any], Unit]
  ...
  /**
    ...
    */
  type XrError = js.Function1[/* err */ js.Error | Null, Unit]
  ...
  /**
    ...
    */
  type XrHitTestStart = js.Function2[/* err */ js.Error | Null, /* hitTestSource */ XrHitTestSource | Null, Unit]
}
