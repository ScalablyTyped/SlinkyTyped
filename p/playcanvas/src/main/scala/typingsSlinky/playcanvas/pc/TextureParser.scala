...
import typingsSlinky.playcanvas.anon.Original
...
trait TextureParser extends StObject {
  ...
  /**
    ...
    */
  def load(url: Original, callback: typingsSlinky.playcanvas.pc.callbacks.ResourceHandler): Unit = js.native
  def load(url: Original, callback: typingsSlinky.playcanvas.pc.callbacks.ResourceHandler, asset: Asset): Unit = js.native
