...
import typingsSlinky.playcanvas.pc.callbacks.VrFrame
import typingsSlinky.std.VRDisplay
import typingsSlinky.std.VRDisplayCapabilities
import typingsSlinky.std.VRFrameData
...
class VrDisplay protected () extends EventHandler {
  ...
  /**
    ...
    */
  def exitPresent(callback: typingsSlinky.playcanvas.pc.callbacks.VrDisplay): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def requestPresent(callback: typingsSlinky.playcanvas.pc.callbacks.VrDisplay): Unit = js.native
  /**
    * @function
