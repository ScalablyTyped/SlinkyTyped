...
import typingsSlinky.playcanvas.Anon_Face
...
class Texture protected () extends js.Object {
  ...
  def lock(options: Anon_Face): scala.scalajs.js.typedarray.Uint8Array | scala.scalajs.js.typedarray.Uint16Array | scala.scalajs.js.typedarray.Float32Array = js.native
