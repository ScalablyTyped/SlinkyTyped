...
trait ResourceLoader extends StObject {
  ...
  /**
    ...
    */
  def load(url: String, `type`: String, callback: typingsSlinky.playcanvas.pc.callbacks.ResourceLoader): Unit = js.native
  def load(
    url: String,
    `type`: String,
    callback: typingsSlinky.playcanvas.pc.callbacks.ResourceLoader,
    asset: Asset
  ): Unit = js.native
