...
object createMesh extends js.Object {
  /**
    ...
    *     });
    */
  def apply(device: GraphicsDevice, positions: js.Array[Double]): Mesh = js.native
  def apply(device: GraphicsDevice, positions: js.Array[Double], opts: AnonColors): Mesh = js.native
}
