...
object Aabb {
  ...
  implicit class AabbMutableBuilder[Self <: Aabb] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeltaNormals(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "deltaNormals", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeltaPositions(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "deltaPositions", value.asInstanceOf[js.Any])
