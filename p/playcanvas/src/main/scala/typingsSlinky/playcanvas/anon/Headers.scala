...
object Headers {
  ...
  implicit class HeadersOps[Self <: Headers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def deleteMaxRetryDelay: Self = this.set("maxRetryDelay", js.undefined)
    @scala.inline
    def setPostdataDocument(value: Document): Self = this.set("postdata", value.asInstanceOf[js.Any])
    @scala.inline
    def setPostdata(value: Document | js.Any): Self = this.set("postdata", value.asInstanceOf[js.Any])
    @scala.inline
