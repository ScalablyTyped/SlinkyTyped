...
trait Anon_AttributesFshader extends js.Object {
...
object Anon_AttributesFshader {
  @scala.inline
  def apply(attributes: js.Any, fshader: String, useTransformFeedback: Boolean, vshader: String): Anon_AttributesFshader = {
    ...
    __obj.asInstanceOf[Anon_AttributesFshader]
  }
}
