...
object workspaceMod {
  ...
  object PluginInfo {
    ...
    implicit class PluginInfoMutableBuilder[Self <: PluginInfo] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInstallTime(value: js.Date): Self = StObject.set(x, "installTime", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.pulumiPulumi.pulumiPulumiStrings.analyzer
    - typingsSlinky.pulumiPulumi.pulumiPulumiStrings.language
    - typingsSlinky.pulumiPulumi.pulumiPulumiStrings.resource
  */
  trait PluginKind extends StObject
  object PluginKind {
    
    @scala.inline
    def analyzer: typingsSlinky.pulumiPulumi.pulumiPulumiStrings.analyzer = "analyzer".asInstanceOf[typingsSlinky.pulumiPulumi.pulumiPulumiStrings.analyzer]
    
    @scala.inline
    def language: typingsSlinky.pulumiPulumi.pulumiPulumiStrings.language = "language".asInstanceOf[typingsSlinky.pulumiPulumi.pulumiPulumiStrings.language]
    
    @scala.inline
    def resource: typingsSlinky.pulumiPulumi.pulumiPulumiStrings.resource = "resource".asInstanceOf[typingsSlinky.pulumiPulumi.pulumiPulumiStrings.resource]
  }
