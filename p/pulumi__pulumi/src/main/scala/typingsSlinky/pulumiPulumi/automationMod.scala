...
object automationMod {
  ...
  class ConcurrentUpdateError ()
    extends typingsSlinky.pulumiPulumi.automationErrorsMod.ConcurrentUpdateError
  
  @JSImport("@pulumi/pulumi/x/automation", "LocalWorkspace")
  @js.native
  class LocalWorkspace protected ()
    extends typingsSlinky.pulumiPulumi.localWorkspaceMod.LocalWorkspace
  /* static members */
  ...
  class Stack protected ()
    extends typingsSlinky.pulumiPulumi.automationStackMod.Stack
  /* static members */
  object Stack {
  ...
  class StackAlreadyExistsError ()
    extends typingsSlinky.pulumiPulumi.automationErrorsMod.StackAlreadyExistsError
  
  @JSImport("@pulumi/pulumi/x/automation", "StackNotFoundError")
  @js.native
  class StackNotFoundError ()
    extends typingsSlinky.pulumiPulumi.automationErrorsMod.StackNotFoundError
