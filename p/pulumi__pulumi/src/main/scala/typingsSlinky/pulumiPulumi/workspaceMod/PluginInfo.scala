package typingsSlinky.pulumiPulumi.workspaceMod
...
trait PluginInfo extends js.Object {
  ...
  var installTime: js.Date = js.native
  
  var kind: PluginKind = js.native
  
  var lastUsedTime: js.Date = js.native
...
object PluginInfo {
  ...
  implicit class PluginInfoOps[Self <: PluginInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstallTime(value: js.Date): Self = this.set("installTime", value.asInstanceOf[js.Any])
