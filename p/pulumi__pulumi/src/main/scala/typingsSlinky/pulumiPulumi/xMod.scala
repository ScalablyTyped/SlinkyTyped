...
@JSImport("@pulumi/pulumi/x", JSImport.Namespace)
@js.native
object xMod extends js.Object {
  
  @js.native
  object automation extends js.Object {
    
    def fullyQualifiedStackName(org_ : String, project: String, stack: String): String = js.native
    
    @js.native
    class CommandError ()
      extends typingsSlinky.pulumiPulumi.automationErrorsMod.CommandError
