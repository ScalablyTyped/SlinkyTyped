...
import typingsSlinky.pulumiPulumi.localWorkspaceMod.InlineProgramArgs
import typingsSlinky.pulumiPulumi.localWorkspaceMod.LocalProgramArgs
import typingsSlinky.pulumiPulumi.localWorkspaceMod.LocalWorkspaceOptions
...
object xMod {
  ...
  object automation {
    ...
    @js.native
    class CommandError ()
      extends typingsSlinky.pulumiPulumi.automationMod.CommandError
    
    @JSImport("@pulumi/pulumi/x", "automation.ConcurrentUpdateError")
    @js.native
    class ConcurrentUpdateError ()
      extends typingsSlinky.pulumiPulumi.automationMod.ConcurrentUpdateError
    
    @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace")
    @js.native
    class LocalWorkspace protected ()
      extends typingsSlinky.pulumiPulumi.automationMod.LocalWorkspace
    /* static members */
    object LocalWorkspace {
      ...
      @js.native
      def create(opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.localWorkspaceMod.LocalWorkspace] = js.native
      ...
      @js.native
      def createOrSelectStack(args: InlineProgramArgs): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.createOrSelectStack")
      @js.native
      def createOrSelectStack(args: InlineProgramArgs, opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      /**
      ...
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.createOrSelectStack")
      @js.native
      def createOrSelectStack(args: LocalProgramArgs): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.createOrSelectStack")
      @js.native
      def createOrSelectStack(args: LocalProgramArgs, opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      ...
      @js.native
      def createStack(args: InlineProgramArgs): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.createStack")
      @js.native
      def createStack(args: InlineProgramArgs, opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      /**
      ...
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.createStack")
      @js.native
      def createStack(args: LocalProgramArgs): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.createStack")
      @js.native
      def createStack(args: LocalProgramArgs, opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      ...
      @js.native
      def selectStack(args: InlineProgramArgs): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.selectStack")
      @js.native
      def selectStack(args: InlineProgramArgs, opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      /**
      ...
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.selectStack")
      @js.native
      def selectStack(args: LocalProgramArgs): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      @JSImport("@pulumi/pulumi/x", "automation.LocalWorkspace.selectStack")
      @js.native
      def selectStack(args: LocalProgramArgs, opts: LocalWorkspaceOptions): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
    }
    
    @JSImport("@pulumi/pulumi/x", "automation.Stack")
    @js.native
    class Stack protected ()
      extends typingsSlinky.pulumiPulumi.automationMod.Stack
    /* static members */
    object Stack {
      ...
      @js.native
      def create(name: String, workspace: Workspace): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      ...
      @js.native
      def createOrSelect(name: String, workspace: Workspace): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
      ...
      @js.native
      def select(name: String, workspace: Workspace): js.Promise[typingsSlinky.pulumiPulumi.automationStackMod.Stack] = js.native
    }
    
    @JSImport("@pulumi/pulumi/x", "automation.StackAlreadyExistsError")
    @js.native
    class StackAlreadyExistsError ()
      extends typingsSlinky.pulumiPulumi.automationMod.StackAlreadyExistsError
    
    @JSImport("@pulumi/pulumi/x", "automation.StackNotFoundError")
    @js.native
    class StackNotFoundError ()
      extends typingsSlinky.pulumiPulumi.automationMod.StackNotFoundError
