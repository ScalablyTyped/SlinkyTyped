...
object all extends js.Object {
  ...
  def apply[T](ds: js.Array[js.UndefOr[Input[T]]]): typingsSlinky.pulumiPulumi.outputMod.Output_[js.Array[Unwrap[T]]] = js.native
  def apply[T](`val`: Record[String, Input[T]]): typingsSlinky.pulumiPulumi.outputMod.Output_[Record[String, Unwrap[T]]] = js.native
  def apply[T1, T2](values: js.Tuple2[js.UndefOr[Input[T1]], js.UndefOr[Input[T2]]]): typingsSlinky.pulumiPulumi.outputMod.Output_[js.Tuple2[Unwrap[T1], Unwrap[T2]]] = js.native
  def apply[T1, T2, T3](values: js.Tuple3[js.UndefOr[Input[T1]], js.UndefOr[Input[T2]], js.UndefOr[Input[T3]]]): typingsSlinky.pulumiPulumi.outputMod.Output_[js.Tuple3[Unwrap[T1], Unwrap[T2], Unwrap[T3]]] = js.native
