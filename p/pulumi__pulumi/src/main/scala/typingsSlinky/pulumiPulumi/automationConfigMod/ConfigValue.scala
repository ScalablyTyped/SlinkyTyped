package typingsSlinky.pulumiPulumi.automationConfigMod
...
@js.native
trait ConfigValue extends js.Object {
...
object ConfigValue {
  ...
  @scala.inline
  implicit class ConfigValueOps[Self <: ConfigValue] (val x: Self) extends AnyVal {
