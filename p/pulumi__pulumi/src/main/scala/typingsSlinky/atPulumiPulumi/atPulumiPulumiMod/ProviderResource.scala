...
abstract class ProviderResource protected ()
  extends typingsSlinky.atPulumiPulumi.resourceMod.ProviderResource {
  /**
...
object ProviderResource extends js.Object {
  ...
  def register(provider: typingsSlinky.atPulumiPulumi.resourceMod.ProviderResource): js.Promise[js.UndefOr[String]] = js.native
}
