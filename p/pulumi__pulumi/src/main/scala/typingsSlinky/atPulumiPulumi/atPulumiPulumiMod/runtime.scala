...
object runtime extends js.Object {
  ...
  class StreamInvokeResponse[T] protected ()
    extends typingsSlinky.atPulumiPulumi.runtimeMod.StreamInvokeResponse[T] {
  ...
  def listResourceOutputs[U /* <: typingsSlinky.atPulumiPulumi.resourceMod.Resource */](): AsyncQueryable[ResolvedResource[U]] = js.native
  def listResourceOutputs[U /* <: typingsSlinky.atPulumiPulumi.resourceMod.Resource */](typeFilter: js.Function1[/* o */ js.Any, /* is U */ Boolean]): AsyncQueryable[ResolvedResource[U]] = js.native
  def listResourceOutputs[U /* <: typingsSlinky.atPulumiPulumi.resourceMod.Resource */](typeFilter: js.Function1[/* o */ js.Any, /* is U */ Boolean], stackName: String): AsyncQueryable[ResolvedResource[U]] = js.native
  def monitorSupportsSecrets(): js.Promise[Boolean] = js.native
  def readResource(
    res: typingsSlinky.atPulumiPulumi.resourceMod.Resource,
    t: String,
    name: String,
    props: Inputs,
  ...
  def registerResourceOutputs(res: typingsSlinky.atPulumiPulumi.resourceMod.Resource, outputs: js.Promise[Inputs]): Unit = js.native
  def registerResourceOutputs(res: typingsSlinky.atPulumiPulumi.resourceMod.Resource, outputs: Inputs): Unit = js.native
  def registerResourceOutputs(
    res: typingsSlinky.atPulumiPulumi.resourceMod.Resource,
    outputs: typingsSlinky.atPulumiPulumi.outputMod.Output[Inputs]
  ): Unit = js.native
  ...
  def serializeProperty(
    ctx: String,
    prop: Input[_],
    dependentResources: Set[typingsSlinky.atPulumiPulumi.resourceMod.Resource]
  ): js.Promise[_] = js.native
  def serializeResourceProperties(label: String, props: Inputs): js.Promise[
    js.Tuple2[
      Record[String, _], 
      Map[String, Set[typingsSlinky.atPulumiPulumi.resourceMod.Resource]]
    ]
  ] = js.native
