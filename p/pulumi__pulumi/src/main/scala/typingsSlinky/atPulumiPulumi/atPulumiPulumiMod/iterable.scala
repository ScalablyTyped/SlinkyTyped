...
object iterable extends js.Object {
  ...
  ): typingsSlinky.atPulumiPulumi.outputMod.Output[StringDictionary[js.Array[V]]] = js.native
  def toObject[T, V](
    iter: Input[js.Array[Input[T]]],
    selector: js.Function1[/* t */ T, Input[js.Tuple2[Input[String], Input[V]]]]
  ): typingsSlinky.atPulumiPulumi.outputMod.Output[StringDictionary[V]] = js.native
}
