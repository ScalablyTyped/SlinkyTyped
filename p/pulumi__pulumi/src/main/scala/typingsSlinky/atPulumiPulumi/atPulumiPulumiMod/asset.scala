...
object asset extends js.Object {
  ...
  abstract class Archive ()
    extends typingsSlinky.atPulumiPulumi.assetMod.Archive
  
  @js.native
  abstract class Asset ()
    extends typingsSlinky.atPulumiPulumi.assetMod.Asset
  
  @js.native
  class AssetArchive protected ()
    extends typingsSlinky.atPulumiPulumi.assetMod.AssetArchive {
  ...
  class FileArchive protected ()
    extends typingsSlinky.atPulumiPulumi.assetMod.FileArchive {
  ...
  class FileAsset protected ()
    extends typingsSlinky.atPulumiPulumi.assetMod.FileAsset {
    def this(path: String) = this()
    def this(path: js.Promise[String]) = this()
  }
  ...
  class RemoteArchive protected ()
    extends typingsSlinky.atPulumiPulumi.assetMod.RemoteArchive {
  ...
  class RemoteAsset protected ()
    extends typingsSlinky.atPulumiPulumi.assetMod.RemoteAsset {
    def this(uri: String) = this()
    def this(uri: js.Promise[String]) = this()
  }
  ...
  class StringAsset protected ()
    extends typingsSlinky.atPulumiPulumi.assetMod.StringAsset {
