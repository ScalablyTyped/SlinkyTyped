...
class ResourceError protected ()
  extends typingsSlinky.atPulumiPulumi.errorsMod.ResourceError {
  def this(message: String) = this()
  def this(message: String, resource: typingsSlinky.atPulumiPulumi.resourceMod.Resource) = this()
  def this(message: String, resource: js.UndefOr[scala.Nothing], hideStack: Boolean) = this()
  def this(message: String, resource: typingsSlinky.atPulumiPulumi.resourceMod.Resource, hideStack: Boolean) = this()
}
