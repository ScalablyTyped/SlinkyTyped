...
import typingsSlinky.atPulumiPulumi.assetArchiveMod.AssetMap
...
object assetMod extends js.Object {
  ...
  abstract class Archive ()
    extends typingsSlinky.atPulumiPulumi.assetArchiveMod.Archive
  
  @js.native
  abstract class Asset ()
    extends typingsSlinky.atPulumiPulumi.assetAssetMod.Asset
  
  @js.native
  class AssetArchive protected ()
    extends typingsSlinky.atPulumiPulumi.assetArchiveMod.AssetArchive {
  ...
  class FileArchive protected ()
    extends typingsSlinky.atPulumiPulumi.assetArchiveMod.FileArchive {
  ...
  class FileAsset protected ()
    extends typingsSlinky.atPulumiPulumi.assetAssetMod.FileAsset {
    def this(path: String) = this()
    def this(path: js.Promise[String]) = this()
  }
  ...
  class RemoteArchive protected ()
    extends typingsSlinky.atPulumiPulumi.assetArchiveMod.RemoteArchive {
  ...
  class RemoteAsset protected ()
    extends typingsSlinky.atPulumiPulumi.assetAssetMod.RemoteAsset {
    def this(uri: String) = this()
    def this(uri: js.Promise[String]) = this()
  }
  ...
  class StringAsset protected ()
    extends typingsSlinky.atPulumiPulumi.assetAssetMod.StringAsset {
