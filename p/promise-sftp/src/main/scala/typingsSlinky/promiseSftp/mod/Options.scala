...
import typingsSlinky.promiseSftp.anon.Echo
import typingsSlinky.promiseSftp.promiseSftpStrings.force
import typingsSlinky.promiseSftp.promiseSftpStrings.md5
import typingsSlinky.promiseSftp.promiseSftpStrings.sha1
...
trait Options extends StObject {
  ...
  var changePassword: js.UndefOr[
    js.Function2[/* message */ String, /* language */ String, typingsSlinky.bluebird.mod.^[String]]
  ] = js.native
  ...
  var tryKeyboard: js.UndefOr[Boolean] with (js.UndefOr[
    js.Function4[
      ...
      (js.Array[String | typingsSlinky.bluebird.mod.^[String]]) | typingsSlinky.bluebird.mod.^[js.Array[String]]
    ]
  ]) = js.native
...
object Options {
  ...
  implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChangePassword(value: (/* message */ String, /* language */ String) => typingsSlinky.bluebird.mod.^[String]): Self = StObject.set(x, "changePassword", js.Any.fromFunction2(value))
