...
object Disable {
  ...
  implicit class DisableOps[Self <: Disable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: Authorization => js.Promise[Response]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDisable(value: Code => js.Promise[Responsedataundefined]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disable")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEnable(value: Code => js.Promise[Responsedataundefined]): Self = {
        val ret = this.duplicate
