...
package object typesMod {
  ...
  {[ P in keyof T ]: promise.allsettled.promise.allsettled/types.PromiseResult<T[P], unknown>}
    */ typingsSlinky.promiseAllsettled.promiseAllsettledStrings.PromiseResultTuple with T
  ...
  {[ P in keyof T ]: std.Promise<T[P]>}
    */ typingsSlinky.promiseAllsettled.promiseAllsettledStrings.PromiseTuple with T
}
