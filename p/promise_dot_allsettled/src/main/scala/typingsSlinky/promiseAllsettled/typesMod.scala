...
object typesMod {
  ...
  */
  ...
  object PromiseResult {
    ...
    @scala.inline
    def PromiseRejection[E](reason: E, status: rejected): typingsSlinky.promiseAllsettled.typesMod.PromiseRejection[E] = {
      val __obj = js.Dynamic.literal(reason = reason.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.promiseAllsettled.typesMod.PromiseRejection[E]]
    }
    
    @scala.inline
    def PromiseResolution[T](status: fulfilled, value: T): typingsSlinky.promiseAllsettled.typesMod.PromiseResolution[T] = {
      val __obj = js.Dynamic.literal(status = status.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.promiseAllsettled.typesMod.PromiseResolution[T]]
    }
  }
  ...
  {[ P in keyof T ]: std.Promise<T[P]>}
    */ typingsSlinky.promiseAllsettled.promiseAllsettledStrings.PromiseTuple with TopLevel[T]
}
