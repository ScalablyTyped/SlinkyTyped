package typingsSlinky.promiseDotAllsettled.typesMod

import typingsSlinky.promiseDotAllsettled.promiseDotAllsettledStrings.fulfilled
import typingsSlinky.promiseDotAllsettled.promiseDotAllsettledStrings.rejected
