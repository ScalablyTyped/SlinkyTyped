...
import typingsSlinky.plotlyDotJs.Anon_Implicit
...
object d3 extends js.Object {
  ...
  def active[Datum, PElement /* <: BaseType */, PDatum](): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[Null, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Null, name: String): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[Null, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: EnterElement): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[EnterElement, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: EnterElement, name: String): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[EnterElement, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Document): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[org.scalajs.dom.raw.Document, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Document, name: String): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[org.scalajs.dom.raw.Document, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Element): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[org.scalajs.dom.raw.Element, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Element, name: String): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[org.scalajs.dom.raw.Element, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Window): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[org.scalajs.dom.raw.Window, Datum, PElement, PDatum]) | Null = js.native
  def active[Datum, PElement /* <: BaseType */, PDatum](node: Window, name: String): (typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[org.scalajs.dom.raw.Window, Datum, PElement, PDatum]) | Null = js.native
  ...
  def axisBottom[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typingsSlinky.d3DashAxis.d3DashAxisMod.Axis[Domain] = js.native
  def axisLeft[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typingsSlinky.d3DashAxis.d3DashAxisMod.Axis[Domain] = js.native
  def axisRight[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typingsSlinky.d3DashAxis.d3DashAxisMod.Axis[Domain] = js.native
  def axisTop[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typingsSlinky.d3DashAxis.d3DashAxisMod.Axis[Domain] = js.native
  ...
  def transition[OldDatum](): typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[HTMLElement, OldDatum, Null, js.UndefOr[scala.Nothing]] = js.native
  def transition[OldDatum](name: String): typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[HTMLElement, OldDatum, Null, js.UndefOr[scala.Nothing]] = js.native
  def transition[OldDatum](
    transition: typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[BaseType, _, BaseType, _]
  ): typingsSlinky.d3DashTransition.d3DashTransitionMod.Transition[HTMLElement, OldDatum, Null, js.UndefOr[scala.Nothing]] = js.native
