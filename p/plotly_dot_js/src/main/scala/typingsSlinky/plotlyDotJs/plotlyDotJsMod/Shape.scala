...
import typingsSlinky.plotlyDotJs.plotlyDotJsStrings.line
import typingsSlinky.plotlyDotJs.plotlyDotJsStrings.paper
import typingsSlinky.plotlyDotJs.plotlyDotJsStrings.path
import typingsSlinky.plotlyDotJs.plotlyDotJsStrings.rect
