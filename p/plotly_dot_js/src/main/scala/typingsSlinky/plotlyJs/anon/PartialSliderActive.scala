...
object PartialSliderActive {
  ...
  @scala.inline
  def apply(): PartialSliderActive = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSliderActive]
  }
  
  @scala.inline
  implicit class PartialSliderActiveOps[Self <: PartialSliderActive] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivebgcolor(value: typingsSlinky.plotlyJs.mod.Color): Self = this.set("activebgcolor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFont(value: typingsSlinky.plotlyJs.mod.Font): Self = this.set("font", value.asInstanceOf[js.Any])
