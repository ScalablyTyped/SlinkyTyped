...
trait PartialLayoutAxisAnchor extends StObject {
  ...
  var rangeselector: js.UndefOr[PartialRangeSelectorActivecolor] = js.native
...
object PartialLayoutAxisAnchor {
  ...
  @scala.inline
  def apply(): PartialLayoutAxisAnchor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLayoutAxisAnchor]
  }
  
  @scala.inline
  implicit class PartialLayoutAxisAnchorMutableBuilder[Self <: PartialLayoutAxisAnchor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutomarginUndefined: Self = StObject.set(x, "automargin", js.undefined)
    ...
    @scala.inline
    def setAutotickUndefined: Self = StObject.set(x, "autotick", js.undefined)
    ...
    @scala.inline
    def setConstraintowardUndefined: Self = StObject.set(x, "constraintoward", js.undefined)
    ...
    @scala.inline
    def setOverlayingUndefined: Self = StObject.set(x, "overlaying", js.undefined)
    ...
    @scala.inline
    def setRangesliderUndefined: Self = StObject.set(x, "rangeslider", js.undefined)
    
    @scala.inline
    def setScaleanchor(value: AxisName): Self = StObject.set(x, "scaleanchor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScaleanchorUndefined: Self = StObject.set(x, "scaleanchor", js.undefined)
