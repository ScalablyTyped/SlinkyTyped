...
object PartialLayoutAxisAnchor {
  ...
  @scala.inline
  implicit class PartialLayoutAxisAnchorOps[Self <: PartialLayoutAxisAnchor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withGridcolor(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLinecolor(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRangeselector(value: PartialRangeSelectorActivecolor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSpikecolor(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitle(value: String | PartialDataTitleFont): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withZerolinecolor(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
