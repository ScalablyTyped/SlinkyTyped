...
trait PartialLayoutAngularaxis extends js.Object {
  ...
  var paper_bgcolor: js.UndefOr[typingsSlinky.plotlyJs.mod.Color] = js.undefined
  var plot_bgcolor: js.UndefOr[typingsSlinky.plotlyJs.mod.Color] = js.undefined
...
object PartialLayoutAngularaxis {
  ...
  def apply(
    ...
    annotations: js.Array[PartialAnnotationsArrowcolor] = null,
    ...
    mapbox: PartialMapboxBearing = null,
    margin: PartialMargin = null,
    orientation: js.UndefOr[Double] = js.undefined,
    paper_bgcolor: typingsSlinky.plotlyJs.mod.Color = null,
    plot_bgcolor: typingsSlinky.plotlyJs.mod.Color = null,
    ...
    sliders: js.Array[PartialSliderActivebgcolor] = null,
    subplot: String = null,
