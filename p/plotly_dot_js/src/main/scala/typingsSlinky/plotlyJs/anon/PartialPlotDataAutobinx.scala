...
object PartialPlotDataAutobinx {
  ...
  @scala.inline
  implicit class PartialPlotDataAutobinxMutableBuilder[Self <: PartialPlotDataAutobinx] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarker(value: PartialPlotMarkerAutocolorscale): Self = StObject.set(x, "marker", value.asInstanceOf[js.Any])
