...
object PartialPlotMarkerCauto {
  ...
  implicit class PartialPlotMarkerCautoMutableBuilder[Self <: PartialPlotMarkerCauto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: typingsSlinky.plotlyJs.mod.Color | js.Array[typingsSlinky.plotlyJs.mod.Color]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    def setColorVarargs(
      value: (js.UndefOr[
          (js.Array[js.UndefOr[String | Double | Null]]) | typingsSlinky.plotlyJs.mod.Color | Double | Null | String
        ])*
    ...
    @scala.inline
    def setColors(value: js.Array[typingsSlinky.plotlyJs.mod.Color]): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColorsUndefined: Self = StObject.set(x, "colors", js.undefined)
    
    @scala.inline
    def setColorsVarargs(value: typingsSlinky.plotlyJs.mod.Color*): Self = StObject.set(x, "colors", js.Array(value :_*))
