...
object PartialSceneAxisAutorange {
  ...
  implicit class PartialSceneAxisAutorangeOps[Self <: PartialSceneAxisAutorange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackgroundcolor(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTickfont(value: Partial[typingsSlinky.plotlyJs.mod.Font]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitlefont(value: Partial[typingsSlinky.plotlyJs.mod.Font]): Self = {
        val ret = this.duplicate
