...
object PartialSceneAxisAutorange {
  ...
  implicit class PartialSceneAxisAutorangeOps[Self <: PartialSceneAxisAutorange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundcolor(value: typingsSlinky.plotlyJs.mod.Color): Self = this.set("backgroundcolor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTickfont(value: Partial[typingsSlinky.plotlyJs.mod.Font]): Self = this.set("tickfont", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTitlefont(value: Partial[typingsSlinky.plotlyJs.mod.Font]): Self = this.set("titlefont", value.asInstanceOf[js.Any])
    @scala.inline
