...
trait PartialSceneAxisAutorange extends StObject {
  ...
  var backgroundcolor: js.UndefOr[typingsSlinky.plotlyJs.mod.Color] = js.native
  ...
  var tickfont: js.UndefOr[Partial[typingsSlinky.plotlyJs.mod.Font]] = js.native
  ...
  var titlefont: js.UndefOr[Partial[typingsSlinky.plotlyJs.mod.Font]] = js.native
...
object PartialSceneAxisAutorange {
  ...
  implicit class PartialSceneAxisAutorangeMutableBuilder[Self <: PartialSceneAxisAutorange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundcolor(value: typingsSlinky.plotlyJs.mod.Color): Self = StObject.set(x, "backgroundcolor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTickfont(value: Partial[typingsSlinky.plotlyJs.mod.Font]): Self = StObject.set(x, "tickfont", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitlefont(value: Partial[typingsSlinky.plotlyJs.mod.Font]): Self = StObject.set(x, "titlefont", value.asInstanceOf[js.Any])
