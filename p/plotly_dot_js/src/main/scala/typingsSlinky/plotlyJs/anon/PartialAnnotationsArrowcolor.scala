...
@js.native
trait PartialAnnotationsArrowcolor extends StObject {
...
object PartialAnnotationsArrowcolor {
  ...
  @scala.inline
  implicit class PartialAnnotationsArrowcolorMutableBuilder[Self <: PartialAnnotationsArrowcolor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHoverlabel(value: Partial[HoverLabel]): Self = StObject.set(x, "hoverlabel", value.asInstanceOf[js.Any])
