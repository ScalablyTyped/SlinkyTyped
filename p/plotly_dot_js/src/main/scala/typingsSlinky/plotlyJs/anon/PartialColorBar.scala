...
trait PartialColorBar extends js.Object {
  ...
  var tickformatstops: js.UndefOr[Dtickrange] = js.native
...
object PartialColorBar {
  ...
  implicit class PartialColorBarOps[Self <: PartialColorBar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBorderwidth(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutlinecolor(value: typingsSlinky.plotlyJs.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTickfont(value: typingsSlinky.plotlyJs.mod.Font): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitlefont(value: typingsSlinky.plotlyJs.mod.Font): Self = {
        val ret = this.duplicate
