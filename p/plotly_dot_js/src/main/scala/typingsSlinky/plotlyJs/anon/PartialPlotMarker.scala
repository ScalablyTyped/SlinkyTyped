...
object PartialPlotMarker {
  ...
  implicit class PartialPlotMarkerOps[Self <: PartialPlotMarker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: typingsSlinky.plotlyJs.mod.Color | js.Array[typingsSlinky.plotlyJs.mod.Color]): Self = this.set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColorsVarargs(value: typingsSlinky.plotlyJs.mod.Color*): Self = this.set("colors", js.Array(value :_*))
    
    @scala.inline
    def setColors(value: js.Array[typingsSlinky.plotlyJs.mod.Color]): Self = this.set("colors", value.asInstanceOf[js.Any])
