...
trait SliderStep extends js.Object {
  ...
  /**
  	 ...
  	 */
  var method: animate | typingsSlinky.plotlyJs.plotlyJsStrings.relayout | typingsSlinky.plotlyJs.plotlyJsStrings.restyle | skip | typingsSlinky.plotlyJs.plotlyJsStrings.update
  /**
