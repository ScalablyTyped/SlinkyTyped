...
object Gauge {
  ...
  implicit class GaugeOps[Self <: Gauge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStepsVarargs(value: typingsSlinky.plotlyJs.anon.Color*): Self = this.set("steps", js.Array(value :_*))
    @scala.inline
    def setSteps(value: js.Array[typingsSlinky.plotlyJs.anon.Color]): Self = this.set("steps", value.asInstanceOf[js.Any])
    @scala.inline
