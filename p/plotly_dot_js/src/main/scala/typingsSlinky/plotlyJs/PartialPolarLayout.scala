...
trait PartialPolarLayout extends js.Object {
  var angularaxis: js.UndefOr[PartialLayoutAxisAnchor] = js.native
  ...
  var radialaxis: js.UndefOr[PartialLayoutAxisAnchor] = js.native
...
object PartialPolarLayout {
  ...
  implicit class PartialPolarLayoutOps[Self <: PartialPolarLayout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAngularaxis(value: PartialLayoutAxisAnchor): Self = {
    ...
    @scala.inline
    def withRadialaxis(value: PartialLayoutAxisAnchor): Self = {
        val ret = this.duplicate
