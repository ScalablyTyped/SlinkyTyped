...
object Content {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](content: js.Array[js.Array[MenuElement[S]]]): Content[S] = {
    val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
    __obj.asInstanceOf[Content[S]]
  }
  @scala.inline
  implicit class ContentOps[Self <: Content[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with Content[S]) extends AnyVal {
    @scala.inline
