...
object DomUpdate {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](update: EditorState[S] => Boolean): DomUpdate[S] = {
    val __obj = js.Dynamic.literal(update = js.Any.fromFunction1(update))
    __obj.asInstanceOf[DomUpdate[S]]
  }
  @scala.inline
  implicit class DomUpdateOps[Self <: DomUpdate[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with DomUpdate[S]) extends AnyVal {
    @scala.inline
