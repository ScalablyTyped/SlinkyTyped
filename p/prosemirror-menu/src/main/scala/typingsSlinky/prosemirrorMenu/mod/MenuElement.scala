...
object MenuElement {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](render: EditorView[S] => Dom[S]): MenuElement[S] = {
    val __obj = js.Dynamic.literal(render = js.Any.fromFunction1(render))
    __obj.asInstanceOf[MenuElement[S]]
  }
  @scala.inline
  implicit class MenuElementOps[Self <: MenuElement[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with MenuElement[S]) extends AnyVal {
    @scala.inline
