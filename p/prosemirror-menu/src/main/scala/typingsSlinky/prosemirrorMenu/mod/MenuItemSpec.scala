...
object MenuItemSpec {
  @scala.inline
  def apply[/* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S](run: (EditorState[S], js.Function1[/* p */ Transaction[S], Unit], EditorView[S], Event) => Unit): MenuItemSpec[S] = {
    val __obj = js.Dynamic.literal(run = js.Any.fromFunction4(run))
    __obj.asInstanceOf[MenuItemSpec[S]]
  }
  @scala.inline
  implicit class MenuItemSpecOps[Self <: MenuItemSpec[_], /* <: typingsSlinky.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with MenuItemSpec[S]) extends AnyVal {
    @scala.inline
