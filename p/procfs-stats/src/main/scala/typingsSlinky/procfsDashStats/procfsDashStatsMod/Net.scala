...
import typingsSlinky.procfsDashStats.Anon_Receive
import typingsSlinky.procfsDashStats.Anon_ReceiveString
import typingsSlinky.procfsDashStats.Anon_Transmit
