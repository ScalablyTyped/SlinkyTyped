...
import typingsSlinky.atPollyjsCore.TypeofClassAdapter
import typingsSlinky.atPollyjsCore.TypeofClassPersister
import typingsSlinky.atPollyjsPersister.atPollyjsPersisterMod.default
