...
trait AnonBody extends js.Object {
  ...
  var headers: js.UndefOr[Boolean | AnonExclude | (MatchBy[Headers, Headers])] = js.native
  var method: js.UndefOr[Boolean | (MatchBy[String, String])] = js.native
  var order: js.UndefOr[Boolean] = js.native
  var url: js.UndefOr[Boolean | (MatchBy[String, String]) | AnonHash] = js.native
}
...
object AnonBody {
  ...
  implicit class AnonBodyOps[Self <: AnonBody] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHeaders(value: Boolean | AnonExclude | (MatchBy[Headers, Headers])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUrl(value: Boolean | (MatchBy[String, String]) | AnonHash): Self = {
        val ret = this.duplicate
